...
`      `[`1.2`](#section-1-2)`. Objectives and Scope of the Document`

`      `[`1.3`](#section-1-3)`. Layer 2 Virtual Private Networks`

`      `[`1.4`](#section-1-4)`. Terminology`

`   `[`2`](#section-2)`. Models`

`      `[`2.1`](#section-2-1)`. Reference Model for VPWS`

`           `[`2.1.1`](#section-2-1-1)`. Entities in the VPWS Reference Model`

`      `[`2.2`](#section-2-2)`. Reference Model for VPLS`

`           `[`2.2.1`](#section-2-2-1)`. Entities in the VPLS Reference Model`

`      `[`2.3`](#section-2-3)`. Reference Model for Distributed VPLS-PE or VPWS-PE`

`           `[`2.3.1`](#section-2-3-1)`. Entities in the Distributed PE Reference Models`

`      `[`2.4`](#section-2-4)`. VPWS-PE and VPLS-PE`

`   `[`3`](#section-3)`. Functional Components of L2 VPN`

`      `[`3.1`](#section-3-1)`. Types of L2VPN`

`           `[`3.1.1`](#section-3-1-1)`. Virtual Private Wire Service (VPWS)`

`           `[`3.1.2`](#section-3-1-2)`. Virtual Private LAN Service (VPLS)`

`           `[`3.1.3`](#section-3-1-3)`. IP-Only LAN-Like Service (IPLS)`

`      `[`3.2`](#section-3-2)`. Generic L2VPN Transport Functional Components`

`           `[`3.2.1`](#section-3-2-1)`. Attachment Circuits`

`           `[`3.2.2`](#section-3-2-2)`. Pseudowires`

`           `[`3.2.3`](#section-3-2-3)`. Forwarders`

`           `[`3.2.4`](#section-3-2-4)`. Tunnels`

`           `[`3.2.5`](#section-3-2-5)`. Encapsulation`

`           `[`3.2.6`](#section-3-2-6)`. Pseudowire Signaling`

`                  `[`3.2.6.1`](#section-3-2-6-1)`. Point-to-Point Signaling`

`                  `[`3.2.6.2`](#section-3-2-6-2)`. Point-to-Multipoint Signaling`

`                  `[`3.2.6.3`](#section-3-2-6-3)`. Inter-AS Considerations`

`           `[`3.2.7`](#section-3-2-7)`. Service Quality`

`                  `[`3.2.7.1`](#section-3-2-7-1)`. Quality of Service (QoS)`

`                  `[`3.2.7.2`](#section-3-2-7-2)`. Resiliency`

`           `[`3.2.8`](#section-3-2-8)`. Management`

`      `[`3.3`](#section-3-3)`. VPWS`

`           `[`3.3.1`](#section-3-3-1)`. Provisioning and Auto-Discovery`

`                  `[`3.3.1.1`](#section-3-3-1-1)`. Attachment Circuit Provisioning`

`                  `[`3.3.1.2`](#section-3-3-1-2)`. PW Provisioning for Arbitrary`

`                           Overlay Topologies`

`                  `[`3.3.1.3`](#section-3-3-1-3)`. Colored Pools PW Provisioning Model`

`           `[`3.3.2`](#section-3-3-2)`. Requirements on Auto-Discovery Procedures`

`           `[`3.3.3`](#section-3-3-3)`. Heterogeneous Pseudowires`

`      `[`3.4`](#section-3-4)`. VPLS Emulated LANs`

`           `[`3.4.1`](#section-3-4-1)`. VPLS Overlay Topologies and Forwarding`

`           `[`3.4.2`](#section-3-4-2)`. Provisioning and Auto-Discovery`

`           `[`3.4.3`](#section-3-4-3)`. Distributed PE`

`           `[`3.4.4`](#section-3-4-4)`. Scaling Issues in VPLS Deployment`

`      `[`3.5`](#section-3-5)`. IP-Only LAN-Like Service (IPLS)`

`   `[`4`](#section-4)`. Security Considerations`

`      `[`4.1`](#section-4-1)`. Provider Network Security Issues`

`      `[`4.2`](#section-4-2)`. Provider-Customer Network Security Issues`

`      `[`4.3`](#section-4-3)`. Customer Network Security Issues`

`   `[`5`](#section-5)`. Acknowledgements`

`   `[`6`](#section-6)`. Normative References`

`   `[`7`](#section-7)`. Informative References`
...
<a id="section-1-2"></a> **`1.2. Objectives and Scope of the Document`**
...
<a id="section-1-3"></a> **`1.3. Layer 2 Virtual Private Networks`**
...
<a id="section-2"></a> **`2. Models`**

```text

```

<a id="section-2-1"></a> **`2.1. Reference Model for VPWS`**
...
<a id="section-2-1-1"></a> **`2.1.1. Entities in the VPWS Reference Model`**
...
<a id="section-2-2"></a> **`2.2. Reference Model for VPLS`**
...
<a id="section-2-2-1"></a> **`2.2.1. Entities in the VPLS Reference Model`**
...
<a id="section-2-3"></a> **`2.3. Reference Model for Distributed VPLS-PE or VPWS-PE`**
...
<a id="section-2-3-1"></a> **`2.3.1. Entities in the Distributed PE Reference Models`**
...
<a id="section-2-4"></a> **`2.4. VPWS-PE and VPLS-PE`**
...
<a id="section-3"></a> **`3. Functional Components of L2 VPN`**
...
<a id="section-3-1"></a> **`3.1. Types of L2VPN`**
...
<a id="section-3-1-1"></a> **`3.1.1. Virtual Private Wire Service (VPWS)`**
...
<a id="section-3-1-2"></a> **`3.1.2. Virtual Private LAN Service (VPLS)`**
...
<a id="section-3-1-3"></a> **`3.1.3. IP-Only LAN-Like Service (IPLS)`**
...
<a id="section-3-2"></a> **`3.2. Generic L2VPN Transport Functional Components`**
...
<a id="section-3-2-1"></a> **`3.2.1. Attachment Circuits`**
...
<a id="section-3-2-2"></a> **`3.2.2. Pseudowires`**
...
<a id="section-3-2-3"></a> **`3.2.3. Forwarders`**
...
<a id="section-3-2-4"></a> **`3.2.4. Tunnels`**
...
<a id="section-3-2-5"></a> **`3.2.5. Encapsulation`**
...
<a id="section-3-2-6"></a> **`3.2.6. Pseudowire Signaling`**
...
<a id="section-3-2-6-1"></a> **`3.2.6.1. Point-to-Point Signaling`**
...
<a id="section-3-2-6-2"></a> **`3.2.6.2. Point-to-Multipoint Signaling`**
...
<a id="section-3-2-6-3"></a> **`3.2.6.3. Inter-AS Considerations`**
...
<a id="section-3-2-7"></a> **`3.2.7. Service Quality`**
...
<a id="section-3-2-7-1"></a> **`3.2.7.1. Quality of Service (QoS)`**
...
<a id="section-3-2-7-2"></a> **`3.2.7.2. Resiliency`**
...
<a id="section-3-2-8"></a> **`3.2.8. Management`**
...
<a id="section-3-3-1"></a> **`3.3.1. Provisioning and Auto-Discovery`**
...
<a id="section-3-3-1-1"></a> **`3.3.1.1. Attachment Circuit Provisioning`**
...
<a id="section-3-3-1-2"></a> **`3.3.1.2. PW Provisioning for Arbitrary Overlay Topologies`**
...
<a id="section-3-3-1-3"></a> **`3.3.1.3. Colored Pools PW Provisioning Model`**
...
<a id="section-3-3-2"></a> **`3.3.2. Requirements on Auto-Discovery Procedures`**
...
<a id="section-3-3-3"></a> **`3.3.3. Heterogeneous Pseudowires`**
...
<a id="section-3-4"></a> **`3.4. VPLS Emulated LANs`**
...
<a id="section-3-4-1"></a> **`3.4.1. VPLS Overlay Topologies and Forwarding`**
...
<a id="section-3-4-2"></a> **`3.4.2. Provisioning and Auto-Discovery`**
...
<a id="section-3-4-3"></a> **`3.4.3. Distributed PE`**
...
<a id="section-3-4-4"></a> **`3.4.4. Scaling Issues in VPLS Deployment`**
...
<a id="section-4-1"></a> **`4.1. Provider Network Security Issues`**
...
<a id="section-4-2"></a> **`4.2. Provider-Customer Network Security Issues`**
...
<a id="section-4-3"></a> **`4.3. Customer Network Security Issues`**
...
<a id="section-5"></a> **`5. Acknowledgements`**
...
<a id="section-6"></a> **`6. Normative References`**
...
<a id="section-7"></a> **`7. Informative References`**
