...
`   `[`1`](#section-1)`. Scope and Introduction`

`   `[`2`](#section-2)`. Security Requirements of VPN Networks`

`      `[`2.1`](#section-2-1)`. Address Space, Routing, and Traffic Separation`

`      `[`2.2`](#section-2-2)`. Hiding the Core Infrastructure`

`      `[`2.3`](#section-2-3)`. Resistance to Attacks`

`      `[`2.4`](#section-2-4)`. Impossibility of Label Spoofing`

`   `[`3`](#section-3)`. Analysis of BGP/MPLS IP VPN Security`

`      `[`3.1`](#section-3-1)`. Address Space, Routing, and Traffic Separation`

`      `[`3.2`](#section-3-2)`. Hiding of the BGP/MPLS IP VPN Core Infrastructure`

`      `[`3.3`](#section-3-3)`. Resistance to Attacks`

`      `[`3.4`](#section-3-4)`. Label Spoofing`

`      `[`3.5`](#section-3-5)`. Comparison with ATM/FR VPNs`

`   `[`4`](#section-4)`. Security of Advanced BGP/MPLS IP VPN Architectures`

`      `[`4.1`](#section-4-1)`. Carriers' Carrier`

`      `[`4.2`](#section-4-2)`. Inter-Provider Backbones`

`   `[`5`](#section-5)`. What BGP/MPLS IP VPNs Do Not Provide`

`      `[`5.1`](#section-5-1)`. Protection against Misconfigurations of the Core`

`           and Attacks 'within' the Core`

`      `[`5.2`](#section-5-2)`. Data Encryption, Integrity, and Origin Authentication`

`      `[`5.3`](#section-5-3)`. Customer Network Security`

`   `[`6`](#section-6)`. Layer 2 Security Considerations`

`   `[`7`](#section-7)`. Summary and Conclusions`
...
<a id="section-1"></a> **`1. Scope and Introduction`**
...
<a id="section-2"></a> **`2. Security Requirements of VPN Networks`**
...
<a id="section-2-1"></a> **`2.1. Address Space, Routing, and Traffic Separation`**
...
<a id="section-2-2"></a> **`2.2. Hiding the Core Infrastructure`**
...
<a id="section-2-3"></a> **`2.3. Resistance to Attacks`**
...
<a id="section-2-4"></a> **`2.4. Impossibility of Label Spoofing`**
...
<a id="section-3"></a> **`3. Analysis of BGP/MPLS IP VPN Security`**
...
<a id="section-3-1"></a> **`3.1. Address Space, Routing, and Traffic Separation`**
...
<a id="section-3-2"></a> **`3.2. Hiding of the BGP/MPLS IP VPN Core Infrastructure`**
...
<a id="section-3-3"></a> **`3.3. Resistance to Attacks`**
...
<a id="section-3-4"></a> **`3.4. Label Spoofing`**
...
<a id="section-3-5"></a> **`3.5. Comparison with ATM/FR VPNs`**
...
<a id="section-4"></a> **`4. Security of Advanced BGP/MPLS IP VPN Architectures`**
...
<a id="section-4-1"></a> **`4.1. Carriers' Carrier`**
...
<a id="section-4-2"></a> **`4.2. Inter-Provider Backbones`**
...
<a id="section-5"></a> **`5. What BGP/MPLS IP VPNs Do Not Provide`**

```text

```

<a id="section-5-1"></a> **`5.1. Protection against Misconfigurations of the Core and Attacks`**
...
<a id="section-5-2"></a> **`5.2. Data Encryption, Integrity, and Origin Authentication`**
...
<a id="section-5-3"></a> **`5.3. Customer Network Security`**
...
<a id="section-6"></a> **`6. Layer 2 Security Considerations`**
...
<a id="section-7"></a> **`7. Summary and Conclusions`**
