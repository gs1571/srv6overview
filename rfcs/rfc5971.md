...
`   `[`2`](#section-2)`. Requirements Notation and Terminology`

`   `[`3`](#section-3)`. Design Overview`

`     `[`3.1`](#section-3-1)`. Overall Design Approach`

`     `[`3.2`](#section-3-2)`. Modes and Messaging Associations`

`     `[`3.3`](#section-3-3)`. Message Routing Methods`

`     `[`3.4`](#section-3-4)`. GIST Messages`

`     `[`3.5`](#section-3-5)`. GIST Peering Relationships`

`     `[`3.6`](#section-3-6)`. Effect on Internet Transparency`

`     `[`3.7`](#section-3-7)`. Signalling Sessions`

`     `[`3.8`](#section-3-8)`. Signalling Applications and NSLPIDs`

`     `[`3.9`](#section-3-9)`. GIST Security Services`

`     `[`3.10`](#section-3-10)`. Example of Operation`

`   `[`4`](#section-4)`. GIST Processing Overview`

`     `[`4.1`](#section-4-1)`. GIST Service Interface`

`     `[`4.2`](#section-4-2)`. GIST State`

`     `[`4.3`](#section-4-3)`. Basic GIST Message Processing`

`     `[`4.4`](#section-4-4)`. Routing State and Messaging Association Maintenance`

`   `[`5`](#section-5)`. Message Formats and Transport`

`     `[`5.1`](#section-5-1)`. GIST Messages`

`     `[`5.2`](#section-5-2)`. Information Elements`

`     `[`5.3`](#section-5-3)`. D-mode Transport`

`     `[`5.4`](#section-5-4)`. C-mode Transport`

`     `[`5.5`](#section-5-5)`. Message Type/Encapsulation Relationships`

`     `[`5.6`](#section-5-6)`. Error Message Processing`

`     `[`5.7`](#section-5-7)`. Messaging Association Setup`

`     `[`5.8`](#section-5-8)`. Specific Message Routing Methods`

`   `[`6`](#section-6)`. Formal Protocol Specification`

`     `[`6.1`](#section-6-1)`. Node Processing`

`     `[`6.2`](#section-6-2)`. Query Node Processing`

`     `[`6.3`](#section-6-3)`. Responder Node Processing`

`     `[`6.4`](#section-6-4)`. Messaging Association Processing`

`   `[`7`](#section-7)`. Additional Protocol Features`

`     `[`7.1`](#section-7-1)`. Route Changes and Local Repair`

`     `[`7.2`](#section-7-2)`. NAT Traversal`

`     `[`7.3`](#section-7-3)`. Interaction with IP Tunnelling`

`     `[`7.4`](#section-7-4)`. IPv4-IPv6 Transition and Interworking`

`   `[`8`](#section-8)`. Security Considerations`

`     `[`8.1`](#section-8-1)`. Message Confidentiality and Integrity`

`     `[`8.2`](#section-8-2)`. Peer Node Authentication`

`     `[`8.3`](#section-8-3)`. Routing State Integrity`

`     `[`8.4`](#section-8-4)`. Denial-of-Service Prevention and Overload Protection  .`

`     `[`8.5`](#section-8-5)`. Requirements on Cookie Mechanisms`

`     `[`8.6`](#section-8-6)`. Security Protocol Selection Policy`

`     `[`8.7`](#section-8-7)`. Residual Threats`
...
<a id="section-2"></a> **`2. Requirements Notation and Terminology`**
...
<a id="section-3"></a> **`3. Design Overview`**

```text

```

<a id="section-3-1"></a> **`3.1. Overall Design Approach`**
...
<a id="section-3-2"></a> **`3.2. Modes and Messaging Associations`**
...
<a id="section-3-3"></a> **`3.3. Message Routing Methods`**
...
<a id="section-3-4"></a> **`3.4. GIST Messages`**
...
<a id="section-3-5"></a> **`3.5. GIST Peering Relationships`**
...
<a id="section-3-6"></a> **`3.6. Effect on Internet Transparency`**
...
<a id="section-3-7"></a> **`3.7. Signalling Sessions`**
...
<a id="section-3-8"></a> **`3.8. Signalling Applications and NSLPIDs`**
...
<a id="section-3-9"></a> **`3.9. GIST Security Services`**
...
<a id="section-3-10"></a> **`3.10. Example of Operation`**
...
<a id="section-4"></a> **`4. GIST Processing Overview`**
...
<a id="section-4-1"></a> **`4.1. GIST Service Interface`**
...
<a id="section-4-1-1"></a> **`4.1.1. Message Handling`**
...
<a id="section-4-1-2"></a> **`4.1.2. Message Transfer Attributes`**
...
<a id="section-4-1-3"></a> **`4.1.3. SID Selection`**
...
<a id="section-4-2"></a> **`4.2. GIST State`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Message Routing State`**
...
<a id="section-4-2-2"></a> **`4.2.2. Peer-Peer Messaging Association State`**
...
<a id="section-4-3"></a> **`4.3. Basic GIST Message Processing`**
...
<a id="section-4-3-1"></a> **`4.3.1. Message Reception`**
...
<a id="section-4-3-2"></a> **`4.3.2. Local Processing and Validation`**
...
<a id="section-4-3-3"></a> **`4.3.3. Message Transmission`**
...
<a id="section-4-3-4"></a> **`4.3.4. Nodes not Hosting the NSLP`**
...
<a id="section-4-4"></a> **`4.4. Routing State and Messaging Association Maintenance`**
...
<a id="section-4-4-1"></a> **`4.4.1. Routing State and Messaging Association Creation`**
...
<a id="section-4-4-2"></a> **`4.4.2. GIST Peer Authorisation`**
...
<a id="section-4-4-3"></a> **`4.4.3. Messaging Association Multiplexing`**
...
<a id="section-4-4-4"></a> **`4.4.4. Routing State Maintenance`**
...
<a id="section-4-4-5"></a> **`4.4.5. Messaging Association Maintenance`**
...
<a id="section-4-4-6"></a> **`4.4.6. Routing State Failures`**
...
<a id="section-5"></a> **`5. Message Formats and Transport`**

```text

```

<a id="section-5-1"></a> **`5.1. GIST Messages`**
...
<a id="section-5-2"></a> **`5.2. Information Elements`**
...
<a id="section-5-2-1"></a> **`5.2.1. The Common Header`**
...
<a id="section-5-2-2"></a> **`5.2.2. TLV Objects`**
...
<a id="section-5-3"></a> **`5.3. D-mode Transport`**
...
<a id="section-5-3-1"></a> **`5.3.1. Normal Encapsulation`**
...
<a id="section-5-3-2"></a> **`5.3.2. Q-mode Encapsulation`**
...
<a id="section-5-3-2-1"></a> **`5.3.2.1. Encapsulation and Interception in IPv4`**
...
<a id="section-5-3-2-2"></a> **`5.3.2.2. Encapsulation and Interception in IPv6`**
...
<a id="section-5-3-2-3"></a> **`5.3.2.3. Upper Layer Encapsulation and Overall Interception`**
...
<a id="section-5-3-2-4"></a> **`5.3.2.4. IP Option Processing`**
...
<a id="section-5-3-3"></a> **`5.3.3. Retransmission and Rate Control`**
...
<a id="section-5-4"></a> **`5.4. C-mode Transport`**
...
<a id="section-5-5"></a> **`5.5. Message Type/Encapsulation Relationships`**
...
<a id="section-5-6"></a> **`5.6. Error Message Processing`**
...
<a id="section-5-7"></a> **`5.7. Messaging Association Setup`**

```text

```

<a id="section-5-7-1"></a> **`5.7.1. Overview`**
...
<a id="section-5-7-2"></a> **`5.7.2. Protocol Definition: Forwards-TCP`**
...
<a id="section-5-7-3"></a> **`5.7.3. Protocol Definition: Transport Layer Security`**
...
<a id="section-5-7-3-1"></a> **`5.7.3.1. Identity Checking in TLS`**
...
<a id="section-5-8"></a> **`5.8. Specific Message Routing Methods`**
...
<a id="section-5-8-1"></a> **`5.8.1. The Path-Coupled MRM`**

```text

```

<a id="section-5-8-1-1"></a> **`5.8.1.1. Message Routing Information`**
...
<a id="section-5-8-1-2"></a> **`5.8.1.2. Downstream Q-mode Encapsulation`**
...
<a id="section-5-8-1-3"></a> **`5.8.1.3. Upstream Q-mode Encapsulation`**
...
<a id="section-5-8-2"></a> **`5.8.2. The Loose-End MRM`**
...
<a id="section-5-8-2-1"></a> **`5.8.2.1. Message Routing Information`**
...
<a id="section-5-8-2-2"></a> **`5.8.2.2. Downstream Q-mode Encapsulation`**
...
<a id="section-6"></a> **`6. Formal Protocol Specification`**
...
<a id="section-6-1"></a> **`6.1. Node Processing`**
...
<a id="section-6-2"></a> **`6.2. Query Node Processing`**
...
<a id="section-6-3"></a> **`6.3. Responder Node Processing`**
...
<a id="section-6-4"></a> **`6.4. Messaging Association Processing`**
...
<a id="section-7"></a> **`7. Additional Protocol Features`**

```text

```

<a id="section-7-1"></a> **`7.1. Route Changes and Local Repair`**

```text

```

<a id="section-7-1-1"></a> **`7.1.1. Introduction`**
...
<a id="section-7-1-2"></a> **`7.1.2. Route Change Detection Mechanisms`**
...
<a id="section-7-1-3"></a> **`7.1.3. GIST Behaviour Supporting Rerouting`**
...
<a id="section-7-1-4"></a> **`7.1.4. Load Splitting and Route Flapping`**
...
<a id="section-7-1-5"></a> **`7.1.5. Signalling Application Operation`**
...
<a id="section-7-2"></a> **`7.2. NAT Traversal`**
...
<a id="section-7-2-1"></a> **`7.2.1. Legacy NAT Handling`**
...
<a id="section-7-2-2"></a> **`7.2.2. GIST-Aware NAT Traversal`**
...
<a id="section-7-2-3"></a> **`7.2.3. Message Processing Rules`**
...
<a id="section-7-3"></a> **`7.3. Interaction with IP Tunnelling`**
...
<a id="section-7-4"></a> **`7.4. IPv4-IPv6 Transition and Interworking`**
...
<a id="section-8-1"></a> **`8.1. Message Confidentiality and Integrity`**
...
<a id="section-8-2"></a> **`8.2. Peer Node Authentication`**
...
<a id="section-8-3"></a> **`8.3. Routing State Integrity`**
...
<a id="section-8-4"></a> **`8.4. Denial-of-Service Prevention and Overload Protection`**
...
<a id="section-8-5"></a> **`8.5. Requirements on Cookie Mechanisms`**
...
<a id="section-8-6"></a> **`8.6. Security Protocol Selection Policy`**
...
<a id="section-8-7"></a> **`8.7. Residual Threats`**
