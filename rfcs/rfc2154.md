...
`   `[`3`](#section-3)`. 1 Signed LSA`

`   `[`3`](#section-3)`. 2 Router Public Key LSA (PKLSA)`

`   `[`3`](#section-3)`. 3 MaxAge Processing`

`   4 Key Management`

`   `[`4`](#section-4)`. 1 Identifying Keys`

`   `[`4.1`](#section-4-1)`. 1 Identifying Router Keys and PKLSAs`

`   `[`4.1`](#section-4-1)`. 2 Identifying TE Public Keys`

`   `[`4.1`](#section-4-1)`. 3 Key to use for Signing`

`   `[`4.1`](#section-4-1)`. 4 Key to use for Verification`

`   `[`4`](#section-4)`. 2 Trusted Entity (TE) Requirements`

`   `[`4`](#section-4)`. 3 Scope for Keys and Signature Algorithms`

`   `[`4`](#section-4)`. 4 Router Key Replacement`

`   `[`4`](#section-4)`. 5 Trusted Entity Key Replacement`

`   `[`4`](#section-4)`. 6 Flexible Cryptographic Environments`

`   `[`4.6`](#section-4-6)`. 1 Multiple Signature Algorithms`

`   `[`4.6`](#section-4-6)`. 2 Multiple Trusted Entities`

`   `[`4.6`](#section-4-6)`. 3 Multiple Keys for One Router`
...
`   `[`7`](#section-7)`. 1 Router Public Key LSA (PKLSA)`

`   `[`7`](#section-7)`. 2 Router Public Key Certificate`

`   `[`7`](#section-7)`. 3 Signed LSA`

`   8 Configuration Information`

`   9 Remaining Vulnerabilities`

`   `[`9`](#section-9)`. 1 Area Border Routers`

`   `[`9`](#section-9)`. 2 Internal Routers`

`   `[`9`](#section-9)`. 3 Autonomous System Border Routers`
...
<a id="section-1"></a> **`1. Acknowledgements`**
...
<a id="section-3"></a> **`3. LSA Processing`**

```text

```

<a id="section-3-1"></a> **`3.1. Signed LSA`**
...
<a id="section-3-2"></a> **`3.2. Router Public Key LSA (PKLSA)`**
...
<a id="section-3-3"></a> **`3.3. MaxAge Processing`**
...
<a id="section-4"></a> **`4. Key Management`**

```text

```

<a id="section-4-1"></a> **`4.1. Identifying Keys`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Identifying Router Keys and PKLSAs`**
...
<a id="section-4-1-2"></a> **`4.1.2. Identifying TE Public Keys`**
...
<a id="section-4-1-3"></a> **`4.1.3. Key to use for Signing`**
...
<a id="section-4-1-4"></a> **`4.1.4. Key to use for Verification`**
...
<a id="section-4-2"></a> **`4.2. Trusted Entity (TE) Requirements`**
...
<a id="section-4-3"></a> **`4.3. Scope for Keys and Signature Algorithms`**
...
<a id="section-4-4"></a> **`4.4. Router Key Replacement`**
...
<a id="section-4-5"></a> **`4.5. Trusted Entity Key Replacement`**
...
<a id="section-4-6"></a> **`4.6. Flexible Cryptographic Environments`**
...
<a id="section-4-6-1"></a> **`4.6.1. Multiple Signature Algorithms`**
...
<a id="section-4-6-2"></a> **`4.6.2. Multiple Trusted Entities`**
...
<a id="section-4-6-3"></a> **`4.6.3. Multiple Keys for One Router`**
...
<a id="section-5"></a> **`5. Compatibility with Standard OSPF V2`**
...
<a id="section-6"></a> **`6. Special Considerations/Restrictions for the ABR-ASBR`**
...
<a id="section-7"></a> **`7. LSA formats`**

```text

```

<a id="section-7-1"></a> **`7.1. Router Public Key LSA (PKLSA)`**
...
<a id="section-7-2"></a> **`7.2. Router Public Key Certificate`**
...
<a id="section-8"></a> **`8. Configuration Information`**
...
<a id="section-9-1"></a> **`9.1. Area Border Routers`**
...
<a id="section-9-2"></a> **`9.2. Internal Routers`**
...
<a id="section-9-3"></a> **`9.3. Autonomous System Border Routers`**
