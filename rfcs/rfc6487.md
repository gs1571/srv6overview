...
`   `[`2`](#section-2)`. Describing Resources in Certificates`

`   `[`3`](#section-3)`. End-Entity (EE) Certificates and Signing Functions in the RPKI  5`

`   `[`4`](#section-4)`. Resource Certificates`

`     `[`4.1`](#section-4-1)`. Version`

`     `[`4.2`](#section-4-2)`. Serial Number`

`     `[`4.3`](#section-4-3)`. Signature Algorithm`

`     `[`4.4`](#section-4-4)`. Issuer`

`     `[`4.5`](#section-4-5)`. Subject`

`     `[`4.6`](#section-4-6)`. Validity`

`       `[`4.6.1`](#section-4-6-1)`. notBefore`

`       `[`4.6.2`](#section-4-6-2)`. notAfter`

`     `[`4.7`](#section-4-7)`. Subject Public Key Info`

`     `[`4.8`](#section-4-8)`. Resource Certificate Extensions`

`       `[`4.8.1`](#section-4-8-1)`. Basic Constraints`

`       `[`4.8.2`](#section-4-8-2)`. Subject Key Identifier`

`       `[`4.8.3`](#section-4-8-3)`. Authority Key Identifier`

`       `[`4.8.4`](#section-4-8-4)`. Key Usage`

`       `[`4.8.5`](#section-4-8-5)`. Extended Key Usage`

`       `[`4.8.6`](#section-4-8-6)`. CRL Distribution Points`

`       `[`4.8.7`](#section-4-8-7)`. Authority Information Access`

`       `[`4.8.8`](#section-4-8-8)`. Subject Information Access`

`       `[`4.8.9`](#section-4-8-9)`. Certificate Policies`

`       `[`4.8.10`](#section-4-8-10)`. IP Resources`

`       `[`4.8.11`](#section-4-8-11)`. AS Resources`

`   `[`5`](#section-5)`. Resource Certificate Revocation Lists`

`   `[`6`](#section-6)`. Resource Certificate Requests`

`     `[`6.1`](#section-6-1)`. PCKS#10 Profile`

`       `[`6.1.1`](#section-6-1-1)`. PKCS#10 Resource Certificate Request Template Fields`

`     `[`6.2`](#section-6-2)`. CRMF Profile`

`       `[`6.2.1`](#section-6-2-1)`. CRMF Resource Certificate Request Template Fields  .`

`       `[`6.2.2`](#section-6-2-2)`. Resource Certificate Request Control Fields`

`     `[`6.3`](#section-6-3)`. Certificate Extension Attributes in Certificate Requests`

`   `[`7`](#section-7)`. Resource Certificate Validation`

`     `[`7.1`](#section-7-1)`. Resource Extension Validation`

`     `[`7.2`](#section-7-2)`. Resource Certification Path Validation`

`   `[`8`](#section-8)`. Design Notes`

`   `[`9`](#section-9)`. Operational Considerations for Profile Agility`
...
<a id="section-2"></a> **`2. Describing Resources in Certificates`**
...
<a id="section-3"></a> **`3. End-Entity (EE) Certificates and Signing Functions in the RPKI`**
...
<a id="section-4"></a> **`4. Resource Certificates`**
...
<a id="section-4-1"></a> **`4.1. Version`**
...
<a id="section-4-2"></a> **`4.2. Serial Number`**
...
<a id="section-4-3"></a> **`4.3. Signature Algorithm`**
...
<a id="section-4-5"></a> **`4.5. Subject`**
...
<a id="section-4-6"></a> **`4.6. Validity`**
...
<a id="section-4-6-1"></a> **`4.6.1. notBefore`**
...
<a id="section-4-6-2"></a> **`4.6.2. notAfter`**
...
<a id="section-4-7"></a> **`4.7. Subject Public Key Info`**
...
<a id="section-4-8"></a> **`4.8. Resource Certificate Extensions`**
...
<a id="section-4-8-1"></a> **`4.8.1. Basic Constraints`**
...
<a id="section-4-8-2"></a> **`4.8.2. Subject Key Identifier`**
...
<a id="section-4-8-3"></a> **`4.8.3. Authority Key Identifier`**
...
<a id="section-4-8-4"></a> **`4.8.4. Key Usage`**
...
<a id="section-4-8-5"></a> **`4.8.5. Extended Key Usage`**
...
<a id="section-4-8-6"></a> **`4.8.6. CRL Distribution Points`**
...
<a id="section-4-8-7"></a> **`4.8.7. Authority Information Access`**
...
<a id="section-4-8-8"></a> **`4.8.8. Subject Information Access`**
...
<a id="section-4-8-8-1"></a> **`4.8.8.1. SIA for CA Certificates`**
...
<a id="section-4-8-8-2"></a> **`4.8.8.2. SIA for EE Certificates`**
...
<a id="section-4-8-9"></a> **`4.8.9. Certificate Policies`**
...
<a id="section-4-8-10"></a> **`4.8.10. IP Resources`**
...
<a id="section-4-8-11"></a> **`4.8.11. AS Resources`**
...
<a id="section-5"></a> **`5. Resource Certificate Revocation Lists`**
...
<a id="section-6"></a> **`6. Resource Certificate Requests`**
...
<a id="section-6-1"></a> **`6.1. PCKS#10 Profile`**
...
<a id="section-6-1-1"></a> **`6.1.1. PKCS#10 Resource Certificate Request Template Fields`**
...
<a id="section-6-2"></a> **`6.2. CRMF Profile`**
...
<a id="section-6-2-1"></a> **`6.2.1. CRMF Resource Certificate Request Template Fields`**
...
<a id="section-6-2-2"></a> **`6.2.2. Resource Certificate Request Control Fields`**
...
<a id="section-6-3"></a> **`6.3. Certificate Extension Attributes in Certificate Requests`**
...
<a id="section-7"></a> **`7. Resource Certificate Validation`**
...
<a id="section-7-1"></a> **`7.1. Resource Extension Validation`**
...
<a id="section-7-2"></a> **`7.2. Resource Certification Path Validation`**
...
<a id="section-8"></a> **`8. Design Notes`**
...
<a id="section-9"></a> **`9. Operational Considerations for Profile Agility`**
