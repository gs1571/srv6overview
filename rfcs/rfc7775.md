...
`   `[`2`](#section-2)`. Use of the Up/Down Bit in Level 2 LSPs`

`   `[`3`](#section-3)`. Types of Routes in IS-IS Supported by Extended Reachability`

`       TLVs`

`     `[`3.1`](#section-3-1)`. Types of Routes Supported by TLVs 135 and 235`

`     `[`3.2`](#section-3-2)`. Types of Routes Supported by TLVs 236 and 237`

`     `[`3.3`](#section-3-3)`. Order of Preference for All Types of Routes Supported by`

`           TLVs 135 and 235`

`     `[`3.4`](#section-3-4)`. Order of Preference for All Types of Routes Supported by`
...
<a id="section-2"></a> **`2. Use of the Up/Down Bit in Level 2 LSPs`**
...
<a id="section-3"></a> **`3. Types of Routes in IS-IS Supported by Extended Reachability TLVs`**
...
<a id="section-3-1"></a> **`3.1. Types of Routes Supported by TLVs 135 and 235`**
...
<a id="section-3-2"></a> **`3.2. Types of Routes Supported by TLVs 236 and 237`**
...
<a id="section-3-3"></a> **`3.3. Order of Preference for All Types of Routes Supported by TLVs 135`**
...
<a id="section-3-4"></a> **`3.4. Order of Preference for All Types of Routes Supported by TLVs 236`**
