...
`   `[`3`](#section-3)`. Encapsulation in IP`

`   `[`4`](#section-4)`. Encapsulation in GRE`

`   `[`5`](#section-5)`. Common Procedures`

`       `[`5.1`](#section-5-1)`. Preventing Fragmentation and Reassembly`

`       `[`5.2`](#section-5-2)`. TTL or Hop Limit`

`       `[`5.3`](#section-5-3)`. Differentiated Services`
...
`       `[`8.1`](#section-8-1)`. Securing the Tunnel with IPsec`

`       `[`8.2`](#section-8-2)`. In the Absence of IPsec`
...
<a id="section-3"></a> **`3. Encapsulation in IP`**
...
<a id="section-4"></a> **`4. Encapsulation in GRE`**
...
<a id="section-5"></a> **`5. Common Procedures`**
...
<a id="section-5-1"></a> **`5.1. Preventing Fragmentation and Reassembly`**
...
<a id="section-5-2"></a> **`5.2. TTL or Hop Limit`**
...
<a id="section-5-3"></a> **`5.3. Differentiated Services`**
...
<a id="section-8-1"></a> **`8.1. Securing the Tunnel with IPsec`**
...
<a id="section-8-2"></a> **`8.2. In the Absence of IPsec`**
