...
`      `[`1.2`](#section-1-2)`. Wildcards in S-PMSI A-D Routes`

`      `[`1.3`](#section-1-3)`. Use Cases`

`   `[`2`](#section-2)`. Encoding of Wildcards`

`   `[`3`](#section-3)`. Finding the Matching S-PMSI A-D Route`

`      `[`3.1`](#section-3-1)`. Finding the Match for Data Transmission`

`      `[`3.2`](#section-3-2)`. Finding the Match for Data Reception`

`           `[`3.2.1`](#section-3-2-1)`. Finding the Match for (C-S,C-G)`

`           `[`3.2.2`](#section-3-2-2)`. Finding the Wildcard Match for (C-*,C-G)`

`   `[`4`](#section-4)`. Procedures for S-PMSI A-D Routes with Wildcards`

`      `[`4.1`](#section-4-1)`. Procedures for All Kinds of Wildcards`

`      `[`4.2`](#section-4-2)`. Procedures for (C-*,C-G) S-PMSI A-D Routes`

`      `[`4.3`](#section-4-3)`. Procedures for (C-S,C-*) S-PMSI A-D Routes`

`      `[`4.4`](#section-4-4)`. Procedures for (C-*,C-*) S-PMSI A-D Routes`
...
<a id="section-1-2"></a> **`1.2. Wildcards in S-PMSI A-D Routes`**
...
<a id="section-1-3"></a> **`1.3. Use Cases`**
...
<a id="section-2"></a> **`2. Encoding of Wildcards`**
...
<a id="section-3"></a> **`3. Finding the Matching S-PMSI A-D Route`**
...
<a id="section-3-1"></a> **`3.1. Finding the Match for Data Transmission`**
...
<a id="section-3-2"></a> **`3.2. Finding the Match for Data Reception`**
...
<a id="section-3-2-1"></a> **`3.2.1. Finding the Match for (C-S,C-G)`**
...
<a id="section-3-2-2"></a> **`3.2.2. Finding the Wildcard Match for (C-*,C-G)`**
...
<a id="section-4"></a> **`4. Procedures for S-PMSI A-D Routes with Wildcards`**

```text

```

<a id="section-4-1"></a> **`4.1. Procedures for All Kinds of Wildcards`**
...
<a id="section-4-2"></a> **`4.2. Procedures for (C-*,C-G) S-PMSI A-D Routes`**
...
<a id="section-4-3"></a> **`4.3. Procedures for (C-S,C-*) S-PMSI A-D Routes`**
...
<a id="section-4-4"></a> **`4.4. Procedures for (C-*,C-*) S-PMSI A-D Routes`**
