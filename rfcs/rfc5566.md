...
`   `[`2`](#section-2)`. Tunnel Encapsulation Types`

`   `[`3`](#section-3)`. Use of IPsec Tunnel Types`

`   `[`4`](#section-4)`. IPsec Tunnel Authenticator sub-TLV`

`      `[`4.1`](#section-4-1)`. Use of the IPsec Tunnel Authenticator sub-TLV`
...
<a id="section-2"></a> **`2. Tunnel Encapsulation Types`**
...
<a id="section-3"></a> **`3. Use of IPsec Tunnel Types`**
...
<a id="section-4"></a> **`4. IPsec Tunnel Authenticator sub-TLV`**
...
<a id="section-4-1"></a> **`4.1. Use of the IPsec Tunnel Authenticator sub-TLV`**
