...
`   `[`2`](#section-2)`. Security Implications of the Generation of IPv6 Atomic`

`      Fragments`

`   `[`3`](#section-3)`. Additional Considerations`
...
<a id="section-2"></a> **`2. Security Implications of the Generation of IPv6 Atomic Fragments`**
...
<a id="section-3"></a> **`3. Additional Considerations`**
