...
`    `[`4`](#section-4)`. Special Characteristics of ATM Switches`

`    `[`5`](#section-5)`. Label Switching Control Component for ATM`

`    `[`6`](#section-6)`. Hybrid Switches (Ships in the Night)`

`    `[`7`](#section-7)`. Use of  VPI/VCIs`

`    `[`7.1`](#section-7-1)`. Direct Connections`

`    `[`7.2`](#section-7-2)`. Connections via an ATM VP`

`    `[`7.3`](#section-7-3)`. Connections via an ATM SVC`

`    `[`8`](#section-8)`. Label Distribution and Maintenance Procedures`

`    `[`8.1`](#section-8-1)`. Edge LSR Behavior`

`    `[`8.2`](#section-8-2)`. Conventional ATM Switches (non-VC-merge)`

`    `[`8.3`](#section-8-3)`. VC-merge-capable ATM Switches`

`    `[`9`](#section-9)`. Encapsulation`

`   `[`10`](#section-10)`. TTL Manipulation`

`   `[`11`](#section-11)`. Optional Loop Detection: Distributing Path Vectors`

`   `[`11.1`](#section-11-1)`. When to Send Path Vectors Downstream`

`   `[`11.2`](#section-11-2)`. When to Send Path Vectors Upstream`
...
<a id="section-4"></a> **`4. Special Characteristics of ATM Switches`**
...
<a id="section-5"></a> **`5. Label Switching Control Component for ATM`**
...
<a id="section-6"></a> **`6. Hybrid Switches (Ships in the Night)`**
...
<a id="section-7"></a> **`7. Use of  VPI/VCIs`**
...
<a id="section-7-1"></a> **`7.1. Direct Connections`**
...
<a id="section-7-2"></a> **`7.2. Connections via an ATM VP`**
...
<a id="section-7-3"></a> **`7.3. Connections via an ATM SVC`**
...
<a id="section-8"></a> **`8. Label Distribution and Maintenance Procedures`**
...
<a id="section-8-1"></a> **`8.1. Edge LSR Behavior`**
...
<a id="section-8-2"></a> **`8.2. Conventional ATM Switches (non-VC-merge)`**
...
<a id="section-8-3"></a> **`8.3. VC-merge-capable ATM Switches`**
...
<a id="section-9"></a> **`9. Encapsulation`**
...
<a id="section-10"></a> **`10. TTL Manipulation`**
...
<a id="section-11"></a> **`11. Optional Loop Detection: Distributing Path Vectors`**
...
<a id="section-11-1"></a> **`11.1. When to Send Path Vectors Downstream`**
...
<a id="section-11-2"></a> **`11.2. When to Send Path Vectors Upstream`**
