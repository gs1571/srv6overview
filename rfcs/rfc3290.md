...
`   `[`3`](#section-3)`. 1 Components of a Diffserv Router`

`   `[`3.1`](#section-3-1)`. 1 Datapath`

`   `[`3.1`](#section-3-1)`. 2 Configuration and Management Interface`

`   `[`3.1`](#section-3-1)`. 3 Optional QoS Agent Module`

`   `[`3`](#section-3)`. 2 Diffserv Functions at Ingress and Egress`

`   `[`3`](#section-3)`. 3 Shaping and Policing`

`   `[`3`](#section-3)`. 4 Hierarchical View of the Model`

`   4 Classifiers`

`   `[`4`](#section-4)`. 1 Definition`

`   `[`4.1`](#section-4-1)`. 1 Filters`

`   `[`4.1`](#section-4-1)`. 2 Overlapping Filters`

`   `[`4`](#section-4)`. 2 Examples`

`   `[`4.2`](#section-4-2)`. 1 Behavior Aggregate (BA) Classifier`

`   `[`4.2`](#section-4-2)`. 2 Multi-Field (MF) Classifier`

`   `[`4.2`](#section-4-2)`. 3 Free-form Classifier`

`   `[`4.2`](#section-4-2)`. 4 Other Possible Classifiers`

`   5 Meters`

`   `[`5`](#section-5)`. 1 Examples`

`   `[`5.1`](#section-5-1)`. 1 Average Rate Meter`

`   `[`5.1`](#section-5-1)`. 2 Exponential Weighted Moving Average (EWMA) Meter`

`   `[`5.1`](#section-5-1)`. 3 Two-Parameter Token Bucket Meter`

`   `[`5.1`](#section-5-1)`. 4 Multi-Stage Token Bucket Meter`

`   `[`5.1`](#section-5-1)`. 5 Null Meter`

`   6 Action Elements`

`   `[`6`](#section-6)`. 1 DSCP Marker`

`   `[`6`](#section-6)`. 2 Absolute Dropper`

`   `[`6`](#section-6)`. 3 Multiplexor`

`   `[`6`](#section-6)`. 4 Counter`

`   `[`6`](#section-6)`. 5 Null Action`

`   7 Queuing Elements`

`   `[`7`](#section-7)`. 1 Queuing Model`

`   `[`7.1`](#section-7-1)`. 1 FIFO Queue`

`   `[`7.1`](#section-7-1)`. 2 Scheduler`

`   `[`7.1`](#section-7-1)`. 3 Algorithmic Dropper`

`   `[`7`](#section-7)`. 2 Sharing load among traffic streams using queuing`

`   `[`7.2`](#section-7-2)`. 1 Load Sharing`

`   `[`7.2`](#section-7-2)`. 2 Traffic Priority`

`   8 Traffic Conditioning Blocks (TCBs)`

`   `[`8`](#section-8)`. 1 TCB`

`   `[`8.1`](#section-8-1)`. 1 Building blocks for Queuing`

`   `[`8`](#section-8)`. 2 An Example TCB`

`   `[`8`](#section-8)`. 3 An Example TCB to Support Multiple Customers`

`   `[`8`](#section-8)`. 4 TCBs Supporting Microflow-based Services`

`   `[`8`](#section-8)`. 5 Cascaded TCBs`
...
<a id="section-3"></a> **`3. Conceptual Model`**
...
<a id="section-3-1"></a> **`3.1. Components of a Diffserv Router`**
...
<a id="section-3-1-1"></a> **`3.1.1. Datapath`**
...
<a id="section-3-1-2"></a> **`3.1.2. Configuration and Management Interface`**
...
<a id="section-3-1-3"></a> **`3.1.3. Optional QoS Agent Module`**
...
<a id="section-3-2"></a> **`3.2. Diffserv Functions at Ingress and Egress`**
...
<a id="section-3-3"></a> **`3.3. Shaping and Policing`**
...
<a id="section-3-4"></a> **`3.4. Hierarchical View of the Model`**
...
<a id="section-4"></a> **`4. Classifiers`**

```text

```

<a id="section-4-1"></a> **`4.1. Definition`**
...
<a id="section-4-1-1"></a> **`4.1.1. Filters`**
...
<a id="section-4-1-2"></a> **`4.1.2. Overlapping Filters`**
...
<a id="section-4-2-1"></a> **`4.2.1. Behavior Aggregate (BA) Classifier`**
...
<a id="section-4-2-2"></a> **`4.2.2. Multi-Field (MF) Classifier`**
...
<a id="section-4-2-3"></a> **`4.2.3. Free-form Classifier`**
...
<a id="section-4-2-4"></a> **`4.2.4. Other Possible Classifiers`**
...
<a id="section-5-1"></a> **`5.1. Examples`**
...
<a id="section-5-1-1"></a> **`5.1.1. Average Rate Meter`**
...
<a id="section-5-1-2"></a> **`5.1.2. Exponential Weighted Moving Average (EWMA) Meter`**
...
<a id="section-5-1-3"></a> **`5.1.3. Two-Parameter Token Bucket Meter`**
...
<a id="section-5-1-4"></a> **`5.1.4. Multi-Stage Token Bucket Meter`**
...
<a id="section-5-1-5"></a> **`5.1.5. Null Meter`**
...
<a id="section-6"></a> **`6. Action Elements`**
...
<a id="section-6-1"></a> **`6.1. DSCP Marker`**
...
<a id="section-6-2"></a> **`6.2. Absolute Dropper`**
...
<a id="section-6-3"></a> **`6.3. Multiplexor`**
...
<a id="section-6-4"></a> **`6.4. Counter`**
...
<a id="section-6-5"></a> **`6.5. Null Action`**
...
<a id="section-7"></a> **`7. Queuing Elements`**
...
<a id="section-7-1"></a> **`7.1. Queuing Model`**
...
<a id="section-7-1-1"></a> **`7.1.1. FIFO Queue`**
...
<a id="section-7-1-2"></a> **`7.1.2. Scheduler`**
...
<a id="section-7-1-3"></a> **`7.1.3. Algorithmic Dropper`**
...
<a id="section-7-2"></a> **`7.2. Sharing load among traffic streams using queuing`**
...
<a id="section-7-2-1"></a> **`7.2.1. Load Sharing`**
...
<a id="section-7-2-2"></a> **`7.2.2. Traffic Priority`**
...
<a id="section-8"></a> **`8. Traffic Conditioning Blocks (TCBs)`**
...
<a id="section-8-1-1"></a> **`8.1.1. Building blocks for Queuing`**
...
<a id="section-8-2"></a> **`8.2. An Example TCB`**
...
<a id="section-8-3"></a> **`8.3. An Example TCB to Support Multiple Customers`**
...
<a id="section-8-4"></a> **`8.4. TCBs Supporting Microflow-based Services`**
...
<a id="section-8-5"></a> **`8.5. Cascaded TCBs`**
