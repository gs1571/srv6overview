...
`   `[`2`](#section-2)`. Constraint-based Routing Overview`

`   `[`2`](#section-2)`. 1 Strict and Loose Explicit Routes`

`   `[`2`](#section-2)`. 2 Traffic Characteristics`

`   `[`2`](#section-2)`. 3 Preemption`

`   `[`2`](#section-2)`. 4 Route Pinning`

`   `[`2`](#section-2)`. 5 Resource Class`

`   `[`3`](#section-3)`. Solution Overview`

`   `[`3`](#section-3)`. 1 Required Messages and TLVs`

`   `[`3`](#section-3)`. 2 Label Request Message`

`   `[`3`](#section-3)`. 3 Label Mapping Message`

`   `[`3`](#section-3)`. 4 Notification Message`

`   `[`3`](#section-3)`. 5 Release , Withdraw, and Abort Messages`

`   `[`4`](#section-4)`. Protocol Specification`

`   `[`4`](#section-4)`. 1 Explicit Route TLV (ER-TLV)`

`   `[`4`](#section-4)`. 2 Explicit Route Hop TLV (ER-Hop TLV)`

`   `[`4`](#section-4)`. 3 Traffic Parameters TLV`

`   `[`4.3`](#section-4-3)`. 1 Semantics`

`   `[`4.3.1`](#section-4-3-1)`. 1 Frequency`

`   `[`4.3.1`](#section-4-3-1)`. 2 Peak Rate`

`   `[`4.3.1`](#section-4-3-1)`. 3 Committed Rate`

`   `[`4.3.1`](#section-4-3-1)`. 4 Excess Burst Size`

`   `[`4.3.1`](#section-4-3-1)`. 5 Peak Rate Token Bucket`

`   `[`4.3.1`](#section-4-3-1)`. 6 Committed Data Rate Token Bucket`

`   `[`4.3.1`](#section-4-3-1)`. 7 Weight`

`   `[`4.3`](#section-4-3)`. 2 Procedures`

`   `[`4.3.2`](#section-4-3-2)`. 1 Label Request Message`

`   `[`4.3.2`](#section-4-3-2)`. 2 Label Mapping Message`

`   `[`4.3.2`](#section-4-3-2)`. 3 Notification Message`

`   `[`4`](#section-4)`. 4 Preemption TLV`

`   `[`4`](#section-4)`. 5 LSPID TLV`

`   `[`4`](#section-4)`. 6 Resource Class (Color) TLV`

`   `[`4`](#section-4)`. 7 ER-Hop semantics`

`   `[`4.7.1`](#section-4-7-1)`. ER-Hop 1: The IPv4 prefix`

`   `[`4.7.2`](#section-4-7-2)`. ER-Hop 2: The IPv6 address`

`   `[`4.7.3`](#section-4-7-3)`. ER-Hop 3:  The autonomous system number`

`   `[`4.7.4`](#section-4-7-4)`. ER-Hop 4: LSPID`

`   `[`4.8`](#section-4-8)`. Processing of the Explicit Route TLV`

`   `[`4.8.1`](#section-4-8-1)`. Selection of the next hop`

`   `[`4.8.2`](#section-4-8-2)`. Adding ER-Hops to the explicit route TLV`

`   `[`4`](#section-4)`. 9 Route Pinning TLV`

`   `[`4`](#section-4)`. 10 CR-LSP FEC Element`

`   `[`5`](#section-5)`. IANA Considerations`

`   `[`5`](#section-5)`. 1 TLV Type Name Space`

`   `[`5`](#section-5)`. 2 FEC Type Name Space`

`   `[`5`](#section-5)`. 3 Status Code Space`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Acknowledgments`

`   `[`8`](#section-8)`. Intellectual Property Consideration`
...
<a id="section-2"></a> **`2. Constraint-based Routing Overview`**
...
<a id="section-3"></a> **`3. Solution Overview`**
...
<a id="section-4-7-1"></a> **`4.7.1. ER-Hop 1: The IPv4 prefix`**
...
<a id="section-4-7-2"></a> **`4.7.2. ER-Hop 2: The IPv6 address`**
...
<a id="section-4-7-3"></a> **`4.7.3. ER-Hop 3:  The autonomous system number`**
...
<a id="section-4-7-4"></a> **`4.7.4. ER-Hop 4: LSPID`**
...
<a id="section-4-8"></a> **`4.8. Processing of the Explicit Route TLV`**

```text

```

<a id="section-4-8-1"></a> **`4.8.1. Selection of the next hop`**
...
<a id="section-4-8-2"></a> **`4.8.2. Adding ER-Hops to the explicit route TLV`**
...
<a id="section-8"></a> **`8. Intellectual Property Consideration`**
...
A.1 Strict Explicit Route Example
   ...
   place:
      ...
      4. LSR2 determines that it is topologically adjacent to the
         ...
         first ER-Hop  from the ER-TLV, which now becomes <b, c>.
...
<a id="section-10"></a> **`10. Author's Addresses`**
