...
`     `[`1.2`](#section-1-2)`. OSPFv3 LSA Terminology`

`   `[`2`](#section-2)`. OSPFv3 Extended LSA Types`

`   `[`3`](#section-3)`. OSPFv3 Extended LSA TLVs`

`     `[`3.1`](#section-3-1)`. Prefix Options Extensions`

`       `[`3.1.1`](#section-3-1-1)`. N-bit Prefix Option`

`     `[`3.2`](#section-3-2)`. Router-Link TLV`

`     `[`3.3`](#section-3-3)`. Attached-Routers TLV`

`     `[`3.4`](#section-3-4)`. Inter-Area-Prefix TLV`

`     `[`3.5`](#section-3-5)`. Inter-Area-Router TLV`

`     `[`3.6`](#section-3-6)`. External-Prefix TLV`

`     `[`3.7`](#section-3-7)`. Intra-Area-Prefix TLV`

`     `[`3.8`](#section-3-8)`. IPv6 Link-Local Address TLV`

`     `[`3.9`](#section-3-9)`. IPv4 Link-Local Address TLV`

`     `[`3.10`](#section-3-10)`. IPv6-Forwarding-Address Sub-TLV`

`     `[`3.11`](#section-3-11)`. IPv4-Forwarding-Address Sub-TLV`

`     `[`3.12`](#section-3-12)`. Route-Tag Sub-TLV`

`   `[`4`](#section-4)`. OSPFv3 Extended LSAs`

`     `[`4.1`](#section-4-1)`. OSPFv3 E-Router-LSA`

`     `[`4.2`](#section-4-2)`. OSPFv3 E-Network-LSA`

`     `[`4.3`](#section-4-3)`. OSPFv3 E-Inter-Area-Prefix-LSA`

`     `[`4.4`](#section-4-4)`. OSPFv3 E-Inter-Area-Router-LSA`

`     `[`4.5`](#section-4-5)`. OSPFv3 E-AS-External-LSA`

`     `[`4.6`](#section-4-6)`. OSPFv3 E-NSSA-LSA`

`     `[`4.7`](#section-4-7)`. OSPFv3 E-Link-LSA`

`     `[`4.8`](#section-4-8)`. OSPFv3 E-Intra-Area-Prefix-LSA`

`   `[`5`](#section-5)`. Malformed OSPFv3 Extended LSA Handling`

`   `[`6`](#section-6)`. LSA Extension Backward Compatibility`

`     `[`6.1`](#section-6-1)`. Full Extended LSA Migration`

`     `[`6.2`](#section-6-2)`. Extended LSA Sparse-Mode Backward Compatibility`

`     `[`6.3`](#section-6-3)`. LSA TLV Processing Backward Compatibility`

`   `[`7`](#section-7)`. Security Considerations`

`   `[`8`](#section-8)`. IANA Considerations`

`     `[`8.1`](#section-8-1)`. OSPFv3 Extended LSA TLV Registry`

`     `[`8.2`](#section-8-2)`. OSPFv3 Extended LSA Sub-TLV Registry`
...
<a id="section-1-2"></a> **`1.2. OSPFv3 LSA Terminology`**
...
<a id="section-2"></a> **`2. OSPFv3 Extended LSA Types`**
...
<a id="section-3"></a> **`3. OSPFv3 Extended LSA TLVs`**
...
<a id="section-3-1"></a> **`3.1. Prefix Options Extensions`**
...
<a id="section-3-1-1"></a> **`3.1.1. N-bit Prefix Option`**
...
<a id="section-3-2"></a> **`3.2. Router-Link TLV`**
...
<a id="section-3-3"></a> **`3.3. Attached-Routers TLV`**
...
<a id="section-3-4"></a> **`3.4. Inter-Area-Prefix TLV`**
...
<a id="section-3-5"></a> **`3.5. Inter-Area-Router TLV`**
...
<a id="section-3-6"></a> **`3.6. External-Prefix TLV`**
...
<a id="section-3-7"></a> **`3.7. Intra-Area-Prefix TLV`**
...
<a id="section-3-8"></a> **`3.8. IPv6 Link-Local Address TLV`**
...
<a id="section-3-9"></a> **`3.9. IPv4 Link-Local Address TLV`**
...
<a id="section-3-10"></a> **`3.10. IPv6-Forwarding-Address Sub-TLV`**
...
<a id="section-3-11"></a> **`3.11. IPv4-Forwarding-Address Sub-TLV`**
...
<a id="section-3-12"></a> **`3.12. Route-Tag Sub-TLV`**
...
<a id="section-4"></a> **`4. OSPFv3 Extended LSAs`**
...
<a id="section-4-1"></a> **`4.1. OSPFv3 E-Router-LSA`**
...
<a id="section-4-2"></a> **`4.2. OSPFv3 E-Network-LSA`**
...
<a id="section-4-3"></a> **`4.3. OSPFv3 E-Inter-Area-Prefix-LSA`**
...
<a id="section-4-4"></a> **`4.4. OSPFv3 E-Inter-Area-Router-LSA`**
...
<a id="section-4-5"></a> **`4.5. OSPFv3 E-AS-External-LSA`**
...
<a id="section-4-6"></a> **`4.6. OSPFv3 E-NSSA-LSA`**
...
<a id="section-4-7"></a> **`4.7. OSPFv3 E-Link-LSA`**
...
<a id="section-4-8"></a> **`4.8. OSPFv3 E-Intra-Area-Prefix-LSA`**
...
<a id="section-5"></a> **`5. Malformed OSPFv3 Extended LSA Handling`**
...
<a id="section-6"></a> **`6. LSA Extension Backward Compatibility`**
...
<a id="section-6-1"></a> **`6.1. Full Extended LSA Migration`**
...
<a id="section-6-2"></a> **`6.2. Extended LSA Sparse-Mode Backward Compatibility`**
...
<a id="section-6-3"></a> **`6.3. LSA TLV Processing Backward Compatibility`**
...
<a id="section-8-1"></a> **`8.1. OSPFv3 Extended LSA TLV Registry`**
...
<a id="section-8-2"></a> **`8.2. OSPFv3 Extended LSA Sub-TLV Registry`**
