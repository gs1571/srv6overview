...
`      `[`1.2`](#section-1-2)`. Scope of Exclude Routes`

`      `[`1.3`](#section-1-3)`. Relationship to MPLS TE MIB`

`   `[`2`](#section-2)`. Shared Risk Link Groups`

`      `[`2.1`](#section-2-1)`. SRLG Subobject`

`   `[`3`](#section-3)`. Exclude Route List`

`      `[`3.1`](#section-3-1)`. EXCLUDE_ROUTE Object (XRO)`

`           `[`3.1.1`](#section-3-1-1)`. IPv4 Prefix Subobject`

`           `[`3.1.2`](#section-3-1-2)`. IPv6 Prefix Subobject`

`           `[`3.1.3`](#section-3-1-3)`. Unnumbered Interface ID Subobject`

`           `[`3.1.4`](#section-3-1-4)`. Autonomous System Number Subobject`

`           `[`3.1.5`](#section-3-1-5)`. SRLG Subobject`

`      `[`3.2`](#section-3-2)`. Processing Rules for the EXCLUDE_ROUTE Object (XRO)`

`   `[`4`](#section-4)`. Explicit Exclusion Route`

`      `[`4.1`](#section-4-1)`. Explicit Exclusion Route Subobject (EXRS)`

`      `[`4.2`](#section-4-2)`. Processing Rules for the Explicit Exclusion Route`

`           Subobject (EXRS)`

`   `[`5`](#section-5)`. Processing of XRO together with EXRS`

`   `[`6`](#section-6)`. Minimum Compliance`

`   `[`7`](#section-7)`. Security Considerations`

`   `[`8`](#section-8)`. IANA Considerations`

`      `[`8.1`](#section-8-1)`. New ERO Subobject Type`

`      `[`8.2`](#section-8-2)`. New RSVP-TE Class Numbers`

`      `[`8.3`](#section-8-3)`. New Error Codes`
...
<a id="section-1-2"></a> **`1.2. Scope of Exclude Routes`**
...
<a id="section-1-3"></a> **`1.3. Relationship to MPLS TE MIB`**
...
<a id="section-2"></a> **`2. Shared Risk Link Groups`**
...
<a id="section-2-1"></a> **`2.1. SRLG Subobject`**
...
<a id="section-3"></a> **`3. Exclude Route List`**
...
<a id="section-3-1"></a> **`3.1. EXCLUDE_ROUTE Object (XRO)`**
...
<a id="section-3-1-1"></a> **`3.1.1. IPv4 Prefix Subobject`**
...
<a id="section-3-1-2"></a> **`3.1.2. IPv6 Prefix Subobject`**
...
<a id="section-3-1-3"></a> **`3.1.3. Unnumbered Interface ID Subobject`**
...
<a id="section-3-1-4"></a> **`3.1.4. Autonomous System Number Subobject`**
...
<a id="section-3-1-5"></a> **`3.1.5. SRLG Subobject`**
...
<a id="section-3-2"></a> **`3.2. Processing Rules for the EXCLUDE_ROUTE Object (XRO)`**
...
<a id="section-4"></a> **`4. Explicit Exclusion Route`**
...
<a id="section-4-1"></a> **`4.1. Explicit Exclusion Route Subobject (EXRS)`**
...
<a id="section-4-2"></a> **`4.2. Processing Rules for the Explicit Exclusion Route Subobject (EXRS)`**
...
<a id="section-5"></a> **`5. Processing of XRO together with EXRS`**
...
<a id="section-6"></a> **`6. Minimum Compliance`**
...
<a id="section-8-1"></a> **`8.1. New ERO Subobject Type`**
...
<a id="section-8-2"></a> **`8.2. New RSVP-TE Class Numbers`**
...
<a id="section-8-3"></a> **`8.3. New Error Codes`**
