...
`   `[`2`](#section-2)`. Algorithm and Mode`

`      `[`2.1`](#section-2-1)`. Key Size Discussion`

`   `[`3`](#section-3)`. Performance`

`   `[`4`](#section-4)`. Interaction with the ESP Cipher Mechanism`

`   `[`5`](#section-5)`. Key Management Considerations`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Eavesdropping`

`      `[`6.2`](#section-6-2)`. Replay`

`      `[`6.3`](#section-6-3)`. Message Insertion`

`      `[`6.4`](#section-6-4)`. Deletion`

`      `[`6.5`](#section-6-5)`. Modification`

`      `[`6.6`](#section-6-6)`. Man in the Middle`

`      `[`6.7`](#section-6-7)`. Denial of Service`
...
<a id="section-2"></a> **`2. Algorithm and Mode`**
...
<a id="section-2-1"></a> **`2.1. Key Size Discussion`**
...
<a id="section-3"></a> **`3. Performance`**
...
<a id="section-4"></a> **`4. Interaction with the ESP Cipher Mechanism`**
...
<a id="section-5"></a> **`5. Key Management Considerations`**
...
<a id="section-6-1"></a> **`6.1. Eavesdropping`**
...
<a id="section-6-3"></a> **`6.3. Message Insertion`**
...
<a id="section-6-4"></a> **`6.4. Deletion`**
...
<a id="section-6-5"></a> **`6.5. Modification`**
...
<a id="section-6-6"></a> **`6.6. Man in the Middle`**
...
<a id="section-6-7"></a> **`6.7. Denial of Service`**
