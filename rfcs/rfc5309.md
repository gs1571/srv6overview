...
<a id="section-3"></a> **`3. IP Multi-Access Subnets`**
...
<a id="section-4"></a> **`4. Point-to-Point Connection over LAN Media`**
...
<a id="section-4-1"></a> **`4.1. Operation of IS-IS`**
...
<a id="section-4-2"></a> **`4.2. Operation of OSPF and OSPFv3`**
...
<a id="section-4-3"></a> **`4.3. ARP and ND`**
...
<a id="section-4-4"></a> **`4.4. Other MAC Address Resolution Mechanisms`**
...
<a id="section-4-5"></a> **`4.5. Detection of Misconfiguration`**
