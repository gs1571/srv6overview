...
`   `[`2`](#section-2)`. OSPFv2 Instance Packet Encoding`

`   `[`3`](#section-3)`. OSPFv2 Interface Instance ID`

`      `[`3.1`](#section-3-1)`. Sending and Receiving OSPFv2 Packets`

`      `[`3.2`](#section-3-2)`. Interface Instance ID Values`

`   `[`4`](#section-4)`. State Sharing Optimizations between OSPFv2 Instances`

`   `[`5`](#section-5)`. OSPFv2 Authentication Impacts`

`   `[`6`](#section-6)`. Backward Compatibility and Deployment Considerations`
...
<a id="section-2"></a> **`2. OSPFv2 Instance Packet Encoding`**
...
<a id="section-3"></a> **`3. OSPFv2 Interface Instance ID`**
...
<a id="section-3-1"></a> **`3.1. Sending and Receiving OSPFv2 Packets`**
...
<a id="section-3-2"></a> **`3.2. Interface Instance ID Values`**
...
<a id="section-4"></a> **`4. State-Sharing Optimizations between OSPFv2 Instances`**
...
<a id="section-5"></a> **`5. OSPFv2 Authentication Impacts`**
...
<a id="section-6"></a> **`6. Backward Compatibility and Deployment Considerations`**
