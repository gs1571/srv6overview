...
`        `[`1.1`](#section-1-1)`. Pseudo Wire Definition`

`        `[`1.2`](#section-1-2)`. PW Service Functionality`

`        `[`1.3`](#section-1-3)`. Non-Goals of This Document`

`        `[`1.4`](#section-1-4)`. Terminology`

`   `[`2`](#section-2)`. PWE3 Applicability`

`   `[`3`](#section-3)`. Protocol Layering Model`

`        `[`3.1`](#section-3-1)`. Protocol Layers`

`        `[`3.2`](#section-3-2)`. Domain of PWE3`

`        `[`3.3`](#section-3-3)`. Payload Types`

`   `[`4`](#section-4)`. Architecture of Pseudo Wires`

`        `[`4.1`](#section-4-1)`. Network Reference Model`

`        `[`4.2`](#section-4-2)`. PWE3 Pre-processing`

`        `[`4.3`](#section-4-3)`. Maintenance Reference Model`

`        `[`4.4`](#section-4-4)`. Protocol Stack Reference Model`

`        `[`4.5`](#section-4-5)`. Pre-processing Extension to Protocol Stack Reference`

`              Model`

`   `[`5`](#section-5)`. PW Encapsulation`

`        `[`5.1`](#section-5-1)`. Payload Convergence Layer`

`        `[`5.2`](#section-5-2)`. Payload-independent PW Encapsulation Layers`

`        `[`5.3`](#section-5-3)`. Fragmentation`

`        `[`5.4`](#section-5-4)`. Instantiation of the Protocol Layers`

`   `[`6`](#section-6)`. PW Demultiplexer Layer and PSN Requirements`

`        `[`6.1`](#section-6-1)`. Multiplexing`

`        `[`6.2`](#section-6-2)`. Fragmentation`

`        `[`6.3`](#section-6-3)`. Length and Delivery`

`        `[`6.4`](#section-6-4)`. PW-PDU Validation`

`        `[`6.5`](#section-6-5)`. Congestion Considerations`

`   `[`7`](#section-7)`. Control Plane`

`        `[`7.1`](#section-7-1)`. Set-up or Teardown of Pseudo Wires`

`        `[`7.2`](#section-7-2)`. Status Monitoring`

`        `[`7.3`](#section-7-3)`. Notification of Pseudo Wire Status Changes`

`        `[`7.4`](#section-7-4)`. Keep-alive`

`        `[`7.5`](#section-7-5)`. Handling Control Messages of the Native Services`

`   `[`8`](#section-8)`. Management and Monitoring`

`        `[`8.1`](#section-8-1)`. Status and Statistics`

`        `[`8.2`](#section-8-2)`. PW SNMP MIB Architecture`

`        `[`8.3`](#section-8-3)`. Connection Verification and Traceroute`
...
`   `[`13`](#section-13)`. Co-Authors`

`   `[`14`](#section-14)`. Editors' Addresses`
...
<a id="section-1-1"></a> **`1.1. Pseudo Wire Definition`**
...
<a id="section-1-2"></a> **`1.2. PW Service Functionality`**
...
<a id="section-1-3"></a> **`1.3. Non-Goals of This Document`**
...
<a id="section-2"></a> **`2. PWE3 Applicability`**
...
<a id="section-3"></a> **`3. Protocol Layering Model`**
...
<a id="section-3-1"></a> **`3.1. Protocol Layers`**
...
<a id="section-3-2"></a> **`3.2. Domain of PWE3`**
...
<a id="section-3-3"></a> **`3.3. Payload Types`**
...
<a id="section-3-3-1"></a> **`3.3.1. Packet Payload`**
...
<a id="section-3-3-2"></a> **`3.3.2. Cell Payload`**
...
<a id="section-3-3-3"></a> **`3.3.3. Bit Stream`**
...
<a id="section-3-3-4"></a> **`3.3.4. Structured Bit Stream`**
...
<a id="section-3-3-5"></a> **`3.3.5. Principle of Minimum Intervention`**
...
<a id="section-4"></a> **`4. Architecture of Pseudo Wires`**
...
<a id="section-4-1"></a> **`4.1. Network Reference Model`**
...
<a id="section-4-2"></a> **`4.2. PWE3 Pre-processing`**
...
<a id="section-4-2-1"></a> **`4.2.1. Forwarders`**
...
<a id="section-4-2-2"></a> **`4.2.2. Native Service Processing`**
...
<a id="section-4-3"></a> **`4.3. Maintenance Reference Model`**
...
<a id="section-4-4"></a> **`4.4. Protocol Stack Reference Model`**
...
<a id="section-4-5"></a> **`4.5. Pre-processing Extension to Protocol Stack Reference Model`**
...
<a id="section-5"></a> **`5. PW Encapsulation`**
...
<a id="section-5-1"></a> **`5.1. Payload Convergence Layer`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. Encapsulation`**
...
<a id="section-5-1-2"></a> **`5.1.2. PWE3 Channel Types`**
...
<a id="section-5-1-3"></a> **`5.1.3. Quality of Service Considerations`**
...
<a id="section-5-2"></a> **`5.2. Payload-Independent PW Encapsulation Layers`**
...
<a id="section-5-2-1"></a> **`5.2.1. Sequencing`**
...
<a id="section-5-2-1-1"></a> **`5.2.1.1. Frame Ordering`**
...
<a id="section-5-2-1-2"></a> **`5.2.1.2. Frame Duplication Detection`**
...
<a id="section-5-2-1-3"></a> **`5.2.1.3. Frame Loss Detection`**
...
<a id="section-5-2-2"></a> **`5.2.2. Timing`**
...
<a id="section-5-2-2-1"></a> **`5.2.2.1. Clock Recovery`**
...
<a id="section-5-2-2-2"></a> **`5.2.2.2. Timed Delivery`**
...
<a id="section-5-4"></a> **`5.4. Instantiation of the Protocol Layers`**
...
<a id="section-5-4-1"></a> **`5.4.1. PWE3 over an IP PSN`**
...
<a id="section-5-4-2"></a> **`5.4.2. PWE3 over an MPLS PSN`**
...
<a id="section-5-4-3"></a> **`5.4.3. PW-IP Packet Discrimination`**
...
<a id="section-6"></a> **`6. PW Demultiplexer Layer and PSN Requirements`**
...
<a id="section-6-1"></a> **`6.1. Multiplexing`**
...
<a id="section-6-2"></a> **`6.2. Fragmentation`**
...
<a id="section-6-3"></a> **`6.3. Length and Delivery`**
...
<a id="section-6-4"></a> **`6.4. PW-PDU Validation`**
...
<a id="section-6-5"></a> **`6.5. Congestion Considerations`**
...
<a id="section-7"></a> **`7. Control Plane`**
...
<a id="section-7-1"></a> **`7.1. Setup or Teardown of Pseudo Wires`**
...
<a id="section-7-2"></a> **`7.2. Status Monitoring`**
...
<a id="section-7-3"></a> **`7.3. Notification of Pseudo Wire Status Changes`**

```text

```

<a id="section-7-3-1"></a> **`7.3.1. Pseudo Wire Up/Down Notification`**
...
<a id="section-7-3-2"></a> **`7.3.2. Misconnection and Payload Type Mismatch`**
...
<a id="section-7-3-3"></a> **`7.3.3. Packet Loss, Corruption, and Out-of-Order Delivery`**
...
<a id="section-7-3-4"></a> **`7.3.4. Other Status Notification`**
...
<a id="section-7-3-5"></a> **`7.3.5. Collective Status Notification`**
...
<a id="section-7-4"></a> **`7.4. Keep-Alive`**
...
<a id="section-7-5"></a> **`7.5. Handling Control Messages of the Native Services`**
...
<a id="section-8"></a> **`8. Management and Monitoring`**
...
<a id="section-8-1"></a> **`8.1. Status and Statistics`**
...
<a id="section-8-2"></a> **`8.2. PW SNMP MIB Architecture`**
...
<a id="section-8-2-1"></a> **`8.2.1. MIB Layering`**
...
<a id="section-8-2-2"></a> **`8.2.2. Service Layer MIB Modules`**
...
<a id="section-8-2-3"></a> **`8.2.3. Generic PW MIB Modules`**
...
<a id="section-8-2-4"></a> **`8.2.4. PSN VC Layer MIB Modules`**
...
<a id="section-8-3"></a> **`8.3. Connection Verification and Traceroute`**
...
<a id="section-13"></a> **`13. Co-Authors`**
...
<a id="section-14"></a> **`14. Editors' Addresses`**
