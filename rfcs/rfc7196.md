...
`     `[`1.1`](#section-1-1)`. Suggested Reading`

`   `[`2`](#section-2)`. Requirements Language`

`   `[`3`](#section-3)`. RFD Parameters`

`   `[`4`](#section-4)`. Suppress Threshold versus Churn`

`   `[`5`](#section-5)`. Maximum Penalty`
...
<a id="section-1-1"></a> **`1.1. Suggested Reading`**
...
<a id="section-3"></a> **`3. RFD Parameters`**
...
<a id="section-4"></a> **`4. Suppress Threshold versus Churn`**
...
<a id="section-5"></a> **`5. Maximum Penalty`**
