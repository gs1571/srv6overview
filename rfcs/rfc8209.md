...
`   `[`3`](#section-3)`. Updates to RFC 6487`

`      `[`3.1`](#section-3-1)`. BGPsec Router Certificate Fields`

`           `[`3.1.1`](#section-3-1-1)`. Subject`

`           `[`3.1.2`](#section-3-1-2)`. Subject Public Key Info`

`           `[`3.1.3`](#section-3-1-3)`. BGPsec Router Certificate Version 3`

`                  Extension Fields`

`                  `[`3.1.3.1`](#section-3-1-3-1)`. Basic Constraints`

`                  `[`3.1.3.2`](#section-3-1-3-2)`. Extended Key Usage`

`                  `[`3.1.3.3`](#section-3-1-3-3)`. Subject Information Access`

`                  `[`3.1.3.4`](#section-3-1-3-4)`. IP Resources`

`                  `[`3.1.3.5`](#section-3-1-3-5)`. AS Resources`

`      `[`3.2`](#section-3-2)`. BGPsec Router Certificate Request Profile`

`      `[`3.3`](#section-3-3)`. BGPsec Router Certificate Validation`

`      `[`3.4`](#section-3-4)`. Router Certificates and Signing Functions in the RPKI`

`   `[`4`](#section-4)`. Design Notes`
...
<a id="section-3"></a> **`3. Updates to RFC 6487`**

```text

```

<a id="section-3-1"></a> **`3.1. BGPsec Router Certificate Fields`**
...
<a id="section-3-1-1"></a> **`3.1.1. Subject`**
...
<a id="section-3-1-2"></a> **`3.1.2. Subject Public Key Info`**
...
<a id="section-3-1-3"></a> **`3.1.3. BGPsec Router Certificate Version 3 Extension Fields`**

```text

```

<a id="section-3-1-3-1"></a> **`3.1.3.1. Basic Constraints`**
...
<a id="section-3-1-3-2"></a> **`3.1.3.2. Extended Key Usage`**
...
<a id="section-3-1-3-3"></a> **`3.1.3.3. Subject Information Access`**
...
<a id="section-3-1-3-4"></a> **`3.1.3.4. IP Resources`**
...
<a id="section-3-1-3-5"></a> **`3.1.3.5. AS Resources`**
...
<a id="section-3-2"></a> **`3.2. BGPsec Router Certificate Request Profile`**
...
<a id="section-3-3"></a> **`3.3. BGPsec Router Certificate Validation`**
...
<a id="section-3-4"></a> **`3.4. Router Certificates and Signing Functions in the RPKI`**
...
<a id="section-4"></a> **`4. Design Notes`**
...
<a id="section-5"></a> **`5. Implementation Considerations`**
