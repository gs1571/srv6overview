...
`   `[`2`](#section-2)`. New Sub-TLVs for Extended Reachability TLVs`

`     `[`2.1`](#section-2-1)`. IPv4/IPv6 Extended Reachability Attribute Flags`

`     `[`2.2`](#section-2-2)`. IPv4/IPv6 Source Router ID`

`     `[`2.3`](#section-2-3)`. Advertising Router IDs`
...
<a id="section-2"></a> **`2. New Sub-TLVs for Extended Reachability TLVs`**
...
<a id="section-2-1"></a> **`2.1. IPv4/IPv6 Extended Reachability Attribute Flags`**
...
<a id="section-2-2"></a> **`2.2. IPv4/IPv6 Source Router ID`**
...
<a id="section-2-3"></a> **`2.3. Advertising Router IDs`**
