...
`      `[`2.1`](#section-2-1)`. Security Parameters Index`
...
`      `[`2.7`](#section-2-7)`. Authentication Data`
...
`         `[`3.2.2`](#section-3-2-2)`. Authentication Algorithms`

`      `[`3.3`](#section-3-3)`. Outbound Packet Processing`

`         `[`3.3.1`](#section-3-3-1)`. Security Association Lookup`

`         `[`3.3.2`](#section-3-3-2)`. Packet Encryption`

`         `[`3.3.3`](#section-3-3-3)`. Sequence Number Generation`

`         `[`3.3.4`](#section-3-3-4)`. Integrity Check Value Calculation`

`         `[`3.3.5`](#section-3-3-5)`. Fragmentation`
...
`         `[`3.4.5`](#section-3-4-5)`. Packet Decryption`
...
`   `[`7`](#section-7)`. Differences from RFC 1827`
...
<a id="section-7"></a> **`7. Differences from RFC 1827`**
