...
`   `[`2`](#section-2)`. Text Representation Flexibility of RFC 4291`

`     `[`2.1`](#section-2-1)`. Leading Zeros in a 16-Bit Field`

`     `[`2.2`](#section-2-2)`. Zero Compression`

`     `[`2.3`](#section-2-3)`. Uppercase or Lowercase`

`   `[`3`](#section-3)`. Problems Encountered with the Flexible Model`

`     `[`3.1`](#section-3-1)`. Searching`

`       `[`3.1.1`](#section-3-1-1)`. General Summary`

`       `[`3.1.2`](#section-3-1-2)`. Searching Spreadsheets and Text Files`

`       `[`3.1.3`](#section-3-1-3)`. Searching with Whois`

`       `[`3.1.4`](#section-3-1-4)`. Searching for an Address in a Network Diagram`

`     `[`3.2`](#section-3-2)`. Parsing and Modifying`

`       `[`3.2.1`](#section-3-2-1)`. General Summary`

`       `[`3.2.2`](#section-3-2-2)`. Logging`

`       `[`3.2.3`](#section-3-2-3)`. Auditing: Case 1`

`       `[`3.2.4`](#section-3-2-4)`. Auditing: Case 2`

`       `[`3.2.5`](#section-3-2-5)`. Verification`

`       `[`3.2.6`](#section-3-2-6)`. Unexpected Modifying`

`     `[`3.3`](#section-3-3)`. Operating`

`       `[`3.3.1`](#section-3-3-1)`. General Summary`

`       `[`3.3.2`](#section-3-3-2)`. Customer Calls`

`       `[`3.3.3`](#section-3-3-3)`. Abuse`

`     `[`3.4`](#section-3-4)`. Other Minor Problems`

`       `[`3.4.1`](#section-3-4-1)`. Changing Platforms`

`       `[`3.4.2`](#section-3-4-2)`. Preference in Documentation`

`       `[`3.4.3`](#section-3-4-3)`. Legibility`

`   `[`4`](#section-4)`. A Recommendation for IPv6 Text Representation`

`     `[`4.1`](#section-4-1)`. Handling Leading Zeros in a 16-Bit Field`

`     `[`4.2`](#section-4-2)`. "::" Usage`

`       `[`4.2.1`](#section-4-2-1)`. Shorten as Much as Possible`

`       `[`4.2.2`](#section-4-2-2)`. Handling One 16-Bit 0 Field`

`       `[`4.2.3`](#section-4-2-3)`. Choice in Placement of "::"`

`     `[`4.3`](#section-4-3)`. Lowercase`

`   `[`5`](#section-5)`. Text Representation of Special Addresses`

`   `[`6`](#section-6)`. Notes on Combining IPv6 Addresses with Port Numbers`

`   `[`7`](#section-7)`. Prefix Representation`
...
<a id="section-2"></a> **`2. Text Representation Flexibility of RFC 4291`**
...
<a id="section-2-1"></a> **`2.1. Leading Zeros in a 16-Bit Field`**
...
<a id="section-2-2"></a> **`2.2. Zero Compression`**
...
<a id="section-2-3"></a> **`2.3. Uppercase or Lowercase`**
...
<a id="section-3"></a> **`3. Problems Encountered with the Flexible Model`**

```text

```

<a id="section-3-1"></a> **`3.1. Searching`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. General Summary`**
...
<a id="section-3-1-2"></a> **`3.1.2. Searching Spreadsheets and Text Files`**
...
<a id="section-3-1-3"></a> **`3.1.3. Searching with Whois`**
...
<a id="section-3-1-4"></a> **`3.1.4. Searching for an Address in a Network Diagram`**
...
<a id="section-3-2"></a> **`3.2. Parsing and Modifying`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. General Summary`**
...
<a id="section-3-2-2"></a> **`3.2.2. Logging`**
...
<a id="section-3-2-3"></a> **`3.2.3. Auditing: Case 1`**
...
<a id="section-3-2-4"></a> **`3.2.4. Auditing: Case 2`**
...
<a id="section-3-2-5"></a> **`3.2.5. Verification`**
...
<a id="section-3-2-6"></a> **`3.2.6. Unexpected Modifying`**
...
<a id="section-3-3"></a> **`3.3. Operating`**

```text

```

<a id="section-3-3-1"></a> **`3.3.1. General Summary`**
...
<a id="section-3-3-2"></a> **`3.3.2. Customer Calls`**
...
<a id="section-3-3-3"></a> **`3.3.3. Abuse`**
...
<a id="section-3-4"></a> **`3.4. Other Minor Problems`**

```text

```

<a id="section-3-4-1"></a> **`3.4.1. Changing Platforms`**
...
<a id="section-3-4-2"></a> **`3.4.2. Preference in Documentation`**
...
<a id="section-3-4-3"></a> **`3.4.3. Legibility`**
...
<a id="section-4"></a> **`4. A Recommendation for IPv6 Text Representation`**
...
<a id="section-4-1"></a> **`4.1. Handling Leading Zeros in a 16-Bit Field`**
...
<a id="section-4-2"></a> **`4.2. "::" Usage`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Shorten as Much as Possible`**
...
<a id="section-4-2-2"></a> **`4.2.2. Handling One 16-Bit 0 Field`**
...
<a id="section-4-2-3"></a> **`4.2.3. Choice in Placement of "::"`**
...
<a id="section-4-3"></a> **`4.3. Lowercase`**
...
<a id="section-5"></a> **`5. Text Representation of Special Addresses`**
...
<a id="section-6"></a> **`6. Notes on Combining IPv6 Addresses with Port Numbers`**
...
<a id="section-7"></a> **`7. Prefix Representation`**
