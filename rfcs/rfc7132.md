...
`   `[`3`](#section-3)`. Threat Characterization`

`   `[`4`](#section-4)`. Attack Characterization`

`     `[`4.1`](#section-4-1)`. Active Wiretapping of Sessions between Routers`

`     `[`4.2`](#section-4-2)`. Attacks on a BGP Router`

`     `[`4.3`](#section-4-3)`. Attacks on Network Operator Management Computers (Non-CA`

`           Computers)`

`     `[`4.4`](#section-4-4)`. Attacks on a Repository Publication Point`

`     `[`4.5`](#section-4-5)`. Attacks on an RPKI CA`

`   `[`5`](#section-5)`. Residual Vulnerabilities`
...
<a id="section-3"></a> **`3. Threat Characterization`**
...
<a id="section-4"></a> **`4. Attack Characterization`**
...
<a id="section-4-1"></a> **`4.1. Active Wiretapping of Sessions between Routers`**
...
<a id="section-4-2"></a> **`4.2. Attacks on a BGP Router`**
...
<a id="section-4-3"></a> **`4.3. Attacks on Network Operator Management Computers (Non-CA`**
...
<a id="section-4-4"></a> **`4.4. Attacks on a Repository Publication Point`**
...
<a id="section-4-5"></a> **`4.5. Attacks on an RPKI CA`**
...
<a id="section-5"></a> **`5. Residual Vulnerabilities`**
