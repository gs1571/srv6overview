...
`   `[`2`](#section-2)`. Why This Document is Needed`

`   `[`3`](#section-3)`. Encoding an mLDP FEC in the MCAST-VPN NLRI`

`   `[`4`](#section-4)`. Wildcards`
...
<a id="section-2"></a> **`2. Why This Document Is Needed`**
...
<a id="section-3"></a> **`3. Encoding an mLDP FEC in the MCAST-VPN NLRI`**
