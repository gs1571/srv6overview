...
`      `[`1.1`](#section-1-1)`. Types of CBs`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Design of a CB (What makes a good CB?)`

`      `[`3.1`](#section-3-1)`. Functional Components`

`      `[`3.2`](#section-3-2)`. Other Network Topologies`

`           `[`3.2.1`](#section-3-2-1)`. Use with a Multicast Control/Routing Protocol`

`           `[`3.2.2`](#section-3-2-2)`. Use with Control Protocols Supporting`

`                  Pre-provisioned Capacity`

`           `[`3.2.3`](#section-3-2-3)`. Unidirectional CBs over Controlled Paths`

`   `[`4`](#section-4)`. Requirements for a Network Transport CB`

`   `[`5`](#section-5)`. Examples of CBs`

`      `[`5.1`](#section-5-1)`. A Fast-Trip CB`

`           `[`5.1.1`](#section-5-1-1)`. A Fast-Trip CB for RTP`

`      `[`5.2`](#section-5-2)`. A Slow-Trip CB`

`      `[`5.3`](#section-5-3)`. A Managed CB`

`           `[`5.3.1`](#section-5-3-1)`. A Managed CB for SAToP Pseudowires`

`           `[`5.3.2`](#section-5-3-2)`. A Managed CB for Pseudowires (PWs)`

`   `[`6`](#section-6)`. Examples in Which CBs May Not Be Needed`

`      `[`6.1`](#section-6-1)`. CBs over Pre-provisioned Capacity`

`      `[`6.2`](#section-6-2)`. CBs with Tunnels Carrying Congestion-Controlled Traffic`

`      `[`6.3`](#section-6-3)`. CBs with Unidirectional Traffic and No Control Path`
...
<a id="section-1-1"></a> **`1.1. Types of CBs`**
...
<a id="section-3"></a> **`3. Design of a CB (What makes a good CB?)`**
...
<a id="section-3-1"></a> **`3.1. Functional Components`**
...
<a id="section-3-2"></a> **`3.2. Other Network Topologies`**
...
<a id="section-3-2-1"></a> **`3.2.1. Use with a Multicast Control/Routing Protocol`**
...
<a id="section-3-2-2"></a> **`3.2.2. Use with Control Protocols Supporting Pre-provisioned Capacity`**
...
<a id="section-3-2-3"></a> **`3.2.3. Unidirectional CBs over Controlled Paths`**
...
<a id="section-4"></a> **`4. Requirements for a Network Transport CB`**
...
<a id="section-5"></a> **`5. Examples of CBs`**
...
<a id="section-5-1"></a> **`5.1. A Fast-Trip CB`**
...
<a id="section-5-1-1"></a> **`5.1.1. A Fast-Trip CB for RTP`**
...
<a id="section-5-2"></a> **`5.2. A Slow-Trip CB`**
...
<a id="section-5-3"></a> **`5.3. A Managed CB`**
...
<a id="section-5-3-1"></a> **`5.3.1. A Managed CB for SAToP Pseudowires`**
...
<a id="section-5-3-2"></a> **`5.3.2. A Managed CB for Pseudowires (PWs)`**
...
<a id="section-6"></a> **`6. Examples in Which CBs May Not Be Needed`**
...
<a id="section-6-1"></a> **`6.1. CBs over Pre-provisioned Capacity`**
...
<a id="section-6-2"></a> **`6.2. CBs with Tunnels Carrying Congestion-Controlled Traffic`**
...
<a id="section-6-3"></a> **`6.3. CBs with Unidirectional Traffic and No Control Path`**
