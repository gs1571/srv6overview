...
`   `[`1.1`](#section-1-1)`. Why COPS for Provisioning?`

`   `[`1.2`](#section-1-2)`. Interaction between the PEP and PDP`

`   `[`2`](#section-2)`. Policy Information Base (PIB)`

`   `[`2.1`](#section-2-1)`. Rules for Modifying and Extending PIBs`

`   `[`2.2`](#section-2-2)`. Adding PRCs to, or deprecating from, a PIB`

`   `[`2.2.1`](#section-2-2-1)`. Adding or Deprecating Attributes of a BER Encoded PRC`

`   `[`2.3`](#section-2-3)`. COPS Operations Supported for a Provisioning Instance`

`   `[`3`](#section-3)`. Message Content`

`   `[`3.1`](#section-3-1)`. Request (REQ)  PEP -> PDP`

`   `[`3.2`](#section-3-2)`. Decision (DEC)  PDP -> PEP`

`   `[`3.3`](#section-3-3)`. Report State (RPT)  PEP -> PDP`

`   `[`4`](#section-4)`. COPS-PR Protocol Objects`

`   `[`4.1`](#section-4-1)`. Complete Provisioning Instance Identifier (PRID)`

`   `[`4.2`](#section-4-2)`. Prefix PRID (PPRID)`

`   `[`4.3`](#section-4-3)`. Encoded Provisioning Instance Data (EPD)`

`   `[`4.4`](#section-4-4)`. Global Provisioning Error Object (GPERR)`

`   `[`4.5`](#section-4-5)`. PRC Class Provisioning Error Object (CPERR)`

`   `[`4.6`](#section-4-6)`. Error PRID Object (ErrorPRID)`

`   `[`5`](#section-5)`. COPS-PR Client-Specific Data Formats`

`   `[`5.1`](#section-5-1)`. Named Decision Data`

`   `[`5.2`](#section-5-2)`. ClientSI Request Data`

`   `[`5.3`](#section-5-3)`. Policy Provisioning Report Data`

`   `[`5.3.1`](#section-5-3-1)`. Success and Failure Report-Type Data Format`

`   `[`5.3.2`](#section-5-3-2)`. Accounting Report-Type Data Format`

`   `[`6`](#section-6)`. Common Operation`

`   `[`7`](#section-7)`. Fault Tolerance`
...
<a id="section-1-1"></a> **`1.1. Why COPS for Provisioning?`**
...
<a id="section-1-2"></a> **`1.2. Interaction between the PEP and PDP`**
...
<a id="section-2"></a> **`2. Policy Information Base (PIB)`**
...
<a id="section-2-1"></a> **`2.1. Rules for Modifying and Extending PIBs`**
...
<a id="section-2-2"></a> **`2.2. Adding PRCs to, or deprecating from, a PIB`**
...
<a id="section-2-2-1"></a> **`2.2.1. Adding or Deprecating Attributes of a BER Encoded PRC`**
...
<a id="section-2-3"></a> **`2.3. COPS Operations Supported for a Provisioning Instance`**
...
<a id="section-3"></a> **`3. Message Content`**
...
<a id="section-3-1"></a> **`3.1. Request (REQ)  PEP -> PDP`**
...
<a id="section-3-2"></a> **`3.2. Decision (DEC)  PDP -> PEP`**
...
<a id="section-3-3"></a> **`3.3. Report State (RPT)  PEP -> PDP`**
...
<a id="section-4"></a> **`4. COPS-PR Protocol Objects`**
...
<a id="section-4-1"></a> **`4.1. Complete Provisioning Instance Identifier (PRID)`**
...
<a id="section-4-2"></a> **`4.2. Prefix PRID (PPRID)`**
...
<a id="section-4-3"></a> **`4.3. Encoded Provisioning Instance Data (EPD)`**
...
<a id="section-4-4"></a> **`4.4. Global Provisioning Error Object (GPERR)`**
...
<a id="section-4-5"></a> **`4.5. PRC Class Provisioning Error Object (CPERR)`**
...
<a id="section-4-6"></a> **`4.6. Error PRID Object (ErrorPRID)`**
...
<a id="section-5"></a> **`5. COPS-PR Client-Specific Data Formats`**
...
<a id="section-5-1"></a> **`5.1. Named Decision Data`**
...
<a id="section-5-2"></a> **`5.2. ClientSI Request Data`**
...
<a id="section-5-3"></a> **`5.3. Policy Provisioning Report Data`**
...
<a id="section-5-3-1"></a> **`5.3.1. Success and Failure Report-Type Data Format`**
...
<a id="section-5-3-2"></a> **`5.3.2. Accounting Report-Type Data Format`**
...
<a id="section-6"></a> **`6. Common Operation`**
...
<a id="section-7"></a> **`7. Fault Tolerance`**
