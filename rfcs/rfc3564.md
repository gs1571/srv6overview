...
`       `[`1.2`](#section-1-2)`. Definitions`

`       `[`1.3`](#section-1-3)`. Mapping of traffic to LSPs`

`   `[`2`](#section-2)`. Application Scenarios`

`       `[`2.1`](#section-2-1)`. Scenario 1: Limiting Proportion of Classes on a Link`

`       `[`2.2`](#section-2-2)`. Scenario 2: Maintain relative proportion of traffic`

`       `[`2.3`](#section-2-3)`. Scenario 3: Guaranteed Bandwidth Services`

`   `[`3`](#section-3)`. Detailed Requirements for DS-TE`

`       `[`3.1`](#section-3-1)`. DS-TE Compatibility`

`       `[`3.2`](#section-3-2)`. Class-Types`

`       `[`3.3`](#section-3-3)`. Bandwidth Constraints`

`       `[`3.4`](#section-3-4)`. Preemption and TE-Classes`

`       `[`3.5`](#section-3-5)`. Mapping of Traffic to LSPs`

`       `[`3.6`](#section-3-6)`. Dynamic Adjustment of Diff-Serv PHBs`

`       `[`3.7`](#section-3-7)`. Overbooking`

`       `[`3.8`](#section-3-8)`. Restoration`

`   `[`4`](#section-4)`. Solution Evaluation Criteria`

`       `[`4.1`](#section-4-1)`. Satisfying detailed requirements`

`       `[`4.2`](#section-4-2)`. Flexibility`

`       `[`4.3`](#section-4-3)`. Extendibility`

`       `[`4.4`](#section-4-4)`. Scalability`

`       `[`4.5`](#section-4-5)`. Backward compatibility/Migration`

`       `[`4.6`](#section-4-6)`. Bandwidth Constraints Model`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. Acknowledgment`

`   `[`7`](#section-7)`. Normative References`

`   `[`8`](#section-8)`. Informative References`

`   `[`9`](#section-9)`. Contributing Authors`

`   `[`10`](#section-10)`. Editors' Addresses`
...
<a id="section-1-2"></a> **`1.2. Definitions`**
...
<a id="section-1-3"></a> **`1.3. Mapping of traffic to LSPs`**
...
<a id="section-2"></a> **`2. Application Scenarios`**

```text

```

<a id="section-2-1"></a> **`2.1. Scenario 1: Limiting Proportion of Classes on a Link`**
...
<a id="section-2-2"></a> **`2.2. Scenario 2: Maintain relative proportion of traffic`**
...
<a id="section-2-3"></a> **`2.3. Scenario 3: Guaranteed Bandwidth Services`**
...
<a id="section-3"></a> **`3. Detailed Requirements for DS-TE`**
...
<a id="section-3-1"></a> **`3.1. DS-TE Compatibility`**
...
<a id="section-3-2"></a> **`3.2. Class-Types`**
...
<a id="section-3-3"></a> **`3.3. Bandwidth Constraints`**
...
<a id="section-3-4"></a> **`3.4. Preemption and TE-Classes`**
...
<a id="section-3-5"></a> **`3.5. Mapping of Traffic to LSPs`**
...
<a id="section-3-6"></a> **`3.6. Dynamic Adjustment of Diff-Serv PHBs`**
...
<a id="section-3-7"></a> **`3.7. Overbooking`**
...
<a id="section-3-8"></a> **`3.8. Restoration`**
...
<a id="section-4"></a> **`4. Solution Evaluation Criteria`**
...
<a id="section-4-1"></a> **`4.1. Satisfying detailed requirements`**
...
<a id="section-4-2"></a> **`4.2. Flexibility`**
...
<a id="section-4-3"></a> **`4.3. Extendibility`**
...
<a id="section-4-4"></a> **`4.4. Scalability`**
...
<a id="section-4-5"></a> **`4.5. Backward compatibility/Migration`**
...
<a id="section-4-6"></a> **`4.6. Bandwidth Constraints Model`**
...
<a id="section-6"></a> **`6. Acknowledgment`**
...
<a id="section-9"></a> **`9. Contributing Authors`**
...
<a id="section-10"></a> **`10. Editors' Addresses`**
