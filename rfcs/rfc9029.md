...
**Keywords:** BGP-LS, IANA

## Related Documents

- [prev](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-registry-05)
- [alternate](https://dx.doi.org/10.17487/rfc9029)
...
- [2. IANA Considerations](#section-2)
  - [2.1. Guidance for Designated Experts](#section-2.1)
- [3. Security Considerations](#section-3)
- [4. Normative References](#section-4)
- [Acknowledgements](#section-appendix.a)
- [Author's Address](#section-appendix.b)

# Introduction

"North-Bound Distribution of Link-State and Traffic Engineering (TE) Information Using BGP" [RFC7752](#RFC7752) requested IANA to create
...
The "Specification Required" policy requires evaluation of any assignment
         ...
         given in [RFC7752](#RFC7752).  In addition, this policy requires that "the
         values and their meanings must be documented in a permanent and readily
         available public specification, in sufficient detail so that
         interoperability between independent implementations is possible" [RFC8126](#RFC8126).
         ...
         IANA assignment of the requested value" [RFC8126](#RFC8126).

Another allocation policy called "Expert Review" is defined in [RFC8126](#RFC8126).
...
This document updates [RFC7752](#RFC7752) by changing the allocation policy for all of
...
[RFC7752](#RFC7752) gives guidance to designated experts.  This section replaces that guidance.
...
5. The designated experts **MUST** then review the assignment requests
                ...
                are made.
6. The designated expert **MUST** ensure that any request for
...
The security considerations described in [RFC7752](#RFC7752) still apply.
...
This work is based on the IANA Considerations described in [RFC7752](#RFC7752).  The author thanks the people who worked on that document.
...
Additional thanks to Gyan Mishra, Acee Lindem, Ketan Talaulikar, Les Ginsberg, Bruno Decraene, Benjamin Kaduk,
        and Martin Vigoureux for engaging in discussion on the details of this work.
