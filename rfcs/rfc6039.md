...
`      `[`1.1`](#section-1-1)`. Pre-Image vs. Collision Attacks`

`      `[`1.2`](#section-1-2)`. Concerns about MD5 and the SHA-1 Algorithm`

`   `[`2`](#section-2)`. Open Shortest Path First Version 2 (OSPFv2)`

`      `[`2.1`](#section-2-1)`. Management Issues with OSPFv2`

`      `[`2.2`](#section-2-2)`. Technical Issues with OSPFv2`

`   `[`3`](#section-3)`. Open Shortest Path First Version 3 (OSPFv3)`

`      `[`3.1`](#section-3-1)`. Management Issues with OSPFv3`

`      `[`3.2`](#section-3-2)`. Technical Issues with OSPFv3`

`   `[`4`](#section-4)`. Intermediate System to Intermediate System Routing`

`      Protocol (IS-IS)`

`      `[`4.1`](#section-4-1)`. Management Issues with IS-IS`

`      `[`4.2`](#section-4-2)`. Technical Issues with IS-IS`

`   `[`5`](#section-5)`. Border Gateway Protocol (BGP-4)`

`      `[`5.1`](#section-5-1)`. Management Issues with BGP-4`

`      `[`5.2`](#section-5-2)`. Technical Issues with BGP-4`

`   `[`6`](#section-6)`. The Routing Information Protocol (RIP)`

`      `[`6.1`](#section-6-1)`. Technical Issues with RIP`

`   `[`7`](#section-7)`. Bidirectional Forwarding Detection (BFD)`

`      `[`7.1`](#section-7-1)`. Technical Issues with BFD`
...
`   `[`11`](#section-11)`. Contributor's Address`


<a id="section-1"></a> **`1. Problem Statement`**
...
<a id="section-1-1"></a> **`1.1. Pre-Image vs. Collision Attacks`**
...
<a id="section-1-2"></a> **`1.2. Concerns about MD5 and the SHA-1 Algorithm`**
...
<a id="section-2"></a> **`2. Open Shortest Path First Version 2 (OSPFv2)`**
...
<a id="section-2-1"></a> **`2.1. Management Issues with OSPFv2`**
...
<a id="section-2-2"></a> **`2.2. Technical Issues with OSPFv2`**
...
<a id="section-3"></a> **`3. Open Shortest Path First Version 3 (OSPFv3)`**
...
<a id="section-3-1"></a> **`3.1. Management Issues with OSPFv3`**
...
<a id="section-3-2"></a> **`3.2. Technical Issues with OSPFv3`**
...
<a id="section-4"></a> **`4. Intermediate System to Intermediate System Routing Protocol (IS-IS)`**
...
<a id="section-4-1"></a> **`4.1. Management Issues with IS-IS`**
...
<a id="section-4-2"></a> **`4.2. Technical Issues with IS-IS`**
...
<a id="section-5"></a> **`5. Border Gateway Protocol (BGP-4)`**
...
<a id="section-5-1"></a> **`5.1. Management Issues with BGP-4`**
...
<a id="section-5-2"></a> **`5.2. Technical Issues with BGP-4`**
...
<a id="section-6"></a> **`6. The Routing Information Protocol (RIP)`**
...
<a id="section-6-1"></a> **`6.1. Technical Issues with RIP`**
...
<a id="section-7"></a> **`7. Bidirectional Forwarding Detection (BFD)`**
...
<a id="section-7-1"></a> **`7.1. Technical Issues with BFD`**
...
<a id="section-11"></a> **`11. Contributor's Address`**
