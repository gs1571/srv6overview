...
`     `[`2.2`](#section-2-2)`. Conventions`

`   `[`3`](#section-3)`. Problem Statement`

`     `[`3.1`](#section-3-1)`. Motivations`

`     `[`3.2`](#section-3-2)`. General Requirements`

`     `[`3.3`](#section-3-3)`. Scaling vs. Optimizing Resource Utilization`

`   `[`4`](#section-4)`. Use Cases`

`     `[`4.1`](#section-4-1)`. Scenarios`

`       `[`4.1.1`](#section-4-1-1)`. Live Content Broadcast`

`       `[`4.1.2`](#section-4-1-2)`. Symmetric Applications`

`       `[`4.1.3`](#section-4-1-3)`. Data Distribution`

`       `[`4.1.4`](#section-4-1-4)`. Generic Multicast VPN Offer`

`     `[`4.2`](#section-4-2)`. Scalability Orders of Magnitude`

`       `[`4.2.1`](#section-4-2-1)`. Number of VPNs with Multicast Enabled`

`       `[`4.2.2`](#section-4-2-2)`. Number of Multicast VPNs per PE`

`       `[`4.2.3`](#section-4-2-3)`. Number of CEs per Multicast VPN per PE`

`       `[`4.2.4`](#section-4-2-4)`. PEs per Multicast VPN`

`       `[`4.2.5`](#section-4-2-5)`. PEs with Multicast VRFs`

`       `[`4.2.6`](#section-4-2-6)`. Number of Streams Sourced`

`   `[`5`](#section-5)`. Requirements for Supporting IP Multicast within L3 PPVPNs  .`

`     `[`5.1`](#section-5-1)`. End User/Customer Standpoint`

`       `[`5.1.1`](#section-5-1-1)`. Service Definition`

`       `[`5.1.2`](#section-5-1-2)`. CE-PE Multicast Routing and Group Management`

`               Protocols`

`       `[`5.1.3`](#section-5-1-3)`. Quality of Service (QoS)`

`       `[`5.1.4`](#section-5-1-4)`. Operations and Management`

`       `[`5.1.5`](#section-5-1-5)`. Security Requirements`

`       `[`5.1.6`](#section-5-1-6)`. Extranet`

`       `[`5.1.7`](#section-5-1-7)`. Internet Multicast`

`       `[`5.1.8`](#section-5-1-8)`. Carrier's Carrier`

`       `[`5.1.9`](#section-5-1-9)`. Multi-Homing, Load Balancing, and Resiliency`

`       `[`5.1.10`](#section-5-1-10)`. RP Engineering`

`       `[`5.1.11`](#section-5-1-11)`. Addressing`

`       `[`5.1.12`](#section-5-1-12)`. Minimum MTU`

`     `[`5.2`](#section-5-2)`. Service Provider Standpoint`

`       `[`5.2.1`](#section-5-2-1)`. General Requirement`

`       `[`5.2.2`](#section-5-2-2)`. Scalability`

`       `[`5.2.3`](#section-5-2-3)`. Resource Optimization`

`       `[`5.2.4`](#section-5-2-4)`. Tunneling Requirements`

`       `[`5.2.5`](#section-5-2-5)`. Control Mechanisms`

`       `[`5.2.6`](#section-5-2-6)`. Support of Inter-AS, Inter-Provider Deployments`

`       `[`5.2.7`](#section-5-2-7)`. Quality-of-Service Differentiation`

`       `[`5.2.8`](#section-5-2-8)`. Infrastructure security`

`       `[`5.2.9`](#section-5-2-9)`. Robustness`

`       `[`5.2.10`](#section-5-2-10)`. Operation, Administration, and Maintenance`

`       `[`5.2.11`](#section-5-2-11)`. Compatibility and Migration Issues`

`       `[`5.2.12`](#section-5-2-12)`. Troubleshooting`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Contributors`
...
<a id="section-2-1"></a> **`2.1. Terminology`**
...
<a id="section-2-2"></a> **`2.2. Conventions`**
...
<a id="section-3"></a> **`3. Problem Statement`**

```text

```

<a id="section-3-1"></a> **`3.1. Motivations`**
...
<a id="section-3-2"></a> **`3.2. General Requirements`**
...
<a id="section-3-3"></a> **`3.3. Scaling vs. Optimizing Resource Utilization`**
...
<a id="section-4-1"></a> **`4.1. Scenarios`**
...
<a id="section-4-1-1"></a> **`4.1.1. Live Content Broadcast`**
...
<a id="section-4-1-2"></a> **`4.1.2. Symmetric Applications`**
...
<a id="section-4-1-3"></a> **`4.1.3. Data Distribution`**
...
<a id="section-4-1-4"></a> **`4.1.4. Generic Multicast VPN Offer`**
...
<a id="section-4-2"></a> **`4.2. Scalability Orders of Magnitude`**
...
<a id="section-4-2-1"></a> **`4.2.1. Number of VPNs with Multicast Enabled`**
...
<a id="section-4-2-2"></a> **`4.2.2. Number of Multicast VPNs per PE`**
...
<a id="section-4-2-3"></a> **`4.2.3. Number of CEs per Multicast VPN per PE`**
...
<a id="section-4-2-4"></a> **`4.2.4. PEs per Multicast VPN`**
...
<a id="section-4-2-4-1"></a> **`4.2.4.1. ... with Sources`**
...
<a id="section-4-2-4-2"></a> **`4.2.4.2. ... with Receivers`**
...
<a id="section-4-2-5"></a> **`4.2.5. PEs with Multicast VRFs`**
...
<a id="section-4-2-6"></a> **`4.2.6. Number of Streams Sourced`**
...
<a id="section-5"></a> **`5. Requirements for Supporting IP Multicast within L3 PPVPNs`**
...
<a id="section-5-1"></a> **`5.1. End User/Customer Standpoint`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. Service Definition`**
...
<a id="section-5-1-2"></a> **`5.1.2. CE-PE Multicast Routing and Group Management Protocols`**
...
<a id="section-5-1-3"></a> **`5.1.3. Quality of Service (QoS)`**
...
<a id="section-5-1-4"></a> **`5.1.4. Operations and Management`**
...
<a id="section-5-1-5"></a> **`5.1.5. Security Requirements`**
...
<a id="section-5-1-6"></a> **`5.1.6. Extranet`**
...
<a id="section-5-1-7"></a> **`5.1.7. Internet Multicast`**
...
<a id="section-5-1-8"></a> **`5.1.8. Carrier's Carrier`**
...
<a id="section-5-1-9"></a> **`5.1.9. Multi-Homing, Load Balancing, and Resiliency`**
...
<a id="section-5-1-10"></a> **`5.1.10. RP Engineering`**
...
<a id="section-5-1-10-1"></a> **`5.1.10.1. RP Outsourcing`**
...
<a id="section-5-1-10-2"></a> **`5.1.10.2. RP Availability`**
...
<a id="section-5-1-10-3"></a> **`5.1.10.3. RP Location`**
...
<a id="section-5-1-11"></a> **`5.1.11. Addressing`**
...
<a id="section-5-1-12"></a> **`5.1.12. Minimum MTU`**
...
<a id="section-5-2"></a> **`5.2. Service Provider Standpoint`**
...
<a id="section-5-2-1"></a> **`5.2.1. General Requirement`**
...
<a id="section-5-2-2"></a> **`5.2.2. Scalability`**
...
<a id="section-5-2-3"></a> **`5.2.3. Resource Optimization`**

```text

```

<a id="section-5-2-3-1"></a> **`5.2.3.1. General Goals`**
...
<a id="section-5-2-3-2"></a> **`5.2.3.2. Trade-off and Tuning`**
...
<a id="section-5-2-3-3"></a> **`5.2.3.3. Traffic Engineering`**
...
<a id="section-5-2-4"></a> **`5.2.4. Tunneling Requirements`**

```text

```

<a id="section-5-2-4-1"></a> **`5.2.4.1. Tunneling Technologies`**
...
<a id="section-5-2-4-2"></a> **`5.2.4.2. MTU and Fragmentation`**
...
<a id="section-5-2-5"></a> **`5.2.5. Control Mechanisms`**
...
<a id="section-5-2-6"></a> **`5.2.6. Support of Inter-AS, Inter-Provider Deployments`**
...
<a id="section-5-2-7"></a> **`5.2.7. Quality-of-Service Differentiation`**
...
<a id="section-5-2-8"></a> **`5.2.8. Infrastructure security`**
...
<a id="section-5-2-9"></a> **`5.2.9. Robustness`**
...
<a id="section-5-2-10"></a> **`5.2.10. Operation, Administration, and Maintenance`**
...
<a id="section-5-2-11"></a> **`5.2.11. Compatibility and Migration Issues`**
...
<a id="section-5-2-12"></a> **`5.2.12. Troubleshooting`**
...
<a id="section-7"></a> **`7. Contributors`**
