...
`   `[`2`](#section-2)`. Terminology and Abbreviations`

`     `[`2.1`](#section-2-1)`. Terminology`

`     `[`2.2`](#section-2-2)`. Abbreviations`

`   `[`3`](#section-3)`. An MPLS Topology-Aware Path Monitoring System`

`   `[`4`](#section-4)`. Illustration of an SR-Based Path Monitoring Use Case`

`     `[`4.1`](#section-4-1)`. Use Case 1: LSP Data-Plane Monitoring`

`     `[`4.2`](#section-4-2)`. Use Case 2: Monitoring a Remote Bundle`

`     `[`4.3`](#section-4-3)`. Use Case 3: Fault Localization`

`   `[`5`](#section-5)`. Path Trace and Failure Notification`

`   `[`6`](#section-6)`. Applying SR to Monitoring LSPs That Are Not SR Based (LDP and`

`       Possibly RSVP-TE)`

`   `[`7`](#section-7)`. PMS Monitoring of Different Segment ID Types`

`   `[`8`](#section-8)`. Connectivity Verification Using PMS`
...
<a id="section-2"></a> **`2. Terminology and Abbreviations`**
...
<a id="section-2-2"></a> **`2.2. Abbreviations`**
...
<a id="section-3"></a> **`3. An MPLS Topology-Aware Path Monitoring System`**
...
<a id="section-4"></a> **`4. Illustration of an SR-Based Path Monitoring Use Case`**

```text

```

<a id="section-4-1"></a> **`4.1. Use Case 1: LSP Data-Plane Monitoring`**
...
<a id="section-4-2"></a> **`4.2. Use Case 2: Monitoring a Remote Bundle`**
...
<a id="section-4-3"></a> **`4.3. Use Case 3: Fault Localization`**
...
<a id="section-5"></a> **`5. Path Trace and Failure Notification`**
...
<a id="section-6"></a> **`6. Applying SR to Monitoring LSPs That Are Not SR Based (LDP and`**
...
<a id="section-7"></a> **`7. PMS Monitoring of Different Segment ID Types`**
...
<a id="section-8"></a> **`8. Connectivity Verification Using PMS`**
