...
`     `[`1.1`](#section-1-1)`. Keep IANA Considerations for IANA`

`     `[`1.2`](#section-1-2)`. For Updated Information`

`     `[`1.3`](#section-1-3)`. A Quick Checklist Upfront`

`   `[`2`](#section-2)`. Creating and Revising Registries`

`     `[`2.1`](#section-2-1)`. Organization of Registries`

`     `[`2.2`](#section-2-2)`. Documentation Requirements for Registries`

`     `[`2.3`](#section-2-3)`. Specifying Change Control for a Registry`

`     `[`2.4`](#section-2-4)`. Revising Existing Registries`

`   `[`3`](#section-3)`. Registering New Values in an Existing Registry`

`     `[`3.1`](#section-3-1)`. Documentation Requirements for Registrations`

`     `[`3.2`](#section-3-2)`. Updating Existing Registrations`

`     `[`3.3`](#section-3-3)`. Overriding Registration Procedures`

`     `[`3.4`](#section-3-4)`. Early Allocations`

`   `[`4`](#section-4)`. Choosing a Registration Policy and Well-Known Policies`

`     `[`4.1`](#section-4-1)`. Private Use`

`     `[`4.2`](#section-4-2)`. Experimental Use`

`     `[`4.3`](#section-4-3)`. Hierarchical Allocation`

`     `[`4.4`](#section-4-4)`. First Come First Served`

`     `[`4.5`](#section-4-5)`. Expert Review`

`     `[`4.6`](#section-4-6)`. Specification Required`

`     `[`4.7`](#section-4-7)`. RFC Required`

`     `[`4.8`](#section-4-8)`. IETF Review`

`     `[`4.9`](#section-4-9)`. Standards Action`

`     `[`4.10`](#section-4-10)`. IESG Approval`

`     `[`4.11`](#section-4-11)`. Using the Well-Known Registration Policies`

`     `[`4.12`](#section-4-12)`. Using Multiple Policies in Combination`

`     `[`4.13`](#section-4-13)`. Provisional Registrations`

`   `[`5`](#section-5)`. Designated Experts`

`     `[`5.1`](#section-5-1)`. The Motivation for Designated Experts`

`     `[`5.2`](#section-5-2)`. The Role of the Designated Expert`

`       `[`5.2.1`](#section-5-2-1)`. Managing Designated Experts in the IETF`

`     `[`5.3`](#section-5-3)`. Designated Expert Reviews`

`     `[`5.4`](#section-5-4)`. Expert Reviews and the Document Lifecycle`

`   `[`6`](#section-6)`. Well-Known Registration Status Terminology`

`   `[`7`](#section-7)`. Documentation References in IANA Registries`

`   `[`8`](#section-8)`. What to Do in "bis" Documents`

`   `[`9`](#section-9)`. Miscellaneous Issues`

`     `[`9.1`](#section-9-1)`. When There Are No IANA Actions`

`     `[`9.2`](#section-9-2)`. Namespaces Lacking Documented Guidance`

`     `[`9.3`](#section-9-3)`. After-the-Fact Registrations`

`     `[`9.4`](#section-9-4)`. Reclaiming Assigned Values`

`     `[`9.5`](#section-9-5)`. Contact Person vs Assignee or Owner`

`     `[`9.6`](#section-9-6)`. Closing or Obsoleting a Registry/Registrations`

`   `[`10`](#section-10)`. Appeals`

`   `[`11`](#section-11)`. Mailing Lists`

`   `[`12`](#section-12)`. Security Considerations`

`   `[`13`](#section-13)`. IANA Considerations`

`   `[`14`](#section-14)`. Changes Relative to Earlier Editions of BCP 26`

`     `[`14.1`](#section-14-1)`. 2016: Changes in This Document Relative to RFC 5226  .`

`     `[`14.2`](#section-14-2)`. 2008: Changes in RFC 5226 Relative to RFC 2434`
...
<a id="section-1-1"></a> **`1.1. Keep IANA Considerations for IANA`**
...
<a id="section-1-2"></a> **`1.2. For Updated Information`**
...
<a id="section-1-3"></a> **`1.3. A Quick Checklist Upfront`**
...
<a id="section-2"></a> **`2. Creating and Revising Registries`**
...
<a id="section-2-1"></a> **`2.1. Organization of Registries`**
...
<a id="section-2-2"></a> **`2.2. Documentation Requirements for Registries`**
...
<a id="section-2-3"></a> **`2.3. Specifying Change Control for a Registry`**
...
<a id="section-2-4"></a> **`2.4. Revising Existing Registries`**
...
<a id="section-3"></a> **`3. Registering New Values in an Existing Registry`**

```text

```

<a id="section-3-1"></a> **`3.1. Documentation Requirements for Registrations`**
...
<a id="section-3-2"></a> **`3.2. Updating Existing Registrations`**
...
<a id="section-3-3"></a> **`3.3. Overriding Registration Procedures`**
...
<a id="section-3-4"></a> **`3.4. Early Allocations`**
...
<a id="section-4"></a> **`4. Choosing a Registration Policy and Well-Known Policies`**
...
<a id="section-4-1"></a> **`4.1. Private Use`**
...
<a id="section-4-2"></a> **`4.2. Experimental Use`**
...
<a id="section-4-3"></a> **`4.3. Hierarchical Allocation`**
...
<a id="section-4-4"></a> **`4.4. First Come First Served`**
...
<a id="section-4-5"></a> **`4.5. Expert Review`**
...
<a id="section-4-6"></a> **`4.6. Specification Required`**
...
<a id="section-4-7"></a> **`4.7. RFC Required`**
...
<a id="section-4-8"></a> **`4.8. IETF Review`**
...
<a id="section-4-9"></a> **`4.9. Standards Action`**
...
<a id="section-4-10"></a> **`4.10. IESG Approval`**
...
<a id="section-4-11"></a> **`4.11. Using the Well-Known Registration Policies`**
...
<a id="section-4-12"></a> **`4.12. Using Multiple Policies in Combination`**
...
<a id="section-4-13"></a> **`4.13. Provisional Registrations`**
...
<a id="section-5"></a> **`5. Designated Experts`**

```text

```

<a id="section-5-1"></a> **`5.1. The Motivation for Designated Experts`**
...
<a id="section-5-2"></a> **`5.2. The Role of the Designated Expert`**
...
<a id="section-5-2-1"></a> **`5.2.1. Managing Designated Experts in the IETF`**
...
<a id="section-5-3"></a> **`5.3. Designated Expert Reviews`**
...
<a id="section-5-4"></a> **`5.4. Expert Reviews and the Document Lifecycle`**
...
<a id="section-6"></a> **`6. Well-Known Registration Status Terminology`**
...
<a id="section-7"></a> **`7. Documentation References in IANA Registries`**
...
<a id="section-8"></a> **`8. What to Do in "bis" Documents`**
...
<a id="section-9"></a> **`9. Miscellaneous Issues`**

```text

```

<a id="section-9-1"></a> **`9.1. When There Are No IANA Actions`**
...
<a id="section-9-2"></a> **`9.2. Namespaces Lacking Documented Guidance`**
...
<a id="section-9-3"></a> **`9.3. After-the-Fact Registrations`**
...
<a id="section-9-4"></a> **`9.4. Reclaiming Assigned Values`**
...
<a id="section-9-5"></a> **`9.5. Contact Person vs Assignee or Owner`**
...
<a id="section-9-6"></a> **`9.6. Closing or Obsoleting a Registry/Registrations`**
...
<a id="section-11"></a> **`11. Mailing Lists`**
...
<a id="section-14"></a> **`14. Changes Relative to Earlier Editions of BCP 26`**

```text

```

<a id="section-14-1"></a> **`14.1. 2016: Changes in This Document Relative to RFC 5226`**
...
<a id="section-14-2"></a> **`14.2. 2008: Changes in RFC 5226 Relative to RFC 2434`**
