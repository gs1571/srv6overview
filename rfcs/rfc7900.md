...
`      `[`1.2`](#section-1-2)`. Scope`

`           `[`1.2.1`](#section-1-2-1)`. Customer Multicast Control Protocols`

`           `[`1.2.2`](#section-1-2-2)`. Provider Multicast Control Protocols`

`      `[`1.3`](#section-1-3)`. Clarification on Use of Route Distinguishers`

`      `[`1.4`](#section-1-4)`. Overview`

`   `[`2`](#section-2)`. Extranets and Overlapping Address Spaces`

`      `[`2.1`](#section-2-1)`. Ambiguity: P-Tunnel with Extranet/Non-extranet Flows`

`      `[`2.2`](#section-2-2)`. Ambiguity: P-Tunnel with Multiple Extranet Flows`

`      `[`2.3`](#section-2-3)`. Preventing Misdelivery in These Scenarios`

`           `[`2.3.1`](#section-2-3-1)`. Do Not Deliver Packets from the Wrong P-tunnel`

`           `[`2.3.2`](#section-2-3-2)`. Policies to Prevent Ambiguity on a P-Tunnel`

`   `[`3`](#section-3)`. Extranet Transmission Models`

`      `[`3.1`](#section-3-1)`. Transmitting an Extranet C-Flow on a Single PMSI`

`           `[`3.1.1`](#section-3-1-1)`. Without Extranet Separation`

`           `[`3.1.2`](#section-3-1-2)`. With Extranet Separation`

`      `[`3.2`](#section-3-2)`. Transmitting an Extranet C-Flow over Multiple PMSIs`

`   `[`4`](#section-4)`. Distribution of Routes That Match C-S/C-RP Addresses`

`      `[`4.1`](#section-4-1)`. UMH-Eligible Routes`

`           `[`4.1.1`](#section-4-1-1)`. Extranet Separation`

`      `[`4.2`](#section-4-2)`. Distribution of Unicast Routes Matching C-RPs and DRs`

`      `[`4.3`](#section-4-3)`. Route Targets and Ambiguous UMH-Eligible Routes`

`      `[`4.4`](#section-4-4)`. Dynamically Marking Extranet Routes`

`           `[`4.4.1`](#section-4-4-1)`. The Extranet Source Extended Community`

`           `[`4.4.2`](#section-4-4-2)`. Distribution of Extranet Source Extended`

`                  Community`

`      `[`4.5`](#section-4-5)`. The Extranet Separation Extended Community`

`   `[`5`](#section-5)`. Origination and Distribution of BGP A-D Routes`

`      `[`5.1`](#section-5-1)`. Route Targets of UMH-Eligible Routes and A-D Routes`

`      `[`5.2`](#section-5-2)`. Considerations for Particular Inclusive Tunnel Types`

`           `[`5.2.1`](#section-5-2-1)`. RSVP-TE P2MP or Ingress Replication`

`           `[`5.2.2`](#section-5-2-2)`. Ingress Replication`

`   `[`6`](#section-6)`. When PIM Is the PE-PE C-Multicast Control Plane`

`      `[`6.1`](#section-6-1)`. Provisioning VRFs with RTs`

`           `[`6.1.1`](#section-6-1-1)`. Incoming and Outgoing Extranet RTs`

`           `[`6.1.2`](#section-6-1-2)`. UMH-Eligible Routes and RTs`

`           `[`6.1.3`](#section-6-1-3)`. PIM C-Instance Reverse Path Forwarding`

`                  Determination`

`      `[`6.2`](#section-6-2)`. "Single PMSI per C-Flow" Model`

`           `[`6.2.1`](#section-6-2-1)`. Forming the MI-PMSIs`

`           `[`6.2.2`](#section-6-2-2)`. S-PMSIs`

`           `[`6.2.3`](#section-6-2-3)`. Sending PIM Control Packets`

`           `[`6.2.4`](#section-6-2-4)`. Receiving PIM Control Packets`

`           `[`6.2.5`](#section-6-2-5)`. Sending and Receiving Data Packets`

`      `[`6.3`](#section-6-3)`. "Multiple PMSIs per C-Flow" Model`

`           `[`6.3.1`](#section-6-3-1)`. Forming the MI-PMSIs`

`   `[`7`](#section-7)`. When BGP Is the PE-PE C-Multicast Control Plane`

`      `[`7.1`](#section-7-1)`. Originating C-Multicast Routes`

`      `[`7.2`](#section-7-2)`. Originating A-D Routes without Extranet Separation`

`           `[`7.2.1`](#section-7-2-1)`. Intra-AS I-PMSI A-D Routes`

`           `[`7.2.2`](#section-7-2-2)`. S-PMSI A-D Routes`

`           `[`7.2.3`](#section-7-2-3)`. Source Active A-D Routes`

`                  `[`7.2.3.1`](#section-7-2-3-1)`. When Inter-Site Shared Trees Are Used`

`                  `[`7.2.3.2`](#section-7-2-3-2)`. When Inter-Site Shared Trees Are`

`                           Not Used`

`      `[`7.3`](#section-7-3)`. Originating A-D Routes with Extranet Separation`

`           `[`7.3.1`](#section-7-3-1)`. Intra-AS I-PMSI A-D Routes`

`           `[`7.3.2`](#section-7-3-2)`. S-PMSI A-D Routes`

`           `[`7.3.3`](#section-7-3-3)`. Source Active A-D Routes`

`      `[`7.4`](#section-7-4)`. Determining the Expected P-Tunnel for a C-Flow`

`           `[`7.4.1`](#section-7-4-1)`. (C-S,C-G) S-PMSI A-D Routes`

`           `[`7.4.2`](#section-7-4-2)`. (C-S,C-*) S-PMSI A-D Routes`

`           `[`7.4.3`](#section-7-4-3)`. (C-*,C-G) S-PMSI A-D Routes`

`           `[`7.4.4`](#section-7-4-4)`. (C-*,C-*) S-PMSI A-D Routes`

`           `[`7.4.5`](#section-7-4-5)`. I-PMSI A-D Routes`

`      `[`7.5`](#section-7-5)`. Packets Arriving from the Wrong P-Tunnel`

`   `[`8`](#section-8)`. Multiple Extranet VRFs on the Same PE`
...
<a id="section-1-2"></a> **`1.2. Scope`**

```text

```

<a id="section-1-2-1"></a> **`1.2.1. Customer Multicast Control Protocols`**
...
<a id="section-1-2-2"></a> **`1.2.2. Provider Multicast Control Protocols`**
...
<a id="section-1-3"></a> **`1.3. Clarification on Use of Route Distinguishers`**
...
<a id="section-1-4"></a> **`1.4. Overview`**
...
<a id="section-2"></a> **`2. Extranets and Overlapping Address Spaces`**
...
<a id="section-2-1"></a> **`2.1. Ambiguity: P-Tunnel with Extranet/Non-extranet Flows`**
...
<a id="section-2-2"></a> **`2.2. Ambiguity: P-Tunnel with Multiple Extranet Flows`**
...
<a id="section-2-3"></a> **`2.3. Preventing Misdelivery in These Scenarios`**
...
<a id="section-2-3-1"></a> **`2.3.1. Do Not Deliver Packets from the Wrong P-tunnel`**
...
<a id="section-2-3-2"></a> **`2.3.2. Policies to Prevent Ambiguity on a P-Tunnel`**
...
<a id="section-3"></a> **`3. Extranet Transmission Models`**
...
<a id="section-3-1"></a> **`3.1. Transmitting an Extranet C-Flow on a Single PMSI`**
...
<a id="section-3-1-1"></a> **`3.1.1. Without Extranet Separation`**
...
<a id="section-3-1-2"></a> **`3.1.2. With Extranet Separation`**
...
<a id="section-3-2"></a> **`3.2. Transmitting an Extranet C-Flow over Multiple PMSIs`**
...
<a id="section-4"></a> **`4. Distribution of Routes That Match C-S/C-RP Addresses`**

```text

```

<a id="section-4-1"></a> **`4.1. UMH-Eligible Routes`**
...
<a id="section-4-1-1"></a> **`4.1.1. Extranet Separation`**
...
<a id="section-4-2"></a> **`4.2. Distribution of Unicast Routes Matching C-RPs and DRs`**
...
<a id="section-4-3"></a> **`4.3. Route Targets and Ambiguous UMH-Eligible Routes`**
...
<a id="section-4-4"></a> **`4.4. Dynamically Marking Extranet Routes`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. The Extranet Source Extended Community`**
...
<a id="section-4-4-2"></a> **`4.4.2. Distribution of Extranet Source Extended Community`**
...
<a id="section-4-5"></a> **`4.5. The Extranet Separation Extended Community`**
...
<a id="section-5"></a> **`5. Origination and Distribution of BGP A-D Routes`**
...
<a id="section-5-1"></a> **`5.1. Route Targets of UMH-Eligible Routes and A-D Routes`**
...
<a id="section-5-2"></a> **`5.2. Considerations for Particular Inclusive Tunnel Types`**
...
<a id="section-5-2-1"></a> **`5.2.1. RSVP-TE P2MP or Ingress Replication`**
...
<a id="section-5-2-2"></a> **`5.2.2. Ingress Replication`**
...
<a id="section-6"></a> **`6. When PIM Is the PE-PE C-Multicast Control Plane`**
...
<a id="section-6-1"></a> **`6.1. Provisioning VRFs with RTs`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. Incoming and Outgoing Extranet RTs`**
...
<a id="section-6-1-2"></a> **`6.1.2. UMH-Eligible Routes and RTs`**
...
<a id="section-6-1-3"></a> **`6.1.3. PIM C-Instance Reverse Path Forwarding Determination`**
...
<a id="section-6-2"></a> **`6.2. "Single PMSI per C-Flow" Model`**
...
<a id="section-6-2-1"></a> **`6.2.1. Forming the MI-PMSIs`**
...
<a id="section-6-2-2"></a> **`6.2.2. S-PMSIs`**
...
<a id="section-6-2-3"></a> **`6.2.3. Sending PIM Control Packets`**
...
<a id="section-6-2-4"></a> **`6.2.4. Receiving PIM Control Packets`**
...
<a id="section-6-2-5"></a> **`6.2.5. Sending and Receiving Data Packets`**
...
<a id="section-6-3"></a> **`6.3. "Multiple PMSIs per C-Flow" Model`**
...
<a id="section-6-3-1"></a> **`6.3.1. Forming the MI-PMSIs`**
...
<a id="section-7"></a> **`7. When BGP Is the PE-PE C-Multicast Control Plane`**
...
<a id="section-7-1"></a> **`7.1. Originating C-Multicast Routes`**
...
<a id="section-7-2"></a> **`7.2. Originating A-D Routes without Extranet Separation`**

```text

```

<a id="section-7-2-1"></a> **`7.2.1. Intra-AS I-PMSI A-D Routes`**
...
<a id="section-7-2-2"></a> **`7.2.2. S-PMSI A-D Routes`**
...
<a id="section-7-2-3"></a> **`7.2.3. Source Active A-D Routes`**

```text

```

<a id="section-7-2-3-1"></a> **`7.2.3.1. When Inter-Site Shared Trees Are Used`**
...
<a id="section-7-2-3-2"></a> **`7.2.3.2. When Inter-Site Shared Trees Are Not Used`**
...
<a id="section-7-3"></a> **`7.3. Originating A-D Routes with Extranet Separation`**
...
<a id="section-7-3-1"></a> **`7.3.1. Intra-AS I-PMSI A-D Routes`**
...
<a id="section-7-3-2"></a> **`7.3.2. S-PMSI A-D Routes`**
...
<a id="section-7-3-3"></a> **`7.3.3. Source Active A-D Routes`**
...
<a id="section-7-4"></a> **`7.4. Determining the Expected P-Tunnel for a C-Flow`**
...
<a id="section-7-4-1"></a> **`7.4.1. (C-S,C-G) S-PMSI A-D Routes`**
...
<a id="section-7-4-2"></a> **`7.4.2. (C-S,C-*) S-PMSI A-D Routes`**
...
<a id="section-7-4-3"></a> **`7.4.3. (C-*,C-G) S-PMSI A-D Routes`**
...
<a id="section-7-4-4"></a> **`7.4.4. (C-*,C-*) S-PMSI A-D Routes`**
...
<a id="section-7-4-5"></a> **`7.4.5. I-PMSI A-D Routes`**
...
<a id="section-7-5"></a> **`7.5. Packets Arriving from the Wrong P-Tunnel`**
...
<a id="section-8"></a> **`8. Multiple Extranet VRFs on the Same PE`**
