...
`      `[`1.2`](#section-1-2)`. Default Designated Forwarder (DF) Election in EVPN`

`           Services`

`      `[`1.3`](#section-1-3)`. Problem Statement`

`           `[`1.3.1`](#section-1-3-1)`. Unfair Load Balancing and Service Disruption`

`           `[`1.3.2`](#section-1-3-2)`. Traffic Black-Holing on Individual AC Failures`

`      `[`1.4`](#section-1-4)`. The Need for Extending the Default DF Election in`

`           EVPN Services`

`   `[`2`](#section-2)`. Designated Forwarder Election Protocol and BGP Extensions`

`      `[`2.1`](#section-2-1)`. The DF Election Finite State Machine (FSM)`

`      `[`2.2`](#section-2-2)`. The DF Election Extended Community`

`           `[`2.2.1`](#section-2-2-1)`. Backward Compatibility`

`   `[`3`](#section-3)`. The Highest Random Weight DF Election Algorithm`

`      `[`3.1`](#section-3-1)`. HRW and Consistent Hashing`

`      `[`3.2`](#section-3-2)`. HRW Algorithm for EVPN DF Election`

`   `[`4`](#section-4)`. The AC-Influenced DF Election Capability`

`      `[`4.1`](#section-4-1)`. AC-Influenced DF Election Capability for`

`           VLAN-Aware Bundle Services`

`   `[`5`](#section-5)`. Solution Benefits`
...
<a id="section-1-2"></a> **`1.2. Default Designated Forwarder (DF) Election in EVPN Services`**
...
<a id="section-1-3"></a> **`1.3. Problem Statement`**
...
<a id="section-1-3-1"></a> **`1.3.1. Unfair Load Balancing and Service Disruption`**
...
<a id="section-1-3-2"></a> **`1.3.2. Traffic Black-Holing on Individual AC Failures`**
...
<a id="section-1-4"></a> **`1.4. The Need for Extending the Default DF Election in EVPN Services`**
...
<a id="section-2"></a> **`2. Designated Forwarder Election Protocol and BGP Extensions`**
...
<a id="section-2-1"></a> **`2.1. The DF Election Finite State Machine (FSM)`**
...
<a id="section-2-2"></a> **`2.2. The DF Election Extended Community`**
...
<a id="section-2-2-1"></a> **`2.2.1. Backward Compatibility`**
...
<a id="section-3"></a> **`3. The Highest Random Weight DF Election Algorithm`**
...
<a id="section-3-1"></a> **`3.1. HRW and Consistent Hashing`**
...
<a id="section-3-2"></a> **`3.2. HRW Algorithm for EVPN DF Election`**
...
<a id="section-4"></a> **`4. The AC-Influenced DF Election Capability`**
...
<a id="section-4-1"></a> **`4.1. AC-Influenced DF Election Capability for VLAN-Aware Bundle`**
...
<a id="section-5"></a> **`5. Solution Benefits`**
