...
`   `[`2`](#section-2)`. Semantics of Source-Specific Multicast Addresses`

`   `[`3`](#section-3)`. Terminology`

`   `[`4`](#section-4)`. Host Requirements`

`      `[`4.1`](#section-4-1)`. Extensions to the IP Module Interface`

`      `[`4.2`](#section-4-2)`. Requirements on the Host IP Module`

`      `[`4.3`](#section-4-3)`. Allocation of Source-Specific Multicast Addresses`

`   `[`5`](#section-5)`. Router Requirements`

`      `[`5.1`](#section-5-1)`. Packet Forwarding`

`      `[`5.2`](#section-5-2)`. Protocols`

`   `[`6`](#section-6)`. Link-Layer Transmission of Datagrams`

`   `[`7`](#section-7)`. Security Considerations`

`      `[`7.1`](#section-7-1)`. IPsec and SSM`

`      `[`7.2`](#section-7-2)`. SSM and RFC 2401 IPsec Caveats`

`      `[`7.3`](#section-7-3)`. Denial of Service`

`      `[`7.4`](#section-7-4)`. Spoofed Source Addresses`

`      `[`7.5`](#section-7-5)`. Administrative Scoping`

`   `[`8`](#section-8)`. Transition Considerations`
...
<a id="section-2"></a> **`2. Semantics of Source-Specific Multicast Addresses`**
...
<a id="section-4"></a> **`4. Host Requirements`**
...
<a id="section-4-1"></a> **`4.1. Extensions to the IP Module Interface`**
...
<a id="section-4-2"></a> **`4.2. Requirements on the Host IP Module`**
...
<a id="section-4-3"></a> **`4.3. Allocation of Source-Specific Multicast Addresses`**
...
<a id="section-5"></a> **`5. Router Requirements`**

```text

```

<a id="section-5-1"></a> **`5.1. Packet Forwarding`**
...
<a id="section-5-2"></a> **`5.2. Protocols`**
...
<a id="section-6"></a> **`6. Link-Layer Transmission of Datagrams`**
...
<a id="section-7-1"></a> **`7.1. IPsec and SSM`**
...
<a id="section-7-2"></a> **`7.2. SSM and RFC 2401 IPsec Caveats`**
...
<a id="section-7-3"></a> **`7.3. Denial of Service`**
...
<a id="section-7-4"></a> **`7.4. Spoofed Source Addresses`**
...
<a id="section-7-5"></a> **`7.5. Administrative Scoping`**
...
<a id="section-8"></a> **`8. Transition Considerations`**
