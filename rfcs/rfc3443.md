...
<a id="section-1"></a> **`1. Introduction and Motivation`**
...
<a id="section-2"></a> **`2. TTL Processing in MPLS Networks`**

```text

```

<a id="section-2-1"></a> **`2.1. Changes to RFC 3032 [MPLS-ENCAPS]`**
...
<a id="section-2-2"></a> **`2.2. Terminology and Background`**
...
<a id="section-2-3"></a> **`2.3. New Terminology`**
...
<a id="section-3"></a> **`3. TTL Processing in different Models`**
...
<a id="section-3-1"></a> **`3.1. TTL Processing for Uniform Model LSPs (with or without PHP)`**
...
<a id="section-3-2"></a> **`3.2. TTL Processing for Short Pipe Model LSPs`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. TTL Processing for Short Pipe Model LSPs without PHP`**
...
<a id="section-3-2-2"></a> **`3.2.2. TTL Processing for Short Pipe Model with PHP:`**
...
<a id="section-3-3"></a> **`3.3. TTL Processing for Pipe Model LSPs (without PHP only):`**
...
<a id="section-3-4"></a> **`3.4. Incoming TTL (iTTL) determination`**
...
<a id="section-3-5"></a> **`3.5. Outgoing TTL Determination and Packet Processing`**
...
<a id="section-3-6"></a> **`3.6. Tunnel Ingress Processing (Push)`**
...
<a id="section-3-7"></a> **`3.7. Implementation Remarks`**
...
<a id="section-8"></a> **`8. Author's Addresses`**
