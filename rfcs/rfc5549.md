...
`   `[`3`](#section-3)`. Extension of AFI/SAFI Definitions for the IPv4 Address Family`

`   `[`4`](#section-4)`. Use of BGP Capability Advertisement`

`   `[`5`](#section-5)`. Operations`

`   `[`6`](#section-6)`. Usage Examples`

`      `[`6.1`](#section-6-1)`. IPv4 over IPv6 Core`

`      `[`6.2`](#section-6-2)`. IPv4 VPN over IPv6 Core`
...
<a id="section-3"></a> **`3. Extension of AFI/SAFI Definitions for the IPv4 Address Family`**
...
<a id="section-4"></a> **`4. Use of BGP Capability Advertisement`**
...
<a id="section-6"></a> **`6. Usage Examples`**

```text

```

<a id="section-6-1"></a> **`6.1. IPv4 over IPv6 Core`**
...
<a id="section-6-2"></a> **`6.2. IPv4 VPN over IPv6 Core`**
