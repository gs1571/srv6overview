...
`     `[`1`](#section-1)`. 2 Using stringprep in protocols`

`   `[`2`](#section-2)`. Preparation Overview`

`   `[`3`](#section-3)`. Mapping`

`     `[`3`](#section-3)`. 1 Commonly mapped to nothing`

`     `[`3`](#section-3)`. 2 Case folding`

`   `[`4`](#section-4)`. Normalization`

`   `[`5`](#section-5)`. Prohibited Output`

`     `[`5`](#section-5)`. 1 Space characters`

`     `[`5`](#section-5)`. 2 Control characters`

`     `[`5`](#section-5)`. 3 Private use`

`     `[`5`](#section-5)`. 4 Non-character code points`

`     `[`5`](#section-5)`. 5 Surrogate codes`

`     `[`5`](#section-5)`. 6 Inappropriate for plain text`

`     `[`5`](#section-5)`. 7 Inappropriate for canonical representation`

`     `[`5`](#section-5)`. 8 Change display properties or deprecated`

`     `[`5`](#section-5)`. 9 Tagging characters`

`   `[`6`](#section-6)`. Bidirectional Characters`

`   `[`7`](#section-7)`. Unassigned Code Points in Stringprep Profiles`

`     `[`7`](#section-7)`. 1 Categories of code points`

`     `[`7`](#section-7)`. 2 Reasons for difference between stored strings and queries`

`     `[`7`](#section-7)`. 3 Versions of applications and stored strings`

`   `[`8`](#section-8)`. References`

`     `[`8`](#section-8)`. 1 Normative references`

`     `[`8`](#section-8)`. 2 Informative references`

`   `[`9`](#section-9)`. Security Considerations`

`     `[`9`](#section-9)`. 1 Stringprep-specific security considerations`

`     `[`9`](#section-9)`. 2 Generic Unicode security considerations`
...
<a id="section-2"></a> **`2. Preparation Overview`**
...
<a id="section-4"></a> **`4. Normalization`**
...
<a id="section-5"></a> **`5. Prohibited Output`**
...
<a id="section-6"></a> **`6. Bidirectional Characters`**
...
<a id="section-7"></a> **`7. Unassigned Code Points in Stringprep Profiles`**
