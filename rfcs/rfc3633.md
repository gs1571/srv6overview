...
`   `[`2`](#section-2)`. DHCPv6 specification dependency`

`   `[`3`](#section-3)`. Terminology`

`   `[`4`](#section-4)`. Requirements`

`   `[`5`](#section-5)`. Model and Applicability`

`        `[`5.1`](#section-5-1)`. Example network architecture`

`   `[`6`](#section-6)`. Identity Association for Prefix Delegation`

`   `[`7`](#section-7)`. Overview of DHCP with Prefix Delegation`

`   `[`8`](#section-8)`. Interface Selection`

`   `[`9`](#section-9)`. Identity Association for Prefix Delegation Option`

`   `[`10`](#section-10)`. IA_PD Prefix option`

`   `[`11`](#section-11)`. Delegating Router Solicitation`

`        `[`11.1`](#section-11-1)`. Requesting router behavior`

`        `[`11.2`](#section-11-2)`. Delegating router behavior`

`   `[`12`](#section-12)`. Requesting router initiated prefix delegation`

`        `[`12.1`](#section-12-1)`. Requesting router behavior`

`        `[`12.2`](#section-12-2)`. Delegating Router behavior`

`   `[`13`](#section-13)`. Prefix Delegation reconfiguration`

`        `[`13.1`](#section-13-1)`. Delegating Router behavior`

`        `[`13.2`](#section-13-2)`. Requesting Router behavior`

`   `[`14`](#section-14)`. Relay agent behavior`

`   `[`15`](#section-15)`. Security Considerations`

`   `[`16`](#section-16)`. IANA Considerations`

`   `[`17`](#section-17)`. Intellectual Property Statement`
...
`   `[`20`](#section-20)`. Authors' Addresses`
...
<a id="section-2"></a> **`2. DHCPv6 specification dependency`**
...
<a id="section-5"></a> **`5. Model and Applicability`**
...
<a id="section-5-1"></a> **`5.1. Example network architecture`**
...
<a id="section-6"></a> **`6. Identity Association for Prefix Delegation`**
...
<a id="section-7"></a> **`7. Overview of DHCP with Prefix Delegation`**
...
<a id="section-8"></a> **`8. Interface Selection`**
...
<a id="section-9"></a> **`9. Identity Association for Prefix Delegation Option`**
...
<a id="section-10"></a> **`10. IA_PD Prefix option`**
...
<a id="section-11"></a> **`11. Delegating Router Solicitation`**
...
<a id="section-11-1"></a> **`11.1. Requesting router behavior`**
...
<a id="section-11-2"></a> **`11.2. Delegating router behavior`**
...
<a id="section-12"></a> **`12. Requesting router initiated prefix delegation`**
...
<a id="section-12-1"></a> **`12.1. Requesting router behavior`**
...
<a id="section-12-2"></a> **`12.2. Delegating Router behavior`**
...
<a id="section-13"></a> **`13. Prefix Delegation reconfiguration`**
...
<a id="section-13-1"></a> **`13.1. Delegating Router behavior`**
...
<a id="section-13-2"></a> **`13.2. Requesting Router behavior`**
...
<a id="section-14"></a> **`14. Relay agent behavior`**
...
<a id="section-17"></a> **`17. Intellectual Property Statement`**
...
<a id="section-20"></a> **`20. Authors' Addresses`**
