...
`   `[`1`](#section-1)`. Justification`

`   `[`2`](#section-2)`. Current RIP`

`   `[`3`](#section-3)`. Basic Protocol`

`   `[`3.1`](#section-3-1)`. Introduction`

`   `[`3.2`](#section-3-2)`. Limitations of the Protocol`

`   `[`3.3`](#section-3-3)`. Organization of this document`

`   `[`3.4`](#section-3-4)`. Distance Vector Algorithms`

`   `[`3.4.1`](#section-3-4-1)`. Dealing with changes in topology`

`   `[`3.4.2`](#section-3-4-2)`. Preventing instability`

`   `[`3.4.3`](#section-3-4-3)`. Split horizon`

`   `[`3.4.4`](#section-3-4-4)`. Triggered updates`

`   `[`3.5`](#section-3-5)`. Protocol Specification`

`   `[`3.6`](#section-3-6)`. Message Format`

`   `[`3.7`](#section-3-7)`. Addressing Considerations`

`   `[`3.8`](#section-3-8)`. Timers`

`   `[`3.9`](#section-3-9)`. Input Processing`

`   `[`3.9.1`](#section-3-9-1)`. Request Messages`

`   `[`3.9.2`](#section-3-9-2)`. Response Messages`

`   `[`3.10`](#section-3-10)`. Output Processing`

`   `[`3.10.1`](#section-3-10-1)`. Triggered Updates`

`   `[`3.10.2`](#section-3-10-2)`. Generating Response Messages`

`   `[`4`](#section-4)`. Protocol Extensions`

`   `[`4.1`](#section-4-1)`. Authentication`

`   `[`4.2`](#section-4-2)`. Route Tag`

`   `[`4.3`](#section-4-3)`. Subnet Mask`

`   `[`4.4`](#section-4-4)`. Next Hop`

`   `[`4.5`](#section-4-5)`. Multicasting`

`   `[`4.6`](#section-4-6)`. Queries`

`   `[`5`](#section-5)`. Compatibility`

`   `[`5.1`](#section-5-1)`. Compatibility Switch`

`   `[`5.2`](#section-5-2)`. Authentication`

`   `[`5.3`](#section-5-3)`. Larger Infinity`

`   `[`5.4`](#section-5-4)`. Addressless Links`

`   `[`6`](#section-6)`. Interaction between version 1 and version 2`
...
<a id="section-1"></a> **`1. Justification`**
...
<a id="section-2"></a> **`2. Current RIP`**
...
<a id="section-3"></a> **`3. Basic Protocol`**
...
<a id="section-3-3"></a> **`3.3. Organization of this document`**
...
<a id="section-4"></a> **`4. Protocol Extensions`**
...
<a id="section-6"></a> **`6. Interaction between version 1 and version 2`**
