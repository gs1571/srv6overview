...
`   `[`2`](#section-2)`. OSPFv3 Default Configuration`

`   `[`3`](#section-3)`. OSPFv3 HelloInterval/RouterDeadInterval Flexibility`

`     `[`3.1`](#section-3-1)`. Wait Timer Reduction`

`   `[`4`](#section-4)`. OSPFv3 Minimal Authentication Configuration`

`   `[`5`](#section-5)`. OSPFv3 Router ID Selection`

`   `[`6`](#section-6)`. OSPFv3 Adjacency Formation`

`   `[`7`](#section-7)`. OSPFv3 Duplicate Router ID Detection and Resolution`

`     `[`7.1`](#section-7-1)`. Duplicate Router ID Detection for Neighbors`

`     `[`7.2`](#section-7-2)`. Duplicate Router ID Detection for Non-neighbors`

`       `[`7.2.1`](#section-7-2-1)`. OSPFv3 Router Autoconfiguration LSA`

`       `[`7.2.2`](#section-7-2-2)`. Router-Hardware-Fingerprint TLV`

`     `[`7.3`](#section-7-3)`. Duplicate Router ID Resolution`

`     `[`7.4`](#section-7-4)`. Change to RFC 2328, Section 13.4 ("Receiving`

`           Self-Originated LSAs")`

`   `[`8`](#section-8)`. Security Considerations`

`   `[`9`](#section-9)`. Management Considerations`
...
<a id="section-2"></a> **`2. OSPFv3 Default Configuration`**
...
<a id="section-3"></a> **`3. OSPFv3 HelloInterval/RouterDeadInterval Flexibility`**
...
<a id="section-3-1"></a> **`3.1. Wait Timer Reduction`**
...
<a id="section-4"></a> **`4. OSPFv3 Minimal Authentication Configuration`**
...
<a id="section-5"></a> **`5. OSPFv3 Router ID Selection`**
...
<a id="section-6"></a> **`6. OSPFv3 Adjacency Formation`**
...
<a id="section-7"></a> **`7. OSPFv3 Duplicate Router ID Detection and Resolution`**
...
<a id="section-7-1"></a> **`7.1. Duplicate Router ID Detection for Neighbors`**
...
<a id="section-7-2"></a> **`7.2. Duplicate Router ID Detection for Non-neighbors`**
...
<a id="section-7-2-1"></a> **`7.2.1. OSPFv3 Router Autoconfiguration LSA`**
...
<a id="section-7-2-2"></a> **`7.2.2. Router-Hardware-Fingerprint TLV`**
...
<a id="section-7-3"></a> **`7.3. Duplicate Router ID Resolution`**
...
<a id="section-7-4"></a> **`7.4. Change to RFC 2328, Section 13.4 ("Receiving Self-Originated`**
...
<a id="section-9"></a> **`9. Management Considerations`**
