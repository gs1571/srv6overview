...
`      `[`1.3`](#section-1-3)`. Document Status`

`   `[`2`](#section-2)`. Normative: Transport Layer Security for RADIUS/TCP`

`      `[`2.1`](#section-2-1)`. TCP port and Packet Types`

`      `[`2.2`](#section-2-2)`. TLS Negotiation`

`      `[`2.3`](#section-2-3)`. Connection Setup`

`      `[`2.4`](#section-2-4)`. Connecting Client Identity`

`      `[`2.5`](#section-2-5)`. RADIUS Datagrams`

`   `[`3`](#section-3)`. Informative: Design Decisions`

`      `[`3.1`](#section-3-1)`. Implications of Dynamic Peer Discovery`

`      `[`3.2`](#section-3-2)`. X.509 Certificate Considerations`

`      `[`3.3`](#section-3-3)`. Ciphersuites and Compression Negotiation Considerations`

`      `[`3.4`](#section-3-4)`. RADIUS Datagram Considerations`

`   `[`4`](#section-4)`. Compatibility with Other RADIUS Transports`

`   `[`5`](#section-5)`. Diameter Compatibility`
...
<a id="section-1-3"></a> **`1.3. Document Status`**
...
<a id="section-2"></a> **`2. Normative: Transport Layer Security for RADIUS/TCP`**

```text

```

<a id="section-2-1"></a> **`2.1. TCP port and Packet Types`**
...
<a id="section-2-2"></a> **`2.2. TLS Negotiation`**
...
<a id="section-2-3"></a> **`2.3. Connection Setup`**
...
<a id="section-2-4"></a> **`2.4. Connecting Client Identity`**
...
<a id="section-2-5"></a> **`2.5. RADIUS Datagrams`**
...
<a id="section-3"></a> **`3. Informative: Design Decisions`**
...
<a id="section-3-1"></a> **`3.1. Implications of Dynamic Peer Discovery`**
...
<a id="section-3-2"></a> **`3.2. X.509 Certificate Considerations`**
...
<a id="section-3-3"></a> **`3.3. Ciphersuites and Compression Negotiation Considerations`**
...
<a id="section-3-4"></a> **`3.4. RADIUS Datagram Considerations`**
...
<a id="section-4"></a> **`4. Compatibility with Other RADIUS Transports`**
...
<a id="section-5"></a> **`5. Diameter Compatibility`**
