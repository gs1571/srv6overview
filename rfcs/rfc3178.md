...
<a id="section-2"></a> **`2. Goals and non-goals`**
...
<a id="section-3"></a> **`3. Basic mechanisms`**
...
<a id="section-4"></a> **`4. Extensions for IPv6`**
...
<a id="section-4-1"></a> **`4.1. IPv6 rule conformance`**
...
<a id="section-4-2"></a> **`4.2. Address assignment to the nodes`**
...
<a id="section-4-3"></a> **`4.3. Configuration of links`**
...
<a id="section-4-4"></a> **`4.4. Using RFC 2260 with IPv6 and BGP4+`**
...
<a id="section-4-5"></a> **`4.5. Using RFC 2260 with IPv6 and RIPng`**
...
<a id="section-5"></a> **`5. Issues with ingress filters in ISP`**
...
<a id="section-6"></a> **`6. Observations`**
...
<a id="section-7"></a> **`7. Operational experiences`**
