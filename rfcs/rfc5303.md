...
`   `[`2`](#section-2)`. Overview of Extensions`

`      `[`2.1`](#section-2-1)`. Handshaking`

`      `[`2.2`](#section-2-2)`. More than 256 Interfaces`

`   `[`3`](#section-3)`. Details`

`      `[`3.1`](#section-3-1)`. Syntax`

`      `[`3.2`](#section-3-2)`. Elements of Procedure`

`   `[`4`](#section-4)`. IANA Considerations`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. Changes from RFC 3373`
...
<a id="section-2"></a> **`2. Overview of Extensions`**
...
<a id="section-2-1"></a> **`2.1. Handshaking`**
...
<a id="section-2-2"></a> **`2.2. More than 256 Interfaces`**
...
<a id="section-3-2"></a> **`3.2. Elements of Procedure`**
...
<a id="section-6"></a> **`6. Changes from RFC 3373`**
