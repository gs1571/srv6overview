...
`   `[`2`](#section-2)`. Terminology and Reference Models`

`      `[`2.1`](#section-2-1)`. Terminology`

`      `[`2.2`](#section-2-2)`. Reference Models`

`      `[`2.3`](#section-2-3)`. Requirements and Design Constraint`

`   `[`3`](#section-3)`. Emulated Services`

`   `[`4`](#section-4)`. CESoPSN Encapsulation Layer`

`      `[`4.1`](#section-4-1)`. CESoPSN Packet Format`

`      `[`4.2`](#section-4-2)`. PSN and Multiplexing Layer Headers`

`      `[`4.3`](#section-4-3)`. CESoPSN Control Word`

`      `[`4.4`](#section-4-4)`. Usage of the RTP Header`

`   `[`5`](#section-5)`. CESoPSN Payload Layer`

`      `[`5.1`](#section-5-1)`. Common Payload Format Considerations`

`      `[`5.2`](#section-5-2)`. Basic NxDS0 Services`

`      `[`5.3`](#section-5-3)`. Extending Basic NxDS0 Services with CE Application`

`           Signaling`

`      `[`5.4`](#section-5-4)`. Trunk-Specific NxDS0 Services with CAS`

`   `[`6`](#section-6)`. CESoPSN Operation`

`      `[`6.1`](#section-6-1)`. Common Considerations`

`      `[`6.2`](#section-6-2)`. IWF Operation`

`           `[`6.2.1`](#section-6-2-1)`. PSN-Bound Direction`

`           `[`6.2.2`](#section-6-2-2)`. CE-Bound Direction`

`      `[`6.3`](#section-6-3)`. CESoPSN Defects`

`      `[`6.4`](#section-6-4)`. CESoPSN PW Performance Monitoring`

`   `[`7`](#section-7)`. QoS Issues`

`   `[`8`](#section-8)`. Congestion Control`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. IANA Considerations`

`   `[`11`](#section-11)`. Applicability Statement`
...
<a id="section-2"></a> **`2. Terminology and Reference Models`**
...
<a id="section-2-2"></a> **`2.2. Reference Models`**
...
<a id="section-2-3"></a> **`2.3. Requirements and Design Constraints`**
...
<a id="section-3"></a> **`3. Emulated Services`**
...
<a id="section-4"></a> **`4. CESoPSN Encapsulation Layer`**

```text

```

<a id="section-4-1"></a> **`4.1. CESoPSN Packet Format`**
...
<a id="section-4-2"></a> **`4.2. PSN and Multiplexing Layer Headers`**
...
<a id="section-4-3"></a> **`4.3. CESoPSN Control Word`**
...
<a id="section-4-4"></a> **`4.4. Usage of the RTP Header`**
...
<a id="section-5"></a> **`5. CESoPSN Payload Layer`**

```text

```

<a id="section-5-1"></a> **`5.1. Common Payload Format Considerations`**
...
<a id="section-5-2"></a> **`5.2. Basic NxDS0 Services`**
...
<a id="section-5-3"></a> **`5.3. Extending Basic NxDS0 Services with CE Application Signaling`**
...
<a id="section-5-4"></a> **`5.4. Trunk-Specific NxDS0 Services with CAS`**
...
<a id="section-6"></a> **`6. CESoPSN Operation`**

```text

```

<a id="section-6-1"></a> **`6.1. Common Considerations`**
...
<a id="section-6-2"></a> **`6.2. IWF Operation`**

```text

```

<a id="section-6-2-1"></a> **`6.2.1. PSN-Bound Direction`**
...
<a id="section-6-2-2"></a> **`6.2.2. CE-Bound Direction`**
...
<a id="section-6-3"></a> **`6.3. CESoPSN Defects`**
...
<a id="section-6-4"></a> **`6.4. CESoPSN PW Performance Monitoring`**
...
<a id="section-8"></a> **`8. Congestion Control`**
...
<a id="section-11"></a> **`11. Applicability Statement`**
