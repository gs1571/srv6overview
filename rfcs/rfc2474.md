...
`   `[`2`](#section-2)`. Terminology Used in This Document`

`   `[`3`](#section-3)`. Differentiated Services Field Definition`

`   `[`4`](#section-4)`. Historical Codepoint Definitions and PHB Requirements`

`     `[`4.1`](#section-4-1)`. A Default PHB`

`     `[`4.2`](#section-4-2)`. Once and Future IP Precedence Field Use`

`       `[`4.2.1`](#section-4-2-1)`. IP Precedence History and Evolution in Brief`

`       `[`4.2.2`](#section-4-2-2)`. Subsuming IP Precedence into Class Selector`

`              Codepoints`

`         `[`4.2.2.1`](#section-4-2-2-1)`. The Class Selector Codepoints`

`         `[`4.2.2.2`](#section-4-2-2-2)`. The Class Selector PHB Requirements`

`         `[`4.2.2.3`](#section-4-2-2-3)`. Using the Class Selector PHB Requirements`

`                  for IP Precedence Compatibility`

`         `[`4.2.2.4`](#section-4-2-2-4)`. Example Mechanisms for Implementing Class`

`                  Selector Compliant PHB Groups`

`     `[`4.3`](#section-4-3)`. Summary`

`   `[`5`](#section-5)`. Per-Hop Behavior Standardization Guidelines`

`   `[`6`](#section-6)`. IANA Considerations`

`   `[`7`](#section-7)`. Security Considerations`

`     `[`7.1`](#section-7-1)`. Theft and Denial of Service`

`     `[`7.2`](#section-7-2)`. IPsec and Tunneling Interactions`
...
<a id="section-2"></a> **`2. Terminology Used in This Document`**
...
<a id="section-3"></a> **`3. Differentiated Services Field Definition`**
...
<a id="section-4"></a> **`4. Historical Codepoint Definitions and PHB Requirements`**
...
<a id="section-5"></a> **`5. Per-Hop Behavior Standardization Guidelines`**
