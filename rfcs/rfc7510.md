...
`     `[`1.1`](#section-1-1)`. Existing Encapsulations`

`     `[`1.2`](#section-1-2)`. Motivations for MPLS-in-UDP Encapsulation`

`     `[`1.3`](#section-1-3)`. Applicability Statements`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Encapsulation in UDP`

`     `[`3.1`](#section-3-1)`. UDP Checksum Usage with IPv6`

`     `[`3.2`](#section-3-2)`. Middlebox Considerations for IPv6 UDP Zero Checksums  .`

`   `[`4`](#section-4)`. Processing Procedures`

`   `[`5`](#section-5)`. Congestion Considerations`
...
<a id="section-1-1"></a> **`1.1. Existing Encapsulations`**
...
<a id="section-1-2"></a> **`1.2. Motivations for MPLS-in-UDP Encapsulation`**
...
<a id="section-1-3"></a> **`1.3. Applicability Statements`**
...
<a id="section-3"></a> **`3. Encapsulation in UDP`**
...
<a id="section-3-1"></a> **`3.1. UDP Checksum Usage with IPv6`**
...
<a id="section-3-2"></a> **`3.2. Middlebox Considerations for IPv6 UDP Zero Checksums`**
...
<a id="section-4"></a> **`4. Processing Procedures`**
...
<a id="section-5"></a> **`5. Congestion Considerations`**
