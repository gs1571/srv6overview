...
`      `[`1.2`](#section-1-2)`. Summary of Changes from RFC 6506`

`   `[`2`](#section-2)`. Proposed Solution`

`      `[`2.1`](#section-2-1)`. AT-Bit in Options Field`

`      `[`2.2`](#section-2-2)`. Basic Operation`

`      `[`2.3`](#section-2-3)`. IPv6 Source Address Protection`

`   `[`3`](#section-3)`. OSPFv3 Security Association`

`   `[`4`](#section-4)`. Authentication Procedure`

`      `[`4.1`](#section-4-1)`. Authentication Trailer`

`           `[`4.1.1`](#section-4-1-1)`. Sequence Number Wrap`

`      `[`4.2`](#section-4-2)`. OSPFv3 Header Checksum and LLS Data Block Checksum`

`      `[`4.3`](#section-4-3)`. Cryptographic Authentication Procedure`

`      `[`4.4`](#section-4-4)`. Cross-Protocol Attack Mitigation`

`      `[`4.5`](#section-4-5)`. Cryptographic Aspects`

`      `[`4.6`](#section-4-6)`. Message Verification`

`   `[`5`](#section-5)`. Migration and Backward Compatibility`
...
<a id="section-1-2"></a> **`1.2. Summary of Changes from RFC 6506`**
...
<a id="section-2"></a> **`2. Proposed Solution`**
...
<a id="section-2-1"></a> **`2.1. AT-Bit in Options Field`**
...
<a id="section-2-2"></a> **`2.2. Basic Operation`**
...
<a id="section-2-3"></a> **`2.3. IPv6 Source Address Protection`**
...
<a id="section-3"></a> **`3. OSPFv3 Security Association`**
...
<a id="section-4"></a> **`4. Authentication Procedure`**

```text

```

<a id="section-4-1"></a> **`4.1. Authentication Trailer`**
...
<a id="section-4-1-1"></a> **`4.1.1. Sequence Number Wrap`**
...
<a id="section-4-2"></a> **`4.2. OSPFv3 Header Checksum and LLS Data Block Checksum`**
...
<a id="section-4-3"></a> **`4.3. Cryptographic Authentication Procedure`**
...
<a id="section-4-4"></a> **`4.4. Cross-Protocol Attack Mitigation`**
...
<a id="section-4-5"></a> **`4.5. Cryptographic Aspects`**
...
<a id="section-4-6"></a> **`4.6. Message Verification`**
...
<a id="section-5"></a> **`5. Migration and Backward Compatibility`**
