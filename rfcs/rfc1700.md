...
<a id="section-1-0-94-0-0-0"></a> **`1.0.94.0.0.0. See the next section on "IANA ETHERNET ADDRESS BLOCK".`**
...
<a id="section-1"></a> **`1. If h < 64, the host table address corresponds to the X.25`**
...
<a id="section-2"></a> **`2. If h > 64 or h = 64, the host table address corresponds to the`**
