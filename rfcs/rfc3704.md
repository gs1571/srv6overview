...
`   `[`2`](#section-2)`. Different Ways to Implement Ingress Filtering`

`       `[`2`](#section-2)`. 1 Ingress Access Lists`

`       `[`2`](#section-2)`. 2 Strict Reverse Path Forwarding`

`       `[`2`](#section-2)`. 3 Feasible Path Reverse Path Forwarding`

`       `[`2`](#section-2)`. 4 Loose Reverse Path Forwarding`

`       `[`2`](#section-2)`. 5 Loose Reverse Path Forwarding Ignoring Default Routes  .`

`   `[`3`](#section-3)`. Clarifying the Applicability of Ingress Filtering`

`       `[`3`](#section-3)`. 1 Ingress Filtering at Multiple Levels`

`       `[`3`](#section-3)`. 2 Ingress Filtering to Protect Your Own Infrastructure`

`       `[`3`](#section-3)`. 3 Ingress Filtering on Peering Links`

`   `[`4`](#section-4)`. Solutions to Ingress Filtering with Multihoming`

`       `[`4`](#section-4)`. 1 Use Loose RPF When Appropriate`

`       `[`4`](#section-4)`. 2 Ensure That Each ISP's Ingress Filter Is Complete`

`       `[`4`](#section-4)`. 3 Send Traffic Using a Provider Prefix Only to That Provider 11`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. Conclusions and Future Work`
...
<a id="section-2"></a> **`2. Different Ways to Implement Ingress Filtering`**
...
<a id="section-2-1"></a> **`2.1. Ingress Access Lists`**
...
<a id="section-2-2"></a> **`2.2. Strict Reverse Path Forwarding`**
...
<a id="section-2-3"></a> **`2.3. Feasible Path Reverse Path Forwarding`**
...
<a id="section-2-4"></a> **`2.4. Loose Reverse Path Forwarding`**
...
<a id="section-2-5"></a> **`2.5. Loose Reverse Path Forwarding Ignoring Default Routes`**
...
<a id="section-3"></a> **`3. Clarifying the Applicability of Ingress Filtering`**
...
<a id="section-3-1"></a> **`3.1. Ingress Filtering at Multiple Levels`**
...
<a id="section-3-2"></a> **`3.2. Ingress Filtering to Protect Your Own Infrastructure`**
...
<a id="section-3-3"></a> **`3.3. Ingress Filtering on Peering Links`**
...
<a id="section-4"></a> **`4. Solutions to Ingress Filtering with Multihoming`**
...
<a id="section-4-1"></a> **`4.1. Use Loose RPF When Appropriate`**
...
<a id="section-4-2"></a> **`4.2. Ensure That Each ISP's Ingress Filter Is Complete`**
...
<a id="section-4-3"></a> **`4.3. Send Traffic Using a Provider Prefix Only to That Provider`**
...
<a id="section-6"></a> **`6. Conclusions and Future Work`**
