...
<a id="section-2"></a> **`2. Acknowledgments`**
...
<a id="section-3"></a> **`3. Introduction`**
...
<a id="section-4"></a> **`4. Definition of the Administratively Scoped IPv4 Multicast Space`**
...
<a id="section-6"></a> **`6. The Structure of the Administratively Scoped Multicast Space`**
...
<a id="section-6-1"></a> **`6.1. The IPv4 Local Scope -- 239.255.0.0/16`**
...
<a id="section-6-2"></a> **`6.2. The IPv4 Organization Local Scope -- 239.192.0.0/14`**
...
<a id="section-6-2-1"></a> **`6.2.1. Expansion of the IPv4 Organization Local Scope`**
...
<a id="section-6-3"></a> **`6.3. Other IPv4 Scopes of Interest`**
...
<a id="section-7"></a> **`7. Topological Requirements for Administrative Boundaries`**
...
<a id="section-8"></a> **`8. Partitioning of the Administratively Scoped Multicast Space`**
...
<a id="section-9"></a> **`9. Structure and Use of a Scoped Region`**
...
<a id="section-9-1"></a> **`9.1. Relative Assignment Guidelines`**
...
<a id="section-12"></a> **`12. Author's Address`**
