...
<a id="section-2"></a> **`2. Terminology Related to Service Level Agreements (SLAs)`**
...
<a id="section-3"></a> **`3. Usage of PHB Group`**
...
<a id="section-4"></a> **`4. Definition of the DS Field`**
...
<a id="section-5"></a> **`5. Ordered Aggregates and PHB Scheduling Classes`**
...
<a id="section-6"></a> **`6. Unknown/Improperly Mapped DSCPs`**
...
<a id="section-7"></a> **`7. No Backward Compatibility With RFC 1349`**
...
<a id="section-9"></a> **`9. Summary of Pending Changes`**
