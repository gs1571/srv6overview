...
`   `[`2`](#section-2)`. Uses of EAP for Application-Layer Access`

`      `[`2.1`](#section-2-1)`. Retransmission`

`      `[`2.2`](#section-2-2)`. Re-authentication`

`   `[`3`](#section-3)`. Revised EAP Applicability Statement`
...
<a id="section-2"></a> **`2. Uses of EAP for Application-Layer Access`**
...
<a id="section-2-1"></a> **`2.1. Retransmission`**
...
<a id="section-2-2"></a> **`2.2. Re-authentication`**
...
<a id="section-3"></a> **`3. Revised EAP Applicability Statement`**
