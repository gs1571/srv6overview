...
`   `[`2`](#section-2)`. RADIUS Support for EAP`

`       `[`2.1`](#section-2-1)`. Protocol Overview`

`       `[`2.2`](#section-2-2)`. Invalid Packets`

`       `[`2.3`](#section-2-3)`. Retransmission`

`       `[`2.4`](#section-2-4)`. Fragmentation`

`       `[`2.5`](#section-2-5)`. Alternative uses`

`       `[`2.6`](#section-2-6)`. Usage Guidelines`

`   `[`3`](#section-3)`. Attributes`

`       `[`3.1`](#section-3-1)`. EAP-Message`

`       `[`3.2`](#section-3-2)`. Message-Authenticator`

`       `[`3.3`](#section-3-3)`. Table of Attributes`

`   `[`4`](#section-4)`. Security Considerations`

`       `[`4.1`](#section-4-1)`. Security Requirements`

`       `[`4.2`](#section-4-2)`. Security Protocol`

`       `[`4.3`](#section-4-3)`. Security Issues`
...
<a id="section-2"></a> **`2. RADIUS Support for EAP`**
...
<a id="section-2-1"></a> **`2.1. Protocol Overview`**
...
<a id="section-2-2"></a> **`2.2. Invalid Packets`**
...
<a id="section-2-3"></a> **`2.3. Retransmission`**
...
<a id="section-2-4"></a> **`2.4. Fragmentation`**
...
<a id="section-2-5"></a> **`2.5. Alternative Uses`**
...
<a id="section-2-6"></a> **`2.6. Usage Guidelines`**

```text

```

<a id="section-2-6-1"></a> **`2.6.1. Identifier Space`**
...
<a id="section-2-6-2"></a> **`2.6.2. Role Reversal`**
...
<a id="section-2-6-3"></a> **`2.6.3. Conflicting Messages`**
...
<a id="section-2-6-4"></a> **`2.6.4. Priority`**
...
<a id="section-2-6-5"></a> **`2.6.5. Displayable Messages`**
...
<a id="section-3-1"></a> **`3.1. EAP-Message`**
...
<a id="section-3-2"></a> **`3.2. Message-Authenticator`**
...
<a id="section-3-3"></a> **`3.3. Table of Attributes`**
...
<a id="section-4-1"></a> **`4.1. Security Requirements`**
...
<a id="section-4-2"></a> **`4.2. Security Protocol`**
...
<a id="section-4-3"></a> **`4.3. Security Issues`**
...
<a id="section-4-3-1"></a> **`4.3.1. Privacy Issues`**
...
<a id="section-4-3-2"></a> **`4.3.2. Spoofing and Hijacking`**
...
<a id="section-4-3-3"></a> **`4.3.3. Dictionary Attacks`**
...
<a id="section-4-3-4"></a> **`4.3.4. Known Plaintext Attacks`**
...
<a id="section-4-3-5"></a> **`4.3.5. Replay Attacks`**
...
<a id="section-4-3-6"></a> **`4.3.6. Negotiation Attacks`**
...
<a id="section-4-3-7"></a> **`4.3.7. Impersonation`**
...
<a id="section-4-3-8"></a> **`4.3.8. Man in the Middle Attacks`**
...
<a id="section-4-3-9"></a> **`4.3.9. Separation of Authenticator and Authentication Server`**
...
<a id="section-4-3-10"></a> **`4.3.10. Multiple Databases`**
