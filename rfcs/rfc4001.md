...
`   `[`4`](#section-4)`. Usage Hints`

`       `[`4.1`](#section-4-1)`. Table Indexing`

`       `[`4.2`](#section-4-2)`. Uniqueness of Addresses`

`       `[`4.3`](#section-4-3)`. Multiple Addresses per Host`

`       `[`4.4`](#section-4-4)`. Resolving DNS Names`

`   `[`5`](#section-5)`. Table Indexing Example`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Acknowledgments`

`   `[`8`](#section-8)`. Changes from RFC 3291 to RFC 4001`

`   `[`9`](#section-9)`. Changes from RFC 2851 to RFC 3291`
...
<a id="section-4"></a> **`4. Usage Hints`**
...
<a id="section-4-1"></a> **`4.1. Table Indexing`**
...
<a id="section-4-2"></a> **`4.2. Uniqueness of Addresses`**
...
<a id="section-4-3"></a> **`4.3. Multiple Addresses per Host`**
...
<a id="section-4-4"></a> **`4.4. Resolving DNS Names`**
...
<a id="section-5"></a> **`5. Table Indexing Example`**
...
<a id="section-8"></a> **`8. Changes from RFC 3291 to RFC 4001`**
...
<a id="section-9"></a> **`9. Changes from RFC 2851 to RFC 3291`**
