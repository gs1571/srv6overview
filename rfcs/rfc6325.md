...
`      `[`1.1`](#section-1-1)`. Algorhyme V2, by Ray Perlner`

`      `[`1.2`](#section-1-2)`. Normative Content and Precedence`

`      `[`1.3`](#section-1-3)`. Terminology and Notation in This Document`

`      `[`1.4`](#section-1-4)`. Categories of Layer 2 Frames`

`      `[`1.5`](#section-1-5)`. Acronyms`

`   `[`2`](#section-2)`. RBridges`

`      `[`2.1`](#section-2-1)`. General Overview`

`      `[`2.2`](#section-2-2)`. End-Station Addresses`

`      `[`2.3`](#section-2-3)`. RBridge Encapsulation Architecture`

`      `[`2.4`](#section-2-4)`. Forwarding Overview`

`           `[`2.4.1`](#section-2-4-1)`. Known-Unicast`

`           `[`2.4.2`](#section-2-4-2)`. Multi-Destination`

`      `[`2.5`](#section-2-5)`. RBridges and VLANs`

`           `[`2.5.1`](#section-2-5-1)`. Link VLAN Assumptions`

`      `[`2.6`](#section-2-6)`. RBridges and IEEE 802.1 Bridges`

`           `[`2.6.1`](#section-2-6-1)`. RBridge Ports and 802.1 Layering`

`           `[`2.6.2`](#section-2-6-2)`. Incremental Deployment`

`   `[`3`](#section-3)`. Details of the TRILL Header`

`      `[`3.1`](#section-3-1)`. TRILL Header Format`

`      `[`3.2`](#section-3-2)`. Version (V)`

`      `[`3.3`](#section-3-3)`. Reserved (R)`

`      `[`3.4`](#section-3-4)`. Multi-destination (M)`

`      `[`3.5`](#section-3-5)`. Op-Length`

`      `[`3.6`](#section-3-6)`. Hop Count`

`      `[`3.7`](#section-3-7)`. RBridge Nicknames`

`           `[`3.7.1`](#section-3-7-1)`. Egress RBridge Nickname`

`           `[`3.7.2`](#section-3-7-2)`. Ingress RBridge Nickname`

`           `[`3.7.3`](#section-3-7-3)`. RBridge Nickname Selection`

`      `[`3.8`](#section-3-8)`. TRILL Header Options`

`   `[`4`](#section-4)`. Other RBridge Design Details`

`      `[`4.1`](#section-4-1)`. Ethernet Data Encapsulation`

`           `[`4.1.1`](#section-4-1-1)`. VLAN Tag Information`

`           `[`4.1.2`](#section-4-1-2)`. Inner VLAN Tag`

`           `[`4.1.3`](#section-4-1-3)`. Outer VLAN Tag`

`           `[`4.1.4`](#section-4-1-4)`. Frame Check Sequence (FCS)`

`      `[`4.2`](#section-4-2)`. Link State Protocol (IS-IS)`

`           `[`4.2.1`](#section-4-2-1)`. IS-IS RBridge Identity`

`           `[`4.2.2`](#section-4-2-2)`. IS-IS Instances`

`           `[`4.2.3`](#section-4-2-3)`. TRILL IS-IS Frames`

`           `[`4.2.4`](#section-4-2-4)`. TRILL Link Hellos, DRBs, and Appointed Forwarders`

`                  `[`4.2.4.1`](#section-4-2-4-1)`. P2P Hello Links`

`                  `[`4.2.4.2`](#section-4-2-4-2)`. Designated RBridge`

`                  `[`4.2.4.3`](#section-4-2-4-3)`. Appointed VLAN-x Forwarder`

`                  `[`4.2.4.4`](#section-4-2-4-4)`. TRILL LSP Information`

`           `[`4.2.5`](#section-4-2-5)`. The TRILL ESADI Protocol`

`                  `[`4.2.5.1`](#section-4-2-5-1)`. TRILL ESADI Participation`

`                  `[`4.2.5.2`](#section-4-2-5-2)`. TRILL ESADI Information`

`           `[`4.2.6`](#section-4-2-6)`. SPF, Forwarding, and Ambiguous Destinations`

`      `[`4.3`](#section-4-3)`. Inter-RBridge Link MTU Size`

`           `[`4.3.1`](#section-4-3-1)`. Determining Campus-Wide TRILL IS-IS MTU Size`

`           `[`4.3.2`](#section-4-3-2)`. Testing Link MTU Size`

`      `[`4.4`](#section-4-4)`. TRILL-Hello Protocol`

`           `[`4.4.1`](#section-4-4-1)`. TRILL-Hello Rationale`

`           `[`4.4.2`](#section-4-4-2)`. TRILL-Hello Contents and Timing`

`                  `[`4.4.2.1`](#section-4-4-2-1)`. TRILL Neighbor List`

`           `[`4.4.3`](#section-4-4-3)`. TRILL MTU-Probe and TRILL Hello VLAN Tagging`

`           `[`4.4.4`](#section-4-4-4)`. Multiple Ports on the Same Link`

`           `[`4.4.5`](#section-4-4-5)`. VLAN Mapping within a Link`

`      `[`4.5`](#section-4-5)`. Distribution Trees`

`           `[`4.5.1`](#section-4-5-1)`. Distribution Tree Calculation`

`           `[`4.5.2`](#section-4-5-2)`. Multi-Destination Frame Checks`

`           `[`4.5.3`](#section-4-5-3)`. Pruning the Distribution Tree`

`           `[`4.5.4`](#section-4-5-4)`. Tree Distribution Optimization`

`           `[`4.5.5`](#section-4-5-5)`. Forwarding Using a Distribution Tree`

`      `[`4.6`](#section-4-6)`. Frame Processing Behavior`

`           `[`4.6.1`](#section-4-6-1)`. Receipt of a Native Frame`

`                  `[`4.6.1.1`](#section-4-6-1-1)`. Native Unicast Case`

`                  `[`4.6.1.2`](#section-4-6-1-2)`. Native Multicast and Broadcast Frames`

`           `[`4.6.2`](#section-4-6-2)`. Receipt of a TRILL Frame`

`                  `[`4.6.2.1`](#section-4-6-2-1)`. TRILL Control Frames`

`                  `[`4.6.2.2`](#section-4-6-2-2)`. TRILL ESADI Frames`

`                  `[`4.6.2.3`](#section-4-6-2-3)`. TRILL Data Frames`

`                  `[`4.6.2.4`](#section-4-6-2-4)`. Known Unicast TRILL Data Frames`

`                  `[`4.6.2.5`](#section-4-6-2-5)`. Multi-Destination TRILL Data Frames`

`           `[`4.6.3`](#section-4-6-3)`. Receipt of a Layer 2 Control Frame`

`      `[`4.7`](#section-4-7)`. IGMP, MLD, and MRD Learning`

`      `[`4.8`](#section-4-8)`. End-Station Address Details`

`           `[`4.8.1`](#section-4-8-1)`. Learning End-Station Addresses`

`           `[`4.8.2`](#section-4-8-2)`. Learning Confidence Level Rationale`

`           `[`4.8.3`](#section-4-8-3)`. Forgetting End-Station Addresses`

`           `[`4.8.4`](#section-4-8-4)`. Shared VLAN Learning`

`      `[`4.9`](#section-4-9)`. RBridge Ports`

`           `[`4.9.1`](#section-4-9-1)`. RBridge Port Configuration`

`           `[`4.9.2`](#section-4-9-2)`. RBridge Port Structure`

`           `[`4.9.3`](#section-4-9-3)`. BPDU Handling`

`                  `[`4.9.3.1`](#section-4-9-3-1)`. Receipt of BPDUs`

`                  `[`4.9.3.2`](#section-4-9-3-2)`. Root Bridge Changes`

`                  `[`4.9.3.3`](#section-4-9-3-3)`. Transmission of BPDUs`

`           `[`4.9.4`](#section-4-9-4)`. Dynamic VLAN Registration`

`   `[`5`](#section-5)`. RBridge Parameters`

`      `[`5.1`](#section-5-1)`. Per RBridge`

`      `[`5.2`](#section-5-2)`. Per Nickname Per RBridge`

`      `[`5.3`](#section-5-3)`. Per Port Per RBridge`

`      `[`5.4`](#section-5-4)`. Per VLAN Per RBridge`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. VLAN Security Considerations`

`      `[`6.2`](#section-6-2)`. BPDU/Hello Denial-of-Service Considerations`

`   `[`7`](#section-7)`. Assignment Considerations`

`      `[`7.1`](#section-7-1)`. IANA Considerations`

`      `[`7.2`](#section-7-2)`. IEEE Registration Authority Considerations`
...
<a id="section-1-1"></a> **`1.1. Algorhyme V2, by Ray Perlner`**
...
<a id="section-1-2"></a> **`1.2. Normative Content and Precedence`**
...
<a id="section-1-3"></a> **`1.3. Terminology and Notation in This Document`**
...
<a id="section-1-4"></a> **`1.4. Categories of Layer 2 Frames`**
...
<a id="section-1-5"></a> **`1.5. Acronyms`**
...
<a id="section-2-1"></a> **`2.1. General Overview`**
...
<a id="section-2-2"></a> **`2.2. End-Station Addresses`**
...
<a id="section-2-3"></a> **`2.3. RBridge Encapsulation Architecture`**
...
<a id="section-2-4"></a> **`2.4. Forwarding Overview`**
...
<a id="section-2-4-1"></a> **`2.4.1. Known-Unicast`**
...
<a id="section-2-4-2"></a> **`2.4.2. Multi-Destination`**
...
<a id="section-2-5"></a> **`2.5. RBridges and VLANs`**
...
<a id="section-2-5-1"></a> **`2.5.1. Link VLAN Assumptions`**
...
<a id="section-2-6"></a> **`2.6. RBridges and IEEE 802.1 Bridges`**
...
<a id="section-2-6-1"></a> **`2.6.1. RBridge Ports and 802.1 Layering`**
...
<a id="section-2-6-2"></a> **`2.6.2. Incremental Deployment`**
...
<a id="section-3"></a> **`3. Details of the TRILL Header`**
...
<a id="section-3-1"></a> **`3.1. TRILL Header Format`**
...
<a id="section-3-2"></a> **`3.2. Version (V)`**
...
<a id="section-3-3"></a> **`3.3. Reserved (R)`**
...
<a id="section-3-4"></a> **`3.4. Multi-destination (M)`**
...
<a id="section-3-5"></a> **`3.5. Op-Length`**
...
<a id="section-3-6"></a> **`3.6. Hop Count`**
...
<a id="section-3-7"></a> **`3.7. RBridge Nicknames`**
...
<a id="section-3-7-1"></a> **`3.7.1. Egress RBridge Nickname`**
...
<a id="section-3-7-2"></a> **`3.7.2. Ingress RBridge Nickname`**
...
<a id="section-3-7-3"></a> **`3.7.3. RBridge Nickname Selection`**
...
<a id="section-3-8"></a> **`3.8. TRILL Header Options`**
...
<a id="section-4"></a> **`4. Other RBridge Design Details`**
...
<a id="section-4-1"></a> **`4.1. Ethernet Data Encapsulation`**
...
<a id="section-4-1-1"></a> **`4.1.1. VLAN Tag Information`**
...
<a id="section-4-1-2"></a> **`4.1.2. Inner VLAN Tag`**
...
<a id="section-4-1-3"></a> **`4.1.3. Outer VLAN Tag`**
...
<a id="section-4-1-4"></a> **`4.1.4. Frame Check Sequence (FCS)`**
...
<a id="section-4-2"></a> **`4.2. Link State Protocol (IS-IS)`**
...
<a id="section-4-2-1"></a> **`4.2.1. IS-IS RBridge Identity`**
...
<a id="section-4-2-2"></a> **`4.2.2. IS-IS Instances`**
...
<a id="section-4-2-3"></a> **`4.2.3. TRILL IS-IS Frames`**
...
<a id="section-4-2-4"></a> **`4.2.4. TRILL Link Hellos, DRBs, and Appointed Forwarders`**
...
<a id="section-4-2-4-1"></a> **`4.2.4.1. P2P Hello Links`**
...
<a id="section-4-2-4-2"></a> **`4.2.4.2. Designated RBridge`**
...
<a id="section-4-2-4-3"></a> **`4.2.4.3. Appointed VLAN-x Forwarder`**
...
<a id="section-4-2-4-4"></a> **`4.2.4.4. TRILL LSP Information`**
...
<a id="section-4-2-5"></a> **`4.2.5. The TRILL ESADI Protocol`**
...
<a id="section-4-2-5-1"></a> **`4.2.5.1. TRILL ESADI Participation`**
...
<a id="section-4-2-5-2"></a> **`4.2.5.2. TRILL ESADI Information`**
...
<a id="section-4-2-6"></a> **`4.2.6. SPF, Forwarding, and Ambiguous Destinations`**
...
<a id="section-4-3"></a> **`4.3. Inter-RBridge Link MTU Size`**
...
<a id="section-4-3-1"></a> **`4.3.1. Determining Campus-Wide TRILL IS-IS MTU Size`**
...
<a id="section-4-3-2"></a> **`4.3.2. Testing Link MTU Size`**
...
<a id="section-4-4"></a> **`4.4. TRILL-Hello Protocol`**
...
<a id="section-4-4-1"></a> **`4.4.1. TRILL-Hello Rationale`**
...
<a id="section-4-4-2"></a> **`4.4.2. TRILL-Hello Contents and Timing`**
...
<a id="section-4-4-2-1"></a> **`4.4.2.1. TRILL Neighbor List`**
...
<a id="section-4-4-3"></a> **`4.4.3. TRILL MTU-Probe and TRILL Hello VLAN Tagging`**
...
<a id="section-4-4-4"></a> **`4.4.4. Multiple Ports on the Same Link`**
...
<a id="section-4-4-5"></a> **`4.4.5. VLAN Mapping within a Link`**
...
<a id="section-4-5"></a> **`4.5. Distribution Trees`**
...
<a id="section-4-5-1"></a> **`4.5.1. Distribution Tree Calculation`**
...
<a id="section-4-5-2"></a> **`4.5.2. Multi-Destination Frame Checks`**
...
<a id="section-4-5-3"></a> **`4.5.3. Pruning the Distribution Tree`**
...
<a id="section-4-5-4"></a> **`4.5.4. Tree Distribution Optimization`**
...
<a id="section-4-5-5"></a> **`4.5.5. Forwarding Using a Distribution Tree`**
...
<a id="section-4-6"></a> **`4.6. Frame Processing Behavior`**
...
<a id="section-4-6-1"></a> **`4.6.1. Receipt of a Native Frame`**
...
<a id="section-4-6-1-1"></a> **`4.6.1.1. Native Unicast Case`**
...
<a id="section-4-6-1-2"></a> **`4.6.1.2. Native Multicast and Broadcast Frames`**
...
<a id="section-4-6-2"></a> **`4.6.2. Receipt of a TRILL Frame`**
...
<a id="section-4-6-2-1"></a> **`4.6.2.1. TRILL Control Frames`**
...
<a id="section-4-6-2-2"></a> **`4.6.2.2. TRILL ESADI Frames`**
...
<a id="section-4-6-2-3"></a> **`4.6.2.3. TRILL Data Frames`**
...
<a id="section-4-6-2-4"></a> **`4.6.2.4. Known Unicast TRILL Data Frames`**
...
<a id="section-4-6-2-5"></a> **`4.6.2.5. Multi-Destination TRILL Data Frames`**
...
<a id="section-4-6-3"></a> **`4.6.3. Receipt of a Layer 2 Control Frame`**
...
<a id="section-4-7"></a> **`4.7. IGMP, MLD, and MRD Learning`**
...
<a id="section-4-8"></a> **`4.8. End-Station Address Details`**
...
<a id="section-4-8-1"></a> **`4.8.1. Learning End-Station Addresses`**
...
<a id="section-4-8-2"></a> **`4.8.2. Learning Confidence Level Rationale`**
...
<a id="section-4-8-3"></a> **`4.8.3. Forgetting End-Station Addresses`**
...
<a id="section-4-8-4"></a> **`4.8.4. Shared VLAN Learning`**
...
<a id="section-4-9"></a> **`4.9. RBridge Ports`**
...
<a id="section-4-9-1"></a> **`4.9.1. RBridge Port Configuration`**
...
<a id="section-4-9-2"></a> **`4.9.2. RBridge Port Structure`**
...
<a id="section-4-9-3"></a> **`4.9.3. BPDU Handling`**
...
<a id="section-4-9-3-1"></a> **`4.9.3.1. Receipt of BPDUs`**
...
<a id="section-4-9-3-2"></a> **`4.9.3.2. Root Bridge Changes`**
...
<a id="section-4-9-3-3"></a> **`4.9.3.3. Transmission of BPDUs`**
...
<a id="section-4-9-4"></a> **`4.9.4. Dynamic VLAN Registration`**
...
<a id="section-5"></a> **`5. RBridge Parameters`**
...
<a id="section-5-1"></a> **`5.1. Per RBridge`**
...
<a id="section-5-2"></a> **`5.2. Per Nickname Per RBridge`**
...
<a id="section-5-3"></a> **`5.3. Per Port Per RBridge`**
...
<a id="section-5-4"></a> **`5.4. Per VLAN Per RBridge`**
...
<a id="section-6-1"></a> **`6.1. VLAN Security Considerations`**
...
<a id="section-6-2"></a> **`6.2. BPDU/Hello Denial-of-Service Considerations`**
...
<a id="section-7"></a> **`7. Assignment Considerations`**
...
<a id="section-7-1"></a> **`7.1. IANA Considerations`**
...
<a id="section-7-2"></a> **`7.2. IEEE Registration Authority Considerations`**
