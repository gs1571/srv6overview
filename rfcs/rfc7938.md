...
`   `[`2`](#section-2)`. Network Design Requirements`

`     `[`2.1`](#section-2-1)`. Bandwidth and Traffic Patterns`

`     `[`2.2`](#section-2-2)`. CAPEX Minimization`

`     `[`2.3`](#section-2-3)`. OPEX Minimization`

`     `[`2.4`](#section-2-4)`. Traffic Engineering`

`     `[`2.5`](#section-2-5)`. Summarized Requirements`

`   `[`3`](#section-3)`. Data Center Topologies Overview`

`     `[`3.1`](#section-3-1)`. Traditional DC Topology`

`     `[`3.2`](#section-3-2)`. Clos Network Topology`

`       `[`3.2.1`](#section-3-2-1)`. Overview`

`       `[`3.2.2`](#section-3-2-2)`. Clos Topology Properties`

`       `[`3.2.3`](#section-3-2-3)`. Scaling the Clos Topology`

`       `[`3.2.4`](#section-3-2-4)`. Managing the Size of Clos Topology Tiers`

`   `[`4`](#section-4)`. Data Center Routing Overview`

`     `[`4.1`](#section-4-1)`. L2-Only Designs`

`     `[`4.2`](#section-4-2)`. Hybrid L2/L3 Designs`

`     `[`4.3`](#section-4-3)`. L3-Only Designs`

`   `[`5`](#section-5)`. Routing Protocol Design`

`     `[`5.1`](#section-5-1)`. Choosing EBGP as the Routing Protocol`

`     `[`5.2`](#section-5-2)`. EBGP Configuration for Clos Topology`

`       `[`5.2.1`](#section-5-2-1)`. EBGP Configuration Guidelines and Example ASN Scheme   15`

`       `[`5.2.2`](#section-5-2-2)`. Private Use ASNs`

`       `[`5.2.3`](#section-5-2-3)`. Prefix Advertisement`

`       `[`5.2.4`](#section-5-2-4)`. External Connectivity`

`       `[`5.2.5`](#section-5-2-5)`. Route Summarization at the Edge`

`   `[`6`](#section-6)`. ECMP Considerations`

`     `[`6.1`](#section-6-1)`. Basic ECMP`

`     `[`6.2`](#section-6-2)`. BGP ECMP over Multiple ASNs`

`     `[`6.3`](#section-6-3)`. Weighted ECMP`

`     `[`6.4`](#section-6-4)`. Consistent Hashing`

`   `[`7`](#section-7)`. Routing Convergence Properties`

`     `[`7.1`](#section-7-1)`. Fault Detection Timing`

`     `[`7.2`](#section-7-2)`. Event Propagation Timing`

`     `[`7.3`](#section-7-3)`. Impact of Clos Topology Fan-Outs`

`     `[`7.4`](#section-7-4)`. Failure Impact Scope`

`     `[`7.5`](#section-7-5)`. Routing Micro-Loops`

`   `[`8`](#section-8)`. Additional Options for Design`

`     `[`8.1`](#section-8-1)`. Third-Party Route Injection`

`     `[`8.2`](#section-8-2)`. Route Summarization within Clos Topology`

`       `[`8.2.1`](#section-8-2-1)`. Collapsing Tier 1 Devices Layer`

`       `[`8.2.2`](#section-8-2-2)`. Simple Virtual Aggregation`

`     `[`8.3`](#section-8-3)`. ICMP Unreachable Message Masquerading`
...
<a id="section-2"></a> **`2. Network Design Requirements`**
...
<a id="section-2-1"></a> **`2.1. Bandwidth and Traffic Patterns`**
...
<a id="section-2-2"></a> **`2.2. CAPEX Minimization`**
...
<a id="section-2-3"></a> **`2.3. OPEX Minimization`**
...
<a id="section-2-4"></a> **`2.4. Traffic Engineering`**
...
<a id="section-2-5"></a> **`2.5. Summarized Requirements`**
...
<a id="section-3"></a> **`3. Data Center Topologies Overview`**
...
<a id="section-3-1"></a> **`3.1. Traditional DC Topology`**
...
<a id="section-3-2"></a> **`3.2. Clos Network Topology`**
...
<a id="section-3-2-1"></a> **`3.2.1. Overview`**
...
<a id="section-3-2-2"></a> **`3.2.2. Clos Topology Properties`**
...
<a id="section-3-2-3"></a> **`3.2.3. Scaling the Clos Topology`**
...
<a id="section-3-2-4"></a> **`3.2.4. Managing the Size of Clos Topology Tiers`**
...
<a id="section-4"></a> **`4. Data Center Routing Overview`**
...
<a id="section-4-1"></a> **`4.1. L2-Only Designs`**
...
<a id="section-4-2"></a> **`4.2. Hybrid L2/L3 Designs`**
...
<a id="section-4-3"></a> **`4.3. L3-Only Designs`**
...
<a id="section-5"></a> **`5. Routing Protocol Design`**
...
<a id="section-5-1"></a> **`5.1. Choosing EBGP as the Routing Protocol`**
...
<a id="section-5-2"></a> **`5.2. EBGP Configuration for Clos Topology`**
...
<a id="section-5-2-1"></a> **`5.2.1. EBGP Configuration Guidelines and Example ASN Scheme`**
...
<a id="section-5-2-2"></a> **`5.2.2. Private Use ASNs`**
...
<a id="section-5-2-3"></a> **`5.2.3. Prefix Advertisement`**
...
<a id="section-5-2-4"></a> **`5.2.4. External Connectivity`**
...
<a id="section-5-2-5"></a> **`5.2.5. Route Summarization at the Edge`**
...
<a id="section-6"></a> **`6. ECMP Considerations`**
...
<a id="section-6-1"></a> **`6.1. Basic ECMP`**
...
<a id="section-6-2"></a> **`6.2. BGP ECMP over Multiple ASNs`**
...
<a id="section-6-3"></a> **`6.3. Weighted ECMP`**
...
<a id="section-6-4"></a> **`6.4. Consistent Hashing`**
...
<a id="section-7"></a> **`7. Routing Convergence Properties`**
...
<a id="section-7-1"></a> **`7.1. Fault Detection Timing`**
...
<a id="section-7-2"></a> **`7.2. Event Propagation Timing`**
...
<a id="section-7-3"></a> **`7.3. Impact of Clos Topology Fan-Outs`**
...
<a id="section-7-4"></a> **`7.4. Failure Impact Scope`**
...
<a id="section-7-5"></a> **`7.5. Routing Micro-Loops`**
...
<a id="section-8"></a> **`8. Additional Options for Design`**

```text

```

<a id="section-8-1"></a> **`8.1. Third-Party Route Injection`**
...
<a id="section-8-2"></a> **`8.2. Route Summarization within Clos Topology`**
...
<a id="section-8-2-1"></a> **`8.2.1. Collapsing Tier 1 Devices Layer`**
...
<a id="section-8-2-2"></a> **`8.2.2. Simple Virtual Aggregation`**
...
<a id="section-8-3"></a> **`8.3. ICMP Unreachable Message Masquerading`**
