...
`      `[`1.1`](#section-1-1)`. Protocol Overview`

`      `[`1.2`](#section-1-2)`. Capabilities`

`      `[`1.3`](#section-1-3)`. Separation of Configuration and State Data`
...
`      `[`2.3`](#section-2-3)`. Authentication`

`      `[`2.4`](#section-2-4)`. Mandatory Transport Protocol`

`   `[`3`](#section-3)`. XML Considerations`

`      `[`3.1`](#section-3-1)`. Namespace`

`      `[`3.2`](#section-3-2)`. No Document Type Declarations`
...
`           `[`6.4.4`](#section-6-4-4)`. Select All <name> Elements within the`
...
`      `[`10.3`](#section-10-3)`. NETCONF Capability URNs`

`   `[`11`](#section-11)`. Authors and Acknowledgements`
...
<a id="section-1-1"></a> **`1.1. Protocol Overview`**
...
<a id="section-1-2"></a> **`1.2. Capabilities`**
...
<a id="section-1-3"></a> **`1.3. Separation of Configuration and State Data`**
...
<a id="section-2-3"></a> **`2.3. Authentication`**
...
<a id="section-2-4"></a> **`2.4. Mandatory Transport Protocol`**
...
<a id="section-3-2"></a> **`3.2. No Document Type Declarations`**
...
<a id="section-10-3"></a> **`10.3. NETCONF Capability URNs`**
...
<a id="section-11"></a> **`11. Authors and Acknowledgements`**
