...
`   `[`2`](#section-2)`. Threats and the Use of IPsec`

`     `[`2.1`](#section-2-1)`. IPsec in Transport Mode`

`     `[`2.2`](#section-2-2)`. IPsec in Tunnel Mode`

`   `[`3`](#section-3)`. Scenarios and Overview`

`     `[`3.1`](#section-3-1)`. Router-to-Router Tunnels`

`     `[`3.2`](#section-3-2)`. Site-to-Router/Router-to-Site Tunnels`

`     `[`3.3`](#section-3-3)`. Host-to-Host Tunnels`

`   `[`4`](#section-4)`. IKE and IPsec Versions`

`   `[`5`](#section-5)`. IPsec Configuration Details`

`     `[`5.1`](#section-5-1)`. IPsec Transport Mode`

`     `[`5.2`](#section-5-2)`. Peer Authorization Database and Identities`
...
<a id="section-2"></a> **`2. Threats and the Use of IPsec`**
...
<a id="section-2-1"></a> **`2.1. IPsec in Transport Mode`**
...
<a id="section-2-2"></a> **`2.2. IPsec in Tunnel Mode`**
...
<a id="section-3"></a> **`3. Scenarios and Overview`**
...
<a id="section-3-1"></a> **`3.1. Router-to-Router Tunnels`**
...
<a id="section-3-2"></a> **`3.2. Site-to-Router/Router-to-Site Tunnels`**
...
<a id="section-3-3"></a> **`3.3. Host-to-Host Tunnels`**
...
<a id="section-4"></a> **`4. IKE and IPsec Versions`**
...
<a id="section-5"></a> **`5. IPsec Configuration Details`**
...
<a id="section-5-1"></a> **`5.1. IPsec Transport Mode`**
...
<a id="section-5-2"></a> **`5.2. Peer Authorization Database and Identities`**
...
<a id="section-6"></a> **`6. Recommendations`**
