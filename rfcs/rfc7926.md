...
`           `[`1.1.1`](#section-1-1-1)`. TE Paths and TE Connections`

`           `[`1.1.2`](#section-1-1-2)`. TE Metrics and TE Attributes`

`           `[`1.1.3`](#section-1-1-3)`. TE Reachability`

`           `[`1.1.4`](#section-1-1-4)`. Domain`

`           `[`1.1.5`](#section-1-1-5)`. Server Network`

`           `[`1.1.6`](#section-1-1-6)`. Client Network`

`           `[`1.1.7`](#section-1-1-7)`. Aggregation`

`           `[`1.1.8`](#section-1-1-8)`. Abstraction`

`           `[`1.1.9`](#section-1-1-9)`. Abstract Link`

`           `[`1.1.10`](#section-1-1-10)`. Abstract Node or Virtual Node`

`           `[`1.1.11`](#section-1-1-11)`. Abstraction Layer Network`

`   `[`2`](#section-2)`. Overview of Use Cases`

`      `[`2.1`](#section-2-1)`. Peer Networks`

`      `[`2.2`](#section-2-2)`. Client-Server Networks`

`      `[`2.3`](#section-2-3)`. Dual-Homing`

`      `[`2.4`](#section-2-4)`. Requesting Connectivity`

`           `[`2.4.1`](#section-2-4-1)`. Discovering Server Network Information`

`   `[`3`](#section-3)`. Problem Statement`

`      `[`3.1`](#section-3-1)`. Policy and Filters`

`      `[`3.2`](#section-3-2)`. Confidentiality`

`      `[`3.3`](#section-3-3)`. Information Overload`

`      `[`3.4`](#section-3-4)`. Issues of Information Churn`

`      `[`3.5`](#section-3-5)`. Issues of Aggregation`

`   `[`4`](#section-4)`. Architecture`

`      `[`4.1`](#section-4-1)`. TE Reachability`

`      `[`4.2`](#section-4-2)`. Abstraction, Not Aggregation`

`           `[`4.2.1`](#section-4-2-1)`. Abstract Links`

`           `[`4.2.2`](#section-4-2-2)`. The Abstraction Layer Network`

`           `[`4.2.3`](#section-4-2-3)`. Abstraction in Client-Server Networks`

`           `[`4.2.4`](#section-4-2-4)`. Abstraction in Peer Networks`

`      `[`4.3`](#section-4-3)`. Considerations for Dynamic Abstraction`

`      `[`4.4`](#section-4-4)`. Requirements for Advertising Links and Nodes`

`      `[`4.5`](#section-4-5)`. Addressing Considerations`

`   `[`5`](#section-5)`. Building on Existing Protocols`

`      `[`5.1`](#section-5-1)`. BGP-LS`

`      `[`5.2`](#section-5-2)`. IGPs`

`      `[`5.3`](#section-5-3)`. RSVP-TE`

`      `[`5.4`](#section-5-4)`. Notes on a Solution`

`   `[`6`](#section-6)`. Application of the Architecture to Optical Domains and`

`      Networks`

`   `[`7`](#section-7)`. Application of the Architecture to the User-Network Interface`

`   `[`8`](#section-8)`. Application of the Architecture to L3VPN Multi-AS Environments`

`   `[`9`](#section-9)`. Scoping Future Work`

`      `[`9.1`](#section-9-1)`. Limiting Scope to Only Part of the Internet`

`      `[`9.2`](#section-9-2)`. Working with "Related" Domains`

`      `[`9.3`](#section-9-3)`. Not Finding Optimal Paths in All Situations`

`      `[`9.4`](#section-9-4)`. Sanity and Scaling`

`   `[`10`](#section-10)`. Manageability Considerations`

`      `[`10.1`](#section-10-1)`. Managing the Abstraction Layer Network`

`      `[`10.2`](#section-10-2)`. Managing Interactions of Abstraction Layer and`

`            Client Networks`

`      `[`10.3`](#section-10-3)`. Managing Interactions of Abstraction Layer and`

`            Server Networks`

`   `[`11`](#section-11)`. Security Considerations`

`   `[`12`](#section-12)`. Informative References`
...
<a id="section-1-1-1"></a> **`1.1.1. TE Paths and TE Connections`**
...
<a id="section-1-1-2"></a> **`1.1.2. TE Metrics and TE Attributes`**
...
<a id="section-1-1-3"></a> **`1.1.3. TE Reachability`**
...
<a id="section-1-1-4"></a> **`1.1.4. Domain`**
...
<a id="section-1-1-5"></a> **`1.1.5. Server Network`**
...
<a id="section-1-1-6"></a> **`1.1.6. Client Network`**
...
<a id="section-1-1-7"></a> **`1.1.7. Aggregation`**
...
<a id="section-1-1-8"></a> **`1.1.8. Abstraction`**
...
<a id="section-1-1-9"></a> **`1.1.9. Abstract Link`**
...
<a id="section-1-1-10"></a> **`1.1.10. Abstract Node or Virtual Node`**
...
<a id="section-1-1-11"></a> **`1.1.11. Abstraction Layer Network`**
...
<a id="section-2"></a> **`2. Overview of Use Cases`**

```text

```

<a id="section-2-1"></a> **`2.1. Peer Networks`**
...
<a id="section-2-2"></a> **`2.2. Client-Server Networks`**
...
<a id="section-2-3"></a> **`2.3. Dual-Homing`**
...
<a id="section-2-4"></a> **`2.4. Requesting Connectivity`**
...
<a id="section-2-4-1"></a> **`2.4.1. Discovering Server Network Information`**
...
<a id="section-3-1"></a> **`3.1. Policy and Filters`**
...
<a id="section-3-2"></a> **`3.2. Confidentiality`**
...
<a id="section-3-3"></a> **`3.3. Information Overload`**
...
<a id="section-3-4"></a> **`3.4. Issues of Information Churn`**
...
<a id="section-3-5"></a> **`3.5. Issues of Aggregation`**
...
<a id="section-4"></a> **`4. Architecture`**

```text

```

<a id="section-4-1"></a> **`4.1. TE Reachability`**
...
<a id="section-4-2"></a> **`4.2. Abstraction, Not Aggregation`**
...
<a id="section-4-2-1"></a> **`4.2.1. Abstract Links`**
...
<a id="section-4-2-2"></a> **`4.2.2. The Abstraction Layer Network`**
...
<a id="section-4-2-2-1"></a> **`4.2.2.1. Nodes in the Abstraction Layer Network`**
...
<a id="section-4-2-3"></a> **`4.2.3. Abstraction in Client-Server Networks`**
...
<a id="section-4-2-3-1"></a> **`4.2.3.1. A Server with Multiple Clients`**
...
<a id="section-4-2-3-2"></a> **`4.2.3.2. A Client with Multiple Servers`**
...
<a id="section-4-2-4"></a> **`4.2.4. Abstraction in Peer Networks`**
...
<a id="section-4-3"></a> **`4.3. Considerations for Dynamic Abstraction`**
...
<a id="section-4-4"></a> **`4.4. Requirements for Advertising Links and Nodes`**
...
<a id="section-4-5"></a> **`4.5. Addressing Considerations`**
...
<a id="section-5"></a> **`5. Building on Existing Protocols`**
...
<a id="section-5-3"></a> **`5.3. RSVP-TE`**
...
<a id="section-5-4"></a> **`5.4. Notes on a Solution`**
...
<a id="section-6"></a> **`6. Application of the Architecture to Optical Domains and Networks`**
...
<a id="section-7"></a> **`7. Application of the Architecture to the User-Network Interface`**
...
<a id="section-8"></a> **`8. Application of the Architecture to L3VPN Multi-AS Environments`**
...
<a id="section-9"></a> **`9. Scoping Future Work`**
...
<a id="section-9-1"></a> **`9.1. Limiting Scope to Only Part of the Internet`**
...
<a id="section-9-2"></a> **`9.2. Working with "Related" Domains`**
...
<a id="section-9-3"></a> **`9.3. Not Finding Optimal Paths in All Situations`**
...
<a id="section-9-4"></a> **`9.4. Sanity and Scaling`**
...
<a id="section-10-1"></a> **`10.1. Managing the Abstraction Layer Network`**
...
<a id="section-10-2"></a> **`10.2. Managing Interactions of Abstraction Layer and Client Networks`**
...
<a id="section-10-3"></a> **`10.3. Managing Interactions of Abstraction Layer and Server Networks`**
...
<a id="section-12"></a> **`12. Informative References`**
