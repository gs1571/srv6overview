...
`     `[`3.1`](#section-3-1)`. Timers`

`     `[`3.2`](#section-3-2)`. Restart TLV`

`       `[`3.2.1`](#section-3-2-1)`. Use of RR and RA Bits`

`       `[`3.2.2`](#section-3-2-2)`. Use of the SA Bit`

`     `[`3.3`](#section-3-3)`. Adjacency (Re)Acquisition`

`       `[`3.3.1`](#section-3-3-1)`. Adjacency Reacquisition during Restart`

`       `[`3.3.2`](#section-3-3-2)`. Adjacency Acquisition during Start`

`       `[`3.3.3`](#section-3-3-3)`. Multiple Levels`

`     `[`3.4`](#section-3-4)`. Database Synchronization`

`       `[`3.4.1`](#section-3-4-1)`. LSP Generation and Flooding and SPF Computation`

`         `[`3.4.1.1`](#section-3-4-1-1)`. Restarting`

`         `[`3.4.1.2`](#section-3-4-1-2)`. Starting`

`   `[`4`](#section-4)`. State Tables`

`     `[`4.1`](#section-4-1)`. Running Router`

`     `[`4.2`](#section-4-2)`. Restarting Router`

`     `[`4.3`](#section-4-3)`. Starting Router`
...
<a id="section-3"></a> **`3. Approach`**

```text

```

<a id="section-3-1"></a> **`3.1. Timers`**
...
<a id="section-3-2"></a> **`3.2. Restart TLV`**
...
<a id="section-3-2-1"></a> **`3.2.1. Use of RR and RA Bits`**
...
<a id="section-3-2-2"></a> **`3.2.2. Use of the SA Bit`**
...
<a id="section-3-3"></a> **`3.3. Adjacency (Re)Acquisition`**
...
<a id="section-3-3-1"></a> **`3.3.1. Adjacency Reacquisition during Restart`**
...
<a id="section-3-3-2"></a> **`3.3.2. Adjacency Acquisition during Start`**
...
<a id="section-3-3-3"></a> **`3.3.3. Multiple Levels`**
...
<a id="section-3-4"></a> **`3.4. Database Synchronization`**
...
<a id="section-3-4-1"></a> **`3.4.1. LSP Generation and Flooding and SPF Computation`**
...
<a id="section-3-4-1-1"></a> **`3.4.1.1. Restarting`**
...
<a id="section-3-4-1-2"></a> **`3.4.1.2. Starting`**
...
<a id="section-4"></a> **`4. State Tables`**
...
<a id="section-4-1"></a> **`4.1. Running Router`**
...
<a id="section-4-2"></a> **`4.2. Restarting Router`**
...
<a id="section-4-3"></a> **`4.3. Starting Router`**
