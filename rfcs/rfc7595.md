...
`     `[`1.1`](#section-1-1)`. URIs and IRIs`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Requirements for Permanent Scheme Definitions`

`     `[`3.1`](#section-3-1)`. Demonstrable, New, Long-Lived Utility`

`     `[`3.2`](#section-3-2)`. Syntactic Compatibility`

`     `[`3.3`](#section-3-3)`. Well Defined`

`     `[`3.4`](#section-3-4)`. Definition of Operations`

`     `[`3.5`](#section-3-5)`. Context of Use`

`     `[`3.6`](#section-3-6)`. Internationalization and Character Encoding`

`     `[`3.7`](#section-3-7)`. Clear Security and Privacy Considerations`

`     `[`3.8`](#section-3-8)`. Scheme Name Considerations`

`     `[`3.9`](#section-3-9)`. Interoperability Considerations`

`   `[`4`](#section-4)`. Guidelines for Provisional URI Scheme Registration`

`   `[`5`](#section-5)`. Guidelines for Historical URI Scheme Registration`

`   `[`6`](#section-6)`. Guidelines for Private URI Scheme Use`

`   `[`7`](#section-7)`. URI Scheme Registration Procedure`

`     `[`7.1`](#section-7-1)`. General`

`     `[`7.2`](#section-7-2)`. Registration Procedures`

`     `[`7.3`](#section-7-3)`. Change Control`

`     `[`7.4`](#section-7-4)`. URI Scheme Registration Template`

`   `[`8`](#section-8)`. The "example" URI Scheme`

`     `[`8.1`](#section-8-1)`. "example" URI Scheme Registration Request`
...
<a id="section-1-1"></a> **`1.1. URIs and IRIs`**
...
<a id="section-3"></a> **`3. Requirements for Permanent Scheme Definitions`**
...
<a id="section-3-1"></a> **`3.1. Demonstrable, New, Long-Lived Utility`**
...
<a id="section-3-2"></a> **`3.2. Syntactic Compatibility`**
...
```text
   ...
   match the  grammar described in [RFC3986].
...
<a id="section-3-3"></a> **`3.3. Well Defined`**
...
<a id="section-3-4"></a> **`3.4. Definition of Operations`**
...
<a id="section-3-5"></a> **`3.5. Context of Use`**
...
<a id="section-3-6"></a> **`3.6. Internationalization and Character Encoding`**
...
<a id="section-3-7"></a> **`3.7. Clear Security and Privacy Considerations`**
...
<a id="section-3-8"></a> **`3.8. Scheme Name Considerations`**
...
<a id="section-3-9"></a> **`3.9. Interoperability Considerations`**
...
<a id="section-4"></a> **`4. Guidelines for Provisional URI Scheme Registration`**
...
<a id="section-5"></a> **`5. Guidelines for Historical URI Scheme Registration`**
...
<a id="section-6"></a> **`6. Guidelines for Private URI Scheme Use`**
...
<a id="section-7"></a> **`7. URI Scheme Registration Procedure`**

```text

```

<a id="section-7-1"></a> **`7.1. General`**
...
<a id="section-7-2"></a> **`7.2. Registration Procedures`**
...
<a id="section-7-3"></a> **`7.3. Change Control`**
...
<a id="section-7-4"></a> **`7.4. URI Scheme Registration Template`**
...
<a id="section-8"></a> **`8. The "example" URI Scheme`**
...
<a id="section-8-1"></a> **`8.1. "example" URI Scheme Registration Request`**
