...
`   `[`3`](#section-3)`. Link-State IGP Segments`

`     `[`3.1`](#section-3-1)`. IGP-Prefix Segment (Prefix-SID)`

`       `[`3.1.1`](#section-3-1-1)`. Prefix-SID Algorithm`

`       `[`3.1.2`](#section-3-1-2)`. SR-MPLS`

`       `[`3.1.3`](#section-3-1-3)`. SRv6`

`     `[`3.2`](#section-3-2)`. IGP-Node Segment (Node-SID)`

`     `[`3.3`](#section-3-3)`. IGP-Anycast Segment (Anycast-SID)`

`       `[`3.3.1`](#section-3-3-1)`. Anycast-SID in SR-MPLS`

`     `[`3.4`](#section-3-4)`. IGP-Adjacency Segment (Adj-SID)`

`       `[`3.4.1`](#section-3-4-1)`. Parallel Adjacencies`

`       `[`3.4.2`](#section-3-4-2)`. LAN Adjacency Segments`

`     `[`3.5`](#section-3-5)`. Inter-Area Considerations`

`   `[`4`](#section-4)`. BGP Segments`

`     `[`4.1`](#section-4-1)`. BGP-Prefix Segment`

`     `[`4.2`](#section-4-2)`. BGP Peering Segments`

`   `[`5`](#section-5)`. Binding Segment`

`     `[`5.1`](#section-5-1)`. IGP Mirroring Context Segment`

`   `[`6`](#section-6)`. Multicast`

`   `[`7`](#section-7)`. IANA Considerations`

`   `[`8`](#section-8)`. Security Considerations`

`     `[`8.1`](#section-8-1)`. SR-MPLS`

`     `[`8.2`](#section-8-2)`. SRv6`

`     `[`8.3`](#section-8-3)`. Congestion Control`
...
<a id="section-3"></a> **`3. Link-State IGP Segments`**
...
<a id="section-3-1"></a> **`3.1. IGP-Prefix Segment (Prefix-SID)`**
...
<a id="section-3-1-1"></a> **`3.1.1. Prefix-SID Algorithm`**
...
<a id="section-3-1-2"></a> **`3.1.2. SR-MPLS`**
...
<a id="section-3-1-3"></a> **`3.1.3. SRv6`**
...
<a id="section-3-2"></a> **`3.2. IGP-Node Segment (Node-SID)`**
...
<a id="section-3-3"></a> **`3.3. IGP-Anycast Segment (Anycast-SID)`**
...
<a id="section-3-3-1"></a> **`3.3.1. Anycast-SID in SR-MPLS`**
...
<a id="section-3-4"></a> **`3.4. IGP-Adjacency Segment (Adj-SID)`**
...
<a id="section-3-4-1"></a> **`3.4.1. Parallel Adjacencies`**
...
<a id="section-3-4-2"></a> **`3.4.2. LAN Adjacency Segments`**
...
<a id="section-3-5"></a> **`3.5. Inter-Area Considerations`**
...
<a id="section-4"></a> **`4. BGP Segments`**
...
<a id="section-4-1"></a> **`4.1. BGP-Prefix Segment`**
...
<a id="section-4-2"></a> **`4.2. BGP Peering Segments`**
...
<a id="section-5"></a> **`5. Binding Segment`**
...
<a id="section-5-1"></a> **`5.1. IGP Mirroring Context Segment`**
...
<a id="section-8-1"></a> **`8.1. SR-MPLS`**
...
<a id="section-8-3"></a> **`8.3. Congestion Control`**
