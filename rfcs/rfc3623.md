...
`   `[`2`](#section-2)`. Operation of Restarting Router`

`       `[`2.1`](#section-2-1)`. Entering Graceful Restart`

`       `[`2.2`](#section-2-2)`. When to Exit Graceful Restart`

`       `[`2.3`](#section-2-3)`. Actions on Exiting Graceful Restart`

`   `[`3`](#section-3)`. Operation of Helper Neighbor`

`       `[`3.1`](#section-3-1)`. Entering Helper Mode`

`       `[`3.2`](#section-3-2)`. Exiting Helper Mode`

`   `[`4`](#section-4)`. Backward Compatibility`

`   `[`5`](#section-5)`. Unplanned Outages`

`   `[`6`](#section-6)`. Interaction with Traffic Engineering`

`   `[`7`](#section-7)`. Possible Future Work`

`   `[`8`](#section-8)`. Intellectual Property Rights Notice`
...
<a id="section-2"></a> **`2. Operation of Restarting Router`**
...
<a id="section-2-1"></a> **`2.1. Entering Graceful Restart`**
...
<a id="section-2-2"></a> **`2.2. When to Exit Graceful Restart`**
...
<a id="section-2-3"></a> **`2.3. Actions on Exiting Graceful Restart`**
...
<a id="section-3"></a> **`3. Operation of Helper Neighbor`**
...
<a id="section-3-1"></a> **`3.1. Entering Helper Mode`**
...
<a id="section-3-2"></a> **`3.2. Exiting Helper Mode`**
...
<a id="section-5"></a> **`5. Unplanned Outages`**
...
<a id="section-6"></a> **`6. Interaction with Traffic Engineering`**
...
<a id="section-7"></a> **`7. Possible Future Work`**
...
<a id="section-8"></a> **`8. Intellectual Property Rights Notice`**
