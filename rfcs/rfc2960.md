...
`     `[`1`](#section-1)`. 1 Motivation`

`     `[`1`](#section-1)`. 2 Architectural View of SCTP`

`     `[`1`](#section-1)`. 3 Functional View of SCTP`

`       `[`1.3`](#section-1-3)`. 1 Association Startup and Takedown`

`       `[`1.3`](#section-1-3)`. 2 Sequenced Delivery within Streams`

`       `[`1.3`](#section-1-3)`. 3 User Data Fragmentation`

`       `[`1.3`](#section-1-3)`. 4 Acknowledgement and Congestion Avoidance`

`       `[`1.3`](#section-1-3)`. 5 Chunk Bundling`

`       `[`1.3`](#section-1-3)`. 6 Packet Validation`

`       `[`1.3`](#section-1-3)`. 7 Path Management`

`     `[`1`](#section-1)`. 4 Key Terms`

`     `[`1`](#section-1)`. 5 Abbreviations`

`     `[`1`](#section-1)`. 6 Serial Number Arithmetic`

`   `[`2`](#section-2)`. Conventions`

`   `[`3`](#section-3)`. SCTP packet Format`

`     `[`3`](#section-3)`. 1 SCTP Common Header Field Descriptions`

`     `[`3`](#section-3)`. 2 Chunk Field Descriptions`

`       `[`3.2`](#section-3-2)`. 1 Optional/Variable-length Parameter Format`

`     `[`3`](#section-3)`. 3 SCTP Chunk Definitions`

`       `[`3.3`](#section-3-3)`. 1 Payload Data (DATA)`

`       `[`3.3`](#section-3-3)`. 2 Initiation (INIT)`

`         `[`3.3.2`](#section-3-3-2)`. 1 Optional or Variable Length Parameters`

`       `[`3.3`](#section-3-3)`. 3 Initiation Acknowledgement (INIT ACK)`

`         `[`3.3.3`](#section-3-3-3)`. 1 Optional or Variable Length Parameters`

`       `[`3.3`](#section-3-3)`. 4 Selective Acknowledgement (SACK)`

`       `[`3.3`](#section-3-3)`. 5 Heartbeat Request (HEARTBEAT)`

`       `[`3.3`](#section-3-3)`. 6 Heartbeat Acknowledgement (HEARTBEAT ACK)`

`       `[`3.3`](#section-3-3)`. 7 Abort Association (ABORT)`

`       `[`3.3`](#section-3-3)`. 8 Shutdown Association (SHUTDOWN)`

`       `[`3.3`](#section-3-3)`. 9 Shutdown Acknowledgement (SHUTDOWN ACK)`

`       `[`3.3`](#section-3-3)`. 10 Operation Error (ERROR)`

`         `[`3.3.10`](#section-3-3-10)`. 1 Invalid Stream Identifier`

`         `[`3.3.10`](#section-3-3-10)`. 2 Missing Mandatory Parameter`

`         `[`3.3.10`](#section-3-3-10)`. 3 Stale Cookie Error`

`         `[`3.3.10`](#section-3-3-10)`. 4 Out of Resource`

`         `[`3.3.10`](#section-3-3-10)`. 5 Unresolvable Address`

`         `[`3.3.10`](#section-3-3-10)`. 6 Unrecognized Chunk Type`

`         `[`3.3.10`](#section-3-3-10)`. 7 Invalid Mandatory Parameter`

`         `[`3.3.10`](#section-3-3-10)`. 8 Unrecognized Parameters`

`         `[`3.3.10`](#section-3-3-10)`. 9 No User Data`

`         `[`3.3.10`](#section-3-3-10)`. 10 Cookie Received While Shutting Down`

`       `[`3.3`](#section-3-3)`. 11 Cookie Echo (COOKIE ECHO)`

`       `[`3.3`](#section-3-3)`. 12 Cookie Acknowledgement (COOKIE ACK)`

`       `[`3.3`](#section-3-3)`. 13 Shutdown Complete (SHUTDOWN COMPLETE)`

`   `[`4`](#section-4)`. SCTP Association State Diagram`

`   `[`5`](#section-5)`. Association Initialization`

`     `[`5`](#section-5)`. 1 Normal Establishment of an Association`

`       `[`5.1`](#section-5-1)`. 1 Handle Stream Parameters`

`       `[`5.1`](#section-5-1)`. 2 Handle Address Parameters`

`       `[`5.1`](#section-5-1)`. 3 Generating State Cookie`

`       `[`5.1`](#section-5-1)`. 4 State Cookie Processing`

`       `[`5.1`](#section-5-1)`. 5 State Cookie Authentication`

`       `[`5.1`](#section-5-1)`. 6 An Example of Normal Association Establishment`

`     `[`5`](#section-5)`. 2 Handle Duplicate or unexpected INIT, INIT ACK, COOKIE ECHO,`

`         and COOKIE ACK`

`       `[`5.2`](#section-5-2)`. 1 Handle Duplicate INIT in COOKIE-WAIT`

`             or COOKIE-ECHOED States`

`       `[`5.2`](#section-5-2)`. 2 Unexpected INIT in States Other than CLOSED,`

`             COOKIE-ECHOED, COOKIE-WAIT and SHUTDOWN-ACK-SENT`

`       `[`5.2`](#section-5-2)`. 3 Unexpected INIT ACK`

`       `[`5.2`](#section-5-2)`. 4 Handle a COOKIE ECHO when a TCB exists`

`         `[`5.2.4`](#section-5-2-4)`. 1 An Example of a Association Restart`

`       `[`5.2`](#section-5-2)`. 5 Handle Duplicate COOKIE ACK`

`       `[`5.2`](#section-5-2)`. 6 Handle Stale COOKIE Error`

`     `[`5`](#section-5)`. 3 Other Initialization Issues`

`       `[`5.3`](#section-5-3)`. 1 Selection of Tag Value`

`   `[`6`](#section-6)`. User Data Transfer`

`     `[`6`](#section-6)`. 1 Transmission of DATA Chunks`

`     `[`6`](#section-6)`. 2 Acknowledgement on Reception of DATA Chunks`

`       `[`6.2`](#section-6-2)`. 1 Tracking Peer's Receive Buffer Space`

`     `[`6`](#section-6)`. 3 Management Retransmission Timer`

`       `[`6.3`](#section-6-3)`. 1 RTO Calculation`

`       `[`6.3`](#section-6-3)`. 2 Retransmission Timer Rules`

`       `[`6.3`](#section-6-3)`. 3 Handle T3-rtx Expiration`

`     `[`6`](#section-6)`. 4 Multi-homed SCTP Endpoints`

`       `[`6.4`](#section-6-4)`. 1 Failover from Inactive Destination Address`

`     `[`6`](#section-6)`. 5 Stream Identifier and Stream Sequence Number`

`     `[`6`](#section-6)`. 6 Ordered and Unordered Delivery`

`     `[`6`](#section-6)`. 7 Report Gaps in Received DATA TSNs`

`     `[`6`](#section-6)`. 8 Adler-32 Checksum Calculation`

`     `[`6`](#section-6)`. 9 Fragmentation`

`     `[`6`](#section-6)`. 10 Bundling`

`   `[`7`](#section-7)`. Congestion Control`

`     `[`7`](#section-7)`. 1 SCTP Differences from TCP Congestion Control`

`     `[`7`](#section-7)`. 2 SCTP Slow-Start and Congestion Avoidance`

`       `[`7.2`](#section-7-2)`. 1 Slow-Start`

`       `[`7.2`](#section-7-2)`. 2 Congestion Avoidance`

`       `[`7.2`](#section-7-2)`. 3 Congestion Control`

`       `[`7.2`](#section-7-2)`. 4 Fast Retransmit on Gap Reports`

`     `[`7`](#section-7)`. 3 Path MTU Discovery`

`   `[`8`](#section-8)`. Fault Management`

`     `[`8`](#section-8)`. 1 Endpoint Failure Detection`

`     `[`8`](#section-8)`. 2 Path Failure Detection`

`     `[`8`](#section-8)`. 3 Path Heartbeat`

`     `[`8`](#section-8)`. 4 Handle "Out of the blue" Packets`

`     `[`8`](#section-8)`. 5 Verification Tag`

`       `[`8.5`](#section-8-5)`. 1 Exceptions in Verification Tag Rules`

`   `[`9`](#section-9)`. Termination of Association`

`     `[`9`](#section-9)`. 1 Abort of an Association`

`     `[`9`](#section-9)`. 2 Shutdown of an Association`

`   `[`10`](#section-10)`. Interface with Upper Layer`

`     `[`10`](#section-10)`. 1 ULP-to-SCTP`

`     `[`10`](#section-10)`. 2 SCTP-to-ULP`

`   `[`11`](#section-11)`. Security Considerations`

`     `[`11`](#section-11)`. 1 Security Objectives`

`     `[`11`](#section-11)`. 2 SCTP Responses To Potential Threats`

`       `[`11.2`](#section-11-2)`. 1 Countering Insider Attacks`

`       `[`11.2`](#section-11-2)`. 2 Protecting against Data Corruption in the Network`

`       `[`11.2`](#section-11-2)`. 3 Protecting Confidentiality`

`       `[`11.2`](#section-11-2)`. 4 Protecting against Blind Denial of Service Attacks`

`         `[`11.2.4`](#section-11-2-4)`. 1 Flooding`

`         `[`11.2.4`](#section-11-2-4)`. 2 Blind Masquerade`

`         `[`11.2.4`](#section-11-2-4)`. 3 Improper Monopolization of Services`

`     `[`11`](#section-11)`. 3 Protection against Fraud and Repudiation`

`   `[`12`](#section-12)`. Recommended Transmission Control Block (TCB) Parameters`

`     `[`12`](#section-12)`. 1 Parameters necessary for the SCTP instance`

`     `[`12`](#section-12)`. 2 Parameters necessary per association (i.e. the TCB)`

`     `[`12`](#section-12)`. 3 Per Transport Address Data`

`     `[`12`](#section-12)`. 4 General Parameters Needed`

`   `[`13`](#section-13)`. IANA Considerations`

`     `[`13`](#section-13)`. 1 IETF-defined Chunk Extension`

`     `[`13`](#section-13)`. 2 IETF-defined Chunk Parameter Extension`

`     `[`13`](#section-13)`. 3 IETF-defined Additional Error Causes`

`     `[`13`](#section-13)`. 4 Payload Protocol Identifiers`

`   `[`14`](#section-14)`. Suggested SCTP Protocol Parameter Values`

`   `[`15`](#section-15)`. Acknowledgements`

`   `[`16`](#section-16)`. Authors' Addresses`

`   `[`17`](#section-17)`. References`

`   `[`18`](#section-18)`. Bibliography`
...
<a id="section-1-5"></a> **`1.5. Abbreviations`**
...
<a id="section-2"></a> **`2. Conventions`**
...
<a id="section-3"></a> **`3. SCTP packet Format`**
...
<a id="section-4"></a> **`4. SCTP Association State Diagram`**
...
<a id="section-5"></a> **`5. Association Initialization`**
...
<a id="section-6"></a> **`6. User Data Transfer`**
...
<a id="section-7"></a> **`7. Congestion control`**
...
<a id="section-8"></a> **`8. Fault Management`**
...
<a id="section-9"></a> **`9. Termination of Association`**
...
<a id="section-10"></a> **`10. Interface with Upper Layer`**
...
<a id="section-12"></a> **`12. Recommended Transmission Control Block (TCB) Parameters`**
...
<a id="section-14"></a> **`14. Suggested SCTP Protocol Parameter Values`**
...
<a id="section-16"></a> **`16. Authors' Addresses`**
...
<a id="section-18"></a> **`18. Bibliography`**
