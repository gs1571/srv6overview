...
`      `[`1`](#section-1)`. 2 Limitations of IDNA`

`      `[`1`](#section-1)`. 3 Brief overview for application developers`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Requirements and applicability`

`      `[`3`](#section-3)`. 1 Requirements`

`      `[`3`](#section-3)`. 2 Applicability`

`         `[`3.2.1`](#section-3-2-1)`. DNS resource records`

`         `[`3.2.2`](#section-3-2-2)`. Non-domain-name data types stored in domain names`

`   `[`4`](#section-4)`. Conversion operations`

`      `[`4`](#section-4)`. 1 ToASCII`

`      `[`4`](#section-4)`. 2 ToUnicode`

`   `[`5`](#section-5)`. ACE prefix`

`   `[`6`](#section-6)`. Implications for typical applications using DNS`

`      `[`6`](#section-6)`. 1 Entry and display in applications`

`      `[`6`](#section-6)`. 2 Applications and resolver libraries`

`      `[`6`](#section-6)`. 3 DNS servers`

`      `[`6`](#section-6)`. 4 Avoiding exposing users to the raw ACE encoding`

`      `[`6.5`](#section-6-5)`. DNSSEC authentication of IDN domain names`

`   `[`7`](#section-7)`. Name server considerations`

`   `[`8`](#section-8)`. Root server considerations`

`   `[`9`](#section-9)`. References`

`      `[`9`](#section-9)`. 1 Normative References`

`      `[`9`](#section-9)`. 2 Informative References`
...
<a id="section-3-2-2"></a> **`3.2.2. Non-domain-name data types stored in domain names`**
...
<a id="section-4"></a> **`4. Conversion operations`**
...
<a id="section-6"></a> **`6. Implications for typical applications using DNS`**
...
<a id="section-7"></a> **`7. Name server considerations`**
...
<a id="section-8"></a> **`8. Root server considerations`**
