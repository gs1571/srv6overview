...
`     `[`2.2`](#section-2-2)`. Terms and Abbreviations`

`   `[`3`](#section-3)`. E-Tree Scenarios`

`     `[`3.1`](#section-3-1)`. Scenario 1: Leaf or Root Site(s) per PE`

`     `[`3.2`](#section-3-2)`. Scenario 2: Leaf or Root Site(s) per AC`

`     `[`3.3`](#section-3-3)`. Scenario 3: Leaf or Root Site(s) per MAC Address`

`   `[`4`](#section-4)`. Operation for EVPN`

`     `[`4.1`](#section-4-1)`. Known Unicast Traffic`

`     `[`4.2`](#section-4-2)`. BUM Traffic`

`       `[`4.2.1`](#section-4-2-1)`. BUM Traffic Originated from a Single-Homed Site on a`

`               Leaf AC`

`       `[`4.2.2`](#section-4-2-2)`. BUM Traffic Originated from a Single-Homed Site on a`

`               Root AC`

`       `[`4.2.3`](#section-4-2-3)`. BUM Traffic Originated from a Multihomed Site on a`

`               Leaf AC`

`       `[`4.2.4`](#section-4-2-4)`. BUM Traffic Originated from a Multihomed Site on a`

`               Root AC`

`     `[`4.3`](#section-4-3)`. E-Tree Traffic Flows for EVPN`

`       `[`4.3.1`](#section-4-3-1)`. E-Tree with MAC Learning`

`       `[`4.3.2`](#section-4-3-2)`. E-Tree without MAC Learning`

`   `[`5`](#section-5)`. Operation for PBB-EVPN`

`     `[`5.1`](#section-5-1)`. Known Unicast Traffic`

`     `[`5.2`](#section-5-2)`. BUM Traffic`

`     `[`5.3`](#section-5-3)`. E-Tree without MAC Learning`

`   `[`6`](#section-6)`. BGP Encoding`

`     `[`6.1`](#section-6-1)`. E-Tree Extended Community`

`     `[`6.2`](#section-6-2)`. PMSI Tunnel Attribute`

`   `[`7`](#section-7)`. Security Considerations`

`   `[`8`](#section-8)`. IANA Considerations`

`     `[`8.1`](#section-8-1)`. Considerations for PMSI Tunnel Types`
...
<a id="section-2-2"></a> **`2.2. Terms and Abbreviations`**
...
<a id="section-3"></a> **`3. E-Tree Scenarios`**
...
<a id="section-3-1"></a> **`3.1. Scenario 1: Leaf or Root Site(s) per PE`**
...
<a id="section-3-2"></a> **`3.2. Scenario 2: Leaf or Root Site(s) per AC`**
...
<a id="section-3-3"></a> **`3.3. Scenario 3: Leaf or Root Site(s) per MAC Address`**
...
<a id="section-4"></a> **`4. Operation for EVPN`**
...
<a id="section-4-1"></a> **`4.1. Known Unicast Traffic`**
...
<a id="section-4-2"></a> **`4.2. BUM Traffic`**
...
<a id="section-4-2-1"></a> **`4.2.1. BUM Traffic Originated from a Single-Homed Site on a Leaf AC`**
...
<a id="section-4-2-2"></a> **`4.2.2. BUM Traffic Originated from a Single-Homed Site on a Root AC`**
...
<a id="section-4-2-3"></a> **`4.2.3. BUM Traffic Originated from a Multihomed Site on a Leaf AC`**
...
<a id="section-4-2-4"></a> **`4.2.4. BUM Traffic Originated from a Multihomed Site on a Root AC`**
...
<a id="section-4-3"></a> **`4.3. E-Tree Traffic Flows for EVPN`**
...
<a id="section-4-3-1"></a> **`4.3.1. E-Tree with MAC Learning`**
...
<a id="section-4-3-2"></a> **`4.3.2. E-Tree without MAC Learning`**
...
<a id="section-5"></a> **`5. Operation for PBB-EVPN`**
...
<a id="section-5-1"></a> **`5.1. Known Unicast Traffic`**
...
<a id="section-5-2"></a> **`5.2. BUM Traffic`**
...
<a id="section-5-3"></a> **`5.3. E-Tree without MAC Learning`**
...
<a id="section-6"></a> **`6. BGP Encoding`**
...
<a id="section-6-1"></a> **`6.1. E-Tree Extended Community`**
...
<a id="section-6-2"></a> **`6.2. PMSI Tunnel Attribute`**
...
<a id="section-8-1"></a> **`8.1. Considerations for PMSI Tunnel Types`**
