...
`   `[`3`](#section-3)`. Upstream-Assigned vs. Downstream-Assigned`

`   `[`4`](#section-4)`. Ethernet Codepoints`

`   `[`5`](#section-5)`. PPP Protocol Field`

`   `[`6`](#section-6)`. GRE Protocol Type`

`   `[`7`](#section-7)`. IP Protocol Number`

`   `[`8`](#section-8)`. Ethernet MAC DA for Multicast MPLS`
...
<a id="section-3"></a> **`3. Upstream-Assigned vs. Downstream-Assigned`**
...
<a id="section-4"></a> **`4. Ethernet Codepoints`**
...
<a id="section-5"></a> **`5. PPP Protocol Field`**
...
<a id="section-6"></a> **`6. GRE Protocol Type`**
...
<a id="section-7"></a> **`7. IP Protocol Number`**
...
<a id="section-8"></a> **`8. Ethernet MAC DA for Multicast MPLS`**
