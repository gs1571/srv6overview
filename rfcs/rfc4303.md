...
`   `[`2`](#section-2)`. Encapsulating Security Payload Packet Format`

`      `[`2.1`](#section-2-1)`. Security Parameters Index (SPI)`

`      `[`2.2`](#section-2-2)`. Sequence Number`

`           `[`2.2.1`](#section-2-2-1)`. Extended (64-bit) Sequence Number`

`      `[`2.3`](#section-2-3)`. Payload Data`

`      `[`2.4`](#section-2-4)`. Padding (for Encryption)`

`      `[`2.5`](#section-2-5)`. Pad Length`

`      `[`2.6`](#section-2-6)`. Next Header`

`      `[`2.7`](#section-2-7)`. Traffic Flow Confidentiality (TFC) Padding`

`      `[`2.8`](#section-2-8)`. Integrity Check Value (ICV)`

`   `[`3`](#section-3)`. Encapsulating Security Protocol Processing`

`      `[`3.1`](#section-3-1)`. ESP Header Location`

`           `[`3.1.1`](#section-3-1-1)`. Transport Mode Processing`

`           `[`3.1.2`](#section-3-1-2)`. Tunnel Mode Processing`

`      `[`3.2`](#section-3-2)`. Algorithms`

`           `[`3.2.1`](#section-3-2-1)`. Encryption Algorithms`

`           `[`3.2.2`](#section-3-2-2)`. Integrity Algorithms`

`           `[`3.2.3`](#section-3-2-3)`. Combined Mode Algorithms`

`      `[`3.3`](#section-3-3)`. Outbound Packet Processing`

`           `[`3.3.1`](#section-3-3-1)`. Security Association Lookup`

`           `[`3.3.2`](#section-3-3-2)`. Packet Encryption and Integrity Check Value`

`                  (ICV) Calculation`

`                  `[`3.3.2.1`](#section-3-3-2-1)`. Separate Confidentiality and`

`                           Integrity Algorithms`

`                  `[`3.3.2.2`](#section-3-3-2-2)`. Combined Confidentiality and`

`                           Integrity Algorithms`

`           `[`3.3.3`](#section-3-3-3)`. Sequence Number Generation`

`           `[`3.3.4`](#section-3-3-4)`. Fragmentation`

`      `[`3.4`](#section-3-4)`. Inbound Packet Processing`

`           `[`3.4.1`](#section-3-4-1)`. Reassembly`

`           `[`3.4.2`](#section-3-4-2)`. Security Association Lookup`

`           `[`3.4.3`](#section-3-4-3)`. Sequence Number Verification`

`           `[`3.4.4`](#section-3-4-4)`. Integrity Check Value Verification`

`                  `[`3.4.4.1`](#section-3-4-4-1)`. Separate Confidentiality and`

`                           Integrity Algorithms`

`                  `[`3.4.4.2`](#section-3-4-4-2)`. Combined Confidentiality and`

`                           Integrity Algorithms`

`   `[`4`](#section-4)`. Auditing`

`   `[`5`](#section-5)`. Conformance Requirements`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Differences from RFC 2406`

`   `[`8`](#section-8)`. Backward-Compatibility Considerations`
...
<a id="section-2"></a> **`2. Encapsulating Security Payload Packet Format`**
...
<a id="section-2-1"></a> **`2.1. Security Parameters Index (SPI)`**
...
<a id="section-2-2"></a> **`2.2. Sequence Number`**
...
<a id="section-2-2-1"></a> **`2.2.1. Extended (64-bit) Sequence Number`**
...
<a id="section-2-3"></a> **`2.3. Payload Data`**
...
<a id="section-2-4"></a> **`2.4. Padding (for Encryption)`**
...
<a id="section-2-5"></a> **`2.5. Pad Length`**
...
<a id="section-2-6"></a> **`2.6. Next Header`**
...
<a id="section-2-7"></a> **`2.7. Traffic Flow Confidentiality (TFC) Padding`**
...
<a id="section-2-8"></a> **`2.8. Integrity Check Value (ICV)`**
...
<a id="section-3"></a> **`3. Encapsulating Security Protocol Processing`**

```text

```

<a id="section-3-1"></a> **`3.1. ESP Header Location`**
...
<a id="section-3-1-1"></a> **`3.1.1. Transport Mode Processing`**
...
<a id="section-3-1-2"></a> **`3.1.2. Tunnel Mode Processing`**
...
<a id="section-3-2"></a> **`3.2. Algorithms`**
...
<a id="section-3-2-1"></a> **`3.2.1. Encryption Algorithms`**
...
<a id="section-3-2-2"></a> **`3.2.2. Integrity Algorithms`**
...
<a id="section-3-2-3"></a> **`3.2.3. Combined Mode Algorithms`**
...
<a id="section-3-3"></a> **`3.3. Outbound Packet Processing`**
...
<a id="section-3-3-1"></a> **`3.3.1. Security Association Lookup`**
...
<a id="section-3-3-2"></a> **`3.3.2. Packet Encryption and Integrity Check Value (ICV) Calculation`**
...
<a id="section-3-3-2-1"></a> **`3.3.2.1. Separate Confidentiality and Integrity Algorithms`**
...
<a id="section-3-3-2-2"></a> **`3.3.2.2. Combined Confidentiality and Integrity Algorithms`**
...
<a id="section-3-3-3"></a> **`3.3.3. Sequence Number Generation`**
...
<a id="section-3-3-4"></a> **`3.3.4. Fragmentation`**
...
<a id="section-3-4"></a> **`3.4. Inbound Packet Processing`**

```text

```

<a id="section-3-4-1"></a> **`3.4.1. Reassembly`**
...
<a id="section-3-4-2"></a> **`3.4.2. Security Association Lookup`**
...
<a id="section-3-4-3"></a> **`3.4.3. Sequence Number Verification`**
...
<a id="section-3-4-4"></a> **`3.4.4. Integrity Check Value Verification`**
...
<a id="section-3-4-4-1"></a> **`3.4.4.1. Separate Confidentiality and Integrity Algorithms`**
...
<a id="section-3-4-4-2"></a> **`3.4.4.2. Combined Confidentiality and Integrity Algorithms`**
...
<a id="section-5"></a> **`5. Conformance Requirements`**
...
<a id="section-7"></a> **`7. Differences from RFC 2406`**
...
<a id="section-8"></a> **`8. Backward-Compatibility Considerations`**
