...
`      `[`3.1`](#section-3-1)`. Instance Identifier TLV`

`      `[`3.2`](#section-3-2)`. Instance Membership`

`      `[`3.3`](#section-3-3)`. Use of Authentication`

`      `[`3.4`](#section-3-4)`. Adjacency Establishment`

`           `[`3.4.1`](#section-3-4-1)`. Point-to-Point Adjacencies`

`           `[`3.4.2`](#section-3-4-2)`. Multi-Access Adjacencies`

`      `[`3.5`](#section-3-5)`. Update Process Operation`

`           `[`3.5.1`](#section-3-5-1)`. Update Process Operation on Point-to-Point`

`                  Circuits`

`           `[`3.5.2`](#section-3-5-2)`. Update Process Operation on Broadcast Circuits`

`      `[`3.6`](#section-3-6)`. Interoperability Considerations`

`           `[`3.6.1`](#section-3-6-1)`. Interoperability Issues on Broadcast Circuits`

`           `[`3.6.2`](#section-3-6-2)`. Interoperability Using Point-to-Point Circuits`

`   `[`4`](#section-4)`. Usage Guidelines`

`      `[`4.1`](#section-4-1)`. One-to-One Mapping between Topologies and Instances`

`      `[`4.2`](#section-4-2)`. Many-to-One Mapping between Topologies and Instances`

`      `[`4.3`](#section-4-3)`. Considerations for the Number of Instances`

`   `[`5`](#section-5)`. Relationship to M-ISIS`

`   `[`6`](#section-6)`. Graceful Restart Interactions`
...
<a id="section-2"></a> **`2. Requirements Language`**
...
<a id="section-3-1"></a> **`3.1. Instance Identifier TLV`**
...
<a id="section-3-2"></a> **`3.2. Instance Membership`**
...
<a id="section-3-3"></a> **`3.3. Use of Authentication`**
...
<a id="section-3-4"></a> **`3.4. Adjacency Establishment`**
...
<a id="section-3-4-1"></a> **`3.4.1. Point-to-Point Adjacencies`**
...
<a id="section-3-4-2"></a> **`3.4.2. Multi-Access Adjacencies`**
...
<a id="section-3-5"></a> **`3.5. Update Process Operation`**
...
<a id="section-3-5-1"></a> **`3.5.1. Update Process Operation on Point-to-Point Circuits`**
...
<a id="section-3-5-2"></a> **`3.5.2. Update Process Operation on Broadcast Circuits`**
...
<a id="section-3-6"></a> **`3.6. Interoperability Considerations`**
...
<a id="section-3-6-1"></a> **`3.6.1. Interoperability Issues on Broadcast Circuits`**
...
<a id="section-3-6-1-1"></a> **`3.6.1.1. Special Considerations when Operating in Point-to-Point Mode`**
...
<a id="section-3-6-2"></a> **`3.6.2. Interoperability Using Point-to-Point Circuits`**
...
<a id="section-4"></a> **`4. Usage Guidelines`**
...
<a id="section-4-1"></a> **`4.1. One-to-One Mapping between Topologies and Instances`**
...
<a id="section-4-2"></a> **`4.2. Many-to-One Mapping between Topologies and Instances`**
...
<a id="section-4-3"></a> **`4.3. Considerations for the Number of Instances`**
...
<a id="section-5"></a> **`5. Relationship to M-ISIS`**
...
<a id="section-6"></a> **`6. Graceful Restart Interactions`**
