...
`      `[`3.1`](#section-3-1)`. Extended Special-Purpose MPLS Label Values`

`      `[`3.2`](#section-3-2)`. Process for Retiring Special-Purpose Labels`

`   `[`4`](#section-4)`. Updated RFCs`
...
<a id="section-3-1"></a> **`3.1. Extended Special-Purpose MPLS Label Values`**
...
<a id="section-3-1-1"></a> **`3.1.1. Forwarding Packets with Extended Special-Purpose Labels`**
...
<a id="section-3-1-2"></a> **`3.1.2. Choosing a New Special-Purpose Label`**
...
<a id="section-3-2"></a> **`3.2. Process for Retiring Special-Purpose Labels`**
...
<a id="section-4"></a> **`4. Updated RFCs`**
