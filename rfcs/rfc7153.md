...
`   `[`2`](#section-2)`. Types, Sub-Types, and Registries`

`   `[`3`](#section-3)`. Applicability to IPv6-Address-Specific EC Attribute`

`   `[`4`](#section-4)`. How to Request EC Type and/or Sub-Type Codepoints`

`   `[`5`](#section-5)`. IANA Considerations`

`      `[`5.1`](#section-5-1)`. Registries for the "Type" Field`

`           `[`5.1.1`](#section-5-1-1)`. Transitive Types`

`           `[`5.1.2`](#section-5-1-2)`. Non-Transitive Types`

`      `[`5.2`](#section-5-2)`. Registries for the "Sub-Type" Field`

`           `[`5.2.1`](#section-5-2-1)`. EVPN Extended Community Sub-Types`

`           `[`5.2.2`](#section-5-2-2)`. Transitive Two-Octet AS-Specific Extended Community`

`                  Sub-Types`

`           `[`5.2.3`](#section-5-2-3)`. Non-Transitive Two-Octet AS-Specific Extended`

`                  Community Sub-Types`

`           `[`5.2.4`](#section-5-2-4)`. Transitive Four-Octet AS-Specific Extended`

`                  Community Sub-Types`

`           `[`5.2.5`](#section-5-2-5)`. Non-Transitive Four-Octet AS-Specific Extended`

`                  Community Sub-Types`

`           `[`5.2.6`](#section-5-2-6)`. Transitive IPv4-Address-Specific Extended Community`

`                  Sub-Types`

`           `[`5.2.7`](#section-5-2-7)`. Non-Transitive IPv4-Address-Specific Extended`

`                  Community Sub-Types`

`           `[`5.2.8`](#section-5-2-8)`. Transitive Opaque Extended Community Sub-Types`

`           `[`5.2.9`](#section-5-2-9)`. Non-Transitive Opaque Extended Community`

`                  Sub-Types`

`           `[`5.2.10`](#section-5-2-10)`. Generic Transitive Experimental Use Extended`

`                   Community Sub-Types`

`           `[`5.2.11`](#section-5-2-11)`. Registries for the "Value" Field`

`                  `[`5.2.11.1`](#section-5-2-11-1)`. Traffic Action Fields`

`      `[`5.3`](#section-5-3)`. Registries for IPv6-Address-Specific ECs`

`           `[`5.3.1`](#section-5-3-1)`. Transitive Types`

`           `[`5.3.2`](#section-5-3-2)`. Non-Transitive Types`
...
<a id="section-2"></a> **`2. Types, Sub-Types, and Registries`**
...
<a id="section-3"></a> **`3. Applicability to IPv6-Address-Specific EC Attribute`**
...
<a id="section-4"></a> **`4. How to Request EC Type and/or Sub-Type Codepoints`**
...
<a id="section-5-1"></a> **`5.1. Registries for the "Type" Field`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. Transitive Types`**
...
<a id="section-5-1-2"></a> **`5.1.2. Non-Transitive Types`**
...
<a id="section-5-2"></a> **`5.2. Registries for the "Sub-Type" Field`**

```text

```

<a id="section-5-2-1"></a> **`5.2.1. EVPN Extended Community Sub-Types`**
...
<a id="section-5-2-2"></a> **`5.2.2. Transitive Two-Octet AS-Specific Extended Community Sub-Types`**
...
<a id="section-5-2-3"></a> **`5.2.3. Non-Transitive Two-Octet AS-Specific Extended Community`**
...
<a id="section-5-2-4"></a> **`5.2.4. Transitive Four-Octet AS-Specific Extended Community Sub-Types`**
...
<a id="section-5-2-5"></a> **`5.2.5. Non-Transitive Four-Octet AS-Specific Extended Community`**
...
<a id="section-5-2-6"></a> **`5.2.6. Transitive IPv4-Address-Specific Extended Community Sub-Types`**
...
<a id="section-5-2-7"></a> **`5.2.7. Non-Transitive IPv4-Address-Specific Extended Community`**
...
<a id="section-5-2-8"></a> **`5.2.8. Transitive Opaque Extended Community Sub-Types`**
...
<a id="section-5-2-9"></a> **`5.2.9. Non-Transitive Opaque Extended Community Sub-Types`**
...
<a id="section-5-2-10"></a> **`5.2.10. Generic Transitive Experimental Use Extended Community`**
...
<a id="section-5-2-11"></a> **`5.2.11. Registries for the "Value" Field`**
...
<a id="section-5-2-11-1"></a> **`5.2.11.1. Traffic Action Fields`**
...
<a id="section-5-3"></a> **`5.3. Registries for IPv6-Address-Specific ECs`**

```text

```

<a id="section-5-3-1"></a> **`5.3.1. Transitive Types`**
...
<a id="section-5-3-2"></a> **`5.3.2. Non-Transitive Types`**
