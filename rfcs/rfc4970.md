...
`     `[`2.3`](#section-2-3)`. OSPF Router Informational Capabilities TLV`

`     `[`2.4`](#section-2-4)`. Assigned OSPF Router Informational Capability Bits`

`     `[`2.5`](#section-2-5)`. Flooding Scope of the Router Information LSA`

`   `[`3`](#section-3)`. Router Information LSA Opaque Usage and Applicability`
...
<a id="section-2-3"></a> **`2.3. OSPF Router Informational Capabilities TLV`**
...
<a id="section-2-4"></a> **`2.4. Assigned OSPF Router Informational Capability Bits`**
...
<a id="section-2-5"></a> **`2.5. Flooding Scope of the Router Information LSA`**
...
<a id="section-3"></a> **`3. Router Information LSA Opaque Usage and Applicability`**
