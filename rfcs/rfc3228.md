...
`   `[`2`](#section-2)`. IANA Considerations for fields in the IPv4 IGMP header`

`   `[`3`](#section-3)`. Assignments for testing and experimentation`

`   `[`4`](#section-4)`. Security Considerations`

`   `[`5`](#section-5)`. Normative References`

`   `[`6`](#section-6)`. Informative References`

`   `[`7`](#section-7)`. Author's Address`

`   `[`8`](#section-8)`. Full Copyright Statement`
...
<a id="section-2"></a> **`2. IANA Considerations for fields in the IPv4 IGMP header`**
...
<a id="section-3"></a> **`3. Assignments for testing and experimentation`**
...
<a id="section-5"></a> **`5. Normative References`**
...
<a id="section-7"></a> **`7. Author's Address`**
...
<a id="section-8"></a> **`8. Full Copyright Statement`**
