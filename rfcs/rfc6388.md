...
`      `[`1.3`](#section-1-3)`. Manageability`

`   `[`2`](#section-2)`. Setting Up P2MP LSPs with LDP`

`      `[`2.1`](#section-2-1)`. Support for P2MP LSP Setup with LDP`

`      `[`2.2`](#section-2-2)`. The P2MP FEC Element`

`      `[`2.3`](#section-2-3)`. The LDP MP Opaque Value Element`

`           `[`2.3.1`](#section-2-3-1)`. The Generic LSP Identifier`

`      `[`2.4`](#section-2-4)`. Using the P2MP FEC Element`

`           `[`2.4.1`](#section-2-4-1)`. Label Mapping`

`           `[`2.4.2`](#section-2-4-2)`. Label Withdraw`

`           `[`2.4.3`](#section-2-4-3)`. Upstream LSR Change`

`   `[`3`](#section-3)`. Setting up MP2MP LSPs with LDP`

`      `[`3.1`](#section-3-1)`. Support for MP2MP LSP Setup with LDP`

`      `[`3.2`](#section-3-2)`. The MP2MP Downstream and Upstream FEC Elements`

`      `[`3.3`](#section-3-3)`. Using the MP2MP FEC Elements`

`           `[`3.3.1`](#section-3-3-1)`. MP2MP Label Mapping`

`           `[`3.3.2`](#section-3-3-2)`. MP2MP Label Withdraw`

`           `[`3.3.3`](#section-3-3-3)`. MP2MP Upstream LSR Change`

`   `[`4`](#section-4)`. Micro-Loops in MP LSPs`

`   `[`5`](#section-5)`. The LDP MP Status TLV`

`      `[`5.1`](#section-5-1)`. The LDP MP Status Value Element`

`      `[`5.2`](#section-5-2)`. LDP Messages Containing LDP MP Status Messages`

`           `[`5.2.1`](#section-5-2-1)`. LDP MP Status Sent in LDP Notification Messages`

`           `[`5.2.2`](#section-5-2-2)`. LDP MP Status TLV in Label Mapping Message`

`   `[`6`](#section-6)`. Upstream Label Allocation on a LAN`

`      `[`6.1`](#section-6-1)`. LDP Multipoint-to-Multipoint on a LAN`

`           `[`6.1.1`](#section-6-1-1)`. MP2MP Downstream Forwarding`

`           `[`6.1.2`](#section-6-1-2)`. MP2MP Upstream Forwarding`

`   `[`7`](#section-7)`. Root Node Redundancy`

`      `[`7.1`](#section-7-1)`. Root Node Redundancy - Procedures for P2MP LSPs`

`      `[`7.2`](#section-7-2)`. Root Node Redundancy - Procedures for MP2MP LSPs`

`   `[`8`](#section-8)`. Make Before Break (MBB)`

`      `[`8.1`](#section-8-1)`. MBB Overview`

`      `[`8.2`](#section-8-2)`. The MBB Status Code`

`      `[`8.3`](#section-8-3)`. The MBB Capability`

`      `[`8.4`](#section-8-4)`. The MBB Procedures`

`           `[`8.4.1`](#section-8-4-1)`. Terminology`

`           `[`8.4.2`](#section-8-4-2)`. Accepting Elements`

`           `[`8.4.3`](#section-8-4-3)`. Procedures for Upstream LSR Change`

`           `[`8.4.4`](#section-8-4-4)`. Receiving a Label Mapping with MBB Status Code`

`           `[`8.4.5`](#section-8-4-5)`. Receiving a Notification with MBB Status Code`

`           `[`8.4.6`](#section-8-4-6)`. Node Operation for MP2MP LSPs`

`   `[`9`](#section-9)`. Typed Wildcard for mLDP FEC Element`
...
`   `[`13`](#section-13)`. Contributing Authors`
...
<a id="section-1-3"></a> **`1.3. Manageability`**
...
<a id="section-2"></a> **`2. Setting Up P2MP LSPs with LDP`**
...
<a id="section-2-1"></a> **`2.1. Support for P2MP LSP Setup with LDP`**
...
<a id="section-2-2"></a> **`2.2. The P2MP FEC Element`**
...
<a id="section-2-3"></a> **`2.3. The LDP MP Opaque Value Element`**
...
<a id="section-2-3-1"></a> **`2.3.1. The Generic LSP Identifier`**
...
<a id="section-2-4"></a> **`2.4. Using the P2MP FEC Element`**
...
<a id="section-2-4-1"></a> **`2.4.1. Label Mapping`**
...
<a id="section-2-4-1-1"></a> **`2.4.1.1. Determining One's 'upstream LSR'`**
...
<a id="section-2-4-1-2"></a> **`2.4.1.2. Determining the Forwarding Interface to an LSR`**
...
<a id="section-2-4-1-3"></a> **`2.4.1.3. Leaf Operation`**
...
<a id="section-2-4-1-4"></a> **`2.4.1.4. Transit Node Operation`**
...
<a id="section-2-4-1-5"></a> **`2.4.1.5. Root Node Operation`**
...
<a id="section-2-4-2"></a> **`2.4.2. Label Withdraw`**
...
<a id="section-2-4-2-1"></a> **`2.4.2.1. Leaf Operation`**
...
<a id="section-2-4-2-2"></a> **`2.4.2.2. Transit Node Operation`**
...
<a id="section-2-4-2-3"></a> **`2.4.2.3. Root Node Operation`**
...
<a id="section-2-4-3"></a> **`2.4.3. Upstream LSR Change`**
...
<a id="section-3"></a> **`3. Setting up MP2MP LSPs with LDP`**
...
<a id="section-3-1"></a> **`3.1. Support for MP2MP LSP Setup with LDP`**
...
<a id="section-3-2"></a> **`3.2. The MP2MP Downstream and Upstream FEC Elements`**
...
<a id="section-3-3"></a> **`3.3. Using the MP2MP FEC Elements`**
...
<a id="section-3-3-1"></a> **`3.3.1. MP2MP Label Mapping`**
...
<a id="section-3-3-1-1"></a> **`3.3.1.1. Determining one's upstream MP2MP LSR`**
...
<a id="section-3-3-1-2"></a> **`3.3.1.2. Determining One's Downstream MP2MP LSR`**
...
<a id="section-3-3-1-3"></a> **`3.3.1.3. Installing the Upstream Path of an MP2MP LSP`**
...
<a id="section-3-3-1-4"></a> **`3.3.1.4. MP2MP Leaf Node Operation`**
...
<a id="section-3-3-1-5"></a> **`3.3.1.5. MP2MP Transit Node Operation`**
...
<a id="section-3-3-1-6"></a> **`3.3.1.6. MP2MP Root Node Operation`**

```text

```

<a id="section-3-3-1-6-1"></a> **`3.3.1.6.1. Root Node Is Also a Leaf`**
...
<a id="section-3-3-1-6-2"></a> **`3.3.1.6.2. Root Node is Not a Leaf`**
...
<a id="section-3-3-2"></a> **`3.3.2. MP2MP Label Withdraw`**
...
<a id="section-3-3-2-1"></a> **`3.3.2.1. MP2MP Leaf Operation`**
...
<a id="section-3-3-2-2"></a> **`3.3.2.2. MP2MP Transit Node Operation`**
...
<a id="section-3-3-2-3"></a> **`3.3.2.3. MP2MP Root Node Operation`**
...
<a id="section-3-3-3"></a> **`3.3.3. MP2MP Upstream LSR Change`**
...
<a id="section-4"></a> **`4. Micro-Loops in MP LSPs`**
...
<a id="section-5"></a> **`5. The LDP MP Status TLV`**
...
<a id="section-5-1"></a> **`5.1. The LDP MP Status Value Element`**
...
<a id="section-5-2"></a> **`5.2. LDP Messages Containing LDP MP Status Messages`**
...
<a id="section-5-2-1"></a> **`5.2.1. LDP MP Status Sent in LDP Notification Messages`**
...
<a id="section-5-2-2"></a> **`5.2.2. LDP MP Status TLV in Label Mapping Message`**
...
<a id="section-6"></a> **`6. Upstream Label Allocation on a LAN`**
...
<a id="section-6-1"></a> **`6.1. LDP Multipoint-to-Multipoint on a LAN`**
...
<a id="section-6-1-1"></a> **`6.1.1. MP2MP Downstream Forwarding`**
...
<a id="section-6-1-2"></a> **`6.1.2. MP2MP Upstream Forwarding`**
...
<a id="section-7"></a> **`7. Root Node Redundancy`**
...
<a id="section-7-1"></a> **`7.1. Root Node Redundancy - Procedures for P2MP LSPs`**
...
<a id="section-7-2"></a> **`7.2. Root Node Redundancy - Procedures for MP2MP LSPs`**
...
<a id="section-8"></a> **`8. Make Before Break (MBB)`**
...
<a id="section-8-1"></a> **`8.1. MBB Overview`**
...
<a id="section-8-2"></a> **`8.2. The MBB Status Code`**
...
<a id="section-8-3"></a> **`8.3. The MBB Capability`**
...
<a id="section-8-4"></a> **`8.4. The MBB Procedures`**

```text

```

<a id="section-8-4-1"></a> **`8.4.1. Terminology`**
...
<a id="section-8-4-2"></a> **`8.4.2. Accepting Elements`**
...
<a id="section-8-4-3"></a> **`8.4.3. Procedures for Upstream LSR Change`**
...
<a id="section-8-4-4"></a> **`8.4.4. Receiving a Label Mapping with MBB Status Code`**
...
<a id="section-8-4-5"></a> **`8.4.5. Receiving a Notification with MBB Status Code`**
...
<a id="section-8-4-6"></a> **`8.4.6. Node Operation for MP2MP LSPs`**
...
<a id="section-9"></a> **`9. Typed Wildcard for mLDP FEC Element`**
...
<a id="section-13"></a> **`13. Contributing Authors`**
