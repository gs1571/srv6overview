...
`   `[`3`](#section-3)`. Co-authors`

`   `[`4`](#section-4)`. Acronyms and Abbreviations`

`   `[`5`](#section-5)`. Applicability Statement`

`   `[`6`](#section-6)`. General Encapsulation Method`

`   `[`7`](#section-7)`. Frame Relay over MPLS PSN for the One-to-One Mode`

`      `[`7.1`](#section-7-1)`. MPLS PSN Tunnel and PW`

`      `[`7.2`](#section-7-2)`. Packet Format over MPLS PSN`

`      `[`7.3`](#section-7-3)`. The Control Word`

`      `[`7.4`](#section-7-4)`. The Martini Legacy Mode Control Word`

`      `[`7.5`](#section-7-5)`. PW Packet Processing`

`           `[`7.5.1`](#section-7-5-1)`. Encapsulation of Frame Relay Frames`

`           `[`7.5.2`](#section-7-5-2)`. Setting the Sequence Number`

`      `[`7.6`](#section-7-6)`. Decapsulation of PW Packets`

`           `[`7.6.1`](#section-7-6-1)`. Processing the Sequence Number`

`           `[`7.6.2`](#section-7-6-2)`. Processing of the Length Field by the Receiver`

`      `[`7.7`](#section-7-7)`. MPLS Shim EXP Bit Values`

`      `[`7.8`](#section-7-8)`. MPLS Shim S Bit Value`

`      `[`7.9`](#section-7-9)`. Control Plane Details for Frame Relay Service`

`           `[`7.9.1`](#section-7-9-1)`. Frame Relay Specific Interface Parameter Sub-TLV`

`   `[`8`](#section-8)`. Frame Relay Port Mode`

`   `[`9`](#section-9)`. Congestion Control`

`   `[`10`](#section-10)`. Security Considerations`

`   `[`11`](#section-11)`. Normative References`
...
<a id="section-4"></a> **`4. Acronyms and Abbreviations`**
...
<a id="section-5"></a> **`5. Applicability Statement`**
...
<a id="section-6"></a> **`6. General Encapsulation Method`**
...
<a id="section-7"></a> **`7. Frame Relay over MPLS PSN for the One-to-One Mode`**

```text

```

<a id="section-7-1"></a> **`7.1. MPLS PSN Tunnel and PW`**
...
<a id="section-7-2"></a> **`7.2. Packet Format over MPLS PSN`**
...
<a id="section-7-3"></a> **`7.3. The Control Word`**
...
<a id="section-7-4"></a> **`7.4. The Martini Legacy Mode Control Word`**
...
<a id="section-7-5"></a> **`7.5. PW Packet Processing`**

```text

```

<a id="section-7-5-1"></a> **`7.5.1. Encapsulation of Frame Relay Frames`**
...
<a id="section-7-5-2"></a> **`7.5.2. Setting the Sequence Number`**
...
<a id="section-7-6"></a> **`7.6. Decapsulation of PW Packets`**
...
<a id="section-7-6-1"></a> **`7.6.1. Processing the Sequence Number`**
...
<a id="section-7-6-2"></a> **`7.6.2. Processing of the Length Field by the Receiver`**
...
<a id="section-7-7"></a> **`7.7. MPLS Shim EXP Bit Values`**
...
<a id="section-7-8"></a> **`7.8. MPLS Shim S Bit Value`**
...
<a id="section-7-9"></a> **`7.9. Control Plane Details for Frame Relay Service`**
...
<a id="section-7-9-1"></a> **`7.9.1. Frame Relay Specific Interface Parameter Sub-TLV`**
...
<a id="section-8"></a> **`8. Frame Relay Port Mode`**
...
<a id="section-9"></a> **`9. Congestion Control`**
...
<a id="section-11"></a> **`11. Normative References`**
