...
`       `[`4`](#section-4)`. 1 Extension Header Order`

`       `[`4`](#section-4)`. 2 Options`

`       `[`4`](#section-4)`. 3 Hop-by-Hop Options Header`

`       `[`4`](#section-4)`. 4 Routing Header`

`       `[`4`](#section-4)`. 5 Fragment Header`

`       `[`4`](#section-4)`. 6 Destination Options Header`

`       `[`4`](#section-4)`. 7 No Next Header`
...
`       `[`8`](#section-8)`. 1 Upper-Layer Checksums`

`       `[`8`](#section-8)`. 2 Maximum Packet Lifetime`

`       `[`8`](#section-8)`. 3 Maximum Upper-Layer Payload Size`

`       `[`8`](#section-8)`. 4 Responding to Packets Carrying Routing Headers`
