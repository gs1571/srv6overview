...
`   `[`2`](#section-2)`. Marker for End-of-RIB`

`   `[`3`](#section-3)`. Graceful Restart Capability`

`   `[`4`](#section-4)`. Operation`

`      `[`4.1`](#section-4-1)`. Procedures for the Restarting Speaker`

`      `[`4.2`](#section-4-2)`. Procedures for the Receiving Speaker`

`   `[`5`](#section-5)`. Changes to BGP Finite State Machine`
...
<a id="section-2"></a> **`2. Marker for End-of-RIB`**
...
<a id="section-3"></a> **`3. Graceful Restart Capability`**
...
<a id="section-4-1"></a> **`4.1. Procedures for the Restarting Speaker`**
...
<a id="section-4-2"></a> **`4.2. Procedures for the Receiving Speaker`**
...
<a id="section-5"></a> **`5. Changes to BGP Finite State Machine`**
