...
`   `[`1`](#section-1)`. The Internet-Standard Management Framework`

`   `[`2`](#section-2)`. Overview`

`       `[`2.1`](#section-2-1)`. Relationship to Other MIBs`
...
<a id="section-1"></a> **`1. The Internet-Standard Management Framework`**
...
<a id="section-2-1"></a> **`2.1. Relationship to Other MIBs`**
...
<a id="section-2-1-1"></a> **`2.1.1. Relationship to RFC1213-MIB`**
...
<a id="section-2-1-2"></a> **`2.1.2. Relationship to IPV6-TCP-MIB`**
...
<a id="section-2-1-3"></a> **`2.1.3. Relationship to HOST-RESOURCES-MIB and SYSAPPL-MIB`**
