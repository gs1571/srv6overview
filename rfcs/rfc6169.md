...
`   `[`2`](#section-2)`. Tunnels May Bypass Security`

`      `[`2.1`](#section-2-1)`. Network Security Bypass`

`      `[`2.2`](#section-2-2)`. IP Ingress and Egress Filtering Bypass`

`      `[`2.3`](#section-2-3)`. Source Routing after the Tunnel Client`

`   `[`3`](#section-3)`. Challenges in Inspecting and Filtering Content of`

`      Tunneled Data Packets`

`      `[`3.1`](#section-3-1)`. Inefficiency of Selective Network Filtering of All`

`           Tunneled Packets`

`      `[`3.2`](#section-3-2)`. Problems with Deep Packet Inspection of Tunneled`

`           Data Packets`

`   `[`4`](#section-4)`. Increased Exposure Due to Tunneling`

`      `[`4.1`](#section-4-1)`. NAT Holes Increase Attack Surface`

`      `[`4.2`](#section-4-2)`. Exposure of a NAT Hole`

`      `[`4.3`](#section-4-3)`. Public Tunnels Widen Holes in Restricted NATs`

`   `[`5`](#section-5)`. Tunnel Address Concerns`

`      `[`5.1`](#section-5-1)`. Feasibility of Guessing Tunnel Addresses`

`      `[`5.2`](#section-5-2)`. Profiling Targets Based on Tunnel Address`

`   `[`6`](#section-6)`. Additional Security Concerns`

`      `[`6.1`](#section-6-1)`. Attacks Facilitated by Changing Tunnel Server Setting`

`   `[`7`](#section-7)`. Mechanisms to Secure the Use of Tunnels`
...
<a id="section-2"></a> **`2. Tunnels May Bypass Security`**

```text

```

<a id="section-2-1"></a> **`2.1. Network Security Bypass`**

```text

```

<a id="section-2-1-1"></a> **`2.1.1. Problem`**
...
<a id="section-2-1-2"></a> **`2.1.2. Discussion`**
...
<a id="section-2-1-3"></a> **`2.1.3. Recommendations`**
...
<a id="section-2-2"></a> **`2.2. IP Ingress and Egress Filtering Bypass`**

```text

```

<a id="section-2-2-1"></a> **`2.2.1. Problem`**
...
<a id="section-2-2-2"></a> **`2.2.2. Discussion`**
...
<a id="section-2-2-3"></a> **`2.2.3. Recommendations`**
...
<a id="section-2-3"></a> **`2.3. Source Routing after the Tunnel Client`**

```text

```

<a id="section-2-3-1"></a> **`2.3.1. Problem`**
...
<a id="section-2-3-2"></a> **`2.3.2. Discussion`**
...
<a id="section-2-3-3"></a> **`2.3.3. Recommendations`**
...
<a id="section-3"></a> **`3. Challenges in Inspecting and Filtering Content of Tunneled Data`**
...
<a id="section-3-1"></a> **`3.1. Inefficiency of Selective Network Filtering of All Tunneled`**
...
<a id="section-3-1-1"></a> **`3.1.1. Problem`**
...
<a id="section-3-1-2"></a> **`3.1.2. Discussion`**
...
<a id="section-3-1-3"></a> **`3.1.3. Recommendations`**
...
<a id="section-3-2"></a> **`3.2. Problems with Deep Packet Inspection of Tunneled Data Packets`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. Problem`**
...
<a id="section-3-2-2"></a> **`3.2.2. Discussion`**
...
<a id="section-3-2-3"></a> **`3.2.3. Recommendations`**
...
<a id="section-4"></a> **`4. Increased Exposure Due to Tunneling`**

```text

```

<a id="section-4-1"></a> **`4.1. NAT Holes Increase Attack Surface`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Problem`**
...
<a id="section-4-1-2"></a> **`4.1.2. Discussion`**
...
<a id="section-4-1-3"></a> **`4.1.3. Recommendation`**
...
<a id="section-4-2"></a> **`4.2. Exposure of a NAT Hole`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Problem`**
...
<a id="section-4-2-2"></a> **`4.2.2. Discussion`**
...
<a id="section-4-2-3"></a> **`4.2.3. Recommendation`**
...
<a id="section-4-3"></a> **`4.3. Public Tunnels Widen Holes in Restricted NATs`**

```text

```

<a id="section-4-3-1"></a> **`4.3.1. Problem`**
...
<a id="section-4-3-2"></a> **`4.3.2. Discussion`**
...
<a id="section-4-3-3"></a> **`4.3.3. Recommendations`**
...
<a id="section-5"></a> **`5. Tunnel Address Concerns`**

```text

```

<a id="section-5-1"></a> **`5.1. Feasibility of Guessing Tunnel Addresses`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. Problem`**
...
<a id="section-5-1-2"></a> **`5.1.2. Discussion`**
...
<a id="section-5-1-3"></a> **`5.1.3. Recommendations`**
...
<a id="section-5-2"></a> **`5.2. Profiling Targets Based on Tunnel Address`**

```text

```

<a id="section-5-2-1"></a> **`5.2.1. Problem`**
...
<a id="section-5-2-2"></a> **`5.2.2. Discussion`**
...
<a id="section-5-2-3"></a> **`5.2.3. Recommendations`**
...
<a id="section-6"></a> **`6. Additional Security Concerns`**

```text

```

<a id="section-6-1"></a> **`6.1. Attacks Facilitated by Changing Tunnel Server Setting`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. Problem`**
...
<a id="section-6-1-2"></a> **`6.1.2. Discussion`**
...
<a id="section-6-1-3"></a> **`6.1.3. Recommendations`**
...
<a id="section-7"></a> **`7. Mechanisms to Secure the Use of Tunnels`**
