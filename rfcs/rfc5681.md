...
<a id="section-3"></a> **`3. Congestion Control Algorithms`**
...
<a id="section-3-1"></a> **`3.1. Slow Start and Congestion Avoidance`**
...
<a id="section-3-2"></a> **`3.2. Fast Retransmit/Fast Recovery`**
...
<a id="section-4"></a> **`4. Additional Considerations`**

```text

```

<a id="section-4-1"></a> **`4.1. Restarting Idle Connections`**
...
<a id="section-4-2"></a> **`4.2. Generating Acknowledgments`**
...
<a id="section-4-3"></a> **`4.3. Loss Recovery Mechanisms`**
...
<a id="section-6"></a> **`6. Changes between RFC 2001 and RFC 2581`**
...
<a id="section-7"></a> **`7. Changes Relative to RFC 2581`**
