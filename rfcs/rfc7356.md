...
`   `[`2`](#section-2)`. Extended TLVs`

`     `[`2.1`](#section-2-1)`. Use of Extended TLVs and Extended Sub-TLVs`

`     `[`2.2`](#section-2-2)`. Use of Standard Code Points in Extended TLVs and Extended`

`           Sub-TLVs`

`   `[`3`](#section-3)`. Definition of New PDUs`

`     `[`3.1`](#section-3-1)`. Flooding Scoped LSP Format`

`     `[`3.2`](#section-3-2)`. Flooding Scoped CSNP Format`

`     `[`3.3`](#section-3-3)`. Flooding Scope PSNP Format`

`   `[`4`](#section-4)`. Flooding Scope Update Process Operation`

`     `[`4.1`](#section-4-1)`. Scope Types`

`     `[`4.2`](#section-4-2)`. Operation on Point-to-Point Circuits`

`     `[`4.3`](#section-4-3)`. Operation on Broadcast Circuits`

`     `[`4.4`](#section-4-4)`. Use of Authentication`

`     `[`4.5`](#section-4-5)`. Priority Flooding`

`   `[`5`](#section-5)`. Deployment Considerations`

`   `[`6`](#section-6)`. Graceful Restart Interactions`

`   `[`7`](#section-7)`. Multi-instance Interactions`

`   `[`8`](#section-8)`. Circuit Scope Flooding`

`   `[`9`](#section-9)`. Extending LSP Set Capacity`

`   `[`10`](#section-10)`. Domain Scope Flooding`

`   `[`11`](#section-11)`. Announcing Support for Flooding Scopes`
...
<a id="section-2"></a> **`2. Extended TLVs`**
...
<a id="section-2-1"></a> **`2.1. Use of Extended TLVs and Extended Sub-TLVs`**
...
<a id="section-2-2"></a> **`2.2. Use of Standard Code Points in Extended TLVs and Extended Sub-TLVs`**
...
<a id="section-3"></a> **`3. Definition of New PDUs`**
...
<a id="section-3-1"></a> **`3.1. Flooding Scoped LSP Format`**
...
<a id="section-3-2"></a> **`3.2. Flooding Scoped CSNP Format`**
...
<a id="section-3-3"></a> **`3.3. Flooding Scope PSNP Format`**
...
<a id="section-4"></a> **`4. Flooding Scope Update Process Operation`**
...
<a id="section-4-1"></a> **`4.1. Scope Types`**
...
<a id="section-4-2"></a> **`4.2. Operation on Point-to-Point Circuits`**
...
<a id="section-4-3"></a> **`4.3. Operation on Broadcast Circuits`**
...
<a id="section-4-4"></a> **`4.4. Use of Authentication`**
...
<a id="section-4-5"></a> **`4.5. Priority Flooding`**
...
<a id="section-5"></a> **`5. Deployment Considerations`**
...
<a id="section-7"></a> **`7. Multi-instance Interactions`**
...
<a id="section-8"></a> **`8. Circuit Scope Flooding`**
...
<a id="section-9"></a> **`9. Extending LSP Set Capacity`**
...
<a id="section-10"></a> **`10. Domain Scope Flooding`**
...
<a id="section-11"></a> **`11. Announcing Support for Flooding Scopes`**
