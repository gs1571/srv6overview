...
`   `[`2`](#section-2)`. Generalized Association ID Field Definition`

`   `[`3`](#section-3)`. Non-GMPLS and Non-Recovery Usage`

`      `[`3.1`](#section-3-1)`. Upstream Initiated Association`

`           `[`3.1.1`](#section-3-1-1)`. Path Message Format`

`           `[`3.1.2`](#section-3-1-2)`. Path Message Processing`

`      `[`3.2`](#section-3-2)`. Downstream Initiated Association`

`           `[`3.2.1`](#section-3-2-1)`. Resv Message Format`

`           `[`3.2.2`](#section-3-2-2)`. Resv Message Processing`

`      `[`3.3`](#section-3-3)`. Association Types`

`           `[`3.3.1`](#section-3-3-1)`. Resource Sharing Association Type`

`           `[`3.3.2`](#section-3-3-2)`. Unknown Association Types`

`   `[`4`](#section-4)`. IPv4 and IPv6 Extended ASSOCIATION Objects`

`      `[`4.1`](#section-4-1)`. IPv4 and IPv6 Extended ASSOCIATION Object Format`

`      `[`4.2`](#section-4-2)`. Processing`
...
`      `[`7.1`](#section-7-1)`. IPv4 and IPv6 Extended ASSOCIATION Objects`

`      `[`7.2`](#section-7-2)`. Resource Sharing Association Type`
...
<a id="section-2"></a> **`2. Generalized Association ID Field Definition`**
...
<a id="section-3"></a> **`3. Non-GMPLS and Non-Recovery Usage`**
...
<a id="section-3-1"></a> **`3.1. Upstream-Initiated Association`**
...
<a id="section-3-1-1"></a> **`3.1.1. Path Message Format`**
...
<a id="section-3-1-2"></a> **`3.1.2. Path Message Processing`**
...
<a id="section-3-2"></a> **`3.2. Downstream-Initiated Association`**
...
<a id="section-3-2-1"></a> **`3.2.1. Resv Message Format`**
...
<a id="section-3-2-2"></a> **`3.2.2. Resv Message Processing`**
...
<a id="section-3-3"></a> **`3.3. Association Types`**
...
<a id="section-3-3-1"></a> **`3.3.1. Resource Sharing Association Type`**
...
<a id="section-3-3-2"></a> **`3.3.2. Unknown Association Types`**
...
<a id="section-4"></a> **`4. IPv4 and IPv6 Extended ASSOCIATION Objects`**
...
<a id="section-4-1"></a> **`4.1. IPv4 and IPv6 Extended ASSOCIATION Object Format`**
...
<a id="section-4-2"></a> **`4.2. Processing`**
...
<a id="section-5"></a> **`5. Compatibility`**
...
<a id="section-7-1"></a> **`7.1. IPv4 and IPv6 Extended ASSOCIATION Objects`**
...
<a id="section-7-2"></a> **`7.2. Resource Sharing Association Type`**
