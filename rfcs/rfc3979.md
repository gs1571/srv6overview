...
`   `[`3`](#section-3)`. Contributions to the IETF`

`       `[`3.1`](#section-3-1)`. General Policy`

`       `[`3.2`](#section-3-2)`. Rights and Permissions`

`   `[`4`](#section-4)`. Actions for Documents for which IPR Disclosure(s) Have Been`

`       Received`

`       `[`4.1`](#section-4-1)`. No Determination of Reasonable and Non-discriminatory`

`             Terms`

`   `[`5`](#section-5)`. Notice to be Included in RFCs`

`   `[`6`](#section-6)`. IPR Disclosures`

`       `[`6.1`](#section-6-1)`. Who Must Make an IPR Disclosure?`

`       `[`6.2`](#section-6-2)`. The Timing of Providing Disclosure`

`       `[`6.3`](#section-6-3)`. How Must a Disclosure be Made?`

`       `[`6.4`](#section-6-4)`. What Must be in a Disclosure?`

`       `[`6.5`](#section-6-5)`. What Licensing Information to Detail in a Disclosure .`

`       `[`6.6`](#section-6-6)`. When is a Disclosure Required?`

`   `[`7`](#section-7)`. Failure to Disclose`

`   `[`8`](#section-8)`. Evaluating Alternative Technologies in IETF Working Groups .`

`   `[`9`](#section-9)`. Change Control for Technologies`

`   `[`10`](#section-10)`. Licensing Requirements to Advance Standards Track Documents.`

`   `[`11`](#section-11)`. No IPR Disclosures in IETF Documents`
...
`   `[`15`](#section-15)`. Editor's Address`

`       Full Copyright Statement`


<a id="section-1"></a> **`1. Definitions`**
...
<a id="section-3"></a> **`3. Contributions to the IETF`**

```text

```

<a id="section-3-1"></a> **`3.1. General Policy`**
...
<a id="section-3-2"></a> **`3.2. Rights and Permissions`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. All Contributions`**
...
<a id="section-4"></a> **`4. Actions for Documents for which IPR Disclosure(s) Have Been Received`**
...
<a id="section-4-1"></a> **`4.1. No Determination of Reasonable and Non-discriminatory Terms`**
...
<a id="section-5"></a> **`5. Notice to be Included in RFCs`**
...
<a id="section-6"></a> **`6. IPR Disclosures`**
...
<a id="section-6-1"></a> **`6.1. Who Must Make an IPR Disclosure?`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. A Contributor's IPR in his or her Contribution`**
...
<a id="section-6-1-2"></a> **`6.1.2. An IETF Participant's IPR in Contributions by Others`**
...
<a id="section-6-1-3"></a> **`6.1.3. IPR of Others`**
...
<a id="section-6-2"></a> **`6.2. The Timing of Providing Disclosure`**
...
<a id="section-6-2-1"></a> **`6.2.1. Timing of Disclosure Under Section 6.1.1`**
...
<a id="section-6-2-2"></a> **`6.2.2. Timing of Disclosure Under Section 6.1.2`**
...
<a id="section-6-3"></a> **`6.3. How Must a Disclosure be Made?`**
...
<a id="section-6-4"></a> **`6.4. What Must be in a Disclosure?`**

```text

```

<a id="section-6-4-1"></a> **`6.4.1. The disclosure must list the numbers of any issued patents or`**
...
<a id="section-6-4-2"></a> **`6.4.2. If a disclosure was made on the basis of a patent application`**
...
<a id="section-6-4-3"></a> **`6.4.3. The requirement for an IPR disclosure is not satisfied by the`**
...
<a id="section-6-5"></a> **`6.5. What Licensing Information to Detail in a Disclosure`**
...
<a id="section-6-6"></a> **`6.6. When is a Disclosure Required?`**
...
<a id="section-7"></a> **`7. Failure to Disclose`**
...
<a id="section-8"></a> **`8. Evaluating Alternative Technologies in IETF Working Groups`**
...
<a id="section-9"></a> **`9. Change Control for Technologies`**
...
<a id="section-10"></a> **`10. Licensing Requirements to Advance Standards Track IETF Documents`**
...
<a id="section-11"></a> **`11. No IPR Disclosures in IETF Documents`**
