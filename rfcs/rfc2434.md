...
`   `[`2`](#section-2)`. Issues To Consider`

`   `[`3`](#section-3)`. Registration maintenance`

`   `[`4`](#section-4)`. What To Put In Documents`

`   `[`5`](#section-5)`. Applicability to Past and Future RFCs`
...
<a id="section-2"></a> **`2. Issues To Consider`**
...
<a id="section-3"></a> **`3. Registration maintenance`**
...
<a id="section-4"></a> **`4. What To Put In Documents`**
...
<a id="section-5"></a> **`5. Applicability to Past and Future RFCs`**
