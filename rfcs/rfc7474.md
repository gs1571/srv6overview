...
`   `[`2`](#section-2)`. Replay Protection Using Extended Sequence Numbers`

`   `[`3`](#section-3)`. OSPF Packet Extensions`

`   `[`4`](#section-4)`. OSPF Packet Key Selection`

`     `[`4.1`](#section-4-1)`. Key Selection for Unicast OSPF Packet Transmission`

`     `[`4.2`](#section-4-2)`. Key Selection for Multicast OSPF Packet Transmission  .`

`     `[`4.3`](#section-4-3)`. Key Selection for OSPF Packet Reception`

`   `[`5`](#section-5)`. Securing the IP Header`

`   `[`6`](#section-6)`. Mitigating Cross-Protocol Attacks`
...
<a id="section-2"></a> **`2. Replay Protection Using Extended Sequence Numbers`**
...
<a id="section-3"></a> **`3. OSPF Packet Extensions`**
...
<a id="section-4"></a> **`4. OSPF Packet Key Selection`**
...
<a id="section-4-1"></a> **`4.1. Key Selection for Unicast OSPF Packet Transmission`**
...
<a id="section-4-2"></a> **`4.2. Key Selection for Multicast OSPF Packet Transmission`**
...
<a id="section-4-3"></a> **`4.3. Key Selection for OSPF Packet Reception`**
...
<a id="section-5"></a> **`5. Securing the IP Header`**
...
<a id="section-6"></a> **`6. Mitigating Cross-Protocol Attacks`**
