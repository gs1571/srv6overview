...
`   `[`1`](#section-1)`. 2 EXP-Inferred-PSC LSPs (E-LSP)`

`   `[`1`](#section-1)`. 3 Label-Only-Inferred-PSC LSPs (L-LSP)`

`   `[`1`](#section-1)`. 4 Overall Operations`

`   `[`1`](#section-1)`. 5 Relationship between Label and FEC`

`   `[`1`](#section-1)`. 6 Bandwidth Reservation for E-LSPs and L-LSPs`

`   `[`2`](#section-2)`. Label Forwarding Model for Diff-Serv LSRs and Tunneling Models`

`   `[`2`](#section-2)`. 1 Label Forwarding Model for Diff-Serv LSRs`

`   `[`2`](#section-2)`. 2 Incoming PHB Determination`

`   `[`2`](#section-2)`. 3 Outgoing PHB Determination With Optional Traffic Conditioning`

`   `[`2`](#section-2)`. 4 Label Forwarding`

`   `[`2`](#section-2)`. 5 Encoding Diff-Serv Information Into Encapsulation Layer`

`   `[`2`](#section-2)`. 6 Diff-Serv Tunneling Models over MPLS`

`   `[`3`](#section-3)`. Detailed Operations of E-LSPs`

`   `[`3`](#section-3)`. 1 E-LSP Definition`

`   `[`3`](#section-3)`. 2 Populating the `Encaps-->PHB mapping' for an incoming E-LSP .`

`   `[`3`](#section-3)`. 3 Incoming PHB Determination On Incoming E-LSP`

`   `[`3`](#section-3)`. 4 Populating the `Set of PHB-->Encaps mappings' for an outgoing`

`       E-LSP`

`   `[`3`](#section-3)`. 5 Encoding Diff-Serv information into Encapsulation Layer On`

`       Outgoing E-LSP`

`   `[`3`](#section-3)`. 6 E-LSP Merging`

`   `[`4`](#section-4)`. Detailed Operation of L-LSPs`

`   `[`4`](#section-4)`. 1 L-LSP Definition`

`   `[`4`](#section-4)`. 2 Populating the `Encaps-->PHB mapping' for an incoming L-LSP .`

`   `[`4`](#section-4)`. 3 Incoming PHB Determination On Incoming L-LSP`

`   `[`4`](#section-4)`. 4 Populating the `Set of PHB-->Encaps mappings' for an outgoing`

`       L-LSP`

`   `[`4`](#section-4)`. 5 Encoding Diff-Serv Information into Encapsulation Layer on`

`       Outgoing L-LSP`

`   `[`4`](#section-4)`. 6 L-LSP Merging`

`   `[`5`](#section-5)`. RSVP Extension for Diff-Serv Support`

`   `[`5`](#section-5)`. 1 Diff-Serv related RSVP Messages Format`

`   `[`5`](#section-5)`. 2 DIFFSERV Object`

`   `[`5`](#section-5)`. 3 Handling DIFFSERV Object`

`   `[`5`](#section-5)`. 4 Non-support of the DIFFSERV Object`

`   `[`5`](#section-5)`. 5 Error Codes For Diff-Serv`

`   `[`5`](#section-5)`. 6 Intserv Service Type`

`   `[`6`](#section-6)`. LDP Extensions for Diff-Serv Support`

`   `[`6`](#section-6)`. 1 Diff-Serv TLV`

`   `[`6`](#section-6)`. 2 Diff-Serv Status Code Values`

`   `[`6`](#section-6)`. 3 Diff-Serv Related LDP Messages`

`   `[`6`](#section-6)`. 4 Handling of the Diff-Serv TLV`

`   `[`6`](#section-6)`. 5 Non-Handling of the Diff-Serv TLV`

`   `[`6`](#section-6)`. 6 Bandwidth Information`

`   `[`7`](#section-7)`. MPLS Support of Diff-Serv over PPP, LAN, Non-LC-ATM and`

`      Non-LC-FR Interfaces`

`   `[`8`](#section-8)`. MPLS Support of Diff-Serv over LC-ATM Interfaces`

`   `[`8`](#section-8)`. 1 Use of ATM Traffic Classes and Traffic Management mechanisms.`

`   `[`8`](#section-8)`. 2 LSR Implementation With LC-ATM Interfaces`

`   `[`9`](#section-9)`. MPLS Support of Diff-Serv over LC-FR Interfaces`

`   `[`9`](#section-9)`. 1 Use of Frame Relay Traffic parameters and Traffic Management`

`       mechanisms`

`   `[`9`](#section-9)`. 2 LSR Implementation With LC-FR Interfaces`
...
<a id="section-2"></a> **`2. Label Forwarding Model for Diff-Serv LSRs and Tunneling Models`**
...
<a id="section-3"></a> **`3. Detailed Operations of E-LSPs`**
...
<a id="section-4"></a> **`4. Detailed Operation of L-LSPs`**
...
<a id="section-5"></a> **`5. RSVP Extension for Diff-Serv Support`**
...
<a id="section-5-2-1"></a> **`5.2.1. DIFFSERV object for an E-LSP:`**
...
<a id="section-6"></a> **`6. LDP Extensions for Diff-Serv Support`**
...
<a id="section-7"></a> **`7. MPLS Support of Diff-Serv over PPP, LAN, Non-LC-ATM and Non-LC-FR`**
...
<a id="section-8"></a> **`8. MPLS Support of Diff-Serv over LC-ATM Interfaces`**
...
<a id="section-9"></a> **`9. MPLS Support of Diff-Serv over LC-FR Interfaces`**
