...
`      `[`1.2`](#section-1-2)`. Background`

`   `[`2`](#section-2)`. Multipath Type {9}`

`   `[`3`](#section-3)`. Pseudowire Tracing`

`   `[`4`](#section-4)`. Entropy Label FEC`

`   `[`5`](#section-5)`. DS Flags: L and E`

`   `[`6`](#section-6)`. New Multipath Information Type {10}`

`   `[`7`](#section-7)`. Initiating LSR Procedures`

`   `[`8`](#section-8)`. Responder LSR Procedures`

`      `[`8.1`](#section-8-1)`. IP-Based Load Balancer That Does Not Push ELI/EL`

`      `[`8.2`](#section-8-2)`. IP-Based Load Balancer That Pushes ELI/EL`

`      `[`8.3`](#section-8-3)`. Label-Based Load Balancer That Does Not Push ELI/EL`

`      `[`8.4`](#section-8-4)`. Label-Based Load Balancer That Pushes ELI/EL`

`      `[`8.5`](#section-8-5)`. Flow-Aware MS-PW Stitching LSR`

`   `[`9`](#section-9)`. Supported and Unsupported Cases`

`   `[`10`](#section-10)`. Security Considerations`

`   `[`11`](#section-11)`. IANA Considerations`

`      `[`11.1`](#section-11-1)`. Entropy Label FEC`

`      `[`11.2`](#section-11-2)`. DS Flags`

`      `[`11.3`](#section-11-3)`. Multipath Type`
...
<a id="section-1-2"></a> **`1.2. Background`**
...
<a id="section-2"></a> **`2. Multipath Type {9}`**
...
<a id="section-3"></a> **`3. Pseudowire Tracing`**
...
<a id="section-4"></a> **`4. Entropy Label FEC`**
...
<a id="section-5"></a> **`5. DS Flags: L and E`**
...
<a id="section-6"></a> **`6. New Multipath Information Type {10}`**
...
<a id="section-7"></a> **`7. Initiating LSR Procedures`**
...
```text
   ...
   o  Received echo reply contains {L=0, E=} DS Flags, but does not
      contain IP Multipath Information.

   o  Received echo reply contains {L=1, E=} DS Flags, but does not
      contain Label Multipath Information.

   o  Received echo reply contains {L=, E=1} DS Flags, but does not
...
<a id="section-8"></a> **`8. Responder LSR Procedures`**
...
<a id="section-8-1"></a> **`8.1. IP-Based Load Balancer That Does Not Push ELI/EL`**
...
<a id="section-8-2"></a> **`8.2. IP-Based Load Balancer That Pushes ELI/EL`**
...
<a id="section-8-3"></a> **`8.3. Label-Based Load Balancer That Does Not Push ELI/EL`**
...
<a id="section-8-4"></a> **`8.4. Label-Based Load Balancer That Pushes ELI/EL`**
...
<a id="section-8-5"></a> **`8.5. Flow-Aware MS-PW Stitching LSR`**
...
<a id="section-9"></a> **`9. Supported and Unsupported Cases`**
...
<a id="section-11-1"></a> **`11.1. Entropy Label FEC`**
...
<a id="section-11-2"></a> **`11.2. DS Flags`**
...
<a id="section-11-3"></a> **`11.3. Multipath Type`**
