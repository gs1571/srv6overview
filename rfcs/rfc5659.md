...
`      `[`1.1`](#section-1-1)`. Motivation and Context`

`      `[`1.2`](#section-1-2)`. Non-Goals of This Document`
...
`      `[`3.1`](#section-3-1)`. Domain of MS-PW Solutions`

`      `[`3.2`](#section-3-2)`. Payload Types`

`   `[`4`](#section-4)`. Multi-Segment Pseudowire Reference Model`

`      `[`4.1`](#section-4-1)`. Intra-Provider Connectivity Architecture`

`           `[`4.1.1`](#section-4-1-1)`. Intra-Provider Switching Using ACs`

`           `[`4.1.2`](#section-4-1-2)`. Intra-Provider Switching Using PWs`

`      `[`4.2`](#section-4-2)`. Inter-Provider Connectivity Architecture`

`           `[`4.2.1`](#section-4-2-1)`. Inter-Provider Switching Using ACs`

`           `[`4.2.2`](#section-4-2-2)`. Inter-Provider Switching Using PWs`

`   `[`5`](#section-5)`. PE Reference Model`

`      `[`5.1`](#section-5-1)`. Pseudowire Pre-Processing`

`           `[`5.1.1`](#section-5-1-1)`. Forwarding`

`           `[`5.1.2`](#section-5-1-2)`. Native Service Processing`

`   `[`6`](#section-6)`. Protocol Stack Reference Model`

`   `[`7`](#section-7)`. Maintenance Reference Model`

`   `[`8`](#section-8)`. PW Demultiplexer Layer and PSN Requirements`

`      `[`8.1`](#section-8-1)`. Multiplexing`

`      `[`8.2`](#section-8-2)`. Fragmentation`

`   `[`9`](#section-9)`. Control Plane`

`      `[`9.1`](#section-9-1)`. Setup and Placement of MS-PWs`

`      `[`9.2`](#section-9-2)`. Pseudowire Up/Down Notification`

`      `[`9.3`](#section-9-3)`. Misconnection and Payload Type Mismatch`

`   `[`10`](#section-10)`. Management and Monitoring`

`   `[`11`](#section-11)`. Congestion Considerations`
...
<a id="section-1-1"></a> **`1.1. Motivation and Context`**
...
<a id="section-1-2"></a> **`1.2. Non-Goals of This Document`**
...
<a id="section-2"></a> **`2. Applicability`**
...
<a id="section-3-1"></a> **`3.1. Domain of MS-PW Solutions`**
...
<a id="section-3-2"></a> **`3.2. Payload Types`**
...
<a id="section-4"></a> **`4. Multi-Segment Pseudowire Reference Model`**
...
<a id="section-4-1"></a> **`4.1. Intra-Provider Connectivity Architecture`**
...
<a id="section-4-1-1"></a> **`4.1.1. Intra-Provider Switching Using ACs`**
...
<a id="section-4-1-2"></a> **`4.1.2. Intra-Provider Switching Using PWs`**
...
<a id="section-4-2"></a> **`4.2. Inter-Provider Connectivity Architecture`**
...
<a id="section-4-2-1"></a> **`4.2.1. Inter-Provider Switching Using ACs`**
...
<a id="section-4-2-2"></a> **`4.2.2. Inter-Provider Switching Using PWs`**
...
<a id="section-5"></a> **`5. PE Reference Model`**

```text

```

<a id="section-5-1"></a> **`5.1. Pseudowire Pre-Processing`**
...
<a id="section-5-1-1"></a> **`5.1.1. Forwarding`**
...
<a id="section-5-1-2"></a> **`5.1.2. Native Service Processing`**
...
<a id="section-6"></a> **`6. Protocol Stack Reference Model`**
...
<a id="section-7"></a> **`7. Maintenance Reference Model`**
...
<a id="section-8"></a> **`8. PW Demultiplexer Layer and PSN Requirements`**

```text

```

<a id="section-8-1"></a> **`8.1. Multiplexing`**
...
<a id="section-8-2"></a> **`8.2. Fragmentation`**
...
<a id="section-9"></a> **`9. Control Plane`**

```text

```

<a id="section-9-1"></a> **`9.1. Setup and Placement of MS-PWs`**
...
<a id="section-9-2"></a> **`9.2. Pseudowire Up/Down Notification`**
...
<a id="section-9-3"></a> **`9.3. Misconnection and Payload Type Mismatch`**
...
<a id="section-10"></a> **`10. Management and Monitoring`**
...
<a id="section-11"></a> **`11. Congestion Considerations`**
