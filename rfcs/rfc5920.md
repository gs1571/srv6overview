...
`      `[`2.1`](#section-2-1)`. Acronyms and Abbreviations`

`      `[`2.2`](#section-2-2)`. MPLS and GMPLS Terminology`

`   `[`3`](#section-3)`. Security Reference Models`

`   `[`4`](#section-4)`. Security Threats`

`      `[`4.1`](#section-4-1)`. Attacks on the Control Plane`

`      `[`4.2`](#section-4-2)`. Attacks on the Data Plane`

`      `[`4.3`](#section-4-3)`. Attacks on Operation and Management Plane`

`      `[`4.4`](#section-4-4)`. Insider Attacks Considerations`

`   `[`5`](#section-5)`. Defensive Techniques for MPLS/GMPLS Networks`

`      `[`5.1`](#section-5-1)`. Authentication`

`      `[`5.2`](#section-5-2)`. Cryptographic Techniques`

`      `[`5.3`](#section-5-3)`. Access Control Techniques`

`      `[`5.4`](#section-5-4)`. Use of Isolated Infrastructure`

`      `[`5.5`](#section-5-5)`. Use of Aggregated Infrastructure`

`      `[`5.6`](#section-5-6)`. Service Provider Quality Control Processes`

`      `[`5.7`](#section-5-7)`. Deployment of Testable MPLS/GMPLS Service`

`      `[`5.8`](#section-5-8)`. Verification of Connectivity`

`   `[`6`](#section-6)`. Monitoring, Detection, and Reporting of Security Attacks`

`   `[`7`](#section-7)`. Service Provider General Security Requirements`

`      `[`7.1`](#section-7-1)`. Protection within the Core Network`

`      `[`7.2`](#section-7-2)`. Protection on the User Access Link`

`      `[`7.3`](#section-7-3)`. General User Requirements for MPLS/GMPLS Providers`

`   `[`8`](#section-8)`. Inter-Provider Security Requirements`

`      `[`8.1`](#section-8-1)`. Control-Plane Protection`

`      `[`8.2`](#section-8-2)`. Data-Plane Protection`

`   `[`9`](#section-9)`. Summary of MPLS and GMPLS Security`

`      `[`9.1`](#section-9-1)`. MPLS and GMPLS Specific Security Threats`

`      `[`9.2`](#section-9-2)`. Defense Techniques`

`      `[`9.3`](#section-9-3)`. Service Provider MPLS and GMPLS Best-Practice Outlines`
...
`   `[`13`](#section-13)`. Contributors' Contact Information`
...
<a id="section-2-1"></a> **`2.1. Acronyms and Abbreviations`**
...
<a id="section-2-2"></a> **`2.2. MPLS and GMPLS Terminology`**
...
<a id="section-3"></a> **`3. Security Reference Models`**
...
<a id="section-4"></a> **`4. Security Threats`**
...
<a id="section-4-1"></a> **`4.1. Attacks on the Control Plane`**
...
<a id="section-4-1-1"></a> **`4.1.1. LSP Creation by an Unauthorized Element`**
...
<a id="section-4-1-2"></a> **`4.1.2. LSP Message Interception`**
...
<a id="section-4-1-3"></a> **`4.1.3. Attacks against RSVP-TE`**
...
<a id="section-4-1-4"></a> **`4.1.4. Attacks against LDP`**
...
<a id="section-4-1-5"></a> **`4.1.5. Denial-of-Service Attacks on the Network Infrastructure`**
...
<a id="section-4-1-6"></a> **`4.1.6. Attacks on the SP's MPLS/GMPLS Equipment via Management`**
...
<a id="section-4-1-7"></a> **`4.1.7. Cross-Connection of Traffic between Users`**
...
<a id="section-4-1-8"></a> **`4.1.8. Attacks against Routing Protocols`**
...
<a id="section-4-1-9"></a> **`4.1.9. Other Attacks on Control Traffic`**
...
<a id="section-4-2"></a> **`4.2. Attacks on the Data Plane`**
...
<a id="section-4-2-1"></a> **`4.2.1. Unauthorized Observation of Data Traffic`**
...
<a id="section-4-2-2"></a> **`4.2.2. Modification of Data Traffic`**
...
<a id="section-4-2-3"></a> **`4.2.3. Insertion of Inauthentic Data Traffic: Spoofing and Replay`**
...
<a id="section-4-2-4"></a> **`4.2.4. Unauthorized Deletion of Data Traffic`**
...
<a id="section-4-2-5"></a> **`4.2.5. Unauthorized Traffic Pattern Analysis`**
...
<a id="section-4-2-6"></a> **`4.2.6. Denial-of-Service Attacks`**
...
<a id="section-4-2-7"></a> **`4.2.7. Misconnection`**
...
<a id="section-4-3"></a> **`4.3. Attacks on Operation and Management Plane`**
...
<a id="section-4-4"></a> **`4.4. Insider Attacks Considerations`**
...
<a id="section-5"></a> **`5. Defensive Techniques for MPLS/GMPLS Networks`**
...
<a id="section-5-1"></a> **`5.1. Authentication`**
...
<a id="section-5-1-1"></a> **`5.1.1. Management System Authentication`**
...
<a id="section-5-1-2"></a> **`5.1.2. Peer-to-Peer Authentication`**
...
<a id="section-5-1-3"></a> **`5.1.3. Cryptographic Techniques for Authenticating Identity`**
...
<a id="section-5-2"></a> **`5.2. Cryptographic Techniques`**
...
<a id="section-5-2-1"></a> **`5.2.1. IPsec in MPLS/GMPLS`**
...
<a id="section-5-2-2"></a> **`5.2.2. MPLS / GMPLS Diffserv and IPsec`**
...
<a id="section-5-2-3"></a> **`5.2.3. Encryption for Device Configuration and Management`**
...
<a id="section-5-2-4"></a> **`5.2.4. Security Considerations for MPLS Pseudowires`**
...
<a id="section-5-2-5"></a> **`5.2.5. End-to-End versus Hop-by-Hop Protection Tradeoffs in MPLS/GMPLS`**
...
<a id="section-5-3"></a> **`5.3. Access Control Techniques`**
...
<a id="section-5-3-1"></a> **`5.3.1. Filtering`**
...
<a id="section-5-3-2"></a> **`5.3.2. Firewalls`**
...
<a id="section-5-3-3"></a> **`5.3.3. Access Control to Management Interfaces`**
...
<a id="section-5-4"></a> **`5.4. Use of Isolated Infrastructure`**
...
<a id="section-5-5"></a> **`5.5. Use of Aggregated Infrastructure`**
...
<a id="section-5-6"></a> **`5.6. Service Provider Quality Control Processes`**
...
<a id="section-5-7"></a> **`5.7. Deployment of Testable MPLS/GMPLS Service`**
...
<a id="section-5-8"></a> **`5.8. Verification of Connectivity`**
...
<a id="section-6"></a> **`6. Monitoring, Detection, and Reporting of Security Attacks`**
...
<a id="section-7"></a> **`7. Service Provider General Security Requirements`**
...
<a id="section-7-1"></a> **`7.1. Protection within the Core Network`**

```text

```

<a id="section-7-1-1"></a> **`7.1.1. Control-Plane Protection - General`**
...
<a id="section-7-1-2"></a> **`7.1.2. Control-Plane Protection with RSVP-TE`**
...
<a id="section-7-1-3"></a> **`7.1.3. Control-Plane Protection with LDP`**
...
<a id="section-7-1-4"></a> **`7.1.4. Data-Plane Protection`**
...
<a id="section-7-2"></a> **`7.2. Protection on the User Access Link`**
...
<a id="section-7-2-1"></a> **`7.2.1. Link Authentication`**
...
<a id="section-7-2-2"></a> **`7.2.2. Access Routing Control`**
...
<a id="section-7-2-3"></a> **`7.2.3. Access QoS`**
...
<a id="section-7-2-4"></a> **`7.2.4. Customer Service Monitoring Tools`**
...
<a id="section-7-3"></a> **`7.3. General User Requirements for MPLS/GMPLS Providers`**
...
<a id="section-8"></a> **`8. Inter-Provider Security Requirements`**
...
<a id="section-8-1"></a> **`8.1. Control-Plane Protection`**
...
<a id="section-8-1-1"></a> **`8.1.1. Authentication of Signaling Sessions`**
...
<a id="section-8-1-2"></a> **`8.1.2. Protection Against DoS Attacks in the Control Plane`**
...
<a id="section-8-1-3"></a> **`8.1.3. Protection against Malformed Packets`**
...
<a id="section-8-1-4"></a> **`8.1.4. Ability to Enable/Disable Specific Protocols`**
...
<a id="section-8-1-5"></a> **`8.1.5. Protection against Incorrect Cross Connection`**
...
<a id="section-8-1-6"></a> **`8.1.6. Protection against Spoofed Updates and Route Advertisements`**
...
<a id="section-8-1-7"></a> **`8.1.7. Protection of Confidential Information`**
...
<a id="section-8-1-8"></a> **`8.1.8. Protection against Over-provisioned Number of RSVP-TE`**
...
<a id="section-8-2"></a> **`8.2. Data-Plane Protection`**

```text

```

<a id="section-8-2-1"></a> **`8.2.1. Protection against DoS in the Data Plane`**
...
<a id="section-8-2-2"></a> **`8.2.2. Protection against Label Spoofing`**
...
<a id="section-8-2-3"></a> **`8.2.3. Protection Using Ingress Traffic Policing and Enforcement`**
...
<a id="section-9"></a> **`9. Summary of MPLS and GMPLS Security`**
...
<a id="section-9-1"></a> **`9.1. MPLS and GMPLS Specific Security Threats`**

```text

```

<a id="section-9-1-1"></a> **`9.1.1. Control-Plane Attacks`**
...
<a id="section-9-1-2"></a> **`9.1.2. Data-Plane Attacks`**
...
<a id="section-9-2"></a> **`9.2. Defense Techniques`**
...
<a id="section-9-3"></a> **`9.3. Service Provider MPLS and GMPLS Best-Practice Outlines`**

```text

```

<a id="section-9-3-1"></a> **`9.3.1. SP Infrastructure Protection`**
...
<a id="section-9-3-2"></a> **`9.3.2. Inter-Provider Security`**
...
<a id="section-13"></a> **`13. Contributors' Contact Information`**
