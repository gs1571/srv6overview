...
`    `[`4`](#section-4)`. Server Reply Source Address Selection`

`    `[`5`](#section-5)`. Resource Record Sets`

`    `[`6`](#section-6)`. Zone Cuts`

`    `[`7`](#section-7)`. SOA RRs`

`    `[`8`](#section-8)`. Time to Live (TTL)`

`    `[`9`](#section-9)`. The TC (truncated) header bit`

`   `[`10`](#section-10)`. Naming issues`

`   `[`11`](#section-11)`. Name syntax`
...
<a id="section-4"></a> **`4. Server Reply Source Address Selection`**
...
<a id="section-4-1"></a> **`4.1. UDP Source Address Selection`**
...
<a id="section-4-2"></a> **`4.2. Port Number Selection`**
...
<a id="section-5"></a> **`5. Resource Record Sets`**
...
<a id="section-5-1"></a> **`5.1. Sending RRs from an RRSet`**
...
<a id="section-5-2"></a> **`5.2. TTLs of RRs in an RRSet`**
...
<a id="section-5-3"></a> **`5.3. DNSSEC Special Cases`**
...
<a id="section-5-3-1"></a> **`5.3.1. SIG records and RRSets`**
...
<a id="section-5-3-2"></a> **`5.3.2. NXT RRs`**
...
<a id="section-5-4"></a> **`5.4. Receiving RRSets`**
...
<a id="section-5-4-1"></a> **`5.4.1. Ranking data`**
...
<a id="section-5-5"></a> **`5.5. Sending RRSets (reprise)`**
...
<a id="section-6-1"></a> **`6.1. Zone authority`**
...
<a id="section-6-2"></a> **`6.2. DNSSEC issues`**
...
<a id="section-7-1"></a> **`7.1. Placement of SOA RRs in authoritative answers`**
...
<a id="section-7-2"></a> **`7.2. TTLs on SOA RRs`**
...
<a id="section-7-3"></a> **`7.3. The SOA.MNAME field`**
...
<a id="section-8"></a> **`8. Time to Live (TTL)`**
...
<a id="section-9"></a> **`9. The TC (truncated) header bit`**
...
<a id="section-10"></a> **`10. Naming issues`**
...
<a id="section-10-1"></a> **`10.1. CNAME resource records`**
...
<a id="section-10-1-1"></a> **`10.1.1. CNAME terminology`**
...
<a id="section-10-2"></a> **`10.2. PTR records`**
...
<a id="section-10-3"></a> **`10.3. MX and NS records`**
...
<a id="section-11"></a> **`11. Name syntax`**
