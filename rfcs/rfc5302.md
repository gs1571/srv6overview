...
`     `[`1.1`](#section-1-1)`. Motivations for Domain-Wide Prefix Distribution`

`     `[`1.2`](#section-1-2)`. Scalability`

`     `[`1.3`](#section-1-3)`. Requirements Language`

`   `[`2`](#section-2)`. Proposed Syntax and Semantics for L2->L1 Inter-Area Routes .`

`     `[`2.1`](#section-2-1)`. Clarification of External Route-Type and External`

`           Metric-Type`

`     `[`2.2`](#section-2-2)`. Definition of External IP Prefixes in Level 1 LSPs`

`   `[`3`](#section-3)`. Types of IP Routes in IS-IS and Their Order of Preference  .`

`     `[`3.1`](#section-3-1)`. Overview of All Types of IP Prefixes in IS-IS Link`

`           State PDUs`

`     `[`3.2`](#section-3-2)`. Order of Preference for all Types of IP Routes in IS-IS`

`     `[`3.3`](#section-3-3)`. Additional Notes on What Prefixes to Accept or`

`           Advertise`

`   `[`4`](#section-4)`. Inter-Operability with Older Implementations`

`   `[`5`](#section-5)`. Comparisons with Other Proposals`
...
<a id="section-1-1"></a> **`1.1. Motivations for Domain-Wide Prefix Distribution`**
...
<a id="section-1-2"></a> **`1.2. Scalability`**
...
<a id="section-2"></a> **`2. Proposed Syntax and Semantics for L2->L1 Inter-Area Routes`**
...
<a id="section-2-1"></a> **`2.1. Clarification of External Route-Type and External Metric-Type`**
...
<a id="section-2-2"></a> **`2.2. Definition of External IP Prefixes in Level 1 LSPs`**
...
<a id="section-3"></a> **`3. Types of IP Routes in IS-IS and Their Order of Preference`**
...
<a id="section-3-1"></a> **`3.1. Overview of All Types of IP Prefixes in IS-IS Link State PDUs`**
...
<a id="section-3-2"></a> **`3.2. Order of Preference for all Types of IP Routes in IS-IS`**
...
<a id="section-3-3"></a> **`3.3. Additional Notes on What Prefixes to Accept or Advertise`**
...
<a id="section-4"></a> **`4. Inter-Operability with Older Implementations`**
...
<a id="section-5"></a> **`5. Comparisons with Other Proposals`**
