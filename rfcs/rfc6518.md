...
`   `[`2`](#section-2)`. Categorizing Routing Protocols`

`      `[`2.1`](#section-2-1)`. Category: Message Transaction Type`

`      `[`2.2`](#section-2-2)`. Category: Peer versus Group Keying`

`   `[`3`](#section-3)`. Consider the Future Existence of a Key Management Protocol`

`      `[`3.1`](#section-3-1)`. Consider Asymmetric Keys`

`      `[`3.2`](#section-3-2)`. Cryptographic Keys Life Cycle`

`   `[`4`](#section-4)`. Roadmap`

`      `[`4.1`](#section-4-1)`. Work Phases on Any Particular Protocol`

`      `[`4.2`](#section-4-2)`. Work Items per Routing Protocol`

`   `[`5`](#section-5)`. Routing Protocols in Categories`

`   `[`6`](#section-6)`. Supporting Incremental Deployment`

`   `[`7`](#section-7)`. Denial-of-Service Attacks`

`   `[`8`](#section-8)`. Gap Analysis`

`   `[`9`](#section-9)`. Security Considerations`

`      `[`9.1`](#section-9-1)`. Use Strong Keys`

`      `[`9.2`](#section-9-2)`. Internal versus External Operation`

`      `[`9.3`](#section-9-3)`. Unique versus Shared Keys`

`      `[`9.4`](#section-9-4)`. Key Exchange Mechanism`
...
<a id="section-2"></a> **`2. Categorizing Routing Protocols`**
...
<a id="section-2-1"></a> **`2.1. Category: Message Transaction Type`**
...
<a id="section-2-2"></a> **`2.2. Category: Peer versus Group Keying`**
...
<a id="section-3"></a> **`3. Consider the Future Existence of a Key Management Protocol`**
...
<a id="section-3-1"></a> **`3.1. Consider Asymmetric Keys`**
...
<a id="section-3-2"></a> **`3.2. Cryptographic Keys Life Cycle`**
...
<a id="section-4"></a> **`4. Roadmap`**

```text

```

<a id="section-4-1"></a> **`4.1. Work Phases on Any Particular Protocol`**
...
<a id="section-4-2"></a> **`4.2. Work Items per Routing Protocol`**
...
<a id="section-5"></a> **`5. Routing Protocols in Categories`**
...
<a id="section-6"></a> **`6. Supporting Incremental Deployment`**
...
<a id="section-7"></a> **`7. Denial-of-Service Attacks`**
...
<a id="section-8"></a> **`8. Gap Analysis`**
...
<a id="section-9-1"></a> **`9.1. Use Strong Keys`**
...
<a id="section-9-2"></a> **`9.2. Internal versus External Operation`**
...
<a id="section-9-3"></a> **`9.3. Unique versus Shared Keys`**
...
<a id="section-9-4"></a> **`9.4. Key Exchange Mechanism`**
