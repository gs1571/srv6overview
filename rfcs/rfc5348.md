...
``[`3`](#section-3)`. Protocol Mechanism`

`   `[`3.1`](#section-3-1)`. TCP Throughput Equation`

`   `[`3.2`](#section-3-2)`. Packet Contents`

`        `[`3.2.1`](#section-3-2-1)`. Data Packets`

`        `[`3.2.2`](#section-3-2-2)`. Feedback Packets`

``[`4`](#section-4)`. Data Sender Protocol`

`   `[`4.1`](#section-4-1)`. Measuring the Segment Size`

`   `[`4.2`](#section-4-2)`. Sender Initialization`

`   `[`4.3`](#section-4-3)`. Sender Behavior When a Feedback Packet Is Received`

`   `[`4.4`](#section-4-4)`. Expiration of Nofeedback Timer`

`   `[`4.5`](#section-4-5)`. Reducing Oscillations`

`   `[`4.6`](#section-4-6)`. Scheduling of Packet Transmissions`

``[`5`](#section-5)`. Calculation of the Loss Event Rate (p)`

`   `[`5.1`](#section-5-1)`. Detection of Lost or Marked Packets`

`   `[`5.2`](#section-5-2)`. Translation from Loss History to Loss Events`

`   `[`5.3`](#section-5-3)`. The Size of a Loss Interval`

`   `[`5.4`](#section-5-4)`. Average Loss Interval`

`   `[`5.5`](#section-5-5)`. History Discounting`

``[`6`](#section-6)`. Data Receiver Protocol`

`   `[`6.1`](#section-6-1)`. Receiver Behavior When a Data Packet Is Received`

`   `[`6.2`](#section-6-2)`. Expiration of Feedback Timer`

`   `[`6.3`](#section-6-3)`. Receiver Initialization`

`        `[`6.3.1`](#section-6-3-1)`. Initializing the Loss History after the`

`               First Loss Event`

``[`7`](#section-7)`. Sender-Based Variants`

``[`8`](#section-8)`. Implementation Issues`

`   `[`8.1`](#section-8-1)`. Computing the Throughput Equation`

`   `[`8.2`](#section-8-2)`. Sender Behavior When a Feedback Packet Is Received`

`        `[`8.2.1`](#section-8-2-1)`. Determining If an Interval Was a`

`               Data-Limited Interval`

`        `[`8.2.2`](#section-8-2-2)`. Maintaining X_recv_set`

`   `[`8.3`](#section-8-3)`. Sending Packets before Their Nominal Send Time`

`   `[`8.4`](#section-8-4)`. Calculation of the Average Loss Interval`

`   `[`8.5`](#section-8-5)`. The Optional History Discounting Mechanism`

``[`9`](#section-9)`. Changes from RFC 3448`

`   `[`9.1`](#section-9-1)`. Overview of Changes`

`   `[`9.2`](#section-9-2)`. Changes in Each Section`

``[`10`](#section-10)`. Security Considerations`

`   `[`10.1`](#section-10-1)`. Security Considerations for TFRC in DCCP`
...
<a id="section-3"></a> **`3. Protocol Mechanism`**
...
<a id="section-3-1"></a> **`3.1. TCP Throughput Equation`**
...
<a id="section-3-2"></a> **`3.2. Packet Contents`**
...
<a id="section-3-2-1"></a> **`3.2.1. Data Packets`**
...
<a id="section-3-2-2"></a> **`3.2.2. Feedback Packets`**
...
<a id="section-4"></a> **`4. Data Sender Protocol`**
...
<a id="section-4-1"></a> **`4.1. Measuring the Segment Size`**
...
<a id="section-4-2"></a> **`4.2. Sender Initialization`**
...
<a id="section-4-3"></a> **`4.3. Sender Behavior When a Feedback Packet Is Received`**
...
<a id="section-4-4"></a> **`4.4. Expiration of Nofeedback Timer`**
...
<a id="section-4-5"></a> **`4.5. Reducing Oscillations`**
...
<a id="section-4-6"></a> **`4.6. Scheduling of Packet Transmissions`**
...
<a id="section-5"></a> **`5. Calculation of the Loss Event Rate (p)`**
...
<a id="section-5-1"></a> **`5.1. Detection of Lost or Marked Packets`**
...
<a id="section-5-2"></a> **`5.2. Translation from Loss History to Loss Events`**
...
<a id="section-5-3"></a> **`5.3. The Size of a Loss Interval`**
...
<a id="section-5-4"></a> **`5.4. Average Loss Interval`**
...
<a id="section-5-5"></a> **`5.5. History Discounting`**
...
<a id="section-6"></a> **`6. Data Receiver Protocol`**
...
<a id="section-6-1"></a> **`6.1. Receiver Behavior When a Data Packet Is Received`**
...
<a id="section-6-2"></a> **`6.2. Expiration of Feedback Timer`**
...
<a id="section-6-3"></a> **`6.3. Receiver Initialization`**
...
<a id="section-6-3-1"></a> **`6.3.1. Initializing the Loss History after the First Loss Event`**
...
<a id="section-7"></a> **`7. Sender-Based Variants`**
...
<a id="section-8"></a> **`8. Implementation Issues`**
...
<a id="section-8-1"></a> **`8.1. Computing the Throughput Equation`**
...
<a id="section-8-2"></a> **`8.2. Sender Behavior When a Feedback Packet Is Received`**
...
<a id="section-8-2-1"></a> **`8.2.1. Determining If an Interval Was a Data-Limited Interval`**
...
<a id="section-8-2-2"></a> **`8.2.2. Maintaining X_recv_set`**
...
<a id="section-8-3"></a> **`8.3. Sending Packets before Their Nominal Send Time`**
...
<a id="section-8-4"></a> **`8.4. Calculation of the Average Loss Interval`**
...
<a id="section-8-5"></a> **`8.5. The Optional History Discounting Mechanism`**
...
<a id="section-9"></a> **`9. Changes from RFC 3448`**

```text

```

<a id="section-9-1"></a> **`9.1. Overview of Changes`**
...
<a id="section-9-2"></a> **`9.2. Changes in Each Section`**
...
<a id="section-10-1"></a> **`10.1. Security Considerations for TFRC in DCCP`**
