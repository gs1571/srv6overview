...
`     `[`1.2`](#section-1-2)`. Summary of Changes from RFC 4970`

`   `[`2`](#section-2)`. OSPF Router Information (RI) LSA`

`     `[`2.1`](#section-2-1)`. OSPFv2 Router Information (RI) Opaque LSA`

`     `[`2.2`](#section-2-2)`. OSPFv3 Router Information (RI) Opaque LSA`

`     `[`2.3`](#section-2-3)`. OSPF Router Information LSA TLV Format`

`     `[`2.4`](#section-2-4)`. OSPF Router Informational Capabilities TLV`

`     `[`2.5`](#section-2-5)`. Assigned OSPF Router Informational Capability Bits`

`     `[`2.6`](#section-2-6)`. OSPF Router Functional Capabilities TLV`

`     `[`2.7`](#section-2-7)`. Flooding Scope of the Router Information LSA`

`   `[`3`](#section-3)`. Backwards Compatibility`

`   `[`4`](#section-4)`. Security Considerations`

`   `[`5`](#section-5)`. IANA Considerations`

`     `[`5.1`](#section-5-1)`. OSPFv2 Opaque LSA Type Assignment`

`     `[`5.2`](#section-5-2)`. OSPFv3 LSA Function Code Assignment`

`     `[`5.3`](#section-5-3)`. OSPF RI LSA TLV Type Assignment`

`     `[`5.4`](#section-5-4)`. Registry for OSPF Router Informational Capability Bits`

`     `[`5.5`](#section-5-5)`. Registry for OSPF Router Functional Capability Bits`
...
<a id="section-1-2"></a> **`1.2. Summary of Changes from RFC 4970`**
...
<a id="section-2"></a> **`2. OSPF Router Information (RI) LSA`**

```text

```

<a id="section-2-1"></a> **`2.1. OSPFv2 Router Information (RI) Opaque LSA`**
...
<a id="section-2-2"></a> **`2.2. OSPFv3 Router Information (RI) Opaque LSA`**
...
<a id="section-2-3"></a> **`2.3. OSPF Router Information LSA TLV Format`**
...
<a id="section-2-4"></a> **`2.4. OSPF Router Informational Capabilities TLV`**
...
<a id="section-2-5"></a> **`2.5. Assigned OSPF Router Informational Capability Bits`**
...
<a id="section-2-6"></a> **`2.6. OSPF Router Functional Capabilities TLV`**
...
<a id="section-2-7"></a> **`2.7. Flooding Scope of the Router Information LSA`**
...
<a id="section-3"></a> **`3. Backwards Compatibility`**
...
<a id="section-5-1"></a> **`5.1. OSPFv2 Opaque LSA Type Assignment`**
...
<a id="section-5-2"></a> **`5.2. OSPFv3 LSA Function Code Assignment`**
...
<a id="section-5-3"></a> **`5.3. OSPF RI LSA TLV Type Assignment`**
...
<a id="section-5-4"></a> **`5.4. Registry for OSPF Router Informational Capability Bits`**
...
<a id="section-5-5"></a> **`5.5. Registry for OSPF Router Functional Capability Bits`**
