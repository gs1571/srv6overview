...
`   `[`4`](#section-4)`. Control Channel Setup`

`     `[`4.1`](#section-4-1)`. Control Client SIP UAC Behavior`

`     `[`4.2`](#section-4-2)`. Control Server SIP UAS Behavior`

`   `[`5`](#section-5)`. Establishing Media Streams - Control Client SIP UAC`

`       Behavior`

`   `[`6`](#section-6)`. Control Framework Interactions`

`     `[`6.1`](#section-6-1)`. General Behavior for Constructing Requests`

`     `[`6.2`](#section-6-2)`. General Behavior for Constructing Responses`

`     `[`6.3`](#section-6-3)`. Transaction Processing`

`       `[`6.3.1`](#section-6-3-1)`. CONTROL Transactions`

`       `[`6.3.2`](#section-6-3-2)`. REPORT Transactions`

`       `[`6.3.3`](#section-6-3-3)`. K-ALIVE Transactions`

`       `[`6.3.4`](#section-6-3-4)`. SYNC Transactions`

`   `[`7`](#section-7)`. Response Code Descriptions`

`     `[`7.1`](#section-7-1)`. 200 Response Code`

`     `[`7.2`](#section-7-2)`. 202 Response Code`

`     `[`7.3`](#section-7-3)`. 400 Response Code`

`     `[`7.4`](#section-7-4)`. 403 Response Code`

`     `[`7.5`](#section-7-5)`. 405 Response Code`

`     `[`7.6`](#section-7-6)`. 406 Response Code`

`     `[`7.7`](#section-7-7)`. 420 Response Code`

`     `[`7.8`](#section-7-8)`. 421 Response Code`

`     `[`7.9`](#section-7-9)`. 422 Response Code`

`     `[`7.10`](#section-7-10)`. 423 Response Code`

`     `[`7.11`](#section-7-11)`. 481 Response Code`

`     `[`7.12`](#section-7-12)`. 500 Response Code`

`   `[`8`](#section-8)`. Control Packages`

`     `[`8.1`](#section-8-1)`. Control Package Name`

`     `[`8.2`](#section-8-2)`. Framework Message Usage`

`     `[`8.3`](#section-8-3)`. Common XML Support`

`     `[`8.4`](#section-8-4)`. CONTROL Message Bodies`

`     `[`8.5`](#section-8-5)`. REPORT Message Bodies`

`     `[`8.6`](#section-8-6)`. Audit`

`     `[`8.7`](#section-8-7)`. Examples`

`   `[`9`](#section-9)`. Formal Syntax`

`     `[`9.1`](#section-9-1)`. Control Framework Formal Syntax`

`     `[`9.2`](#section-9-2)`. Control Framework Dialog Identifier SDP Attribute`

`   `[`10`](#section-10)`. Examples`

`   `[`11`](#section-11)`. Extensibility`

`   `[`12`](#section-12)`. Security Considerations`

`     `[`12.1`](#section-12-1)`. Session Establishment`

`     `[`12.2`](#section-12-2)`. Transport-Level Protection`

`     `[`12.3`](#section-12-3)`. Control Channel Policy Management`

`   `[`13`](#section-13)`. IANA Considerations`

`     `[`13.1`](#section-13-1)`. Control Packages Registration Information`

`       `[`13.1.1`](#section-13-1-1)`. Control Package Registration Template`

`     `[`13.2`](#section-13-2)`. Control Framework Method Names`

`     `[`13.3`](#section-13-3)`. Control Framework Status Codes`

`     `[`13.4`](#section-13-4)`. Control Framework Header Fields`

`     `[`13.5`](#section-13-5)`. Control Framework Port`

`     `[`13.6`](#section-13-6)`. Media Type Registrations`

`       `[`13.6.1`](#section-13-6-1)`. Registration of MIME Media Type application/cfw`

`       `[`13.6.2`](#section-13-6-2)`. Registration of MIME Media Type`

`               application/framework-attributes+xml`

`     `[`13.7`](#section-13-7)`. 'cfw-id' SDP Attribute`

`     `[`13.8`](#section-13-8)`. URN Sub-Namespace for`

`           urn:ietf:params:xml:ns:control:framework-attributes`

`     `[`13.9`](#section-13-9)`. XML Schema Registration`

`   `[`14`](#section-14)`. Contributors`
...
<a id="section-2"></a> **`2. Conventions and Terminology`**
...
<a id="section-4"></a> **`4. Control Channel Setup`**
...
<a id="section-4-1"></a> **`4.1. Control Client SIP UAC Behavior`**
...
```text
   ...
   c=<nettype>  <connection-address>

   The first sub-field, <nettype>, MUST equal the value "IN".  The
   second sub-field, , MUST equal either "IP4" or "IP6".  The
...
<a id="section-4-2"></a> **`4.2. Control Server SIP UAS Behavior`**
...
<a id="section-5"></a> **`5. Establishing Media Streams - Control Client SIP UAC Behavior`**
...
<a id="section-6"></a> **`6. Control Framework Interactions`**
...
<a id="section-6-1"></a> **`6.1. General Behavior for Constructing Requests`**
...
<a id="section-6-2"></a> **`6.2. General Behavior for Constructing Responses`**
...
<a id="section-6-3"></a> **`6.3. Transaction Processing`**
...
<a id="section-6-3-1"></a> **`6.3.1. CONTROL Transactions`**
...
<a id="section-6-3-2"></a> **`6.3.2. REPORT Transactions`**
...
<a id="section-6-3-2-1"></a> **`6.3.2.1. Reporting the Status of Extended Transactions`**
...
<a id="section-6-3-3"></a> **`6.3.3. K-ALIVE Transactions`**
...
<a id="section-6-3-3-1"></a> **`6.3.3.1. Behavior for an Entity in an Active Role`**
...
<a id="section-6-3-3-2"></a> **`6.3.3.2. Behavior for an Entity in a Passive Role`**
...
<a id="section-6-3-4"></a> **`6.3.4. SYNC Transactions`**
...
<a id="section-6-3-4-1"></a> **`6.3.4.1. Timeout Negotiation for the Initial SYNC Transaction`**
...
<a id="section-6-3-4-2"></a> **`6.3.4.2. Package Negotiation`**
...
<a id="section-7"></a> **`7. Response Code Descriptions`**
...
<a id="section-7-1"></a> **`7.1. 200 Response Code`**
...
<a id="section-7-2"></a> **`7.2. 202 Response Code`**
...
<a id="section-7-3"></a> **`7.3. 400 Response Code`**
...
<a id="section-7-4"></a> **`7.4. 403 Response Code`**
...
<a id="section-7-5"></a> **`7.5. 405 Response Code`**
...
<a id="section-7-6"></a> **`7.6. 406 Response Code`**
...
<a id="section-7-7"></a> **`7.7. 420 Response Code`**
...
<a id="section-7-8"></a> **`7.8. 421 Response Code`**
...
<a id="section-7-9"></a> **`7.9. 422 Response Code`**
...
<a id="section-7-10"></a> **`7.10. 423 Response Code`**
...
<a id="section-7-11"></a> **`7.11. 481 Response Code`**
...
<a id="section-7-12"></a> **`7.12. 500 Response Code`**
...
<a id="section-8"></a> **`8. Control Packages`**
...
<a id="section-8-1"></a> **`8.1. Control Package Name`**
...
<a id="section-8-2"></a> **`8.2. Framework Message Usage`**
...
<a id="section-8-3"></a> **`8.3. Common XML Support`**
...
<a id="section-8-4"></a> **`8.4. CONTROL Message Bodies`**
...
<a id="section-8-5"></a> **`8.5. REPORT Message Bodies`**
...
<a id="section-8-7"></a> **`8.7. Examples`**
...
<a id="section-9"></a> **`9. Formal Syntax`**

```text

```

<a id="section-9-1"></a> **`9.1. Control Framework Formal Syntax`**
...
<a id="section-9-2"></a> **`9.2. Control Framework Dialog Identifier SDP Attribute`**
...
<a id="section-11"></a> **`11. Extensibility`**
...
<a id="section-12-1"></a> **`12.1. Session Establishment`**
...
<a id="section-12-2"></a> **`12.2. Transport-Level Protection`**
...
<a id="section-12-3"></a> **`12.3. Control Channel Policy Management`**
...
<a id="section-13-1"></a> **`13.1. Control Packages Registration Information`**
...
<a id="section-13-1-1"></a> **`13.1.1. Control Package Registration Template`**
...
<a id="section-13-2"></a> **`13.2. Control Framework Method Names`**
...
<a id="section-13-3"></a> **`13.3. Control Framework Status Codes`**
...
<a id="section-13-4"></a> **`13.4. Control Framework Header Fields`**
...
<a id="section-13-5"></a> **`13.5. Control Framework Port`**
...
<a id="section-13-6"></a> **`13.6. Media Type Registrations`**
...
<a id="section-13-6-1"></a> **`13.6.1. Registration of MIME Media Type application/cfw`**
...
<a id="section-13-6-2"></a> **`13.6.2. Registration of MIME Media Type application/`**
...
<a id="section-13-7"></a> **`13.7. 'cfw-id' SDP Attribute`**
...
<a id="section-13-8"></a> **`13.8. URN Sub-Namespace for`**
...
<a id="section-13-9"></a> **`13.9. XML Schema Registration`**
...
<a id="section-14"></a> **`14. Contributors`**
