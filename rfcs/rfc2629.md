...
`   `[`2`](#section-2)`. Using the DTD to Write I-Ds and RFCs`

`   `[`2.1`](#section-2-1)`. XML basics`

`   `[`2.2`](#section-2-2)`. Front matter`

`   `[`2.2.1`](#section-2-2-1)`. The title Element`

`   `[`2.2.2`](#section-2-2-2)`. The author Element`

`   `[`2.2.3`](#section-2-2-3)`. The date Element`

`   `[`2.2.4`](#section-2-2-4)`. Meta Data Elements`

`   `[`2.2.5`](#section-2-2-5)`. The abstract Element`

`   `[`2.2.6`](#section-2-2-6)`. The note Element`

`   `[`2.2.7`](#section-2-2-7)`. Status, Copyright Notice, Table of Contents`

`   `[`2.2.7`](#section-2-2-7)`. 1 Conformance with RFC 2026`

`   `[`2.2.8`](#section-2-2-8)`. Everything in the Front`

`   `[`2.3`](#section-2-3)`. The Middle`

`   `[`2.3.1`](#section-2-3-1)`. The section Element`

`   `[`2.3.1`](#section-2-3-1)`. 1 The t Element`

`   `[`2.3.1`](#section-2-3-1)`. 2 The list Element`

`   `[`2.3.1`](#section-2-3-1)`. 3 The figure Element`

`   `[`2.3.1`](#section-2-3-1)`. 4 The xref Element`

`   `[`2.3.1`](#section-2-3-1)`. 5 The eref Element`

`   `[`2.3.1`](#section-2-3-1)`. 6 The iref Element`

`   `[`2.3.1`](#section-2-3-1)`. 7 The vspace Element`

`   `[`2.4`](#section-2-4)`. Back matter`

`   `[`2.4.1`](#section-2-4-1)`. The references Element`

`   `[`2.4.2`](#section-2-4-2)`. Appendices`

`   `[`2.4.3`](#section-2-4-3)`. Copyright Status`

`   `[`3`](#section-3)`. Processing the XML Source File`

`   `[`3.1`](#section-3-1)`. Editing`

`   `[`3.1.1`](#section-3-1-1)`. Checking`

`   `[`3.2`](#section-3-2)`. Converting to Text Format`

`   `[`3.3`](#section-3-3)`. Converting to HTML Format`

`   `[`3.4`](#section-3-4)`. Viewing`

`   `[`3.5`](#section-3-5)`. Searching`
...
<a id="section-2"></a> **`2. Using the DTD to Write I-Ds and RFCs`**
...
2.3.1.4 The xref Element
   ...
   processing, such as "RFC 2223 [2]" or "RFC
...
<a id="section-3"></a> **`3. Processing the XML Source File`**
