...
`         `[`1.1`](#section-1-1)`. Intended Audience`

`         `[`1.2`](#section-1-2)`. Scope`

`         `[`1.3`](#section-1-3)`. XML Evolution`

`         `[`1.4`](#section-1-4)`. XML Users, Support Groups, and Additional`

`               Information`

`   `[`2`](#section-2)`. XML Selection Considerations`

`   `[`3`](#section-3)`. XML Alternatives`

`   `[`4`](#section-4)`. XML Use Considerations and Recommendations`

`         `[`4.1`](#section-4-1)`. XML Syntax and Well-Formedness`

`         `[`4.2`](#section-4-2)`. XML Information Set`

`         `[`4.3`](#section-4-3)`. Syntactic Restrictions`

`         `[`4.4`](#section-4-4)`. XML Declarations`

`         `[`4.5`](#section-4-5)`. XML Processing Instructions`

`         `[`4.6`](#section-4-6)`. XML Comments`

`         `[`4.7`](#section-4-7)`. Validity and Extensibility`

`         `[`4.8`](#section-4-8)`. Semantics as Well as Syntax`

`         `[`4.9`](#section-4-9)`. Namespaces`

`               `[`4.9`](#section-4-9)`. 1 Namespaces and Attributes`

`         `[`4.10`](#section-4-10)`. Element and Attribute Design Considerations`

`         `[`4.11`](#section-4-11)`. Binary Data and Text with Control Characters`

`         `[`4.12`](#section-4-12)`. Incremental Processing`

`         `[`4.13`](#section-4-13)`. Entity Declarations and Entity References`

`         `[`4.14`](#section-4-14)`. External References`

`         `[`4.15`](#section-4-15)`. URI Processing`

`         `[`4.16`](#section-4-16)`. White Space`

`         `[`4.17`](#section-4-17)`. Interaction with the IANA`

`   `[`5`](#section-5)`. Internationalization Considerations`

`         `[`5.1`](#section-5-1)`. Character Sets and Encodings`

`         `[`5.2`](#section-5-2)`. Language Declaration`

`         `[`5.3`](#section-5-3)`. Other Internationalization Considerations`
...
<a id="section-2"></a> **`2. XML Selection Considerations`**
...
<a id="section-3"></a> **`3. XML Alternatives`**
...
<a id="section-4"></a> **`4. XML Use Considerations and Recommendations`**
...
4.16 White Space
   ...
   This fragment contains an  element and two child elements.
   ...
   o  one or more white space characters prefixing the  and
...
<a id="section-5"></a> **`5. Internationalization Considerations`**
