...
`   `[`2`](#section-2)`. IANA Considerations`

`      `[`2.1`](#section-2-1)`. Assignment of an IPv4 Address Block to IANA`

`      `[`2.2`](#section-2-2)`. Restructuring of the IPv4 and IPv6 Special-Purpose`

`           Address`

`           `[`2.2.1`](#section-2-2-1)`. Information Requirements`

`           `[`2.2.2`](#section-2-2-2)`. IPv4 Special-Purpose Address Registry Entries`

`           `[`2.2.3`](#section-2-2-3)`. IPv6 Special-Purpose Address Registry Entries`
...
<a id="section-2"></a> **`2. IANA Considerations`**

```text

```

<a id="section-2-1"></a> **`2.1. Assignment of an IPv4 Address Block to IANA`**
...
<a id="section-2-2"></a> **`2.2. Restructuring of the IPv4 and IPv6 Special-Purpose Address`**
...
<a id="section-2-2-1"></a> **`2.2.1. Information Requirements`**
...
<a id="section-2-2-2"></a> **`2.2.2. IPv4 Special-Purpose Address Registry Entries`**
...
<a id="section-2-2-3"></a> **`2.2.3. IPv6 Special-Purpose Address Registry Entries`**
