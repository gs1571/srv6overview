...
`   `[`3`](#section-3)`. Protocol Extensions`

`      `[`3.1`](#section-3-1)`. IS-IS`

`      `[`3.2`](#section-3-2)`. OSPF`

`   `[`4`](#section-4)`. Elements of Procedure`
...
<a id="section-4"></a> **`4. Elements of Procedure`**
