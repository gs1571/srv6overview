...
`   `[`3`](#section-3)`. Anycast Service Distribution`

`      `[`3.1`](#section-3-1)`. General Description`

`      `[`3.2`](#section-3-2)`. Goals`

`   `[`4`](#section-4)`. Design`

`      `[`4.1`](#section-4-1)`. Protocol Suitability`

`      `[`4.2`](#section-4-2)`. Node Placement`

`      `[`4.3`](#section-4-3)`. Routing Systems`

`           `[`4.3.1`](#section-4-3-1)`. Anycast within an IGP`

`           `[`4.3.2`](#section-4-3-2)`. Anycast within the Global Internet`

`      `[`4.4`](#section-4-4)`. Routing Considerations`

`           `[`4.4.1`](#section-4-4-1)`. Signalling Service Availability`

`           `[`4.4.2`](#section-4-4-2)`. Covering Prefix`

`           `[`4.4.3`](#section-4-4-3)`. Equal-Cost Paths`

`           `[`4.4.4`](#section-4-4-4)`. Route Dampening`

`           `[`4.4.5`](#section-4-4-5)`. Reverse Path Forwarding Checks`

`           `[`4.4.6`](#section-4-4-6)`. Propagation Scope`

`           `[`4.4.7`](#section-4-4-7)`. Other Peoples' Networks`

`           `[`4.4.8`](#section-4-4-8)`. Aggregation Risks`

`      `[`4.5`](#section-4-5)`. Addressing Considerations`

`      `[`4.6`](#section-4-6)`. Data Synchronisation`

`      `[`4.7`](#section-4-7)`. Node Autonomy`

`      `[`4.8`](#section-4-8)`. Multi-Service Nodes`

`           `[`4.8.1`](#section-4-8-1)`. Multiple Covering Prefixes`

`           `[`4.8.2`](#section-4-8-2)`. Pessimistic Withdrawal`

`           `[`4.8.3`](#section-4-8-3)`. Intra-Node Interior Connectivity`

`      `[`4.9`](#section-4-9)`. Node Identification by Clients`

`   `[`5`](#section-5)`. Service Management`

`      `[`5.1`](#section-5-1)`. Monitoring`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Denial-of-Service Attack Mitigation`

`      `[`6.2`](#section-6-2)`. Service Compromise`

`      `[`6.3`](#section-6-3)`. Service Hijacking`
...
<a id="section-3"></a> **`3. Anycast Service Distribution`**

```text

```

<a id="section-3-1"></a> **`3.1. General Description`**
...
<a id="section-4"></a> **`4. Design`**

```text

```

<a id="section-4-1"></a> **`4.1. Protocol Suitability`**
...
<a id="section-4-2"></a> **`4.2. Node Placement`**
...
<a id="section-4-3"></a> **`4.3. Routing Systems`**

```text

```

<a id="section-4-3-1"></a> **`4.3.1. Anycast within an IGP`**
...
<a id="section-4-3-2"></a> **`4.3.2. Anycast within the Global Internet`**
...
<a id="section-4-4"></a> **`4.4. Routing Considerations`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. Signalling Service Availability`**
...
<a id="section-4-4-2"></a> **`4.4.2. Covering Prefix`**
...
<a id="section-4-4-3"></a> **`4.4.3. Equal-Cost Paths`**
...
<a id="section-4-4-4"></a> **`4.4.4. Route Dampening`**
...
<a id="section-4-4-5"></a> **`4.4.5. Reverse Path Forwarding Checks`**
...
<a id="section-4-4-6"></a> **`4.4.6. Propagation Scope`**
...
<a id="section-4-4-7"></a> **`4.4.7. Other Peoples' Networks`**
...
<a id="section-4-4-8"></a> **`4.4.8. Aggregation Risks`**
...
<a id="section-4-6"></a> **`4.6. Data Synchronisation`**
...
<a id="section-4-7"></a> **`4.7. Node Autonomy`**
...
<a id="section-4-8"></a> **`4.8. Multi-Service Nodes`**
...
<a id="section-4-8-1"></a> **`4.8.1. Multiple Covering Prefixes`**
...
<a id="section-4-8-2"></a> **`4.8.2. Pessimistic Withdrawal`**
...
<a id="section-4-8-3"></a> **`4.8.3. Intra-Node Interior Connectivity`**
...
<a id="section-4-9"></a> **`4.9. Node Identification by Clients`**
...
<a id="section-5"></a> **`5. Service Management`**

```text

```

<a id="section-5-1"></a> **`5.1. Monitoring`**
...
<a id="section-6-1"></a> **`6.1. Denial-of-Service Attack Mitigation`**
...
<a id="section-6-2"></a> **`6.2. Service Compromise`**
...
<a id="section-6-3"></a> **`6.3. Service Hijacking`**
