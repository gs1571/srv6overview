...
`      `[`2.1`](#section-2-1)`. Requirements Language`

`   `[`3`](#section-3)`. General Assumptions`

`      `[`3.1`](#section-3-1)`. Common Assumptions`

`      `[`3.2`](#section-3-2)`. Example of Topology for the Inter-Area TE Case`

`      `[`3.3`](#section-3-3)`. Example of Topology for the Inter-AS TE Case`

`   `[`4`](#section-4)`. Per-Domain Path Computation Procedures`

`      `[`4.1`](#section-4-1)`. Example with an Inter-Area TE LSP`

`           `[`4.1.1`](#section-4-1-1)`. Case 1: T0 Is a Contiguous TE LSP`

`           `[`4.1.2`](#section-4-1-2)`. Case 2: T0 Is a Stitched or Nested TE LSP`

`      `[`4.2`](#section-4-2)`. Example with an Inter-AS TE LSP`

`           `[`4.2.1`](#section-4-2-1)`. Case 1: T1 Is a Contiguous TE LSP`

`           `[`4.2.2`](#section-4-2-2)`. Case 2: T1 Is a Stitched or Nested TE LSP`

`   `[`5`](#section-5)`. Path Optimality/Diversity`

`   `[`6`](#section-6)`. Reoptimization of an Inter-Domain TE LSP`

`      `[`6.1`](#section-6-1)`. Contiguous TE LSPs`

`      `[`6.2`](#section-6-2)`. Stitched or Nested (non-contiguous) TE LSPs`

`      `[`6.3`](#section-6-3)`. Path Characteristics after Reoptimization`
...
<a id="section-2-1"></a> **`2.1. Requirements Language`**
...
<a id="section-3-1"></a> **`3.1. Common Assumptions`**
...
<a id="section-3-2"></a> **`3.2. Example of Topology for the Inter-Area TE Case`**
...
<a id="section-3-3"></a> **`3.3. Example of Topology for the Inter-AS TE Case`**
...
<a id="section-4"></a> **`4. Per-Domain Path Computation Procedures`**
...
<a id="section-4-1"></a> **`4.1. Example with an Inter-Area TE LSP`**
...
<a id="section-4-1-1"></a> **`4.1.1. Case 1: T0 Is a Contiguous TE LSP`**
...
<a id="section-4-1-2"></a> **`4.1.2. Case 2: T0 Is a Stitched or Nested TE LSP`**
...
<a id="section-4-2"></a> **`4.2. Example with an Inter-AS TE LSP`**
...
<a id="section-4-2-1"></a> **`4.2.1. Case 1: T1 Is a Contiguous TE LSP`**
...
<a id="section-4-2-2"></a> **`4.2.2. Case 2: T1 Is a Stitched or Nested TE LSP`**
...
<a id="section-5"></a> **`5. Path Optimality/Diversity`**
...
<a id="section-6"></a> **`6. Reoptimization of an Inter-Domain TE LSP`**
...
<a id="section-6-1"></a> **`6.1. Contiguous TE LSPs`**
...
<a id="section-6-2"></a> **`6.2. Stitched or Nested (non-contiguous) TE LSPs`**
...
<a id="section-6-3"></a> **`6.3. Path Characteristics after Reoptimization`**
