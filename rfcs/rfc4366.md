...
`   `[`2`](#section-2)`. General Extension Mechanisms`

`      `[`2.1`](#section-2-1)`. Extended Client Hello`

`      `[`2.2`](#section-2-2)`. Extended Server Hello`

`      `[`2.3`](#section-2-3)`. Hello Extensions`

`      `[`2.4`](#section-2-4)`. Extensions to the Handshake Protocol`

`   `[`3`](#section-3)`. Specific Extensions`

`      `[`3.1`](#section-3-1)`. Server Name Indication`

`      `[`3.2`](#section-3-2)`. Maximum Fragment Length Negotiation`

`      `[`3.3`](#section-3-3)`. Client Certificate URLs`

`      `[`3.4`](#section-3-4)`. Trusted CA Indication`

`      `[`3.5`](#section-3-5)`. Truncated HMAC`

`      `[`3.6`](#section-3-6)`. Certificate Status Request`

`   `[`4`](#section-4)`. Error Alerts`

`   `[`5`](#section-5)`. Procedure for Defining New Extensions`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Security of server_name`

`      `[`6.2`](#section-6-2)`. Security of max_fragment_length`

`      `[`6.3`](#section-6-3)`. Security of client_certificate_url`

`      `[`6.4`](#section-6-4)`. Security of trusted_ca_keys`

`      `[`6.5`](#section-6-5)`. Security of truncated_hmac`

`      `[`6.6`](#section-6-6)`. Security of status_request`

`   `[`7`](#section-7)`. Internationalization Considerations`
...
<a id="section-2"></a> **`2. General Extension Mechanisms`**
...
<a id="section-2-1"></a> **`2.1. Extended Client Hello`**
...
<a id="section-2-2"></a> **`2.2. Extended Server Hello`**
...
<a id="section-2-3"></a> **`2.3. Hello Extensions`**
...
<a id="section-2-4"></a> **`2.4. Extensions to the Handshake Protocol`**
...
<a id="section-3"></a> **`3. Specific Extensions`**
...
<a id="section-3-1"></a> **`3.1. Server Name Indication`**
...
<a id="section-3-2"></a> **`3.2. Maximum Fragment Length Negotiation`**
...
<a id="section-3-3"></a> **`3.3. Client Certificate URLs`**
...
<a id="section-3-4"></a> **`3.4. Trusted CA Indication`**
...
<a id="section-3-5"></a> **`3.5. Truncated HMAC`**
...
<a id="section-3-6"></a> **`3.6. Certificate Status Request`**
...
<a id="section-4"></a> **`4. Error Alerts`**
...
<a id="section-5"></a> **`5. Procedure for Defining New Extensions`**
...
<a id="section-6-1"></a> **`6.1. Security of server_name`**
...
<a id="section-6-2"></a> **`6.2. Security of max_fragment_length`**
...
<a id="section-6-3"></a> **`6.3. Security of client_certificate_url`**
...
<a id="section-6-4"></a> **`6.4. Security of trusted_ca_keys`**
...
<a id="section-6-5"></a> **`6.5. Security of truncated_hmac`**
...
<a id="section-6-6"></a> **`6.6. Security of status_request`**
...
<a id="section-7"></a> **`7. Internationalization Considerations`**
