...
<a id="section-4"></a> **`4. Address allocation and assignment`**
...
<a id="section-5"></a> **`5. Routing information exchange`**
...
<a id="section-5-1"></a> **`5.1. Advertising reachability information by enterprise border routers`**
...
<a id="section-5-2"></a> **`5.2. Further improvements`**
...
<a id="section-5-3"></a> **`5.3. Combining the two`**
...
<a id="section-5-4"></a> **`5.4. Better (more optimal) routing in steady state`**
...
<a id="section-6"></a> **`6. Comparison with other approaches`**
...
<a id="section-6-1"></a> **`6.1. Solution 1`**
...
<a id="section-6-2"></a> **`6.2. Solution 2`**
...
<a id="section-8"></a> **`8. Applications to multi-homed ISPs`**
