...
`       `[`4.1`](#section-4-1)`. Measuring the Packet Size`

`       `[`4.2`](#section-4-2)`. Sender Initialization`

`       `[`4.3`](#section-4-3)`. Sender behavior when a feedback packet is`

`            received. . . . . . . . . . . . . .`

`       `[`4.4`](#section-4-4)`. Expiration of nofeedback timer`

`       `[`4.5`](#section-4-5)`. Preventing Oscillations`
...
`       `[`5.3`](#section-5-3)`. Inter-loss Event Interval`
...
`       `[`6.1`](#section-6-1)`. Receiver behavior when a data packet is`
...
`   `[`12`](#section-12)`. Non-Normative References`
...
<a id="section-4-1"></a> **`4.1. Measuring the Packet Size`**
...
<a id="section-4-5"></a> **`4.5. Preventing Oscillations`**
...
<a id="section-5-3"></a> **`5.3. Inter-loss Event Interval`**
...
<a id="section-12"></a> **`12. Informational References`**
