...
`   `[`3`](#section-3)`. IPv6 Tunneling`

`       `[`3`](#section-3)`. 1 IPv6 Encapsulation`

`       `[`3`](#section-3)`. 2 IPv6 Packet Processing in Tunnels`

`       `[`3`](#section-3)`. 3 IPv6 Decapsulation`

`       `[`3`](#section-3)`. 4 IPv6 Tunnel Protocol Engine`

`   `[`4`](#section-4)`. Nested Encapsulation`

`       `[`4.1`](#section-4-1)`. Limiting Nested Encapsulation`

`           `[`4.1.1`](#section-4-1-1)`. Tunnel Encapsulation Limit Option`

`           `[`4.1.2`](#section-4-1-2)`. Loopback Encapsulation`

`           `[`4.1.3`](#section-4-1-3)`. Routing Loop Nested Encapsulation`

`   `[`5`](#section-5)`. Tunnel IPv6 Header`

`       `[`5`](#section-5)`. 1 Tunnel IPv6 Extension Headers`

`   `[`6`](#section-6)`. IPv6 Tunnel State Variables`

`       `[`6`](#section-6)`. 1 IPv6 Tunnel Entry-Point Node`

`       `[`6`](#section-6)`. 2 IPv6 Tunnel Exit-Point Node`

`       `[`6`](#section-6)`. 3 IPv6 Tunnel Hop Limit`

`       `[`6`](#section-6)`. 4 IPv6 Tunnel Packet Traffic Class`

`       `[`6`](#section-6)`. 5 IPv6 Tunnel Flow Label`

`       `[`6`](#section-6)`. 6 IPv6 Tunnel Encapsulation Limit`

`       `[`6`](#section-6)`. 7 IPv6 Tunnel MTU`

`   `[`7`](#section-7)`. IPv6 Tunnel Packet Size Issues`

`       `[`7`](#section-7)`. 1 IPv6 Tunnel Packet Fragmentation`

`       `[`7`](#section-7)`. 2 IPv4 Tunnel Packet Fragmentation`

`   `[`8`](#section-8)`. IPv6 Tunnel Error Reporting and Processing`

`       `[`8`](#section-8)`. 1 Tunnel ICMP Messages`

`       `[`8`](#section-8)`. 2 ICMP Messages for IPv6 Original Packets`

`       `[`8`](#section-8)`. 3 ICMP Messages for IPv4 Original Packets`

`       `[`8`](#section-8)`. 4 ICMP Messages for Nested Tunnel Packets`
...
`   Appendix A. Risk Factors in Recursive Encapsulation`
...
<a id="section-3"></a> **`3. IPv6 Tunneling`**
...
<a id="section-4"></a> **`4. Nested Encapsulation`**
...
<a id="section-5"></a> **`5. Tunnel IPv6 Header`**
...
<a id="section-6"></a> **`6. IPv6 Tunnel State Variables`**
...
<a id="section-7"></a> **`7. IPv6 Tunnel Packet Size Issues`**
...
<a id="section-8"></a> **`8. IPv6 Tunnel Error Processing and Reporting`**
