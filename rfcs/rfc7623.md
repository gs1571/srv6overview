...
`      `[`3.1`](#section-3-1)`. MAC Advertisement Route Scalability`

`      `[`3.2`](#section-3-2)`. C-MAC Mobility Independent of B-MAC Advertisements`

`      `[`3.3`](#section-3-3)`. C-MAC Address Learning and Confinement`

`      `[`3.4`](#section-3-4)`. Per-Site Policy Support`

`      `[`3.5`](#section-3-5)`. No C-MAC Address Flushing for All-Active Multihoming`

`   `[`4`](#section-4)`. Solution Overview`

`   `[`5`](#section-5)`. BGP Encoding`

`      `[`5.1`](#section-5-1)`. Ethernet Auto-Discovery Route`

`      `[`5.2`](#section-5-2)`. MAC/IP Advertisement Route`

`      `[`5.3`](#section-5-3)`. Inclusive Multicast Ethernet Tag Route`

`      `[`5.4`](#section-5-4)`. Ethernet Segment Route`

`      `[`5.5`](#section-5-5)`. ESI Label Extended Community`

`      `[`5.6`](#section-5-6)`. ES-Import Route Target`

`      `[`5.7`](#section-5-7)`. MAC Mobility Extended Community`

`      `[`5.8`](#section-5-8)`. Default Gateway Extended Community`

`   `[`6`](#section-6)`. Operation`

`      `[`6.1`](#section-6-1)`. MAC Address Distribution over Core`

`      `[`6.2`](#section-6-2)`. Device Multihoming`

`           `[`6.2.1`](#section-6-2-1)`. Flow-Based Load-Balancing`

`                  `[`6.2.1.1`](#section-6-2-1-1)`. PE B-MAC Address Assignment`

`                  `[`6.2.1.2`](#section-6-2-1-2)`. Automating B-MAC Address Assignment`

`                  `[`6.2.1.3`](#section-6-2-1-3)`. Split Horizon and Designated`

`                           Forwarder Election`

`           `[`6.2.2`](#section-6-2-2)`. Load-Balancing based on I-SID`

`                  `[`6.2.2.1`](#section-6-2-2-1)`. PE B-MAC Address Assignment`

`                  `[`6.2.2.2`](#section-6-2-2-2)`. Split Horizon and Designated`

`                           Forwarder Election`

`                  `[`6.2.2.3`](#section-6-2-2-3)`. Handling Failure Scenarios`

`      `[`6.3`](#section-6-3)`. Network Multihoming`

`      `[`6.4`](#section-6-4)`. Frame Forwarding`

`           `[`6.4.1`](#section-6-4-1)`. Unicast`

`           `[`6.4.2`](#section-6-4-2)`. Multicast/Broadcast`

`      `[`6.5`](#section-6-5)`. MPLS Encapsulation of PBB Frames`

`   `[`7`](#section-7)`. Minimizing ARP/ND Broadcast`

`   `[`8`](#section-8)`. Seamless Interworking with IEEE 802.1aq / 802.1Qbp`

`      `[`8.1`](#section-8-1)`. B-MAC Address Assignment`

`      `[`8.2`](#section-8-2)`. IEEE 802.1aq / 802.1Qbp B-MAC Address Advertisement`

`      `[`8.3`](#section-8-3)`. Operation:`

`   `[`9`](#section-9)`. Solution Advantages`

`      `[`9.1`](#section-9-1)`. MAC Advertisement Route Scalability`

`      `[`9.2`](#section-9-2)`. C-MAC Mobility Independent of B-MAC Advertisements`

`      `[`9.3`](#section-9-3)`. C-MAC Address Learning and Confinement`

`      `[`9.4`](#section-9-4)`. Seamless Interworking with 802.1aq Access Networks`

`      `[`9.5`](#section-9-5)`. Per-Site Policy Support`

`      `[`9.6`](#section-9-6)`. No C-MAC Address Flushing for All-Active Multihoming`
...
<a id="section-3"></a> **`3. Requirements`**
...
<a id="section-3-1"></a> **`3.1. MAC Advertisement Route Scalability`**
...
<a id="section-3-2"></a> **`3.2. C-MAC Mobility Independent of B-MAC Advertisements`**
...
<a id="section-3-3"></a> **`3.3. C-MAC Address Learning and Confinement`**
...
<a id="section-3-4"></a> **`3.4. Per-Site Policy Support`**
...
<a id="section-3-5"></a> **`3.5. No C-MAC Address Flushing for All-Active Multihoming`**
...
<a id="section-4"></a> **`4. Solution Overview`**
...
<a id="section-5"></a> **`5. BGP Encoding`**
...
<a id="section-5-1"></a> **`5.1. Ethernet Auto-Discovery Route`**
...
<a id="section-5-2"></a> **`5.2. MAC/IP Advertisement Route`**
...
<a id="section-5-3"></a> **`5.3. Inclusive Multicast Ethernet Tag Route`**
...
<a id="section-5-4"></a> **`5.4. Ethernet Segment Route`**
...
<a id="section-5-5"></a> **`5.5. ESI Label Extended Community`**
...
<a id="section-5-6"></a> **`5.6. ES-Import Route Target`**
...
<a id="section-5-7"></a> **`5.7. MAC Mobility Extended Community`**
...
<a id="section-5-8"></a> **`5.8. Default Gateway Extended Community`**
...
<a id="section-6-1"></a> **`6.1. MAC Address Distribution over Core`**
...
<a id="section-6-2"></a> **`6.2. Device Multihoming`**

```text

```

<a id="section-6-2-1"></a> **`6.2.1. Flow-Based Load-Balancing`**
...
<a id="section-6-2-1-1"></a> **`6.2.1.1. PE B-MAC Address Assignment`**
...
<a id="section-6-2-1-2"></a> **`6.2.1.2. Automating B-MAC Address Assignment`**
...
<a id="section-6-2-1-3"></a> **`6.2.1.3. Split Horizon and Designated Forwarder Election`**
...
<a id="section-6-2-2"></a> **`6.2.2. Load-Balancing based on I-SID`**
...
<a id="section-6-2-2-1"></a> **`6.2.2.1. PE B-MAC Address Assignment`**
...
<a id="section-6-2-2-2"></a> **`6.2.2.2. Split Horizon and Designated Forwarder Election`**
...
<a id="section-6-2-2-3"></a> **`6.2.2.3. Handling Failure Scenarios`**
...
<a id="section-6-3"></a> **`6.3. Network Multihoming`**
...
<a id="section-6-4"></a> **`6.4. Frame Forwarding`**
...
<a id="section-6-4-1"></a> **`6.4.1. Unicast`**
...
<a id="section-6-4-2"></a> **`6.4.2. Multicast/Broadcast`**
...
<a id="section-6-5"></a> **`6.5. MPLS Encapsulation of PBB Frames`**
...
<a id="section-7"></a> **`7. Minimizing ARP/ND Broadcast`**
...
<a id="section-8"></a> **`8. Seamless Interworking with IEEE 802.1aq / 802.1Qbp`**
...
<a id="section-8-1"></a> **`8.1. B-MAC Address Assignment`**
...
<a id="section-8-2"></a> **`8.2. IEEE 802.1aq / 802.1Qbp B-MAC Address Advertisement`**
...
<a id="section-8-3"></a> **`8.3. Operation:`**
...
<a id="section-9"></a> **`9. Solution Advantages`**
...
<a id="section-9-1"></a> **`9.1. MAC Advertisement Route Scalability`**
...
<a id="section-9-2"></a> **`9.2. C-MAC Mobility Independent of B-MAC Advertisements`**
...
<a id="section-9-3"></a> **`9.3. C-MAC Address Learning and Confinement`**
...
<a id="section-9-4"></a> **`9.4. Seamless Interworking with 802.1aq Access Networks`**
...
<a id="section-9-5"></a> **`9.5. Per-Site Policy Support`**
...
<a id="section-9-6"></a> **`9.6. No C-MAC Address Flushing for All-Active Multihoming`**
