...
`   `[`2`](#section-2)`. Definitions of Terms Used in This Memo`

`   `[`3`](#section-3)`. Flow Specifications`

`   `[`4`](#section-4)`. Dissemination of Information`

`   `[`5`](#section-5)`. Traffic Filtering`

`      `[`5.1`](#section-5-1)`. Order of Traffic Filtering Rules`

`   `[`6`](#section-6)`. Validation Procedure`

`   `[`7`](#section-7)`. Traffic Filtering Actions`

`   `[`8`](#section-8)`. Traffic Filtering in BGP/MPLS VPN Networks`

`   `[`9`](#section-9)`. Monitoring`
...
<a id="section-2"></a> **`2. Definitions of Terms Used in This Memo`**
...
<a id="section-3"></a> **`3. Flow Specifications`**
...
<a id="section-4"></a> **`4. Dissemination of Information`**
...
<a id="section-5"></a> **`5. Traffic Filtering`**
...
<a id="section-5-1"></a> **`5.1. Order of Traffic Filtering Rules`**
...
<a id="section-6"></a> **`6. Validation Procedure`**
...
<a id="section-7"></a> **`7. Traffic Filtering Actions`**
...
<a id="section-8"></a> **`8. Traffic Filtering in BGP/MPLS VPN Networks`**
