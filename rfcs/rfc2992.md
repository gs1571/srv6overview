...
<a id="section-1"></a> **`1. Hash-Threshold`**
...
<a id="section-2-1"></a> **`2.1. Performance`**
...
<a id="section-2-2"></a> **`2.2. Disruption`**
...
<a id="section-3"></a> **`3. Comparison to other algorithms`**
