...
`     `[`3.1`](#section-3-1)`. Summary of Changes`

`     `[`3.2`](#section-3-2)`. New Return Codes`

`       `[`3.2.1`](#section-3-2-1)`. Return Code per Downstream`

`       `[`3.2.2`](#section-3-2-2)`. Return Code for Stitched LSPs`

`     `[`3.3`](#section-3-3)`. Downstream Detailed Mapping TLV`

`       `[`3.3.1`](#section-3-3-1)`. Sub-TLVs`

`         `[`3.3.1.1`](#section-3-3-1-1)`. Multipath Data Sub-TLV`

`     `[`3.4`](#section-3-4)`. Deprecation of Downstream Mapping TLV`

`   `[`4`](#section-4)`. Performing MPLS Traceroute on Tunnels`

`     `[`4.1`](#section-4-1)`. Transit Node Procedure`

`       `[`4.1.1`](#section-4-1-1)`. Addition of a New Tunnel`

`       `[`4.1.2`](#section-4-1-2)`. Transition between Tunnels`

`       `[`4.1.3`](#section-4-1-3)`. Modification to FEC Validation Procedure on Transit`

`     `[`4.2`](#section-4-2)`. Modification to FEC Validation Procedure on Egress`

`     `[`4.3`](#section-4-3)`. Ingress Node Procedure`

`       `[`4.3.1`](#section-4-3-1)`. Processing Downstream Detailed Mapping TLV`

`         `[`4.3.1.1`](#section-4-3-1-1)`. Stack Change Sub-TLV Not Present`

`         `[`4.3.1.2`](#section-4-3-1-2)`. Stack Change Sub-TLV(s) Present`

`       `[`4.3.2`](#section-4-3-2)`. Modifications to Handling a Return Code 3 Reply`

`       `[`4.3.3`](#section-4-3-3)`. Handling of New Return Codes`

`     `[`4.4`](#section-4-4)`. Handling Deprecated Downstream Mapping TLV`
...
<a id="section-3-1"></a> **`3.1. Summary of Changes`**
...
<a id="section-3-2"></a> **`3.2. New Return Codes`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. Return Code per Downstream`**
...
<a id="section-3-2-2"></a> **`3.2.2. Return Code for Stitched LSPs`**
...
<a id="section-3-3"></a> **`3.3. Downstream Detailed Mapping TLV`**
...
<a id="section-3-3-1"></a> **`3.3.1. Sub-TLVs`**
...
<a id="section-3-3-1-1"></a> **`3.3.1.1. Multipath Data Sub-TLV`**
...
<a id="section-3-3-1-2"></a> **`3.3.1.2. Label Stack Sub-TLV`**
...
<a id="section-3-3-1-3"></a> **`3.3.1.3. FEC Stack Change Sub-TLV`**
...
<a id="section-3-4"></a> **`3.4. Deprecation of Downstream Mapping TLV`**
...
<a id="section-4"></a> **`4. Performing MPLS Traceroute on Tunnels`**
...
<a id="section-4-1"></a> **`4.1. Transit Node Procedure`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Addition of a New Tunnel`**
...
<a id="section-4-1-2"></a> **`4.1.2. Transition between Tunnels`**
...
<a id="section-4-1-3"></a> **`4.1.3. Modification to FEC Validation Procedure on Transit`**
...
<a id="section-4-2"></a> **`4.2. Modification to FEC Validation Procedure on Egress`**
...
<a id="section-4-3"></a> **`4.3. Ingress Node Procedure`**
...
<a id="section-4-3-1"></a> **`4.3.1. Processing Downstream Detailed Mapping TLV`**
...
<a id="section-4-3-1-1"></a> **`4.3.1.1. Stack Change Sub-TLV Not Present`**
...
<a id="section-4-3-1-2"></a> **`4.3.1.2. Stack Change Sub-TLV(s) Present`**
...
<a id="section-4-3-2"></a> **`4.3.2. Modifications to Handling a Return Code 3 Reply.`**
...
<a id="section-4-3-3"></a> **`4.3.3. Handling of New Return Codes`**
...
<a id="section-4-4"></a> **`4.4. Handling Deprecated Downstream Mapping TLV`**
...
<a id="section-6-1"></a> **`6.1. New TLV`**
...
<a id="section-6-2"></a> **`6.2. New Sub-TLV Types and Associated Registry`**
...
<a id="section-6-3"></a> **`6.3. New Return Codes`**
