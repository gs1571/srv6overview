...
`   `[`1`](#section-1)`. Model of Protecting Symmetric Keys with Public Keys`

`       `[`1.1`](#section-1-1)`. The key exchange algorithms`

`   `[`2`](#section-2)`. Determining the Effort to Factor`

`       `[`2.1`](#section-2-1)`. Choosing parameters for the equation`

`       `[`2.2`](#section-2-2)`. Choosing k from empirical reports`

`       `[`2.3`](#section-2-3)`. Pollard's rho method`

`       `[`2.4`](#section-2-4)`. Limits of large memory and many machines`

`       `[`2.5`](#section-2-5)`. Special purpose machines`

`   `[`3`](#section-3)`. Compute Time for the Algorithms`

`       `[`3.1`](#section-3-1)`. Diffie-Hellman Key Exchange`

`            `[`3.1.1`](#section-3-1-1)`. Diffie-Hellman with elliptic curve groups`

`       `[`3.2`](#section-3-2)`. RSA encryption and decryption`

`       `[`3.3`](#section-3-3)`. Real-world examples`

`   `[`4`](#section-4)`. Equivalences of Key Sizes`

`       `[`4.1`](#section-4-1)`. Key equivalence against special purpose brute force`

`            hardware`

`       `[`4.2`](#section-4-2)`. Key equivalence against conventional CPU brute force`

`            attack`

`       `[`4.3`](#section-4-3)`. A One Year Attack: 80 bits of strength`

`       `[`4.4`](#section-4-4)`. Key equivalence for other ciphers`

`       `[`4.5`](#section-4-5)`. Hash functions for deriving symmetric keys from public`

`            key algorithms`

`       `[`4.6`](#section-4-6)`. Importance of randomness`

`   `[`5`](#section-5)`. Conclusion`

`       `[`5.1`](#section-5-1)`. TWIRL Correction`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. References`

`       `[`7.1`](#section-7-1)`. Informational References`
...
<a id="section-1"></a> **`1. Model of Protecting Symmetric Keys with Public Keys`**
...
<a id="section-1-1"></a> **`1.1. The key exchange algorithms`**
...
<a id="section-2"></a> **`2. Determining the Effort to Factor`**
...
<a id="section-2-1"></a> **`2.1. Choosing parameters for the equation`**
...
<a id="section-2-2"></a> **`2.2. Choosing k from empirical reports`**
...
<a id="section-2-3"></a> **`2.3. Pollard's rho method`**
...
<a id="section-2-4"></a> **`2.4. Limits of large memory and many machines`**
...
<a id="section-2-5"></a> **`2.5. Special purpose machines`**
...
<a id="section-3"></a> **`3. Compute Time for the Algorithms`**
...
<a id="section-3-1"></a> **`3.1. Diffie-Hellman Key Exchange`**
...
<a id="section-3-1-1"></a> **`3.1.1. Diffie-Hellman with elliptic curve groups`**
...
<a id="section-3-2"></a> **`3.2. RSA encryption and decryption`**
...
<a id="section-3-3"></a> **`3.3. Real-world examples`**
...
<a id="section-4"></a> **`4. Equivalences of Key Sizes`**
...
<a id="section-4-1"></a> **`4.1. Key equivalence against special purpose brute force hardware`**
...
<a id="section-4-3"></a> **`4.3. A One Year Attack: 80 bits of strength`**
...
<a id="section-4-4"></a> **`4.4. Key equivalence for other ciphers`**
...
<a id="section-4-5"></a> **`4.5. Hash functions for deriving symmetric keys from public key`**
...
<a id="section-4-6"></a> **`4.6. Importance of randomness`**
...
<a id="section-5-1"></a> **`5.1. TWIRL Correction`**
...
<a id="section-7-1"></a> **`7.1. Informational References`**
