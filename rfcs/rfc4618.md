...
`   `[`4`](#section-4)`. General Encapsulation Method`

`      `[`4.1`](#section-4-1)`. The Control Word`

`      `[`4.2`](#section-4-2)`. MTU Requirements`

`   `[`5`](#section-5)`. Protocol-Specific Details`

`      `[`5.1`](#section-5-1)`. HDLC`

`      `[`5.2`](#section-5-2)`. Frame Relay Port Mode`

`      `[`5.3`](#section-5-3)`. PPP`

`   `[`6`](#section-6)`. Using an MPLS Label as the Demultiplexer Field`

`      `[`6.1`](#section-6-1)`. MPLS Shim EXP Bit Values`

`      `[`6.2`](#section-6-2)`. MPLS Shim S Bit Value`
...
<a id="section-4"></a> **`4. General Encapsulation Method`**
...
<a id="section-4-1"></a> **`4.1. The Control Word`**
...
<a id="section-4-2"></a> **`4.2. MTU Requirements`**
...
<a id="section-5"></a> **`5. Protocol-Specific Details`**

```text

```

<a id="section-5-1"></a> **`5.1. HDLC`**
...
<a id="section-5-2"></a> **`5.2. Frame Relay Port Mode`**
...
<a id="section-6"></a> **`6. Using an MPLS Label as the Demultiplexer Field`**
...
<a id="section-6-1"></a> **`6.1. MPLS Shim EXP Bit Values`**
...
<a id="section-6-2"></a> **`6.2. MPLS Shim S Bit Value`**
