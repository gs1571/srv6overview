...
`     `[`1.2`](#section-1-2)`. Documentation Note`

`   `[`2`](#section-2)`. General Scenario`

`   `[`3`](#section-3)`. RPKI Considerations`

`     `[`3.1`](#section-3-1)`. Origin Validation`

`     `[`3.2`](#section-3-2)`. Path Validation`

`       `[`3.2.1`](#section-3-2-1)`. Outbound Announcements (PE-->CE)`

`       `[`3.2.2`](#section-3-2-2)`. Inbound Announcements (CE-->PE)`

`   `[`4`](#section-4)`. Requirements`

`   `[`5`](#section-5)`. Solution`

`     `[`5.1`](#section-5-1)`. Outbound (PE-->CE)`

`     `[`5.2`](#section-5-2)`. Inbound (CE-->PE)`

`     `[`5.3`](#section-5-3)`. Other Considerations`

`     `[`5.4`](#section-5-4)`. Example`
...
<a id="section-1-2"></a> **`1.2. Documentation Note`**
...
<a id="section-2"></a> **`2. General Scenario`**
...
<a id="section-3"></a> **`3. RPKI Considerations`**
...
<a id="section-3-1"></a> **`3.1. Origin Validation`**
...
<a id="section-3-2"></a> **`3.2. Path Validation`**
...
<a id="section-3-2-1"></a> **`3.2.1. Outbound Announcements (PE-->CE)`**
...
<a id="section-3-2-2"></a> **`3.2.2. Inbound Announcements (CE-->PE)`**
...
<a id="section-5-1"></a> **`5.1. Outbound (PE-->CE)`**
...
<a id="section-5-2"></a> **`5.2. Inbound (CE-->PE)`**
...
<a id="section-5-3"></a> **`5.3. Other Considerations`**
...
<a id="section-5-4"></a> **`5.4. Example`**
