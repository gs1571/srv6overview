...
`   `[`3`](#section-3)`. Notice on Intellectual Property`
...
`   `[`7`](#section-7)`. Changes from RFC 1907`

`   `[`8`](#section-8)`. Editor's Address`
...
<a id="section-3"></a> **`3. Notice on Intellectual Property`**
...
<a id="section-6-1"></a> **`6.1. Informative References`**
...
<a id="section-7"></a> **`7. Changes from RFC 1907`**
...
<a id="section-8"></a> **`8. Editor's Address`**
