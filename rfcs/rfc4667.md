...
`   `[`2`](#section-2)`. Network Reference Model`

`   `[`3`](#section-3)`. Forwarder Identifier`

`   `[`4`](#section-4)`. Protocol Components`

`      `[`4.1`](#section-4-1)`. Control Messages`

`      `[`4.2`](#section-4-2)`. Existing AVPs for L2VPN`

`      `[`4.3`](#section-4-3)`. New AVPs for L2VPN`

`      `[`4.4`](#section-4-4)`. AVP Interoperability`

`   `[`5`](#section-5)`. Signaling Procedures`

`      `[`5.1`](#section-5-1)`. Overview`

`      `[`5.2`](#section-5-2)`. Pseudowire Tie Detection`

`      `[`5.3`](#section-5-3)`. Generic Algorithm`

`   `[`6`](#section-6)`. IANA Considerations`

`   `[`7`](#section-7)`. Security Considerations`

`   `[`8`](#section-8)`. Acknowledgement`
...
<a id="section-2"></a> **`2. Network Reference Model`**
...
<a id="section-3"></a> **`3. Forwarder Identifier`**
...
<a id="section-4"></a> **`4. Protocol Components`**

```text

```

<a id="section-4-1"></a> **`4.1. Control Messages`**
...
<a id="section-4-2"></a> **`4.2. Existing AVPs for L2VPN`**
...
<a id="section-4-3"></a> **`4.3. New AVPs for L2VPN`**
...
<a id="section-4-4"></a> **`4.4. AVP Interoperability`**
...
<a id="section-5"></a> **`5. Signaling Procedures`**

```text

```

<a id="section-5-1"></a> **`5.1. Overview`**
...
<a id="section-5-2"></a> **`5.2. Pseudowire Tie Detection`**
...
<a id="section-5-3"></a> **`5.3. Generic Algorithm`**
...
<a id="section-8"></a> **`8. Acknowledgement`**
