...
`   `[`2`](#section-2)`. Introduction to Seamless BFD`

`   `[`3`](#section-3)`. Use Cases`

`      `[`3.1`](#section-3-1)`. Unidirectional Forwarding Path Validation`

`      `[`3.2`](#section-3-2)`. Validation of the Forwarding Path prior to`

`           Switching Traffic`

`      `[`3.3`](#section-3-3)`. Centralized Traffic Engineering`

`      `[`3.4`](#section-3-4)`. BFD in Centralized Segment Routing`

`      `[`3.5`](#section-3-5)`. Efficient BFD Operation under Resource Constraints`

`      `[`3.6`](#section-3-6)`. BFD for Anycast Addresses`

`      `[`3.7`](#section-3-7)`. BFD Fault Isolation`

`      `[`3.8`](#section-3-8)`. Multiple BFD Sessions to the Same Target Node`

`      `[`3.9`](#section-3-9)`. An MPLS BFD Session per ECMP Path`

`   `[`4`](#section-4)`. Detailed Requirements for Seamless BFD`
...
<a id="section-2"></a> **`2. Introduction to Seamless BFD`**
...
<a id="section-3-1"></a> **`3.1. Unidirectional Forwarding Path Validation`**
...
<a id="section-3-2"></a> **`3.2. Validation of the Forwarding Path prior to Switching Traffic`**
...
<a id="section-3-3"></a> **`3.3. Centralized Traffic Engineering`**
...
<a id="section-3-4"></a> **`3.4. BFD in Centralized Segment Routing`**
...
<a id="section-3-5"></a> **`3.5. Efficient BFD Operation under Resource Constraints`**
...
<a id="section-3-6"></a> **`3.6. BFD for Anycast Addresses`**
...
<a id="section-3-7"></a> **`3.7. BFD Fault Isolation`**
...
<a id="section-3-8"></a> **`3.8. Multiple BFD Sessions to the Same Target Node`**
...
<a id="section-3-9"></a> **`3.9. An MPLS BFD Session per ECMP Path`**
...
<a id="section-4"></a> **`4. Detailed Requirements for Seamless BFD`**
