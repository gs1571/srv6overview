...
`     `[`2.1`](#section-2-1)`. Acronyms`

`     `[`2.2`](#section-2-2)`. ROHC Terminology`

`   `[`3`](#section-3)`. Background (Informative)`

`     `[`3.1`](#section-3-1)`. Header Compression Fundamentals`

`     `[`3.2`](#section-3-2)`. A Short History of Header Compression`

`   `[`4`](#section-4)`. Overview of ROHC (Informative)`

`     `[`4.1`](#section-4-1)`. General Principles`

`     `[`4.2`](#section-4-2)`. Compression Efficiency, Robustness, and Transparency`

`     `[`4.3`](#section-4-3)`. Developing the ROHC Protocol`

`     `[`4.4`](#section-4-4)`. Operational Characteristics of the ROHC Channel`

`     `[`4.5`](#section-4-5)`. Compression and Master Sequence Number (MSN)`

`     `[`4.6`](#section-4-6)`. Static and Dynamic Parts of a Context`

`   `[`5`](#section-5)`. The ROHC Framework (Normative)`

`     `[`5.1`](#section-5-1)`. The ROHC Channel`

`       `[`5.1.1`](#section-5-1-1)`. Contexts and Context Identifiers`

`       `[`5.1.2`](#section-5-1-2)`. Per-Channel Parameters`

`       `[`5.1.3`](#section-5-1-3)`. Persistence of Decompressor Contexts`

`     `[`5.2`](#section-5-2)`. ROHC Packets and Packet Types`

`       `[`5.2.1`](#section-5-2-1)`. General Format of ROHC Packets`

`         `[`5.2.1.1`](#section-5-2-1-1)`. Format of the Padding Octet`

`         `[`5.2.1.2`](#section-5-2-1-2)`. Format of the Add-CID Octet`

`         `[`5.2.1.3`](#section-5-2-1-3)`. General Format of Header`

`       `[`5.2.2`](#section-5-2-2)`. Initialization and Refresh (IR) Packet Types`

`         `[`5.2.2.1`](#section-5-2-2-1)`. ROHC IR Header Format`

`         `[`5.2.2.2`](#section-5-2-2-2)`. ROHC IR-DYN Header Format`

`       `[`5.2.3`](#section-5-2-3)`. ROHC Initial Decompressor Processing`

`       `[`5.2.4`](#section-5-2-4)`. ROHC Feedback`

`         `[`5.2.4.1`](#section-5-2-4-1)`. ROHC Feedback Format`

`       `[`5.2.5`](#section-5-2-5)`. ROHC Segmentation`

`         `[`5.2.5.1`](#section-5-2-5-1)`. Segmentation Usage Considerations`

`         `[`5.2.5.2`](#section-5-2-5-2)`. Segmentation Protocol`

`     `[`5.3`](#section-5-3)`. General Encoding Methods`

`       `[`5.3.1`](#section-5-3-1)`. Header Compression CRCs, Coverage, and Polynomials .`

`         `[`5.3.1.1`](#section-5-3-1-1)`. 8-bit CRC in IR and IR-DYN Headers`

`         `[`5.3.1.2`](#section-5-3-1-2)`. 3-bit CRC in Compressed Headers`

`         `[`5.3.1.3`](#section-5-3-1-3)`. 7-bit CRC in Compressed Headers`

`         `[`5.3.1.4`](#section-5-3-1-4)`. 32-bit Segmentation CRC`

`       `[`5.3.2`](#section-5-3-2)`. Self-Describing Variable-Length Values`

`     `[`5.4`](#section-5-4)`. ROHC UNCOMPRESSED -- No Compression  (Profile 0x0000)  .`

`       `[`5.4.1`](#section-5-4-1)`. IR Packet`

`       `[`5.4.2`](#section-5-4-2)`. Normal Packet`

`       `[`5.4.3`](#section-5-4-3)`. Context Initialization`

`       `[`5.4.4`](#section-5-4-4)`. Decompressor Operation`

`       `[`5.4.5`](#section-5-4-5)`. Feedback`

`   `[`6`](#section-6)`. Overview of a ROHC Profile (Informative)`
...
<a id="section-2-1"></a> **`2.1. Acronyms`**
...
<a id="section-2-2"></a> **`2.2. ROHC Terminology`**
...
<a id="section-3"></a> **`3. Background (Informative)`**
...
<a id="section-3-1"></a> **`3.1. Header Compression Fundamentals`**
...
<a id="section-3-2"></a> **`3.2. A Short History of Header Compression`**
...
<a id="section-4"></a> **`4. Overview of ROHC (Informative)`**

```text

```

<a id="section-4-1"></a> **`4.1. General Principles`**
...
<a id="section-4-2"></a> **`4.2. Compression Efficiency, Robustness, and Transparency`**
...
<a id="section-4-3"></a> **`4.3. Developing the ROHC Protocol`**
...
<a id="section-4-4"></a> **`4.4. Operational Characteristics of the ROHC Channel`**
...
<a id="section-4-5"></a> **`4.5. Compression and Master Sequence Number (MSN)`**
...
<a id="section-4-6"></a> **`4.6. Static and Dynamic Parts of a Context`**
...
<a id="section-5"></a> **`5. The ROHC Framework (Normative)`**
...
<a id="section-5-1"></a> **`5.1. The ROHC Channel`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. Contexts and Context Identifiers`**
...
<a id="section-5-1-2"></a> **`5.1.2. Per-Channel Parameters`**
...
<a id="section-5-1-3"></a> **`5.1.3. Persistence of Decompressor Contexts`**
...
<a id="section-5-2"></a> **`5.2. ROHC Packets and Packet Types`**
...
<a id="section-5-2-1"></a> **`5.2.1. General Format of ROHC Packets`**
...
<a id="section-5-2-1-1"></a> **`5.2.1.1. Format of the Padding Octet`**
...
<a id="section-5-2-1-2"></a> **`5.2.1.2. Format of the Add-CID Octet`**
...
<a id="section-5-2-1-3"></a> **`5.2.1.3. General Format of Header`**
...
<a id="section-5-2-2"></a> **`5.2.2. Initialization and Refresh (IR) Packet Types`**
...
<a id="section-5-2-2-1"></a> **`5.2.2.1. ROHC IR Header Format`**
...
<a id="section-5-2-2-2"></a> **`5.2.2.2. ROHC IR-DYN Header Format`**
...
<a id="section-5-2-3"></a> **`5.2.3. ROHC Initial Decompressor Processing`**
...
<a id="section-5-2-4"></a> **`5.2.4. ROHC Feedback`**
...
<a id="section-5-2-4-1"></a> **`5.2.4.1. ROHC Feedback Format`**
...
<a id="section-5-2-5"></a> **`5.2.5. ROHC Segmentation`**
...
<a id="section-5-2-5-1"></a> **`5.2.5.1. Segmentation Usage Considerations`**
...
<a id="section-5-2-5-2"></a> **`5.2.5.2. Segmentation Protocol`**
...
<a id="section-5-3"></a> **`5.3. General Encoding Methods`**

```text

```

<a id="section-5-3-1"></a> **`5.3.1. Header Compression CRCs, Coverage, and Polynomials`**
...
<a id="section-5-3-1-1"></a> **`5.3.1.1. 8-bit CRC in IR and IR-DYN Headers`**
...
<a id="section-5-3-1-2"></a> **`5.3.1.2. 3-bit CRC in Compressed Headers`**
...
<a id="section-5-3-1-3"></a> **`5.3.1.3. 7-bit CRC in Compressed Headers`**
...
<a id="section-5-3-1-4"></a> **`5.3.1.4. 32-bit Segmentation CRC`**
...
<a id="section-5-3-2"></a> **`5.3.2. Self-Describing Variable-Length Values`**
...
<a id="section-5-4"></a> **`5.4. ROHC UNCOMPRESSED -- No Compression  (Profile 0x0000)`**
...
<a id="section-5-4-1"></a> **`5.4.1. IR Packet`**
...
<a id="section-5-4-2"></a> **`5.4.2. Normal Packet`**
...
<a id="section-5-4-3"></a> **`5.4.3. Context Initialization`**
...
<a id="section-5-4-4"></a> **`5.4.4. Decompressor Operation`**
...
<a id="section-5-4-5"></a> **`5.4.5. Feedback`**
...
<a id="section-6"></a> **`6. Overview of a ROHC Profile (Informative)`**
