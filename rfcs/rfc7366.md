...
`   `[`2`](#section-2)`. Negotiating Encrypt-then-MAC`

`     `[`2.1`](#section-2-1)`. Rationale`

`   `[`3`](#section-3)`. Applying Encrypt-then-MAC`

`     `[`3.1`](#section-3-1)`. Rehandshake Issues`
...
<a id="section-2"></a> **`2. Negotiating Encrypt-then-MAC`**
...
<a id="section-2-1"></a> **`2.1. Rationale`**
...
<a id="section-3"></a> **`3. Applying Encrypt-then-MAC`**
...
<a id="section-3-1"></a> **`3.1. Rehandshake Issues`**
