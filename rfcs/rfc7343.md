...
`     `[`1.1`](#section-1-1)`. Rationale and Intent`

`     `[`1.2`](#section-1-2)`. ORCHID Properties`

`     `[`1.3`](#section-1-3)`. Expected Use of ORCHIDs`

`     `[`1.4`](#section-1-4)`. Action Plan`

`     `[`1.5`](#section-1-5)`. Terminology`

`   `[`2`](#section-2)`. Cryptographic Hash Identifier Construction`

`   `[`3`](#section-3)`. Routing and Forwarding Considerations`
...
<a id="section-1-1"></a> **`1.1. Rationale and Intent`**
...
<a id="section-1-2"></a> **`1.2. ORCHID Properties`**
...
<a id="section-1-3"></a> **`1.3. Expected Use of ORCHIDs`**
...
<a id="section-1-4"></a> **`1.4. Action Plan`**
...
<a id="section-2"></a> **`2. Cryptographic Hash Identifier Construction`**
...
<a id="section-3"></a> **`3. Routing and Forwarding Considerations`**
