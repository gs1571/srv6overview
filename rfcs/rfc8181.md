...
`   `[`2`](#section-2)`. Protocol Specification`

`     `[`2.1`](#section-2-1)`. Common XML Message Format`

`     `[`2.2`](#section-2-2)`. Publication and Withdrawal`

`     `[`2.3`](#section-2-3)`. Listing the Repository`

`     `[`2.4`](#section-2-4)`. Error Handling`

`     `[`2.5`](#section-2-5)`. Error Codes`

`     `[`2.6`](#section-2-6)`. XML Schema`

`   `[`3`](#section-3)`. Examples`

`     `[`3.1`](#section-3-1)`. <publish/> Query, No Existing Object`

`     `[`3.2`](#section-3-2)`. <publish/> Query, Overwriting Existing Object`

`     `[`3.3`](#section-3-3)`. <withdraw/> Query`

`     `[`3.4`](#section-3-4)`. <success/> Reply`

`     `[`3.5`](#section-3-5)`. <report_error/> with Optional Elements`

`     `[`3.6`](#section-3-6)`. <report_error/> without Optional Elements`

`     `[`3.7`](#section-3-7)`. Error Handling with Multi-Element Queries`

`       `[`3.7.1`](#section-3-7-1)`. Multi-Element Query`

`       `[`3.7.2`](#section-3-7-2)`. Successful Multi-Element Response`

`       `[`3.7.3`](#section-3-7-3)`. Failure Multi-Element Response, First Error Only  .`

`       `[`3.7.4`](#section-3-7-4)`. Failure Multi-Element Response, All Errors`

`     `[`3.8`](#section-3-8)`. <list/> Query`

`     `[`3.9`](#section-3-9)`. <list/> Reply`
...
<a id="section-2"></a> **`2. Protocol Specification`**
...
<a id="section-2-1"></a> **`2.1. Common XML Message Format`**
...
<a id="section-2-2"></a> **`2.2. Publication and Withdrawal`**
...
<a id="section-2-3"></a> **`2.3. Listing the Repository`**
...
<a id="section-2-4"></a> **`2.4. Error Handling`**
...
<a id="section-2-5"></a> **`2.5. Error Codes`**
...
<a id="section-2-6"></a> **`2.6. XML Schema`**
...
<a id="section-3-1"></a> **`3.1. <publish/> Query, No Existing Object`**
...
<a id="section-3-2"></a> **`3.2. <publish/> Query, Overwriting Existing Object`**
...
<a id="section-3-3"></a> **`3.3. <withdraw/> Query`**
...
<a id="section-3-4"></a> **`3.4. <success/> Reply`**
...
<a id="section-3-5"></a> **`3.5. <report_error/> with Optional Elements`**
...
<a id="section-3-6"></a> **`3.6. <report_error/> without Optional Elements`**
...
<a id="section-3-7"></a> **`3.7. Error Handling with Multi-Element Queries`**

```text

```

<a id="section-3-7-1"></a> **`3.7.1. Multi-Element Query`**
...
<a id="section-3-7-2"></a> **`3.7.2. Successful Multi-Element Response`**
...
<a id="section-3-7-3"></a> **`3.7.3. Failure Multi-Element Response, First Error Only`**
...
<a id="section-3-7-4"></a> **`3.7.4. Failure Multi-Element Response, All Errors`**
...
<a id="section-3-8"></a> **`3.8. <list/> Query`**
...
<a id="section-3-9"></a> **`3.9. <list/> Reply`**
