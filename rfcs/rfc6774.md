...
`      `[`2.1`](#section-2-1)`. BGP Add-Paths Proposal`

`   `[`3`](#section-3)`. Goals`

`   `[`4`](#section-4)`. Multi-Plane Route Reflection`

`      `[`4.1`](#section-4-1)`. Co-located Best- and Backup-Path RRs`

`      `[`4.2`](#section-4-2)`. Randomly Located Best- and Backup-Path RRs`

`      `[`4.3`](#section-4-3)`. Multi-Plane Route Servers for Internet Exchanges`

`   `[`5`](#section-5)`. Discussion on Current Models of IBGP Route Distribution`

`      `[`5.1`](#section-5-1)`. Full Mesh`

`      `[`5.2`](#section-5-2)`. Confederations`

`      `[`5.3`](#section-5-3)`. Route Reflectors`

`   `[`6`](#section-6)`. Deployment Considerations`

`   `[`7`](#section-7)`. Summary of Benefits`

`   `[`8`](#section-8)`. Applications`
...
<a id="section-2-1"></a> **`2.1. BGP Add-Paths Proposal`**
...
<a id="section-4"></a> **`4. Multi-Plane Route Reflection`**
...
<a id="section-4-1"></a> **`4.1. Co-located Best- and Backup-Path RRs`**
...
<a id="section-4-2"></a> **`4.2. Randomly Located Best- and Backup-Path RRs`**
...
<a id="section-4-3"></a> **`4.3. Multi-Plane Route Servers for Internet Exchanges`**
...
<a id="section-5"></a> **`5. Discussion on Current Models of IBGP Route Distribution`**
...
<a id="section-5-1"></a> **`5.1. Full Mesh`**
...
<a id="section-5-2"></a> **`5.2. Confederations`**
...
<a id="section-5-3"></a> **`5.3. Route Reflectors`**
...
<a id="section-7"></a> **`7. Summary of Benefits`**
...
<a id="section-8"></a> **`8. Applications`**
