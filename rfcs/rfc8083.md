...
`   `[`4`](#section-4)`. RTP Circuit Breakers for Systems Using the RTP/AVP Profile`

`     `[`4.1`](#section-4-1)`. RTP/AVP Circuit Breaker #1: RTCP Timeout`

`     `[`4.2`](#section-4-2)`. RTP/AVP Circuit Breaker #2: Media Timeout`

`     `[`4.3`](#section-4-3)`. RTP/AVP Circuit Breaker #3: Congestion`

`     `[`4.4`](#section-4-4)`. RTP/AVP Circuit Breaker #4: Media Usability`

`     `[`4.5`](#section-4-5)`. Ceasing Transmission`

`   `[`5`](#section-5)`. RTP Circuit Breakers and the RTP/AVPF and RTP/SAVPF Profiles   18`

`   `[`6`](#section-6)`. Impact of RTCP Extended Reports (XR)`

`   `[`7`](#section-7)`. Impact of Explicit Congestion Notification (ECN)`

`   `[`8`](#section-8)`. Impact of Bundled Media and Layered Coding`
...
<a id="section-4"></a> **`4. RTP Circuit Breakers for Systems Using the RTP/AVP Profile`**
...
<a id="section-4-1"></a> **`4.1. RTP/AVP Circuit Breaker #1: RTCP Timeout`**
...
<a id="section-4-2"></a> **`4.2. RTP/AVP Circuit Breaker #2: Media Timeout`**
...
<a id="section-4-3"></a> **`4.3. RTP/AVP Circuit Breaker #3: Congestion`**
...
<a id="section-4-4"></a> **`4.4. RTP/AVP Circuit Breaker #4: Media Usability`**
...
<a id="section-4-5"></a> **`4.5. Ceasing Transmission`**
...
<a id="section-5"></a> **`5. RTP Circuit Breakers and the RTP/AVPF and RTP/SAVPF Profiles`**
...
<a id="section-6"></a> **`6. Impact of RTCP Extended Reports (XR)`**
...
<a id="section-7"></a> **`7. Impact of Explicit Congestion Notification (ECN)`**
...
<a id="section-8"></a> **`8. Impact of Bundled Media and Layered Coding`**
