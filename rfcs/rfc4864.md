...
`   `[`2`](#section-2)`. Perceived Benefits of NAT and Its Impact on IPv4`

`     `[`2.1`](#section-2-1)`. Simple Gateway between Internet and Private Network`

`     `[`2.2`](#section-2-2)`. Simple Security Due to Stateful Filter Implementation  .`

`     `[`2.3`](#section-2-3)`. User/Application Tracking`

`     `[`2.4`](#section-2-4)`. Privacy and Topology Hiding`

`     `[`2.5`](#section-2-5)`. Independent Control of Addressing in a Private Network .`

`     `[`2.6`](#section-2-6)`. Global Address Pool Conservation`

`     `[`2.7`](#section-2-7)`. Multihoming and Renumbering with NAT`

`   `[`3`](#section-3)`. Description of the IPv6 Tools`

`     `[`3.1`](#section-3-1)`. Privacy Addresses (RFC 3041)`

`     `[`3.2`](#section-3-2)`. Unique Local Addresses`

`     `[`3.3`](#section-3-3)`. DHCPv6 Prefix Delegation`

`     `[`3.4`](#section-3-4)`. Untraceable IPv6 Addresses`

`   `[`4`](#section-4)`. Using IPv6 Technology to Provide the Market Perceived`

`       Benefits of NAT`

`     `[`4.1`](#section-4-1)`. Simple Gateway between Internet and Internal Network`

`     `[`4.2`](#section-4-2)`. IPv6 and Simple Security`

`     `[`4.3`](#section-4-3)`. User/Application Tracking`

`     `[`4.4`](#section-4-4)`. Privacy and Topology Hiding Using IPv6`

`     `[`4.5`](#section-4-5)`. Independent Control of Addressing in a Private Network .`

`     `[`4.6`](#section-4-6)`. Global Address Pool Conservation`

`     `[`4.7`](#section-4-7)`. Multihoming and Renumbering`

`   `[`5`](#section-5)`. Case Studies`

`     `[`5.1`](#section-5-1)`. Medium/Large Private Networks`

`     `[`5.2`](#section-5-2)`. Small Private Networks`

`     `[`5.3`](#section-5-3)`. Single User Connection`

`     `[`5.4`](#section-5-4)`. ISP/Carrier Customer Networks`

`   `[`6`](#section-6)`. IPv6 Gap Analysis`

`     `[`6.1`](#section-6-1)`. Simple Security`

`     `[`6.2`](#section-6-2)`. Subnet Topology Masking`

`     `[`6.3`](#section-6-3)`. Minimal Traceability of Privacy Addresses`

`     `[`6.4`](#section-6-4)`. Site Multihoming`
...
<a id="section-2"></a> **`2. Perceived Benefits of NAT and Its Impact on IPv4`**
...
<a id="section-2-1"></a> **`2.1. Simple Gateway between Internet and Private Network`**
...
<a id="section-2-2"></a> **`2.2. Simple Security Due to Stateful Filter Implementation`**
...
<a id="section-2-3"></a> **`2.3. User/Application Tracking`**
...
<a id="section-2-4"></a> **`2.4. Privacy and Topology Hiding`**
...
<a id="section-2-5"></a> **`2.5. Independent Control of Addressing in a Private Network`**
...
<a id="section-2-6"></a> **`2.6. Global Address Pool Conservation`**
...
<a id="section-2-7"></a> **`2.7. Multihoming and Renumbering with NAT`**
...
<a id="section-3"></a> **`3. Description of the IPv6 Tools`**
...
<a id="section-3-1"></a> **`3.1. Privacy Addresses (RFC 3041)`**
...
<a id="section-3-2"></a> **`3.2. Unique Local Addresses`**
...
<a id="section-3-3"></a> **`3.3. DHCPv6 Prefix Delegation`**
...
<a id="section-3-4"></a> **`3.4. Untraceable IPv6 Addresses`**
...
<a id="section-4"></a> **`4. Using IPv6 Technology to Provide the Market Perceived Benefits of`**
...
<a id="section-4-1"></a> **`4.1. Simple Gateway between Internet and Internal Network`**
...
<a id="section-4-2"></a> **`4.2. IPv6 and Simple Security`**
...
<a id="section-4-3"></a> **`4.3. User/Application Tracking`**
...
<a id="section-4-4"></a> **`4.4. Privacy and Topology Hiding Using IPv6`**
...
<a id="section-4-5"></a> **`4.5. Independent Control of Addressing in a Private Network`**
...
<a id="section-4-6"></a> **`4.6. Global Address Pool Conservation`**
...
<a id="section-4-7"></a> **`4.7. Multihoming and Renumbering`**
...
<a id="section-5"></a> **`5. Case Studies`**
...
<a id="section-5-1"></a> **`5.1. Medium/Large Private Networks`**
...
<a id="section-5-2"></a> **`5.2. Small Private Networks`**
...
<a id="section-5-3"></a> **`5.3. Single User Connection`**
...
<a id="section-5-4"></a> **`5.4. ISP/Carrier Customer Networks`**
...
<a id="section-6"></a> **`6. IPv6 Gap Analysis`**
...
<a id="section-6-1"></a> **`6.1. Simple Security`**
...
<a id="section-6-2"></a> **`6.2. Subnet Topology Masking`**
...
<a id="section-6-3"></a> **`6.3. Minimal Traceability of Privacy Addresses`**
...
<a id="section-6-4"></a> **`6.4. Site Multihoming`**
