...
`   `[`2`](#section-2)`. Document Conventions`

`   `[`3`](#section-3)`. Motivations`
...
<a id="section-2"></a> **`2. Document Conventions`**
...
<a id="section-2-2"></a> **`2.2. Acronyms`**
...
<a id="section-3"></a> **`3. Motivations`**
...
<a id="section-4-1"></a> **`4.1. Detection of Label Switched Path Defects`**
...
<a id="section-4-2"></a> **`4.2. Diagnosis of a Broken Label Switched Path`**
...
<a id="section-4-3"></a> **`4.3. Path Characterization`**
...
<a id="section-4-4"></a> **`4.4. Service Level Agreement Measurement`**
...
<a id="section-4-5"></a> **`4.5. Frequency of OAM Execution`**
...
<a id="section-4-6"></a> **`4.6. Alarm Suppression, Aggregation, and Layer Coordination`**
...
<a id="section-4-7"></a> **`4.7. Support for OAM Inter-working for Fault Notification`**
...
<a id="section-4-8"></a> **`4.8. Error Detection and Recovery`**
...
<a id="section-4-9"></a> **`4.9. Standard Management Interfaces`**
...
<a id="section-4-10"></a> **`4.10. Detection of Denial of Service Attacks`**
...
<a id="section-4-11"></a> **`4.11. Per-LSP Accounting Requirements`**
...
<a id="section-4-11-1"></a> **`4.11.1. Requirements`**
...
<a id="section-4-11-2"></a> **`4.11.2. Location of Accounting`**
