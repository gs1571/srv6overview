...
**Consensus:** true
**IPR:** trust200902
**Doc Name:** draft-ietf-idr-bgp-ct-39
...
**Keywords:** BGP-CT, CT, Intent-Based Routing, BGP Service Mapping

## Related Documents

- [prev](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ct-39)
- [alternate](https://dx.doi.org/10.17487/rfc9832)
...
Information about the current status of this document, any
            ...
            [https://www.rfc-editor.org/info/rfc9832](https://www.rfc-editor.org/info/rfc9832).
...
- [2. Terminology](#section-2)
  - [2.1. Abbreviations](#section-2.1)
  - [2.2. Definitions and Notations](#section-2.2)
  - [2.3. Requirements Language](#section-2.3)
- [3. Architecture Overview](#section-3)
- [4. Transport Class](#tc)
  - [4.1. Classifying TE Tunnels](#tc-te)
  - [4.2. Transport Route Database (TRDB)](#trdb)
  - [4.3. Transport Class Route Target](#tc-rt)
- [5. Resolution Scheme](#Nexthop_Resoln_Schm)
  - [5.1. Mapping Community](#Mapping_Comm)
- [6. BGP Classful Transport Family](#ct-family)
  - [6.1. NLRI Encoding](#ct-nlri)
  - [6.2. Next Hop Encoding](#ct-nhop)
  - [6.3. Carrying Multiple Types of Encapsulation Information](#CTMultiEncap)
  - [6.4. Comparison with Other Families Using Encoding from RFC 8277](#section-6.4)
- [7. Protocol Procedures](#section-7)
  - [7.1. Preparing the Network to Deploy Classful Transport Planes](#section-7.1)
  - [7.2. Originating BGP CT Routes](#section-7.2)
  - [7.3. Processing BGP CT Routes by Ingress Nodes](#CTingress)
  - [7.4. Readvertising BGP CT Route by Border Nodes](#section-7.4)
  - [7.5. Border Nodes Receiving BGP CT Routes on EBGP](#section-7.5)
  - [7.6. Avoiding Path Hiding Through Route Reflectors](#section-7.6)
  - [7.7. Avoiding Loops Between Route Reflectors in Forwarding Paths](#section-7.7)
  - [7.8. Ingress Nodes Receiving Service Routes with a Mapping Community](#section-7.8)
  - [7.9. Best-Effort Transport Class](#section-7.9)
  - [7.10. Interaction with BGP Attributes Specifying Next Hop Address and Color](#bgp-att)
  - [7.11. Applicability to Flowspec Redirect-to-IP](#section-7.11)
  - [7.12. Applicability to IPv6](#IPv6-Applicability)
  - [7.13. SRv6 Support](#SRv6-Support)
  - [7.14. Error-Handling Considerations](#error-handling)
- [8. Illustration of BGP CT Procedures](#CTProc)
  - [8.1. Reference Topology](#section-8.1)
  - [8.2. Service Layer Route Exchange](#section-8.2)
  - [8.3. Transport Layer Route Propagation](#section-8.3)
  - [8.4. Data Plane View](#section-8.4)
    - [8.4.1. Steady State](#section-8.4.1)
    - [8.4.2. Local Repair of Primary Path](#section-8.4.2)
    - [8.4.3. Absorbing Failure of the Primary Path: Fallback to Best-Effort Tunnels](#section-8.4.3)
- [9. Scaling Considerations](#section-9)
  - [9.1. Avoiding Unintended Spread of BGP CT Routes Across Domains](#secure-propagate)
  - [9.2. Constrained Distribution of PNHs to SNs (On-Demand Next Hop)](#section-9.2)
  - [9.3. Limiting the Visibility Scope of PE Loopback as PNHs](#section-9.3)
- [10. Operations and Manageability Considerations](#section-10)
  - [10.1. MPLS OAM](#mpls-oam)
  - [10.2. Usage of RD and Label-Allocation Modes](#rd-lbl-usage)
  - [10.3. Managing Transport-Route Visibility](#CTRouteVis)
- [11. Deployment Considerations](#CTdeploy)
  - [11.1. Coordination Between Domains Using Different Community Namespaces](#section-11.1)
  - [11.2. Managing Intent at Service and Transport Layers](#section-11.2)
    - [11.2.1. Service Layer Color Management](#section-11.2.1)
    - [11.2.2. Non-Agreeing Color Transport Domains](#non-agreeing)
    - [11.2.3. Heterogeneous Agreeing Color Transport Domains](#section-11.2.3)
  - [11.3. Migration Scenarios](#section-11.3)
    - [11.3.1. BGP CT Islands Connected via BGP LU Domain](#section-11.3.1)
    - [11.3.2. BGP CT: Interoperability Between MPLS and Other Forwarding Technologies](#section-11.3.2)
  - [11.4. MTU Considerations](#section-11.4)
  - [11.5. Use of DSCP](#section-11.5)
- [12. Applicability to Network Slicing](#section-12)
- [13. IANA Considerations](#IANA)
  - [13.1. New BGP SAFI](#section-13.1)
  - [13.2. New Format for BGP Extended Community](#section-13.2)
    - [13.2.1. Existing Registries](#section-13.2.1)
    - [13.2.2. New Registries](#section-13.2.2)
  - [13.3. MPLS OAM Code Points](#section-13.3)
- [14. Transport Class ID Registry](#section-14)
- [15. Security Considerations](#Security)
- [16. References](#section-16)
  - [16.1. Normative References](#section-16.1)
  - [16.2. Informative References](#section-16.2)
- [Appendix A. Extensibility Considerations](#Appendix_A)
  - [A.1. Signaling Intent over a PE-CE Attachment Circuit](#section-appendix.a.1)
  - [A.2. BGP CT Egress TE](#section-appendix.a.2)
- [Appendix B. Applicability to Intra-AS and Different Inter-AS Deployments](#Appendix_B)
  - [B.1. Intra-AS Use Case](#section-appendix.b.1)
    - [B.1.1. Topology](#section-appendix.b.1.1)
    - [B.1.2. Transport Layer](#section-appendix.b.1.2)
    - [B.1.3. Service Layer Route Exchange](#section-appendix.b.1.3)
  - [B.2. Inter-AS Option A Use Case](#section-appendix.b.2)
    - [B.2.1. Topology](#section-appendix.b.2.1)
    - [B.2.2. Transport Layer](#section-appendix.b.2.2)
    - [B.2.3. Service Layer Route Exchange](#section-appendix.b.2.3)
  - [B.3. Inter-AS Option B Use Case](#section-appendix.b.3)
    - [B.3.1. Topology](#section-appendix.b.3.1)
    - [B.3.2. Transport Layer](#section-appendix.b.3.2)
    - [B.3.3. Service Layer Route Exchange](#section-appendix.b.3.3)
- [Appendix C. Why reuse RFCs 8277 and 4364?](#Appendix_C)
  - [C.1. Update Packing Considerations](#section-appendix.c.1)
- [Appendix D. Scaling Using BGP MPLS Namespaces](#Appendix_D)
...
[RFC9315](#RFC9315) defines "Intent" as:

This document prescribes constructs and procedures
...
The mechanisms defined in this document allow different tunneling
      ...
      example, the details for Segment Routing over IPv6 (SRv6) are provided in [BGP-CT-SRv6](#I-D.ietf-idr-bgp-ct-srv6) and an overview is provided in [Section 7.13](#SRv6-Support).
...
[Intent-Routing-Color](#I-D.hr-spring-intentaware-routing-using-color) describes various use cases and
      applications of the procedures described in this document.

[Appendix C](#Appendix_C) provides an outline of the design
...
**ABR:**
  Area Border Router (readvertises BGP CT or BGP LU
  	routes with NH self)
...
**BGP VPN:**
  VPNs built using RD or RT; architecture described
  	in [RFC4364](#RFC4364)
...
**RTC:**
  Route Target Constraint [RFC4684](#RFC4684)
...
**color:0:100 or col-100:**
  This notation denotes a Color extended
            community as defined in [RFC9012](#RFC9012) with the "Flags" field set to 0 and
            the "Color Value" field set to 100.

**End-to-End Tunnel:**
  A tunnel spanning several adjacent
            tunnel domains created by "stitching" them together using MPLS
            labels or an equivalent identifier based on the forwarding
            architecture.

**Import processing:**
  Receive-side processing of an overlay
            route, including things like import-policy application, Resolution Scheme selection, and NH resolution.

**Mapping Community:**
  Any BGP CCA (e.g., Community,
            Extended Community) on an overlay route that maps to a Resolution
            Scheme. For example, color:0:100, transport-target:0:100.

**Provider Namespace:**
  Internal Infrastructure address
            space in a provider network managed by the operator.

**Resolution Scheme:**
  A construct comprising of an ordered
            set of TRDBs to resolve NH reachability for realizing a
            desired Intent.

**Service Family:**
  A BGP address family used for
            advertising routes for destinations in "data traffic". For example,
            AFI/SAFIs 1/1 or 1/128.

**Service Prefix:**
  A destination in "data traffic". Routes
            to these prefixes are carried in a Service Family.

**Transport Family:**
  A BGP address family used for
            advertising tunnels, which are, in turn, used by service routes for
            resolution. For example, AFI/SAFIs 1/4 or 1/76.

**Transport Tunnel:**
  A tunnel over which a service may
            ...
            UDP, LDP, RSVP-TE, IGP Flexible Algorithm (Flex-Algo), or SRTE.

**Transport Layer:**
  A layer in the network that
            contains Transport Tunnels and Transport Families.

**Tunnel Route:**
  A Route to Tunnel Destination/Endpoint
            that is installed at the headend (ingress) of the tunnel.

**Tunnel Domain:**
  A domain of the network containing
            SNs and BNs under a single
            administrative control that has tunnels between them.

**Brownfield network:**
  An existing network that is already
...
**Greenfield network:**
  A new network deployment that can
            make choices of new technology or hardware as needed with fewer
            constraints than brownfield network.

**Transport Class:**
  A construct to group transport tunnels
            offering similar SLAs (see [Section 4.1](#tc-te)).

**Transport Class RT:**
  A Route Target extended community
            used to identify a specific Transport Class.

**transport-target:0:100:**
  This notation denotes a
            Transport Class RT as defined in this document
            with the "Transport Class ID" field set to 100.

**Transport Route Database:**
  At the SN and BN, a Transport
            Class has an associated TRDB that collects its
            tunnel routes.

**Transport Plane:**
  An end-to-end plane consisting of
            transport tunnels belonging to the same Transport Class.
...
- The "Transport Class" construct (see [Section 4](#tc)) to group
          underlay tunnels.
- The "Resolution Scheme" construct (see [Section 5](#Nexthop_Resoln_Schm))
          for overlay routes with Mapping Communities to resolve NH reachability from either one or an ordered set of Transport
          Classes.
- The "BGP Classful Transport" (see [Section 6](#ct-family))
          address family to extend these constructs to adjacent domains.

[Figure 1](#ArchOv) depicts the intra-AS and inter-AS
      application of these constructs. Interactions between SN1 and PE11 describe
      the intra-AS usage. Interactions between PE21 and PE11 describe the inter-AS usage.

The example topology is an inter-AS
      option C network ([RFC4364](#RFC4364)) with two AS domains;
...
PE21, SN11, and PE11 are the SNs in this network. SN11 is an ingress
      ...
      inter-domain reachability to PE11.
...
The tunneling mechanisms are made "Transport Class" aware. They
      ...
      (see [Section 4.2](#trdb)). In [Figure 1](#ArchOv), RSVP-TE publishes its underlay tunnels into TRDBs
...
Resolution Schemes are used to realize Intent. A Resolution Scheme is
      ...
      Intent using a BGP community, which assumes the role of "Mapping Community".
...
For the intra-AS case, SN1 maps this intra-AS route on RSVP-TE 
      tunnels with TC ID 100 by using the Resolution Scheme for color:0:100.

For the inter-AS case, the underlay route in a TRDB is advertised 
      ...
      thus avoiding the need for multiple loopbacks on the eSN.
...
The BGP CT address family carries transport prefixes across tunnel
      ...
      the end-to-end network a "Transport Class" aware tunneled network.

In [Figure 1](#ArchOv), BGP CT routes are originated at BN11 in
      ...
      BGP CT tunnel for each TC ID at PE21.
...
PE21 maps the inter-AS service routes received with color:0:100 from 
      ...
      in the intra-AS case.

The following text illustrates how CT architecture provides tiered
      fallback options at a per-route granularity. [Figure 1](#ArchOv)
      ...
      routes of prefixes IP1, IP2, and IP3:

- Resolve IP1 NH over available tunnels in TRDB for Transport
          Class 100 with fallback to TRDB for best effort.
- Resolve IP2 NH over available tunnels in TRDB for Transport
          Class 200 with fallback to TRDB for best effort.
- Resolve IP3 NH over available tunnels in TRDB for Transport
          Class 100 with fallback to TRDB for Transport Class 200.

In [Figure 1](#ArchOv), SN11 resolves IP1, IP2, and IP3
      directly over RSVP-TE tunnels in AS1. PE21 resolves IP1, IP2, and IP3
      over extended BGP CT tunnels that resolve over SR-TE tunnels in AS2.
...
This document describes procedures using MPLS forwarding
      ...
      for non-MPLS forwarding architectures as well. [Section 7.13](#SRv6-Support) 
...
A Transport Class is uniquely identified by a 32-bit "Transport Class
      ...
      domain with its unique Transport Class ID.
...
A Transport Class is also configured with RD and import/export RT
      ...
      TRDB and Resolution Schemes on that node.
...
All nodes within a domain agree on a common Transport Class ID
      ...
      namespaces between cooperating domains are specified in [Section 11.2.2](#non-agreeing).
...
- Tunnels (RSVP-TE, IGP Flex-Algo, SR-TE) that support latency
            sensitive routing.
- RSVP-TE tunnels that only go over admin-group with Green
            links.
...
- Tunnels (RSVP-TE, SR-TE, BGP CT) that avoid certain nodes in
            the network based on RSVP-TE Explicit Route Object (ERO), SR-TE policy, or BGP policy.
...
When a tunnel is made Transport Class aware, it causes the Tunnel
        ...
        RT, which is a new Route Target extended community defined in [Section 4.3](#tc-rt).
...
When the tunnel route is received via [RFC9830](#RFC9830) with
...
[PCEP-SRPOLICY](#I-D.ietf-pce-segment-routing-policy-cp) extends the Path Computation Element
        ...
        associating the SR Policy with the desired Transport Class.

Similarly, [PCEP-RSVP-COLOR](#I-D.ietf-pce-pcep-color) extends PCEP to carry
...
A TRDB is a logical collection of
        ...
        the scope of the TRDBs.

Tunnel EP addresses in a TRDB belong to the provider
        namespace representing the core transport region.

An implementation may realize the TRDB as a "Routing Table"
        referred to in [RFC4271](#RFC4271), which is used only for resolving NH
        ...
        used to resolve an NH.

SNs or BNs originate routes for the BGP CT address
...
This section defines a new type of Route Target called a
        ...
        with BGP CT routes (AFI/SAFI: 1/76 or 2/76) are described below.

The Transport Class RT is a
        transitive extended community [RFC4360](#RFC4360)
        of extended type, which has the format as shown in [Figure 2](#TCExtCom).
...
A Transport Class RT with TC ID 100
        is denoted as "transport-target:0:100".

The VPN route import/export mechanisms specified in BGP/MPLS IP VPNs (see [RFC4364](#RFC4364)) and the Constrained Route
        Distribution mechanisms specified in Route Target Constraint (see [RFC4684](#RFC4684)) are applied using the Route Target extended
        community. These mechanisms are applied to BGP CT routes (AFI/SAFI:
        1/76 or 2/76) using the Transport Class RT".

A BGP speaker that implements procedures described in this document
        and [RFC4684](#RFC4684) **MUST** also
...
Further, when processing RT membership NLRIs containing a Transport
        ...
        EBGP RTC paths are considered.

The Transport Class RT is carried on
        ...
        for scenarios described in [Section 11.2.2](#non-agreeing).
...
Defining a new type code for the Transport Class RT
        avoids conflicting with any VPN Route Target
        assignments already in use for service families.

This document also reserves the non-transitive version of the Transport Class RT
        (see [Section 13.2.1.1.2](#tc-rt-nt)) for future use. The non-transitive Transport Class
...
Resolution Schemes enable a BGP speaker to resolve NH
      reachability for overlay routes over the appropriate underlay tunnels
      within the scope of the TRDBs. Longest Prefix Match (LPM) of the NH is performed within the identified TRDB.
...
To accomplish this, the "Resolution Scheme" is configured with the
      ...
      they consist of the same ordered set of TRDBs.
...
A Mapping Community is a "role" and not a new type of community;
...
A Mapping Community maps to exactly one Resolution Scheme at
        a receiving BGP speaker. An implementation **SHOULD** allow the association of
        multiple Mapping Communities to a Resolution Scheme. This helps with
        renumbering and migration scenarios.

An example of a Mapping Community is a Color extended community "color:0:100", described in
        [RFC9012](#RFC9012), or the "transport-target:0:100" described in
        [Section 4.3](#tc-rt).
...
The first community on the overlay route that matches a Mapping
        ...
        these distinct Mapping Communities as equivalent in Intent.

On an overlay route, if more than one Mapping Community exists that map
...
It should be noted that the Mapping Community role does not require
        applying Route Target Constraint procedures specified in [RFC4684](#RFC4684).

<a name="ct-family"></a>
# BGP Classful Transport Family
...
The AFI/SAFI 1/76 **MUST** be negotiated as per the Multiprotocol
      Extensions capability described in [RFC4760](#RFC4760)
...
The "Classful Transport" SAFI NLRI has the same encoding as
        specified in [RFC8277](#RFC8277).

When the AFI/SAFI is 1/76, the BGP CT NLRI Prefix consists
...
The procedures described for AFI/SAFIs 1/4 or 1/128 in
        [RFC8277](#RFC8277) apply for AFI/SAFI 1/76 also. The procedures
        described for AFI/SAFIs 2/4 or 2/128 in [RFC8277](#RFC8277) apply for AFI/SAFI 2/76 also.

BGP CT routes **MAY** carry multiple labels in the NLRI by negotiating
        the Multiple Labels Capability as described in [RFC8277](#RFC8277).

Properties received on a BGP CT route include the
...
When the length of Next hop Address field is 24 (or 48), the next
...
If the length of the Next hop Address field contains any other
        ...
        as per [RFC7606](#RFC7606).

<a name="CTMultiEncap"></a>
## Carrying Multiple Types of Encapsulation Information
...
An MPLS label is carried using the encoding in [RFC8277](#RFC8277). A node that does not support MPLS forwarding
        advertises the special label 3 (Implicit NULL) in the MPLS label field (see [RFC8277](#RFC8277)). The Implicit NULL label carried in BGP CT route indicates
...
The SID information for SR with respect to SRv6 data plane is
        carried as specified in [Section 7.13](#SRv6-Support).

UDP tunneling information is carried using the Tunnel Encapsulation
        Attribute as specified in [RFC9012](#RFC9012).

## Comparison with Other Families Using Encoding from RFC 8277

AFI/SAFI 1/128 (L3VPN) is a family encoded using [RFC8277](#RFC8277) that carries service prefixes in the NLRI, where the prefixes
        come from the customer namespaces and are contextualized into separate
        user virtual service RIBs called VRFs as per [RFC4364](#RFC4364).

AFI/SAFI 1/4 (BGP LU) is a family encoded using [RFC8277](#RFC8277) that carries
        transport prefixes in the NLRI, where the prefixes come from the
        provider namespace.

AFI/SAFI 1/76 (BGP CT) is a family encoded using [RFC8277](#RFC8277) that carries transport prefixes in the NLRI, where the prefixes
        come from the provider namespace and are contextualized into separate
        TRDB, following mechanisms similar to [RFC4364](#RFC4364) procedures.
...
It is worth noting that AFI/SAFI 1/128 has been used to carry
        ...
        defined in [RFC4364](#RFC4364), where BGP LU/LDP
        prefixes in CsC VRF are advertised in AFI/SAFI 1/128 towards the
        remote-end client carrier.

In this document, SAFI 76 (CT) is used instead of reusing SAFI
...
A new SAFI 76 for AFI 1 and AFI 2 also facilitates having a
        ...
        "NH self" rewrite over inter-AS links.

The BGP CT SAFI 76 for AFI 1 and 2 is conceptually similar to BGP
...
## Preparing the Network to Deploy Classful Transport Planes
...
Implementations **MAY** provide automatic generation and
        assignment of RD, RT values. They **MAY** also provide a
...
## Originating BGP CT Routes

BGP CT routes are sent only to BGP peers that have negotiated the
        Multiprotocol Extensions capability described in [RFC4760](#RFC4760) to be able to send
        and receive BGP CT routes.
...
The egress node of the tunnel, i.e., the tunnel endpoint (EP),
        ...
        ingress node to BGP peers in neighboring domains.
...
This originated route **SHOULD NOT** be advertised to
...
A unique RD **SHOULD** be used by the originator of a
        ...
        diversity and troubleshooting, as described in [Section 10.2](#rd-lbl-usage).

<a name="CTingress"></a>
## Processing BGP CT Routes by Ingress Nodes
...
The routes in the TRDBs associated with a selected Resolution
...
If the resolution process does not find a matching route for the EP
          ...
          considered unresolvable. (See [RFC4271](#RFC4271).)
...
The received BGP CT route **MUST** be added to the TRDB corresponding
          ...
          hence, it only uses the EP as the lookup key (without RD or TC ID).

If no Mapping Community is found on a BGP CT route, the Best-Effort Resolution Scheme is used to resolve the route's next hop,
          and the BGP CT route is not added to any TRDB.

## Readvertising BGP CT Route by Border Nodes
...
The label **SHOULD** be allocated with "per-prefix" label-allocation
          ...
          end-to-end convergence should be considered.
...
The value of the advertised MPLS label is locally significant
          ...
          the ones described related to BGP Prefix-SID as described in BGP (see [RFC8669](#RFC8669)).

## Border Nodes Receiving BGP CT Routes on EBGP
...
If the inter-AS links need to honor Transport Class, then the BN
          **MUST** follow the procedures of an ingress node ([Section 7.3](#CTingress)) and perform the next hop resolution process.
...
When multiple instances of a given RD:EP exist with different
          forwarding characteristics, BGP ADD-PATH (see [RFC7911](#RFC7911)) is helpful.

When multiple BNs exist such that they advertise an "RD:EP" prefix
          to Route Reflectors (RRs), the RRs may hide all but one of the BNs,
          unless BGP ADD-PATH (see [RFC7911](#RFC7911)) is used for the
          BGP CT family. This is similar to L3VPN inter-AS option B
          scenarios.

Hence, BGP ADD-PATH (see [RFC7911](#RFC7911)) **SHOULD** be used
...
## Avoiding Loops Between Route Reflectors in Forwarding Paths

A pair of redundant ABRs, each acting as an RR with the next hop
...
Using one or more of the approaches described in [BGP-FWD-RR](#I-D.ietf-idr-bgp-fwd-rr) lowers the possibility of such loops in a
          network with redundant ABRs.

## Ingress Nodes Receiving Service Routes with a Mapping Community
...
Note: For an illustration of above procedures in an MPLS network,
        refer to [Section 8](#CTProc).

## Best-Effort Transport Class
...
Alternatively, BGP CT may also be used to carry the best-effort
          ...
          **SHOULD** provide configuration to use a different value for this
          ...
          namespaces between domains are provided in [Section 11.2.2](#non-agreeing).
...
The "Best-Effort Transport Class ID" value is used in the
          ...
          best-effort tunnel endpoint. Thus, the RT formed is called the "Best-Effort Transport Class RT".
...
<a name="bgp-att"></a>
## Interaction with BGP Attributes Specifying Next Hop Address and Color

The Tunnel Encapsulation Attribute, described in [RFC9012](#RFC9012), can be used to request a specific type of tunnel
        encapsulation. This attribute may apply to BGP service routes or
        transport routes including BGP CT family routes.

It should be noted that in such cases "Transport Class ID/Color"
        ...
        order of precedence with more-specific scoping of Color preferred to less-specific scoping:
...
## Applicability to Flowspec Redirect-to-IP

Flowspec routes using redirect-to-IP next hop are described in [FLOWSPEC-REDIR-IP](#I-D.ietf-idr-flowspec-redirect-ip).
...
The Flowspec BGP family acts as just another service that can make use
        of the BGP CT architecture to achieve flow-based forwarding with SLAs.

<a name="IPv6-Applicability"></a>
## Applicability to IPv6

BGP CT procedures apply equally to IPv4- and IPv6-enabled intra-AS
        or inter-AS option A, B, and C networks. This section describes
        the applicability of BGP CT to IPv6 at various layers.
...
A network that is BGP CT enabled supports IPv6 service families (for
        ...
        like SRTEv6, LDPv6, or RSVP-TEv6.
...
Procedures in this document also apply to a 6PE network with an
...
Details of SRv6 Endpoint behaviors used by BGP CT and the
        procedures are specified and illustrated in a separate document (see [BGP-CT-SRv6](#I-D.ietf-idr-bgp-ct-srv6)). As noted in that
        document, a BGP CT route update for SRv6 includes a BGP attribute
        containing SRv6 SID information (e.g., a BGP Prefix-SID [RFC9252](#RFC9252)) with the
        Transposition Scheme disabled.

<a name="error-handling"></a>
## Error-Handling Considerations

If a BGP speaker receives both transitive and non-transitive (see [Section 13.2.1.1.1](#tc-rt-t) and [Section 13.2.1.1.2](#tc-rt-nt), respectively) versions of a Transport Class
...
If a BGP speaker considers a received "Transport Class" extended
        ...
        parse the NLRI and attributes, the treat-as-withdraw approach from [RFC7606](#RFC7606) is used. The route is kept as Unusable, with
        appropriate diagnostic information, to aid troubleshooting.

<a name="CTProc"></a>
# Illustration of BGP CT Procedures

This section illustrates BGP CT procedures in an inter-AS option C
      MPLS network.

All illustrations in this document make use of IP address ranges as described in [RFC6890](#RFC6890). The range 192.0.2.0/24 is used to
...
Though this section illustrates the use of IPv4, as described in [Section 7.12](#IPv6-Applicability), these procedures work equally for IPv6
      as well.
...
- AS1 uses ISIS Flex-Algo (see[RFC9350](#RFC9350)) intra-domain tunnels.
- AS2 uses RSVP-TE intra-domain
          tunnels.

MPLS forwarding is used within these domains and on
        inter-domain links.
...
These tunnels are either provisioned or autodiscovered to belong
        to Transport Class IDs 100 or 200.

## Service Layer Route Exchange

Service nodes PE11 and PE12 negotiate service families (AFI/SAFIs: 1/1 and
...
The PEs see each other as the next hop in the BGP UPDATE message for the
...
Consider CE31 getting VPN service from PE11. The
...
For Gold tunnels, PE11 is provisioned with Transport Class having TC ID 100, RD value
...
The RD value originated by an egress node is not modified by any
...
ASBR13 and ASBR14 negotiate BGP CT family with transport ASBRs
        ...
        BGP CT carries Gold and Bronze Transport Class routes.
...
PE11 is provisioned to originate a BGP CT route for endpoint PE11,
        ...
        either be Implicit NULL (Label 3) or a UHP label.
...
In the Bronze plane, the BGP CT route with a Bronze SLA to endpoint PE11
        ...
        process being described for the Gold SLA path.
...
Similarly, ASBR22 receives BGP CT route 192.0.2.11:100:192.0.2.11
        ...
        to ABR23 and ABR24 with the label and next hop unchanged.
...
BGP ADD-PATH is enabled for the BGP CT family on the sessions between
        ...
        available next hops for the Gold SLA.
...
ABR23 receives the route with next hop 192.0.2.21 and label B-L3 from
        ...
        from the Gold SLA tunneled path.
...
In this manner, the Gold transport LSP "ASBR13_to_PE11_gold" in the
        ...
        next hop set to itself towards PE25.
...
When PE25 receives service routes from RR26 with next hop
...
This section describes how the data plane looks in steady
          state.
...
ABR23 decapsulates the packet received on PE25_to_ABR23_gold
...
### Local Repair of Primary Path

This section describes how the data plane at ASBR22 reacts when
          the link between ASBR22 and ASBR13 experiences a failure and an
          alternate path exists.

Assuming the ASBR22_to_ASBR13 link goes down, traffic with
...
### Absorbing Failure of the Primary Path: Fallback to Best-Effort Tunnels

This section describes how the data plane reacts when a Gold path
          experiences a failure but no alternate path exists.

Assume tunnel ABR23_to_ASBR22_gold goes down, such that now no
...
The withdrawal for 192.0.2.11:100:192.0.2.11 allows PE25 to react
...
Traffic repair to absorb the failure happens at ingress node
          PE25 in a service prefix scale independent manner (PIC). The repair time will be proportional to time taken for withdrawing 
          the BGP CT route.

These examples demonstrate the various levels of fail-safe
          mechanisms available to protect traffic in a BGP CT network.

# Scaling Considerations

<a name="secure-propagate"></a>
## Avoiding Unintended Spread of BGP CT Routes Across Domains
...
## Constrained Distribution of PNHs to SNs (On-Demand Next Hop)
...
This section describes how the number of Protocol Next Hops (PNHs)
          ...
          Transport and RTC (see [RFC4684](#RFC4684).
...
Note that such use of the IP-address-specific route target
          ...
          PE that imports its Transport Class.
...
The transport-target:0:<TC> is the new type of route target
          ...
          extended community attribute (attribute code 16).

The RT carrying <eSN>:<TC> **MAY** be an IP-address-specific regular RT (attribute code 16), or IPv6-address
          ...
          along with a 4-octet Local Administrator field.
...
When RTC is in use, as described here, BGP CT routes will be
          ...
          the network, closer to the egress SN.
...
However, the amount of state carried in RTC family may become
          ...
          region of an ingress SN, or the BNs of a super core.
...
MPLS Operations, Administration, and Maintenance (OAM) procedures specified in [RFC8029](#RFC8029) also
        apply to BGP CT.

The Target FEC Stack sub-TLV for IPv4 BGP CT has a
        ...
        encoded as shown in [Figure 4](#FECv4).
...
```
The Target FEC Stack sub-TLV for IPv6 BGP CT has a
        ...
        encoded as shown in [Figure 5](#FECv6).
...
```
These prefix layouts are inherited from Sections [RFC8029](#RFC8029) and [RFC8029](#RFC8029) of [RFC8029](#RFC8029).

<a name="rd-lbl-usage"></a>
## Usage of RD and Label-Allocation Modes
...
For example, unique "RDx:EP1" prefixes can be advertised by an SN
...
A label is allocated for a BGP CT route when it is advertised with
        ...
        CT offers two flavors for per-prefix label allocation:

- The first
          flavor assigns a label for each unique "RD, EP".
- The second flavor
...
In a BGP CT network, the number of routes at an ingress PE is a
        ...
        are detailed with an example in [Section 10.3](#CTRouteVis).

<a name="CTRouteVis"></a>
## Managing Transport-Route Visibility
...
Consider a multi-domain BGP CT network as illustrated in the
        following [Figure 6](#MultiDomainNetwork):
...
In [Figure 7](#RDLabelVis), route scale at
        ...
        diversity in the ingress domain.
...
[Figure 7](#RDLabelVis) demonstrates that
...
## Coordination Between Domains Using Different Community Namespaces

Cooperating inter-AS option C domains may sometimes not agree on
...
The Transport Class RT is useful to
        avoid collision with regular Route Target namespace used by service
        routes.

## Managing Intent at Service and Transport Layers
...
### Service Layer Color Management
...
As explained in [Section 5](#Nexthop_Resoln_Schm), a Mapping Community carried on a service
...
In this manner, it is recommended to keep color namespace
          ...
          on a single global namespace.

<a name="non-agreeing"></a>
### Non-Agreeing Color Transport Domains
...
The following example illustrates how traffic is stitched and SLA
...
In the topology shown in [Figure 8](#BGPCT_NON_AGREEING_COLOR_DOMAIN), we have three Autonomous
...
The service route carries an abstract Mapping Community that maps
...
At the AS boundary, the Transport Class RT is rewritten
...
Transport Class RT rewrite requires coordination of color values
          ...
          problem to a pair of adjacent color domains and solving it.

### Heterogeneous Agreeing Color Transport Domains

In a heterogeneous-domain scenario, it might not be possible to
          map a service layer Intent to the matching transport color, as the
          color might not be locally available in a domain.
...
In [Figure 9](#BGPCT_HETERO_COLOR_DOMAIN), we have three Autonomous
          Systems. All the nodes in the topology support BGP CT.
...
This problem can be solved by the two approaches described in Sections [11.2.3.1](#dup_tun_ap) and [11.2.3.2](#cust_res_scheme).

<a name="dup_tun_ap"></a>
#### Duplicate Tunnels Approach
...
These tunnels will be installed in TRDBs corresponding to
            transport classes of colors 101 and 102.

Overlay routes received with a Mapping Community (e.g.,
...
<a name="cust_res_scheme"></a>
#### Customized Resolution Schemes Approach
...
In this approach, Resolution Schemes in domains AS1 and AS3 are
            ...
            the transport or forwarding planes.

Service routes advertised by PE31 that need to resolve over
            ...
            available, and it maps to color 101 TRDB.

Similarly, service routes advertised by PE31 that need to
            ...
            AS2, Gold2 is available, and it maps to color 102 TRDB.

To facilitate this, SNs/BNs in all three ASes provision the
...
PE31 is provisioned to originate BGP CT routes with color 101
...
At ASBR22, the BGP CT routes received with
            ...
            is readvertised to ASBR21 with transport-target:0:101.

Similarly, at ASBR21, the BGP CT routes received with
            transport-target:0:101 will be added to color 101 TRDB and
            strictly resolve over tunnel routes in the same TRDB. This route
            is readvertised to ASBR11 with transport-target:0:101.
...
In doing so, PE11 can forward traffic via tunnels with color
            101, color 102 in the core domain and color 100 in the metro
            domains.

## Migration Scenarios

### BGP CT Islands Connected via BGP LU Domain
...
In the preceding topology shown in [Figure 10](#BGPCTIsles),
          there are three AS domains: AS1 and AS3 support BGP CT, while AS2
          does not support BGP CT.

Nodes in AS1, AS2, and AS3 negotiate BGP LU family on IBGP
          ...
          formed using BGP LU reachability.
...
ASBR21 readvertises the BGP LU route for endpoint
...
ASBR31 adds the ASBR11_lpbk_gold route received via EBGP LU from
          ...
          and AS3 follows the procedures as explained in [Section 8](#CTProc).
...
In cases where an SLA cannot be preserved in AS2 because SLA-specific
          ...
          eases migration in case of a heterogeneous color domain as well.

### BGP CT: Interoperability Between MPLS and Other Forwarding Technologies

This section describes how nodes supporting dissimilar
          encapsulation technologies can interoperate when
          using the BGP CT family.

#### Interoperation Between MPLS and SRv6 Nodes

BGP speakers may carry MPLS labels and SRv6 SIDs in BGP CT SAFI
            76 for AFI 1 or 2 routes using protocol encoding as described in
            [Section 6.3](#CTMultiEncap).

MPLS labels are carried using the encoding described in [RFC8277](#RFC8277), and SRv6 SIDs
            are carried using the Prefix-SID attribute as specified in [Section 7.13](#SRv6-Support).

**Figure 11: BGP CT Interoperation Between MPLS and SRv6 Nodes**

This example shows a provider network with a mix of devices
            ...
            is negotiated on these sessions.

R1 and R2 send and receive both MPLS labels and SRv6 SIDs in the
            ...
            using the encoding described in [RFC8277](#RFC8277), and an SRv6 SID is carried using the Prefix-SID
            attribute as specified in [Section 7.13](#SRv6-Support) without the 
            Transposition Scheme. In this way, either MPLS or SRv6 forwarding
            can be used between R1 and R2.

R1 and R3 send and receive an MPLS label in the BGP CT control
            plane routes using the encoding described in [RFC8277](#RFC8277). This allows them to be
            ...
            interoperate with MPLS-only device R3, R1 **MUST NOT** use the SRv6
            Transposition Scheme described in [RFC9252](#RFC9252). The
            encoding suggested in [Section 7.13](#SRv6-Support) is used by R1.
            MPLS forwarding will be used between R1 and R3.
...
R1 and R4 send and receive SRv6 SIDs in the BGP CT control plane
            ...
            (Implicit NULL) in the encoding described in [RFC8277](#RFC8277), which tells R1 not to push
            any MPLS label for this BGP CT route towards R4. The MPLS label
            advertised by R1 in an NLRI as described in [RFC8277](#RFC8277) will not be used by R4. SRv6
...
#### Interop Between Nodes Supporting MPLS and UDP Tunneling
...
This section describes how nodes supporting MPLS forwarding can
            ...
            when using BGP CT family.

MPLS labels are carried using the encoding described in [RFC8277](#RFC8277), and UDP (or
            IP) tunneling information is carried using the TEA attribute or the
            Encapsulation extended community as specified in [RFC9012](#RFC9012).
...
R1 and R2 send and receive both MPLS labels and UDP tunneling
            ...
            The MPLS label is carried using the encoding described in [RFC8277](#RFC8277). As specified in
            [RFC9012](#RFC9012), UDP tunneling information is carried
...
R1 and R3 send and receive MPLS labels in the BGP CT control
            plane routes using the encoding described in [RFC8277](#RFC8277). This allows them to be
            ingress and egress for MPLS data plane. R1 will carry UDP
            tunneling info in the TEA, which will not be used by R3.
            MPLS forwarding will be used between R1 and R3.

R1 and R4 send and receive UDP tunneling info in the BGP CT
            ...
            MPLS special label 3 (Implicit NULL) in the encoding described in [RFC8277](#RFC8277),
...
Note that, in this example, R3 and R4 cannot communicate
...
Operators should coordinate the MTU of the intra-domain tunnels
...
[INTAREA-TUNNELS](#I-D.ietf-intarea-tunnels) discusses these
...
It may be desirable to allow a CE device to indicate in the data
        ...
        is forwarded within the provider network.

Such an indication can be in the form of a DSCP (see [RFC2474](#RFC2474)) in the IP header.
...
Let PE1 be configured to map DSCP1 to the Gold TC and
        ...
        known as Class-Based Forwarding (CBF).
...
The Transport Class construct described in this document can be used
      to realize the "IETF Network Slice" described in [RFC9543](#RFC9543).
...
This will be used to create new AFI/SAFI pairs for IPv4 and IPv6
        BGP CT families, namely:

- IPv4 BGP CT: AFI/SAFI = 1/76, for carrying IPv4 prefixes.
- IPv6 BGP CT: AFI/SAFI = 2/76, for carrying IPv6 prefixes.

## New Format for BGP Extended Community

IANA has assigned a Format type (Type high = 0xa) of Extended
        Community [RFC4360](#RFC4360) for the Transport Class
        from the following registries in the "Border Gateway Protocol (BGP) Extended Communities" registry group:

- the "BGP Transitive Extended Community Types" registry and
- the "BGP Non-Transitive Extended Community Types" registry.

The same low-order six bits have been assigned for both
        allocations.
...
Following [RFC7153](#RFC7153),
        assignments in the following subsections have been made.

### Existing Registries

#### Registries for the "Type" Field

<a name="tc-rt-t"></a>
##### Transitive Types

This registry contains values of the high-order octet (the
...
This registry contains values of the high-order octet (the
              "Type" field) of a Non-Transitive Extended Community.
...
**Registry Name:**
  ...
  (Sub-Types are defined in the "Non-Transitive Transport
  		Class Extended Community Sub-Types" registry.)
...
IANA has added the following subregistry under the
...
## MPLS OAM Code Points

The following two code points have been assigned for Target FEC
        Stack sub-TLVs:
...
As noted in Sections [4](#tc) and [7.10](#bgp-att), 'Transport Class ID' is
        ...
        in [RFC9012](#RFC9012) and [RFC9256](#RFC9256), the range 1-4294967295 uses
        'Private Use' as the Registration Procedure.

<a name="Security"></a>
# Security Considerations

This document uses the mechanisms from [RFC4760](#RFC4760) to define new
...
Furthermore, procedures defined in [Section 9.1](#secure-propagate) mitigate 
...
This document does not change the underlying security issues inherent
      in the existing BGP protocol, such as those described in [RFC4271](#RFC4271) and [RFC4272](#RFC4272).

Additionally, BGP sessions **SHOULD** be protected using the TCP
      Authentication Option [RFC5925](#RFC5925) and the Generalized TTL
      Security Mechanism [RFC5082](#RFC5082).
...
BGP CT routes distribute label binding using [RFC8277](#RFC8277)
      for the MPLS data plane; hence, its security considerations apply.

BGP CT routes distribute SRv6 SIDs for SRv6 data planes; hence,
      the security considerations of [RFC9252](#RFC9252)
      apply. Moreover, the SRv6 SID Transposition Scheme is disabled in BGP CT, as
      described in [Section 7.13](#SRv6-Support), to mitigate the risk of
      misinterpreting transposed SRv6 SID information as an MPLS label.

As [RFC4272](#RFC4272) discusses, BGP is vulnerable to
...
In order to mitigate the risk of the diversion of traffic from its
      intended destination, BGPsec solutions ([RFC8205](#RFC8205) and
      Origin Validation [RFC8210](#RFC8210)[RFC6811](#RFC6811)) may
...
The restriction of the applicability of the BGP CT SAFI 76 to its
      intended well-defined scope and utilizing [RFC8212](#RFC8212) limits
...
<a name="RFC2474"></a> **[RFC2474]** K. Nichols, S. Blake, F. Baker, D. Black, "Definition of the Differentiated Services Field (DS Field) in the IPv4 and IPv6 Headers", RFC 2474, DOI 10.17487/RFC2474, December 1998. <https://www.rfc-editor.org/info/rfc2474> [Local MD](rfc2474.md)

<a name="RFC2545"></a> **[RFC2545]** P. Marques, F. Dupont, "Use of BGP-4 Multiprotocol Extensions for IPv6 Inter-Domain Routing", RFC 2545, DOI 10.17487/RFC2545, March 1999. <https://www.rfc-editor.org/info/rfc2545> [Local MD](rfc2545.md)

<a name="RFC4271"></a> **[RFC4271]** Y. Rekhter, T. Li, S. Hares, "A Border Gateway Protocol 4 (BGP-4)", RFC 4271, DOI 10.17487/RFC4271, January 2006. <https://www.rfc-editor.org/info/rfc4271> [Local MD](rfc4271.md)

<a name="RFC4272"></a> **[RFC4272]** S. Murphy, "BGP Security Vulnerabilities Analysis", RFC 4272, DOI 10.17487/RFC4272, January 2006. <https://www.rfc-editor.org/info/rfc4272> [Local MD](rfc4272.md)

<a name="RFC4360"></a> **[RFC4360]** S. Sangli, D. Tappan, Y. Rekhter, "BGP Extended Communities Attribute", RFC 4360, DOI 10.17487/RFC4360, February 2006. <https://www.rfc-editor.org/info/rfc4360> [Local MD](rfc4360.md)
...
<a name="RFC4659"></a> **[RFC4659]** J. De Clercq, D. Ooms, M. Carugi, F. Le Faucheur, "BGP-MPLS IP Virtual Private Network (VPN) Extension for IPv6 VPN", RFC 4659, DOI 10.17487/RFC4659, September 2006. <https://www.rfc-editor.org/info/rfc4659> [Local MD](rfc4659.md)

<a name="RFC4684"></a> **[RFC4684]** P. Marques, R. Bonica, L. Fang, L. Martini, R. Raszuk, K. Patel, J. Guichard, "Constrained Route Distribution for Border Gateway Protocol/MultiProtocol Label Switching (BGP/MPLS) Internet Protocol (IP) Virtual Private Networks (VPNs)", RFC 4684, DOI 10.17487/RFC4684, November 2006. <https://www.rfc-editor.org/info/rfc4684> [Local MD](rfc4684.md)
...
<a name="RFC5082"></a> **[RFC5082]** V. Gill, J. Heasley, D. Meyer, P. Savola, C. Pignataro, "The Generalized TTL Security Mechanism (GTSM)", RFC 5082, DOI 10.17487/RFC5082, October 2007. <https://www.rfc-editor.org/info/rfc5082> [Local MD](rfc5082.md)
...
<a name="RFC6811"></a> **[RFC6811]** P. Mohapatra, J. Scudder, D. Ward, R. Bush, R. Austein, "BGP Prefix Origin Validation", RFC 6811, DOI 10.17487/RFC6811, January 2013. <https://www.rfc-editor.org/info/rfc6811> [Local MD](rfc6811.md)

<a name="RFC7153"></a> **[RFC7153]** E. Rosen, Y. Rekhter, "IANA Registries for BGP Extended Communities", RFC 7153, DOI 10.17487/RFC7153, March 2014. <https://www.rfc-editor.org/info/rfc7153> [Local MD](rfc7153.md)

<a name="RFC7606"></a> **[RFC7606]** E. Chen, J. Scudder, P. Mohapatra, K. Patel, "Revised Error Handling for BGP UPDATE Messages", RFC 7606, DOI 10.17487/RFC7606, August 2015. <https://www.rfc-editor.org/info/rfc7606> [Local MD](rfc7606.md)
...
<a name="RFC8212"></a> **[RFC8212]** J. Mauch, J. Snijders, G. Hankins, "Default External BGP (EBGP) Route Propagation Behavior without Policies", RFC 8212, DOI 10.17487/RFC8212, July 2017. <https://www.rfc-editor.org/info/rfc8212> [Local MD](rfc8212.md)
...
<a name="RFC8669"></a> **[RFC8669]** S. Previdi, C. Filsfils, A. Lindem, A. Sreekantiah, H. Gredler, "Segment Routing Prefix Segment Identifier Extensions for BGP", RFC 8669, DOI 10.17487/RFC8669, December 2019. <https://www.rfc-editor.org/info/rfc8669> [Local MD](rfc8669.md)

<a name="RFC9012"></a> **[RFC9012]** K. Patel, G. Van de Velde, S. Sangli, J. Scudder, "The BGP Tunnel Encapsulation Attribute", RFC 9012, DOI 10.17487/RFC9012, April 2021. <https://www.rfc-editor.org/info/rfc9012> [Local MD](rfc9012.md)

<a name="RFC9252"></a> **[RFC9252]** G. Dawra, K. Talaulikar, R. Raszuk, B. Decraene, S. Zhuang, J. Rabadan, "BGP Overlay Services Based on Segment Routing over IPv6 (SRv6)", RFC 9252, DOI 10.17487/RFC9252, July 2022. <https://www.rfc-editor.org/info/rfc9252> [Local MD](rfc9252.md)
...
<a name="I-D.ietf-idr-bgp-ct-srv6"></a> **[BGP-CT-SRv6]** K. Vairavakkalai, N. Venkataraman, "BGP CT - Adaptation to SRv6 dataplane", Internet-Draft draft-ietf-idr-bgp-ct-srv6-07, August 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-idr-bgp-ct-srv6-07>

<a name="I-D.ietf-idr-bgp-fwd-rr"></a> **[BGP-FWD-RR]** K. Vairavakkalai, N. Venkataraman, "BGP Route Reflector with Next Hop Self", Internet-Draft draft-ietf-idr-bgp-fwd-rr-04, August 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-idr-bgp-fwd-rr-04>

<a name="I-D.gredler-idr-bgplu-epe"></a> **[BGP-LU-EPE]** H. Gredler, K. Vairavakkalai, C. R, B. Rajagopalan, E. Aries, L. Fang, "Egress Peer Engineering using BGP-LU", Internet-Draft draft-gredler-idr-bgplu-epe-16, October 2024. Work in Progress <https://datatracker.ietf.org/doc/html/draft-gredler-idr-bgplu-epe-16>

<a name="I-D.ietf-idr-flowspec-redirect-ip"></a> **[FLOWSPEC-REDIR-IP]** J. Haas, W. Henderickx, A. Simpson, "BGP Flow-Spec Redirect-to-IP Action", Internet-Draft draft-ietf-idr-flowspec-redirect-ip-04, September 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-idr-flowspec-redirect-ip-04>

<a name="I-D.ietf-intarea-tunnels"></a> **[INTAREA-TUNNELS]** J. D. Touch, M. Townsley, "IP Tunnels in the Internet Architecture", Internet-Draft draft-ietf-intarea-tunnels-15, May 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-intarea-tunnels-15>

<a name="I-D.hr-spring-intentaware-routing-using-color"></a> **[Intent-Routing-Color]** S. Hegde, D. Rao, J. Uttaro, A. Bogdanov, L. Jalil, "Problem statement for Inter-domain Intent-aware Routing using Color", Internet-Draft draft-hr-spring-intentaware-routing-using-color-04, January 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-hr-spring-intentaware-routing-using-color-04>

<a name="I-D.ietf-idr-multinexthop-attribute"></a> **[MNH]** K. Vairavakkalai, J. M. Jeganathan, M. Nanduri, A. R. Lingala, "BGP MultiNexthop Attribute", Internet-Draft draft-ietf-idr-multinexthop-attribute-04, March 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-idr-multinexthop-attribute-04>

<a name="I-D.kaliraj-bess-bgp-mpls-namespaces"></a> **[MPLS-NS]** K. Vairavakkalai, J. M. Jeganathan, P. Ramadenu, I. Means, "BGP Signaled MPLS Namespaces", Internet-Draft draft-kaliraj-bess-bgp-mpls-namespaces-01, Aug 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-kaliraj-bess-bgp-mpls-namespaces-01>

<a name="PACKING-TEST"></a> **[PACKING-TEST]** "update-packing-test-results.txt", 06 2023. 1a75d4d <https://github.com/ietf-wg-idr/draft-ietf-idr-bgp-ct/blob/main/update-packing-test-results.txt>

<a name="I-D.ietf-pce-pcep-color"></a> **[PCEP-RSVP-COLOR]** B. Rajagopalan, V. P. Beeram, S. Peng, M. Koldychev, G. S. Mishra, "Path Computation Element Protocol (PCEP) Extension for Color", Internet-Draft draft-ietf-pce-pcep-color-12, February 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-pce-pcep-color-12>

<a name="I-D.ietf-pce-segment-routing-policy-cp"></a> **[PCEP-SRPOLICY]** M. Koldychev, S. Sivabalan, S. Sidor, C. Barth, S. Peng, H. Bidgoli, "Path Computation Element Communication Protocol (PCEP) Extensions for Segment Routing (SR) Policy Candidate Paths", Internet-Draft draft-ietf-pce-segment-routing-policy-cp-27, April 2025. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-pce-segment-routing-policy-cp-27>

<a name="RFC6890"></a> **[RFC6890]** M. Cotton, L. Vegoda, R. Bonica, B. Haberman, "Special-Purpose IP Address Registries", BCP 153, RFC 6890, DOI 10.17487/RFC6890, April 2013. <https://www.rfc-editor.org/info/rfc6890> [Local MD](rfc6890.md)

<a name="RFC8205"></a> **[RFC8205]** M. Lepinski, K. Sriram, "BGPsec Protocol Specification", RFC 8205, DOI 10.17487/RFC8205, September 2017. <https://www.rfc-editor.org/info/rfc8205> [Local MD](rfc8205.md)

<a name="RFC8210"></a> **[RFC8210]** R. Bush, R. Austein, "The Resource Public Key Infrastructure (RPKI) to Router Protocol, Version 1", RFC 8210, DOI 10.17487/RFC8210, September 2017. <https://www.rfc-editor.org/info/rfc8210> [Local MD](rfc8210.md)
...
<a name="RFC9315"></a> **[RFC9315]** A. Clemm, L. Ciavaglia, L. Z. Granville, J. Tantsura, "Intent-Based Networking - Concepts and Definitions", RFC 9315, DOI 10.17487/RFC9315, October 2022. <https://www.rfc-editor.org/info/rfc9315> [Local MD](rfc9315.md)

<a name="RFC9350"></a> **[RFC9350]** P. Psenak, S. Hegde, C. Filsfils, K. Talaulikar, A. Gulko, "IGP Flexible Algorithm", RFC 9350, DOI 10.17487/RFC9350, February 2023. <https://www.rfc-editor.org/info/rfc9350> [Local MD](rfc9350.md)

<a name="RFC9543"></a> **[RFC9543]** A. Farrel, J. Drake, R. Rokui, S. Homma, K. Makhijani, L. Contreras, J. Tantsura, "A Framework for Network Slices in Networks Built from IETF Technologies", RFC 9543, DOI 10.17487/RFC9543, March 2024. <https://www.rfc-editor.org/info/rfc9543> [Local MD](rfc9543.md)

<a name="Appendix_A"></a>
# Extensibility Considerations

## Signaling Intent over a PE-CE Attachment Circuit

It may be desirable to allow a CE device to indicate in the data
        packet it sends what treatment it desires (the Intent) when the packet
        is forwarded within the provider network.

[MNH](#I-D.ietf-idr-multinexthop-attribute) describes some mechanisms that enable such
        signaling.

## BGP CT Egress TE

Mechanisms described in [BGP-LU-EPE](#I-D.gredler-idr-bgplu-epe) also apply to the
        BGP CT family.
...
<a name="Appendix_B"></a>
# Applicability to Intra-AS and Different Inter-AS Deployments

As described in [RFC4364](#RFC4364), in an option C network, service routes (VPN-IPv4) are
      neither maintained nor distributed by the ASBRs. Transport routes are
      maintained in the ASBRs and propagated in BGP LU or BGP CT.
...
[Section 8](#CTProc)
      ...
      Resolution Scheme are used in an inter-AS option C deployment.

In intra-AS and inter-AS option A and option B scenarios, AFI/SAFI 1/76
...
[Figure 14](#BGPCT_INTRA_AS) shows a provider
...
AS1 uses RSVP-TE intra-domain tunnels between PE11 and PE12. And it uses
          LDP tunnels for best-effort traffic.

The network has two TCs: Gold with TC ID 100 and Bronze
          with TC ID 200. These TCs
          are provisioned at the PEs. This creates the Resolution Schemes for
          these TCs at these PEs.
...
CE31 advertises a route, for example, prefix 203.0.113.31 with the next
...
Consider CE31 getting VPN service from PE12. The
...
## Inter-AS Option A Use Case

### Topology

**Figure 15: BGP CT Inter-AS option A**

This example in [Figure 15](#BGPCT_INTERAS_A) shows two
...
Traffic direction being described is CE31 to CE41. CE41 may
          request a specific SLA (e.g., Gold for this traffic), when traversing
          these provider core networks.

### Transport Layer

AS1 uses RSVP-TE intra-domain tunnels between PE11 and ASBR11.
...
The networks have two TCs: Gold with TC ID 100,
...
These tunnels are provisioned to belong to TC 100 or
          200.

### Service Layer Route Exchange

Service nodes PE11, ASBR11 negotiate service family (AFI/SAFI
          1/128) on the BGP session with RR11. Service helper RR11 reflects
...
Consider, CE41 is getting VPN service from PE21. The
          ...
          ASBR21_to_PE21_gold SRTE LSP.

The IP FIB at ASBR21 VRF will have a route for 203.0.113.41 with
...
This route is readvertised with the next hop set to itself by ASBR21 to ASBR11
...
## Inter-AS Option B Use Case

### Topology

**Figure 16: BGP CT Inter-AS option B**

[Figure 16](#BGPCT_INTERAS_B) shows two
...
AS1 uses RSVP-TE intra-domain tunnels between PE11 and ASBR21
          and LDP tunnels for best-effort traffic. AS2 uses SRTE intra-domain
...
ASBR21 and ASBR12 negotiate AFI/SAFI 1/128 between them and
          ...
          The single-hop EBGP session endpoints are interface addresses.

CE41 advertises a route, for example, prefix 203.0.113.41 with the next
          ...
          PE22 can attach the same using locally configured policies.

Consider CE41 getting VPN service from PE22. The
...
<a name="Appendix_C"></a>
# Why reuse RFCs 8277 and 4364?

[RFC4364](#RFC4364) is one of the key design patterns produced by the networking
      ...
      virtualization, and Flowspec VPN.

It is to be noted that these services have different NLRI encodings.
      The L3VPN service family that binds the MPLS label to an IP prefix uses the encoding described in  [RFC8277](#RFC8277)
      and others define different NLRI encodings.

BGP CT reuses the procedures described in [RFC4364](#RFC4364) to slice a transport network into
      multiple transport planes that different service routes can bind to
      using color.

BGP CT reuses [RFC8277](#RFC8277) because it precisely fits the purpose.  That is, in
      ...
      RD:IP_Prefix and carrying a Label for it as specified in [RFC8277](#RFC8277) works
      well for this purpose.

Another advantage of using the precise encoding as defined in [RFC4364](#RFC4364) and [RFC8277](#RFC8277) is that it allows 
      ...
      network support BGP CT.

In the future, if [RFC8277](#RFC8277) evolves into a typed NLRI that does not carry
      ...
      technologies ([RFC4364](#RFC4364) and [RFC8277](#RFC8277)) and will adapt to any changes mechanisms from [RFC8277](#RFC8277)
      undergo in future.

This approach leverages the benefits of time-tested design patterns
      proposed in [RFC4364](#RFC4364) and [RFC8277](#RFC8277). Moreover, this approach greatly
      ...
      new NLRI and procedures.

BGP CT design also avoids overloading the NLRI MPLS label field from [RFC8277](#RFC8277)
      with information related to the non-MPLS data plane because it leads to
      backward-compatibility issues.

## Update Packing Considerations
...
BGP CT carries Transport Class as an attribute. This means routes
        ...
        BGP UPDATE message. Update packing in BGP CT will be similar to family routes from [RFC8277](#RFC8277)
...
[Intent-Routing-Color](#I-D.hr-spring-intentaware-routing-using-color) suggests
        ...
        with BGP CT IPv6 endpoints and SRv6 SID are planned.
...
Tests were conducted with a 1.9 million BGP CT route scale (387K
        ...
        are available in [PACKING-TEST](#PACKING-TEST).
...
Furthermore, even in today's BGP LU deployments, each egress node
        ...
        help with update packing in transport family routes.

<a name="Appendix_D"></a>
# Scaling Using BGP MPLS Namespaces

This document considers the scaling scenario suggested in [Intent-Routing-Color](#I-D.hr-spring-intentaware-routing-using-color) where 300K nodes exist in the
      network with 5 TCs.
...
[MPLS-NS](#I-D.kaliraj-bess-bgp-mpls-namespaces) describes how MPLS Namespaces
...
The authors thank Jeff Haas, John Scudder, Susan Hares, Dongjie (Jimmy), Moses Nagarajah,
      Jeffrey (Zhaohui) Zhang, Joel       Halpern, Jingrong Xie, Mohamed Boucadair, Greg Skinner,
      Simon Leinen, Navaneetha       Krishnan, Ravi M R, Chandrasekar Ramachandran, Shradha       Hegde, Colby Barth, Vishnu       Pavan Beeram, Sunil Malali, William J Britto, R Shilpa, Ashish Kumar (FE), Sunil Kumar Rawat,
      Abhishek Chakraborty, Richard       Roberts, Krzysztof Szarkowicz, John E Drake, Srihari Sangli,
      Jim Uttaro, Luay Jalil,
      Keyur Patel, Ketan       Talaulikar, Dhananjaya Rao, Swadesh Agarwal, Robert Raszuk,
      Ahmed Darwish, Aravind Srinivas       Srinivasa Prabhakar, Moshiko Nayman, Chris Tripp, Gyan Mishra, Vijay Kestur, and Santosh Kolenchery
...
The decision to not reuse SAFI 128 and create a new address family to
      carry these transport routes was based on suggestion made by Richard Roberts and Krzysztof       Szarkowicz.

Thanks to John Scudder for showing us with
      example how the Figures can be enhanced using SVG format.
...
- Organization: AT&T
- Address: 2212 Avenida Mara, Chula Vista, California, 91914, United States of America
- Email: israel.means@att.com

**Csaba Mate**

- Organization: KIFU, Hungarian NREN
- Address: 35 Vaci Street, Budapest, 1134, Hungary
- Email: ietf@nop.hu

**Deepak J Gowda**

- Organization: Extreme Networks
- Address: 55 Commerce Valley Drive West, Suite 300, Thornhill, Toronto, Ontario, L3T 7V9, Canada
...
- Organization: Juniper Networks, Inc.
- Address: Electra, Exora Business Park~Marathahalli - Sarjapur Outer Ring Road, Bangalore, KA, 560103, India
...
- Organization: AT&T
- Address: 200 S Laurel Ave, Middletown, NJ, 07748, United States of America
...
- Organization: Google
- Address: 1160 N Mathilda Ave, Bldg 5, Sunnyvale, CA, 94089, United States of America
