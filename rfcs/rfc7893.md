...
`   `[`3`](#section-3)`. PWs Comprising Elastic Flows`

`   `[`4`](#section-4)`. PWs Comprising Inelastic Flows`
...
<a id="section-3"></a> **`3. PWs Comprising Elastic Flows`**
...
<a id="section-4"></a> **`4. PWs Comprising Inelastic Flows`**
