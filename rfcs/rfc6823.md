...
`   `[`3`](#section-3)`. Encoding Format for GENINFO`

`     `[`3.1`](#section-3-1)`. GENINFO TLV`

`     `[`3.2`](#section-3-2)`. Use of Sub-TLVs in GENINFO TLV`

`   `[`4`](#section-4)`. GENINFO Flooding Procedures`

`     `[`4.1`](#section-4-1)`. Leaking Procedures`

`     `[`4.2`](#section-4-2)`. Minimizing Update Confusion`

`     `[`4.3`](#section-4-3)`. Interpreting Attribute Information`

`   `[`5`](#section-5)`. Use of a Separate Protocol Instance`

`   `[`6`](#section-6)`. Applicability of GENINFO TLV`

`   `[`7`](#section-7)`. Standardization Requirements`
...
<a id="section-3"></a> **`3. Encoding Format for GENINFO`**
...
<a id="section-3-1"></a> **`3.1. GENINFO TLV`**
...
<a id="section-3-2"></a> **`3.2. Use of Sub-TLVs in GENINFO TLV`**
...
<a id="section-4"></a> **`4. GENINFO Flooding Procedures`**
...
<a id="section-4-1"></a> **`4.1. Leaking Procedures`**
...
<a id="section-4-2"></a> **`4.2. Minimizing Update Confusion`**
...
<a id="section-4-3"></a> **`4.3. Interpreting Attribute Information`**
...
<a id="section-5"></a> **`5. Use of a Separate Protocol Instance`**
...
<a id="section-6"></a> **`6. Applicability of GENINFO TLV`**
...
<a id="section-7"></a> **`7. Standardization Requirements`**
