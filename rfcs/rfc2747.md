...
<a id="section-1-2"></a> **`1.2. Why not use the Standard IPSEC Authentication Header?`**
...
<a id="section-2"></a> **`2. Data Structures`**

```text

```

<a id="section-2-1"></a> **`2.1. INTEGRITY Object Format`**
...
<a id="section-2-2"></a> **`2.2. Security Association`**
...
<a id="section-3"></a> **`3. Generating Sequence Numbers`**
...
<a id="section-3-1"></a> **`3.1. Simple Sequence Numbers`**
...
<a id="section-3-2"></a> **`3.2. Sequence Numbers Based on a Real Time Clock`**
...
<a id="section-3-3"></a> **`3.3. Sequence Numbers Based on a Network Recovered Clock`**
...
<a id="section-4"></a> **`4. Message Processing`**
...
<a id="section-4-1"></a> **`4.1. Message Generation`**
...
<a id="section-4-2"></a> **`4.2. Message Reception`**
...
<a id="section-4-3"></a> **`4.3. Integrity Handshake at Restart or Initialization of the Receiver`**
...
<a id="section-5"></a> **`5. Key Management`**
...
<a id="section-5-1"></a> **`5.1. Key Management Procedures`**
...
<a id="section-5-2"></a> **`5.2. Key Management Requirements`**
...
<a id="section-5-3"></a> **`5.3. Pathological Case`**
...
<a id="section-6"></a> **`6. Conformance Requirements`**
...
<a id="section-7"></a> **`7. Kerberos generation of RSVP Authentication Keys`**
...
<a id="section-7-1"></a> **`7.1. Optimization when using Kerberos Based Authentication`**
...
<a id="section-12"></a> **`12. Appendix 1: Key Management Interface`**
...
<a id="section-12-1"></a> **`12.1. Data Structures`**
...
<a id="section-12-2"></a> **`12.2. Default Key Table`**
...
<a id="section-12-3"></a> **`12.3. Querying for Unknown Receive Keys`**
...
<a id="section-12-4"></a> **`12.4. Polling for Updates`**
...
<a id="section-12-5"></a> **`12.5. Asynchronous Upcall Interface`**
