...
`      `[`1.1`](#section-1-1)`. Summary of Contents of Document`

`      `[`1.2`](#section-1-2)`. Audience`

`      `[`1.3`](#section-1-3)`. Related Documents`

`   `[`2`](#section-2)`. Design Objectives`

`      `[`2.1`](#section-2-1)`. Goals/Objectives/Requirements/Problem Description`

`      `[`2.2`](#section-2-2)`. Caveats and Assumptions`

`   `[`3`](#section-3)`. System Overview`

`      `[`3.1`](#section-3-1)`. What IPsec Does`

`      `[`3.2`](#section-3-2)`. How IPsec Works`

`      `[`3.3`](#section-3-3)`. Where IPsec Can Be Implemented`

`   `[`4`](#section-4)`. Security Associations`

`      `[`4.1`](#section-4-1)`. Definition and Scope`

`      `[`4.2`](#section-4-2)`. SA Functionality`

`      `[`4.3`](#section-4-3)`. Combining SAs`

`      `[`4.4`](#section-4-4)`. Major IPsec Databases`

`           `[`4.4.1`](#section-4-4-1)`. The Security Policy Database (SPD)`

`                  `[`4.4.1.1`](#section-4-4-1-1)`. Selectors`

`                  `[`4.4.1.2`](#section-4-4-1-2)`. Structure of an SPD Entry`

`                  `[`4.4.1.3`](#section-4-4-1-3)`. More Regarding Fields Associated`

`                           with Next Layer Protocols`

`           `[`4.4.2`](#section-4-4-2)`. Security Association Database (SAD)`

`                  `[`4.4.2.1`](#section-4-4-2-1)`. Data Items in the SAD`

`                  `[`4.4.2.2`](#section-4-4-2-2)`. Relationship between SPD, PFP`

`                           flag, packet, and SAD`

`           `[`4.4.3`](#section-4-4-3)`. Peer Authorization Database (PAD)`

`                  `[`4.4.3.1`](#section-4-4-3-1)`. PAD Entry IDs and Matching Rules`

`                  `[`4.4.3.2`](#section-4-4-3-2)`. IKE Peer Authentication Data`

`                  `[`4.4.3.3`](#section-4-4-3-3)`. Child SA Authorization Data`

`                  `[`4.4.3.4`](#section-4-4-3-4)`. How the PAD Is Used`

`      `[`4.5`](#section-4-5)`. SA and Key Management`

`           `[`4.5.1`](#section-4-5-1)`. Manual Techniques`

`           `[`4.5.2`](#section-4-5-2)`. Automated SA and Key Management`

`           `[`4.5.3`](#section-4-5-3)`. Locating a Security Gateway`

`      `[`4.6`](#section-4-6)`. SAs and Multicast`

`   `[`5`](#section-5)`. IP Traffic Processing`

`      `[`5.1`](#section-5-1)`. Outbound IP Traffic Processing`

`           (protected-to-unprotected)`

`           `[`5.1.1`](#section-5-1-1)`. Handling an Outbound Packet That Must Be`

`                  Discarded`

`           `[`5.1.2`](#section-5-1-2)`. Header Construction for Tunnel Mode`

`                  `[`5.1.2.1`](#section-5-1-2-1)`. IPv4: Header Construction for`

`                           Tunnel Mode`

`                  `[`5.1.2.2`](#section-5-1-2-2)`. IPv6: Header Construction for`

`                           Tunnel Mode`

`      `[`5.2`](#section-5-2)`. Processing Inbound IP Traffic (unprotected-to-protected)`

`   `[`6`](#section-6)`. ICMP Processing`

`      `[`6.1`](#section-6-1)`. Processing ICMP Error Messages Directed to an`

`           IPsec Implementation`

`           `[`6.1.1`](#section-6-1-1)`. ICMP Error Messages Received on the`

`                  Unprotected Side of the Boundary`

`           `[`6.1.2`](#section-6-1-2)`. ICMP Error Messages Received on the`

`                  Protected Side of the Boundary`

`      `[`6.2`](#section-6-2)`. Processing Protected, Transit ICMP Error Messages`

`   `[`7`](#section-7)`. Handling Fragments (on the protected side of the IPsec`

`      boundary)`

`      `[`7.1`](#section-7-1)`. Tunnel Mode SAs that Carry Initial and Non-Initial`

`           Fragments`

`      `[`7.2`](#section-7-2)`. Separate Tunnel Mode SAs for Non-Initial Fragments`

`      `[`7.3`](#section-7-3)`. Stateful Fragment Checking`

`      `[`7.4`](#section-7-4)`. BYPASS/DISCARD Traffic`

`   `[`8`](#section-8)`. Path MTU/DF Processing`

`      `[`8.1`](#section-8-1)`. DF Bit`

`      `[`8.2`](#section-8-2)`. Path MTU (PMTU) Discovery`

`           `[`8.2.1`](#section-8-2-1)`. Propagation of PMTU`

`           `[`8.2.2`](#section-8-2-2)`. PMTU Aging`

`   `[`9`](#section-9)`. Auditing`

`   `[`10`](#section-10)`. Conformance Requirements`

`   `[`11`](#section-11)`. Security Considerations`

`   `[`12`](#section-12)`. IANA Considerations`

`   `[`13`](#section-13)`. Differences from RFC 2401`
...
<a id="section-1-1"></a> **`1.1. Summary of Contents of Document`**
...
<a id="section-1-2"></a> **`1.2. Audience`**
...
<a id="section-1-3"></a> **`1.3. Related Documents`**
...
<a id="section-2"></a> **`2. Design Objectives`**

```text

```

<a id="section-2-1"></a> **`2.1. Goals/Objectives/Requirements/Problem Description`**
...
<a id="section-2-2"></a> **`2.2. Caveats and Assumptions`**
...
<a id="section-3"></a> **`3. System Overview`**
...
<a id="section-3-1"></a> **`3.1. What IPsec Does`**
...
<a id="section-3-2"></a> **`3.2. How IPsec Works`**
...
<a id="section-3-3"></a> **`3.3. Where IPsec Can Be Implemented`**
...
<a id="section-4"></a> **`4. Security Associations`**
...
<a id="section-4-1"></a> **`4.1. Definition and Scope`**
...
<a id="section-4-2"></a> **`4.2. SA Functionality`**
...
<a id="section-4-3"></a> **`4.3. Combining SAs`**
...
<a id="section-4-4"></a> **`4.4. Major IPsec Databases`**
...
<a id="section-4-4-1"></a> **`4.4.1. The Security Policy Database (SPD)`**
...
<a id="section-4-4-1-1"></a> **`4.4.1.1. Selectors`**
...
<a id="section-4-4-1-2"></a> **`4.4.1.2. Structure of an SPD Entry`**
...
<a id="section-4-4-1-3"></a> **`4.4.1.3. More Regarding Fields Associated with Next Layer Protocols`**
...
<a id="section-4-4-2"></a> **`4.4.2. Security Association Database (SAD)`**
...
<a id="section-4-4-2-1"></a> **`4.4.2.1. Data Items in the SAD`**
...
<a id="section-4-4-2-2"></a> **`4.4.2.2. Relationship between SPD, PFP flag, packet, and SAD`**
...
<a id="section-4-4-3"></a> **`4.4.3. Peer Authorization Database (PAD)`**
...
<a id="section-4-4-3-1"></a> **`4.4.3.1. PAD Entry IDs and Matching Rules`**
...
<a id="section-4-4-3-2"></a> **`4.4.3.2. IKE Peer Authentication Data`**
...
<a id="section-4-4-3-3"></a> **`4.4.3.3. Child SA Authorization Data`**
...
<a id="section-4-4-3-4"></a> **`4.4.3.4. How the PAD Is Used`**
...
<a id="section-4-5"></a> **`4.5. SA and Key Management`**
...
<a id="section-4-5-1"></a> **`4.5.1. Manual Techniques`**
...
<a id="section-4-5-2"></a> **`4.5.2. Automated SA and Key Management`**
...
<a id="section-4-5-3"></a> **`4.5.3. Locating a Security Gateway`**
...
<a id="section-4-6"></a> **`4.6. SAs and Multicast`**
...
<a id="section-5"></a> **`5. IP Traffic Processing`**
...
<a id="section-5-1"></a> **`5.1. Outbound IP Traffic Processing (protected-to-unprotected)`**
...
<a id="section-5-1-1"></a> **`5.1.1. Handling an Outbound Packet That Must Be Discarded`**
...
<a id="section-5-1-2"></a> **`5.1.2. Header Construction for Tunnel Mode`**
...
<a id="section-5-1-2-1"></a> **`5.1.2.1. IPv4: Header Construction for Tunnel Mode`**
...
<a id="section-5-1-2-2"></a> **`5.1.2.2. IPv6: Header Construction for Tunnel Mode`**
...
<a id="section-5-2"></a> **`5.2. Processing Inbound IP Traffic (unprotected-to-protected)`**
...
<a id="section-6"></a> **`6. ICMP Processing`**
...
<a id="section-6-1"></a> **`6.1. Processing ICMP Error Messages Directed to an IPsec Implementation`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. ICMP Error Messages Received on the Unprotected Side of the`**
...
<a id="section-6-1-2"></a> **`6.1.2. ICMP Error Messages Received on the Protected Side of the`**
...
<a id="section-6-2"></a> **`6.2. Processing Protected, Transit ICMP Error Messages`**
...
<a id="section-7"></a> **`7. Handling Fragments (on the protected side of the IPsec boundary)`**
...
<a id="section-7-1"></a> **`7.1. Tunnel Mode SAs that Carry Initial and Non-Initial Fragments`**
...
<a id="section-7-2"></a> **`7.2. Separate Tunnel Mode SAs for Non-Initial Fragments`**
...
<a id="section-7-3"></a> **`7.3. Stateful Fragment Checking`**
...
<a id="section-7-4"></a> **`7.4. BYPASS/DISCARD Traffic`**
...
<a id="section-8"></a> **`8. Path MTU/DF Processing`**
...
<a id="section-8-2"></a> **`8.2. Path MTU (PMTU) Discovery`**
...
<a id="section-8-2-1"></a> **`8.2.1. Propagation of PMTU`**
...
<a id="section-8-2-2"></a> **`8.2.2. PMTU Aging`**
...
<a id="section-10"></a> **`10. Conformance Requirements`**
...
<a id="section-13"></a> **`13. Differences from RFC 2401`**
