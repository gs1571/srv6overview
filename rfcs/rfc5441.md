...
`   `[`3`](#section-3)`. General Assumptions`

`   `[`4`](#section-4)`. BRPC Procedure`

`     `[`4.1`](#section-4-1)`. Domain Path Selection`

`     `[`4.2`](#section-4-2)`. Mode of Operation`

`   `[`5`](#section-5)`. PCEP Protocol Extensions`

`   `[`6`](#section-6)`. VSPT Encoding`

`   `[`7`](#section-7)`. Inter-AS TE Links`

`   `[`8`](#section-8)`. Usage in Conjunction with Per-Domain Path Computation`

`   `[`9`](#section-9)`. BRPC Procedure Completion Failure`

`   `[`10`](#section-10)`. Applicability`

`     `[`10.1`](#section-10-1)`. Diverse End-to-End Path Computation`

`     `[`10.2`](#section-10-2)`. Path Optimality`

`   `[`11`](#section-11)`. Reoptimization of an Inter-Domain TE LSP`

`   `[`12`](#section-12)`. Path Computation Failure`

`   `[`13`](#section-13)`. Metric Normalization`

`   `[`14`](#section-14)`. Manageability Considerations`

`     `[`14.1`](#section-14-1)`. Control of Function and Policy`

`     `[`14.2`](#section-14-2)`. Information and Data Models`

`     `[`14.3`](#section-14-3)`. Liveness Detection and Monitoring`

`     `[`14.4`](#section-14-4)`. Verifying Correct Operation`

`     `[`14.5`](#section-14-5)`. Requirements on Other Protocols and Functional`

`           Components`

`     `[`14.6`](#section-14-6)`. Impact on Network Operation`

`     `[`14.7`](#section-14-7)`. Path Computation Chain Monitoring`

`   `[`15`](#section-15)`. IANA Considerations`

`     `[`15.1`](#section-15-1)`. New Flag of the RP Object`

`     `[`15.2`](#section-15-2)`. New Error-Type and Error-Value`

`     `[`15.3`](#section-15-3)`. New Flag of the NO-PATH-VECTOR TLV`
...
<a id="section-3"></a> **`3. General Assumptions`**
...
<a id="section-4"></a> **`4. BRPC Procedure`**
...
<a id="section-4-1"></a> **`4.1. Domain Path Selection`**
...
<a id="section-4-2"></a> **`4.2. Mode of Operation`**
...
<a id="section-5"></a> **`5. PCEP Protocol Extensions`**
...
<a id="section-6"></a> **`6. VSPT Encoding`**
...
<a id="section-7"></a> **`7. Inter-AS TE Links`**
...
<a id="section-8"></a> **`8. Usage in Conjunction with Per-Domain Path Computation`**
...
<a id="section-9"></a> **`9. BRPC Procedure Completion Failure`**
...
<a id="section-10"></a> **`10. Applicability`**
...
<a id="section-10-1"></a> **`10.1. Diverse End-to-End Path Computation`**
...
<a id="section-10-2"></a> **`10.2. Path Optimality`**
...
<a id="section-11"></a> **`11. Reoptimization of an Inter-Domain TE LSP`**
...
<a id="section-12"></a> **`12. Path Computation Failure`**
...
<a id="section-13"></a> **`13. Metric Normalization`**
...
<a id="section-14"></a> **`14. Manageability Considerations`**
...
<a id="section-14-1"></a> **`14.1. Control of Function and Policy`**
...
<a id="section-14-2"></a> **`14.2. Information and Data Models`**
...
<a id="section-14-3"></a> **`14.3. Liveness Detection and Monitoring`**
...
<a id="section-14-4"></a> **`14.4. Verifying Correct Operation`**
...
<a id="section-14-5"></a> **`14.5. Requirements on Other Protocols and Functional Components`**
...
<a id="section-14-6"></a> **`14.6. Impact on Network Operation`**
...
<a id="section-14-7"></a> **`14.7. Path Computation Chain Monitoring`**
...
<a id="section-15-1"></a> **`15.1. New Flag of the RP Object`**
...
<a id="section-15-2"></a> **`15.2. New Error-Type and Error-Value`**
...
<a id="section-15-3"></a> **`15.3. New Flag of the NO-PATH-VECTOR TLV`**
