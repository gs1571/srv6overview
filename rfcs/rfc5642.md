...
`   `[`2`](#section-2)`. Possible Solutions`

`   `[`3`](#section-3)`. Implementation`

`     `[`3.1`](#section-3-1)`. Dynamic Hostname TLV`

`       `[`3.1.1`](#section-3-1-1)`. Flooding Scope`

`       `[`3.1.2`](#section-3-1-2)`. Multiple OSPF Instances`

`   `[`4`](#section-4)`. IPv6 Considerations`
...
<a id="section-2"></a> **`2. Possible Solutions`**
...
<a id="section-3"></a> **`3. Implementation`**
...
<a id="section-3-1"></a> **`3.1. Dynamic Hostname TLV`**
...
<a id="section-3-1-1"></a> **`3.1.1. Flooding Scope`**
...
<a id="section-3-1-2"></a> **`3.1.2. Multiple OSPF Instances`**
...
<a id="section-4"></a> **`4. IPv6 Considerations`**
