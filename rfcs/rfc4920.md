...
<a id="section-1"></a> **`1. Introduction and Framework ......................................4`**
...
<a id="section-2"></a> **`2. Discussion: Explicit versus Implicit Re-Routing Indications .....7`**

```text

```

<a id="section-3"></a> **`3. Required Operation ..............................................8`**
...
<a id="section-4"></a> **`4. Existing Protocol Support for Crankback Re-Routing .............11`**
...
<a id="section-5"></a> **`5. Control of Crankback Operation .................................13`**
...
<a id="section-6"></a> **`6. Reporting Crankback Information ................................15`**
...
<a id="section-7"></a> **`7. LSP Recovery Considerations ....................................29`**
...
<a id="section-8"></a> **`8. IANA Considerations ............................................30`**
...
<a id="section-9"></a> **`9. Security Considerations ........................................31`**

```text

```

<a id="section-10"></a> **`10. Acknowledgments ...............................................32`**

```text

```

<a id="section-11"></a> **`11. References ....................................................33`**
...
<a id="section-1"></a> **`1. Introduction and Framework`**
...
<a id="section-1-2"></a> **`1.2. Control Plane and Data Plane Separation`**
...
<a id="section-1-3"></a> **`1.3. Repair and Recovery`**
...
<a id="section-1-4"></a> **`1.4. Interaction with TE Flooding Mechanisms`**
...
<a id="section-2"></a> **`2. Discussion: Explicit versus Implicit Re-Routing Indications`**
...
<a id="section-3"></a> **`3. Required Operation`**
...
<a id="section-3-1"></a> **`3.1. Resource Failure or Unavailability`**
...
<a id="section-3-2"></a> **`3.2. Computation of an Alternate Path`**
...
<a id="section-3-2-1"></a> **`3.2.1. Information Required for Re-Routing`**
...
<a id="section-3-2-2"></a> **`3.2.2. Signaling a New Route`**
...
<a id="section-3-3"></a> **`3.3. Persistence of Error Information`**
...
<a id="section-3-4"></a> **`3.4. Handling Re-Route Failure`**
...
<a id="section-3-5"></a> **`3.5. Limiting Re-Routing Attempts`**
...
<a id="section-4"></a> **`4. Existing Protocol Support for Crankback Re-Routing`**
...
<a id="section-4-1"></a> **`4.1. RSVP-TE`**
...
<a id="section-4-2"></a> **`4.2. GMPLS-RSVP-TE`**
...
<a id="section-5"></a> **`5. Control of Crankback Operation`**

```text

```

<a id="section-5-1"></a> **`5.1. Requesting Crankback and Controlling In-Network Re-Routing`**
...
<a id="section-5-2"></a> **`5.2. Action on Detecting a Failure`**
...
<a id="section-5-3"></a> **`5.3. Limiting Re-Routing Attempts`**
...
<a id="section-5-3-1"></a> **`5.3.1. New Status Codes for Re-Routing`**
...
<a id="section-5-4"></a> **`5.4. Protocol Control of Re-Routing Behavior`**
...
<a id="section-6"></a> **`6. Reporting Crankback Information`**

```text

```

<a id="section-6-1"></a> **`6.1. Required Information`**
...
<a id="section-6-2"></a> **`6.2. Protocol Extensions`**
...
<a id="section-6-3"></a> **`6.3. Guidance for Use of IF_ID ERROR_SPEC TLVs`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. General Principles`**
...
<a id="section-6-3-2"></a> **`6.3.2. Error Report TLVs`**
...
<a id="section-6-3-3"></a> **`6.3.3. Fundamental Crankback TLVs`**
...
<a id="section-6-3-4"></a> **`6.3.4. Additional Crankback TLVs`**
...
<a id="section-6-3-5"></a> **`6.3.5. Grouping TLVs by Failure Location`**
...
<a id="section-6-3-6"></a> **`6.3.6. Alternate Path Identification`**
...
<a id="section-6-4"></a> **`6.4. Action on Receiving Crankback Information`**

```text

```

<a id="section-6-4-1"></a> **`6.4.1. Re-Route Attempts`**
...
<a id="section-6-4-2"></a> **`6.4.2. Location Identifiers of Blocked Links or Nodes`**
...
<a id="section-6-4-3"></a> **`6.4.3. Locating Errors within Loose or Abstract Nodes`**
...
<a id="section-6-4-4"></a> **`6.4.4. When Re-Routing Fails`**
...
<a id="section-6-4-5"></a> **`6.4.5. Aggregation of Crankback Information`**
...
<a id="section-6-5"></a> **`6.5. Notification of Errors`**

```text

```

<a id="section-6-5-1"></a> **`6.5.1. ResvErr Processing`**
...
<a id="section-6-5-2"></a> **`6.5.2. Notify Message Processing`**
...
<a id="section-6-6"></a> **`6.6. Error Values`**
...
<a id="section-6-7"></a> **`6.7. Backward Compatibility`**
...
<a id="section-7"></a> **`7. LSP Recovery Considerations`**
...
<a id="section-7-1"></a> **`7.1. Upstream of the Fault`**
...
<a id="section-7-2"></a> **`7.2. Downstream of the Fault`**
...
<a id="section-8-1"></a> **`8.1. Error Codes`**
...
<a id="section-8-2"></a> **`8.2. IF_ID_ERROR_SPEC TLVs`**
...
<a id="section-8-3"></a> **`8.3. LSP_ATTRIBUTES Object`**
