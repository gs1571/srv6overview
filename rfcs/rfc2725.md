...
`   `[`3`](#section-3)`. Implicit Policy Assumptions`

`   `[`4`](#section-4)`. Scope of Security Coverage`

`   `[`5`](#section-5)`. Organization of this Document`

`   `[`6`](#section-6)`. Goals and Requirements`

`   `[`7`](#section-7)`. Data Representation`

`   `[`8`](#section-8)`. Authentication Model`

`   `[`9`](#section-9)`. Authorization Model`

`     `[`9.1`](#section-9-1)`. Maintainer Objects`

`     `[`9.2`](#section-9-2)`. as-block and aut-num objects`

`     `[`9.3`](#section-9-3)`. inetnum objects`

`     `[`9.4`](#section-9-4)`. route objects`

`     `[`9.5`](#section-9-5)`. reclaim and no-reclaim attributes`

`     `[`9.6`](#section-9-6)`. Other Objects`

`     `[`9.7`](#section-9-7)`. Objects with AS Hierarchical Names`

`     `[`9.8`](#section-9-8)`. Query Processing`

`     `[`9.9`](#section-9-9)`. Adding to the Database`

`     `[`9.10`](#section-9-10)`. Modifying or Deleting Database Objects`

`   `[`10`](#section-10)`. Data Format Summaries`

`     `[`10.1`](#section-10-1)`. Changes to the RIPE/RPSL Schema`
