...
`     `[`1.1`](#section-1-1)`. Requirements to Meet`

`     `[`1.2`](#section-1-2)`. Requirements Notation`

`   `[`2`](#section-2)`. Current State`

`     `[`2.1`](#section-2-1)`. OSPFv2`

`     `[`2.2`](#section-2-2)`. OSPFv3`

`   `[`3`](#section-3)`. Impacts of OSPF Replays`

`   `[`4`](#section-4)`. Gap Analysis and Specific Requirements`

`   `[`5`](#section-5)`. Solution Work`
...
<a id="section-1-1"></a> **`1.1. Requirements to Meet`**
...
<a id="section-2"></a> **`2. Current State`**
...
<a id="section-3"></a> **`3. Impacts of OSPF Replays`**
...
<a id="section-4"></a> **`4. Gap Analysis and Specific Requirements`**
...
<a id="section-5"></a> **`5. Solution Work`**
