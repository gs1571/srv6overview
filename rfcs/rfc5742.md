...
<a id="section-1"></a> **`1. Introduction and History`**
...
<a id="section-1-1"></a> **`1.1. Changes since RFC 3932`**
...
<a id="section-2"></a> **`2. Background Material`**
...
<a id="section-3"></a> **`3. Detailed Description of IESG Review`**
...
<a id="section-4"></a> **`4. Dispute Resolution`**
...
<a id="section-5"></a> **`5. Examples of Cases Where Publication Is Harmful`**
...
<a id="section-6"></a> **`6. IAB Statement`**
...
<a id="section-9-1"></a> **`9.1. Normative Reference`**
