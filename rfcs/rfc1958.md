...
`      `[`1`](#section-1)`. Constant Change`

`      `[`2`](#section-2)`. Is there an Internet Architecture?`

`      `[`3`](#section-3)`. General Design Issues`

`      `[`4`](#section-4)`. Name and address issues`

`      `[`5`](#section-5)`. External Issues`

`      `[`6`](#section-6)`. Related to Confidentiality and Authentication`
...
<a id="section-1"></a> **`1. Constant Change`**
...
<a id="section-2"></a> **`2. Is there an Internet Architecture?`**
...
<a id="section-3"></a> **`3. General Design Issues`**
...
<a id="section-4"></a> **`4. Name and address issues`**
...
<a id="section-5"></a> **`5. External Issues`**
...
<a id="section-6"></a> **`6. Related to Confidentiality and Authentication`**
