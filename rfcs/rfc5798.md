...
`      `[`1.1`](#section-1-1)`. A Note on Terminology`

`      `[`1.2`](#section-1-2)`. IPv4`

`      `[`1.3`](#section-1-3)`. IPv6`

`      `[`1.4`](#section-1-4)`. Requirements Language`

`      `[`1.5`](#section-1-5)`. Scope`

`      `[`1.6`](#section-1-6)`. Definitions`

`   `[`2`](#section-2)`. Required Features`

`      `[`2.1`](#section-2-1)`. IPvX Address Backup`

`      `[`2.2`](#section-2-2)`. Preferred Path Indication`

`      `[`2.3`](#section-2-3)`. Minimization of Unnecessary Service Disruptions`

`      `[`2.4`](#section-2-4)`. Efficient Operation over Extended LANs`

`      `[`2.5`](#section-2-5)`. Sub-Second Operation for IPv4 and IPv6`

`   `[`3`](#section-3)`. VRRP Overview`

`   `[`4`](#section-4)`. Sample Configurations`

`      `[`4.1`](#section-4-1)`. Sample Configuration 1`

`      `[`4.2`](#section-4-2)`. Sample Configuration 2`

`   `[`5`](#section-5)`. Protocol`

`      `[`5.1`](#section-5-1)`. VRRP Packet Format`

`           `[`5.1.1`](#section-5-1-1)`. IPv4 Field Descriptions`

`                  `[`5.1.1.1`](#section-5-1-1-1)`. Source Address`

`                  `[`5.1.1.2`](#section-5-1-1-2)`. Destination Address`

`                  `[`5.1.1.3`](#section-5-1-1-3)`. TTL`

`                  `[`5.1.1.4`](#section-5-1-1-4)`. Protocol`

`           `[`5.1.2`](#section-5-1-2)`. IPv6 Field Descriptions`

`                  `[`5.1.2.1`](#section-5-1-2-1)`. Source Address`

`                  `[`5.1.2.2`](#section-5-1-2-2)`. Destination Address`

`                  `[`5.1.2.3`](#section-5-1-2-3)`. Hop Limit`

`                  `[`5.1.2.4`](#section-5-1-2-4)`. Next Header`

`      `[`5.2`](#section-5-2)`. VRRP Field Descriptions`

`           `[`5.2.1`](#section-5-2-1)`. Version`

`           `[`5.2.2`](#section-5-2-2)`. Type`

`           `[`5.2.3`](#section-5-2-3)`. Virtual Rtr ID (VRID)`

`           `[`5.2.4`](#section-5-2-4)`. Priority`

`           `[`5.2.5`](#section-5-2-5)`. Count IPvX Addr`

`           `[`5.2.6`](#section-5-2-6)`. Rsvd`

`           `[`5.2.7`](#section-5-2-7)`. Maximum Advertisement Interval (Max Adver Int)`

`           `[`5.2.8`](#section-5-2-8)`. Checksum`

`           `[`5.2.9`](#section-5-2-9)`. IPvX Address(es)`

`   `[`6`](#section-6)`. Protocol State Machine`

`      `[`6.1`](#section-6-1)`. Parameters Per Virtual Router`

`      `[`6.2`](#section-6-2)`. Timers`

`      `[`6.3`](#section-6-3)`. State Transition Diagram`

`      `[`6.4`](#section-6-4)`. State Descriptions`

`           `[`6.4.1`](#section-6-4-1)`. Initialize`

`           `[`6.4.2`](#section-6-4-2)`. Backup`

`           `[`6.4.3`](#section-6-4-3)`. Master`

`   `[`7`](#section-7)`. Sending and Receiving VRRP Packets`

`      `[`7.1`](#section-7-1)`. Receiving VRRP Packets`

`      `[`7.2`](#section-7-2)`. Transmitting VRRP Packets`

`      `[`7.3`](#section-7-3)`. Virtual Router MAC Address`

`      `[`7.4`](#section-7-4)`. IPv6 Interface Identifiers`

`   `[`8`](#section-8)`. Operational Issues`

`      `[`8.1`](#section-8-1)`. IPv4`

`           `[`8.1.1`](#section-8-1-1)`. ICMP Redirects`

`           `[`8.1.2`](#section-8-1-2)`. Host ARP Requests`

`           `[`8.1.3`](#section-8-1-3)`. Proxy ARP`

`      `[`8.2`](#section-8-2)`. IPv6`

`           `[`8.2.1`](#section-8-2-1)`. ICMPv6 Redirects`

`           `[`8.2.2`](#section-8-2-2)`. ND Neighbor Solicitation`

`           `[`8.2.3`](#section-8-2-3)`. Router Advertisements`

`      `[`8.3`](#section-8-3)`. IPvX`

`           `[`8.3.1`](#section-8-3-1)`. Potential Forwarding Loop`

`           `[`8.3.2`](#section-8-3-2)`. Recommendations Regarding Setting Priority Values`

`      `[`8.4`](#section-8-4)`. VRRPv3 and VRRPv2 Interoperation`

`           `[`8.4.1`](#section-8-4-1)`. Assumptions`

`           `[`8.4.2`](#section-8-4-2)`. VRRPv3 Support of VRRPv2`

`           `[`8.4.3`](#section-8-4-3)`. VRRPv3 Support of VRRPv2 Considerations`

`                  `[`8.4.3.1`](#section-8-4-3-1)`. Slow, High-Priority Masters`

`                  `[`8.4.3.2`](#section-8-4-3-2)`. Overwhelming VRRPv2 Backups`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Contributors and Acknowledgments`
...
<a id="section-1-4"></a> **`1.4. Requirements Language`**
...
<a id="section-1-6"></a> **`1.6. Definitions`**
...
<a id="section-2"></a> **`2. Required Features`**
...
<a id="section-2-1"></a> **`2.1. IPvX Address Backup`**
...
<a id="section-2-2"></a> **`2.2. Preferred Path Indication`**
...
<a id="section-2-3"></a> **`2.3. Minimization of Unnecessary Service Disruptions`**
...
<a id="section-2-4"></a> **`2.4. Efficient Operation over Extended LANs`**
...
<a id="section-2-5"></a> **`2.5. Sub-Second Operation for IPv4 and IPv6`**
...
<a id="section-3"></a> **`3. VRRP Overview`**
...
<a id="section-4"></a> **`4. Sample Configurations`**

```text

```

<a id="section-4-1"></a> **`4.1. Sample Configuration 1`**
...
<a id="section-4-2"></a> **`4.2. Sample Configuration 2`**
...
<a id="section-5-1"></a> **`5.1. VRRP Packet Format`**
...
<a id="section-5-1-1"></a> **`5.1.1. IPv4 Field Descriptions`**

```text

```

<a id="section-5-1-1-1"></a> **`5.1.1.1. Source Address`**
...
<a id="section-5-1-1-2"></a> **`5.1.1.2. Destination Address`**
...
<a id="section-5-1-1-3"></a> **`5.1.1.3. TTL`**
...
<a id="section-5-1-1-4"></a> **`5.1.1.4. Protocol`**
...
<a id="section-5-1-2"></a> **`5.1.2. IPv6 Field Descriptions`**

```text

```

<a id="section-5-1-2-1"></a> **`5.1.2.1. Source Address`**
...
<a id="section-5-1-2-2"></a> **`5.1.2.2. Destination Address`**
...
<a id="section-5-1-2-3"></a> **`5.1.2.3. Hop Limit`**
...
<a id="section-5-1-2-4"></a> **`5.1.2.4. Next Header`**
...
<a id="section-5-2"></a> **`5.2. VRRP Field Descriptions`**

```text

```

<a id="section-5-2-1"></a> **`5.2.1. Version`**
...
<a id="section-5-2-2"></a> **`5.2.2. Type`**
...
<a id="section-5-2-3"></a> **`5.2.3. Virtual Rtr ID (VRID)`**
...
<a id="section-5-2-4"></a> **`5.2.4. Priority`**
...
<a id="section-5-2-5"></a> **`5.2.5. Count IPvX Addr`**
...
<a id="section-5-2-6"></a> **`5.2.6. Rsvd`**
...
<a id="section-5-2-7"></a> **`5.2.7. Maximum Advertisement Interval (Max Adver Int)`**
...
<a id="section-5-2-8"></a> **`5.2.8. Checksum`**
...
<a id="section-5-2-9"></a> **`5.2.9. IPvX Address(es)`**
...
<a id="section-6"></a> **`6. Protocol State Machine`**

```text

```

<a id="section-6-1"></a> **`6.1. Parameters Per Virtual Router`**
...
<a id="section-6-3"></a> **`6.3. State Transition Diagram`**
...
<a id="section-6-4"></a> **`6.4. State Descriptions`**
...
<a id="section-6-4-1"></a> **`6.4.1. Initialize`**
...
<a id="section-6-4-2"></a> **`6.4.2. Backup`**
...
<a id="section-6-4-3"></a> **`6.4.3. Master`**
...
<a id="section-7"></a> **`7. Sending and Receiving VRRP Packets`**

```text

```

<a id="section-7-1"></a> **`7.1. Receiving VRRP Packets`**
...
<a id="section-7-2"></a> **`7.2. Transmitting VRRP Packets`**
...
<a id="section-7-3"></a> **`7.3. Virtual Router MAC Address`**
...
<a id="section-7-4"></a> **`7.4. IPv6 Interface Identifiers`**
...
<a id="section-8"></a> **`8. Operational Issues`**

```text

```

<a id="section-8-1"></a> **`8.1. IPv4`**

```text

```

<a id="section-8-1-1"></a> **`8.1.1. ICMP Redirects`**
...
<a id="section-8-1-2"></a> **`8.1.2. Host ARP Requests`**
...
<a id="section-8-1-3"></a> **`8.1.3. Proxy ARP`**
...
<a id="section-8-2"></a> **`8.2. IPv6`**

```text

```

<a id="section-8-2-1"></a> **`8.2.1. ICMPv6 Redirects`**
...
<a id="section-8-2-2"></a> **`8.2.2. ND Neighbor Solicitation`**
...
<a id="section-8-2-3"></a> **`8.2.3. Router Advertisements`**
...
<a id="section-8-3"></a> **`8.3. IPvX`**

```text

```

<a id="section-8-3-1"></a> **`8.3.1. Potential Forwarding Loop`**
...
<a id="section-8-3-2"></a> **`8.3.2. Recommendations Regarding Setting Priority Values`**
...
<a id="section-8-4"></a> **`8.4. VRRPv3 and VRRPv2 Interoperation`**

```text

```

<a id="section-8-4-1"></a> **`8.4.1. Assumptions`**
...
<a id="section-8-4-2"></a> **`8.4.2. VRRPv3 Support of VRRPv2`**
...
<a id="section-8-4-3"></a> **`8.4.3. VRRPv3 Support of VRRPv2 Considerations`**

```text

```

<a id="section-8-4-3-1"></a> **`8.4.3.1. Slow, High-Priority Masters`**
...
<a id="section-8-4-3-2"></a> **`8.4.3.2. Overwhelming VRRPv2 Backups`**
...
<a id="section-10"></a> **`10. Contributors and Acknowledgments`**
