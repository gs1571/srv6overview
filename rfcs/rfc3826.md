...
`       `[`1.1`](#section-1-1)`. Goals and Constraints`

`       `[`1.2`](#section-1-2)`. Key Localization`

`       `[`1.3`](#section-1-3)`. Password Entropy and Storage`

`   `[`2`](#section-2)`. Definitions`

`   `[`3`](#section-3)`. CFB128-AES-128 Symmetric Encryption Protocol`

`       `[`3.1`](#section-3-1)`. Mechanisms`

`             `[`3.1.1`](#section-3-1-1)`. The AES-based Symmetric Encryption Protocol .`

`             `[`3.1.2`](#section-3-1-2)`. Localized Key, AES Encryption Key and`

`                    Initialization Vector`

`             `[`3.1.3`](#section-3-1-3)`. Data Encryption`

`             `[`3.1.4`](#section-3-1-4)`. Data Decryption`

`       `[`3.2`](#section-3-2)`. Elements of the AES Privacy Protocol`

`             `[`3.2.1`](#section-3-2-1)`. Users`

`             `[`3.2.2`](#section-3-2-2)`. msgAuthoritativeEngineID`

`             `[`3.2.3`](#section-3-2-3)`. SNMP Messages Using this Privacy Protocol`

`             `[`3.2.4`](#section-3-2-4)`. Services provided by the AES Privacy Modules.`

`       `[`3.3`](#section-3-3)`. Elements of Procedure`

`             `[`3.3.1`](#section-3-3-1)`. Processing an Outgoing Message`

`             `[`3.3.2`](#section-3-3-2)`. Processing an Incoming Message`
...
`   `[`9`](#section-9)`. Full Copyright Statement`
...
<a id="section-1-1"></a> **`1.1. Goals and Constraints`**
...
<a id="section-1-2"></a> **`1.2. Key Localization`**
...
<a id="section-1-3"></a> **`1.3. Password Entropy and Storage`**
...
<a id="section-3"></a> **`3. CFB128-AES-128 Symmetric Encryption Protocol`**
...
<a id="section-3-1"></a> **`3.1. Mechanisms`**
...
<a id="section-3-1-1"></a> **`3.1.1. The AES-based Symmetric Encryption Protocol`**
...
<a id="section-3-1-1-1"></a> **`3.1.1.1. Mode of operation`**
...
<a id="section-3-1-1-2"></a> **`3.1.1.2. Key Size`**
...
<a id="section-3-1-1-3"></a> **`3.1.1.3. Block Size and Padding`**
...
<a id="section-3-1-1-4"></a> **`3.1.1.4. Rounds`**
...
<a id="section-3-1-2"></a> **`3.1.2. Localized Key, AES Encryption Key, and Initialization Vector`**
...
<a id="section-3-1-2-1"></a> **`3.1.2.1. AES Encryption Key and IV`**
...
<a id="section-3-1-3"></a> **`3.1.3. Data Encryption`**
...
<a id="section-3-1-4"></a> **`3.1.4. Data Decryption`**
...
<a id="section-3-2"></a> **`3.2. Elements of the AES Privacy Protocol`**
...
<a id="section-3-2-1"></a> **`3.2.1. Users`**
...
<a id="section-3-2-2"></a> **`3.2.2. msgAuthoritativeEngineID`**
...
<a id="section-3-2-3"></a> **`3.2.3. SNMP Messages Using this Privacy Protocol`**
...
<a id="section-3-2-4"></a> **`3.2.4. Services provided by the AES Privacy Modules`**
...
<a id="section-3-2-4-1"></a> **`3.2.4.1. Services for Encrypting Outgoing Data`**
...
<a id="section-3-2-4-2"></a> **`3.2.4.2. Services for Decrypting Incoming Data`**
...
<a id="section-3-3"></a> **`3.3. Elements of Procedure`**
...
<a id="section-3-3-1"></a> **`3.3.1. Processing an Outgoing Message`**
...
<a id="section-3-3-2"></a> **`3.3.2. Processing an Incoming Message`**
...
<a id="section-9"></a> **`9. Full Copyright Statement`**
