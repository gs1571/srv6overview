...
`       `[`1.1`](#section-1-1)`. Structure of this Document`

`       `[`1.2`](#section-1-2)`. Document Terminology and Conventions`

`   `[`2`](#section-2)`. Message Header Fields`

`       `[`2.1`](#section-2-1)`. Permanent and Provisional Header Fields`

`       `[`2.2`](#section-2-2)`. Definitions of Message Header Fields`

`             `[`2.2.1`](#section-2-2-1)`. Application-specific Message Header Fields`

`             `[`2.2.2`](#section-2-2-2)`. MIME Header Fields`

`   `[`3`](#section-3)`. Registry Usage Requirements`

`   `[`4`](#section-4)`. Registration Procedure`

`       `[`4.1`](#section-4-1)`. Header Field Specification`

`       `[`4.2`](#section-4-2)`. Registration Templates`

`             `[`4.2.1`](#section-4-2-1)`. Permanent Message Header Field Registration`

`                    Template`

`             `[`4.2.2`](#section-4-2-2)`. Provisional Message Header Field Submission`

`                    Template`

`       `[`4.3`](#section-4-3)`. Submission of Registration`

`       `[`4.4`](#section-4-4)`. Objections to Registration`

`       `[`4.5`](#section-4-5)`. Change Control`

`       `[`4.6`](#section-4-6)`. Comments on Header Definitions`

`       `[`4.7`](#section-4-7)`. Location of Header Field Registry`
...
<a id="section-1-1"></a> **`1.1. Structure of this Document`**
...
<a id="section-1-2"></a> **`1.2. Document Terminology and Conventions`**
...
<a id="section-2"></a> **`2. Message Header Fields`**

```text

```

<a id="section-2-1"></a> **`2.1. Permanent and Provisional Header Fields`**
...
<a id="section-2-2"></a> **`2.2. Definitions of Message Header Fields`**
...
<a id="section-2-2-1"></a> **`2.2.1. Application-specific Message Header Fields`**
...
<a id="section-2-2-2"></a> **`2.2.2. MIME Header Fields`**
...
<a id="section-3"></a> **`3. Registry Usage Requirements`**
...
<a id="section-4"></a> **`4. Registration Procedure`**
...
<a id="section-4-1"></a> **`4.1. Header Field Specification`**
...
<a id="section-4-2"></a> **`4.2. Registration Templates`**
...
<a id="section-4-2-1"></a> **`4.2.1. Permanent Message Header Field Registration Template`**
...
<a id="section-4-2-2"></a> **`4.2.2. Provisional Message Header Field Submission Template`**
...
<a id="section-4-3"></a> **`4.3. Submission of Registration`**
...
<a id="section-4-4"></a> **`4.4. Objections to Registration`**
...
<a id="section-4-5"></a> **`4.5. Change Control`**
...
<a id="section-4-6"></a> **`4.6. Comments on Header Definitions`**
...
<a id="section-4-7"></a> **`4.7. Location of Header Field Registry`**
