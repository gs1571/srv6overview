...
`   `[`3`](#section-3)`. Architectural Overview`

`     `[`3.1`](#section-3-1)`. Motivation`

`     `[`3.2`](#section-3-2)`. Operation Overview`

`   `[`4`](#section-4)`. Support of PCE-Initiated LSPs`

`     `[`4.1`](#section-4-1)`. STATEFUL-PCE-CAPABILITY TLV`

`   `[`5`](#section-5)`. PCE-Initiated LSP Instantiation and Deletion`

`     `[`5.1`](#section-5-1)`. The LSP Initiate Request`

`     `[`5.2`](#section-5-2)`. The R Flag in the SRP Object`

`     `[`5.3`](#section-5-3)`. LSP Instantiation`

`       `[`5.3.1`](#section-5-3-1)`. The Create Flag`

`       `[`5.3.2`](#section-5-3-2)`. The SPEAKER-ENTITY-ID TLV`

`     `[`5.4`](#section-5-4)`. LSP Deletion`

`   `[`6`](#section-6)`. LSP Delegation and Cleanup`

`   `[`7`](#section-7)`. LSP State Synchronization`

`   `[`8`](#section-8)`. IANA Considerations`

`     `[`8.1`](#section-8-1)`. PCEP Messages`

`     `[`8.2`](#section-8-2)`. LSP Object`

`     `[`8.3`](#section-8-3)`. SRP object`

`     `[`8.4`](#section-8-4)`. STATEFUL-PCE-CAPABILITY TLV`

`     `[`8.5`](#section-8-5)`. PCEP-Error Object`

`   `[`9`](#section-9)`. Security Considerations`

`     `[`9.1`](#section-9-1)`. Malicious PCE`

`     `[`9.2`](#section-9-2)`. Malicious PCC`
...
<a id="section-3"></a> **`3. Architectural Overview`**
...
<a id="section-3-2"></a> **`3.2. Operation Overview`**
...
<a id="section-4"></a> **`4. Support of PCE-Initiated LSPs`**
...
<a id="section-4-1"></a> **`4.1. STATEFUL-PCE-CAPABILITY TLV`**
...
<a id="section-5"></a> **`5. PCE-Initiated LSP Instantiation and Deletion`**
...
<a id="section-5-1"></a> **`5.1. The LSP Initiate Request`**
...
<a id="section-5-2"></a> **`5.2. The R Flag in the SRP Object`**
...
<a id="section-5-3"></a> **`5.3. LSP Instantiation`**
...
<a id="section-5-3-1"></a> **`5.3.1. The Create Flag`**
...
<a id="section-5-3-2"></a> **`5.3.2. The SPEAKER-ENTITY-ID TLV`**
...
<a id="section-5-4"></a> **`5.4. LSP Deletion`**
...
<a id="section-6"></a> **`6. LSP Delegation and Cleanup`**
...
<a id="section-7"></a> **`7. LSP State Synchronization`**
...
<a id="section-8-1"></a> **`8.1. PCEP Messages`**
...
<a id="section-8-2"></a> **`8.2. LSP Object`**
...
<a id="section-8-3"></a> **`8.3. SRP object`**
...
<a id="section-8-4"></a> **`8.4. STATEFUL-PCE-CAPABILITY TLV`**
...
<a id="section-9-1"></a> **`9.1. Malicious PCE`**
...
<a id="section-9-2"></a> **`9.2. Malicious PCC`**
