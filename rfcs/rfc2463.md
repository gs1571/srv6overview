...
`            `[`2`](#section-2)`. 1 Message General Format`

`            `[`2`](#section-2)`. 2 Message Source Address Determination`

`            `[`2`](#section-2)`. 3 Message Checksum Calculation`

`            `[`2`](#section-2)`. 4 Message Processing Rules`

`      `[`3`](#section-3)`. ICMPv6 Error Messages`

`            `[`3`](#section-3)`. 1 Destination Unreachable Message`

`            `[`3`](#section-3)`. 2 Packet Too Big Message`

`            `[`3`](#section-3)`. 3 Time Exceeded Message`

`            `[`3`](#section-3)`. 4 Parameter Problem Message`

`      `[`4`](#section-4)`. ICMPv6 Informational Messages`

`            `[`4`](#section-4)`. 1 Echo Request Message`

`            `[`4`](#section-4)`. 2 Echo Reply Message`
...
`      Appendix A - Changes since RFC 1885`
