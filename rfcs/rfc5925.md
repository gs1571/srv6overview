...
`      `[`1.2`](#section-1-2)`. Applicability Statement`

`      `[`1.3`](#section-1-3)`. Executive Summary`

`   `[`2`](#section-2)`. The TCP Authentication Option`

`      `[`2.1`](#section-2-1)`. Review of TCP MD5 Option`

`      `[`2.2`](#section-2-2)`. The TCP Authentication Option Format`

`   `[`3`](#section-3)`. TCP-AO Keys and Their Properties`

`      `[`3.1`](#section-3-1)`. Master Key Tuple`

`      `[`3.2`](#section-3-2)`. Traffic Keys`

`      `[`3.3`](#section-3-3)`. MKT Properties`

`   `[`4`](#section-4)`. Per-Connection TCP-AO Parameters`

`   `[`5`](#section-5)`. Cryptographic Algorithms`

`      `[`5.1`](#section-5-1)`. MAC Algorithms`

`      `[`5.2`](#section-5-2)`. Traffic Key Derivation Functions`

`      `[`5.3`](#section-5-3)`. Traffic Key Establishment and Duration Issues`

`           `[`5.3.1`](#section-5-3-1)`. MKT Reuse Across Socket Pairs`

`           `[`5.3.2`](#section-5-3-2)`. MKTs Use within a Long-Lived Connection`

`   `[`6`](#section-6)`. Additional Security Mechanisms`

`      `[`6.1`](#section-6-1)`. Coordinating Use of New MKTs`

`      `[`6.2`](#section-6-2)`. Preventing Replay Attacks within Long-Lived Connections`

`   `[`7`](#section-7)`. TCP-AO Interaction with TCP`

`      `[`7.1`](#section-7-1)`. TCP User Interface`

`      `[`7.2`](#section-7-2)`. TCP States and Transitions`

`      `[`7.3`](#section-7-3)`. TCP Segments`

`      `[`7.4`](#section-7-4)`. Sending TCP Segments`

`      `[`7.5`](#section-7-5)`. Receiving TCP Segments`

`      `[`7.6`](#section-7-6)`. Impact on TCP Header Size`

`      `[`7.7`](#section-7-7)`. Connectionless Resets`

`      `[`7.8`](#section-7-8)`. ICMP Handling`

`   `[`8`](#section-8)`. Obsoleting TCP MD5 and Legacy Interactions`

`   `[`9`](#section-9)`. Interactions with Middleboxes`

`      `[`9.1`](#section-9-1)`. Interactions with Non-NAT/NAPT Middleboxes`

`      `[`9.2`](#section-9-2)`. Interactions with NAT/NAPT Devices`

`   `[`10`](#section-10)`. Evaluation of Requirements Satisfaction`
...
<a id="section-1-2"></a> **`1.2. Applicability Statement`**
...
<a id="section-1-3"></a> **`1.3. Executive Summary`**
...
<a id="section-2"></a> **`2. The TCP Authentication Option`**
...
<a id="section-2-1"></a> **`2.1. Review of TCP MD5 Option`**
...
<a id="section-2-2"></a> **`2.2. The TCP Authentication Option Format`**
...
<a id="section-3"></a> **`3. TCP-AO Keys and Their Properties`**
...
<a id="section-3-1"></a> **`3.1. Master Key Tuple`**
...
<a id="section-3-2"></a> **`3.2. Traffic Keys`**
...
<a id="section-3-3"></a> **`3.3. MKT Properties`**
...
<a id="section-4"></a> **`4. Per-Connection TCP-AO Parameters`**
...
<a id="section-5"></a> **`5. Cryptographic Algorithms`**
...
<a id="section-5-1"></a> **`5.1. MAC Algorithms`**
...
<a id="section-5-2"></a> **`5.2. Traffic Key Derivation Functions`**
...
<a id="section-5-3"></a> **`5.3. Traffic Key Establishment and Duration Issues`**
...
<a id="section-5-3-1"></a> **`5.3.1. MKT Reuse Across Socket Pairs`**
...
<a id="section-5-3-2"></a> **`5.3.2. MKTs Use within a Long-Lived Connection`**
...
<a id="section-6"></a> **`6. Additional Security Mechanisms`**
...
<a id="section-6-1"></a> **`6.1. Coordinating Use of New MKTs`**
...
<a id="section-6-2"></a> **`6.2. Preventing Replay Attacks within Long-Lived Connections`**
...
<a id="section-7"></a> **`7. TCP-AO Interaction with TCP`**
...
<a id="section-7-1"></a> **`7.1. TCP User Interface`**
...
<a id="section-7-2"></a> **`7.2. TCP States and Transitions`**
...
<a id="section-7-3"></a> **`7.3. TCP Segments`**
...
<a id="section-7-4"></a> **`7.4. Sending TCP Segments`**
...
<a id="section-7-5"></a> **`7.5. Receiving TCP Segments`**
...
<a id="section-7-6"></a> **`7.6. Impact on TCP Header Size`**
...
<a id="section-7-7"></a> **`7.7. Connectionless Resets`**
...
<a id="section-7-8"></a> **`7.8. ICMP Handling`**
...
<a id="section-8"></a> **`8. Obsoleting TCP MD5 and Legacy Interactions`**
...
<a id="section-9"></a> **`9. Interactions with Middleboxes`**
...
<a id="section-9-1"></a> **`9.1. Interactions with Non-NAT/NAPT Middleboxes`**
...
<a id="section-9-2"></a> **`9.2. Interactions with NAT/NAPT Devices`**
...
<a id="section-10"></a> **`10. Evaluation of Requirements Satisfaction`**
