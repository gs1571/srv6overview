...
`   `[`2`](#section-2)`. Goals and Philosophy`

`   `[`3`](#section-3)`. Specification of the Type of Service Octet`

`   `[`4`](#section-4)`. Specification of the TOS Field`

`   `[`5`](#section-5)`. Use of the TOS Field in the Internet Protocols`

`      `[`5.1`](#section-5-1)`. Internet Control Message Protocol (ICMP)`

`      `[`5.2`](#section-5-2)`. Transport Protocols`

`      `[`5.3`](#section-5-3)`. Application Protocols`

`   `[`6`](#section-6)`. ICMP and the TOS Facility`

`      `[`6.1`](#section-6-1)`. Destination Unreachable`

`      `[`6.2`](#section-6-2)`. Redirect`

`   `[`7`](#section-7)`. Use of the TOS Field in Routing`

`      `[`7.1`](#section-7-1)`. Host Routing`

`      `[`7.2`](#section-7-2)`. Forwarding`

`   `[`8`](#section-8)`. Other consequences of TOS`
...
<a id="section-2"></a> **`2. Goals and Philosophy`**
...
<a id="section-3"></a> **`3. Specification of the Type of Service Octet`**
...
<a id="section-4"></a> **`4. Specification of the TOS Field`**
...
<a id="section-5"></a> **`5. Use of the TOS Field in the Internet Protocols`**
...
<a id="section-6"></a> **`6. ICMP and the TOS Facility`**
...
<a id="section-7"></a> **`7. Use of the TOS Field in Routing`**
...
<a id="section-8"></a> **`8. Other consequences of TOS`**
