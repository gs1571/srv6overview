...
`   `[`2`](#section-2)`. Terminology and Architectural Framework`

`     `[`2.1`](#section-2-1)`. Requirements Notation`

`     `[`2.2`](#section-2-2)`. ALTO Terminology`

`     `[`2.3`](#section-2-3)`. Architectural Framework for ALTO`

`   `[`3`](#section-3)`. ALTO Requirements`

`     `[`3.1`](#section-3-1)`. ALTO Client Protocol`

`       `[`3.1.1`](#section-3-1-1)`. General Requirements`

`       `[`3.1.2`](#section-3-1-2)`. Host-Group Descriptor Support`

`       `[`3.1.3`](#section-3-1-3)`. Rating Criteria Support`

`       `[`3.1.4`](#section-3-1-4)`. Placement of Entities and Timing of Transactions`

`       `[`3.1.5`](#section-3-1-5)`. Protocol Extensibility`

`       `[`3.1.6`](#section-3-1-6)`. Error Handling and Overload Protection`

`     `[`3.2`](#section-3-2)`. ALTO Server Discovery`

`     `[`3.3`](#section-3-3)`. Security and Privacy`

`   `[`4`](#section-4)`. IANA Considerations`

`   `[`5`](#section-5)`. Security Considerations`

`     `[`5.1`](#section-5-1)`. High-Level Security Considerations`

`     `[`5.2`](#section-5-2)`. Information Disclosure Scenarios`

`       `[`5.2.1`](#section-5-2-1)`. Classification of Information Disclosure Scenarios .`

`       `[`5.2.2`](#section-5-2-2)`. Discussion of Information Disclosure Scenarios`

`     `[`5.3`](#section-5-3)`. ALTO Server Discovery`

`     `[`5.4`](#section-5-4)`. Security Requirements`
...
<a id="section-2"></a> **`2. Terminology and Architectural Framework`**
...
<a id="section-2-2"></a> **`2.2. ALTO Terminology`**
...
<a id="section-2-3"></a> **`2.3. Architectural Framework for ALTO`**
...
<a id="section-3"></a> **`3. ALTO Requirements`**

```text

```

<a id="section-3-1"></a> **`3.1. ALTO Client Protocol`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. General Requirements`**
...
<a id="section-3-1-2"></a> **`3.1.2. Host-Group Descriptor Support`**
...
<a id="section-3-1-3"></a> **`3.1.3. Rating Criteria Support`**
...
<a id="section-3-1-4"></a> **`3.1.4. Placement of Entities and Timing of Transactions`**
...
<a id="section-3-1-5"></a> **`3.1.5. Protocol Extensibility`**
...
<a id="section-3-1-6"></a> **`3.1.6. Error Handling and Overload Protection`**
...
<a id="section-3-2"></a> **`3.2. ALTO Server Discovery`**
...
<a id="section-3-3"></a> **`3.3. Security and Privacy`**
...
<a id="section-5-1"></a> **`5.1. High-Level Security Considerations`**
...
<a id="section-5-2"></a> **`5.2. Information Disclosure Scenarios`**
...
<a id="section-5-2-1"></a> **`5.2.1. Classification of Information Disclosure Scenarios`**
...
<a id="section-5-2-2"></a> **`5.2.2. Discussion of Information Disclosure Scenarios`**
...
<a id="section-5-3"></a> **`5.3. ALTO Server Discovery`**
...
<a id="section-5-4"></a> **`5.4. Security Requirements`**
