...
`   `[`3`](#section-3)`. RPKI Repository Delta Protocol Implementation`

`     `[`3.1`](#section-3-1)`. Informal Overview`

`     `[`3.2`](#section-3-2)`. Certificate Authority Use`

`     `[`3.3`](#section-3-3)`. Repository Server Use`

`       `[`3.3.1`](#section-3-3-1)`. Initialization`

`       `[`3.3.2`](#section-3-3-2)`. Publishing Updates`

`     `[`3.4`](#section-3-4)`. Relying Party Use`

`       `[`3.4.1`](#section-3-4-1)`. Processing the Update Notification File`

`       `[`3.4.2`](#section-3-4-2)`. Processing Delta Files`

`       `[`3.4.3`](#section-3-4-3)`. Processing a Snapshot File`

`       `[`3.4.4`](#section-3-4-4)`. Polling the Update Notification File`

`       `[`3.4.5`](#section-3-4-5)`. Considerations Regarding Operational Failures in RRDP  11`

`     `[`3.5`](#section-3-5)`. File Definitions`

`       `[`3.5.1`](#section-3-5-1)`. Update Notification File`

`       `[`3.5.2`](#section-3-5-2)`. Snapshot File`

`       `[`3.5.3`](#section-3-5-3)`. Delta File`

`       `[`3.5.4`](#section-3-5-4)`. XML Schema`

`   `[`4`](#section-4)`. Operational Considerations`

`     `[`4.1`](#section-4-1)`. Compatibility with previous standards`

`     `[`4.2`](#section-4-2)`. Distribution Considerations`

`     `[`4.3`](#section-4-3)`. HTTPS Considerations`
...
<a id="section-3"></a> **`3. RPKI Repository Delta Protocol Implementation`**

```text

```

<a id="section-3-1"></a> **`3.1. Informal Overview`**
...
<a id="section-3-2"></a> **`3.2. Certificate Authority Use`**
...
<a id="section-3-3"></a> **`3.3. Repository Server Use`**

```text

```

<a id="section-3-3-1"></a> **`3.3.1. Initialization`**
...
<a id="section-3-3-2"></a> **`3.3.2. Publishing Updates`**
...
<a id="section-3-4"></a> **`3.4. Relying Party Use`**

```text

```

<a id="section-3-4-1"></a> **`3.4.1. Processing the Update Notification File`**
...
<a id="section-3-4-2"></a> **`3.4.2. Processing Delta Files`**
...
<a id="section-3-4-3"></a> **`3.4.3. Processing a Snapshot File`**
...
<a id="section-3-4-4"></a> **`3.4.4. Polling the Update Notification File`**
...
<a id="section-3-4-5"></a> **`3.4.5. Considerations Regarding Operational Failures in RRDP`**
...
<a id="section-3-5"></a> **`3.5. File Definitions`**

```text

```

<a id="section-3-5-1"></a> **`3.5.1. Update Notification File`**

```text

```

<a id="section-3-5-1-1"></a> **`3.5.1.1. Purpose`**
...
<a id="section-3-5-1-2"></a> **`3.5.1.2. Cache Concerns`**
...
<a id="section-3-5-1-3"></a> **`3.5.1.3. File Format and Validation`**
...
<a id="section-3-5-2"></a> **`3.5.2. Snapshot File`**

```text

```

<a id="section-3-5-2-1"></a> **`3.5.2.1. Purpose`**
...
<a id="section-3-5-2-2"></a> **`3.5.2.2. Cache Concerns`**
...
<a id="section-3-5-2-3"></a> **`3.5.2.3. File Format and Validation`**
...
<a id="section-3-5-3"></a> **`3.5.3. Delta File`**

```text

```

<a id="section-3-5-3-1"></a> **`3.5.3.1. Purpose`**
...
<a id="section-3-5-3-2"></a> **`3.5.3.2. Cache Concerns`**
...
<a id="section-3-5-3-3"></a> **`3.5.3.3. File Format and Validation`**
...
<a id="section-3-5-4"></a> **`3.5.4. XML Schema`**
...
<a id="section-4"></a> **`4. Operational Considerations`**

```text

```

<a id="section-4-1"></a> **`4.1. Compatibility with previous standards`**
...
<a id="section-4-2"></a> **`4.2. Distribution Considerations`**
...
<a id="section-4-3"></a> **`4.3. HTTPS Considerations`**
