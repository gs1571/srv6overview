...
**Consensus:** true
**IPR:** trust200902
**Doc Name:** draft-ietf-anima-autonomic-control-plane-30
...
**Keywords:** addressing-scheme, ANI, autonomic networking, autonomous operation, BRSKI, certificate, Data-Plane, domain, DTLS, DULL, EST, GRASP, IDevID, inband, IPsec, IPv6, LDevID, loopback-interface, NOC, OAM, out-of-band, registrar, renewal, RPL, secure, self-management, ULA, VPN, VRF

## Related Documents

- [prev](https://datatracker.ietf.org/doc/draft-ietf-anima-autonomic-control-plane-30)
- [alternate](https://dx.doi.org/10.17487/rfc8994)
...
- [1. Introduction (Informative)](#intro)
  - [1.1. Applicability and Scope](#applicability)
- [2. Acronyms and Terminology (Informative)](#terminology)
- [3. Use Cases for an Autonomic Control Plane (Informative)](#usage)
  - [3.1. An Infrastructure for Autonomic Functions](#infrastructure)
  - [3.2. Secure Bootstrap over an Unconfigured Network](#secure-bootstrap)
  - [3.3. Permanent Reachability Independent of the Data Plane](#reachability)
- [4. Requirements (Informative)](#requirements)
- [5. Overview (Informative)](#overview)
- [6. Self-Creation of an Autonomic Control Plane (ACP) (Normative)](#self-creation)
  - [6.1. Requirements for the Use of Transport Layer Security (TLS)](#tls)
  - [6.2. ACP Domain, Certificate, and Network](#domcert)
    - [6.2.1. ACP Certificates](#acp-certificates)
    - [6.2.2. ACP Certificate AcpNodeName](#domcert-acpinfo)
      - [6.2.2.1. AcpNodeName ASN.1 Module](#asn1)
    - [6.2.3. ACP Domain Membership Check](#certcheck)
      - [6.2.3.1. Realtime Clock and Time Validation](#cert-time)
    - [6.2.4. Trust Anchors (TA)](#trust-anchors)
    - [6.2.5. Certificate and Trust Anchor Maintenance](#domcert-maint)
      - [6.2.5.1. GRASP Objective for EST Server](#domcert-grasp)
      - [6.2.5.2. Renewal](#domcert-renewal)
      - [6.2.5.3. Certificate Revocation Lists (CRLs)](#domcert-crl)
      - [6.2.5.4. Lifetimes](#domcert-lifetime)
      - [6.2.5.5. Reenrollment](#domcert-re-enroll)
      - [6.2.5.6. Failing Certificates](#domcert-failing)
  - [6.3. ACP Adjacency Table](#adj-table)
  - [6.4. Neighbor Discovery with DULL GRASP](#discovery-grasp)
  - [6.5. Candidate ACP Neighbor Selection](#selection)
  - [6.6. Channel Selection](#channel-selection)
  - [6.7. Candidate ACP Neighbor Verification](#neighbor_verification)
  - [6.8. Security Association (Secure Channel) Protocols](#associations)
    - [6.8.1. General Considerations](#general-considerations)
    - [6.8.2. Common Requirements](#common-requirements)
    - [6.8.3. ACP via IPsec](#IPsec-group)
      - [6.8.3.1. Native IPsec](#IPsec)
        - [6.8.3.1.1. RFC 8221 (IPsec/ESP)](#rfc8221req)
        - [6.8.3.1.2. RFC 8247 (IKEv2)](#rfc4247req)
      - [6.8.3.2. IPsec with GRE Encapsulation](#IPsec-GRE)
    - [6.8.4. ACP via DTLS](#DTLS)
    - [6.8.5. ACP Secure Channel Profiles](#Profiles)
  - [6.9. GRASP in the ACP](#GRASP)
    - [6.9.1. GRASP as a Core Service of the ACP](#GRASP-core)
    - [6.9.2. ACP as the Security and Transport Substrate for GRASP](#GRASP-substrate)
      - [6.9.2.1. Discussion](#GRASP-discussion)
  - [6.10. Context Separation](#separation)
  - [6.11. Addressing inside the ACP](#addressing)
    - [6.11.1. Fundamental Concepts of Autonomic Addressing](#addr-fundamentals)
    - [6.11.2. The ACP Addressing Base Scheme](#scheme)
    - [6.11.3. ACP Zone Addressing Sub-Scheme (ACP-Zone)](#zone-scheme)
    - [6.11.4. ACP Manual Addressing Sub-Scheme (ACP-Manual)](#manual-scheme)
    - [6.11.5. ACP Vlong Addressing Sub-Scheme (ACP-Vlong-8/ACP-Vlong-16)](#Vlong)
    - [6.11.6. Other ACP Addressing Sub-Schemes](#other-sub-schemes)
    - [6.11.7. ACP Registrars](#acp-registrars)
      - [6.11.7.1. Use of BRSKI or Other Mechanisms or Protocols](#registrars-protocols)
      - [6.11.7.2. Unique Address/Prefix Allocation](#registrars-unique)
      - [6.11.7.3. Addressing Sub-Scheme Policies](#registrars-policy)
      - [6.11.7.4. Address/Prefix Persistence](#registrars-renewal)
      - [6.11.7.5. Further Details](#registrars-further)
  - [6.12. Routing in the ACP](#routing)
    - [6.12.1. ACP RPL Profile](#rpl-profile)
      - [6.12.1.1. Overview](#rpl-summary)
        - [6.12.1.1.1. Single Instance](#rpl-single-instance)
        - [6.12.1.1.2. Reconvergence](#rpl-convergence)
      - [6.12.1.2. RPL Instances](#rpl-instances)
      - [6.12.1.3. Storing vs. Non-Storing Mode](#rpl-storing)
      - [6.12.1.4. DAO Policy](#rpl-dao-policy)
      - [6.12.1.5. Path Metrics](#rpl-path-metric)
      - [6.12.1.6. Objective Function](#rpl-objective-function)
      - [6.12.1.7. DODAG Repair](#rpl-dodag-repair)
      - [6.12.1.8. Multicast](#rpl-multicast)
      - [6.12.1.9. Security](#rpl-security)
      - [6.12.1.10. P2P Communications](#rpl-p2p)
      - [6.12.1.11. IPv6 Address Configuration](#rpl-ipv6)
      - [6.12.1.12. Administrative Parameters](#rpl-admin)
      - [6.12.1.13. RPL Packet Information](#rpl-Data-Plane)
      - [6.12.1.14. Unknown Destinations](#rpl-unknown)
  - [6.13. General ACP Considerations](#acp_general)
    - [6.13.1. Performance](#performance)
    - [6.13.2. Addressing of Secure Channels](#general_addressing)
    - [6.13.3. MTU](#general_MTU)
    - [6.13.4. Multiple Links between Nodes](#general_multipath)
    - [6.13.5. ACP Interfaces](#ACP_interfaces)
      - [6.13.5.1. ACP Loopback Interfaces](#ACP-loopback)
      - [6.13.5.2. ACP Virtual Interfaces](#ACP-virtual-interfaces)
        - [6.13.5.2.1. ACP Point-to-Point Virtual Interfaces](#ACP-p2p-virtual-interfaces)
        - [6.13.5.2.2. ACP Multi-Access Virtual Interfaces](#ACP-ma-virtual-interfaces)
- [7. ACP Support on L2 Switches/Ports (Normative)](#acp-l2-switches)
  - [7.1. Why (Benefits of ACP on L2 Switches)](#acp-l2-switches-why)
  - [7.2. How (per L2 Port DULL GRASP)](#acp-l2-switches-how)
- [8. Support for Non-ACP Components (Normative)](#workarounds)
  - [8.1. ACP Connect](#ACPconnect)
    - [8.1.1. Non-ACP Controller and/or Network Management System (NMS)](#NMS)
    - [8.1.2. Software Components](#software)
    - [8.1.3. Autoconfiguration](#ACautoconfig)
    - [8.1.4. Combined ACP and Data Plane Interface (VRF Select)](#SingleIF)
    - [8.1.5. Use of GRASP](#ACgrasp)
  - [8.2. Connecting ACP Islands over Non-ACP L3 Networks (Remote ACP Neighbors)](#remote-acp-neighbors)
    - [8.2.1. Configured Remote ACP Neighbor](#conf-remote)
    - [8.2.2. Tunneled Remote ACP Neighbor](#conf-tunnel)
    - [8.2.3. Summary](#conf-summary)
- [9. ACP Operations (Informative)](#operational)
  - [9.1. ACP (and BRSKI) Diagnostics](#diagnostics)
    - [9.1.1. Secure Channel Peer Diagnostics](#ta-troubleshoot)
  - [9.2. ACP Registrars](#registrar-considerations)
    - [9.2.1. Registrar Interactions](#reg-interact)
    - [9.2.2. Registrar Parameters](#reg-config)
    - [9.2.3. Certificate Renewal and Limitations](#cert-renewal)
    - [9.2.4. ACP Registrars with Sub-CA](#sub-ca)
    - [9.2.5. Centralized Policy Control](#pms)
  - [9.3. Enabling and Disabling the ACP and/or the ANI](#enabling-acp)
    - [9.3.1. Filtering for Non-ACP/ANI Packets](#secure-enabling)
    - [9.3.2. "admin down" State](#admin-down)
      - [9.3.2.1. Security](#down-security)
      - [9.3.2.2. Fast State Propagation and Diagnostics](#down-fast-state-propagation)
      - [9.3.2.3. Low-Level Link Diagnostics](#low-level-link)
      - [9.3.2.4. Power Consumption Issues](#power-consumption)
    - [9.3.3. Enabling Interface-Level ACP and ANI](#if-enable)
    - [9.3.4. Which Interfaces to Auto-Enable?](#if-enable-auto)
    - [9.3.5. Enabling Node-Level ACP and ANI](#node-enable)
      - [9.3.5.1. Brownfield Nodes](#brownfield)
      - [9.3.5.2. Greenfield Nodes](#greenfield)
    - [9.3.6. Undoing "ANI/ACP enable"](#disabling)
    - [9.3.7. Summary](#enable-summary)
  - [9.4. Partial or Incremental Adoption](#incremental-adoption)
  - [9.5. Configuration and the ACP (Summary)](#configuration)
- [10. Summary: Benefits (Informative)](#benefit)
  - [10.1. Self-Healing Properties](#self-healing)
  - [10.2. Self-Protection Properties](#self-protecting)
    - [10.2.1. From the Outside](#self-protecting-outside)
    - [10.2.2. From the Inside](#self-protecting-inside)
  - [10.3. The Administrator View](#admin-view)
- [11. Security Considerations](#security)
- [12. IANA Considerations](#iana)
- [13. References](#section-13)
  - [13.1. Normative References](#section-13.1)
  - [13.2. Informative References](#section-13.2)
- [Appendix A. Background and Future (Informative)](#further)
  - [A.1. ACP Address Space Schemes](#address-spaces)
  - [A.2. BRSKI Bootstrap (ANI)](#bootstrap)
  - [A.3. ACP Neighbor Discovery Protocol Selection](#discovery)
    - [A.3.1. LLDP](#discovery-lldp)
    - [A.3.2. mDNS and L2 Support](#discovery-mdns)
    - [A.3.3. Why DULL GRASP?](#discovery-comparison)
  - [A.4. Choice of Routing Protocol (RPL)](#why-rpl)
  - [A.5. ACP Information Distribution and Multicast](#acp-grasp)
  - [A.6. CAs, Domains, and Routing Subdomains](#domain-usage)
  - [A.7. Intent for the ACP](#intent)
  - [A.8. Adopting ACP Concepts for Other Environments](#reuse-acp)
  - [A.9. Further (Future) Options](#futures)
    - [A.9.1. Auto-Aggregation of Routes](#auto-aggregation)
    - [A.9.2. More Options for Avoiding IPv6 Data Plane Dependencies](#dp-dependency)
    - [A.9.3. ACP APIs and Operational Models (YANG)](#acp-api)
    - [A.9.4. RPL Enhancements](#future-rpl)
    - [A.9.5. Role Assignments](#role-assignments)
    - [A.9.6. Autonomic L3 Transit](#l3-transit)
    - [A.9.7. Diagnostics](#future-diag)
    - [A.9.8. Avoiding and Dealing with Compromised ACP Nodes](#compromised)
    - [A.9.9. Detecting ACP Secure Channel Downgrade Attacks](#downgrade)
...
Autonomic Networking is a concept of self-management: autonomic functions self-configure, and negotiate parameters and settings across the network. "[Autonomic Networking: Definitions and Design Goals](#RFC7575)" [RFC7575](#RFC7575) defines the fundamental ideas and design goals of Autonomic Networking.  A gap analysis of Autonomic Networking is given in "[General Gap Analysis for Autonomic Networking](#RFC7576)" [RFC7576](#RFC7576).  The reference architecture for Autonomic Networking in the IETF is specified in the document "[A Reference Model for Autonomic Networking](#RFC8993)" [RFC8993](#RFC8993).
...
Autonomic functions need an autonomically built communications
      ...
      reusable by all autonomic functions.  [RFC7575](#RFC7575) introduces that infrastructure and calls it the Autonomic Control Plane (ACP).  More descriptively, it could be called the "Autonomic communications infrastructure for OAM and control".  For naming consistency with that prior document, this document continues to use the name ACP.
...
For an example of in-band management failing in the face of operator-induced misconfiguration, see [FCC](#FCC), for example, Section III.B.15 on page 8:
...
Like the forwarding plane for "data" packets, the non-autonomous control and management plane functions can then be managed and/or used via the ACP. This terminology is consistent with preexisting documents such as "[Using an Autonomic Control Plane for Stable Connectivity of Network Operations, Administration, and Maintenance (OAM)](#RFC8368)" [RFC8368](#RFC8368).

In both autonomous and non-autonomous instances, the ACP is built such that it operates in the absence of the data plane.
The ACP also operates in the presence of any (mis)configured non-autonomous management and/or control components in the data plane.

The ACP serves several purposes simultaneously:

1. Autonomic functions communicate over the ACP.  The ACP therefore directly supports Autonomic Networking functions, as described in [RFC8993](#RFC8993).  For example, GRASP ("[GeneRic Autonomic Signaling Protocol (GRASP)](#RFC8990)" [RFC8990](#RFC8990)) runs securely inside the ACP and depends on the ACP as its "security and transport substrate".
2. A controller or network management system can use ACP to securely bootstrap network devices in remote locations, even if the (data plane) network in between is not yet configured; no bootstrap configuration that is dependent on the data plane is required.  An example of such a secure bootstrap process is described in "[Bootstrapping Remote Secure Key Infrastructure (BRSKI)](#RFC8995)" [RFC8995](#RFC8995).
...
This document describes these purposes as use cases for the ACP in [Section 3](#usage), and it defines the requirements in [Section 4](#requirements). [Section 5](#overview) gives an overview of how the ACP is constructed.

The normative part of this document starts with [Section 6](#self-creation), where the ACP is specified. [Section 7](#acp-l2-switches) explains how to support ACP on Layer 2 (L2) switches (normative). [Section 8](#workarounds) explains how non-ACP nodes and networks can be integrated (normative).

The remaining sections are non-normative. [Section 10](#benefit) reviews the benefits of the ACP (after all the details have been defined). [Section 9](#operational) provides operational recommendations. [Appendix A](#further) 
...
There are no dependencies on [Appendix A](#further) in order to build a complete working and interoperable
ACP according to this document.

The ACP provides secure IPv6 connectivity; therefore, it can be used for secure connectivity not only for self-management as required for the ACP in [RFC7575](#RFC7575) but also for traditional (centralized) management. The ACP can be implemented and operated without any other components of Autonomic Networks, except for GRASP. ACP relies on per-link Discovery Unsolicited Link-Local (DULL) GRASP (see [Section 6.4](#discovery-grasp)) to auto-discover ACP neighbors and includes the ACP GRASP instance to provide service discovery for clients of the ACP (see [Section 6.9](#GRASP)), including for its own maintenance of ACP certificates.

The document [RFC8368](#RFC8368) describes how the ACP can be used alone to provide secure and stable connectivity for autonomic and non-autonomic OAM applications, specifically for the case of current non-autonomic networks and/or nodes. That document also explains how existing management solutions can leverage the ACP in parallel with traditional management models, when to use the ACP, and how to integrate with potentially IPv4-only OAM backends.

Combining ACP with Bootstrapping Remote Secure Key Infrastructure (BRSKI) (see [RFC8995](#RFC8995)) results in the "Autonomic Network Infrastructure" (ANI) as defined in [RFC8993](#RFC8993), which provides autonomic connectivity (from ACP) with secure zero-touch (automated) bootstrap from BRSKI.  The ANI itself does not constitute an Autonomic Network, but it allows the building of more or less Autonomic Networks on top of it, using either centralized automation in SDN style (see "[Software-Defined Networking (SDN): Layers and Architecture Terminology](#RFC7426)" [RFC7426](#RFC7426)) or distributed automation via Autonomic Service Agents (ASA) and/or Autonomic Functions (AF), or a mixture of both.  See [RFC8993](#RFC8993) for more information.

<a name="applicability"></a>
## Applicability and Scope

Please see the following Terminology section ([Section 2](#terminology)) for explanations of terms used in this section.

The design of the ACP as defined in this document is considered to
	...
	[Operational Technology](#ot) (OT) networks. The ACP can operate equally on Layer 3 (L3) equipment and on L2 equipment such as bridges (see [Section 7](#acp-l2-switches)). The hop-by-hop authentication, integrity protection, and confidentiality mechanism used by the ACP is defined to be negotiable; therefore, it can be extended  to environments with different protocol preferences. The minimum implementation requirements in this document attempt to achieve maximum interoperability by requiring support for multiple options depending on the type of device: IPsec (see "[Security Architecture for the Internet Protocol](#RFC4301)" [RFC4301](#RFC4301)) and Datagram Transport Layer Security (DTLS, see [Section 6.8.4](#DTLS)).

The implementation footprint of the ACP consists of Public Key Infrastructure (PKI) code for the ACP certificate including EST (see "[Enrollment over Secure Transport](#RFC7030)" [RFC7030](#RFC7030)), GRASP, UDP, TCP, and Transport Layer Security (TLS, see [Section 6.1](#tls)). For more information regarding the security and reliability of GRASP and for EST, the ACP secure channel protocol used (such as IPsec or DTLS), and an instance of IPv6 packet forwarding and routing via RPL, see "[RPL: IPv6 Routing Protocol for Low-Power and Lossy Networks](#RFC6550)" [RFC6550](#RFC6550), which is separate from routing and forwarding for the data plane (user traffic).
...
The ACP design can be applicable to devices constrained with respect to CPU and memory, and to networks constrained with respect to bitrate and reliability,
but this document does not attempt to define the most constrained type of devices or networks to which the ACP is applicable. RPL and DTLS for ACP secure channels are two protocol choices already making ACP more applicable to constrained environments. Support for constrained devices in this specification is opportunistic, but not complete, because the reliable transport for GRASP (see [Section 6.9.2](#GRASP-substrate)) only specifies TCP/TLS.  See [Appendix A.8](#reuse-acp) for discussions about how future standards or proprietary extensions and/or variations of the ACP could better meet expectations that are different from those upon which the current design is based, including supporting constrained devices better.

<a name="terminology"></a>
# Acronyms and Terminology (Informative)

This document serves both as a normative specification for ACP
...
This document introduces or uses the following terms (sorted alphabetically).  Introduced terms are
        explained on first use, so this list is for reference only.

**ACP:**
  Autonomic Control Plane.  The [autonomic function](#af-def) as defined in this document.
              ...
              The ACP is primarily meant to be used as a component of the [ANI](#ani-def) to enable [Autonomic Networks](#an-def),
              but it can equally be used in simple ANI networks (with no other autonomic functions) or
              completely by itself.

**ACP address:**
  An IPv6 address assigned to the ACP node.  It is stored
              in the [acp-node-name](#acp-node-name-def) of the [ACP certificate](#domcert-def).
...
**ACP certificate:**
  A Local Device IDentity ([LDevID](#ldevid)) certificate conforming to "[Internet X.509 Public Key Infrastructure Certificate and Certificate Revocation List (CRL) Profile](#RFC5280)" [RFC5280](#RFC5280) that carries the [acp-node-name](#acp-node-name-def), which is used by the ACP to learn its address in the ACP and to derive and cryptographically assert its membership in the ACP domain.  In the context of the ANI, the ACP certificate is also called the ANI certificate.
  In the context of AN, the ACP certificate is also called the AN certificate.

**ACP connect interface:**
  An interface on an ACP node that provides access to the ACP for non-ACP-capable nodes without using an ACP secure channel.  See [Section 8.1.1](#NMS).

**ACP domain:**
  The ACP domain is the set of nodes with [ACP certificates](#domcert-def) that allow them to authenticate each other as members of the ACP domain.  See also [Section 6.2.3](#certcheck).

**ACP loopback interface:**
  The loopback interface in the ACP [VRF](#vrf-def) that has the ACP address assigned to it. See [Section 6.13.5.1](#ACP-loopback).

**ACP network:**
  The ACP network comprises all the nodes that have access to the ACP.
...
**ACP (ULA) prefix(es):**
  The /48 IPv6 address prefixes used across the ACP.  In the normal or simple case, the ACP has one [Unique Local Address (ULA)](#ula-def) prefix, see [Section 6.11](#addressing).  The ACP routing table may include multiple ULA prefixes if the rsub option is used to create addresses from more than one ULA prefix.  See [Section 6.2.2](#domcert-acpinfo).  The ACP may also include non-ULA prefixes if those are configured on ACP connect interfaces.  See [Section 8.1.1](#NMS).

**ACP secure channel:**
  A channel authenticated via [ACP certificates](#domcert-def) providing integrity protection and confidentiality through encryption. These channels are established between (normally) adjacent ACP nodes to carry ACP [VRF](#vrf-def) traffic in-band over the same links and paths as data plane traffic but isolate it from the data plane traffic and secure it.

**ACP secure channel protocol:**
  The protocol used to build an ACP secure channel,
              e.g., Internet Key Exchange Protocol version 2 (IKEv2) with IPsec or DTLS.

**ACP virtual interface:**
  An interface in the ACP [VRF](#vrf-def) mapped to one or more
              ACP secure channels.  See [Section 6.13.5](#ACP_interfaces).

**acp-node-name field:**
  An information field in the [ACP certificate](#domcert-def) in which the following ACP-relevant information is encoded: the ACP domain name, the ACP IPv6 address of the node, and optional additional role attributes about the node.

**AN:**
  Autonomic Network. A network according to [RFC8993](#RFC8993).
              Its main components are [ANI](#ani-def), [autonomic functions](#af-def), and [Intent](#intent-def).

**(AN) Domain Name:**
  An FQDN (Fully Qualified Domain Name) in the acp-node-name of the domain certificate.  See [Section 6.2.2](#domcert-acpinfo).

**ANI (nodes/network):**
  Autonomic Network Infrastructure. 
              The ANI is the infrastructure to enable [Autonomic Networks](#an-def).  It includes ACP, BRSKI, and GRASP. 
              Every Autonomic Network includes the ANI, but not every ANI network needs to include [autonomic functions](#af-def) beyond the ANI (nor [Intent](#intent-def)).  An ANI network without further autonomic functions can, for example, support secure zero-touch (automated) bootstrap
              and stable connectivity for SDN networks, see [RFC8368](#RFC8368).
...
**ASA:**
  Autonomic Service Agent.  Autonomic software modules running on
              an [ANI](#ani-def) device.  The components making up the ANI (BRSKI, ACP, and GRASP) are also described as ASAs.

**autonomic function:**
  A function and/or service in an Autonomic Network (AN)
              composed of one or more ASAs across one or more ANI nodes.

**BRSKI:**
  Bootstrapping Remote Secure Key Infrastructure
              [RFC8995](#RFC8995).  A protocol extending [EST](#est-def) to
...
**data plane:**
  The counterpoint to the ACP [VRF](#vrf-def) in an ACP node: the forwarding of user traffic 
              in non-autonomous nodes and/or networks and also any non-autonomous control and/or management plane functions.
              In a fully [Autonomic Network](#an-def) node, the data plane is managed autonomically via [autonomic
              functions](#af-def) and [Intent](#intent-def). See [Section 1](#intro) for more details.

**device:**
  A physical system or physical node.

**enrollment:**
  The process by which a node authenticates itself to a
              network with an initial identity, which is often called an [Initial Device IDentity (IDevID)](#idevid-def) certificate, and acquires from the network
              a network-specific identity, which is often called an [LDevID](#ldevid) certificate, and certificates of one or more [trust anchor(s)](#ta-def).
              In the ACP, the LDevID certificate is called the [ACP certificate](#domcert-def).

**EST:**
  Enrollment over Secure Transport [RFC7030](#RFC7030).  IETF
              Standards Track protocol for enrollment of a node with an [LDevID](#ldevid) certificate.  BRSKI is based on EST.

**GRASP:**
  GeneRic Autonomic Signaling Protocol.  An extensible signaling
              protocol required by the ACP for ACP neighbor discovery.

  The ACP also provides the
              ...
              [autonomic functions](#af-def).  See [RFC8990](#RFC8990).

**IDevID:**
  An Initial Device IDentity X.509 certificate installed by
              ...
              and serial number.  See [AR8021](#AR8021). The IDevID certificate cannot be used as a node identifier for the
...
**in-band (as in management or signaling):**
  In-band management traffic and/or control plane signaling uses the same network
              ...
              Compared to [out-of-band](#out-of-band-def), the in-band mechanism
              requires no additional physical resources, but it introduces potentially circular
              dependencies for its correct operations.
              See [Section 1](#intro).

**Intent:**
  The policy language of an Autonomic Network according to [RFC8993](#RFC8993).

**Loopback interface:**
  See 
              [ACP loopback interface](#acp-loopback-def).

**LDevID:**
  A Local Device IDentity is an X.509 certificate installed during
              [enrollment](#enrollment-def).  The [domain certificate](#domcert-def) used by the ACP is an LDevID certificate.  See [AR8021](#AR8021).

**management:**
  Used in this document as another word for [OAM](#OAM).
...
**MIC:**
  Manufacturer Installed Certificate.  A synonym for an [IDevID](#idevid-def) in referenced materials. This term is not used in this document.
...
**Node-ID:**
  The identifier of an ACP node inside that ACP. It is either the last 64 bits (see [Section 6.11.3](#zone-scheme)) or 78 bits (see [Section 6.11.5](#Vlong)) of the ACP address.
...
**Operational Technology (OT):**
  "The hardware and software dedicated to detecting or causing changes
                ...
                devices such as valves, pumps, etc." [OP-TECH](#OP-TECH). In most cases today, OT networks are 
...
**out-of-band network, virtual:**
  The ACP can be called a virtual out-of-band network for management and control
               ...
               [out-of-band network](#out-of-band-def)
               even though it is physically carried [in-band](#in-band-def).
               See [Section 1](#intro).

**root CA:**
  root Certification Authority. A [CA](#ca-def) for which the root CA key update
  	procedures of [RFC7030](#RFC7030), can be applied.

**RPL:**
  IPv6 Routing Protocol for Low-Power and Lossy Networks.  The routing protocol used in the ACP. See [RFC6550](#RFC6550).

**registrar (ACP, ANI/BRSKI):**
  An ACP registrar is an entity (software and/or person) that orchestrates
              the [enrollment](#enrollment-def) of ACP nodes with the [ACP certificate](#domcert-def). ANI nodes use
              BRSKI, so ANI registrars are also called BRSKI registrars. For non-ANI ACP nodes,
              the registrar mechanisms are not defined in this document. See [Section 6.11.7](#acp-registrars). 
              ...
              ACP certificate renewal (see [Section 6.2.5](#domcert-maint)). BRSKI
...
**RPI:**
  RPL Packet Information. Network extension headers for use with  
              [RPL](#rpl-def).
              Not used with RPL in the ACP. See [Section 6.12.1.13](#rpl-Data-Plane).

**RPL:**
  Routing Protocol for Low-Power and Lossy Networks. The routing protocol used in the ACP.  See [Section 6.12](#routing).
...
**TA:**
  Trust Anchor. A TA is an entity that
  	is trusted for the purpose of certificate validation. TA 
  	information such as self-signed certificate(s) of the TA is
  	configured into the ACP node as part of [enrollment](#enrollment-def). See [RFC5280](#RFC5280).
...
**UDI:**
  Unique Device Identifier.  In the context of this document, unsecured
              ...
              serial number, often in a vendor-specific format.  See [sUDI](#sudi) and [LDevID](#ldevid).

**ULA (Global ID prefix):**
  A Unique Local Address is an IPv6
              address in the block fc00::/7, defined in "[Unique Local IPv6 Unicast Addresses](#RFC4193)" [RFC4193](#RFC4193).  ULA is the
              IPv6 successor of the IPv4 private address space ("[Address Allocation for Private Internets](#RFC1918)" [RFC1918](#RFC1918)).
...
## Permanent Reachability Independent of the Data Plane
...
Assuming appropriate implementation (see [Section 6.13.2](#general_addressing) for more details), the ACP provides reachability that is independent of the data plane. This  allows the control plane and OAM plane to operate more robustly:
...
The following requirements were identified for the design of the ACP based on the above use cases ([Section 3](#usage)). These requirements are informative. The ACP as specified in the normative parts of this document is meeting or exceeding these use case requirements:
...
3. The ACP must use an autonomically managed address space.  An autonomically managed address space provides ease of bootstrap and setup ("autonomic"), and robustness (the administrator cannot break network easily).  This document uses ULA for this purpose, see [RFC4193](#RFC4193).
...
The explanation for [ACP4](#acp4) is as follows: in a fully Autonomic Network (AN), all newly written ASAs could potentially communicate with each other exclusively via GRASP, and if that were the only requirement for the ACP, it would not need to provide IPv6-layer connectivity between nodes, but only GRASP connectivity. Nevertheless, because ACP also intends to support non-autonomous networks, it is crucial to support IPv6-layer connectivity across the ACP to support any transport-layer and application-layer protocols.

The ACP operates hop-by-hop because this interaction can be built on IPv6 link-local addressing, which is autonomic, and has no dependency on configuration (requirement [ACP1](#acp1)).  It may be necessary to have ACP connectivity across non-ACP nodes, for example, to link ACP nodes over the general Internet.  This is possible, but it introduces a dependency on stable and/or resilient routing over the non-ACP hops (see [Section 8.2](#remote-acp-neighbors)).

<a name="overview"></a>
# Overview (Informative)

When a node has an ACP certificate (see [Section 6.2.1](#acp-certificates)) and is enabled to bring up the ACP (see [Section 9.3.5](#node-enable)), it will create its ACP without any configuration as follows. For details, see [Section 6](#self-creation) and following sections:

1. The node creates a VRF instance or a similar virtual context for the ACP.
2. The node assigns its ULA IPv6 address (prefix) (see [Section 6.11](#addressing)), which is learned from the acp-node-name (see [Section 6.2.2](#domcert-acpinfo)) of its ACP certificate (see [Section 6.2.1](#acp-certificates)), to an ACP loopback interface (see [Section 6.11](#addressing)) and connects this interface to the ACP VRF.
3. The node establishes a list of candidate peer adjacencies and candidate channel types to try for the adjacency. This is automatic for all candidate link-local adjacencies (see [Section 6.4](#discovery-grasp)) across all native interfaces (see [Section 9.3.4](#if-enable-auto)). If a candidate peer is discovered via multiple interfaces, this will result in one adjacency per interface. If the ACP node has multiple interfaces connecting to the same subnet across which it is also operating as an L2 switch in the data plane, it employs methods for ACP with L2 switching, see [Section 7](#acp-l2-switches).
4. For each entry in the candidate adjacency list, the node negotiates a secure tunnel using the candidate channel types.  See [Section 6.6](#channel-selection).
5. The node authenticates the peer node during secure channel setup and authorizes it to become part of the ACP according to [Section 6.2.3](#certcheck).
6. Unsuccessful authentication of a candidate peer results in throttled connection retries for as long as the candidate peer is discoverable. See [Section 6.7](#neighbor_verification).
7. Each successfully established secure channel is mapped to an ACP virtual interface, which is placed into the ACP VRF.  See [Section 6.13.5.2](#ACP-virtual-interfaces).
8. Each node runs a lightweight routing protocol (see [Section 6.12](#routing)) to announce reachability of the ACP loopback address (or prefix) across the ACP.
...
- Additional candidate peer adjacencies for ACP connections across non-ACP Layer 3 clouds requires explicit configuration. See [Section 8.2](#remote-acp-neighbors).

[Figure 1](#acp) illustrates the ACP.
...
Attacks against the network via incorrect routing or addressing information for the data plane will not impact the ACP. Even impaired ACP nodes will have a significantly reduced attack surface against malicious misconfiguration because only very limited ACP or interface up/down configuration can affect the ACP, and depending on their specific designs, these types of attacks could also be eliminated. See more in [Section 9.3](#enabling-acp) and [Section 11](#security).

An ACP node can be a router, switch, controller, NMS host, or any other IPv6-capable node.  Initially, it **MUST** have its ACP certificate, as well as an (empty) ACP adjacency table (described in [Section 6.3](#adj-table)).  It then can start to discover ACP neighbors and build the ACP.  This is described step by step in the following sections.

<a name="tls"></a>
## Requirements for the Use of Transport Layer Security (TLS)

The following requirements apply to TLS that is required or used by ACP components. Applicable ACP components include ACP certificate maintenance via EST (see [Section 6.2.5](#domcert-maint)), TLS connections for CRL Distribution Point (CRLDP) or Online Certificate Status Protocol (OCSP) responder (if used, see [Section 6.2.3](#certcheck)), and ACP GRASP (see [Section 6.9.2](#GRASP-substrate)). On ANI nodes, these requirements also apply to BRSKI.

TLS **MUST** comply with "[Recommendations for Secure Use of Transport Layer Security (TLS) and Datagram Transport Layer Security (DTLS)](#RFC7525)" [RFC7525](#RFC7525) except that TLS 1.2 ("[The Transport Layer Security (TLS) Protocol Version 1.2](#RFC5246)" [RFC5246](#RFC5246)) is **REQUIRED** and that older versions of TLS **MUST NOT** be used.  TLS 1.3 ("[The Transport Layer Security (TLS) Protocol Version 1.3](#RFC8446)" [RFC8446](#RFC8446)) **SHOULD** be supported. The choice for TLS 1.2 as the lowest common denominator for the ACP is based on the currently expected and most likely availability across the wide range of candidate ACP node types, potentially with non-agile operating system TCP/IP stacks.
...
TLS **MUST** also include the "Supported Elliptic Curves" extension, and it **MUST** support the NIST P-256 (secp256r1(22)) and P-384 (secp384r1(24)) curves "[Elliptic Curve Cryptography (ECC) Cipher Suites for Transport Layer Security (TLS) Versions 1.2 and Earlier](#RFC8422)" [RFC8422](#RFC8422).  In addition, TLS 1.2 clients **SHOULD** send an ec_point_format extension with a single element, "uncompressed".

<a name="domcert"></a>
## ACP Domain, Certificate, and Network

The ACP relies on group security.  An ACP domain is a group of nodes that trust
...
keying material: an ACP node **MUST** have an LDevID certificate
and information about one or more TAs
as required for the ACP domain membership check ([Section 6.2.3](#certcheck)).
...
The ACP does not mandate specific mechanisms by which this keying material is provisioned into the ACP node. It only requires that the certificate comply with [Section 6.2.1](#acp-certificates), specifically that it have the acp-node-name as specified in [Section 6.2.2](#domcert-acpinfo) in its domain certificate as well as those of candidate ACP peers.  See [Appendix A.2](#bootstrap) for more information about enrollment or provisioning options.

This document uses the term ACP in many places where the Autonomic Networking reference documents [RFC7575](#RFC7575) and [RFC8993](#RFC8993) use the word autonomic.  This is done because those reference documents consider (only) fully Autonomic Networks and nodes, but the support of ACP does not require the support for other components of Autonomic Networks except for the reliance on GRASP and the providing of security and transport for GRASP.  Therefore, the word autonomic might be misleading to operators interested in only the ACP.

[RFC7575](#RFC7575) defines the term "autonomic domain" as a collection of autonomic nodes.  ACP nodes do not need to be fully autonomic, but when they are, then the ACP domain is an autonomic domain.  Likewise, [RFC8993](#RFC8993) defines the term "domain certificate" as the certificate used in an autonomic domain.  The ACP certificate is that domain certificate when ACP nodes are (fully) autonomic nodes.  Finally, this document uses the term ACP network to refer to the network created by active ACP nodes in an ACP domain.  The ACP network itself can extend beyond ACP nodes through the mechanisms described in [Section 8.1](#ACPconnect).

<a name="acp-certificates"></a>
### ACP Certificates

ACP certificates **MUST** be [RFC5280](#RFC5280) compliant X.509 v3 [X.509](#X.509) certificates.
...
Any secure channel protocols used for the ACP as specified in this document or extensions of this document **MUST** therefore support authentication (e.g., signing), starting with these types of certificates. See [RFC8422](#RFC8422) for more information.

The reason for these choices are as follows: as of 2020, RSA is still more widely used than ECC, therefore the **MUST**-level requirements for RSA. ECC offers equivalent security at (logarithmically) shorter key lengths (see [RFC8422](#RFC8422)). This can be beneficial especially in the presence of constrained bandwidth or constrained nodes in an ACP/ANI network. Some ACP functions such as GRASP peer-to-peer across the ACP require end-to-end/any-to-any authentication and authorization, therefore ECC can only reliably be used in the ACP when it **MUST** be supported on all ACP nodes. RSA signatures are mandatory to be supported also for ECC certificates because the CAs themselves may not support ECC yet.

The ACP certificate **SHOULD** be used for any authentication between nodes with ACP
...
[Section 6.2.3](#certcheck) defines this "ACP domain membership check".
The uses of this check that are standardized in this document are for the establishment of
hop-by-hop ACP secure channels ([Section 6.8](#associations)) and for ACP GRASP ([Section 6.9.2](#GRASP-substrate)) end to end via TLS.

The ACP domain membership check requires a minimum number of elements in a certificate as described in [Section 6.2.3](#certcheck). The identity of a node in the ACP is carried via the acp-node-name as defined in [Section 6.2.2](#domcert-acpinfo).

To support Elliptic Curve Diffie-Hellman (ECDH) directly with the key in the ACP certificate,
...
required ciphersuites in this document and may not be supported by all CAs.

Any other fields of the ACP certificate are to be populated as required by [RFC5280](#RFC5280). As long as they are compliant with [RFC5280](#RFC5280), any other field of an ACP certificate can be set as desired by the operator of the ACP domain through the appropriate ACP registrar and/or ACP CA procedures. For example, other fields may be required for purposes other than those that the ACP certificate is intended to be used for (such as elements of a SubjectName).

For further certificate details, ACP certificates may follow the recommendations from [CABFORUM](#CABFORUM).

For diagnostic and other operational purposes, it is beneficial
	  to copy the device-identifying fields of the node's IDevID
	  certificate into the ACP certificate, such as the 
"serialNumber" attribute 
([X.520](#X.520), Section 6.2.9) 
in the subject field distinguished name encoding. Note
	  that this is not the certificate serial-number.  See also [RFC8995](#RFC8995). This can be done, for example, if it would be acceptable for the device's "serialNumber" to be signaled via the Link Layer Discovery Protocol [LLDP](#LLDP) because, like LLDP-signaled information, the ACP certificate information can be retrieved by neighboring nodes without further authentication and can be used either for beneficial diagnostics or for malicious attacks. Retrieval of the ACP certificate is possible via a (failing) attempt to set up an ACP secure channel, and the "serialNumber" usually contains device type information that may help to more quickly determine working exploits/attacks against the device.

Note that there is no intention to constrain authorization within the ACP or Autonomic Networks using the ACP to just the ACP domain membership check as defined in this document. It can be extended or modified with additional requirements. Such future authorizations can use and require additional elements in certificates or policies or even additional certificates. See [Section 6.2.5](#domcert-maint) for the additional check against the id-kp-cmcRA extended key usage attribute ("[Certificate Management over CMS (CMC) Updates](#RFC6402)" [RFC6402](#RFC6402)), and  see [Appendix A.9.5](#role-assignments) for possible future extensions.

<a name="domcert-acpinfo"></a>
...
Given an ACP address of fd89:b714:f3db:0:200:0:6400:0000,
    ...
    and an rsub extension of area51.research, then this results in the following:
...
The acp-node-name in [Figure 2](#acp-dominfo-abnf) is the ABNF definition ("[Augmented BNF for Syntax Specifications: ABNF](#RFC5234)" [RFC5234](#RFC5234)) of the ACP Node Name. An ACP certificate **MUST** carry this information. It **MUST** contain an otherName field in the X.509 Subject Alternative Name extension, and the otherName **MUST** contain an AcpNodeName as described in [Section 6.2.2](#domcert-acpinfo).

Nodes complying with this specification **MUST** be able to receive their ACP address through the domain certificate, in which case their own ACP certificate **MUST** have a 32HEXDIG acp-address field. The acp-address field is case insensitive because ABNF HEXDIG is. It is recommended to encode acp-address with lowercase letters. Nodes complying with this specification **MUST** also be able to authenticate nodes as ACP domain members or ACP secure channel peers when they have a zero-value acp-address field and as ACP domain members (but not as ACP secure channel peers) when the acp-address field is omitted from their AcpNodeName.  See [Section 6.2.3](#certcheck).

The acp-domain-name is used to indicate the ACP domain across which ACP nodes authenticate and authorize each other, for example, to build ACP secure channels to each other, see [Section 6.2.3](#certcheck). The acp-domain-name **SHOULD** be the FQDN of an Internet domain owned by the network administration of the ACP and ideally reserved to only be used for the ACP. In this specification, it serves as a name for the ACP that ideally is globally unique.  When acp-domain-name is a globally unique name, collision of ACP addresses across different ACP domains can only happen due to ULA hash collisions (see [Section 6.11.2](#scheme)). Using different acp-domain-names, operators can distinguish multiple ACPs even when using the same TA.
...
The routing-subdomain is a string that can be constructed from the acp-node-name, and it is used in the hash creation of the ULA (see [Section 6.11.2](#scheme)).  The presence of the rsub component allows a single ACP domain to employ multiple /48 ULA prefixes.  See [Appendix A.6](#domain-usage) for example use cases.
...
3. Compatibilities:
              It should be possible to use the ACP certificate as an LDevID certificate on the system for uses besides the ACP.  Therefore, the information element required for the ACP should be encoded so that it minimizes the possibility of creating incompatibilities with other such uses. The attributes of the subject field, for example, are often used in non-ACP applications and therefore should not be occupied by new ACP values.
                The element should not require additional ASN.1 encoding and/or decoding because libraries for accessing certificate information, especially for embedded devices, may not support extended ASN.1 decoding beyond predefined, mandatory fields. subjectAltName / otherName is already used with a single string parameter for several otherNames (see "[Extensible Messaging and Presence Protocol (XMPP): Core](#RFC6120)" [RFC6120](#RFC6120), "[Dynamic Peer Discovery for RADIUS/TLS and RADIUS/DTLS Based on the Network Access Identifier (NAI)](#RFC7585)" [RFC7585](#RFC7585), "[Internet X.509 Public Key Infrastructure Subject Alternative Name for Expression of Service Name](#RFC4985)" [RFC4985](#RFC4985), "[Internationalized Email Addresses in X.509 Certificates](#RFC8398)" [RFC8398](#RFC8398)).
...
See [RFC5280](#RFC5280) for details on the subjectAltName field.

<a name="asn1"></a>
#### AcpNodeName ASN.1 Module

The following ASN.1 module normatively specifies the AcpNodeName structure.
This specification uses the ASN.1 definitions from "[New ASN.1 Modules for the Public Key Infrastructure Using X.509 (PKIX)](#RFC5912)" [RFC5912](#RFC5912)
with the 2002 ASN.1 notation used in that document.  [RFC5912](#RFC5912)
...
1. The peer has proved ownership of the private key associated
	    with the certificate's public key. This check is performed by the
	    security association protocol used, for example, Section [RFC7296](#RFC7296) of ["Internet Key Exchange Protocol Version 2 (IKEv2)"](#RFC7296).
2. The peer's certificate passes certificate path validation as
	    defined in [RFC5280](#RFC5280), against one of the TAs associated with the ACP node's ACP certificate (see [Section 6.2.4](#trust-anchors)). This includes verification of the validity (lifetime) of the certificates in the path.
3. If the peer's certificate indicates a CRLDP
             ([RFC5280](#RFC5280)) or OCSP responder
             ([RFC5280](#RFC5280)), then the peer's certificate **MUST** be valid according to those
             ...
             or has no access an OCSP responder, and the security association protocol itself also has no way to communicate the CRL or OCSP check.
              Retries to learn revocation via OCSP or CRL **SHOULD** be made using the same backoff as described in [Section 6.7](#neighbor_verification). If and when the ACP node then learns that an ACP peer's certificate is invalid for which [Rule 3](#step3) had to be skipped during ACP secure channel establishment, then the ACP secure channel to that peer **MUST** be closed even if this peer is the only connectivity to access CRL/OCSP. This applies (of course) to all ACP secure channels to this peer if there are multiple.  The ACP secure channel connection **MUST** be retried periodically to support the case that the neighbor acquires a new, valid certificate.
4. The peer's certificate has a syntactically valid acp-node-name field,
             and the acp-domain-name in that peer's acp-node-name is the same as in this ACP node's certificate (lowercase normalized).

When checking a candidate peer's certificate for the purpose of establishing an ACP secure channel,
         one additional check is performed:

1. The acp-address field of the candidate peer certificate's AcpNodeName is not omitted but is either 32HEXDIG or 0, according to [Figure 2](#acp-dominfo-abnf).

Technically, ACP secure channels can only be built with nodes that
         have an acp-address. [Rule 5](#step5) ensures that this is taken into account
...
Nodes with an omitted acp-address field can only use their ACP domain
         ...
         into the ACP via [ACP connect](#ACPconnect)

The special value "0" in an ACP certificate's acp-address field
          ...
          ACP nodes can build ACP secure channels to them according to [Rule 5.](#step5)

The optional rsub field of the AcpNodeName is not relevant to the
          ...
          (hence the name "routing subdomain").

In summary:

- [Steps 1 through 4](#step1) constitute standard certificate validity verification and private key authentication as defined by [RFC5280](#RFC5280) and security association protocols (such as [IKEv2](#RFC7296)) when leveraging certificates.
- Except for its public key, [Steps 1 through 4](#step1) do not include the verification of any preexisting
	    form of a certificate's identity
      elements, such as a web server's domain name prefix, which is
      often encoded in the certificate common name. [Step 5](#step5) is an equivalent step for the AcpNodeName.
- [Step 4](#step4) constitutes standard CRL and OCSP checks refined for the case of missing connectivity and limited-functionality security association protocols.
- [Steps 1 through 4](#step1) authorize the building of any secure connection between members of the same ACP domain except for ACP secure channels.
- [Step 5](#step5) is the additional verification of the presence of an ACP address as necessary for ACP secure channels.
- [Steps 1 through 5](#step1) therefore authorize the building of an ACP secure channel.
...
<a name="cert-time"></a>
#### Realtime Clock and Time Validation
...
An ACP node with a realtime clock in which it has confidence **MUST**
            ...
            as checking the certificate validity period in [Step 1](#step1) and the respective
            times in [Step 4](#step4) for revocation information (e.g., signingTimes in Cryptographic Message Syntax (CMS) signatures).
...
Current time **MAY** be learned in an unsecured fashion, for example, via NTP ("[Network Time Protocol Version 4: Protocol and Algorithms Specification](#RFC5905)" [RFC5905](#RFC5905))
            over the same link-local IPv6 addresses used for the ACP from neighboring ACP nodes.
            ACP nodes that do provide unsecured NTP over their link-local addresses **SHOULD**
...
<a name="trust-anchors"></a>
### Trust Anchors (TA)

ACP nodes need TA information according to [RFC5280](#RFC5280) (d), typically in the form of one or more certificates of the TA to perform certificate
path validation as required by [Section 6.2.3, Rule 2](#step2).
...
ACP node. ACP nodes **MUST** also support the renewal of TA information via 
EST as described in [Section 6.2.5](#domcert-maint).

The required information about a TA can consist of 
one or more
certificates as required for dealing with CA certificate renewals
as explained in Section [RFC4210](#RFC4210) of ["Internet X.509 Public Key Infrastructure Certificate Management Protocol (CMP)"](#RFC4210)).
...
Note that different ACP nodes may have different intermediate CAs
...
ACP domain membership check [Rules 1 through 3](#step1) are performed need to support
the exchange not only of the ACP nodes certificates but also the exchange of
the intermediate TA.

For the ACP domain membership check, ACP nodes **MUST** support certificate path 
validation with zero or one intermediate CA. They **SHOULD** support two intermediate CAs
and two TAs (to permit migration from one TA to another TA).
...
A single owner can operate multiple, independent ACP domains from the same
set of TAs. Registrars must then know into which ACP a node needs to be enrolled.

<a name="domcert-maint"></a>
### Certificate and Trust Anchor Maintenance

ACP nodes **MUST** support renewal of their certificate and TA information via EST
and **MAY** support other mechanisms.  See [Section 6.1](#tls) for TLS requirements.
An ACP network **MUST** have at least one ACP node supporting EST server functionality across the ACP so that EST
renewal is usable.

ACP nodes **SHOULD** remember the GRASP O_IPv6_LOCATOR parameters of
   the EST server with which they last renewed their ACP certificate.
They **SHOULD** provide the ability
for these EST server parameters to also be set by the ACP registrar
(see [Section 6.11.7](#acp-registrars)) that initially enrolled the ACP
device with its ACP certificate. When BRSKI 
is used (see [RFC8995](#RFC8995)), the IPv6 locator of the BRSKI registrar from the BRSKI TLS
...
via GRASP on its ACP address (see [Section 6.2.5.1](#domcert-grasp)).

The EST server **MUST** present a certificate that passes the ACP domain
membership check in its TLS connection setup ([Section 6.2.3, rules 1 through 4](#step1), not [rule 5](#step5) as this is not for an ACP secure channel setup).
The EST server certificate **MUST** also contain the id-kp-cmcRA 
extended key usage attribute [RFC6402](#RFC6402), and the EST client **MUST** check its presence.

The additional check against the id-kp-cmcRA extended key usage extension field
...
CA certificates when they expire.
...
with the id-kp-cmcRA extended usage extension for themselves.

<a name="domcert-grasp"></a>
#### GRASP Objective for EST Server

ACP nodes that are EST servers **MUST** announce their service in the ACP via GRASP 
Flood Synchronization (M_FLOOD) messages. See [RFC8990](#RFC8990) for the definition of this message type
and [Figure 4](#est-example) for an example.
...
```
The formal definition of the objective in CDDL
   (see "[Concise Data Definition Language (CDDL): A Notational Convention to Express Concise Binary Object Representation (CBOR) and JSON Data Structures](#RFC8610)" [RFC8610](#RFC8610)) is as follows:
...
[RFC7030](#RFC7030) because "est" is a
registered service name ("[Internet Assigned Numbers Authority (IANA) Procedures for the Management of the Service Name and Transport Protocol Port Number Registry](#RFC6335)" [RFC6335](#RFC6335)) for [RFC7030](#RFC7030).
The 'objective-value' field **MUST** be ignored if present. Backward-compatible extensions to
[RFC7030](#RFC7030) **MAY** be indicated through 'objective-value'.
Certificate renewal options that are incompatible with [RFC7030](#RFC7030) **MUST** use a different 'objective-name'.
Unrecognized 'objective-value' fields (or parts thereof if it is a partially understood structure) **MUST** be ignored.

The M_FLOOD message **MUST** be sent periodically.  The default **SHOULD** be 60 seconds;
...
The "SRV.est" objective(s) **SHOULD** only be announced when the ACP node knows that it can successfully
communicate with a CA to perform the EST renewal and/or rekeying operations for the ACP domain. See also
[Section 11](#security).

<a name="domcert-renewal"></a>
#### Renewal
...
with which certificate renewal succeeds **SHOULD** be remembered for the next renewal.

Remembering the last renewal server and preferring it provides stickiness
that can help diagnostics.  It also provides some protection against off-path,
compromised ACP members announcing bogus information into GRASP.

Renewal of certificates **SHOULD** start after less than 50% of the domain certificate
...
disconnected from any CA.

<a name="domcert-crl"></a>
#### Certificate Revocation Lists (CRLs)

The ACP node **SHOULD** support revocation through CRL(s) via HTTP from one
...
domain name, the ACP node will connect to the CRLDP via the data plane.

It is common to use domain names for CRLDP(s), but there is no requirement
...
indicator whether or not to reach the CRLDP via the ACP.

A CRLDP can be reachable across the ACP either by running it on a
node with ACP or by connecting its node via an ACP connect interface (see [Section 8.1](#ACPconnect)).

When using a private PKI for ACP certificates, the CRL may be need-to-know, for example,
...
Authentication and authorization **SHOULD** use ACP certificates and the ACP domain membership check ([Section 6.2.3](#certcheck)).
...
[Section 9.2.4](#sub-ca) for a discussion about an example setup achieving
this. See also "[Support for Short-Term, Automatically Renewed (STAR) Certificates in the Automated Certificate Management Environment (ACME)](#RFC8739)" [RFC8739](#RFC8739).
...
certificate maintenance infrastructure.

See [Appendix A.2](#bootstrap) for further optimizations of certificate
maintenance when BRSKI can be used [RFC8995](#RFC8995).

<a name="domcert-re-enroll"></a>
#### Reenrollment

An ACP node may determine that its ACP certificate
...
In this role, the node maintains the TA and certificate
...
Please refer to [Section 6.11.7](#acp-registrars) and [RFC8995](#RFC8995)
...
When BRSKI is used (i.e., on ACP nodes that are ANI nodes), the reenrolling
candidate ACP node attempts to enroll like a candidate ACP node (BRSKI pledge), 
but instead of using the ACP node's IDevID certificate, it **SHOULD** first attempt to use its ACP domain
...
to the ACP node in the new ACP certificate.

If the BRSKI registrar denies the use of the old ACP certificate,
the reenrolling candidate ACP node **MUST** reattempt reenrollment using
its IDevID certificate as defined in BRSKI during the TLS connection setup.

When the BRSKI connection is attempted with either with the old ACP certificate
or the IDevID certificate, the reenrolling candidate ACP node **SHOULD** authenticate
...
The reenrolling candidate ACP node **SHOULD** only fall back to requesting a voucher from the BRSKI registrar 
...
certificate and ACP TA **SHOULD** therefore be maintained and attempted to be used as one possible credential for reenrollment
until new keying material is acquired.

When using BRSKI or other protocols and/or mechanisms that support vouchers,
...
of ACP nodes may be operationally expensive or otherwise undesirable.

<a name="domcert-failing"></a>
#### Failing Certificates

An ACP certificate is called failing in this document
...
should pass the domain membership check ([Section 6.2.3](#certcheck)),
and connection error diagnostics should exclude other reasons for the connection failure.
...
The following are examples of failing certificates that the ACP node can only
...
the ACP node's domain certificate.
...
reenrolling candidate ACP node as explained in [Section 6.2.5.5](#domcert-re-enroll).

<a name="adj-table"></a>
## ACP Adjacency Table

To know to which nodes to establish an ACP channel, every ACP node maintains an adjacency table.  The adjacency table contains information about adjacent ACP nodes, at a minimum: Node-ID (the identifier of the node inside the ACP, see [Section 6.11.3](#zone-scheme) and [Section 6.11.5](#Vlong)), the interface on which neighbor was discovered (by GRASP as explained below), the link-local IPv6 address of the neighbor on that interface, and the certificate (including acp-node-name).  An ACP node **MUST** maintain this adjacency table.  This table is used to determine to which neighbor an ACP connection is established.

When the next ACP node is not directly adjacent (i.e., not on a link
connected to this node), the information in the adjacency table can be supplemented by configuration.  For example, the Node-ID and IP address could be configured. See [Section 8.2](#remote-acp-neighbors).

The adjacency table **MAY** contain information about the validity and trust of the adjacent ACP node's certificate.  However, subsequent steps **MUST** always start with the ACP domain membership check against the peer (see [Section 6.2.3](#certcheck)).
...
<a name="discovery-grasp"></a>
## Neighbor Discovery with DULL GRASP

Discovery Unsolicited Link-Local (DULL) GRASP is a limited subset of GRASP intended to operate across an
insecure link-local scope.  See [RFC8990](#RFC8990) for its
...
by policy as noted earlier ([Section 5, bullet point 2](#sec5bt2)), native interfaces
...
Reception of packets on such otherwise unconfigured interfaces **MUST** be limited so that
at first only SLAAC ("[IPv6 Stateless Address Autoconfiguration](#RFC4862)" [RFC4862](#RFC4862))
...
(e.g., no other link-local IPv6 transport stack responders, for example).

Note that the use of the IPv6 link-local multicast address (ALL_GRASP_NEIGHBORS) implies
the need to use MLDv2 (see "[Multicast Listener Discovery Version 2 (MLDv2) for IPv6](#RFC3810)" [RFC3810](#RFC3810))
...
MLD-snooping switches ("[Considerations for Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Snooping Switches](#RFC4541)" [RFC4541](#RFC4541)) that either do not support ACP or are not ACP enabled because those switches would stop forwarding DULL GRASP packets.
Switches that do not support MLD snooping simply need to operate as pure L2 bridges for
IPv6 multicast packets for DULL GRASP to work.

ACP discovery **SHOULD NOT** be enabled by default on non-native interfaces.  In particular, ACP discovery **MUST NOT** run inside the ACP across ACP virtual interfaces.  See [Section 9.3](#enabling-acp) for further non-normative suggestions on how to enable and disable ACP at the node and interface level.  See [Section 8.2.2](#conf-tunnel) for more details about tunnels (typical non-native interfaces).  See [Section 7](#acp-l2-switches) for extending ACP on devices operating (also) as L2 bridges.

Note: if an ACP node also implements BRSKI to enroll its ACP certificate
(see [Appendix A.2](#bootstrap) for a summary), then the above considerations also apply to 
...
therefore never needs to discover both a bootstrap proxy and an ACP neighbor at the same time.

An ACP node announces itself to potential ACP peers by use of the "AN_ACP" objective.
...
will be distributed with the flooded objective.  An example of the message is informally:
...
The 'method-name' in the 'objective-value' parameter is a string indicating the protocol available at the specified or implied locator. It is a protocol supported by the node to negotiate a secure channel. "IKEv2" as shown in [Figure 6](#an-acp-example) is the protocol used to negotiate an IPsec secure channel.
...
A node that supports more than one secure channel protocol method needs to flood multiple versions
    of the "AN_ACP" objective so that each method can be accompanied by its own 'locator-option'.  This can use a single GRASP M_FLOOD message as shown in [Figure 6](#an-acp-example).
...
The ACP is established exclusively between nodes in the same domain.  This includes all routing subdomains. [Appendix A.6](#domain-usage) explains how ACP connections across multiple routing subdomains are special.
...
- The Follower becomes passive: it does not attempt to further initiate ACP secure channel protocol connections with the Decider and does not consider it to be an error when the Decider closes secure channels.  The Decider becomes the active party, continuing to attempt the setup of secure channel protocols with the Follower. This process terminates when the Decider arrives at the "best"
 ACP secure channel connection option that also works with the Follower ("best" from the Decider's point of view).
...
**[9]**
  Node 1 refrains from attempting any further secure channel connections to Node
...
**[11:C2]**
  Node 1's certificate has a lower ACP Node-ID than Node 2's, therefore Node 1
...
of secure channel creation. [Section 6.6](#channel-selection) shows how simultaneous mutual
secure channel setup collisions are resolved.

<a name="associations"></a>
## Security Association (Secure Channel) Protocols

This section describes how ACP nodes establish secured data connections to automatically discovered or configured peers in the ACP. [Section 6.4](#discovery-grasp) describes how peers that are adjacent on an IPv6 subnet are discovered automatically. [Section 8.2](#remote-acp-neighbors) describes how to configure peers that are not adjacent on an IPv6 subnet.

[Section 6.13.5.2](#ACP-virtual-interfaces) describes how secure channels are mapped to virtual IPv6 subnet interfaces in the ACP. The simple case is to map every ACP secure channel to a separate ACP point-to-point virtual interface ([Section 6.13.5.2.1](#ACP-p2p-virtual-interfaces)). When a single subnet has multiple ACP peers, this results in multiple ACP point-to-point virtual interfaces across that underlying multiparty IPv6 subnet. This can be optimized with ACP multi-access virtual interfaces ([Section 6.13.5.2.2](#ACP-ma-virtual-interfaces)), but the benefits of that optimization may not justify the complexity of that option.

<a name="general-considerations"></a>
### General Considerations

Due to channel selection ([Section 6.6](#channel-selection)), ACP can support an evolving set of security association protocols and does not require support for a single network-wide MTI.  ACP nodes only need to implement those protocols required to interoperate with their candidate peers, not with potentially any node in the ACP domain. See [Section 6.8.5](#Profiles) for an example of this.
...
Security association protocols typically only signal the end entity certificate
...
to aid troubleshooting, see [Section 9.1.1](#ta-troubleshoot).

Signaling of TA certificates may not be appropriate when the deployment relies on
...
a specific secure channel protocol.
...
The ACP usage of IPsec and IKEv2 mandates a profile with a narrow set of options of the current Standards Track usage guidance for IPsec ("[Cryptographic Algorithm Implementation Requirements and Usage Guidance for Encapsulating Security Payload (ESP) and Authentication Header (AH)](#RFC8221)" [RFC8221](#RFC8221)) and IKEv2 ("[Algorithm Implementation Requirements and Usage Guidance for the Internet Key Exchange Protocol Version 2 (IKEv2)](#RFC8247)" [RFC8247](#RFC8247)).  These options result in stringent security properties and can exclude deprecated and legacy algorithms because there is no need for interoperability with legacy equipment for ACP secure channels.  Any such backward compatibility would lead only to an increased attack surface and implementation complexity, for no benefit.

<a name="IPsec"></a>
#### Native IPsec

An ACP node that is supporting native IPsec
	    **MUST** use IPsec in tunnel mode, negotiated via
	    IKEv2, and with IPv6 payload (e.g., ESP Next Header of 41). It
	    **MUST** use local and peer link-local IPv6 addresses
	    for encapsulation.  Manual keying **MUST NOT** be used,
	    see [Section 6.2](#domcert). Traffic Selectors
	    are:
...
ACP IPsec implementations **MUST** comply with [RFC8221](#RFC8221) and any specifications that update it. The requirements from above and this section amend and supersede its requirements.

The IP Authentication Header (AH) **MUST NOT** be used (because it does not provide confidentiality).

For the required ESP encryption algorithms in [RFC8221](#RFC8221), the following guidance applies:

- ENCR_NULL AH **MUST NOT** be used (because it does not provide confidentiality).
- ENCR_AES_GCM_16 is the only MTI ESP encryption algorithm for ACP via IPsec/ESP (it is already listed as **MUST** in [RFC8221](#RFC8221)).
...
- ENCR_CHACHA20_POLY1305 is mandatory in [RFC8221](#RFC8221) because
...
[RFC8221](#RFC8221) allows for 128-bit or 256-bit AES keys.
  This document mandates that only 256-bit AES keys **MUST** be supported.

When [RFC8221](#RFC8221) is updated, ACP implementations will need to
consider legacy interoperability.

<a name="rfc4247req"></a>
##### RFC 8247 (IKEv2)

[RFC8247](#RFC8247) provides a baseline recommendation for mandatory-to-implement ciphers, integrity checks, pseudorandom functions, and Diffie-Hellman mechanisms.
Those recommendations, and the recommendations of subsequent documents, apply as well to the ACP.
Because IKEv2 for ACP secure channels is sufficient to be implemented in control plane software rather than in Application-Specific Integrated Circuit (ASIC) hardware, and ACP nodes supporting IKEv2 are not assumed to be code space constrained, and because existing IKEv2 implementations are expected to support [RFC8247](#RFC8247) recommendations, this document makes no attempt to simplify its recommendations for use with the ACP.

See [IKEV2IANA](#IKEV2IANA) for IANA IKEv2 parameter names used in this text.

ACP nodes supporting IKEv2 **MUST** comply with [RFC8247](#RFC8247) amended by the following requirements, which constitute a policy statement as permitted by [RFC8247](#RFC8247).

To signal the ACP certificate chain (including TA) as required by [Section 6.8.2](#common-requirements), the "X.509 Certificate - Signature" payload in IKEv2 can be used. It is mandatory according to [RFC7296](#RFC7296).

ACP nodes **SHOULD** set up IKEv2 to only use the ACP certificate and TA when acting as an IKEv2 responder on the IPv6 link-local address and port number indicated in the "AN_ACP" DULL GRASP announcements (see [Section 6.4](#discovery-grasp)).

When CERTREQ is received from a peer, and it does not indicate any of this 
ACP node's TA certificates, the ACP node **SHOULD** ignore the CERTREQ and 
continue sending its certificate chain including its TA as subject to 
the requirements and explanations in [Section 6.8.2](#common-requirements). This will not result in successful mutual authentication but assists diagnostics.

Note that with IKEv2, failing authentication will only result in the responder
receiving the certificate chain from the initiator, but not vice versa. Because
ACP secure channel setup is symmetric (see [Section 6.7](#neighbor_verification)),
...
In IKEv2, ACP nodes are identified by their ACP addresses.
...
See [Section 6.2.3](#certcheck) for more information about "0" or omitted ACP address fields in the acp-node-name.
...
The requirements for ESP/IPsec/IKEv2 with GRE are the same as
	    for native IPsec (see [Section 6.8.3.1](#IPsec))
...
If the IKEv2 initiator and responder support IPsec over GRE, it will be preferred over native IPsec because of how IKEv2 negotiates transport mode (as used by this IPsec over GRE profile) versus tunnel mode as used by native IPsec (see [RFC7296](#RFC7296)).  The ACP IPv6 traffic has to be carried across GRE according to "[IPv6 Support for Generic Routing Encapsulation (GRE)](#RFC7676)" [RFC7676](#RFC7676).
...
An ACP node announces its ability to support DTLS version 1.2 ("[Datagram Transport Layer Security Version 1.2](#RFC6347)" [RFC6347](#RFC6347)) compliant with the requirements defined in this document as an ACP secure channel protocol in GRASP through the "DTLS" 'objective-value' in the "AN_ACP" objective (see [Section 6.4](#discovery-grasp)).
...
DTLS 1.3 [TLS-DTLS13](#I-D.ietf-tls-dtls13) is "backward compatible" with
DTLS 1.2 (see [TLS-DTLS13](#I-D.ietf-tls-dtls13)).  A DTLS implementation supporting both
...
- The existing BCP [RFC7525](#RFC7525) for DTLS 1.2 may take an equally longer time to be updated with experience from a newer DTLS version.
- There are no significant benefits of DTLS 1.3 over DTLS 1.2 that are use-case relevant in the
      ...
      the fact that DTLS connections are mostly link local (short RTT).
...
<a name="Profiles"></a>
### ACP Secure Channel Profiles

As explained in the beginning of [Section 6.6](#channel-selection), there is no single secure channel mechanism mandated for all ACP nodes. Instead, this section defines two ACP profiles, "baseline" and "constrained", for ACP nodes that do introduce such requirements.
...
<a name="GRASP-core"></a>
### GRASP as a Core Service of the ACP

The ACP **MUST** run an instance of GRASP inside of it.  It is a key part of the
        ACP services.  The function in GRASP that makes it fundamental as a service of the ACP
        is the ability to provide ACP-wide service discovery (using objectives in GRASP).

ACP provides IP unicast routing via RPL (see [Section 6.12](#routing)).

The ACP does not use IP multicast routing nor does it provide generic IP multicast services
        (the handling of GRASP link-local multicast messages is explained in [Section 6.9.2](#GRASP-substrate)).
        ...
        (GRASP M_DISCOVERY messages) and service announcement (GRASP M_FLOOD messages).

See [Appendix A.5](#acp-grasp) for discussion about this design choice
        of the ACP.

<a name="GRASP-substrate"></a>
### ACP as the Security and Transport Substrate for GRASP

In the terminology of GRASP [RFC8990](#RFC8990), the ACP is the
        security and transport substrate for the GRASP instance run inside the ACP ("ACP GRASP").

This means that the ACP is responsible for ensuring that this instance of GRASP is
        ...
        certificate, and it continues to exist even if all of its neighbors cease operation.

In this case, ASAs using GRASP running on the same node still need 
        to be able to discover each other's objectives.  When the ACP does not exist, ASAs leveraging 
        the ACP instance of GRASP via APIs **MUST** still be able to operate, and they **MUST** be able to
        understand that there is no ACP and that therefore the ACP instance of GRASP cannot
        operate.

How the ACP acts as the security and transport substrate for GRASP is shown 
        in [Figure 8](#acp-grasp-picture).

GRASP unicast messages inside the ACP always use the ACP address.  Link-local
        addresses from the ACP VRF **MUST NOT** be used inside objectives.  GRASP unicast messages inside the ACP
        are transported via TLS. See [Section 6.1](#tls) for TLS requirements.
        TLS mutual authentication **MUST** use the ACP domain membership check 
        defined in [Section 6.2.3](#certcheck).

GRASP link-local multicast messages are targeted for a specific ACP virtual interface 
        (as defined [Section 6.13.5](#ACP_interfaces)), but they are sent by the ACP to 
        ...
        the GRASP link-local multicast messages are replicated to all neighbor TCP connections.
...
TLS is mandated for GRASP non-link-local unicast because the ACP secure channel
            ...
            detected and removed (e.g., via domain certificate revocation and/or expiry).

If GRASP peer connections were to use just TCP, compromised ACP members could
...
Eavesdropping and/or spoofing by a compromised ACP node is still possible because
            ...
            this is quite likely public knowledge or even standardized.

The GRASP TLS connections are run the same as any other ACP traffic through the ACP
            secure channels.  This leads to double authentication and encryption, which has the following
            benefits:

- Secure channel methods such as IPsec may provide protection against additional
                attacks, for example, reset attacks.
- The secure channel method may leverage hardware acceleration, and there may be little
                or no gain in eliminating it.
- The security model for ACP GRASP is no different than other ACP traffic. Instead,
                there is just another layer of protection against certain attacks from the inside,
                which is important due to the role of GRASP in the ACP.
...
<a name="addressing"></a>
## Addressing inside the ACP

The channels explained above typically only establish communication between two adjacent nodes.  In order for communication to happen across multiple hops, the Autonomic Control Plane requires ACP network-wide valid addresses and routing.  Each ACP node creates a loopback interface with an ACP network-wide unique address (prefix) inside the ACP context (as explained in [Section 6.10](#separation)).  This address may be used also in other virtual contexts.

With the algorithm introduced here, all ACP nodes in the same routing subdomain have the same /48 ULA prefix.  Conversely, ULA Global IDs from different domains are unlikely to clash, such that two ACP networks can be merged, as long as the policy allows that merge.  See also [Section 10.1](#self-healing) for a discussion on merging domains.
...
<a name="addr-fundamentals"></a>
### Fundamental Concepts of Autonomic Addressing
...
- Loopback only: only ACP loopback interfaces (and potentially those configured for ACP connect, see [Section 8.1](#ACPconnect)) carry routable address(es); all other interfaces (called ACP virtual interfaces) only use IPv6 link-local addresses.  The usage of IPv6 link-local addressing is discussed in "[Using Only Link-Local Addressing inside an IPv6 Network](#RFC7404)" [RFC7404](#RFC7404).
- Use of ULA: for loopback interfaces of ACP nodes, we use ULA with
	   the L bit set to 1 (as defined in [RFC4193](#RFC4193)). Note that the random hash for ACP loopback addresses uses the definition in [Section 6.11.2](#scheme) and not the one in [RFC4193](#RFC4193).
...
- Addresses in the ACP are permanent and do not support temporary addresses as defined in "[Temporary Address Extensions for Stateless Address Autoconfiguration in IPv6](#RFC8981)" [RFC8981](#RFC8981).
- Addresses in the ACP are not considered sensitive on privacy grounds because ACP nodes are not expected to be end-user hosts, and therefore ACP addresses do not represent end users or groups of end users.  All ACP nodes are in one (potentially federated) administrative domain. For ACP traffic, the nodes are assumed to be either candidate hosts or transit nodes.  There are no transit nodes with fewer privileges to know the identity of other hosts in the ACP.  Therefore, ACP addresses do not need to be pseudorandom as discussed in "[Security and Privacy Considerations for IPv6 Address Generation Mechanisms](#RFC7721)" [RFC7721](#RFC7721).  Because they are not propagated to untrusted (non-ACP) nodes and stay within a domain (of trust), we also do not consider them to be subject to scanning attacks.
...
- OAM protocols do not require IPv4: the ACP may carry OAM protocols.  All relevant protocols (SNMP, TFTP, SSH, SCP, RADIUS, Diameter, NETCONF, etc.) are available in IPv6. See also [RFC8368](#RFC8368) for how ACP could be made to interoperate with IPv4-only OAM.

Further explanation about the addressing and routing-related reasons for the choice of the autonomous ACP addressing can be found in [Section 6.13.5.1](#ACP-loopback).

<a name="scheme"></a>
### The ACP Addressing Base Scheme
...
```
The first 48 bits follow the ULA scheme as defined in [RFC4193](#RFC4193), to which a Type field is added.

**fd:**
  Identifies a locally defined ULA address.

**hash(routing-subdomain):**
  The 40-bit ULA Global ID (a term from [RFC4193](#RFC4193)) for ACP addresses carried in the acp-node-name in the ACP certificates are the first 40 bits of the SHA-256 hash of the routing-subdomain from the same acp-node-name.  In the example of [Section 6.2.2](#domcert-acpinfo), the routing-subdomain is "area51.research.acp.example.com", and the 40-bit ULA Global ID is 89b714f3db.
  ...
  Establishing connectivity between different ACPs (different acp-domain-names) is outside the scope of this specification.
...
Please refer to [Section 6.11.7](#acp-registrars) and [Appendix A.1](#address-spaces) for further explanations for why the following addressing sub-schemes are used and why multiple are necessary.

The following summarizes the addressing sub-schemes:

**Table: Addressing Sub-Schemes**
...
The F-bit (format bit, [Section 6.11.5](#Vlong)) and Z ([Section 6.11.4](#manual-scheme)) are two encoding fields that are explained in the sections covering 
...
<a name="zone-scheme"></a>
### ACP Zone Addressing Sub-Scheme (ACP-Zone)
...
**Node-ID:**
  ...
  **Registrar-ID (48 bits):**
    A number unique inside the domain identifying the ACP registrar that assigned the Node-ID to the node.  One or more domain-wide unique identifiers of the ACP registrar can be used for this purpose. See [Section 6.11.7.2](#registrars-unique).
...
The ACP address set of the node includes addresses with any Zone-ID value and any V value. Therefore, no two nodes in the same ACP and the same hash(routing-subdomain)
  can have the same Node-ID with the Zone Addressing Sub-Scheme, for
  example, by differing only in their Zone-ID.
...
It is **RECOMMENDED** that only Zone-ID 0 is used unless it is meant to be
                used in conjunction with operational practices for partial or incremental adoption
                of the ACP as described in [Section 9.4](#incremental-adoption).

Note: Zones and Zone-ID as defined here are not related to zones or zone_id defined in "[IPv6 Scoped Address Architecture](#RFC4007)" [RFC4007](#RFC4007). ACP zone addresses are not scoped (i.e., reachable only from within a zone as defined by [RFC4007](#RFC4007)) but are reachable across the whole ACP. A zone_id is a zone index that has only local significance on a node [RFC4007](#RFC4007), whereas an ACP Zone-ID is an identifier for an ACP zone that is unique across that ACP.

<a name="manual-scheme"></a>
### ACP Manual Addressing Sub-Scheme (ACP-Manual)
...
**Interface Identifier:**
  Interface identifier according to [RFC4291](#RFC4291).


This sub-scheme is meant for the "manual" allocation to subnets where the other addressing schemes cannot be used.  The primary use case is for assignment to ACP connect subnets (see [Section 8.1.1](#NMS)).
...
The Z bit field was added to distinguish between the Zone Addressing Sub-Scheme and the Manual Addressing Sub-Scheme without requiring one more bit in the base scheme and therefore allowing for the Vlong Addressing Sub-Scheme (described in [Section 6.11.5](#Vlong)) to have one more bit available.

The Manual Addressing Sub-Scheme addresses **SHOULD NOT** be used in ACP certificates. Any node capable of building ACP secure channels and is permitted by registrar policy to participate in building ACP secure channels **SHOULD** receive an ACP address (prefix) from one of the other ACP addressing sub-schemes.  A node that cannot or is not permitted to participate in ACP secure channels can connect to the ACP via ACP connect interfaces of ACP edge nodes (see [Section 8.1](#ACPconnect)) without setting up an ACP secure channel. Its ACP certificate **MUST** omit the acp-address field to indicate that its ACP certificate is only usable for non-ACP secure channel authentication, such as end-to-end transport connections across the ACP or data plane.

Address management of ACP connect subnets is done using traditional assignment methods and existing IPv6 protocols. See [Section 8.1.3](#ACautoconfig) for details. Therefore, the notion of /V-bits multiple addresses assigned to the ACP nodes does not apply to this sub-scheme.

<a name="Vlong"></a>
### ACP Vlong Addressing Sub-Scheme (ACP-Vlong-8/ACP-Vlong-16)
...
```
This addressing sub-scheme foregoes the Zone-ID field ([Section 6.11.3](#zone-scheme)) to allow
                  for larger, flatter routed networks (e.g., as in IoT) with
                  8,421,376 Node-Numbers (223 + 215).  It also allows for up to
                  216 (i.e., 65,536) different virtualized addresses within a
                  node, which could be used to address individual software
                components in an ACP node.

The fields are the same as in the Zone Addressing Sub-Scheme ([Section 6.11.3](#zone-scheme)) with the
                following refinements:

**F:**
  Format bit.  This bit determines the format of the
                      subsequent bits.

**V:**
  Virtualization bit: this is a field that is
                      either 8 or 16 bits.  For F=0, it is 8 bits, for F=1
                      it is 16 bits.  The V-bits are assigned by the ACP
                      node.  In the ACP certificate's ACP address ([Section 6.2.2](#domcert-acpinfo)), the V-bits are always
                      set to 0.

**Registrar-ID:**
  To maximize Node-Number and V, the
                      Registrar-ID is reduced to 46 bits. One or more domain-wide unique identifiers of the ACP registrar can be used for this purpose. See [Section 6.11.7.2](#registrars-unique).
...
The F=1 bit Node-Numbers are intended for
                  ACP nodes that are ACP edge nodes (see [Section 8.1.1](#NMS))
                  or that have a large number of clients requiring separate
                  V(irtual) addresses, for example, large SDN controllers with
                  container modular software architecture (see [Section 8.1.2](#software)).
...
<a name="other-sub-schemes"></a>
### Other ACP Addressing Sub-Schemes
...
<a name="acp-registrars"></a>
### ACP Registrars

ACP registrars are responsible for enrolling candidate ACP nodes
...
<a name="registrars-protocols"></a>
#### Use of BRSKI or Other Mechanisms or Protocols

Any protocols or mechanisms may be used by ACP registrars
as long as the resulting ACP certificate and TA certificate(s) can be used  
by other domain members to perform the ACP domain membership check described in [Section 6.2.3](#certcheck),
and the acp-node-name meets the ACP addressing 
   requirements described in the next three sections.

An ACP registrar could be a person deciding whether to
...
ACP registrar may use.

<a name="registrars-unique"></a>
#### Unique Address/Prefix Allocation
...
gets an acp-node-name field ([Section 6.2.2](#domcert-acpinfo))
...
(see [RFC8995](#RFC8995), "EST CSR Attributes").

<a name="registrars-policy"></a>
#### Addressing Sub-Scheme Policies

The ACP registrar selects for the candidate ACP node a unique 
address prefix from an appropriate ACP addressing sub-scheme,
either a Zone Addressing Sub-Scheme prefix (see [Section 6.11.3](#zone-scheme)),
or a Vlong Addressing Sub-Scheme prefix (see [Section 6.11.5](#Vlong)). The
...
the ACP routing protocol (see [Section 6.12](#routing)) to establish
IPv6 reachability across the ACP.
...
addressing sub-scheme for the (class of) node(s).

ACP registrars **SHOULD** default to allocating Zone Addressing Sub-Scheme
addresses with Zone-ID 0.

ACP registrars that are aware of the IDevID certificate of a candidate ACP device
**SHOULD** be able to choose the Zone vs. Vlong Addressing Sub-Scheme for
ACP nodes based on the "serialNumber" attribute [X.520](#X.520) in the 
...
would not recycle ACP address prefixes from ACP nodes that are no longer used.

If allocated addresses cannot be remembered by registrars, then
...
such strategies may require coordination amongst registrars.

<a name="registrars-renewal"></a>
#### Address/Prefix Persistence
...
ACP address information **SHOULD** be maintained even when the renewing and/or rekeying
ACP registrar is not the same as the one that enrolled the prior ACP certificate.
See [Section 9.2.4](#sub-ca) for an example.

ACP address information **SHOULD** also be maintained even after an ACP
certificate expires or fails. See [Section 6.2.5.5](#domcert-re-enroll)
and [Section 6.2.5.6](#domcert-failing).

<a name="registrars-further"></a>
#### Further Details

[Section 9.2](#registrar-considerations) discusses further informative
details of ACP registrars: needed interactions, required
parameters, certificate renewal and limitations, use of sub-CAs on
registrars, and centralized policy control.
...
The routing protocol inside the ACP is RPL [RFC6550](#RFC6550).  See [Appendix A.4](#why-rpl) for more details on the choice of RPL.

RPL adjacencies are set up across all ACP channels in the same domain including all its routing subdomains.  See [Appendix A.6](#domain-usage) for more details.

<a name="rpl-profile"></a>
### ACP RPL Profile

The following is a description of the RPL profile that ACP nodes need to support by default.  The format of this section is derived from [ROLL-APPLICABILITY](#I-D.ietf-roll-applicability-template).

<a name="rpl-summary"></a>
#### Overview

RPL Packet Information (RPI), defined in [RFC6550](#RFC6550), defines the
...
This choice is a compromise. Consider a network that has multiple NOCs in different locations. 
      ...
      See [Appendix A.9.4](#future-rpl) for more details.
...
<a name="rpl-convergence"></a>
##### Reconvergence

In RPL profiles where RPI (see [Section 6.12.1.13](#rpl-Data-Plane)) is present,
...
The ACP RPL profile instead relies on quickly reconverging the DODAG by
      ...
      as described in [Section 6.12.1.7](#rpl-dodag-repair).  Since links in the ACP
      are assumed to be mostly reliable (or have link-layer protection against loss)
      and because there is no stretch according to [Section 6.12.1.7](#rpl-dodag-repair), 
...
In addition, there are a variety of mechanisms possible in RPL to further
      avoid temporary loops that are **RECOMMENDED** to be used for the ACP RPL profile:
      DODAG Information Objects (DIOs) **SHOULD** be sent two or three times to inform children
      when losing the last parent. The technique in [RFC6550](#RFC6550) (Detaching) **SHOULD** be favored over that in Section [RFC6550](#RFC6550)
...
<a name="rpl-instances"></a>
#### RPL Instances

There is a single RPL instance.  The default RPLInstanceID is 0.

<a name="rpl-storing"></a>
#### Storing vs. Non-Storing Mode

The RPL Mode of Operation (MOP) **MUST** support mode 2, "Storing Mode of Operations
        with no multicast support".  Implementations **MAY** support mode 3 ("... with multicast support") as that is a superset of mode 2.  Note: Root indicates mode in DIO flow.

<a name="rpl-dao-policy"></a>
#### DAO Policy

The DAO policy is proactive, aggressive DAO state maintenance:

- Use the 'K' flag in unsolicited DAO to indicate change from previous
               information (to require DAO-ACK).
- Retry such DAO DAO-RETRIES(3) times with DAO-ACK_TIME_OUT(256ms) in between.

<a name="rpl-path-metric"></a>
#### Path Metrics

Use Hop Count according to "[Routing Metrics Used for Path Calculation in Low-Power and Lossy Networks](#RFC6551)" [RFC6551](#RFC6551). Note that this is
        solely for diagnostic purposes as it is not used by the Objective Function.

<a name="rpl-objective-function"></a>
#### Objective Function

**Objective Function (OF):**
  Use Objective Function Zero (OF0) ("[Objective Function Zero for the Routing Protocol for Low-Power and Lossy Networks (RPL)](#RFC6552)" [RFC6552](#RFC6552)).
             Metric containers are not used.

**rank_factor:**
  Derived from link speed:
              if less than or equal to 100 Mbps, LOW_SPEED_FACTOR(5), else HIGH_SPEED_FACTOR(1).
...
<a name="rpl-dodag-repair"></a>
#### DODAG Repair

**Global Repair:**
  We assume stable links and ranks (metrics), so there is
...
**Local Repair:**
  As soon as link breakage is detected, the ACP node sends
          ...
          that advertises the new rank.  Then it sends a DAO with a new path sequence about itself.

  When using ACP multi-access virtual interfaces, local repair can be
                 triggered directly by peer breakage, see [Section 6.13.5.2.2](#ACP-ma-virtual-interfaces).
...
<a name="rpl-multicast"></a>
#### Multicast

Multicast is not used yet, but it is possible because of the selected mode of operations.

<a name="rpl-security"></a>
#### Security

RPL security [RFC6550](#RFC6550) is not used, and ACP security is substituted.
...
<a name="rpl-Data-Plane"></a>
#### RPL Packet Information

RPI is not required in the ACP RPL profile for the following reasons.

One RPI option is the RPL Source Routing Header (SRH) ("[An IPv6 Routing Header for Source Routes with the Routing Protocol for Low-Power and Lossy Networks (RPL)](#RFC6554)" [RFC6554](#RFC6554)), which is not 
           necessary because the ACP RPL profile uses storing mode where each hop has the necessary next-hop
           forwarding information.

The simpler RPL Option header "[The Routing Protocol for Low-Power and Lossy Networks (RPL) Option for Carrying RPL Information in Data-Plane Datagrams](#RFC6553)" [RFC6553](#RFC6553) is also
           not necessary in this profile, because it uses a single RPL instance and data-path
           validation is also not used.

<a name="rpl-unknown"></a>
...
As this requirement places additional constraints on the data plane
              ...
              administrative parameter from [Section 6.12.1.12](#rpl-admin) has value 0b001).
...
adjacent neighbors.  Note: [Section 8.2](#remote-acp-neighbors) specifies
...
To avoid impacting the operations of the
...
see [Appendix A.9.2](#dp-dependency).
...
of the secure channel protocols (IPsec and/or DTLS).

<a name="general_MTU"></a>
### MTU
...
<a name="general_multipath"></a>
### Multiple Links between Nodes

If two nodes are connected via several links, the ACP **SHOULD** be established across every link, but it is possible to establish the ACP only on a subset of links.  Having an ACP channel on every link has a number of advantages, for example, it allows for a faster failover in case of link failure, and it reflects the physical topology more closely.  Using a subset of links (for example, a single link), reduces resource consumption on the node because state needs to be kept per ACP channel.  The negotiation scheme explained in [Section 6.6](#channel-selection) allows the Decider (the node with the higher ACP address) to drop all but the desired ACP channels to the Follower, and the Follower will not retry to build these secure channels from its side unless the Decider appears with a previously unknown GRASP announcement (e.g., on a different link or with a different address announced in GRASP).

<a name="ACP_interfaces"></a>
### ACP Interfaces

Conceptually, the ACP VRF has two types of interfaces: the "ACP loopback 
...
<a name="ACP-loopback"></a>
#### ACP Loopback Interfaces

For autonomous operations of the ACP, as described in [Section 6](#self-creation)
        and [Section 7](#acp-l2-switches), the ACP node uses the first address from
        the N bit ACP prefix assigned to the node. N = (128 - number of Vbits of the ACP address).
        This address is assigned with an address prefix of N or larger to a loopback interface.

Other addresses from the prefix can be used by the ACP of the node as desired. 
        ...
        (see [Figure 14](#acp-connect)), may also introduce additional
        global-scope IPv6 addresses on other types of interfaces to the ACP.

The use of loopback interfaces for global-scope addresses is 
        common operational configuration practice on routers, for example, in Internal BGP (IBGP)
        connections since BGP4 (see "[A Border Gateway Protocol 4 (BGP-4)](#RFC1654)" [RFC1654](#RFC1654)) or earlier.
        The ACP adopts and automates this operational practice.

A loopback interface for use with the ACP as described above is an interface
        that behaves according to Section [RFC6724](#RFC6724) of ["Default Address Selection for Internet Protocol Version 6 (IPv6)"](#RFC6724), paragraph 2.
...
The term "loopback only" indicates this behavior, but not the actual name of the
...
A loopback interface used for the ACP **MUST NOT** have connectivity to other
        nodes.

The following list reviews the reasons for the choice of loopback addresses
        for ACP addresses, which is based on the IPv6 address architecture and common challenges:

1. IPv6 addresses are assigned to interfaces, not nodes. IPv6 continues
          the IPv4 model that a subnet prefix is associated with one link,
          see Section [RFC4291](#RFC4291) of ["IP Version 6 Addressing Architecture"](#RFC4291).
...
3. Global-scope addresses assigned to interfaces that connect to other
          ...
          This could render the addresses assigned to that interface unusable.
4. If failure of the subnet does not bring down the interface and make
          ...
          be operational even though it is not.
5. Many OAM service implementations on routers cannot deal with more than one peer address,
...
6. Even when an application supports multiple addresses to a peer, it
          ...
          transport protocols, TCP and UDP. While "[TCP Extensions for Multipath Operation with Multiple Addresses](#RFC6824)" [RFC6824](#RFC6824)/[RFC8684](#RFC8684) solves this problem,
...
7. To completely autonomously assign global-scope addresses to subnets
          ...
          with adjacent nodes across those subnets which address space to use for each subnet.
8. Using global-scope addresses for subnets between nodes is 
          ...
          it should attempt to minimize the per-node overhead of the ACP VRF.
9. For all these reasons, the ACP addressing sub-schemes do not consider
          ACP addresses for subnets connecting ACP nodes.

Note that "[Segment Routing Architecture](#RFC8402)" [RFC8402](#RFC8402) introduces the term Node-SID to refer
        to IGP prefix segments that identify a specific router, for example, on a loopback interface.
        An ACP loopback address prefix may similarly be called an ACP Node Identifier.

<a name="ACP-virtual-interfaces"></a>
#### ACP Virtual Interfaces

Any ACP secure channel to another ACP node is
        ...
        or other future protocol, either standardized or not).
...
Note that all the considerations described here assume point-to-point
        ...
        "[The Group Domain of Interpretation](#RFC6407)" [RFC6407](#RFC6407), is out of scope.

<a name="ACP-p2p-virtual-interfaces"></a>
##### ACP Point-to-Point Virtual Interfaces

In this option, each ACP secure channel is
...
When the secure channel protocol determines a peer to be dead, this **SHOULD**
        result in indicating link breakage to trigger RPL DODAG repair, see
        [Section 6.12.1.7](#rpl-dodag-repair).

<a name="ACP-ma-virtual-interfaces"></a>
##### ACP Multi-Access Virtual Interfaces

In a more advanced implementation approach,
        ...
        used to reach the packets' destination address.
...
When the secure channel protocol determines that a peer is dead for a
        ...
        RPL DODAG repair, see [Section 6.12.1.7](#rpl-dodag-repair).
...
ACP nodes **MUST** perform standard IPv6 operations across ACP
        ...
        [RFC4862](#RFC4862) to assign their IPv6 link-local address on the ACP
        virtual interface and ND ("[Neighbor Discovery for IP version 6 (IPv6)](#RFC4861)" [RFC4861](#RFC4861))
        ...
        This is independent of whether the ACP virtual interface is point-to-point or multi-access.

Optimistic Duplicate Address Detection (DAD) according to 
        "[Optimistic Duplicate Address Detection (DAD) for IPv6](#RFC4429)" [RFC4429](#RFC4429) is **RECOMMENDED** because the likelihood for
        ...
        (e.g., EUI-48/EUI-64, see below).

ACP nodes **MAY** reduce the amount of link-local IPv6 multicast
...
The ACP virtual interface IPv6 link-local address can be derived from
        ...
        that may not be protected by the secure channel mechanism.

The link-layer address of an ACP virtual interface is the
...
Multi-access ACP virtual interfaces are preferable implementations
        ...
        have been built running natively on the multi-access interfaces.

Consider also the impact of point-to-point vs. multi-access virtual interfaces
        on the efficiency of flooding via link-local multicast messages.
...
Assume a LAN with three ACP neighbors, Alice, Bob, and Carol.
        ...
        does not replicate packets back to the interface from which they were received.

Note that link-local GRASP multicast messages are not sent
        ...
        See [Section 6.9.2](#GRASP-substrate) for more details.
...
RPL does support operations and correct routing table construction
        ...
        represented as an ACP point-to-point virtual interface. See also [Appendix A.9.4](#future-rpl).
...
Care needs to be taken when creating multi-access ACP virtual
        ...
        virtual interfaces for these inter-domain secure channels.

<a name="acp-l2-switches"></a>
# ACP Support on L2 Switches/Ports (Normative)

<a name="acp-l2-switches-why"></a>
## Why (Benefits of ACP on L2 Switches)
...
```
Consider a large L2 LAN with routers ANrtr1 through ANrtrN connected via some topology of L2 switches.
Examples include large enterprise campus networks with an L2 core, IoT networks, or broadband
aggregation networks, which often have a multilevel L2-switched topology.

If the discovery protocol used for the ACP operates at the subnet level, every ACP router
...
full mesh would include those switches as well.

A full mesh of ACP connections can create fundamental scale challenges.  The number of
...
to support the ACP on arbitrary platforms and in arbitrary deployments.

Predictable scaling requirements for ACP neighbors can most easily be achieved if, in
...
in management operations or by ASAs.
...
<a name="acp-l2-switches-how"></a>
## How (per L2 Port DULL GRASP)

To support ACP on L2 switches or L2-switched ports of an L3 device, it is necessary to
...
all ports of the VLAN to which the port belongs).
...
peer by the VLAN logic of the device.
...
(see [Section 6.13.5.2.2](#ACP-ma-virtual-interfaces)), it is **REQUIRED** not to coalesce all
 the ACP secure channels on the same L3 VLAN interface, but only all those on the same L2 port.
...
ports where the VLAN is carried untagged.
...
secure channels to per-port L2-adjacent ACP node neighbors.

For example, in the above picture, ANswitch1 would run separate DULL GRASP instances on its ports
...
The description in the previous paragraph is specifically meant to illustrate that, on hybrid
...
L3 interface.  This hopefully makes support for per-L2 port ACP on those hybrid devices easy.

In devices without such a mix of L2 port/interfaces and L3 interfaces (to terminate any
...
type of L2 devices as simple as possible.
...
options are not sufficient to achieve this.

<a name="workarounds"></a>
# Support for Non-ACP Components (Normative)

<a name="ACPconnect"></a>
## ACP Connect

<a name="NMS"></a>
### Non-ACP Controller and/or Network Management System (NMS)
...
and that property could only be changed through reenrollment.  See also [Appendix A.9.5](#role-assignments).

ACP edge nodes **SHOULD** have a configurable option to prohibit packets with RPI headers (see [Section 6.12.1.13](#rpl-Data-Plane)) across an ACP connect interface. These headers are outside the scope of the RPL profile in this specification but may be used in future extensions of this specification.
...
<a name="ACautoconfig"></a>
### Autoconfiguration

ACP edge nodes, NMS hosts, and software components that, as described in the previous section, are meant to be composed via virtual interfaces **SHOULD** support SLAAC [RFC4862](#RFC4862) on the ACP connect subnet and route autoconfiguration according to "[Default Router Preferences and More-Specific Routes](#RFC4191)" [RFC4191](#RFC4191).

The ACP edge node acts as the router towards the ACP on the ACP connect subnet,
          providing the (auto)configured prefix for the ACP connect subnet and
          (auto)configured routes to the ACP to NMS hosts and/or software components.

The ACP edge node uses the Route Information Option (RIO) of [RFC4191](#RFC4191) to announce
...
These RIOs allow the connecting of type C hosts to the ACP via an ACP connect subnet on one interface
...
<a name="SingleIF"></a>
### Combined ACP and Data Plane Interface (VRF Select)
...
With separate ACP connect and data plane subnets and prefix announcements [RFC4191](#RFC4191) that are to be routed across the ACP connect interface, the source address selection of Rule 5 (use address of outgoing interface) ([RFC6724](#RFC6724)) will be used, so that above problems do not occur, even in more complex cases of multiple ULA and non-ULA prefixes in the ACP routing table.

To achieve the same behavior with a combined ACP and data plane interface, the ACP edge node needs to behave as two separate routers on the interface: one link-local IPv6 address/router for its ACP reachability, and one link-local IPv6 address/router for its data plane reachability.  The Router Advertisements for both are as described in [Section 8.1.3](#ACautoconfig): for the ACP, the ACP prefix is announced together with the prefix option [RFC4191](#RFC4191) routed across the ACP, and the lifetime is set to zero to disqualify this next hop as a default router.  For the data plane, the data plane prefix(es) are announced together with whatever default router parameters are used for the data plane.

As a result, source address selection Rule 5.5 ([RFC6724](#RFC6724)) may result in the same correct source address selection behavior of NMS hosts without further configuration as the separate ACP connect and data plane interfaces on the host.  As described in the text for Rule 5.5 ([RFC6724](#RFC6724)), this is only a **MAY** because IPv6 hosts are not required to track next-hop information.  If an NMS host does not do this, then separate ACP connect and data plane interfaces are the preferable method of attachment.  Hosts implementing "[First-Hop Router Selection by Hosts in a Multi-Prefix Network](#RFC8028)" [RFC8028](#RFC8028) should (instead of may) implement Rule 5.5 ([RFC6724](#RFC6724)), so it is preferred for hosts to support [RFC8028](#RFC8028).
...
GRASP can and should be possible to use across ACP connect interfaces, especially in
the architecturally correct solution when it is used as a mechanism to connect software
(e.g., ASA or legacy NMS applications) to the ACP.
...
and accordingly designed to isolate access to the ACP against external equipment.

The difference in security is that cryptographic security of the
...
interface. See [Section 8.1.1](#NMS).

When using the combined ACP and data plane interface, care has to be taken that
...
are also assumed to belong to the ACP address space.

<a name="remote-acp-neighbors"></a>
...
<a name="conf-remote"></a>
### Configured Remote ACP Neighbor

On the ACP node, remote ACP neighbors are configured explicitly. 
...
```
Explicit configuration of a remote peer according to this
ABNF provides all the information to build a secure channel without requiring a tunnel
to that peer and running DULL GRASP inside of it.

The configuration includes the parameters otherwise signaled
via DULL GRASP: local address, remote (peer) locator, and
method. The differences over DULL GRASP local neighbor
discovery and secure channel creation are as follows:
...
- If local address is "any", the local address used when initiating a secure channel connection is decided by source address selection ([RFC6724](#RFC6724) for IPv6). As a responder, the connection listens on all addresses of the node in the selected VRF.
...
<a name="conf-tunnel"></a>
### Tunneled Remote ACP Neighbor
...
An IP-in-IP, GRE, or other form of preexisting tunnel is configured
        ...
        with DULL and secure channel setup procedures described in this document.

Tunneled Remote ACP Neighbor requires two encapsulations:
        ...
        firewall while the secure channel method may not.
...
Tunneling using an insecure tunnel encapsulation increases, on average,
     ...
     attacked ACP secure channel option to force use of that option.
        ...
        (if the ACP node supports more than one ACP secure channel protocol in the first place).

<a name="conf-summary"></a>
### Summary
...
Configured and Tunneled Remote ACP Neighbors are less "indestructible"
        ...
        they depend on more correct data plane operations, such as routing and global addressing.
...
# ACP Operations (Informative)

The following sections document important operational aspects of the ACP. They are not normative because they do not impact the interoperability between components of the ACP, but they include recommendations and/or requirements for the internal operational model that are beneficial or necessary to achieve the desired use-case benefits of the ACP (see [Section 3](#usage)).

- [Section 9.1](#diagnostics) describes the recommended capabilities of operator diagnostics of ACP nodes.
- [Section 9.2](#registrar-considerations) describes at a high level how an ACP registrar needs to work, what its configuration parameters are, and specific issues impacting the choices of deployment design due to renewal and revocation issues. It describes a model where ACP registrars have their own sub-CA to provide the most distributed deployment option for ACP registrars, and it describes considerations for centralized policy control of ACP registrar operations.
- [Section 9.3](#enabling-acp) describes suggested ACP node behavior and operational interfaces (configuration options) to manage the ACP in so-called greenfield devices (previously unconfigured) and brownfield devices (preconfigured).
...
## ACP (and BRSKI) Diagnostics

Even though ACP and ANI in general are removing many manual configuration mistakes
through their automation, it is important to provide good diagnostics for them.
...
VRF, and so on.  While necessary, this is not sufficient.

Simply representing the state of components does not allow operators to quickly take
action -- unless they understand how to interpret the data, which can mean a
requirement for deep understanding of all components and how they interact in the ACP/ANI.

Diagnostic supports should help to quickly answer the questions operators
are expected to ask, such as "Is the ACP working correctly?" or "Why is there no
ACP connection to a known neighboring node?"
...
utilizing the ANI, it is not sufficient to diagnose the ANI itself:

- Developing the logic to identify common issues requires operational experience
with the components of the ANI.  Letting each management system define its
own analysis is inefficient.
...
capabilities available locally on the nodes themselves.
- Certain operations are difficult or impossible to monitor in real time, such as
...
The simplest form of diagnostics for answering questions such as the above
...
cause, or just log and/or highlight that item.  For example:

Question: Is the ACP operational to accept neighbor connections?

- Check if the necessary configurations to make ACP/ANI operational are correct (see [Section 9.3](#enabling-acp) for a discussion of such commands).
            ...
            Did the neighbor close the connection on us, or did we close the connection on it because the domain certificate membership failed?
              ...
              If we failed the attempt, display our local reason:
                There was no common secure channel protocol supported by the two neighbors (this could not happen on nodes supporting this specification because it mandates common support for IPsec).
                  Did the ACP certificate membership check ([Section 6.2.3](#certcheck)) fail?
...
The items so far illustrate how the ANI operations can
...
1. BRSKI does not allow for a neighboring
...
2. LLDP disseminates information about nodes,
    ...
    to make this information available unprotected to all possible neighbors.

An "interested adjacent party" can always determine the IDevID certificate of a BRSKI pledge
...
on the same subnet can determine who is an "interested adjacent party".

<a name="ta-troubleshoot"></a>
### Secure Channel Peer Diagnostics

When using mutual certificate authentication, the TA certificate is not required
...
For this reason, [Section 6.8.2](#common-requirements) recommends also including the TA certificate in the
secure channel signaling. This should be possible
to do without modifying the security association protocols used by the
ACP. For example, while [RFC7296](#RFC7296) does not mention this, it
also does not prohibit it.

One common use case where diagnostics through the signaled
...
receive L2 connectivity into the wrong tenant's network.

While the ACP itself is not impacted by this, the data plane to be built later may be
...
Another use case is the intended or accidental reactivation of equipment,
such as redundant gear taken from storage, whose TA certificate has long expired.

A third use case is when, in a merger and acquisition case, ACP nodes have not
...
domain membership check is only failing on the TA.
...
<a name="registrar-considerations"></a>
## ACP Registrars

As described in [Section 6.11.7](#acp-registrars), the ACP addressing
...
any appropriate mechanism and/or protocol, automated or not.

This section discusses informatively more details and options for ACP registrars.

<a name="reg-interact"></a>
### Registrar Interactions

This section summarizes and discusses the interactions with other entities required
by an ACP registrar.
...
ACP registrars can be set up, performing the following interactions.

To orchestrate enrolling a candidate ACP node autonomically,
...
In non-autonomic enrollment options, the data plane 
...
For example, NETCONF Zero Touch ("[Secure Zero Touch Provisioning (SZTP)](#RFC8572)" [RFC8572](#RFC8572))
...
it is presented with a voucher (see "[A Voucher Artifact for Bootstrapping Protocols](#RFC8366)" [RFC8366](#RFC8366)) authorizing
...
The interactions of an ACP registrar outlined in [Section 6.11.7](#acp-registrars) and
[Section 9.2.1](#reg-interact) depend on the following parameters:

- A URL to the TA and credentials so that the ACP
   registrar can let the TA sign candidate ACP node certificates.
- The ACP domain name.
- The Registrar-ID to use. This could default to a MAC address of the ACP registrar.
- For recovery, the next usable Node-IDs for the Zone Addressing Sub-Scheme (Zone-ID 0)
     ...
     from the set of currently known ACP nodes.
- Policies on whether the candidate ACP nodes should receive a domain certificate or not,
     for example, based on the device's IDevID certificate as in BRSKI. The ACP registrar may 
     whitelist or blacklist based on a device's "serialNumber" attribute [X.520](#X.520) in the subject field distinguished name encoding of its IDevID certificate.
- Policies on what type of address prefix to assign to a candidate ACP device,
     likely based on the same information.
- For BRSKI or other mechanisms using vouchers: parameters to determine
     ...
     learned, such as from the IDevID certificate of candidate ACP nodes (as defined in BRSKI).

<a name="cert-renewal"></a>
### Certificate Renewal and Limitations

When an ACP node renews and/or rekeys its certificate, it may end up doing so via
...
ACP certificate is signaled during the TLS handshake.

This simple scenario has two limitations:

1. The ACP registrar cannot directly assign certificates to nodes and
     therefore needs an "online" connection to the TA.
2. Recovery from a compromised ACP registrar is difficult.
...
As the ACP domain membership check verifies a
...
ACP nodes enrolled by a compromised ACP registrar
...
- Deciding which candidate ACP node is permitted or not permitted into an
     ...
     a human decision in a NOC.
- Tracking all enrolled ACP nodes and their certificate information.
     For example, in support of revoking an individual ACP node's certificates.
...
was successfully enrolled onto a candidate ACP node.

<a name="enabling-acp"></a>
## Enabling and Disabling the ACP and/or the ANI
...
<a name="secure-enabling"></a>
### Filtering for Non-ACP/ANI Packets
...
<a name="down-security"></a>
#### Security

Interfaces are physically brought down (or left in default "down" state) as a form of security.
...
the deployment's security review  whether "admin down" is a feasible replacement for "physical down".

The need to trust the security of ACP/ANI operations needs to be weighed against
...
on interfaces in "admin down" state.

<a name="down-fast-state-propagation"></a>
#### Fast State Propagation and Diagnostics
...
have the same (fast) result.

Bringing interfaces to "physical down" state is, to the best of our knowledge, always
...
Ideally, fast physical state propagation is replaced by fast software-driven state
propagation.  For example, a DULL GRASP "admin-state" objective could be used to autoconfigure
a BFD session ("[Bidirectional Forwarding Detection (BFD)](#RFC5880)" [RFC5880](#RFC5880)) between the two sides of the link that would be used to propagate the
"up" vs. "admin down" state.

Triggering "physical down" state may also be used as a means of diagnosing cabling issues
...
determine whether up/down toggling will cause the same reaction on the remote side.

See [Section 9.1](#diagnostics) for a discussion about how LLDP and/or diagnostics
...
neighbors support ACP/ANI.

<a name="low-level-link"></a>
#### Low-Level Link Diagnostics
...
Power consumption of "physical down" interfaces may be significantly lower than those
...
Automatically setting "ANI enable" on brownfield nodes where the operator is unaware of BRSKI and MASA operations 
...
Nodes that claim to support ANI greenfield operations **SHOULD NOT** enable in parallel to BRSKI any enrollment/bootstrap protocol/mechanism that allows Trust On First Use (TOFU, "[Opportunistic Security: Some Protection Most of the Time](#RFC7435)" [RFC7435](#RFC7435)) over interfaces other than those traditionally indicating physical possession of the node.  Protocols/mechanisms with published default username/password authentication are considered to suffer from TOFU. Securing the bootstrap protocol/mechanism by requiring a voucher [RFC8366](#RFC8366) can be used to avoid TOFU.
...
<a name="disabling"></a>
### Undoing "ANI/ACP enable"

Disabling ANI/ACP by undoing "ACP/ANI enable" is a risk for the reliable operations of the ACP if it can be executed by mistake or without authorization.  
...
<a name="incremental-adoption"></a>
## Partial or Incremental Adoption

The Zone Addressing Sub-Scheme (see [Section 6.11.3](#zone-scheme)) allows incremental
adoption of the ACP in a network where ACP can be deployed on edge areas, but not
across the core that is connecting those edges.

In such a setup, each edge network, such as a branch or campus of an enterprise network,
...
common set of TAs and of course the same ACP domain name.

These ACP zones can first be brought up as separate networks without any connection
...
from those ACP VRFs across the VPN's non-autonomic routing protocol(s).
...
for every individual ACP node as required in the other ACP addressing schemes.

Note that the non-autonomous ACP-Core VPN requires additional extensions
to propagate GRASP messages when GRASP discovery is desired across the zones.
...
example L3VPN multicast support.

Finally, these partial deployments can be merged into a single, contiguous
ACP that is completely autonomous (given appropriate ACP support across the core) without changes
in the cryptographic material because the node's ACP certificates are from a single ACP.
...
- Certificate maintenance requires PKI functions. Discovery of these functions across the ACP is automated (see [Section 6.2.5](#domcert-maint)), but their configuration is not.
- When non-ACP-capable nodes such as preexisting NMS need to be physically connected to the ACP, the ACP node to which they attach needs to be configured with ACP connect according to [Section 8.1](#ACPconnect). It is also possible to use that single physical connection to connect both to the ACP and the data plane of the network as explained in [Section 8.1.4](#SingleIF).
- When devices are not autonomically bootstrapped, explicit configuration to enable the ACP needs to be applied. See [Section 9.3](#enabling-acp).
- When the ACP needs to be extended across interfaces other than L2, the ACP as defined in this document cannot auto-discover candidate neighbors automatically. Remote neighbors need to be configured, see [Section 8.2](#remote-acp-neighbors).
...
Merging two networks with different TAs requires the ACP nodes to trust the union of TAs.  As long as the routing-subdomain hashes are different, the addressing will not overlap. Overlaps will only happen accidentally in the unlikely event of a 40-bit hash collision in SHA-256 (see [Section 6.11](#addressing)).
Note that the complete mechanisms to merge networks is out of scope of this specification.
...
<a name="self-protecting"></a>
## Self-Protection Properties

<a name="self-protecting-outside"></a>
### From the Outside

As explained in [Section 6](#self-creation), the ACP is based on secure channels built between nodes that have mutually authenticated each other with their domain certificates.  The channels themselves are protected using standard encryption technologies such as DTLS or IPsec, which provide additional authentication during channel establishment, data integrity, and data confidentiality protection inside the ACP, and also provide replay protection.
...
The degree to which compromised ACP nodes can impact the ACP depends on the implementation of the ACP nodes and their impairment. When an attacker has only gained administrative privileges to configure ACP nodes remotely, the attacker can disrupt the ACP only through one of the few configuration options to disable it (see [Section 9.3](#enabling-acp)) or by the configuring of non-autonomic ACP options if those are supported on the impaired ACP nodes (see [Section 8](#workarounds)). Injecting traffic into or extracting traffic from an impaired ACP node is only possible when an impaired ACP node supports ACP connect (see [Section 8.1](#ACPconnect)), and the attacker can control traffic into/from one of the ACP node's interfaces, such as by having physical access to the ACP node.

The ACP also serves as protection (through authentication and encryption) for protocols relevant to OAM that may not have secured protocol stack options or where implementation or deployment of those options fail due to some vendor, product, or customer limitations.  This includes protocols such as SNMP ("[An Architecture for Describing Simple Network Management Protocol (SNMP) Management Frameworks](#RFC3411)" [RFC3411](#RFC3411)), NTP [RFC5905](#RFC5905), PTP (Precision Time Protocol [IEEE-1588-2008](#IEEE-1588-2008)), DNS ("[DNS Extensions to Support IP Version 6](#RFC3596)" [RFC3596](#RFC3596)), DHCPv6 ("[Dynamic Host Configuration Protocol for IPv6 (DHCPv6)](#RFC3315)" [RFC3315](#RFC3315)), syslog ("[The BSD Syslog Protocol](#RFC3164)" [RFC3164](#RFC3164)), RADIUS ("[Remote Authentication Dial In User Service (RADIUS)](#RFC2865)" [RFC2865](#RFC2865)), Diameter ("[Diameter Base Protocol](#RFC6733)" [RFC6733](#RFC6733)), TACACS ("[An Access Control Protocol, Sometimes Called TACACS](#RFC1492)" [RFC1492](#RFC1492)), IPFIX ("[Specification of the IP Flow Information Export (IPFIX) Protocol for the Exchange of Flow Information](#RFC7011)" [RFC7011](#RFC7011)), NetFlow ("[Cisco Systems NetFlow Services Export Version 9](#RFC3954)" [RFC3954](#RFC3954)) -- just to name a few. Not all of these protocol references are necessarily the latest version of protocols, but they are versions that are still widely deployed.
...
<a name="self-protecting-inside"></a>
### From the Inside

The security model of the ACP is based on trusting all members of the group of nodes
 that receive an ACP certificate for the same domain.  Attacks from the inside by
a compromised group member are therefore the biggest challenge.

Group members must be protected against attackers so that there is no easy way to compromise them
...
the ACP in mind than in legacy, software-based systems where the ACP is added on as another feature.
...
or modify communications, but they can just filter them (which is unavoidable by any means).

See [Appendix A.9.8](#compromised) for further considerations on avoiding and dealing with
compromised nodes.
...
While configuration (except for [Section 8](#workarounds) and  [Section 9.2](#registrar-considerations))
...
Since an ACP is self-protecting, a node that does not support the ACP or that does not have a valid domain certificate cannot connect to it.  This means that by default a traditional controller or NMS cannot connect to an ACP.  See [Section 8.1.1](#NMS) for details on how to connect an NMS host to the ACP.
...
The self-protecting property does not include workarounds for non-autonomic components as explained in [Section 8](#workarounds). See [Section 10.2](#self-protecting) for details of how the ACP protects itself against attacks from the outside and, to a more limited degree, from the inside as well.
...
Because ACP peers select one out of potentially more than one mutually supported ACP secure channel protocols via the approach described in [Section 6.6](#channel-selection), ACP secure channel setup is subject to downgrade attacks by MITM attackers. This can be discovered after such an attack by additional mechanisms described in [Appendix A.9.9](#downgrade). Alternatively, more advanced channel selection mechanisms can be devised.

The security model of the ACP as defined in this document is tailored for use with private PKI. The TA of a private PKI provides the security against maliciously created ACP certificates that give access to an ACP. Such attacks can create fake ACP certificates with correct-looking AcpNodeNames, but those certificates would not pass the certificate path validation of the ACP domain membership check (see [Section 6.2.3](#certcheck), point 2).
...
Mitigation against compromised ACP members is possible through standard automated certificate management mechanisms including revocation and nonrenewal of short-lived certificates. In this specification, there are no further optimizations of these mechanisms defined for the ACP (but see [Appendix A.9.8](#compromised)).

Higher-layer service built using ACP certificates should not solely rely on undifferentiated group security when another model is more appropriate or more secure. For example, central network configuration relies on a security model where only a few especially trusted nodes are allowed to configure the data plane of network nodes (CLI, NETCONF). This can be done through ACP certificates by differentiating them and introducing roles. See [Appendix A.9.5](#role-assignments).

Operators and developers of provisioning software need to be aware of how the provisioning and configuration of network devices impacts the ability of the operator and/or provisioning software to remotely access the network nodes. By using the ACP, most of the issues of provisioning/configuration causing connectivity loss of remote provisioning and configuration will be eliminated, see [Section 6](#self-creation). Only a few exceptions, such as explicit physical interface down configuration, will be left. See [Section 9.3.2](#admin-down).

Many details of ACP are designed with security in mind and discussed elsewhere in the document.

IPv6 addresses used by nodes in the ACP are covered as part of the node's domain certificate as described in [Section 6.2.2](#domcert-acpinfo).  This allows even verification of ownership of a peer's IPv6 address when using a connection authenticated with the domain certificate.

The ACP acts as a security (and transport) substrate for GRASP inside the ACP such that GRASP is not only protected by attacks from the outside, but also by attacks from compromised inside attackers -- by relying not only on hop-by-hop security of ACP secure channels, but also by adding end-to-end security for those GRASP messages.  See [Section 6.9.2](#GRASP-substrate).

ACP provides for secure, resilient zero-touch discovery of EST servers for certificate renewal.  See [Section 6.2.5](#domcert-maint).

ACP provides extensible, autoconfiguring hop-by-hop protection of the ACP infrastructure via the negotiation of hop-by-hop secure channel protocols.  See [Section 6.6](#channel-selection).

The ACP is designed to minimize attacks from the outside by minimizing its dependency on any non-ACP (data plane) operations and/or configuration on a node.  See also [Section 6.13.2](#general_addressing).

In combination with BRSKI, ACP enables a resilient, fully zero-touch network solution for short-lived certificates that can be renewed or reenrolled even after unintentional expiry (e.g., due to interrupted connectivity).  See [Appendix A.2](#bootstrap).

Because ACP secure channels can be long lived, but certificates used may be short-lived, secure channels, for example, built via IPsec, need to be terminated when peer certificates expire. See [Section 6.8.5](#Profiles).

[Section 7.2](#acp-l2-switches-how) describes how to implement a routed
...
GRASP DULL instance needs to ensure that the IPv6 address in the locator-option matches the source IPv6 address of the DULL GRASP packet.
...
For the ANIMA-ACP-2020 ASN.1 module, IANA has assigned 
...
IANA has registered the names in [Table 2](#iana-objnames) in 
the "GRASP Objective Names" subregistry of the "GeneRic Autonomic Signaling Protocol (GRASP) Parameters" registry.

**Table: GRASP Objective Names**

| Objective Name | Reference |
| --- | --- |
| AN_ACP | RFC 8994 ([Section 6.4](#discovery-grasp)) |
| SRV.est | RFC 8994 ([Section 6.2.5](#domcert-maint)) |

Explanation: this document chooses the initially strange looking format "SRV.<service-name>" because these objective names would be in line with potential future simplification of the GRASP objective registry. Today, every name in the GRASP objective registry needs to be explicitly allocated by IANA. In the future, this type of objective names could be considered to be automatically registered in that registry for the same service for which a <service-name> is registered according to [RFC6335](#RFC6335). This explanation is solely informational and has no impact on the requested registration.

IANA has created an "Autonomic Control Plane (ACP)" registry with
the subregistry, "ACP Address Type" ([Table 3](#iana-acpaddresstype)).

**Table: Initial Values in the "ACP Address Type" Subregistry**

| Value | Description | Reference |
| --- | --- | --- |
| 0 | ACP Zone Addressing Sub-Scheme/ACP Manual Addressing Sub-Scheme | RFC 8994 ([Section 6.11.3](#zone-scheme), [Section 6.11.4](#manual-scheme)) |
| 1 | ACP Vlong Addressing Sub-Scheme | RFC 8994 ([Section 6.11.5](#Vlong)) |
| 2-3 | Unassigned |  |

The values in the "ACP Address Type" subregistry are numeric values 0..3 paired with a name (string).  Future values **MUST** be assigned using the Standards Action policy defined by "[Guidelines for Writing an IANA Considerations Section in RFCs](#RFC8126)" [RFC8126](#RFC8126).
...
<a name="IKEV2IANA"></a> **[IKEV2IANA]** IANA, "Internet Key Exchange Version 2 (IKEv2) Parameters", <https://www.iana.org/assignments/ikev2-parameters>

<a name="RFC1034"></a> **[RFC1034]** P.V. Mockapetris, "Domain names - concepts and facilities", STD 13, RFC 1034, DOI 10.17487/RFC1034, November 1987. <https://www.rfc-editor.org/info/rfc1034> [Local MD](rfc1034.md)
...
<a name="RFC3810"></a> **[RFC3810]** R. Vida, L. Costa, "Multicast Listener Discovery Version 2 (MLDv2) for IPv6", RFC 3810, DOI 10.17487/RFC3810, June 2004. <https://www.rfc-editor.org/info/rfc3810> [Local MD](rfc3810.md)

<a name="RFC4191"></a> **[RFC4191]** R. Draves, D. Thaler, "Default Router Preferences and More-Specific Routes", RFC 4191, DOI 10.17487/RFC4191, November 2005. <https://www.rfc-editor.org/info/rfc4191> [Local MD](rfc4191.md)

<a name="RFC4193"></a> **[RFC4193]** R. Hinden, B. Haberman, "Unique Local IPv6 Unicast Addresses", RFC 4193, DOI 10.17487/RFC4193, October 2005. <https://www.rfc-editor.org/info/rfc4193> [Local MD](rfc4193.md)
...
<a name="RFC4301"></a> **[RFC4301]** S. Kent, K. Seo, "Security Architecture for the Internet Protocol", RFC 4301, DOI 10.17487/RFC4301, December 2005. <https://www.rfc-editor.org/info/rfc4301> [Local MD](rfc4301.md)

<a name="RFC4861"></a> **[RFC4861]** T. Narten, E. Nordmark, W. Simpson, H. Soliman, "Neighbor Discovery for IP version 6 (IPv6)", RFC 4861, DOI 10.17487/RFC4861, September 2007. <https://www.rfc-editor.org/info/rfc4861> [Local MD](rfc4861.md)

<a name="RFC4862"></a> **[RFC4862]** S. Thomson, T. Narten, T. Jinmei, "IPv6 Stateless Address Autoconfiguration", RFC 4862, DOI 10.17487/RFC4862, September 2007. <https://www.rfc-editor.org/info/rfc4862> [Local MD](rfc4862.md)

<a name="RFC5234"></a> **[RFC5234]** D. Crocker, P. Overell, "Augmented BNF for Syntax Specifications: ABNF", STD 68, RFC 5234, DOI 10.17487/RFC5234, January 2008. <https://www.rfc-editor.org/info/rfc5234> [Local MD](rfc5234.md)
...
<a name="RFC5954"></a> **[RFC5954]** V. Gurbani, B. Carpenter, B. Tate, "Essential Correction for IPv6 ABNF and URI Comparison in RFC 3261", RFC 5954, DOI 10.17487/RFC5954, August 2010. <https://www.rfc-editor.org/info/rfc5954> [Local MD](rfc5954.md)
...
<a name="RFC6550"></a> **[RFC6550]** T. Winter, P. Thubert, A. Brandt, J. Hui, R. Kelsey, P. Levis, K. Pister, R. Struik, JP. Vasseur, R. Alexander, "RPL: IPv6 Routing Protocol for Low-Power and Lossy Networks", RFC 6550, DOI 10.17487/RFC6550, March 2012. <https://www.rfc-editor.org/info/rfc6550> [Local MD](rfc6550.md)

<a name="RFC6551"></a> **[RFC6551]** JP. Vasseur, M. Kim, K. Pister, N. Dejean, D. Barthel, "Routing Metrics Used for Path Calculation in Low-Power and Lossy Networks", RFC 6551, DOI 10.17487/RFC6551, March 2012. <https://www.rfc-editor.org/info/rfc6551> [Local MD](rfc6551.md)

<a name="RFC6552"></a> **[RFC6552]** P. Thubert, "Objective Function Zero for the Routing Protocol for Low-Power and Lossy Networks (RPL)", RFC 6552, DOI 10.17487/RFC6552, March 2012. <https://www.rfc-editor.org/info/rfc6552> [Local MD](rfc6552.md)

<a name="RFC6553"></a> **[RFC6553]** J. Hui, JP. Vasseur, "The Routing Protocol for Low-Power and Lossy Networks (RPL) Option for Carrying RPL Information in Data-Plane Datagrams", RFC 6553, DOI 10.17487/RFC6553, March 2012. <https://www.rfc-editor.org/info/rfc6553> [Local MD](rfc6553.md)

<a name="RFC7030"></a> **[RFC7030]** M. Pritikin, P. Yee, D. Harkins, "Enrollment over Secure Transport", RFC 7030, DOI 10.17487/RFC7030, October 2013. <https://www.rfc-editor.org/info/rfc7030> [Local MD](rfc7030.md)

<a name="RFC7296"></a> **[RFC7296]** C. Kaufman, P. Hoffman, Y. Nir, P. Eronen, T. Kivinen, "Internet Key Exchange Protocol Version 2 (IKEv2)", STD 79, RFC 7296, DOI 10.17487/RFC7296, October 2014. <https://www.rfc-editor.org/info/rfc7296> [Local MD](rfc7296.md)
...
<a name="RFC7676"></a> **[RFC7676]** C. Pignataro, R. Bonica, S. Krishnan, "IPv6 Support for Generic Routing Encapsulation (GRE)", RFC 7676, DOI 10.17487/RFC7676, October 2015. <https://www.rfc-editor.org/info/rfc7676> [Local MD](rfc7676.md)
...
<a name="RFC8221"></a> **[RFC8221]** P. Wouters, D. Migault, J. Mattsson, Y. Nir, T. Kivinen, "Cryptographic Algorithm Implementation Requirements and Usage Guidance for Encapsulating Security Payload (ESP) and Authentication Header (AH)", RFC 8221, DOI 10.17487/RFC8221, October 2017. <https://www.rfc-editor.org/info/rfc8221> [Local MD](rfc8221.md)

<a name="RFC8247"></a> **[RFC8247]** Y. Nir, T. Kivinen, P. Wouters, D. Migault, "Algorithm Implementation Requirements and Usage Guidance for the Internet Key Exchange Protocol Version 2 (IKEv2)", RFC 8247, DOI 10.17487/RFC8247, September 2017. <https://www.rfc-editor.org/info/rfc8247> [Local MD](rfc8247.md)
...
<a name="RFC8610"></a> **[RFC8610]** H. Birkholz, C. Vigano, C. Bormann, "Concise Data Definition Language (CDDL): A Notational Convention to Express Concise Binary Object Representation (CBOR) and JSON Data Structures", RFC 8610, DOI 10.17487/RFC8610, June 2019. <https://www.rfc-editor.org/info/rfc8610> [Local MD](rfc8610.md)

<a name="RFC8990"></a> **[RFC8990]** C Bormann, B Carpenter, B Liu, "GeneRic Autonomic Signaling Protocol (GRASP)", RFC 8990, DOI 10.17487/RFC8990, May 2021. <https://www.rfc-editor.org/info/rfc8990> [Local MD](rfc8990.md)

<a name="RFC8995"></a> **[RFC8995]** M Pritikin, M Richardson, T Eckert, M Behringer, K Watsen, "Bootstrapping Remote Secure Key Infrastructure (BRSKI)", RFC 8995, DOI 10.17487/RFC8995, May 2021. <https://www.rfc-editor.org/info/rfc8995> [Local MD](rfc8995.md)

## Informative References

<a name="AR8021"></a> **[AR8021]** "IEEE Standard for Local and metropolitan area networks - Secure Device Identity", IEEE 802.1AR, <https://1.ieee802.org/security/802-1ar>

<a name="CABFORUM"></a> **[CABFORUM]** "Certificate Contents for Baseline SSL", Nov 2019. <https://cabforum.org/baseline-requirements-certificate-contents/>

<a name="FCC"></a> **[FCC]** "June 15, 2020 T-Mobile Network Outage Report", PS Docket No. 20-183, October 2020. A Report of the Public Safety and Homeland Security Bureau
	Federal Communications Commission <https://docs.fcc.gov/public/attachments/DOC-367699A1.docx>

<a name="IEEE-1588-2008"></a> **[IEEE-1588-2008]** "IEEE Standard for a Precision Clock Synchronization Protocol for Networked Measurement and Control Systems", DOI 10.1109/IEEESTD.2008.4579760, IEEE 1588-2008, July 2008. <https://standards.ieee.org/standard/1588-2008.html>

<a name="IEEE-802.1X"></a> **[IEEE-802.1X]** "IEEE Standard for Local and metropolitan area networks--Port-Based Network Access Control", DOI 10.1109/IEEESTD.2010.5409813, IEEE 802.1X-2010, February 2010. <https://standards.ieee.org/standard/802_1X-2010.html>

<a name="LLDP"></a> **[LLDP]** "IEEE Standard for Local and metropolitan area networks: Station and Media Access Control Connectivity Discovery", DOI 10.1109/IEEESTD.2016.7433915, IEEE 802.1AB-2016, March 2016. <https://standards.ieee.org/standard/802_1AB-2016.html>

<a name="MACSEC"></a> **[MACSEC]** "IEEE Standard for Local and Metropolitan Area Networks: Media Access Control (MAC) Security", DOI 10.1109/IEEESTD.2006.245590, IEEE 802.1AE-2006, August 2006. <https://standards.ieee.org/standard/802_1AE-2006.html>

<a name="I-D.eckert-anima-noc-autoconfig"></a> **[NOC-AUTOCONFIG]** Toerless Eckert, "Autoconfiguration of NOC services in ACP networks via GRASP", Internet-Draft draft-eckert-anima-noc-autoconfig-00, July 2018. Work in Progress <https://tools.ietf.org/html/draft-eckert-anima-noc-autoconfig-00>

<a name="OP-TECH"></a> **[OP-TECH]** "Operational technology", October 2020. <https://en.wikipedia.org/w/index.php?title=Operational_technology&oldid=986363045>

<a name="RFC1112"></a> **[RFC1112]** S.E. Deering, "Host extensions for IP multicasting", STD 5, RFC 1112, DOI 10.17487/RFC1112, August 1989. <https://www.rfc-editor.org/info/rfc1112> [Local MD](rfc1112.md)

<a name="RFC1492"></a> **[RFC1492]** C. Finseth, "An Access Control Protocol, Sometimes Called TACACS", RFC 1492, DOI 10.17487/RFC1492, July 1993. <https://www.rfc-editor.org/info/rfc1492> [Local MD](rfc1492.md)

<a name="RFC1654"></a> **[RFC1654]** Y. Rekhter, T. Li, "A Border Gateway Protocol 4 (BGP-4)", RFC 1654, DOI 10.17487/RFC1654, July 1994. <https://www.rfc-editor.org/info/rfc1654> [Local MD](rfc1654.md)

<a name="RFC1918"></a> **[RFC1918]** Y. Rekhter, B. Moskowitz, D. Karrenberg, G. J. de Groot, E. Lear, "Address Allocation for Private Internets", BCP 5, RFC 1918, DOI 10.17487/RFC1918, February 1996. <https://www.rfc-editor.org/info/rfc1918> [Local MD](rfc1918.md)

<a name="RFC2315"></a> **[RFC2315]** B. Kaliski, "PKCS #7: Cryptographic Message Syntax Version 1.5", RFC 2315, DOI 10.17487/RFC2315, March 1998. <https://www.rfc-editor.org/info/rfc2315> [Local MD](rfc2315.md)

<a name="RFC2409"></a> **[RFC2409]** D. Harkins, D. Carrel, "The Internet Key Exchange (IKE)", RFC 2409, DOI 10.17487/RFC2409, November 1998. <https://www.rfc-editor.org/info/rfc2409> [Local MD](rfc2409.md)

<a name="RFC2865"></a> **[RFC2865]** C. Rigney, S. Willens, A. Rubens, W. Simpson, "Remote Authentication Dial In User Service (RADIUS)", RFC 2865, DOI 10.17487/RFC2865, June 2000. <https://www.rfc-editor.org/info/rfc2865> [Local MD](rfc2865.md)

<a name="RFC3164"></a> **[RFC3164]** C. Lonvick, "The BSD Syslog Protocol", RFC 3164, DOI 10.17487/RFC3164, August 2001. <https://www.rfc-editor.org/info/rfc3164> [Local MD](rfc3164.md)

<a name="RFC3315"></a> **[RFC3315]** R. Droms, J. Bound, B. Volz, T. Lemon, C. Perkins, M. Carney, "Dynamic Host Configuration Protocol for IPv6 (DHCPv6)", RFC 3315, DOI 10.17487/RFC3315, July 2003. <https://www.rfc-editor.org/info/rfc3315> [Local MD](rfc3315.md)

<a name="RFC3411"></a> **[RFC3411]** D. Harrington, R. Presuhn, B. Wijnen, "An Architecture for Describing Simple Network Management Protocol (SNMP) Management Frameworks", STD 62, RFC 3411, DOI 10.17487/RFC3411, December 2002. <https://www.rfc-editor.org/info/rfc3411> [Local MD](rfc3411.md)

<a name="RFC3596"></a> **[RFC3596]** S. Thomson, C. Huitema, V. Ksinant, M. Souissi, "DNS Extensions to Support IP Version 6", STD 88, RFC 3596, DOI 10.17487/RFC3596, October 2003. <https://www.rfc-editor.org/info/rfc3596> [Local MD](rfc3596.md)

<a name="RFC3954"></a> **[RFC3954]** B. Claise, "Cisco Systems NetFlow Services Export Version 9", RFC 3954, DOI 10.17487/RFC3954, October 2004. <https://www.rfc-editor.org/info/rfc3954> [Local MD](rfc3954.md)

<a name="RFC4007"></a> **[RFC4007]** S. Deering, B. Haberman, T. Jinmei, E. Nordmark, B. Zill, "IPv6 Scoped Address Architecture", RFC 4007, DOI 10.17487/RFC4007, March 2005. <https://www.rfc-editor.org/info/rfc4007> [Local MD](rfc4007.md)

<a name="RFC4210"></a> **[RFC4210]** C. Adams, S. Farrell, T. Kause, T. Mononen, "Internet X.509 Public Key Infrastructure Certificate Management Protocol (CMP)", RFC 4210, DOI 10.17487/RFC4210, September 2005. <https://www.rfc-editor.org/info/rfc4210> [Local MD](rfc4210.md)
...
<a name="RFC4429"></a> **[RFC4429]** N. Moore, "Optimistic Duplicate Address Detection (DAD) for IPv6", RFC 4429, DOI 10.17487/RFC4429, April 2006. <https://www.rfc-editor.org/info/rfc4429> [Local MD](rfc4429.md)

<a name="RFC4541"></a> **[RFC4541]** M. Christensen, K. Kimball, F. Solensky, "Considerations for Internet Group Management Protocol (IGMP) and Multicast Listener Discovery (MLD) Snooping Switches", RFC 4541, DOI 10.17487/RFC4541, May 2006. <https://www.rfc-editor.org/info/rfc4541> [Local MD](rfc4541.md)

<a name="RFC4604"></a> **[RFC4604]** H. Holbrook, B. Cain, B. Haberman, "Using Internet Group Management Protocol Version 3 (IGMPv3) and Multicast Listener Discovery Protocol Version 2 (MLDv2) for Source-Specific Multicast", RFC 4604, DOI 10.17487/RFC4604, August 2006. <https://www.rfc-editor.org/info/rfc4604> [Local MD](rfc4604.md)

<a name="RFC4607"></a> **[RFC4607]** H. Holbrook, B. Cain, "Source-Specific Multicast for IP", RFC 4607, DOI 10.17487/RFC4607, August 2006. <https://www.rfc-editor.org/info/rfc4607> [Local MD](rfc4607.md)

<a name="RFC4610"></a> **[RFC4610]** D. Farinacci, Y. Cai, "Anycast-RP Using Protocol Independent Multicast (PIM)", RFC 4610, DOI 10.17487/RFC4610, August 2006. <https://www.rfc-editor.org/info/rfc4610> [Local MD](rfc4610.md)

<a name="RFC4985"></a> **[RFC4985]** S. Santesson, "Internet X.509 Public Key Infrastructure Subject Alternative Name for Expression of Service Name", RFC 4985, DOI 10.17487/RFC4985, August 2007. <https://www.rfc-editor.org/info/rfc4985> [Local MD](rfc4985.md)

<a name="RFC5790"></a> **[RFC5790]** H. Liu, W. Cao, H. Asaeda, "Lightweight Internet Group Management Protocol Version 3 (IGMPv3) and Multicast Listener Discovery Version 2 (MLDv2) Protocols", RFC 5790, DOI 10.17487/RFC5790, February 2010. <https://www.rfc-editor.org/info/rfc5790> [Local MD](rfc5790.md)

<a name="RFC5880"></a> **[RFC5880]** D. Katz, D. Ward, "Bidirectional Forwarding Detection (BFD)", RFC 5880, DOI 10.17487/RFC5880, June 2010. <https://www.rfc-editor.org/info/rfc5880> [Local MD](rfc5880.md)

<a name="RFC5905"></a> **[RFC5905]** D. Mills, J. Martin, J. Burbank, W. Kasch, "Network Time Protocol Version 4: Protocol and Algorithms Specification", RFC 5905, DOI 10.17487/RFC5905, June 2010. <https://www.rfc-editor.org/info/rfc5905> [Local MD](rfc5905.md)

<a name="RFC5912"></a> **[RFC5912]** P. Hoffman, J. Schaad, "New ASN.1 Modules for the Public Key Infrastructure Using X.509 (PKIX)", RFC 5912, DOI 10.17487/RFC5912, June 2010. <https://www.rfc-editor.org/info/rfc5912> [Local MD](rfc5912.md)
...
<a name="RFC6335"></a> **[RFC6335]** M. Cotton, L. Eggert, J. Touch, M. Westerlund, S. Cheshire, "Internet Assigned Numbers Authority (IANA) Procedures for the Management of the Service Name and Transport Protocol Port Number Registry", BCP 165, RFC 6335, DOI 10.17487/RFC6335, August 2011. <https://www.rfc-editor.org/info/rfc6335> [Local MD](rfc6335.md)

<a name="RFC6402"></a> **[RFC6402]** J. Schaad, "Certificate Management over CMS (CMC) Updates", RFC 6402, DOI 10.17487/RFC6402, November 2011. <https://www.rfc-editor.org/info/rfc6402> [Local MD](rfc6402.md)

<a name="RFC6407"></a> **[RFC6407]** B. Weis, S. Rowles, T. Hardjono, "The Group Domain of Interpretation", RFC 6407, DOI 10.17487/RFC6407, October 2011. <https://www.rfc-editor.org/info/rfc6407> [Local MD](rfc6407.md)

<a name="RFC6554"></a> **[RFC6554]** J. Hui, JP. Vasseur, D. Culler, V. Manral, "An IPv6 Routing Header for Source Routes with the Routing Protocol for Low-Power and Lossy Networks (RPL)", RFC 6554, DOI 10.17487/RFC6554, March 2012. <https://www.rfc-editor.org/info/rfc6554> [Local MD](rfc6554.md)

<a name="RFC6724"></a> **[RFC6724]** D. Thaler, R. Draves, A. Matsumoto, T. Chown, "Default Address Selection for Internet Protocol Version 6 (IPv6)", RFC 6724, DOI 10.17487/RFC6724, September 2012. <https://www.rfc-editor.org/info/rfc6724> [Local MD](rfc6724.md)

<a name="RFC6733"></a> **[RFC6733]** V. Fajardo, J. Arkko, J. Loughney, G. Zorn, "Diameter Base Protocol", RFC 6733, DOI 10.17487/RFC6733, October 2012. <https://www.rfc-editor.org/info/rfc6733> [Local MD](rfc6733.md)

<a name="RFC6762"></a> **[RFC6762]** S. Cheshire, M. Krochmal, "Multicast DNS", RFC 6762, DOI 10.17487/RFC6762, February 2013. <https://www.rfc-editor.org/info/rfc6762> [Local MD](rfc6762.md)

<a name="RFC6763"></a> **[RFC6763]** S. Cheshire, M. Krochmal, "DNS-Based Service Discovery", RFC 6763, DOI 10.17487/RFC6763, February 2013. <https://www.rfc-editor.org/info/rfc6763> [Local MD](rfc6763.md)

<a name="RFC6824"></a> **[RFC6824]** A. Ford, C. Raiciu, M. Handley, O. Bonaventure, "TCP Extensions for Multipath Operation with Multiple Addresses", RFC 6824, DOI 10.17487/RFC6824, January 2013. <https://www.rfc-editor.org/info/rfc6824> [Local MD](rfc6824.md)

<a name="RFC6830"></a> **[RFC6830]** D. Farinacci, V. Fuller, D. Meyer, D. Lewis, "The Locator/ID Separation Protocol (LISP)", RFC 6830, DOI 10.17487/RFC6830, January 2013. <https://www.rfc-editor.org/info/rfc6830> [Local MD](rfc6830.md)
...
<a name="RFC7404"></a> **[RFC7404]** M. Behringer, E. Vyncke, "Using Only Link-Local Addressing inside an IPv6 Network", RFC 7404, DOI 10.17487/RFC7404, November 2014. <https://www.rfc-editor.org/info/rfc7404> [Local MD](rfc7404.md)

<a name="RFC7426"></a> **[RFC7426]** E. Haleplidis, K. Pentikousis, S. Denazis, J. Hadi Salim, D. Meyer, O. Koufopavlou, "Software-Defined Networking (SDN): Layers and Architecture Terminology", RFC 7426, DOI 10.17487/RFC7426, January 2015. <https://www.rfc-editor.org/info/rfc7426> [Local MD](rfc7426.md)
...
<a name="RFC7575"></a> **[RFC7575]** M. Behringer, M. Pritikin, S. Bjarnason, A. Clemm, B. Carpenter, S. Jiang, L. Ciavaglia, "Autonomic Networking: Definitions and Design Goals", RFC 7575, DOI 10.17487/RFC7575, June 2015. <https://www.rfc-editor.org/info/rfc7575> [Local MD](rfc7575.md)

<a name="RFC7576"></a> **[RFC7576]** S. Jiang, B. Carpenter, M. Behringer, "General Gap Analysis for Autonomic Networking", RFC 7576, DOI 10.17487/RFC7576, June 2015. <https://www.rfc-editor.org/info/rfc7576> [Local MD](rfc7576.md)

<a name="RFC7585"></a> **[RFC7585]** S. Winter, M. McCauley, "Dynamic Peer Discovery for RADIUS/TLS and RADIUS/DTLS Based on the Network Access Identifier (NAI)", RFC 7585, DOI 10.17487/RFC7585, October 2015. <https://www.rfc-editor.org/info/rfc7585> [Local MD](rfc7585.md)

<a name="RFC7721"></a> **[RFC7721]** A. Cooper, F. Gont, D. Thaler, "Security and Privacy Considerations for IPv6 Address Generation Mechanisms", RFC 7721, DOI 10.17487/RFC7721, March 2016. <https://www.rfc-editor.org/info/rfc7721> [Local MD](rfc7721.md)

<a name="RFC7761"></a> **[RFC7761]** B. Fenner, M. Handley, H. Holbrook, I. Kouvelas, R. Parekh, Z. Zhang, L. Zheng, "Protocol Independent Multicast - Sparse Mode (PIM-SM): Protocol Specification (Revised)", STD 83, RFC 7761, DOI 10.17487/RFC7761, March 2016. <https://www.rfc-editor.org/info/rfc7761> [Local MD](rfc7761.md)

<a name="RFC7950"></a> **[RFC7950]** M. Bjorklund, "The YANG 1.1 Data Modeling Language", RFC 7950, DOI 10.17487/RFC7950, August 2016. <https://www.rfc-editor.org/info/rfc7950> [Local MD](rfc7950.md)

<a name="RFC8028"></a> **[RFC8028]** F. Baker, B. Carpenter, "First-Hop Router Selection by Hosts in a Multi-Prefix Network", RFC 8028, DOI 10.17487/RFC8028, November 2016. <https://www.rfc-editor.org/info/rfc8028> [Local MD](rfc8028.md)
...
<a name="RFC8316"></a> **[RFC8316]** J. Nobre, L. Granville, A. Clemm, A. Gonzalez Prieto, "Autonomic Networking Use Case for Distributed Detection of Service Level Agreement (SLA) Violations", RFC 8316, DOI 10.17487/RFC8316, February 2018. <https://www.rfc-editor.org/info/rfc8316> [Local MD](rfc8316.md)

<a name="RFC8366"></a> **[RFC8366]** K. Watsen, M. Richardson, M. Pritikin, T. Eckert, "A Voucher Artifact for Bootstrapping Protocols", RFC 8366, DOI 10.17487/RFC8366, May 2018. <https://www.rfc-editor.org/info/rfc8366> [Local MD](rfc8366.md)

<a name="RFC8368"></a> **[RFC8368]** T. Eckert, M. Behringer, "Using an Autonomic Control Plane for Stable Connectivity of Network Operations, Administration, and Maintenance (OAM)", RFC 8368, DOI 10.17487/RFC8368, May 2018. <https://www.rfc-editor.org/info/rfc8368> [Local MD](rfc8368.md)

<a name="RFC8398"></a> **[RFC8398]** A. Melnikov, W. Chuang, "Internationalized Email Addresses in X.509 Certificates", RFC 8398, DOI 10.17487/RFC8398, May 2018. <https://www.rfc-editor.org/info/rfc8398> [Local MD](rfc8398.md)
...
<a name="RFC8572"></a> **[RFC8572]** K. Watsen, I. Farrer, M. Abrahamsson, "Secure Zero Touch Provisioning (SZTP)", RFC 8572, DOI 10.17487/RFC8572, April 2019. <https://www.rfc-editor.org/info/rfc8572> [Local MD](rfc8572.md)

<a name="RFC8684"></a> **[RFC8684]** A. Ford, C. Raiciu, M. Handley, O. Bonaventure, C. Paasch, "TCP Extensions for Multipath Operation with Multiple Addresses", RFC 8684, DOI 10.17487/RFC8684, March 2020. <https://www.rfc-editor.org/info/rfc8684> [Local MD](rfc8684.md)

<a name="RFC8739"></a> **[RFC8739]** Y. Sheffer, D. Lopez, O. Gonzalez de Dios, A. Pastor Perales, T. Fossati, "Support for Short-Term, Automatically Renewed (STAR) Certificates in the Automated Certificate Management Environment (ACME)", RFC 8739, DOI 10.17487/RFC8739, March 2020. <https://www.rfc-editor.org/info/rfc8739> [Local MD](rfc8739.md)

<a name="RFC8981"></a> **[RFC8981]** F. Gont, S. Krishnan, T. Narten, R. Draves, "Temporary Address Extensions for Stateless Address Autoconfiguration in IPv6", RFC 8981, DOI 10.17487/RFC8981, February 2021. <https://www.rfc-editor.org/info/rfc8981> [Local MD](rfc8981.md)

<a name="RFC8992"></a> **[RFC8992]** S Jiang, Z Du, B Carpenter, Q Sun, "Autonomic IPv6 Edge Prefix Management in Large-Scale Networks", RFC 8992, DOI 10.17487/RFC8992, May 2021. <https://www.rfc-editor.org/info/rfc8992> [Local MD](rfc8992.md)

<a name="RFC8993"></a> **[RFC8993]** M Behringer, B Carpenter, T Eckert, L Ciavaglia, J Nobre, "A Reference Model for Autonomic Networking", RFC 8993, DOI 10.17487/RFC8993, May 2021. <https://www.rfc-editor.org/info/rfc8993> [Local MD](rfc8993.md)

<a name="I-D.ietf-roll-applicability-template"></a> **[ROLL-APPLICABILITY]** M Richardson, "ROLL Applicability Statement Template", Internet-Draft draft-ietf-roll-applicability-template-09, May 2016. Work in Progress <https://tools.ietf.org/html/draft-ietf-roll-applicability-template-09>

<a name="SR"></a> **[SR]** "Single-root input/output virtualization", September 2020. <https://en.wikipedia.org/w/index.php?title=Single-root_input/output_virtualization&oldid=978867619>

<a name="I-D.ietf-tls-dtls13"></a> **[TLS-DTLS13]** Eric Rescorla, Hannes Tschofenig, Nagendra Modadugu, "The Datagram Transport Layer Security (DTLS) Protocol Version 1.3", Internet-Draft draft-ietf-tls-dtls13-43, April 2021. Work in Progress <https://tools.ietf.org/html/draft-ietf-tls-dtls13-43>

<a name="X.509"></a> **[X.509]** "Information technology - Open Systems Interconnection - The Directory: Public-key and attribute certificate frameworks", October 2016. <https://www.itu.int/rec/T-REC-X.509>

<a name="X.520"></a> **[X.520]** "Information technology - Open Systems Interconnection - The Directory: Selected attribute types", October 2016. <https://www.itu.int/rec/T-REC-X.520>
...
<a name="address-spaces"></a>
## ACP Address Space Schemes

This document defines the Zone, Vlong, and Manual Addressing Sub-Schemes primarily to support address prefix assignment
via distributed, potentially uncoordinated ACP registrars as defined
in [Section 6.11.7](#acp-registrars). This
...
In networks that expect always to rely on a centralized PMS
as described [Section 9.2.5](#pms), the 48/46-bits for
...
Note that an explicitly defined Manual Addressing Sub-Scheme
...
BRSKI describes how nodes with an IDevID certificate can securely and zero-touch enroll with an LDevID certificate to support the ACP.  BRSKI also leverages the ACP to enable zero-touch bootstrap of new nodes across networks without any configuration requirements across the transit nodes (e.g., no DHCP, DNS forwarding, and/or server setup).  This includes otherwise unconfigured networks as described in [Section 3.2](#secure-bootstrap).  Therefore, BRSKI in conjunction with ACP provides for a secure and zero-touch management solution for complete networks.  Nodes supporting such an infrastructure (BRSKI and ACP) are called ANI nodes (Autonomic Networking Infrastructure), see [RFC8993](#RFC8993).  Nodes that do not support an IDevID certificate but only an (insecure) vendor-specific Unique Device Identifier (UDI) or nodes whose manufacturer does not support a MASA could use some future, reduced-security version of BRSKI.
...
In the absence of BRSKI or less secure variants thereof, the provisioning of certificates may involve one or more touches or nonstandardized automation.  Node vendors usually support the provisioning of certificates into nodes via PKCS #7 (see "[PKCS #7: Cryptographic Message Syntax Version 1.5](#RFC2315)" [RFC2315](#RFC2315)) and may support this provisioning through vendor-specific models via NETCONF ("[Network Configuration Protocol (NETCONF)](#RFC6241)" [RFC6241](#RFC6241)).  If such nodes also support NETCONF Zero Touch [RFC8572](#RFC8572), then this can be combined with zero-touch provisioning of domain certificates into nodes.  Unless there is the equivalent integration of NETCONF connections across the ACP as there is in BRSKI, this combination would not support zero-touch bootstrap across an unconfigured network, though.

<a name="discovery"></a>
## ACP Neighbor Discovery Protocol Selection

This section discusses why GRASP DULL was chosen as the discovery protocol
for L2-adjacent candidate ACP neighbors.  The contenders that were considered were GRASP, mDNS, and LLDP.

<a name="discovery-lldp"></a>
### LLDP

LLDP and Cisco's earlier Cisco Discovery Protocol (CDP) are examples of L2 discovery protocols that terminate
...
more work than the benefit of "reusing the existing protocol" LLDP for this very simple purpose.

<a name="discovery-mdns"></a>
### mDNS and L2 Support

Multicast DNS (mDNS) "[Multicast DNS](#RFC6762)" [RFC6762](#RFC6762) with DNS Service Discovery (DNS-SD) Resource Records (RRs) as defined in "[DNS-Based Service Discovery](#RFC6763)" [RFC6763](#RFC6763)
...
an ACP-capable (L3)/L2 switch as outlined in [Section 7](#acp-l2-switches), then this would
...
risky to support on such L2 switches.

<a name="discovery-comparison"></a>
### Why DULL GRASP?
...
If mDNS was not already existing in a node, it would be more work to implement than
...
<a name="why-rpl"></a>
## Choice of Routing Protocol (RPL)

This section motivates why RPL ("IPv6 Routing Protocol for Low-Power and Lossy Networks [RFC6550](#RFC6550)) was chosen as the default (and in this specification only) routing protocol for the ACP.  The choice and above explained profile were derived from a pre-standard implementation of ACP that was successfully deployed in operational networks.
...
- Self-management: the ACP must build automatically, without human
	  ...
	  configuration is carried as part of the protocol (see [RFC6550](#RFC6550)).
...
- No need for path optimization: RPL does not necessarily compute the optimal path between any two nodes.  However, the ACP does not require this today, since it carries mainly delay-insensitive feedback loops.  It is possible that different optimization schemes will become necessary in the future, but RPL can be expanded (see ["Extensibility"](#extens) above).

<a name="acp-grasp"></a>
## ACP Information Distribution and Multicast

IP multicast is not used by the ACP because the ANI itself does not require IP multicast 
        but only service announcement/discovery.  Using IP multicast for that would have made it
        necessary to develop a zero-touch autoconfiguring solution for ASM (Any Source Multicast - the original form of IP multicast defined in "[Host extensions for IP multicasting](#RFC1112)" [RFC1112](#RFC1112)), which
        ...
        routers that should be PIM Sparse Mode (PIM-SM) Rendezvous Points (RPs) (see "[Protocol Independent Multicast - Sparse Mode (PIM-SM): Protocol Specification (Revised)](#RFC7761)" [RFC7761](#RFC7761)).  The other aspects of complexity
        are the implementation of MLD ("[Using Internet Group Management Protocol Version 3 (IGMPv3) and Multicast Listener Discovery Protocol Version 2 (MLDv2) for Source-Specific Multicast](#RFC4604)" [RFC4604](#RFC4604)), PIM-SM, and Anycast-RP (see "[Anycast-RP Using Protocol Independent Multicast (PIM)](#RFC4610)" [RFC4610](#RFC4610)).  If those implementations already
        ...
        of performing only service discovery.

Some future ASA may need high-performance, in-network data replication.  That is the case
        when the use of IP multicast is justified.  Such an ASA can then use service discovery
        from ACP GRASP, and then they do not need ASM but only SSM (see "[Source-Specific Multicast for IP](#RFC4607)" [RFC4607](#RFC4607))
        ...
        on all nodes, and it only requires a simpler version of MLD (see "[Lightweight Internet Group Management Protocol Version 3 (IGMPv3) and Multicast Listener Discovery Version 2 (MLDv2) Protocols](#RFC5790)" [RFC5790](#RFC5790)).

IGP routing protocols based on LSP (Link State Protocol) typically have a mechanism to
        ...
        the M_DISCOVERY method is more efficient than flooding across the whole domain.

Because the ACP uses RPL, one desirable future extension is to use RPL's existing 
        notion of DODAG, which are loop-free distribution trees, to make GRASP flooding more efficient
        both for M_FLOOD and M_DISCOVERY. See [Section 6.13.5](#ACP_interfaces) for how this will be
        ...
        and how difficult it would be to let GRASP flooding access the DODAG information.

<a name="domain-usage"></a>
## CAs, Domains, and Routing Subdomains
...
An ACP domain is the set of all ACP nodes that can authenticate each other as belonging to the same ACP network using the ACP domain membership check ([Section 6.2.3](#certcheck)).  GRASP inside the ACP is run across all transitively connected ACP nodes in a domain.
...
Intent is the architecture component of Autonomic Networks according to
 [RFC8993](#RFC8993) that allows operators to issue policies to
the network.  Its applicability for use is quite  flexible and freeform, with potential applications including
policies flooded across ACP GRASP and interpreted on every ACP node.
...
For example, Intent could indicate the desire to build an ACP across all domains
...
If each domain has its own source of Intent, then the Intent would simply have to
allow adding the peer domain's TA and domain names to the parameters for the ACP domain membership check
([Section 6.2.3](#certcheck)) so that nodes from those other domains are accepted as ACP peers.

If this Intent was to be originated only from one domain, it could likely not be made
to work because the other domains will not build any ACP connections amongst each other,
whether they use the same or different CA due to the ACP domain membership check.
...
and passing of arbitrary GRASP information, unless the Intent policies permit this
 to happen across domain boundaries.

This type of approach, where the ACP first allows Intent to operate and only then
...
reachability across the ACP to certain types of nodes or locations of nodes.

<a name="reuse-acp"></a>
## Adopting ACP Concepts for Other Environments

The ACP as specified in this document is very explicit about the choice of options to
allow interoperable implementations.  The choices made may not be the best for all environments,
but the concepts used by the ACP can be used to build derived solutions.

The ACP specifies the use of ULA and the derivation of its prefix from the domain name
...
of the ACP registrar deriving the /48 ULA prefix from the AN domain name.
...
to store that local ID also in the certificate.

The ACP is defined as a separate VRF because it intends to support well-managed
...
solution derived from "[Autonomic IPv6 Edge Prefix Management in Large-Scale Networks](#RFC8992)" [RFC8992](#RFC8992).

TCP/TLS as the protocols to provide reliability and security to GRASP in the ACP
...
different routing protocol or introduce more advanced RPL profiles.

Variations such as which routing protocol to use, or whether to instantiate an ACP
...
Last but not least, secure channel protocols including their encapsulations are
...
provided by ACP secure channels.

<a name="futures"></a>
## Further (Future) Options

<a name="auto-aggregation"></a>
### Auto-Aggregation of Routes
...
in the acp-node-name) and/or Zone-ID based prefixes.
...
even the /48 prefix based on the GRASP announcements.

<a name="dp-dependency"></a>
### More Options for Avoiding IPv6 Data Plane Dependencies

As described in [Section 6.13.2](#general_addressing), the ACP depends on the
...
different SR-IOV interfaces use different MAC addresses.
...
An option that would require additional specification is to use a different
Ethertype from 0x86DD (IPv6) to encapsulate IPv6 packets for the ACP. This would
be a similar approach as used for IP authentication packets in [IEEE-802.1X](#IEEE-802.1X),
which uses the Extensible Authentication Protocol over Local Area Network (EAPoL) 
Ethertype (0x88A2).

Note that in the case of ANI nodes, all of the above considerations equally
apply to the encapsulation of BRSKI packets including GRASP used for BRSKI.

<a name="acp-api"></a>
### ACP APIs and Operational Models (YANG)

Future work should define a YANG data model [RFC7950](#RFC7950) 
and/or node-internal APIs to monitor and manage the ACP.

Support for the ACP adjacency table ([Section 6.3](#adj-table)) and ACP GRASP needs to
be included in such model and/or API.
...
```
The profile for RPL specified in this document builds only one spanning-tree path set to a root, typically a registrar in one NOC. In the presence of multiple NOCs, routing toward the non-root NOCs may be suboptimal. [Figure 17](#dual-noc) shows an extreme example. Assuming that node ACP1 becomes the RPL root, traffic between ACP11 and NOC2 will pass through ACP4-ACP3-ACP1-ACP2 instead of ACP4-ACP2 because the RPL-calculated DODAG and routes are shortest paths towards the RPL root.
...
ACP connect is an explicit mechanism to "leak" ACP traffic explicitly (for example,
in a NOC). It is therefore also a possible security gap when it is easy to enable ACP
 connect on arbitrary compromised ACP nodes.

One simple solution is to define an extension in the ACP certificate's ACP information
field indicating the permission for ACP connect to be configured on that ACP node. This
could similarly be done to decide whether a node is permitted to be a registrar or not.

Tying the permitted "roles" of an ACP node to the ACP certificate provides
...
<a name="l3-transit"></a>
### Autonomic L3 Transit

In this specification, the ACP can only establish autonomic connectivity across L2
...
a peer-to-peer tunneling mechanism could tunnel ACP islands across an L3VPN infrastructure.

<a name="future-diag"></a>
### Diagnostics

[Section 9.1](#diagnostics) describes diagnostics options that can be applied
without changing the external, interoperability-affecting characteristics of ACP implementations.

Even better diagnostics of ACP operations are possible with additional
signaling extensions, such as the following:

1. Consider if LLDP should be a recommended functionality for ANI devices
    to improve diagnostics, and if so, which information elements it should
    signal (noting that such information is conveyed in an insecure manner). This includes potentially new information elements.
2. As an alternative to LLDP, a DULL GRASP diagnostics objective could
    be defined to carry these information elements.
3. The IDevID certificate of BRSKI pledges should be included in the selected
    insecure diagnostics option. This may be undesirable when exposure of device information is seen as too much of a security issue (the ability to deduce possible attack vectors from device model, for example).
...
### Avoiding and Dealing with Compromised ACP Nodes

Compromised ACP nodes pose the biggest risk to the operations of the network.
...
The most important aspect of security design against these types of attacks is
...
the private keys cannot leak. This limits unexpected propagation of credentials.
...
be autoconfiguring across the ACP. See [NOC-AUTOCONFIG](#I-D.eckert-anima-noc-autoconfig).

Without physical access to the compromised device, attackers with access to
...
ACP configuration that locks down the current ACP configuration unless factory reset is done.

With such means, the valid administration has the best chances to maintain
access to ACP nodes, to discover malicious configuration though ongoing configuration
tracking from central locations, for example, and to react accordingly.

The primary reaction is to withdraw or change credentials, terminate malicious
...
likely require new work.

Only when these steps are infeasible, would it be necessary
to revoke or expire the ACP certificate credentials and consider the node kicked off the network
until the situation can be further rectified, likely requiring direct physical access to the node.

Without extensions, compromised ACP nodes can only be removed from the ACP
...
the explicit removal indication of the compromised node's domain certificate.

<a name="downgrade"></a>
### Detecting ACP Secure Channel Downgrade Attacks
...
This work originated from an Autonomic Networking project at Cisco
      Systems, which started in early 2010. Many people contributed to this project and the idea of the Autonomic Control Plane, amongst whom (in alphabetical order): Ignas Bagdonas, Parag Bhide, Balaji BL, Alex Clemm, Yves Hertoghs, Bruno Klauser, Max Pritikin, Michael Richardson, and Ravi Kumar Vadapalli.
...
- Address: School of Computer Science, Auckland, 1142, New Zealand
...
- Address: Building D, Mougins - Sophia Antipolis, 06254, France
...
- Organization: Futurewei Technologies Inc. USA
- Address: 2330 Central Expy, Santa Clara, CA, 95050, United States of America
- Email: tte+ietf@cs.fau.de
...
- Address: 2727 South State Street, Suite 200, Ann Arbor, MI, 48104, United States of America
- Email: sbjarnason@arbor.net
