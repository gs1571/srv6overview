...
`   `[`2`](#section-2)`. 1 The OBJECT-GROUP macro`

`   `[`2`](#section-2)`. 2 The NOTIFICATION-GROUP macro`

`   `[`2`](#section-2)`. 3 The MODULE-COMPLIANCE macro`

`   `[`2`](#section-2)`. 4 The AGENT-CAPABILITIES macro`

`   3 Mapping of the OBJECT-GROUP macro`

`   `[`3`](#section-3)`. 1 Mapping of the OBJECTS clause`

`   `[`3`](#section-3)`. 2 Mapping of the STATUS clause`

`   `[`3`](#section-3)`. 3 Mapping of the DESCRIPTION clause`

`   `[`3`](#section-3)`. 4 Mapping of the REFERENCE clause`

`   `[`3`](#section-3)`. 5 Mapping of the OBJECT-GROUP value`

`   `[`3`](#section-3)`. 6 Usage Example`

`   4 Mapping of the NOTIFICATION-GROUP macro`

`   `[`4`](#section-4)`. 1 Mapping of the NOTIFICATIONS clause`

`   `[`4`](#section-4)`. 2 Mapping of the STATUS clause`

`   `[`4`](#section-4)`. 3 Mapping of the DESCRIPTION clause`

`   `[`4`](#section-4)`. 4 Mapping of the REFERENCE clause`

`   `[`4`](#section-4)`. 5 Mapping of the NOTIFICATION-GROUP value`

`   `[`4`](#section-4)`. 6 Usage Example`

`   5 Mapping of the MODULE-COMPLIANCE macro`

`   `[`5`](#section-5)`. 1 Mapping of the STATUS clause`

`   `[`5`](#section-5)`. 2 Mapping of the DESCRIPTION clause`

`   `[`5`](#section-5)`. 3 Mapping of the REFERENCE clause`

`   `[`5`](#section-5)`. 4 Mapping of the MODULE clause`

`   `[`5.4`](#section-5-4)`. 1 Mapping of the MANDATORY-GROUPS clause`

`   `[`5.4`](#section-5-4)`. 2 Mapping of the GROUP clause`

`   `[`5.4`](#section-5-4)`. 3 Mapping of the OBJECT clause`

`   `[`5.4.3`](#section-5-4-3)`. 1 Mapping of the SYNTAX clause`

`   `[`5.4.3`](#section-5-4-3)`. 2 Mapping of the WRITE-SYNTAX clause`

`   `[`5.4.3`](#section-5-4-3)`. 3 Mapping of the MIN-ACCESS clause`

`   `[`5.4`](#section-5-4)`. 4 Mapping of the DESCRIPTION clause`

`   `[`5`](#section-5)`. 5 Mapping of the MODULE-COMPLIANCE value`

`   `[`5`](#section-5)`. 6 Usage Example`

`   6 Mapping of the AGENT-CAPABILITIES macro`

`   `[`6`](#section-6)`. 1 Mapping of the PRODUCT-RELEASE clause`

`   `[`6`](#section-6)`. 2 Mapping of the STATUS clause`

`   `[`6`](#section-6)`. 3 Mapping of the DESCRIPTION clause`

`   `[`6`](#section-6)`. 4 Mapping of the REFERENCE clause`

`   `[`6`](#section-6)`. 5 Mapping of the SUPPORTS clause`

`   `[`6.5`](#section-6-5)`. 1 Mapping of the INCLUDES clause`

`   `[`6.5`](#section-6-5)`. 2 Mapping of the VARIATION clause`

`   `[`6.5.2`](#section-6-5-2)`. 1 Mapping of the SYNTAX clause`

`   `[`6.5.2`](#section-6-5-2)`. 2 Mapping of the WRITE-SYNTAX clause`

`   `[`6.5.2`](#section-6-5-2)`. 3 Mapping of the ACCESS clause`

`   `[`6.5.2`](#section-6-5-2)`. 4 Mapping of the CREATION-REQUIRES clause`

`   `[`6.5.2`](#section-6-5-2)`. 5 Mapping of the DEFVAL clause`

`   `[`6.5.2`](#section-6-5-2)`. 6 Mapping of the DESCRIPTION clause`

`   `[`6`](#section-6)`. 6 Mapping of the AGENT-CAPABILITIES value`

`   `[`6`](#section-6)`. 7 Usage Example`

`   7 Extending an Information Module`

`   `[`7`](#section-7)`. 1 Conformance Groups`

`   `[`7`](#section-7)`. 2 Compliance Definitions`

`   `[`7`](#section-7)`. 3 Capabilities Definitions`
...
<a id="section-3"></a> **`3. Mapping of the OBJECT-GROUP macro`**
...
<a id="section-3-1"></a> **`3.1. Mapping of the OBJECTS clause`**
...
<a id="section-3-2"></a> **`3.2. Mapping of the STATUS clause`**
...
<a id="section-3-3"></a> **`3.3. Mapping of the DESCRIPTION clause`**
...
<a id="section-3-4"></a> **`3.4. Mapping of the REFERENCE clause`**
...
<a id="section-3-5"></a> **`3.5. Mapping of the OBJECT-GROUP value`**
...
<a id="section-3-6"></a> **`3.6. Usage Example`**
...
<a id="section-4"></a> **`4. Mapping of the NOTIFICATION-GROUP macro`**
...
<a id="section-4-1"></a> **`4.1. Mapping of the NOTIFICATIONS clause`**
...
<a id="section-4-2"></a> **`4.2. Mapping of the STATUS clause`**
...
<a id="section-4-3"></a> **`4.3. Mapping of the DESCRIPTION clause`**
...
<a id="section-4-4"></a> **`4.4. Mapping of the REFERENCE clause`**
...
<a id="section-4-5"></a> **`4.5. Mapping of the NOTIFICATION-GROUP value`**
...
<a id="section-4-6"></a> **`4.6. Usage Example`**
...
<a id="section-5"></a> **`5. Mapping of the MODULE-COMPLIANCE macro`**
...
<a id="section-5-1"></a> **`5.1. Mapping of the STATUS clause`**
...
<a id="section-5-2"></a> **`5.2. Mapping of the DESCRIPTION clause`**
...
<a id="section-5-3"></a> **`5.3. Mapping of the REFERENCE clause`**
...
<a id="section-5-4"></a> **`5.4. Mapping of the MODULE clause`**
...
<a id="section-5-4-1"></a> **`5.4.1. Mapping of the MANDATORY-GROUPS clause`**
...
<a id="section-5-4-2"></a> **`5.4.2. Mapping of the GROUP clause`**
...
<a id="section-5-4-3"></a> **`5.4.3. Mapping of the OBJECT clause`**
...
<a id="section-5-4-3-1"></a> **`5.4.3.1. Mapping of the SYNTAX clause`**
...
<a id="section-5-4-3-2"></a> **`5.4.3.2. Mapping of the WRITE-SYNTAX clause`**
...
<a id="section-5-4-3-3"></a> **`5.4.3.3. Mapping of the MIN-ACCESS clause`**
...
<a id="section-5-4-4"></a> **`5.4.4. Mapping of the DESCRIPTION clause`**
...
<a id="section-5-5"></a> **`5.5. Mapping of the MODULE-COMPLIANCE value`**
...
<a id="section-5-6"></a> **`5.6. Usage Example`**
...
<a id="section-6"></a> **`6. Mapping of the AGENT-CAPABILITIES macro`**
...
<a id="section-6-1"></a> **`6.1. Mapping of the PRODUCT-RELEASE clause`**
...
<a id="section-6-2"></a> **`6.2. Mapping of the STATUS clause`**
...
<a id="section-6-3"></a> **`6.3. Mapping of the DESCRIPTION clause`**
...
<a id="section-6-4"></a> **`6.4. Mapping of the REFERENCE clause`**
...
<a id="section-6-5"></a> **`6.5. Mapping of the SUPPORTS clause`**
...
<a id="section-6-5-1"></a> **`6.5.1. Mapping of the INCLUDES clause`**
...
<a id="section-6-5-2"></a> **`6.5.2. Mapping of the VARIATION clause`**
...
<a id="section-6-5-2-1"></a> **`6.5.2.1. Mapping of the SYNTAX clause`**
...
<a id="section-6-5-2-2"></a> **`6.5.2.2. Mapping of the WRITE-SYNTAX clause`**
...
<a id="section-6-5-2-3"></a> **`6.5.2.3. Mapping of the ACCESS clause`**
...
<a id="section-6-5-2-4"></a> **`6.5.2.4. Mapping of the CREATION-REQUIRES clause`**
...
<a id="section-6-5-2-5"></a> **`6.5.2.5. Mapping of the DEFVAL clause`**
...
<a id="section-6-5-2-6"></a> **`6.5.2.6. Mapping of the DESCRIPTION clause`**
...
<a id="section-6-6"></a> **`6.6. Mapping of the AGENT-CAPABILITIES value`**
...
<a id="section-6-7"></a> **`6.7. Usage Example`**
...
<a id="section-7"></a> **`7. Extending an Information Module`**
...
<a id="section-7-1"></a> **`7.1. Conformance Groups`**
...
<a id="section-7-2"></a> **`7.2. Compliance Definitions`**
...
<a id="section-7-3"></a> **`7.3. Capabilities Definitions`**
...
<a id="section-9"></a> **`9. Editors' Addresses`**
