...
<a id="section-1"></a> **`1. Conventions, Terms, and Notation`**
...
<a id="section-2"></a> **`2. Extended Challenges and Extended Responses`**
...
<a id="section-2-2"></a> **`2.2. Requirements`**
...
<a id="section-3"></a> **`3. The "hex" and "word" Responses`**
...
<a id="section-3-2"></a> **`3.2. Requirements`**
...
<a id="section-4"></a> **`4. The "init-hex" and "init-word" Responses`**
...
<a id="section-4-2"></a> **`4.2. Description of Fields`**
...
<a id="section-4-3"></a> **`4.3. Requirements`**
