...
`     `[`2.2`](#section-2-2)`. VNS Model of ACTN`

`       `[`2.2.1`](#section-2-2-1)`. Customers`

`       `[`2.2.2`](#section-2-2-2)`. Service Providers`

`       `[`2.2.3`](#section-2-2-3)`. Network Operators`

`   `[`3`](#section-3)`. ACTN Base Architecture`

`     `[`3.1`](#section-3-1)`. Customer Network Controller`

`     `[`3.2`](#section-3-2)`. Multi-Domain Service Coordinator`

`     `[`3.3`](#section-3-3)`. Provisioning Network Controller`

`     `[`3.4`](#section-3-4)`. ACTN Interfaces`

`   `[`4`](#section-4)`. Advanced ACTN Architectures`

`     `[`4.1`](#section-4-1)`. MDSC Hierarchy`

`     `[`4.2`](#section-4-2)`. Functional Split of MDSC Functions in Orchestrators`

`   `[`5`](#section-5)`. Topology Abstraction Methods`

`     `[`5.1`](#section-5-1)`. Abstraction Factors`

`     `[`5.2`](#section-5-2)`. Abstraction Types`

`       `[`5.2.1`](#section-5-2-1)`. Native/White Topology`

`       `[`5.2.2`](#section-5-2-2)`. Black Topology`

`       `[`5.2.3`](#section-5-2-3)`. Grey Topology`

`     `[`5.3`](#section-5-3)`. Methods of Building Grey Topologies`

`       `[`5.3.1`](#section-5-3-1)`. Automatic Generation of Abstract Topology by`

`               Configuration`

`       `[`5.3.2`](#section-5-3-2)`. On-Demand Generation of Supplementary Topology via`

`               Path Compute Request/Reply`

`     `[`5.4`](#section-5-4)`. Hierarchical Topology Abstraction Example`

`     `[`5.5`](#section-5-5)`. VN Recursion with Network Layers`

`   `[`6`](#section-6)`. Access Points and Virtual Network Access Points`

`     `[`6.1`](#section-6-1)`. Dual-Homing Scenario`

``[`7`](#section-7)`. Advanced ACTN Application: Multi-Destination Service`

`     `[`7.1`](#section-7-1)`. Preplanned Endpoint Migration`

`     `[`7.2`](#section-7-2)`. On-the-Fly Endpoint Migration`

`   `[`8`](#section-8)`. Manageability Considerations`

`     `[`8.1`](#section-8-1)`. Policy`

`     `[`8.2`](#section-8-2)`. Policy Applied to the Customer Network Controller`

`     `[`8.3`](#section-8-3)`. Policy Applied to the Multi-Domain Service Coordinator`

`     `[`8.4`](#section-8-4)`. Policy Applied to the Provisioning Network Controller .`

`   `[`9`](#section-9)`. Security Considerations`

`     `[`9.1`](#section-9-1)`. CNC-MDSC Interface (CMI)`

`     `[`9.2`](#section-9-2)`. MDSC-PNC Interface (MPI)`
...
<a id="section-2-2"></a> **`2.2. VNS Model of ACTN`**
...
<a id="section-2-2-1"></a> **`2.2.1. Customers`**
...
<a id="section-2-2-2"></a> **`2.2.2. Service Providers`**
...
<a id="section-2-2-3"></a> **`2.2.3. Network Operators`**
...
<a id="section-3"></a> **`3. ACTN Base Architecture`**
...
<a id="section-3-1"></a> **`3.1. Customer Network Controller`**
...
<a id="section-3-2"></a> **`3.2. Multi-Domain Service Coordinator`**
...
<a id="section-3-3"></a> **`3.3. Provisioning Network Controller`**
...
<a id="section-3-4"></a> **`3.4. ACTN Interfaces`**
...
<a id="section-4"></a> **`4. Advanced ACTN Architectures`**
...
<a id="section-4-1"></a> **`4.1. MDSC Hierarchy`**
...
<a id="section-4-2"></a> **`4.2. Functional Split of MDSC Functions in Orchestrators`**
...
<a id="section-5"></a> **`5. Topology Abstraction Methods`**
...
<a id="section-5-1"></a> **`5.1. Abstraction Factors`**
...
<a id="section-5-2"></a> **`5.2. Abstraction Types`**
...
<a id="section-5-2-1"></a> **`5.2.1. Native/White Topology`**
...
<a id="section-5-2-2"></a> **`5.2.2. Black Topology`**
...
<a id="section-5-2-3"></a> **`5.2.3. Grey Topology`**
...
<a id="section-5-3"></a> **`5.3. Methods of Building Grey Topologies`**
...
<a id="section-5-3-1"></a> **`5.3.1. Automatic Generation of Abstract Topology by Configuration`**
...
<a id="section-5-3-2"></a> **`5.3.2. On-Demand Generation of Supplementary Topology via Path Compute`**
...
<a id="section-5-4"></a> **`5.4. Hierarchical Topology Abstraction Example`**
...
<a id="section-5-5"></a> **`5.5. VN Recursion with Network Layers`**
...
<a id="section-6"></a> **`6. Access Points and Virtual Network Access Points`**
...
<a id="section-6-1"></a> **`6.1. Dual-Homing Scenario`**
...
<a id="section-7"></a> **`7. Advanced ACTN Application: Multi-Destination Service`**
...
<a id="section-7-1"></a> **`7.1. Preplanned Endpoint Migration`**
...
<a id="section-7-2"></a> **`7.2. On-the-Fly Endpoint Migration`**
...
<a id="section-8-2"></a> **`8.2. Policy Applied to the Customer Network Controller`**
...
<a id="section-8-3"></a> **`8.3. Policy Applied to the Multi-Domain Service Coordinator`**
...
<a id="section-8-4"></a> **`8.4. Policy Applied to the Provisioning Network Controller`**
...
<a id="section-9-1"></a> **`9.1. CNC-MDSC Interface (CMI)`**
...
<a id="section-9-2"></a> **`9.2. MDSC-PNC Interface (MPI)`**
