...
`   `[`2`](#section-2)`. Using BGP to Bind an Address Prefix to One or More MPLS`

`       Labels`

`     `[`2.1`](#section-2-1)`. Multiple Labels Capability`

`     `[`2.2`](#section-2-2)`. NLRI Encoding When the Multiple Labels Capability Is`

`           Not Used`

`     `[`2.3`](#section-2-3)`. NLRI Encoding When the Multiple Labels Capability Is Used  10`

`     `[`2.4`](#section-2-4)`. How to Explicitly Withdraw the Binding of a Label to a`

`           Prefix`

`     `[`2.5`](#section-2-5)`. Changing the Label That Is Bound to a Prefix`

`   `[`3`](#section-3)`. Installing and/or Propagating SAFI-4 or SAFI-128 Routes`

`     `[`3.1`](#section-3-1)`. Comparability of Routes`

`     `[`3.2`](#section-3-2)`. Modification of Label(s) Field When Propagating`

`       `[`3.2.1`](#section-3-2-1)`. When the Next Hop Field Is Unchanged`

`       `[`3.2.2`](#section-3-2-2)`. When the Next Hop Field Is Changed`

`   `[`4`](#section-4)`. Data Plane`

`   `[`5`](#section-5)`. Relationship between SAFI-4 and SAFI-1 Routes`
...
<a id="section-2"></a> **`2. Using BGP to Bind an Address Prefix to One or More MPLS Labels`**
...
<a id="section-2-1"></a> **`2.1. Multiple Labels Capability`**
...
<a id="section-2-2"></a> **`2.2. NLRI Encoding When the Multiple Labels Capability Is Not Used`**
...
<a id="section-2-3"></a> **`2.3. NLRI Encoding When the Multiple Labels Capability Is Used`**
...
<a id="section-2-4"></a> **`2.4. How to Explicitly Withdraw the Binding of a Label to a Prefix`**
...
<a id="section-2-5"></a> **`2.5. Changing the Label That Is Bound to a Prefix`**
...
<a id="section-3"></a> **`3. Installing and/or Propagating SAFI-4 or SAFI-128 Routes`**

```text

```

<a id="section-3-1"></a> **`3.1. Comparability of Routes`**
...
<a id="section-3-2"></a> **`3.2. Modification of Label(s) Field When Propagating`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. When the Next Hop Field Is Unchanged`**
...
<a id="section-3-2-2"></a> **`3.2.2. When the Next Hop Field Is Changed`**
...
<a id="section-5"></a> **`5. Relationship between SAFI-4 and SAFI-1 Routes`**
