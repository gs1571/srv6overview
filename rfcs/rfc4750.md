...
`      `[`1.2`](#section-1-2)`. Conceptual Row Creation`

`      `[`1.3`](#section-1-3)`. Default Configuration`

`      `[`1.4`](#section-1-4)`. OSPF Counters`

`      `[`1.5`](#section-1-5)`. Multiple OSPF Instances`

`      `[`1.6`](#section-1-6)`. Conventions`

`   `[`2`](#section-2)`. Structure of This MIB`

`      `[`2.1`](#section-2-1)`. The Purposes of the Sections in This MIB`

`           `[`2.1.1`](#section-2-1-1)`. General Variables`

`           `[`2.1.2`](#section-2-1-2)`. Area Data Structure and Area Stub Metric Table`

`           `[`2.1.3`](#section-2-1-3)`. Link State Database and External Link State`

`                  Database`

`           `[`2.1.4`](#section-2-1-4)`. Address Table and Host Tables`

`           `[`2.1.5`](#section-2-1-5)`. Interface and Interface Metric Tables`

`           `[`2.1.6`](#section-2-1-6)`. Virtual Interface Table`

`           `[`2.1.7`](#section-2-1-7)`. Neighbor and Virtual Neighbor Tables`

`           `[`2.1.8`](#section-2-1-8)`. Local Link State Database Table and Virtual`

`                  Local Link State Database Table`

`           `[`2.1.9`](#section-2-1-9)`. AS-scope Link State Database Table`

`           `[`2.1.10`](#section-2-1-10)`. Area LSA Count Table`

`   `[`3`](#section-3)`. OSPF MIB Module`

`   `[`4`](#section-4)`. OSPF Trap Overview`

`      `[`4.1`](#section-4-1)`. Introduction`

`      `[`4.2`](#section-4-2)`. Approach`

`      `[`4.3`](#section-4-3)`. Ignoring Initial Activity`

`      `[`4.4`](#section-4-4)`. Throttling Traps`

`      `[`4.5`](#section-4-5)`. One Trap Per OSPF Event`

`      `[`4.6`](#section-4-6)`. Polling Event Counters`

`      `[`4.7`](#section-4-7)`. Translating Notification Parameters`

`      `[`4.8`](#section-4-8)`. Historical Artifacts`

`   `[`5`](#section-5)`. OSPF Trap Definitions`
...
<a id="section-1-2"></a> **`1.2. Conceptual Row Creation`**
...
<a id="section-1-3"></a> **`1.3. Default Configuration`**
...
<a id="section-1-4"></a> **`1.4. OSPF Counters`**
...
<a id="section-1-5"></a> **`1.5. Multiple OSPF Instances`**
...
<a id="section-1-6"></a> **`1.6. Conventions`**
...
<a id="section-2"></a> **`2. Structure of This MIB`**
...
<a id="section-2-1"></a> **`2.1. The Purposes of the Sections in This MIB`**

```text

```

<a id="section-2-1-1"></a> **`2.1.1. General Variables`**
...
<a id="section-2-1-2"></a> **`2.1.2. Area Data Structure and Area Stub Metric Table`**
...
<a id="section-2-1-3"></a> **`2.1.3. Link State Database and External Link State Database`**
...
<a id="section-2-1-4"></a> **`2.1.4. Address Table and Host Tables`**
...
<a id="section-2-1-5"></a> **`2.1.5. Interface and Interface Metric Tables`**
...
<a id="section-2-1-6"></a> **`2.1.6. Virtual Interface Table`**
...
<a id="section-2-1-7"></a> **`2.1.7. Neighbor and Virtual Neighbor Tables`**
...
<a id="section-2-1-8"></a> **`2.1.8. Local Link State Database Table and Virtual Local Link State`**
...
<a id="section-2-1-9"></a> **`2.1.9. AS-scope Link State Database Table`**
...
<a id="section-2-1-10"></a> **`2.1.10. Area LSA Count Table`**
...
<a id="section-3"></a> **`3. OSPF MIB Module`**
...
<a id="section-4"></a> **`4. OSPF Trap Overview`**
...
<a id="section-4-2"></a> **`4.2. Approach`**
...
<a id="section-4-3"></a> **`4.3. Ignoring Initial Activity`**
...
<a id="section-4-4"></a> **`4.4. Throttling Traps`**
...
<a id="section-4-5"></a> **`4.5. One Trap Per OSPF Event`**
...
<a id="section-4-6"></a> **`4.6. Polling Event Counters`**
...
<a id="section-4-7"></a> **`4.7. Translating Notification Parameters`**
...
<a id="section-4-8"></a> **`4.8. Historical Artifacts`**
...
<a id="section-5"></a> **`5. OSPF Trap Definitions`**
