...
`      `[`1.1`](#section-1-1)`. Background and Motivation`

`      `[`1.2`](#section-1-2)`. Securing the Association of a Domain Name with a`

`           Server's Certificate`

`      `[`1.3`](#section-1-3)`. Method for Securing Certificate Associations`

`      `[`1.4`](#section-1-4)`. Terminology`

`   `[`2`](#section-2)`. The TLSA Resource Record`

`      `[`2.1`](#section-2-1)`. TLSA RDATA Wire Format`

`           `[`2.1.1`](#section-2-1-1)`. The Certificate Usage Field`

`           `[`2.1.2`](#section-2-1-2)`. The Selector Field`

`           `[`2.1.3`](#section-2-1-3)`. The Matching Type Field`

`           `[`2.1.4`](#section-2-1-4)`. The Certificate Association Data Field`

`      `[`2.2`](#section-2-2)`. TLSA RR Presentation Format`

`      `[`2.3`](#section-2-3)`. TLSA RR Examples`

`   `[`3`](#section-3)`. Domain Names for TLSA Certificate Associations`

`   `[`4`](#section-4)`. Use of TLSA Records in TLS`

`      `[`4.1`](#section-4-1)`. Usable Certificate Associations`

`   `[`5`](#section-5)`. TLSA and DANE Use Cases and Requirements`

`   `[`6`](#section-6)`. Mandatory-to-Implement Features`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. TLSA RRtype`

`      `[`7.2`](#section-7-2)`. TLSA Certificate Usages`

`      `[`7.3`](#section-7-3)`. TLSA Selectors`

`      `[`7.4`](#section-7-4)`. TLSA Matching Types`

`   `[`8`](#section-8)`. Security Considerations`

`      `[`8.1`](#section-8-1)`. Comparing DANE to Public CAs`

`           `[`8.1.1`](#section-8-1-1)`. Risk of Key Compromise`

`           `[`8.1.2`](#section-8-1-2)`. Impact of Key Compromise`

`           `[`8.1.3`](#section-8-1-3)`. Detection of Key Compromise`

`           `[`8.1.4`](#section-8-1-4)`. Spoofing Hostnames`

`      `[`8.2`](#section-8-2)`. DNS Caching`

`      `[`8.3`](#section-8-3)`. External DNSSEC Validators`
...
<a id="section-1-1"></a> **`1.1. Background and Motivation`**
...
<a id="section-1-2"></a> **`1.2. Securing the Association of a Domain Name with a Server's`**
...
<a id="section-1-3"></a> **`1.3. Method for Securing Certificate Associations`**
...
<a id="section-2"></a> **`2. The TLSA Resource Record`**
...
<a id="section-2-1"></a> **`2.1. TLSA RDATA Wire Format`**
...
<a id="section-2-1-1"></a> **`2.1.1. The Certificate Usage Field`**
...
<a id="section-2-1-2"></a> **`2.1.2. The Selector Field`**
...
<a id="section-2-1-3"></a> **`2.1.3. The Matching Type Field`**
...
<a id="section-2-1-4"></a> **`2.1.4. The Certificate Association Data Field`**
...
<a id="section-2-2"></a> **`2.2. TLSA RR Presentation Format`**
...
<a id="section-2-3"></a> **`2.3. TLSA RR Examples`**
...
<a id="section-3"></a> **`3. Domain Names for TLSA Certificate Associations`**
...
<a id="section-4"></a> **`4. Use of TLSA Records in TLS`**
...
<a id="section-4-1"></a> **`4.1. Usable Certificate Associations`**
...
<a id="section-5"></a> **`5. TLSA and DANE Use Cases and Requirements`**
...
<a id="section-6"></a> **`6. Mandatory-to-Implement Features`**
...
<a id="section-7-1"></a> **`7.1. TLSA RRtype`**
...
<a id="section-7-2"></a> **`7.2. TLSA Certificate Usages`**
...
<a id="section-7-3"></a> **`7.3. TLSA Selectors`**
...
<a id="section-7-4"></a> **`7.4. TLSA Matching Types`**
...
<a id="section-8-1"></a> **`8.1. Comparing DANE to Public CAs`**
...
<a id="section-8-1-1"></a> **`8.1.1. Risk of Key Compromise`**
...
<a id="section-8-1-2"></a> **`8.1.2. Impact of Key Compromise`**
...
<a id="section-8-1-3"></a> **`8.1.3. Detection of Key Compromise`**
...
<a id="section-8-1-4"></a> **`8.1.4. Spoofing Hostnames`**
...
<a id="section-8-2"></a> **`8.2. DNS Caching`**
...
<a id="section-8-3"></a> **`8.3. External DNSSEC Validators`**
