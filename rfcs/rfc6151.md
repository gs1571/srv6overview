...
<a id="section-2-1"></a> **`2.1. Collision Resistance`**
...
<a id="section-2-2"></a> **`2.2. Pre-Image and Second Pre-Image Resistance`**
...
<a id="section-4"></a> **`4. Informative References`**
