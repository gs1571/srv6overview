...
`     `[`1.1`](#section-1-1)`. Document Structure`

`     `[`1.2`](#section-1-2)`. Terminology`

`     `[`1.3`](#section-1-3)`. Use of UDP Tunnels`

`       `[`1.3.1`](#section-1-3-1)`. Motivation for New Approaches`

`       `[`1.3.2`](#section-1-3-2)`. Reducing Forwarding Costs`

`       `[`1.3.3`](#section-1-3-3)`. Need to Inspect the Entire Packet`

`       `[`1.3.4`](#section-1-3-4)`. Interactions with Middleboxes`

`       `[`1.3.5`](#section-1-3-5)`. Support for Load Balancing`

`   `[`2`](#section-2)`. Standards-Track Transports`

`     `[`2.1`](#section-2-1)`. UDP with Standard Checksum`

`     `[`2.2`](#section-2-2)`. UDP-Lite`

`       `[`2.2.1`](#section-2-2-1)`. Using UDP-Lite as a Tunnel Encapsulation`

`     `[`2.3`](#section-2-3)`. General Tunnel Encapsulations`

`     `[`2.4`](#section-2-4)`. Relationship of Zero UDP Checksum to UDP-Lite and UDP`

`           with Checksum`

`   `[`3`](#section-3)`. Issues Requiring Consideration`

`     `[`3.1`](#section-3-1)`. Effect of Packet Modification in the Network`

`       `[`3.1.1`](#section-3-1-1)`. Corruption of the Destination IP Address Field`

`       `[`3.1.2`](#section-3-1-2)`. Corruption of the Source IP Address Field`

`       `[`3.1.3`](#section-3-1-3)`. Corruption of Port Information`

`       `[`3.1.4`](#section-3-1-4)`. Delivery to an Unexpected Port`

`       `[`3.1.5`](#section-3-1-5)`. Corruption of Fragmentation Information`

`     `[`3.2`](#section-3-2)`. Where Packet Corruption Occurs`

`     `[`3.3`](#section-3-3)`. Validating the Network Path`

`     `[`3.4`](#section-3-4)`. Applicability of the Zero UDP Checksum Method`

`     `[`3.5`](#section-3-5)`. Impact on Non-Supporting Devices or Applications`

`   `[`4`](#section-4)`. Constraints on Implementation of IPv6 Nodes Supporting`

`       Zero Checksum`

`   `[`5`](#section-5)`. Requirements on Usage of the Zero UDP Checksum`
...
<a id="section-1-1"></a> **`1.1. Document Structure`**
...
<a id="section-1-3"></a> **`1.3. Use of UDP Tunnels`**
...
<a id="section-1-3-1"></a> **`1.3.1. Motivation for New Approaches`**
...
<a id="section-1-3-2"></a> **`1.3.2. Reducing Forwarding Costs`**
...
<a id="section-1-3-3"></a> **`1.3.3. Need to Inspect the Entire Packet`**
...
<a id="section-1-3-4"></a> **`1.3.4. Interactions with Middleboxes`**
...
<a id="section-1-3-5"></a> **`1.3.5. Support for Load Balancing`**
...
<a id="section-2"></a> **`2. Standards-Track Transports`**
...
<a id="section-2-1"></a> **`2.1. UDP with Standard Checksum`**
...
<a id="section-2-2"></a> **`2.2. UDP-Lite`**
...
<a id="section-2-2-1"></a> **`2.2.1. Using UDP-Lite as a Tunnel Encapsulation`**
...
<a id="section-2-3"></a> **`2.3. General Tunnel Encapsulations`**
...
<a id="section-2-4"></a> **`2.4. Relationship of Zero UDP Checksum to UDP-Lite and UDP with`**
...
<a id="section-3"></a> **`3. Issues Requiring Consideration`**
...
<a id="section-3-1"></a> **`3.1. Effect of Packet Modification in the Network`**
...
<a id="section-3-1-1"></a> **`3.1.1. Corruption of the Destination IP Address Field`**
...
<a id="section-3-1-2"></a> **`3.1.2. Corruption of the Source IP Address Field`**
...
<a id="section-3-1-3"></a> **`3.1.3. Corruption of Port Information`**
...
<a id="section-3-1-4"></a> **`3.1.4. Delivery to an Unexpected Port`**
...
<a id="section-3-1-5"></a> **`3.1.5. Corruption of Fragmentation Information`**
...
<a id="section-3-2"></a> **`3.2. Where Packet Corruption Occurs`**
...
<a id="section-3-3"></a> **`3.3. Validating the Network Path`**
...
<a id="section-3-4"></a> **`3.4. Applicability of the Zero UDP Checksum Method`**
...
<a id="section-3-5"></a> **`3.5. Impact on Non-Supporting Devices or Applications`**
...
<a id="section-4"></a> **`4. Constraints on Implementation of IPv6 Nodes Supporting Zero Checksum`**
...
<a id="section-5"></a> **`5. Requirements on Usage of the Zero UDP Checksum`**
