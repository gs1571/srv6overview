...
`   `[`4`](#section-4)`. Redundancy Requirements`

`      `[`4.1`](#section-4-1)`. Flow-Based Load Balancing`

`      `[`4.2`](#section-4-2)`. Flow-Based Multipathing`

`      `[`4.3`](#section-4-3)`. Geo-redundant PE Nodes`

`      `[`4.4`](#section-4-4)`. Optimal Traffic Forwarding`

`      `[`4.5`](#section-4-5)`. Support for Flexible Redundancy Grouping`

`      `[`4.6`](#section-4-6)`. Multihomed Network`

`   `[`5`](#section-5)`. Multicast Optimization Requirements`

`   `[`6`](#section-6)`. Ease of Provisioning Requirements`

`   `[`7`](#section-7)`. New Service Interface Requirements`

`   `[`8`](#section-8)`. Fast Convergence`

`   `[`9`](#section-9)`. Flood Suppression`

`   `[`10`](#section-10)`. Supporting Flexible VPN Topologies and Policies`
...
<a id="section-4"></a> **`4. Redundancy Requirements`**

```text

```

<a id="section-4-1"></a> **`4.1. Flow-Based Load Balancing`**
...
<a id="section-4-2"></a> **`4.2. Flow-Based Multipathing`**
...
<a id="section-4-3"></a> **`4.3. Geo-redundant PE Nodes`**
...
<a id="section-4-4"></a> **`4.4. Optimal Traffic Forwarding`**
...
<a id="section-4-5"></a> **`4.5. Support for Flexible Redundancy Grouping`**
...
<a id="section-4-6"></a> **`4.6. Multihomed Network`**
...
<a id="section-5"></a> **`5. Multicast Optimization Requirements`**
...
<a id="section-6"></a> **`6. Ease of Provisioning Requirements`**
...
<a id="section-7"></a> **`7. New Service Interface Requirements`**
...
<a id="section-8"></a> **`8. Fast Convergence`**
...
<a id="section-9"></a> **`9. Flood Suppression`**
...
<a id="section-10"></a> **`10. Supporting Flexible VPN Topologies and Policies`**
