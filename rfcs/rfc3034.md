...
`   `[`3`](#section-3)`. Special Characteristics of Frame Relay Switches`

`   `[`4`](#section-4)`. Label Encapsulation`

`   `[`5`](#section-5)`. Frame Relay Label Switching Processing`

`   `[`5.1`](#section-5-1)`. Use of DLCIs`

`   `[`5.2`](#section-5-2)`. Homogeneous LSPs`

`   `[`5.3`](#section-5-3)`. Heterogeneous LSPs`

`   `[`5.4`](#section-5-4)`. Frame Relay Label Switching Loop Prevention and Control`

`   `[`5.4.1`](#section-5-4-1)`. FR-LSRs Loop Control - MPLS TTL Processing`

`   `[`5.4.2`](#section-5-4-2)`. Performing MPLS TTL calculations`

`   `[`5.5`](#section-5-5)`. Label Processing by Ingress FR-LSRs`

`   `[`5.6`](#section-5-6)`. Label Processing by Core FR-LSRs`

`   `[`5.7`](#section-5-7)`. Label Processing by Egress FR-LSRs`

`   `[`6`](#section-6)`. Label Switching Control Component for Frame Relay`

`   `[`6.1`](#section-6-1)`. Hybrid Switches (Ships in the Night)`

`   `[`7`](#section-7)`. Label Allocation and Maintenance Procedures`

`   `[`7.1`](#section-7-1)`. Edge LSR Behavior`

`   `[`7.2`](#section-7-2)`. Efficient use of label space-Merging FR-LSRs`

`   `[`7.3`](#section-7-3)`. LDP message fields specific to Frame Relay`
...
<a id="section-3"></a> **`3. Special characteristics of Frame Relay Switches`**
...
<a id="section-4"></a> **`4. Label Encapsulation`**
...
<a id="section-5"></a> **`5. Frame Relay Label Switching Processing`**
...
<a id="section-6"></a> **`6. Label Switching Control Component for Frame Relay`**
...
<a id="section-7"></a> **`7. Label Allocation and Maintenance Procedures`**
