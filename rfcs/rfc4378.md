...
`   `[`3`](#section-3)`. Fault Management`

`      `[`3.1`](#section-3-1)`. Fault Detection`

`      `[`3.2`](#section-3-2)`. Diagnosis`

`      `[`3.3`](#section-3-3)`. Availability`

`   `[`4`](#section-4)`. Configuration Management`

`   `[`5`](#section-5)`. Accounting`

`   `[`6`](#section-6)`. Performance Management`

`   `[`7`](#section-7)`. Security Management`
...
<a id="section-3"></a> **`3. Fault Management`**

```text

```

<a id="section-3-1"></a> **`3.1. Fault Detection`**
...
<a id="section-3-1-1"></a> **`3.1.1. Enumeration and Detection of Types of Data Plane Faults`**
...
<a id="section-3-1-2"></a> **`3.1.2. Timeliness`**
...
<a id="section-3-2"></a> **`3.2. Diagnosis`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. Characterization`**
...
<a id="section-3-2-2"></a> **`3.2.2. Isolation`**
...
<a id="section-3-3"></a> **`3.3. Availability`**
...
<a id="section-4"></a> **`4. Configuration Management`**
...
<a id="section-6"></a> **`6. Performance Management`**
...
<a id="section-7"></a> **`7. Security Management`**
