...
`   `[`2`](#section-2)`. Working Definition of Route Leaks`

`   `[`3`](#section-3)`. Classification of Route Leaks Based on Documented Events  .`

`     `[`3.1`](#section-3-1)`. Type 1: Hairpin Turn with Full Prefix`

`     `[`3.2`](#section-3-2)`. Type 2: Lateral ISP-ISP-ISP Leak`

`     `[`3.3`](#section-3-3)`. Type 3: Leak of Transit-Provider Prefixes to Peer`

`     `[`3.4`](#section-3-4)`. Type 4: Leak of Peer Prefixes to Transit Provider`

`     `[`3.5`](#section-3-5)`. Type 5: Prefix Re-origination with Data Path to`

`           Legitimate Origin`

`     `[`3.6`](#section-3-6)`. Type 6: Accidental Leak of Internal Prefixes and More-`

`           Specific Prefixes`

`   `[`4`](#section-4)`. Additional Comments about the Classification`
...
<a id="section-2"></a> **`2. Working Definition of Route Leaks`**
...
<a id="section-3"></a> **`3. Classification of Route Leaks Based on Documented Events`**
...
<a id="section-3-1"></a> **`3.1. Type 1: Hairpin Turn with Full Prefix`**
...
<a id="section-3-2"></a> **`3.2. Type 2: Lateral ISP-ISP-ISP Leak`**
...
<a id="section-3-3"></a> **`3.3. Type 3: Leak of Transit-Provider Prefixes to Peer`**
...
<a id="section-3-4"></a> **`3.4. Type 4: Leak of Peer Prefixes to Transit Provider`**
...
<a id="section-3-5"></a> **`3.5. Type 5: Prefix Re-origination with Data Path to Legitimate Origin`**
...
<a id="section-3-6"></a> **`3.6. Type 6: Accidental Leak of Internal Prefixes and More-Specific`**
...
<a id="section-4"></a> **`4. Additional Comments about the Classification`**
