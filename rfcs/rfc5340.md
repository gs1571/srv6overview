...
`   `[`2`](#section-2)`. Differences from OSPF for IPv4`

`     `[`2.1`](#section-2-1)`. Protocol Processing Per-Link, Not Per-Subnet`

`     `[`2.2`](#section-2-2)`. Removal of Addressing Semantics`

`     `[`2.3`](#section-2-3)`. Addition of Flooding Scope`

`     `[`2.4`](#section-2-4)`. Explicit Support for Multiple Instances per Link`

`     `[`2.5`](#section-2-5)`. Use of Link-Local Addresses`

`     `[`2.6`](#section-2-6)`. Authentication Changes`

`     `[`2.7`](#section-2-7)`. Packet Format Changes`

`     `[`2.8`](#section-2-8)`. LSA Format Changes`

`     `[`2.9`](#section-2-9)`. Handling Unknown LSA Types`

`     `[`2.10`](#section-2-10)`. Stub/NSSA Area Support`

`     `[`2.11`](#section-2-11)`. Identifying Neighbors by Router ID`

`   `[`3`](#section-3)`. Differences with RFC 2740`

`     `[`3.1`](#section-3-1)`. Support for Multiple Interfaces on the Same Link`

`     `[`3.2`](#section-3-2)`. Deprecation of MOSPF for IPv6`

`     `[`3.3`](#section-3-3)`. NSSA Specification`

`     `[`3.4`](#section-3-4)`. Stub Area Unknown LSA Flooding Restriction Deprecated  .`

`     `[`3.5`](#section-3-5)`. Link LSA Suppression`

`     `[`3.6`](#section-3-6)`. LSA Options and Prefix Options Updates`

`     `[`3.7`](#section-3-7)`. IPv6 Site-Local Addresses`

`   `[`4`](#section-4)`. Implementation Details`

`     `[`4.1`](#section-4-1)`. Protocol Data Structures`

`       `[`4.1.1`](#section-4-1-1)`. The Area Data Structure`

`       `[`4.1.2`](#section-4-1-2)`. The Interface Data Structure`

`       `[`4.1.3`](#section-4-1-3)`. The Neighbor Data Structure`

`     `[`4.2`](#section-4-2)`. Protocol Packet Processing`

`       `[`4.2.1`](#section-4-2-1)`. Sending Protocol Packets`

`         `[`4.2.1.1`](#section-4-2-1-1)`. Sending Hello Packets`

`         `[`4.2.1.2`](#section-4-2-1-2)`. Sending Database Description Packets`

`       `[`4.2.2`](#section-4-2-2)`. Receiving Protocol Packets`

`         `[`4.2.2.1`](#section-4-2-2-1)`. Receiving Hello Packets`

`     `[`4.3`](#section-4-3)`. The Routing table Structure`

`       `[`4.3.1`](#section-4-3-1)`. Routing Table Lookup`

`     `[`4.4`](#section-4-4)`. Link State Advertisements`

`       `[`4.4.1`](#section-4-4-1)`. The LSA Header`

`       `[`4.4.2`](#section-4-4-2)`. The Link-State Database`

`       `[`4.4.3`](#section-4-4-3)`. Originating LSAs`

`         `[`4.4.3.1`](#section-4-4-3-1)`. LSA Options`

`         `[`4.4.3.2`](#section-4-4-3-2)`. Router-LSAs`

`         `[`4.4.3.3`](#section-4-4-3-3)`. Network-LSAs`

`         `[`4.4.3.4`](#section-4-4-3-4)`. Inter-Area-Prefix-LSAs`

`         `[`4.4.3.5`](#section-4-4-3-5)`. Inter-Area-Router-LSAs`

`         `[`4.4.3.6`](#section-4-4-3-6)`. AS-External-LSAs`

`         `[`4.4.3.7`](#section-4-4-3-7)`. NSSA-LSAs`

`         `[`4.4.3.8`](#section-4-4-3-8)`. Link-LSAs`

`         `[`4.4.3.9`](#section-4-4-3-9)`. Intra-Area-Prefix-LSAs`

`       `[`4.4.4`](#section-4-4-4)`. Future LSA Validation`

`     `[`4.5`](#section-4-5)`. Flooding`

`       `[`4.5.1`](#section-4-5-1)`. Receiving Link State Update Packets`

`       `[`4.5.2`](#section-4-5-2)`. Sending Link State Update Packets`

`       `[`4.5.3`](#section-4-5-3)`. Installing LSAs in the Database`

`     `[`4.6`](#section-4-6)`. Definition of Self-Originated LSAs`

`     `[`4.7`](#section-4-7)`. Virtual Links`

`     `[`4.8`](#section-4-8)`. Routing Table Calculation`

`       `[`4.8.1`](#section-4-8-1)`. Calculating the Shortest-Path Tree for an Area`

`       `[`4.8.2`](#section-4-8-2)`. The Next-Hop Calculation`

`       `[`4.8.3`](#section-4-8-3)`. Calculating the Inter-Area Routes`

`       `[`4.8.4`](#section-4-8-4)`. Examining Transit Areas' Summary-LSAs`

`       `[`4.8.5`](#section-4-8-5)`. Calculating AS External and NSSA Routes`

`     `[`4.9`](#section-4-9)`. Multiple Interfaces to a Single Link`

`       `[`4.9.1`](#section-4-9-1)`. Standby Interface State`
...
`     `[`7.1`](#section-7-1)`. MOSPF for OSPFv3 Deprecation IANA Considerations`
...
<a id="section-2"></a> **`2. Differences from OSPF for IPv4`**
...
<a id="section-2-1"></a> **`2.1. Protocol Processing Per-Link, Not Per-Subnet`**
...
<a id="section-2-2"></a> **`2.2. Removal of Addressing Semantics`**
...
<a id="section-2-3"></a> **`2.3. Addition of Flooding Scope`**
...
<a id="section-2-4"></a> **`2.4. Explicit Support for Multiple Instances per Link`**
...
<a id="section-2-5"></a> **`2.5. Use of Link-Local Addresses`**
...
<a id="section-2-6"></a> **`2.6. Authentication Changes`**
...
<a id="section-2-7"></a> **`2.7. Packet Format Changes`**
...
<a id="section-2-8"></a> **`2.8. LSA Format Changes`**
...
<a id="section-2-9"></a> **`2.9. Handling Unknown LSA Types`**
...
<a id="section-2-10"></a> **`2.10. Stub/NSSA Area Support`**
...
<a id="section-2-11"></a> **`2.11. Identifying Neighbors by Router ID`**
...
<a id="section-3"></a> **`3. Differences with RFC 2740`**
...
<a id="section-3-1"></a> **`3.1. Support for Multiple Interfaces on the Same Link`**
...
<a id="section-3-2"></a> **`3.2. Deprecation of MOSPF for IPv6`**
...
<a id="section-3-3"></a> **`3.3. NSSA Specification`**
...
<a id="section-3-4"></a> **`3.4. Stub Area Unknown LSA Flooding Restriction Deprecated`**
...
<a id="section-3-5"></a> **`3.5. Link LSA Suppression`**
...
<a id="section-3-6"></a> **`3.6. LSA Options and Prefix Options Updates`**
...
<a id="section-3-7"></a> **`3.7. IPv6 Site-Local Addresses`**
...
<a id="section-4"></a> **`4. Implementation Details`**
...
<a id="section-4-1"></a> **`4.1. Protocol Data Structures`**
...
<a id="section-4-1-1"></a> **`4.1.1. The Area Data Structure`**
...
<a id="section-4-1-2"></a> **`4.1.2. The Interface Data Structure`**
...
<a id="section-4-1-3"></a> **`4.1.3. The Neighbor Data Structure`**
...
<a id="section-4-2"></a> **`4.2. Protocol Packet Processing`**
...
<a id="section-4-2-1"></a> **`4.2.1. Sending Protocol Packets`**
...
<a id="section-4-2-1-1"></a> **`4.2.1.1. Sending Hello Packets`**
...
<a id="section-4-2-1-2"></a> **`4.2.1.2. Sending Database Description Packets`**
...
<a id="section-4-2-2"></a> **`4.2.2. Receiving Protocol Packets`**
...
<a id="section-4-2-2-1"></a> **`4.2.2.1. Receiving Hello Packets`**
...
<a id="section-4-3"></a> **`4.3. The Routing table Structure`**
...
<a id="section-4-3-1"></a> **`4.3.1. Routing Table Lookup`**
...
<a id="section-4-4"></a> **`4.4. Link State Advertisements`**
...
<a id="section-4-4-1"></a> **`4.4.1. The LSA Header`**
...
<a id="section-4-4-2"></a> **`4.4.2. The Link-State Database`**
...
<a id="section-4-4-3"></a> **`4.4.3. Originating LSAs`**
...
<a id="section-4-4-3-1"></a> **`4.4.3.1. LSA Options`**
...
<a id="section-4-4-3-2"></a> **`4.4.3.2. Router-LSAs`**
...
<a id="section-4-4-3-3"></a> **`4.4.3.3. Network-LSAs`**
...
<a id="section-4-4-3-4"></a> **`4.4.3.4. Inter-Area-Prefix-LSAs`**
...
<a id="section-4-4-3-5"></a> **`4.4.3.5. Inter-Area-Router-LSAs`**
...
<a id="section-4-4-3-6"></a> **`4.4.3.6. AS-External-LSAs`**
...
<a id="section-4-4-3-7"></a> **`4.4.3.7. NSSA-LSAs`**
...
<a id="section-4-4-3-8"></a> **`4.4.3.8. Link-LSAs`**
...
<a id="section-4-4-3-9"></a> **`4.4.3.9. Intra-Area-Prefix-LSAs`**
...
<a id="section-4-4-4"></a> **`4.4.4. Future LSA Validation`**
...
<a id="section-4-5"></a> **`4.5. Flooding`**
...
<a id="section-4-5-1"></a> **`4.5.1. Receiving Link State Update Packets`**
...
<a id="section-4-5-2"></a> **`4.5.2. Sending Link State Update Packets`**
...
<a id="section-4-5-3"></a> **`4.5.3. Installing LSAs in the Database`**
...
<a id="section-4-6"></a> **`4.6. Definition of Self-Originated LSAs`**
...
<a id="section-4-7"></a> **`4.7. Virtual Links`**
...
<a id="section-4-8"></a> **`4.8. Routing Table Calculation`**
...
<a id="section-4-8-1"></a> **`4.8.1. Calculating the Shortest-Path Tree for an Area`**
...
<a id="section-4-8-2"></a> **`4.8.2. The Next-Hop Calculation`**
...
<a id="section-4-8-3"></a> **`4.8.3. Calculating the Inter-Area Routes`**
...
<a id="section-4-8-4"></a> **`4.8.4. Examining Transit Areas' Summary-LSAs`**
...
<a id="section-4-8-5"></a> **`4.8.5. Calculating AS External and NSSA Routes`**
...
<a id="section-4-9"></a> **`4.9. Multiple Interfaces to a Single Link`**
...
<a id="section-4-9-1"></a> **`4.9.1. Standby Interface State`**
...
<a id="section-7-1"></a> **`7.1. MOSPF for OSPFv3 Deprecation IANA Considerations`**
