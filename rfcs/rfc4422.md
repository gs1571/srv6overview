...
`      `[`1.1`](#section-1-1)`. Document Audiences`

`      `[`1.2`](#section-1-2)`. Relationship to Other Documents`

`      `[`1.3`](#section-1-3)`. Conventions`

`   `[`2`](#section-2)`. Identity Concepts`

`   `[`3`](#section-3)`. The Authentication Exchange`

`      `[`3.1`](#section-3-1)`. Mechanism Naming`

`      `[`3.2`](#section-3-2)`. Mechanism Negotiation`

`      `[`3.3`](#section-3-3)`. Request Authentication Exchange`

`      `[`3.4`](#section-3-4)`. Challenges and Responses`

`           `[`3.4.1`](#section-3-4-1)`. Authorization Identity String`

`      `[`3.5`](#section-3-5)`. Aborting Authentication Exchanges`

`      `[`3.6`](#section-3-6)`. Authentication Outcome`

`      `[`3.7`](#section-3-7)`. Security Layers`

`      `[`3.8`](#section-3-8)`. Multiple Authentications`

`   `[`4`](#section-4)`. Protocol Requirements`

`   `[`5`](#section-5)`. Mechanism Requirements`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Active Attacks`

`           `[`6.1.1`](#section-6-1-1)`. Hijack Attacks`

`           `[`6.1.2`](#section-6-1-2)`. Downgrade Attacks`

`           `[`6.1.3`](#section-6-1-3)`. Replay Attacks`

`           `[`6.1.4`](#section-6-1-4)`. Truncation Attacks`

`           `[`6.1.5`](#section-6-1-5)`. Other Active Attacks`

`      `[`6.2`](#section-6-2)`. Passive Attacks`

`      `[`6.3`](#section-6-3)`. Re-keying`

`      `[`6.4`](#section-6-4)`. Other Considerations`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. SASL Mechanism Registry`

`      `[`7.2`](#section-7-2)`. Registration Changes`
...
<a id="section-1-1"></a> **`1.1. Document Audiences`**
...
<a id="section-1-2"></a> **`1.2. Relationship to Other Documents`**
...
<a id="section-1-3"></a> **`1.3. Conventions`**
...
<a id="section-2"></a> **`2. Identity Concepts`**
...
<a id="section-3"></a> **`3. The Authentication Exchange`**
...
<a id="section-3-1"></a> **`3.1. Mechanism Naming`**
...
<a id="section-3-2"></a> **`3.2. Mechanism Negotiation`**
...
<a id="section-3-3"></a> **`3.3. Request Authentication Exchange`**
...
<a id="section-3-4"></a> **`3.4. Challenges and Responses`**
...
<a id="section-3-4-1"></a> **`3.4.1. Authorization Identity String`**
...
<a id="section-3-5"></a> **`3.5. Aborting Authentication Exchanges`**
...
<a id="section-3-6"></a> **`3.6. Authentication Outcome`**
...
<a id="section-3-7"></a> **`3.7. Security Layers`**
...
<a id="section-3-8"></a> **`3.8. Multiple Authentications`**
...
<a id="section-4"></a> **`4. Protocol Requirements`**
...
<a id="section-5"></a> **`5. Mechanism Requirements`**
...
<a id="section-6-1"></a> **`6.1. Active Attacks`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. Hijack Attacks`**
...
<a id="section-6-1-2"></a> **`6.1.2. Downgrade Attacks`**
...
<a id="section-6-1-3"></a> **`6.1.3. Replay Attacks`**
...
<a id="section-6-1-4"></a> **`6.1.4. Truncation Attacks`**
...
<a id="section-6-1-5"></a> **`6.1.5. Other Active Attacks`**
...
<a id="section-6-2"></a> **`6.2. Passive Attacks`**
...
<a id="section-6-3"></a> **`6.3. Re-keying`**
...
<a id="section-6-4"></a> **`6.4. Other Considerations`**
...
<a id="section-7-1"></a> **`7.1. SASL Mechanism Registry`**
...
<a id="section-7-1-1"></a> **`7.1.1. Mechanism Name Registration Procedure`**
...
<a id="section-7-1-2"></a> **`7.1.2. Family Name Registration Procedure`**
...
<a id="section-7-1-3"></a> **`7.1.3. Comments on SASL Mechanism Registrations`**
...
<a id="section-7-1-4"></a> **`7.1.4. Change Control`**
...
<a id="section-7-2"></a> **`7.2. Registration Changes`**
