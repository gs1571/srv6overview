...
`       `[`1.1`](#section-1-1)`. Requirements for Layer-Specific TE Attributes`

`       `[`1.2`](#section-1-2)`. Excluding Data Traffic from Control Channels`

`   `[`2`](#section-2)`. GMPLS Routing Enhancements`

`       `[`2.1`](#section-2-1)`. Support for Unnumbered Links`

`       `[`2.2`](#section-2-2)`. Link Protection Type`

`       `[`2.3`](#section-2-3)`. Shared Risk Link Group Information`

`       `[`2.4`](#section-2-4)`. Interface Switching Capability Descriptor`

`             `[`2.4.1`](#section-2-4-1)`. Layer-2 Switch Capable`

`             `[`2.4.2`](#section-2-4-2)`. Packet-Switch Capable`

`             `[`2.4.3`](#section-2-4-3)`. Time-Division Multiplex Capable`

`             `[`2.4.4`](#section-2-4-4)`. Lambda-Switch Capable`

`             `[`2.4.5`](#section-2-4-5)`. Fiber-Switch Capable`

`             `[`2.4.6`](#section-2-4-6)`. Multiple Switching Capabilities per Interface`

`             `[`2.4.7`](#section-2-4-7)`. Interface Switching Capabilities and Labels .`

`             `[`2.4.8`](#section-2-4-8)`. Other Issues`

`       `[`2.5`](#section-2-5)`. Bandwidth Encoding`

`   `[`3`](#section-3)`. Examples of Interface Switching Capability Descriptor`

`       `[`3.1`](#section-3-1)`. STM-16 POS Interface on a LSR`

`       `[`3.2`](#section-3-2)`. GigE Packet Interface on a LSR`

`       `[`3.3`](#section-3-3)`. STM-64 SDH Interface on a Digital Cross Connect with`

`             Standard SDH`

`       `[`3.4`](#section-3-4)`. STM-64 SDH Interface on a Digital Cross Connect with`

`             Two Types of SDH Multiplexing Hierarchy Supported`

`       `[`3.5`](#section-3-5)`. Interface on an Opaque OXC (SDH Framed) with Support`

`             for One Lambda per Port/Interface`

`       `[`3.6`](#section-3-6)`. Interface on a Transparent OXC (PXC) with External`

`             DWDM that understands SDH framing`

`       `[`3.7`](#section-3-7)`. Interface on a Transparent OXC (PXC) with External`

`             DWDM That Is Transparent to Bit-Rate and Framing`

`       `[`3.8`](#section-3-8)`. Interface on a PXC with No External DWDM`

`       `[`3.9`](#section-3-9)`. Interface on a OXC with Internal DWDM That Understands`

`             SDH Framing`

`       `[`3.10`](#section-3-10)`. Interface on a OXC with Internal DWDM That Is`

`             Transparent to Bit-Rate and Framing`

`   `[`4`](#section-4)`. Example of Interfaces That Support Multiple Switching`

`       Capabilities`

`       `[`4.1`](#section-4-1)`. Interface on a PXC+TDM Device with External DWDM`

`       `[`4.2`](#section-4-2)`. Interface on an Opaque OXC+TDM Device with External`

`             DWDM`

`       `[`4.3`](#section-4-3)`. Interface on a PXC+LSR Device with External DWDM`

`       `[`4.4`](#section-4-4)`. Interface on a TDM+LSR Device`
...
<a id="section-1-1"></a> **`1.1. Requirements for Layer-Specific TE Attributes`**
...
<a id="section-1-2"></a> **`1.2. Excluding Data Traffic from Control Channels`**
...
<a id="section-2"></a> **`2. GMPLS Routing Enhancements`**
...
<a id="section-2-1"></a> **`2.1. Support for Unnumbered Links`**
...
<a id="section-2-2"></a> **`2.2. Link Protection Type`**
...
<a id="section-2-3"></a> **`2.3. Shared Risk Link Group Information`**
...
<a id="section-2-4"></a> **`2.4. Interface Switching Capability Descriptor`**
...
<a id="section-2-4-1"></a> **`2.4.1. Layer-2 Switch Capable`**
...
<a id="section-2-4-2"></a> **`2.4.2. Packet-Switch Capable`**
...
<a id="section-2-4-3"></a> **`2.4.3. Time-Division Multiplex Capable`**
...
<a id="section-2-4-4"></a> **`2.4.4. Lambda-Switch Capable`**
...
<a id="section-2-4-5"></a> **`2.4.5. Fiber-Switch Capable`**
...
<a id="section-2-4-6"></a> **`2.4.6. Multiple Switching Capabilities per Interface`**
...
<a id="section-2-4-7"></a> **`2.4.7. Interface Switching Capabilities and Labels`**
...
<a id="section-2-4-8"></a> **`2.4.8. Other Issues`**
...
<a id="section-2-5"></a> **`2.5. Bandwidth Encoding`**
...
<a id="section-3"></a> **`3. Examples of Interface Switching Capability Descriptor`**

```text

```

<a id="section-3-1"></a> **`3.1. STM-16 POS Interface on a LSR`**
...
<a id="section-3-2"></a> **`3.2. GigE Packet Interface on a LSR`**
...
<a id="section-3-3"></a> **`3.3. STM-64 SDH Interface on a Digital Cross Connect with Standard SDH`**
...
<a id="section-3-4"></a> **`3.4. STM-64 SDH Interface on a Digital Cross Connect with Two Types of`**
...
<a id="section-3-5"></a> **`3.5. Interface on an Opaque OXC (SDH Framed) with Support for One`**
...
<a id="section-3-6"></a> **`3.6. Interface on a Transparent OXC (PXC) with External DWDM That`**
...
<a id="section-3-7"></a> **`3.7. Interface on a Transparent OXC (PXC) with External DWDM That Is`**
...
<a id="section-3-8"></a> **`3.8. Interface on a PXC with No External DWDM`**
...
<a id="section-3-9"></a> **`3.9. Interface on a OXC with Internal DWDM That Understands SDH Framing`**
...
<a id="section-3-10"></a> **`3.10. Interface on a OXC with Internal DWDM That Is Transparent to`**
...
<a id="section-4"></a> **`4. Example of Interfaces That Support Multiple Switching Capabilities`**
...
<a id="section-4-1"></a> **`4.1. Interface on a PXC+TDM Device with External DWDM`**
...
<a id="section-4-2"></a> **`4.2. Interface on an Opaque OXC+TDM Device with External DWDM`**
...
<a id="section-4-3"></a> **`4.3. Interface on a PXC+LSR Device with External DWDM`**
...
<a id="section-4-4"></a> **`4.4. Interface on a TDM+LSR Device`**
...
<a id="section-8"></a> **`8. Contributors`**
