...
`   `[`2`](#section-2)`. Comparison with LSP Hierarchy`

`   `[`3`](#section-3)`. Usage`

`      `[`3.1`](#section-3-1)`. Triggers for LSP Segment Setup`

`      `[`3.2`](#section-3-2)`. Applications`

`   `[`4`](#section-4)`. Routing Aspects`

`   `[`5`](#section-5)`. Signaling Aspects`

`      `[`5.1`](#section-5-1)`. RSVP-TE Signaling Extensions`

`           `[`5.1.1`](#section-5-1-1)`. Creating and Preparing an LSP Segment for`

`                  Stitching`

`                  `[`5.1.1.1`](#section-5-1-1-1)`. Steps to Support Penultimate Hop`

`                           Popping`

`           `[`5.1.2`](#section-5-1-2)`. Stitching the e2e LSP to the LSP Segment`

`           `[`5.1.3`](#section-5-1-3)`. RRO Processing for e2e LSPs`

`           `[`5.1.4`](#section-5-1-4)`. Teardown of LSP Segments`

`           `[`5.1.5`](#section-5-1-5)`. Teardown of e2e LSPs`

`      `[`5.2`](#section-5-2)`. Summary of LSP Stitching Procedures`

`           `[`5.2.1`](#section-5-2-1)`. Example Topology`

`           `[`5.2.2`](#section-5-2-2)`. LSP Segment Setup`

`           `[`5.2.3`](#section-5-2-3)`. Setup of an e2e LSP`

`           `[`5.2.4`](#section-5-2-4)`. Stitching of an e2e LSP into an LSP Segment`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. Attribute Flags for LSP_ATTRIBUTES Object`

`      `[`7.2`](#section-7-2)`. New Error Codes`
...
<a id="section-2"></a> **`2. Comparison with LSP Hierarchy`**
...
<a id="section-3"></a> **`3. Usage`**

```text

```

<a id="section-3-1"></a> **`3.1. Triggers for LSP Segment Setup`**
...
<a id="section-3-2"></a> **`3.2. Applications`**
...
<a id="section-4"></a> **`4. Routing Aspects`**
...
<a id="section-5"></a> **`5. Signaling Aspects`**
...
<a id="section-5-1"></a> **`5.1. RSVP-TE Signaling Extensions`**
...
<a id="section-5-1-1"></a> **`5.1.1. Creating and Preparing an LSP Segment for Stitching`**
...
<a id="section-5-1-1-1"></a> **`5.1.1.1. Steps to Support Penultimate Hop Popping`**
...
<a id="section-5-1-2"></a> **`5.1.2. Stitching the e2e LSP to the LSP Segment`**
...
<a id="section-5-1-3"></a> **`5.1.3. RRO Processing for e2e LSPs`**
...
<a id="section-5-1-4"></a> **`5.1.4. Teardown of LSP Segments`**
...
<a id="section-5-1-5"></a> **`5.1.5. Teardown of e2e LSPs`**
...
<a id="section-5-2"></a> **`5.2. Summary of LSP Stitching Procedures`**

```text

```

<a id="section-5-2-1"></a> **`5.2.1. Example Topology`**
...
<a id="section-5-2-2"></a> **`5.2.2. LSP Segment Setup`**
...
<a id="section-5-2-3"></a> **`5.2.3. Setup of an e2e LSP`**
...
<a id="section-5-2-4"></a> **`5.2.4. Stitching of an e2e LSP into an LSP Segment`**
...
<a id="section-7-1"></a> **`7.1. Attribute Flags for LSP_ATTRIBUTES Object`**
...
<a id="section-7-2"></a> **`7.2. New Error Codes`**
