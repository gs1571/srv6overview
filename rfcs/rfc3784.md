...
<a id="section-5"></a> **`5. The Traffic Engineering Router ID TLV`**
...
<a id="section-6-1"></a> **`6.1. TLV Codepoint Allocations`**
...
<a id="section-6-2"></a> **`6.2. New Registries`**
...
<a id="section-6-2-1"></a> **`6.2.1. Sub-TLVs for the Extended IS Reachability TLV`**
...
<a id="section-6-2-2"></a> **`6.2.2. Sub-TLVs for the Extended IP Reachability TLV`**
