...
`      `[`1.1`](#section-1-1)`. Virtual Private Networks`

`      `[`1.2`](#section-1-2)`. Customer Edge and Provider Edge`

`      `[`1.3`](#section-1-3)`. VPNs with Overlapping Address Spaces`

`      `[`1.4`](#section-1-4)`. VPNs with Different Routes to the Same System`

`      `[`1.5`](#section-1-5)`. SP Backbone Routers`

`      `[`1.6`](#section-1-6)`. Security`

`   `[`2`](#section-2)`. Sites and CEs`

`   `[`3`](#section-3)`. VRFs: Multiple Forwarding Tables in PEs`

`      `[`3.1`](#section-3-1)`. VRFs and Attachment Circuits`

`      `[`3.2`](#section-3-2)`. Associating IP Packets with VRFs`

`      `[`3.3`](#section-3-3)`. Populating the VRFs`

`   `[`4`](#section-4)`. VPN Route Distribution via BGP`

`      `[`4.1`](#section-4-1)`. The VPN-IPv4 Address Family`

`      `[`4.2`](#section-4-2)`. Encoding of Route Distinguishers`

`      `[`4.3`](#section-4-3)`. Controlling Route Distribution`

`           `[`4.3.1`](#section-4-3-1)`. The Route Target Attribute`

`           `[`4.3.2`](#section-4-3-2)`. Route Distribution Among PEs by BGP`

`           `[`4.3.3`](#section-4-3-3)`. Use of Route Reflectors`

`           `[`4.3.4`](#section-4-3-4)`. How VPN-IPv4 NLRI Is Carried in BGP`

`           `[`4.3.5`](#section-4-3-5)`. Building VPNs Using Route Targets`

`           `[`4.3.6`](#section-4-3-6)`. Route Distribution Among VRFs in a Single PE`

`   `[`5`](#section-5)`. Forwarding`

`   `[`6`](#section-6)`. Maintaining Proper Isolation of VPNs`

`   `[`7`](#section-7)`. How PEs Learn Routes from CEs`

`   `[`8`](#section-8)`. How CEs Learn Routes from PEs`

`   `[`9`](#section-9)`. Carriers' Carriers`

`   `[`10`](#section-10)`. Multi-AS Backbones`

`   `[`11`](#section-11)`. Accessing the Internet from a VPN`

`   `[`12`](#section-12)`. Management VPNs`

`   `[`13`](#section-13)`. Security Considerations`

`      `[`13.1`](#section-13-1)`. Data Plane`

`      `[`13.2`](#section-13-2)`. Control Plane`

`      `[`13.3`](#section-13-3)`. Security of P and PE Devices`

`   `[`14`](#section-14)`. Quality of Service`

`   `[`15`](#section-15)`. Scalability`
...
`   `[`19`](#section-19)`. Normative References`

`   `[`20`](#section-20)`. Informative References`
...
<a id="section-1-1"></a> **`1.1. Virtual Private Networks`**
...
<a id="section-1-2"></a> **`1.2. Customer Edge and Provider Edge`**
...
<a id="section-1-3"></a> **`1.3. VPNs with Overlapping Address Spaces`**
...
<a id="section-1-4"></a> **`1.4. VPNs with Different Routes to the Same System`**
...
<a id="section-1-5"></a> **`1.5. SP Backbone Routers`**
...
<a id="section-1-6"></a> **`1.6. Security`**
...
<a id="section-2"></a> **`2. Sites and CEs`**
...
<a id="section-3"></a> **`3. VRFs: Multiple Forwarding Tables in PEs`**
...
<a id="section-3-1"></a> **`3.1. VRFs and Attachment Circuits`**
...
<a id="section-3-2"></a> **`3.2. Associating IP Packets with VRFs`**
...
<a id="section-3-3"></a> **`3.3. Populating the VRFs`**
...
<a id="section-4"></a> **`4. VPN Route Distribution via BGP`**
...
<a id="section-4-1"></a> **`4.1. The VPN-IPv4 Address Family`**
...
<a id="section-4-2"></a> **`4.2. Encoding of Route Distinguishers`**
...
<a id="section-4-3"></a> **`4.3. Controlling Route Distribution`**
...
<a id="section-4-3-1"></a> **`4.3.1. The Route Target Attribute`**
...
<a id="section-4-3-2"></a> **`4.3.2. Route Distribution Among PEs by BGP`**
...
<a id="section-4-3-3"></a> **`4.3.3. Use of Route Reflectors`**
...
<a id="section-4-3-4"></a> **`4.3.4. How VPN-IPv4 NLRI Is Carried in BGP`**
...
<a id="section-4-3-5"></a> **`4.3.5. Building VPNs Using Route Targets`**
...
<a id="section-4-3-6"></a> **`4.3.6. Route Distribution Among VRFs in a Single PE`**
...
<a id="section-6"></a> **`6. Maintaining Proper Isolation of VPNs`**
...
<a id="section-7"></a> **`7. How PEs Learn Routes from CEs`**
...
<a id="section-8"></a> **`8. How CEs Learn Routes from PEs`**
...
<a id="section-9"></a> **`9. Carriers' Carriers`**
...
<a id="section-10"></a> **`10. Multi-AS Backbones`**
...
<a id="section-11"></a> **`11. Accessing the Internet from a VPN`**
...
<a id="section-12"></a> **`12. Management VPNs`**
...
<a id="section-13-1"></a> **`13.1. Data Plane`**
...
<a id="section-13-2"></a> **`13.2. Control Plane`**
...
<a id="section-13-3"></a> **`13.3. Security of P and PE Devices`**
...
<a id="section-14"></a> **`14. Quality of Service`**
...
<a id="section-15"></a> **`15. Scalability`**
...
<a id="section-19"></a> **`19. Normative References`**
...
<a id="section-20"></a> **`20. Informative References`**
