...
`      `[`2`](#section-2)`. 1 Addressing Model`

`      `[`2`](#section-2)`. 2 Text Representation of Addresses`

`      `[`2`](#section-2)`. 3 Text Representation of Address Prefixes`

`      `[`2`](#section-2)`. 4 Address Type Identification`

`      `[`2`](#section-2)`. 5 Unicast Addresses`

`          `[`2.5`](#section-2-5)`. 1 Interface Identifiers`

`          `[`2.5`](#section-2-5)`. 2 The Unspecified Address`

`          `[`2.5`](#section-2-5)`. 3 The Loopback Address`

`          `[`2.5`](#section-2-5)`. 4 Global Unicast Addresses`

`          `[`2.5`](#section-2-5)`. 5 IPv6 Addresses with Embedded IPv4 Addresses`

`          `[`2.5`](#section-2-5)`. 6 Local-use IPv6 Unicast Addresses`

`      `[`2`](#section-2)`. 6 Anycast Addresses`

`          `[`2.6`](#section-2-6)`. 1 Required Anycast Address`

`      `[`2`](#section-2)`. 7 Multicast Addresses`

`          `[`2.7`](#section-2-7)`. 1 Pre-Defined Multicast Addresses`

`      `[`2`](#section-2)`. 8 A Node's Required Addresses`
...
`      `[`5`](#section-5)`. 1 Normative References`

`      `[`5`](#section-5)`. 2 Informative References`

`   APPENDIX A: Creating Modified EUI-64 format Interface IDs`
