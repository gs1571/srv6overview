...
**Consensus:** true
**IPR:** trust200902
**Doc Name:** draft-ietf-idr-bgp-ls-segment-routing-ext-18
...
- [2. BGP-LS Extensions for Segment Routing](#section-2)
  - [2.1. Node Attribute TLVs](#NODE)
    - [2.1.1. SID/Label TLV](#SIDLABELTLV)
    - [2.1.2. SR Capabilities TLV](#SRCAPTLV)
    - [2.1.3. SR-Algorithm TLV](#SRALGOTLV)
    - [2.1.4. SR Local Block TLV](#SRLB)
    - [2.1.5. SRMS Preference TLV](#SRMSPREF)
  - [2.2. Link Attribute TLVs](#LINK)
    - [2.2.1. Adjacency SID TLV](#ADJSIDTLV)
    - [2.2.2. LAN Adjacency SID TLV](#LANADJSIDTLV)
    - [2.2.3. L2 Bundle Member Attributes TLV](#L2BUNDLETLV)
  - [2.3. Prefix Attribute TLVs](#PREFIX)
    - [2.3.1. Prefix-SID TLV](#PREFIXSIDTLV)
    - [2.3.2. Prefix Attribute Flags TLV](#PREFIXATTRFLAGTLV)
    - [2.3.3. Source Router Identifier TLV](#SOURCEIDTLV)
    - [2.3.4. Source OSPF Router-ID TLV](#SOURCEOSPFRIDTLV)
    - [2.3.5. Range TLV](#RANGETLV)
  - [2.4. Equivalent IS-IS Segment Routing TLVs/Sub-TLVs](#ISISTLV)
  - [2.5. Equivalent OSPFv2/OSPFv3 Segment Routing TLVs/Sub-TLVs](#OSPFTLV)
- [3. IANA Considerations](#IANA)
  - [3.1. TLV/Sub-TLV Code Points Summary](#TLVSUMMARY)
- [4. Manageability Considerations](#Manageability)
...
<a name="RFC5308"></a> **[RFC5308]** C. Hopps, "Routing IPv6 with IS-IS", RFC 5308, DOI 10.17487/RFC5308, October 2008. <https://www.rfc-editor.org/info/rfc5308> [Local MD](rfc5308.md)
...
<a name="RFC7794"></a> **[RFC7794]** L. Ginsberg, B. Decraene, S. Previdi, X. Xu, U. Chunduri, "IS-IS Prefix Attributes for Extended IPv4 and IPv6 Reachability", RFC 7794, DOI 10.17487/RFC7794, March 2016. <https://www.rfc-editor.org/info/rfc7794> [Local MD](rfc7794.md)
...
<a name="RFC8668"></a> **[RFC8668]** L. Ginsberg, A. Bashandy, C. Filsfils, M. Nanduri, E. Aries, "Advertising Layer 2 Bundle Member Link Attributes in IS-IS", RFC 8668, DOI 10.17487/RFC8668, December 2019. <https://www.rfc-editor.org/info/rfc8668> [Local MD](rfc8668.md)
...
<a name="RFC8661"></a> **[RFC8661]** A. Bashandy, C. Filsfils, S. Previdi, B. Decraene, S. Litkowski, "Segment Routing MPLS Interworking with LDP", RFC 8661, DOI 10.17487/RFC8661, December 2019. <https://www.rfc-editor.org/info/rfc8661> [Local MD](rfc8661.md)

<a name="RFC9020"></a> **[RFC9020]** S. Litkowski, Y. Qu, A. Lindem, P. Sarkar, J. Tantsura, "YANG Data Model for Segment Routing", RFC 9020, DOI 10.17487/RFC9020, May 2021. <https://www.rfc-editor.org/info/rfc9020> [Local MD](rfc9020.md)
