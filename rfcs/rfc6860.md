...
`   `[`2`](#section-2)`. Hiding IPv4 Transit-Only Networks in OSPFv2`

`      `[`2.1`](#section-2-1)`. Point-to-Point Networks`

`           `[`2.1.1`](#section-2-1-1)`. Advertising Point-to-Point Networks`

`           `[`2.1.2`](#section-2-1-2)`. Hiding Point-to-Point Networks`

`      `[`2.2`](#section-2-2)`. Broadcast Networks`

`           `[`2.2.1`](#section-2-2-1)`. Advertising Broadcast Networks`

`           `[`2.2.2`](#section-2-2-2)`. Hiding Broadcast Networks`

`                  `[`2.2.2.1`](#section-2-2-2-1)`. Sending Network-LSA`

`                  `[`2.2.2.2`](#section-2-2-2-2)`. Receiving Network-LSA`

`                           `[`2.2.2.2.1`](#section-2-2-2-2-1)`. Backward Compatibility`

`      `[`2.3`](#section-2-3)`. Non-Broadcast Networks`

`           `[`2.3.1`](#section-2-3-1)`. NBMA`

`           `[`2.3.2`](#section-2-3-2)`. Point-to-Multipoint`

`                  `[`2.3.2.1`](#section-2-3-2-1)`. Advertising Point-to-Multipoint Networks`

`                  `[`2.3.2.2`](#section-2-3-2-2)`. Hiding Point-to-Multipoint Networks`

`   `[`3`](#section-3)`. Hiding IPv6 Transit-Only Networks in OSPFv3`

`      `[`3.1`](#section-3-1)`. Hiding AF-Enabled Transit-Only Networks in OSPFv3`

`   `[`4`](#section-4)`. Operational Considerations`

`      `[`4.1`](#section-4-1)`. Forwarding Address`

`      `[`4.2`](#section-4-2)`. Virtual Links`

`      `[`4.3`](#section-4-3)`. Unnumbered Interfaces`
...
<a id="section-2"></a> **`2. Hiding IPv4 Transit-Only Networks in OSPFv2`**
...
<a id="section-2-1"></a> **`2.1. Point-to-Point Networks`**
...
<a id="section-2-1-1"></a> **`2.1.1. Advertising Point-to-Point Networks`**
...
<a id="section-2-1-2"></a> **`2.1.2. Hiding Point-to-Point Networks`**
...
<a id="section-2-2"></a> **`2.2. Broadcast Networks`**
...
<a id="section-2-2-1"></a> **`2.2.1. Advertising Broadcast Networks`**
...
<a id="section-2-2-2"></a> **`2.2.2. Hiding Broadcast Networks`**

```text

```

<a id="section-2-2-2-1"></a> **`2.2.2.1. Sending Network-LSA`**
...
<a id="section-2-2-2-2"></a> **`2.2.2.2. Receiving Network-LSA`**
...
<a id="section-2-2-2-2-1"></a> **`2.2.2.2.1. Backward Compatibility`**
...
<a id="section-2-3"></a> **`2.3. Non-Broadcast Networks`**
...
<a id="section-2-3-1"></a> **`2.3.1. NBMA`**
...
<a id="section-2-3-2"></a> **`2.3.2. Point-to-Multipoint`**
...
<a id="section-2-3-2-1"></a> **`2.3.2.1. Advertising Point-to-Multipoint Networks`**
...
<a id="section-2-3-2-2"></a> **`2.3.2.2. Hiding Point-to-Multipoint Networks`**
...
<a id="section-3"></a> **`3. Hiding IPv6 Transit-Only Networks in OSPFv3`**
...
<a id="section-3-1"></a> **`3.1. Hiding AF-Enabled Transit-Only Networks in OSPFv3`**
...
<a id="section-4-1"></a> **`4.1. Forwarding Address`**
...
<a id="section-4-2"></a> **`4.2. Virtual Links`**
...
<a id="section-4-3"></a> **`4.3. Unnumbered Interfaces`**
...
<a id="section-6"></a> **`6. Acknowledgments`**
