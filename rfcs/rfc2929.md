...
`   `[`2`](#section-2)`. 1 One Spare Bit?`

`   `[`2`](#section-2)`. 2 Opcode Assignment`

`   `[`2`](#section-2)`. 3 RCODE Assignment`

`   `[`3`](#section-3)`. DNS Resource Records`

`   `[`3`](#section-3)`. 1 RR TYPE IANA Considerations`

`   `[`3.1`](#section-3-1)`. 1 Special Note on the OPT RR`

`   `[`3`](#section-3)`. 2 RR CLASS IANA Considerations`

`   `[`3`](#section-3)`. 3 RR NAME Considerations`
