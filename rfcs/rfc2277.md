...
<a id="section-2"></a> **`2. Where to do internationalization`**
...
<a id="section-3-1"></a> **`3.1. What charset to use`**
...
<a id="section-3-2"></a> **`3.2. How to decide a charset`**
...
<a id="section-4"></a> **`4. Languages`**

```text

```

<a id="section-4-1"></a> **`4.1. The need for language information`**
...
<a id="section-4-2"></a> **`4.2. Requirement for language tagging`**
...
<a id="section-4-3"></a> **`4.3. How to identify a language`**
...
<a id="section-4-4"></a> **`4.4. Considerations for language negotiation`**
...
<a id="section-4-5"></a> **`4.5. Default Language`**
...
<a id="section-6"></a> **`6. Documenting internationalization decisions`**
...
<a id="section-9"></a> **`9. Author's Address`**
