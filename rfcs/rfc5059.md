...
`      `[`1.3`](#section-1-3)`. Administrative Scoping and BSR`

`   `[`2`](#section-2)`. BSR State and Timers`

`   `[`3`](#section-3)`. Bootstrap Router Election and RP-Set Distribution`

`      `[`3.1`](#section-3-1)`. Bootstrap Router Election`

`           `[`3.1.1`](#section-3-1-1)`. Per-Scope-Zone Candidate-BSR State Machine`

`           `[`3.1.2`](#section-3-1-2)`. Per-Scope-Zone State Machine for`

`                  Non-Candidate-BSR Routers`

`           `[`3.1.3`](#section-3-1-3)`. Bootstrap Message Processing Checks`

`           `[`3.1.4`](#section-3-1-4)`. State Machine Transition Events`

`           `[`3.1.5`](#section-3-1-5)`. State Machine Actions`

`      `[`3.2`](#section-3-2)`. Sending Candidate-RP-Advertisement Messages`

`      `[`3.3`](#section-3-3)`. Creating the RP-Set at the BSR`

`      `[`3.4`](#section-3-4)`. Forwarding Bootstrap Messages`

`      `[`3.5`](#section-3-5)`. Bootstrap Messages to New and Rebooting Routers`

`           `[`3.5.1`](#section-3-5-1)`. No-Forward Bootstrap Messages`

`           `[`3.5.2`](#section-3-5-2)`. Unicasting Bootstrap Messages`

`      `[`3.6`](#section-3-6)`. Receiving and Using the RP-Set`

`   `[`4`](#section-4)`. Message Formats`

`      `[`4.1`](#section-4-1)`. Bootstrap Message Format`

`           `[`4.1.1`](#section-4-1-1)`. Semantic Fragmentation of BSMs`

`      `[`4.2`](#section-4-2)`. Candidate-RP-Advertisement Message Format`

`   `[`5`](#section-5)`. Timers and Timer Values`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Possible Threats`

`      `[`6.2`](#section-6-2)`. Limiting Third-Party DoS Attacks`

`      `[`6.3`](#section-6-3)`. Bootstrap Message Security`

`           `[`6.3.1`](#section-6-3-1)`. Unicast Bootstrap Messages`

`           `[`6.3.2`](#section-6-3-2)`. Multi-Access Subnets`

`      `[`6.4`](#section-6-4)`. Candidate-RP-Advertisement Message Security`

`           `[`6.4.1`](#section-6-4-1)`. Non-Cryptographic Security of C-RP-Adv Messages`

`           `[`6.4.2`](#section-6-4-2)`. Cryptographic Security of C-RP-Adv Messages`

`      `[`6.5`](#section-6-5)`. Denial of Service using IPsec`
...
<a id="section-1-3"></a> **`1.3. Administrative Scoping and BSR`**
...
<a id="section-2"></a> **`2. BSR State and Timers`**
...
<a id="section-3"></a> **`3. Bootstrap Router Election and RP-Set Distribution`**

```text

```

<a id="section-3-1"></a> **`3.1. Bootstrap Router Election`**
...
<a id="section-3-1-1"></a> **`3.1.1. Per-Scope-Zone Candidate-BSR State Machine`**
...
<a id="section-3-1-2"></a> **`3.1.2. Per-Scope-Zone State Machine for Non-Candidate-BSR Routers`**
...
<a id="section-3-1-3"></a> **`3.1.3. Bootstrap Message Processing Checks`**
...
<a id="section-3-1-4"></a> **`3.1.4. State Machine Transition Events`**
...
<a id="section-3-1-5"></a> **`3.1.5. State Machine Actions`**
...
<a id="section-3-2"></a> **`3.2. Sending Candidate-RP-Advertisement Messages`**
...
<a id="section-3-3"></a> **`3.3. Creating the RP-Set at the BSR`**
...
<a id="section-3-4"></a> **`3.4. Forwarding Bootstrap Messages`**
...
<a id="section-3-5"></a> **`3.5. Bootstrap Messages to New and Rebooting Routers`**
...
<a id="section-3-5-1"></a> **`3.5.1. No-Forward Bootstrap Messages`**
...
<a id="section-3-5-2"></a> **`3.5.2. Unicasting Bootstrap Messages`**
...
<a id="section-3-6"></a> **`3.6. Receiving and Using the RP-Set`**
...
<a id="section-4-1"></a> **`4.1. Bootstrap Message Format`**
...
<a id="section-4-1-1"></a> **`4.1.1. Semantic Fragmentation of BSMs`**
...
<a id="section-4-2"></a> **`4.2. Candidate-RP-Advertisement Message Format`**
...
<a id="section-5"></a> **`5. Timers and Timer Values`**
...
<a id="section-6-1"></a> **`6.1. Possible Threats`**
...
<a id="section-6-2"></a> **`6.2. Limiting Third-Party DoS Attacks`**
...
<a id="section-6-3"></a> **`6.3. Bootstrap Message Security`**
...
<a id="section-6-3-1"></a> **`6.3.1. Unicast Bootstrap Messages`**
...
<a id="section-6-3-2"></a> **`6.3.2. Multi-Access Subnets`**
...
<a id="section-6-4"></a> **`6.4. Candidate-RP-Advertisement Message Security`**
...
<a id="section-6-4-1"></a> **`6.4.1. Non-Cryptographic Security of C-RP-Adv Messages`**
...
<a id="section-6-4-2"></a> **`6.4.2. Cryptographic Security of C-RP-Adv Messages`**
...
<a id="section-6-5"></a> **`6.5. Denial of Service using IPsec`**
