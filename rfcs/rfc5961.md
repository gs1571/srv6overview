...
`      `[`1.1`](#section-1-1)`. Applicability Statement`

`      `[`1.2`](#section-1-2)`. Basic Attack Methodology`

`      `[`1.3`](#section-1-3)`. Attack probabilities`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Blind Reset Attack Using the RST Bit`

`      `[`3.1`](#section-3-1)`. Description of the Attack`

`      `[`3.2`](#section-3-2)`. Mitigation`

`   `[`4`](#section-4)`. Blind Reset Attack Using the SYN Bit`

`      `[`4.1`](#section-4-1)`. Description of the Attack`

`      `[`4.2`](#section-4-2)`. Mitigation`

`   `[`5`](#section-5)`. Blind Data Injection Attack`

`      `[`5.1`](#section-5-1)`. Description of the Attack`

`      `[`5.2`](#section-5-2)`. Mitigation`

`   `[`6`](#section-6)`. Suggested Mitigation Strengths`

`   `[`7`](#section-7)`. ACK Throttling`

`   `[`8`](#section-8)`. Backward Compatibility and Other Considerations`

`   `[`9`](#section-9)`. Middlebox Considerations`

`      `[`9.1`](#section-9-1)`. Middlebox That Resend RSTs`

`      `[`9.2`](#section-9-2)`. Middleboxes That Advance Sequence Numbers`

`      `[`9.3`](#section-9-3)`. Middleboxes That Drop the Challenge ACK`
...
<a id="section-1-1"></a> **`1.1. Applicability Statement`**
...
<a id="section-1-2"></a> **`1.2. Basic Attack Methodology`**
...
<a id="section-1-3"></a> **`1.3. Attack probabilities`**
...
<a id="section-3"></a> **`3. Blind Reset Attack Using the RST Bit`**

```text

```

<a id="section-3-1"></a> **`3.1. Description of the Attack`**
...
<a id="section-3-2"></a> **`3.2. Mitigation`**
...
<a id="section-4"></a> **`4. Blind Reset Attack Using the SYN Bit`**

```text

```

<a id="section-4-1"></a> **`4.1. Description of the Attack`**
...
<a id="section-4-2"></a> **`4.2. Mitigation`**
...
<a id="section-5"></a> **`5. Blind Data Injection Attack`**

```text

```

<a id="section-5-1"></a> **`5.1. Description of the Attack`**
...
<a id="section-5-2"></a> **`5.2. Mitigation`**
...
<a id="section-6"></a> **`6. Suggested Mitigation Strengths`**
...
<a id="section-7"></a> **`7. ACK Throttling`**
...
<a id="section-8"></a> **`8. Backward Compatibility and Other Considerations`**
...
<a id="section-9"></a> **`9. Middlebox Considerations`**

```text

```

<a id="section-9-1"></a> **`9.1. Middlebox That Resend RSTs`**
...
<a id="section-9-2"></a> **`9.2. Middleboxes That Advance Sequence Numbers`**
...
<a id="section-9-3"></a> **`9.3. Middleboxes That Drop the Challenge ACK`**
