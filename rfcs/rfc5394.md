...
`      `[`2.1`](#section-2-1)`. Motivation`

`      `[`2.2`](#section-2-2)`. Policy Attributes`

`      `[`2.3`](#section-2-3)`. Representative Policy Scenarios`

`           `[`2.3.1`](#section-2-3-1)`. Scenario: Policy Configured Paths`

`           `[`2.3.2`](#section-2-3-2)`. Scenario: Provider Selection Policy`

`           `[`2.3.3`](#section-2-3-3)`. Scenario: Policy Based Constraints`

`           `[`2.3.4`](#section-2-3-4)`. Scenario: Advanced Load Balancing (ALB) Example`

`   `[`3`](#section-3)`. Requirements`

`   `[`4`](#section-4)`. Path Computation Policy Information Model (PCPIM)`

`   `[`5`](#section-5)`. Policy-Enabled Path Computation Framework Components`

`   `[`6`](#section-6)`. Policy Component Configurations`

`      `[`6.1`](#section-6-1)`. PCC-PCE Configurations`

`      `[`6.2`](#section-6-2)`. Policy Repositories`

`      `[`6.3`](#section-6-3)`. Cooperating PCE Configurations`

`      `[`6.4`](#section-6-4)`. Policy Configuration Management`

`   `[`7`](#section-7)`. Inter-Component Communication`

`      `[`7.1`](#section-7-1)`. Policy Communication`

`      `[`7.2`](#section-7-2)`. PCE Discovery Policy Considerations`

`   `[`8`](#section-8)`. Path Computation Sequence of Events`

`      `[`8.1`](#section-8-1)`. Policy-Enabled PCC, Policy-Enabled PCE`

`      `[`8.2`](#section-8-2)`. Policy-Ignorant PCC, Policy-Enabled PCE`

`   `[`9`](#section-9)`. Introduction of New Constraints`
...
<a id="section-2-1"></a> **`2.1. Motivation`**
...
<a id="section-2-2"></a> **`2.2. Policy Attributes`**
...
<a id="section-2-3"></a> **`2.3. Representative Policy Scenarios`**
...
<a id="section-2-3-1"></a> **`2.3.1. Scenario: Policy Configured Paths`**
...
<a id="section-2-3-2"></a> **`2.3.2. Scenario: Provider Selection Policy`**
...
<a id="section-2-3-3"></a> **`2.3.3. Scenario: Policy Based Constraints`**
...
<a id="section-2-3-4"></a> **`2.3.4. Scenario: Advanced Load Balancing (ALB) Example`**
...
<a id="section-4"></a> **`4. Path Computation Policy Information Model (PCPIM)`**
...
<a id="section-5"></a> **`5. Policy-Enabled Path Computation Framework Components`**
...
<a id="section-6"></a> **`6. Policy Component Configurations`**

```text

```

<a id="section-6-1"></a> **`6.1. PCC-PCE Configurations`**
...
<a id="section-6-2"></a> **`6.2. Policy Repositories`**
...
<a id="section-6-3"></a> **`6.3. Cooperating PCE Configurations`**
...
<a id="section-6-4"></a> **`6.4. Policy Configuration Management`**
...
<a id="section-7"></a> **`7. Inter-Component Communication`**

```text

```

<a id="section-7-1"></a> **`7.1. Policy Communication`**
...
<a id="section-7-2"></a> **`7.2. PCE Discovery Policy Considerations`**
...
<a id="section-8"></a> **`8. Path Computation Sequence of Events`**
...
<a id="section-8-1"></a> **`8.1. Policy-Enabled PCC, Policy-Enabled PCE`**
...
<a id="section-8-2"></a> **`8.2. Policy-Ignorant PCC, Policy-Enabled PCE`**
...
<a id="section-9"></a> **`9. Introduction of New Constraints`**
