...
`   `[`3`](#section-3)`. Requirements and Applicability`

`     `[`3.1`](#section-3-1)`. Requirements`

`     `[`3.2`](#section-3-2)`. Applicability`

`       `[`3.2.1`](#section-3-2-1)`. DNS Resource Records`

`       `[`3.2.2`](#section-3-2-2)`. Non-Domain-Name Data Types Stored in the DNS`

`   `[`4`](#section-4)`. Registration Protocol`

`     `[`4.1`](#section-4-1)`. Input to IDNA Registration`

`     `[`4.2`](#section-4-2)`. Permitted Character and Label Validation`

`       `[`4.2.1`](#section-4-2-1)`. Input Format`

`       `[`4.2.2`](#section-4-2-2)`. Rejection of Characters That Are Not Permitted`

`       `[`4.2.3`](#section-4-2-3)`. Label Validation`

`       `[`4.2.4`](#section-4-2-4)`. Registration Validation Requirements`

`     `[`4.3`](#section-4-3)`. Registry Restrictions`

`     `[`4.4`](#section-4-4)`. Punycode Conversion`

`     `[`4.5`](#section-4-5)`. Insertion in the Zone`

`   `[`5`](#section-5)`. Domain Name Lookup Protocol`

`     `[`5.1`](#section-5-1)`. Label String Input`

`     `[`5.2`](#section-5-2)`. Conversion to Unicode`

`     `[`5.3`](#section-5-3)`. A-label Input`

`     `[`5.4`](#section-5-4)`. Validation and Character List Testing`

`     `[`5.5`](#section-5-5)`. Punycode Conversion`

`     `[`5.6`](#section-5-6)`. DNS Name Resolution`
...
<a id="section-3"></a> **`3. Requirements and Applicability`**
...
<a id="section-3-2-1"></a> **`3.2.1. DNS Resource Records`**
...
<a id="section-3-2-2"></a> **`3.2.2. Non-Domain-Name Data Types Stored in the DNS`**
...
<a id="section-4-1"></a> **`4.1. Input to IDNA Registration`**
...
<a id="section-4-2"></a> **`4.2. Permitted Character and Label Validation`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Input Format`**
...
<a id="section-4-2-2"></a> **`4.2.2. Rejection of Characters That Are Not Permitted`**
...
<a id="section-4-2-3"></a> **`4.2.3. Label Validation`**
...
<a id="section-4-2-3-1"></a> **`4.2.3.1. Hyphen Restrictions`**
...
<a id="section-4-2-3-2"></a> **`4.2.3.2. Leading Combining Marks`**
...
<a id="section-4-2-3-3"></a> **`4.2.3.3. Contextual Rules`**
...
<a id="section-4-2-3-4"></a> **`4.2.3.4. Labels Containing Characters Written Right to Left`**
...
<a id="section-4-2-4"></a> **`4.2.4. Registration Validation Requirements`**
...
<a id="section-4-3"></a> **`4.3. Registry Restrictions`**
...
<a id="section-4-4"></a> **`4.4. Punycode Conversion`**
...
<a id="section-4-5"></a> **`4.5. Insertion in the Zone`**
...
<a id="section-5"></a> **`5. Domain Name Lookup Protocol`**
...
<a id="section-5-1"></a> **`5.1. Label String Input`**
...
<a id="section-5-2"></a> **`5.2. Conversion to Unicode`**
...
<a id="section-5-3"></a> **`5.3. A-label Input`**
...
<a id="section-5-4"></a> **`5.4. Validation and Character List Testing`**
...
<a id="section-5-5"></a> **`5.5. Punycode Conversion`**
...
<a id="section-5-6"></a> **`5.6. DNS Name Resolution`**
