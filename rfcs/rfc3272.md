...
`      `[`1`](#section-1)`. 1 What is Internet Traffic Engineering?`
...
`      `[`2`](#section-2)`. 1 Context of Internet Traffic Engineering`

`      `[`2`](#section-2)`. 2 Network Context`

`      `[`2`](#section-2)`. 3 Problem Context`

`         `[`2.3`](#section-2-3)`. 1 Congestion and its Ramifications`

`      `[`2`](#section-2)`. 4 Solution Context`

`         `[`2.4`](#section-2-4)`. 1 Combating the Congestion Problem`

`      `[`2`](#section-2)`. 5 Implementation and Operational Context`

`   `[`3`](#section-3)`. 0 Traffic Engineering Process Model`

`      `[`3`](#section-3)`. 1 Components of the Traffic Engineering Process Model`

`      `[`3`](#section-3)`. 2 Measurement`

`      `[`3`](#section-3)`. 3 Modeling, Analysis, and Simulation`

`      `[`3`](#section-3)`. 4 Optimization`

`   `[`4`](#section-4)`. 0 Historical Review and Recent Developments`

`      `[`4`](#section-4)`. 1 Traffic Engineering in Classical Telephone Networks`

`      `[`4`](#section-4)`. 2 Evolution of Traffic Engineering in the Internet`

`         `[`4.2`](#section-4-2)`. 1 Adaptive Routing in ARPANET`

`         `[`4.2`](#section-4-2)`. 2 Dynamic Routing in the Internet`

`         `[`4.2`](#section-4-2)`. 3 ToS Routing`

`         `[`4.2`](#section-4-2)`. 4 Equal Cost Multi-Path`

`         `[`4.2`](#section-4-2)`. 5 Nimrod`

`      `[`4`](#section-4)`. 3 Overlay Model`

`      `[`4`](#section-4)`. 4 Constraint-Based Routing`

`      `[`4`](#section-4)`. 5 Overview of Other IETF Projects Related to Traffic`

`          Engineering`

`         `[`4.5`](#section-4-5)`. 1 Integrated Services`

`         `[`4.5`](#section-4-5)`. 2 RSVP`

`         `[`4.5`](#section-4-5)`. 3 Differentiated Services`

`         `[`4.5`](#section-4-5)`. 4 MPLS`

`         `[`4.5`](#section-4-5)`. 5 IP Performance Metrics`

`         `[`4.5`](#section-4-5)`. 6 Flow Measurement`

`         `[`4.5`](#section-4-5)`. 7 Endpoint Congestion Management`

`      `[`4`](#section-4)`. 6 Overview of ITU Activities Related to Traffic`

`          Engineering`

`      `[`4`](#section-4)`. 7 Content Distribution`

`   `[`5`](#section-5)`. 0 Taxonomy of Traffic Engineering Systems`

`      `[`5`](#section-5)`. 1 Time-Dependent Versus State-Dependent`

`      `[`5`](#section-5)`. 2 Offline Versus Online`

`      `[`5`](#section-5)`. 3 Centralized Versus Distributed`

`      `[`5`](#section-5)`. 4 Local Versus Global`

`      `[`5`](#section-5)`. 5 Prescriptive Versus Descriptive`

`      `[`5`](#section-5)`. 6 Open-Loop Versus Closed-Loop`

`      `[`5`](#section-5)`. 7 Tactical vs Strategic`

`   `[`6`](#section-6)`. 0 Recommendations for Internet Traffic Engineering`

`      `[`6`](#section-6)`. 1 Generic Non-functional Recommendations`

`      `[`6`](#section-6)`. 2 Routing Recommendations`

`      `[`6`](#section-6)`. 3 Traffic Mapping Recommendations`

`      `[`6`](#section-6)`. 4 Measurement Recommendations`

`      `[`6`](#section-6)`. 5 Network Survivability`

`         `[`6.5`](#section-6-5)`. 1 Survivability in MPLS Based Networks`

`         `[`6.5`](#section-6-5)`. 2 Protection Option`

`      `[`6`](#section-6)`. 6 Traffic Engineering in Diffserv Environments`

`      `[`6`](#section-6)`. 7 Network Controllability`

`   `[`7`](#section-7)`. 0 Inter-Domain Considerations`

`   `[`8`](#section-8)`. 0 Overview of Contemporary TE Practices in Operational`

`       IP Networks`

`   `[`9`](#section-9)`. 0 Conclusion`

`   `[`10`](#section-10)`. 0 Security Considerations`

`   `[`11`](#section-11)`. 0 Acknowledgments`

`   `[`12`](#section-12)`. 0 References`

`   `[`13`](#section-13)`. 0 Authors' Addresses`

`   `[`14`](#section-14)`. 0 Full Copyright Statement`
...
<a id="section-1-1"></a> **`1.1. What is Internet Traffic Engineering?`**
