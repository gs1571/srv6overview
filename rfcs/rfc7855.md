...
`   `[`2`](#section-2)`. Data Planes`

`   `[`3`](#section-3)`. SPRING Use Cases`

`     `[`3.1`](#section-3-1)`. IGP-Based MPLS Tunneling`

`       `[`3.1.1`](#section-3-1-1)`. Example of IGP-Based MPLS Tunnels`

`     `[`3.2`](#section-3-2)`. Fast Reroute (FRR)`

`     `[`3.3`](#section-3-3)`. Traffic Engineering`

`       `[`3.3.1`](#section-3-3-1)`. Examples of Traffic-Engineering Use Cases`

`     `[`3.4`](#section-3-4)`. Interoperability with Non-SPRING Nodes`
...
<a id="section-2"></a> **`2. Data Planes`**
...
<a id="section-3"></a> **`3. SPRING Use Cases`**

```text

```

<a id="section-3-1"></a> **`3.1. IGP-Based MPLS Tunneling`**
...
<a id="section-3-1-1"></a> **`3.1.1. Example of IGP-Based MPLS Tunnels`**
...
<a id="section-3-2"></a> **`3.2. Fast Reroute (FRR)`**
...
<a id="section-3-3"></a> **`3.3. Traffic Engineering`**
...
<a id="section-3-3-1"></a> **`3.3.1. Examples of Traffic-Engineering Use Cases`**
...
<a id="section-3-3-1-1"></a> **`3.3.1.1. Traffic Engineering without Bandwidth Admission Control`**
...
<a id="section-3-3-1-1-1"></a> **`3.3.1.1.1. Disjointness in Dual-Plane Networks`**
...
<a id="section-3-3-1-1-2"></a> **`3.3.1.1.2. Egress Peering Traffic Engineering`**
...
<a id="section-3-3-1-1-3"></a> **`3.3.1.1.3. Load Balancing among Non-parallel Links`**
...
<a id="section-3-3-1-2"></a> **`3.3.1.2. Traffic Engineering with Bandwidth Admission Control`**
...
<a id="section-3-3-1-2-1"></a> **`3.3.1.2.1. Capacity-Planning Process`**
...
<a id="section-3-3-1-2-2"></a> **`3.3.1.2.2. SDN Use Case`**
...
<a id="section-3-4"></a> **`3.4. Interoperability with Non-SPRING Nodes`**
