...
`   `[`2.10`](#section-2-10)`. Stub area support`

`   `[`2.11`](#section-2-11)`. Identifying neighbors by Router ID`

`   `[`3`](#section-3)`. Implementation details`

`   `[`3.1`](#section-3-1)`. Protocol data structures`

`   `[`3.1.1`](#section-3-1-1)`. The Area Data structure`

`   `[`3.1.2`](#section-3-1-2)`. The Interface Data structure`

`   `[`3.1.3`](#section-3-1-3)`. The Neighbor Data Structure`

`   `[`3.2`](#section-3-2)`. Protocol Packet Processing`

`   `[`3.2.1`](#section-3-2-1)`. Sending protocol packets`

`   `[`3.2.1.1`](#section-3-2-1-1)`. Sending Hello packets`

`   `[`3.2.1.2`](#section-3-2-1-2)`. Sending Database Description Packets`

`   `[`3.2.2`](#section-3-2-2)`. Receiving protocol packets`

`   `[`3.2.2.1`](#section-3-2-2-1)`. Receiving Hello Packets`

`   `[`3.3`](#section-3-3)`. The Routing table Structure`

`   `[`3.3.1`](#section-3-3-1)`. Routing table lookup`

`   `[`3.4`](#section-3-4)`. Link State Advertisements`

`   `[`3.4.1`](#section-3-4-1)`. The LSA Header`

`   `[`3.4.2`](#section-3-4-2)`. The link-state database`

`   `[`3.4.3`](#section-3-4-3)`. Originating LSAs`

`   `[`3.4.3.1`](#section-3-4-3-1)`. Router-LSAs`

`   `[`3.4.3.2`](#section-3-4-3-2)`. Network-LSAs`

`   `[`3.4.3.3`](#section-3-4-3-3)`. Inter-Area-Prefix-LSAs`

`   `[`3.4.3.4`](#section-3-4-3-4)`. Inter-Area-Router-LSAs`

`   `[`3.4.3.5`](#section-3-4-3-5)`. AS-external-LSAs`

`   `[`3.4.3.6`](#section-3-4-3-6)`. Link-LSAs`

`   `[`3.4.3.7`](#section-3-4-3-7)`. Intra-Area-Prefix-LSAs`

`   `[`3.5`](#section-3-5)`. Flooding`

`   `[`3.5.1`](#section-3-5-1)`. Receiving Link State Update packets`

`   `[`3.5.2`](#section-3-5-2)`. Sending Link State Update packets`

`   `[`3.5.3`](#section-3-5-3)`. Installing LSAs in the database`

`   `[`3.6`](#section-3-6)`. Definition of self-originated LSAs`

`   `[`3.7`](#section-3-7)`. Virtual links`

`   `[`3.8`](#section-3-8)`. Routing table calculation`

`   `[`3.8.1`](#section-3-8-1)`. Calculating the shortest path tree for an area`

`   `[`3.8.1.1`](#section-3-8-1-1)`. The next hop calculation`

`   `[`3.8.2`](#section-3-8-2)`. Calculating the inter-area routes`

`   `[`3.8.3`](#section-3-8-3)`. Examining transit areas' summary-LSAs`

`   `[`3.8.4`](#section-3-8-4)`. Calculating AS external routes`

`   `[`3.9`](#section-3-9)`. Multiple interfaces to a single link`
...
<a id="section-2-10"></a> **`2.10. Stub area support`**
...
<a id="section-3"></a> **`3. Implementation details`**
...
<a id="section-3-1"></a> **`3.1. Protocol data structures`**
...
<a id="section-3-1-1"></a> **`3.1.1. The Area Data structure`**
...
<a id="section-3-1-2"></a> **`3.1.2. The Interface Data structure`**
...
<a id="section-3-1-3"></a> **`3.1.3. The Neighbor Data Structure`**
...
<a id="section-3-2"></a> **`3.2. Protocol Packet Processing`**
...
<a id="section-3-2-1"></a> **`3.2.1. Sending protocol packets`**
...
<a id="section-3-2-1-1"></a> **`3.2.1.1. Sending Hello packets`**
...
<a id="section-3-2-1-2"></a> **`3.2.1.2. Sending Database Description Packets`**
...
<a id="section-3-2-2"></a> **`3.2.2. Receiving protocol packets`**
...
<a id="section-3-2-2-1"></a> **`3.2.2.1. Receiving Hello Packets`**
...
<a id="section-3-3"></a> **`3.3. The Routing table Structure`**
...
<a id="section-3-3-1"></a> **`3.3.1. Routing table lookup`**
...
<a id="section-3-4"></a> **`3.4. Link State Advertisements`**
...
<a id="section-3-4-1"></a> **`3.4.1. The LSA Header`**
...
<a id="section-3-4-2"></a> **`3.4.2. The link-state database`**
...
<a id="section-3-4-3"></a> **`3.4.3. Originating LSAs`**
...
<a id="section-3-4-3-1"></a> **`3.4.3.1. Router-LSAs`**
...
<a id="section-3-4-3-2"></a> **`3.4.3.2. Network-LSAs`**
...
<a id="section-3-4-3-3"></a> **`3.4.3.3. Inter-Area-Prefix-LSAs`**
...
<a id="section-3-4-3-4"></a> **`3.4.3.4. Inter-Area-Router-LSAs`**
...
<a id="section-3-4-3-5"></a> **`3.4.3.5. AS-external-LSAs`**
...
<a id="section-3-4-3-6"></a> **`3.4.3.6. Link-LSAs`**
...
<a id="section-3-4-3-7"></a> **`3.4.3.7. Intra-Area-Prefix-LSAs`**
...
<a id="section-3-5"></a> **`3.5. Flooding`**
...
<a id="section-3-5-1"></a> **`3.5.1. Receiving Link State Update packets`**
...
<a id="section-3-5-2"></a> **`3.5.2. Sending Link State Update packets`**
...
<a id="section-3-5-3"></a> **`3.5.3. Installing LSAs in the database`**
...
<a id="section-3-6"></a> **`3.6. Definition of self-originated LSAs`**
...
<a id="section-3-7"></a> **`3.7. Virtual links`**
...
<a id="section-3-8"></a> **`3.8. Routing table calculation`**
...
<a id="section-3-8-1"></a> **`3.8.1. Calculating the shortest path tree for an area`**
...
<a id="section-3-8-1-1"></a> **`3.8.1.1. The next hop calculation`**
...
<a id="section-3-8-2"></a> **`3.8.2. Calculating the inter-area routes`**
...
<a id="section-3-8-3"></a> **`3.8.3. Examining transit areas' summary-LSAs`**
...
<a id="section-3-8-4"></a> **`3.8.4. Calculating AS external routes`**
...
<a id="section-3-9"></a> **`3.9. Multiple interfaces to a single link`**
