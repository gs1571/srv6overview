...
`   `[`3`](#section-3)`. Rights in IETF Contributions`

`       `[`3.1`](#section-3-1)`. General Policy`

`       `[`3.2`](#section-3-2)`. Confidentiality Obligations`

`       `[`3.3`](#section-3-3)`. Granting of Rights and Permissions`

`       `[`3.4`](#section-3-4)`. Representations and Warranties`

`       `[`3.5`](#section-3-5)`. No Duty to Publish`

`       `[`3.6`](#section-3-6)`. Trademarks`

`   `[`4`](#section-4)`. Rights in RFC Editor Contributions`

`       `[`4.1`](#section-4-1)`. Requirements from Section 3`

`       `[`4.2`](#section-4-2)`. Granting of Rights and Permissions`

`   `[`5`](#section-5)`. Notices Required in IETF Documents`

`       `[`5.1`](#section-5-1)`. IPR Disclosure Acknowledgement`

`       `[`5.2`](#section-5-2)`. Derivative Works Limitation`

`       `[`5.3`](#section-5-3)`. Publication Limitation`

`       `[`5.4`](#section-5-4)`. Copyright Notice`

`       `[`5.5`](#section-5-5)`. Disclaimer`

`       `[`5.6`](#section-5-6)`. Exceptions`

`   `[`6`](#section-6)`. Notices and Rights Required in RFC Editor Contributions`

`   `[`7`](#section-7)`. Exposition of why these procedures are the way they are`

`       `[`7.1`](#section-7-1)`. Rights Granted in IETF Contributions`

`       `[`7.2`](#section-7-2)`. Rights to use Contributed Material`

`       `[`7.3`](#section-7-3)`. Right to Produce Derivative Works`

`       `[`7.4`](#section-7-4)`. Rights to use Trademarks`

`       `[`7.5`](#section-7-5)`. Who Does This Apply To?`

`   `[`8`](#section-8)`. Contributions Not Subject to Copyright`
...
<a id="section-3"></a> **`3. Rights in IETF Contributions`**
...
<a id="section-3-2"></a> **`3.2. Confidentiality Obligations`**
...
<a id="section-3-3"></a> **`3.3. Granting of Rights and Permissions`**
...
<a id="section-3-4"></a> **`3.4. Representations and Warranties`**
...
<a id="section-3-5"></a> **`3.5. No Duty to Publish`**
...
<a id="section-3-6"></a> **`3.6. Trademarks`**
...
<a id="section-4"></a> **`4. Rights in RFC Editor Contributions`**
...
<a id="section-4-1"></a> **`4.1. Requirements from Section 3`**
...
<a id="section-4-2"></a> **`4.2. Granting of Rights and Permissions`**
...
<a id="section-5"></a> **`5. Notices Required in IETF Documents`**
...
<a id="section-5-1"></a> **`5.1. IPR Disclosure Acknowledgement (required in all Internet-Drafts`**
...
<a id="section-5-2"></a> **`5.2. Derivative Works Limitation`**
...
<a id="section-5-3"></a> **`5.3. Publication Limitation`**
...
<a id="section-5-4"></a> **`5.4. Copyright Notice (required for all IETF Documents)`**
...
<a id="section-5-5"></a> **`5.5. Disclaimer (required in all IETF Documents)`**
...
<a id="section-5-6"></a> **`5.6. Exceptions`**
...
<a id="section-6"></a> **`6. Notices and Rights Required in RFC Editor Contributions`**
...
<a id="section-7"></a> **`7. Exposition of Why These Procedures Are the Way They Are`**

```text

```

<a id="section-7-1"></a> **`7.1. Rights Granted in IETF Contributions`**
...
<a id="section-7-2"></a> **`7.2. Rights to use Contributed Material`**
...
<a id="section-7-3"></a> **`7.3. Right to Produce Derivative Works`**
...
<a id="section-7-4"></a> **`7.4. Rights to Use Trademarks`**
...
<a id="section-7-5"></a> **`7.5. Who Does This Apply To?`**
...
<a id="section-8"></a> **`8. Contributions Not Subject to Copyright`**
