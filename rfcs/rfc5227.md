...
`      `[`1.1`](#section-1-1)`. Conventions and Terminology Used in This Document`

`      `[`1.2`](#section-1-2)`. Relationship to RFC 826`

`           `[`1.2.1`](#section-1-2-1)`. Broadcast ARP Replies`

`      `[`1.3`](#section-1-3)`. Applicability`

`   `[`2`](#section-2)`. Address Probing, Announcing, Conflict Detection, and Defense`

`      `[`2.1`](#section-2-1)`. Probing an Address`

`           `[`2.1.1`](#section-2-1-1)`. Probe Details`

`      `[`2.2`](#section-2-2)`. Shorter Timeouts on Appropriate Network Technologies`

`      `[`2.3`](#section-2-3)`. Announcing an Address`

`      `[`2.4`](#section-2-4)`. Ongoing Address Conflict Detection and Address Defense`

`      `[`2.5`](#section-2-5)`. Continuing Operation`

`      `[`2.6`](#section-2-6)`. Broadcast ARP Replies`

`   `[`3`](#section-3)`. Why Are ARP Announcements Performed Using ARP Request`

`      Packets and Not ARP Reply Packets?`

`   `[`4`](#section-4)`. Historical Note`
...
<a id="section-1-1"></a> **`1.1. Conventions and Terminology Used in This Document`**
...
<a id="section-1-2"></a> **`1.2. Relationship to RFC 826`**
...
<a id="section-1-2-1"></a> **`1.2.1. Broadcast ARP Replies`**
...
<a id="section-2"></a> **`2. Address Probing, Announcing, Conflict Detection, and Defense`**
...
<a id="section-2-1"></a> **`2.1. Probing an Address`**
...
<a id="section-2-1-1"></a> **`2.1.1. Probe Details`**
...
<a id="section-2-2"></a> **`2.2. Shorter Timeouts on Appropriate Network Technologies`**
...
<a id="section-2-3"></a> **`2.3. Announcing an Address`**
...
<a id="section-2-4"></a> **`2.4. Ongoing Address Conflict Detection and Address Defense`**
...
<a id="section-2-5"></a> **`2.5. Continuing Operation`**
...
<a id="section-2-6"></a> **`2.6. Broadcast ARP Replies`**
...
<a id="section-3"></a> **`3. Why Are ARP Announcements Performed Using ARP Request Packets and`**
...
<a id="section-4"></a> **`4. Historical Note`**
