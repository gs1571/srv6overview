...
`   `[`2.1`](#section-2-1)`. The Dispatcher`

`   `[`2.2`](#section-2-2)`. Message Processing Subsystem`

`   `[`3`](#section-3)`. Elements of Message Processing and Dispatching`

`   `[`3.1`](#section-3-1)`. messageProcessingModel`

`   `[`3.2`](#section-3-2)`. pduVersion`

`   `[`3.3`](#section-3-3)`. pduType`

`   `[`3.4`](#section-3-4)`. sendPduHandle`

`   `[`4`](#section-4)`. Dispatcher Elements of Procedure`

`   `[`4.1`](#section-4-1)`. Sending an SNMP Message to the Network`

`   `[`4.1.1`](#section-4-1-1)`. Sending a Request or Notification`

`   `[`4.1.2`](#section-4-1-2)`. Sending a Response to the Network`

`   `[`4.2`](#section-4-2)`. Receiving an SNMP Message from the Network`

`   `[`4.2.1`](#section-4-2-1)`. Message Dispatching of received SNMP Messages`

`   `[`4.2.2`](#section-4-2-2)`. PDU Dispatching for Incoming Messages`

`   `[`4.2.2.1`](#section-4-2-2-1)`. Incoming Requests and Notifications`

`   `[`4.2.2.2`](#section-4-2-2-2)`. Incoming Responses`

`   `[`4.3`](#section-4-3)`. Application Registration for Handling PDU types`

`   `[`4.4`](#section-4-4)`. Application Unregistration for Handling PDU Types`

`   `[`5`](#section-5)`. Definitions`

`   `[`5.1`](#section-5-1)`. Definitions for SNMP Message Processing and Dispatching`

`   `[`6`](#section-6)`. The SNMPv3 Message Format`

`   `[`6.1`](#section-6-1)`. msgVersion`

`   `[`6.2`](#section-6-2)`. msgID`

`   `[`6.3`](#section-6-3)`. msgMaxSize`

`   `[`6.4`](#section-6-4)`. msgFlags`

`   `[`6.5`](#section-6-5)`. msgSecurityModel`

`   `[`6.6`](#section-6-6)`. msgSecurityParameters`

`   `[`6.7`](#section-6-7)`. scopedPduData`

`   `[`6.8`](#section-6-8)`. scopedPDU`

`   `[`6.8.1`](#section-6-8-1)`. contextEngineID`

`   `[`6.8.2`](#section-6-8-2)`. contextName`

`   `[`6.8.3`](#section-6-8-3)`. data`

`   `[`7`](#section-7)`. Elements of Procedure for v3MP`

`   `[`7.1`](#section-7-1)`. Prepare an Outgoing SNMP Message`

`   `[`7.2`](#section-7-2)`. Prepare Data Elements from an Incoming SNMP Message`
...
`   `[`12`](#section-12)`. Editors' Addresses`
...
<a id="section-2-1"></a> **`2.1. The Dispatcher`**
...
<a id="section-2-2"></a> **`2.2. Message Processing Subsystem`**
...
<a id="section-3"></a> **`3. Elements of Message Processing and Dispatching`**
...
<a id="section-3-1"></a> **`3.1. messageProcessingModel`**
...
<a id="section-3-2"></a> **`3.2. pduVersion`**
...
<a id="section-3-3"></a> **`3.3. pduType`**
...
<a id="section-3-4"></a> **`3.4. sendPduHandle`**
...
<a id="section-4"></a> **`4. Dispatcher Elements of Procedure`**
...
<a id="section-4-1"></a> **`4.1. Sending an SNMP Message to the Network`**
...
<a id="section-4-1-1"></a> **`4.1.1. Sending a Request or Notification`**
...
<a id="section-4-1-2"></a> **`4.1.2. Sending a Response to the Network`**
...
<a id="section-4-2"></a> **`4.2. Receiving an SNMP Message from the Network`**
...
<a id="section-4-2-1"></a> **`4.2.1. Message Dispatching of received SNMP Messages`**
...
<a id="section-4-2-2"></a> **`4.2.2. PDU Dispatching for Incoming Messages`**
...
<a id="section-4-2-2-1"></a> **`4.2.2.1. Incoming Requests and Notifications`**
...
<a id="section-4-2-2-2"></a> **`4.2.2.2. Incoming Responses`**
...
<a id="section-4-3"></a> **`4.3. Application Registration for Handling PDU types`**
...
<a id="section-4-4"></a> **`4.4. Application Unregistration for Handling PDU Types`**
...
<a id="section-5-1"></a> **`5.1. Definitions for SNMP Message Processing and Dispatching`**
...
<a id="section-6"></a> **`6. The SNMPv3 Message Format`**
...
<a id="section-6-1"></a> **`6.1. msgVersion`**
...
<a id="section-6-3"></a> **`6.3. msgMaxSize`**
...
<a id="section-6-4"></a> **`6.4. msgFlags`**
...
<a id="section-6-5"></a> **`6.5. msgSecurityModel`**
...
<a id="section-6-6"></a> **`6.6. msgSecurityParameters`**
...
<a id="section-6-7"></a> **`6.7. scopedPduData`**
...
<a id="section-6-8"></a> **`6.8. scopedPDU`**
...
<a id="section-6-8-1"></a> **`6.8.1. contextEngineID`**
...
<a id="section-6-8-2"></a> **`6.8.2. contextName`**
...
<a id="section-6-8-3"></a> **`6.8.3. data`**
...
<a id="section-7"></a> **`7. Elements of Procedure for v3MP`**
...
<a id="section-7-1"></a> **`7.1. Prepare an Outgoing SNMP Message`**
...
<a id="section-7-2"></a> **`7.2. Prepare Data Elements from an Incoming SNMP Message`**
...
<a id="section-12"></a> **`12. Editors' Addresses`**
...
<a id="section-13"></a> **`13. Full Copyright Statement`**
