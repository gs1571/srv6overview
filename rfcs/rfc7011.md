...
`      `[`1.1`](#section-1-1)`. Changes since RFC 5101`

`      `[`1.2`](#section-1-2)`. IPFIX Documents Overview`

`   `[`2`](#section-2)`. Terminology`

`      `[`2.1`](#section-2-1)`. Terminology Summary Table`

`   `[`3`](#section-3)`. IPFIX Message Format`

`      `[`3.1`](#section-3-1)`. Message Header Format`

`      `[`3.2`](#section-3-2)`. Field Specifier Format`

`      `[`3.3`](#section-3-3)`. Set and Set Header Format`

`           `[`3.3.1`](#section-3-3-1)`. Set Format`

`           `[`3.3.2`](#section-3-3-2)`. Set Header Format`

`      `[`3.4`](#section-3-4)`. Record Format`

`           `[`3.4.1`](#section-3-4-1)`. Template Record Format`

`           `[`3.4.2`](#section-3-4-2)`. Options Template Record Format`

`                  `[`3.4.2.1`](#section-3-4-2-1)`. Scope`

`                  `[`3.4.2.2`](#section-3-4-2-2)`. Options Template Record Format`

`           `[`3.4.3`](#section-3-4-3)`. Data Record Format`

`   `[`4`](#section-4)`. Specific Reporting Requirements`

`      `[`4.1`](#section-4-1)`. The Metering Process Statistics Options Template`

`      `[`4.2`](#section-4-2)`. The Metering Process Reliability Statistics`

`           Options Template`

`      `[`4.3`](#section-4-3)`. The Exporting Process Reliability Statistics`

`           Options Template`

`      `[`4.4`](#section-4-4)`. The Flow Keys Options Template`

`   `[`5`](#section-5)`. Timing Considerations`

`      `[`5.1`](#section-5-1)`. IPFIX Message Header Export Time and Flow Record Time`

`      `[`5.2`](#section-5-2)`. Supporting Timestamp Wraparound`

`   `[`6`](#section-6)`. Linkage with the Information Model`

`      `[`6.1`](#section-6-1)`. Encoding of IPFIX Data Types`

`           `[`6.1.1`](#section-6-1-1)`. Integral Data Types`

`           `[`6.1.2`](#section-6-1-2)`. Address Types`

`           `[`6.1.3`](#section-6-1-3)`. float32`

`           `[`6.1.4`](#section-6-1-4)`. float64`

`           `[`6.1.5`](#section-6-1-5)`. boolean`

`           `[`6.1.6`](#section-6-1-6)`. string and octetArray`

`           `[`6.1.7`](#section-6-1-7)`. dateTimeSeconds`

`           `[`6.1.8`](#section-6-1-8)`. dateTimeMilliseconds`

`           `[`6.1.9`](#section-6-1-9)`. dateTimeMicroseconds`

`           `[`6.1.10`](#section-6-1-10)`. dateTimeNanoseconds`

`      `[`6.2`](#section-6-2)`. Reduced-Size Encoding`

`   `[`7`](#section-7)`. Variable-Length Information Element`

`   `[`8`](#section-8)`. Template Management`

`      `[`8.1`](#section-8-1)`. Template Withdrawal and Redefinition`

`      `[`8.2`](#section-8-2)`. Sequencing Template Management Actions`

`      `[`8.3`](#section-8-3)`. Additional Considerations for Template Management`

`           over SCTP`

`      `[`8.4`](#section-8-4)`. Additional Considerations for Template Management`

`           over UDP`

`   `[`9`](#section-9)`. The Collecting Process's Side`

`      `[`9.1`](#section-9-1)`. Collecting Process Handling of Malformed IPFIX Messages`

`      `[`9.2`](#section-9-2)`. Additional Considerations for SCTP Collecting Processes`

`      `[`9.3`](#section-9-3)`. Additional Considerations for UDP Collecting Processes`

`   `[`10`](#section-10)`. Transport Protocol`

`      `[`10.1`](#section-10-1)`. Transport Compliance and Transport Usage`

`      `[`10.2`](#section-10-2)`. SCTP`

`           `[`10.2.1`](#section-10-2-1)`. Congestion Avoidance`

`           `[`10.2.2`](#section-10-2-2)`. Reliability`

`           `[`10.2.3`](#section-10-2-3)`. MTU`

`           `[`10.2.4`](#section-10-2-4)`. Association Establishment and Shutdown`

`           `[`10.2.5`](#section-10-2-5)`. Failover`

`           `[`10.2.6`](#section-10-2-6)`. Streams`

`      `[`10.3`](#section-10-3)`. UDP`

`           `[`10.3.1`](#section-10-3-1)`. Congestion Avoidance`

`           `[`10.3.2`](#section-10-3-2)`. Reliability`

`           `[`10.3.3`](#section-10-3-3)`. MTU`

`           `[`10.3.4`](#section-10-3-4)`. Session Establishment and Shutdown`

`           `[`10.3.5`](#section-10-3-5)`. Failover and Session Duplication`

`      `[`10.4`](#section-10-4)`. TCP`

`           `[`10.4.1`](#section-10-4-1)`. Congestion Avoidance`

`           `[`10.4.2`](#section-10-4-2)`. Reliability`

`           `[`10.4.3`](#section-10-4-3)`. MTU`

`           `[`10.4.4`](#section-10-4-4)`. Connection Establishment and Shutdown`

`           `[`10.4.5`](#section-10-4-5)`. Failover`

`   `[`11`](#section-11)`. Security Considerations`

`      `[`11.1`](#section-11-1)`. Applicability of TLS and DTLS`

`      `[`11.2`](#section-11-2)`. Usage`

`      `[`11.3`](#section-11-3)`. Mutual Authentication`

`      `[`11.4`](#section-11-4)`. Protection against DoS Attacks`

`      `[`11.5`](#section-11-5)`. When DTLS or TLS Is Not an Option`

`      `[`11.6`](#section-11-6)`. Logging an IPFIX Attack`

`      `[`11.7`](#section-11-7)`. Securing the Collector`

`      `[`11.8`](#section-11-8)`. Privacy Considerations for Collected Data`

`   `[`12`](#section-12)`. Management Considerations`
...
<a id="section-1-1"></a> **`1.1. Changes since RFC 5101`**
...
<a id="section-1-2"></a> **`1.2. IPFIX Documents Overview`**
...
<a id="section-2-1"></a> **`2.1. Terminology Summary Table`**
...
<a id="section-3"></a> **`3. IPFIX Message Format`**
...
<a id="section-3-1"></a> **`3.1. Message Header Format`**
...
<a id="section-3-2"></a> **`3.2. Field Specifier Format`**
...
<a id="section-3-3"></a> **`3.3. Set and Set Header Format`**
...
<a id="section-3-3-1"></a> **`3.3.1. Set Format`**
...
<a id="section-3-3-2"></a> **`3.3.2. Set Header Format`**
...
<a id="section-3-4"></a> **`3.4. Record Format`**
...
<a id="section-3-4-1"></a> **`3.4.1. Template Record Format`**
...
<a id="section-3-4-2"></a> **`3.4.2. Options Template Record Format`**
...
<a id="section-3-4-2-1"></a> **`3.4.2.1. Scope`**
...
<a id="section-3-4-2-2"></a> **`3.4.2.2. Options Template Record Format`**
...
<a id="section-3-4-3"></a> **`3.4.3. Data Record Format`**
...
<a id="section-4"></a> **`4. Specific Reporting Requirements`**
...
<a id="section-4-1"></a> **`4.1. The Metering Process Statistics Options Template`**
...
<a id="section-4-2"></a> **`4.2. The Metering Process Reliability Statistics Options Template`**
...
<a id="section-4-3"></a> **`4.3. The Exporting Process Reliability Statistics Options Template`**
...
<a id="section-4-4"></a> **`4.4. The Flow Keys Options Template`**
...
<a id="section-5"></a> **`5. Timing Considerations`**

```text

```

<a id="section-5-1"></a> **`5.1. IPFIX Message Header Export Time and Flow Record Time`**
...
<a id="section-5-2"></a> **`5.2. Supporting Timestamp Wraparound`**
...
<a id="section-6"></a> **`6. Linkage with the Information Model`**
...
<a id="section-6-1"></a> **`6.1. Encoding of IPFIX Data Types`**
...
<a id="section-6-1-1"></a> **`6.1.1. Integral Data Types`**
...
<a id="section-6-1-2"></a> **`6.1.2. Address Types`**
...
<a id="section-6-1-3"></a> **`6.1.3. float32`**
...
<a id="section-6-1-4"></a> **`6.1.4. float64`**
...
<a id="section-6-1-5"></a> **`6.1.5. boolean`**
...
<a id="section-6-1-6"></a> **`6.1.6. string and octetArray`**
...
<a id="section-6-1-7"></a> **`6.1.7. dateTimeSeconds`**
...
<a id="section-6-1-8"></a> **`6.1.8. dateTimeMilliseconds`**
...
<a id="section-6-1-9"></a> **`6.1.9. dateTimeMicroseconds`**
...
<a id="section-6-1-10"></a> **`6.1.10. dateTimeNanoseconds`**
...
<a id="section-6-2"></a> **`6.2. Reduced-Size Encoding`**
...
<a id="section-7"></a> **`7. Variable-Length Information Element`**
...
<a id="section-8"></a> **`8. Template Management`**
...
<a id="section-8-1"></a> **`8.1. Template Withdrawal and Redefinition`**
...
<a id="section-8-2"></a> **`8.2. Sequencing Template Management Actions`**
...
<a id="section-8-3"></a> **`8.3. Additional Considerations for Template Management over SCTP`**
...
<a id="section-8-4"></a> **`8.4. Additional Considerations for Template Management over UDP`**
...
<a id="section-9"></a> **`9. The Collecting Process's Side`**
...
<a id="section-9-1"></a> **`9.1. Collecting Process Handling of Malformed IPFIX Messages`**
...
<a id="section-9-2"></a> **`9.2. Additional Considerations for SCTP Collecting Processes`**
...
<a id="section-9-3"></a> **`9.3. Additional Considerations for UDP Collecting Processes`**
...
<a id="section-10"></a> **`10. Transport Protocol`**
...
<a id="section-10-1"></a> **`10.1. Transport Compliance and Transport Usage`**
...
<a id="section-10-2-1"></a> **`10.2.1. Congestion Avoidance`**
...
<a id="section-10-2-2"></a> **`10.2.2. Reliability`**
...
<a id="section-10-2-3"></a> **`10.2.3. MTU`**
...
<a id="section-10-2-4"></a> **`10.2.4. Association Establishment and Shutdown`**
...
<a id="section-10-2-5"></a> **`10.2.5. Failover`**
...
<a id="section-10-2-6"></a> **`10.2.6. Streams`**
...
<a id="section-10-3-1"></a> **`10.3.1. Congestion Avoidance`**
...
<a id="section-10-3-2"></a> **`10.3.2. Reliability`**
...
<a id="section-10-3-3"></a> **`10.3.3. MTU`**
...
<a id="section-10-3-4"></a> **`10.3.4. Session Establishment and Shutdown`**
...
<a id="section-10-3-5"></a> **`10.3.5. Failover and Session Duplication`**
...
<a id="section-10-4-1"></a> **`10.4.1. Congestion Avoidance`**
...
<a id="section-10-4-2"></a> **`10.4.2. Reliability`**
...
<a id="section-10-4-3"></a> **`10.4.3. MTU`**
...
<a id="section-10-4-4"></a> **`10.4.4. Connection Establishment and Shutdown`**
...
<a id="section-10-4-5"></a> **`10.4.5. Failover`**
...
<a id="section-11-1"></a> **`11.1. Applicability of TLS and DTLS`**
...
<a id="section-11-2"></a> **`11.2. Usage`**
...
<a id="section-11-3"></a> **`11.3. Mutual Authentication`**
...
<a id="section-11-4"></a> **`11.4. Protection against DoS Attacks`**
...
<a id="section-11-5"></a> **`11.5. When DTLS or TLS Is Not an Option`**
...
<a id="section-11-6"></a> **`11.6. Logging an IPFIX Attack`**
...
<a id="section-11-7"></a> **`11.7. Securing the Collector`**
...
<a id="section-11-8"></a> **`11.8. Privacy Considerations for Collected Data`**
...
<a id="section-12"></a> **`12. Management Considerations`**
...
<a id="section-13"></a> **`13. IANA Considerations`**
