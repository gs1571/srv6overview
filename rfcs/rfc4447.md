...
`   `[`3`](#section-3)`. The Pseudowire Label`

`   `[`4`](#section-4)`. Details Specific to Particular Emulated Services`

`      `[`4.1`](#section-4-1)`. IP Layer 2 Transport`

`   `[`5`](#section-5)`. LDP`

`      `[`5.1`](#section-5-1)`. LDP Extensions`

`      `[`5.2`](#section-5-2)`. The PWid FEC Element`

`      `[`5.3`](#section-5-3)`. The Generalized PWid FEC Element`

`           `[`5.3.1`](#section-5-3-1)`. Attachment Identifiers`

`           `[`5.3.2`](#section-5-3-2)`. Encoding the Generalized ID FEC Element`

`                  `[`5.3.2.1`](#section-5-3-2-1)`. Interface Parameters TLV`

`                  `[`5.3.2.2`](#section-5-3-2-2)`. PW Grouping TLV`

`           `[`5.3.3`](#section-5-3-3)`. Signaling Procedures`

`      `[`5.4`](#section-5-4)`. Signaling of Pseudowire Status`

`           `[`5.4.1`](#section-5-4-1)`. Use of Label Mappings Messages`

`           `[`5.4.2`](#section-5-4-2)`. Signaling PW Status`

`           `[`5.4.3`](#section-5-4-3)`. Pseudowire Status Negotiation Procedures`

`      `[`5.5`](#section-5-5)`. Interface Parameters Sub-TLV`

`   `[`6`](#section-6)`. Control Word`

`      `[`6.1`](#section-6-1)`. PW Types for Which the Control Word is REQUIRED`

`      `[`6.2`](#section-6-2)`. PW Types for Which the Control Word is NOT Mandatory`

`      `[`6.3`](#section-6-3)`. LDP Label Withdrawal Procedures`

`      `[`6.4`](#section-6-4)`. Sequencing Considerations`

`           `[`6.4.1`](#section-6-4-1)`. Label Advertisements`

`           `[`6.4.2`](#section-6-4-2)`. Label Release`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. LDP TLV TYPE`

`      `[`7.2`](#section-7-2)`. LDP Status Codes`

`      `[`7.3`](#section-7-3)`. FEC Type Name Space`

`   `[`8`](#section-8)`. Security Considerations`

`      `[`8.1`](#section-8-1)`. Data-Plane Security`

`      `[`8.2`](#section-8-2)`. Control-Plane Security`
...
`   `[`12`](#section-12)`. Additional Contributing Authors`
...
<a id="section-3"></a> **`3. The Pseudowire Label`**
...
<a id="section-4"></a> **`4. Details Specific to Particular Emulated Services`**

```text

```

<a id="section-4-1"></a> **`4.1. IP Layer 2 Transport`**
...
<a id="section-5-1"></a> **`5.1. LDP Extensions`**
...
<a id="section-5-2"></a> **`5.2. The PWid FEC Element`**
...
<a id="section-5-3"></a> **`5.3. The Generalized PWid FEC Element`**
...
<a id="section-5-3-1"></a> **`5.3.1. Attachment Identifiers`**
...
<a id="section-5-3-2"></a> **`5.3.2. Encoding the Generalized ID FEC Element`**
...
<a id="section-5-3-2-1"></a> **`5.3.2.1. Interface Parameters TLV`**
...
<a id="section-5-3-2-2"></a> **`5.3.2.2. PW Grouping TLV`**
...
<a id="section-5-3-3"></a> **`5.3.3. Signaling Procedures`**
...
<a id="section-5-4"></a> **`5.4. Signaling of Pseudowire Status`**

```text

```

<a id="section-5-4-1"></a> **`5.4.1. Use of Label Mappings Messages`**
...
<a id="section-5-4-2"></a> **`5.4.2. Signaling PW Status`**
...
<a id="section-5-4-3"></a> **`5.4.3. Pseudowire Status Negotiation Procedures`**
...
<a id="section-5-5"></a> **`5.5. Interface Parameters Sub-TLV`**
...
<a id="section-6"></a> **`6. Control Word`**

```text

```

<a id="section-6-1"></a> **`6.1. PW Types for Which the Control Word is REQUIRED`**
...
<a id="section-6-2"></a> **`6.2. PW Types for Which the Control Word is NOT Mandatory`**
...
<a id="section-6-3"></a> **`6.3. LDP Label Withdrawal Procedures`**
...
<a id="section-6-4"></a> **`6.4. Sequencing Considerations`**
...
<a id="section-6-4-1"></a> **`6.4.1. Label Advertisements`**
...
<a id="section-6-4-2"></a> **`6.4.2. Label Release`**
...
<a id="section-7-1"></a> **`7.1. LDP TLV TYPE`**
...
<a id="section-7-2"></a> **`7.2. LDP Status Codes`**
...
<a id="section-7-3"></a> **`7.3. FEC Type Name Space`**
...
<a id="section-8-1"></a> **`8.1. Data-Plane Security`**
...
<a id="section-8-2"></a> **`8.2. Control-Plane Security`**
...
<a id="section-10"></a> **`10. Normative References`**
...
<a id="section-12"></a> **`12. Additional Contributing Authors`**
