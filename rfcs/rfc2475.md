...
`     `[`1.4`](#section-1-4)`. Comparisons with Other Approaches`

`   `[`2`](#section-2)`. Differentiated Services Architectural Model`

`     `[`2.1`](#section-2-1)`. Differentiated Services Domain`

`       `[`2.1.1`](#section-2-1-1)`. DS Boundary Nodes and Interior Nodes`

`       `[`2.1.2`](#section-2-1-2)`. DS Ingress Node and Egress Node`

`     `[`2.2`](#section-2-2)`. Differentiated Services Region`

`     `[`2.3`](#section-2-3)`. Traffic Classification and Conditioning`

`       `[`2.3.1`](#section-2-3-1)`. Classifiers`

`       `[`2.3.2`](#section-2-3-2)`. Traffic Profiles`

`       `[`2.3.3`](#section-2-3-3)`. Traffic Conditioners`

`         `[`2.3.3.1`](#section-2-3-3-1)`. Meters`

`         `[`2.3.3.2`](#section-2-3-3-2)`. Markers`

`         `[`2.3.3.3`](#section-2-3-3-3)`. Shapers`

`         `[`2.3.3.4`](#section-2-3-3-4)`. Droppers`

`       `[`2.3.4`](#section-2-3-4)`. Location of Traffic Conditioners and MF Classifiers`

`         `[`2.3.4.1`](#section-2-3-4-1)`. Within the Source Domain`

`         `[`2.3.4.2`](#section-2-3-4-2)`. At the Boundary of a DS Domain`

`         `[`2.3.4.3`](#section-2-3-4-3)`. In non-DS-Capable Domains`

`         `[`2.3.4.4`](#section-2-3-4-4)`. In Interior DS Nodes`

`     `[`2.4`](#section-2-4)`. Per-Hop Behaviors`

`     `[`2.5`](#section-2-5)`. Network Resource Allocation`

`   `[`3`](#section-3)`. Per-Hop Behavior Specification Guidelines`

`   `[`4`](#section-4)`. Interoperability with Non-Differentiated Services-Compliant`

`       Nodes`

`   `[`5`](#section-5)`. Multicast Considerations`

`   `[`6`](#section-6)`. Security and Tunneling Considerations`

`     `[`6.1`](#section-6-1)`. Theft and Denial of Service`

`     `[`6.2`](#section-6-2)`. IPsec and Tunneling Interactions`

`     `[`6.3`](#section-6-3)`. Auditing`
...
<a id="section-2"></a> **`2. Differentiated Services Architectural Model`**
...
<a id="section-3"></a> **`3. Per-Hop Behavior Specification Guidelines`**
...
<a id="section-4"></a> **`4. Interoperability with Non-Differentiated Services-Compliant Nodes`**
...
<a id="section-5"></a> **`5. Multicast Considerations`**
...
<a id="section-6"></a> **`6. Security and Tunneling Considerations`**
