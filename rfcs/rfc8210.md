...
`     `[`1.2`](#section-1-2)`. Changes from RFC 6810`

`   `[`2`](#section-2)`. Glossary`

`   `[`3`](#section-3)`. Deployment Structure`

`   `[`4`](#section-4)`. Operational Overview`

`   `[`5`](#section-5)`. Protocol Data Units (PDUs)`

`     `[`5.1`](#section-5-1)`. Fields of a PDU`

`     `[`5.2`](#section-5-2)`. Serial Notify`

`     `[`5.3`](#section-5-3)`. Serial Query`

`     `[`5.4`](#section-5-4)`. Reset Query`

`     `[`5.5`](#section-5-5)`. Cache Response`

`     `[`5.6`](#section-5-6)`. IPv4 Prefix`

`     `[`5.7`](#section-5-7)`. IPv6 Prefix`

`     `[`5.8`](#section-5-8)`. End of Data`

`     `[`5.9`](#section-5-9)`. Cache Reset`

`     `[`5.10`](#section-5-10)`. Router Key`

`     `[`5.11`](#section-5-11)`. Error Report`

`   `[`6`](#section-6)`. Protocol Timing Parameters`

`   `[`7`](#section-7)`. Protocol Version Negotiation`

`   `[`8`](#section-8)`. Protocol Sequences`

`     `[`8.1`](#section-8-1)`. Start or Restart`

`     `[`8.2`](#section-8-2)`. Typical Exchange`

`     `[`8.3`](#section-8-3)`. No Incremental Update Available`

`     `[`8.4`](#section-8-4)`. Cache Has No Data Available`

`   `[`9`](#section-9)`. Transport`

`     `[`9.1`](#section-9-1)`. SSH Transport`

`     `[`9.2`](#section-9-2)`. TLS Transport`

`     `[`9.3`](#section-9-3)`. TCP MD5 Transport`

`     `[`9.4`](#section-9-4)`. TCP-AO Transport`

`   `[`10`](#section-10)`. Router-Cache Setup`

`   `[`11`](#section-11)`. Deployment Scenarios`

`   `[`12`](#section-12)`. Error Codes`
...
<a id="section-1-2"></a> **`1.2. Changes from RFC 6810`**
...
<a id="section-3"></a> **`3. Deployment Structure`**
...
<a id="section-4"></a> **`4. Operational Overview`**
...
<a id="section-5"></a> **`5. Protocol Data Units (PDUs)`**
...
<a id="section-5-1"></a> **`5.1. Fields of a PDU`**
...
<a id="section-5-2"></a> **`5.2. Serial Notify`**
...
<a id="section-5-3"></a> **`5.3. Serial Query`**
...
<a id="section-5-4"></a> **`5.4. Reset Query`**
...
<a id="section-5-5"></a> **`5.5. Cache Response`**
...
<a id="section-5-6"></a> **`5.6. IPv4 Prefix`**
...
<a id="section-5-7"></a> **`5.7. IPv6 Prefix`**
...
<a id="section-5-8"></a> **`5.8. End of Data`**
...
<a id="section-5-9"></a> **`5.9. Cache Reset`**
...
<a id="section-5-10"></a> **`5.10. Router Key`**
...
<a id="section-5-11"></a> **`5.11. Error Report`**
...
<a id="section-6"></a> **`6. Protocol Timing Parameters`**
...
<a id="section-7"></a> **`7. Protocol Version Negotiation`**
...
<a id="section-8"></a> **`8. Protocol Sequences`**
...
<a id="section-8-1"></a> **`8.1. Start or Restart`**
...
<a id="section-8-2"></a> **`8.2. Typical Exchange`**
...
<a id="section-8-3"></a> **`8.3. No Incremental Update Available`**
...
<a id="section-8-4"></a> **`8.4. Cache Has No Data Available`**
...
<a id="section-9-1"></a> **`9.1. SSH Transport`**
...
<a id="section-9-2"></a> **`9.2. TLS Transport`**
...
<a id="section-9-3"></a> **`9.3. TCP MD5 Transport`**
...
<a id="section-9-4"></a> **`9.4. TCP-AO Transport`**
...
<a id="section-10"></a> **`10. Router-Cache Setup`**
...
<a id="section-11"></a> **`11. Deployment Scenarios`**
...
<a id="section-12"></a> **`12. Error Codes`**
