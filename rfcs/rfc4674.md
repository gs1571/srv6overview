...
`   `[`2`](#section-2)`. Problem Statement and Requirements Overview`

`      `[`2.1`](#section-2-1)`. Problem Statement`

`      `[`2.2`](#section-2-2)`. Requirements Overview`

`   `[`3`](#section-3)`. Example of Application Scenario`

`   `[`4`](#section-4)`. Detailed Requirements`

`      `[`4.1`](#section-4-1)`. PCE Information to Be Disclosed`

`           `[`4.1.1`](#section-4-1-1)`. General PCE Information (Mandatory Support)`

`                  `[`4.1.1.1`](#section-4-1-1-1)`. Discovery of PCE Location`

`                  `[`4.1.1.2`](#section-4-1-1-2)`. Discovery of PCE Domains and`

`                           Inter-domain Functions`

`           `[`4.1.2`](#section-4-1-2)`. Detailed PCE Information (Optional Support)`

`                  `[`4.1.2.1`](#section-4-1-2-1)`. Discovery of PCE Capabilities`

`                  `[`4.1.2.2`](#section-4-1-2-2)`. Discovery of Alternate PCEs`

`      `[`4.2`](#section-4-2)`. Scope of PCE Discovery`

`           `[`4.2.1`](#section-4-2-1)`. Inter-AS Specific Requirements`

`      `[`4.3`](#section-4-3)`. PCE Information Synchronization`

`      `[`4.4`](#section-4-4)`. Discovery of PCE Deactivation`

`      `[`4.5`](#section-4-5)`. Policy Support`

`      `[`4.6`](#section-4-6)`. Security Requirements`

`      `[`4.7`](#section-4-7)`. Extensibility`

`      `[`4.8`](#section-4-8)`. Scalability`

`      `[`4.9`](#section-4-9)`. Operational Orders of Magnitudes`

`      `[`4.10`](#section-4-10)`. Manageability Considerations`

`           `[`4.10.1`](#section-4-10-1)`. Configuration of PCE Discovery Parameters`

`           `[`4.10.2`](#section-4-10-2)`. PCE Discovery MIB Modules`

`                  `[`4.10.2.1`](#section-4-10-2-1)`. PCC MIB Module`

`                  `[`4.10.2.2`](#section-4-10-2-2)`. PCE MIB module`

`           `[`4.10.3`](#section-4-10-3)`. Monitoring Protocol Operations`

`           `[`4.10.4`](#section-4-10-4)`. Impact on Network Operations`
...
<a id="section-2"></a> **`2. Problem Statement and Requirements Overview`**

```text

```

<a id="section-2-1"></a> **`2.1. Problem Statement`**
...
<a id="section-2-2"></a> **`2.2. Requirements Overview`**
...
<a id="section-3"></a> **`3. Example of Application Scenario`**
...
<a id="section-4"></a> **`4. Detailed Requirements`**

```text

```

<a id="section-4-1"></a> **`4.1. PCE Information to Be Disclosed`**
...
<a id="section-4-1-1"></a> **`4.1.1. General PCE Information (Mandatory Support)`**

```text

```

<a id="section-4-1-1-1"></a> **`4.1.1.1. Discovery of PCE Location`**
...
<a id="section-4-1-1-2"></a> **`4.1.1.2. Discovery of PCE Domains and Inter-domain Functions`**
...
<a id="section-4-1-2"></a> **`4.1.2. Detailed PCE Information (Optional Support)`**

```text

```

<a id="section-4-1-2-1"></a> **`4.1.2.1. Discovery of PCE Capabilities`**
...
<a id="section-4-1-2-2"></a> **`4.1.2.2. Discovery of Alternate PCEs`**
...
<a id="section-4-2"></a> **`4.2. Scope of PCE Discovery`**
...
<a id="section-4-2-1"></a> **`4.2.1. Inter-AS Specific Requirements`**
...
<a id="section-4-3"></a> **`4.3. PCE Information Synchronization`**
...
<a id="section-4-4"></a> **`4.4. Discovery of PCE Deactivation`**
...
<a id="section-4-5"></a> **`4.5. Policy Support`**
...
<a id="section-4-7"></a> **`4.7. Extensibility`**
...
<a id="section-4-8"></a> **`4.8. Scalability`**
...
<a id="section-4-9"></a> **`4.9. Operational Orders of Magnitudes`**
...
<a id="section-4-10"></a> **`4.10. Manageability Considerations`**
...
<a id="section-4-10-1"></a> **`4.10.1. Configuration of PCE Discovery Parameters`**
...
<a id="section-4-10-2"></a> **`4.10.2. PCE Discovery MIB Modules`**
...
<a id="section-4-10-2-1"></a> **`4.10.2.1. PCC MIB Module`**
...
<a id="section-4-10-2-2"></a> **`4.10.2.2. PCE MIB module`**
...
<a id="section-4-10-3"></a> **`4.10.3. Monitoring Protocol Operations`**
...
<a id="section-4-10-4"></a> **`4.10.4. Impact on Network Operations`**
