...
`      `[`1.1`](#section-1-1)`. Applicability`

`      `[`1.2`](#section-1-2)`. Requirements Language`

`      `[`1.3`](#section-1-3)`. Definition of Terms`

`      `[`1.4`](#section-1-4)`. Problem Space`

`      `[`1.5`](#section-1-5)`. NSH-Based Service Chaining`

`   `[`2`](#section-2)`. Network Service Header`

`      `[`2.1`](#section-2-1)`. Network Service Header Format`

`      `[`2.2`](#section-2-2)`. NSH Base Header`

`      `[`2.3`](#section-2-3)`. Service Path Header`

`      `[`2.4`](#section-2-4)`. NSH MD Type 1`

`      `[`2.5`](#section-2-5)`. NSH MD Type 2`

`           `[`2.5.1`](#section-2-5-1)`. Optional Variable-Length Metadata`

`   `[`3`](#section-3)`. NSH Actions`

`   `[`4`](#section-4)`. NSH Transport Encapsulation`

`   `[`5`](#section-5)`. Fragmentation Considerations`

`   `[`6`](#section-6)`. Service Path Forwarding with NSH`

`      `[`6.1`](#section-6-1)`. SFFs and Overlay Selection`

`      `[`6.2`](#section-6-2)`. Mapping the NSH to Network Topology`

`      `[`6.3`](#section-6-3)`. Service Plane Visibility`

`      `[`6.4`](#section-6-4)`. Service Graphs`

`   `[`7`](#section-7)`. Policy Enforcement with NSH`

`      `[`7.1`](#section-7-1)`. NSH Metadata and Policy Enforcement`

`      `[`7.2`](#section-7-2)`. Updating/Augmenting Metadata`

`      `[`7.3`](#section-7-3)`. Service Path Identifier and Metadata`

`   `[`8`](#section-8)`. Security Considerations`

`      `[`8.1`](#section-8-1)`. NSH Security Considerations from Operators' Environments`

`      `[`8.2`](#section-8-2)`. NSH Security Considerations from the SFC Architecture`

`           `[`8.2.1`](#section-8-2-1)`. Integrity`

`           `[`8.2.2`](#section-8-2-2)`. Confidentiality`

`   `[`9`](#section-9)`. IANA Considerations`

`      `[`9.1`](#section-9-1)`. NSH Parameters`

`           `[`9.1.1`](#section-9-1-1)`. NSH Base Header Bits`

`           `[`9.1.2`](#section-9-1-2)`. NSH Version`

`           `[`9.1.3`](#section-9-1-3)`. NSH MD Types`

`           `[`9.1.4`](#section-9-1-4)`. NSH MD Class`

`           `[`9.1.5`](#section-9-1-5)`. NSH IETF-Assigned Optional Variable-Length`

`                  Metadata Types`

`           `[`9.1.6`](#section-9-1-6)`. NSH Next Protocol`

`   `[`10`](#section-10)`. NSH-Related Codepoints`

`      `[`10.1`](#section-10-1)`. NSH Ethertype`
...
<a id="section-1-1"></a> **`1.1. Applicability`**
...
<a id="section-1-3"></a> **`1.3. Definition of Terms`**
...
<a id="section-1-4"></a> **`1.4. Problem Space`**
...
<a id="section-1-5"></a> **`1.5. NSH-Based Service Chaining`**
...
<a id="section-2"></a> **`2. Network Service Header`**
...
<a id="section-2-1"></a> **`2.1. Network Service Header Format`**
...
<a id="section-2-2"></a> **`2.2. NSH Base Header`**
...
<a id="section-2-3"></a> **`2.3. Service Path Header`**
...
<a id="section-2-4"></a> **`2.4. NSH MD Type 1`**
...
<a id="section-2-5"></a> **`2.5. NSH MD Type 2`**
...
<a id="section-2-5-1"></a> **`2.5.1. Optional Variable-Length Metadata`**
...
<a id="section-3"></a> **`3. NSH Actions`**
...
<a id="section-5"></a> **`5. Fragmentation Considerations`**
...
<a id="section-6"></a> **`6. Service Path Forwarding with NSH`**

```text

```

<a id="section-6-1"></a> **`6.1. SFFs and Overlay Selection`**
...
<a id="section-6-2"></a> **`6.2. Mapping the NSH to Network Topology`**
...
<a id="section-6-3"></a> **`6.3. Service Plane Visibility`**
...
<a id="section-6-4"></a> **`6.4. Service Graphs`**
...
<a id="section-7"></a> **`7. Policy Enforcement with NSH`**

```text

```

<a id="section-7-1"></a> **`7.1. NSH Metadata and Policy Enforcement`**
...
<a id="section-7-2"></a> **`7.2. Updating/Augmenting Metadata`**
...
<a id="section-7-3"></a> **`7.3. Service Path Identifier and Metadata`**
...
<a id="section-8-1"></a> **`8.1. NSH Security Considerations from Operators' Environments`**
...
<a id="section-8-2"></a> **`8.2. NSH Security Considerations from the SFC Architecture`**
...
<a id="section-8-2-1"></a> **`8.2.1. Integrity`**
...
<a id="section-8-2-2"></a> **`8.2.2. Confidentiality`**
...
<a id="section-9-1"></a> **`9.1. NSH Parameters`**
...
<a id="section-9-1-1"></a> **`9.1.1. NSH Base Header Bits`**
...
<a id="section-9-1-2"></a> **`9.1.2. NSH Version`**
...
<a id="section-9-1-3"></a> **`9.1.3. NSH MD Types`**
...
<a id="section-9-1-4"></a> **`9.1.4. NSH MD Class`**
...
<a id="section-9-1-5"></a> **`9.1.5. NSH IETF-Assigned Optional Variable-Length Metadata Types`**
...
<a id="section-9-1-6"></a> **`9.1.6. NSH Next Protocol`**
...
<a id="section-10"></a> **`10. NSH-Related Codepoints`**

```text

```

<a id="section-10-1"></a> **`10.1. NSH Ethertype`**
