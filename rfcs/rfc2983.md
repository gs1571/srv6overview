...
<a id="section-1"></a> **`1. Conventions used in this document`**
...
<a id="section-2"></a> **`2. Diffserv and Tunnels Overview`**
...
<a id="section-3"></a> **`3. Conceptual Models for Diffserv Tunnels`**
...
<a id="section-4"></a> **`4. Ingress Functionality`**
...
<a id="section-5"></a> **`5. Egress Functionality`**
...
<a id="section-6"></a> **`6. Diffserv and Protocol Translators`**
...
<a id="section-10"></a> **`10. Author's Address`**
