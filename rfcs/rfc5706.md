...
`      `[`1.1`](#section-1-1)`. Designing for Operations and Management`

`      `[`1.2`](#section-1-2)`. This Document`

`      `[`1.3`](#section-1-3)`. Motivation`

`      `[`1.4`](#section-1-4)`. Background`

`      `[`1.5`](#section-1-5)`. Available Management Technologies`

`      `[`1.6`](#section-1-6)`. Terminology`

`   `[`2`](#section-2)`. Operational Considerations - How Will the New Protocol`

`      Fit into the Current Environment?`

`      `[`2.1`](#section-2-1)`. Operations`

`      `[`2.2`](#section-2-2)`. Installation and Initial Setup`

`      `[`2.3`](#section-2-3)`. Migration Path`

`      `[`2.4`](#section-2-4)`. Requirements on Other Protocols and Functional`

`           Components`

`      `[`2.5`](#section-2-5)`. Impact on Network Operation`

`      `[`2.6`](#section-2-6)`. Verifying Correct Operation`

`   `[`3`](#section-3)`. Management Considerations - How Will the Protocol Be Managed?`

`      `[`3.1`](#section-3-1)`. Interoperability`

`      `[`3.2`](#section-3-2)`. Management Information`

`           `[`3.2.1`](#section-3-2-1)`. Information Model Design`

`      `[`3.3`](#section-3-3)`. Fault Management`

`           `[`3.3.1`](#section-3-3-1)`. Liveness Detection and Monitoring`

`           `[`3.3.2`](#section-3-3-2)`. Fault Determination`

`           `[`3.3.3`](#section-3-3-3)`. Root Cause Analysis`

`           `[`3.3.4`](#section-3-3-4)`. Fault Isolation`

`      `[`3.4`](#section-3-4)`. Configuration Management`

`           `[`3.4.1`](#section-3-4-1)`. Verifying Correct Operation`

`      `[`3.5`](#section-3-5)`. Accounting Management`

`      `[`3.6`](#section-3-6)`. Performance Management`

`           `[`3.6.1`](#section-3-6-1)`. Monitoring the Protocol`

`           `[`3.6.2`](#section-3-6-2)`. Monitoring the Device`

`           `[`3.6.3`](#section-3-6-3)`. Monitoring the Network`

`           `[`3.6.4`](#section-3-6-4)`. Monitoring the Service`

`      `[`3.7`](#section-3-7)`. Security Management`

`   `[`4`](#section-4)`. Documentation Guidelines`

`      `[`4.1`](#section-4-1)`. Recommended Discussions`

`      `[`4.2`](#section-4-2)`. Null Manageability Considerations Sections`

`      `[`4.3`](#section-4-3)`. Placement of Operations and Manageability`
...
<a id="section-1-1"></a> **`1.1. Designing for Operations and Management`**
...
<a id="section-1-2"></a> **`1.2. This Document`**
...
<a id="section-1-3"></a> **`1.3. Motivation`**
...
<a id="section-1-4"></a> **`1.4. Background`**
...
<a id="section-1-5"></a> **`1.5. Available Management Technologies`**
...
<a id="section-1-6"></a> **`1.6. Terminology`**
...
<a id="section-2"></a> **`2. Operational Considerations - How Will the New Protocol Fit into the`**
...
<a id="section-2-1"></a> **`2.1. Operations`**
...
<a id="section-2-2"></a> **`2.2. Installation and Initial Setup`**
...
<a id="section-2-3"></a> **`2.3. Migration Path`**
...
<a id="section-2-4"></a> **`2.4. Requirements on Other Protocols and Functional Components`**
...
<a id="section-2-5"></a> **`2.5. Impact on Network Operation`**
...
<a id="section-2-6"></a> **`2.6. Verifying Correct Operation`**
...
<a id="section-3"></a> **`3. Management Considerations - How Will the Protocol Be Managed?`**
...
<a id="section-3-1"></a> **`3.1. Interoperability`**
...
<a id="section-3-2"></a> **`3.2. Management Information`**
...
<a id="section-3-2-1"></a> **`3.2.1. Information Model Design`**
...
<a id="section-3-3"></a> **`3.3. Fault Management`**
...
<a id="section-3-3-1"></a> **`3.3.1. Liveness Detection and Monitoring`**
...
<a id="section-3-3-2"></a> **`3.3.2. Fault Determination`**
...
<a id="section-3-3-3"></a> **`3.3.3. Root Cause Analysis`**
...
<a id="section-3-3-4"></a> **`3.3.4. Fault Isolation`**
...
<a id="section-3-4"></a> **`3.4. Configuration Management`**
...
<a id="section-3-4-1"></a> **`3.4.1. Verifying Correct Operation`**
...
<a id="section-3-5"></a> **`3.5. Accounting Management`**
...
<a id="section-3-6"></a> **`3.6. Performance Management`**
...
<a id="section-3-6-1"></a> **`3.6.1. Monitoring the Protocol`**
...
<a id="section-3-6-2"></a> **`3.6.2. Monitoring the Device`**
...
<a id="section-3-6-3"></a> **`3.6.3. Monitoring the Network`**
...
<a id="section-3-6-4"></a> **`3.6.4. Monitoring the Service`**
...
<a id="section-3-7"></a> **`3.7. Security Management`**
...
<a id="section-4"></a> **`4. Documentation Guidelines`**
...
<a id="section-4-1"></a> **`4.1. Recommended Discussions`**
...
<a id="section-4-2"></a> **`4.2. Null Manageability Considerations Sections`**
...
<a id="section-4-3"></a> **`4.3. Placement of Operations and Manageability Considerations Sections`**
