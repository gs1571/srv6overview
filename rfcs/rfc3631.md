...
<a id="section-2"></a> **`2. Decision Factors`**

```text

```

<a id="section-2-1"></a> **`2.1. Threat Model`**
...
<a id="section-2-2"></a> **`2.2. A Word about Mandatory Mechanisms`**
...
<a id="section-2-3"></a> **`2.3. Granularity of Protection`**
...
<a id="section-2-4"></a> **`2.4. Implementation Layer`**
...
<a id="section-3"></a> **`3. Standard Security Mechanisms`**

```text

```

<a id="section-3-1"></a> **`3.1. One-Time Passwords`**
...
<a id="section-3-6"></a> **`3.6. GSS-API`**
...
<a id="section-3-8"></a> **`3.8. Security/Multipart`**
...
<a id="section-3-9"></a> **`3.9. Digital Signatures`**
...
<a id="section-3-10"></a> **`3.10. OpenPGP and S/MIME`**
...
<a id="section-3-11"></a> **`3.11. Firewalls and Topology`**
...
<a id="section-3-12"></a> **`3.12. Kerberos`**
...
<a id="section-4"></a> **`4. Insecurity Mechanisms`**
...
<a id="section-4-1"></a> **`4.1. Plaintext Passwords`**
...
<a id="section-4-2"></a> **`4.2. Address-Based Authentication`**
...
<a id="section-4-3"></a> **`4.3. Name-Based Authentication`**
...
<a id="section-10"></a> **`10. Author Information`**
