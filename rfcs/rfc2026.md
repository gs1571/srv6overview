...
`     `[`1.1`](#section-1-1)`. Internet Standards`

`     `[`1.2`](#section-1-2)`. The Internet Standards Process`

`     `[`1.3`](#section-1-3)`. Organization of This Document`

`   `[`2`](#section-2)`. INTERNET STANDARDS-RELATED PUBLICATIONS`

`     `[`2.1`](#section-2-1)`. Requests for Comments (RFCs)`

`     `[`2.2`](#section-2-2)`. Internet-Drafts`

`   `[`3`](#section-3)`. INTERNET STANDARD SPECIFICATIONS`

`     `[`3.1`](#section-3-1)`. Technical Specification (TS)`

`     `[`3.2`](#section-3-2)`. Applicability Statement (AS)`

`     `[`3.3`](#section-3-3)`. Requirement Levels`

`   `[`4`](#section-4)`. THE INTERNET STANDARDS TRACK`

`     `[`4.1`](#section-4-1)`. Standards Track Maturity Levels`

`       `[`4.1.1`](#section-4-1-1)`. Proposed Standard`

`       `[`4.1.2`](#section-4-1-2)`. Draft Standard`

`       `[`4.1.3`](#section-4-1-3)`. Internet Standard`

`     `[`4.2`](#section-4-2)`. Non-Standards Track Maturity Levels`

`       `[`4.2.1`](#section-4-2-1)`. Experimental`

`       `[`4.2.2`](#section-4-2-2)`. Informational`

`       `[`4.2.3`](#section-4-2-3)`. Procedures for Experimental and Informational RFCs`

`       `[`4.2.4`](#section-4-2-4)`. Historic`

`   `[`5`](#section-5)`. Best Current Practice (BCP) RFCs`

`     `[`5.1`](#section-5-1)`. BCP Review Process`

`   `[`6`](#section-6)`. THE INTERNET STANDARDS PROCESS`

`     `[`6.1`](#section-6-1)`. Standards Actions`

`       `[`6.1.1`](#section-6-1-1)`. Initiation of Action`

`       `[`6.1.2`](#section-6-1-2)`. IESG Review and Approval`

`       `[`6.1.3`](#section-6-1-3)`. Publication`

`     `[`6.2`](#section-6-2)`. Advancing in the Standards Track`

`     `[`6.3`](#section-6-3)`. Revising a Standard`

`     `[`6.4`](#section-6-4)`. Retiring a Standard`

`     `[`6.5`](#section-6-5)`. Conflict Resolution and Appeals`

`       `[`6.5`](#section-6-5)`. 1 Working Group Disputes`

`       `[`6.5`](#section-6-5)`. 2 Process Failures`

`       `[`6.5`](#section-6-5)`. 3 Questions of Applicable Procedure`

`       `[`6.5`](#section-6-5)`. 4 Appeals Procedure`

`   `[`7`](#section-7)`. EXTERNAL STANDARDS AND SPECIFICATIONS`

`     `[`7.1`](#section-7-1)`. Use of External Specifications`

`       `[`7.1.1`](#section-7-1-1)`. Incorporation of an Open Standard`

`       `[`7.1.2`](#section-7-1-2)`. Incorporation of a Other Specifications`

`       `[`7.1.3`](#section-7-1-3)`. Assumption`

`   `[`8`](#section-8)`. NOTICES AND RECORD KEEPING`

`   `[`9`](#section-9)`. VARYING THE PROCESS`

`     `[`9`](#section-9)`. 1 The Variance Procedure`

`     `[`9`](#section-9)`. 2 Exclusions`

`   `[`10`](#section-10)`. INTELLECTUAL PROPERTY RIGHTS`

`     `[`10.1`](#section-10-1)`. General Policy`

`     `[`10.2`](#section-10-2)`. Confidentiality Obligations`

`     `[`10.3`](#section-10-3)`. Rights and Permissions`

`       `[`10.3.1`](#section-10-3-1)`. All Contributions`

`       `[`10.3.2`](#section-10-3-2)`. Standards Track Documents`

`       `[`10.3.3`](#section-10-3-3)`. Determination of Reasonable and`

`              Non-discriminatory Terms`

`     `[`10.4`](#section-10-4)`. Notices`
...
`   `[`14`](#section-14)`. DEFINITIONS OF TERMS`

`   `[`15`](#section-15)`. AUTHOR'S ADDRESS`
...
<a id="section-2"></a> **`2. INTERNET STANDARDS-RELATED PUBLICATIONS`**
...
<a id="section-3"></a> **`3. INTERNET STANDARD SPECIFICATIONS`**
...
<a id="section-4"></a> **`4. THE INTERNET STANDARDS TRACK`**
...
<a id="section-5"></a> **`5. BEST CURRENT PRACTICE (BCP) RFCs`**
...
<a id="section-6"></a> **`6. THE INTERNET STANDARDS PROCESS`**
...
<a id="section-7"></a> **`7. EXTERNAL STANDARDS AND SPECIFICATIONS`**
...
<a id="section-8"></a> **`8. NOTICES AND RECORD KEEPING`**
...
<a id="section-9"></a> **`9. VARYING THE PROCESS`**
...
<a id="section-10"></a> **`10. INTELLECTUAL PROPERTY RIGHTS`**

```text

```

<a id="section-10-1"></a> **`10.1. General Policy`**
...
<a id="section-10-3"></a> **`10.3. Rights and Permissions`**
...
<a id="section-10-3-1"></a> **`10.3.1. All Contributions`**
...
<a id="section-10-3-2"></a> **`10.3.2. Standards Track Documents`**
...
<a id="section-10-4"></a> **`10.4. Notices`**
...
<a id="section-14"></a> **`14. DEFINITIONS OF TERMS`**
...
<a id="section-15"></a> **`15. AUTHOR'S ADDRESS`**
