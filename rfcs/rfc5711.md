...
`   `[`2`](#section-2)`. Protocol Behavior`

`      `[`2.1`](#section-2-1)`. Behavior at Detecting Nodes`

`      `[`2.2`](#section-2-2)`. Behavior at Receiving Nodes`

`      `[`2.3`](#section-2-3)`. Data-Plane Behavior`

`   `[`3`](#section-3)`. RSVP PathErr Messages for a Preempted TE LSP`
...
<a id="section-2"></a> **`2. Protocol Behavior`**
...
<a id="section-2-1"></a> **`2.1. Behavior at Detecting Nodes`**
...
<a id="section-2-2"></a> **`2.2. Behavior at Receiving Nodes`**
...
<a id="section-2-3"></a> **`2.3. Data-Plane Behavior`**
...
<a id="section-3"></a> **`3. RSVP PathErr Messages for a Preempted TE LSP`**
