...
`   `[`2`](#section-2)`. How to Identify a Path`

`   `[`3`](#section-3)`. Extended NLRI Encodings`

`   `[`4`](#section-4)`. ADD-PATH Capability`
...
<a id="section-2"></a> **`2. How to Identify a Path`**
...
<a id="section-3"></a> **`3. Extended NLRI Encodings`**
...
<a id="section-4"></a> **`4. ADD-PATH Capability`**
