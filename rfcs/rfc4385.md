...
<a id="section-2"></a> **`2. Avoiding ECMP`**
...
<a id="section-3"></a> **`3. Generic PW MPLS Control Word`**
...
<a id="section-4-1"></a> **`4.1. Setting the Sequence Number`**
...
<a id="section-4-2"></a> **`4.2. Processing the Sequence Number`**
...
<a id="section-5"></a> **`5. PW Associated Channel`**
