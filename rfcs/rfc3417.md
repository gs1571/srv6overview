...
`   `[`3`](#section-3)`. SNMP over UDP over IPv4`

`   `[`3.1`](#section-3-1)`. Serialization`

`   `[`3.2`](#section-3-2)`. Well-known Values`

`   `[`4`](#section-4)`. SNMP over OSI`

`   `[`4.1`](#section-4-1)`. Serialization`

`   `[`4.2`](#section-4-2)`. Well-known Values`

`   `[`5`](#section-5)`. SNMP over DDP`

`   `[`5.1`](#section-5-1)`. Serialization`

`   `[`5.2`](#section-5-2)`. Well-known Values`

`   `[`5.3`](#section-5-3)`. Discussion of AppleTalk Addressing`

`   `[`5.3.1`](#section-5-3-1)`. How to Acquire NBP names`

`   `[`5.3.2`](#section-5-3-2)`. When to Turn NBP names into DDP addresses`

`   `[`5.3.3`](#section-5-3-3)`. How to Turn NBP names into DDP addresses`

`   `[`5.3.4`](#section-5-3-4)`. What if NBP is broken`

`   `[`6`](#section-6)`. SNMP over IPX`

`   `[`6.1`](#section-6-1)`. Serialization`

`   `[`6.2`](#section-6-2)`. Well-known Values`

`   `[`7`](#section-7)`. Proxy to SNMPv1`

`   `[`8`](#section-8)`. Serialization using the Basic Encoding Rules`

`   `[`8.1`](#section-8-1)`. Usage Example`

`   `[`9`](#section-9)`. Notice on Intellectual Property`
...
`   `[`14`](#section-14)`. Changes from RFC 1906`
...
<a id="section-3"></a> **`3. SNMP over UDP over IPv4`**
...
<a id="section-3-1"></a> **`3.1. Serialization`**
...
<a id="section-3-2"></a> **`3.2. Well-known Values`**
...
<a id="section-4"></a> **`4. SNMP over OSI`**
...
<a id="section-4-1"></a> **`4.1. Serialization`**
...
<a id="section-4-2"></a> **`4.2. Well-known Values`**
...
<a id="section-5"></a> **`5. SNMP over DDP`**
...
<a id="section-5-1"></a> **`5.1. Serialization`**
...
<a id="section-5-2"></a> **`5.2. Well-known Values`**
...
<a id="section-5-3"></a> **`5.3. Discussion of AppleTalk Addressing`**
...
<a id="section-5-3-1"></a> **`5.3.1. How to Acquire NBP names`**
...
<a id="section-5-3-2"></a> **`5.3.2. When to Turn NBP names into DDP addresses`**
...
<a id="section-5-3-3"></a> **`5.3.3. How to Turn NBP names into DDP addresses`**
...
<a id="section-5-3-4"></a> **`5.3.4. What if NBP is broken`**
...
<a id="section-6"></a> **`6. SNMP over IPX`**
...
<a id="section-6-1"></a> **`6.1. Serialization`**
...
<a id="section-6-2"></a> **`6.2. Well-known Values`**
...
<a id="section-7"></a> **`7. Proxy to SNMPv1`**
...
<a id="section-8"></a> **`8. Serialization using the Basic Encoding Rules`**
...
<a id="section-8-1"></a> **`8.1. Usage Example`**
...
<a id="section-9"></a> **`9. Notice on Intellectual Property`**
...
<a id="section-14"></a> **`14. Changes from RFC 1906`**
...
<a id="section-15"></a> **`15. Editor's Address`**
