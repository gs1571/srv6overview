...
`   `[`2`](#section-2)`. Load-Balancing Block sub-TLV`

`     `[`2.1`](#section-2-1)`. Applicability to Tunnel Types`

`     `[`2.2`](#section-2-2)`. Encapsulation Considerations`
...
<a id="section-2"></a> **`2. Load-Balancing Block sub-TLV`**
...
<a id="section-2-1"></a> **`2.1. Applicability to Tunnel Types`**
...
<a id="section-2-2"></a> **`2.2. Encapsulation Considerations`**
