...
`   `[`3`](#section-3)`. Security Reference Model`

`   `[`4`](#section-4)`. Security Threats`

`       `[`4.1`](#section-4-1)`. Attacks on the Data Plane`

`       `[`4.2`](#section-4-2)`. Attacks on the Control Plane`

`   `[`5`](#section-5)`. Defensive Techniques for PPVPN Service Providers`

`       `[`5.1`](#section-5-1)`. Cryptographic Techniques`

`       `[`5.2`](#section-5-2)`. Authentication`
...
`       `[`5.7`](#section-5-7)`. Deployment of Testable PPVPN Service`

`   `[`6`](#section-6)`. Monitoring, Detection, and Reporting of Security Attacks`

`   `[`7`](#section-7)`. User Security Requirements`

`       `[`7.1`](#section-7-1)`. Isolation`

`       `[`7.2`](#section-7-2)`. Protection`

`       `[`7.3`](#section-7-3)`. Confidentiality`

`       `[`7.4`](#section-7-4)`. CE Authentication`

`       `[`7.5`](#section-7-5)`. Integrity`

`       `[`7.6`](#section-7-6)`. Anti-replay`

`   `[`8`](#section-8)`. Provider Security Requirements`

`       `[`8.1`](#section-8-1)`. Protection within the Core Network`

`       `[`8.2`](#section-8-2)`. Protection on the User Access Link`

`       `[`8.3`](#section-8-3)`. General Requirements for PPVPN Providers`

`   `[`9`](#section-9)`. Security Evaluation of PPVPN Technologies`

`       `[`9.1`](#section-9-1)`. Evaluating the Template`

`       `[`9.2`](#section-9-2)`. Template`

`   `[`10`](#section-10)`. Security Considerations`

`   `[`11`](#section-11)`. Contributors`

`   `[`12`](#section-12)`. Acknowledgement`

`   `[`13`](#section-13)`. Normative References`

`   `[`14`](#section-14)`. Informative References`
...
<a id="section-3"></a> **`3. Security Reference Model`**
...
<a id="section-4-1"></a> **`4.1. Attacks on the Data Plane`**
...
<a id="section-4-1-1"></a> **`4.1.1. Unauthorized Observation of Data Traffic`**
...
<a id="section-4-1-2"></a> **`4.1.2. Modification of Data Traffic`**
...
<a id="section-4-1-3"></a> **`4.1.3. Insertion of Non-authentic Data Traffic: Spoofing and Replay`**
...
<a id="section-4-1-4"></a> **`4.1.4. Unauthorized Deletion of Data Traffic`**
...
<a id="section-4-1-5"></a> **`4.1.5. Unauthorized Traffic Pattern Analysis`**
...
<a id="section-4-1-6"></a> **`4.1.6. Denial-of-Service Attacks on the VPN`**
...
<a id="section-4-2"></a> **`4.2. Attacks on the Control Plane`**
...
<a id="section-4-2-1"></a> **`4.2.1. Denial-of-Service Attacks on Network Infrastructure`**
...
<a id="section-4-2-2"></a> **`4.2.2. Attacks on Service Provider Equipment via Management`**
...
<a id="section-4-2-3"></a> **`4.2.3. Social Engineering Attacks on Service Provider`**
...
<a id="section-4-2-4"></a> **`4.2.4. Cross-Connection of Traffic between PPVPNs`**
...
<a id="section-4-2-5"></a> **`4.2.5. Attacks against PPVPN Routing Protocols`**
...
<a id="section-4-2-6"></a> **`4.2.6. Attacks on Route Separation`**
...
<a id="section-4-2-7"></a> **`4.2.7. Attacks on Address Space Separation`**
...
<a id="section-4-2-8"></a> **`4.2.8. Other Attacks on PPVPN Control Traffic`**
...
<a id="section-5"></a> **`5. Defensive Techniques for PPVPN Service Providers`**
...
<a id="section-5-1"></a> **`5.1. Cryptographic Techniques`**
...
<a id="section-5-1-1"></a> **`5.1.1. IPsec in PPVPNs`**
...
<a id="section-5-1-2"></a> **`5.1.2. Encryption for Device Configuration and Management`**
...
<a id="section-5-1-3"></a> **`5.1.3. Cryptographic Techniques in Layer-2 PPVPNs`**
...
<a id="section-5-1-4"></a> **`5.1.4. End-to-End vs. Hop-by-Hop Encryption Tradeoffs in PPVPNs`**
...
<a id="section-5-2"></a> **`5.2. Authentication`**
...
<a id="section-5-2-1"></a> **`5.2.1. VPN Member Authentication`**
...
<a id="section-5-2-2"></a> **`5.2.2. Management System Authentication`**
...
<a id="section-5-2-3"></a> **`5.2.3. Peer-to-Peer Authentication`**
...
<a id="section-5-2-4"></a> **`5.2.4. Authenticating Remote Access VPN Members`**
...
<a id="section-5-2-5"></a> **`5.2.5. Cryptographic Techniques for Authenticating Identity`**
...
<a id="section-5-7"></a> **`5.7. Deployment of Testable PPVPN Service`**
...
<a id="section-7"></a> **`7. User Security Requirements`**
...
<a id="section-7-1"></a> **`7.1. Isolation`**
...
<a id="section-7-1-1"></a> **`7.1.1. Address Separation`**
...
<a id="section-7-1-2"></a> **`7.1.2. Routing Separation`**
...
<a id="section-7-1-3"></a> **`7.1.3. Traffic Separation`**
...
<a id="section-7-2"></a> **`7.2. Protection`**
...
<a id="section-7-2-1"></a> **`7.2.1. Protection against Intrusion`**
...
<a id="section-7-2-2"></a> **`7.2.2. Protection against Denial-of-Service Attacks`**
...
<a id="section-7-2-3"></a> **`7.2.3. Protection against Spoofing`**
...
<a id="section-7-3"></a> **`7.3. Confidentiality`**
...
<a id="section-7-4"></a> **`7.4. CE Authentication`**
...
<a id="section-7-5"></a> **`7.5. Integrity`**
...
<a id="section-7-6"></a> **`7.6. Anti-replay`**
...
<a id="section-8"></a> **`8. Provider Security Requirements`**
...
<a id="section-8-1"></a> **`8.1. Protection within the Core Network`**

```text

```

<a id="section-8-1-1"></a> **`8.1.1. Control Plane Protection`**
...
<a id="section-8-1-2"></a> **`8.1.2. Data Plane Protection`**
...
<a id="section-8-2"></a> **`8.2. Protection on the User Access Link`**
...
<a id="section-8-2-1"></a> **`8.2.1. Link Authentication`**
...
<a id="section-8-2-2"></a> **`8.2.2. Access Routing`**
...
<a id="section-8-2-3"></a> **`8.2.3. Access QoS`**
...
<a id="section-8-2-4"></a> **`8.2.4. Customer VPN Monitoring Tools`**
...
<a id="section-8-3"></a> **`8.3. General Requirements for PPVPN Providers`**
...
<a id="section-9"></a> **`9. Security Evaluation of PPVPN Technologies`**
...
<a id="section-9-1"></a> **`9.1. Evaluating the Template`**
...
<a id="section-9-2"></a> **`9.2. Template`**
...
<a id="section-12"></a> **`12. Acknowledgement`**
...
<a id="section-13"></a> **`13. Normative References`**
...
<a id="section-14"></a> **`14. Informative References`**
