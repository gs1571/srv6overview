...
`   `[`3`](#section-3)`. Description of a TE Mesh-Group`

`   `[`4`](#section-4)`. TE-MESH-GROUP TLV Formats`

`      `[`4.1`](#section-4-1)`. OSPF TE-MESH-GROUP TLV Format`

`      `[`4.2`](#section-4-2)`. IS-IS TE-MESH-GROUP Sub-TLV Format`
...
`      `[`7.1`](#section-7-1)`. OSPF`

`      `[`7.2`](#section-7-2)`. IS-IS`
...
<a id="section-3"></a> **`3. Description of a TE Mesh-Group`**
...
<a id="section-4"></a> **`4. TE-MESH-GROUP TLV Formats`**

```text

```

<a id="section-4-1"></a> **`4.1. OSPF TE-MESH-GROUP TLV Format`**
...
<a id="section-4-2"></a> **`4.2. IS-IS TE-MESH-GROUP Sub-TLV Format`**
