...
`   `[`2`](#section-2)`. Why Management of a Namespace May Be Necessary`

`   `[`3`](#section-3)`. Designated Experts`

`      `[`3.1`](#section-3-1)`. The Motivation for Designated Experts`

`      `[`3.2`](#section-3-2)`. The Role of the Designated Expert`

`      `[`3.3`](#section-3-3)`. Designated Expert Reviews`

`   `[`4`](#section-4)`. Creating a Registry`

`      `[`4.1`](#section-4-1)`. Well-Known IANA Policy Definitions`

`      `[`4.2`](#section-4-2)`. What to Put in Documents That Create a Registry`

`      `[`4.3`](#section-4-3)`. Updating IANA Guidelines for Existing Registries`

`   `[`5`](#section-5)`. Registering New Values in an Existing Registry`

`      `[`5.1`](#section-5-1)`. What to Put in Documents When Registering Values`

`      `[`5.2`](#section-5-2)`. Updating Registrations`

`      `[`5.3`](#section-5-3)`. Overriding Registration Procedures`

`   `[`6`](#section-6)`. Miscellaneous Issues`

`      `[`6.1`](#section-6-1)`. When There Are No IANA Actions`

`      `[`6.2`](#section-6-2)`. Namespaces Lacking Documented Guidance`

`      `[`6.3`](#section-6-3)`. After-the-Fact Registrations`

`      `[`6.4`](#section-6-4)`. Reclaiming Assigned Values`

`   `[`7`](#section-7)`. Appeals`

`   `[`8`](#section-8)`. Mailing Lists`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Changes Relative to RFC 2434`
...
<a id="section-2"></a> **`2. Why Management of a Namespace May Be Necessary`**
...
<a id="section-3"></a> **`3. Designated Experts`**

```text

```

<a id="section-3-1"></a> **`3.1. The Motivation for Designated Experts`**
...
<a id="section-3-2"></a> **`3.2. The Role of the Designated Expert`**
...
<a id="section-3-3"></a> **`3.3. Designated Expert Reviews`**
...
<a id="section-4"></a> **`4. Creating a Registry`**
...
<a id="section-4-1"></a> **`4.1. Well-Known IANA Policy Definitions`**
...
<a id="section-4-2"></a> **`4.2. What to Put in Documents That Create a Registry`**
...
<a id="section-4-3"></a> **`4.3. Updating IANA Guidelines for Existing Registries`**
...
<a id="section-5"></a> **`5. Registering New Values in an Existing Registry`**

```text

```

<a id="section-5-1"></a> **`5.1. What to Put in Documents When Registering Values`**
...
<a id="section-5-2"></a> **`5.2. Updating Registrations`**
...
<a id="section-5-3"></a> **`5.3. Overriding Registration Procedures`**
...
<a id="section-6"></a> **`6. Miscellaneous Issues`**

```text

```

<a id="section-6-1"></a> **`6.1. When There Are No IANA Actions`**
...
<a id="section-6-2"></a> **`6.2. Namespaces Lacking Documented Guidance`**
...
<a id="section-6-3"></a> **`6.3. After-the-Fact Registrations`**
...
<a id="section-6-4"></a> **`6.4. Reclaiming Assigned Values`**
...
<a id="section-8"></a> **`8. Mailing Lists`**
...
<a id="section-10"></a> **`10. Changes Relative to RFC 2434`**
