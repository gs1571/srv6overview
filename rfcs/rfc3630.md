...
<a id="section-1-2"></a> **`1.2. Limitations`**
...
<a id="section-2"></a> **`2. LSA Format`**

```text

```

<a id="section-2-1"></a> **`2.1. LSA type`**
...
<a id="section-2-3"></a> **`2.3. LSA Format Overview`**

```text

```

<a id="section-2-3-1"></a> **`2.3.1. LSA Header`**
...
<a id="section-2-3-2"></a> **`2.3.2. TLV Header`**
...
<a id="section-2-4"></a> **`2.4. LSA payload details`**
...
<a id="section-2-4-1"></a> **`2.4.1. Router Address TLV`**
...
<a id="section-2-4-2"></a> **`2.4.2. Link TLV`**
...
<a id="section-2-5"></a> **`2.5. Sub-TLV Details`**

```text

```

<a id="section-2-5-1"></a> **`2.5.1. Link Type`**
...
<a id="section-2-5-2"></a> **`2.5.2. Link ID`**
...
<a id="section-2-5-3"></a> **`2.5.3. Local Interface IP Address`**
...
<a id="section-2-5-4"></a> **`2.5.4. Remote Interface IP Address`**
...
<a id="section-2-5-5"></a> **`2.5.5. Traffic Engineering Metric`**
...
<a id="section-2-5-6"></a> **`2.5.6. Maximum Bandwidth`**
...
<a id="section-2-5-7"></a> **`2.5.7. Maximum Reservable Bandwidth`**
...
<a id="section-2-5-8"></a> **`2.5.8. Unreserved Bandwidth`**
...
<a id="section-2-5-9"></a> **`2.5.9. Administrative Group`**
...
<a id="section-4"></a> **`4. Compatibility Issues`**
...
<a id="section-7"></a> **`7. Intellectual Property Rights Statement`**
