...
`      `[`1.1`](#section-1-1)`. Design Considerations`

`      `[`1.2`](#section-1-2)`. Terminology`

`   `[`2`](#section-2)`. Notes on Motivation`

`      `[`2.1`](#section-2-1)`. Basic Motivations for LSP Ping`

`      `[`2.2`](#section-2-2)`. Motivations for LSP Ping for P2MP LSPs`

`   `[`3`](#section-3)`. Packet Format`

`      `[`3.1`](#section-3-1)`. Identifying the LSP Under Test`

`           `[`3.1.1`](#section-3-1-1)`. Identifying a P2MP MPLS TE LSP`

`                  `[`3.1.1.1`](#section-3-1-1-1)`. RSVP P2MP IPv4 Session Sub-TLV`

`                  `[`3.1.1.2`](#section-3-1-1-2)`. RSVP P2MP IPv6 Session Sub-TLV`

`           `[`3.1.2`](#section-3-1-2)`. Identifying a Multicast LDP LSP`

`                  `[`3.1.2.1`](#section-3-1-2-1)`. Multicast LDP FEC Stack Sub-TLVs`

`                  `[`3.1.2.2`](#section-3-1-2-2)`. Applicability to`

`                           Multipoint-to-Multipoint LSPs`

`      `[`3.2`](#section-3-2)`. Limiting the Scope of Responses`

`           `[`3.2.1`](#section-3-2-1)`. Egress Address P2MP Responder Sub-TLVs`

`           `[`3.2.2`](#section-3-2-2)`. Node Address P2MP Responder Sub-TLVs`

`      `[`3.3`](#section-3-3)`. Preventing Congestion of Echo Replies`

`      `[`3.4`](#section-3-4)`. Respond Only If TTL Expired Flag`

`      `[`3.5`](#section-3-5)`. Downstream Detailed Mapping TLV`

`   `[`4`](#section-4)`. Operation of LSP Ping for a P2MP LSP`

`      `[`4.1`](#section-4-1)`. Initiating LSR Operations`

`           `[`4.1.1`](#section-4-1-1)`. Limiting Responses to Echo Requests`

`           `[`4.1.2`](#section-4-1-2)`. Jittered Responses to Echo Requests`

`      `[`4.2`](#section-4-2)`. Responding LSR Operations`

`           `[`4.2.1`](#section-4-2-1)`. Echo Reply Reporting`

`                  `[`4.2.1.1`](#section-4-2-1-1)`. Responses from Transit and Branch Nodes`

`                  `[`4.2.1.2`](#section-4-2-1-2)`. Responses from Egress Nodes`

`                  `[`4.2.1.3`](#section-4-2-1-3)`. Responses from Bud Nodes`

`      `[`4.3`](#section-4-3)`. Special Considerations for Traceroute`

`           `[`4.3.1`](#section-4-3-1)`. End of Processing for Traceroutes`

`           `[`4.3.2`](#section-4-3-2)`. Multiple Responses from Bud and Egress Nodes`

`           `[`4.3.3`](#section-4-3-3)`. Non-Response to Traceroute Echo Requests`

`           `[`4.3.4`](#section-4-3-4)`. Use of Downstream Detailed Mapping TLV in`

`                  Echo Requests`

`           `[`4.3.5`](#section-4-3-5)`. Cross-Over Node Processing`

`   `[`5`](#section-5)`. Non-Compliant Routers`

`   `[`6`](#section-6)`. OAM and Management Considerations`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. New Sub-TLV Types`

`      `[`7.2`](#section-7-2)`. New TLVs`

`      `[`7.3`](#section-7-3)`. New Global Flags Registry`
...
<a id="section-1-1"></a> **`1.1. Design Considerations`**
...
<a id="section-2"></a> **`2. Notes on Motivation`**

```text

```

<a id="section-2-1"></a> **`2.1. Basic Motivations for LSP Ping`**
...
<a id="section-2-2"></a> **`2.2. Motivations for LSP Ping for P2MP LSPs`**
...
<a id="section-3-1"></a> **`3.1. Identifying the LSP Under Test`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. Identifying a P2MP MPLS TE LSP`**
...
<a id="section-3-1-1-1"></a> **`3.1.1.1. RSVP P2MP IPv4 Session Sub-TLV`**
...
<a id="section-3-1-1-2"></a> **`3.1.1.2. RSVP P2MP IPv6 Session Sub-TLV`**
...
<a id="section-3-1-2"></a> **`3.1.2. Identifying a Multicast LDP LSP`**
...
<a id="section-3-1-2-1"></a> **`3.1.2.1. Multicast LDP FEC Stack Sub-TLVs`**
...
<a id="section-3-1-2-2"></a> **`3.1.2.2. Applicability to Multipoint-to-Multipoint LSPs`**
...
<a id="section-3-2"></a> **`3.2. Limiting the Scope of Responses`**
...
<a id="section-3-2-1"></a> **`3.2.1. Egress Address P2MP Responder Sub-TLVs`**
...
<a id="section-3-2-2"></a> **`3.2.2. Node Address P2MP Responder Sub-TLVs`**
...
<a id="section-3-3"></a> **`3.3. Preventing Congestion of Echo Replies`**
...
<a id="section-3-4"></a> **`3.4. Respond Only If TTL Expired Flag`**
...
<a id="section-3-5"></a> **`3.5. Downstream Detailed Mapping TLV`**
...
<a id="section-4"></a> **`4. Operation of LSP Ping for a P2MP LSP`**
...
<a id="section-4-1"></a> **`4.1. Initiating LSR Operations`**
...
<a id="section-4-1-1"></a> **`4.1.1. Limiting Responses to Echo Requests`**
...
<a id="section-4-1-2"></a> **`4.1.2. Jittered Responses to Echo Requests`**
...
<a id="section-4-2"></a> **`4.2. Responding LSR Operations`**
...
<a id="section-4-2-1"></a> **`4.2.1. Echo Reply Reporting`**
...
<a id="section-4-2-1-1"></a> **`4.2.1.1. Responses from Transit and Branch Nodes`**
...
<a id="section-4-2-1-2"></a> **`4.2.1.2. Responses from Egress Nodes`**
...
<a id="section-4-2-1-3"></a> **`4.2.1.3. Responses from Bud Nodes`**
...
<a id="section-4-3"></a> **`4.3. Special Considerations for Traceroute`**

```text

```

<a id="section-4-3-1"></a> **`4.3.1. End of Processing for Traceroutes`**
...
<a id="section-4-3-2"></a> **`4.3.2. Multiple Responses from Bud and Egress Nodes`**
...
<a id="section-4-3-3"></a> **`4.3.3. Non-Response to Traceroute Echo Requests`**
...
<a id="section-4-3-4"></a> **`4.3.4. Use of Downstream Detailed Mapping TLV in Echo Requests`**
...
<a id="section-4-3-5"></a> **`4.3.5. Cross-Over Node Processing`**
...
<a id="section-5"></a> **`5. Non-Compliant Routers`**
...
<a id="section-6"></a> **`6. OAM and Management Considerations`**
...
<a id="section-7-1"></a> **`7.1. New Sub-TLV Types`**
...
<a id="section-7-2"></a> **`7.2. New TLVs`**
...
<a id="section-7-3"></a> **`7.3. New Global Flags Registry`**
