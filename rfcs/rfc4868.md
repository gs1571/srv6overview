...
`   `[`2`](#section-2)`. The HMAC-SHA-256+ Algorithms`

`     `[`2.1`](#section-2-1)`. Keying Material`

`       `[`2.1.1`](#section-2-1-1)`. Data Origin Authentication and Integrity`

`               Verification Usage`

`       `[`2.1.2`](#section-2-1-2)`. Pseudo-Random Function (PRF) Usage`

`       `[`2.1.3`](#section-2-1-3)`. Randomness and Key Strength`

`       `[`2.1.4`](#section-2-1-4)`. Key Distribution`

`       `[`2.1.5`](#section-2-1-5)`. Refreshing Keys`

`     `[`2.2`](#section-2-2)`. Padding`

`     `[`2.3`](#section-2-3)`. Truncation`

`     `[`2.4`](#section-2-4)`. Using HMAC-SHA-256+ as PRFs in IKE and IKEv2`

`     `[`2.5`](#section-2-5)`. Interactions with the ESP, IKE, or IKEv2 Cipher`

`           Mechanisms`

`     `[`2.6`](#section-2-6)`. HMAC-SHA-256+ Parameter Summary`

`     `[`2.7`](#section-2-7)`. Test Vectors`

`       `[`2.7.1`](#section-2-7-1)`. PRF Test Vectors`

`       `[`2.7.2`](#section-2-7-2)`. Authenticator Test Vectors`

`   `[`3`](#section-3)`. Security Considerations`

`     `[`3.1`](#section-3-1)`. HMAC Key Length vs Truncation Length`
...
<a id="section-2"></a> **`2. The HMAC-SHA-256+ Algorithms`**
...
<a id="section-2-1"></a> **`2.1. Keying Material`**
...
<a id="section-2-1-1"></a> **`2.1.1. Data Origin Authentication and Integrity Verification Usage`**
...
<a id="section-2-1-2"></a> **`2.1.2. Pseudo-Random Function (PRF) Usage`**
...
<a id="section-2-1-3"></a> **`2.1.3. Randomness and Key Strength`**
...
<a id="section-2-1-4"></a> **`2.1.4. Key Distribution`**
...
<a id="section-2-1-5"></a> **`2.1.5. Refreshing Keys`**
...
<a id="section-2-2"></a> **`2.2. Padding`**
...
<a id="section-2-3"></a> **`2.3. Truncation`**
...
<a id="section-2-4"></a> **`2.4. Using HMAC-SHA-256+ as PRFs in IKE and IKEv2`**
...
<a id="section-2-5"></a> **`2.5. Interactions with the ESP, IKE, or IKEv2 Cipher Mechanisms`**
...
<a id="section-2-6"></a> **`2.6. HMAC-SHA-256+ Parameter Summary`**
...
<a id="section-2-7"></a> **`2.7. Test Vectors`**
...
<a id="section-2-7-1"></a> **`2.7.1. PRF Test Vectors`**
...
<a id="section-2-7-2"></a> **`2.7.2. Authenticator Test Vectors`**
...
<a id="section-2-7-2-1"></a> **`2.7.2.1. SHA256 Authentication Test Vectors`**
...
<a id="section-2-7-2-2"></a> **`2.7.2.2. SHA384 Authentication Test Vectors`**
...
<a id="section-2-7-2-3"></a> **`2.7.2.3. SHA512 Authentication Test Vectors`**
...
<a id="section-3-1"></a> **`3.1. HMAC Key Length vs Truncation Length`**
