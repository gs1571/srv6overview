...
`     `[`1.1`](#section-1-1)`. Why Translation?`

`     `[`1.2`](#section-1-2)`. Terminology`

`     `[`1.3`](#section-1-3)`. Translation Objectives`

`     `[`1.4`](#section-1-4)`. Transition Plan`

`   `[`2`](#section-2)`. Scenarios for IPv4/IPv6 Translation`

`     `[`2.1`](#section-2-1)`. Scenario 1: An IPv6 Network to the IPv4 Internet`

`     `[`2.2`](#section-2-2)`. Scenario 2: The IPv4 Internet to an IPv6 Network`

`     `[`2.3`](#section-2-3)`. Scenario 3: The IPv6 Internet to an IPv4 Network`

`     `[`2.4`](#section-2-4)`. Scenario 4: An IPv4 Network to the IPv6 Internet`

`     `[`2.5`](#section-2-5)`. Scenario 5: An IPv6 Network to an IPv4 Network`

`     `[`2.6`](#section-2-6)`. Scenario 6: An IPv4 Network to an IPv6 Network`

`     `[`2.7`](#section-2-7)`. Scenario 7: The IPv6 Internet to the IPv4 Internet`

`     `[`2.8`](#section-2-8)`. Scenario 8: The IPv4 Internet to the IPv6 Internet`

`   `[`3`](#section-3)`. Framework`

`     `[`3.1`](#section-3-1)`. Translation Components`

`       `[`3.1.1`](#section-3-1-1)`. Address Translation`

`       `[`3.1.2`](#section-3-1-2)`. IP and ICMP Translation`

`       `[`3.1.3`](#section-3-1-3)`. Maintaining Translation State`

`       `[`3.1.4`](#section-3-1-4)`. DNS64 and DNS46`

`       `[`3.1.5`](#section-3-1-5)`. ALGs for Other Applications Layer Protocols`

`     `[`3.2`](#section-3-2)`. Operation Mode for Specific Scenarios`

`       `[`3.2.1`](#section-3-2-1)`. Stateless Translation`

`       `[`3.2.2`](#section-3-2-2)`. Stateful Translation`

`     `[`3.3`](#section-3-3)`. Layout of the Related Documents`

`   `[`4`](#section-4)`. Translation in Operation`

`   `[`5`](#section-5)`. Unsolved Problems`
...
<a id="section-1-1"></a> **`1.1. Why Translation?`**
...
<a id="section-1-3"></a> **`1.3. Translation Objectives`**
...
<a id="section-1-4"></a> **`1.4. Transition Plan`**
...
<a id="section-2"></a> **`2. Scenarios for IPv4/IPv6 Translation`**
...
<a id="section-2-1"></a> **`2.1. Scenario 1: An IPv6 Network to the IPv4 Internet`**
...
<a id="section-2-2"></a> **`2.2. Scenario 2: The IPv4 Internet to an IPv6 Network`**
...
<a id="section-2-3"></a> **`2.3. Scenario 3: The IPv6 Internet to an IPv4 Network`**
...
<a id="section-2-4"></a> **`2.4. Scenario 4: An IPv4 Network to the IPv6 Internet`**
...
<a id="section-2-5"></a> **`2.5. Scenario 5: An IPv6 Network to an IPv4 Network`**
...
<a id="section-2-6"></a> **`2.6. Scenario 6: An IPv4 Network to an IPv6 Network`**
...
<a id="section-2-7"></a> **`2.7. Scenario 7: The IPv6 Internet to the IPv4 Internet`**
...
<a id="section-2-8"></a> **`2.8. Scenario 8: The IPv4 Internet to the IPv6 Internet`**
...
<a id="section-3-1"></a> **`3.1. Translation Components`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. Address Translation`**
...
<a id="section-3-1-2"></a> **`3.1.2. IP and ICMP Translation`**
...
<a id="section-3-1-3"></a> **`3.1.3. Maintaining Translation State`**
...
<a id="section-3-1-4"></a> **`3.1.4. DNS64 and DNS46`**
...
<a id="section-3-1-5"></a> **`3.1.5. ALGs for Other Applications Layer Protocols`**
...
<a id="section-3-2"></a> **`3.2. Operation Mode for Specific Scenarios`**
...
<a id="section-3-2-1"></a> **`3.2.1. Stateless Translation`**
...
<a id="section-3-2-2"></a> **`3.2.2. Stateful Translation`**
...
<a id="section-3-3"></a> **`3.3. Layout of the Related Documents`**
...
<a id="section-4"></a> **`4. Translation in Operation`**
...
<a id="section-5"></a> **`5. Unsolved Problems`**
