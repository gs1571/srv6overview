...
`   `[`3`](#section-3)`. Scope and Applicability`

`   `[`4`](#section-4)`. Problem Analysis`

`   `[`5`](#section-5)`. Mechanisms for IP Fast-Reroute`

`     `[`5.1`](#section-5-1)`. Mechanisms for Fast Failure Detection`

`     `[`5.2`](#section-5-2)`. Mechanisms for Repair Paths`

`       `[`5.2.1`](#section-5-2-1)`. Scope of Repair Paths`

`       `[`5.2.2`](#section-5-2-2)`. Analysis of Repair Coverage`

`       `[`5.2.3`](#section-5-2-3)`. Link or Node Repair`

`       `[`5.2.4`](#section-5-2-4)`. Maintenance of Repair Paths`

`       `[`5.2.5`](#section-5-2-5)`. Local Area Networks`

`       `[`5.2.6`](#section-5-2-6)`. Multiple Failures and Shared Risk Link Groups`

`     `[`5.3`](#section-5-3)`. Mechanisms for Micro-Loop Prevention`

`   `[`6`](#section-6)`. Management Considerations`
...
<a id="section-3"></a> **`3. Scope and Applicability`**
...
<a id="section-4"></a> **`4. Problem Analysis`**
...
<a id="section-5"></a> **`5. Mechanisms for IP Fast-Reroute`**
...
<a id="section-5-1"></a> **`5.1. Mechanisms for Fast Failure Detection`**
...
<a id="section-5-2"></a> **`5.2. Mechanisms for Repair Paths`**
...
<a id="section-5-2-1"></a> **`5.2.1. Scope of Repair Paths`**
...
<a id="section-5-2-2"></a> **`5.2.2. Analysis of Repair Coverage`**
...
<a id="section-5-2-3"></a> **`5.2.3. Link or Node Repair`**
...
<a id="section-5-2-4"></a> **`5.2.4. Maintenance of Repair Paths`**
...
<a id="section-5-2-5"></a> **`5.2.5. Local Area Networks`**
...
<a id="section-5-2-6"></a> **`5.2.6. Multiple Failures and Shared Risk Link Groups`**
...
<a id="section-5-3"></a> **`5.3. Mechanisms for Micro-Loop Prevention`**
...
<a id="section-6"></a> **`6. Management Considerations`**
