...
`       `[`3.1`](#section-3-1)`. Multi-hop Scenarios`

`             `[`3.1.1`](#section-3-1-1)`. Intra-domain Protocol Handling`
...
`             `[`5.2.1`](#section-5-2-1)`. IP in IP`

`             `[`5.2.2`](#section-5-2-2)`. IP in MPLS`

`       `[`5.3`](#section-5-3)`. Multi-Hop Protocol Sessions`
...
<a id="section-3-1"></a> **`3.1. Multi-hop Scenarios`**
...
<a id="section-3-1-1"></a> **`3.1.1. Intra-domain Protocol Handling`**
...
<a id="section-5-2-1"></a> **`5.2.1. IP in IP`**
...
<a id="section-5-2-2"></a> **`5.2.2. IP in MPLS`**
...
<a id="section-5-3"></a> **`5.3. Multi-Hop Protocol Sessions`**
