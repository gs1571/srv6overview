...
`   `[`3`](#section-3)`. Rejected Potential Solution`

`   `[`4`](#section-4)`. Solution`

`      `[`4.1`](#section-4-1)`. Node Attribute TLV`

`      `[`4.2`](#section-4-2)`. Operation`
...
<a id="section-3"></a> **`3. Rejected Potential Solution`**
...
<a id="section-4-1"></a> **`4.1. Node Attribute TLV`**
...
<a id="section-4-2"></a> **`4.2. Operation`**
