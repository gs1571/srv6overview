...
`      `[`2.1`](#section-2-1)`. Conventions Used in This Document`

`   `[`3`](#section-3)`. Motivations for PCE-Based Inter-Area Path Computation`

`   `[`4`](#section-4)`. Detailed Inter-Area Specific Requirements on PCECP`

`      `[`4.1`](#section-4-1)`. Control and Recording of Area Crossing`

`      `[`4.2`](#section-4-2)`. Area Recording`

`      `[`4.3`](#section-4-3)`. Strict Explicit Path and Loose Path`

`      `[`4.4`](#section-4-4)`. PCE List Enforcement and Recording in Multiple-PCE`

`           Computation`

`      `[`4.5`](#section-4-5)`. Inclusion of Area IDs in Request`

`      `[`4.6`](#section-4-6)`. Area Inclusion/Exclusion`

`      `[`4.7`](#section-4-7)`. Inter-Area Diverse Path Computation`

`      `[`4.8`](#section-4-8)`. Inter-Area Policies`

`      `[`4.9`](#section-4-9)`. Loop Avoidance`

`   `[`5`](#section-5)`. Manageability Considerations`
...
<a id="section-2-1"></a> **`2.1. Conventions Used in This Document`**
...
<a id="section-3"></a> **`3. Motivations for PCE-Based Inter-Area Path Computation`**
...
<a id="section-4"></a> **`4. Detailed Inter-Area Specific Requirements on PCECP`**
...
<a id="section-4-1"></a> **`4.1. Control and Recording of Area Crossing`**
...
<a id="section-4-2"></a> **`4.2. Area Recording`**
...
<a id="section-4-3"></a> **`4.3. Strict Explicit Path and Loose Path`**
...
<a id="section-4-4"></a> **`4.4. PCE List Enforcement and Recording in Multiple-PCE Computation`**
...
<a id="section-4-5"></a> **`4.5. Inclusion of Area IDs in Request`**
...
<a id="section-4-6"></a> **`4.6. Area Inclusion/Exclusion`**
...
<a id="section-4-7"></a> **`4.7. Inter-Area Diverse Path Computation`**
...
<a id="section-4-8"></a> **`4.8. Inter-Area Policies`**
...
<a id="section-4-9"></a> **`4.9. Loop Avoidance`**
...
<a id="section-5"></a> **`5. Manageability Considerations`**
