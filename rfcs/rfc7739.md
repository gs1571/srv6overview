...
`   `[`3`](#section-3)`. Security Implications of Predictable Fragment Identification`

`       Values`

`   `[`4`](#section-4)`. Constraints for the Selection of Fragment Identification`

`       Values`

`   `[`5`](#section-5)`. Algorithms for Selecting Fragment Identification Values`

`     `[`5.1`](#section-5-1)`. Per-Destination Counter (Initialized to a Random Value)`

`     `[`5.2`](#section-5-2)`. Randomized Identification Values`

`     `[`5.3`](#section-5-3)`. Hash-Based Fragment Identification Selection Algorithm`
...
<a id="section-3"></a> **`3. Security Implications of Predictable Fragment Identification Values`**
...
<a id="section-4"></a> **`4. Constraints for the Selection of Fragment Identification Values`**
...
<a id="section-5"></a> **`5. Algorithms for Selecting Fragment Identification Values`**
...
<a id="section-5-1"></a> **`5.1. Per-Destination Counter (Initialized to a Random Value)`**
...
<a id="section-5-2"></a> **`5.2. Randomized Identification Values`**
...
<a id="section-5-3"></a> **`5.3. Hash-Based Fragment Identification Selection Algorithm`**
