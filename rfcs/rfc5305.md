...
`   `[`2`](#section-2)`. Introducing Sub-TLVs`

`   `[`3`](#section-3)`. The Extended IS Reachability TLV`

`      `[`3.1`](#section-3-1)`. Sub-TLV 3: Administrative Group (color, resource class)`

`      `[`3.2`](#section-3-2)`. Sub-TLV 6: IPv4 Interface Address`

`      `[`3.3`](#section-3-3)`. Sub-TLV 8: IPv4 Neighbor Address`

`      `[`3.4`](#section-3-4)`. Sub-TLV 9: Maximum Link Bandwidth`

`      `[`3.5`](#section-3-5)`. Sub-TLV 10: Maximum Reservable Link Bandwidth`

`      `[`3.6`](#section-3-6)`. Sub-TLV 11: Unreserved Bandwidth`

`      `[`3.7`](#section-3-7)`. Sub-TLV 18: Traffic Engineering Default Metric`

`   `[`4`](#section-4)`. The Extended IP Reachability TLV`

`      `[`4.1`](#section-4-1)`. The up/down Bit`

`      `[`4.2`](#section-4-2)`. Expandability of the Extended IP Reachability TLV`

`           with Sub-TLVs`

`      `[`4.3`](#section-4-3)`. The Traffic Engineering Router ID TLV`

`   `[`5`](#section-5)`. IANA Considerations`

`      `[`5.1`](#section-5-1)`. TLV Codepoint Allocations`

`      `[`5.2`](#section-5-2)`. New Registries`

`           `[`5.2.1`](#section-5-2-1)`. Sub-TLVs for the Extended IS Reachability TLV`

`           `[`5.2.2`](#section-5-2-2)`. Sub-TLVs for the Extended IP Reachability TLV`
...
<a id="section-2"></a> **`2. Introducing Sub-TLVs`**
...
<a id="section-3"></a> **`3. The Extended IS Reachability TLV`**
...
<a id="section-3-1"></a> **`3.1. Sub-TLV 3: Administrative Group (color, resource class)`**
...
<a id="section-3-2"></a> **`3.2. Sub-TLV 6: IPv4 Interface Address`**
...
<a id="section-3-3"></a> **`3.3. Sub-TLV 8: IPv4 Neighbor Address`**
...
<a id="section-3-4"></a> **`3.4. Sub-TLV 9: Maximum Link Bandwidth`**
...
<a id="section-3-5"></a> **`3.5. Sub-TLV 10: Maximum Reservable Link Bandwidth`**
...
<a id="section-3-6"></a> **`3.6. Sub-TLV 11: Unreserved Bandwidth`**
...
<a id="section-3-7"></a> **`3.7. Sub-TLV 18: Traffic Engineering Default Metric`**
...
<a id="section-4"></a> **`4. The Extended IP Reachability TLV`**
...
<a id="section-4-1"></a> **`4.1. The up/down Bit`**
...
<a id="section-4-2"></a> **`4.2. Expandability of the Extended IP Reachability TLV with Sub-TLVs`**
...
<a id="section-4-3"></a> **`4.3. The Traffic Engineering Router ID TLV`**
...
<a id="section-5-1"></a> **`5.1. TLV Codepoint Allocations`**
...
<a id="section-5-2"></a> **`5.2. New Registries`**
...
<a id="section-5-2-1"></a> **`5.2.1. Sub-TLVs for the Extended IS Reachability TLV`**
...
<a id="section-5-2-2"></a> **`5.2.2. Sub-TLVs for the Extended IP Reachability TLV`**
