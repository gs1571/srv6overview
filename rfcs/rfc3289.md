...
`   `[`2.1`](#section-2-1)`. Relationship to the Informal Management Model for`

`        Differentiated Services Router`

`   `[`2`](#section-2)`. 2 Relationship to other MIBs and Policy Management`

`   3 MIB Overview`

`   `[`3`](#section-3)`. 1 Processing Path`

`   `[`3.1`](#section-3-1)`. 1 diffServDataPathTable - The Data Path Table`

`   `[`3`](#section-3)`. 2 Classifier`

`   `[`3.2`](#section-3-2)`. 1 diffServClfrElementTable - The Classifier Element Table`

`   `[`3.2`](#section-3-2)`. 2 diffServMultiFieldClfrTable - The Multi-field Classifier`

`        Table`

`   `[`3`](#section-3)`. 3 Metering Traffic`

`   `[`3.3`](#section-3-3)`. 1 diffServMeterTable - The Meter Table`

`   `[`3.3`](#section-3-3)`. 2 diffServTBParamTable - The Token Bucket Parameters Table`

`   `[`3`](#section-3)`. 4 Actions applied to packets`

`   `[`3.4`](#section-3-4)`. 1 diffServActionTable - The Action Table`

`   `[`3.4`](#section-3-4)`. 2 diffServCountActTable - The Count Action Table`

`   `[`3.4`](#section-3-4)`. 3 diffServDscpMarkActTable - The Mark Action Table`

`   `[`3.4`](#section-3-4)`. 4 diffServAlgDropTable - The Algorithmic Drop Table`

`   `[`3.4`](#section-3-4)`. 5 diffServRandomDropTable - The Random Drop Parameters Table   14`

`   `[`3`](#section-3)`. 5 Queuing and Scheduling of Packets`

`   `[`3.5`](#section-3-5)`. 1 diffServQTable - The Class or Queue Table`

`   `[`3.5`](#section-3-5)`. 2 diffServSchedulerTable - The Scheduler Table`

`   `[`3.5`](#section-3-5)`. 3 diffServMinRateTable - The Minimum Rate Table`

`   `[`3.5`](#section-3-5)`. 4 diffServMaxRateTable - The Maximum Rate Table`

`   `[`3.5`](#section-3-5)`. 5 Using queues and schedulers together`

`   `[`3`](#section-3)`. 6 Example configuration for AF and EF`

`   `[`3.6`](#section-3-6)`. 1 AF and EF Ingress Interface Configuration`

`   `[`3.6.1`](#section-3-6-1)`. 1 Classification In The Example`

`   `[`3.6.1`](#section-3-6-1)`. 2 AF Implementation On an Ingress Edge Interface`

`   `[`3.6.1.2`](#section-3-6-1-2)`. 1 AF Metering On an Ingress Edge Interface`

`   `[`3.6.1.2`](#section-3-6-1-2)`. 2 AF Actions On an Ingress Edge Interface`

`   `[`3.6.1`](#section-3-6-1)`. 3 EF Implementation On an Ingress Edge Interface`

`   `[`3.6.1.3`](#section-3-6-1-3)`. 1 EF Metering On an Ingress Edge Interface`

`   `[`3.6.1.3`](#section-3-6-1-3)`. 2 EF Actions On an Ingress Edge Interface`

`   `[`3`](#section-3)`. 7 AF and EF Egress Edge Interface Configuration`

`   `[`3.7`](#section-3-7)`. 1 Classification On an Egress Edge Interface`

`   `[`3.7`](#section-3-7)`. 2 AF Implementation On an Egress Edge Interface`

`   `[`3.7.2`](#section-3-7-2)`. 1 AF Metering On an Egress Edge Interface`

`   `[`3.7.2`](#section-3-7-2)`. 2 AF Actions On an Egress Edge Interface`

`   `[`3.7.2`](#section-3-7-2)`. 3 AF Rate-based Queuing On an Egress Edge Interface`

`   `[`3.7`](#section-3-7)`. 3 EF Implementation On an Egress Edge Interface`

`   `[`3.7.3`](#section-3-7-3)`. 1 EF Metering On an Egress Edge Interface`

`   `[`3.7.3`](#section-3-7-3)`. 2 EF Actions On an Egress Edge Interface`

`   `[`3.7.3`](#section-3-7-3)`. 3 EF Priority Queuing On an Egress Edge Interface`

`   4 Conventions used in this MIB`

`   `[`4`](#section-4)`. 1 The use of RowPointer to indicate data path linkage`

`   `[`4`](#section-4)`. 2 The use of RowPointer to indicate parameters`

`   `[`4`](#section-4)`. 3 Conceptual row creation and deletion`
...
<a id="section-1"></a> **`1. The SNMP Management Framework`**
...
<a id="section-2"></a> **`2. Relationship to other working group documents`**
...
<a id="section-2-1"></a> **`2.1. Relationship to the Informal Management Model for Differentiated`**
...
<a id="section-2-2"></a> **`2.2. Relationship to other MIBs and Policy Management`**
...
<a id="section-3"></a> **`3. MIB Overview`**
...
<a id="section-3-1"></a> **`3.1. Processing Path`**
...
<a id="section-3-1-1"></a> **`3.1.1. diffServDataPathTable - The Data Path Table`**
...
<a id="section-3-2"></a> **`3.2. Classifier`**
...
<a id="section-3-2-1"></a> **`3.2.1. diffServClfrElementTable - The Classifier Element Table`**
...
<a id="section-3-2-2"></a> **`3.2.2. diffServMultiFieldClfrTable - The Multi-field Classifier Table`**
...
<a id="section-3-3"></a> **`3.3. Metering Traffic`**
...
<a id="section-3-3-1"></a> **`3.3.1. diffServMeterTable - The Meter Table`**
...
<a id="section-3-3-2"></a> **`3.3.2. diffServTBParamTable - The Token Bucket Parameters Table`**
...
<a id="section-3-4"></a> **`3.4. Actions applied to packets`**
...
<a id="section-3-4-1"></a> **`3.4.1. diffServActionTable - The Action Table`**
...
<a id="section-3-4-2"></a> **`3.4.2. diffServCountActTable - The Count Action Table`**
...
<a id="section-3-4-3"></a> **`3.4.3. diffServDscpMarkActTable - The Mark Action Table`**
...
<a id="section-3-4-4"></a> **`3.4.4. diffServAlgDropTable - The Algorithmic Drop Table`**
...
<a id="section-3-4-5"></a> **`3.4.5. diffServRandomDropTable - The Random Drop Parameters Table`**
...
<a id="section-3-5"></a> **`3.5. Queuing and Scheduling of Packets`**
...
<a id="section-3-5-1"></a> **`3.5.1. diffServQTable - The Class or Queue Table`**
...
<a id="section-3-5-2"></a> **`3.5.2. diffServSchedulerTable - The Scheduler Table`**
...
<a id="section-3-5-3"></a> **`3.5.3. diffServMinRateTable - The Minimum Rate Table`**
...
<a id="section-3-5-4"></a> **`3.5.4. diffServMaxRateTable - The Maximum Rate Table`**
...
<a id="section-3-5-5"></a> **`3.5.5. Using queues and schedulers together`**
...
<a id="section-3-6"></a> **`3.6. Example configuration for AF and EF`**
...
<a id="section-3-6-1"></a> **`3.6.1. AF and EF Ingress Interface Configuration`**
...
<a id="section-3-6-1-1"></a> **`3.6.1.1. Classification In The Example`**
...
<a id="section-3-6-1-2"></a> **`3.6.1.2. AF Implementation On an Ingress Edge Interface`**
...
<a id="section-3-6-1-2-1"></a> **`3.6.1.2.1. AF Metering On an Ingress Edge Interface`**
...
<a id="section-3-6-1-2-2"></a> **`3.6.1.2.2. AF Actions On an Ingress Edge Interface`**
...
<a id="section-3-6-1-3"></a> **`3.6.1.3. EF Implementation On an Ingress Edge Interface`**
...
<a id="section-3-6-1-3-1"></a> **`3.6.1.3.1. EF Metering On an Ingress Edge Interface`**
...
<a id="section-3-6-1-3-2"></a> **`3.6.1.3.2. EF Actions On an Ingress Edge Interface`**
...
<a id="section-3-7"></a> **`3.7. AF and EF Egress Edge Interface Configuration`**

```text

```

<a id="section-3-7-1"></a> **`3.7.1. Classification On an Egress Edge Interface`**
...
<a id="section-3-7-2"></a> **`3.7.2. AF Implementation On an Egress Edge Interface`**
...
<a id="section-3-7-2-1"></a> **`3.7.2.1. AF Metering On an Egress Edge Interface`**
...
<a id="section-3-7-2-2"></a> **`3.7.2.2. AF Actions On an Egress Edge Interface`**
...
<a id="section-3-7-2-3"></a> **`3.7.2.3. AF Rate-based Queuing On an Egress Edge Interface`**
...
<a id="section-3-7-3"></a> **`3.7.3. EF Implementation On an Egress Edge Interface`**
...
<a id="section-3-7-3-1"></a> **`3.7.3.1. EF Metering On an Egress Edge Interface`**
...
<a id="section-3-7-3-2"></a> **`3.7.3.2. EF Actions On an Egress Edge Interface`**
...
<a id="section-3-7-3-3"></a> **`3.7.3.3. EF Priority Queuing On an Egress Edge Interface`**
...
<a id="section-4"></a> **`4. Conventions used in this MIB`**

```text

```

<a id="section-4-1"></a> **`4.1. The use of RowPointer to indicate data path linkage`**
...
<a id="section-4-2"></a> **`4.2. The use of RowPointer to indicate parameters`**
...
<a id="section-4-3"></a> **`4.3. Conceptual row creation and deletion`**
...
<a id="section-5"></a> **`5. Extending this MIB`**
...
<a id="section-6"></a> **`6. MIB Definition`**
...
<a id="section-9"></a> **`9. Intellectual Property Rights`**
