...
`     `[`1.1`](#section-1-1)`. Choice of IP Header Fields for Hash Input`

`     `[`1.2`](#section-1-2)`. Flow Label Rules`

`   `[`2`](#section-2)`. Normative Notation`

`   `[`3`](#section-3)`. Guidelines`
...
<a id="section-1-1"></a> **`1.1. Choice of IP Header Fields for Hash Input`**
...
<a id="section-1-2"></a> **`1.2. Flow Label Rules`**
...
<a id="section-2"></a> **`2. Normative Notation`**
