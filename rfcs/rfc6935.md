...
`     `[`4.1`](#section-4-1)`. Analysis of Corruption in Tunnel Context`

`     `[`4.2`](#section-4-2)`. Limitation to Tunnel Protocols`

`     `[`4.3`](#section-4-3)`. Middleboxes`

`   `[`5`](#section-5)`. The Zero UDP Checksum Update`

`   `[`6`](#section-6)`. Additional Observations`
...
<a id="section-4-1"></a> **`4.1. Analysis of Corruption in Tunnel Context`**
...
<a id="section-4-2"></a> **`4.2. Limitation to Tunnel Protocols`**
...
<a id="section-4-3"></a> **`4.3. Middleboxes`**
...
<a id="section-5"></a> **`5. The Zero UDP Checksum Update`**
...
<a id="section-6"></a> **`6. Additional Observations`**
