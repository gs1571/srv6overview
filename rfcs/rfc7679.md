...
`   `[`2`](#section-2)`. General Issues regarding Time`

`   `[`3`](#section-3)`. A Singleton Definition for One-Way Delay`

`      `[`3.1`](#section-3-1)`. Metric Name`

`      `[`3.2`](#section-3-2)`. Metric Parameters`

`      `[`3.3`](#section-3-3)`. Metric Units`

`      `[`3.4`](#section-3-4)`. Definition`

`      `[`3.5`](#section-3-5)`. Discussion`

`      `[`3.6`](#section-3-6)`. Methodologies`

`      `[`3.7`](#section-3-7)`. Errors and Uncertainties`

`           `[`3.7.1`](#section-3-7-1)`. Errors or Uncertainties Related to Clocks`

`           `[`3.7.2`](#section-3-7-2)`. Errors or Uncertainties Related to Wire`

`                  Time vs. Host Time`

`           `[`3.7.3`](#section-3-7-3)`. Calibration of Errors and Uncertainties`

`      `[`3.8`](#section-3-8)`. Reporting the Metric`

`           `[`3.8.1`](#section-3-8-1)`. Type-P`

`           `[`3.8.2`](#section-3-8-2)`. Loss Threshold`

`           `[`3.8.3`](#section-3-8-3)`. Calibration Results`

`           `[`3.8.4`](#section-3-8-4)`. Path`

`   `[`4`](#section-4)`. A Definition for Samples of One-Way Delay`

`      `[`4.1`](#section-4-1)`. Metric Name`

`      `[`4.2`](#section-4-2)`. Metric Parameters`

`      `[`4.3`](#section-4-3)`. Metric Units`

`      `[`4.4`](#section-4-4)`. Definition`

`      `[`4.5`](#section-4-5)`. Discussion`

`      `[`4.6`](#section-4-6)`. Methodologies`

`      `[`4.7`](#section-4-7)`. Errors and Uncertainties`

`      `[`4.8`](#section-4-8)`. Reporting the Metric`

`   `[`5`](#section-5)`. Some Statistics Definitions for One-Way Delay`

`      `[`5.1`](#section-5-1)`. Type-P-One-way-Delay-Percentile`

`      `[`5.2`](#section-5-2)`. Type-P-One-way-Delay-Median`

`      `[`5.3`](#section-5-3)`. Type-P-One-way-Delay-Minimum`

`      `[`5.4`](#section-5-4)`. Type-P-One-way-Delay-Inverse-Percentile`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Changes from RFC 2679`
...
<a id="section-2"></a> **`2. General Issues regarding Time`**
...
<a id="section-3"></a> **`3. A Singleton Definition for One-Way Delay`**
...
<a id="section-3-2"></a> **`3.2. Metric Parameters`**
...
<a id="section-3-6"></a> **`3.6. Methodologies`**
...
<a id="section-3-7-1"></a> **`3.7.1. Errors or Uncertainties Related to Clocks`**
...
<a id="section-3-7-2"></a> **`3.7.2. Errors or Uncertainties Related to Wire Time vs. Host Time`**
...
<a id="section-3-7-3"></a> **`3.7.3. Calibration of Errors and Uncertainties`**
...
<a id="section-3-8"></a> **`3.8. Reporting the Metric`**
...
<a id="section-3-8-1"></a> **`3.8.1. Type-P`**
...
<a id="section-3-8-2"></a> **`3.8.2. Loss Threshold`**
...
<a id="section-3-8-3"></a> **`3.8.3. Calibration Results`**
...
<a id="section-3-8-4"></a> **`3.8.4. Path`**
...
<a id="section-4"></a> **`4. A Definition for Samples of One-Way Delay`**
...
<a id="section-4-1"></a> **`4.1. Metric Name`**
...
<a id="section-4-2"></a> **`4.2. Metric Parameters`**
...
<a id="section-4-3"></a> **`4.3. Metric Units`**
...
<a id="section-4-4"></a> **`4.4. Definition`**
...
<a id="section-4-5"></a> **`4.5. Discussion`**
...
<a id="section-4-6"></a> **`4.6. Methodologies`**
...
<a id="section-4-7"></a> **`4.7. Errors and Uncertainties`**
...
<a id="section-4-8"></a> **`4.8. Reporting the Metric`**
...
<a id="section-5"></a> **`5. Some Statistics Definitions for One-Way Delay`**
...
<a id="section-5-1"></a> **`5.1. Type-P-One-way-Delay-Percentile`**
...
<a id="section-5-2"></a> **`5.2. Type-P-One-way-Delay-Median`**
...
<a id="section-5-3"></a> **`5.3. Type-P-One-way-Delay-Minimum`**
...
<a id="section-5-4"></a> **`5.4. Type-P-One-way-Delay-Inverse-Percentile`**
...
<a id="section-7"></a> **`7. Changes from RFC 2679`**
