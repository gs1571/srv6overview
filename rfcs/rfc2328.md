...
`    `[`1.2`](#section-1-2)`. Definitions of commonly used terms`

`    `[`1.3`](#section-1-3)`. Brief history of link-state routing technology`

`    `[`1.4`](#section-1-4)`. Organization of this document`

`    `[`1.5`](#section-1-5)`. Acknowledgments`

`    `[`2`](#section-2)`. The link-state database: organization and calculations  13`

`    `[`2.1`](#section-2-1)`. Representation of routers and networks`

`    `[`2.1.1`](#section-2-1-1)`. Representation of non-broadcast networks`

`    `[`2.1.2`](#section-2-1-2)`. An example link-state database`

`    `[`2.2`](#section-2-2)`. The shortest-path tree`

`    `[`2.3`](#section-2-3)`. Use of external routing information`

`    `[`2.4`](#section-2-4)`. Equal-cost multipath`

`    `[`3`](#section-3)`. Splitting the AS into Areas`

`    `[`3.1`](#section-3-1)`. The backbone of the Autonomous System`

`    `[`3.2`](#section-3-2)`. Inter-area routing`

`    `[`3.3`](#section-3-3)`. Classification of routers`

`    `[`3.4`](#section-3-4)`. A sample area configuration`

`    `[`3.5`](#section-3-5)`. IP subnetting support`

`    `[`3.6`](#section-3-6)`. Supporting stub areas`

`    `[`3.7`](#section-3-7)`. Partitions of areas`

`    `[`4`](#section-4)`. Functional Summary`

`    `[`4.1`](#section-4-1)`. Inter-area routing`

`    `[`4.2`](#section-4-2)`. AS external routes`

`    `[`4.3`](#section-4-3)`. Routing protocol packets`

`    `[`4.4`](#section-4-4)`. Basic implementation requirements`

`    `[`4.5`](#section-4-5)`. Optional OSPF capabilities`

`    `[`5`](#section-5)`. Protocol data structures`

`    `[`6`](#section-6)`. The Area Data Structure`

`    `[`7`](#section-7)`. Bringing Up Adjacencies`

`    `[`7.1`](#section-7-1)`. The Hello Protocol`

`    `[`7.2`](#section-7-2)`. The Synchronization of Databases`

`    `[`7.3`](#section-7-3)`. The Designated Router`

`    `[`7.4`](#section-7-4)`. The Backup Designated Router`

`    `[`7.5`](#section-7-5)`. The graph of adjacencies`

`    `[`8`](#section-8)`. Protocol Packet Processing`

`    `[`8.1`](#section-8-1)`. Sending protocol packets`

`    `[`8.2`](#section-8-2)`. Receiving protocol packets`

`    `[`9`](#section-9)`. The Interface Data Structure`

`    `[`9.1`](#section-9-1)`. Interface states`

`    `[`9.2`](#section-9-2)`. Events causing interface state changes`

`    `[`9.3`](#section-9-3)`. The Interface state machine`

`    `[`9.4`](#section-9-4)`. Electing the Designated Router`

`    `[`9.5`](#section-9-5)`. Sending Hello packets`

`    `[`9.5.1`](#section-9-5-1)`. Sending Hello packets on NBMA networks`

`    `[`10`](#section-10)`. The Neighbor Data Structure`

`    `[`10.1`](#section-10-1)`. Neighbor states`

`    `[`10.2`](#section-10-2)`. Events causing neighbor state changes`

`    `[`10.3`](#section-10-3)`. The Neighbor state machine`

`    `[`10.4`](#section-10-4)`. Whether to become adjacent`

`    `[`10.5`](#section-10-5)`. Receiving Hello Packets`

`    `[`10.6`](#section-10-6)`. Receiving Database Description Packets`

`    `[`10.7`](#section-10-7)`. Receiving Link State Request Packets`

`    `[`10.8`](#section-10-8)`. Sending Database Description Packets`

`    `[`10.9`](#section-10-9)`. Sending Link State Request Packets`

`    `[`10.10`](#section-10-10)`. An Example`

`    `[`11`](#section-11)`. The Routing Table Structure`

`    `[`11.1`](#section-11-1)`. Routing table lookup`

`    `[`11.2`](#section-11-2)`. Sample routing table, without areas`

`    `[`11.3`](#section-11-3)`. Sample routing table, with areas`

`    `[`12`](#section-12)`. Link State Advertisements (LSAs)`

`    `[`12.1`](#section-12-1)`. The LSA Header`

`    `[`12.1.1`](#section-12-1-1)`. LS age`

`    `[`12.1.2`](#section-12-1-2)`. Options`

`    `[`12.1.3`](#section-12-1-3)`. LS type`

`    `[`12.1.4`](#section-12-1-4)`. Link State ID`

`    `[`12.1.5`](#section-12-1-5)`. Advertising Router`

`    `[`12.1.6`](#section-12-1-6)`. LS sequence number`

`    `[`12.1.7`](#section-12-1-7)`. LS checksum`

`    `[`12.2`](#section-12-2)`. The link state database`

`    `[`12.3`](#section-12-3)`. Representation of TOS`

`    `[`12.4`](#section-12-4)`. Originating LSAs`

`    `[`12.4.1`](#section-12-4-1)`. Router-LSAs`

`    `[`12.4.1`](#section-12-4-1)`. 1 Describing point-to-point interfaces`

`    `[`12.4.1`](#section-12-4-1)`. 2 Describing broadcast and NBMA interfaces`

`    `[`12.4.1`](#section-12-4-1)`. 3 Describing virtual links`

`    `[`12.4.1`](#section-12-4-1)`. 4 Describing Point-to-MultiPoint interfaces`

`    `[`12.4.1`](#section-12-4-1)`. 5 Examples of router-LSAs`

`    `[`12.4.2`](#section-12-4-2)`. Network-LSAs`

`    `[`12.4.2`](#section-12-4-2)`. 1 Examples of network-LSAs`

`    `[`12.4.3`](#section-12-4-3)`. Summary-LSAs`

`    `[`12.4.3`](#section-12-4-3)`. 1 Originating summary-LSAs into stub areas`

`    `[`12.4.3`](#section-12-4-3)`. 2 Examples of summary-LSAs`

`    `[`12.4.4`](#section-12-4-4)`. AS-external-LSAs`

`    `[`12.4.4`](#section-12-4-4)`. 1 Examples of AS-external-LSAs`

`    `[`13`](#section-13)`. The Flooding Procedure`

`    `[`13.1`](#section-13-1)`. Determining which LSA is newer`

`    `[`13.2`](#section-13-2)`. Installing LSAs in the database`

`    `[`13.3`](#section-13-3)`. Next step in the flooding procedure`

`    `[`13.4`](#section-13-4)`. Receiving self-originated LSAs`

`    `[`13.5`](#section-13-5)`. Sending Link State Acknowledgment packets`

`    `[`13.6`](#section-13-6)`. Retransmitting LSAs`

`    `[`13.7`](#section-13-7)`. Receiving link state acknowledgments`

`    `[`14`](#section-14)`. Aging The Link State Database`

`    `[`14.1`](#section-14-1)`. Premature aging of LSAs`

`    `[`15`](#section-15)`. Virtual Links`

`    `[`16`](#section-16)`. Calculation of the routing table`

`    `[`16.1`](#section-16-1)`. Calculating the shortest-path tree for an area`

`    `[`16.1.1`](#section-16-1-1)`. The next hop calculation`

`    `[`16.2`](#section-16-2)`. Calculating the inter-area routes`

`    `[`16.3`](#section-16-3)`. Examining transit areas' summary-LSAs`

`    `[`16.4`](#section-16-4)`. Calculating AS external routes`

`    `[`16.4.1`](#section-16-4-1)`. External path preferences`

`    `[`16.5`](#section-16-5)`. Incremental updates -- summary-LSAs`

`    `[`16.6`](#section-16-6)`. Incremental updates -- AS-external-LSAs`

`    `[`16.7`](#section-16-7)`. Events generated as a result of routing table changes  177`

`    `[`16.8`](#section-16-8)`. Equal-cost multipath`
...
<a id="section-2"></a> **`2. The Link-state Database: organization and calculations`**
...
<a id="section-3"></a> **`3. Splitting the AS into Areas`**
...
<a id="section-4"></a> **`4. Functional Summary`**
...
<a id="section-5"></a> **`5. Protocol Data Structures`**
...
<a id="section-6"></a> **`6. The Area Data Structure`**
...
<a id="section-7"></a> **`7. Bringing Up Adjacencies`**
...
<a id="section-8"></a> **`8. Protocol Packet Processing`**
...
<a id="section-9"></a> **`9. The Interface Data Structure`**
...
<a id="section-10"></a> **`10. The Neighbor Data Structure`**
...
<a id="section-11"></a> **`11. The Routing Table Structure`**
...
<a id="section-12"></a> **`12. Link State Advertisements (LSAs)`**
...
<a id="section-13"></a> **`13. The Flooding Procedure`**
...
<a id="section-14"></a> **`14. Aging The Link State Database`**
...
<a id="section-15"></a> **`15. Virtual Links`**
...
<a id="section-16"></a> **`16. Calculation of the routing table`**
