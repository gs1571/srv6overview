...
<a id="section-2"></a> **`2. Design Criteria`**
...
<a id="section-3"></a> **`3. Route Reflection`**
...
<a id="section-4"></a> **`4. Terminology and Concepts`**
...
<a id="section-6"></a> **`6. Redundant RRs`**
...
<a id="section-7"></a> **`7. Avoiding Routing Information Loops`**
...
<a id="section-9"></a> **`9. Configuration and Deployment Considerations`**
