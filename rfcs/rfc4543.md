...
`   `[`2`](#section-2)`. AES-GMAC`

`   `[`3`](#section-3)`. The Use of AES-GMAC in ESP`

`      `[`3.1`](#section-3-1)`. Initialization Vector`

`      `[`3.2`](#section-3-2)`. Nonce Format`

`      `[`3.3`](#section-3-3)`. AAD Construction`

`      `[`3.4`](#section-3-4)`. Integrity Check Value (ICV)`

`      `[`3.5`](#section-3-5)`. Differences with AES-GCM-ESP`

`      `[`3.6`](#section-3-6)`. Packet Expansion`

`   `[`4`](#section-4)`. The Use of AES-GMAC in AH`

`   `[`5`](#section-5)`. IKE Conventions`

`      `[`5.1`](#section-5-1)`. Phase 1 Identifier`

`      `[`5.2`](#section-5-2)`. Phase 2 Identifier`

`      `[`5.3`](#section-5-3)`. Key Length Attribute`

`      `[`5.4`](#section-5-4)`. Keying Material and Salt Values`
...
<a id="section-3"></a> **`3. The Use of AES-GMAC in ESP`**
...
<a id="section-3-2"></a> **`3.2. Nonce Format`**
...
<a id="section-3-3"></a> **`3.3. AAD Construction`**
...
<a id="section-3-4"></a> **`3.4. Integrity Check Value (ICV)`**
...
<a id="section-3-5"></a> **`3.5. Differences with AES-GCM-ESP`**
...
<a id="section-3-6"></a> **`3.6. Packet Expansion`**
...
<a id="section-4"></a> **`4. The Use of AES-GMAC in AH`**
...
<a id="section-5-1"></a> **`5.1. Phase 1 Identifier`**
...
<a id="section-5-2"></a> **`5.2. Phase 2 Identifier`**
...
<a id="section-5-3"></a> **`5.3. Key Length Attribute`**
...
<a id="section-5-4"></a> **`5.4. Keying Material and Salt Values`**
