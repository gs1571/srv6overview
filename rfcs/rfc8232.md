...
`   `[`3`](#section-3)`. State Synchronization Avoidance`

`      `[`3.1`](#section-3-1)`. Motivation`

`      `[`3.2`](#section-3-2)`. State Synchronization Avoidance Procedure`

`           `[`3.2.1`](#section-3-2-1)`. IP Address Change during Session Re-establishment`

`      `[`3.3`](#section-3-3)`. PCEP Extensions`

`           `[`3.3.1`](#section-3-3-1)`. LSP-DB Version Number TLV`

`           `[`3.3.2`](#section-3-3-2)`. Speaker Entity Identifier TLV`

`   `[`4`](#section-4)`. Incremental State Synchronization`

`      `[`4.1`](#section-4-1)`. Motivation`

`      `[`4.2`](#section-4-2)`. Incremental Synchronization Procedure`

`   `[`5`](#section-5)`. PCE-Triggered Initial Synchronization`

`      `[`5.1`](#section-5-1)`. Motivation`

`      `[`5.2`](#section-5-2)`. PCE-Triggered Initial State Synchronization Procedure`

`   `[`6`](#section-6)`. PCE-Triggered Resynchronization`

`      `[`6.1`](#section-6-1)`. Motivation`

`      `[`6.2`](#section-6-2)`. PCE-Triggered State Resynchronization Procedure`

`   `[`7`](#section-7)`. Advertising Support of Synchronization Optimizations`

`   `[`8`](#section-8)`. IANA Considerations`

`      `[`8.1`](#section-8-1)`. PCEP-Error Object`

`      `[`8.2`](#section-8-2)`. PCEP TLV Type Indicators`

`      `[`8.3`](#section-8-3)`. STATEFUL-PCE-CAPABILITY TLV`
...
<a id="section-3"></a> **`3. State Synchronization Avoidance`**
...
<a id="section-3-2"></a> **`3.2. State Synchronization Avoidance Procedure`**
...
<a id="section-3-2-1"></a> **`3.2.1. IP Address Change during Session Re-establishment`**
...
<a id="section-3-3"></a> **`3.3. PCEP Extensions`**
...
<a id="section-3-3-1"></a> **`3.3.1. LSP-DB Version Number TLV`**
...
<a id="section-3-3-2"></a> **`3.3.2. Speaker Entity Identifier TLV`**
...
<a id="section-4"></a> **`4. Incremental State Synchronization`**
...
<a id="section-4-1"></a> **`4.1. Motivation`**
...
<a id="section-4-2"></a> **`4.2. Incremental Synchronization Procedure`**
...
<a id="section-5"></a> **`5. PCE-Triggered Initial Synchronization`**

```text

```

<a id="section-5-1"></a> **`5.1. Motivation`**
...
<a id="section-5-2"></a> **`5.2. PCE-Triggered Initial State Synchronization Procedure`**
...
<a id="section-6"></a> **`6. PCE-Triggered Resynchronization`**

```text

```

<a id="section-6-1"></a> **`6.1. Motivation`**
...
<a id="section-6-2"></a> **`6.2. PCE-Triggered State Resynchronization Procedure`**
...
<a id="section-7"></a> **`7. Advertising Support of Synchronization Optimizations`**
...
<a id="section-8-1"></a> **`8.1. PCEP-Error Object`**
...
<a id="section-8-2"></a> **`8.2. PCEP TLV Type Indicators`**
...
<a id="section-8-3"></a> **`8.3. STATEFUL-PCE-CAPABILITY TLV`**
