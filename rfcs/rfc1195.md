...
`    `[`1`](#section-1)`. Introduction: Overview of the Protocol`

`        `[`1.1`](#section-1-1)`. What the Integrated IS-IS offers`

`        `[`1.2`](#section-1-2)`. Overview of the ISO IS-IS Protocol`

`        `[`1.3`](#section-1-3)`. Overview of the Integrated IS-IS`

`        `[`1.4`](#section-1-4)`. Support of Mixed Routing Domains`

`        `[`1.5`](#section-1-5)`. Advantages of Using Integrated IS-IS`

`    `[`2`](#section-2)`. Symbols and Abbreviations`

`    `[`3`](#section-3)`. Subnetwork Independent Functions`

`        `[`3.1`](#section-3-1)`. Exchange of Routing Information`

`        `[`3.2`](#section-3-2)`. Hierarchical Abbreviation of IP Reachability Information`

`        `[`3.3`](#section-3-3)`. Addressing Routers in IS-IS Packets`

`        `[`3.4`](#section-3-4)`. External Links`

`        `[`3.5`](#section-3-5)`. Type of Service Routing`

`        `[`3.6`](#section-3-6)`. Multiple LSPs and SNPs`

`        `[`3.7`](#section-3-7)`. IP-Only Operation`

`        `[`3.8`](#section-3-8)`. Encapsulation`

`        `[`3.9`](#section-3-9)`. Authentication`

`        `[`3.10`](#section-3-10)`. Order of Preference of Routes / Dijkstra Computation`

`    `[`4`](#section-4)`. Subnetwork Dependent Functions`

`        `[`4.1`](#section-4-1)`. Link Demultiplexing`

`        `[`4.2`](#section-4-2)`. Multiple IP Addresses per Interface`

`        `[`4.3`](#section-4-3)`. LANs, Designated Routers, and Pseudonodes`

`        `[`4.4`](#section-4-4)`. Maintaining Router Adjacencies`

`        `[`4.5`](#section-4-5)`. Forwarding to Incompatible Routers`

`    `[`5`](#section-5)`. Structure and Encoding of PDUs`

`        `[`5.1`](#section-5-1)`. Overview of IS-IS PDUs`

`        `[`5.2`](#section-5-2)`. Overview of IP-Specific Information for IS-IS`

`        `[`5.3`](#section-5-3)`. Encoding of IP-Specific Fields in IS-IS PDUs`

`    `[`6`](#section-6)`. Security Considerations`

`    `[`7`](#section-7)`. Author's Address`
