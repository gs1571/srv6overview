...
`     `[`1.1`](#section-1-1)`. Requirement for a Standardized Text Stream Format`

`     `[`1.2`](#section-1-2)`. Terminology`

`   `[`2`](#section-2)`. Net-Unicode Definition`

`   `[`3`](#section-3)`. Normalization`

`   `[`4`](#section-4)`. Versions of Unicode`

`   `[`5`](#section-5)`. Applicability and Stability of this Specification`

`     `[`5.1`](#section-5-1)`. Use in IETF Applications Specifications`

`     `[`5.2`](#section-5-2)`. Unicode Versions and Applicability`
...
<a id="section-1-1"></a> **`1.1. Requirement for a Standardized Text Stream Format`**
...
<a id="section-2"></a> **`2. Net-Unicode Definition`**
...
<a id="section-3"></a> **`3. Normalization`**
...
<a id="section-4"></a> **`4. Versions of Unicode`**
...
<a id="section-5"></a> **`5. Applicability and Stability of this Specification`**

```text

```

<a id="section-5-1"></a> **`5.1. Use in IETF Applications Specifications`**
...
<a id="section-5-2"></a> **`5.2. Unicode Versions and Applicability`**
