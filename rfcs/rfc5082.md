...
`   `[`2`](#section-2)`. Assumptions Underlying GTSM`

`     `[`2.1`](#section-2-1)`. GTSM Negotiation`

`     `[`2.2`](#section-2-2)`. Assumptions on Attack Sophistication`

`   `[`3`](#section-3)`. GTSM Procedure`

`   `[`4`](#section-4)`. Acknowledgments`

`   `[`5`](#section-5)`. Security Considerations`

`     `[`5.1`](#section-5-1)`. TTL (Hop Limit) Spoofing`

`     `[`5.2`](#section-5-2)`. Tunneled Packets`

`       `[`5.2.1`](#section-5-2-1)`. IP Tunneled over IP`

`       `[`5.2.2`](#section-5-2-2)`. IP Tunneled over MPLS`

`     `[`5.3`](#section-5-3)`. Onlink Attackers`

`     `[`5.4`](#section-5-4)`. Fragmentation Considerations`

`     `[`5.5`](#section-5-5)`. Multi-Hop Protocol Sessions`

`   `[`6`](#section-6)`. Applicability Statement`

`     `[`6.1`](#section-6-1)`. Backwards Compatibility`
...
<a id="section-2"></a> **`2. Assumptions Underlying GTSM`**
...
<a id="section-2-1"></a> **`2.1. GTSM Negotiation`**
...
<a id="section-2-2"></a> **`2.2. Assumptions on Attack Sophistication`**
...
<a id="section-3"></a> **`3. GTSM Procedure`**
...
<a id="section-5-1"></a> **`5.1. TTL (Hop Limit) Spoofing`**
...
<a id="section-5-2"></a> **`5.2. Tunneled Packets`**
...
<a id="section-5-2-1"></a> **`5.2.1. IP Tunneled over IP`**
...
<a id="section-5-2-2"></a> **`5.2.2. IP Tunneled over MPLS`**
...
<a id="section-5-3"></a> **`5.3. Onlink Attackers`**
...
<a id="section-5-4"></a> **`5.4. Fragmentation Considerations`**
...
<a id="section-5-5"></a> **`5.5. Multi-Hop Protocol Sessions`**
...
<a id="section-6"></a> **`6. Applicability Statement`**
...
<a id="section-6-1"></a> **`6.1. Backwards Compatibility`**
