...
`        `[`1.3`](#section-1-3)`. Applicability`

`   `[`2`](#section-2)`. Extensible Authentication Protocol (EAP)`

`        `[`2.1`](#section-2-1)`. Support for Sequences`

`        `[`2.2`](#section-2-2)`. EAP Multiplexing Model`

`        `[`2.3`](#section-2-3)`. Pass-Through Behavior`

`        `[`2.4`](#section-2-4)`. Peer-to-Peer Operation`

`   `[`3`](#section-3)`. Lower Layer Behavior`

`        `[`3.1`](#section-3-1)`. Lower Layer Requirements`

`        `[`3.2`](#section-3-2)`. EAP Usage Within PPP`

`              `[`3.2.1`](#section-3-2-1)`. PPP Configuration Option Format`

`        `[`3.3`](#section-3-3)`. EAP Usage Within IEEE 802`

`        `[`3.4`](#section-3-4)`. Lower Layer Indications`

`   `[`4`](#section-4)`. EAP Packet Format`

`        `[`4.1`](#section-4-1)`. Request and Response`

`        `[`4.2`](#section-4-2)`. Success and Failure`

`        `[`4.3`](#section-4-3)`. Retransmission Behavior`

`   `[`5`](#section-5)`. Initial EAP Request/Response Types`

`        `[`5.1`](#section-5-1)`. Identity`

`        `[`5.2`](#section-5-2)`. Notification`

`        `[`5.3`](#section-5-3)`. Nak`

`              `[`5.3.1`](#section-5-3-1)`. Legacy Nak`

`              `[`5.3.2`](#section-5-3-2)`. Expanded Nak`

`        `[`5.4`](#section-5-4)`. MD5-Challenge`

`        `[`5.5`](#section-5-5)`. One-Time Password (OTP)`

`        `[`5.6`](#section-5-6)`. Generic Token Card (GTC)`

`        `[`5.7`](#section-5-7)`. Expanded Types`

`        `[`5.8`](#section-5-8)`. Experimental`

`   `[`6`](#section-6)`. IANA Considerations`

`        `[`6.1`](#section-6-1)`. Packet Codes`

`        `[`6.2`](#section-6-2)`. Method Types`

`   `[`7`](#section-7)`. Security Considerations`

`        `[`7.1`](#section-7-1)`. Threat Model`

`        `[`7.2`](#section-7-2)`. Security Claims`

`              `[`7.2.1`](#section-7-2-1)`. Security Claims Terminology for EAP Methods`

`        `[`7.3`](#section-7-3)`. Identity Protection`

`        `[`7.4`](#section-7-4)`. Man-in-the-Middle Attacks`

`        `[`7.5`](#section-7-5)`. Packet Modification Attacks`

`        `[`7.6`](#section-7-6)`. Dictionary Attacks`

`        `[`7.7`](#section-7-7)`. Connection to an Untrusted Network`

`        `[`7.8`](#section-7-8)`. Negotiation Attacks`

`        `[`7.9`](#section-7-9)`. Implementation Idiosyncrasies`

`        `[`7.10`](#section-7-10)`. Key Derivation`

`        `[`7.11`](#section-7-11)`. Weak Ciphersuites`

`        `[`7.12`](#section-7-12)`. Link Layer`

`        `[`7.13`](#section-7-13)`. Separation of Authenticator and Backend Authentication`

`              Server`

`        `[`7.14`](#section-7-14)`. Cleartext Passwords`

`        `[`7.15`](#section-7-15)`. Channel Binding`

`        `[`7.16`](#section-7-16)`. Protected Result Indications`
...
<a id="section-1-3"></a> **`1.3. Applicability`**
...
<a id="section-2"></a> **`2. Extensible Authentication Protocol (EAP)`**
...
<a id="section-2-1"></a> **`2.1. Support for Sequences`**
...
<a id="section-2-2"></a> **`2.2. EAP Multiplexing Model`**
...
<a id="section-2-3"></a> **`2.3. Pass-Through Behavior`**
...
<a id="section-2-4"></a> **`2.4. Peer-to-Peer Operation`**
...
<a id="section-3"></a> **`3. Lower Layer Behavior`**

```text

```

<a id="section-3-1"></a> **`3.1. Lower Layer Requirements`**
...
<a id="section-3-2"></a> **`3.2. EAP Usage Within PPP`**
...
<a id="section-3-2-1"></a> **`3.2.1. PPP Configuration Option Format`**
...
<a id="section-3-3"></a> **`3.3. EAP Usage Within IEEE 802`**
...
<a id="section-3-4"></a> **`3.4. Lower Layer Indications`**
...
<a id="section-4"></a> **`4. EAP Packet Format`**
...
<a id="section-4-1"></a> **`4.1. Request and Response`**
...
<a id="section-4-2"></a> **`4.2. Success and Failure`**
...
<a id="section-4-3"></a> **`4.3. Retransmission Behavior`**
...
<a id="section-5"></a> **`5. Initial EAP Request/Response Types`**
...
<a id="section-5-1"></a> **`5.1. Identity`**
...
<a id="section-5-2"></a> **`5.2. Notification`**
...
<a id="section-5-3"></a> **`5.3. Nak`**

```text

```

<a id="section-5-3-1"></a> **`5.3.1. Legacy Nak`**
...
<a id="section-5-3-2"></a> **`5.3.2. Expanded Nak`**
...
<a id="section-5-4"></a> **`5.4. MD5-Challenge`**
...
<a id="section-5-5"></a> **`5.5. One-Time Password (OTP)`**
...
<a id="section-5-6"></a> **`5.6. Generic Token Card (GTC)`**
...
<a id="section-5-7"></a> **`5.7. Expanded Types`**
...
<a id="section-5-8"></a> **`5.8. Experimental`**
...
<a id="section-6-1"></a> **`6.1. Packet Codes`**
...
<a id="section-6-2"></a> **`6.2. Method Types`**
...
<a id="section-7-1"></a> **`7.1. Threat Model`**
...
<a id="section-7-2"></a> **`7.2. Security Claims`**
...
<a id="section-7-2-1"></a> **`7.2.1. Security Claims Terminology for EAP Methods`**
...
<a id="section-7-3"></a> **`7.3. Identity Protection`**
...
<a id="section-7-4"></a> **`7.4. Man-in-the-Middle Attacks`**
...
<a id="section-7-5"></a> **`7.5. Packet Modification Attacks`**
...
<a id="section-7-6"></a> **`7.6. Dictionary Attacks`**
...
<a id="section-7-7"></a> **`7.7. Connection to an Untrusted Network`**
...
<a id="section-7-8"></a> **`7.8. Negotiation Attacks`**
...
<a id="section-7-9"></a> **`7.9. Implementation Idiosyncrasies`**
...
<a id="section-7-10"></a> **`7.10. Key Derivation`**
...
<a id="section-7-11"></a> **`7.11. Weak Ciphersuites`**
...
<a id="section-7-12"></a> **`7.12. Link Layer`**
...
<a id="section-7-13"></a> **`7.13. Separation of Authenticator and Backend Authentication Server`**
...
<a id="section-7-14"></a> **`7.14. Cleartext Passwords`**
...
<a id="section-7-15"></a> **`7.15. Channel Binding`**
...
<a id="section-7-16"></a> **`7.16. Protected Result Indications`**
