...
`   `[`3`](#section-3)`. Acronyms`

`   `[`4`](#section-4)`. Topological Model for VPLS`

`      `[`4.1`](#section-4-1)`. Flooding and Forwarding`

`      `[`4.2`](#section-4-2)`. Address Learning`

`      `[`4.3`](#section-4-3)`. Tunnel Topology`

`      `[`4.4`](#section-4-4)`. Loop free VPLS`

`   `[`5`](#section-5)`. Discovery`

`   `[`6`](#section-6)`. Control Plane`

`      `[`6.1`](#section-6-1)`. LDP-Based Signaling of Demultiplexers`

`           `[`6.1.1`](#section-6-1-1)`. Using the Generalized PWid FEC Element`

`      `[`6.2`](#section-6-2)`. MAC Address Withdrawal`

`           `[`6.2.1`](#section-6-2-1)`. MAC List TLV`

`           `[`6.2.2`](#section-6-2-2)`. Address Withdraw Message Containing MAC List TLV`

`   `[`7`](#section-7)`. Data Forwarding on an Ethernet PW`

`      `[`7.1`](#section-7-1)`. VPLS Encapsulation Actions`

`      `[`7.2`](#section-7-2)`. VPLS Learning Actions`

`   `[`8`](#section-8)`. Data Forwarding on an Ethernet VLAN PW`

`      `[`8.1`](#section-8-1)`. VPLS Encapsulation Actions`

`   `[`9`](#section-9)`. Operation of a VPLS`

`      `[`9.1`](#section-9-1)`. MAC Address Aging`

`   `[`10`](#section-10)`. A Hierarchical VPLS Model`

`      `[`10.1`](#section-10-1)`. Hierarchical Connectivity`

`           `[`10.1.1`](#section-10-1-1)`. Spoke Connectivity for Bridging-Capable Devices`

`           `[`10.1.2`](#section-10-1-2)`. Advantages of Spoke Connectivity`

`           `[`10.1.3`](#section-10-1-3)`. Spoke Connectivity for Non-Bridging Devices`

`      `[`10.2`](#section-10-2)`. Redundant Spoke Connections`

`           `[`10.2.1`](#section-10-2-1)`. Dual-Homed MTU-s`

`           `[`10.2.2`](#section-10-2-2)`. Failure Detection and Recovery`

`      `[`10.3`](#section-10-3)`. Multi-domain VPLS Service`

`   `[`11`](#section-11)`. Hierarchical VPLS Model Using Ethernet Access Network`

`      `[`11.1`](#section-11-1)`. Scalability`

`      `[`11.2`](#section-11-2)`. Dual Homing and Failure Recovery`

`   `[`12`](#section-12)`. Contributors`
...
<a id="section-2-1"></a> **`2.1. Conventions`**
...
<a id="section-4"></a> **`4. Topological Model for VPLS`**
...
<a id="section-4-1"></a> **`4.1. Flooding and Forwarding`**
...
<a id="section-4-2"></a> **`4.2. Address Learning`**
...
<a id="section-4-3"></a> **`4.3. Tunnel Topology`**
...
<a id="section-4-4"></a> **`4.4. Loop free VPLS`**
...
<a id="section-6"></a> **`6. Control Plane`**
...
<a id="section-6-1"></a> **`6.1. LDP-Based Signaling of Demultiplexers`**
...
<a id="section-6-1-1"></a> **`6.1.1. Using the Generalized PWid FEC Element`**
...
<a id="section-6-2"></a> **`6.2. MAC Address Withdrawal`**
...
<a id="section-6-2-1"></a> **`6.2.1. MAC List TLV`**
...
<a id="section-6-2-2"></a> **`6.2.2. Address Withdraw Message Containing MAC List TLV`**
...
<a id="section-7"></a> **`7. Data Forwarding on an Ethernet PW`**
...
<a id="section-7-1"></a> **`7.1. VPLS Encapsulation Actions`**
...
<a id="section-7-2"></a> **`7.2. VPLS Learning Actions`**
...
<a id="section-8"></a> **`8. Data Forwarding on an Ethernet VLAN PW`**
...
<a id="section-8-1"></a> **`8.1. VPLS Encapsulation Actions`**
...
<a id="section-9"></a> **`9. Operation of a VPLS`**
...
<a id="section-9-1"></a> **`9.1. MAC Address Aging`**
...
<a id="section-10"></a> **`10. A Hierarchical VPLS Model`**
...
<a id="section-10-1"></a> **`10.1. Hierarchical Connectivity`**
...
<a id="section-10-1-1"></a> **`10.1.1. Spoke Connectivity for Bridging-Capable Devices`**
...
<a id="section-10-1-1-1"></a> **`10.1.1.1. MTU-s Operation`**
...
<a id="section-10-1-1-2"></a> **`10.1.1.2. PE-rs Operation`**
...
<a id="section-10-1-2"></a> **`10.1.2. Advantages of Spoke Connectivity`**
...
<a id="section-10-1-3"></a> **`10.1.3. Spoke Connectivity for Non-Bridging Devices`**
...
<a id="section-10-2"></a> **`10.2. Redundant Spoke Connections`**
...
<a id="section-10-2-1"></a> **`10.2.1. Dual-Homed MTU-s`**
...
<a id="section-10-2-2"></a> **`10.2.2. Failure Detection and Recovery`**
...
<a id="section-10-3"></a> **`10.3. Multi-domain VPLS Service`**
...
<a id="section-11"></a> **`11. Hierarchical VPLS Model Using Ethernet Access Network`**
...
<a id="section-11-1"></a> **`11.1. Scalability`**
...
<a id="section-11-2"></a> **`11.2. Dual Homing and Failure Recovery`**
...
<a id="section-12"></a> **`12. Contributors`**
