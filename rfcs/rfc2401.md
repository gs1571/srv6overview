...
`  `[`1`](#section-1)`. 1 Summary of Contents of Document`

`  `[`1`](#section-1)`. 2 Audience`

`  `[`1`](#section-1)`. 3 Related Documents`

``[`2`](#section-2)`. Design Objectives`

`  `[`2`](#section-2)`. 1 Goals/Objectives/Requirements/Problem Description`

`  `[`2`](#section-2)`. 2 Caveats and Assumptions`

``[`3`](#section-3)`. System Overview`

`  `[`3`](#section-3)`. 1 What IPsec Does`

`  `[`3`](#section-3)`. 2 How IPsec Works`

`  `[`3`](#section-3)`. 3 Where IPsec May Be Implemented`

``[`4`](#section-4)`. Security Associations`

`  `[`4`](#section-4)`. 1 Definition and Scope`

`  `[`4`](#section-4)`. 2 Security Association Functionality`

`  `[`4`](#section-4)`. 3 Combining Security Associations`

`  `[`4`](#section-4)`. 4 Security Association Databases`

`     `[`4.4`](#section-4-4)`. 1 The Security Policy Database (SPD)`

`     `[`4.4`](#section-4-4)`. 2 Selectors`

`     `[`4.4`](#section-4-4)`. 3 Security Association Database (SAD)`

`  `[`4`](#section-4)`. 5 Basic Combinations of Security Associations`

`  `[`4`](#section-4)`. 6 SA and Key Management`

`     `[`4.6`](#section-4-6)`. 1 Manual Techniques`

`     `[`4.6`](#section-4-6)`. 2 Automated SA and Key Management`

`     `[`4.6`](#section-4-6)`. 3 Locating a Security Gateway`

`  `[`4`](#section-4)`. 7 Security Associations and Multicast`

``[`5`](#section-5)`. IP Traffic Processing`

`  `[`5`](#section-5)`. 1 Outbound IP Traffic Processing`

`     `[`5.1`](#section-5-1)`. 1 Selecting and Using an SA or SA Bundle`

`     `[`5.1`](#section-5-1)`. 2 Header Construction for Tunnel Mode`

`        `[`5.1.2`](#section-5-1-2)`. 1 IPv4 -- Header Construction for Tunnel Mode`

`        `[`5.1.2`](#section-5-1-2)`. 2 IPv6 -- Header Construction for Tunnel Mode`

`  `[`5`](#section-5)`. 2 Processing Inbound IP Traffic`

`     `[`5.2`](#section-5-2)`. 1 Selecting and Using an SA or SA Bundle`

`     `[`5.2`](#section-5-2)`. 2 Handling of AH and ESP tunnels`

``[`6`](#section-6)`. ICMP Processing (relevant to IPsec)`

`  `[`6`](#section-6)`. 1 PMTU/DF Processing`

`     `[`6.1`](#section-6-1)`. 1 DF Bit`

`     `[`6.1`](#section-6-1)`. 2 Path MTU Discovery (PMTU)`

`        `[`6.1.2`](#section-6-1-2)`. 1 Propagation of PMTU`

`        `[`6.1.2`](#section-6-1-2)`. 2 Calculation of PMTU`

`        `[`6.1.2`](#section-6-1-2)`. 3 Granularity of PMTU Processing`

`        `[`6.1.2`](#section-6-1-2)`. 4 PMTU Aging`

``[`7`](#section-7)`. Auditing`

``[`8`](#section-8)`. Use in Systems Supporting Information Flow Security`

`  `[`8`](#section-8)`. 1 Relationship Between Security Associations and Data Sensitivity`

`  `[`8`](#section-8)`. 2 Sensitivity Consistency Checking`

`  `[`8`](#section-8)`. 3 Additional MLS Attributes for Security Association Databases`

`  `[`8`](#section-8)`. 4 Additional Inbound Processing Steps for MLS Networking`

`  `[`8`](#section-8)`. 5 Additional Outbound Processing Steps for MLS Networking`

`  `[`8`](#section-8)`. 6 Additional MLS Processing for Security Gateways`

``[`9`](#section-9)`. Performance Issues`

``[`10`](#section-10)`. Conformance Requirements`

``[`11`](#section-11)`. Security Considerations`

``[`12`](#section-12)`. Differences from RFC 1825`
...
<a id="section-6"></a> **`6. ICMP Processing (relevant to IPsec)`**
...
<a id="section-8"></a> **`8. Use in Systems Supporting Information Flow Security`**
...
<a id="section-9"></a> **`9. Performance Issues`**
...
<a id="section-12"></a> **`12. Differences from RFC 1825`**
