...
<a id="section-5"></a> **`5. AS_CONFED Segment Type Extension`**
...
<a id="section-6-1"></a> **`6.1. AS_PATH Modification Rules`**
...
<a id="section-7"></a> **`7. Common Administration Issues`**
...
<a id="section-8"></a> **`8. Compatability Considerations`**
...
<a id="section-9"></a> **`9. Deployment Considerations`**
