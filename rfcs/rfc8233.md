...
`   `[`3`](#section-3)`. PCEP Extensions`

`      `[`3.1`](#section-3-1)`. Extensions to METRIC Object`

`           `[`3.1.1`](#section-3-1-1)`. Path Delay Metric`

`                  `[`3.1.1.1`](#section-3-1-1-1)`. Path Delay Metric Value`

`           `[`3.1.2`](#section-3-1-2)`. Path Delay Variation Metric`

`                  `[`3.1.2.1`](#section-3-1-2-1)`. Path Delay Variation Metric Value`

`           `[`3.1.3`](#section-3-1-3)`. Path Loss Metric`

`                  `[`3.1.3.1`](#section-3-1-3-1)`. Path Loss Metric Value`

`           `[`3.1.4`](#section-3-1-4)`. Non-Understanding / Non-Support of`

`                  Service-Aware Path Computation`

`           `[`3.1.5`](#section-3-1-5)`. Mode of Operation`

`                  `[`3.1.5.1`](#section-3-1-5-1)`. Examples`

`           `[`3.1.6`](#section-3-1-6)`. Point-to-Multipoint (P2MP)`

`                  `[`3.1.6.1`](#section-3-1-6-1)`. P2MP Path Delay Metric`

`                  `[`3.1.6.2`](#section-3-1-6-2)`. P2MP Path Delay Variation Metric`

`                  `[`3.1.6.3`](#section-3-1-6-3)`. P2MP Path Loss Metric`

`      `[`3.2`](#section-3-2)`. Bandwidth Utilization`

`           `[`3.2.1`](#section-3-2-1)`. Link Bandwidth Utilization (LBU)`

`           `[`3.2.2`](#section-3-2-2)`. Link Reserved Bandwidth Utilization (LRBU)`

`           `[`3.2.3`](#section-3-2-3)`. Bandwidth Utilization (BU) Object`

`                  `[`3.2.3.1`](#section-3-2-3-1)`. Elements of Procedure`

`      `[`3.3`](#section-3-3)`. Objective Functions`

`   `[`4`](#section-4)`. Stateful PCE and PCE Initiated LSPs`

`   `[`5`](#section-5)`. PCEP Message Extension`

`      `[`5.1`](#section-5-1)`. The PCReq Message`

`      `[`5.2`](#section-5-2)`. The PCRep Message`

`      `[`5.3`](#section-5-3)`. The PCRpt Message`

`   `[`6`](#section-6)`. Other Considerations`

`      `[`6.1`](#section-6-1)`. Inter-domain Path Computation`

`           `[`6.1.1`](#section-6-1-1)`. Inter-AS Links`

`           `[`6.1.2`](#section-6-1-2)`. Inter-Layer Path Computation`

`      `[`6.2`](#section-6-2)`. Reoptimizing Paths`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. METRIC Types`

`      `[`7.2`](#section-7-2)`. New PCEP Object`

`      `[`7.3`](#section-7-3)`. BU Object`

`      `[`7.4`](#section-7-4)`. OF Codes`

`      `[`7.5`](#section-7-5)`. New Error-Values`
...
`      `[`9.4`](#section-9-4)`. Verify Correct Operations`

`      `[`9.5`](#section-9-5)`. Requirements on Other Protocols`

`      `[`9.6`](#section-9-6)`. Impact on Network Operations`
...
<a id="section-3"></a> **`3. PCEP Extensions`**
...
<a id="section-3-1"></a> **`3.1. Extensions to METRIC Object`**
...
<a id="section-3-1-1"></a> **`3.1.1. Path Delay Metric`**
...
<a id="section-3-1-1-1"></a> **`3.1.1.1. Path Delay Metric Value`**
...
<a id="section-3-1-2"></a> **`3.1.2. Path Delay Variation Metric`**
...
<a id="section-3-1-2-1"></a> **`3.1.2.1. Path Delay Variation Metric Value`**
...
<a id="section-3-1-3"></a> **`3.1.3. Path Loss Metric`**
...
<a id="section-3-1-3-1"></a> **`3.1.3.1. Path Loss Metric Value`**
...
<a id="section-3-1-4"></a> **`3.1.4. Non-Understanding / Non-Support of Service-Aware Path`**
...
<a id="section-3-1-5"></a> **`3.1.5. Mode of Operation`**
...
<a id="section-3-1-5-1"></a> **`3.1.5.1. Examples`**
...
<a id="section-3-1-6"></a> **`3.1.6. Point-to-Multipoint (P2MP)`**
...
<a id="section-3-1-6-1"></a> **`3.1.6.1. P2MP Path Delay Metric`**
...
<a id="section-3-1-6-2"></a> **`3.1.6.2. P2MP Path Delay Variation Metric`**
...
<a id="section-3-1-6-3"></a> **`3.1.6.3. P2MP Path Loss Metric`**
...
<a id="section-3-2"></a> **`3.2. Bandwidth Utilization`**

```text

```

<a id="section-3-2-1"></a> **`3.2.1. Link Bandwidth Utilization (LBU)`**
...
<a id="section-3-2-2"></a> **`3.2.2. Link Reserved Bandwidth Utilization (LRBU)`**
...
<a id="section-3-2-3"></a> **`3.2.3. Bandwidth Utilization (BU) Object`**
...
<a id="section-3-2-3-1"></a> **`3.2.3.1. Elements of Procedure`**
...
<a id="section-3-3"></a> **`3.3. Objective Functions`**
...
<a id="section-4"></a> **`4. Stateful PCE and PCE Initiated LSPs`**
...
```text
   ...
   <intended-attribute-list> and , respectively, (where
...
<a id="section-5"></a> **`5. PCEP Message Extension`**
...
<a id="section-5-1"></a> **`5.1. The PCReq Message`**
...
<a id="section-5-2"></a> **`5.2. The PCRep Message`**
...
<a id="section-5-3"></a> **`5.3. The PCRpt Message`**
...
```text
   ...
   The PCRpt message can use the updated  (as extended
   in Section 5.2) for the purpose of including the BU object.

```

<a id="section-6"></a> **`6. Other Considerations`**

```text

```

<a id="section-6-1"></a> **`6.1. Inter-domain Path Computation`**
...
<a id="section-6-1-1"></a> **`6.1.1. Inter-AS Links`**
...
<a id="section-6-1-2"></a> **`6.1.2. Inter-Layer Path Computation`**
...
<a id="section-6-2"></a> **`6.2. Reoptimizing Paths`**
...
<a id="section-7-1"></a> **`7.1. METRIC Types`**
...
<a id="section-7-2"></a> **`7.2. New PCEP Object`**
...
<a id="section-7-3"></a> **`7.3. BU Object`**
...
<a id="section-7-4"></a> **`7.4. OF Codes`**
...
<a id="section-7-5"></a> **`7.5. New Error-Values`**
...
<a id="section-9-4"></a> **`9.4. Verify Correct Operations`**
...
<a id="section-9-5"></a> **`9.5. Requirements on Other Protocols`**
...
<a id="section-9-6"></a> **`9.6. Impact on Network Operations`**
