...
`     `[`2.1`](#section-2-1)`. OSPFv3-Only Solution`

`   `[`3`](#section-3)`. Maximum Link Metric`
...
<a id="section-2-1"></a> **`2.1. OSPFv3-Only Solution`**
...
<a id="section-3"></a> **`3. Maximum Link Metric`**
