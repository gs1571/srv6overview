...
`   `[`2`](#section-2)`. Overview of IP Multicast Operation`

`   `[`3`](#section-3)`. Security Association Modes`

`      `[`3.1`](#section-3-1)`. Tunnel Mode with Address Preservation`

`   `[`4`](#section-4)`. Security Association`

`      `[`4.1`](#section-4-1)`. Major IPsec Databases`

`           `[`4.1.1`](#section-4-1-1)`. Group Security Policy Database (GSPD)`

`           `[`4.1.2`](#section-4-1-2)`. Security Association Database (SAD)`

`           `[`4.1.3`](#section-4-1-3)`. Group Peer Authorization Database (GPAD)`

`      `[`4.2`](#section-4-2)`. Group Security Association (GSA)`

`           `[`4.2.1`](#section-4-2-1)`. Concurrent IPsec SA Life Spans and Re-key Rollover`

`      `[`4.3`](#section-4-3)`. Data Origin Authentication`

`      `[`4.4`](#section-4-4)`. Group SA and Key Management`

`           `[`4.4.1`](#section-4-4-1)`. Co-Existence of Multiple Key Management Protocols`

`   `[`5`](#section-5)`. IP Traffic Processing`

`      `[`5.1`](#section-5-1)`. Outbound IP Traffic Processing`

`      `[`5.2`](#section-5-2)`. Inbound IP Traffic Processing`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. Security Issues Solved by IPsec Multicast Extensions`

`      `[`6.2`](#section-6-2)`. Security Issues Not Solved by IPsec Multicast Extensions`

`           `[`6.2.1`](#section-6-2-1)`. Outsider Attacks`

`           `[`6.2.2`](#section-6-2-2)`. Insider Attacks`

`      `[`6.3`](#section-6-3)`. Implementation or Deployment Issues that Impact Security`

`           `[`6.3.1`](#section-6-3-1)`. Homogeneous Group Cryptographic Algorithm`

`                  Capabilities`

`           `[`6.3.2`](#section-6-3-2)`. Groups that Span Two or More Security`

`                  Policy Domains`

`           `[`6.3.3`](#section-6-3-3)`. Source-Specific Multicast Group Sender`
...
<a id="section-2"></a> **`2. Overview of IP Multicast Operation`**
...
<a id="section-3"></a> **`3. Security Association Modes`**
...
<a id="section-3-1"></a> **`3.1. Tunnel Mode with Address Preservation`**
...
<a id="section-4"></a> **`4. Security Association`**

```text

```

<a id="section-4-1"></a> **`4.1. Major IPsec Databases`**
...
<a id="section-4-1-1"></a> **`4.1.1. Group Security Policy Database (GSPD)`**
...
<a id="section-4-1-2"></a> **`4.1.2. Security Association Database (SAD)`**
...
<a id="section-4-1-3"></a> **`4.1.3. Group Peer Authorization Database (GPAD)`**
...
<a id="section-4-1-3-1"></a> **`4.1.3.1. GCKS Identifiers`**
...
<a id="section-4-1-3-2"></a> **`4.1.3.2. GCKS Peer Authentication Data`**
...
<a id="section-4-1-3-3"></a> **`4.1.3.3. Group Identifier Authorization Data`**
...
<a id="section-4-1-3-4"></a> **`4.1.3.4. IPsec SA Traffic Selector Authorization Data`**
...
<a id="section-4-1-3-5"></a> **`4.1.3.5. How the GPAD Is Used`**
...
<a id="section-4-2"></a> **`4.2. Group Security Association (GSA)`**
...
<a id="section-4-2-1"></a> **`4.2.1. Concurrent IPsec SA Life Spans and Re-key Rollover`**
...
<a id="section-4-3"></a> **`4.3. Data Origin Authentication`**
...
<a id="section-4-4"></a> **`4.4. Group SA and Key Management`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. Co-Existence of Multiple Key Management Protocols`**
...
<a id="section-5-1"></a> **`5.1. Outbound IP Traffic Processing`**
...
<a id="section-5-2"></a> **`5.2. Inbound IP Traffic Processing`**
...
<a id="section-6-1"></a> **`6.1. Security Issues Solved by IPsec Multicast Extensions`**
...
<a id="section-6-2"></a> **`6.2. Security Issues Not Solved by IPsec Multicast Extensions`**
...
<a id="section-6-2-1"></a> **`6.2.1. Outsider Attacks`**
...
<a id="section-6-2-2"></a> **`6.2.2. Insider Attacks`**
...
<a id="section-6-3"></a> **`6.3. Implementation or Deployment Issues that Impact Security`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. Homogeneous Group Cryptographic Algorithm Capabilities`**
...
<a id="section-6-3-2"></a> **`6.3.2. Groups that Span Two or More Security Policy Domains`**
...
<a id="section-6-3-3"></a> **`6.3.3. Source-Specific Multicast Group Sender Transient Locators`**
