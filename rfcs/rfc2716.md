...
<a id="section-3-1"></a> **`3.1. Overview of the EAP-TLS conversation`**
...
<a id="section-3-2"></a> **`3.2. Retry behavior`**
...
<a id="section-3-3"></a> **`3.3. Fragmentation`**
...
<a id="section-3-4"></a> **`3.4. Identity verification`**
...
<a id="section-3-5"></a> **`3.5. Key derivation`**
...
<a id="section-3-6"></a> **`3.6. ECP negotiation`**
...
<a id="section-3-7"></a> **`3.7. CCP negotiation`**
...
<a id="section-3-8"></a> **`3.8. Examples`**
...
<a id="section-4"></a> **`4. Detailed description of the EAP-TLS protocol`**

```text

```

<a id="section-4-1"></a> **`4.1. PPP EAP TLS Packet Format`**
...
<a id="section-4-2"></a> **`4.2. PPP EAP TLS Request Packet`**
...
<a id="section-4-3"></a> **`4.3. PPP EAP TLS Response Packet`**
...
<a id="section-6-1"></a> **`6.1. Certificate revocation`**
...
<a id="section-6-2"></a> **`6.2. Separation of the EAP server and PPP authenticator`**
...
<a id="section-6-3"></a> **`6.3. Relationship of PPP encryption to other security mechanisms`**
