...
`   `[`2`](#section-2)`. Contributing Authors`

`   `[`3`](#section-3)`. Definitions and Requirements Statement`

`      `[`3.1`](#section-3-1)`. Definitions`

`      `[`3.2`](#section-3-2)`. Objectives and Requirements of Inter-AS Traffic`

`           Engineering`

`           `[`3.2.1`](#section-3-2-1)`. Inter-AS Bandwidth Guarantees`

`           `[`3.2.2`](#section-3-2-2)`. Inter-AS Resource Optimization`

`           `[`3.2.3`](#section-3-2-3)`. Fast Recovery across ASes`

`      `[`3.3`](#section-3-3)`. Inter-AS Traffic Engineering Requirements Statement`

`   `[`4`](#section-4)`. Application Scenarios`

`      `[`4.1`](#section-4-1)`. Application Scenarios Requiring Inter-AS Bandwidth`

`           Guarantees`

`           `[`4.1.1`](#section-4-1-1)`. Scenario I - Extended or Virtual PoP (VPoP)`

`           `[`4.1.2`](#section-4-1-2)`. Scenario II - Extended or Virtual Trunk`

`           `[`4.1.3`](#section-4-1-3)`. Scenario III - End-to-End Inter-AS MPLS TE`

`                  from CE to CE`

`      `[`4.2`](#section-4-2)`. Application Scenarios Requiring Inter-AS Resource`

`           Optimization`

`           `[`4.2.1`](#section-4-2-1)`. Scenario IV - TE across multi-AS within a`

`                  Single SP`

`           `[`4.2.2`](#section-4-2-2)`. Scenario V - Transit ASes as Primary and`

`                  Redundant Transport`

`   `[`5`](#section-5)`. Detailed Requirements for Inter-AS MPLS Traffic Engineering`

`      `[`5.1`](#section-5-1)`. Requirements within One SP Administrative Domain`

`           `[`5.1.1`](#section-5-1-1)`. Inter-AS MPLS TE Operations and Interoperability`

`           `[`5.1.2`](#section-5-1-2)`. Protocol Signaling and Path Computations`

`           `[`5.1.3`](#section-5-1-3)`. Optimality`

`           `[`5.1.4`](#section-5-1-4)`. Support of Diversely Routed Inter-AS TE LSP`

`           `[`5.1.5`](#section-5-1-5)`. Re-Optimization`

`           `[`5.1.6`](#section-5-1-6)`. Fast Recovery Support Using MPLS TE Fast Reroute`

`           `[`5.1.7`](#section-5-1-7)`. DS-TE Support`

`           `[`5.1.8`](#section-5-1-8)`. Scalability and Hierarchical LSP Support`

`           `[`5.1.9`](#section-5-1-9)`. Mapping of Traffic onto Inter-AS MPLS TE Tunnels`

`           `[`5.1.10`](#section-5-1-10)`. Inter-AS MPLS TE Management`

`                  `[`5.1.10.1`](#section-5-1-10-1)`. Inter-AS MPLS TE MIB Requirements`

`                  `[`5.1.10.2`](#section-5-1-10-2)`. Inter-AS MPLS TE Fault Management`

`                            Requirements`

`           `[`5.1.11`](#section-5-1-11)`. Extensibility`

`           `[`5.1.12`](#section-5-1-12)`. Complexity and Risks`

`           `[`5.1.13`](#section-5-1-13)`. Backward Compatibility`

`           `[`5.1.14`](#section-5-1-14)`. Performance`

`      `[`5.2`](#section-5-2)`. Requirements for Inter-AS MPLS TE across Multiple SP`

`           `[`5.2.1`](#section-5-2-1)`. Confidentiality`

`           `[`5.2.2`](#section-5-2-2)`. Policy Control`

`                  `[`5.2.2.1`](#section-5-2-2-1)`. Inter-AS TE Agreement Enforcement`

`                           Polices`

`                  `[`5.2.2.2`](#section-5-2-2-2)`. Inter-AS TE Rewrite Policies`

`                  `[`5.2.2.3`](#section-5-2-2-3)`. Inter-AS Traffic Policing`
...
<a id="section-2"></a> **`2. Contributing Authors`**
...
<a id="section-3"></a> **`3. Definitions and Requirements Statement`**

```text

```

<a id="section-3-1"></a> **`3.1. Definitions`**
...
<a id="section-3-2"></a> **`3.2. Objectives and Requirements of Inter-AS Traffic Engineering`**
...
<a id="section-3-2-1"></a> **`3.2.1. Inter-AS Bandwidth Guarantees`**
...
<a id="section-3-2-2"></a> **`3.2.2. Inter-AS Resource Optimization`**
...
<a id="section-3-2-3"></a> **`3.2.3. Fast Recovery across ASes`**
...
<a id="section-3-3"></a> **`3.3. Inter-AS Traffic Engineering Requirements Statement`**
...
<a id="section-4"></a> **`4. Application Scenarios`**
...
<a id="section-4-1"></a> **`4.1. Application Scenarios Requiring Inter-AS Bandwidth Guarantees`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Scenario I - Extended or Virtual PoP (VPoP)`**
...
<a id="section-4-1-2"></a> **`4.1.2. Scenario II - Extended or Virtual Trunk`**
...
<a id="section-4-1-3"></a> **`4.1.3. Scenario III - End-to-End Inter-AS MPLS TE from CE to CE`**
...
<a id="section-4-2"></a> **`4.2. Application Scenarios Requiring Inter-AS Resource Optimization`**
...
<a id="section-4-2-1"></a> **`4.2.1. Scenario IV - TE across multi-AS within a Single SP`**
...
<a id="section-4-2-2"></a> **`4.2.2. Scenario V - Transit ASes as Primary and Redundant Transport`**
...
<a id="section-5"></a> **`5. Detailed Requirements for Inter-AS MPLS Traffic Engineering`**
...
<a id="section-5-1"></a> **`5.1. Requirements within One SP Administrative Domain`**
...
<a id="section-5-1-1"></a> **`5.1.1. Inter-AS MPLS TE Operations and Interoperability`**
...
<a id="section-5-1-2"></a> **`5.1.2. Protocol Signaling and Path Computations`**
...
<a id="section-5-1-3"></a> **`5.1.3. Optimality`**
...
<a id="section-5-1-4"></a> **`5.1.4. Support of Diversely Routed Inter-AS TE LSP`**
...
<a id="section-5-1-5"></a> **`5.1.5. Re-Optimization`**
...
<a id="section-5-1-6"></a> **`5.1.6. Fast Recovery Support Using MPLS TE Fast Reroute`**
...
<a id="section-5-1-7"></a> **`5.1.7. DS-TE Support`**
...
<a id="section-5-1-8"></a> **`5.1.8. Scalability and Hierarchical LSP Support`**
...
<a id="section-5-1-9"></a> **`5.1.9. Mapping of Traffic onto Inter-AS MPLS TE Tunnels`**
...
<a id="section-5-1-10"></a> **`5.1.10. Inter-AS MPLS TE Management`**

```text

```

<a id="section-5-1-10-1"></a> **`5.1.10.1. Inter-AS MPLS TE MIB Requirements`**
...
<a id="section-5-1-10-2"></a> **`5.1.10.2. Inter-AS MPLS TE Fault Management Requirements`**
...
<a id="section-5-1-11"></a> **`5.1.11. Extensibility`**
...
<a id="section-5-1-12"></a> **`5.1.12. Complexity and Risks`**
...
<a id="section-5-1-13"></a> **`5.1.13. Backward Compatibility`**
...
<a id="section-5-1-14"></a> **`5.1.14. Performance`**
...
<a id="section-5-2"></a> **`5.2. Requirements for Inter-AS MPLS TE across Multiple SP`**
...
<a id="section-5-2-1"></a> **`5.2.1. Confidentiality`**
...
<a id="section-5-2-2"></a> **`5.2.2. Policy Control`**
...
<a id="section-5-2-2-1"></a> **`5.2.2.1. Inter-AS TE Agreement Enforcement Polices`**
...
<a id="section-5-2-2-2"></a> **`5.2.2.2. Inter-AS TE Rewrite Policies`**
...
<a id="section-5-2-2-3"></a> **`5.2.2.3. Inter-AS Traffic Policing`**
