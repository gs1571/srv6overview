...
`   `[`2`](#section-2)`. Terms and Concepts`

`   `[`3`](#section-3)`. Using Service Models`

`     `[`3.1`](#section-3-1)`. Practical Considerations`

`   `[`4`](#section-4)`. Service Models in an SDN Context`

`   `[`5`](#section-5)`. Possible Causes of Confusion`

`   `[`6`](#section-6)`. Comparison with Other Work`

`     `[`6.1`](#section-6-1)`. Comparison with Network Service Models`

`     `[`6.2`](#section-6-2)`. Service Delivery and Network Element Model Work`

`     `[`6.3`](#section-6-3)`. Customer Service Model Work`

`     `[`6.4`](#section-6-4)`. The MEF Architecture`

`   `[`7`](#section-7)`. Further Concepts`

`     `[`7.1`](#section-7-1)`. Technology Agnostic`

`     `[`7.2`](#section-7-2)`. Relationship to Policy`

`     `[`7.3`](#section-7-3)`. Operator-Specific Features`

`     `[`7.4`](#section-7-4)`. Supporting Multiple Services`
...
<a id="section-2"></a> **`2. Terms and Concepts`**
...
<a id="section-3"></a> **`3. Using Service Models`**
...
<a id="section-3-1"></a> **`3.1. Practical Considerations`**
...
<a id="section-4"></a> **`4. Service Models in an SDN Context`**
...
<a id="section-5"></a> **`5. Possible Causes of Confusion`**
...
<a id="section-6"></a> **`6. Comparison with Other Work`**
...
<a id="section-6-1"></a> **`6.1. Comparison with Network Service Models`**
...
<a id="section-6-2"></a> **`6.2. Service Delivery and Network Element Model Work`**
...
<a id="section-6-3"></a> **`6.3. Customer Service Model Work`**
...
<a id="section-6-4"></a> **`6.4. The MEF Architecture`**
...
<a id="section-7"></a> **`7. Further Concepts`**
...
<a id="section-7-1"></a> **`7.1. Technology Agnostic`**
...
<a id="section-7-2"></a> **`7.2. Relationship to Policy`**
...
<a id="section-7-3"></a> **`7.3. Operator-Specific Features`**
...
<a id="section-7-4"></a> **`7.4. Supporting Multiple Services`**
