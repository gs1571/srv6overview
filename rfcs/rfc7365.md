...
`      `[`1.1`](#section-1-1)`. General Terminology`

`      `[`1.2`](#section-1-2)`. DC Network Architecture`

`   `[`2`](#section-2)`. Reference Models`

`      `[`2.1`](#section-2-1)`. Generic Reference Model`

`      `[`2.2`](#section-2-2)`. NVE Reference Model`

`      `[`2.3`](#section-2-3)`. NVE Service Types`

`           `[`2.3.1`](#section-2-3-1)`. L2 NVE Providing Ethernet LAN-Like Service`

`           `[`2.3.2`](#section-2-3-2)`. L3 NVE Providing IP/VRF-Like Service`

`      `[`2.4`](#section-2-4)`. Operational Management Considerations`

`   `[`3`](#section-3)`. Functional Components`

`      `[`3.1`](#section-3-1)`. Service Virtualization Components`

`           `[`3.1.1`](#section-3-1-1)`. Virtual Access Points (VAPs)`

`           `[`3.1.2`](#section-3-1-2)`. Virtual Network Instance (VNI)`

`           `[`3.1.3`](#section-3-1-3)`. Overlay Modules and VN Context`

`           `[`3.1.4`](#section-3-1-4)`. Tunnel Overlays and Encapsulation Options`

`           `[`3.1.5`](#section-3-1-5)`. Control-Plane Components`

`                  `[`3.1.5.1`](#section-3-1-5-1)`. Distributed vs. Centralized`

`                           Control Plane`

`                  `[`3.1.5.2`](#section-3-1-5-2)`. Auto-provisioning and Service Discovery`

`                  `[`3.1.5.3`](#section-3-1-5-3)`. Address Advertisement and Tunnel Mapping`

`                  `[`3.1.5.4`](#section-3-1-5-4)`. Overlay Tunneling`

`      `[`3.2`](#section-3-2)`. Multihoming`

`      `[`3.3`](#section-3-3)`. VM Mobility`

`   `[`4`](#section-4)`. Key Aspects of Overlay Networks`

`      `[`4.1`](#section-4-1)`. Pros and Cons`

`      `[`4.2`](#section-4-2)`. Overlay Issues to Consider`

`           `[`4.2.1`](#section-4-2-1)`. Data Plane vs. Control Plane Driven`

`           `[`4.2.2`](#section-4-2-2)`. Coordination between Data Plane and Control Plane`

`           `[`4.2.3`](#section-4-2-3)`. Handling Broadcast, Unknown Unicast, and`

`                  Multicast (BUM) Traffic`

`           `[`4.2.4`](#section-4-2-4)`. Path MTU`

`           `[`4.2.5`](#section-4-2-5)`. NVE Location Trade-Offs`

`           `[`4.2.6`](#section-4-2-6)`. Interaction between Network Overlays and`

`                  Underlays`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. Informative References`
...
<a id="section-1-1"></a> **`1.1. General Terminology`**
...
<a id="section-1-2"></a> **`1.2. DC Network Architecture`**
...
<a id="section-2-1"></a> **`2.1. Generic Reference Model`**
...
<a id="section-2-2"></a> **`2.2. NVE Reference Model`**
...
<a id="section-2-3"></a> **`2.3. NVE Service Types`**
...
<a id="section-2-3-1"></a> **`2.3.1. L2 NVE Providing Ethernet LAN-Like Service`**
...
<a id="section-2-3-2"></a> **`2.3.2. L3 NVE Providing IP/VRF-Like Service`**
...
<a id="section-2-4"></a> **`2.4. Operational Management Considerations`**
...
<a id="section-3"></a> **`3. Functional Components`**
...
<a id="section-3-1"></a> **`3.1. Service Virtualization Components`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. Virtual Access Points (VAPs)`**
...
<a id="section-3-1-2"></a> **`3.1.2. Virtual Network Instance (VNI)`**
...
<a id="section-3-1-3"></a> **`3.1.3. Overlay Modules and VN Context`**
...
<a id="section-3-1-4"></a> **`3.1.4. Tunnel Overlays and Encapsulation Options`**
...
<a id="section-3-1-5"></a> **`3.1.5. Control-Plane Components`**

```text

```

<a id="section-3-1-5-1"></a> **`3.1.5.1. Distributed vs. Centralized Control Plane`**
...
<a id="section-3-1-5-2"></a> **`3.1.5.2. Auto-provisioning and Service Discovery`**
...
<a id="section-3-1-5-3"></a> **`3.1.5.3. Address Advertisement and Tunnel Mapping`**
...
<a id="section-3-1-5-4"></a> **`3.1.5.4. Overlay Tunneling`**
...
<a id="section-3-2"></a> **`3.2. Multihoming`**
...
<a id="section-3-3"></a> **`3.3. VM Mobility`**
...
<a id="section-4"></a> **`4. Key Aspects of Overlay Networks`**
...
<a id="section-4-1"></a> **`4.1. Pros and Cons`**
...
<a id="section-4-2"></a> **`4.2. Overlay Issues to Consider`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Data Plane vs. Control Plane Driven`**
...
<a id="section-4-2-2"></a> **`4.2.2. Coordination between Data Plane and Control Plane`**
...
<a id="section-4-2-3"></a> **`4.2.3. Handling Broadcast, Unknown Unicast, and Multicast (BUM) Traffic`**
...
<a id="section-4-2-4"></a> **`4.2.4. Path MTU`**
...
<a id="section-4-2-5"></a> **`4.2.5. NVE Location Trade-Offs`**
...
<a id="section-4-2-6"></a> **`4.2.6. Interaction between Network Overlays and Underlays`**
...
<a id="section-6"></a> **`6. Informative References`**
