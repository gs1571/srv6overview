...
`   `[`2`](#section-2)`. Link Attribute TLVs for TE Metric Extensions`

`      `[`2.1`](#section-2-1)`. Unidirectional Link Delay TLV`

`      `[`2.2`](#section-2-2)`. Min/Max Unidirectional Link Delay TLV`

`      `[`2.3`](#section-2-3)`. Unidirectional Delay Variation TLV`

`      `[`2.4`](#section-2-4)`. Unidirectional Link Loss TLV`

`      `[`2.5`](#section-2-5)`. Unidirectional Residual Bandwidth TLV`

`      `[`2.6`](#section-2-6)`. Unidirectional Available Bandwidth TLV`

`      `[`2.7`](#section-2-7)`. Unidirectional Utilized Bandwidth TLV`

`      `[`2.8`](#section-2-8)`. Mappings to IGP Source Sub-TLVs`
...
<a id="section-2"></a> **`2. Link Attribute TLVs for TE Metric Extensions`**
...
<a id="section-2-1"></a> **`2.1. Unidirectional Link Delay TLV`**
...
<a id="section-2-2"></a> **`2.2. Min/Max Unidirectional Link Delay TLV`**
...
<a id="section-2-3"></a> **`2.3. Unidirectional Delay Variation TLV`**
...
<a id="section-2-4"></a> **`2.4. Unidirectional Link Loss TLV`**
...
<a id="section-2-5"></a> **`2.5. Unidirectional Residual Bandwidth TLV`**
...
<a id="section-2-6"></a> **`2.6. Unidirectional Available Bandwidth TLV`**
...
<a id="section-2-7"></a> **`2.7. Unidirectional Utilized Bandwidth TLV`**
...
<a id="section-2-8"></a> **`2.8. Mappings to IGP Source Sub-TLVs`**
