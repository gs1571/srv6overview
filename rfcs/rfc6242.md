...
`   `[`3`](#section-3)`. Starting NETCONF over SSH`

`     `[`3.1`](#section-3-1)`. Capabilities Exchange`

`   `[`4`](#section-4)`. Using NETCONF over SSH`

`     `[`4.1`](#section-4-1)`. Framing Protocol`

`     `[`4.2`](#section-4-2)`. Chunked Framing Mechanism`

`     `[`4.3`](#section-4-3)`. End-of-Message Framing Mechanism`

`   `[`5`](#section-5)`. Exiting the NETCONF Subsystem`
...
<a id="section-3"></a> **`3. Starting NETCONF over SSH`**
...
<a id="section-3-1"></a> **`3.1. Capabilities Exchange`**
...
<a id="section-4"></a> **`4. Using NETCONF over SSH`**
...
<a id="section-4-1"></a> **`4.1. Framing Protocol`**
...
<a id="section-4-2"></a> **`4.2. Chunked Framing Mechanism`**
...
<a id="section-4-3"></a> **`4.3. End-of-Message Framing Mechanism`**
...
<a id="section-5"></a> **`5. Exiting the NETCONF Subsystem`**
