...
`      `[`1.1`](#section-1-1)`. Acronyms and Definitions`

`   `[`2`](#section-2)`. Conventions Used in This Document`

`   `[`3`](#section-3)`. VXLAN Problem Statement`

`      `[`3.1`](#section-3-1)`. Limitations Imposed by Spanning Tree and VLAN Ranges`

`      `[`3.2`](#section-3-2)`. Multi-tenant Environments`

`      `[`3.3`](#section-3-3)`. Inadequate Table Sizes at ToR Switch`

`   `[`4`](#section-4)`. VXLAN`

`      `[`4.1`](#section-4-1)`. Unicast VM-to-VM Communication`

`      `[`4.2`](#section-4-2)`. Broadcast Communication and Mapping to Multicast`

`      `[`4.3`](#section-4-3)`. Physical Infrastructure Requirements`

`   `[`5`](#section-5)`. VXLAN Frame Format`

`   `[`6`](#section-6)`. VXLAN Deployment Scenarios`

`      `[`6.1`](#section-6-1)`. Inner VLAN Tag Handling`
...
<a id="section-1-1"></a> **`1.1. Acronyms and Definitions`**
...
<a id="section-3"></a> **`3. VXLAN Problem Statement`**
...
<a id="section-3-1"></a> **`3.1. Limitations Imposed by Spanning Tree and VLAN Ranges`**
...
<a id="section-3-2"></a> **`3.2. Multi-tenant Environments`**
...
<a id="section-3-3"></a> **`3.3. Inadequate Table Sizes at ToR Switch`**
...
<a id="section-4-1"></a> **`4.1. Unicast VM-to-VM Communication`**
...
<a id="section-4-2"></a> **`4.2. Broadcast Communication and Mapping to Multicast`**
...
<a id="section-4-3"></a> **`4.3. Physical Infrastructure Requirements`**
...
<a id="section-5"></a> **`5. VXLAN Frame Format`**
...
<a id="section-6"></a> **`6. VXLAN Deployment Scenarios`**
...
<a id="section-6-1"></a> **`6.1. Inner VLAN Tag Handling`**
