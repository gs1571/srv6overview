...
`   `[`4`](#section-4)`. BGP MPLS-Based EVPN Overview`

`   `[`5`](#section-5)`. Ethernet Segment`

`   `[`6`](#section-6)`. Ethernet Tag ID`

`      `[`6.1`](#section-6-1)`. VLAN-Based Service Interface`

`      `[`6.2`](#section-6-2)`. VLAN Bundle Service Interface`

`           `[`6.2.1`](#section-6-2-1)`. Port-Based Service Interface`

`      `[`6.3`](#section-6-3)`. VLAN-Aware Bundle Service Interface`

`           `[`6.3.1`](#section-6-3-1)`. Port-Based VLAN-Aware Service Interface`

`   `[`7`](#section-7)`. BGP EVPN Routes`

`      `[`7.1`](#section-7-1)`. Ethernet Auto-discovery Route`

`      `[`7.2`](#section-7-2)`. MAC/IP Advertisement Route`

`      `[`7.3`](#section-7-3)`. Inclusive Multicast Ethernet Tag Route`

`      `[`7.4`](#section-7-4)`. Ethernet Segment Route`

`      `[`7.5`](#section-7-5)`. ESI Label Extended Community`

`      `[`7.6`](#section-7-6)`. ES-Import Route Target`

`      `[`7.7`](#section-7-7)`. MAC Mobility Extended Community`

`      `[`7.8`](#section-7-8)`. Default Gateway Extended Community`

`      `[`7.9`](#section-7-9)`. Route Distinguisher Assignment per EVI`

`      `[`7.10`](#section-7-10)`. Route Targets`

`           `[`7.10.1`](#section-7-10-1)`. Auto-derivation from the Ethernet Tag ID`

`   `[`8`](#section-8)`. Multihoming Functions`

`      `[`8.1`](#section-8-1)`. Multihomed Ethernet Segment Auto-discovery`

`           `[`8.1.1`](#section-8-1-1)`. Constructing the Ethernet Segment Route`

`      `[`8.2`](#section-8-2)`. Fast Convergence`

`           `[`8.2.1`](#section-8-2-1)`. Constructing Ethernet A-D per Ethernet`

`                  Segment Route`

`                  `[`8.2.1.1`](#section-8-2-1-1)`. Ethernet A-D Route Targets`

`      `[`8.3`](#section-8-3)`. Split Horizon`

`           `[`8.3.1`](#section-8-3-1)`. ESI Label Assignment`

`                  `[`8.3.1.1`](#section-8-3-1-1)`. Ingress Replication`

`                  `[`8.3.1.2`](#section-8-3-1-2)`. P2MP MPLS LSPs`

`      `[`8.4`](#section-8-4)`. Aliasing and Backup Path`

`           `[`8.4.1`](#section-8-4-1)`. Constructing Ethernet A-D per EVPN Instance Route`

`      `[`8.5`](#section-8-5)`. Designated Forwarder Election`

`      `[`8.6`](#section-8-6)`. Interoperability with Single-Homing PEs`

`   `[`9`](#section-9)`. Determining Reachability to Unicast MAC Addresses`

`      `[`9.1`](#section-9-1)`. Local Learning`

`      `[`9.2`](#section-9-2)`. Remote Learning`

`           `[`9.2.1`](#section-9-2-1)`. Constructing MAC/IP Address Advertisement`

`           `[`9.2.2`](#section-9-2-2)`. Route Resolution`

`   `[`10`](#section-10)`. ARP and ND`

`      `[`10.1`](#section-10-1)`. Default Gateway`

`   `[`11`](#section-11)`. Handling of Multi-destination Traffic`

`      `[`11.1`](#section-11-1)`. Constructing Inclusive Multicast Ethernet Tag Route`

`      `[`11.2`](#section-11-2)`. P-Tunnel Identification`

`   `[`12`](#section-12)`. Processing of Unknown Unicast Packets`

`      `[`12.1`](#section-12-1)`. Ingress Replication`

`      `[`12.2`](#section-12-2)`. P2MP MPLS LSPs`

`   `[`13`](#section-13)`. Forwarding Unicast Packets`

`      `[`13.1`](#section-13-1)`. Forwarding Packets Received from a CE`

`      `[`13.2`](#section-13-2)`. Forwarding Packets Received from a Remote PE`

`           `[`13.2.1`](#section-13-2-1)`. Unknown Unicast Forwarding`

`           `[`13.2.2`](#section-13-2-2)`. Known Unicast Forwarding`

`   `[`14`](#section-14)`. Load Balancing of Unicast Packets`

`      `[`14.1`](#section-14-1)`. Load Balancing of Traffic from a PE to Remote CEs`

`           `[`14.1.1`](#section-14-1-1)`. Single-Active Redundancy Mode`

`           `[`14.1.2`](#section-14-1-2)`. All-Active Redundancy Mode`

`      `[`14.2`](#section-14-2)`. Load Balancing of Traffic between a PE and a Local CE`

`           `[`14.2.1`](#section-14-2-1)`. Data-Plane Learning`

`           `[`14.2.2`](#section-14-2-2)`. Control-Plane Learning`

`   `[`15`](#section-15)`. MAC Mobility`

`      `[`15.1`](#section-15-1)`. MAC Duplication Issue`

`      `[`15.2`](#section-15-2)`. Sticky MAC Addresses`

`   `[`16`](#section-16)`. Multicast and Broadcast`

`      `[`16.1`](#section-16-1)`. Ingress Replication`

`      `[`16.2`](#section-16-2)`. P2MP LSPs`

`           `[`16.2.1`](#section-16-2-1)`. Inclusive Trees`

`   `[`17`](#section-17)`. Convergence`

`      `[`17.1`](#section-17-1)`. Transit Link and Node Failures between PEs`

`      `[`17.2`](#section-17-2)`. PE Failures`

`      `[`17.3`](#section-17-3)`. PE-to-CE Network Failures`

`   `[`18`](#section-18)`. Frame Ordering`
...
<a id="section-4"></a> **`4. BGP MPLS-Based EVPN Overview`**
...
<a id="section-5"></a> **`5. Ethernet Segment`**
...
<a id="section-6"></a> **`6. Ethernet Tag ID`**
...
<a id="section-6-1"></a> **`6.1. VLAN-Based Service Interface`**
...
<a id="section-6-2"></a> **`6.2. VLAN Bundle Service Interface`**
...
<a id="section-6-2-1"></a> **`6.2.1. Port-Based Service Interface`**
...
<a id="section-6-3"></a> **`6.3. VLAN-Aware Bundle Service Interface`**
...
<a id="section-6-3-1"></a> **`6.3.1. Port-Based VLAN-Aware Service Interface`**
...
<a id="section-7"></a> **`7. BGP EVPN Routes`**
...
<a id="section-7-1"></a> **`7.1. Ethernet Auto-discovery Route`**
...
<a id="section-7-2"></a> **`7.2. MAC/IP Advertisement Route`**
...
<a id="section-7-3"></a> **`7.3. Inclusive Multicast Ethernet Tag Route`**
...
<a id="section-7-4"></a> **`7.4. Ethernet Segment Route`**
...
<a id="section-7-5"></a> **`7.5. ESI Label Extended Community`**
...
<a id="section-7-6"></a> **`7.6. ES-Import Route Target`**
...
<a id="section-7-7"></a> **`7.7. MAC Mobility Extended Community`**
...
<a id="section-7-8"></a> **`7.8. Default Gateway Extended Community`**
...
<a id="section-7-9"></a> **`7.9. Route Distinguisher Assignment per MAC-VRF`**
...
<a id="section-7-10"></a> **`7.10. Route Targets`**
...
<a id="section-7-10-1"></a> **`7.10.1. Auto-derivation from the Ethernet Tag ID`**
...
<a id="section-8"></a> **`8. Multihoming Functions`**
...
<a id="section-8-1"></a> **`8.1. Multihomed Ethernet Segment Auto-discovery`**
...
<a id="section-8-1-1"></a> **`8.1.1. Constructing the Ethernet Segment Route`**
...
<a id="section-8-2"></a> **`8.2. Fast Convergence`**
...
<a id="section-8-2-1"></a> **`8.2.1. Constructing Ethernet A-D per Ethernet Segment Route`**
...
<a id="section-8-2-1-1"></a> **`8.2.1.1. Ethernet A-D Route Targets`**
...
<a id="section-8-3"></a> **`8.3. Split Horizon`**
...
<a id="section-8-3-1"></a> **`8.3.1. ESI Label Assignment`**
...
<a id="section-8-3-1-1"></a> **`8.3.1.1. Ingress Replication`**
...
<a id="section-8-3-1-2"></a> **`8.3.1.2. P2MP MPLS LSPs`**
...
<a id="section-8-4"></a> **`8.4. Aliasing and Backup Path`**
...
<a id="section-8-4-1"></a> **`8.4.1. Constructing Ethernet A-D per EVPN Instance Route`**
...
<a id="section-8-5"></a> **`8.5. Designated Forwarder Election`**
...
<a id="section-8-6"></a> **`8.6. Interoperability with Single-Homing PEs`**
...
<a id="section-9"></a> **`9. Determining Reachability to Unicast MAC Addresses`**
...
<a id="section-9-1"></a> **`9.1. Local Learning`**
...
<a id="section-9-2"></a> **`9.2. Remote Learning`**
...
<a id="section-9-2-1"></a> **`9.2.1. Constructing MAC/IP Address Advertisement`**
...
<a id="section-9-2-2"></a> **`9.2.2. Route Resolution`**
...
<a id="section-10"></a> **`10. ARP and ND`**
...
<a id="section-10-1"></a> **`10.1. Default Gateway`**
...
<a id="section-11"></a> **`11. Handling of Multi-destination Traffic`**
...
<a id="section-11-1"></a> **`11.1. Constructing Inclusive Multicast Ethernet Tag Route`**
...
<a id="section-11-2"></a> **`11.2. P-Tunnel Identification`**
...
<a id="section-12"></a> **`12. Processing of Unknown Unicast Packets`**
...
<a id="section-12-1"></a> **`12.1. Ingress Replication`**
...
<a id="section-12-2"></a> **`12.2. P2MP MPLS LSPs`**
...
<a id="section-13"></a> **`13. Forwarding Unicast Packets`**
...
<a id="section-13-1"></a> **`13.1. Forwarding Packets Received from a CE`**
...
<a id="section-13-2"></a> **`13.2. Forwarding Packets Received from a Remote PE`**
...
<a id="section-13-2-1"></a> **`13.2.1. Unknown Unicast Forwarding`**
...
<a id="section-13-2-2"></a> **`13.2.2. Known Unicast Forwarding`**
...
<a id="section-14"></a> **`14. Load Balancing of Unicast Packets`**
...
<a id="section-14-1"></a> **`14.1. Load Balancing of Traffic from a PE to Remote CEs`**
...
<a id="section-14-1-1"></a> **`14.1.1. Single-Active Redundancy Mode`**
...
<a id="section-14-1-2"></a> **`14.1.2. All-Active Redundancy Mode`**
...
<a id="section-14-2"></a> **`14.2. Load Balancing of Traffic between a PE and a Local CE`**
...
<a id="section-14-2-1"></a> **`14.2.1. Data-Plane Learning`**
...
<a id="section-14-2-2"></a> **`14.2.2. Control-Plane Learning`**
...
<a id="section-15"></a> **`15. MAC Mobility`**
...
<a id="section-15-1"></a> **`15.1. MAC Duplication Issue`**
...
<a id="section-15-2"></a> **`15.2. Sticky MAC Addresses`**
...
<a id="section-16"></a> **`16. Multicast and Broadcast`**
...
<a id="section-16-1"></a> **`16.1. Ingress Replication`**
...
<a id="section-16-2"></a> **`16.2. P2MP LSPs`**
...
<a id="section-16-2-1"></a> **`16.2.1. Inclusive Trees`**
...
<a id="section-17"></a> **`17. Convergence`**
...
<a id="section-17-1"></a> **`17.1. Transit Link and Node Failures between PEs`**
...
<a id="section-17-2"></a> **`17.2. PE Failures`**
...
<a id="section-17-3"></a> **`17.3. PE-to-CE Network Failures`**
...
<a id="section-18"></a> **`18. Frame Ordering`**
...
<a id="section-19"></a> **`19. Security Considerations`**
...
<a id="section-20"></a> **`20. IANA Considerations`**
...
<a id="section-21"></a> **`21. References`**

```text

```

<a id="section-21-1"></a> **`21.1. Normative References`**
...
<a id="section-21-2"></a> **`21.2. Informative References`**
