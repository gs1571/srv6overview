...
<a id="section-2"></a> **`2. Path-Key Solution`**
...
<a id="section-2-1"></a> **`2.1. Mode of Operation`**
...
<a id="section-2-2"></a> **`2.2. Example`**
...
<a id="section-3"></a> **`3. PCEP Protocol Extensions`**

```text

```

<a id="section-3-1"></a> **`3.1. Path-Keys in PCRep Messages`**
...
<a id="section-3-1-1"></a> **`3.1.1. PKS with 32-Bit PCE ID`**
...
<a id="section-3-1-2"></a> **`3.1.2. PKS with 128-Bit PCE ID`**
...
<a id="section-3-2"></a> **`3.2. Unlocking Path-Keys`**
...
<a id="section-3-2-1"></a> **`3.2.1. Path-Key Bit`**
...
<a id="section-3-2-2"></a> **`3.2.2. PATH-KEY Object`**
...
<a id="section-3-2-3"></a> **`3.2.3. Path Computation Request (PCReq) Message with Path-Key`**
...
<a id="section-4"></a> **`4. PCEP Mode of Operation for Path-Key Expansion`**
...
<a id="section-6-1"></a> **`6.1. Control of Function through Configuration and Policy`**
...
<a id="section-6-2"></a> **`6.2. Information and Data Models`**
...
<a id="section-7-1"></a> **`7.1. New Subobjects for the ERO Object`**
...
<a id="section-7-3"></a> **`7.3. New RP Object Bit Flag`**
...
<a id="section-7-4"></a> **`7.4. New NO-PATH-VECTOR TLV Bit Flag`**
