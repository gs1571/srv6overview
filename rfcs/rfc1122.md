...
`         `[`1.1.1`](#section-1-1-1)`. Internet Hosts`

`         `[`1.1.2`](#section-1-1-2)`. Architectural Assumptions`

`         `[`1.1.3`](#section-1-1-3)`. Internet Protocol Suite`

`         `[`1.1.4`](#section-1-1-4)`. Embedded Gateway Code`
...
`   `[`2`](#section-2)`. LINK LAYER`

`      `[`2.1`](#section-2-1)`. INTRODUCTION`
...
<a id="section-3"></a> **`3. INTERNET LAYER PROTOCOLS`**
...
<a id="section-4"></a> **`4. TRANSPORT PROTOCOLS`**
