...
`    `[`1.2`](#section-1-2)`. Acknowledgments`

`    `[`2`](#section-2)`. Multicast routing in MOSPF`

`    `[`2.1`](#section-2-1)`. Routing characteristics`

`    `[`2.2`](#section-2-2)`. Sample path of a multicast datagram`

`    `[`2.3`](#section-2-3)`. MOSPF forwarding mechanism`

`    `[`2.3.1`](#section-2-3-1)`. IGMP interface: the local group database`

`    `[`2.3.2`](#section-2-3-2)`. A datagram's shortest-path tree`

`    `[`2.3.3`](#section-2-3-3)`. Support for Non-broadcast networks`

`    `[`2.3.4`](#section-2-3-4)`. Details concerning forwarding cache entries`

`    `[`3`](#section-3)`. Inter-area multicasting`

`    `[`3.1`](#section-3-1)`. Extent of group-membership-LSAs`

`    `[`3.2`](#section-3-2)`. Building inter-area datagram shortest-path trees`

`    `[`4`](#section-4)`. Inter-AS multicasting`

`    `[`4.1`](#section-4-1)`. Building inter-AS datagram shortest-path trees`

`    `[`4.2`](#section-4-2)`. Stub area behavior`

`    `[`4.3`](#section-4-3)`. Inter-AS multicasting in a core Autonomous System`

`    `[`5`](#section-5)`. Modelling internal group membership`

`    `[`6`](#section-6)`. Additional capabilities`

`    `[`6.1`](#section-6-1)`. Mixing with non-multicast routers`

`    `[`6.2`](#section-6-2)`. TOS-based multicast`

`    `[`6.3`](#section-6-3)`. Assigning multiple IP networks to a physical network`

`    `[`6.4`](#section-6-4)`. Networks on Autonomous System boundaries`

`    `[`6.5`](#section-6-5)`. Recommended system configuration`

`    `[`7`](#section-7)`. Basic implementation requirements`

`    `[`8`](#section-8)`. Protocol data structures`

`    `[`8.1`](#section-8-1)`. Additions to the OSPF area structure`

`    `[`8.2`](#section-8-2)`. Additions to the OSPF interface structure`

`    `[`8.3`](#section-8-3)`. Additions to the OSPF neighbor structure`

`    `[`8.4`](#section-8-4)`. The local group database`

`    `[`8.5`](#section-8-5)`. The forwarding cache`

`    `[`9`](#section-9)`. Interaction with the IGMP protocol`

`    `[`9.1`](#section-9-1)`. Sending IGMP Host Membership Queries`

`    `[`9.2`](#section-9-2)`. Receiving IGMP Host Membership Reports`

`    `[`9.3`](#section-9-3)`. Aging local group database entries`

`    `[`9.4`](#section-9-4)`. Receiving IGMP Host Membership Queries`

`    `[`10`](#section-10)`. Group-membership-LSAs`

`    `[`10.1`](#section-10-1)`. Constructing group-membership-LSAs`

`    `[`10.2`](#section-10-2)`. Flooding group-membership-LSAs`

`    `[`11`](#section-11)`. Detailed description of multicast datagram forwarding`

`    `[`11.1`](#section-11-1)`. Associating a MOSPF interface with a received datagram  55`

`    `[`11.2`](#section-11-2)`. Locating the source network`

`    `[`11.3`](#section-11-3)`. Forwarding locally originated multicasts`

`    `[`12`](#section-12)`. Construction of forwarding cache entries`

`    `[`12.1`](#section-12-1)`. The Vertex data structure`

`    `[`12.2`](#section-12-2)`. The SPF calculation`

`    `[`12.2.1`](#section-12-2-1)`. Candidate list Initialization: Case SourceIntraArea`

`    `[`12.2.2`](#section-12-2-2)`. Candidate list Initialization: Case SourceInterArea1`

`    `[`12.2.3`](#section-12-2-3)`. Candidate list Initialization: Case SourceInterArea2`

`    `[`12.2.4`](#section-12-2-4)`. Candidate list Initialization: Case SourceExternal`

`    `[`12.2.5`](#section-12-2-5)`. Candidate list Initialization: Case SourceStubExternal  70`

`    `[`12.2.6`](#section-12-2-6)`. Processing labelled vertices`

`    `[`12.2.7`](#section-12-2-7)`. Merging datagram shortest-path trees`

`    `[`12.2.8`](#section-12-2-8)`. TOS considerations`

`    `[`12.2.9`](#section-12-2-9)`. Comparison to the unicast SPF calculation`

`    `[`12.3`](#section-12-3)`. Adding local database entries to the forwarding cache   75`

`    `[`13`](#section-13)`. Maintaining the forwarding cache`

`    `[`14`](#section-14)`. Other additions to the OSPF specification`

`    `[`14.1`](#section-14-1)`. The Designated Router`

`    `[`14.2`](#section-14-2)`. Sending Hello packets`

`    `[`14.3`](#section-14-3)`. The Neighbor state machine`

`    `[`14.4`](#section-14-4)`. Receiving Database Description packets`

`    `[`14.5`](#section-14-5)`. Sending Database Description packets`

`    `[`14.6`](#section-14-6)`. Originating Router-LSAs`

`    `[`14.7`](#section-14-7)`. Originating Network-LSAs`

`    `[`14.8`](#section-14-8)`. Originating Summary-link-LSAs`

`    `[`14.9`](#section-14-9)`. Originating AS external-link-LSAs`

`    `[`14.10`](#section-14-10)`. Next step in the flooding procedure`

`    `[`14.11`](#section-14-11)`. Virtual links`
...
<a id="section-2"></a> **`2. Multicast routing in MOSPF`**
...
<a id="section-3"></a> **`3. Inter-area multicasting`**
...
<a id="section-4"></a> **`4. Inter-AS multicasting`**
...
<a id="section-5"></a> **`5. Modelling internal group membership`**
...
<a id="section-6"></a> **`6. Additional capabilities`**
...
<a id="section-7"></a> **`7. Basic implementation requirements`**
...
<a id="section-8"></a> **`8. Protocol data structures`**
...
<a id="section-9"></a> **`9. Interaction with the IGMP protocol`**
...
<a id="section-10"></a> **`10. Group-membership-LSAs`**
...
<a id="section-11"></a> **`11. Detailed description of multicast datagram forwarding`**
...
<a id="section-12"></a> **`12. Construction of forwarding cache entries`**
...
<a id="section-13"></a> **`13. Maintaining the forwarding cache`**
...
<a id="section-14"></a> **`14. Other additions to the OSPF specification`**
