...
`    `[`3`](#section-3)`. Restricting forged traffic`

`    `[`4`](#section-4)`. Further capabilities for networking equipment`

`    `[`5`](#section-5)`. Liabilities`
...
<a id="section-3"></a> **`3. Restricting forged traffic`**
...
<a id="section-4"></a> **`4. Further possible capabilities for networking equipment`**
...
<a id="section-5"></a> **`5. Liabilities`**
