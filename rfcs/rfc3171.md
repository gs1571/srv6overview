...
<a id="section-2"></a> **`2. Definition of Current Assignment Practice`**
...
<a id="section-3"></a> **`3. Local Network Control Block (224.0.0/24)`**
...
<a id="section-3-1"></a> **`3.1. Assignment Guidelines`**
...
<a id="section-4"></a> **`4. Internetwork Control Block (224.0.1/24)`**
...
<a id="section-5"></a> **`5. AD-HOC Block (224.0.2.0/24 - 224.0.255.0/24)`**
...
<a id="section-6"></a> **`6. SDP/SAP Block (224.2/16)`**
...
<a id="section-7"></a> **`7. Source Specific Multicast Block (232/8)`**
...
<a id="section-8"></a> **`8. GLOP Block (233/8)`**
...
<a id="section-9"></a> **`9. Administratively Scoped Address Block (239/8)`**
...
<a id="section-9-1-1"></a> **`9.1.1. Relative Offsets`**
...
<a id="section-10"></a> **`10. Annual Review`**
...
<a id="section-10-1"></a> **`10.1. Address Reclamation`**
...
<a id="section-11"></a> **`11. Use of IANA Reserved Addresses`**
