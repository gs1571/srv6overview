...
`      `[`1.1`](#section-1-1)`. Specific Extensions Covered`

`      `[`1.2`](#section-1-2)`. Conventions Used in This Document`

`   `[`2`](#section-2)`. Extensions to the Handshake Protocol`

`   `[`3`](#section-3)`. Server Name Indication`

`   `[`4`](#section-4)`. Maximum Fragment Length Negotiation`

`   `[`5`](#section-5)`. Client Certificate URLs`

`   `[`6`](#section-6)`. Trusted CA Indication`

`   `[`7`](#section-7)`. Truncated HMAC`

`   `[`8`](#section-8)`. Certificate Status Request`

`   `[`9`](#section-9)`. Error Alerts`

`   `[`10`](#section-10)`. IANA Considerations`

`      `[`10.1`](#section-10-1)`. pkipath MIME Type Registration`

`      `[`10.2`](#section-10-2)`. Reference for TLS Alerts, TLS HandshakeTypes, and`

`            ExtensionTypes`

`   `[`11`](#section-11)`. Security Considerations`

`      `[`11.1`](#section-11-1)`. Security Considerations for server_name`

`      `[`11.2`](#section-11-2)`. Security Considerations for max_fragment_length`

`      `[`11.3`](#section-11-3)`. Security Considerations for client_certificate_url`

`      `[`11.4`](#section-11-4)`. Security Considerations for trusted_ca_keys`

`      `[`11.5`](#section-11-5)`. Security Considerations for truncated_hmac`

`      `[`11.6`](#section-11-6)`. Security Considerations for status_request`
...
<a id="section-1-1"></a> **`1.1. Specific Extensions Covered`**
...
<a id="section-2"></a> **`2. Extensions to the Handshake Protocol`**
...
<a id="section-3"></a> **`3. Server Name Indication`**
...
<a id="section-4"></a> **`4. Maximum Fragment Length Negotiation`**
...
<a id="section-5"></a> **`5. Client Certificate URLs`**
...
<a id="section-6"></a> **`6. Trusted CA Indication`**
...
<a id="section-7"></a> **`7. Truncated HMAC`**
...
<a id="section-8"></a> **`8. Certificate Status Request`**
...
<a id="section-9"></a> **`9. Error Alerts`**
...
<a id="section-10-1"></a> **`10.1. pkipath MIME Type Registration`**
...
<a id="section-10-2"></a> **`10.2. Reference for TLS Alerts, TLS HandshakeTypes, and ExtensionTypes`**
...
<a id="section-11-1"></a> **`11.1. Security Considerations for server_name`**
...
<a id="section-11-2"></a> **`11.2. Security Considerations for max_fragment_length`**
...
<a id="section-11-3"></a> **`11.3. Security Considerations for client_certificate_url`**
...
<a id="section-11-4"></a> **`11.4. Security Considerations for trusted_ca_keys`**
...
<a id="section-11-5"></a> **`11.5. Security Considerations for truncated_hmac`**
...
<a id="section-11-6"></a> **`11.6. Security Considerations for status_request`**
