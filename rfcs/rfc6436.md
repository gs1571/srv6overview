...
`   `[`2`](#section-2)`. Impact of Current Specification`

`   `[`3`](#section-3)`. Changes to the Specification`
...
<a id="section-2"></a> **`2. Impact of Current Specification`**
...
<a id="section-3"></a> **`3. Changes to the Specification`**
