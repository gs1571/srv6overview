...
`     `[`2`](#section-2)`. 1 Next Header`

`     `[`2`](#section-2)`. 2 Payload Length`

`     `[`2`](#section-2)`. 3 Reserved`

`     `[`2`](#section-2)`. 4 Security Parameters Index (SPI)`

`     `[`2`](#section-2)`. 5 Sequence Number`

`     `[`2`](#section-2)`. 6 Authentication Data`

`  `[`3`](#section-3)`. Authentication Header Processing`

`     `[`3.1`](#section-3-1)`. Authentication Header Location`

`     `[`3.2`](#section-3-2)`. Authentication Algorithms`
...
`              `[`3.3.3.1.1`](#section-3-3-3-1-1)`. ICV Computation for IPv4`

`                 `[`3.3.3.1.1`](#section-3-3-3-1-1)`. 1 Base Header Fields`

`                 `[`3.3.3.1.1`](#section-3-3-3-1-1)`. 2 Options`

`              `[`3.3.3.1.2`](#section-3-3-3-1-2)`. ICV Computation for IPv6`

`                 `[`3.3.3.1.2`](#section-3-3-3-1-2)`. 1 Base Header Fields`

`                 `[`3.3.3.1.2`](#section-3-3-3-1-2)`. 2 Extension Headers Containing Options`

`                 `[`3.3.3.1.2`](#section-3-3-3-1-2)`. 3 Extension Headers Not Containing Options`

`           `[`3.3.3.2`](#section-3-3-3-2)`. Padding`

`              `[`3.3.3.2.1`](#section-3-3-3-2-1)`. Authentication Data Padding`

`              `[`3.3.3.2.2`](#section-3-3-3-2-2)`. Implicit Packet Padding`
...
`  `[`7`](#section-7)`. Differences from RFC 1826`
...
<a id="section-7"></a> **`7. Differences from RFC 1826`**
