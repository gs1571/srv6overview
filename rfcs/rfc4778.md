...
`     `[`1.1`](#section-1-1)`. Scope`

`     `[`1.2`](#section-1-2)`. Threat Model`

`     `[`1.3`](#section-1-3)`. Attack Sources`

`     `[`1.4`](#section-1-4)`. Operational Security Impact from Threats`

`     `[`1.5`](#section-1-5)`. Document Layout`

`   `[`2`](#section-2)`. Protected Operational Functions`

`     `[`2.1`](#section-2-1)`. Device Physical Access`

`     `[`2.2`](#section-2-2)`. Device Management - In-Band and Out-of-Band (OOB)`

`     `[`2.3`](#section-2-3)`. Data Path`

`     `[`2.4`](#section-2-4)`. Routing Control Plane`

`     `[`2.5`](#section-2-5)`. Software Upgrades and Configuration`

`           Integrity/Validation`

`     `[`2.6`](#section-2-6)`. Logging Considerations`

`     `[`2.7`](#section-2-7)`. Filtering Considerations`

`     `[`2.8`](#section-2-8)`. Denial-of-Service Tracking/Tracing`

`   `[`3`](#section-3)`. Security Considerations`

`   `[`4`](#section-4)`. Acknowledgments`

`   `[`5`](#section-5)`. References`

`     `[`5.1`](#section-5-1)`. Normative References`

`     `[`5.2`](#section-5-2)`. Informational References`
...
<a id="section-1-2"></a> **`1.2. Threat Model`**
...
<a id="section-1-3"></a> **`1.3. Attack Sources`**
...
<a id="section-1-4"></a> **`1.4. Operational Security Impact from Threats`**
...
<a id="section-1-5"></a> **`1.5. Document Layout`**
...
<a id="section-2"></a> **`2. Protected Operational Functions`**

```text

```

<a id="section-2-1"></a> **`2.1. Device Physical Access`**
...
<a id="section-2-1-1"></a> **`2.1.1. Threats/Attacks`**
...
<a id="section-2-1-2"></a> **`2.1.2. Security Practices`**
...
<a id="section-2-1-3"></a> **`2.1.3. Security Services`**
...
<a id="section-2-1-4"></a> **`2.1.4. Additional Considerations`**
...
<a id="section-2-2"></a> **`2.2. Device Management - In-Band and Out-of-Band (OOB)`**
...
<a id="section-2-2-1"></a> **`2.2.1. Threats/Attacks`**
...
<a id="section-2-2-1-1"></a> **`2.2.1.1. Confidentiality Violations`**
...
<a id="section-2-2-1-2"></a> **`2.2.1.2. Offline Cryptographic Attacks`**
...
<a id="section-2-2-1-3"></a> **`2.2.1.3. Replay Attacks`**
...
<a id="section-2-2-1-4"></a> **`2.2.1.4. Message Insertion/Deletion/Modification`**
...
<a id="section-2-2-1-5"></a> **`2.2.1.5. Man-In-The-Middle`**
...
<a id="section-2-2-2"></a> **`2.2.2. Security Practices`**
...
<a id="section-2-2-3"></a> **`2.2.3. Security Services`**
...
<a id="section-2-2-4"></a> **`2.2.4. Additional Considerations`**
...
<a id="section-2-3"></a> **`2.3. Data Path`**
...
<a id="section-2-3-1"></a> **`2.3.1. Threats/Attacks`**
...
<a id="section-2-3-2"></a> **`2.3.2. Security Practices`**
...
<a id="section-2-3-3"></a> **`2.3.3. Security Services`**
...
<a id="section-2-3-4"></a> **`2.3.4. Additional Considerations`**
...
<a id="section-2-4"></a> **`2.4. Routing Control Plane`**
...
<a id="section-2-4-1"></a> **`2.4.1. Threats/Attacks`**
...
<a id="section-2-4-1-1"></a> **`2.4.1.1. Confidentiality Violations`**
...
<a id="section-2-4-1-2"></a> **`2.4.1.2. Offline Cryptographic Attacks`**
...
<a id="section-2-4-1-3"></a> **`2.4.1.3. Replay Attacks`**
...
<a id="section-2-4-1-4"></a> **`2.4.1.4. Message Insertion/Deletion/Modification`**
...
<a id="section-2-4-1-5"></a> **`2.4.1.5. Man-In-The-Middle`**
...
<a id="section-2-4-2"></a> **`2.4.2. Security Practices`**
...
<a id="section-2-4-3"></a> **`2.4.3. Security Services`**
...
<a id="section-2-4-4"></a> **`2.4.4. Additional Considerations`**
...
<a id="section-2-5"></a> **`2.5. Software Upgrades and Configuration Integrity/Validation`**
...
<a id="section-2-5-1"></a> **`2.5.1. Threats/Attacks`**
...
<a id="section-2-5-1-1"></a> **`2.5.1.1. Confidentiality Violations`**
...
<a id="section-2-5-1-2"></a> **`2.5.1.2. Offline Cryptographic Attacks`**
...
<a id="section-2-5-1-3"></a> **`2.5.1.3. Replay Attacks`**
...
<a id="section-2-5-1-4"></a> **`2.5.1.4. Message Insertion/Deletion/Modification`**
...
<a id="section-2-5-1-5"></a> **`2.5.1.5. Man-In-The-Middle`**
...
<a id="section-2-5-2"></a> **`2.5.2. Security Practices`**
...
<a id="section-2-5-3"></a> **`2.5.3. Security Services`**
...
<a id="section-2-5-4"></a> **`2.5.4. Additional Considerations`**
...
<a id="section-2-6"></a> **`2.6. Logging Considerations`**
...
<a id="section-2-6-1"></a> **`2.6.1. Threats/Attacks`**
...
<a id="section-2-6-1-1"></a> **`2.6.1.1. Confidentiality Violations`**
...
<a id="section-2-6-1-2"></a> **`2.6.1.2. Offline Cryptographic Attacks`**
...
<a id="section-2-6-1-3"></a> **`2.6.1.3. Replay Attacks`**
...
<a id="section-2-6-1-4"></a> **`2.6.1.4. Message Insertion/Deletion/Modification`**
...
<a id="section-2-6-1-5"></a> **`2.6.1.5. Man-In-The-Middle`**
...
<a id="section-2-6-2"></a> **`2.6.2. Security Practices`**
...
<a id="section-2-6-3"></a> **`2.6.3. Security Services`**
...
<a id="section-2-6-4"></a> **`2.6.4. Additional Considerations`**
...
<a id="section-2-7"></a> **`2.7. Filtering Considerations`**
...
<a id="section-2-7-1"></a> **`2.7.1. Data Plane Filtering`**
...
<a id="section-2-7-2"></a> **`2.7.2. Management Plane Filtering`**
...
<a id="section-2-7-3"></a> **`2.7.3. Routing Control Plane Filtering`**
...
<a id="section-2-8"></a> **`2.8. Denial-of-Service Tracking/Tracing`**
...
<a id="section-2-8-1"></a> **`2.8.1. Sinkhole Routing`**
...
<a id="section-2-8-2"></a> **`2.8.2. Black Hole Triggered Routing`**
...
<a id="section-2-8-3"></a> **`2.8.3. Unicast Reverse Path Forwarding`**
...
<a id="section-2-8-4"></a> **`2.8.4. Rate Limiting`**
...
<a id="section-2-8-5"></a> **`2.8.5. Specific Control Plane Traffic Enhancements`**
...
<a id="section-3"></a> **`3. Security Considerations`**
...
<a id="section-4"></a> **`4. Acknowledgments`**
...
<a id="section-5"></a> **`5. References`**

```text

```

<a id="section-5-1"></a> **`5.1. Normative References`**
...
<a id="section-5-2"></a> **`5.2. Informational References`**
