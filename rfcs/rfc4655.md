...
`   `[`4`](#section-4)`. Motivation for a PCE-Based Architecture`

`      `[`4.1`](#section-4-1)`. CPU-Intensive Path Computation`

`      `[`4.2`](#section-4-2)`. Partial Visibility`

`      `[`4.3`](#section-4-3)`. Absence of the TED or Use of Non-TE-Enabled IGP`

`      `[`4.4`](#section-4-4)`. Node Outside the Routing Domain`

`      `[`4.5`](#section-4-5)`. Network Element Lacks Control Plane or Routing Capability`

`      `[`4.6`](#section-4-6)`. Backup Path Computation for Bandwidth Protection`

`      `[`4.7`](#section-4-7)`. Multi-layer Networks`

`      `[`4.8`](#section-4-8)`. Path Selection Policy`

`      `[`4.9`](#section-4-9)`. Non-Motivations`

`           `[`4.9.1`](#section-4-9-1)`. The Whole Internet`

`           `[`4.9.2`](#section-4-9-2)`. Guaranteed TE LSP Establishment`

`   `[`5`](#section-5)`. Overview of the PCE-Based Architecture`

`      `[`5.1`](#section-5-1)`. Composite PCE Node`

`      `[`5.2`](#section-5-2)`. External PCE`

`      `[`5.3`](#section-5-3)`. Multiple PCE Path Computation`

`      `[`5.4`](#section-5-4)`. Multiple PCE Path Computation with Inter-PCE`

`           Communication`

`      `[`5.5`](#section-5-5)`. Management-Based PCE Usage`

`      `[`5.6`](#section-5-6)`. Areas for Standardization`

`   `[`6`](#section-6)`. PCE Architectural Considerations`

`      `[`6.1`](#section-6-1)`. Centralized Computation Model`

`      `[`6.2`](#section-6-2)`. Distributed Computation Model`

`      `[`6.3`](#section-6-3)`. Synchronization`

`      `[`6.4`](#section-6-4)`. PCE Discovery and Load Balancing`

`      `[`6.5`](#section-6-5)`. Detecting PCE Liveness`

`      `[`6.6`](#section-6-6)`. PCC-PCE and PCE-PCE Communication`

`      `[`6.7`](#section-6-7)`. PCE TED Synchronization`

`      `[`6.8`](#section-6-8)`. Stateful versus Stateless PCEs`

`      `[`6.9`](#section-6-9)`. Monitoring`

`      `[`6.10`](#section-6-10)`. Confidentiality`

`      `[`6.11`](#section-6-11)`. Policy`

`           `[`6.11.1`](#section-6-11-1)`. PCE Policy Architecture`

`           `[`6.11.2`](#section-6-11-2)`. Policy Realization`

`           `[`6.11.3`](#section-6-11-3)`. Type of Policies`

`           `[`6.11.4`](#section-6-11-4)`. Relationship to Signaling`

`      `[`6.12`](#section-6-12)`. Unsolicited Interactions`

`      `[`6.13`](#section-6-13)`. Relationship with Crankback`

`   `[`7`](#section-7)`. The View from the Path Computation Client`

`   `[`8`](#section-8)`. Evaluation Metrics`

`   `[`9`](#section-9)`. Manageability Considerations`

`      `[`9.1`](#section-9-1)`. Control of Function and Policy`
...
`      `[`9.7`](#section-9-7)`. Other Considerations`
...
<a id="section-4"></a> **`4. Motivation for a PCE-Based Architecture`**
...
<a id="section-4-1"></a> **`4.1. CPU-Intensive Path Computation`**
...
<a id="section-4-2"></a> **`4.2. Partial Visibility`**
...
<a id="section-4-3"></a> **`4.3. Absence of the TED or Use of Non-TE-Enabled IGP`**
...
<a id="section-4-4"></a> **`4.4. Node Outside the Routing Domain`**
...
<a id="section-4-5"></a> **`4.5. Network Element Lacks Control Plane or Routing Capability`**
...
<a id="section-4-6"></a> **`4.6. Backup Path Computation for Bandwidth Protection`**
...
<a id="section-4-7"></a> **`4.7. Multi-layer Networks`**
...
<a id="section-4-8"></a> **`4.8. Path Selection Policy`**
...
<a id="section-4-9"></a> **`4.9. Non-Motivations`**

```text

```

<a id="section-4-9-1"></a> **`4.9.1. The Whole Internet`**
...
<a id="section-4-9-2"></a> **`4.9.2. Guaranteed TE LSP Establishment`**
...
<a id="section-5"></a> **`5. Overview of the PCE-Based Architecture`**
...
<a id="section-5-1"></a> **`5.1. Composite PCE Node`**
...
<a id="section-5-2"></a> **`5.2. External PCE`**
...
<a id="section-5-3"></a> **`5.3. Multiple PCE Path Computation`**
...
<a id="section-5-4"></a> **`5.4. Multiple PCE Path Computation with Inter-PCE Communication`**
...
<a id="section-5-5"></a> **`5.5. Management-Based PCE Usage`**
...
<a id="section-5-6"></a> **`5.6. Areas for Standardization`**
...
<a id="section-6"></a> **`6. PCE Architectural Considerations`**
...
<a id="section-6-1"></a> **`6.1. Centralized Computation Model`**
...
<a id="section-6-2"></a> **`6.2. Distributed Computation Model`**
...
<a id="section-6-3"></a> **`6.3. Synchronization`**
...
<a id="section-6-4"></a> **`6.4. PCE Discovery and Load Balancing`**
...
<a id="section-6-5"></a> **`6.5. Detecting PCE Liveness`**
...
<a id="section-6-6"></a> **`6.6. PCC-PCE and PCE-PCE Communication`**
...
<a id="section-6-7"></a> **`6.7. PCE TED Synchronization`**
...
<a id="section-6-8"></a> **`6.8. Stateful versus Stateless PCEs`**
...
<a id="section-6-9"></a> **`6.9. Monitoring`**
...
<a id="section-6-10"></a> **`6.10. Confidentiality`**
...
<a id="section-6-11"></a> **`6.11. Policy`**
...
<a id="section-6-11-1"></a> **`6.11.1. PCE Policy Architecture`**
...
<a id="section-6-11-2"></a> **`6.11.2. Policy Realization`**
...
<a id="section-6-11-3"></a> **`6.11.3. Type of Policies`**
...
<a id="section-6-11-4"></a> **`6.11.4. Relationship to Signaling`**
...
<a id="section-6-12"></a> **`6.12. Unsolicited Interactions`**
...
<a id="section-6-13"></a> **`6.13. Relationship with Crankback`**
...
<a id="section-7"></a> **`7. The View from the Path Computation Client`**
...
<a id="section-8"></a> **`8. Evaluation Metrics`**
...
<a id="section-9-1"></a> **`9.1. Control of Function and Policy`**
...
<a id="section-9-7"></a> **`9.7. Other Considerations`**
