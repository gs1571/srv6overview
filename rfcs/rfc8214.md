...
`   `[`2`](#section-2)`. Service Interface`

`      `[`2.1`](#section-2-1)`. VLAN-Based Service Interface`

`      `[`2.2`](#section-2-2)`. VLAN Bundle Service Interface`

`           `[`2.2.1`](#section-2-2-1)`. Port-Based Service Interface`

`      `[`2.3`](#section-2-3)`. VLAN-Aware Bundle Service Interface`

`   `[`3`](#section-3)`. BGP Extensions`

`      `[`3.1`](#section-3-1)`. EVPN Layer 2 Attributes Extended Community`

`   `[`4`](#section-4)`. Operation`

`   `[`5`](#section-5)`. EVPN Comparison to PW Signaling`

`   `[`6`](#section-6)`. Failure Scenarios`

`      `[`6.1`](#section-6-1)`. Single-Homed CEs`

`      `[`6.2`](#section-6-2)`. Multihomed CEs`
...
<a id="section-2"></a> **`2. Service Interface`**

```text

```

<a id="section-2-1"></a> **`2.1. VLAN-Based Service Interface`**
...
<a id="section-2-2"></a> **`2.2. VLAN Bundle Service Interface`**
...
<a id="section-2-2-1"></a> **`2.2.1. Port-Based Service Interface`**
...
<a id="section-2-3"></a> **`2.3. VLAN-Aware Bundle Service Interface`**
...
<a id="section-3"></a> **`3. BGP Extensions`**
...
<a id="section-3-1"></a> **`3.1. EVPN Layer 2 Attributes Extended Community`**
...
<a id="section-5"></a> **`5. EVPN Comparison to PW Signaling`**
...
<a id="section-6"></a> **`6. Failure Scenarios`**
...
<a id="section-6-1"></a> **`6.1. Single-Homed CEs`**
...
<a id="section-6-2"></a> **`6.2. Multihomed CEs`**
