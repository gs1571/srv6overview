...
`       `[`1.2`](#section-1-2)`. Use of DNS Address-to-Name Maps (IN-ADDR.ARPA and`

`             IP6.ARPA)`

`       `[`1.3`](#section-1-3)`. Usage Criteria`

`   `[`2`](#section-2)`. Storage Formats`

`       `[`2.1`](#section-2-1)`. IPSECKEY RDATA Format`

`       `[`2.2`](#section-2-2)`. RDATA Format - Precedence`

`       `[`2.3`](#section-2-3)`. RDATA Format - Gateway Type`

`       `[`2.4`](#section-2-4)`. RDATA Format - Algorithm Type`

`       `[`2.5`](#section-2-5)`. RDATA Format - Gateway`

`       `[`2.6`](#section-2-6)`. RDATA Format - Public Keys`

`   `[`3`](#section-3)`. Presentation Formats`

`       `[`3.1`](#section-3-1)`. Representation of IPSECKEY RRs`

`       `[`3.2`](#section-3-2)`. Examples`

`   `[`4`](#section-4)`. Security Considerations`

`       `[`4.1`](#section-4-1)`. Active Attacks Against Unsecured IPSECKEY Resource`

`             Records`

`             `[`4.1.1`](#section-4-1-1)`. Active Attacks Against IPSECKEY Keying`

`                     Materials`

`             `[`4.1.2`](#section-4-1-2)`. Active Attacks Against IPSECKEY Gateway`
...
<a id="section-1-2"></a> **`1.2. Use of DNS Address-to-Name Maps (IN-ADDR.ARPA and IP6.ARPA)`**
...
<a id="section-1-3"></a> **`1.3. Usage Criteria`**
...
<a id="section-2"></a> **`2. Storage Formats`**

```text

```

<a id="section-2-1"></a> **`2.1. IPSECKEY RDATA Format`**
...
<a id="section-2-2"></a> **`2.2. RDATA Format - Precedence`**
...
<a id="section-2-3"></a> **`2.3. RDATA Format - Gateway Type`**
...
<a id="section-2-4"></a> **`2.4. RDATA Format - Algorithm Type`**
...
<a id="section-2-5"></a> **`2.5. RDATA Format - Gateway`**
...
<a id="section-2-6"></a> **`2.6. RDATA Format - Public Keys`**
...
<a id="section-3"></a> **`3. Presentation Formats`**

```text

```

<a id="section-3-1"></a> **`3.1. Representation of IPSECKEY RRs`**
...
<a id="section-4-1"></a> **`4.1. Active Attacks Against Unsecured IPSECKEY Resource Records`**
...
<a id="section-4-1-1"></a> **`4.1.1. Active Attacks Against IPSECKEY Keying Materials`**
...
<a id="section-4-1-2"></a> **`4.1.2. Active Attacks Against IPSECKEY Gateway Material`**
