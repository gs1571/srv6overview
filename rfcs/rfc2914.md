...
<a id="section-2"></a> **`2. Current standards on congestion control`**
...
<a id="section-3"></a> **`3. The development of end-to-end congestion control.`**

```text

```

<a id="section-3-1"></a> **`3.1. Preventing congestion collapse.`**
...
<a id="section-3-2"></a> **`3.2. Fairness`**
...
<a id="section-3-3"></a> **`3.3. Optimizing performance regarding throughput, delay, and loss.`**
...
<a id="section-4"></a> **`4. The role of the standards process`**
...
<a id="section-4-1"></a> **`4.1. The development of new transport protocols.`**
...
<a id="section-4-2"></a> **`4.2. Application-level issues that affect congestion control`**
...
<a id="section-4-3"></a> **`4.3. New developments in the standards process`**
...
<a id="section-5"></a> **`5. A description of congestion collapse`**
...
<a id="section-6"></a> **`6. Forms of end-to-end congestion control`**
...
<a id="section-6-1"></a> **`6.1. End-to-end congestion control for avoiding congestion collapse.`**
...
<a id="section-6-2"></a> **`6.2. End-to-end congestion control for fairness with TCP.`**
...
<a id="section-9"></a> **`9. TCP-Specific issues`**
...
<a id="section-9-1"></a> **`9.1. Slow-start.`**
...
<a id="section-9-2"></a> **`9.2. Additive Increase, Multiplicative Decrease.`**
...
<a id="section-9-3"></a> **`9.3. Retransmit timers.`**
...
<a id="section-9-4"></a> **`9.4. Fast Retransmit and Fast Recovery.`**
...
<a id="section-9-5"></a> **`9.5. Other aspects of TCP congestion control.`**
