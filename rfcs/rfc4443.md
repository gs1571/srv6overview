...
`   `[`2`](#section-2)`. ICMPv6 (ICMP for IPv6)`

`      `[`2.1`](#section-2-1)`. Message General Format`

`      `[`2.2`](#section-2-2)`. Message Source Address Determination`

`      `[`2.3`](#section-2-3)`. Message Checksum Calculation`

`      `[`2.4`](#section-2-4)`. Message Processing Rules`

`   `[`3`](#section-3)`. ICMPv6 Error Messages`

`      `[`3.1`](#section-3-1)`. Destination Unreachable Message`

`      `[`3.2`](#section-3-2)`. Packet Too Big Message`

`      `[`3.3`](#section-3-3)`. Time Exceeded Message`

`      `[`3.4`](#section-3-4)`. Parameter Problem Message`

`   `[`4`](#section-4)`. ICMPv6 Informational Messages`

`      `[`4.1`](#section-4-1)`. Echo Request Message`

`      `[`4.2`](#section-4-2)`. Echo Reply Message`

`   `[`5`](#section-5)`. Security Considerations`

`      `[`5.1`](#section-5-1)`. Authentication and Confidentiality of ICMP Messages`

`      `[`5.2`](#section-5-2)`. ICMP Attacks`

`   `[`6`](#section-6)`. IANA Considerations`

`      `[`6.1`](#section-6-1)`. Procedure for New ICMPV6 Type and Code Value Assignments`

`      `[`6.2`](#section-6-2)`. Assignments for This Document`
...
<a id="section-2"></a> **`2. ICMPv6 (ICMP for IPv6)`**
...
<a id="section-2-1"></a> **`2.1. Message General Format`**
...
<a id="section-2-2"></a> **`2.2. Message Source Address Determination`**
...
<a id="section-2-3"></a> **`2.3. Message Checksum Calculation`**
...
<a id="section-2-4"></a> **`2.4. Message Processing Rules`**
...
<a id="section-3"></a> **`3. ICMPv6 Error Messages`**

```text

```

<a id="section-3-1"></a> **`3.1. Destination Unreachable Message`**
...
<a id="section-3-2"></a> **`3.2. Packet Too Big Message`**
...
<a id="section-3-3"></a> **`3.3. Time Exceeded Message`**
...
<a id="section-3-4"></a> **`3.4. Parameter Problem Message`**
...
<a id="section-4"></a> **`4. ICMPv6 Informational Messages`**

```text

```

<a id="section-4-1"></a> **`4.1. Echo Request Message`**
...
<a id="section-4-2"></a> **`4.2. Echo Reply Message`**
...
<a id="section-5-1"></a> **`5.1. Authentication and Confidentiality of ICMP Messages`**
...
<a id="section-5-2"></a> **`5.2. ICMP Attacks`**
...
<a id="section-6-1"></a> **`6.1. Procedure for New ICMPV6 Type and Code Value Assignments`**
...
<a id="section-6-2"></a> **`6.2. Assignments for This Document`**
