...
`   `[`2`](#section-2)`. Introduction to MPLS`

`   `[`2.1`](#section-2-1)`. Overview`

`   `[`2.2`](#section-2-2)`. Terminology`

`   `[`2.3`](#section-2-3)`. Acronyms and Abbreviations`

`   `[`2.4`](#section-2-4)`. Acknowledgments`

`   `[`3`](#section-3)`. MPLS Basics`

`   `[`3.1`](#section-3-1)`. Labels`

`   `[`3.2`](#section-3-2)`. Upstream and Downstream LSRs`

`   `[`3.3`](#section-3-3)`. Labeled Packet`

`   `[`3.4`](#section-3-4)`. Label Assignment and Distribution`

`   `[`3.5`](#section-3-5)`. Attributes of a Label Binding`

`   `[`3.6`](#section-3-6)`. Label Distribution Protocols`

`   `[`3.7`](#section-3-7)`. Unsolicited Downstream vs. Downstream-on-Demand`

`   `[`3.8`](#section-3-8)`. Label Retention Mode`

`   `[`3.9`](#section-3-9)`. The Label Stack`

`   `[`3.10`](#section-3-10)`. The Next Hop Label Forwarding Entry (NHLFE)`

`   `[`3.11`](#section-3-11)`. Incoming Label Map (ILM)`

`   `[`3.12`](#section-3-12)`. FEC-to-NHLFE Map (FTN)`

`   `[`3.13`](#section-3-13)`. Label Swapping`

`   `[`3.14`](#section-3-14)`. Scope and Uniqueness of Labels`

`   `[`3.15`](#section-3-15)`. Label Switched Path (LSP), LSP Ingress, LSP Egress`

`   `[`3.16`](#section-3-16)`. Penultimate Hop Popping`

`   `[`3.17`](#section-3-17)`. LSP Next Hop`

`   `[`3.18`](#section-3-18)`. Invalid Incoming Labels`

`   `[`3.19`](#section-3-19)`. LSP Control: Ordered versus Independent`

`   `[`3.20`](#section-3-20)`. Aggregation`

`   `[`3.21`](#section-3-21)`. Route Selection`

`   `[`3.22`](#section-3-22)`. Lack of Outgoing Label`

`   `[`3.23`](#section-3-23)`. Time-to-Live (TTL)`

`   `[`3.24`](#section-3-24)`. Loop Control`

`   `[`3.25`](#section-3-25)`. Label Encodings`

`   `[`3.25.1`](#section-3-25-1)`. MPLS-specific Hardware and/or Software`

`   `[`3.25.2`](#section-3-25-2)`. ATM Switches as LSRs`

`   `[`3.25.3`](#section-3-25-3)`. Interoperability among Encoding Techniques`

`   `[`3.26`](#section-3-26)`. Label Merging`

`   `[`3.26.1`](#section-3-26-1)`. Non-merging LSRs`

`   `[`3.26.2`](#section-3-26-2)`. Labels for Merging and Non-Merging LSRs`

`   `[`3.26.3`](#section-3-26-3)`. Merge over ATM`

`   `[`3.26.3.1`](#section-3-26-3-1)`. Methods of Eliminating Cell Interleave`

`   `[`3.26.3.2`](#section-3-26-3-2)`. Interoperation: VC Merge, VP Merge, and Non-Merge`

`   `[`3.27`](#section-3-27)`. Tunnels and Hierarchy`

`   `[`3.27.1`](#section-3-27-1)`. Hop-by-Hop Routed Tunnel`

`   `[`3.27.2`](#section-3-27-2)`. Explicitly Routed Tunnel`

`   `[`3.27.3`](#section-3-27-3)`. LSP Tunnels`

`   `[`3.27.4`](#section-3-27-4)`. Hierarchy: LSP Tunnels within LSPs`

`   `[`3.27.5`](#section-3-27-5)`. Label Distribution Peering and Hierarchy`

`   `[`3.28`](#section-3-28)`. Label Distribution Protocol Transport`

`   `[`3.29`](#section-3-29)`. Why More than one Label Distribution Protocol?`

`   `[`3.29.1`](#section-3-29-1)`. BGP and LDP`

`   `[`3.29.2`](#section-3-29-2)`. Labels for RSVP Flowspecs`

`   `[`3.29.3`](#section-3-29-3)`. Labels for Explicitly Routed LSPs`

`   `[`3.30`](#section-3-30)`. Multicast`

`   `[`4`](#section-4)`. Some Applications of MPLS`

`   `[`4.1`](#section-4-1)`. MPLS and Hop by Hop Routed Traffic`

`   `[`4.1.1`](#section-4-1-1)`. Labels for Address Prefixes`

`   `[`4.1.2`](#section-4-1-2)`. Distributing Labels for Address Prefixes`

`   `[`4.1.2.1`](#section-4-1-2-1)`. Label Distribution Peers for an Address Prefix`

`   `[`4.1.2.2`](#section-4-1-2-2)`. Distributing Labels`

`   `[`4.1.3`](#section-4-1-3)`. Using the Hop by Hop path as the LSP`

`   `[`4.1.4`](#section-4-1-4)`. LSP Egress and LSP Proxy Egress`

`   `[`4.1.5`](#section-4-1-5)`. The Implicit NULL Label`

`   `[`4.1.6`](#section-4-1-6)`. Option: Egress-Targeted Label Assignment`

`   `[`4.2`](#section-4-2)`. MPLS and Explicitly Routed LSPs`

`   `[`4.2.1`](#section-4-2-1)`. Explicitly Routed LSP Tunnels`

`   `[`4.3`](#section-4-3)`. Label Stacks and Implicit Peering`

`   `[`4.4`](#section-4-4)`. MPLS and Multi-Path Routing`

`   `[`4.5`](#section-4-5)`. LSP Trees as Multipoint-to-Point Entities`

`   `[`4.6`](#section-4-6)`. LSP Tunneling between BGP Border Routers`

`   `[`4.7`](#section-4-7)`. Other Uses of Hop-by-Hop Routed LSP Tunnels`

`   `[`4.8`](#section-4-8)`. MPLS and Multicast`

`   `[`5`](#section-5)`. Label Distribution Procedures (Hop-by-Hop)`

`   `[`5.1`](#section-5-1)`. The Procedures for Advertising and Using labels`

`   `[`5.1.1`](#section-5-1-1)`. Downstream LSR: Distribution Procedure`

`   `[`5.1.1.1`](#section-5-1-1-1)`. PushUnconditional`

`   `[`5.1.1.2`](#section-5-1-1-2)`. PushConditional`

`   `[`5.1.1.3`](#section-5-1-1-3)`. PulledUnconditional`

`   `[`5.1.1.4`](#section-5-1-1-4)`. PulledConditional`

`   `[`5.1.2`](#section-5-1-2)`. Upstream LSR: Request Procedure`

`   `[`5.1.2.1`](#section-5-1-2-1)`. RequestNever`

`   `[`5.1.2.2`](#section-5-1-2-2)`. RequestWhenNeeded`

`   `[`5.1.2.3`](#section-5-1-2-3)`. RequestOnRequest`

`   `[`5.1.3`](#section-5-1-3)`. Upstream LSR: NotAvailable Procedure`

`   `[`5.1.3.1`](#section-5-1-3-1)`. RequestRetry`

`   `[`5.1.3.2`](#section-5-1-3-2)`. RequestNoRetry`

`   `[`5.1.4`](#section-5-1-4)`. Upstream LSR: Release Procedure`

`   `[`5.1.4.1`](#section-5-1-4-1)`. ReleaseOnChange`

`   `[`5.1.4.2`](#section-5-1-4-2)`. NoReleaseOnChange`

`   `[`5.1.5`](#section-5-1-5)`. Upstream LSR: labelUse Procedure`

`   `[`5.1.5.1`](#section-5-1-5-1)`. UseImmediate`

`   `[`5.1.5.2`](#section-5-1-5-2)`. UseIfLoopNotDetected`

`   `[`5.1.6`](#section-5-1-6)`. Downstream LSR: Withdraw Procedure`

`   `[`5.2`](#section-5-2)`. MPLS Schemes: Supported Combinations of Procedures`

`   `[`5.2.1`](#section-5-2-1)`. Schemes for LSRs that Support Label Merging`

`   `[`5.2.2`](#section-5-2-2)`. Schemes for LSRs that do not Support Label Merging`

`   `[`5.2.3`](#section-5-2-3)`. Interoperability Considerations`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Intellectual Property`

`   `[`8`](#section-8)`. Authors' Addresses`

`   `[`9`](#section-9)`. References`

`   `[`10`](#section-10)`. Full Copyright Statement`


<a id="section-1"></a> **`1. Specification`**
...
<a id="section-2"></a> **`2. Introduction to MPLS`**
...
<a id="section-2-1"></a> **`2.1. Overview`**
...
<a id="section-2-2"></a> **`2.2. Terminology`**
...
<a id="section-2-3"></a> **`2.3. Acronyms and Abbreviations`**
...
<a id="section-2-4"></a> **`2.4. Acknowledgments`**
...
<a id="section-3"></a> **`3. MPLS Basics`**
...
<a id="section-3-2"></a> **`3.2. Upstream and Downstream LSRs`**
...
<a id="section-3-3"></a> **`3.3. Labeled Packet`**
...
<a id="section-3-4"></a> **`3.4. Label Assignment and Distribution`**
...
<a id="section-3-5"></a> **`3.5. Attributes of a Label Binding`**
...
<a id="section-3-6"></a> **`3.6. Label Distribution Protocols`**
...
<a id="section-3-7"></a> **`3.7. Unsolicited Downstream vs. Downstream-on-Demand`**
...
<a id="section-3-8"></a> **`3.8. Label Retention Mode`**
...
<a id="section-3-9"></a> **`3.9. The Label Stack`**
...
<a id="section-3-10"></a> **`3.10. The Next Hop Label Forwarding Entry (NHLFE)`**
...
<a id="section-3-11"></a> **`3.11. Incoming Label Map (ILM)`**
...
<a id="section-3-12"></a> **`3.12. FEC-to-NHLFE Map (FTN)`**
...
<a id="section-3-13"></a> **`3.13. Label Swapping`**
...
<a id="section-3-14"></a> **`3.14. Scope and Uniqueness of Labels`**
...
<a id="section-3-15"></a> **`3.15. Label Switched Path (LSP), LSP Ingress, LSP Egress`**
...
<a id="section-3-16"></a> **`3.16. Penultimate Hop Popping`**
...
<a id="section-3-17"></a> **`3.17. LSP Next Hop`**
...
<a id="section-3-18"></a> **`3.18. Invalid Incoming Labels`**
...
<a id="section-3-19"></a> **`3.19. LSP Control: Ordered versus Independent`**
...
<a id="section-3-20"></a> **`3.20. Aggregation`**
...
<a id="section-3-21"></a> **`3.21. Route Selection`**
...
<a id="section-3-22"></a> **`3.22. Lack of Outgoing Label`**
...
<a id="section-3-23"></a> **`3.23. Time-to-Live (TTL)`**
...
<a id="section-3-24"></a> **`3.24. Loop Control`**
...
<a id="section-3-25"></a> **`3.25. Label Encodings`**
...
<a id="section-3-25-1"></a> **`3.25.1. MPLS-specific Hardware and/or Software`**
...
<a id="section-3-25-2"></a> **`3.25.2. ATM Switches as LSRs`**
...
<a id="section-3-25-3"></a> **`3.25.3. Interoperability among Encoding Techniques`**
...
<a id="section-3-26"></a> **`3.26. Label Merging`**
...
<a id="section-3-26-1"></a> **`3.26.1. Non-merging LSRs`**
...
<a id="section-3-26-2"></a> **`3.26.2. Labels for Merging and Non-Merging LSRs`**
...
<a id="section-3-26-3"></a> **`3.26.3. Merge over ATM`**

```text

```

<a id="section-3-26-3-1"></a> **`3.26.3.1. Methods of Eliminating Cell Interleave`**
...
<a id="section-3-26-3-2"></a> **`3.26.3.2. Interoperation: VC Merge, VP Merge, and Non-Merge`**
...
<a id="section-3-27"></a> **`3.27. Tunnels and Hierarchy`**
...
<a id="section-3-27-1"></a> **`3.27.1. Hop-by-Hop Routed Tunnel`**
...
<a id="section-3-27-2"></a> **`3.27.2. Explicitly Routed Tunnel`**
...
<a id="section-3-27-3"></a> **`3.27.3. LSP Tunnels`**
...
<a id="section-3-27-4"></a> **`3.27.4. Hierarchy: LSP Tunnels within LSPs`**
...
<a id="section-3-27-5"></a> **`3.27.5. Label Distribution Peering and Hierarchy`**
...
<a id="section-3-28"></a> **`3.28. Label Distribution Protocol Transport`**
...
<a id="section-3-29"></a> **`3.29. Why More than one Label Distribution Protocol?`**
...
<a id="section-3-29-1"></a> **`3.29.1. BGP and LDP`**
...
<a id="section-3-29-2"></a> **`3.29.2. Labels for RSVP Flowspecs`**
...
<a id="section-3-29-3"></a> **`3.29.3. Labels for Explicitly Routed LSPs`**
...
<a id="section-3-30"></a> **`3.30. Multicast`**
...
<a id="section-4"></a> **`4. Some Applications of MPLS`**

```text

```

<a id="section-4-1"></a> **`4.1. MPLS and Hop by Hop Routed Traffic`**
...
<a id="section-4-1-1"></a> **`4.1.1. Labels for Address Prefixes`**
...
<a id="section-4-1-2"></a> **`4.1.2. Distributing Labels for Address Prefixes`**

```text

```

<a id="section-4-1-2-1"></a> **`4.1.2.1. Label Distribution Peers for an Address Prefix`**
...
<a id="section-4-1-2-2"></a> **`4.1.2.2. Distributing Labels`**
...
<a id="section-4-1-3"></a> **`4.1.3. Using the Hop by Hop path as the LSP`**
...
<a id="section-4-1-4"></a> **`4.1.4. LSP Egress and LSP Proxy Egress`**
...
<a id="section-4-1-5"></a> **`4.1.5. The Implicit NULL Label`**
...
<a id="section-4-1-6"></a> **`4.1.6. Option: Egress-Targeted Label Assignment`**
...
<a id="section-4-2"></a> **`4.2. MPLS and Explicitly Routed LSPs`**
...
<a id="section-4-2-1"></a> **`4.2.1. Explicitly Routed LSP Tunnels`**
...
<a id="section-4-3"></a> **`4.3. Label Stacks and Implicit Peering`**
...
<a id="section-4-4"></a> **`4.4. MPLS and Multi-Path Routing`**
...
<a id="section-4-5"></a> **`4.5. LSP Trees as Multipoint-to-Point Entities`**
...
<a id="section-4-6"></a> **`4.6. LSP Tunneling between BGP Border Routers`**
...
<a id="section-4-7"></a> **`4.7. Other Uses of Hop-by-Hop Routed LSP Tunnels`**
...
<a id="section-4-8"></a> **`4.8. MPLS and Multicast`**
...
<a id="section-5"></a> **`5. Label Distribution Procedures (Hop-by-Hop)`**
...
<a id="section-5-1"></a> **`5.1. The Procedures for Advertising and Using labels`**
...
<a id="section-5-1-1"></a> **`5.1.1. Downstream LSR: Distribution Procedure`**
...
<a id="section-5-1-1-1"></a> **`5.1.1.1. PushUnconditional`**
...
<a id="section-5-1-1-2"></a> **`5.1.1.2. PushConditional`**
...
<a id="section-5-1-1-3"></a> **`5.1.1.3. PulledUnconditional`**
...
<a id="section-5-1-1-4"></a> **`5.1.1.4. PulledConditional`**
...
<a id="section-5-1-2"></a> **`5.1.2. Upstream LSR: Request Procedure`**
...
<a id="section-5-1-2-1"></a> **`5.1.2.1. RequestNever`**
...
<a id="section-5-1-2-2"></a> **`5.1.2.2. RequestWhenNeeded`**
...
<a id="section-5-1-2-3"></a> **`5.1.2.3. RequestOnRequest`**
...
<a id="section-5-1-3"></a> **`5.1.3. Upstream LSR: NotAvailable Procedure`**
...
<a id="section-5-1-3-1"></a> **`5.1.3.1. RequestRetry`**
...
<a id="section-5-1-3-2"></a> **`5.1.3.2. RequestNoRetry`**
...
<a id="section-5-1-4"></a> **`5.1.4. Upstream LSR: Release Procedure`**
...
<a id="section-5-1-4-1"></a> **`5.1.4.1. ReleaseOnChange`**
...
<a id="section-5-1-4-2"></a> **`5.1.4.2. NoReleaseOnChange`**
...
<a id="section-5-1-5"></a> **`5.1.5. Upstream LSR: labelUse Procedure`**
...
<a id="section-5-1-5-1"></a> **`5.1.5.1. UseImmediate`**
...
<a id="section-5-1-5-2"></a> **`5.1.5.2. UseIfLoopNotDetected`**
...
<a id="section-5-1-6"></a> **`5.1.6. Downstream LSR: Withdraw Procedure`**
...
<a id="section-5-2"></a> **`5.2. MPLS Schemes: Supported Combinations of Procedures`**
...
<a id="section-5-2-1"></a> **`5.2.1. Schemes for LSRs that Support Label Merging`**
...
<a id="section-5-2-2"></a> **`5.2.2. Schemes for LSRs that do not Support Label Merging`**
...
<a id="section-5-2-3"></a> **`5.2.3. Interoperability Considerations`**
...
<a id="section-7"></a> **`7. Intellectual Property`**
...
<a id="section-8"></a> **`8. Authors' Addresses`**
...
<a id="section-10"></a> **`10. Full Copyright Statement`**
