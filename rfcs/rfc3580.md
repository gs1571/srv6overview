...
`   `[`2`](#section-2)`. RADIUS Accounting Attributes`

`       `[`2.1`](#section-2-1)`. Acct-Terminate-Cause`

`       `[`2.2`](#section-2-2)`. Acct-Multi-Session-Id`

`       `[`2.3`](#section-2-3)`. Acct-Link-Count`

`   `[`3`](#section-3)`. RADIUS Authentication`

`       `[`3.1`](#section-3-1)`. User-Name`

`       `[`3.2`](#section-3-2)`. User-Password, CHAP-Password, CHAP-Challenge`

`       `[`3.3`](#section-3-3)`. NAS-IP-Address, NAS-IPv6-Address`

`       `[`3.4`](#section-3-4)`. NAS-Port`

`       `[`3.5`](#section-3-5)`. Service-Type`

`       `[`3.6`](#section-3-6)`. Framed-Protocol`

`       `[`3.7`](#section-3-7)`. Framed-IP-Address, Framed-IP-Netmask`

`       `[`3.8`](#section-3-8)`. Framed-Routing`

`       `[`3.9`](#section-3-9)`. Filter-ID`

`       `[`3.10`](#section-3-10)`. Framed-MTU`

`       `[`3.11`](#section-3-11)`. Framed-Compression`

`       `[`3.12`](#section-3-12)`. Displayable Messages`

`       `[`3.13`](#section-3-13)`. Callback-Number, Callback-ID`

`       `[`3.14`](#section-3-14)`. Framed-Route, Framed-IPv6-Route`

`       `[`3.15`](#section-3-15)`. State, Class, Proxy-State`

`       `[`3.16`](#section-3-16)`. Vendor-Specific`

`       `[`3.17`](#section-3-17)`. Session-Timeout`

`       `[`3.18`](#section-3-18)`. Idle-Timeout`

`       `[`3.19`](#section-3-19)`. Termination-Action`

`       `[`3.20`](#section-3-20)`. Called-Station-Id`

`       `[`3.21`](#section-3-21)`. Calling-Station-Id`

`       `[`3.22`](#section-3-22)`. NAS-Identifier`

`       `[`3.23`](#section-3-23)`. NAS-Port-Type`

`       `[`3.24`](#section-3-24)`. Port-Limit`

`       `[`3.25`](#section-3-25)`. Password-Retry`

`       `[`3.26`](#section-3-26)`. Connect-Info`

`       `[`3.27`](#section-3-27)`. EAP-Message`

`       `[`3.28`](#section-3-28)`. Message-Authenticator`

`       `[`3.29`](#section-3-29)`. NAS-Port-Id`

`       `[`3.30`](#section-3-30)`. Framed-Pool, Framed-IPv6-Pool`

`       `[`3.31`](#section-3-31)`. Tunnel Attributes`

`   `[`4`](#section-4)`. RC4 EAPOL-Key Descriptor`

`   `[`5`](#section-5)`. Security Considerations`

`       `[`5.1`](#section-5-1)`. Packet Modification or Forgery`

`       `[`5.2`](#section-5-2)`. Dictionary Attacks`

`       `[`5.3`](#section-5-3)`. Known Plaintext Attacks`

`       `[`5.4`](#section-5-4)`. Replay`

`       `[`5.5`](#section-5-5)`. Outcome Mismatches`

`       `[`5.6`](#section-5-6)`. 802.11 Integration`

`       `[`5.7`](#section-5-7)`. Key Management Issues`
...
`   `[`8`](#section-8)`. Table of Attributes`

`   `[`9`](#section-9)`. Intellectual Property Statement`
...
<a id="section-2"></a> **`2. RADIUS Accounting Attributes`**
...
<a id="section-2-1"></a> **`2.1. Acct-Terminate-Cause`**
...
<a id="section-2-2"></a> **`2.2. Acct-Multi-Session-Id`**
...
<a id="section-2-3"></a> **`2.3. Acct-Link-Count`**
...
<a id="section-3"></a> **`3. RADIUS Authentication`**
...
<a id="section-3-1"></a> **`3.1. User-Name`**
...
<a id="section-3-2"></a> **`3.2. User-Password, CHAP-Password, CHAP-Challenge`**
...
<a id="section-3-3"></a> **`3.3. NAS-IP-Address, NAS-IPv6-Address`**
...
<a id="section-3-4"></a> **`3.4. NAS-Port`**
...
<a id="section-3-5"></a> **`3.5. Service-Type`**
...
<a id="section-3-6"></a> **`3.6. Framed-Protocol`**
...
<a id="section-3-7"></a> **`3.7. Framed-IP-Address, Framed-IP-Netmask`**
...
<a id="section-3-8"></a> **`3.8. Framed-Routing`**
...
<a id="section-3-9"></a> **`3.9. Filter-ID`**
...
<a id="section-3-10"></a> **`3.10. Framed-MTU`**
...
<a id="section-3-11"></a> **`3.11. Framed-Compression`**
...
<a id="section-3-12"></a> **`3.12. Displayable Messages`**
...
<a id="section-3-13"></a> **`3.13. Callback-Number, Callback-ID`**
...
<a id="section-3-14"></a> **`3.14. Framed-Route, Framed-IPv6-Route`**
...
<a id="section-3-15"></a> **`3.15. State, Class, Proxy-State`**
...
<a id="section-3-16"></a> **`3.16. Vendor-Specific`**
...
<a id="section-3-17"></a> **`3.17. Session-Timeout`**
...
<a id="section-3-18"></a> **`3.18. Idle-Timeout`**
...
<a id="section-3-19"></a> **`3.19. Termination-Action`**
...
<a id="section-3-20"></a> **`3.20. Called-Station-Id`**
...
<a id="section-3-21"></a> **`3.21. Calling-Station-Id`**
...
<a id="section-3-22"></a> **`3.22. NAS-Identifier`**
...
<a id="section-3-23"></a> **`3.23. NAS-Port-Type`**
...
<a id="section-3-24"></a> **`3.24. Port-Limit`**
...
<a id="section-3-25"></a> **`3.25. Password-Retry`**
...
<a id="section-3-26"></a> **`3.26. Connect-Info`**
...
<a id="section-3-27"></a> **`3.27. EAP-Message`**
...
<a id="section-3-28"></a> **`3.28. Message-Authenticator`**
...
<a id="section-3-29"></a> **`3.29. NAS-Port-Id`**
...
<a id="section-3-30"></a> **`3.30. Framed-Pool, Framed-IPv6-Pool`**
...
<a id="section-3-31"></a> **`3.31. Tunnel Attributes`**
...
<a id="section-4"></a> **`4. RC4 EAPOL-Key Frame`**
...
<a id="section-5-1"></a> **`5.1. Packet Modification or Forgery`**
...
<a id="section-5-2"></a> **`5.2. Dictionary Attacks`**
...
<a id="section-5-3"></a> **`5.3. Known Plaintext Attacks`**
...
<a id="section-5-5"></a> **`5.5. Outcome Mismatches`**
...
<a id="section-5-6"></a> **`5.6. 802.11 Integration`**
...
<a id="section-5-7"></a> **`5.7. Key Management Issues`**
...
<a id="section-8"></a> **`8. Table of Attributes`**
...
<a id="section-9"></a> **`9. Intellectual Property Statement`**
