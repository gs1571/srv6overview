...
`      `[`1.2`](#section-1-2)`. Expected Use in the Network`

`      `[`1.3`](#section-1-3)`. Service Class Definition`

`      `[`1.4`](#section-1-4)`. Key Differentiated Services Concepts`

`           `[`1.4.1`](#section-1-4-1)`. Queuing`

`                  `[`1.4.1.1`](#section-1-4-1-1)`. Priority Queuing`

`                  `[`1.4.1.2`](#section-1-4-1-2)`. Rate Queuing`

`           `[`1.4.2`](#section-1-4-2)`. Active Queue Management`

`           `[`1.4.3`](#section-1-4-3)`. Traffic Conditioning`

`           `[`1.4.4`](#section-1-4-4)`. Differentiated Services Code Point (DSCP)`

`           `[`1.4.5`](#section-1-4-5)`. Per-Hop Behavior (PHB)`

`      `[`1.5`](#section-1-5)`. Key Service Concepts`

`           `[`1.5.1`](#section-1-5-1)`. Default Forwarding (DF)`

`           `[`1.5.2`](#section-1-5-2)`. Assured Forwarding (AF)`

`           `[`1.5.3`](#section-1-5-3)`. Expedited Forwarding (EF)`

`           `[`1.5.4`](#section-1-5-4)`. Class Selector (CS)`

`           `[`1.5.5`](#section-1-5-5)`. Admission Control`

`   `[`2`](#section-2)`. Service Differentiation`

`      `[`2.1`](#section-2-1)`. Service Classes`

`      `[`2.2`](#section-2-2)`. Categorization of User Service Classes`

`      `[`2.3`](#section-2-3)`. Service Class Characteristics`

`      `[`2.4`](#section-2-4)`. Deployment Scenarios`

`           `[`2.4.1`](#section-2-4-1)`. Example 1`

`           `[`2.4.2`](#section-2-4-2)`. Example 2`

`           `[`2.4.3`](#section-2-4-3)`. Example 3`

`   `[`3`](#section-3)`. Network Control Traffic`

`      `[`3.1`](#section-3-1)`. Current Practice in the Internet`

`      `[`3.2`](#section-3-2)`. Network Control Service Class`

`      `[`3.3`](#section-3-3)`. OAM Service Class`

`   `[`4`](#section-4)`. User Traffic`

`      `[`4.1`](#section-4-1)`. Telephony Service Class`

`      `[`4.2`](#section-4-2)`. Signaling Service Class`

`      `[`4.3`](#section-4-3)`. Multimedia Conferencing Service Class`

`      `[`4.4`](#section-4-4)`. Real-Time Interactive Service Class`

`      `[`4.5`](#section-4-5)`. Multimedia Streaming Service Class`

`      `[`4.6`](#section-4-6)`. Broadcast Video Service Class`

`      `[`4.7`](#section-4-7)`. Low-Latency Data Service Class`

`      `[`4.8`](#section-4-8)`. High-Throughput Data Service Class`

`      `[`4.9`](#section-4-9)`. Standard Service Class`

`      `[`4.10`](#section-4-10)`. Low-Priority Data`

`   `[`5`](#section-5)`. Additional Information on Service Class Usage`

`      `[`5.1`](#section-5-1)`. Mapping for Signaling`

`      `[`5.2`](#section-5-2)`. Mapping for NTP`

`      `[`5.3`](#section-5-3)`. VPN Service Mapping`

`   `[`6`](#section-6)`. Security Considerations`

`   `[`7`](#section-7)`. Acknowledgements`

`   `[`8`](#section-8)`. Appendix A`

`      `[`8.1`](#section-8-1)`. Explanation of Ring Clipping`
...
<a id="section-1-2"></a> **`1.2. Expected Use in the Network`**
...
<a id="section-1-3"></a> **`1.3. Service Class Definition`**
...
<a id="section-1-4"></a> **`1.4. Key Differentiated Services Concepts`**
...
<a id="section-1-4-1"></a> **`1.4.1. Queuing`**
...
<a id="section-1-4-1-1"></a> **`1.4.1.1. Priority Queuing`**
...
<a id="section-1-4-1-2"></a> **`1.4.1.2. Rate Queuing`**
...
<a id="section-1-4-2"></a> **`1.4.2. Active Queue Management`**
...
<a id="section-1-4-3"></a> **`1.4.3. Traffic Conditioning`**
...
<a id="section-1-4-4"></a> **`1.4.4. Differentiated Services Code Point (DSCP)`**
...
<a id="section-1-4-5"></a> **`1.4.5. Per-Hop Behavior (PHB)`**
...
<a id="section-1-5"></a> **`1.5. Key Service Concepts`**
...
<a id="section-1-5-1"></a> **`1.5.1. Default Forwarding (DF)`**
...
<a id="section-1-5-2"></a> **`1.5.2. Assured Forwarding (AF)`**
...
<a id="section-1-5-3"></a> **`1.5.3. Expedited Forwarding (EF)`**
...
<a id="section-1-5-4"></a> **`1.5.4. Class Selector (CS)`**
...
<a id="section-1-5-5"></a> **`1.5.5. Admission Control`**
...
<a id="section-2"></a> **`2. Service Differentiation`**
...
<a id="section-2-1"></a> **`2.1. Service Classes`**
...
<a id="section-2-2"></a> **`2.2. Categorization of User Service Classes`**
...
<a id="section-2-3"></a> **`2.3. Service Class Characteristics`**
...
<a id="section-2-4"></a> **`2.4. Deployment Scenarios`**
...
<a id="section-2-4-1"></a> **`2.4.1. Example 1`**
...
<a id="section-2-4-2"></a> **`2.4.2. Example 2`**
...
<a id="section-2-4-3"></a> **`2.4.3. Example 3`**
...
<a id="section-3"></a> **`3. Network Control Traffic`**
...
<a id="section-3-1"></a> **`3.1. Current Practice in the Internet`**
...
<a id="section-3-2"></a> **`3.2. Network Control Service Class`**
...
<a id="section-3-3"></a> **`3.3. OAM Service Class`**
...
<a id="section-4"></a> **`4. User Traffic`**
...
<a id="section-4-1"></a> **`4.1. Telephony Service Class`**
...
<a id="section-4-2"></a> **`4.2. Signaling Service Class`**
...
<a id="section-4-3"></a> **`4.3. Multimedia Conferencing Service Class`**
...
<a id="section-4-4"></a> **`4.4. Real-Time Interactive Service Class`**
...
<a id="section-4-5"></a> **`4.5. Multimedia Streaming Service Class`**
...
<a id="section-4-6"></a> **`4.6. Broadcast Video Service Class`**
...
<a id="section-4-7"></a> **`4.7. Low-Latency Data Service Class`**
...
<a id="section-4-8"></a> **`4.8. High-Throughput Data Service Class`**
...
<a id="section-4-9"></a> **`4.9. Standard Service Class`**
...
<a id="section-4-10"></a> **`4.10. Low-Priority Data`**
...
<a id="section-5"></a> **`5. Additional Information on Service Class Usage`**
...
<a id="section-5-1"></a> **`5.1. Mapping for Signaling`**
...
<a id="section-5-2"></a> **`5.2. Mapping for NTP`**
...
<a id="section-5-3"></a> **`5.3. VPN Service Mapping`**
...
<a id="section-8"></a> **`8. Appendix A`**

```text

```

<a id="section-8-1"></a> **`8.1. Explanation of Ring Clipping`**
