...
`   `[`4`](#section-4)`. Procedures for Defining and Using Node and Link MSD`

`       Advertisements`

`   `[`5`](#section-5)`. Base MPLS Imposition MSD`
...
<a id="section-2"></a> **`2. Node MSD Advertisement`**
...
<a id="section-3"></a> **`3. Link MSD Advertisement`**
...
<a id="section-4"></a> **`4. Procedures for Defining and Using Node and Link MSD Advertisements`**
...
<a id="section-5"></a> **`5. Base MPLS Imposition MSD`**
