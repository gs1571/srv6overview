...
`   `[`3`](#section-3)`. Bidirectional Forwarding Detection Connectivity`

`       Verification`

`     `[`3.1`](#section-3-1)`. BFD CV Type Operation`

`     `[`3.2`](#section-3-2)`. BFD Encapsulation`

`     `[`3.3`](#section-3-3)`. CV Types for BFD`

`   `[`4`](#section-4)`. Capability Selection`

`   `[`5`](#section-5)`. IANA Considerations`

`     `[`5.1`](#section-5-1)`. MPLS CV Types for the VCCV Interface Parameters Sub-TLV`

`     `[`5.2`](#section-5-2)`. PW Associated Channel Type`

`     `[`5.3`](#section-5-3)`. L2TPv3 CV Types for the VCCV Capability AVP`

`   `[`6`](#section-6)`. Congestion Considerations`
...
<a id="section-3"></a> **`3. Bidirectional Forwarding Detection Connectivity Verification`**
...
<a id="section-3-1"></a> **`3.1. BFD CV Type Operation`**
...
<a id="section-3-2"></a> **`3.2. BFD Encapsulation`**
...
<a id="section-3-3"></a> **`3.3. CV Types for BFD`**
...
<a id="section-4"></a> **`4. Capability Selection`**
...
<a id="section-5-1"></a> **`5.1. MPLS CV Types for the VCCV Interface Parameters Sub-TLV`**
...
<a id="section-5-2"></a> **`5.2. PW Associated Channel Type`**
...
<a id="section-5-3"></a> **`5.3. L2TPv3 CV Types for the VCCV Capability AVP`**
...
<a id="section-6"></a> **`6. Congestion Considerations`**
