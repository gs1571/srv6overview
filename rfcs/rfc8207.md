...
`   `[`2`](#section-2)`. Suggested Reading`

`   `[`3`](#section-3)`. RPKI Distribution and Maintenance`

`   `[`4`](#section-4)`. AS/Router Certificates`

`   `[`5`](#section-5)`. Within a Network`

`   `[`6`](#section-6)`. Considerations for Edge Sites`

`   `[`7`](#section-7)`. Routing Policy`
...
<a id="section-2"></a> **`2. Suggested Reading`**
...
<a id="section-3"></a> **`3. RPKI Distribution and Maintenance`**
...
<a id="section-4"></a> **`4. AS/Router Certificates`**
...
<a id="section-5"></a> **`5. Within a Network`**
...
<a id="section-6"></a> **`6. Considerations for Edge Sites`**
...
<a id="section-7"></a> **`7. Routing Policy`**
