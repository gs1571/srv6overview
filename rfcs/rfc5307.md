...
<a id="section-1-1"></a> **`1.1. Link Local/Remote Identifiers`**
...
<a id="section-1-2"></a> **`1.2. Link Protection Type`**
...
<a id="section-1-3"></a> **`1.3. Interface Switching Capability Descriptor`**
...
<a id="section-1-4"></a> **`1.4. Shared Risk Link Group TLV`**
...
<a id="section-1-5"></a> **`1.5. Link Identifier for Unnumbered Interfaces`**
...
<a id="section-2"></a> **`2. Implications on Graceful Restart`**
