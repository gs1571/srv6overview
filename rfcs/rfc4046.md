...
`   `[`1`](#section-1)`. Introduction: Purpose of this Document`

`   `[`2`](#section-2)`. Requirements of a Group Key Management Protocol`

`   `[`3`](#section-3)`. Overall Design of Group Key Management Architecture`

`      `[`3.1`](#section-3-1)`. Overview`

`      `[`3.2`](#section-3-2)`. Detailed Description of the GKM Architecture`

`      `[`3.3`](#section-3-3)`. Properties of the Design`

`      `[`3.4`](#section-3-4)`. Group Key Management Block Diagram`

`   `[`4`](#section-4)`. Registration Protocol`

`      `[`4.1`](#section-4-1)`. Registration Protocol via Piggybacking or Protocol Reuse`

`      `[`4.2`](#section-4-2)`. Properties of Alternative Registration Exchange Types`

`      `[`4.3`](#section-4-3)`. Infrastructure for Alternative Registration`

`           Exchange Types`

`      `[`4.4`](#section-4-4)`. De-registration Exchange`

`   `[`5`](#section-5)`. Rekey Protocol`

`      `[`5.1`](#section-5-1)`. Goals of the Rekey Protocol`

`      `[`5.2`](#section-5-2)`. Rekey Message Transport and Protection`

`      `[`5.3`](#section-5-3)`. Reliable Transport of Rekey Messages`

`      `[`5.4`](#section-5-4)`. State-of-the-art on Reliable Multicast Infrastructure`

`      `[`5.5`](#section-5-5)`. Implosion`

`      `[`5.6`](#section-5-6)`. Incorporating Group Key Management Algorithms`

`      `[`5.7`](#section-5-7)`. Stateless, Stateful, and Self-healing Rekeying`

`           Algorithms`

`      `[`5.8`](#section-5-8)`. Interoperability of a GKMA`

`   `[`6`](#section-6)`. Group Security Association`

`      `[`6.1`](#section-6-1)`. Group Policy`

`      `[`6.2`](#section-6-2)`. Contents of the Rekey SA`

`           `[`6.2.1`](#section-6-2-1)`. Rekey SA Policy`

`           `[`6.2.2`](#section-6-2-2)`. Group Identity`

`           `[`6.2.3`](#section-6-2-3)`. KEKs`

`           `[`6.2.4`](#section-6-2-4)`. Authentication Key`

`           `[`6.2.5`](#section-6-2-5)`. Replay Protection`

`           `[`6.2.6`](#section-6-2-6)`. Security Parameter Index (SPI)`

`      `[`6.3`](#section-6-3)`. Contents of the Data SA`

`           `[`6.3.1`](#section-6-3-1)`. Group Identity`

`           `[`6.3.2`](#section-6-3-2)`. Source Identity`

`           `[`6.3.3`](#section-6-3-3)`. Traffic Protection Keys`

`           `[`6.3.4`](#section-6-3-4)`. Data Authentication Keys`

`           `[`6.3.5`](#section-6-3-5)`. Sequence Numbers`

`           `[`6.3.6`](#section-6-3-6)`. Security Parameter Index (SPI)`

`           `[`6.3.7`](#section-6-3-7)`. Data SA Policy`

`   `[`7`](#section-7)`. Scalability Considerations`
...
<a id="section-1"></a> **`1. Introduction: Purpose of this Document`**
...
<a id="section-2"></a> **`2. Requirements of a Group Key Management Protocol`**
...
<a id="section-3"></a> **`3. Overall Design of Group Key Management Architecture`**
...
<a id="section-3-2"></a> **`3.2. Detailed Description of the GKM Architecture`**
...
<a id="section-3-3"></a> **`3.3. Properties of the Design`**
...
<a id="section-3-4"></a> **`3.4. Group Key Management Block Diagram`**
...
<a id="section-4"></a> **`4. Registration Protocol`**
...
<a id="section-4-1"></a> **`4.1. Registration Protocol via Piggybacking or Protocol Reuse`**
...
<a id="section-4-2"></a> **`4.2. Properties of Alternative Registration Exchange Types`**
...
<a id="section-4-3"></a> **`4.3. Infrastructure for Alternative Registration Exchange Types`**
...
<a id="section-4-4"></a> **`4.4. De-registration Exchange`**
...
<a id="section-5"></a> **`5. Rekey Protocol`**
...
<a id="section-5-1"></a> **`5.1. Goals of the Rekey Protocol`**
...
<a id="section-5-2"></a> **`5.2. Rekey Message Transport and Protection`**
...
<a id="section-5-3"></a> **`5.3. Reliable Transport of Rekey Messages`**
...
<a id="section-5-4"></a> **`5.4. State-of-the-art on Reliable Multicast Infrastructure`**
...
<a id="section-5-5"></a> **`5.5. Implosion`**
...
<a id="section-5-6"></a> **`5.6. Incorporating Group Key Management Algorithms`**
...
<a id="section-5-7"></a> **`5.7. Stateless, Stateful, and Self-healing Rekeying Algorithms`**
...
<a id="section-5-8"></a> **`5.8. Interoperability of a GKMA`**
...
<a id="section-6"></a> **`6. Group Security Association`**
...
<a id="section-6-1"></a> **`6.1. Group Policy`**
...
<a id="section-6-2"></a> **`6.2. Contents of the Rekey SA`**
...
<a id="section-6-2-1"></a> **`6.2.1. Rekey SA Policy`**
...
<a id="section-6-2-2"></a> **`6.2.2. Group Identity`**
...
<a id="section-6-2-3"></a> **`6.2.3. KEKs`**
...
<a id="section-6-2-4"></a> **`6.2.4. Authentication Key`**
...
<a id="section-6-2-5"></a> **`6.2.5. Replay Protection`**
...
<a id="section-6-2-6"></a> **`6.2.6. Security Parameter Index (SPI)`**
...
<a id="section-6-3"></a> **`6.3. Contents of the Data SA`**
...
<a id="section-6-3-1"></a> **`6.3.1. Group Identity`**
...
<a id="section-6-3-2"></a> **`6.3.2. Source Identity`**
...
<a id="section-6-3-3"></a> **`6.3.3. Traffic Protection Keys`**
...
<a id="section-6-3-4"></a> **`6.3.4. Data Authentication Keys`**
...
<a id="section-6-3-5"></a> **`6.3.5. Sequence Numbers`**
...
<a id="section-6-3-6"></a> **`6.3.6. Security Parameter Index (SPI)`**
...
<a id="section-6-3-7"></a> **`6.3.7. Data SA policy`**
...
<a id="section-7"></a> **`7. Scalability Considerations`**
