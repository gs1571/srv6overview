...
`   `[`2`](#section-2)`. ROA Validation Outcomes for a Route`

`   `[`3`](#section-3)`. Applying Validation Outcomes to Route Selection`

`   `[`4`](#section-4)`. Disavowal of Routing Origination`

`   `[`5`](#section-5)`. Route Validation Lifetime`
...
<a id="section-2"></a> **`2. ROA Validation Outcomes for a Route`**
...
<a id="section-3"></a> **`3. Applying Validation Outcomes to Route Selection`**
...
<a id="section-4"></a> **`4. Disavowal of Routing Origination`**
...
<a id="section-5"></a> **`5. Route Validation Lifetime`**
