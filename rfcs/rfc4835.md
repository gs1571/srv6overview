...
`   `[`3`](#section-3)`. Algorithm Selection`

`     `[`3.1`](#section-3-1)`. Encapsulating Security Payload`

`       `[`3.1.1`](#section-3-1-1)`. ESP Encryption and Authentication Algorithms`

`       `[`3.1.2`](#section-3-1-2)`. ESP Combined Mode Algorithms`

`     `[`3.2`](#section-3-2)`. Authentication Header`

`   `[`4`](#section-4)`. Security Considerations`

`   `[`5`](#section-5)`. Acknowledgements`

`   `[`6`](#section-6)`. Changes from RFC 2402 and RFC 2406 to RFC 4305`

`   `[`7`](#section-7)`. Changes from RFC 4305`
...
<a id="section-3"></a> **`3. Algorithm Selection`**
...
<a id="section-3-1"></a> **`3.1. Encapsulating Security Payload`**
...
<a id="section-3-1-1"></a> **`3.1.1. ESP Encryption and Authentication Algorithms`**
...
<a id="section-3-1-2"></a> **`3.1.2. ESP Combined Mode Algorithms`**
...
<a id="section-3-2"></a> **`3.2. Authentication Header`**
...
<a id="section-6"></a> **`6. Changes from RFC 2402 and RFC 2406 to RFC 4305`**
...
<a id="section-7"></a> **`7. Changes from RFC 4305`**
