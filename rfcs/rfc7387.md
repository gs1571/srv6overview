...
`      `[`2.1`](#section-2-1)`. Ethernet Bridge Network`

`      `[`2.2`](#section-2-2)`. MEF Multipoint Ethernet Services: E-LAN and E-Tree`

`      `[`2.3`](#section-2-3)`. IETF L2VPN`

`           `[`2.3.1`](#section-2-3-1)`. Virtual Private LAN Service (VPLS)`

`           `[`2.3.2`](#section-2-3-2)`. Ethernet VPN (EVPN)`

`           `[`2.3.3`](#section-2-3-3)`. Virtual Private Multicast Service (VPMS)`

`   `[`3`](#section-3)`. E-Tree Architecture Reference Model`

`   `[`4`](#section-4)`. E-Tree Use Cases`

`   `[`5`](#section-5)`. L2VPN Gaps for Emulating MEF E-Tree Service`

`      `[`5.1`](#section-5-1)`. No Differentiation on AC Role`

`      `[`5.2`](#section-5-2)`. No AC Role Indication or Advertisement`

`      `[`5.3`](#section-5-3)`. Other Issues`
...
<a id="section-2-1"></a> **`2.1. Ethernet Bridge Network`**
...
<a id="section-2-2"></a> **`2.2. MEF Multipoint Ethernet Services: E-LAN and E-Tree`**
...
<a id="section-2-3"></a> **`2.3. IETF L2VPN`**

```text

```

<a id="section-2-3-1"></a> **`2.3.1. Virtual Private LAN Service (VPLS)`**
...
<a id="section-2-3-2"></a> **`2.3.2. Ethernet VPN (EVPN)`**
...
<a id="section-2-3-3"></a> **`2.3.3. Virtual Private Multicast Service (VPMS)`**
...
<a id="section-3"></a> **`3. E-Tree Architecture Reference Model`**
...
<a id="section-4"></a> **`4. E-Tree Use Cases`**
...
<a id="section-5"></a> **`5. L2VPN Gaps for Emulating MEF E-Tree Service`**
...
<a id="section-5-1"></a> **`5.1. No Differentiation on AC Role`**
...
<a id="section-5-2"></a> **`5.2. No AC Role Indication or Advertisement`**
...
<a id="section-5-3"></a> **`5.3. Other Issues`**
