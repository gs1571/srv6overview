...
`   `[`3`](#section-3)`. Path Setup Type Capability TLV`

`   `[`4`](#section-4)`. Path Setup Type TLV`
...
`     `[`8.1`](#section-8-1)`. Additions to PCEP TLV Type Indicators Registry`

`     `[`8.2`](#section-8-2)`. New PCEP Path Setup Types Registry`

`     `[`8.3`](#section-8-3)`. Additions to PCEP-ERROR Object Error Types and Values`
...
<a id="section-3"></a> **`3. Path Setup Type Capability TLV`**
...
<a id="section-4"></a> **`4. Path Setup Type TLV`**
...
<a id="section-8-1"></a> **`8.1. Additions to PCEP TLV Type Indicators Registry`**
...
<a id="section-8-2"></a> **`8.2. New PCEP Path Setup Types Registry`**
...
<a id="section-8-3"></a> **`8.3. Additions to PCEP-ERROR Object Error Types and Values Registry`**
