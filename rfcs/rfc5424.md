...
`   `[`4`](#section-4)`. Basic Principles`

`      `[`4.1`](#section-4-1)`. Example Deployment Scenarios`

`   `[`5`](#section-5)`. Transport Layer Protocol`

`      `[`5.1`](#section-5-1)`. Minimum Required Transport Mapping`

`   `[`6`](#section-6)`. Syslog Message Format`

`      `[`6.1`](#section-6-1)`. Message Length`

`      `[`6.2`](#section-6-2)`. HEADER`

`           `[`6.2.1`](#section-6-2-1)`. PRI`

`           `[`6.2.2`](#section-6-2-2)`. VERSION`

`           `[`6.2.3`](#section-6-2-3)`. TIMESTAMP`

`           `[`6.2.4`](#section-6-2-4)`. HOSTNAME`

`           `[`6.2.5`](#section-6-2-5)`. APP-NAME`

`           `[`6.2.6`](#section-6-2-6)`. PROCID`

`           `[`6.2.7`](#section-6-2-7)`. MSGID`

`      `[`6.3`](#section-6-3)`. STRUCTURED-DATA`

`           `[`6.3.1`](#section-6-3-1)`. SD-ELEMENT`

`           `[`6.3.2`](#section-6-3-2)`. SD-ID`

`           `[`6.3.3`](#section-6-3-3)`. SD-PARAM`

`           `[`6.3.4`](#section-6-3-4)`. Change Control`

`           `[`6.3.5`](#section-6-3-5)`. Examples`

`      `[`6.4`](#section-6-4)`. MSG`

`      `[`6.5`](#section-6-5)`. Examples`

`   `[`7`](#section-7)`. Structured Data IDs`

`      `[`7.1`](#section-7-1)`. timeQuality`

`           `[`7.1.1`](#section-7-1-1)`. tzKnown`

`           `[`7.1.2`](#section-7-1-2)`. isSynced`

`           `[`7.1.3`](#section-7-1-3)`. syncAccuracy`

`           `[`7.1.4`](#section-7-1-4)`. Examples`

`      `[`7.2`](#section-7-2)`. origin`

`           `[`7.2.1`](#section-7-2-1)`. ip`

`           `[`7.2.2`](#section-7-2-2)`. enterpriseId`

`           `[`7.2.3`](#section-7-2-3)`. software`

`           `[`7.2.4`](#section-7-2-4)`. swVersion`

`           `[`7.2.5`](#section-7-2-5)`. Example`

`      `[`7.3`](#section-7-3)`. meta`

`           `[`7.3.1`](#section-7-3-1)`. sequenceId`

`           `[`7.3.2`](#section-7-3-2)`. sysUpTime`

`           `[`7.3.3`](#section-7-3-3)`. language`

`   `[`8`](#section-8)`. Security Considerations`

`      `[`8.1`](#section-8-1)`. UNICODE`

`      `[`8.2`](#section-8-2)`. Control Characters`

`      `[`8.3`](#section-8-3)`. Message Truncation`

`      `[`8.4`](#section-8-4)`. Replay`

`      `[`8.5`](#section-8-5)`. Reliable Delivery`

`      `[`8.6`](#section-8-6)`. Congestion Control`

`      `[`8.7`](#section-8-7)`. Message Integrity`

`      `[`8.8`](#section-8-8)`. Message Observation`

`      `[`8.9`](#section-8-9)`. Inappropriate Configuration`

`      `[`8.10`](#section-8-10)`. Forwarding Loop`

`      `[`8.11`](#section-8-11)`. Load Considerations`

`      `[`8.12`](#section-8-12)`. Denial of Service`

`   `[`9`](#section-9)`. IANA Considerations`

`      `[`9.1`](#section-9-1)`. VERSION`

`      `[`9.2`](#section-9-2)`. SD-IDs`

`   `[`10`](#section-10)`. Working Group`
...
<a id="section-4"></a> **`4. Basic Principles`**
...
<a id="section-4-1"></a> **`4.1. Example Deployment Scenarios`**
...
<a id="section-5"></a> **`5. Transport Layer Protocol`**
...
<a id="section-5-1"></a> **`5.1. Minimum Required Transport Mapping`**
...
<a id="section-6"></a> **`6. Syslog Message Format`**
...
<a id="section-6-1"></a> **`6.1. Message Length`**
...
<a id="section-6-2-1"></a> **`6.2.1. PRI`**
...
<a id="section-6-2-2"></a> **`6.2.2. VERSION`**
...
<a id="section-6-2-3"></a> **`6.2.3. TIMESTAMP`**
...
<a id="section-6-2-3-1"></a> **`6.2.3.1. Examples`**
...
<a id="section-6-2-4"></a> **`6.2.4. HOSTNAME`**
...
<a id="section-6-2-5"></a> **`6.2.5. APP-NAME`**
...
<a id="section-6-2-6"></a> **`6.2.6. PROCID`**
...
<a id="section-6-2-7"></a> **`6.2.7. MSGID`**
...
<a id="section-6-3"></a> **`6.3. STRUCTURED-DATA`**
...
<a id="section-6-3-1"></a> **`6.3.1. SD-ELEMENT`**
...
<a id="section-6-3-2"></a> **`6.3.2. SD-ID`**
...
<a id="section-6-3-3"></a> **`6.3.3. SD-PARAM`**
...
<a id="section-6-3-4"></a> **`6.3.4. Change Control`**
...
<a id="section-6-3-5"></a> **`6.3.5. Examples`**
...
<a id="section-6-5"></a> **`6.5. Examples`**
...
<a id="section-7"></a> **`7. Structured Data IDs`**
...
<a id="section-7-1"></a> **`7.1. timeQuality`**
...
<a id="section-7-1-1"></a> **`7.1.1. tzKnown`**
...
<a id="section-7-1-2"></a> **`7.1.2. isSynced`**
...
<a id="section-7-1-3"></a> **`7.1.3. syncAccuracy`**
...
<a id="section-7-1-4"></a> **`7.1.4. Examples`**
...
<a id="section-7-2-2"></a> **`7.2.2. enterpriseId`**
...
<a id="section-7-2-3"></a> **`7.2.3. software`**
...
<a id="section-7-2-4"></a> **`7.2.4. swVersion`**
...
<a id="section-7-2-5"></a> **`7.2.5. Example`**
...
<a id="section-7-3-1"></a> **`7.3.1. sequenceId`**
...
<a id="section-7-3-2"></a> **`7.3.2. sysUpTime`**
...
<a id="section-7-3-3"></a> **`7.3.3. language`**
...
<a id="section-8-1"></a> **`8.1. UNICODE`**
...
<a id="section-8-2"></a> **`8.2. Control Characters`**
...
<a id="section-8-3"></a> **`8.3. Message Truncation`**
...
<a id="section-8-5"></a> **`8.5. Reliable Delivery`**
...
<a id="section-8-6"></a> **`8.6. Congestion Control`**
...
<a id="section-8-7"></a> **`8.7. Message Integrity`**
...
<a id="section-8-8"></a> **`8.8. Message Observation`**
...
<a id="section-8-9"></a> **`8.9. Inappropriate Configuration`**
...
<a id="section-8-10"></a> **`8.10. Forwarding Loop`**
...
<a id="section-8-11"></a> **`8.11. Load Considerations`**
...
<a id="section-8-12"></a> **`8.12. Denial of Service`**
...
<a id="section-9-1"></a> **`9.1. VERSION`**
...
<a id="section-10"></a> **`10. Working Group`**
