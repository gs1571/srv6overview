...
`      `[`1.1`](#section-1-1)`. Nested Domains`

`   `[`2`](#section-2)`. Signaling Options`

`      `[`2.1`](#section-2-1)`. LSP Nesting`

`      `[`2.2`](#section-2-2)`. Contiguous LSP`

`      `[`2.3`](#section-2-3)`. LSP Stitching`

`      `[`2.4`](#section-2-4)`. Hybrid Methods`

`      `[`2.5`](#section-2-5)`. Control of Downstream Choice of Signaling Method`

`   `[`3`](#section-3)`. Path Computation Techniques`

`      `[`3.1`](#section-3-1)`. Management Configuration`

`      `[`3.2`](#section-3-2)`. Head-End Computation`

`           `[`3.2.1`](#section-3-2-1)`. Multi-Domain Visibility Computation`

`           `[`3.2.2`](#section-3-2-2)`. Partial Visibility Computation`

`           `[`3.2.3`](#section-3-2-3)`. Local Domain Visibility Computation`

`      `[`3.3`](#section-3-3)`. Domain Boundary Computation`

`      `[`3.4`](#section-3-4)`. Path Computation Element`

`           `[`3.4.1`](#section-3-4-1)`. Multi-Domain Visibility Computation`

`           `[`3.4.2`](#section-3-4-2)`. Path Computation Use of PCE When Preserving`

`                  Confidentiality`

`           `[`3.4.3`](#section-3-4-3)`. Per-Domain Computation Elements`

`      `[`3.5`](#section-3-5)`. Optimal Path Computation`

`   `[`4`](#section-4)`. Distributing Reachability and TE Information`

`   `[`5`](#section-5)`. Comments on Advanced Functions`

`      `[`5.1`](#section-5-1)`. LSP Re-Optimization`

`      `[`5.2`](#section-5-2)`. LSP Setup Failure`

`      `[`5.3`](#section-5-3)`. LSP Repair`

`      `[`5.4`](#section-5-4)`. Fast Reroute`

`      `[`5.5`](#section-5-5)`. Comments on Path Diversity`

`      `[`5.6`](#section-5-6)`. Domain-Specific Constraints`

`      `[`5.7`](#section-5-7)`. Policy Control`

`      `[`5.8`](#section-5-8)`. Inter-Domain Operations and Management (OAM)`

`      `[`5.9`](#section-5-9)`. Point-to-Multipoint`

`      `[`5.10`](#section-5-10)`. Applicability to Non-Packet Technologies`
...
<a id="section-1-1"></a> **`1.1. Nested Domains`**
...
<a id="section-2"></a> **`2. Signaling Options`**
...
<a id="section-2-1"></a> **`2.1. LSP Nesting`**
...
<a id="section-2-2"></a> **`2.2. Contiguous LSP`**
...
<a id="section-2-3"></a> **`2.3. LSP Stitching`**
...
<a id="section-2-4"></a> **`2.4. Hybrid Methods`**
...
<a id="section-2-5"></a> **`2.5. Control of Downstream Choice of Signaling Method`**
...
<a id="section-3"></a> **`3. Path Computation Techniques`**
...
<a id="section-3-1"></a> **`3.1. Management Configuration`**
...
<a id="section-3-2"></a> **`3.2. Head-End Computation`**
...
<a id="section-3-2-1"></a> **`3.2.1. Multi-Domain Visibility Computation`**
...
<a id="section-3-2-2"></a> **`3.2.2. Partial Visibility Computation`**
...
<a id="section-3-2-3"></a> **`3.2.3. Local Domain Visibility Computation`**
...
<a id="section-3-3"></a> **`3.3. Domain Boundary Computation`**
...
<a id="section-3-4"></a> **`3.4. Path Computation Element`**
...
<a id="section-3-4-1"></a> **`3.4.1. Multi-Domain Visibility Computation`**
...
<a id="section-3-4-2"></a> **`3.4.2. Path Computation Use of PCE When Preserving Confidentiality`**
...
<a id="section-3-4-3"></a> **`3.4.3. Per-Domain Computation Elements`**
...
<a id="section-3-5"></a> **`3.5. Optimal Path Computation`**
...
<a id="section-4"></a> **`4. Distributing Reachability and TE Information`**
...
<a id="section-5"></a> **`5. Comments on Advanced Functions`**
...
<a id="section-5-1"></a> **`5.1. LSP Re-Optimization`**
...
<a id="section-5-2"></a> **`5.2. LSP Setup Failure`**
...
<a id="section-5-3"></a> **`5.3. LSP Repair`**
...
<a id="section-5-4"></a> **`5.4. Fast Reroute`**
...
<a id="section-5-5"></a> **`5.5. Comments on Path Diversity`**
...
<a id="section-5-6"></a> **`5.6. Domain-Specific Constraints`**
...
<a id="section-5-7"></a> **`5.7. Policy Control`**
...
<a id="section-5-8"></a> **`5.8. Inter-Domain Operations and Management (OAM)`**
...
<a id="section-5-9"></a> **`5.9. Point-to-Multipoint`**
...
<a id="section-5-10"></a> **`5.10. Applicability to Non-Packet Technologies`**
