...
`   `[`2`](#section-2)`. PSAMP Documents Overview`

`   `[`3`](#section-3)`. Terminology`

`      `[`3.1`](#section-3-1)`. IPFIX Terminology`

`      `[`3.2`](#section-3-2)`. PSAMP Terminology`

`           `[`3.2.1`](#section-3-2-1)`. Packet Streams and Packet Content`

`           `[`3.2.2`](#section-3-2-2)`. Selection Process`

`           `[`3.2.3`](#section-3-2-3)`. Reporting`

`           `[`3.2.4`](#section-3-2-4)`. Metering Process`

`           `[`3.2.5`](#section-3-2-5)`. Exporting Process`

`           `[`3.2.6`](#section-3-2-6)`. PSAMP Device`

`           `[`3.2.7`](#section-3-2-7)`. Collector`

`           `[`3.2.8`](#section-3-2-8)`. Selection Methods`

`      `[`3.3`](#section-3-3)`. IPFIX and PSAMP Terminology Comparison`

`           `[`3.3.1`](#section-3-3-1)`. IPFIX and PSAMP Processes`

`           `[`3.3.2`](#section-3-3-2)`. Packet Report, Packet Interpretation, and`

`                  Data Record`

`   `[`4`](#section-4)`. Differences between PSAMP and IPFIX`

`      `[`4.1`](#section-4-1)`. Architecture Point of View`

`      `[`4.2`](#section-4-2)`. Protocol Point of View`

`      `[`4.3`](#section-4-3)`. Information Model Point of View`

`   `[`5`](#section-5)`. PSAMP Requirements versus the IPFIX Solution`

`      `[`5.1`](#section-5-1)`. High-Level View of the Integration`

`   `[`6`](#section-6)`. Using the IPFIX Protocol for PSAMP`

`      `[`6.1`](#section-6-1)`. Selector ID`

`      `[`6.2`](#section-6-2)`. The Selection Sequence ID`

`      `[`6.3`](#section-6-3)`. The Exporting Process`

`      `[`6.4`](#section-6-4)`. Packet Report`

`           `[`6.4.1`](#section-6-4-1)`. Basic Packet Report`

`           `[`6.4.2`](#section-6-4-2)`. Extended Packet Report`

`      `[`6.5`](#section-6-5)`. Report Interpretation`

`           `[`6.5.1`](#section-6-5-1)`. Selection Sequence Report Interpretation`

`           `[`6.5.2`](#section-6-5-2)`. Selector Report Interpretation`

`                  `[`6.5.2.1`](#section-6-5-2-1)`. Systematic Count-Based Sampling`

`                  `[`6.5.2.2`](#section-6-5-2-2)`. Systematic Time-Based Sampling`

`                  `[`6.5.2.3`](#section-6-5-2-3)`. Random n-out-of-N Sampling`

`                  `[`6.5.2.4`](#section-6-5-2-4)`. Uniform Probabilistic Sampling`

`                  `[`6.5.2.5`](#section-6-5-2-5)`. Property Match Filtering`

`                  `[`6.5.2.6`](#section-6-5-2-6)`. Hash-Based Filtering`

`                  `[`6.5.2.7`](#section-6-5-2-7)`. Other Selection Methods`

`           `[`6.5.3`](#section-6-5-3)`. Selection Sequence Statistics Report`

`                  Interpretation`

`           `[`6.5.4`](#section-6-5-4)`. Accuracy Report Interpretation`

`   `[`7`](#section-7)`. Security Considerations`

`   `[`8`](#section-8)`. IANA Considerations`

`      `[`8.1`](#section-8-1)`. IPFIX-Related Considerations`

`      `[`8.2`](#section-8-2)`. PSAMP-Related Considerations`
...
<a id="section-2"></a> **`2. PSAMP Documents Overview`**
...
<a id="section-3-1"></a> **`3.1. IPFIX Terminology`**
...
<a id="section-3-2"></a> **`3.2. PSAMP Terminology`**
...
<a id="section-3-2-1"></a> **`3.2.1. Packet Streams and Packet Content`**
...
<a id="section-3-2-2"></a> **`3.2.2. Selection Process`**
...
<a id="section-3-2-3"></a> **`3.2.3. Reporting`**
...
<a id="section-3-2-4"></a> **`3.2.4. Metering Process`**
...
<a id="section-3-2-5"></a> **`3.2.5. Exporting Process`**
...
<a id="section-3-2-6"></a> **`3.2.6. PSAMP Device`**
...
<a id="section-3-2-7"></a> **`3.2.7. Collector`**
...
<a id="section-3-2-8"></a> **`3.2.8. Selection Methods`**
...
<a id="section-3-3"></a> **`3.3. IPFIX and PSAMP Terminology Comparison`**
...
<a id="section-3-3-1"></a> **`3.3.1. IPFIX and PSAMP Processes`**
...
<a id="section-3-3-2"></a> **`3.3.2. Packet Report, Packet Interpretation, and Data Record`**
...
<a id="section-4"></a> **`4. Differences between PSAMP and IPFIX`**
...
<a id="section-4-1"></a> **`4.1. Architecture Point of View`**
...
<a id="section-4-2"></a> **`4.2. Protocol Point of View`**
...
<a id="section-4-3"></a> **`4.3. Information Model Point of View`**
...
<a id="section-5"></a> **`5. PSAMP Requirements versus the IPFIX Solution`**
...
<a id="section-5-1"></a> **`5.1. High-Level View of the Integration`**
...
<a id="section-6"></a> **`6. Using the IPFIX Protocol for PSAMP`**
...
<a id="section-6-1"></a> **`6.1. Selector ID`**
...
<a id="section-6-2"></a> **`6.2. The Selection Sequence ID`**
...
<a id="section-6-3"></a> **`6.3. The Exporting Process`**
...
<a id="section-6-4"></a> **`6.4. Packet Report`**
...
<a id="section-6-4-1"></a> **`6.4.1. Basic Packet Report`**
...
<a id="section-6-4-2"></a> **`6.4.2. Extended Packet Report`**
...
<a id="section-6-5"></a> **`6.5. Report Interpretation`**
...
<a id="section-6-5-1"></a> **`6.5.1. Selection Sequence Report Interpretation`**
...
<a id="section-6-5-2"></a> **`6.5.2. Selector Report Interpretation`**
...
<a id="section-6-5-2-1"></a> **`6.5.2.1. Systematic Count-Based Sampling`**
...
<a id="section-6-5-2-2"></a> **`6.5.2.2. Systematic Time-Based Sampling`**
...
<a id="section-6-5-2-3"></a> **`6.5.2.3. Random n-out-of-N Sampling`**
...
<a id="section-6-5-2-4"></a> **`6.5.2.4. Uniform Probabilistic Sampling`**
...
<a id="section-6-5-2-5"></a> **`6.5.2.5. Property Match Filtering`**
...
<a id="section-6-5-2-6"></a> **`6.5.2.6. Hash-Based Filtering`**
...
<a id="section-6-5-2-7"></a> **`6.5.2.7. Other Selection Methods`**
...
<a id="section-6-5-3"></a> **`6.5.3. Selection Sequence Statistics Report Interpretation`**
...
<a id="section-6-5-4"></a> **`6.5.4. Accuracy Report Interpretation`**
...
<a id="section-8-1"></a> **`8.1. IPFIX-Related Considerations`**
...
<a id="section-8-2"></a> **`8.2. PSAMP-Related Considerations`**
