...
`   `[`2`](#section-2)`. Conventions, Definitions, and Acronyms`

`   `[`3`](#section-3)`. Discussion, Requirements, and Design Rationale`

`      `[`3.1`](#section-3-1)`. Requirements`

`      `[`3.2`](#section-3-2)`. Applicability`

`      `[`3.3`](#section-3-3)`. Interoperability`

`   `[`4`](#section-4)`. Overview of Use of ECN with RTP/UDP/IP`

`   `[`5`](#section-5)`. RTCP Extensions for ECN Feedback`

`      `[`5.1`](#section-5-1)`. RTP/AVPF Transport-Layer ECN Feedback Packet`

`      `[`5.2`](#section-5-2)`. RTCP XR Report Block for ECN Summary Information`

`   `[`6`](#section-6)`. SDP Signalling Extensions for ECN`

`      `[`6.1`](#section-6-1)`. Signalling ECN Capability Using SDP`

`      `[`6.2`](#section-6-2)`. RTCP ECN Feedback SDP Parameter`

`      `[`6.3`](#section-6-3)`. XR Block ECN SDP Parameter`

`      `[`6.4`](#section-6-4)`. ICE Parameter to Signal ECN Capability`

`   `[`7`](#section-7)`. Use of ECN with RTP/UDP/IP`

`      `[`7.1`](#section-7-1)`. Negotiation of ECN Capability`

`      `[`7.2`](#section-7-2)`. Initiation of ECN Use in an RTP Session`

`      `[`7.3`](#section-7-3)`. Ongoing Use of ECN within an RTP Session`

`      `[`7.4`](#section-7-4)`. Detecting Failures`

`   `[`8`](#section-8)`. Processing ECN in RTP Translators and Mixers`

`      `[`8.1`](#section-8-1)`. Transport Translators`

`      `[`8.2`](#section-8-2)`. Fragmentation and Reassembly in Translators`

`      `[`8.3`](#section-8-3)`. Generating RTCP ECN Feedback in Media Transcoders`

`      `[`8.4`](#section-8-4)`. Generating RTCP ECN Feedback in Mixers`

`   `[`9`](#section-9)`. Implementation Considerations`

`   `[`10`](#section-10)`. IANA Considerations`

`      `[`10.1`](#section-10-1)`. SDP Attribute Registration`

`      `[`10.2`](#section-10-2)`. RTP/AVPF Transport-Layer Feedback Message`

`      `[`10.3`](#section-10-3)`. RTCP Feedback SDP Parameter`

`      `[`10.4`](#section-10-4)`. RTCP XR Report Blocks`

`      `[`10.5`](#section-10-5)`. RTCP XR SDP Parameter`

`      `[`10.6`](#section-10-6)`. STUN Attribute`

`      `[`10.7`](#section-10-7)`. ICE Option`

`   `[`11`](#section-11)`. Security Considerations`

`   `[`12`](#section-12)`. Examples of SDP Signalling`

`      `[`12.1`](#section-12-1)`. Basic SDP Offer/Answer`

`      `[`12.2`](#section-12-2)`. Declarative Multicast SDP`
...
<a id="section-2"></a> **`2. Conventions, Definitions, and Acronyms`**
...
<a id="section-3"></a> **`3. Discussion, Requirements, and Design Rationale`**
...
<a id="section-3-1"></a> **`3.1. Requirements`**
...
<a id="section-3-2"></a> **`3.2. Applicability`**
...
<a id="section-3-3"></a> **`3.3. Interoperability`**
...
<a id="section-4"></a> **`4. Overview of Use of ECN with RTP/UDP/IP`**
...
<a id="section-5"></a> **`5. RTCP Extensions for ECN Feedback`**
...
<a id="section-5-1"></a> **`5.1. RTP/AVPF Transport-Layer ECN Feedback Packet`**
...
<a id="section-5-2"></a> **`5.2. RTCP XR Report Block for ECN Summary Information`**
...
<a id="section-6"></a> **`6. SDP Signalling Extensions for ECN`**
...
<a id="section-6-1"></a> **`6.1. Signalling ECN Capability Using SDP`**
...
<a id="section-6-1-1"></a> **`6.1.1. Use of "a=ecn-capable-rtp:" with the Offer/Answer Model`**
...
<a id="section-6-1-2"></a> **`6.1.2. Use of "a=ecn-capable-rtp:" with Declarative SDP`**
...
<a id="section-6-1-3"></a> **`6.1.3. General Use of the "a=ecn-capable-rtp:" Attribute`**
...
<a id="section-6-2"></a> **`6.2. RTCP ECN Feedback SDP Parameter`**
...
<a id="section-6-3"></a> **`6.3. XR Block ECN SDP Parameter`**
...
<a id="section-6-4"></a> **`6.4. ICE Parameter to Signal ECN Capability`**
...
<a id="section-7"></a> **`7. Use of ECN with RTP/UDP/IP`**
...
<a id="section-7-1"></a> **`7.1. Negotiation of ECN Capability`**
...
<a id="section-7-2"></a> **`7.2. Initiation of ECN Use in an RTP Session`**
...
<a id="section-7-2-1"></a> **`7.2.1. Detection of ECT Using RTP and RTCP`**
...
<a id="section-7-2-2"></a> **`7.2.2. Detection of ECT Using STUN with ICE`**
...
<a id="section-7-2-3"></a> **`7.2.3. Leap-of-Faith ECT Initiation Method`**
...
<a id="section-7-3"></a> **`7.3. Ongoing Use of ECN within an RTP Session`**
...
<a id="section-7-3-1"></a> **`7.3.1. Transmission of ECT-Marked RTP Packets`**
...
<a id="section-7-3-2"></a> **`7.3.2. Reporting ECN Feedback via RTCP`**
...
<a id="section-7-3-3"></a> **`7.3.3. Response to Congestion Notifications`**
...
<a id="section-7-4"></a> **`7.4. Detecting Failures`**
...
<a id="section-7-4-1"></a> **`7.4.1. Fallback Mechanisms`**
...
<a id="section-7-4-2"></a> **`7.4.2. Interpretation of ECN Summary Information`**
...
<a id="section-8"></a> **`8. Processing ECN in RTP Translators and Mixers`**
...
<a id="section-8-1"></a> **`8.1. Transport Translators`**
...
<a id="section-8-2"></a> **`8.2. Fragmentation and Reassembly in Translators`**
...
<a id="section-8-3"></a> **`8.3. Generating RTCP ECN Feedback in Media Transcoders`**
...
<a id="section-8-4"></a> **`8.4. Generating RTCP ECN Feedback in Mixers`**
...
<a id="section-9"></a> **`9. Implementation Considerations`**
...
<a id="section-10-1"></a> **`10.1. SDP Attribute Registration`**
...
<a id="section-10-2"></a> **`10.2. RTP/AVPF Transport-Layer Feedback Message`**
...
<a id="section-10-3"></a> **`10.3. RTCP Feedback SDP Parameter`**
...
<a id="section-10-4"></a> **`10.4. RTCP XR Report Blocks`**
...
<a id="section-10-5"></a> **`10.5. RTCP XR SDP Parameter`**
...
<a id="section-10-6"></a> **`10.6. STUN Attribute`**
...
<a id="section-10-7"></a> **`10.7. ICE Option`**
...
<a id="section-12"></a> **`12. Examples of SDP Signalling`**
...
<a id="section-12-1"></a> **`12.1. Basic SDP Offer/Answer`**
...
<a id="section-12-2"></a> **`12.2. Declarative Multicast SDP`**
