...
`     `[`1.1`](#section-1-1)`. Purpose and Applicability`

`     `[`1.2`](#section-1-2)`. Background and History`

`     `[`1.3`](#section-1-3)`. Structure of the Rest of This Document`

`     `[`1.4`](#section-1-4)`. Terminology`

`   `[`2`](#section-2)`. The Bidi Rule`

`   `[`3`](#section-3)`. The Requirement Set for the Bidi Rule`

`   `[`4`](#section-4)`. Examples of Issues Found with RFC 3454`

`     `[`4.1`](#section-4-1)`. Dhivehi`

`     `[`4.2`](#section-4-2)`. Yiddish`

`     `[`4.3`](#section-4-3)`. Strings with Numbers`

`   `[`5`](#section-5)`. Troublesome Situations and Guidelines`

`   `[`6`](#section-6)`. Other Issues in Need of Resolution`

`   `[`7`](#section-7)`. Compatibility Considerations`

`     `[`7.1`](#section-7-1)`. Backwards Compatibility Considerations`

`     `[`7.2`](#section-7-2)`. Forward Compatibility Considerations`
...
<a id="section-1-1"></a> **`1.1. Purpose and Applicability`**
...
<a id="section-1-2"></a> **`1.2. Background and History`**
...
<a id="section-1-3"></a> **`1.3. Structure of the Rest of This Document`**
...
<a id="section-2"></a> **`2. The Bidi Rule`**
...
<a id="section-3"></a> **`3. The Requirement Set for the Bidi Rule`**
...
<a id="section-4"></a> **`4. Examples of Issues Found with RFC 3454`**

```text

```

<a id="section-4-1"></a> **`4.1. Dhivehi`**
...
<a id="section-4-2"></a> **`4.2. Yiddish`**
...
<a id="section-4-3"></a> **`4.3. Strings with Numbers`**
...
<a id="section-5"></a> **`5. Troublesome Situations and Guidelines`**
...
<a id="section-6"></a> **`6. Other Issues in Need of Resolution`**
...
<a id="section-7"></a> **`7. Compatibility Considerations`**

```text

```

<a id="section-7-1"></a> **`7.1. Backwards Compatibility Considerations`**
...
<a id="section-7-2"></a> **`7.2. Forward Compatibility Considerations`**
