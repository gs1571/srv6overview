...
`    `[`2`](#section-2)`. BOOTP Extension/DHCP Option Field Format`

`    `[`3`](#section-3)`. RFC 1497 Vendor Extensions`

`    `[`4`](#section-4)`. IP Layer Parameters per Host`

`    `[`5`](#section-5)`. IP Layer Parameters per Interface`

`    `[`6`](#section-6)`. Link Layer Parameters per Interface`

`    `[`7`](#section-7)`. TCP Parameters`

`    `[`8`](#section-8)`. Application and Service Parameters`

`    `[`9`](#section-9)`. DHCP Extensions`

`   `[`10`](#section-10)`. Defining new extensions`
...
`   `[`14`](#section-14)`. Authors' Addresses`
...
<a id="section-2"></a> **`2. BOOTP Extension/DHCP Option Field Format`**
...
<a id="section-3"></a> **`3. RFC 1497 Vendor Extensions`**
...
<a id="section-3-1"></a> **`3.1. Pad Option`**
...
<a id="section-3-2"></a> **`3.2. End Option`**
...
<a id="section-3-3"></a> **`3.3. Subnet Mask`**
...
<a id="section-3-4"></a> **`3.4. Time Offset`**
...
<a id="section-3-5"></a> **`3.5. Router Option`**
...
<a id="section-3-6"></a> **`3.6. Time Server Option`**
...
<a id="section-3-7"></a> **`3.7. Name Server Option`**
...
<a id="section-3-8"></a> **`3.8. Domain Name Server Option`**
...
<a id="section-3-9"></a> **`3.9. Log Server Option`**
...
<a id="section-3-10"></a> **`3.10. Cookie Server Option`**
...
<a id="section-3-11"></a> **`3.11. LPR Server Option`**
...
<a id="section-3-12"></a> **`3.12. Impress Server Option`**
...
<a id="section-3-13"></a> **`3.13. Resource Location Server Option`**
...
<a id="section-3-14"></a> **`3.14. Host Name Option`**
...
<a id="section-3-15"></a> **`3.15. Boot File Size Option`**
...
<a id="section-3-16"></a> **`3.16. Merit Dump File`**
...
<a id="section-3-17"></a> **`3.17. Domain Name`**
...
<a id="section-3-18"></a> **`3.18. Swap Server`**
...
<a id="section-3-19"></a> **`3.19. Root Path`**
...
<a id="section-3-20"></a> **`3.20. Extensions Path`**
...
<a id="section-4"></a> **`4. IP Layer Parameters per Host`**
...
<a id="section-4-1"></a> **`4.1. IP Forwarding Enable/Disable Option`**
...
<a id="section-4-2"></a> **`4.2. Non-Local Source Routing Enable/Disable Option`**
...
<a id="section-4-3"></a> **`4.3. Policy Filter Option`**
...
<a id="section-4-4"></a> **`4.4. Maximum Datagram Reassembly Size`**
...
<a id="section-4-5"></a> **`4.5. Default IP Time-to-live`**
...
<a id="section-4-6"></a> **`4.6. Path MTU Aging Timeout Option`**
...
<a id="section-4-7"></a> **`4.7. Path MTU Plateau Table Option`**
...
<a id="section-5"></a> **`5. IP Layer Parameters per Interface`**
...
<a id="section-5-1"></a> **`5.1. Interface MTU Option`**
...
<a id="section-5-2"></a> **`5.2. All Subnets are Local Option`**
...
<a id="section-5-3"></a> **`5.3. Broadcast Address Option`**
...
<a id="section-5-4"></a> **`5.4. Perform Mask Discovery Option`**
...
<a id="section-5-5"></a> **`5.5. Mask Supplier Option`**
...
<a id="section-5-6"></a> **`5.6. Perform Router Discovery Option`**
...
<a id="section-5-7"></a> **`5.7. Router Solicitation Address Option`**
...
<a id="section-5-8"></a> **`5.8. Static Route Option`**
...
<a id="section-6"></a> **`6. Link Layer Parameters per Interface`**
...
<a id="section-6-1"></a> **`6.1. Trailer Encapsulation Option`**
...
<a id="section-6-2"></a> **`6.2. ARP Cache Timeout Option`**
...
<a id="section-6-3"></a> **`6.3. Ethernet Encapsulation Option`**
...
<a id="section-7"></a> **`7. TCP Parameters`**
...
<a id="section-7-1"></a> **`7.1. TCP Default TTL Option`**
...
<a id="section-7-2"></a> **`7.2. TCP Keepalive Interval Option`**
...
<a id="section-7-3"></a> **`7.3. TCP Keepalive Garbage Option`**
...
<a id="section-8"></a> **`8. Application and Service Parameters`**
...
<a id="section-8-1"></a> **`8.1. Network Information Service Domain Option`**
...
<a id="section-8-2"></a> **`8.2. Network Information Servers Option`**
...
<a id="section-8-3"></a> **`8.3. Network Time Protocol Servers Option`**
...
<a id="section-8-4"></a> **`8.4. Vendor Specific Information`**
...
<a id="section-8-5"></a> **`8.5. NetBIOS over TCP/IP Name Server Option`**
...
<a id="section-8-6"></a> **`8.6. NetBIOS over TCP/IP Datagram Distribution Server Option`**
...
<a id="section-8-7"></a> **`8.7. NetBIOS over TCP/IP Node Type Option`**
...
<a id="section-8-8"></a> **`8.8. NetBIOS over TCP/IP Scope Option`**
...
<a id="section-8-9"></a> **`8.9. X Window System Font Server Option`**
...
<a id="section-8-10"></a> **`8.10. X Window System Display Manager Option`**
...
<a id="section-8-11"></a> **`8.11. Network Information Service+ Domain Option`**
...
<a id="section-8-12"></a> **`8.12. Network Information Service+ Servers Option`**
...
<a id="section-8-13"></a> **`8.13. Mobile IP Home Agent option`**
...
<a id="section-8-14"></a> **`8.14. Simple Mail Transport Protocol (SMTP) Server Option`**
...
<a id="section-8-15"></a> **`8.15. Post Office Protocol (POP3) Server Option`**
...
<a id="section-8-16"></a> **`8.16. Network News Transport Protocol (NNTP) Server Option`**
...
<a id="section-8-17"></a> **`8.17. Default World Wide Web (WWW) Server Option`**
...
<a id="section-8-18"></a> **`8.18. Default Finger Server Option`**
...
<a id="section-8-19"></a> **`8.19. Default Internet Relay Chat (IRC) Server Option`**
...
<a id="section-8-20"></a> **`8.20. StreetTalk Server Option`**
...
<a id="section-8-21"></a> **`8.21. StreetTalk Directory Assistance (STDA) Server Option`**
...
<a id="section-9"></a> **`9. DHCP Extensions`**
...
<a id="section-9-1"></a> **`9.1. Requested IP Address`**
...
<a id="section-9-2"></a> **`9.2. IP Address Lease Time`**
...
<a id="section-9-3"></a> **`9.3. Option Overload`**
...
<a id="section-9-6"></a> **`9.6. DHCP Message Type`**
...
<a id="section-9-7"></a> **`9.7. Server Identifier`**
...
<a id="section-9-8"></a> **`9.8. Parameter Request List`**
...
<a id="section-9-9"></a> **`9.9. Message`**
...
<a id="section-9-10"></a> **`9.10. Maximum DHCP Message Size`**
...
<a id="section-9-11"></a> **`9.11. Renewal (T1) Time Value`**
...
<a id="section-9-12"></a> **`9.12. Rebinding (T2) Time Value`**
...
<a id="section-9-13"></a> **`9.13. Vendor class identifier`**
...
<a id="section-9-14"></a> **`9.14. Client-identifier`**
...
<a id="section-10"></a> **`10. Defining new extensions`**
...
<a id="section-14"></a> **`14. Authors' Addresses`**
