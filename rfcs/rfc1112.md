...
<a id="section-3"></a> **`3. LEVELS OF CONFORMANCE`**
...
<a id="section-4"></a> **`4. HOST GROUP ADDRESSES`**
...
<a id="section-5"></a> **`5. MODEL OF A HOST IP IMPLEMENTATION`**
...
<a id="section-6"></a> **`6. SENDING MULTICAST IP DATAGRAMS`**

```text

```

<a id="section-6-1"></a> **`6.1. Extensions to the IP Service Interface`**
...
<a id="section-6-2"></a> **`6.2. Extensions to the IP Module`**
...
<a id="section-6-3"></a> **`6.3. Extensions to the Local Network Service Interface`**
...
<a id="section-6-4"></a> **`6.4. Extensions to an Ethernet Local Network Module`**
...
<a id="section-6-5"></a> **`6.5. Extensions to Local Network Modules other than Ethernet`**
...
<a id="section-7"></a> **`7. RECEIVING MULTICAST IP DATAGRAMS`**

```text

```

<a id="section-7-1"></a> **`7.1. Extensions to the IP Service Interface`**
...
<a id="section-7-2"></a> **`7.2. Extensions to the IP Module`**
...
<a id="section-7-3"></a> **`7.3. Extensions to the Local Network Service Interface`**
...
<a id="section-7-4"></a> **`7.4. Extensions to an Ethernet Local Network Module`**
...
<a id="section-7-5"></a> **`7.5. Extensions to Local Network Modules other than Ethernet`**
