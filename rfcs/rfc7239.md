...
`   `[`3`](#section-3)`. Syntax Notations`

`   `[`4`](#section-4)`. Forwarded HTTP Header Field`

`   `[`5`](#section-5)`. Parameters`

`      `[`5.1`](#section-5-1)`. Forwarded By`

`      `[`5.2`](#section-5-2)`. Forwarded For`

`      `[`5.3`](#section-5-3)`. Forwarded Host`

`      `[`5.4`](#section-5-4)`. Forwarded Proto`

`      `[`5.5`](#section-5-5)`. Extensions`

`   `[`6`](#section-6)`. Node Identifiers`

`      `[`6.1`](#section-6-1)`. IPv4 and IPv6 Identifiers`

`      `[`6.2`](#section-6-2)`. The "unknown" Identifier`

`      `[`6.3`](#section-6-3)`. Obfuscated Identifier`

`   `[`7`](#section-7)`. Implementation Considerations`

`      `[`7.1`](#section-7-1)`. HTTP Lists`

`      `[`7.2`](#section-7-2)`. Header Field Preservation`

`      `[`7.3`](#section-7-3)`. Relation to Via`

`      `[`7.4`](#section-7-4)`. Transition`

`      `[`7.5`](#section-7-5)`. Example Usage`

`   `[`8`](#section-8)`. Security Considerations`

`      `[`8.1`](#section-8-1)`. Header Validity and Integrity`

`      `[`8.2`](#section-8-2)`. Information Leak`

`      `[`8.3`](#section-8-3)`. Privacy Considerations`
...
<a id="section-2"></a> **`2. Notational Conventions`**
...
<a id="section-3"></a> **`3. Syntax Notations`**
...
<a id="section-4"></a> **`4. Forwarded HTTP Header Field`**
...
<a id="section-5-1"></a> **`5.1. Forwarded By`**
...
<a id="section-5-2"></a> **`5.2. Forwarded For`**
...
<a id="section-5-3"></a> **`5.3. Forwarded Host`**
...
<a id="section-5-4"></a> **`5.4. Forwarded Proto`**
...
<a id="section-5-5"></a> **`5.5. Extensions`**
...
<a id="section-6"></a> **`6. Node Identifiers`**
...
<a id="section-6-1"></a> **`6.1. IPv4 and IPv6 Identifiers`**
...
<a id="section-6-2"></a> **`6.2. The "unknown" Identifier`**
...
<a id="section-6-3"></a> **`6.3. Obfuscated Identifier`**
...
<a id="section-7"></a> **`7. Implementation Considerations`**

```text

```

<a id="section-7-1"></a> **`7.1. HTTP Lists`**
...
<a id="section-7-2"></a> **`7.2. Header Field Preservation`**
...
<a id="section-7-3"></a> **`7.3. Relation to Via`**
...
<a id="section-7-4"></a> **`7.4. Transition`**
...
<a id="section-7-5"></a> **`7.5. Example Usage`**
...
<a id="section-8-1"></a> **`8.1. Header Validity and Integrity`**
...
<a id="section-8-2"></a> **`8.2. Information Leak`**
...
<a id="section-8-3"></a> **`8.3. Privacy Considerations`**
