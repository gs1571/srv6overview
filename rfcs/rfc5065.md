...
`   `[`3`](#section-3)`. AS_CONFED Segment Type Extension`

`   `[`4`](#section-4)`. Operation`

`      `[`4.1`](#section-4-1)`. AS_PATH Modification Rules`

`   `[`5`](#section-5)`. Error Handling`

`      `[`5.1`](#section-5-1)`. Error Handling`

`      `[`5.2`](#section-5-2)`. MED and LOCAL_PREF Handling`

`      `[`5.3`](#section-5-3)`. AS_PATH and Path Selection`

`   `[`6`](#section-6)`. Compatibility Considerations`

`   `[`7`](#section-7)`. Deployment Considerations`
...
<a id="section-3"></a> **`3. AS_CONFED Segment Type Extension`**
...
<a id="section-4-1"></a> **`4.1. AS_PATH Modification Rules`**
...
<a id="section-5"></a> **`5. Error Handling`**
...
<a id="section-5-1"></a> **`5.1. Common Administrative Issues`**
...
<a id="section-5-2"></a> **`5.2. MED and LOCAL_PREF Handling`**
...
<a id="section-5-3"></a> **`5.3. AS_PATH and Path Selection`**
...
<a id="section-6"></a> **`6. Compatibility Considerations`**
...
<a id="section-7"></a> **`7. Deployment Considerations`**
