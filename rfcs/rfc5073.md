...
`   `[`3`](#section-3)`. TE Node Capability Descriptor`

`      `[`3.1`](#section-3-1)`. Description`

`      `[`3.2`](#section-3-2)`. Required Information`

`   `[`4`](#section-4)`. TE Node Capability Descriptor TLV Formats`

`      `[`4.1`](#section-4-1)`. OSPF TE Node Capability Descriptor TLV Format`

`      `[`4.2`](#section-4-2)`. IS-IS TE Node Capability Descriptor sub-TLV format`

`   `[`5`](#section-5)`. Elements of Procedure`

`      `[`5.1`](#section-5-1)`. OSPF`

`      `[`5.2`](#section-5-2)`. IS-IS`
...
`      `[`8.1`](#section-8-1)`. OSPF TLV`

`      `[`8.2`](#section-8-2)`. ISIS sub-TLV`

`      `[`8.3`](#section-8-3)`. Capability Registry`
...
<a id="section-3"></a> **`3. TE Node Capability Descriptor`**
...
<a id="section-3-2"></a> **`3.2. Required Information`**
...
<a id="section-4"></a> **`4. TE Node Capability Descriptor TLV Formats`**

```text

```

<a id="section-4-1"></a> **`4.1. OSPF TE Node Capability Descriptor TLV Format`**
...
<a id="section-4-2"></a> **`4.2. IS-IS TE Node Capability Descriptor sub-TLV format`**
...
<a id="section-8-1"></a> **`8.1. OSPF TLV`**
...
<a id="section-8-2"></a> **`8.2. ISIS sub-TLV`**
...
<a id="section-8-3"></a> **`8.3. Capability Registry`**
