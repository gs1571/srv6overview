...
<a id="section-2"></a> **`2. Attributes`**

```text

```

<a id="section-2-1"></a> **`2.1. NAS-IPv6-Address`**
...
<a id="section-3-2"></a> **`3.2. Framed-Interface-Id`**
...
<a id="section-2-3"></a> **`2.3. Framed-IPv6-Prefix`**
...
<a id="section-2-4"></a> **`2.4. Login-IPv6-Host`**
...
<a id="section-2-5"></a> **`2.5. Framed-IPv6-Route`**
...
<a id="section-2-6"></a> **`2.6. Framed-IPv6-Pool`**
...
<a id="section-3"></a> **`3. Table of Attributes`**
