...
<a id="section-2"></a> **`2. Terminology and Conventions`**
...
<a id="section-2-1"></a> **`2.1. Policy Terminology`**
...
<a id="section-2-2"></a> **`2.2. Requirement Terminology`**
...
<a id="section-2-3"></a> **`2.3. Common ABNF Productions`**
...
<a id="section-3"></a> **`3. IANA Considerations for LDAP`**
...
<a id="section-3-1"></a> **`3.1. Object Identifiers`**
...
<a id="section-3-2"></a> **`3.2. Protocol Mechanisms`**
...
<a id="section-3-3"></a> **`3.3. LDAP Syntaxes`**
...
<a id="section-3-4"></a> **`3.4. Object Identifier Descriptors`**
...
<a id="section-3-5"></a> **`3.5. AttributeDescription Options`**
...
<a id="section-3-6"></a> **`3.6. LDAP Message Types`**
...
<a id="section-3-7"></a> **`3.7. LDAP Authentication Method`**
...
<a id="section-3-8"></a> **`3.8. LDAP Result Codes`**
...
<a id="section-3-9"></a> **`3.9. LDAP Search Scope`**
...
<a id="section-3-10"></a> **`3.10. LDAP Filter Choice`**
...
<a id="section-3-11"></a> **`3.11. LDAP ModifyRequest Operation Type`**
...
<a id="section-3-12"></a> **`3.12. LDAP authzId Prefixes`**

```text

   Authorization Identities in LDAP are strings conforming to the
    production [RFC4513].  This production is extensible.  Each
...
<a id="section-3-13"></a> **`3.13. Directory Systems Names`**
...
<a id="section-5"></a> **`5. Registration Maintenance`**
...
<a id="section-5-1"></a> **`5.1. Lists of Registered Values`**
...
<a id="section-5-2"></a> **`5.2. Change Control`**
...
<a id="section-5-3"></a> **`5.3. Comments`**
...
<a id="section-7"></a> **`7. Acknowledgement`**
