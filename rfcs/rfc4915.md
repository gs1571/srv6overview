...
`     `[`1.1`](#section-1-1)`. Differences between Multi-Topology and TOS-Based`

`           Routing`

`   `[`2`](#section-2)`. Terminology`

`     `[`2.1`](#section-2-1)`. Requirements Notation`

`     `[`2.2`](#section-2-2)`. Terms`

`   `[`3`](#section-3)`. Base MT Functional Specifications`

`     `[`3.1`](#section-3-1)`. MT Area Boundary`

`     `[`3.2`](#section-3-2)`. Adjacency for MTs`

`     `[`3.3`](#section-3-3)`. Sending OSPF Control Packets`

`     `[`3.4`](#section-3-4)`. Advertising MT Adjacencies and the Corresponding IP`

`           Prefixes`

`       `[`3.4.1`](#section-3-4-1)`. Inter-Area and External Routing`

`     `[`3.5`](#section-3-5)`. Flushing MT Information`

`     `[`3.6`](#section-3-6)`. MT SPF Computation`

`     `[`3.7`](#section-3-7)`. MT-ID Values`

`     `[`3.8`](#section-3-8)`. Forwarding in MT`

`   `[`4`](#section-4)`. Default Topology Link Exclusion Functional Specifications  .`

`     `[`4.1`](#section-4-1)`. Exclusion of Links in the Default Topology`

`     `[`4.2`](#section-4-2)`. New Area Data Structure Parameter`

`     `[`4.3`](#section-4-3)`. Adjacency Formation with Link Exclusion Capability`

`     `[`4.4`](#section-4-4)`. OSPF Control Packets Transmission over Excluded Links  .`

`     `[`4.5`](#section-4-5)`. OSPF LSA Advertisement and SPF Computation for`

`           Excluded Links`

`   `[`5`](#section-5)`. Interoperability between MT-Capable and Non-MT-Capable`

`       Routers`

`     `[`5.1`](#section-5-1)`. Demand Circuit Compatibility Considerations`

`   `[`6`](#section-6)`. Migration from Non-MT-Area to MT-Area`

`   `[`7`](#section-7)`. MT Network Management Considerations`

`     `[`7.1`](#section-7-1)`. Create Dedicated Management Topology to Include All`

`           the Nodes`

`     `[`7.2`](#section-7-2)`. Extend the Default Topology to All the Nodes`
...
<a id="section-1-1"></a> **`1.1. Differences between Multi-Topology and TOS-Based Routing`**
...
<a id="section-2-1"></a> **`2.1. Requirements Notation`**
...
<a id="section-3"></a> **`3. Base MT Functional Specifications`**

```text

```

<a id="section-3-1"></a> **`3.1. MT Area Boundary`**
...
<a id="section-3-2"></a> **`3.2. Adjacency for MTs`**
...
<a id="section-3-3"></a> **`3.3. Sending OSPF Control Packets`**
...
<a id="section-3-4"></a> **`3.4. Advertising MT Adjacencies and the Corresponding IP Prefixes`**
...
<a id="section-3-4-1"></a> **`3.4.1. Inter-Area and External Routing`**
...
<a id="section-3-5"></a> **`3.5. Flushing MT Information`**
...
<a id="section-3-6"></a> **`3.6. MT SPF Computation`**
...
<a id="section-3-7"></a> **`3.7. MT-ID Values`**
...
<a id="section-3-8"></a> **`3.8. Forwarding in MT`**
...
<a id="section-4"></a> **`4. Default Topology Link Exclusion Functional Specifications`**
...
<a id="section-4-1"></a> **`4.1. Exclusion of Links in the Default Topology`**
...
<a id="section-4-2"></a> **`4.2. New Area Data Structure Parameter`**
...
<a id="section-4-3"></a> **`4.3. Adjacency Formation with Link Exclusion Capability`**
...
<a id="section-4-4"></a> **`4.4. OSPF Control Packets Transmission over Excluded Links`**
...
<a id="section-4-5"></a> **`4.5. OSPF LSA Advertisement and SPF Computation for Excluded Links`**
...
<a id="section-5"></a> **`5. Interoperability between MT-Capable and Non-MT-Capable Routers`**
...
<a id="section-5-1"></a> **`5.1. Demand Circuit Compatibility Considerations`**
...
<a id="section-6"></a> **`6. Migration from Non-MT-Area to MT-Area`**
...
<a id="section-7"></a> **`7. MT Network Management Considerations`**
...
<a id="section-7-1"></a> **`7.1. Create Dedicated Management Topology to Include All the Nodes`**
...
<a id="section-7-2"></a> **`7.2. Extend the Default Topology to All the Nodes`**
