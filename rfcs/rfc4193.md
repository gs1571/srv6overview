...
`   `[`3`](#section-3)`. Local IPv6 Unicast Addresses`

`      `[`3.1`](#section-3-1)`. Format`

`           `[`3.1.1`](#section-3-1-1)`. Background`

`      `[`3.2`](#section-3-2)`. Global ID`

`           `[`3.2.1`](#section-3-2-1)`. Locally Assigned Global IDs`

`           `[`3.2.2`](#section-3-2-2)`. Sample Code for Pseudo-Random Global ID Algorithm`

`           `[`3.2.3`](#section-3-2-3)`. Analysis of the Uniqueness of Global IDs`

`      `[`3.3`](#section-3-3)`. Scope Definition`

`   `[`4`](#section-4)`. Operational Guidelines`

`      `[`4.1`](#section-4-1)`. Routing`

`      `[`4.2`](#section-4-2)`. Renumbering and Site Merging`

`      `[`4.3`](#section-4-3)`. Site Border Router and Firewall Packet Filtering`

`      `[`4.4`](#section-4-4)`. DNS Issues`

`      `[`4.5`](#section-4-5)`. Application and Higher Level Protocol Issues`

`      `[`4.6`](#section-4-6)`. Use of Local IPv6 Addresses for Local Communication`

`      `[`4.7`](#section-4-7)`. Use of Local IPv6 Addresses with VPNs`

`   `[`5`](#section-5)`. Global Routing Considerations`

`      `[`5.1`](#section-5-1)`. From the Standpoint of the Internet`

`      `[`5.2`](#section-5-2)`. From the Standpoint of a Site`

`   `[`6`](#section-6)`. Advantages and Disadvantages`

`      `[`6.1`](#section-6-1)`. Advantages`

`      `[`6.2`](#section-6-2)`. Disadvantages`
...
<a id="section-3"></a> **`3. Local IPv6 Unicast Addresses`**

```text

```

<a id="section-3-1"></a> **`3.1. Format`**
...
<a id="section-3-2"></a> **`3.2. Global ID`**
...
<a id="section-3-2-1"></a> **`3.2.1. Locally Assigned Global IDs`**
...
<a id="section-3-2-2"></a> **`3.2.2. Sample Code for Pseudo-Random Global ID Algorithm`**
...
<a id="section-3-2-3"></a> **`3.2.3. Analysis of the Uniqueness of Global IDs`**
...
<a id="section-3-3"></a> **`3.3. Scope Definition`**
...
<a id="section-4"></a> **`4. Operational Guidelines`**
...
<a id="section-4-1"></a> **`4.1. Routing`**
...
<a id="section-4-2"></a> **`4.2. Renumbering and Site Merging`**
...
<a id="section-4-3"></a> **`4.3. Site Border Router and Firewall Packet Filtering`**
...
<a id="section-4-4"></a> **`4.4. DNS Issues`**
...
<a id="section-4-5"></a> **`4.5. Application and Higher Level Protocol Issues`**
...
<a id="section-4-6"></a> **`4.6. Use of Local IPv6 Addresses for Local Communication`**
...
<a id="section-4-7"></a> **`4.7. Use of Local IPv6 Addresses with VPNs`**
...
<a id="section-5"></a> **`5. Global Routing Considerations`**
...
<a id="section-5-1"></a> **`5.1. From the Standpoint of the Internet`**
...
<a id="section-5-2"></a> **`5.2. From the Standpoint of a Site`**
...
<a id="section-6"></a> **`6. Advantages and Disadvantages`**

```text

```

<a id="section-6-1"></a> **`6.1. Advantages`**
...
<a id="section-6-2"></a> **`6.2. Disadvantages`**
