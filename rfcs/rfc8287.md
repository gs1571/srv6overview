...
`     `[`1.1`](#section-1-1)`. Coexistence of SR-Capable and Non-SR-Capable Node`
...
`   `[`4`](#section-4)`. Challenges with Existing Mechanisms`

`     `[`4.1`](#section-4-1)`. Path Validation in Segment Routing Networks`

`   `[`5`](#section-5)`. Segment ID Sub-TLV`

`     `[`5.1`](#section-5-1)`. IPv4 IGP-Prefix Segment ID`

`     `[`5.2`](#section-5-2)`. IPv6 IGP-Prefix Segment ID`

`     `[`5.3`](#section-5-3)`. IGP-Adjacency Segment ID`

`   `[`6`](#section-6)`. Extension to Downstream Detailed Mapping TLV`

`   `[`7`](#section-7)`. Procedures`

`     `[`7.1`](#section-7-1)`. FECs in Target FEC Stack TLV`

`     `[`7.2`](#section-7-2)`. FEC Stack Change Sub-TLV`

`     `[`7.3`](#section-7-3)`. Segment ID POP Operation`

`     `[`7.4`](#section-7-4)`. Segment ID Check`

`     `[`7.5`](#section-7-5)`. TTL Consideration for Traceroute`

`   `[`8`](#section-8)`. Backward Compatibility with Non-SR Devices`

`   `[`9`](#section-9)`. IANA Considerations`

`     `[`9.1`](#section-9-1)`. New Target FEC Stack Sub-TLVs`

`     `[`9.2`](#section-9-2)`. Protocol in the Segment ID Sub-TLV`

`     `[`9.3`](#section-9-3)`. Adjacency Type in the IGP-Adjacency Segment ID`

`     `[`9.4`](#section-9-4)`. Protocol in the Label Stack Sub-TLV of the Downstream`

`           Detailed Mapping TLV`

`     `[`9.5`](#section-9-5)`. Return Code`
...
<a id="section-1-1"></a> **`1.1. Coexistence of SR-Capable and Non-SR-Capable Node Scenarios`**
...
<a id="section-4"></a> **`4. Challenges with Existing Mechanisms`**
...
<a id="section-4-1"></a> **`4.1. Path Validation in Segment Routing Networks`**
...
<a id="section-5"></a> **`5. Segment ID Sub-TLV`**
...
<a id="section-5-1"></a> **`5.1. IPv4 IGP-Prefix Segment ID`**
...
<a id="section-5-2"></a> **`5.2. IPv6 IGP-Prefix Segment ID`**
...
<a id="section-5-3"></a> **`5.3. IGP-Adjacency Segment ID`**
...
<a id="section-6"></a> **`6. Extension to Downstream Detailed Mapping TLV`**
...
<a id="section-7-1"></a> **`7.1. FECs in Target FEC Stack TLV`**
...
<a id="section-7-2"></a> **`7.2. FEC Stack Change Sub-TLV`**
...
<a id="section-7-3"></a> **`7.3. Segment ID POP Operation`**
...
<a id="section-7-4"></a> **`7.4. Segment ID Check`**
...
<a id="section-7-5"></a> **`7.5. TTL Consideration for Traceroute`**
...
<a id="section-8"></a> **`8. Backward Compatibility with Non-SR Devices`**
...
<a id="section-9-1"></a> **`9.1. New Target FEC Stack Sub-TLVs`**
...
<a id="section-9-2"></a> **`9.2. Protocol in the Segment ID Sub-TLV`**
...
<a id="section-9-3"></a> **`9.3. Adjacency Type in the IGP-Adjacency Segment ID`**
...
<a id="section-9-4"></a> **`9.4. Protocol in the Label Stack Sub-TLV of the Downstream Detailed`**
...
<a id="section-9-5"></a> **`9.5. Return Code`**
