...
<a id="section-3"></a> **`3. Protocol Extensions`**
...
<a id="section-4-1"></a> **`4.1. Interaction between NEW BGP Speakers`**
...
<a id="section-4-2"></a> **`4.2. Interaction between NEW and OLD BGP Speakers`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. BGP Peering`**
...
<a id="section-4-2-2"></a> **`4.2.2. Generating Updates`**
...
<a id="section-4-2-3"></a> **`4.2.3. Processing Received Updates`**
...
<a id="section-5"></a> **`5. Handling BGP Communities`**
