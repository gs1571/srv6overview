...
`      `[`1.1`](#section-1-1)`. Notations Used in This Document`

`      `[`1.2`](#section-1-2)`. Changes from RFC 5342`

`      `[`1.3`](#section-1-3)`. The IEEE Registration Authority`

`      `[`1.4`](#section-1-4)`. The IANA OUI`

`   `[`2`](#section-2)`. Ethernet Identifier Parameters`

`      `[`2.1`](#section-2-1)`. 48-Bit MAC Identifiers, OUIs, and Other Prefixes`

`           `[`2.1.1`](#section-2-1-1)`. EUI-48 Assignments under the IANA OUI`

`           `[`2.1.2`](#section-2-1-2)`. EUI-48 Documentation Values`

`           `[`2.1.3`](#section-2-1-3)`. EUI-48 IANA Assignment Considerations`

`      `[`2.2`](#section-2-2)`. 64-Bit MAC Identifiers`

`           `[`2.2.1`](#section-2-2-1)`. IPv6 Use of Modified EUI-64 Identifiers`

`           `[`2.2.2`](#section-2-2-2)`. EUI-64 IANA Assignment Considerations`

`           `[`2.2.3`](#section-2-2-3)`. EUI-64 Documentation Values`

`      `[`2.3`](#section-2-3)`. Other MAC-48 Identifiers Used by the IETF`

`           `[`2.3.1`](#section-2-3-1)`. Identifiers Prefixed "33-33"`

`           `[`2.3.2`](#section-2-3-2)`. The 'CF Series'`

`                  `[`2.3.2.1`](#section-2-3-2-1)`. Changes to RFC 2153`

`   `[`3`](#section-3)`. Ethernet Protocol Parameters`

`      `[`3.1`](#section-3-1)`. Ethernet Protocol Assignment under the IANA OUI`

`      `[`3.2`](#section-3-2)`. Documentation Protocol Number`

`   `[`4`](#section-4)`. Other OUI-Based Parameters`

`   `[`5`](#section-5)`. IANA Considerations`

`      `[`5.1`](#section-5-1)`. Expert Review and IESG Ratification`

`      `[`5.2`](#section-5-2)`. MAC Address AFNs and RRTYPEs`

`      `[`5.3`](#section-5-3)`. Informational IANA Web Page Material`

`      `[`5.4`](#section-5-4)`. OUI Exhaustion`

`      `[`5.5`](#section-5-5)`. IANA OUI MAC Address Table`

`      `[`5.6`](#section-5-6)`. SNAP Protocol Number Table and Assignment`
...
<a id="section-1-1"></a> **`1.1. Notations Used in This Document`**
...
<a id="section-1-2"></a> **`1.2. Changes from RFC 5342`**
...
<a id="section-1-3"></a> **`1.3. The IEEE Registration Authority`**
...
<a id="section-1-4"></a> **`1.4. The IANA OUI`**
...
<a id="section-2"></a> **`2. Ethernet Identifier Parameters`**
...
<a id="section-2-1"></a> **`2.1. 48-Bit MAC Identifiers, OUIs, and Other Prefixes`**
...
<a id="section-2-1-1"></a> **`2.1.1. EUI-48 Assignments under the IANA OUI`**
...
<a id="section-2-1-2"></a> **`2.1.2. EUI-48 Documentation Values`**
...
<a id="section-2-1-3"></a> **`2.1.3. EUI-48 IANA Assignment Considerations`**
...
<a id="section-2-2"></a> **`2.2. 64-Bit MAC Identifiers`**
...
<a id="section-2-2-1"></a> **`2.2.1. IPv6 Use of Modified EUI-64 Identifiers`**
...
<a id="section-2-2-2"></a> **`2.2.2. EUI-64 IANA Assignment Considerations`**
...
<a id="section-2-2-3"></a> **`2.2.3. EUI-64 Documentation Values`**
...
<a id="section-2-3"></a> **`2.3. Other MAC-48 Identifiers Used by the IETF`**
...
<a id="section-2-3-1"></a> **`2.3.1. Identifiers Prefixed "33-33"`**
...
<a id="section-2-3-2"></a> **`2.3.2. The 'CF Series'`**
...
<a id="section-2-3-2-1"></a> **`2.3.2.1. Changes to RFC 2153`**
...
<a id="section-3"></a> **`3. Ethernet Protocol Parameters`**
...
<a id="section-3-1"></a> **`3.1. Ethernet Protocol Assignment under the IANA OUI`**
...
<a id="section-3-2"></a> **`3.2. Documentation Protocol Number`**
...
<a id="section-4"></a> **`4. Other OUI-Based Parameters`**
...
<a id="section-5-1"></a> **`5.1. Expert Review and IESG Ratification`**
...
<a id="section-5-2"></a> **`5.2. MAC Address AFNs and RRTYPEs`**
...
<a id="section-5-3"></a> **`5.3. Informational IANA Web Page Material`**
...
<a id="section-5-4"></a> **`5.4. OUI Exhaustion`**
...
<a id="section-5-5"></a> **`5.5. IANA OUI MAC Address Table`**
...
<a id="section-5-6"></a> **`5.6. SNAP Protocol Number Table and Assignment`**
