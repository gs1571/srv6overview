...
`   `[`3`](#section-3)`. Scenarios of Interest`

`      `[`3.1`](#section-3-1)`. IPv6-over-IPv4 Scenario`

`      `[`3.2`](#section-3-2)`. IPv4-over-IPv6 Scenario`

`   `[`4`](#section-4)`. General Principles of the Solution`

`      `[`4.1`](#section-4-1)`. E-IP and I-IP`

`      `[`4.2`](#section-4-2)`. Routing`

`      `[`4.3`](#section-4-3)`. Tunneled Forwarding`

`   `[`5`](#section-5)`. Distribution of Inter-AFBR Routing Information`

`   `[`6`](#section-6)`. Softwire Signaling`

`   `[`7`](#section-7)`. Choosing to Forward through a Softwire`

`   `[`8`](#section-8)`. Selecting a Tunneling Technology`

`   `[`9`](#section-9)`. Selecting the Softwire for a Given Packet`

`   `[`10`](#section-10)`. Softwire OAM and MIBs`

`      `[`10.1`](#section-10-1)`. Operations and Maintenance (OAM)`

`      `[`10.2`](#section-10-2)`. MIBs`

`   `[`11`](#section-11)`. Softwire Multicast`

`      `[`11.1`](#section-11-1)`. One-to-One Mappings`

`           `[`11.1.1`](#section-11-1-1)`. Using PIM in the Core`

`           `[`11.1.2`](#section-11-1-2)`. Using mLDP and Multicast MPLS in the Core`

`      `[`11.2`](#section-11-2)`. MVPN-Like Schemes`

`   `[`12`](#section-12)`. Inter-AS Considerations`

`   `[`13`](#section-13)`. Security Considerations`

`      `[`13.1`](#section-13-1)`. Problem Analysis`

`      `[`13.2`](#section-13-2)`. Non-Cryptographic Techniques`

`      `[`13.3`](#section-13-3)`. Cryptographic Techniques`
...
<a id="section-3"></a> **`3. Scenarios of Interest`**

```text

```

<a id="section-3-1"></a> **`3.1. IPv6-over-IPv4 Scenario`**
...
<a id="section-3-2"></a> **`3.2. IPv4-over-IPv6 Scenario`**
...
<a id="section-4"></a> **`4. General Principles of the Solution`**
...
<a id="section-4-1"></a> **`4.1. E-IP and I-IP`**
...
<a id="section-4-2"></a> **`4.2. Routing`**
...
<a id="section-4-3"></a> **`4.3. Tunneled Forwarding`**
...
<a id="section-5"></a> **`5. Distribution of Inter-AFBR Routing Information`**
...
<a id="section-6"></a> **`6. Softwire Signaling`**
...
<a id="section-7"></a> **`7. Choosing to Forward through a Softwire`**
...
<a id="section-8"></a> **`8. Selecting a Tunneling Technology`**
...
<a id="section-9"></a> **`9. Selecting the Softwire for a Given Packet`**
...
<a id="section-10"></a> **`10. Softwire OAM and MIBs`**

```text

```

<a id="section-10-1"></a> **`10.1. Operations and Maintenance (OAM)`**
...
<a id="section-11"></a> **`11. Softwire Multicast`**
...
<a id="section-11-1"></a> **`11.1. One-to-One Mappings`**
...
<a id="section-11-1-1"></a> **`11.1.1. Using PIM in the Core`**
...
<a id="section-11-1-2"></a> **`11.1.2. Using mLDP and Multicast MPLS in the Core`**
...
<a id="section-11-2"></a> **`11.2. MVPN-Like Schemes`**
...
<a id="section-12"></a> **`12. Inter-AS Considerations`**
...
<a id="section-13-1"></a> **`13.1. Problem Analysis`**
...
<a id="section-13-2"></a> **`13.2. Non-Cryptographic Techniques`**
...
<a id="section-13-3"></a> **`13.3. Cryptographic Techniques`**
