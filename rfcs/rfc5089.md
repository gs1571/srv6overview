...
`   `[`4`](#section-4)`. The IS-IS PCED Sub-TLV`

`      `[`4.1`](#section-4-1)`. PCE-ADDRESS Sub-TLV`

`      `[`4.2`](#section-4-2)`. The PATH-SCOPE Sub-TLV`
...
<a id="section-4"></a> **`4. The IS-IS PCED Sub-TLV`**
...
<a id="section-4-2"></a> **`4.2. The PATH-SCOPE Sub-TLV`**
