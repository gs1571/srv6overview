...
`   `[`2`](#section-2)`. Modes of Operation`

`   `[`3`](#section-3)`. Protocol Modes`

`      `[`3.1`](#section-3-1)`. Dynamic Server Discovery`

`   `[`4`](#section-4)`. Definitions`

`   `[`5`](#section-5)`. Implementation Model`

`   `[`6`](#section-6)`. Data Types`

`   `[`7`](#section-7)`. Data Structures`

`      `[`7.1`](#section-7-1)`. Structure Conventions`

`      `[`7.2`](#section-7-2)`. Global Parameters`

`      `[`7.3`](#section-7-3)`. Packet Header Variables`

`      `[`7.4`](#section-7-4)`. The Kiss-o'-Death Packet`

`      `[`7.5`](#section-7-5)`. NTP Extension Field Format`

`   `[`8`](#section-8)`. On-Wire Protocol`

`   `[`9`](#section-9)`. Peer Process`

`      `[`9.1`](#section-9-1)`. Peer Process Variables`

`      `[`9.2`](#section-9-2)`. Peer Process Operations`

`   `[`10`](#section-10)`. Clock Filter Algorithm`

`   `[`11`](#section-11)`. System Process`

`      `[`11.1`](#section-11-1)`. System Process Variables`

`      `[`11.2`](#section-11-2)`. System Process Operations`

`           `[`11.2.1`](#section-11-2-1)`. Selection Algorithm`

`           `[`11.2.2`](#section-11-2-2)`. Cluster Algorithm`

`           `[`11.2.3`](#section-11-2-3)`. Combine Algorithm`

`      `[`11.3`](#section-11-3)`. Clock Discipline Algorithm`

`   `[`12`](#section-12)`. Clock-Adjust Process`

`   `[`13`](#section-13)`. Poll Process`

`      `[`13.1`](#section-13-1)`. Poll Process Variables`

`      `[`13.2`](#section-13-2)`. Poll Process Operations`

`   `[`14`](#section-14)`. Simple Network Time Protocol (SNTP)`
...
<a id="section-2"></a> **`2. Modes of Operation`**
...
<a id="section-3"></a> **`3. Protocol Modes`**
...
<a id="section-3-1"></a> **`3.1. Dynamic Server Discovery`**
...
<a id="section-4"></a> **`4. Definitions`**
...
<a id="section-5"></a> **`5. Implementation Model`**
...
<a id="section-7"></a> **`7. Data Structures`**
...
<a id="section-7-1"></a> **`7.1. Structure Conventions`**
...
<a id="section-7-2"></a> **`7.2. Global Parameters`**
...
<a id="section-7-3"></a> **`7.3. Packet Header Variables`**
...
<a id="section-7-4"></a> **`7.4. The Kiss-o'-Death Packet`**
...
<a id="section-7-5"></a> **`7.5. NTP Extension Field Format`**
...
<a id="section-8"></a> **`8. On-Wire Protocol`**
...
<a id="section-9"></a> **`9. Peer Process`**
...
<a id="section-9-1"></a> **`9.1. Peer Process Variables`**
...
<a id="section-9-2"></a> **`9.2. Peer Process Operations`**
...
<a id="section-10"></a> **`10. Clock Filter Algorithm`**
...
<a id="section-11"></a> **`11. System Process`**
...
<a id="section-11-1"></a> **`11.1. System Process Variables`**
...
<a id="section-11-2"></a> **`11.2. System Process Operations`**
...
<a id="section-11-2-1"></a> **`11.2.1. Selection Algorithm`**
...
<a id="section-11-2-2"></a> **`11.2.2. Cluster Algorithm`**
...
<a id="section-11-2-3"></a> **`11.2.3. Combine Algorithm`**
...
<a id="section-11-3"></a> **`11.3. Clock Discipline Algorithm`**
...
<a id="section-12"></a> **`12. Clock-Adjust Process`**
...
<a id="section-13"></a> **`13. Poll Process`**
...
<a id="section-13-1"></a> **`13.1. Poll Process Variables`**
...
<a id="section-13-2"></a> **`13.2. Poll Process Operations`**
...
<a id="section-14"></a> **`14. Simple Network Time Protocol (SNTP)`**
