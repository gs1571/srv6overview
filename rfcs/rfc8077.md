...
`   `[`2`](#section-2)`. Changes from RFC 4447`

`   `[`3`](#section-3)`. Specification of Requirements`

`   `[`4`](#section-4)`. The Pseudowire Label`

`   `[`5`](#section-5)`. Details Specific to Particular Emulated Services`

`      `[`5.1`](#section-5-1)`. IP Layer 2 Transport`

`   `[`6`](#section-6)`. LDP`

`      `[`6.1`](#section-6-1)`. The PWid FEC Element`

`      `[`6.2`](#section-6-2)`. The Generalized PWid FEC Element`

`           `[`6.2.1`](#section-6-2-1)`. Attachment Identifiers`

`           `[`6.2.2`](#section-6-2-2)`. Encoding the Generalized PWid FEC Element`

`                  `[`6.2.2.1`](#section-6-2-2-1)`. PW Interface Parameters TLV`

`                  `[`6.2.2.2`](#section-6-2-2-2)`. PW Group ID TLV`

`           `[`6.2.3`](#section-6-2-3)`. Signaling Procedures`

`      `[`6.3`](#section-6-3)`. Signaling of Pseudowire Status`

`           `[`6.3.1`](#section-6-3-1)`. Use of Label Mapping Messages`

`           `[`6.3.2`](#section-6-3-2)`. Signaling PW Status`

`           `[`6.3.3`](#section-6-3-3)`. Pseudowire Status Negotiation Procedures`

`      `[`6.4`](#section-6-4)`. Interface Parameter Sub-TLV`

`      `[`6.5`](#section-6-5)`. LDP Label Withdrawal Procedures`

`   `[`7`](#section-7)`. Control Word`

`      `[`7.1`](#section-7-1)`. PW Types for Which the Control Word Is REQUIRED`

`      `[`7.2`](#section-7-2)`. PW Types for Which the Control Word Is NOT Mandatory`

`      `[`7.3`](#section-7-3)`. Control-Word Renegotiation by Label Request Message`

`      `[`7.4`](#section-7-4)`. Sequencing Considerations`

`           `[`7.4.1`](#section-7-4-1)`. Label Advertisements`

`           `[`7.4.2`](#section-7-4-2)`. Label Release`

`   `[`8`](#section-8)`. IANA Considerations`

`      `[`8.1`](#section-8-1)`. LDP TLV TYPE`

`      `[`8.2`](#section-8-2)`. LDP Status Codes`

`      `[`8.3`](#section-8-3)`. FEC Type Name Space`

`   `[`9`](#section-9)`. Security Considerations`

`      `[`9.1`](#section-9-1)`. Data-Plane Security`

`      `[`9.2`](#section-9-2)`. Control-Plane Security`

`   `[`10`](#section-10)`. Interoperability and Deployment`
...
<a id="section-2"></a> **`2. Changes from RFC 4447`**
...
<a id="section-3"></a> **`3. Specification of Requirements`**
...
<a id="section-4"></a> **`4. The Pseudowire Label`**
...
<a id="section-5"></a> **`5. Details Specific to Particular Emulated Services`**

```text

```

<a id="section-5-1"></a> **`5.1. IP Layer 2 Transport`**
...
<a id="section-6-1"></a> **`6.1. The PWid FEC Element`**
...
<a id="section-6-2"></a> **`6.2. The Generalized PWid FEC Element`**
...
<a id="section-6-2-1"></a> **`6.2.1. Attachment Identifiers`**
...
<a id="section-6-2-2"></a> **`6.2.2. Encoding the Generalized PWid FEC Element`**
...
<a id="section-6-2-2-1"></a> **`6.2.2.1. PW Interface Parameters TLV`**
...
<a id="section-6-2-2-2"></a> **`6.2.2.2. PW Group ID TLV`**
...
<a id="section-6-2-3"></a> **`6.2.3. Signaling Procedures`**
...
<a id="section-6-3"></a> **`6.3. Signaling of Pseudowire Status`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. Use of Label Mapping Messages`**
...
<a id="section-6-3-2"></a> **`6.3.2. Signaling PW Status`**
...
<a id="section-6-3-3"></a> **`6.3.3. Pseudowire Status Negotiation Procedures`**
...
<a id="section-6-4"></a> **`6.4. Interface Parameter Sub-TLV`**
...
<a id="section-6-5"></a> **`6.5. LDP Label Withdrawal Procedures`**
...
<a id="section-7"></a> **`7. Control Word`**

```text

```

<a id="section-7-1"></a> **`7.1. PW Types for Which the Control Word Is REQUIRED`**
...
<a id="section-7-2"></a> **`7.2. PW Types for Which the Control Word Is NOT Mandatory`**
...
<a id="section-7-3"></a> **`7.3. Control-Word Renegotiation by Label Request Message`**
...
<a id="section-7-4"></a> **`7.4. Sequencing Considerations`**
...
<a id="section-7-4-1"></a> **`7.4.1. Label Advertisements`**
...
<a id="section-7-4-2"></a> **`7.4.2. Label Release`**
...
<a id="section-8-1"></a> **`8.1. LDP TLV TYPE`**
...
<a id="section-8-2"></a> **`8.2. LDP Status Codes`**
...
<a id="section-8-3"></a> **`8.3. FEC Type Name Space`**
...
<a id="section-9-1"></a> **`9.1. Data-Plane Security`**
...
<a id="section-9-2"></a> **`9.2. Control-Plane Security`**
...
<a id="section-10"></a> **`10. Interoperability and Deployment`**
