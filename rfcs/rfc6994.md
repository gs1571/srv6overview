...
`   `[`3`](#section-3)`. TCP Experimental Option Structure`

`      `[`3.1`](#section-3-1)`. Selecting an ExID`

`      `[`3.2`](#section-3-2)`. Impact on TCP Option Processing`

`   `[`4`](#section-4)`. Reducing the Impact of False Positives`

`   `[`5`](#section-5)`. Migration to Assigned Options`

`   `[`6`](#section-6)`. Rationale`
...
<a id="section-3"></a> **`3. TCP Experimental Option Structure`**
...
<a id="section-3-1"></a> **`3.1. Selecting an ExID`**
...
<a id="section-3-2"></a> **`3.2. Impact on TCP Option Processing`**
...
<a id="section-4"></a> **`4. Reducing the Impact of False Positives`**
...
<a id="section-5"></a> **`5. Migration to Assigned Options`**
