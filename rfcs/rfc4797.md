...
`   `[`4`](#section-4)`. Specification`

`     `[`4.1`](#section-4-1)`. MPLS-in-IP/MPLS-in-GRE Encapsulation by Ingress PE`

`     `[`4.2`](#section-4-2)`. MPLS-in-IP/MPLS-in-GRE Decapsulation by Egress PE`

`   `[`5`](#section-5)`. Implications on Packet Spoofing`
...
<a id="section-4"></a> **`4. Specification`**
...
<a id="section-4-1"></a> **`4.1. MPLS-in-IP/MPLS-in-GRE Encapsulation by Ingress PE`**
...
<a id="section-4-2"></a> **`4.2. MPLS-in-IP/MPLS-in-GRE Decapsulation by Egress PE`**
...
<a id="section-5"></a> **`5. Implications on Packet Spoofing`**
