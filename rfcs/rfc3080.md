...
`   `[`2`](#section-2)`. The BEEP Core`

`   `[`2.1`](#section-2-1)`. Roles`

`   `[`2.1.1`](#section-2-1-1)`. Exchange Styles`

`   `[`2.2`](#section-2-2)`. Messages and Frames`

`   `[`2.2.1`](#section-2-2-1)`. Frame Syntax`

`   `[`2.2.1`](#section-2-2-1)`. 1 Frame Header`

`   `[`2.2.1`](#section-2-2-1)`. 2 Frame Payload`

`   `[`2.2.1`](#section-2-2-1)`. 3 Frame Trailer`

`   `[`2.2.2`](#section-2-2-2)`. Frame Semantics`

`   `[`2.2.2`](#section-2-2-2)`. 1 Poorly-formed Messages`

`   `[`2.3`](#section-2-3)`. Channel Management`

`   `[`2.3.1`](#section-2-3-1)`. Message Semantics`

`   `[`2.3.1`](#section-2-3-1)`. 1 The Greeting Message`

`   `[`2.3.1`](#section-2-3-1)`. 2 The Start Message`

`   `[`2.3.1`](#section-2-3-1)`. 3 The Close Message`

`   `[`2.3.1`](#section-2-3-1)`. 4 The OK Message`

`   `[`2.3.1`](#section-2-3-1)`. 5 The Error Message`

`   `[`2.4`](#section-2-4)`. Session Establishment and Release`

`   `[`2.5`](#section-2-5)`. Transport Mappings`

`   `[`2.5.1`](#section-2-5-1)`. Session Management`

`   `[`2.5.2`](#section-2-5-2)`. Message Exchange`

`   `[`2.6`](#section-2-6)`. Asynchrony`

`   `[`2.6.1`](#section-2-6-1)`. Within a Single Channel`

`   `[`2.6.2`](#section-2-6-2)`. Between Different Channels`

`   `[`2.6.3`](#section-2-6-3)`. Pre-emptive Replies`

`   `[`2.6.4`](#section-2-6-4)`. Interference`

`   `[`2.7`](#section-2-7)`. Peer-to-Peer Behavior`

`   `[`3`](#section-3)`. Transport Security`

`   `[`3.1`](#section-3-1)`. The TLS Transport Security Profile`

`   `[`3.1.1`](#section-3-1-1)`. Profile Identification and Initialization`

`   `[`3.1.2`](#section-3-1-2)`. Message Syntax`

`   `[`3.1.3`](#section-3-1-3)`. Message Semantics`

`   `[`3.1.3`](#section-3-1-3)`. 1 The Ready Message`

`   `[`3.1.3`](#section-3-1-3)`. 2 The Proceed Message`

`   `[`4`](#section-4)`. User Authentication`

`   `[`4.1`](#section-4-1)`. The SASL Family of Profiles`

`   `[`4.1.1`](#section-4-1-1)`. Profile Identification and Initialization`

`   `[`4.1.2`](#section-4-1-2)`. Message Syntax`

`   `[`4.1.3`](#section-4-1-3)`. Message Semantics`

`   `[`5`](#section-5)`. Registration Templates`

`   `[`5.1`](#section-5-1)`. Profile Registration Template`

`   `[`5.2`](#section-5-2)`. Feature Registration Template`

`   `[`6`](#section-6)`. Initial Registrations`

`   `[`6.1`](#section-6-1)`. Registration: BEEP Channel Management`

`   `[`6.2`](#section-6-2)`. Registration: TLS Transport Security Profile`

`   `[`6.3`](#section-6-3)`. Registration: SASL Family of Profiles`

`   `[`6.4`](#section-6-4)`. Registration: application/beep+xml`

`   `[`7`](#section-7)`. DTDs`

`   `[`7.1`](#section-7-1)`. BEEP Channel Management DTD`

`   `[`7.2`](#section-7-2)`. TLS Transport Security Profile DTD`

`   `[`7.3`](#section-7-3)`. SASL Family of Profiles DTD`

`   `[`8`](#section-8)`. Reply Codes`
...
<a id="section-2"></a> **`2. The BEEP Core`**
...
<a id="section-3"></a> **`3. Transport Security`**
...
<a id="section-4"></a> **`4. User Authentication`**
...
<a id="section-5"></a> **`5. Registration Templates`**
...
<a id="section-6"></a> **`6. Initial Registrations`**
...
<a id="section-8"></a> **`8. Reply Codes`**
