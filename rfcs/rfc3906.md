...
<a id="section-2"></a> **`2. Enhancement to the Shortest Path First Computation`**
...
<a id="section-3"></a> **`3. Special Cases and Exceptions`**
...
<a id="section-4"></a> **`4. Metric Adjustment of IP Routes over TE-tunnels`**
...
<a id="section-4-1"></a> **`4.1. Absolute and Relative Metrics`**
...
<a id="section-4-2"></a> **`4.2. Examples of Metric Adjustment`**
