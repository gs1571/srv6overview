...
`   `[`4`](#section-4)`. SAToP Encapsulation Layer`

`      `[`4.1`](#section-4-1)`. SAToP Packet Format`

`      `[`4.2`](#section-4-2)`. PSN and PW Demultiplexing Layer Headers`

`      `[`4.3`](#section-4-3)`. SAToP Header`

`           `[`4.3.1`](#section-4-3-1)`. Usage and Structure of the Control Word`

`           `[`4.3.2`](#section-4-3-2)`. Usage of RTP Header`

`   `[`5`](#section-5)`. SAToP Payload Layer`

`      `[`5.1`](#section-5-1)`. General Payloads`

`      `[`5.2`](#section-5-2)`. Octet-Aligned T1`

`   `[`6`](#section-6)`. SAToP Operation`
...
`      `[`6.3`](#section-6-3)`. SAToP Defects`

`      `[`6.4`](#section-6-4)`. SAToP PW Performance Monitoring`

`   `[`7`](#section-7)`. Quality of Service (QoS) Issues`

`   `[`8`](#section-8)`. Congestion Control`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Applicability Statement`
...
<a id="section-4"></a> **`4. SAToP Encapsulation Layer`**

```text

```

<a id="section-4-1"></a> **`4.1. SAToP Packet Format`**
...
<a id="section-4-2"></a> **`4.2. PSN and PW Demultiplexing Layer Headers`**
...
<a id="section-4-3"></a> **`4.3. SAToP Header`**
...
<a id="section-4-3-1"></a> **`4.3.1. Usage and Structure of the Control Word`**
...
<a id="section-4-3-2"></a> **`4.3.2. Usage of RTP Header`**
...
<a id="section-5"></a> **`5. SAToP Payload Layer`**

```text

```

<a id="section-5-1"></a> **`5.1. General Payloads`**
...
<a id="section-5-2"></a> **`5.2. Octet-Aligned T1`**
...
<a id="section-6"></a> **`6. SAToP Operation`**
...
<a id="section-6-3"></a> **`6.3. SAToP Defects`**
...
<a id="section-6-4"></a> **`6.4. SAToP PW Performance Monitoring`**
...
<a id="section-7"></a> **`7. Quality of Service (QoS) Issues`**
...
<a id="section-10"></a> **`10. Applicability Statement`**
