...
`            `[`6.3.8`](#section-6-3-8)`. Updating we_sent`
...
`       `[`12`](#section-12)`. 1 RTCP Packet Types`

`       `[`12`](#section-12)`. 2 SDES Types`
...
`   Appendix A.3  Determining Number of Packets Expected and Lost`
...
<a id="section-2"></a> **`2. RTP Use Scenarios`**
...
<a id="section-4"></a> **`4. Byte Order, Alignment, and Time Format`**
...
<a id="section-5"></a> **`5. RTP Data Transfer Protocol`**
...
<a id="section-6"></a> **`6. RTP Control Protocol -- RTCP`**
...
<a id="section-7"></a> **`7. RTP Translators and Mixers`**
...
<a id="section-8"></a> **`8. SSRC Identifier Allocation and Use`**
...
<a id="section-11"></a> **`11. RTP over Network and Transport Protocols`**
...
<a id="section-12"></a> **`12. Summary of Protocol Constants`**
...
<a id="section-13"></a> **`13. RTP Profiles and Payload Format Specifications`**
...
<a id="section-16"></a> **`16. Intellectual Property Rights Statement`**
