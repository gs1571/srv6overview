...
`   `[`2`](#section-2)`. Design Rationale`

`   `[`3`](#section-3)`. Conventions and Terminology`

`      `[`3.1`](#section-3-1)`. Numbers and Fields`

`      `[`3.2`](#section-3-2)`. Parts of a Connection`

`      `[`3.3`](#section-3-3)`. Features`

`      `[`3.4`](#section-3-4)`. Round-Trip Times`

`      `[`3.5`](#section-3-5)`. Security Limitation`

`      `[`3.6`](#section-3-6)`. Robustness Principle`

`   `[`4`](#section-4)`. Overview`

`      `[`4.1`](#section-4-1)`. Packet Types`

`      `[`4.2`](#section-4-2)`. Packet Sequencing`

`      `[`4.3`](#section-4-3)`. States`

`      `[`4.4`](#section-4-4)`. Congestion Control Mechanisms`

`      `[`4.5`](#section-4-5)`. Feature Negotiation Options`

`      `[`4.6`](#section-4-6)`. Differences from TCP`

`      `[`4.7`](#section-4-7)`. Example Connection`

`   `[`5`](#section-5)`. Packet Formats`

`      `[`5.1`](#section-5-1)`. Generic Header`

`      `[`5.2`](#section-5-2)`. DCCP-Request Packets`

`      `[`5.3`](#section-5-3)`. DCCP-Response Packets`

`      `[`5.4`](#section-5-4)`. DCCP-Data, DCCP-Ack, and DCCP-DataAck Packets`

`      `[`5.5`](#section-5-5)`. DCCP-CloseReq and DCCP-Close Packets`

`      `[`5.6`](#section-5-6)`. DCCP-Reset Packets`

`      `[`5.7`](#section-5-7)`. DCCP-Sync and DCCP-SyncAck Packets`

`      `[`5.8`](#section-5-8)`. Options`

`           `[`5.8.1`](#section-5-8-1)`. Padding Option`

`           `[`5.8.2`](#section-5-8-2)`. Mandatory Option`

`   `[`6`](#section-6)`. Feature Negotiation`

`      `[`6.1`](#section-6-1)`. Change Options`

`      `[`6.2`](#section-6-2)`. Confirm Options`

`      `[`6.3`](#section-6-3)`. Reconciliation Rules`

`           `[`6.3.1`](#section-6-3-1)`. Server-Priority`

`           `[`6.3.2`](#section-6-3-2)`. Non-Negotiable`

`      `[`6.4`](#section-6-4)`. Feature Numbers`

`      `[`6.5`](#section-6-5)`. Feature Negotiation Examples`

`      `[`6.6`](#section-6-6)`. Option Exchange`

`           `[`6.6.1`](#section-6-6-1)`. Normal Exchange`

`           `[`6.6.2`](#section-6-6-2)`. Processing Received Options`

`           `[`6.6.3`](#section-6-6-3)`. Loss and Retransmission`

`           `[`6.6.4`](#section-6-6-4)`. Reordering`

`           `[`6.6.5`](#section-6-6-5)`. Preference Changes`

`           `[`6.6.6`](#section-6-6-6)`. Simultaneous Negotiation`

`           `[`6.6.7`](#section-6-6-7)`. Unknown Features`

`           `[`6.6.8`](#section-6-6-8)`. Invalid Options`

`           `[`6.6.9`](#section-6-6-9)`. Mandatory Feature Negotiation`

`   `[`7`](#section-7)`. Sequence Numbers`

`      `[`7.1`](#section-7-1)`. Variables`

`      `[`7.2`](#section-7-2)`. Initial Sequence Numbers`

`      `[`7.3`](#section-7-3)`. Quiet Time`

`      `[`7.4`](#section-7-4)`. Acknowledgement Numbers`

`      `[`7.5`](#section-7-5)`. Validity and Synchronization`

`           `[`7.5.1`](#section-7-5-1)`. Sequence and Acknowledgement Number Windows`

`           `[`7.5.2`](#section-7-5-2)`. Sequence Window Feature`

`           `[`7.5.3`](#section-7-5-3)`. Sequence-Validity Rules`

`           `[`7.5.4`](#section-7-5-4)`. Handling Sequence-Invalid Packets`

`           `[`7.5.5`](#section-7-5-5)`. Sequence Number Attacks`

`           `[`7.5.6`](#section-7-5-6)`. Sequence Number Handling Examples`

`      `[`7.6`](#section-7-6)`. Short Sequence Numbers`

`           `[`7.6.1`](#section-7-6-1)`. Allow Short Sequence Numbers Feature`

`           `[`7.6.2`](#section-7-6-2)`. When to Avoid Short Sequence Numbers`

`      `[`7.7`](#section-7-7)`. NDP Count and Detecting Application Loss`

`           `[`7.7.1`](#section-7-7-1)`. NDP Count Usage Notes`

`           `[`7.7.2`](#section-7-7-2)`. Send NDP Count Feature`

`   `[`8`](#section-8)`. Event Processing`

`      `[`8.1`](#section-8-1)`. Connection Establishment`

`           `[`8.1.1`](#section-8-1-1)`. Client Request`

`           `[`8.1.2`](#section-8-1-2)`. Service Codes`

`           `[`8.1.3`](#section-8-1-3)`. Server Response`

`           `[`8.1.4`](#section-8-1-4)`. Init Cookie Option`

`           `[`8.1.5`](#section-8-1-5)`. Handshake Completion`

`      `[`8.2`](#section-8-2)`. Data Transfer`

`      `[`8.3`](#section-8-3)`. Termination`

`           `[`8.3.1`](#section-8-3-1)`. Abnormal Termination`

`      `[`8.4`](#section-8-4)`. DCCP State Diagram`

`      `[`8.5`](#section-8-5)`. Pseudocode`

`   `[`9`](#section-9)`. Checksums`

`      `[`9.1`](#section-9-1)`. Header Checksum Field`

`      `[`9.2`](#section-9-2)`. Header Checksum Coverage Field`

`           `[`9.2.1`](#section-9-2-1)`. Minimum Checksum Coverage Feature`

`      `[`9.3`](#section-9-3)`. Data Checksum Option`

`           `[`9.3.1`](#section-9-3-1)`. Check Data Checksum Feature`

`           `[`9.3.2`](#section-9-3-2)`. Checksum Usage Notes`

`   `[`10`](#section-10)`. Congestion Control`

`      `[`10.1`](#section-10-1)`. TCP-like Congestion Control`

`      `[`10.2`](#section-10-2)`. TFRC Congestion Control`

`      `[`10.3`](#section-10-3)`. CCID-Specific Options, Features, and Reset Codes`

`      `[`10.4`](#section-10-4)`. CCID Profile Requirements`

`      `[`10.5`](#section-10-5)`. Congestion State`

`   `[`11`](#section-11)`. Acknowledgements`

`      `[`11.1`](#section-11-1)`. Acks of Acks and Unidirectional Connections`

`      `[`11.2`](#section-11-2)`. Ack Piggybacking`

`      `[`11.3`](#section-11-3)`. Ack Ratio Feature`

`      `[`11.4`](#section-11-4)`. Ack Vector Options`

`           `[`11.4.1`](#section-11-4-1)`. Ack Vector Consistency`

`           `[`11.4.2`](#section-11-4-2)`. Ack Vector Coverage`

`      `[`11.5`](#section-11-5)`. Send Ack Vector Feature`

`      `[`11.6`](#section-11-6)`. Slow Receiver Option`

`      `[`11.7`](#section-11-7)`. Data Dropped Option`

`           `[`11.7.1`](#section-11-7-1)`. Data Dropped and Normal Congestion Response`

`           `[`11.7.2`](#section-11-7-2)`. Particular Drop Codes`

`   `[`12`](#section-12)`. Explicit Congestion Notification`

`      `[`12.1`](#section-12-1)`. ECN Incapable Feature`

`      `[`12.2`](#section-12-2)`. ECN Nonces`

`      `[`12.3`](#section-12-3)`. Aggression Penalties`

`   `[`13`](#section-13)`. Timing Options`

`      `[`13.1`](#section-13-1)`. Timestamp Option`

`      `[`13.2`](#section-13-2)`. Elapsed Time Option`

`      `[`13.3`](#section-13-3)`. Timestamp Echo Option`

`   `[`14`](#section-14)`. Maximum Packet Size`

`      `[`14.1`](#section-14-1)`. Measuring PMTU`

`      `[`14.2`](#section-14-2)`. Sender Behavior`

`   `[`15`](#section-15)`. Forward Compatibility`

`   `[`16`](#section-16)`. Middlebox Considerations`

`   `[`17`](#section-17)`. Relations to Other Specifications`

`      `[`17.1`](#section-17-1)`. RTP`

`      `[`17.2`](#section-17-2)`. Congestion Manager and Multiplexing`

`   `[`18`](#section-18)`. Security Considerations`

`      `[`18.1`](#section-18-1)`. Security Considerations for Partial Checksums`

`   `[`19`](#section-19)`. IANA Considerations`

`      `[`19.1`](#section-19-1)`. Packet Types Registry`

`      `[`19.2`](#section-19-2)`. Reset Codes Registry`

`      `[`19.3`](#section-19-3)`. Option Types Registry`

`      `[`19.4`](#section-19-4)`. Feature Numbers Registry`

`      `[`19.5`](#section-19-5)`. Congestion Control Identifiers Registry`

`      `[`19.6`](#section-19-6)`. Ack Vector States Registry`

`      `[`19.7`](#section-19-7)`. Drop Codes Registry`

`      `[`19.8`](#section-19-8)`. Service Codes Registry`

`      `[`19.9`](#section-19-9)`. Port Numbers Registry`

`   `[`20`](#section-20)`. Thanks`
...
<a id="section-2"></a> **`2. Design Rationale`**
...
<a id="section-3"></a> **`3. Conventions and Terminology`**
...
<a id="section-3-1"></a> **`3.1. Numbers and Fields`**
...
<a id="section-3-2"></a> **`3.2. Parts of a Connection`**
...
<a id="section-3-3"></a> **`3.3. Features`**
...
<a id="section-3-4"></a> **`3.4. Round-Trip Times`**
...
<a id="section-3-5"></a> **`3.5. Security Limitation`**
...
<a id="section-3-6"></a> **`3.6. Robustness Principle`**
...
<a id="section-4-1"></a> **`4.1. Packet Types`**
...
<a id="section-4-2"></a> **`4.2. Packet Sequencing`**
...
<a id="section-4-4"></a> **`4.4. Congestion Control Mechanisms`**
...
<a id="section-4-5"></a> **`4.5. Feature Negotiation Options`**
...
<a id="section-4-6"></a> **`4.6. Differences from TCP`**
...
<a id="section-4-7"></a> **`4.7. Example Connection`**
...
<a id="section-5"></a> **`5. Packet Formats`**
...
<a id="section-5-1"></a> **`5.1. Generic Header`**
...
<a id="section-5-2"></a> **`5.2. DCCP-Request Packets`**
...
<a id="section-5-3"></a> **`5.3. DCCP-Response Packets`**
...
<a id="section-5-4"></a> **`5.4. DCCP-Data, DCCP-Ack, and DCCP-DataAck Packets`**
...
<a id="section-5-5"></a> **`5.5. DCCP-CloseReq and DCCP-Close Packets`**
...
<a id="section-5-6"></a> **`5.6. DCCP-Reset Packets`**
...
<a id="section-5-7"></a> **`5.7. DCCP-Sync and DCCP-SyncAck Packets`**
...
<a id="section-5-8"></a> **`5.8. Options`**
...
<a id="section-5-8-1"></a> **`5.8.1. Padding Option`**
...
<a id="section-5-8-2"></a> **`5.8.2. Mandatory Option`**
...
<a id="section-6"></a> **`6. Feature Negotiation`**
...
<a id="section-6-1"></a> **`6.1. Change Options`**
...
<a id="section-6-2"></a> **`6.2. Confirm Options`**
...
<a id="section-6-3"></a> **`6.3. Reconciliation Rules`**
...
<a id="section-6-3-1"></a> **`6.3.1. Server-Priority`**
...
<a id="section-6-3-2"></a> **`6.3.2. Non-Negotiable`**
...
<a id="section-6-4"></a> **`6.4. Feature Numbers`**
...
<a id="section-6-5"></a> **`6.5. Feature Negotiation Examples`**
...
<a id="section-6-6"></a> **`6.6. Option Exchange`**
...
<a id="section-6-6-1"></a> **`6.6.1. Normal Exchange`**
...
<a id="section-6-6-2"></a> **`6.6.2. Processing Received Options`**
...
<a id="section-6-6-3"></a> **`6.6.3. Loss and Retransmission`**
...
<a id="section-6-6-4"></a> **`6.6.4. Reordering`**
...
<a id="section-6-6-5"></a> **`6.6.5. Preference Changes`**
...
<a id="section-6-6-6"></a> **`6.6.6. Simultaneous Negotiation`**
...
<a id="section-6-6-7"></a> **`6.6.7. Unknown Features`**
...
<a id="section-6-6-8"></a> **`6.6.8. Invalid Options`**
...
<a id="section-6-6-9"></a> **`6.6.9. Mandatory Feature Negotiation`**
...
<a id="section-7"></a> **`7. Sequence Numbers`**
...
<a id="section-7-1"></a> **`7.1. Variables`**
...
<a id="section-7-2"></a> **`7.2. Initial Sequence Numbers`**
...
<a id="section-7-3"></a> **`7.3. Quiet Time`**
...
<a id="section-7-4"></a> **`7.4. Acknowledgement Numbers`**
...
<a id="section-7-5"></a> **`7.5. Validity and Synchronization`**
...
<a id="section-7-5-1"></a> **`7.5.1. Sequence and Acknowledgement Number Windows`**
...
<a id="section-7-5-2"></a> **`7.5.2. Sequence Window Feature`**
...
<a id="section-7-5-3"></a> **`7.5.3. Sequence-Validity Rules`**
...
<a id="section-7-5-4"></a> **`7.5.4. Handling Sequence-Invalid Packets`**
...
<a id="section-7-5-5"></a> **`7.5.5. Sequence Number Attacks`**
...
<a id="section-7-5-6"></a> **`7.5.6. Sequence Number Handling Examples`**
...
<a id="section-7-6"></a> **`7.6. Short Sequence Numbers`**
...
<a id="section-7-6-1"></a> **`7.6.1. Allow Short Sequence Numbers Feature`**
...
<a id="section-7-6-2"></a> **`7.6.2. When to Avoid Short Sequence Numbers`**
...
<a id="section-7-7"></a> **`7.7. NDP Count and Detecting Application Loss`**
...
<a id="section-7-7-1"></a> **`7.7.1. NDP Count Usage Notes`**
...
<a id="section-7-7-2"></a> **`7.7.2. Send NDP Count Feature`**
...
<a id="section-8"></a> **`8. Event Processing`**
...
<a id="section-8-1"></a> **`8.1. Connection Establishment`**
...
<a id="section-8-1-1"></a> **`8.1.1. Client Request`**
...
<a id="section-8-1-2"></a> **`8.1.2. Service Codes`**
...
<a id="section-8-1-3"></a> **`8.1.3. Server Response`**
...
<a id="section-8-1-4"></a> **`8.1.4. Init Cookie Option`**
...
<a id="section-8-1-5"></a> **`8.1.5. Handshake Completion`**
...
<a id="section-8-2"></a> **`8.2. Data Transfer`**
...
<a id="section-8-3"></a> **`8.3. Termination`**
...
<a id="section-8-3-1"></a> **`8.3.1. Abnormal Termination`**
...
<a id="section-8-4"></a> **`8.4. DCCP State Diagram`**
...
<a id="section-8-5"></a> **`8.5. Pseudocode`**
...
<a id="section-9-1"></a> **`9.1. Header Checksum Field`**
...
<a id="section-9-2"></a> **`9.2. Header Checksum Coverage Field`**
...
<a id="section-9-2-1"></a> **`9.2.1. Minimum Checksum Coverage Feature`**
...
<a id="section-9-3"></a> **`9.3. Data Checksum Option`**
...
<a id="section-9-3-1"></a> **`9.3.1. Check Data Checksum Feature`**
...
<a id="section-9-3-2"></a> **`9.3.2. Checksum Usage Notes`**
...
<a id="section-10"></a> **`10. Congestion Control`**
...
<a id="section-10-1"></a> **`10.1. TCP-like Congestion Control`**
...
<a id="section-10-2"></a> **`10.2. TFRC Congestion Control`**
...
<a id="section-10-3"></a> **`10.3. CCID-Specific Options, Features, and Reset Codes`**
...
<a id="section-10-4"></a> **`10.4. CCID Profile Requirements`**
...
<a id="section-10-5"></a> **`10.5. Congestion State`**
...
<a id="section-11-1"></a> **`11.1. Acks of Acks and Unidirectional Connections`**
...
<a id="section-11-2"></a> **`11.2. Ack Piggybacking`**
...
<a id="section-11-3"></a> **`11.3. Ack Ratio Feature`**
...
<a id="section-11-4"></a> **`11.4. Ack Vector Options`**
...
<a id="section-11-4-1"></a> **`11.4.1. Ack Vector Consistency`**
...
<a id="section-11-4-2"></a> **`11.4.2. Ack Vector Coverage`**
...
<a id="section-11-5"></a> **`11.5. Send Ack Vector Feature`**
...
<a id="section-11-6"></a> **`11.6. Slow Receiver Option`**
...
<a id="section-11-7"></a> **`11.7. Data Dropped Option`**
...
<a id="section-11-7-1"></a> **`11.7.1. Data Dropped and Normal Congestion Response`**
...
<a id="section-11-7-2"></a> **`11.7.2. Particular Drop Codes`**
...
<a id="section-12"></a> **`12. Explicit Congestion Notification`**
...
<a id="section-12-1"></a> **`12.1. ECN Incapable Feature`**
...
<a id="section-12-2"></a> **`12.2. ECN Nonces`**
...
<a id="section-12-3"></a> **`12.3. Aggression Penalties`**
...
<a id="section-13"></a> **`13. Timing Options`**
...
<a id="section-13-1"></a> **`13.1. Timestamp Option`**
...
<a id="section-13-2"></a> **`13.2. Elapsed Time Option`**
...
<a id="section-13-3"></a> **`13.3. Timestamp Echo Option`**
...
<a id="section-14"></a> **`14. Maximum Packet Size`**
...
<a id="section-14-1"></a> **`14.1. Measuring PMTU`**
...
<a id="section-14-2"></a> **`14.2. Sender Behavior`**
...
<a id="section-15"></a> **`15. Forward Compatibility`**
...
<a id="section-16"></a> **`16. Middlebox Considerations`**
...
<a id="section-17"></a> **`17. Relations to Other Specifications`**

```text

```

<a id="section-17-1"></a> **`17.1. RTP`**
...
<a id="section-17-2"></a> **`17.2. Congestion Manager and Multiplexing`**
...
<a id="section-18"></a> **`18. Security Considerations`**
...
<a id="section-18-1"></a> **`18.1. Security Considerations for Partial Checksums`**
...
<a id="section-19"></a> **`19. IANA Considerations`**
...
<a id="section-19-1"></a> **`19.1. Packet Types Registry`**
...
<a id="section-19-2"></a> **`19.2. Reset Codes Registry`**
...
<a id="section-19-3"></a> **`19.3. Option Types Registry`**
...
<a id="section-19-4"></a> **`19.4. Feature Numbers Registry`**
...
<a id="section-19-5"></a> **`19.5. Congestion Control Identifiers Registry`**
...
<a id="section-19-6"></a> **`19.6. Ack Vector States Registry`**
...
<a id="section-19-7"></a> **`19.7. Drop Codes Registry`**
...
<a id="section-19-8"></a> **`19.8. Service Codes Registry`**
...
<a id="section-19-9"></a> **`19.9. Port Numbers Registry`**
