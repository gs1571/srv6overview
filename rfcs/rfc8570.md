...
`   `[`2`](#section-2)`. TE Metric Extensions to IS-IS`

`   `[`3`](#section-3)`. Interface and Neighbor Addresses`
...
<a id="section-2"></a> **`2. TE Metric Extensions to IS-IS`**
...
<a id="section-3"></a> **`3. Interface and Neighbor Addresses`**
