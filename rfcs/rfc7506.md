...
`   `[`3`](#section-3)`. IPv6 RAO Value for MPLS OAM`

`   `[`4`](#section-4)`. Updates to RFC 4379`
...
<a id="section-3"></a> **`3. IPv6 RAO Value for MPLS OAM`**
...
<a id="section-4"></a> **`4. Updates to RFC 4379`**
