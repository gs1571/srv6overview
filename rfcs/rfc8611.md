...
`     `[`1.3`](#section-1-3)`. Requirements Language`

`   `[`2`](#section-2)`. Overview of Solution`

`   `[`3`](#section-3)`. LSR Capability Discovery`

`     `[`3.1`](#section-3-1)`. Initiator LSR Procedures`

`     `[`3.2`](#section-3-2)`. Responder LSR Procedures`

`   `[`4`](#section-4)`. Mechanism to Discover L2 ECMP`

`     `[`4.1`](#section-4-1)`. Initiator LSR Procedures`

`     `[`4.2`](#section-4-2)`. Responder LSR Procedures`

`     `[`4.3`](#section-4-3)`. Additional Initiator LSR Procedures`

`   `[`5`](#section-5)`. Mechanism to Validate L2 ECMP Traversal`

`     `[`5.1`](#section-5-1)`. Incoming LAG Member Links Verification`

`       `[`5.1.1`](#section-5-1-1)`. Initiator LSR Procedures`

`       `[`5.1.2`](#section-5-1-2)`. Responder LSR Procedures`

`       `[`5.1.3`](#section-5-1-3)`. Additional Initiator LSR Procedures`

`     `[`5.2`](#section-5-2)`. Individual End-to-End Path Verification`

`   `[`6`](#section-6)`. LSR Capability TLV`

`   `[`7`](#section-7)`. LAG Description Indicator Flag: G`

`   `[`8`](#section-8)`. Local Interface Index Sub-TLV`

`   `[`9`](#section-9)`. Remote Interface Index Sub-TLV`

`   `[`10`](#section-10)`. Detailed Interface and Label Stack TLV`

`     `[`10.1`](#section-10-1)`. Sub-TLVs`

`       `[`10.1.1`](#section-10-1-1)`. Incoming Label Stack Sub-TLV`

`       `[`10.1.2`](#section-10-1-2)`. Incoming Interface Index Sub-TLV`

`   `[`11`](#section-11)`. Rate-Limiting on Echo Request/Reply Messages`

`   `[`12`](#section-12)`. Security Considerations`

`   `[`13`](#section-13)`. IANA Considerations`

`     `[`13.1`](#section-13-1)`. LSR Capability TLV`

`       `[`13.1.1`](#section-13-1-1)`. LSR Capability Flags`

`     `[`13.2`](#section-13-2)`. Local Interface Index Sub-TLV`

`       `[`13.2.1`](#section-13-2-1)`. Interface Index Flags`

`     `[`13.3`](#section-13-3)`. Remote Interface Index Sub-TLV`

`     `[`13.4`](#section-13-4)`. Detailed Interface and Label Stack TLV`

`       `[`13.4.1`](#section-13-4-1)`. Sub-TLVs for TLV Type 6`

`       `[`13.4.2`](#section-13-4-2)`. Interface and Label Stack Address Types`

`     `[`13.5`](#section-13-5)`. DS Flags`
...
<a id="section-1-3"></a> **`1.3. Requirements Language`**
...
<a id="section-3"></a> **`3. LSR Capability Discovery`**
...
<a id="section-3-1"></a> **`3.1. Initiator LSR Procedures`**
...
<a id="section-3-2"></a> **`3.2. Responder LSR Procedures`**
...
<a id="section-4"></a> **`4. Mechanism to Discover L2 ECMP`**

```text

```

<a id="section-4-1"></a> **`4.1. Initiator LSR Procedures`**
...
<a id="section-4-2"></a> **`4.2. Responder LSR Procedures`**
...
<a id="section-4-3"></a> **`4.3. Additional Initiator LSR Procedures`**
...
<a id="section-5"></a> **`5. Mechanism to Validate L2 ECMP Traversal`**
...
<a id="section-5-1"></a> **`5.1. Incoming LAG Member Links Verification`**
...
<a id="section-5-1-1"></a> **`5.1.1. Initiator LSR Procedures`**
...
<a id="section-5-1-2"></a> **`5.1.2. Responder LSR Procedures`**
...
<a id="section-5-1-3"></a> **`5.1.3. Additional Initiator LSR Procedures`**
...
<a id="section-5-2"></a> **`5.2. Individual End-to-End Path Verification`**
...
<a id="section-6"></a> **`6. LSR Capability TLV`**
...
<a id="section-7"></a> **`7. LAG Description Indicator Flag: G`**
...
<a id="section-8"></a> **`8. Local Interface Index Sub-TLV`**
...
<a id="section-9"></a> **`9. Remote Interface Index Sub-TLV`**
...
<a id="section-10"></a> **`10. Detailed Interface and Label Stack TLV`**
...
<a id="section-10-1"></a> **`10.1. Sub-TLVs`**
...
<a id="section-10-1-1"></a> **`10.1.1. Incoming Label Stack Sub-TLV`**
...
<a id="section-10-1-2"></a> **`10.1.2. Incoming Interface Index Sub-TLV`**
...
<a id="section-11"></a> **`11. Rate-Limiting on Echo Request/Reply Messages`**
...
<a id="section-13-1"></a> **`13.1. LSR Capability TLV`**
...
<a id="section-13-1-1"></a> **`13.1.1. LSR Capability Flags`**
...
<a id="section-13-2"></a> **`13.2. Local Interface Index Sub-TLV`**
...
<a id="section-13-2-1"></a> **`13.2.1. Interface Index Flags`**
...
<a id="section-13-3"></a> **`13.3. Remote Interface Index Sub-TLV`**
...
<a id="section-13-4"></a> **`13.4. Detailed Interface and Label Stack TLV`**
...
<a id="section-13-4-1"></a> **`13.4.1. Sub-TLVs for TLV Type 6`**
...
<a id="section-13-4-2"></a> **`13.4.2. Interface and Label Stack Address Types`**
...
<a id="section-13-5"></a> **`13.5. DS Flags`**
