...
`   `[`2`](#section-2)`. MPLS over L2TPv3 Encoding`

`   `[`3`](#section-3)`. Assigning the L2TPv3 Session ID and Cookie`

`   `[`4`](#section-4)`. Applicability`

`   `[`5`](#section-5)`. Congestion Considerations`

`   `[`6`](#section-6)`. Security Considerations`

`      `[`6.1`](#section-6-1)`. In the Absence of IPsec`

`      `[`6.2`](#section-6-2)`. Context Validation`

`      `[`6.3`](#section-6-3)`. Securing the Tunnel with IPsec`
...
<a id="section-2"></a> **`2. MPLS over L2TPv3 Encoding`**
...
<a id="section-3"></a> **`3. Assigning the L2TPv3 Session ID and Cookie`**
...
<a id="section-4"></a> **`4. Applicability`**
...
<a id="section-6-1"></a> **`6.1. In the Absence of IPsec`**
...
<a id="section-6-2"></a> **`6.2. Context Validation`**
...
<a id="section-6-3"></a> **`6.3. Securing the Tunnel with IPsec`**
