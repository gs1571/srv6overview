...
`   `[`4`](#section-4)`. Current Intra-Area Uses of MPLS Traffic Engineering`

`      `[`4.1`](#section-4-1)`. Intra-Area MPLS Traffic Engineering Architecture`

`      `[`4.2`](#section-4-2)`. Intra-Area MPLS Traffic Engineering Applications`

`           `[`4.2.1`](#section-4-2-1)`. Intra-Area Resource Optimization`

`           `[`4.2.2`](#section-4-2-2)`. Intra-Area QoS Guarantees`

`           `[`4.2.3`](#section-4-2-3)`. Fast Recovery within an IGP Area`

`      `[`4.3`](#section-4-3)`. Intra-Area MPLS TE and Routing`

`   `[`5`](#section-5)`. Problem Statement, Requirements, and Objectives of Inter-Area`

`      `[`5.1`](#section-5-1)`. Inter-Area Traffic Engineering Problem Statement`

`      `[`5.2`](#section-5-2)`. Overview of Requirements for Inter-Area MPLS TE`

`      `[`5.3`](#section-5-3)`. Key Objectives for an Inter-Area MPLS-TE Solution`

`           `[`5.3.1`](#section-5-3-1)`. Preserving the IGP Hierarchy Concept`

`           `[`5.3.2`](#section-5-3-2)`. Preserving Scalability`

`   `[`6`](#section-6)`. Application Scenario`

`   `[`7`](#section-7)`. Detailed Requirements for Inter-Area MPLS TE`

`      `[`7.1`](#section-7-1)`. Inter-Area MPLS TE Operations and Interoperability`

`      `[`7.2`](#section-7-2)`. Inter-Area TE-LSP Signaling`

`      `[`7.3`](#section-7-3)`. Path Optimality`

`      `[`7.4`](#section-7-4)`. Inter-Area MPLS-TE Routing`

`      `[`7.5`](#section-7-5)`. Inter-Area MPLS-TE Path Computation`

`      `[`7.6`](#section-7-6)`. Inter-Area Crankback Routing`

`      `[`7.7`](#section-7-7)`. Support of Diversely-Routed Inter-Area TE LSPs`

`      `[`7.8`](#section-7-8)`. Intra/Inter-Area Path Selection Policy`

`      `[`7.9`](#section-7-9)`. Reoptimization of Inter-Area TE LSP`

`      `[`7.10`](#section-7-10)`. Inter-Area LSP Recovery`

`            `[`7.10.1`](#section-7-10-1)`. Rerouting of Inter-Area TE LSPs`

`            `[`7.10.2`](#section-7-10-2)`. Fast Recovery of Inter-Area TE LSP`

`      `[`7.11`](#section-7-11)`. DS-TE support`

`      `[`7.12`](#section-7-12)`. Hierarchical LSP Support`

`      `[`7.13`](#section-7-13)`. Hard/Soft Preemption`

`      `[`7.14`](#section-7-14)`. Auto-Discovery of TE Meshes`

`      `[`7.15`](#section-7-15)`. Inter-Area MPLS TE Fault Management Requirements`

`      `[`7.16`](#section-7-16)`. Inter-Area MPLS TE and Routing`

`   `[`8`](#section-8)`. Evaluation criteria`

`      `[`8.1`](#section-8-1)`. Performances`

`      `[`8.2`](#section-8-2)`. Complexity and Risks`

`      `[`8.3`](#section-8-3)`. Backward Compatibility`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Acknowledgements`

`   `[`11`](#section-11)`. Contributing Authors`
...
<a id="section-4"></a> **`4. Current Intra-Area Uses of MPLS Traffic Engineering`**
...
<a id="section-4-1"></a> **`4.1. Intra-Area MPLS Traffic Engineering Architecture`**
...
<a id="section-4-2"></a> **`4.2. Intra-Area MPLS Traffic Engineering Applications`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Intra-Area Resource Optimization`**
...
<a id="section-4-2-2"></a> **`4.2.2. Intra-Area QoS Guarantees`**
...
<a id="section-4-2-3"></a> **`4.2.3. Fast Recovery within an IGP Area`**
...
<a id="section-4-3"></a> **`4.3. Intra-Area MPLS TE and Routing`**
...
<a id="section-5"></a> **`5. Problem Statement, Requirements, and Objectives of Inter-Area`**
...
<a id="section-5-1"></a> **`5.1. Inter-Area Traffic Engineering Problem Statement`**
...
<a id="section-5-2"></a> **`5.2. Overview of Requirements for Inter-Area MPLS TE`**
...
<a id="section-5-3"></a> **`5.3. Key Objectives for an Inter-Area MPLS-TE Solution`**
...
<a id="section-5-3-1"></a> **`5.3.1. Preserving the IGP Hierarchy Concept`**
...
<a id="section-5-3-2"></a> **`5.3.2. Preserving Scalability`**
...
<a id="section-6"></a> **`6. Application Scenario`**
...
<a id="section-7"></a> **`7. Detailed Requirements for Inter-Area MPLS TE`**

```text

```

<a id="section-7-1"></a> **`7.1. Inter-Area MPLS TE Operations and Interoperability`**
...
<a id="section-7-2"></a> **`7.2. Inter-Area TE-LSP Signaling`**
...
<a id="section-7-3"></a> **`7.3. Path Optimality`**
...
<a id="section-7-4"></a> **`7.4. Inter-Area MPLS-TE Routing`**
...
<a id="section-7-5"></a> **`7.5. Inter-Area MPLS-TE Path Computation`**
...
<a id="section-7-6"></a> **`7.6. Inter-Area Crankback Routing`**
...
<a id="section-7-7"></a> **`7.7. Support of Diversely-Routed Inter-Area TE LSPs`**
...
<a id="section-7-8"></a> **`7.8. Intra/Inter-Area Path Selection Policy`**
...
<a id="section-7-9"></a> **`7.9. Reoptimization of Inter-Area TE LSP`**
...
<a id="section-7-10"></a> **`7.10. Inter-Area LSP Recovery`**

```text

```

<a id="section-7-10-1"></a> **`7.10.1. Rerouting of Inter-Area TE LSPs`**
...
<a id="section-7-10-2"></a> **`7.10.2. Fast Recovery of Inter-Area TE LSP`**
...
<a id="section-7-11"></a> **`7.11. DS-TE support`**
...
<a id="section-7-12"></a> **`7.12. Hierarchical LSP Support`**
...
<a id="section-7-13"></a> **`7.13. Hard/Soft Preemption`**
...
<a id="section-7-14"></a> **`7.14. Auto-Discovery of TE Meshes`**
...
<a id="section-7-15"></a> **`7.15. Inter-Area MPLS TE Fault Management Requirements`**
...
<a id="section-7-16"></a> **`7.16. Inter-Area MPLS TE and Routing`**
...
<a id="section-8"></a> **`8. Evaluation criteria`**

```text

```

<a id="section-8-1"></a> **`8.1. Performances`**
...
<a id="section-8-2"></a> **`8.2. Complexity and Risks`**
...
<a id="section-8-3"></a> **`8.3. Backward Compatibility`**
...
<a id="section-11"></a> **`11. Contributing Authors`**
