...
`   `[`2`](#section-2)`. Signaling Overview`

`      `[`2.1`](#section-2-1)`. Signaling Options`

`   `[`3`](#section-3)`. Procedures on the Domain Border Node`

`      `[`3.1`](#section-3-1)`. Rules on ERO Processing`

`      `[`3.2`](#section-3-2)`. LSP Setup Failure and Crankback`

`      `[`3.3`](#section-3-3)`. RRO Processing across Domains`

`      `[`3.4`](#section-3-4)`. Notify Message Processing`

`   `[`4`](#section-4)`. RSVP-TE Signaling Extensions`

`      `[`4.1`](#section-4-1)`. Control of Downstream Choice of Signaling Method`

`   `[`5`](#section-5)`. Protection and Recovery of Inter-Domain TE LSPs`

`      `[`5.1`](#section-5-1)`. Fast Recovery Support Using MPLS-TE Fast Reroute (FRR)`

`           `[`5.1.1`](#section-5-1-1)`. Failure within a Domain (Link or Node Failure)`

`           `[`5.1.2`](#section-5-1-2)`. Failure of Link at Domain Border`

`           `[`5.1.3`](#section-5-1-3)`. Failure of a Border Node`

`      `[`5.2`](#section-5-2)`. Protection and Recovery of GMPLS LSPs`

`   `[`6`](#section-6)`. Reoptimization of Inter-Domain TE LSPs`

`   `[`7`](#section-7)`. Backward Compatibility`

`   `[`8`](#section-8)`. Security Considerations`

`   `[`9`](#section-9)`. IANA Considerations`

`      `[`9.1`](#section-9-1)`. Attribute Flags for LSP_Attributes Object`

`      `[`9.2`](#section-9-2)`. New Error Codes`
...
<a id="section-2"></a> **`2. Signaling Overview`**
...
<a id="section-2-1"></a> **`2.1. Signaling Options`**
...
<a id="section-3"></a> **`3. Procedures on the Domain Border Node`**
...
<a id="section-3-1"></a> **`3.1. Rules on ERO Processing`**
...
<a id="section-3-2"></a> **`3.2. LSP Setup Failure and Crankback`**
...
<a id="section-3-3"></a> **`3.3. RRO Processing across Domains`**
...
<a id="section-3-4"></a> **`3.4. Notify Message Processing`**
...
<a id="section-4"></a> **`4. RSVP-TE Signaling Extensions`**
...
<a id="section-4-1"></a> **`4.1. Control of Choice of Signaling Method`**
...
<a id="section-5"></a> **`5. Protection and Recovery of Inter-Domain TE LSPs`**
...
<a id="section-5-1"></a> **`5.1. Fast Recovery Support Using MPLS-TE Fast Reroute (FRR)`**
...
<a id="section-5-1-1"></a> **`5.1.1. Failure within a Domain (Link or Node Failure)`**
...
<a id="section-5-1-2"></a> **`5.1.2. Failure of a Link at a Domain Border`**
...
<a id="section-5-1-3"></a> **`5.1.3. Failure of a Border Node`**
...
<a id="section-5-2"></a> **`5.2. Protection and Recovery of GMPLS LSPs`**
...
<a id="section-6"></a> **`6. Reoptimization of Inter-Domain TE LSPs`**
...
<a id="section-7"></a> **`7. Backward Compatibility`**
...
<a id="section-9-1"></a> **`9.1. Attribute Flags for LSP_Attributes Object`**
...
<a id="section-9-2"></a> **`9.2. New Error Codes`**
