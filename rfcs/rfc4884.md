...
`   `[`3`](#section-3)`. Summary of Changes to ICMP`

`   `[`4`](#section-4)`. ICMP Extensibility`

`      `[`4.1`](#section-4-1)`. ICMPv4 Destination Unreachable`

`      `[`4.2`](#section-4-2)`. ICMPv4 Time Exceeded`

`      `[`4.3`](#section-4-3)`. ICMPv4 Parameter Problem`

`      `[`4.4`](#section-4-4)`. ICMPv6 Destination Unreachable`

`      `[`4.5`](#section-4-5)`. ICMPv6 Time Exceeded`

`      `[`4.6`](#section-4-6)`. ICMP Messages That Can Be Extended`

`   `[`5`](#section-5)`. Backwards Compatibility`

`      `[`5.1`](#section-5-1)`. Classic Application Receives ICMP Message with`

`           Extensions`

`      `[`5.2`](#section-5-2)`. Non-Compliant Application Receives ICMP Message`

`           with No Extensions`

`      `[`5.3`](#section-5-3)`. Non-Compliant Application Receives ICMP Message`

`           with Compliant Extensions`

`      `[`5.4`](#section-5-4)`. Compliant Application Receives ICMP Message with`

`           No Extensions`

`      `[`5.5`](#section-5-5)`. Compliant Application Receives ICMP Message with`

`           Non-Compliant Extensions`

`   `[`6`](#section-6)`. Interaction with Network Address Translation`

`   `[`7`](#section-7)`. The ICMP Extension Structure`

`   `[`8`](#section-8)`. ICMP Extension Objects`
...
<a id="section-3"></a> **`3. Summary of Changes to ICMP`**
...
<a id="section-4"></a> **`4. ICMP Extensibility`**
...
<a id="section-4-1"></a> **`4.1. ICMPv4 Destination Unreachable`**
...
<a id="section-4-2"></a> **`4.2. ICMPv4 Time Exceeded`**
...
<a id="section-4-3"></a> **`4.3. ICMPv4 Parameter Problem`**
...
<a id="section-4-4"></a> **`4.4. ICMPv6 Destination Unreachable`**
...
<a id="section-4-5"></a> **`4.5. ICMPv6 Time Exceeded`**
...
<a id="section-4-6"></a> **`4.6. ICMP Messages That Can Be Extended`**
...
<a id="section-5"></a> **`5. Backwards Compatibility`**
...
<a id="section-5-1"></a> **`5.1. Classic Application Receives ICMP Message with Extensions`**
...
<a id="section-5-2"></a> **`5.2. Non-Compliant Application Receives ICMP Message with No Extensions`**
...
<a id="section-5-3"></a> **`5.3. Non-Compliant Application Receives ICMP Message with Compliant`**
...
<a id="section-5-4"></a> **`5.4. Compliant Application Receives ICMP Message with No Extensions`**
...
<a id="section-5-5"></a> **`5.5. Compliant Application Receives ICMP Message with Non-Compliant`**
...
<a id="section-6"></a> **`6. Interaction with Network Address Translation`**
...
<a id="section-7"></a> **`7. The ICMP Extension Structure`**
...
<a id="section-8"></a> **`8. ICMP Extension Objects`**
