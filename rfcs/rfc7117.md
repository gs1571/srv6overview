...
`      `[`2.1`](#section-2-1)`. Specification of Requirements`

`   `[`3`](#section-3)`. Overview`

`      `[`3.1`](#section-3-1)`. Inclusive and Selective Multicast Trees`

`      `[`3.2`](#section-3-2)`. BGP-Based VPLS Membership Auto-discovery`

`      `[`3.3`](#section-3-3)`. IP Multicast Group Membership Discovery`

`      `[`3.4`](#section-3-4)`. Advertising P-Multicast Tree to VPLS/C-Multicast Binding`

`      `[`3.5`](#section-3-5)`. Aggregation`

`      `[`3.6`](#section-3-6)`. Inter-AS VPLS Multicast`

`   `[`4`](#section-4)`. Intra-AS Inclusive P-Multicast Tree Auto-discovery/Binding`

`      `[`4.1`](#section-4-1)`. Originating Intra-AS VPLS A-D Routes`

`      `[`4.2`](#section-4-2)`. Receiving Intra-AS VPLS A-D Routes`

`   `[`5`](#section-5)`. Demultiplexing P-Multicast Tree Traffic`

`      `[`5.1`](#section-5-1)`. One P-Multicast Tree - One VPLS Mapping`

`      `[`5.2`](#section-5-2)`. One P-Multicast Tree - Many VPLS Mapping`

`   `[`6`](#section-6)`. Establishing P-Multicast Trees`

`      `[`6.1`](#section-6-1)`. Common Procedures`

`      `[`6.2`](#section-6-2)`. RSVP-TE P2MP LSPs`

`           `[`6.2.1`](#section-6-2-1)`. P2MP TE LSP - VPLS Mapping`

`      `[`6.3`](#section-6-3)`. Receiver-Initiated P2MP LSP`

`           `[`6.3.1`](#section-6-3-1)`. P2MP LSP - VPLS Mapping`

`      `[`6.4`](#section-6-4)`. Encapsulation of Aggregate P-Multicast Trees`

`   `[`7`](#section-7)`. Inter-AS Inclusive P-Multicast Tree A-D/Binding`

`      `[`7.1`](#section-7-1)`. VSIs on the ASBRs`

`           `[`7.1.1`](#section-7-1-1)`. Option (a): VSIs on the ASBRs`

`           `[`7.1.2`](#section-7-1-2)`. Option (e): VSIs on the ASBRs`

`      `[`7.2`](#section-7-2)`. Option (b) - Segmented Inter-AS Trees`

`           `[`7.2.1`](#section-7-2-1)`. Segmented Inter-AS Trees VPLS Inter-AS`

`                  A-D/Binding`

`           `[`7.2.2`](#section-7-2-2)`. Propagating BGP VPLS A-D Routes to Other`

`                  ASes: Overview`

`                  `[`7.2.2.1`](#section-7-2-2-1)`. Propagating Intra-AS VPLS A-D`

`                           Routes in EBGP`

`                  `[`7.2.2.2`](#section-7-2-2-2)`. Inter-AS A-D Route Received via EBGP`

`                  `[`7.2.2.3`](#section-7-2-2-3)`. Leaf A-D Route Received via EBGP`

`                  `[`7.2.2.4`](#section-7-2-2-4)`. Inter-AS A-D Route Received via IBGP`

`      `[`7.3`](#section-7-3)`. Option (c): Non-segmented Tunnels`

`   `[`8`](#section-8)`. Optimizing Multicast Distribution via Selective Trees`

`      `[`8.1`](#section-8-1)`. Protocol for Switching to Selective Trees`

`      `[`8.2`](#section-8-2)`. Advertising (C-S, C-G) Binding to a Selective Tree`

`      `[`8.3`](#section-8-3)`. Receiving S-PMSI A-D Routes by PEs`

`      `[`8.4`](#section-8-4)`. Inter-AS Selective Tree`

`           `[`8.4.1`](#section-8-4-1)`. VSIs on the ASBRs`

`                  `[`8.4.1.1`](#section-8-4-1-1)`. VPLS Inter-AS Selective Tree A-D Binding`

`           `[`8.4.2`](#section-8-4-2)`. Inter-AS Segmented Selective Trees`

`                  `[`8.4.2.1`](#section-8-4-2-1)`. Handling S-PMSI A-D Routes by ASBRs`

`                           `[`8.4.2.1.1`](#section-8-4-2-1-1)`. Merging Selective Tree`

`                                      into an Inclusive Tree`

`           `[`8.4.3`](#section-8-4-3)`. Inter-AS Non-segmented Selective Trees`

`   `[`9`](#section-9)`. BGP Extensions`

`      `[`9.1`](#section-9-1)`. Inclusive Tree/Selective Tree Identifier`

`      `[`9.2`](#section-9-2)`. MCAST-VPLS NLRI`

`           `[`9.2.1`](#section-9-2-1)`. S-PMSI A-D Route`

`           `[`9.2.2`](#section-9-2-2)`. Leaf A-D Route`

`   `[`10`](#section-10)`. Aggregation Considerations`

`   `[`11`](#section-11)`. Data Forwarding`

`      `[`11.1`](#section-11-1)`. MPLS Tree Encapsulation`

`           `[`11.1.1`](#section-11-1-1)`. Mapping Multiple VPLS Instances to a P2MP LSP`

`           `[`11.1.2`](#section-11-1-2)`. Mapping One VPLS Instance to a P2MP LSP`

`   `[`12`](#section-12)`. VPLS Data Packet Treatment`
...
<a id="section-2-1"></a> **`2.1. Specification of Requirements`**
...
<a id="section-3-1"></a> **`3.1. Inclusive and Selective Multicast Trees`**
...
<a id="section-3-2"></a> **`3.2. BGP-Based VPLS Membership Auto-discovery`**
...
<a id="section-3-3"></a> **`3.3. IP Multicast Group Membership Discovery`**
...
<a id="section-3-4"></a> **`3.4. Advertising P-Multicast Tree to VPLS/C-Multicast Binding`**
...
<a id="section-3-5"></a> **`3.5. Aggregation`**
...
<a id="section-3-6"></a> **`3.6. Inter-AS VPLS Multicast`**
...
<a id="section-4"></a> **`4. Intra-AS Inclusive P-Multicast Tree Auto-discovery/Binding`**
...
<a id="section-4-1"></a> **`4.1. Originating Intra-AS VPLS A-D Routes`**
...
<a id="section-4-2"></a> **`4.2. Receiving Intra-AS VPLS A-D Routes`**
...
<a id="section-5"></a> **`5. Demultiplexing P-Multicast Tree Traffic`**
...
<a id="section-5-1"></a> **`5.1. One P-Multicast Tree - One VPLS Mapping`**
...
<a id="section-5-2"></a> **`5.2. One P-Multicast Tree - Many VPLS Mapping`**
...
<a id="section-6"></a> **`6. Establishing P-Multicast Trees`**
...
<a id="section-6-1"></a> **`6.1. Common Procedures`**
...
<a id="section-6-2"></a> **`6.2. RSVP-TE P2MP LSPs`**
...
<a id="section-6-2-1"></a> **`6.2.1. P2MP TE LSP - VPLS Mapping`**
...
<a id="section-6-3"></a> **`6.3. Receiver-Initiated P2MP LSP`**
...
<a id="section-6-3-1"></a> **`6.3.1. P2MP LSP - VPLS Mapping`**
...
<a id="section-6-4"></a> **`6.4. Encapsulation of Aggregate P-multicast Trees`**
...
<a id="section-7"></a> **`7. Inter-AS Inclusive P-Multicast Tree A-D/Binding`**
...
<a id="section-7-1"></a> **`7.1. VSIs on the ASBRs`**
...
<a id="section-7-1-1"></a> **`7.1.1. Option (a): VSIs on the ASBRs`**
...
<a id="section-7-1-2"></a> **`7.1.2. Option (e): VSIs on the ASBRs`**
...
<a id="section-7-2"></a> **`7.2. Option (b) - Segmented Inter-AS Trees`**
...
<a id="section-7-2-1"></a> **`7.2.1. Segmented Inter-AS Trees VPLS Inter-AS A-D/Binding`**
...
<a id="section-7-2-2"></a> **`7.2.2. Propagating BGP VPLS A-D Routes to Other ASes: Overview`**
...
<a id="section-7-2-2-1"></a> **`7.2.2.1. Propagating Intra-AS VPLS A-D Routes in EBGP`**
...
<a id="section-7-2-2-2"></a> **`7.2.2.2. Inter-AS A-D Route Received via EBGP`**
...
<a id="section-7-2-2-3"></a> **`7.2.2.3. Leaf A-D Route Received via EBGP`**
...
<a id="section-7-2-2-4"></a> **`7.2.2.4. Inter-AS A-D Route Received via IBGP`**
...
<a id="section-7-3"></a> **`7.3. Option (c): Non-segmented Tunnels`**
...
<a id="section-8"></a> **`8. Optimizing Multicast Distribution via Selective Trees`**
...
<a id="section-8-1"></a> **`8.1. Protocol for Switching to Selective Trees`**
...
<a id="section-8-2"></a> **`8.2. Advertising (C-S, C-G) Binding to a Selective Tree`**
...
<a id="section-8-3"></a> **`8.3. Receiving S-PMSI A-D Routes by PEs`**
...
<a id="section-8-4"></a> **`8.4. Inter-AS Selective Tree`**
...
<a id="section-8-4-1"></a> **`8.4.1. VSIs on the ASBRs`**
...
<a id="section-8-4-1-1"></a> **`8.4.1.1. VPLS Inter-AS Selective Tree A-D Binding`**
...
<a id="section-8-4-2"></a> **`8.4.2. Inter-AS Segmented Selective Trees`**
...
<a id="section-8-4-2-1"></a> **`8.4.2.1. Handling S-PMSI A-D Routes by ASBRs`**
...
<a id="section-8-4-2-1-1"></a> **`8.4.2.1.1. Merging Selective Tree into an Inclusive Tree`**
...
<a id="section-8-4-3"></a> **`8.4.3. Inter-AS Non-segmented Selective Trees`**
...
<a id="section-9"></a> **`9. BGP Extensions`**
...
<a id="section-9-1"></a> **`9.1. Inclusive Tree/Selective Tree Identifier`**
...
<a id="section-9-2"></a> **`9.2. MCAST-VPLS NLRI`**
...
<a id="section-9-2-1"></a> **`9.2.1. S-PMSI A-D Route`**
...
<a id="section-9-2-2"></a> **`9.2.2. Leaf A-D Route`**
...
<a id="section-10"></a> **`10. Aggregation Considerations`**
...
<a id="section-11"></a> **`11. Data Forwarding`**

```text

```

<a id="section-11-1"></a> **`11.1. MPLS Tree Encapsulation`**

```text

```

<a id="section-11-1-1"></a> **`11.1.1. Mapping Multiple VPLS Instances to a P2MP LSP`**
...
<a id="section-11-1-2"></a> **`11.1.2. Mapping One VPLS Instance to a P2MP LSP`**
...
<a id="section-12"></a> **`12. VPLS Data Packet Treatment`**
