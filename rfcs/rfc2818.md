...
`   `[`2`](#section-2)`. HTTP Over TLS`

`   `[`2.1`](#section-2-1)`. Connection Initiation`

`   `[`2.2`](#section-2-2)`. Connection Closure`

`   `[`2.2.1`](#section-2-2-1)`. Client Behavior`

`   `[`2.2.2`](#section-2-2-2)`. Server Behavior`

`   `[`2.3`](#section-2-3)`. Port Number`

`   `[`2.4`](#section-2-4)`. URI Format`

`   `[`3`](#section-3)`. Endpoint Identification`

`   `[`3.1`](#section-3-1)`. Server Identity`

`   `[`3.2`](#section-3-2)`. Client Identity`
...
<a id="section-2"></a> **`2. HTTP Over TLS`**
...
<a id="section-2-1"></a> **`2.1. Connection Initiation`**
...
<a id="section-2-2"></a> **`2.2. Connection Closure`**
...
<a id="section-2-2-1"></a> **`2.2.1. Client Behavior`**
...
<a id="section-2-2-2"></a> **`2.2.2. Server Behavior`**
...
<a id="section-2-3"></a> **`2.3. Port Number`**
...
<a id="section-2-4"></a> **`2.4. URI Format`**
...
<a id="section-3"></a> **`3. Endpoint Identification`**

```text

```

<a id="section-3-1"></a> **`3.1. Server Identity`**
...
<a id="section-3-2"></a> **`3.2. Client Identity`**
