...
`      `[`1.2`](#section-1-2)`. ECMP in Label Switching Routers`

`      `[`1.3`](#section-1-3)`. Flow Label`

`   `[`2`](#section-2)`. Native Service Processing Function`

`   `[`3`](#section-3)`. Pseudowire Forwarder`

`      `[`3.1`](#section-3-1)`. Encapsulation`

`   `[`4`](#section-4)`. Signalling the Presence of the Flow Label`

`      `[`4.1`](#section-4-1)`. Structure of Flow Label Sub-TLV`

`   `[`5`](#section-5)`. Static Pseudowires`

`   `[`6`](#section-6)`. Multi-Segment Pseudowires`

`   `[`7`](#section-7)`. Operations, Administration, and Maintenance (OAM)`

`   `[`8`](#section-8)`. Applicability of PWs Using Flow Labels`

`      `[`8.1`](#section-8-1)`. Equal Cost Multiple Paths`

`      `[`8.2`](#section-8-2)`. Link Aggregation Groups`

`      `[`8.3`](#section-8-3)`. Multiple RSVP-TE Paths`

`      `[`8.4`](#section-8-4)`. The Single Large Flow Case`

`      `[`8.5`](#section-8-5)`. Applicability to MPLS-TP`

`      `[`8.6`](#section-8-6)`. Asymmetric Operation`

`   `[`9`](#section-9)`. Applicability to MPLS LSPs`
...
<a id="section-1-2"></a> **`1.2. ECMP in Label Switching Routers`**
...
<a id="section-1-3"></a> **`1.3. Flow Label`**
...
<a id="section-2"></a> **`2. Native Service Processing Function`**
...
<a id="section-3"></a> **`3. Pseudowire Forwarder`**
...
<a id="section-3-1"></a> **`3.1. Encapsulation`**
...
<a id="section-4"></a> **`4. Signalling the Presence of the Flow Label`**
...
<a id="section-4-1"></a> **`4.1. Structure of Flow Label Sub-TLV`**
...
<a id="section-5"></a> **`5. Static Pseudowires`**
...
<a id="section-6"></a> **`6. Multi-Segment Pseudowires`**
...
<a id="section-7"></a> **`7. Operations, Administration, and Maintenance (OAM)`**
...
<a id="section-8"></a> **`8. Applicability of PWs Using Flow Labels`**
...
<a id="section-8-1"></a> **`8.1. Equal Cost Multiple Paths`**
...
<a id="section-8-2"></a> **`8.2. Link Aggregation Groups`**
...
<a id="section-8-3"></a> **`8.3. Multiple RSVP-TE Paths`**
...
<a id="section-8-4"></a> **`8.4. The Single Large Flow Case`**
...
<a id="section-8-5"></a> **`8.5. Applicability to MPLS-TP`**
...
<a id="section-8-6"></a> **`8.6. Asymmetric Operation`**
...
<a id="section-9"></a> **`9. Applicability to MPLS LSPs`**
