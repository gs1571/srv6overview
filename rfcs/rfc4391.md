...
`   `[`2`](#section-2)`. IP over UD Mode`

`   `[`3`](#section-3)`. InfiniBand Datalink`

`   `[`4`](#section-4)`. Multicast Mapping`

`      `[`4.1`](#section-4-1)`. Broadcast-GID Parameters`

`   `[`5`](#section-5)`. Setting Up an IPoIB Link`

`   `[`6`](#section-6)`. Frame Format`

`   `[`7`](#section-7)`. Maximum Transmission Unit`

`   `[`8`](#section-8)`. IPv6 Stateless Autoconfiguration`

`      `[`8.1`](#section-8-1)`. IPv6 Link-Local Address`

`   `[`9`](#section-9)`. Address Mapping - Unicast`

`      `[`9.1`](#section-9-1)`. Link Information`

`           `[`9.1.1`](#section-9-1-1)`. Link-Layer Address/Hardware Address`

`           `[`9.1.2`](#section-9-1-2)`. Auxiliary Link Information`

`      `[`9.2`](#section-9-2)`. Address Resolution in IPv4 Subnets`

`      `[`9.3`](#section-9-3)`. Address Resolution in IPv6 Subnets`

`      `[`9.4`](#section-9-4)`. Cautionary Note on QPN Caching`

`   `[`10`](#section-10)`. Sending and Receiving IP Multicast Packets`

`   `[`11`](#section-11)`. IP Multicast Routing`

`   `[`12`](#section-12)`. New Types of Vulnerability in IB Multicast`
...
<a id="section-2"></a> **`2. IP over UD Mode`**
...
<a id="section-3"></a> **`3. InfiniBand Datalink`**
...
<a id="section-4"></a> **`4. Multicast Mapping`**
...
```text
   ...
   +--------+----+----+----------------+---------+----------+---------+
   |11111111|0001|scop|0100000000011011|< P_Key >|00.......0||
   +--------+----+----+----------------+---------+----------+---------+
...
<a id="section-4-1"></a> **`4.1. Broadcast-GID Parameters`**
...
<a id="section-5"></a> **`5. Setting Up an IPoIB Link`**
...
<a id="section-6"></a> **`6. Frame Format`**
...
<a id="section-7"></a> **`7. Maximum Transmission Unit`**
...
<a id="section-8"></a> **`8. IPv6 Stateless Autoconfiguration`**
...
<a id="section-8-1"></a> **`8.1. IPv6 Link-Local Address`**
...
<a id="section-9"></a> **`9. Address Mapping - Unicast`**
...
<a id="section-9-1"></a> **`9.1. Link Information`**
...
<a id="section-9-1-1"></a> **`9.1.1. Link-Layer Address/Hardware Address`**
...
<a id="section-9-1-2"></a> **`9.1.2. Auxiliary Link Information`**
...
<a id="section-9-2"></a> **`9.2. Address Resolution in IPv4 Subnets`**
...
<a id="section-9-3"></a> **`9.3. Address Resolution in IPv6 Subnets`**
...
<a id="section-9-4"></a> **`9.4. Cautionary Note on QPN Caching`**
...
<a id="section-10"></a> **`10. Sending and Receiving IP Multicast Packets`**
...
<a id="section-11"></a> **`11. IP Multicast Routing`**
...
<a id="section-12"></a> **`12. New Types of Vulnerability in IB Multicast`**
