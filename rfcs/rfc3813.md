...
`   `[`3`](#section-3)`. The SNMP Management Framework`

`   `[`4`](#section-4)`. Outline`

`       `[`4.1`](#section-4-1)`. Summary of LSR MIB Module`

`   `[`5`](#section-5)`. Brief Description of MIB Module Objects`

`       `[`5.1`](#section-5-1)`. mplsInterfaceTable`

`       `[`5.2`](#section-5-2)`. mplsInterfacePerfTable`

`       `[`5.3`](#section-5-3)`. mplsInSegmentTable`

`       `[`5.4`](#section-5-4)`. mplsInSegmentPerfTable`

`       `[`5.5`](#section-5-5)`. mplsOutSegmentTable`

`       `[`5.6`](#section-5-6)`. mplsOutSegmentPerfTable`

`       `[`5.7`](#section-5-7)`. mplsXCTable`

`       `[`5.8`](#section-5-8)`. mplsLabelStackTable`

`       `[`5.9`](#section-5-9)`. mplsInSegmentMapTable`

`   `[`6`](#section-6)`. Use of 32-bit and 64-bit Counters`

`   `[`7`](#section-7)`. Example of LSP Setup`

`   `[`8`](#section-8)`. Application of the Interface Group to MPLS`

`       `[`8.1`](#section-8-1)`. Support of the MPLS Layer by ifTable`

`   `[`9`](#section-9)`. The Use of RowPointer`

`   `[`10`](#section-10)`. MPLS Label Switching Router MIB Module Definitions`
...
`       `[`13.1`](#section-13-1)`. IANA Considerations for MPLS-LSR-STD-MIB`
...
<a id="section-3"></a> **`3. The SNMP Management Framework`**
...
<a id="section-4-1"></a> **`4.1. Summary of LSR MIB Module`**
...
<a id="section-5"></a> **`5. Brief Description of MIB Module Objects`**
...
<a id="section-5-1"></a> **`5.1. mplsInterfaceTable`**
...
<a id="section-5-2"></a> **`5.2. mplsInterfacePerfTable`**
...
<a id="section-5-3"></a> **`5.3. mplsInSegmentTable`**
...
<a id="section-5-4"></a> **`5.4. mplsInSegmentPerfTable`**
...
<a id="section-5-5"></a> **`5.5. mplsOutSegmentTable`**
...
<a id="section-5-6"></a> **`5.6. mplsOutSegmentPerfTable`**
...
<a id="section-5-7"></a> **`5.7. mplsXCTable`**
...
<a id="section-5-8"></a> **`5.8. mplsLabelStackTable`**
...
<a id="section-6"></a> **`6. Use of 32-bit and 64-bit Counters`**
...
<a id="section-7"></a> **`7. Example of LSP Setup`**
...
<a id="section-8"></a> **`8. Application of the Interface Group to MPLS`**
...
<a id="section-8-1"></a> **`8.1. Support of the MPLS Layer by ifTable`**
...
<a id="section-9"></a> **`9. The Use of RowPointer`**
...
<a id="section-10"></a> **`10. MPLS Label Switching Router MIB Module Definitions`**
...
<a id="section-13-1"></a> **`13.1. IANA Considerations for MPLS-LSR-STD-MIB`**
