...
`      `[`2.1`](#section-2-1)`. Requirements`

`   `[`3`](#section-3)`. DESIGN GOALS`

`   `[`4`](#section-4)`. PROTOCOL OVERVIEW`

`      `[`4.1`](#section-4-1)`. Site Renumbering`

`   `[`5`](#section-5)`. PROTOCOL SPECIFICATION`

`      `[`5.1`](#section-5-1)`. Node Configuration Variables`

`      `[`5.2`](#section-5-2)`. Autoconfiguration-Related Variables`

`      `[`5.3`](#section-5-3)`. Creation of Link-Local Addresses`

`      `[`5.4`](#section-5-4)`. Duplicate Address Detection`

`         `[`5.4.1`](#section-5-4-1)`. Message Validation`

`         `[`5.4.2`](#section-5-4-2)`. Sending Neighbor Solicitation Messages`

`         `[`5.4.3`](#section-5-4-3)`. Receiving Neighbor Solicitation Messages`

`         `[`5.4.4`](#section-5-4-4)`. Receiving Neighbor Advertisement Messages`

`         `[`5.4.5`](#section-5-4-5)`. When Duplicate Address Detection Fails`

`      `[`5.5`](#section-5-5)`. Creation of Global and Site-Local Addresses`

`         `[`5.5.1`](#section-5-5-1)`. Soliciting Router Advertisements`

`         `[`5.5.2`](#section-5-5-2)`. Absence of Router Advertisements`

`         `[`5.5.3`](#section-5-5-3)`. Router Advertisement Processing`

`         `[`5.5.4`](#section-5-5-4)`. Address Lifetime Expiry`

`      `[`5.6`](#section-5-6)`. Configuration Consistency`

`   `[`6`](#section-6)`. SECURITY CONSIDERATIONS`

`   `[`7`](#section-7)`. References`

`   `[`8`](#section-8)`. Acknowledgements and Authors' Addresses`

`   `[`9`](#section-9)`. APPENDIX A: LOOPBACK SUPPRESSION & DUPLICATE ADDRESS`

`         DETECTION`

`   `[`10`](#section-10)`. APPENDIX B: CHANGES SINCE RFC 1971`
...
<a id="section-2-1"></a> **`2.1. Requirements`**
...
<a id="section-3"></a> **`3. DESIGN GOALS`**
...
<a id="section-4"></a> **`4. PROTOCOL OVERVIEW`**
...
<a id="section-4-1"></a> **`4.1. Site Renumbering`**
...
<a id="section-5"></a> **`5. PROTOCOL SPECIFICATION`**
...
<a id="section-5-1"></a> **`5.1. Node Configuration Variables`**
...
<a id="section-5-2"></a> **`5.2. Autoconfiguration-Related Variables`**
...
<a id="section-5-3"></a> **`5.3. Creation of Link-Local Addresses`**
...
<a id="section-5-4"></a> **`5.4. Duplicate Address Detection`**
...
<a id="section-5-4-1"></a> **`5.4.1. Message Validation`**
...
<a id="section-5-4-2"></a> **`5.4.2. Sending Neighbor Solicitation Messages`**
...
<a id="section-5-4-3"></a> **`5.4.3. Receiving Neighbor Solicitation Messages`**
...
<a id="section-5-4-4"></a> **`5.4.4. Receiving Neighbor Advertisement Messages`**
...
<a id="section-5-4-5"></a> **`5.4.5. When Duplicate Address Detection Fails`**
...
<a id="section-5-5"></a> **`5.5. Creation of Global and Site-Local Addresses`**
...
<a id="section-5-5-1"></a> **`5.5.1. Soliciting Router Advertisements`**
...
<a id="section-5-5-2"></a> **`5.5.2. Absence of Router Advertisements`**
...
<a id="section-5-5-3"></a> **`5.5.3. Router Advertisement Processing`**
...
<a id="section-5-5-4"></a> **`5.5.4. Address Lifetime Expiry`**
...
<a id="section-5-6"></a> **`5.6. Configuration Consistency`**
...
<a id="section-9"></a> **`9. APPENDIX A: LOOPBACK SUPPRESSION & DUPLICATE ADDRESS DETECTION`**
...
<a id="section-10"></a> **`10. APPENDIX B: CHANGES SINCE RFC 1971`**
