...
`   `[`4`](#section-4)`. Basic Overview`

`      `[`4.1`](#section-4-1)`. Packet Flow Sequence`

`   `[`5`](#section-5)`. LISP Encapsulation Details`

`      `[`5.1`](#section-5-1)`. LISP IPv4-in-IPv4 Header Format`

`      `[`5.2`](#section-5-2)`. LISP IPv6-in-IPv6 Header Format`

`      `[`5.3`](#section-5-3)`. Tunnel Header Field Descriptions`

`      `[`5.4`](#section-5-4)`. Dealing with Large Encapsulated Packets`

`           `[`5.4.1`](#section-5-4-1)`. A Stateless Solution to MTU Handling`

`           `[`5.4.2`](#section-5-4-2)`. A Stateful Solution to MTU Handling`

`      `[`5.5`](#section-5-5)`. Using Virtualization and Segmentation with LISP`

`   `[`6`](#section-6)`. EID-to-RLOC Mapping`

`      `[`6.1`](#section-6-1)`. LISP IPv4 and IPv6 Control-Plane Packet Formats`

`           `[`6.1.1`](#section-6-1-1)`. LISP Packet Type Allocations`

`           `[`6.1.2`](#section-6-1-2)`. Map-Request Message Format`

`           `[`6.1.3`](#section-6-1-3)`. EID-to-RLOC UDP Map-Request Message`

`           `[`6.1.4`](#section-6-1-4)`. Map-Reply Message Format`

`           `[`6.1.5`](#section-6-1-5)`. EID-to-RLOC UDP Map-Reply Message`

`           `[`6.1.6`](#section-6-1-6)`. Map-Register Message Format`

`           `[`6.1.7`](#section-6-1-7)`. Map-Notify Message Format`

`           `[`6.1.8`](#section-6-1-8)`. Encapsulated Control Message Format`

`      `[`6.2`](#section-6-2)`. Routing Locator Selection`

`      `[`6.3`](#section-6-3)`. Routing Locator Reachability`

`           `[`6.3.1`](#section-6-3-1)`. Echo Nonce Algorithm`

`           `[`6.3.2`](#section-6-3-2)`. RLOC-Probing Algorithm`

`      `[`6.4`](#section-6-4)`. EID Reachability within a LISP Site`

`      `[`6.5`](#section-6-5)`. Routing Locator Hashing`

`      `[`6.6`](#section-6-6)`. Changing the Contents of EID-to-RLOC Mappings`

`           `[`6.6.1`](#section-6-6-1)`. Clock Sweep`

`           `[`6.6.2`](#section-6-6-2)`. Solicit-Map-Request (SMR)`

`           `[`6.6.3`](#section-6-6-3)`. Database Map-Versioning`

`   `[`7`](#section-7)`. Router Performance Considerations`

`   `[`8`](#section-8)`. Deployment Scenarios`

`      `[`8.1`](#section-8-1)`. First-Hop/Last-Hop Tunnel Routers`

`      `[`8.2`](#section-8-2)`. Border/Edge Tunnel Routers`

`      `[`8.3`](#section-8-3)`. ISP Provider Edge (PE) Tunnel Routers`

`      `[`8.4`](#section-8-4)`. LISP Functionality with Conventional NATs`

`      `[`8.5`](#section-8-5)`. Packets Egressing a LISP Site`

`   `[`9`](#section-9)`. Traceroute Considerations`

`      `[`9.1`](#section-9-1)`. IPv6 Traceroute`

`      `[`9.2`](#section-9-2)`. IPv4 Traceroute`

`      `[`9.3`](#section-9-3)`. Traceroute Using Mixed Locators`

`   `[`10`](#section-10)`. Mobility Considerations`

`      `[`10.1`](#section-10-1)`. Site Mobility`

`      `[`10.2`](#section-10-2)`. Slow Endpoint Mobility`

`      `[`10.3`](#section-10-3)`. Fast Endpoint Mobility`

`      `[`10.4`](#section-10-4)`. Fast Network Mobility`

`      `[`10.5`](#section-10-5)`. LISP Mobile Node Mobility`

`   `[`11`](#section-11)`. Multicast Considerations`

`   `[`12`](#section-12)`. Security Considerations`

`   `[`13`](#section-13)`. Network Management Considerations`

`   `[`14`](#section-14)`. IANA Considerations`

`      `[`14.1`](#section-14-1)`. LISP ACT and Flag Fields`

`      `[`14.2`](#section-14-2)`. LISP Address Type Codes`

`      `[`14.3`](#section-14-3)`. LISP UDP Port Numbers`

`      `[`14.4`](#section-14-4)`. LISP Key ID Numbers`

`   `[`15`](#section-15)`. Known Open Issues and Areas of Future Work`
...
<a id="section-2"></a> **`2. Requirements Notation`**
...
<a id="section-3"></a> **`3. Definition of Terms`**
...
<a id="section-4"></a> **`4. Basic Overview`**
...
<a id="section-4-1"></a> **`4.1. Packet Flow Sequence`**
...
<a id="section-5"></a> **`5. LISP Encapsulation Details`**
...
<a id="section-5-1"></a> **`5.1. LISP IPv4-in-IPv4 Header Format`**
...
<a id="section-5-2"></a> **`5.2. LISP IPv6-in-IPv6 Header Format`**
...
<a id="section-5-3"></a> **`5.3. Tunnel Header Field Descriptions`**
...
<a id="section-5-4"></a> **`5.4. Dealing with Large Encapsulated Packets`**
...
<a id="section-5-4-1"></a> **`5.4.1. A Stateless Solution to MTU Handling`**
...
<a id="section-5-4-2"></a> **`5.4.2. A Stateful Solution to MTU Handling`**
...
<a id="section-5-5"></a> **`5.5. Using Virtualization and Segmentation with LISP`**
...
<a id="section-6"></a> **`6. EID-to-RLOC Mapping`**

```text

```

<a id="section-6-1"></a> **`6.1. LISP IPv4 and IPv6 Control-Plane Packet Formats`**
...
<a id="section-6-1-1"></a> **`6.1.1. LISP Packet Type Allocations`**
...
<a id="section-6-1-2"></a> **`6.1.2. Map-Request Message Format`**
...
<a id="section-6-1-3"></a> **`6.1.3. EID-to-RLOC UDP Map-Request Message`**
...
<a id="section-6-1-4"></a> **`6.1.4. Map-Reply Message Format`**
...
<a id="section-6-1-5"></a> **`6.1.5. EID-to-RLOC UDP Map-Reply Message`**
...
<a id="section-6-1-5-1"></a> **`6.1.5.1. Traffic Redirection with Coarse EID-Prefixes`**
...
<a id="section-6-1-6"></a> **`6.1.6. Map-Register Message Format`**
...
<a id="section-6-1-7"></a> **`6.1.7. Map-Notify Message Format`**
...
<a id="section-6-1-8"></a> **`6.1.8. Encapsulated Control Message Format`**
...
<a id="section-6-2"></a> **`6.2. Routing Locator Selection`**
...
<a id="section-6-3"></a> **`6.3. Routing Locator Reachability`**
...
<a id="section-6-3-1"></a> **`6.3.1. Echo Nonce Algorithm`**
...
<a id="section-6-3-2"></a> **`6.3.2. RLOC-Probing Algorithm`**
...
<a id="section-6-4"></a> **`6.4. EID Reachability within a LISP Site`**
...
<a id="section-6-5"></a> **`6.5. Routing Locator Hashing`**
...
<a id="section-6-6"></a> **`6.6. Changing the Contents of EID-to-RLOC Mappings`**
...
<a id="section-6-6-1"></a> **`6.6.1. Clock Sweep`**
...
<a id="section-6-6-2"></a> **`6.6.2. Solicit-Map-Request (SMR)`**
...
<a id="section-6-6-3"></a> **`6.6.3. Database Map-Versioning`**
...
<a id="section-7"></a> **`7. Router Performance Considerations`**
...
<a id="section-8"></a> **`8. Deployment Scenarios`**
...
<a id="section-8-1"></a> **`8.1. First-Hop/Last-Hop Tunnel Routers`**
...
<a id="section-8-2"></a> **`8.2. Border/Edge Tunnel Routers`**
...
<a id="section-8-3"></a> **`8.3. ISP Provider Edge (PE) Tunnel Routers`**
...
<a id="section-8-4"></a> **`8.4. LISP Functionality with Conventional NATs`**
...
<a id="section-8-5"></a> **`8.5. Packets Egressing a LISP Site`**
...
<a id="section-9"></a> **`9. Traceroute Considerations`**
...
<a id="section-9-1"></a> **`9.1. IPv6 Traceroute`**
...
<a id="section-9-2"></a> **`9.2. IPv4 Traceroute`**
...
<a id="section-9-3"></a> **`9.3. Traceroute Using Mixed Locators`**
...
<a id="section-10"></a> **`10. Mobility Considerations`**
...
<a id="section-10-1"></a> **`10.1. Site Mobility`**
...
<a id="section-10-2"></a> **`10.2. Slow Endpoint Mobility`**
...
<a id="section-10-3"></a> **`10.3. Fast Endpoint Mobility`**
...
<a id="section-10-4"></a> **`10.4. Fast Network Mobility`**
...
<a id="section-10-5"></a> **`10.5. LISP Mobile Node Mobility`**
...
<a id="section-11"></a> **`11. Multicast Considerations`**
...
<a id="section-13"></a> **`13. Network Management Considerations`**
...
<a id="section-14-1"></a> **`14.1. LISP ACT and Flag Fields`**
...
<a id="section-14-2"></a> **`14.2. LISP Address Type Codes`**
...
<a id="section-14-3"></a> **`14.3. LISP UDP Port Numbers`**
...
<a id="section-14-4"></a> **`14.4. LISP Key ID Numbers`**
...
<a id="section-15"></a> **`15. Known Open Issues and Areas of Future Work`**
