...
`       `[`1`](#section-1)`. 1 Motivation, Scope and Goals of this document`

`       `[`1`](#section-1)`. 2 Requirements Terminology`

`       `[`1`](#section-1)`. 3 Audience`

`       `[`1`](#section-1)`. 4 Definition of Technical Terms`

`   `[`2`](#section-2)`. 0 Statement of the Problem`

`   `[`3`](#section-3)`. 0 Requirements for an IP-based Configuration Management System`

`   `[`4`](#section-4)`. 0 Security Considerations`
