...
`      `[`1.1`](#section-1-1)`. Conventions Used`

`      `[`1.2`](#section-1-2)`. Motivation`

`   `[`2`](#section-2)`. Approaches`

`   `[`3`](#section-3)`. Entropy Labels and Their Structure`

`   `[`4`](#section-4)`. Data Plane Processing of Entropy Labels`

`      `[`4.1`](#section-4-1)`. Egress LSR`

`      `[`4.2`](#section-4-2)`. Ingress LSR`

`      `[`4.3`](#section-4-3)`. Transit LSR`

`      `[`4.4`](#section-4-4)`. Penultimate Hop LSR`

`   `[`5`](#section-5)`. Signaling for Entropy Labels`

`      `[`5.1`](#section-5-1)`. LDP Signaling`

`           `[`5.1.1`](#section-5-1-1)`. Processing the ELC TLV`

`      `[`5.2`](#section-5-2)`. BGP Signaling`

`      `[`5.3`](#section-5-3)`. RSVP-TE Signaling`

`      `[`5.4`](#section-5-4)`. Multicast LSPs and Entropy Labels`

`   `[`6`](#section-6)`. Operations, Administration, and Maintenance (OAM) and`

`      Entropy Labels`

`   `[`7`](#section-7)`. MPLS-TP and Entropy Labels`

`   `[`8`](#section-8)`. Entropy Labels in Various Scenarios`

`      `[`8.1`](#section-8-1)`. LDP Tunnel`

`      `[`8.2`](#section-8-2)`. LDP over RSVP-TE`

`      `[`8.3`](#section-8-3)`. MPLS Applications`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. IANA Considerations`

`      `[`10.1`](#section-10-1)`. Reserved Label for ELI`

`      `[`10.2`](#section-10-2)`. LDP Entropy Label Capability TLV`

`      `[`10.3`](#section-10-3)`. BGP Entropy Label Capability Attribute`

`      `[`10.4`](#section-10-4)`. RSVP-TE Entropy Label Capability Flag`
...
<a id="section-1-1"></a> **`1.1. Conventions Used`**
...
<a id="section-1-2"></a> **`1.2. Motivation`**
...
<a id="section-3"></a> **`3. Entropy Labels and Their Structure`**
...
<a id="section-4"></a> **`4. Data Plane Processing of Entropy Labels`**

```text

```

<a id="section-4-1"></a> **`4.1. Egress LSR`**
...
<a id="section-4-2"></a> **`4.2. Ingress LSR`**
...
<a id="section-4-3"></a> **`4.3. Transit LSR`**
...
<a id="section-4-4"></a> **`4.4. Penultimate Hop LSR`**
...
<a id="section-5"></a> **`5. Signaling for Entropy Labels`**
...
<a id="section-5-1"></a> **`5.1. LDP Signaling`**
...
<a id="section-5-1-1"></a> **`5.1.1. Processing the ELC TLV`**
...
<a id="section-5-2"></a> **`5.2. BGP Signaling`**
...
<a id="section-5-3"></a> **`5.3. RSVP-TE Signaling`**
...
<a id="section-5-4"></a> **`5.4. Multicast LSPs and Entropy Labels`**
...
<a id="section-6"></a> **`6. Operations, Administration, and Maintenance (OAM) and Entropy Labels`**
...
<a id="section-7"></a> **`7. MPLS-TP and Entropy Labels`**
...
<a id="section-8"></a> **`8. Entropy Labels in Various Scenarios`**
...
<a id="section-8-1"></a> **`8.1. LDP Tunnel`**
...
<a id="section-8-2"></a> **`8.2. LDP over RSVP-TE`**
...
<a id="section-8-3"></a> **`8.3. MPLS Applications`**
...
<a id="section-10-1"></a> **`10.1. Reserved Label for ELI`**
...
<a id="section-10-2"></a> **`10.2. LDP Entropy Label Capability TLV`**
...
<a id="section-10-3"></a> **`10.3. BGP Entropy Label Capability Attribute`**
...
<a id="section-10-4"></a> **`10.4. RSVP-TE Entropy Label Capability Flag`**
