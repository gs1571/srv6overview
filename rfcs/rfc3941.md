...
`   `[`2`](#section-2)`. Rationale`

`      `[`2.1`](#section-2-1)`. Delivery Service Model`

`      `[`2.2`](#section-2-2)`. Group Membership Dynamics`

`      `[`2.3`](#section-2-3)`. Sender/Receiver Relationships`

`      `[`2.4`](#section-2-4)`. Group Size Scalability`

`      `[`2.5`](#section-2-5)`. Data Delivery Performance`

`      `[`2.6`](#section-2-6)`. Network Environments`

`      `[`2.7`](#section-2-7)`. Router/Intermediate System Assistance`

`   `[`3`](#section-3)`. Functionality`

`      `[`3.1`](#section-3-1)`. NORM Sender Transmission`

`      `[`3.2`](#section-3-2)`. NORM Repair Process`

`           `[`3.2.1`](#section-3-2-1)`. Receiver NACK Process Initiation`

`           `[`3.2.2`](#section-3-2-2)`. NACK Suppression`

`           `[`3.2.3`](#section-3-2-3)`. NACK Content`

`                  `[`3.2.3.1`](#section-3-2-3-1)`. NACK and FEC Repair Strategies`

`                  `[`3.2.3.2`](#section-3-2-3-2)`. NACK Content Format`

`           `[`3.2.4`](#section-3-2-4)`. Sender Repair Response`

`      `[`3.3`](#section-3-3)`. NORM Receiver Join Policies and Procedures`

`      `[`3.4`](#section-3-4)`. Reliable Multicast Member Identification`

`      `[`3.5`](#section-3-5)`. Data Content Identification`

`      `[`3.6`](#section-3-6)`. Forward Error Correction (FEC)`

`      `[`3.7`](#section-3-7)`. Round-trip Timing Collection`

`           `[`3.7.1`](#section-3-7-1)`. One-to-Many Sender GRTT Measurement`

`           `[`3.7.2`](#section-3-7-2)`. One-to-Many Receiver RTT Measurement`

`           `[`3.7.3`](#section-3-7-3)`. Many-to-Many RTT Measurement`

`           `[`3.7.4`](#section-3-7-4)`. Sender GRTT Advertisement`

`      `[`3.8`](#section-3-8)`. Group Size Determination/Estimation`

`      `[`3.9`](#section-3-9)`. Congestion Control Operation`

`      `[`3`](#section-3)`. 10 Router/Intermediate System Assistance`

`      `[`3`](#section-3)`. 11 NORM Applicability`
...
<a id="section-2-1"></a> **`2.1. Delivery Service Model`**
...
<a id="section-2-2"></a> **`2.2. Group Membership Dynamics`**
...
<a id="section-2-3"></a> **`2.3. Sender/Receiver Relationships`**
...
<a id="section-2-4"></a> **`2.4. Group Size Scalability`**
...
<a id="section-2-5"></a> **`2.5. Data Delivery Performance`**
...
<a id="section-2-6"></a> **`2.6. Network Environments`**
...
<a id="section-2-7"></a> **`2.7. Router/Intermediate System Assistance`**
...
<a id="section-3"></a> **`3. Functionality`**
...
<a id="section-3-1"></a> **`3.1. NORM Sender Transmission`**
...
<a id="section-3-2"></a> **`3.2. NORM Repair Process`**
...
<a id="section-3-2-1"></a> **`3.2.1. Receiver NACK Process Initiation`**
...
<a id="section-3-2-2"></a> **`3.2.2. NACK Suppression`**
...
<a id="section-3-2-3"></a> **`3.2.3. NACK Content`**
...
<a id="section-3-2-3-1"></a> **`3.2.3.1. NACK and FEC Repair Strategies`**
...
<a id="section-3-2-3-2"></a> **`3.2.3.2. NACK Content Format`**
...
<a id="section-3-2-4"></a> **`3.2.4. Sender Repair Response`**
...
<a id="section-3-3"></a> **`3.3. NORM Receiver Join Policies and Procedures`**
...
<a id="section-3-4"></a> **`3.4. Reliable Multicast Member Identification`**
...
<a id="section-3-5"></a> **`3.5. Data Content Identification`**
...
<a id="section-3-6"></a> **`3.6. Forward Error Correction (FEC)`**
...
<a id="section-3-7"></a> **`3.7. Round-trip Timing Collection`**
...
<a id="section-3-7-1"></a> **`3.7.1. One-to-Many Sender GRTT Measurement`**
...
<a id="section-3-7-2"></a> **`3.7.2. One-to-Many Receiver RTT Measurement`**
...
<a id="section-3-7-3"></a> **`3.7.3. Many-to-Many RTT Measurement`**
...
<a id="section-3-7-4"></a> **`3.7.4. Sender GRTT Advertisement`**
...
<a id="section-3-8"></a> **`3.8. Group Size Determination/Estimation`**
...
<a id="section-3-9"></a> **`3.9. Congestion Control Operation`**
...
<a id="section-3-10"></a> **`3.10. Router/Intermediate System Assistance`**
...
<a id="section-3-11"></a> **`3.11. NORM Applicability`**
...
<a id="section-5"></a> **`5. Acknowledgements (and these are not Negative)`**
...
<a id="section-7"></a> **`7. Authors' Addresses`**
