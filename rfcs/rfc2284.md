...
`   `[`2`](#section-2)`. PPP Extensible Authentication Protocol (EAP)`

`      `[`2.1`](#section-2-1)`. Configuration Option Format`

`      `[`2.2`](#section-2-2)`. Packet Format`

`         `[`2.2.1`](#section-2-2-1)`. Request and Response`

`         `[`2.2.2`](#section-2-2-2)`. Success and Failure`

`   `[`3`](#section-3)`. Initial EAP Request/Response Types`

`      `[`3.1`](#section-3-1)`. Identity`

`      `[`3.2`](#section-3-2)`. Notification`

`      `[`3.3`](#section-3-3)`. Nak`

`      `[`3.4`](#section-3-4)`. MD5-Challenge`

`      `[`3.5`](#section-3-5)`. One-Time Password (OTP)`

`      `[`3.6`](#section-3-6)`. Generic Token Card`
...
<a id="section-2"></a> **`2. PPP Extensible Authentication Protocol (EAP)`**
...
<a id="section-2-1"></a> **`2.1. Configuration Option Format`**
...
<a id="section-2-2"></a> **`2.2. Packet Format`**
...
<a id="section-2-2-1"></a> **`2.2.1. Request and Response`**
...
<a id="section-2-2-2"></a> **`2.2.2. Success and Failure`**
...
<a id="section-3"></a> **`3. Initial EAP Request/Response Types`**
...
<a id="section-3-1"></a> **`3.1. Identity`**
...
<a id="section-3-2"></a> **`3.2. Notification`**
...
<a id="section-3-4"></a> **`3.4. MD5-Challenge`**
...
<a id="section-3-5"></a> **`3.5. One-Time Password (OTP)`**
...
<a id="section-3-6"></a> **`3.6. Generic Token Card`**
