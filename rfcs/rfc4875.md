...
`   `[`4`](#section-4)`. Mechanism`

`      `[`4.1`](#section-4-1)`. P2MP Tunnels`

`      `[`4.2`](#section-4-2)`. P2MP LSP`

`      `[`4.3`](#section-4-3)`. Sub-Groups`

`      `[`4.4`](#section-4-4)`. S2L Sub-LSPs`

`           `[`4.4.1`](#section-4-4-1)`. Representation of an S2L Sub-LSP`

`           `[`4.4.2`](#section-4-4-2)`. S2L Sub-LSPs and Path Messages`

`      `[`4.5`](#section-4-5)`. Explicit Routing`

`   `[`5`](#section-5)`. Path Message`

`      `[`5.1`](#section-5-1)`. Path Message Format`

`      `[`5.2`](#section-5-2)`. Path Message Processing`

`           `[`5.2.1`](#section-5-2-1)`. Multiple Path Messages`

`           `[`5.2.2`](#section-5-2-2)`. Multiple S2L Sub-LSPs in One Path Message`

`           `[`5.2.3`](#section-5-2-3)`. Transit Fragmentation of Path State Information`

`           `[`5.2.4`](#section-5-2-4)`. Control of Branch Fate Sharing`

`      `[`5.3`](#section-5-3)`. Grafting`

`   `[`6`](#section-6)`. Resv Message`

`      `[`6.1`](#section-6-1)`. Resv Message Format`

`      `[`6.2`](#section-6-2)`. Resv Message Processing`

`           `[`6.2.1`](#section-6-2-1)`. Resv Message Throttling`

`      `[`6.3`](#section-6-3)`. Route Recording`

`           `[`6.3.1`](#section-6-3-1)`. RRO Processing`

`      `[`6.4`](#section-6-4)`. Reservation Style`

`   `[`7`](#section-7)`. PathTear Message`

`      `[`7.1`](#section-7-1)`. PathTear Message Format`

`      `[`7.2`](#section-7-2)`. Pruning`

`           `[`7.2.1`](#section-7-2-1)`. Implicit S2L Sub-LSP Teardown`

`           `[`7.2.2`](#section-7-2-2)`. Explicit S2L Sub-LSP Teardown`

`   `[`8`](#section-8)`. Notify and ResvConf Messages`

`      `[`8.1`](#section-8-1)`. Notify Messages`

`      `[`8.2`](#section-8-2)`. ResvConf Messages`

`   `[`9`](#section-9)`. Refresh Reduction`

`   `[`10`](#section-10)`. State Management`

`      `[`10.1`](#section-10-1)`. Incremental State Update`

`      `[`10.2`](#section-10-2)`. Combining Multiple Path Messages`

`   `[`11`](#section-11)`. Error Processing`

`      `[`11.1`](#section-11-1)`. PathErr Messages`

`      `[`11.2`](#section-11-2)`. ResvErr Messages`

`      `[`11.3`](#section-11-3)`. Branch Failure Handling`

`   `[`12`](#section-12)`. Admin Status Change`

`   `[`13`](#section-13)`. Label Allocation on LANs with Multiple Downstream Nodes`

`   `[`14`](#section-14)`. P2MP LSP and Sub-LSP Re-Optimization`

`      `[`14.1`](#section-14-1)`. Make-before-Break`

`      `[`14.2`](#section-14-2)`. Sub-Group-Based Re-Optimization`

`   `[`15`](#section-15)`. Fast Reroute`

`      `[`15.1`](#section-15-1)`. Facility Backup`

`           `[`15.1.1`](#section-15-1-1)`. Link Protection`

`           `[`15.1.2`](#section-15-1-2)`. Node Protection`

`      `[`15.2`](#section-15-2)`. One-to-One Backup`

`   `[`16`](#section-16)`. Support for LSRs That Are Not P2MP Capable`

`   `[`17`](#section-17)`. Reduction in Control Plane Processing with LSP Hierarchy`

`   `[`18`](#section-18)`. P2MP LSP Re-Merging and Cross-Over`

`      `[`18.1`](#section-18-1)`. Procedures`

`           `[`18.1.1`](#section-18-1-1)`. Re-Merge Procedures`

`   `[`19`](#section-19)`. New and Updated Message Objects`

`      `[`19.1`](#section-19-1)`. SESSION Object`

`           `[`19.1.1`](#section-19-1-1)`. P2MP LSP Tunnel IPv4 SESSION Object`

`           `[`19.1.2`](#section-19-1-2)`. P2MP LSP Tunnel IPv6 SESSION Object`

`      `[`19.2`](#section-19-2)`. SENDER_TEMPLATE Object`

`           `[`19.2.1`](#section-19-2-1)`. P2MP LSP Tunnel IPv4 SENDER_TEMPLATE Object`

`           `[`19.2.2`](#section-19-2-2)`. P2MP LSP Tunnel IPv6 SENDER_TEMPLATE Object`

`      `[`19.3`](#section-19-3)`. S2L_SUB_LSP Object`

`           `[`19.3.1`](#section-19-3-1)`. S2L_SUB_LSP IPv4 Object`

`           `[`19.3.2`](#section-19-3-2)`. S2L_SUB_LSP IPv6 Object`

`      `[`19.4`](#section-19-4)`. FILTER_SPEC Object`

`           `[`19.4.1`](#section-19-4-1)`. P2MP LSP_IPv4 FILTER_SPEC Object`

`           `[`19.4.2`](#section-19-4-2)`. P2MP LSP_IPv6 FILTER_SPEC Object`

`      `[`19.5`](#section-19-5)`. P2MP SECONDARY_EXPLICIT_ROUTE Object (SERO)`

`      `[`19.6`](#section-19-6)`. P2MP SECONDARY_RECORD_ROUTE Object (SRRO)`

`   `[`20`](#section-20)`. IANA Considerations`

`      `[`20.1`](#section-20-1)`. New Class Numbers`

`      `[`20.2`](#section-20-2)`. New Class Types`

`      `[`20.3`](#section-20-3)`. New Error Values`

`      `[`20.4`](#section-20-4)`. LSP Attributes Flags`

`   `[`21`](#section-21)`. Security Considerations`

`   `[`22`](#section-22)`. Acknowledgements`

`   `[`23`](#section-23)`. References`

`      `[`23.1`](#section-23-1)`. Normative References`

`      `[`23.2`](#section-23-2)`. Informative References`
...
<a id="section-2"></a> **`2. Conventions Used in This Document`**
...
<a id="section-4-1"></a> **`4.1. P2MP Tunnels`**
...
<a id="section-4-2"></a> **`4.2. P2MP LSP`**
...
<a id="section-4-3"></a> **`4.3. Sub-Groups`**
...
<a id="section-4-4"></a> **`4.4. S2L Sub-LSPs`**
...
<a id="section-4-4-1"></a> **`4.4.1. Representation of an S2L Sub-LSP`**
...
<a id="section-4-4-2"></a> **`4.4.2. S2L Sub-LSPs and Path Messages`**
...
<a id="section-4-5"></a> **`4.5. Explicit Routing`**
...
<a id="section-5"></a> **`5. Path Message`**

```text

```

<a id="section-5-1"></a> **`5.1. Path Message Format`**
...
<a id="section-5-2"></a> **`5.2. Path Message Processing`**
...
<a id="section-5-2-1"></a> **`5.2.1. Multiple Path Messages`**
...
<a id="section-5-2-2"></a> **`5.2.2. Multiple S2L Sub-LSPs in One Path Message`**
...
<a id="section-5-2-3"></a> **`5.2.3. Transit Fragmentation of Path State Information`**
...
<a id="section-5-2-4"></a> **`5.2.4. Control of Branch Fate Sharing`**
...
<a id="section-5-3"></a> **`5.3. Grafting`**
...
<a id="section-6"></a> **`6. Resv Message`**

```text

```

<a id="section-6-1"></a> **`6.1. Resv Message Format`**
...
<a id="section-6-2"></a> **`6.2. Resv Message Processing`**
...
<a id="section-6-2-1"></a> **`6.2.1. Resv Message Throttling`**
...
<a id="section-6-3"></a> **`6.3. Route Recording`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. RRO Processing`**
...
<a id="section-6-4"></a> **`6.4. Reservation Style`**
...
<a id="section-7"></a> **`7. PathTear Message`**

```text

```

<a id="section-7-1"></a> **`7.1. PathTear Message Format`**
...
<a id="section-7-2"></a> **`7.2. Pruning`**
...
<a id="section-7-2-1"></a> **`7.2.1. Implicit S2L Sub-LSP Teardown`**
...
<a id="section-7-2-2"></a> **`7.2.2. Explicit S2L Sub-LSP Teardown`**
...
<a id="section-8"></a> **`8. Notify and ResvConf Messages`**

```text

```

<a id="section-8-1"></a> **`8.1. Notify Messages`**
...
<a id="section-8-2"></a> **`8.2. ResvConf Messages`**
...
<a id="section-9"></a> **`9. Refresh Reduction`**
...
<a id="section-10"></a> **`10. State Management`**
...
<a id="section-10-1"></a> **`10.1. Incremental State Update`**
...
<a id="section-10-2"></a> **`10.2. Combining Multiple Path Messages`**
...
<a id="section-11"></a> **`11. Error Processing`**
...
<a id="section-11-1"></a> **`11.1. PathErr Messages`**
...
<a id="section-11-2"></a> **`11.2. ResvErr Messages`**
...
<a id="section-11-3"></a> **`11.3. Branch Failure Handling`**
...
<a id="section-12"></a> **`12. Admin Status Change`**
...
<a id="section-13"></a> **`13. Label Allocation on LANs with Multiple Downstream Nodes`**
...
<a id="section-14"></a> **`14. P2MP LSP and Sub-LSP Re-Optimization`**
...
<a id="section-14-1"></a> **`14.1. Make-before-Break`**
...
<a id="section-14-2"></a> **`14.2. Sub-Group-Based Re-Optimization`**
...
<a id="section-15"></a> **`15. Fast Reroute`**
...
<a id="section-15-1"></a> **`15.1. Facility Backup`**
...
<a id="section-15-1-1"></a> **`15.1.1. Link Protection`**
...
<a id="section-15-1-2"></a> **`15.1.2. Node Protection`**
...
<a id="section-15-2"></a> **`15.2. One-to-One Backup`**
...
<a id="section-16"></a> **`16. Support for LSRs That Are Not P2MP Capable`**
...
<a id="section-17"></a> **`17. Reduction in Control Plane Processing with LSP Hierarchy`**
...
<a id="section-18"></a> **`18. P2MP LSP Re-Merging and Cross-Over`**
...
<a id="section-18-1"></a> **`18.1. Procedures`**
...
<a id="section-18-1-1"></a> **`18.1.1. Re-Merge Procedures`**
...
<a id="section-19"></a> **`19. New and Updated Message Objects`**
...
<a id="section-19-1"></a> **`19.1. SESSION Object`**
...
<a id="section-19-1-1"></a> **`19.1.1. P2MP LSP Tunnel IPv4 SESSION Object`**
...
<a id="section-19-1-2"></a> **`19.1.2. P2MP LSP Tunnel IPv6 SESSION Object`**
...
<a id="section-19-2"></a> **`19.2. SENDER_TEMPLATE Object`**
...
<a id="section-19-2-1"></a> **`19.2.1. P2MP LSP Tunnel IPv4 SENDER_TEMPLATE Object`**
...
<a id="section-19-2-2"></a> **`19.2.2. P2MP LSP Tunnel IPv6 SENDER_TEMPLATE Object`**
...
<a id="section-19-3"></a> **`19.3. S2L_SUB_LSP Object`**
...
<a id="section-19-3-1"></a> **`19.3.1. S2L_SUB_LSP IPv4 Object`**
...
<a id="section-19-3-2"></a> **`19.3.2. S2L_SUB_LSP IPv6 Object`**
...
<a id="section-19-4"></a> **`19.4. FILTER_SPEC Object`**
...
<a id="section-19-4-1"></a> **`19.4.1. P2MP LSP_IPv4 FILTER_SPEC Object`**
...
<a id="section-19-4-2"></a> **`19.4.2. P2MP LSP_IPv6 FILTER_SPEC Object`**
...
<a id="section-19-5"></a> **`19.5. P2MP SECONDARY_EXPLICIT_ROUTE Object (SERO)`**
...
<a id="section-19-6"></a> **`19.6. P2MP SECONDARY_RECORD_ROUTE Object (SRRO)`**
...
<a id="section-20-1"></a> **`20.1. New Class Numbers`**
...
<a id="section-20-2"></a> **`20.2. New Class Types`**
...
<a id="section-20-3"></a> **`20.3. New Error Values`**
...
<a id="section-20-4"></a> **`20.4. LSP Attributes Flags`**
...
<a id="section-21"></a> **`21. Security Considerations`**
...
<a id="section-22"></a> **`22. Acknowledgements`**
...
<a id="section-23"></a> **`23. References`**

```text

```

<a id="section-23-1"></a> **`23.1. Normative References`**
...
<a id="section-23-2"></a> **`23.2. Informative References`**
