...
`       `[`1.1`](#section-1-1)`. Keywords`

`       `[`1.2`](#section-1-2)`. Definitions of Commonly Used Terms`

`       `[`1.3`](#section-1-3)`. Operation Modes`

`       `[`1.4`](#section-1-4)`. Overview`

`   `[`2`](#section-2)`. IS Alias ID TLV (IS-A)`

`   `[`3`](#section-3)`. Generating LSPs`

`       `[`3.1`](#section-3-1)`. Both Operation Modes`

`       `[`3.2`](#section-3-2)`. Operation Mode 1 Additives`

`   `[`4`](#section-4)`. Purging Extended LSP Fragments`

`   `[`5`](#section-5)`. Modifications to LSP handling in SPF`

`   `[`6`](#section-6)`. Forming Adjacencies`

`   `[`7`](#section-7)`. Interoperating between extension-capable and non-capable ISs`
...
<a id="section-1-1"></a> **`1.1. Keywords`**
...
<a id="section-1-2"></a> **`1.2. Definitions of Commonly Used Terms`**
...
<a id="section-1-3"></a> **`1.3. Operation Modes`**
...
<a id="section-2"></a> **`2. IS Alias ID TLV (IS-A)`**
...
<a id="section-3"></a> **`3. Generating LSPs`**

```text

```

<a id="section-3-1"></a> **`3.1. Both Operation Modes`**
...
<a id="section-3-1-1"></a> **`3.1.1. The Attached Bits`**
...
<a id="section-3-1-2"></a> **`3.1.2. The Partition Repair Bit`**
...
<a id="section-3-1-3"></a> **`3.1.3. ES Neighbors TLV`**
...
<a id="section-3-1-4"></a> **`3.1.4. Overload Bit`**
...
<a id="section-3-1-5"></a> **`3.1.5. Other Fields and TLVs`**
...
<a id="section-3-2"></a> **`3.2. Operation Mode 1 Additions`**
...
<a id="section-3-2-1"></a> **`3.2.1. IS Neighbors TLV (Mode 1 Only)`**
...
<a id="section-3-2-2"></a> **`3.2.2. Originating System in the Overload State in (Mode 1 Only)`**
...
<a id="section-4"></a> **`4. Purging Extended LSP Fragments`**
...
<a id="section-5"></a> **`5. Modifications to LSP handling in SPF`**
...
<a id="section-6"></a> **`6. Forming Adjacencies`**
...
<a id="section-7"></a> **`7. Interoperating between extension-capable and non-extension-capable`**
