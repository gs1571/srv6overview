...
`   `[`1`](#section-1)`. 1 Changes to RFC1541`

`   `[`1`](#section-1)`. 2 Related Work`

`   `[`1`](#section-1)`. 3 Problem definition and issues`

`   `[`1`](#section-1)`. 4 Requirements`

`   `[`1`](#section-1)`. 5 Terminology`

`   `[`1`](#section-1)`. 6 Design goals`

`   `[`2`](#section-2)`. Protocol Summary`

`   `[`2`](#section-2)`. 1 Configuration parameters repository`

`   `[`2`](#section-2)`. 2 Dynamic allocation of network addresses`

`   `[`3`](#section-3)`. The Client-Server Protocol`

`   `[`3`](#section-3)`. 1 Client-server interaction - allocating a network address`

`   `[`3`](#section-3)`. 2 Client-server interaction - reusing a  previously allocated`

`       network address`

`   `[`3`](#section-3)`. 3 Interpretation and representation of time values`

`   `[`3`](#section-3)`. 4 Obtaining parameters with externally configured network`

`       address`

`   `[`3`](#section-3)`. 5 Client parameters in DHCP`

`   `[`3`](#section-3)`. 6 Use of DHCP in clients with multiple interfaces`

`   `[`3`](#section-3)`. 7 When clients should use DHCP`

`   `[`4`](#section-4)`. Specification of the DHCP client-server protocol`

`   `[`4`](#section-4)`. 1 Constructing and sending DHCP messages`

`   `[`4`](#section-4)`. 2 DHCP server administrative controls`

`   `[`4`](#section-4)`. 3 DHCP server behavior`

`   `[`4`](#section-4)`. 4 DHCP client behavior`
...
<a id="section-2"></a> **`2. Protocol Summary`**
...
<a id="section-3"></a> **`3. The Client-Server Protocol`**
...
<a id="section-4"></a> **`4. Specification of the DHCP client-server protocol`**
...
<a id="section-8"></a> **`8. Author's Address`**
