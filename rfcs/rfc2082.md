...
`   `[`3`](#section-3)`. 1 RIP-2 PDU Format`

`   `[`3`](#section-3)`. 2 Processing Algorithm`

`   `[`3.2`](#section-3-2)`. 1 Message Generation`

`   `[`3.2`](#section-3-2)`. 2 Message Reception`

`   4 Management Procedures`

`   `[`4`](#section-4)`. 1 Key Management Requirements`

`   `[`4`](#section-4)`. 2 Key Management Procedures`

`   `[`4`](#section-4)`. 3 Pathological Cases`
...
<a id="section-1"></a> **`1. Use of Imperatives`**
...
<a id="section-3"></a> **`3. Implementation Approach`**
...
<a id="section-3-1"></a> **`3.1. RIP-2 PDU Format`**
...
<a id="section-3-2"></a> **`3.2. Processing Algorithm`**
...
<a id="section-3-2-1"></a> **`3.2.1. Message Generation`**
...
<a id="section-3-2-2"></a> **`3.2.2. Message Reception`**
...
<a id="section-4"></a> **`4. Management Procedures`**

```text

```

<a id="section-4-1"></a> **`4.1. Key Management Requirements`**
...
<a id="section-4-2"></a> **`4.2. Key Management Procedures`**
...
<a id="section-4-3"></a> **`4.3. Pathological Cases`**
...
<a id="section-9"></a> **`9. Chairman's Address`**
