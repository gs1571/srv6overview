...
<a id="section-2"></a> **`2. The Algorithm`**
...
<a id="section-2-1"></a> **`2.1. Reception`**
...
<a id="section-2-2"></a> **`2.2. Transmission`**
...
<a id="section-3"></a> **`3. Operations`**

```text

```

<a id="section-3-1"></a> **`3.1. Single-Ended Operations`**
...
<a id="section-3-2"></a> **`3.2. Double-Ended Operations`**
...
<a id="section-3-3"></a> **`3.3. Monitoring`**
...
<a id="section-4"></a> **`4. Moving Forward`**
