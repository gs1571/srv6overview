...
<a id="section-3"></a> **`3. Multiprotocol Reachable NLRI - MP_REACH_NLRI (Type Code 14):`**
...
<a id="section-4"></a> **`4. Multiprotocol Unreachable NLRI - MP_UNREACH_NLRI (Type Code 15):`**
...
<a id="section-5"></a> **`5. NLRI Encoding`**
...
<a id="section-6"></a> **`6. Subsequent Address Family Identifier`**
...
<a id="section-8"></a> **`8. Use of BGP Capability Advertisement`**
...
<a id="section-10"></a> **`10. Comparison with RFC 2858`**
...
<a id="section-11"></a> **`11. Comparison with RFC 2283`**
