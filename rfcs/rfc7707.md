...
`   `[`3`](#section-3)`. Requirements for the Applicability of Network Reconnaissance`

`       Techniques`

`   `[`4`](#section-4)`. IPv6 Address Scanning`

`     `[`4.1`](#section-4-1)`. Address Configuration in IPv6`

`       `[`4.1.1`](#section-4-1-1)`. Stateless Address Autoconfiguration (SLAAC)`

`       `[`4.1.2`](#section-4-1-2)`. Dynamic Host Configuration Protocol for IPv6 (DHCPv6)  11`

`       `[`4.1.3`](#section-4-1-3)`. Manually Configured Addresses`

`       `[`4.1.4`](#section-4-1-4)`. IPv6 Addresses Corresponding to`

`               Transition/Coexistence Technologies`

`       `[`4.1.5`](#section-4-1-5)`. IPv6 Address Assignment in Real-World Network`

`               Scenarios`

`     `[`4.2`](#section-4-2)`. IPv6 Address Scanning of Remote Networks`

`       `[`4.2.1`](#section-4-2-1)`. Reducing the Subnet ID Search Space`

`     `[`4.3`](#section-4-3)`. IPv6 Address Scanning of Local Networks`

`     `[`4.4`](#section-4-4)`. Existing IPv6 Address-Scanning Tools`

`       `[`4.4.1`](#section-4-4-1)`. Remote IPv6 Network Address Scanners`

`       `[`4.4.2`](#section-4-4-2)`. Local IPv6 Network Address Scanners`

`     `[`4.5`](#section-4-5)`. Mitigations`

`     `[`4.6`](#section-4-6)`. Conclusions`

`   `[`5`](#section-5)`. Alternative Methods to Glean IPv6 Addresses`

`     `[`5.1`](#section-5-1)`. Leveraging the Domain Name System (DNS) for Network`

`           Reconnaissance`

`       `[`5.1.1`](#section-5-1-1)`. DNS Advertised Hosts`

`       `[`5.1.2`](#section-5-1-2)`. DNS Zone Transfers`

`       `[`5.1.3`](#section-5-1-3)`. DNS Brute Forcing`

`       `[`5.1.4`](#section-5-1-4)`. DNS Reverse Mappings`

`     `[`5.2`](#section-5-2)`. Leveraging Local Name Resolution and Service Discovery`

`           Services`

`     `[`5.3`](#section-5-3)`. Public Archives`

`     `[`5.4`](#section-5-4)`. Application Participation`

`     `[`5.5`](#section-5-5)`. Inspection of the IPv6 Neighbor Cache and Routing Table`

`     `[`5.6`](#section-5-6)`. Inspection of System Configuration and Log Files`

`     `[`5.7`](#section-5-7)`. Gleaning Information from Routing Protocols`

`     `[`5.8`](#section-5-8)`. Gleaning Information from IP Flow Information Export`

`           (IPFIX)`

`     `[`5.9`](#section-5-9)`. Obtaining Network Information with traceroute6`

`     `[`5.10`](#section-5-10)`. Gleaning Information from Network Devices Using SNMP  .`

`     `[`5.11`](#section-5-11)`. Obtaining Network Information via Traffic Snooping`
...
<a id="section-3"></a> **`3. Requirements for the Applicability of Network Reconnaissance`**
...
<a id="section-4"></a> **`4. IPv6 Address Scanning`**
...
<a id="section-4-1"></a> **`4.1. Address Configuration in IPv6`**
...
<a id="section-4-1-1"></a> **`4.1.1. Stateless Address Autoconfiguration (SLAAC)`**
...
<a id="section-4-1-1-1"></a> **`4.1.1.1. Interface Identifiers Embedding IEEE Identifiers`**
...
<a id="section-4-1-1-2"></a> **`4.1.1.2. Interface Identifiers of Virtualization Technologies`**
...
<a id="section-4-1-1-2-1"></a> **`4.1.1.2.1. VirtualBox`**
...
<a id="section-4-1-1-2-2"></a> **`4.1.1.2.2. VMware ESX Server`**
...
<a id="section-4-1-1-2-3"></a> **`4.1.1.2.3. VMware vSphere`**
...
<a id="section-4-1-1-3"></a> **`4.1.1.3. Temporary Addresses`**
...
<a id="section-4-1-1-4"></a> **`4.1.1.4. Constant, Semantically Opaque IIDs`**
...
<a id="section-4-1-1-5"></a> **`4.1.1.5. Stable, Semantically Opaque IIDs`**
...
<a id="section-4-1-2"></a> **`4.1.2. Dynamic Host Configuration Protocol for IPv6 (DHCPv6)`**
...
<a id="section-4-1-3"></a> **`4.1.3. Manually Configured Addresses`**
...
<a id="section-4-1-3-1"></a> **`4.1.3.1. Low-Byte Addresses`**
...
<a id="section-4-1-3-2"></a> **`4.1.3.2. IPv4-Based Addresses`**
...
<a id="section-4-1-3-3"></a> **`4.1.3.3. Service-Port Addresses`**
...
<a id="section-4-1-3-4"></a> **`4.1.3.4. Wordy Addresses`**
...
<a id="section-4-1-4"></a> **`4.1.4. IPv6 Addresses Corresponding to Transition/Coexistence`**
...
<a id="section-4-1-5"></a> **`4.1.5. IPv6 Address Assignment in Real-World Network Scenarios`**
...
<a id="section-4-2"></a> **`4.2. IPv6 Address Scanning of Remote Networks`**
...
<a id="section-4-2-1"></a> **`4.2.1. Reducing the Subnet ID Search Space`**
...
<a id="section-4-3"></a> **`4.3. IPv6 Address Scanning of Local Networks`**
...
<a id="section-4-4"></a> **`4.4. Existing IPv6 Address-Scanning Tools`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. Remote IPv6 Network Address Scanners`**
...
<a id="section-4-4-2"></a> **`4.4.2. Local IPv6 Network Address Scanners`**
...
<a id="section-4-5"></a> **`4.5. Mitigations`**
...
<a id="section-4-6"></a> **`4.6. Conclusions`**
...
<a id="section-5"></a> **`5. Alternative Methods to Glean IPv6 Addresses`**
...
<a id="section-5-1"></a> **`5.1. Leveraging the Domain Name System (DNS) for Network Reconnaissance`**

```text

```

<a id="section-5-1-1"></a> **`5.1.1. DNS Advertised Hosts`**
...
<a id="section-5-1-2"></a> **`5.1.2. DNS Zone Transfers`**
...
<a id="section-5-1-3"></a> **`5.1.3. DNS Brute Forcing`**
...
<a id="section-5-1-4"></a> **`5.1.4. DNS Reverse Mappings`**
...
<a id="section-5-2"></a> **`5.2. Leveraging Local Name Resolution and Service Discovery Services`**
...
<a id="section-5-3"></a> **`5.3. Public Archives`**
...
<a id="section-5-4"></a> **`5.4. Application Participation`**
...
<a id="section-5-5"></a> **`5.5. Inspection of the IPv6 Neighbor Cache and Routing Table`**
...
<a id="section-5-6"></a> **`5.6. Inspection of System Configuration and Log Files`**
...
<a id="section-5-7"></a> **`5.7. Gleaning Information from Routing Protocols`**
...
<a id="section-5-8"></a> **`5.8. Gleaning Information from IP Flow Information Export (IPFIX)`**
...
<a id="section-5-9"></a> **`5.9. Obtaining Network Information with traceroute6`**
...
<a id="section-5-10"></a> **`5.10. Gleaning Information from Network Devices Using SNMP`**
...
<a id="section-5-11"></a> **`5.11. Obtaining Network Information via Traffic Snooping`**
...
<a id="section-6"></a> **`6. Conclusions`**
