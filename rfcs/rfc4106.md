...
`   `[`3`](#section-3)`. ESP Payload Data`

`      `[`3.1`](#section-3-1)`. Initialization Vector (IV)`

`      `[`3.2`](#section-3-2)`. Ciphertext`

`   `[`4`](#section-4)`. Nonce Format`

`   `[`5`](#section-5)`. AAD Construction`

`   `[`6`](#section-6)`. Integrity Check Value (ICV)`

`   `[`7`](#section-7)`. Packet Expansion`

`   `[`8`](#section-8)`. IKE Conventions`

`      `[`8.1`](#section-8-1)`. Keying Material and Salt Values`

`      `[`8.2`](#section-8-2)`. Phase 1 Identifier`

`      `[`8.3`](#section-8-3)`. Phase 2 Identifier`

`      `[`8.4`](#section-8-4)`. Key Length Attribute`

`   `[`9`](#section-9)`. Test Vectors`

`   `[`10`](#section-10)`. Security Considerations`

`   `[`11`](#section-11)`. Design Rationale`
...
<a id="section-3"></a> **`3. ESP Payload Data`**
...
<a id="section-3-1"></a> **`3.1. Initialization Vector (IV)`**
...
<a id="section-3-2"></a> **`3.2. Ciphertext`**
...
<a id="section-4"></a> **`4. Nonce Format`**
...
<a id="section-5"></a> **`5. AAD Construction`**
...
<a id="section-6"></a> **`6. Integrity Check Value (ICV)`**
...
<a id="section-7"></a> **`7. Packet Expansion`**
...
<a id="section-8"></a> **`8. IKE Conventions`**
...
<a id="section-8-1"></a> **`8.1. Keying Material and Salt Values`**
...
<a id="section-8-2"></a> **`8.2. Phase 1 Identifier`**
...
<a id="section-8-3"></a> **`8.3. Phase 2 Identifier`**
...
<a id="section-8-4"></a> **`8.4. Key Length Attribute`**
...
<a id="section-9"></a> **`9. Test Vectors`**
...
<a id="section-11"></a> **`11. Design Rationale`**
