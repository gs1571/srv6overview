...
`     `[`1.3`](#section-1-3)`. Benefits`

`     `[`1.4`](#section-1-4)`. Conventions Used in This Document`

`   `[`2`](#section-2)`. AEAD Interface`

`     `[`2.1`](#section-2-1)`. Authenticated Encryption`

`     `[`2.2`](#section-2-2)`. Authenticated Decryption`

`     `[`2.3`](#section-2-3)`. Data Formatting`

`   `[`3`](#section-3)`. Guidance on the Use of AEAD Algorithms`

`     `[`3.1`](#section-3-1)`. Requirements on Nonce Generation`

`     `[`3.2`](#section-3-2)`. Recommended Nonce Formation`

`       `[`3.2.1`](#section-3-2-1)`. Partially Implicit Nonces`

`     `[`3.3`](#section-3-3)`. Construction of AEAD Inputs`

`     `[`3.4`](#section-3-4)`. Example Usage`

`   `[`4`](#section-4)`. Requirements on AEAD Algorithm Specifications`

`   `[`5`](#section-5)`. AEAD Algorithms`

`     `[`5.1`](#section-5-1)`. AEAD_AES_128_GCM`

`       `[`5.1.1`](#section-5-1-1)`. Nonce Reuse`

`     `[`5.2`](#section-5-2)`. AEAD_AES_256_GCM`

`     `[`5.3`](#section-5-3)`. AEAD_AES_128_CCM`

`       `[`5.3.1`](#section-5-3-1)`. Nonce Reuse`

`     `[`5.4`](#section-5-4)`. AEAD_AES_256_CCM`

`   `[`6`](#section-6)`. IANA Considerations`

`   `[`7`](#section-7)`. Other Considerations`
...
<a id="section-1-3"></a> **`1.3. Benefits`**
...
<a id="section-1-4"></a> **`1.4. Conventions Used in This Document`**
...
<a id="section-2"></a> **`2. AEAD Interface`**
...
<a id="section-2-1"></a> **`2.1. Authenticated Encryption`**
...
<a id="section-2-2"></a> **`2.2. Authenticated Decryption`**
...
<a id="section-2-3"></a> **`2.3. Data Formatting`**
...
<a id="section-3"></a> **`3. Guidance on the Use of AEAD Algorithms`**
...
<a id="section-3-1"></a> **`3.1. Requirements on Nonce Generation`**
...
<a id="section-3-2"></a> **`3.2. Recommended Nonce Formation`**
...
<a id="section-3-2-1"></a> **`3.2.1. Partially Implicit Nonces`**
...
<a id="section-3-3"></a> **`3.3. Construction of AEAD Inputs`**
...
<a id="section-3-4"></a> **`3.4. Example Usage`**
...
<a id="section-4"></a> **`4. Requirements on AEAD Algorithm Specifications`**
...
<a id="section-5"></a> **`5. AEAD Algorithms`**
...
<a id="section-5-1"></a> **`5.1. AEAD_AES_128_GCM`**
...
<a id="section-5-1-1"></a> **`5.1.1. Nonce Reuse`**
...
<a id="section-5-2"></a> **`5.2. AEAD_AES_256_GCM`**
...
<a id="section-5-3"></a> **`5.3. AEAD_AES_128_CCM`**
...
<a id="section-5-3-1"></a> **`5.3.1. Nonce Reuse`**
...
<a id="section-5-4"></a> **`5.4. AEAD_AES_256_CCM`**
...
<a id="section-7"></a> **`7. Other Considerations`**
