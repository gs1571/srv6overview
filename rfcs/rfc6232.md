...
`   `[`3`](#section-3)`. The Purge Originator Identification (POI) TLV`

`   `[`4`](#section-4)`. Using the Dynamic Hostname TLV in Purges`
...
<a id="section-3"></a> **`3. The Purge Originator Identification (POI) TLV`**
...
<a id="section-4"></a> **`4. Using the Dynamic Hostname TLV in Purges`**
