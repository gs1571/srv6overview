...
<a id="section-2"></a> **`2. Protocol Revisions`**
...
<a id="section-2-1"></a> **`2.1. Definition of the BGP Identifier`**
...
<a id="section-2-2"></a> **`2.2. Open Message Error Handling`**
...
<a id="section-2-3"></a> **`2.3. Connection Collision Resolution`**
