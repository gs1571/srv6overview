...
`   `[`4`](#section-4)`. General Description`

`   `[`5`](#section-5)`. PW Switching and Attachment Circuit Type`

`   `[`6`](#section-6)`. Applicability`

`   `[`7`](#section-7)`. MPLS-PW to MPLS-PW Switching`

`      `[`7.1`](#section-7-1)`. Static Control Plane Switching`

`      `[`7.2`](#section-7-2)`. Two LDP Control Planes Using the Same FEC Type`

`           `[`7.2.1`](#section-7-2-1)`. FEC 129 Active/Passive T-PE Election Procedure`

`      `[`7.3`](#section-7-3)`. LDP Using FEC 128 to LDP Using the Generalized FEC 129`

`      `[`7.4`](#section-7-4)`. LDP SP-PE TLV`

`           `[`7.4.1`](#section-7-4-1)`. PW Switching Point PE Sub-TLVs`

`           `[`7.4.2`](#section-7-4-2)`. Adaptation of Interface Parameters`

`      `[`7.5`](#section-7-5)`. Group ID`

`      `[`7.6`](#section-7-6)`. PW Loop Detection`

`   `[`8`](#section-8)`. MPLS-PW to L2TPv3-PW Control Plane Switching`

`      `[`8.1`](#section-8-1)`. Static MPLS and L2TPv3 PWs`

`      `[`8.2`](#section-8-2)`. Static MPLS PW and Dynamic L2TPv3 PW`

`      `[`8.3`](#section-8-3)`. Static L2TPv3 PW and Dynamic LDP/MPLS PW`

`      `[`8.4`](#section-8-4)`. Dynamic LDP/MPLS and L2TPv3 PWs`

`           `[`8.4.1`](#section-8-4-1)`. Session Establishment`

`           `[`8.4.2`](#section-8-4-2)`. Adaptation of PW Status message`

`           `[`8.4.3`](#section-8-4-3)`. Session Tear Down`

`      `[`8.5`](#section-8-5)`. Adaptation of L2TPv3 AVPs to Interface Parameters`

`      `[`8.6`](#section-8-6)`. Switching Point TLV in L2TPv3`

`      `[`8.7`](#section-8-7)`. L2TPv3 and MPLS PW Data Plane`

`           `[`8.7.1`](#section-8-7-1)`. Mapping the MPLS Control Word to L2TP`

`   `[`9`](#section-9)`. Operations, Administration, and Maintenance (OAM)`

`      `[`9.1`](#section-9-1)`. Extensions to VCCV to Support MS-PWs`

`      `[`9.2`](#section-9-2)`. OAM from MPLS PW to L2TPv3 PW`

`      `[`9.3`](#section-9-3)`. OAM Data Plane Indication from MPLS PW to MPLS PW`

`      `[`9.4`](#section-9-4)`. Signaling OAM Capabilities for Switched Pseudowires`

`      `[`9.5`](#section-9-5)`. OAM Capability for MS-PWs Demultiplexed Using MPLS`

`           `[`9.5.1`](#section-9-5-1)`. MS-PW and VCCV CC Type 1`

`           `[`9.5.2`](#section-9-5-2)`. MS-PW and VCCV CC Type 2`

`           `[`9.5.3`](#section-9-5-3)`. MS-PW and VCCV CC Type 3`

`      `[`9.6`](#section-9-6)`. MS-PW VCCV Operations`

`           `[`9.6.1`](#section-9-6-1)`. VCCV Echo Message Processing`

`           `[`9.6.2`](#section-9-6-2)`. Detailed VCCV Procedures`

`   `[`10`](#section-10)`. Mapping Switched Pseudowire Status`

`      `[`10.1`](#section-10-1)`. PW Status Messages Initiated by the S-PE`

`           `[`10.1.1`](#section-10-1-1)`. Local PW2 Transmit Direction Fault`

`           `[`10.1.2`](#section-10-1-2)`. Local PW1 Transmit Direction Fault`

`           `[`10.1.3`](#section-10-1-3)`. Local PW2 Receive Direction Fault`

`           `[`10.1.4`](#section-10-1-4)`. Local PW1 Receive Direction Fault`

`           `[`10.1.5`](#section-10-1-5)`. Clearing Faults`

`      `[`10.2`](#section-10-2)`. PW Status Messages and SP-PE TLV Processing`

`      `[`10.3`](#section-10-3)`. T-PE Processing of PW Status Messages`

`      `[`10.4`](#section-10-4)`. Pseudowire Status Negotiation Procedures`

`      `[`10.5`](#section-10-5)`. Status Dampening`

`   `[`11`](#section-11)`. Peering between Autonomous Systems`

`   `[`12`](#section-12)`. Congestion Considerations`

`   `[`13`](#section-13)`. Security Considerations`

`      `[`13.1`](#section-13-1)`. Data Plane Security`

`           `[`13.1.1`](#section-13-1-1)`. VCCV Security Considerations`

`      `[`13.2`](#section-13-2)`. Control Protocol Security`

`   `[`14`](#section-14)`. IANA Considerations`

`      `[`14.1`](#section-14-1)`. L2TPv3 AVP`

`      `[`14.2`](#section-14-2)`. LDP TLV TYPE`

`      `[`14.3`](#section-14-3)`. LDP Status Codes`

`      `[`14.4`](#section-14-4)`. L2TPv3 Result Codes`

`      `[`14.5`](#section-14-5)`. New IANA Registries`

`   `[`15`](#section-15)`. Normative References`

`   `[`16`](#section-16)`. Informative References`

`   `[`17`](#section-17)`. Acknowledgments`

`   `[`18`](#section-18)`. Contributors`
...
<a id="section-4"></a> **`4. General Description`**
...
<a id="section-5"></a> **`5. PW Switching and Attachment Circuit Type`**
...
<a id="section-6"></a> **`6. Applicability`**
...
<a id="section-7"></a> **`7. MPLS-PW to MPLS-PW Switching`**
...
<a id="section-7-1"></a> **`7.1. Static Control Plane Switching`**
...
<a id="section-7-2"></a> **`7.2. Two LDP Control Planes Using the Same FEC Type`**
...
<a id="section-7-2-1"></a> **`7.2.1. FEC 129 Active/Passive T-PE Election Procedure`**
...
<a id="section-7-3"></a> **`7.3. LDP Using FEC 128 to LDP Using the Generalized FEC 129`**
...
<a id="section-7-4"></a> **`7.4. LDP SP-PE TLV`**
...
<a id="section-7-4-1"></a> **`7.4.1. PW Switching Point PE Sub-TLVs`**
...
<a id="section-7-4-2"></a> **`7.4.2. Adaptation of Interface Parameters`**
...
<a id="section-7-5"></a> **`7.5. Group ID`**
...
<a id="section-7-6"></a> **`7.6. PW Loop Detection`**
...
<a id="section-8"></a> **`8. MPLS-PW to L2TPv3-PW Control Plane Switching`**
...
<a id="section-8-1"></a> **`8.1. Static MPLS and L2TPv3 PWs`**
...
<a id="section-8-2"></a> **`8.2. Static MPLS PW and Dynamic L2TPv3 PW`**
...
<a id="section-8-3"></a> **`8.3. Static L2TPv3 PW and Dynamic LDP/MPLS PW`**
...
<a id="section-8-4"></a> **`8.4. Dynamic LDP/MPLS and L2TPv3 PWs`**
...
<a id="section-8-4-1"></a> **`8.4.1. Session Establishment`**
...
<a id="section-8-4-2"></a> **`8.4.2. Adaptation of PW Status Message`**
...
<a id="section-8-4-3"></a> **`8.4.3. Session Tear Down`**
...
<a id="section-8-5"></a> **`8.5. Adaptation of L2TPv3 AVPs to Interface Parameters`**
...
<a id="section-8-6"></a> **`8.6. PW Switching Point PE TLV in L2TPv3`**
...
<a id="section-8-7"></a> **`8.7. L2TPv3 and MPLS PW Data Plane`**
...
<a id="section-8-7-1"></a> **`8.7.1. Mapping the MPLS Control Word to L2TP`**
...
<a id="section-9"></a> **`9. Operations, Administration, and Maintenance (OAM)`**

```text

```

<a id="section-9-1"></a> **`9.1. Extensions to VCCV to Support MS-PWs`**
...
<a id="section-9-2"></a> **`9.2. OAM from MPLS PW to L2TPv3 PW`**
...
<a id="section-9-3"></a> **`9.3. OAM Data Plane Indication from MPLS PW to MPLS PW`**
...
<a id="section-9-4"></a> **`9.4. Signaling OAM Capabilities for Switched Pseudowires`**
...
<a id="section-9-5"></a> **`9.5. OAM Capability for MS-PWs Demultiplexed Using MPLS`**
...
<a id="section-9-5-1"></a> **`9.5.1. MS-PW and VCCV CC Type 1`**
...
<a id="section-9-5-2"></a> **`9.5.2. MS-PW and VCCV CC Type 2`**
...
<a id="section-9-5-3"></a> **`9.5.3. MS-PW and VCCV CC Type 3`**
...
<a id="section-9-6"></a> **`9.6. MS-PW VCCV Operations`**
...
<a id="section-9-6-1"></a> **`9.6.1. VCCV Echo Message Processing`**
...
<a id="section-9-6-1-1"></a> **`9.6.1.1. Sending a VCCV Echo Request`**
...
<a id="section-9-6-1-2"></a> **`9.6.1.2. Receiving a VCCV Echo Request`**
...
<a id="section-9-6-1-3"></a> **`9.6.1.3. Receiving a VCCV Echo Reply`**
...
<a id="section-9-6-2"></a> **`9.6.2. Detailed VCCV Procedures`**
...
<a id="section-9-6-2-1"></a> **`9.6.2.1. End-to-End Connectivity Verification between T-PEs`**
...
<a id="section-9-6-2-2"></a> **`9.6.2.2. Partial Connectivity Verification from T-PE`**
...
<a id="section-9-6-2-3"></a> **`9.6.2.3. Partial Connectivity Verification between S-PEs`**
...
<a id="section-9-6-2-4"></a> **`9.6.2.4. MS-PW Path Verification`**
...
<a id="section-9-6-2-5"></a> **`9.6.2.5. MS-PW Path Trace`**
...
<a id="section-10"></a> **`10. Mapping Switched Pseudowire Status`**
...
<a id="section-10-1"></a> **`10.1. PW Status Messages Initiated by the S-PE`**
...
<a id="section-10-1-1"></a> **`10.1.1. Local PW2 Transmit Direction Fault`**
...
<a id="section-10-1-2"></a> **`10.1.2. Local PW1 Transmit Direction Fault`**
...
<a id="section-10-1-3"></a> **`10.1.3. Local PW2 Receive Direction Fault`**
...
<a id="section-10-1-4"></a> **`10.1.4. Local PW1 Receive Direction Fault`**
...
<a id="section-10-1-5"></a> **`10.1.5. Clearing Faults`**
...
<a id="section-10-2"></a> **`10.2. PW Status Messages and SP-PE TLV Processing`**
...
<a id="section-10-3"></a> **`10.3. T-PE Processing of PW Status Messages`**
...
<a id="section-10-4"></a> **`10.4. Pseudowire Status Negotiation Procedures`**
...
<a id="section-10-5"></a> **`10.5. Status Dampening`**
...
<a id="section-11"></a> **`11. Peering between Autonomous Systems`**
...
<a id="section-12"></a> **`12. Congestion Considerations`**
...
<a id="section-13-1"></a> **`13.1. Data Plane Security`**
...
<a id="section-13-1-1"></a> **`13.1.1. VCCV Security Considerations`**
...
<a id="section-13-2"></a> **`13.2. Control Protocol Security`**
...
<a id="section-14-1"></a> **`14.1. L2TPv3 AVP`**
...
<a id="section-14-2"></a> **`14.2. LDP TLV TYPE`**
...
<a id="section-14-3"></a> **`14.3. LDP Status Codes`**
...
<a id="section-14-4"></a> **`14.4. L2TPv3 Result Codes`**
...
<a id="section-14-5"></a> **`14.5. New IANA Registries`**
...
<a id="section-15"></a> **`15. Normative References`**
...
<a id="section-16"></a> **`16. Informative References`**
...
<a id="section-17"></a> **`17. Acknowledgments`**
...
<a id="section-18"></a> **`18. Contributors`**
