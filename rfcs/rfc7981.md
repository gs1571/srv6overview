...
`   `[`4`](#section-4)`. Interoperability with Routers Not Supporting the IS-IS Router`
...
<a id="section-4"></a> **`4. Interoperability with Routers Not Supporting the IS-IS Router`**
