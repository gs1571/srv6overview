...
<a id="section-2"></a> **`2. Assignment Policies for RSVP Entities`**
...
<a id="section-2-1"></a> **`2.1. Message Types`**
...
<a id="section-2-2"></a> **`2.2. Class Names and Numbers`**
...
<a id="section-2-3"></a> **`2.3. Class Types`**
...
<a id="section-2-3-1"></a> **`2.3.1. Sub-objects`**
...
<a id="section-2-4"></a> **`2.4. Virtual Destination Ports`**
...
<a id="section-2-5"></a> **`2.5. Error Codes and Values`**
...
<a id="section-3"></a> **`3. Modifying RSVP Procedures`**
