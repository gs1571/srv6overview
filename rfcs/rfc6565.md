...
`      `[`3.1`](#section-3-1)`. OSPFv3 Specificities`

`   `[`4`](#section-4)`. BGP/OSPFv3 Interaction Procedures for PE Routers`

`      `[`4.1`](#section-4-1)`. VRFs and OSPFv3 Instances`

`           `[`4.1.1`](#section-4-1-1)`. Independent OSPFv3 Instances in PEs`

`           `[`4.1.2`](#section-4-1-2)`. OSPFv3 Domain Identifier`

`      `[`4.2`](#section-4-2)`. OSPFv3 Areas`

`      `[`4.3`](#section-4-3)`. VRFs and Routes`

`           `[`4.3.1`](#section-4-3-1)`. OSPFv3 Routes on PEs`

`           `[`4.3.2`](#section-4-3-2)`. VPN-IPv6 Routes Received from MP-BGP`

`      `[`4.4`](#section-4-4)`. BGP Extended Communities Attribute`

`      `[`4.5`](#section-4-5)`. Loop Prevention Techniques`

`           `[`4.5.1`](#section-4-5-1)`. OSPFv3 Down Bit`

`           `[`4.5.2`](#section-4-5-2)`. Other Possible Loops`

`   `[`5`](#section-5)`. OSPFv3 Sham Links`

`      `[`5.1`](#section-5-1)`. Creating a Sham Link`

`      `[`5.2`](#section-5-2)`. OSPF Protocol on Sham Link`

`      `[`5.3`](#section-5-3)`. OSPF Packet Forwarding on Sham Link`

`   `[`6`](#section-6)`. Multiple Address Family Support`
...
<a id="section-3-1"></a> **`3.1. OSPFv3 Specificities`**
...
<a id="section-4"></a> **`4. BGP/OSPFv3 Interaction Procedures for PE Routers`**

```text

```

<a id="section-4-1"></a> **`4.1. VRFs and OSPFv3 Instances`**
...
<a id="section-4-1-1"></a> **`4.1.1. Independent OSPFv3 Instances in PEs`**
...
<a id="section-4-1-2"></a> **`4.1.2. OSPFv3 Domain Identifier`**
...
<a id="section-4-2"></a> **`4.2. OSPFv3 Areas`**
...
<a id="section-4-3"></a> **`4.3. VRFs and Routes`**
...
<a id="section-4-3-1"></a> **`4.3.1. OSPFv3 Routes on PEs`**
...
<a id="section-4-3-2"></a> **`4.3.2. VPN-IPv6 Routes Received from MP-BGP`**
...
<a id="section-4-3-2-1"></a> **`4.3.2.1. OSPF Inter-Area Routes`**
...
<a id="section-4-3-2-2"></a> **`4.3.2.2. OSPF Intra-Area Route`**
...
<a id="section-4-3-2-3"></a> **`4.3.2.3. OSPF External Routes and NSSA Routes`**
...
<a id="section-4-4"></a> **`4.4. BGP Extended Communities Attributes`**
...
<a id="section-4-5"></a> **`4.5. Loop Prevention Techniques`**
...
<a id="section-4-5-1"></a> **`4.5.1. OSPFv3 Down Bit`**
...
<a id="section-4-5-2"></a> **`4.5.2. Other Possible Loops`**
...
<a id="section-5"></a> **`5. OSPFv3 Sham Links`**
...
<a id="section-5-1"></a> **`5.1. Creating a Sham Link`**
...
<a id="section-5-2"></a> **`5.2. OSPF Protocol on Sham Link`**
...
<a id="section-5-3"></a> **`5.3. OSPF Packet Forwarding on Sham Link`**
...
<a id="section-6"></a> **`6. Multiple Address Family Support`**
