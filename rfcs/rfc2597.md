...
<a id="section-1"></a> **`1. Purpose and Overview`**
...
<a id="section-2"></a> **`2. The AF PHB Group`**
...
<a id="section-3"></a> **`3. Traffic Conditioning Actions`**
...
<a id="section-4"></a> **`4. Queueing and Discard Behavior`**
...
<a id="section-6"></a> **`6. Recommended Codepoints`**
...
<a id="section-7"></a> **`7. Interactions with Other PHB Groups`**
...
<a id="section-8"></a> **`8. Security Implications`**
