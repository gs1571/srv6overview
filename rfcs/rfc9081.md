...
**Consensus:** true
**IPR:** trust200902
**Doc Name:** draft-ietf-bess-mvpn-msdp-sa-interoperation-08
...
- [prev](https://datatracker.ietf.org/doc/draft-ietf-bess-mvpn-msdp-sa-interoperation-08)
- [alternate](https://dx.doi.org/10.17487/rfc9081)
...
Information about the current status of this document, any
            ...
            [https://www.rfc-editor.org/info/rfc9081](https://www.rfc-editor.org/info/rfc9081).
...
Section [ "Supporting 
      PIM-SM without Inter-Site Shared C-Trees"](#RFC6514) of
       [RFC6514](#RFC6514) specifies the procedures for MVPN PEs to discover (C-S,C-G)
...
[RFC6514](#RFC6514) only specifies that a PE receiving the MVPN SA routes,
       ...
       [RFC6514](#RFC6514) does not specify that PE2 advertises MSDP SA messages to those
...
- VPN extranet [RFC2764](#RFC2764) mechanisms can be used to propagate (C-S,C-G)
...
The procedures apply to Global Table Multicast (GTM) [RFC7716](#RFC7716) as well.
...
For comparison, another method of supporting customer ASM is generally
       ...
       C-Tree to a Source C-Tree"](#RFC6514) of [RFC6514](#RFC6514) specifies the MVPN SA procedures
...
Familiarity with MVPN [RFC6513](#RFC6513) [RFC6514](#RFC6514) and MSDP [RFC3618](#RFC3618) protocols and procedures is assumed.
...
The key words "**MUST**", "**MUST NOT**", "**REQUIRED**", "**SHALL**", "**SHALL NOT**", "**SHOULD**", "**SHOULD NOT**", "**RECOMMENDED**", "**NOT RECOMMENDED**",
          ...
          described in BCP 14 [RFC2119](#RFC2119) [RFC8174](#RFC8174) when, and only when, they appear in all
...
When an MVPN PE advertises an MVPN SA route following procedures in
       [RFC6514](#RFC6514) for the "spt-only" mode,
...
In addition to the procedures in [RFC6514](#RFC6514), an MVPN PE may be provisioned
...
[RFC6514](#RFC6514) specifies the procedure for a PE to generate an MVPN SA upon 
...
[RFC6514](#RFC6514) and [RFC3618](#RFC3618).  Moreover, the 
...
<a name="RFC3618"></a> **[RFC3618]** B. Fenner, D. Meyer, "Multicast Source Discovery Protocol (MSDP)", RFC 3618, DOI 10.17487/RFC3618, October 2003. <https://www.rfc-editor.org/info/rfc3618> [Local MD](rfc3618.md)
...
<a name="RFC2764"></a> **[RFC2764]** B. Gleeson, A. Lin, J. Heinanen, G. Armitage, A. Malis, "A Framework for IP Based Virtual Private Networks", RFC 2764, DOI 10.17487/RFC2764, February 2000. <https://www.rfc-editor.org/info/rfc2764> [Local MD](rfc2764.md)
...
<a name="RFC7716"></a> **[RFC7716]** J. Zhang, L. Giuliano, E. Rosen, K. Subramanian, D. Pacella, "Global Table Multicast with BGP Multicast VPN (BGP-MVPN) Procedures", RFC 7716, DOI 10.17487/RFC7716, December 2015. <https://www.rfc-editor.org/info/rfc7716> [Local MD](rfc7716.md)

<a name="Acknowledgements"></a>
# Acknowledgements

The authors thank Eric Rosen,
         Vinod Kumar, Yajun Liu,
         Stig Venaas,
         Mankamana Mishra,
         Gyan Mishra, Qin Wu,
         and Jia He for their reviews, comments,
