...
`   `[`2`](#section-2)`. Extended Administrative Groups Sub-TLV`

`     `[`2.1`](#section-2-1)`. Packet Format`

`     `[`2.2`](#section-2-2)`. Admin Group Numbering`

`     `[`2.3`](#section-2-3)`. Backward Compatibility`

`       `[`2.3.1`](#section-2-3-1)`. AG and EAG Coexistence`

`       `[`2.3.2`](#section-2-3-2)`. Desire for Unadvertised EAG Bits`
...
<a id="section-2"></a> **`2. Extended Administrative Groups Sub-TLV`**
...
<a id="section-2-1"></a> **`2.1. Packet Format`**
...
<a id="section-2-2"></a> **`2.2. Admin Group Numbering`**
...
<a id="section-2-3"></a> **`2.3. Backward Compatibility`**
...
<a id="section-2-3-1"></a> **`2.3.1. AG and EAG Coexistence`**
...
<a id="section-2-3-2"></a> **`2.3.2. Desire for Unadvertised EAG Bits`**
