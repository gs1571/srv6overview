...
`   `[`2`](#section-2)`. Technical Overview of ISP Traffic Engineering`

`   `[`3`](#section-3)`. Applicability of Internet Traffic Engineering`

`   `[`3`](#section-3)`. 1 Avoidance of Congested Resources`

`   `[`3`](#section-3)`. 2 Resource Utilization in Network Topologies with Parallel Links`

`   `[`3`](#section-3)`. 3 Implementing Routing Policies using Affinities`

`   `[`3`](#section-3)`. 4 Re-optimization After Restoration`

`   `[`4`](#section-4)`. Implementation Considerations`

`   `[`4`](#section-4)`. 1 Architectural and Operational Considerations`

`   `[`4`](#section-4)`. 2 Network Management Aspects`

`   `[`4`](#section-4)`. 3 Capacity Engineering Aspects`

`   `[`4`](#section-4)`. 4 Network Measurement Aspects`

`   `[`5`](#section-5)`. Limitations`
...
<a id="section-2"></a> **`2. Technical Overview of ISP Traffic Engineering`**
...
<a id="section-3"></a> **`3. Applicability of Internet Traffic Engineering`**
...
<a id="section-4"></a> **`4. Implementation Considerations`**
...
<a id="section-5"></a> **`5. Limitations`**
