...
<a id="section-1-3"></a> **`1.3. Structure of this Document`**
...
<a id="section-3"></a> **`3. Dual IP Layer`**
...
<a id="section-3-1"></a> **`3.1. Address Configuration`**
...
<a id="section-3-1-1"></a> **`3.1.1. IPv4 Loopback Address`**
...
<a id="section-3-2-1"></a> **`3.2.1. Handling Records for IPv4-Compatible Addresses`**
...
<a id="section-4"></a> **`4. IPv6-over-IPv4 Tunneling`**
...
<a id="section-4-1"></a> **`4.1. Common Tunneling Mechanisms`**
...
<a id="section-4-1-1"></a> **`4.1.1. Tunnel MTU and Fragmentation`**
...
<a id="section-4-1-2"></a> **`4.1.2. Hop Limit`**
...
<a id="section-4-1-3"></a> **`4.1.3. Handling IPv4 ICMP errors`**
...
<a id="section-4-1-4"></a> **`4.1.4. IPv4 Header Construction`**
...
<a id="section-4-1-5"></a> **`4.1.5. Decapsulating IPv6-in-IPv4 Packets`**
...
<a id="section-4-2"></a> **`4.2. Configured Tunneling`**
...
<a id="section-4-2-1"></a> **`4.2.1. Default Configured Tunnel`**
...
<a id="section-4-3"></a> **`4.3. Automatic Tunneling`**
...
<a id="section-4-4"></a> **`4.4. Default Sending Algorithm`**
