...
`      `[`3.1`](#section-3-1)`. PCE Discovery Information`

`      `[`3.2`](#section-3-2)`. Flooding Scope`

`   `[`4`](#section-4)`. The OSPF PCED TLV`

`      `[`4.1`](#section-4-1)`. PCE-ADDRESS Sub-TLV`

`      `[`4.2`](#section-4-2)`. PATH-SCOPE Sub-TLV`

`      `[`4.3`](#section-4-3)`. PCE-DOMAIN Sub-TLV`

`      `[`4.4`](#section-4-4)`. NEIG-PCE-DOMAIN Sub-TLV`

`      `[`4.5`](#section-4-5)`. PCE-CAP-FLAGS Sub-TLV`

`   `[`5`](#section-5)`. Elements of Procedure`

`   `[`6`](#section-6)`. Backward Compatibility`

`   `[`7`](#section-7)`. IANA Considerations`

`      `[`7.1`](#section-7-1)`. OSPF TLV`

`      `[`7.2`](#section-7-2)`. PCE Capability Flags Registry`

`   `[`8`](#section-8)`. Security Considerations`

`   `[`9`](#section-9)`. Manageability Considerations`

`      `[`9.1`](#section-9-1)`. Control of Policy and Functions`

`      `[`9.2`](#section-9-2)`. Information and Data Model`
...
<a id="section-3-1"></a> **`3.1. PCE Discovery Information`**
...
<a id="section-3-2"></a> **`3.2. Flooding Scope`**
...
<a id="section-4"></a> **`4. The OSPF PCED TLV`**
...
<a id="section-4-1"></a> **`4.1. PCE-ADDRESS Sub-TLV`**
...
<a id="section-4-2"></a> **`4.2. PATH-SCOPE Sub-TLV`**
...
<a id="section-4-3"></a> **`4.3. PCE-DOMAIN Sub-TLV`**
...
<a id="section-4-4"></a> **`4.4. NEIG-PCE-DOMAIN Sub-TLV`**
...
<a id="section-4-5"></a> **`4.5. PCE-CAP-FLAGS Sub-TLV`**
...
<a id="section-6"></a> **`6. Backward Compatibility`**
...
<a id="section-7-1"></a> **`7.1. OSPF TLV`**
...
<a id="section-7-2"></a> **`7.2. PCE Capability Flags Registry`**
...
<a id="section-9-1"></a> **`9.1. Control of Policy and Functions`**
...
<a id="section-9-2"></a> **`9.2. Information and Data Model`**
