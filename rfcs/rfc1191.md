...
`       `[`2`](#section-2)`. Protocol overview                                            3`

`       `[`3`](#section-3)`. Host specification                                           4`

`           `[`3.1`](#section-3-1)`. TCP MSS Option                                         5`

`       `[`4`](#section-4)`. Router specification                                         6`

`       `[`5`](#section-5)`. Host processing of old-style messages                        7`

`       `[`6`](#section-6)`. Host implementation                                          8`

`           `[`6.1`](#section-6-1)`. Layering                                               9`

`           `[`6.2`](#section-6-2)`. Storing PMTU information                              10`

`           `[`6.3`](#section-6-3)`. Purging stale PMTU information                        11`

`           `[`6.4`](#section-6-4)`. TCP layer actions                                     13`

`           `[`6.5`](#section-6-5)`. Issues for other transport protocols                  14`

`           `[`6.6`](#section-6-6)`. Management interface                                  15`

`       `[`7`](#section-7)`. Likely values for Path MTUs                                 15`

`           `[`7.1`](#section-7-1)`. A better way to detect PMTU increases                 16`

`       `[`8`](#section-8)`. Security considerations                                     18`
...
<a id="section-3"></a> **`3. Host specification`**
...
<a id="section-3-1"></a> **`3.1. TCP MSS Option`**
...
<a id="section-4"></a> **`4. Router specification`**
...
<a id="section-5"></a> **`5. Host processing of old-style messages`**
...
<a id="section-6"></a> **`6. Host implementation`**
...
<a id="section-6-1"></a> **`6.1. Layering`**
...
<a id="section-6-2"></a> **`6.2. Storing PMTU information`**
...
<a id="section-6-3"></a> **`6.3. Purging stale PMTU information`**
...
<a id="section-6-4"></a> **`6.4. TCP layer actions`**
...
<a id="section-6-5"></a> **`6.5. Issues for other transport protocols`**
...
<a id="section-6-6"></a> **`6.6. Management interface`**
...
<a id="section-7"></a> **`7. Likely values for Path MTUs`**
...
<a id="section-7-1"></a> **`7.1. A better way to detect PMTU increases`**
