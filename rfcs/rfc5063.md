...
`   `[`4`](#section-4)`. Extensions to Nodal Fault Handling`

`      `[`4.1`](#section-4-1)`. RecoveryPath Message Format`

`      `[`4.2`](#section-4-2)`. Capability Object`

`           `[`4.2.1`](#section-4-2-1)`. Conformance`

`      `[`4.3`](#section-4-3)`. Related Procedures`

`      `[`4.4`](#section-4-4)`. Procedures for the Capability Object`

`           `[`4.4.1`](#section-4-4-1)`. Procedures for the Downstream Neighbor`

`           `[`4.4.2`](#section-4-4-2)`. Procedures for the Restarting Node`

`      `[`4.5`](#section-4-5)`. Procedures for the RecoveryPath Message`

`           `[`4.5.1`](#section-4-5-1)`. Procedures for the Downstream Neighbor`

`           `[`4.5.2`](#section-4-5-2)`. Procedures for the Restarting Node`

`                  `[`4.5.2.1`](#section-4-5-2-1)`. Path and RecoveryPath Message Procedures`

`                  `[`4.5.2.2`](#section-4-5-2-2)`. Re-Synchronization Procedures`

`                  `[`4.5.2.3`](#section-4-5-2-3)`. Procedures on Expiration of`

`                           Recovery Period`

`      `[`4.6`](#section-4-6)`. Compatibility`

`   `[`5`](#section-5)`. RecoveryPath Summary Refresh`

`      `[`5.1`](#section-5-1)`. MESSAGE_ID ACK/NACK and MESSAGE_ID LIST Objects`

`      `[`5.2`](#section-5-2)`. RecoveryPath Srefresh Capable Bit`

`           `[`5.2.1`](#section-5-2-1)`. Procedures`

`           `[`5.2.2`](#section-5-2-2)`. Compatibility`

`      `[`5.3`](#section-5-3)`. RecoveryPath Summary Refresh Procedures`

`           `[`5.3.1`](#section-5-3-1)`. Generation of RecoveryPath-Related Srefresh`

`                  Messages`

`           `[`5.3.2`](#section-5-3-2)`. RecoveryPath-Related Srefresh Receive`

`                  Processing and NACK Generation`

`           `[`5.3.3`](#section-5-3-3)`. RecoveryPath-Related MESSAGE_ID NACK`
...
<a id="section-4"></a> **`4. Extensions to Nodal Fault Handling`**
...
<a id="section-4-1"></a> **`4.1. RecoveryPath Message Format`**
...
<a id="section-4-2"></a> **`4.2. Capability Object`**
...
<a id="section-4-2-1"></a> **`4.2.1. Conformance`**
...
<a id="section-4-3"></a> **`4.3. Related Procedures`**
...
<a id="section-4-4"></a> **`4.4. Procedures for the Capability Object`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. Procedures for the Downstream Neighbor`**
...
<a id="section-4-4-2"></a> **`4.4.2. Procedures for the Restarting Node`**
...
<a id="section-4-5"></a> **`4.5. Procedures for the RecoveryPath Message`**

```text

```

<a id="section-4-5-1"></a> **`4.5.1. Procedures for the Downstream Neighbor`**
...
<a id="section-4-5-2"></a> **`4.5.2. Procedures for the Restarting Node`**
...
<a id="section-4-5-2-1"></a> **`4.5.2.1. Path and RecoveryPath Message Procedures`**
...
<a id="section-4-5-2-2"></a> **`4.5.2.2. Re-Synchronization Procedures`**
...
<a id="section-4-5-2-3"></a> **`4.5.2.3. Procedures on Expiration of Recovery Period`**
...
<a id="section-4-6"></a> **`4.6. Compatibility`**
...
<a id="section-5"></a> **`5. RecoveryPath Summary Refresh`**
...
<a id="section-5-1"></a> **`5.1. MESSAGE_ID ACK/NACK and MESSAGE_ID LIST Objects`**
...
<a id="section-5-2"></a> **`5.2. RecoveryPath Srefresh Capable Bit`**
...
<a id="section-5-2-2"></a> **`5.2.2. Compatibility`**
...
<a id="section-5-3"></a> **`5.3. RecoveryPath Summary Refresh Procedures`**
...
<a id="section-5-3-1"></a> **`5.3.1. Generation of RecoveryPath-Related Srefresh Messages`**
...
<a id="section-5-3-2"></a> **`5.3.2. RecoveryPath-Related Srefresh Receive Processing and NACK`**
...
<a id="section-5-3-3"></a> **`5.3.3. RecoveryPath-Related MESSAGE_ID NACK Receive Processing`**
