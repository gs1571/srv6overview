...
`   `[`2`](#section-2)`. IPv6 Prefix Allocation`

`   `[`2`](#section-2)`. 1 Address Selection`

`   `[`3`](#section-3)`. Encapsulation in IPv4`

`   `[`3.1`](#section-3-1)`. Link-Local Address and NUD`

`   `[`4`](#section-4)`. Maximum Transmission Unit`

`   `[`5`](#section-5)`. Unicast scenarios, scaling, and transition to normal prefixes 8`

`   `[`5`](#section-5)`. 1 Simple scenario - all sites work the same`

`   `[`5`](#section-5)`. 2 Mixed scenario with relay to native IPv6`

`   `[`5.2`](#section-5-2)`. 1 Variant scenario with ISP relay`

`   `[`5.2`](#section-5-2)`. 2 Summary of relay router configuration`

`   `[`5.2.2.1`](#section-5-2-2-1)`. BGP4+ not used`

`   `[`5.2.2.2`](#section-5-2-2-2)`. BGP4+ used`

`   `[`5.2.2.3`](#section-5-2-2-3)`. Relay router scaling`

`   `[`5.2`](#section-5-2)`. 3 Unwilling to relay`

`   `[`5`](#section-5)`. 3 Sending and decapsulation rules`

`   `[`5`](#section-5)`. 4 Variant scenario with tunnel to IPv6 space`

`   `[`5`](#section-5)`. 5 Fragmented Scenarios`

`   `[`5`](#section-5)`. 6 Multihoming`

`   `[`5`](#section-5)`. 7 Transition Considerations`

`   `[`5`](#section-5)`. 8 Coexistence with firewall, NAT or RSIP`

`   `[`5`](#section-5)`. 9 Usage within Intranets`

`   `[`5`](#section-5)`. 10 Summary of impact on routing`

`   `[`5.11`](#section-5-11)`. Routing loop prevention`

`   `[`6`](#section-6)`. Multicast and Anycast`

`   `[`7`](#section-7)`. ICMP messages`
...
<a id="section-2"></a> **`2. IPv6 Prefix Allocation`**
...
<a id="section-3"></a> **`3. Encapsulation in IPv4`**
...
<a id="section-3-1"></a> **`3.1. Link-Local Address and NUD`**
...
<a id="section-4"></a> **`4. Maximum Transmission Unit`**
...
<a id="section-5"></a> **`5. Unicast scenarios, scaling, and transition to normal prefixes`**
...
<a id="section-5-2-2-1"></a> **`5.2.2.1. BGP4+ not used`**
...
<a id="section-5-2-2-2"></a> **`5.2.2.2. BGP4+ used`**
...
<a id="section-5-2-2-3"></a> **`5.2.2.3. Relay router scaling`**
...
<a id="section-5-11"></a> **`5.11. Routing loop prevention`**
...
<a id="section-6"></a> **`6. Multicast and Anycast`**
...
<a id="section-7"></a> **`7. ICMP messages`**
