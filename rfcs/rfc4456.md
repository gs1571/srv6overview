...
`   `[`3`](#section-3)`. Design Criteria`

`   `[`4`](#section-4)`. Route Reflection`

`   `[`5`](#section-5)`. Terminology and Concepts`

`   `[`6`](#section-6)`. Operation`

`   `[`7`](#section-7)`. Redundant RRs`

`   `[`8`](#section-8)`. Avoiding Routing Information Loops`

`   `[`9`](#section-9)`. Impact on Route Selection`

`   `[`10`](#section-10)`. Implementation Considerations`

`   `[`11`](#section-11)`. Configuration and Deployment Considerations`
...
<a id="section-3"></a> **`3. Design Criteria`**
...
<a id="section-4"></a> **`4. Route Reflection`**
...
<a id="section-5"></a> **`5. Terminology and Concepts`**
...
<a id="section-7"></a> **`7. Redundant RRs`**
...
<a id="section-8"></a> **`8. Avoiding Routing Information Loops`**
...
<a id="section-9"></a> **`9. Impact on Route Selection`**
...
<a id="section-10"></a> **`10. Implementation Considerations`**
...
<a id="section-11"></a> **`11. Configuration and Deployment Considerations`**
