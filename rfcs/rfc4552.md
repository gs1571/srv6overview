...
`   `[`2`](#section-2)`. Transport Mode vs. Tunnel Mode`

`   `[`3`](#section-3)`. Authentication`

`   `[`4`](#section-4)`. Confidentiality`

`   `[`5`](#section-5)`. Distinguishing OSPFv3 from OSPFv2`

`   `[`6`](#section-6)`. IPsec Requirements`

`   `[`7`](#section-7)`. Key Management`

`   `[`8`](#section-8)`. SA Granularity and Selectors`

`   `[`9`](#section-9)`. Virtual Links`

`   `[`10`](#section-10)`. Rekeying`

`      `[`10.1`](#section-10-1)`. Rekeying Procedure`

`      `[`10.2`](#section-10-2)`. KeyRolloverInterval`

`      `[`10.3`](#section-10-3)`. Rekeying Interval`

`   `[`11`](#section-11)`. IPsec Protection Barrier and SPD`

`   `[`12`](#section-12)`. Entropy of Manual Keys`

`   `[`13`](#section-13)`. Replay Protection`
...
<a id="section-2"></a> **`2. Transport Mode vs. Tunnel Mode`**
...
<a id="section-3"></a> **`3. Authentication`**
...
<a id="section-4"></a> **`4. Confidentiality`**
...
<a id="section-5"></a> **`5. Distinguishing OSPFv3 from OSPFv2`**
...
<a id="section-6"></a> **`6. IPsec Requirements`**
...
<a id="section-7"></a> **`7. Key Management`**
...
<a id="section-8"></a> **`8. SA Granularity and Selectors`**
...
<a id="section-9"></a> **`9. Virtual Links`**
...
<a id="section-10-1"></a> **`10.1. Rekeying Procedure`**
...
<a id="section-10-2"></a> **`10.2. KeyRolloverInterval`**
...
<a id="section-10-3"></a> **`10.3. Rekeying Interval`**
...
<a id="section-11"></a> **`11. IPsec Protection Barrier and SPD`**
...
<a id="section-12"></a> **`12. Entropy of Manual Keys`**
...
<a id="section-13"></a> **`13. Replay Protection`**
