...
`   `[`2`](#section-2)`. Routine and Major Extensions`

`      `[`2.1`](#section-2-1)`. What Constitutes a Major Extension?`

`      `[`2.2`](#section-2-2)`. When is an Extension Routine?`

`   `[`3`](#section-3)`. Architectural Principles`

`      `[`3.1`](#section-3-1)`. Limited Extensibility`

`      `[`3.2`](#section-3-2)`. Design for Global Interoperability`

`      `[`3.3`](#section-3-3)`. Architectural Compatibility`

`      `[`3.4`](#section-3-4)`. Protocol Variations`

`      `[`3.5`](#section-3-5)`. Testability`

`      `[`3.6`](#section-3-6)`. Protocol Parameter Registration`

`      `[`3.7`](#section-3-7)`. Extensions to Critical Protocols`

`   `[`4`](#section-4)`. Considerations for the Base Protocol`

`      `[`4.1`](#section-4-1)`. Version Numbers`

`      `[`4.2`](#section-4-2)`. Reserved Fields`

`      `[`4.3`](#section-4-3)`. Encoding Formats`

`      `[`4.4`](#section-4-4)`. Parameter Space Design`

`      `[`4.5`](#section-4-5)`. Cryptographic Agility`

`      `[`4.6`](#section-4-6)`. Transport`

`      `[`4.7`](#section-4-7)`. Handling of Unknown Extensions`
...
`   `[`8`](#section-8)`. IAB Members at the Time of Approval`
...
<a id="section-2"></a> **`2. Routine and Major Extensions`**
...
<a id="section-2-1"></a> **`2.1. What Constitutes a Major Extension?`**
...
<a id="section-2-2"></a> **`2.2. When is an Extension Routine?`**
...
<a id="section-3"></a> **`3. Architectural Principles`**
...
<a id="section-3-1"></a> **`3.1. Limited Extensibility`**
...
<a id="section-3-2"></a> **`3.2. Design for Global Interoperability`**
...
<a id="section-3-2-1"></a> **`3.2.1. Private Extensions`**
...
<a id="section-3-2-2"></a> **`3.2.2. Local Use`**
...
<a id="section-3-2-3"></a> **`3.2.3. Multi-Site Experiments`**
...
<a id="section-3-3"></a> **`3.3. Architectural Compatibility`**
...
<a id="section-3-4"></a> **`3.4. Protocol Variations`**
...
<a id="section-3-4-1"></a> **`3.4.1. Profiles`**
...
<a id="section-3-5"></a> **`3.5. Testability`**
...
<a id="section-3-6"></a> **`3.6. Protocol Parameter Registration`**
...
<a id="section-3-7"></a> **`3.7. Extensions to Critical Protocols`**
...
<a id="section-4"></a> **`4. Considerations for the Base Protocol`**
...
<a id="section-4-1"></a> **`4.1. Version Numbers`**
...
<a id="section-4-2"></a> **`4.2. Reserved Fields`**
...
<a id="section-4-3"></a> **`4.3. Encoding Formats`**
...
<a id="section-4-4"></a> **`4.4. Parameter Space Design`**
...
<a id="section-4-5"></a> **`4.5. Cryptographic Agility`**
...
<a id="section-4-6"></a> **`4.6. Transport`**
...
<a id="section-4-7"></a> **`4.7. Handling of Unknown Extensions`**
...
<a id="section-8"></a> **`8. IAB Members at the Time of Approval`**
