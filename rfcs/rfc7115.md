...
`   `[`4`](#section-4)`. Within a Network`

`   `[`5`](#section-5)`. Routing Policy`

`   `[`6`](#section-6)`. Notes and Recommendations`
...
<a id="section-4"></a> **`4. Within a Network`**
...
<a id="section-5"></a> **`5. Routing Policy`**
...
<a id="section-6"></a> **`6. Notes and Recommendations`**
