...
`   `[`3`](#section-3)`. NLRI Distribution`

`      `[`3.1`](#section-3-1)`. Inter-AS VPN Route Distribution`

`      `[`3.2`](#section-3-2)`. Intra-AS VPN Route Distribution`

`   `[`4`](#section-4)`. Route Target Membership NLRI Advertisements`
...
<a id="section-3"></a> **`3. NLRI Distribution`**

```text

```

<a id="section-3-1"></a> **`3.1. Inter-AS VPN Route Distribution`**
...
<a id="section-3-2"></a> **`3.2. Intra-AS VPN Route Distribution`**
...
<a id="section-4"></a> **`4. Route Target Membership NLRI Advertisements`**
