...
- [2. Segment Routing Identifiers](#section-2)
  - [2.1. Prefix Segment Identifier (Prefix-SID) Sub-TLV](#section-2.1)
    - [2.1.1. Flags](#section-2.1.1)
    - [2.1.2. Prefix-SID Propagation](#section-2.1.2)
  - [2.2. Adjacency Segment Identifier](#section-2.2)
    - [2.2.1. Adjacency Segment Identifier (Adj-SID) Sub-TLV](#section-2.2.1)
    - [2.2.2. Adjacency Segment Identifier (LAN-Adj-SID) Sub-TLV](#section-2.2.2)
  - [2.3. SID/Label Sub-TLV](#section-2.3)
  - [2.4. SID/Label Binding TLV](#section-2.4)
    ...
    - [2.4.5. SID/Label Sub-TLV](#section-2.4.5)
    - [2.4.6. Example Encodings](#section-2.4.6)
  - [2.5. Multi-Topology SID/Label Binding TLV](#section-2.5)
- [3. Router Capabilities](#section-3)
  - [3.1. SR-Capabilities Sub-TLV](#section-3.1)
  - [3.2. SR-Algorithm Sub-TLV](#section-3.2)
  - [3.3. SR Local Block Sub-TLV](#section-3.3)
  - [3.4. SRMS Preference Sub-TLV](#section-3.4)
- [4. IANA Considerations](#section-4)
...
<a name="RFC8660"></a> **[RFC8660]** A Bashandy, C Filsfils, S Previdi, B Decraene, S Litkowski, R Shakir, "Segment Routing with the MPLS Data Plane", December 2019. <https://www.rfc-editor.org/info/rfc8660>
...
<a name="RFC5311"></a> **[RFC5311]** D. McPherson, L. Ginsberg, S. Previdi, M. Shand, "Simplified Extension of Link State PDU (LSP) Space for IS-IS", RFC 5311, DOI 10.17487/RFC5311, February 2009. <https://www.rfc-editor.org/info/rfc5311>
