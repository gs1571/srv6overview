...
`     `[`1.1`](#section-1-1)`. Failure Scenarios`

`     `[`1.2`](#section-1-2)`. Requirement Language`

`   `[`2`](#section-2)`. Applicability of Described Mechanisms`

`   `[`3`](#section-3)`. Alternate Next-Hop Calculation`

`     `[`3.1`](#section-3-1)`. Basic Loop-Free Condition`

`     `[`3.2`](#section-3-2)`. Node-Protecting Alternate Next-Hops`

`     `[`3.3`](#section-3-3)`. Broadcast and Non-Broadcast Multi-Access (NBMA) Links  .`

`     `[`3.4`](#section-3-4)`. ECMP and Alternates`

`     `[`3.5`](#section-3-5)`. Interactions with IS-IS Overload, RFC 3137, and Costed`

`           Out Links`

`       `[`3.5.1`](#section-3-5-1)`. Interactions with IS-IS Link Attributes`

`     `[`3.6`](#section-3-6)`. Selection Procedure`

`     `[`3.7`](#section-3-7)`. LFA Types and Trade-Offs`

`     `[`3.8`](#section-3-8)`. A Simplification: Per-Next-Hop LFAs`

`   `[`4`](#section-4)`. Using an Alternate`

`     `[`4.1`](#section-4-1)`. Terminating Use of Alternate`

`   `[`5`](#section-5)`. Requirements on LDP Mode`

`   `[`6`](#section-6)`. Routing Aspects`

`     `[`6.1`](#section-6-1)`. Multi-Homed Prefixes`

`     `[`6.2`](#section-6-2)`. IS-IS`

`     `[`6.3`](#section-6-3)`. OSPF`

`       `[`6.3.1`](#section-6-3-1)`. OSPF External Routing`

`       `[`6.3.2`](#section-6-3-2)`. OSPF Multi-Topology`

`     `[`6.4`](#section-6-4)`. BGP Next-Hop Synchronization`

`     `[`6.5`](#section-6-5)`. Multicast Considerations`
...
<a id="section-1-1"></a> **`1.1. Failure Scenarios`**
...
<a id="section-1-2"></a> **`1.2. Requirement Language`**
...
<a id="section-2"></a> **`2. Applicability of Described Mechanisms`**
...
<a id="section-3"></a> **`3. Alternate Next-Hop Calculation`**
...
<a id="section-3-1"></a> **`3.1. Basic Loop-Free Condition`**
...
<a id="section-3-2"></a> **`3.2. Node-Protecting Alternate Next-Hops`**
...
<a id="section-3-3"></a> **`3.3. Broadcast and Non-Broadcast Multi-Access (NBMA) Links`**
...
<a id="section-3-4"></a> **`3.4. ECMP and Alternates`**
...
<a id="section-3-5"></a> **`3.5. Interactions with IS-IS Overload, RFC 3137, and Costed Out Links`**
...
<a id="section-3-5-1"></a> **`3.5.1. Interactions with IS-IS Link Attributes`**
...
<a id="section-3-6"></a> **`3.6. Selection Procedure`**
...
<a id="section-3-7"></a> **`3.7. LFA Types and Trade-Offs`**
...
<a id="section-3-8"></a> **`3.8. A Simplification: Per-Next-Hop LFAs`**
...
<a id="section-4"></a> **`4. Using an Alternate`**
...
<a id="section-4-1"></a> **`4.1. Terminating Use of Alternate`**
...
<a id="section-5"></a> **`5. Requirements on LDP Mode`**
...
<a id="section-6"></a> **`6. Routing Aspects`**

```text

```

<a id="section-6-1"></a> **`6.1. Multi-Homed Prefixes`**
...
<a id="section-6-3-1"></a> **`6.3.1. OSPF External Routing`**
...
<a id="section-6-3-2"></a> **`6.3.2. OSPF Multi-Topology`**
...
<a id="section-6-4"></a> **`6.4. BGP Next-Hop Synchronization`**
...
<a id="section-6-5"></a> **`6.5. Multicast Considerations`**
