...
`      `[`2.1`](#section-2-1)`. A Note on Non-Objectives`

`      `[`2.2`](#section-2-2)`. Per-Domain Path Determination`

`      `[`2.3`](#section-2-3)`. Backward Recursive Path Computation`

`   `[`3`](#section-3)`. Extensions to ISIS-TE`

`      `[`3.1`](#section-3-1)`. Inter-AS Reachability TLV`

`      `[`3.2`](#section-3-2)`. TE Router ID`

`      `[`3.3`](#section-3-3)`. Sub-TLV Detail`

`           `[`3.3.1`](#section-3-3-1)`. Remote AS Number Sub-TLV`

`           `[`3.3.2`](#section-3-3-2)`. IPv4 Remote ASBR ID Sub-TLV`

`           `[`3.3.3`](#section-3-3-3)`. IPv6 Remote ASBR ID Sub-TLV`

`           `[`3.3.4`](#section-3-3-4)`. IPv4 TE Router ID sub-TLV`

`           `[`3.3.5`](#section-3-3-5)`. IPv6 TE Router ID sub-TLV`

`   `[`4`](#section-4)`. Procedure for Inter-AS TE Links`

`      `[`4.1`](#section-4-1)`. Origin of Proxied TE Information`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. IANA Considerations`

`      `[`6.1`](#section-6-1)`. Inter-AS Reachability TLV`

`      `[`6.2`](#section-6-2)`. Sub-TLVs for the Inter-AS Reachability TLV`

`      `[`6.3`](#section-6-3)`. Sub-TLVs for the IS-IS Router Capability TLV`
...
<a id="section-2"></a> **`2. Problem Statement`**
...
<a id="section-2-1"></a> **`2.1. A Note on Non-Objectives`**
...
<a id="section-2-2"></a> **`2.2. Per-Domain Path Determination`**
...
<a id="section-2-3"></a> **`2.3. Backward Recursive Path Computation`**
...
<a id="section-3"></a> **`3. Extensions to ISIS-TE`**
...
<a id="section-3-1"></a> **`3.1. Inter-AS Reachability TLV`**
...
<a id="section-3-2"></a> **`3.2. TE Router ID`**
...
<a id="section-3-3"></a> **`3.3. Sub-TLV Detail`**

```text

```

<a id="section-3-3-1"></a> **`3.3.1. Remote AS Number Sub-TLV`**
...
<a id="section-3-3-2"></a> **`3.3.2. IPv4 Remote ASBR ID Sub-TLV`**
...
<a id="section-3-3-3"></a> **`3.3.3. IPv6 Remote ASBR ID Sub-TLV`**
...
<a id="section-3-3-4"></a> **`3.3.4. IPv4 TE Router ID sub-TLV`**
...
<a id="section-3-3-5"></a> **`3.3.5. IPv6 TE Router ID sub-TLV`**
...
<a id="section-4"></a> **`4. Procedure for Inter-AS TE Links`**
...
<a id="section-4-1"></a> **`4.1. Origin of Proxied TE Information`**
...
<a id="section-6-1"></a> **`6.1. Inter-AS Reachability TLV`**
...
<a id="section-6-2"></a> **`6.2. Sub-TLVs for the Inter-AS Reachability TLV`**
...
<a id="section-6-3"></a> **`6.3. Sub-TLVs for the IS-IS Router Capability TLV`**
