...
`   `[`2`](#section-2)`. PCC-PCE Communication Requirements`

`   `[`3`](#section-3)`. Protocol Procedures and Extensions`

`      `[`3.1`](#section-3-1)`. P2MP Capability Advertisement`

`           `[`3.1.1`](#section-3-1-1)`. IGP Extensions for P2MP Capability Advertisement`

`           `[`3.1.2`](#section-3-1-2)`. Open Message Extension`

`      `[`3.2`](#section-3-2)`. Efficient Presentation of P2MP LSPs`

`      `[`3.3`](#section-3-3)`. P2MP Path Computation Request/Reply Message Extensions`

`           `[`3.3.1`](#section-3-3-1)`. The Extension of the RP Object`

`           `[`3.3.2`](#section-3-3-2)`. The P2MP END-POINTS Object`

`      `[`3.4`](#section-3-4)`. Request Message Format`

`      `[`3.5`](#section-3-5)`. Reply Message Format`

`      `[`3.6`](#section-3-6)`. P2MP Objective Functions and Metric Types`

`           `[`3.6.1`](#section-3-6-1)`. Objective Functions`

`           `[`3.6.2`](#section-3-6-2)`. METRIC Object-Type Values`

`      `[`3.7`](#section-3-7)`. Non-Support of P2MP Path Computation`

`      `[`3.8`](#section-3-8)`. Non-Support by Back-Level PCE Implementations`

`      `[`3.9`](#section-3-9)`. P2MP TE Path Reoptimization Request`

`      `[`3.10`](#section-3-10)`. Adding and Pruning Leaves to/from the P2MP Tree`

`      `[`3.11`](#section-3-11)`. Discovering Branch Nodes`

`           `[`3.11.1`](#section-3-11-1)`. Branch Node Object`

`      `[`3.12`](#section-3-12)`. Synchronization of P2MP TE Path Computation Requests`

`      `[`3.13`](#section-3-13)`. Request and Response Fragmentation`

`           `[`3.13.1`](#section-3-13-1)`. Request Fragmentation Procedure`

`           `[`3.13.2`](#section-3-13-2)`. Response Fragmentation Procedure`

`           `[`3.13.3`](#section-3-13-3)`. Fragmentation Example`

`      `[`3.14`](#section-3-14)`. UNREACH-DESTINATION Object`

`      `[`3.15`](#section-3-15)`. P2MP PCEP-ERROR Objects and Types`

`      `[`3.16`](#section-3-16)`. PCEP NO-PATH Indicator`

`   `[`4`](#section-4)`. Manageability Considerations`

`      `[`4.1`](#section-4-1)`. Control of Function and Policy`

`      `[`4.2`](#section-4-2)`. Information and Data Models`

`      `[`4.3`](#section-4-3)`. Liveness Detection and Monitoring`

`      `[`4.4`](#section-4-4)`. Verifying Correct Operation`

`      `[`4.5`](#section-4-5)`. Requirements for Other Protocols and Functional`

`           Components`

`      `[`4.6`](#section-4-6)`. Impact on Network Operation`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. IANA Considerations`

`      `[`6.1`](#section-6-1)`. PCEP TLV Type Indicators`

`      `[`6.2`](#section-6-2)`. Request Parameter Bit Flags`

`      `[`6.3`](#section-6-3)`. Objective Functions`

`      `[`6.4`](#section-6-4)`. METRIC Object-Type Values`

`      `[`6.5`](#section-6-5)`. PCEP Objects`

`      `[`6.6`](#section-6-6)`. PCEP-ERROR Objects and Types`

`      `[`6.7`](#section-6-7)`. PCEP NO-PATH Indicator`

`      `[`6.8`](#section-6-8)`. SVEC Object Flag`

`      `[`6.9`](#section-6-9)`. OSPF PCE Capability Flag`
...
<a id="section-2"></a> **`2. PCC-PCE Communication Requirements`**
...
<a id="section-3"></a> **`3. Protocol Procedures and Extensions`**
...
<a id="section-3-1"></a> **`3.1. P2MP Capability Advertisement`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. IGP Extensions for P2MP Capability Advertisement`**
...
<a id="section-3-1-2"></a> **`3.1.2. Open Message Extension`**
...
<a id="section-3-2"></a> **`3.2. Efficient Presentation of P2MP LSPs`**
...
<a id="section-3-3"></a> **`3.3. P2MP Path Computation Request/Reply Message Extensions`**
...
<a id="section-3-3-1"></a> **`3.3.1. The Extension of the RP Object`**
...
<a id="section-3-3-2"></a> **`3.3.2. The P2MP END-POINTS Object`**
...
<a id="section-3-4"></a> **`3.4. Request Message Format`**
...
<a id="section-3-5"></a> **`3.5. Reply Message Format`**
...
<a id="section-3-6"></a> **`3.6. P2MP Objective Functions and Metric Types`**

```text

```

<a id="section-3-6-1"></a> **`3.6.1. Objective Functions`**
...
<a id="section-3-6-2"></a> **`3.6.2. METRIC Object-Type Values`**
...
<a id="section-3-7"></a> **`3.7. Non-Support of P2MP Path Computation`**
...
<a id="section-3-8"></a> **`3.8. Non-Support by Back-Level PCE Implementations`**
...
<a id="section-3-9"></a> **`3.9. P2MP TE Path Reoptimization Request`**
...
<a id="section-3-10"></a> **`3.10. Adding and Pruning Leaves to/from the P2MP Tree`**
...
<a id="section-3-11"></a> **`3.11. Discovering Branch Nodes`**
...
<a id="section-3-11-1"></a> **`3.11.1. Branch Node Object`**
...
<a id="section-3-12"></a> **`3.12. Synchronization of P2MP TE Path Computation Requests`**
...
<a id="section-3-13"></a> **`3.13. Request and Response Fragmentation`**
...
<a id="section-3-13-1"></a> **`3.13.1. Request Fragmentation Procedure`**
...
<a id="section-3-13-2"></a> **`3.13.2. Response Fragmentation Procedure`**
...
<a id="section-3-13-3"></a> **`3.13.3. Fragmentation Example`**
...
<a id="section-3-14"></a> **`3.14. UNREACH-DESTINATION Object`**
...
<a id="section-3-15"></a> **`3.15. P2MP PCEP-ERROR Objects and Types`**
...
<a id="section-3-16"></a> **`3.16. PCEP NO-PATH Indicator`**
...
<a id="section-4"></a> **`4. Manageability Considerations`**
...
<a id="section-4-1"></a> **`4.1. Control of Function and Policy`**
...
<a id="section-4-2"></a> **`4.2. Information and Data Models`**
...
<a id="section-4-3"></a> **`4.3. Liveness Detection and Monitoring`**
...
<a id="section-4-4"></a> **`4.4. Verifying Correct Operation`**
...
<a id="section-4-5"></a> **`4.5. Requirements for Other Protocols and Functional Components`**
...
<a id="section-4-6"></a> **`4.6. Impact on Network Operation`**
...
<a id="section-6-1"></a> **`6.1. PCEP TLV Type Indicators`**
...
<a id="section-6-2"></a> **`6.2. Request Parameter Bit Flags`**
...
<a id="section-6-3"></a> **`6.3. Objective Functions`**
...
<a id="section-6-4"></a> **`6.4. METRIC Object-Type Values`**
...
<a id="section-6-5"></a> **`6.5. PCEP Objects`**
...
<a id="section-6-6"></a> **`6.6. PCEP-ERROR Objects and Types`**
...
<a id="section-6-7"></a> **`6.7. PCEP NO-PATH Indicator`**
...
<a id="section-6-8"></a> **`6.8. SVEC Object Flag`**
...
<a id="section-6-9"></a> **`6.9. OSPF PCE Capability Flag`**
