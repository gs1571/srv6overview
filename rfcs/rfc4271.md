...
`      `[`1.1`](#section-1-1)`. Definition of Commonly Used Terms`

`      `[`1.2`](#section-1-2)`. Specification of Requirements`

`   `[`2`](#section-2)`. Acknowledgements`

`   `[`3`](#section-3)`. Summary of Operation`

`      `[`3.1`](#section-3-1)`. Routes: Advertisement and Storage`

`      `[`3.2`](#section-3-2)`. Routing Information Base`

`   `[`4`](#section-4)`. Message Formats`

`      `[`4.1`](#section-4-1)`. Message Header Format`

`      `[`4.2`](#section-4-2)`. OPEN Message Format`

`      `[`4.3`](#section-4-3)`. UPDATE Message Format`

`      `[`4.4`](#section-4-4)`. KEEPALIVE Message Format`

`      `[`4.5`](#section-4-5)`. NOTIFICATION Message Format`

`   `[`5`](#section-5)`. Path Attributes`

`      `[`5.1`](#section-5-1)`. Path Attribute Usage`

`           `[`5.1.1`](#section-5-1-1)`. ORIGIN`

`           `[`5.1.2`](#section-5-1-2)`. AS_PATH`

`           `[`5.1.3`](#section-5-1-3)`. NEXT_HOP`

`           `[`5.1.4`](#section-5-1-4)`. MULTI_EXIT_DISC`

`           `[`5.1.5`](#section-5-1-5)`. LOCAL_PREF`

`           `[`5.1.6`](#section-5-1-6)`. ATOMIC_AGGREGATE`

`           `[`5.1.7`](#section-5-1-7)`. AGGREGATOR`

`   `[`6`](#section-6)`. BGP Error Handling.`

`      `[`6.1`](#section-6-1)`. Message Header Error Handling`

`      `[`6.2`](#section-6-2)`. OPEN Message Error Handling`

`      `[`6.3`](#section-6-3)`. UPDATE Message Error Handling`

`      `[`6.4`](#section-6-4)`. NOTIFICATION Message Error Handling`

`      `[`6.5`](#section-6-5)`. Hold Timer Expired Error Handling`

`      `[`6.6`](#section-6-6)`. Finite State Machine Error Handling`

`      `[`6.7`](#section-6-7)`. Cease`

`      `[`6.8`](#section-6-8)`. BGP Connection Collision Detection`

`   `[`7`](#section-7)`. BGP Version Negotiation`

`   `[`8`](#section-8)`. BGP Finite State Machine (FSM)`

`      `[`8.1`](#section-8-1)`. Events for the BGP FSM`

`           `[`8.1.1`](#section-8-1-1)`. Optional Events Linked to Optional Session`

`                  Attributes`

`           `[`8.1.2`](#section-8-1-2)`. Administrative Events`

`           `[`8.1.3`](#section-8-1-3)`. Timer Events`

`           `[`8.1.4`](#section-8-1-4)`. TCP Connection-Based Events`

`           `[`8.1.5`](#section-8-1-5)`. BGP Message-Based Events`

`      `[`8.2`](#section-8-2)`. Description of FSM`

`           `[`8.2.1`](#section-8-2-1)`. FSM Definition`

`                  `[`8.2.1.1`](#section-8-2-1-1)`. Terms "active" and "passive"`

`                  `[`8.2.1.2`](#section-8-2-1-2)`. FSM and Collision Detection`

`                  `[`8.2.1.3`](#section-8-2-1-3)`. FSM and Optional Session Attributes`

`                  `[`8.2.1.4`](#section-8-2-1-4)`. FSM Event Numbers`

`                  `[`8.2.1.5`](#section-8-2-1-5)`. FSM Actions that are Implementation`

`                           Dependent`

`           `[`8.2.2`](#section-8-2-2)`. Finite State Machine`

`   `[`9`](#section-9)`. UPDATE Message Handling`

`      `[`9.1`](#section-9-1)`. Decision Process`

`           `[`9.1.1`](#section-9-1-1)`. Phase 1: Calculation of Degree of Preference`

`           `[`9.1.2`](#section-9-1-2)`. Phase 2: Route Selection`

`                  `[`9.1.2.1`](#section-9-1-2-1)`. Route Resolvability Condition`

`                  `[`9.1.2.2`](#section-9-1-2-2)`. Breaking Ties (Phase 2)`

`           `[`9.1.3`](#section-9-1-3)`. Phase 3: Route Dissemination`

`           `[`9.1.4`](#section-9-1-4)`. Overlapping Routes`

`      `[`9.2`](#section-9-2)`. Update-Send Process`

`           `[`9.2.1`](#section-9-2-1)`. Controlling Routing Traffic Overhead`

`                  `[`9.2.1.1`](#section-9-2-1-1)`. Frequency of Route Advertisement`

`                  `[`9.2.1.2`](#section-9-2-1-2)`. Frequency of Route Origination`

`           `[`9.2.2`](#section-9-2-2)`. Efficient Organization of Routing Information`

`                  `[`9.2.2.1`](#section-9-2-2-1)`. Information Reduction`

`                  `[`9.2.2.2`](#section-9-2-2-2)`. Aggregating Routing Information`

`      `[`9.3`](#section-9-3)`. Route Selection Criteria`

`      `[`9.4`](#section-9-4)`. Originating BGP routes`

`   `[`10`](#section-10)`. BGP Timers`
...
<a id="section-1-1"></a> **`1.1. Definition of Commonly Used Terms`**
...
<a id="section-2"></a> **`2. Acknowledgements`**
...
<a id="section-3"></a> **`3. Summary of Operation`**
...
<a id="section-3-1"></a> **`3.1. Routes: Advertisement and Storage`**
...
<a id="section-3-2"></a> **`3.2. Routing Information Base`**
...
<a id="section-4-1"></a> **`4.1. Message Header Format`**
...
<a id="section-4-2"></a> **`4.2. OPEN Message Format`**
...
<a id="section-4-3"></a> **`4.3. UPDATE Message Format`**
...
<a id="section-4-4"></a> **`4.4. KEEPALIVE Message Format`**
...
<a id="section-4-5"></a> **`4.5. NOTIFICATION Message Format`**
...
<a id="section-5"></a> **`5. Path Attributes`**
...
<a id="section-5-1"></a> **`5.1. Path Attribute Usage`**
...
<a id="section-5-1-1"></a> **`5.1.1. ORIGIN`**
...
<a id="section-5-1-2"></a> **`5.1.2. AS_PATH`**
...
<a id="section-5-1-3"></a> **`5.1.3. NEXT_HOP`**
...
<a id="section-5-1-4"></a> **`5.1.4. MULTI_EXIT_DISC`**
...
<a id="section-5-1-5"></a> **`5.1.5. LOCAL_PREF`**
...
<a id="section-5-1-6"></a> **`5.1.6. ATOMIC_AGGREGATE`**
...
<a id="section-5-1-7"></a> **`5.1.7. AGGREGATOR`**
...
<a id="section-6"></a> **`6. BGP Error Handling.`**
...
<a id="section-6-1"></a> **`6.1. Message Header Error Handling`**
...
<a id="section-6-2"></a> **`6.2. OPEN Message Error Handling`**
...
<a id="section-6-3"></a> **`6.3. UPDATE Message Error Handling`**
...
<a id="section-6-4"></a> **`6.4. NOTIFICATION Message Error Handling`**
...
<a id="section-6-5"></a> **`6.5. Hold Timer Expired Error Handling`**
...
<a id="section-6-6"></a> **`6.6. Finite State Machine Error Handling`**
...
<a id="section-6-8"></a> **`6.8. BGP Connection Collision Detection`**
...
<a id="section-7"></a> **`7. BGP Version Negotiation`**
...
<a id="section-8"></a> **`8. BGP Finite State Machine (FSM)`**
...
<a id="section-8-1"></a> **`8.1. Events for the BGP FSM`**

```text

```

<a id="section-8-1-1"></a> **`8.1.1. Optional Events Linked to Optional Session Attributes`**
...
<a id="section-8-1-2"></a> **`8.1.2. Administrative Events`**
...
<a id="section-8-1-3"></a> **`8.1.3. Timer Events`**
...
<a id="section-8-1-4"></a> **`8.1.4. TCP Connection-Based Events`**
...
<a id="section-8-1-5"></a> **`8.1.5. BGP Message-Based Events`**
...
<a id="section-8-2"></a> **`8.2. Description of FSM`**

```text

```

<a id="section-8-2-1"></a> **`8.2.1. FSM Definition`**
...
<a id="section-8-2-1-1"></a> **`8.2.1.1. Terms "active" and "passive"`**
...
<a id="section-8-2-1-2"></a> **`8.2.1.2. FSM and Collision Detection`**
...
<a id="section-8-2-1-3"></a> **`8.2.1.3. FSM and Optional Session Attributes`**
...
<a id="section-8-2-1-4"></a> **`8.2.1.4. FSM Event Numbers`**
...
<a id="section-8-2-1-5"></a> **`8.2.1.5. FSM Actions that are Implementation Dependent`**
...
<a id="section-8-2-2"></a> **`8.2.2. Finite State Machine`**
...
<a id="section-9"></a> **`9. UPDATE Message Handling`**
...
<a id="section-9-1"></a> **`9.1. Decision Process`**
...
<a id="section-9-1-1"></a> **`9.1.1. Phase 1: Calculation of Degree of Preference`**
...
<a id="section-9-1-2"></a> **`9.1.2. Phase 2: Route Selection`**
...
<a id="section-9-1-2-1"></a> **`9.1.2.1. Route Resolvability Condition`**
...
<a id="section-9-1-2-2"></a> **`9.1.2.2. Breaking Ties (Phase 2)`**
...
<a id="section-9-1-3"></a> **`9.1.3. Phase 3: Route Dissemination`**
...
<a id="section-9-1-4"></a> **`9.1.4. Overlapping Routes`**
...
<a id="section-9-2"></a> **`9.2. Update-Send Process`**
...
<a id="section-9-2-1"></a> **`9.2.1. Controlling Routing Traffic Overhead`**
...
<a id="section-9-2-1-1"></a> **`9.2.1.1. Frequency of Route Advertisement`**
...
<a id="section-9-2-1-2"></a> **`9.2.1.2. Frequency of Route Origination`**
...
<a id="section-9-2-2"></a> **`9.2.2. Efficient Organization of Routing Information`**
...
<a id="section-9-2-2-1"></a> **`9.2.2.1. Information Reduction`**
...
<a id="section-9-2-2-2"></a> **`9.2.2.2. Aggregating Routing Information`**
...
<a id="section-9-3"></a> **`9.3. Route Selection Criteria`**
...
<a id="section-9-4"></a> **`9.4. Originating BGP routes`**
...
<a id="section-10"></a> **`10. BGP Timers`**
