...
**Consensus:** true
**IPR:** trust200902
**Doc Name:** draft-ietf-lsr-flex-algo-26
...
- [prev](https://datatracker.ietf.org/doc/draft-ietf-lsr-flex-algo-26)
- [alternate](https://dx.doi.org/10.17487/rfc9350)
- [alternate](urn:issn:2070-1721)

## Abstract

IGP protocols historically compute the best paths over the network based
...
- [2. Requirements Language](#reqlang)
- [3. Terminology](#TERMINOLOGY)
- [4. Flexible Algorithm](#FLEXALG)
- [5. Flexible Algorithm Definition Advertisement](#FLEXALGDEF)
  - [5.1. IS-IS Flexible Algorithm Definition Sub-TLV](#ISISFLEXALGTLV)
  - [5.2. OSPF Flexible Algorithm Definition TLV](#OSPFFLEXALGTLV)
  - [5.3. Common Handling of the Flexible Algorithm Definition TLV](#COMMONLEXALGTLV)
- [6. Sub-TLVs of IS-IS FAD Sub-TLV](#ISISFADLTLVS)
  - [6.1. IS-IS Flexible Algorithm Exclude Admin Group Sub-TLV](#ISISFLEXALGEXLTLV)
  - [6.2. IS-IS Flexible Algorithm Include-Any Admin Group Sub-TLV](#ISISFLEXALGINCANYTLV)
  - [6.3. IS-IS Flexible Algorithm Include-All Admin Group Sub-TLV](#ISISFLEXALGINCALLTLV)
  - [6.4. IS-IS Flexible Algorithm Definition Flags Sub-TLV](#ISISFLEXALGFLAG)
  - [6.5. IS-IS Flexible Algorithm Exclude SRLG Sub-TLV](#ISISFLEXALGEXSRLGTLV)
- [7. Sub-TLVs of the OSPF FAD TLV](#OSPFFADLTLVS)
  - [7.1. OSPF Flexible Algorithm Exclude Admin Group Sub-TLV](#OSPFFLEXALGEXLTLV)
  - [7.2. OSPF Flexible Algorithm Include-Any Admin Group Sub-TLV](#OSPFFLEXALGINCANYTLV)
  - [7.3. OSPF Flexible Algorithm Include-All Admin Group Sub-TLV](#OSPFFLEXALGINCALLTLV)
  - [7.4. OSPF Flexible Algorithm Definition Flags Sub-TLV](#OSPFFLEXALGFLAG)
  - [7.5. OSPF Flexible Algorithm Exclude SRLG Sub-TLV](#OSPFFLEXALGEXSRLGTLV)
- [8. IS-IS Flexible Algorithm Prefix Metric Sub-TLV](#ISISFLEXMETRIC)
- [9. OSPF Flexible Algorithm Prefix Metric Sub-TLV](#OSPFFLEXMETRIC)
- [10. OSPF Flexible Algorithm ASBR Reachability Advertisement](#OSPFASBR)
  - [10.1. OSPFv2 Extended Inter-Area ASBR LSA](#OSPFEXTASBRLSA)
    - [10.1.1. OSPFv2 Extended Inter-Area ASBR TLV](#OSPFEXTASBRTLV)
  - [10.2. OSPF Flexible Algorithm ASBR Metric Sub-TLV](#OSPFFAASBRMETRIC)
- [11. Advertisement of Node Participation in a Flex-Algorithm](#FLEXALGPART)
  - [11.1. Advertisement of Node Participation for Segment Routing](#FLEXALGPARTSR)
  - [11.2. Advertisement of Node Participation for Other Data Planes](#FLEXALGPARTOTHER)
- [12. Advertisement of Link Attributes for Flex-Algorithm](#FLEXALGLINKATTR)
- [13. Calculation of Flexible Algorithm Paths](#FLEXALGPATHCALC)
  - [13.1. Multi-area and Multi-domain Considerations](#FLEXALGPATHCALCINTER)
- [14. Flex-Algorithm and Forwarding Plane](#FLEXALFORW)
  - [14.1. Segment Routing MPLS Forwarding for Flex-Algorithm](#FLEXALGPSRFORW)
  - [14.2. SRv6 Forwarding for Flex-Algorithm](#FLEXALGPSRV6FORW)
  - [14.3. Other Data Planes' Forwarding for Flex-Algorithm](#FLEXALGPSRFORWOTHER)
- [15. Operational Considerations](#section-15)
  - [15.1. Inter-area Considerations](#section-15.1)
  - [15.2. Usage of the SRLG Exclude Rule with Flex-Algorithm](#section-15.2)
  - [15.3. Max-Metric Consideration](#section-15.3)
  - [15.4. Flexible Algorithm Definition and Changes](#section-15.4)
  - [15.5. Number of Flex-Algorithms](#section-15.5)
- [16. Backward Compatibility](#section-16)
- [17. Security Considerations](#section-17)
- [18. IANA Considerations](#IANA)
  - [18.1. IGP IANA Considerations](#IANAIGP)
    - [18.1.1. IGP Algorithm Types Registry](#IANAIGPIGPALGTYPE)
    - [18.1.2. IGP Metric-Type Registry](#IGPMETRICTYPE)
  - [18.2. IGP Flexible Algorithm Definition Flags Registry](#IANAFADFLGAS)
  - [18.3. IS-IS IANA Considerations](#IANAISIS)
    - [18.3.1. IS-IS Sub-TLVs for IS-IS Router CAPABILITY TLV Registry](#SUBTLVS)
    - [18.3.2. IS-IS Sub-TLVs for TLVs Advertising Prefix Reachability Registry](#SUBTLVS135)
    - [18.3.3. IS-IS Sub-Sub-TLVs for Flexible Algorithm Definition Sub-TLV Registry](#SUBTLVREGISTRY)
  - [18.4. OSPF IANA Considerations](#IANAOSPF)
    - [18.4.1. OSPF Router Information (RI) TLVs Registry](#RITLVREG)
    - [18.4.2. OSPFv2 Extended Prefix TLV Sub-TLVs Registry](#SUBTLVEXTPFX)
    - [18.4.3. OSPFv3 Extended-LSA Sub-TLVs Registry](#SUBTLVV3EXTLSA)
    - [18.4.4. OSPF Flex-Algorithm Prefix Metric Bits Registry](#FAPMFLAGS)
    - [18.4.5. Opaque Link-State Advertisements (LSA) Option Types Registry](#OPQLSAOPTS)
    - [18.4.6. OSPFv2 Extended Inter-Area ASBR TLVs Registry](#IAASBRTLV)
    - [18.4.7. OSPFv2 Extended Inter-Area ASBR Sub-TLVs Registry](#IAASBRSTLV)
    - [18.4.8. OSPF Flexible Algorithm Definition TLV Sub-TLVs Registry](#section-18.4.8)
    - [18.4.9. Link Attribute Application Identifiers Registry](#section-18.4.9)
- [19. References](#section-19)
  - [19.1. Normative References](#section-19.1)
  - [19.2. Informative References](#section-19.2)
...
An IGP-computed path based on the shortest IGP metric is often
      ...
      the best IGP path may not reflect the best path from such a user's perspective.
...
To overcome this limitation, various sorts of Traffic Engineering
      ...
      paths and mechanisms, like the one described in [RFC3906](#RFC3906), and are
...
This document also specifies a way for a router to use IGPs to
      ...
      Prefix-SIDs [RFC8660](#RFC8660) or Segment Routing over IPv6 (SRv6) 
      locators [RFC8986](#RFC8986) with a particular Flex-Algorithm. Each 
      ...
      that holds the binding to the algorithm.
...
**Flexible Algorithm Participation:**
  per the data plane configuration
...
**IGP Algorithm:**
  value from the IANA "IGP Algorithm Types" registry
...
Many possible constraints may be used to compute a path over a
      ...
      of constraint can include some extended metric, as described in [RFC8570](#RFC8570). Constraints that restrict paths to links with
      specific affinities or avoid links with specific affinities are also
      possible. Combinations of these are also possible.

To provide maximum flexibility, a mechanism is provided that
      ...
      consistent and traffic is not subject to any looping.

The set consisting of (a) a calculation-type, (b) a metric-type, and (c)
...
To guarantee loop-free forwarding for paths computed for a
      ...
      definition of the Flex-Algorithm. The following procedures
  	  ensure this condition is fulfilled.

<a name="ISISFLEXALGTLV"></a>
## IS-IS Flexible Algorithm Definition Sub-TLV

The IS-IS Flexible Algorithm Definition (FAD) sub-TLV is
        used to advertise the definition of the Flex-Algorithm.

The IS-IS FAD sub-TLV is advertised as a sub-TLV of the IS-IS Router
        CAPABILITY TLV-242, which is defined in [RFC7981](#RFC7981).
...
**where:**
  ...
  **Flex-Algorithm:**
    Flexible Algorithm number. Single octet value between 
                  128 and 255 inclusive.

  **Metric-Type:**
    type of metric from the IANA "IGP Metric-Type" registry
    		([Section 18.1.2](#IGPMETRICTYPE)) to be used during the
    		calculation. The following values are defined:

    **0:**
      IGP Metric

    **1:**
      Min Unidirectional Link Delay, as defined in [RFC8570](#RFC8570), encoded as an application-specific link attribute, as specified in [RFC8919](#RFC8919) and [Section 12](#FLEXALGLINKATTR) of this document.

    **2:**
      Traffic Engineering Default Metric, as defined in [RFC5305](#RFC5305), encoded as an
      		  application-specific link attribute, as specified in [RFC8919](#RFC8919) and [Section 12](#FLEXALGLINKATTR) of this document.


  **Calc-Type:**
    calculation-type. Value from 0-127 inclusive from the IANA "IGP
                  ...
                  Algorithm is used. The Metric/Constraints **MUST NOT** be
    	      inherited.
                  If the required calculation-type is Shortest Path First, the value
                  0 **MUST** appear in this field.

  **Priority:**
    value between 0 and 255 inclusive that specifies the
                  priority of the advertisement. Numerically greater values are preferred.
                  Usage of the priority is described in [Section 5.3](#COMMONLEXALGTLV).
...
The IS-IS FAD sub-TLV **MAY** be advertised in a Label Switched Path (LSP) of any number. 
        The IS-IS router **MAY** advertise more than one IS-IS FAD sub-TLV for a given
        Flexible Algorithm (see [Section 6](#ISISFADLTLVS)).

The IS-IS FAD sub-TLV has an area/level scope. The Router Capability TLV
...
<a name="OSPFFLEXALGTLV"></a>
## OSPF Flexible Algorithm Definition TLV

The OSPF FAD TLV is advertised as a top-level TLV of the Router Information (RI)
        Link State Advertisement (LSA), which is defined in [RFC7770](#RFC7770).
...
**where:**
  ...
  **Metric-Type:**
    ...
    **1:**
      Min Unidirectional Link Delay, as defined in [RFC7471](#RFC7471), encoded as an
      	      application-specific link attribute, as specified in [RFC8920](#RFC8920) and [Section 12](#FLEXALGLINKATTR) of
                    this document.

    **2:**
      Traffic Engineering Metric, as defined in [RFC3630](#RFC3630), encoded as an
      	      application-specific link attribute, as specified in [RFC8920](#RFC8920) and [Section 12](#FLEXALGLINKATTR) of
                    this document.


  **Calc-Type:**
    as described in [Section 5.1](#ISISFLEXALGTLV).
...
When multiple OSPF FAD TLVs, for the same Flexible Algorithm, are
        ...
        in the RI LSA with the area-scoped flooding scope **MUST**
...
The RI LSA can be advertised at any of the defined opaque flooding
        ...
        AS flooding scope **SHOULD NOT** be used unless
        local configuration policy on the originating router indicates domain-wide
	flooding.

<a name="COMMONLEXALGTLV"></a>
## Common Handling of the Flexible Algorithm Definition TLV
...
Only a subset of the routers participating in the particular
        Flex-Algorithm need to advertise the definition of the
        Flex-Algorithm.

Every router that is configured to participate in a particular
        ...
        different definitions for a given Flex-Algorithm:

1. From the advertisements of the FAD in the area (including
...
2. If there are multiple advertisements of the FAD with the
	  ...
	  Router ID, in the case of OSPFv2 and OSPFv3. For IS-IS, the System-ID is
          described in [ISO10589](#ISO10589). For OSPFv2 and OSPFv3,
          the standard Router ID is described in [RFC2328](#RFC2328) and [RFC5340](#RFC5340),
	  respectively.

The FAD selected according to these rules is also known as the 
  		"winning FAD".

A router that is not configured to participate in a particular
        Flex-Algorithm **MUST** ignore FAD sub-TLV advertisements for such
        Flex-Algorithm.

A router that is not participating in a particular Flex-Algorithm
        **MAY** advertise the FAD for such Flex-Algorithm. Receiving routers
...
If a node is configured to participate in a particular
        ...
        participation for such Flexible Algorithm, as specified in [Section 11](#FLEXALGPART), and it **MUST** remove any forwarding state
        associated with it.

The Flex-Algorithm Definition is topology independent. It applies to
        all topologies that a router participates in.

<a name="ISISFADLTLVS"></a>
# Sub-TLVs of IS-IS FAD Sub-TLV

One of the limitations of IS-IS [ISO10589](#ISO10589) is that the length of 
    ...
    In such cases, the FAD **MAY** be split into multiple such sub-TLVs, and the content of 
    the multiple FAD sub-TLVs are combined to provide a complete FAD for the Flex-Algorithm. 
    In such a case, the fixed portion of the FAD (see [Section 5.1](#ISISFLEXALGTLV)) 
    **MUST** be identical in all FAD sub-TLVs for a given Flex-Algorithm from a given IS. 
    ...
    in the fixed portion in the FAD sub-TLV in the first occurrence in the lowest-numbered LSP from a given IS **MUST** be used.

Any specification that introduces a new IS-IS FAD sub-sub-TLV **MUST** specify whether 
    the FAD sub-TLV may appear multiple times in the set of FAD sub-TLVs for a given 
    Flex-Algorithm from a given IS and how to handle them if multiple are allowed.

<a name="ISISFLEXALGEXLTLV"></a>
## IS-IS Flexible Algorithm Exclude Admin Group Sub-TLV

The Flexible Algorithm Definition can specify "colors" that are
        used by the operator to exclude links during the Flex-Algorithm path
        computation.

The IS-IS Flexible Algorithm Exclude Admin Group (FAEAG) sub-TLV is used to
        advertise the exclude rule that is used during the Flex-Algorithm path
        calculation, as specified in [Section 13](#FLEXALGPATHCALC).
...
**where:**
  ...
  **Extended Administrative Group:**
    Extended Administrative Group, as
                  defined in [RFC7308](#RFC7308).



The IS-IS FAEAG sub-TLV **MUST NOT** appear more than once in a single IS-IS
        FAD sub-TLV. If it appears more than once, the IS-IS FAD sub-TLV **MUST**
        be ignored by the receiver.

The IS-IS FAEAG sub-TLV **MUST NOT** appear more than once in the set of FAD 
...
<a name="ISISFLEXALGINCANYTLV"></a>
## IS-IS Flexible Algorithm Include-Any Admin Group Sub-TLV
...
The IS-IS Flexible Algorithm Include-Any Admin Group sub-TLV is used
        ...
        path calculation, as specified in [Section 13](#FLEXALGPATHCALC).

The IS-IS Flexible Algorithm Include-Any Admin Group
...
The IS-IS Flexible Algorithm Include-Any Admin Group sub-TLV **MUST NOT** appear more than once in a single IS-IS FAD sub-TLV. If it appears more
        than once, the IS-IS FAD sub-TLV **MUST** be ignored by the receiver.

The IS-IS Flexible Algorithm Include-Any Admin Group sub-TLV **MUST NOT** appear 
...
<a name="ISISFLEXALGINCALLTLV"></a>
## IS-IS Flexible Algorithm Include-All Admin Group Sub-TLV
...
The IS-IS Flexible Algorithm Include-All Admin Group
        sub-TLV is a sub-TLV of the IS-IS FAD sub-TLV. It has the following
        format:
...
The IS-IS Flexible Algorithm Include-All Admin Group sub-TLV **MUST NOT** appear more than once in a single IS-IS FAD sub-TLV. If it appears more
        than once, the IS-IS FAD sub-TLV **MUST** be ignored by the receiver.

The IS-IS Flexible Algorithm Include-All Admin Group sub-TLV **MUST NOT** appear 
        more than once in the set of FAD sub-TLVs for a given Flex-Algorithm from a given IS. 
...
<a name="ISISFLEXALGFLAG"></a>
## IS-IS Flexible Algorithm Definition Flags Sub-TLV

The IS-IS Flexible Algorithm Definition Flags (FADF) sub-TLV
...
The IS-IS FADF sub-TLV **MUST NOT** appear more than once in a single IS-IS FAD
        sub-TLV. If it appears more than once, the IS-IS FAD sub-TLV **MUST** be
        ignored by the receiver.

The IS-IS FADF sub-TLV **MUST NOT** appear more than once in the set of FAD 
        sub-TLVs for a given Flex-Algorithm from a given IS. If it appears more than once
        in such a set, the IS-IS FADF sub-TLV in the first occurrence in the lowest-numbered LSP from a given IS **MUST** be used, and any other occurrences **MUST** be ignored.

If the IS-IS FADF sub-TLV is not present inside the IS-IS FAD
        sub-TLV, all the bits are assumed to be set to 0.

If a node is configured to participate in a particular Flexible Algorithm, 
...
New flag bits may be defined in the future. Implementations **MUST** check all 
        advertised flag bits in the received IS-IS FADF sub-TLV -- not just the subset 
        currently defined.

The M-flag **MUST** not be used when calculating prefix reachability for the SRv6 
        Locator prefix.

<a name="ISISFLEXALGEXSRLGTLV"></a>
## IS-IS Flexible Algorithm Exclude SRLG Sub-TLV

The Flexible Algorithm Definition can specify Shared Risk Link
...
**where:**
  ...
  **Length:**
    variable, dependent on number of SRLG values. **MUST** be a
                  multiple of 4 octets.

  **Shared Risk Link Group Value:**
    SRLG value, as defined in [RFC5307](#RFC5307).



The IS-IS FAESRLG sub-TLV **MUST NOT** appear more than once in a single IS-IS FAD
        sub-TLV. If it appears more than once, the IS-IS FAD sub-TLV **MUST** be
        ignored by the receiver.
...
The IS-IS FAESRLG sub-TLV **MAY** appear more than once in the set of FAD 
        ...
        use the union of all values across all IS-IS FAESRLG sub-TLVs from such set.

<a name="OSPFFADLTLVS"></a>
# Sub-TLVs of the OSPF FAD TLV

<a name="OSPFFLEXALGEXLTLV"></a>
## OSPF Flexible Algorithm Exclude Admin Group Sub-TLV

The OSPF Flexible Algorithm Exclude Admin Group (FAEAG) sub-TLV
        is a sub-TLV of the OSPF FAD TLV. Its usage is described in [Section 6.1](#ISISFLEXALGEXLTLV). It has the following format:
...
The OSPF FAEAG sub-TLV **MUST NOT** appear more than once in an OSPF
        FAD TLV. If it appears more than once, the OSPF FAD TLV **MUST** be
        ignored by the receiver.

<a name="OSPFFLEXALGINCANYTLV"></a>
## OSPF Flexible Algorithm Include-Any Admin Group Sub-TLV

The OSPF Flexible Algorithm Include-Any Admin Group
        sub-TLV is a sub-TLV of the OSPF FAD TLV. The usage of this sub-TLV is described in [Section 6.2](#ISISFLEXALGINCANYTLV). It has the following format:
...
The OSPF Flexible Algorithm Include-Any Admin Group sub-TLV **MUST NOT** appear more than once in an OSPF FAD TLV. If it appears more than
        once, the OSPF FAD TLV **MUST** be ignored by the receiver.

<a name="OSPFFLEXALGINCALLTLV"></a>
## OSPF Flexible Algorithm Include-All Admin Group Sub-TLV

The OSPF Flexible Algorithm Include-All Admin Group
        sub-TLV is a sub-TLV of the OSPF FAD TLV. The usage of this sub-TLV is 
        described in [Section 6.3](#ISISFLEXALGINCALLTLV). It has the following format:
...
The OSPF Flexible Algorithm Include-All Admin Group sub-TLV **MUST NOT** appear more than once in an OSPF FAD TLV. If it appears more than
        once, the OSPF FAD TLV **MUST** be ignored by the receiver.

<a name="OSPFFLEXALGFLAG"></a>
## OSPF Flexible Algorithm Definition Flags Sub-TLV

The OSPF Flexible Algorithm Definition Flags (FADF) sub-TLV
...
**where:**
  ...
  **Flags:**
    **M-flag:**
      when set, the Flex-Algorithm-specific prefix and
                    ASBR metric **MUST** be used for inter-area and external
...
If the OSPF FADF sub-TLV is not present inside the OSPF FAD TLV,
...
<a name="OSPFFLEXALGEXSRLGTLV"></a>
## OSPF Flexible Algorithm Exclude SRLG Sub-TLV

The OSPF Flexible Algorithm Exclude SRLG (FAESRLG) sub-TLV
        is a sub-TLV of the OSPF FAD TLV. Its usage is described in [Section 6.5](#ISISFLEXALGEXSRLGTLV). It has the following format:
...
**where:**
  ...
  **Length:**
    variable, dependent on the number of SRLGs. **MUST** be a
                  multiple of 4 octets.

  **Shared Risk Link Group Value:**
    SRLG value, as defined in [RFC4203](#RFC4203).
...
<a name="ISISFLEXMETRIC"></a>
# IS-IS Flexible Algorithm Prefix Metric Sub-TLV

The IS-IS Flexible Algorithm Prefix Metric (FAPM) sub-TLV supports the
      advertisement of a Flex-Algorithm-specific prefix metric associated with
      a given prefix advertisement.

The IS-IS FAPM sub-TLV is a sub-TLV of TLVs 135, 235, 236, and 237 and
      has the following format:
...
**where:**
  ...
  **Flex-Algorithm:**
    single octet value between 128 and 255
                inclusive.
...
The IS-IS FAPM sub-TLV **MAY** appear multiple times in its parent TLV. If
      it appears more than once with the same Flex-Algorithm value, the first
      instance **MUST** be used and any subsequent instances **MUST** be ignored.

If a prefix is advertised with a Flex-Algorithm prefix metric larger
      than MAX_PATH_METRIC, as defined in [RFC5305](#RFC5305), this prefix
      **MUST NOT** be considered during the Flexible Algorithm computation.

The usage of the Flex-Algorithm prefix metric is described in [Section 13](#FLEXALGPATHCALC).

The IS-IS FAPM sub-TLV **MUST NOT** be advertised as a sub-TLV of the IS-IS
      SRv6 Locator TLV [RFC9352](#RFC9352). The
...
<a name="OSPFFLEXMETRIC"></a>
# OSPF Flexible Algorithm Prefix Metric Sub-TLV
...
- OSPFv2 Extended Prefix TLV [RFC7684](#RFC7684)
	and
- following OSPFv3 TLVs, as defined in [RFC8362](#RFC8362):
...
**where:**
  ...
  **Flags:**
    ...
    **E bit:**
      position 0: The type of external metric. If the bit is
                  ...
                  This is semantically the same as the E bit in [RFC2328](#RFC2328) and [RFC5340](#RFC5340) for OSPFv2 and OSPFv3, respectively.

    **Bits 1 through 7:**
      **MUST** be cleared by the originator and ignored by
                  the receiver.
...
The OSPF FAPM sub-TLV **MAY** appear multiple times in its parent TLV. If
      it appears more than once with the same Flex-Algorithm value, the first
      instance **MUST** be used and any subsequent instances **MUST** be ignored.
...
<a name="OSPFASBR"></a>
# OSPF Flexible Algorithm ASBR Reachability Advertisement
...
An OSPF ABR advertises the reachability of ASBRs in its attached
      ...
      computations, as described further in [Section 13.1](#FLEXALGPATHCALCINTER).

<a name="OSPFEXTASBRLSA"></a>
## OSPFv2 Extended Inter-Area ASBR LSA

The OSPFv2 Extended Inter-Area ASBR (EIA-ASBR) LSA is an OSPF
        Opaque LSA [RFC5250](#RFC5250) that is used to advertise
        ...
        format Type 4 summary-LSA [RFC2328](#RFC2328). Unlike the Type 4
        ...
        defined to be area-scoped only.
...
An OSPFv2 ABR generates the EIA-ASBR LSA for an ASBR when it is
        ...
        conveyed in the fixed-format Type 4 summary-LSA. An OSPFv2 ABR **MUST NOT** advertise the EIA-ASBR LSA for an ASBR for which it is not
...
The LS Type **MUST** be 10, indicating that the Opaque
        LSA flooding scope is area-local [RFC5250](#RFC5250).

The Opaque Type used by the OSPFv2 EIA-ASBR LSA is 11. 
        The Opaque Type is used to differentiate the various types
        of OSPFv2 Opaque LSAs and is described in [RFC5250](#RFC5250).
...
The Length field is as defined in [RFC2328](#RFC2328).
        It represents the total length (in octets) of the Opaque LSA, including the 
        LSA header and all TLVs (including padding).

The format of the TLVs within the body of the OSPFv2 EIA-ASBR LSA
        is the same as the format used by the Traffic Engineering Extensions
        to OSPFv2 [RFC3630](#RFC3630). The variable TLV section consists
...
<a name="OSPFEXTASBRTLV"></a>
### OSPFv2 Extended Inter-Area ASBR TLV

The OSPFv2 Extended Inter-Area ASBR (EIA-ASBR) TLV is a top-level
...
**where:**
  ...
  **ASBR Router ID:**
    4 octets carrying the OSPF Router ID of
    		the ASBR whose information is being carried.
...
Only a single OSPFv2 EIA-ASBR TLV **MUST** be advertised in each
          OSPFv2 EIA-ASBR LSA, and the receiver **MUST** ignore all instances of
          this TLV other than the first one in an LSA.
...
The OSPF FAAM sub-TLV is a sub-TLV of
        the:

- OSPFv2 Extended Inter-Area ASBR TLV, as defined in [Section 10.1.1](#OSPFEXTASBRTLV), and
- OSPFv3 Inter-Area-Router TLV, as defined in [RFC8362](#RFC8362).
...
**where:**
  ...
  **Reserved:**
    3 octets. **MUST** be set to 0 and ignored at
    	      reception.
...
The advertisement of the ASBR reachability using the OSPF FAAM
        sub-TLV inside the OSPFv2 EIA-ASBR LSA follows [RFC2328](#RFC2328) and inside the OSPFv3 E-Inter-Area-Router-LSA
        follows [RFC5340](#RFC5340). The
        reachability of the ASBR is evaluated in the context of the specific
        Flex-Algorithm.

The FAAM computed by the ABR will be equal to the metric to reach
...
OSPF routers **MUST** use the OSPF FAAM sub-TLV to calculate the
        ...
        OSPFv3 Inter-Area-Router-LSAs **MUST** be used, as specified in
        [RFC2328](#RFC2328) and [RFC5340](#RFC5340) for OSPFv2 and OSPFv3, respectively.
...
The processing of a new or changed OSPF FAAM sub-TLV triggers the
        ...
        [RFC2328](#RFC2328) for OSPFv2 and [RFC5340](#RFC5340) for OSPFv3 for the specific
        Flex-Algorithm.
	The OSPF external and NSSA external route calculation
        should be limited to a Flex-Algorithm(s) for which the winning FAD(s)
        includes the M-flag.

Processing of the OSPF FAAM sub-TLV does not require the existence
...
<a name="FLEXALGPART"></a>
# Advertisement of Node Participation in a Flex-Algorithm

When a router is configured to participate in a particular Flex-Algorithm and
      is advertising such participation, it is participating in that Flex-Algorithm.

Paths for various data planes **MAY** be computed for a specific Flex-Algorithm. 
...
Advertisement of the participation for any particular Flex-Algorithm in any 
      data plane is subject to the condition specified in 
        [Section 5.3](#COMMONLEXALGTLV).

<a name="FLEXALGPARTSR"></a>
## Advertisement of Node Participation for Segment Routing

[RFC8665](#RFC8665), [RFC8666](#RFC8666), and [RFC8667](#RFC8667) (IGP Segment Routing extensions) describe how the
        SR-Algorithm is used to compute the IGP best path.
...
<a name="FLEXALGPARTOTHER"></a>
## Advertisement of Node Participation for Other Data Planes
...
Data-plane-specific advertisement for Flex-Algorithm participation
        **MUST** be defined for each data plane and is outside the scope of
        this document.

<a name="FLEXALGLINKATTR"></a>
# Advertisement of Link Attributes for Flex-Algorithm
...
Various link attributes may be used during the Flex-Algorithm path
      ...
      [6](#ISISFADLTLVS) and [7](#OSPFFADLTLVS).

Application-specific link attributes, as specified in 
      [RFC8919](#RFC8919) or [RFC8920](#RFC8920), 
      ...
      [RFC8919](#RFC8919) or  [RFC8920](#RFC8920) unless, in the case of IS-IS, 
      the L-flag is set in the ASLA advertisement. When the L-flag is set, then legacy 
      advertisements **MUST** be used, subject to the procedures and constraints defined in 
      [RFC8919](#RFC8919) and [Section 6](#ISISFADLTLVS).
...
The mandatory use of ASLA advertisements applies to link attributes
      ...
      used in support of Flex-Algorithm in the future.
...
A new Application Identifier Bit is defined to indicate that the ASLA
      ...
      bit is set in the Standard Application Bit Mask (SABM) defined in [RFC8919](#RFC8919) or [RFC8920](#RFC8920):
...
A receiver supporting this specification **MUST** accept both ASLA 
      ...
      [RFC8919](#RFC8919) or [RFC8920](#RFC8920). In the case of IS-IS, if 
      the L-flag is set in the ASLA advertisement, as defined in [RFC8919](#RFC8919), then the receiver **MUST** be able to accept both the Administrative Group TLV, 
      as defined in [RFC5305](#RFC5305), and the Extended Administrative Group TLV, as 
      defined in [RFC7308](#RFC7308).

<a name="FLEXALGPATHCALC"></a>
# Calculation of Flexible Algorithm Paths

A router **MUST** be configured to participate in a given Flex-Algorithm
      K and **MUST** select the FAD based on the rules defined in [Section 5.3](#COMMONLEXALGTLV) before it can compute any path for that
      Flex-Algorithm.

No specific two-way connectivity check is performed during the Flex-Algorithm  
      path computation. The result of the existing Flex-Algorithm-agnostic, two-way 
      connectivity check is used during the Flex-Algorithm path computation.

As described in [Section 11](#FLEXALGPART), participation for any
...
Multiple data planes **MAY** use the same Flex-Algorithm value at the
      ...
      will be forwarded based on the data-plane-specific forwarding entries.

The Flex-Algorithm Definition is data plane independent and is used by
...
When computing the path for a given Flex-Algorithm, the metric-type
      that is part of the Flex-Algorithm Definition ([Section 5](#FLEXALGDEF)) **MUST** be used.

When computing the path for a given Flex-Algorithm, the
      calculation-type that is part of the Flex-Algorithm Definition ([Section 5](#FLEXALGDEF)) **MUST** be used.

Various links that include or exclude rules can be part of the
      Flex-Algorithm Definition. To refer to a particular bit within an Admin Group or
      Extended Admin Group, we use the term "color".
...
1. Check if any exclude Administrative Group rule is part of the Flex-Algorithm
        ...
        set, the link **MUST** be pruned from the computation.
2. Check if any exclude SRLG rule is part of the Flex-Algorithm
        ...
        computation.
3. Check if any include-any Administrative Group rule is part of the Flex-Algorithm
...
4. Check if any include-all Administrative Group rule is part of the Flex-Algorithm
...
5. If the Flex-Algorithm Definition uses something other than the IGP metric
        ([Section 5](#FLEXALGDEF)), and such metric is not
...
<a name="FLEXALGPATHCALCINTER"></a>
## Multi-area and Multi-domain Considerations
...
Any IGP Shortest Path Tree calculation is limited to a single area.
        ...
        area or domain, the traffic could be dropped by the ABR/ASBR.

To allow the optimal end-to-end path for an inter-area or
        inter-domain prefix for any Flex-Algorithm to be computed, the FAPM
        has been defined in Sections [8](#ISISFLEXMETRIC)
	and [9](#OSPFFLEXMETRIC). For external route
	calculation for prefixes originated by ASBRs in remote areas in OSPF, the FAAM
	has been defined in [Section 10.2](#OSPFFAASBRMETRIC) for the
	ABR to indicate its ASBR reachability along with the metric for the specific
        Flex-Algorithm.

If the FAD selected based on the rules defined in [Section 5.3](#COMMONLEXALGTLV) includes the M-flag, an ABR or an ASBR
	**MUST** include the FAPM (see Sections [8](#ISISFLEXMETRIC) and [9](#OSPFFLEXMETRIC)) when
...
If the FAD selected based on the rules defined in [Section 5.3](#COMMONLEXALGTLV) includes the M-flag, the FAPM **MUST** be used
        ...
        **MUST** be considered as unreachable for that Flex-Algorithm, and the
        ...
        for that Flex-Algorithm.

The Flex-Algorithm prefix metrics and the OSPF Flex-Algorithm ASBR
        metrics **MUST NOT** be used during the Flex-Algorithm computation
	unless the FAD selected based on the rules defined in [Section 5.3](#COMMONLEXALGTLV) includes the M-flag, as described in
	Sections [6.4](#ISISFLEXALGFLAG) or [7.4](#OSPFFLEXALGFLAG).

In the case of OSPF, when calculating external routes in a
...
This is similar in nature to how the metric is calculated for
        routes learned from remote ASBRs in the default algorithm using the
        OSPFv2 Type 4 ASBR summary-LSA and the OSPFv3 Inter-Area-Router-LSA.

If the FAD selected based on the rules defined in [Section 5.3](#COMMONLEXALGTLV) does not include the M-flag, then the IGP
        ...
        base OSPFv2 Type 4 summary-LSA and the OSFPv3 Inter-Area-Router-LSA.
...
During the route computation, it is possible for the Flex-Algorithm-specific
...
The M-flag in the FAD is not applicable to prefixes advertised as SRv6
        locators. The IS-IS SRv6 Locator TLV [RFC9352](#RFC9352) includes the Algorithm
...
OSPF external and NSSA external prefix advertisements **MAY** include a
        ...
        reachability of the forwarding address.
...
In OSPF, the procedures for translation of NSSA external prefix
        ...
        NSSA ABR [RFC3101](#RFC3101) remain unchanged for Flex-Algorithm.
...
An area could become partitioned from the perspective of the Flex-Algorithm 
...
<a name="FLEXALFORW"></a>
# Flex-Algorithm and Forwarding Plane

This section describes how Flex-Algorithm paths are used in
      forwarding.

<a name="FLEXALGPSRFORW"></a>
## Segment Routing MPLS Forwarding for Flex-Algorithm

This section describes how Flex-Algorithm paths are used with SR
        MPLS forwarding.

Prefix-SID advertisements include an SR-Algorithm value and, as
...
A Flex-Algorithm path **MUST** be installed in the MPLS forwarding
...
Loop Free Alternate (LFA) paths ([RFC6571](#RFC6571) or its variants) 
...
In SRv6, a node is provisioned with a (topology, algorithm) specific
        ...
        that node that have the matching topology/algorithm.

The SRv6 locator advertisement in IS-IS [RFC9352](#RFC9352) includes the Multi-Topology Identifier (MTID) value
...
If LFA protection is being used to protect locators associated with
        a given Flex-Algorithm, all routers in the area participating in the
        given Flex-Algorithm **SHOULD** advertise at least one
...
<a name="FLEXALGPSRFORWOTHER"></a>
## Other Data Planes' Forwarding for Flex-Algorithm

Any data plane that wants to use Flex-Algorithm-specific
...
## Inter-area Considerations

The scope of the Flex-Algorithm computation and the scope of the
...
As described in [Section 5.1](#ISISFLEXALGTLV), IS-IS allows the
        ...
        particular Flex-Algorithm is advertised.

Regeneration of the FAD from a level 1 area to the level 2 area is not
        supported in IS-IS, so if the intent is to regenerate the FAD between
        IS-IS levels, the FAD **MUST** be defined on a router(s) that is in level 2.
...
## Usage of the SRLG Exclude Rule with Flex-Algorithm
...
- In a context of a single Flex-Algorithm, it can be used for
          computation of backup paths, as described in [RTGWG-SEGMENT-ROUTING-TI-LFA](#I-D.ietf-rtgwg-segment-routing-ti-lfa). This usage
	  does not require association of any specific SRLG constraint with the
          given Flex-Algorithm Definition.
- In the context of multiple Flex-Algorithms, it can be used for
            ...
            Flex-Algorithm computes its paths. This usage:
            facilitates the usage of already deployed SRLG
              configurations for the setup of disjoint paths between two or more
              Flex-Algorithms and
              requires explicit association of a given Flex-Algorithm
              with a specific set of SRLG constraints, as defined in Sections [6.5](#ISISFLEXALGEXSRLGTLV) and [7.5](#OSPFFLEXALGEXSRLGTLV).
  - facilitates the usage of already deployed SRLG
              configurations for the setup of disjoint paths between two or more
              Flex-Algorithms and
  - requires explicit association of a given Flex-Algorithm
...
The link can be made unreachable for all Flex-Algorithms that use the
        Min Unidirectional Link Delay as a metric, as described in [Section 5.1](#ISISFLEXALGTLV), by removing the Flex-Algorithm ASLA Min
...
The link can be made unreachable for all Flex-Algorithms that use the
        TE metric, as described in [Section 5.1](#ISISFLEXALGTLV), by
        ...
        the value of (224 - 1) in IS-IS and (232 - 1) in OSPF.

## Flexible Algorithm Definition and Changes
...
When configuring a node to participate in a specific Flex-Algorithm,
      ...
      constraint advertised by the winning FAD (see [Section 5.3](#COMMONLEXALGTLV)). Changes in 
      the FAD configuration should also be considered in light of the capabilities of 
      the participating routers in the scope of the FAD advertisement.

As [Section 5.3](#COMMONLEXALGTLV) notes, a change in the Flex-Algorithm 
      ...
      and making changes to the FAD.

## Number of Flex-Algorithms

The maximum number of Flex-Algorithms is determined by the algorithm range 
      128-255, as specified in [Section 4](#FLEXALG). Although possible, 
      it is not expected that all of them will be used simultaneously. Typically, 
      only a limited subset of Flex-Algorithms is expected to be deployed in the network.
...
- An attacker could make it look like a router supports a
...
Both of these attacks can be addressed by the existing security
      extensions, as described in [RFC5304](#RFC5304) and [RFC5310](#RFC5310) for IS-IS, in [RFC2328](#RFC2328) and [RFC7474](#RFC7474) for OSPFv2, and in [RFC4552](#RFC4552) and [RFC5340](#RFC5340) for OSPFv3.

If the node that is authenticated is taken over by an attacker, such rogue
...
<a name="IANAIGP"></a>
## IGP IANA Considerations

<a name="IANAIGPIGPALGTYPE"></a>
### IGP Algorithm Types Registry

This document makes the following registration in the "IGP
          Algorithm Types" registry:

**Table: IGP Algorithm Types Registry**

| Value | Description | Reference |
| --- | --- | --- |
| 128-255 | Flexible Algorithms | RFC 9350, [Section 4](#FLEXALG) |

<a name="IGPMETRICTYPE"></a>
### IGP Metric-Type Registry

IANA has created the "IGP Metric-Type" registry
          within the "Interior Gateway Protocol (IGP) Parameters" registry group. The registration policy is "Standards
          Action" [RFC8126](#RFC8126) [RFC7120](#RFC7120). Values are assigned from the range 0-255 and have been registered as follows.

**Table: IGP Metric-Type Registry**

| Type | Description | Reference |
| --- | --- | --- |
| 0 | IGP Metric | RFC 9350, [Section 5.1](#ISISFLEXALGTLV) |
| 1 | Min Unidirectional Link Delay as defined in [RFC8570](#RFC8570) and [RFC7471](#RFC7471) | RFC 9350, [Section 5.1](#ISISFLEXALGTLV) |
| 2 | Traffic Engineering Default Metric as defined in [RFC5305](#RFC5305) and Traffic Engineering Metric as defined in [RFC3630](#RFC3630) | RFC 9350, [Section 5.1](#ISISFLEXALGTLV) |

<a name="IANAFADFLGAS"></a>
## IGP Flexible Algorithm Definition Flags Registry

IANA has created the "IGP Flexible
        ...
        ascending bit order (see [Section 6.4](#ISISFLEXALGFLAG)); the following single bit has been assigned as follows.

**Table: IGP Flexible Algorithm Definition Flags Registry**

| Bit | Name | Reference |
| --- | --- | --- |
| 0 | Prefix Metric Flag (M-flag) | RFC 9350, Sections [6.4](#ISISFLEXALGFLAG) and  [7.4](#OSPFFLEXALGFLAG) |

<a name="IANAISIS"></a>
## IS-IS IANA Considerations
...
| Value | Description | Reference |
| --- | --- | --- |
| 26 | Flexible Algorithm Definition (FAD) | RFC 9350, [Section 5.1](#ISISFLEXALGTLV) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 6 | Flexible Algorithm Prefix Metric (FAPM) | n | y | y | y | y | RFC 9350, [Section 8](#ISISFLEXMETRIC) |

<a name="SUBTLVREGISTRY"></a>
### IS-IS Sub-Sub-TLVs for Flexible Algorithm Definition Sub-TLV Registry

IANA has created the "IS-IS Sub-Sub-TLVs for Flexible Algorithm Definition Sub-TLV" registry within the
...
**Table: IS-IS Sub-Sub-TLVs for Flexible Algorithm Definition Sub-TLV Registry**

| Type | Description | Reference |
| --- | --- | --- |
| 0 | Reserved | RFC 9350 |
| 1 | Flexible Algorithm Exclude Admin Group | RFC 9350, [Section 6.1](#ISISFLEXALGEXLTLV) |
| 2 | Flexible Algorithm Include-Any Admin Group | RFC 9350, [Section 6.2](#ISISFLEXALGINCANYTLV) |
| 3 | Flexible Algorithm Include-All Admin Group | RFC 9350, [Section 6.3](#ISISFLEXALGINCALLTLV) |
| 4 | Flexible Algorithm Definition Flags | RFC 9350, [Section 6.4](#ISISFLEXALGFLAG) |
| 5 | Flexible Algorithm Exclude SRLG | RFC 9350, [Section 6.5](#ISISFLEXALGEXSRLGTLV) |
| 6-255 | Unassigned |  |
...
This document makes the following registration in the "OSPF 
          Router Information (RI) TLVs" registry.

**Table: OSPF Router Information (RI) TLVs Registry**

| Value | Description | Reference |
| --- | --- | --- |
| 16 | Flexible Algorithm Definition (FAD) TLV | RFC 9350, [Section 5.2](#OSPFFLEXALGTLV) |

<a name="SUBTLVEXTPFX"></a>
...
**Table: OSPFv2 Extended Prefix TLV Sub-TLVs Registry**

| Value | Description | Reference |
| --- | --- | --- |
| 3 | Flexible Algorithm Prefix Metric (FAPM) | RFC 9350, [Section 9](#OSPFFLEXMETRIC) |

<a name="SUBTLVV3EXTLSA"></a>
...
**Table: OSPFv3 Extended-LSA Sub-TLVs Registry**

| Value | Description | Reference |
| --- | --- | --- |
| 26 | Flexible Algorithm Prefix Metric (FAPM) | RFC 9350, [Section 9](#OSPFFLEXMETRIC) |
| 33 | OSPF Flexible Algorithm ASBR Metric | RFC 9350, [Section 10.2](#OSPFFAASBRMETRIC) |

<a name="FAPMFLAGS"></a>
### OSPF Flex-Algorithm Prefix Metric Bits Registry

IANA has created the "OSPF Flex-Algorithm
          Prefix Metric Bits" registry under the "Open Shortest Path First 
          (OSPF) Parameters" registry. The registration procedure
          is "IETF Review". Bits 1-7 are unassigned, and the initial value has been assigned as follows.

**Table: OSPF Flex-Algorithm Prefix Metric Bits Registry**

| Bit Number | Description | Reference |
| --- | --- | --- |
| 0 | E bit - External Type | RFC 9350, [Section 9](#OSPFFLEXMETRIC) |

<a name="OPQLSAOPTS"></a>
### Opaque Link-State Advertisements (LSA) Option Types Registry

This document makes the following registration in the "Opaque Link-State 
          Advertisements (LSA) Option Types" registry within the "Open Shortest Path First 
          (OSPF) Opaque Link-State Advertisements (LSA) Option Types" registry group.

**Table: Opaque Link-State Advertisements (LSA) Option Types Registry**

| Value | Opaque Type | Reference |
| --- | --- | --- |
| 11 | OSPFv2 Extended Inter-Area ASBR (EIA-ASBR) LSA | RFC 9350, [Section 10.1](#OSPFEXTASBRLSA) |

<a name="IAASBRTLV"></a>
### OSPFv2 Extended Inter-Area ASBR TLVs Registry

IANA has created the "OSPFv2 Extended
          Inter-Area ASBR TLVs" registry within the "Open Shortest Path First v2 (OSPFv2) Parameters" registry group. The registration procedure is "IETF Review" or "IESG Approval". The initial value has been assigned as follows.

**Table: OSPFv2 Extended Inter-Area ASBR TLVs Registry**

| Value | Description | Reference |
| --- | --- | --- |
| 1 | Extended Inter-Area ASBR | RFC 9350 |

The values 2-32767 are unassigned, the values 32768-33023
...
IANA has created the "OSPFv2 Extended
          ...
          First v2 (OSPFv2) Parameters" registry. The registration procedure is "IETF Review" or "IESG Approval". The initial value has been assigned as follows.

**Table: OSPFv2 Extended Inter-Area ASBR Sub-TLVs Registry**
...
### OSPF Flexible Algorithm Definition TLV Sub-TLVs Registry
...
The "OSPF Flexible Algorithm Definition TLV Sub-TLVs" registry
          will define sub-TLVs at any level of nesting for the Flexible
          Algorithm TLV, and new values can be allocated via the registration procedure.

This document registers the following sub-TLVs.

**Table: OSPF Flexible Algorithm Definition TLV Sub-TLVs Registry**

| Bit Number | Description | Reference |
| --- | --- | --- |
| 0 | Reserved | RFC 9350 |
| 1 | Flexible Algorithm Exclude Admin Group | RFC 9350, [Section 7.1](#OSPFFLEXALGEXLTLV) |
| 2 | Flexible Algorithm Include-Any Admin Group | RFC 9350, [Section 7.2](#OSPFFLEXALGINCANYTLV) |
| 3 | Flexible Algorithm Include-All Admin Group | RFC 9350, [Section 7.3](#OSPFFLEXALGINCALLTLV) |
| 4 | Flexible Algorithm Definition Flags | RFC 9350, [Section 7.4](#OSPFFLEXALGFLAG) |
| 5 | Flexible Algorithm Exclude SRLG | RFC 9350, [Section 7.5](#OSPFFLEXALGEXSRLGTLV) |

The values 6-32767 are unassigned, and values 32768-33023 are for 
          Experimental Use; these will not be registered with IANA.

Types in the range 33024-65535 are not to be assigned at this
...
**Table: Link Attribute Application Identifiers Registry**

| Bit | Description | Reference |
| --- | --- | --- |
| 3 | Flexible Algorithm (X-bit) | RFC 9350, [Section 12](#FLEXALGLINKATTR) |
...
<a name="RFC5250"></a> **[RFC5250]** L. Berger, I. Bryskin, A. Zinin, R. Coltun, "The OSPF Opaque LSA Option", RFC 5250, DOI 10.17487/RFC5250, July 2008. <https://www.rfc-editor.org/info/rfc5250> [Local MD](rfc5250.md)
...
<a name="RFC7981"></a> **[RFC7981]** L. Ginsberg, S. Previdi, M. Chen, "IS-IS Extensions for Advertising Router Information", RFC 7981, DOI 10.17487/RFC7981, October 2016. <https://www.rfc-editor.org/info/rfc7981> [Local MD](rfc7981.md)
...
<a name="RFC8660"></a> **[RFC8660]** A. Bashandy, C. Filsfils, S. Previdi, B. Decraene, S. Litkowski, R. Shakir, "Segment Routing with the MPLS Data Plane", RFC 8660, DOI 10.17487/RFC8660, December 2019. <https://www.rfc-editor.org/info/rfc8660> [Local MD](rfc8660.md)

<a name="RFC8665"></a> **[RFC8665]** P. Psenak, S. Previdi, C. Filsfils, H. Gredler, R. Shakir, W. Henderickx, J. Tantsura, "OSPF Extensions for Segment Routing", RFC 8665, DOI 10.17487/RFC8665, December 2019. <https://www.rfc-editor.org/info/rfc8665> [Local MD](rfc8665.md)

<a name="RFC8666"></a> **[RFC8666]** P. Psenak, S. Previdi, "OSPFv3 Extensions for Segment Routing", RFC 8666, DOI 10.17487/RFC8666, December 2019. <https://www.rfc-editor.org/info/rfc8666> [Local MD](rfc8666.md)

<a name="RFC8667"></a> **[RFC8667]** S. Previdi, L. Ginsberg, C. Filsfils, A. Bashandy, H. Gredler, B. Decraene, "IS-IS Extensions for Segment Routing", RFC 8667, DOI 10.17487/RFC8667, December 2019. <https://www.rfc-editor.org/info/rfc8667> [Local MD](rfc8667.md)

<a name="RFC8919"></a> **[RFC8919]** L. Ginsberg, P. Psenak, S. Previdi, W. Henderickx, J. Drake, "IS-IS Application-Specific Link Attributes", RFC 8919, DOI 10.17487/RFC8919, October 2020. <https://www.rfc-editor.org/info/rfc8919> [Local MD](rfc8919.md)

<a name="RFC8920"></a> **[RFC8920]** P. Psenak, L. Ginsberg, W. Henderickx, J. Tantsura, J. Drake, "OSPF Application-Specific Link Attributes", RFC 8920, DOI 10.17487/RFC8920, October 2020. <https://www.rfc-editor.org/info/rfc8920> [Local MD](rfc8920.md)
...
<a name="RFC3101"></a> **[RFC3101]** P. Murphy, "The OSPF Not-So-Stubby Area (NSSA) Option", RFC 3101, DOI 10.17487/RFC3101, January 2003. <https://www.rfc-editor.org/info/rfc3101> [Local MD](rfc3101.md)
...
<a name="RFC3906"></a> **[RFC3906]** N. Shen, H. Smit, "Calculating Interior Gateway Protocol (IGP) Routes Over Traffic Engineering Tunnels", RFC 3906, DOI 10.17487/RFC3906, October 2004. <https://www.rfc-editor.org/info/rfc3906> [Local MD](rfc3906.md)

<a name="RFC4552"></a> **[RFC4552]** M. Gupta, N. Melam, "Authentication/Confidentiality for OSPFv3", RFC 4552, DOI 10.17487/RFC4552, June 2006. <https://www.rfc-editor.org/info/rfc4552> [Local MD](rfc4552.md)
...
<a name="RFC6571"></a> **[RFC6571]** C. Filsfils, P. Francois, M. Shand, B. Decraene, J. Uttaro, N. Leymann, M. Horneffer, "Loop-Free Alternate (LFA) Applicability in Service Provider (SP) Networks", RFC 6571, DOI 10.17487/RFC6571, June 2012. <https://www.rfc-editor.org/info/rfc6571> [Local MD](rfc6571.md)

<a name="RFC7120"></a> **[RFC7120]** M. Cotton, "Early IANA Allocation of Standards Track Code Points", BCP 100, RFC 7120, DOI 10.17487/RFC7120, January 2014. <https://www.rfc-editor.org/info/rfc7120> [Local MD](rfc7120.md)
...
<a name="RFC7474"></a> **[RFC7474]** M. Bhatia, S. Hartman, D. Zhang, A. Lindem, "Security Extension for OSPFv2 When Using Manual Key Management", RFC 7474, DOI 10.17487/RFC7474, April 2015. <https://www.rfc-editor.org/info/rfc7474> [Local MD](rfc7474.md)
...
<a name="I-D.gulkohegde-routing-planes-using-sr"></a> **[ROUTING-PLANES-USING-SR]** S. Hegde, A. Gulko, "Separating Routing Planes using Segment Routing", Internet-Draft draft-gulkohegde-routing-planes-using-sr-00, March 2017. Work in Progress <https://datatracker.ietf.org/doc/html/draft-gulkohegde-routing-planes-using-sr-00>

<a name="I-D.ietf-rtgwg-segment-routing-ti-lfa"></a> **[RTGWG-SEGMENT-ROUTING-TI-LFA]** S. Litkowski, A. Bashandy, C. Filsfils, P. Francois, B. Decraene, D. Voyer, "Topology Independent Fast Reroute using Segment Routing", Internet-Draft draft-ietf-rtgwg-segment-routing-ti-lfa-09, December 2022. Work in Progress <https://datatracker.ietf.org/doc/html/draft-ietf-rtgwg-segment-routing-ti-lfa-09>

<a name="ACK"></a>
# Acknowledgements

This document, among other things, addresses the problem that
      [ROUTING-PLANES-USING-SR](#I-D.gulkohegde-routing-planes-using-sr) was trying
      to solve. All authors of that document agreed to join this document.

Thanks to Eric Rosen, Tony Przygienda, William Britto A. J., Gunter Van       de Velde, Dirk Goethals, Manju Sivaji, and Baalajee S. for their detailed
      review and excellent comments.

Thanks to Cengiz Halit for his review and feedback during
      the initial phase of the solution definition.
...
- Address: Mlynske nivy 43, Bratislava, 82109, Slovakia
- Email: ppsenak@cisco.com

**Shraddha Hegde**

- Organization: Juniper Networks, Inc.
- Address: Bangalore, KA, 560093, India
- Email: shraddha@juniper.net
