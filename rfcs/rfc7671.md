...
`   `[`2`](#section-2)`. DANE TLSA Record Overview`

`      `[`2.1`](#section-2-1)`. Example TLSA Record`

`   `[`3`](#section-3)`. DANE TLS Requirements`

`   `[`4`](#section-4)`. DANE Certificate Usage Selection Guidelines`

`      `[`4.1`](#section-4-1)`. Opportunistic Security and PKIX Usages`

`      `[`4.2`](#section-4-2)`. Interaction with Certificate Transparency`

`      `[`4.3`](#section-4-3)`. Switching from/to PKIX-TA/EE to/from DANE-TA/EE`

`   `[`5`](#section-5)`. Certificate-Usage-Specific DANE Updates and Guidelines`

`      `[`5.1`](#section-5-1)`. Certificate Usage DANE-EE(3)`

`      `[`5.2`](#section-5-2)`. Certificate Usage DANE-TA(2)`

`      `[`5.3`](#section-5-3)`. Certificate Usage PKIX-EE(1)`

`      `[`5.4`](#section-5-4)`. Certificate Usage PKIX-TA(0)`

`   `[`6`](#section-6)`. Service Provider and TLSA Publisher Synchronization`

`   `[`7`](#section-7)`. TLSA Base Domain and CNAMEs`

`   `[`8`](#section-8)`. TLSA Publisher Requirements`

`      `[`8.1`](#section-8-1)`. Key Rollover with Fixed TLSA Parameters`

`      `[`8.2`](#section-8-2)`. Switching to DANE-TA(2) from DANE-EE(3)`

`      `[`8.3`](#section-8-3)`. Switching to New TLSA Parameters`

`      `[`8.4`](#section-8-4)`. TLSA Publisher Requirements: Summary`

`   `[`9`](#section-9)`. Digest Algorithm Agility`

`   `[`10`](#section-10)`. General DANE Guidelines`

`      `[`10.1`](#section-10-1)`. DANE DNS Record Size Guidelines`

`      `[`10.2`](#section-10-2)`. Certificate Name Check Conventions`

`      `[`10.3`](#section-10-3)`. Design Considerations for Protocols Using DANE`

`   `[`11`](#section-11)`. Note on DNSSEC Security`

`   `[`12`](#section-12)`. Summary of Updates to RFC 6698`

`   `[`13`](#section-13)`. Operational Considerations`
...
<a id="section-2"></a> **`2. DANE TLSA Record Overview`**
...
<a id="section-2-1"></a> **`2.1. Example TLSA Record`**
...
<a id="section-3"></a> **`3. DANE TLS Requirements`**
...
<a id="section-4"></a> **`4. DANE Certificate Usage Selection Guidelines`**
...
<a id="section-4-1"></a> **`4.1. Opportunistic Security and PKIX Usages`**
...
<a id="section-4-2"></a> **`4.2. Interaction with Certificate Transparency`**
...
<a id="section-4-3"></a> **`4.3. Switching from/to PKIX-TA/EE to/from DANE-TA/EE`**
...
<a id="section-5"></a> **`5. Certificate-Usage-Specific DANE Updates and Guidelines`**
...
<a id="section-5-1"></a> **`5.1. Certificate Usage DANE-EE(3)`**
...
<a id="section-5-2"></a> **`5.2. Certificate Usage DANE-TA(2)`**
...
<a id="section-5-2-1"></a> **`5.2.1. Recommended Record Combinations`**
...
<a id="section-5-2-2"></a> **`5.2.2. Trust Anchor Digests and Server Certificate Chain`**
...
<a id="section-5-2-3"></a> **`5.2.3. Trust Anchor Public Keys`**
...
<a id="section-5-3"></a> **`5.3. Certificate Usage PKIX-EE(1)`**
...
<a id="section-5-4"></a> **`5.4. Certificate Usage PKIX-TA(0)`**
...
<a id="section-6"></a> **`6. Service Provider and TLSA Publisher Synchronization`**
...
<a id="section-7"></a> **`7. TLSA Base Domain and CNAMEs`**
...
<a id="section-8"></a> **`8. TLSA Publisher Requirements`**
...
<a id="section-8-1"></a> **`8.1. Key Rollover with Fixed TLSA Parameters`**
...
<a id="section-8-2"></a> **`8.2. Switching to DANE-TA(2) from DANE-EE(3)`**
...
<a id="section-8-3"></a> **`8.3. Switching to New TLSA Parameters`**
...
<a id="section-8-4"></a> **`8.4. TLSA Publisher Requirements: Summary`**
...
<a id="section-9"></a> **`9. Digest Algorithm Agility`**
...
<a id="section-10"></a> **`10. General DANE Guidelines`**
...
<a id="section-10-1"></a> **`10.1. DANE DNS Record Size Guidelines`**
...
<a id="section-10-1-1"></a> **`10.1.1. UDP and TCP Considerations`**
...
<a id="section-10-1-2"></a> **`10.1.2. Packet Size Considerations for TLSA Parameters`**
...
<a id="section-10-2"></a> **`10.2. Certificate Name Check Conventions`**
...
<a id="section-10-3"></a> **`10.3. Design Considerations for Protocols Using DANE`**
...
<a id="section-11"></a> **`11. Note on DNSSEC Security`**
...
<a id="section-12"></a> **`12. Summary of Updates to RFC 6698`**
...
<a id="section-13"></a> **`13. Operational Considerations`**
