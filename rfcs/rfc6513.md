...
`      `[`2.1`](#section-2-1)`. Optimality vs. Scalability`

`           `[`2.1.1`](#section-2-1-1)`. Multicast Distribution Trees`

`           `[`2.1.2`](#section-2-1-2)`. Ingress Replication through Unicast Tunnels`

`      `[`2.2`](#section-2-2)`. Multicast Routing Adjacencies`

`      `[`2.3`](#section-2-3)`. MVPN Definition`

`      `[`2.4`](#section-2-4)`. Auto-Discovery`

`      `[`2.5`](#section-2-5)`. PE-PE Multicast Routing Information`

`      `[`2.6`](#section-2-6)`. PE-PE Multicast Data Transmission`

`      `[`2.7`](#section-2-7)`. Inter-AS MVPNs`

`      `[`2.8`](#section-2-8)`. Optionally Eliminating Shared Tree State`

`   `[`3`](#section-3)`. Concepts and Framework`

`      `[`3.1`](#section-3-1)`. PE-CE Multicast Routing`

`      `[`3.2`](#section-3-2)`. P-Multicast Service Interfaces (PMSIs)`

`           `[`3.2.1`](#section-3-2-1)`. Inclusive and Selective PMSIs`

`           `[`3.2.2`](#section-3-2-2)`. P-Tunnels Instantiating PMSIs`

`      `[`3.3`](#section-3-3)`. Use of PMSIs for Carrying Multicast Data`

`      `[`3.4`](#section-3-4)`. PE-PE Transmission of C-Multicast Routing`

`           `[`3.4.1`](#section-3-4-1)`. PIM Peering`

`                  `[`3.4.1.1`](#section-3-4-1-1)`. Full per-MVPN PIM Peering across`

`                           an MI-PMSI`

`                  `[`3.4.1.2`](#section-3-4-1-2)`. Lightweight PIM Peering across an MI-PMSI`

`                  `[`3.4.1.3`](#section-3-4-1-3)`. Unicasting of PIM C-Join/Prune Messages`

`           `[`3.4.2`](#section-3-4-2)`. Using BGP to Carry C-Multicast Routing`

`   `[`4`](#section-4)`. BGP-Based Auto-Discovery of MVPN Membership`

`   `[`5`](#section-5)`. PE-PE Transmission of C-Multicast Routing`

`      `[`5.1`](#section-5-1)`. Selecting the Upstream Multicast Hop (UMH)`

`           `[`5.1.1`](#section-5-1-1)`. Eligible Routes for UMH Selection`

`           `[`5.1.2`](#section-5-1-2)`. Information Carried by Eligible UMH Routes`

`           `[`5.1.3`](#section-5-1-3)`. Selecting the Upstream PE`

`           `[`5.1.4`](#section-5-1-4)`. Selecting the Upstream Multicast Hop`

`      `[`5.2`](#section-5-2)`. Details of Per-MVPN Full PIM Peering over MI-PMSI`

`           `[`5.2.1`](#section-5-2-1)`. PIM C-Instance Control Packets`

`           `[`5.2.2`](#section-5-2-2)`. PIM C-Instance Reverse Path Forwarding`

`                  (RPF) Determination`

`      `[`5.3`](#section-5-3)`. Use of BGP for Carrying C-Multicast Routing`

`           `[`5.3.1`](#section-5-3-1)`. Sending BGP Updates`

`           `[`5.3.2`](#section-5-3-2)`. Explicit Tracking`

`           `[`5.3.3`](#section-5-3-3)`. Withdrawing BGP Updates`

`           `[`5.3.4`](#section-5-3-4)`. BSR`

`   `[`6`](#section-6)`. PMSI Instantiation`

`      `[`6.1`](#section-6-1)`. Use of the Intra-AS I-PMSI A-D Route`

`           `[`6.1.1`](#section-6-1-1)`. Sending Intra-AS I-PMSI A-D Routes`

`           `[`6.1.2`](#section-6-1-2)`. Receiving Intra-AS I-PMSI A-D Routes`

`      `[`6.2`](#section-6-2)`. When C-flows Are Specifically Bound to P-Tunnels`

`      `[`6.3`](#section-6-3)`. Aggregating Multiple MVPNs on a Single P-Tunnel`

`           `[`6.3.1`](#section-6-3-1)`. Aggregate Tree Leaf Discovery`

`           `[`6.3.2`](#section-6-3-2)`. Aggregation Methodology`

`           `[`6.3.3`](#section-6-3-3)`. Demultiplexing C-Multicast Traffic`

`      `[`6.4`](#section-6-4)`. Considerations for Specific Tunnel Technologies`

`           `[`6.4.1`](#section-6-4-1)`. RSVP-TE P2MP LSPs`

`           `[`6.4.2`](#section-6-4-2)`. PIM Trees`

`           `[`6.4.3`](#section-6-4-3)`. mLDP P2MP LSPs`

`           `[`6.4.4`](#section-6-4-4)`. mLDP MP2MP LSPs`

`           `[`6.4.5`](#section-6-4-5)`. Ingress Replication`

`   `[`7`](#section-7)`. Binding Specific C-Flows to Specific P-Tunnels`

`      `[`7.1`](#section-7-1)`. General Considerations`

`           `[`7.1.1`](#section-7-1-1)`. At the PE Transmitting the C-Flow on the P-Tunnel`

`           `[`7.1.2`](#section-7-1-2)`. At the PE Receiving the C-flow from the P-Tunnel`

`      `[`7.2`](#section-7-2)`. Optimizing Multicast Distribution via S-PMSIs`

`      `[`7.3`](#section-7-3)`. Announcing the Presence of Unsolicited Flooded Data`

`      `[`7.4`](#section-7-4)`. Protocols for Binding C-Flows to P-Tunnels`

`           `[`7.4.1`](#section-7-4-1)`. Using BGP S-PMSI A-D Routes`

`                  `[`7.4.1.1`](#section-7-4-1-1)`. Advertising C-Flow Binding to P-Tunnel`

`                  `[`7.4.1.2`](#section-7-4-1-2)`. Explicit Tracking`

`           `[`7.4.2`](#section-7-4-2)`. UDP-Based Protocol`

`                  `[`7.4.2.1`](#section-7-4-2-1)`. Advertising C-Flow Binding to P-Tunnel`

`                  `[`7.4.2.2`](#section-7-4-2-2)`. Packet Formats and Constants`

`           `[`7.4.3`](#section-7-4-3)`. Aggregation`

`   `[`8`](#section-8)`. Inter-AS Procedures`

`      `[`8.1`](#section-8-1)`. Non-Segmented Inter-AS P-Tunnels`

`           `[`8.1.1`](#section-8-1-1)`. Inter-AS MVPN Auto-Discovery`

`           `[`8.1.2`](#section-8-1-2)`. Inter-AS MVPN Routing Information Exchange`

`           `[`8.1.3`](#section-8-1-3)`. Inter-AS P-Tunnels`

`                  `[`8.1.3.1`](#section-8-1-3-1)`. PIM-Based Inter-AS P-Multicast Trees`

`                  `[`8.1.3.2`](#section-8-1-3-2)`. The PIM MVPN Join Attribute`

`                           `[`8.1.3.2.1`](#section-8-1-3-2-1)`. Definition`

`                           `[`8.1.3.2.2`](#section-8-1-3-2-2)`. Usage`

`      `[`8.2`](#section-8-2)`. Segmented Inter-AS P-Tunnels`

`   `[`9`](#section-9)`. Preventing Duplication of Multicast Data Packets`

`      `[`9.1`](#section-9-1)`. Methods for Ensuring Non-Duplication`

`           `[`9.1.1`](#section-9-1-1)`. Discarding Packets from Wrong PE`

`           `[`9.1.2`](#section-9-1-2)`. Single Forwarder Selection`

`           `[`9.1.3`](#section-9-1-3)`. Native PIM Methods`

`      `[`9.2`](#section-9-2)`. Multihomed C-S or C-RP`

`      `[`9.3`](#section-9-3)`. Switching from the C-RP Tree to the C-S Tree`

`           `[`9.3.1`](#section-9-3-1)`. How Duplicates Can Occur`

`           `[`9.3.2`](#section-9-3-2)`. Solution Using Source Active A-D Routes`

`   `[`10`](#section-10)`. Eliminating PE-PE Distribution of (C-*,C-G) State`

`      `[`10.1`](#section-10-1)`. Co-Locating C-RPs on a PE`

`           `[`10.1.1`](#section-10-1-1)`. Initial Configuration`

`           `[`10.1.2`](#section-10-1-2)`. Anycast RP Based on Propagating Active Sources`

`                  `[`10.1.2.1`](#section-10-1-2-1)`. Receiver(s) within a Site`

`                  `[`10.1.2.2`](#section-10-1-2-2)`. Source within a Site`

`                  `[`10.1.2.3`](#section-10-1-2-3)`. Receiver Switching from Shared to`

`                            Source Tree`

`      `[`10.2`](#section-10-2)`. Using MSDP between a PE and a Local C-RP`

`   `[`11`](#section-11)`. Support for PIM-BIDIR C-Groups`

`      `[`11.1`](#section-11-1)`. The VPN Backbone Becomes the RPL`

`           `[`11.1.1`](#section-11-1-1)`. Control Plane`

`           `[`11.1.2`](#section-11-1-2)`. Data Plane`

`      `[`11.2`](#section-11-2)`. Partitioned Sets of PEs`

`           `[`11.2.1`](#section-11-2-1)`. Partitions`

`           `[`11.2.2`](#section-11-2-2)`. Using PE Distinguisher Labels`

`           `[`11.2.3`](#section-11-2-3)`. Partial Mesh of MP2MP P-Tunnels`

`   `[`12`](#section-12)`. Encapsulations`

`      `[`12.1`](#section-12-1)`. Encapsulations for Single PMSI per P-Tunnel`

`           `[`12.1.1`](#section-12-1-1)`. Encapsulation in GRE`

`           `[`12.1.2`](#section-12-1-2)`. Encapsulation in IP`

`           `[`12.1.3`](#section-12-1-3)`. Encapsulation in MPLS`

`      `[`12.2`](#section-12-2)`. Encapsulations for Multiple PMSIs per P-Tunnel`

`           `[`12.2.1`](#section-12-2-1)`. Encapsulation in GRE`

`           `[`12.2.2`](#section-12-2-2)`. Encapsulation in IP`

`      `[`12.3`](#section-12-3)`. Encapsulations Identifying a Distinguished PE`

`           `[`12.3.1`](#section-12-3-1)`. For MP2MP LSP P-Tunnels`

`           `[`12.3.2`](#section-12-3-2)`. For Support of PIM-BIDIR C-Groups`

`      `[`12.4`](#section-12-4)`. General Considerations for IP and GRE Encapsulations`

`           `[`12.4.1`](#section-12-4-1)`. MTU (Maximum Transmission Unit)`

`           `[`12.4.2`](#section-12-4-2)`. TTL (Time to Live)`

`           `[`12.4.3`](#section-12-4-3)`. Avoiding Conflict with Internet Multicast`

`      `[`12.5`](#section-12-5)`. Differentiated Services`

`   `[`13`](#section-13)`. Security Considerations`

`   `[`14`](#section-14)`. IANA Considerations`

`   `[`15`](#section-15)`. Acknowledgments`

`   `[`16`](#section-16)`. References`

`      `[`16.1`](#section-16-1)`. Normative References`

`      `[`16.2`](#section-16-2)`. Informative References`
...
<a id="section-2"></a> **`2. Overview`**

```text

```

<a id="section-2-1"></a> **`2.1. Optimality vs. Scalability`**
...
<a id="section-2-1-1"></a> **`2.1.1. Multicast Distribution Trees`**
...
<a id="section-2-1-2"></a> **`2.1.2. Ingress Replication through Unicast Tunnels`**
...
<a id="section-2-2"></a> **`2.2. Multicast Routing Adjacencies`**
...
<a id="section-2-3"></a> **`2.3. MVPN Definition`**
...
<a id="section-2-4"></a> **`2.4. Auto-Discovery`**
...
<a id="section-2-5"></a> **`2.5. PE-PE Multicast Routing Information`**
...
<a id="section-2-6"></a> **`2.6. PE-PE Multicast Data Transmission`**
...
<a id="section-2-7"></a> **`2.7. Inter-AS MVPNs`**
...
<a id="section-2-8"></a> **`2.8. Optionally Eliminating Shared Tree State`**
...
<a id="section-3"></a> **`3. Concepts and Framework`**

```text

```

<a id="section-3-1"></a> **`3.1. PE-CE Multicast Routing`**
...
<a id="section-3-2"></a> **`3.2. P-Multicast Service Interfaces (PMSIs)`**
...
<a id="section-3-2-1"></a> **`3.2.1. Inclusive and Selective PMSIs`**
...
<a id="section-3-2-2"></a> **`3.2.2. P-Tunnels Instantiating PMSIs`**
...
<a id="section-3-3"></a> **`3.3. Use of PMSIs for Carrying Multicast Data`**
...
<a id="section-3-4"></a> **`3.4. PE-PE Transmission of C-Multicast Routing`**
...
<a id="section-3-4-1"></a> **`3.4.1. PIM Peering`**

```text

```

<a id="section-3-4-1-1"></a> **`3.4.1.1. Full per-MVPN PIM Peering across an MI-PMSI`**
...
<a id="section-3-4-1-2"></a> **`3.4.1.2. Lightweight PIM Peering across an MI-PMSI`**
...
<a id="section-3-4-1-3"></a> **`3.4.1.3. Unicasting of PIM C-Join/Prune Messages`**
...
<a id="section-3-4-2"></a> **`3.4.2. Using BGP to Carry C-Multicast Routing`**
...
<a id="section-4"></a> **`4. BGP-Based Auto-Discovery of MVPN Membership`**
...
<a id="section-5"></a> **`5. PE-PE Transmission of C-Multicast Routing`**
...
<a id="section-5-1"></a> **`5.1. Selecting the Upstream Multicast Hop (UMH)`**
...
<a id="section-5-1-1"></a> **`5.1.1. Eligible Routes for UMH Selection`**
...
<a id="section-5-1-2"></a> **`5.1.2. Information Carried by Eligible UMH Routes`**
...
<a id="section-5-1-3"></a> **`5.1.3. Selecting the Upstream PE`**
...
<a id="section-5-1-4"></a> **`5.1.4. Selecting the Upstream Multicast Hop`**
...
<a id="section-5-2"></a> **`5.2. Details of Per-MVPN Full PIM Peering over MI-PMSI`**
...
<a id="section-5-2-1"></a> **`5.2.1. PIM C-Instance Control Packets`**
...
<a id="section-5-2-2"></a> **`5.2.2. PIM C-Instance Reverse Path Forwarding (RPF) Determination`**
...
<a id="section-5-3"></a> **`5.3. Use of BGP for Carrying C-Multicast Routing`**
...
<a id="section-5-3-1"></a> **`5.3.1. Sending BGP Updates`**
...
<a id="section-5-3-2"></a> **`5.3.2. Explicit Tracking`**
...
<a id="section-5-3-3"></a> **`5.3.3. Withdrawing BGP Updates`**
...
<a id="section-5-3-4"></a> **`5.3.4. BSR`**
...
<a id="section-6"></a> **`6. PMSI Instantiation`**
...
<a id="section-6-1"></a> **`6.1. Use of the Intra-AS I-PMSI A-D Route`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. Sending Intra-AS I-PMSI A-D Routes`**
...
<a id="section-6-1-2"></a> **`6.1.2. Receiving Intra-AS I-PMSI A-D Routes`**
...
<a id="section-6-2"></a> **`6.2. When C-flows Are Specifically Bound to P-Tunnels`**
...
<a id="section-6-3"></a> **`6.3. Aggregating Multiple MVPNs on a Single P-Tunnel`**
...
<a id="section-6-3-1"></a> **`6.3.1. Aggregate Tree Leaf Discovery`**
...
<a id="section-6-3-2"></a> **`6.3.2. Aggregation Methodology`**
...
<a id="section-6-3-3"></a> **`6.3.3. Demultiplexing C-Multicast Traffic`**
...
<a id="section-6-4"></a> **`6.4. Considerations for Specific Tunnel Technologies`**
...
<a id="section-6-4-1"></a> **`6.4.1. RSVP-TE P2MP LSPs`**
...
<a id="section-6-4-2"></a> **`6.4.2. PIM Trees`**
...
<a id="section-6-4-3"></a> **`6.4.3. mLDP P2MP LSPs`**
...
<a id="section-6-4-4"></a> **`6.4.4. mLDP MP2MP LSPs`**
...
<a id="section-6-4-5"></a> **`6.4.5. Ingress Replication`**
...
<a id="section-7"></a> **`7. Binding Specific C-Flows to Specific P-Tunnels`**
...
<a id="section-7-1"></a> **`7.1. General Considerations`**

```text

```

<a id="section-7-1-1"></a> **`7.1.1. At the PE Transmitting the C-Flow on the P-Tunnel`**
...
<a id="section-7-1-2"></a> **`7.1.2. At the PE Receiving the C-flow from the P-Tunnel`**
...
<a id="section-7-2"></a> **`7.2. Optimizing Multicast Distribution via S-PMSIs`**
...
<a id="section-7-3"></a> **`7.3. Announcing the Presence of Unsolicited Flooded Data`**
...
<a id="section-7-4"></a> **`7.4. Protocols for Binding C-Flows to P-Tunnels`**
...
<a id="section-7-4-1"></a> **`7.4.1. Using BGP S-PMSI A-D Routes`**
...
<a id="section-7-4-1-1"></a> **`7.4.1.1. Advertising C-Flow Binding to P-Tunnel`**
...
<a id="section-7-4-1-2"></a> **`7.4.1.2. Explicit Tracking`**
...
<a id="section-7-4-2"></a> **`7.4.2. UDP-Based Protocol`**
...
<a id="section-7-4-2-1"></a> **`7.4.2.1. Advertising C-Flow Binding to P-Tunnel`**
...
<a id="section-7-4-2-2"></a> **`7.4.2.2. Packet Formats and Constants`**
...
<a id="section-7-4-3"></a> **`7.4.3. Aggregation`**
...
<a id="section-8"></a> **`8. Inter-AS Procedures`**
...
<a id="section-8-1"></a> **`8.1. Non-Segmented Inter-AS P-Tunnels`**
...
<a id="section-8-1-1"></a> **`8.1.1. Inter-AS MVPN Auto-Discovery`**
...
<a id="section-8-1-2"></a> **`8.1.2. Inter-AS MVPN Routing Information Exchange`**
...
<a id="section-8-1-3"></a> **`8.1.3. Inter-AS P-Tunnels`**
...
<a id="section-8-1-3-1"></a> **`8.1.3.1. PIM-Based Inter-AS P-Multicast Trees`**
...
<a id="section-8-1-3-2"></a> **`8.1.3.2. The PIM MVPN Join Attribute`**

```text

```

<a id="section-8-1-3-2-1"></a> **`8.1.3.2.1. Definition`**
...
<a id="section-8-1-3-2-2"></a> **`8.1.3.2.2. Usage`**
...
<a id="section-8-2"></a> **`8.2. Segmented Inter-AS P-Tunnels`**
...
<a id="section-9"></a> **`9. Preventing Duplication of Multicast Data Packets`**
...
<a id="section-9-1"></a> **`9.1. Methods for Ensuring Non-Duplication`**
...
<a id="section-9-1-1"></a> **`9.1.1. Discarding Packets from Wrong PE`**
...
<a id="section-9-1-2"></a> **`9.1.2. Single Forwarder Selection`**
...
<a id="section-9-1-3"></a> **`9.1.3. Native PIM Methods`**
...
<a id="section-9-2"></a> **`9.2. Multihomed C-S or C-RP`**
...
<a id="section-9-3"></a> **`9.3. Switching from the C-RP Tree to the C-S Tree`**

```text

```

<a id="section-9-3-1"></a> **`9.3.1. How Duplicates Can Occur`**
...
<a id="section-9-3-2"></a> **`9.3.2. Solution Using Source Active A-D Routes`**
...
<a id="section-10"></a> **`10. Eliminating PE-PE Distribution of (C-*,C-G) State`**
...
<a id="section-10-1"></a> **`10.1. Co-Locating C-RPs on a PE`**
...
<a id="section-10-1-1"></a> **`10.1.1. Initial Configuration`**
...
<a id="section-10-1-2"></a> **`10.1.2. Anycast RP Based on Propagating Active Sources`**
...
<a id="section-10-1-2-1"></a> **`10.1.2.1. Receiver(s) within a Site`**
...
<a id="section-10-1-2-2"></a> **`10.1.2.2. Source within a Site`**
...
<a id="section-10-1-2-3"></a> **`10.1.2.3. Receiver Switching from Shared to Source Tree`**
...
<a id="section-10-2"></a> **`10.2. Using MSDP between a PE and a Local C-RP`**
...
<a id="section-11"></a> **`11. Support for PIM-BIDIR C-Groups`**
...
<a id="section-11-1"></a> **`11.1. The VPN Backbone Becomes the RPL`**
...
<a id="section-11-1-1"></a> **`11.1.1. Control Plane`**
...
<a id="section-11-1-2"></a> **`11.1.2. Data Plane`**
...
<a id="section-11-2"></a> **`11.2. Partitioned Sets of PEs`**
...
<a id="section-11-2-1"></a> **`11.2.1. Partitions`**
...
<a id="section-11-2-2"></a> **`11.2.2. Using PE Distinguisher Labels`**
...
<a id="section-11-2-3"></a> **`11.2.3. Partial Mesh of MP2MP P-Tunnels`**
...
<a id="section-12"></a> **`12. Encapsulations`**
...
<a id="section-12-1"></a> **`12.1. Encapsulations for Single PMSI per P-Tunnel`**

```text

```

<a id="section-12-1-1"></a> **`12.1.1. Encapsulation in GRE`**
...
<a id="section-12-1-2"></a> **`12.1.2. Encapsulation in IP`**
...
<a id="section-12-1-3"></a> **`12.1.3. Encapsulation in MPLS`**
...
<a id="section-12-2"></a> **`12.2. Encapsulations for Multiple PMSIs per P-Tunnel`**
...
<a id="section-12-2-1"></a> **`12.2.1. Encapsulation in GRE`**
...
<a id="section-12-2-2"></a> **`12.2.2. Encapsulation in IP`**
...
<a id="section-12-3"></a> **`12.3. Encapsulations Identifying a Distinguished PE`**

```text

```

<a id="section-12-3-1"></a> **`12.3.1. For MP2MP LSP P-Tunnels`**
...
<a id="section-12-3-2"></a> **`12.3.2. For Support of PIM-BIDIR C-Groups`**
...
<a id="section-12-4"></a> **`12.4. General Considerations for IP and GRE Encapsulations`**
...
<a id="section-12-4-1"></a> **`12.4.1. MTU (Maximum Transmission Unit)`**
...
<a id="section-12-4-2"></a> **`12.4.2. TTL (Time to Live)`**
...
<a id="section-12-4-3"></a> **`12.4.3. Avoiding Conflict with Internet Multicast`**
...
<a id="section-12-5"></a> **`12.5. Differentiated Services`**
...
<a id="section-15"></a> **`15. Acknowledgments`**
...
<a id="section-16"></a> **`16. References`**

```text

```

<a id="section-16-1"></a> **`16.1. Normative References`**
...
<a id="section-16-2"></a> **`16.2. Informative References`**
