...
<a id="section-2"></a> **`2. Implementation Approach`**
...
<a id="section-2-1"></a> **`2.1. RIPv2 PDU Format`**
...
<a id="section-2-2"></a> **`2.2. RIPv2 Security Association`**
...
<a id="section-2-3"></a> **`2.3. Basic Authentication Processing`**
...
<a id="section-2-3-1"></a> **`2.3.1. Message Generation`**
...
<a id="section-2-3-2"></a> **`2.3.2. Message Reception`**
...
<a id="section-2-4"></a> **`2.4. Keyed-MD5 Algorithm-Dependent Processing`**
...
<a id="section-2-5"></a> **`2.5. HMAC-SHA1 Algorithm-Dependent Processing`**
...
<a id="section-3"></a> **`3. Management Procedures`**
...
<a id="section-3-1"></a> **`3.1. Key Management Requirements`**
...
<a id="section-3-2"></a> **`3.2. Key Management Procedures`**
...
<a id="section-5-1"></a> **`5.1. Known Pathological Cases`**
...
<a id="section-5-3"></a> **`5.3. Key Management Considerations`**
...
<a id="section-5-4"></a> **`5.4. Assurance Considerations`**
...
<a id="section-5-5"></a> **`5.5. Confidentiality and Traffic Analysis Considerations`**
...
<a id="section-5-6"></a> **`5.6. Other Security Considerations`**
...
<a id="section-5-7"></a> **`5.7. Future Security Directions`**
