...
`   `[`3`](#section-3)`. Motivation`

`   `[`4`](#section-4)`. Operation`

`     `[`4.1`](#section-4-1)`. Interface Parameters`

`     `[`4.2`](#section-4-2)`. Neighbor Data Structure`

`     `[`4.3`](#section-4-3)`. Neighbor Discovery and Maintenance`

`     `[`4.4`](#section-4-4)`. Database Synchronization`

`     `[`4.5`](#section-4-5)`. Generating Network-LSAs`

`     `[`4.6`](#section-4-6)`. Generating Router and Intra-Area-Prefix-LSAs`

`       `[`4.6.1`](#section-4-6-1)`. Stub Links in OSPFv2 Router-LSA`

`       `[`4.6.2`](#section-4-6-2)`. OSPFv3 Intra-Area-Prefix-LSA`

`     `[`4.7`](#section-4-7)`. Next-Hop Calculation`

`     `[`4.8`](#section-4-8)`. Graceful Restart`

`   `[`5`](#section-5)`. Compatibility Considerations`

`   `[`6`](#section-6)`. Scalability and Deployment Considerations`
...
<a id="section-4-1"></a> **`4.1. Interface Parameters`**
...
<a id="section-4-2"></a> **`4.2. Neighbor Data Structure`**
...
<a id="section-4-3"></a> **`4.3. Neighbor Discovery and Maintenance`**
...
<a id="section-4-4"></a> **`4.4. Database Synchronization`**
...
<a id="section-4-5"></a> **`4.5. Generating Network-LSAs`**
...
<a id="section-4-6"></a> **`4.6. Generating Router and Intra-Area-Prefix-LSAs`**
...
<a id="section-4-6-1"></a> **`4.6.1. Stub Links in OSPFv2 Router-LSA`**
...
<a id="section-4-6-2"></a> **`4.6.2. OSPFv3 Intra-Area-Prefix-LSA`**
...
<a id="section-4-7"></a> **`4.7. Next-Hop Calculation`**
...
<a id="section-4-8"></a> **`4.8. Graceful Restart`**
...
<a id="section-5"></a> **`5. Compatibility Considerations`**
...
<a id="section-6"></a> **`6. Scalability and Deployment Considerations`**
