...
`   `[`5`](#section-5)`. Implementation Issues`

`     `[`5.1`](#section-5-1)`. Layering`

`     `[`5.2`](#section-5-2)`. Storing PMTU Information`

`     `[`5.3`](#section-5-3)`. Purging Stale PMTU Information`

`     `[`5.4`](#section-5-4)`. Packetization Layer Actions`

`     `[`5.5`](#section-5-5)`. Issues for Other Transport Protocols`

`     `[`5.6`](#section-5-6)`. Management Interface`
...
<a id="section-5"></a> **`5. Implementation Issues`**
...
<a id="section-5-1"></a> **`5.1. Layering`**
...
<a id="section-5-3"></a> **`5.3. Purging Stale PMTU Information`**
...
<a id="section-5-4"></a> **`5.4. Packetization Layer Actions`**
...
<a id="section-5-5"></a> **`5.5. Issues for Other Transport Protocols`**
...
<a id="section-5-6"></a> **`5.6. Management Interface`**
