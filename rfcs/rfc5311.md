...
`   `[`3`](#section-3)`. Definition of Commonly Used Terms`

`   `[`4`](#section-4)`. Utilizing Additional System IDs`

`      `[`4.1`](#section-4-1)`. Additional Information in Extended LSPs`

`      `[`4.2`](#section-4-2)`. Extended LSP Restrictions`

`           `[`4.2.1`](#section-4-2-1)`. TLVs That MUST NOT Appear`

`           `[`4.2.2`](#section-4-2-2)`. Leaf Advertisements in Extended LSPs`

`           `[`4.2.3`](#section-4-2-3)`. IS Neighbor Advertisement Restrictions`

`           `[`4.2.4`](#section-4-2-4)`. Area Addresses`

`           `[`4.2.5`](#section-4-2-5)`. Overload, Attached, Partition Repair Bits`

`      `[`4.3`](#section-4-3)`. Originating LSP Requirements`

`      `[`4.4`](#section-4-4)`. IS Alias ID TLV (IS Alias ID)`

`      `[`4.5`](#section-4-5)`. New TLVs in Support of IS Neighbor Attributes`

`   `[`5`](#section-5)`. Comparison with the RFC 3786 Solution`

`   `[`6`](#section-6)`. Deployment Considerations`

`      `[`6.1`](#section-6-1)`. Advertising New TLVs in Extended LSPs`

`      `[`6.2`](#section-6-2)`. Reachability and Non-SPF TLV Staleness`

`      `[`6.3`](#section-6-3)`. Normal LSP OL State and Use of Extended LSPs`

`      `[`6.4`](#section-6-4)`. Moving Neighbor Attribute INFO LSPs`

`      `[`6.5`](#section-6-5)`. Advertising Leaf INFO Extended LSPs`
...
<a id="section-3"></a> **`3. Definition of Commonly Used Terms`**
...
<a id="section-4"></a> **`4. Utilizing Additional System IDs`**
...
<a id="section-4-1"></a> **`4.1. Additional Information in Extended LSPs`**
...
<a id="section-4-2"></a> **`4.2. Extended LSP Restrictions`**
...
<a id="section-4-2-1"></a> **`4.2.1. TLVs That MUST NOT Appear`**
...
<a id="section-4-2-2"></a> **`4.2.2. Leaf Advertisements in Extended LSPs`**
...
<a id="section-4-2-3"></a> **`4.2.3. IS Neighbor Advertisement Restrictions`**
...
<a id="section-4-2-4"></a> **`4.2.4. Area Addresses`**
...
<a id="section-4-2-5"></a> **`4.2.5. Overload, Attached, Partition Repair Bits`**
...
<a id="section-4-3"></a> **`4.3. Originating LSP Requirements`**
...
<a id="section-4-4"></a> **`4.4. IS Alias ID TLV (IS Alias ID)`**
...
<a id="section-4-5"></a> **`4.5. New TLVs in Support of IS Neighbor Attributes`**
...
<a id="section-5"></a> **`5. Comparison with the RFC 3786 Solution`**
...
<a id="section-6"></a> **`6. Deployment Considerations`**
...
<a id="section-6-1"></a> **`6.1. Advertising New TLVs in Extended LSPs`**
...
<a id="section-6-2"></a> **`6.2. Reachability and Non-SPF TLV Staleness`**
...
<a id="section-6-3"></a> **`6.3. Normal LSP OL State and Use of Extended LSPs`**
...
<a id="section-6-4"></a> **`6.4. Moving Neighbor Attribute INFO LSPs`**
...
<a id="section-6-5"></a> **`6.5. Advertising Leaf INFO Extended LSPs`**
