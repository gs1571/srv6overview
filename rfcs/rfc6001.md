...
`   `[`2`](#section-2)`. Summary of the Requirements and Evaluation`

`   `[`3`](#section-3)`. Interface Adjustment Capability Descriptor (IACD)`

`      `[`3.1`](#section-3-1)`. Overview`

`      `[`3.2`](#section-3-2)`. Interface Adjustment Capability Descriptor (IACD)`

`   `[`4`](#section-4)`. Multi-Region Signaling`

`      `[`4.1`](#section-4-1)`. XRO Subobjects`

`   `[`5`](#section-5)`. Virtual TE Link`

`      `[`5.1`](#section-5-1)`. Edge-to-Edge Association`

`      `[`5.2`](#section-5-2)`. Soft Forwarding Adjacency (Soft FA)`
...
`      `[`8.1`](#section-8-1)`. RSVP`

`      `[`8.2`](#section-8-2)`. OSPF`

`      `[`8.3`](#section-8-3)`. IS-IS`
...
<a id="section-2"></a> **`2. Summary of the Requirements and Evaluation`**
...
<a id="section-3"></a> **`3. Interface Adjustment Capability Descriptor (IACD)`**
...
<a id="section-3-2"></a> **`3.2. Interface Adjustment Capability Descriptor (IACD)`**
...
<a id="section-3-2-1"></a> **`3.2.1. OSPF`**
...
<a id="section-3-2-2"></a> **`3.2.2. IS-IS`**
...
<a id="section-4"></a> **`4. Multi-Region Signaling`**
...
<a id="section-4-1"></a> **`4.1. XRO Subobjects`**
...
<a id="section-4-1-1"></a> **`4.1.1. SC Subobject`**
...
<a id="section-4-1-2"></a> **`4.1.2. Label Subobject`**
...
<a id="section-5"></a> **`5. Virtual TE Link`**
...
<a id="section-5-1"></a> **`5.1. Edge-to-Edge Association`**
...
<a id="section-5-1-1"></a> **`5.1.1. CALL_ATTRIBUTES Object`**
...
<a id="section-5-1-2"></a> **`5.1.2. Processing`**
...
<a id="section-5-1-3"></a> **`5.1.3. Call Attributes TLVs`**
...
<a id="section-5-1-4"></a> **`5.1.4. Call Attributes Flags TLV`**
...
<a id="section-5-1-5"></a> **`5.1.5. Call Inheritance Flag`**
...
<a id="section-5-2"></a> **`5.2. Soft Forwarding Adjacency (Soft FA)`**
...
<a id="section-5-2-1"></a> **`5.2.1. Pre-Planned LSP Flag`**
...
<a id="section-5-2-2"></a> **`5.2.2. Path Provisioned LSPs`**
