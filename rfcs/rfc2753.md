...
<a id="section-3"></a> **`3. Policy-based Admission Control: Goals and Requirements`**
...
<a id="section-4"></a> **`4. Architectural Elements`**
...
<a id="section-4-1"></a> **`4.1. Example of a RSVP Router`**
...
<a id="section-4-2"></a> **`4.2. Additional functionality at the PDP`**
...
<a id="section-4-3"></a> **`4.3. Interactions between PEP, LPDP, and PDP at a RSVP router`**
...
<a id="section-4-4"></a> **`4.4. Placement of Policy Elements in a Network`**
...
<a id="section-5"></a> **`5. Example Policies, Scenarios, and  Policy Support`**
...
<a id="section-5-1"></a> **`5.1. Admission control policies based on factors such as Time-of-Day,`**
...
<a id="section-5-2"></a> **`5.2. Bilateral agreements between service providers`**
...
<a id="section-5-3"></a> **`5.3. Priority based admission control policies`**
...
<a id="section-5-4"></a> **`5.4. Pre-paid calling card or Tokens`**
...
<a id="section-5-5"></a> **`5.5. Sender Specified Restrictions on Receiver Reservations`**
...
<a id="section-6"></a> **`6. Interaction Between the Policy Enforcement Point (PEP) and the Policy`**
...
<a id="section-6-1"></a> **`6.1. PEP to PDP Protocol Requirements`**
