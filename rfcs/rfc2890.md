...
<a id="section-1-1"></a> **`1.1. Specification Language`**
...
<a id="section-2"></a> **`2. Extensions to GRE Header`**
...
<a id="section-2-1"></a> **`2.1. Key Field (4 octets)`**
...
<a id="section-2-2"></a> **`2.2. Sequence Number (4 octets)`**
