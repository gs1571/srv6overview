...
`     `[`1.1`](#section-1-1)`. Motivation`

`     `[`1.2`](#section-1-2)`. Audience`

`     `[`1.3`](#section-1-3)`. How to Read This Document`

`     `[`1.4`](#section-1-4)`. Applicability`

`     `[`1.5`](#section-1-5)`. Overview of Recommendations`

`     `[`1.6`](#section-1-6)`. Generalization from Current Technologies`

`     `[`1.7`](#section-1-7)`. Scope`

`       `[`1.7.1`](#section-1-7-1)`. In Scope`

`       `[`1.7.2`](#section-1-7-2)`. Out of Scope`

`     `[`1.8`](#section-1-8)`. Terminology`

`   `[`2`](#section-2)`. Naming of Application Services`

`     `[`2.1`](#section-2-1)`. Naming Application Services`

`     `[`2.2`](#section-2-2)`. DNS Domain Names`

`     `[`2.3`](#section-2-3)`. Subject Naming in PKIX Certificates`

`       `[`2.3.1`](#section-2-3-1)`. Implementation Notes`

`   `[`3`](#section-3)`. Designing Application Protocols`

`   `[`4`](#section-4)`. Representing Server Identity`

`     `[`4.1`](#section-4-1)`. Rules`

`     `[`4.2`](#section-4-2)`. Examples`

`   `[`5`](#section-5)`. Requesting Server Certificates`

`   `[`6`](#section-6)`. Verifying Service Identity`

`     `[`6.1`](#section-6-1)`. Overview`

`     `[`6.2`](#section-6-2)`. Constructing a List of Reference Identifiers`

`       `[`6.2.1`](#section-6-2-1)`. Rules`

`       `[`6.2.2`](#section-6-2-2)`. Examples`

`     `[`6.3`](#section-6-3)`. Preparing to Seek a Match`

`     `[`6.4`](#section-6-4)`. Matching the DNS Domain Name Portion`

`       `[`6.4.1`](#section-6-4-1)`. Checking of Traditional Domain Names`

`       `[`6.4.2`](#section-6-4-2)`. Checking of Internationalized Domain Names`

`       `[`6.4.3`](#section-6-4-3)`. Checking of Wildcard Certificates`

`       `[`6.4.4`](#section-6-4-4)`. Checking of Common Names`

`     `[`6.5`](#section-6-5)`. Matching the Application Service Type Portion`

`       `[`6.5.1`](#section-6-5-1)`. SRV-ID`

`       `[`6.5.2`](#section-6-5-2)`. URI-ID`

`     `[`6.6`](#section-6-6)`. Outcome`

`       `[`6.6.1`](#section-6-6-1)`. Case #1: Match Found`

`       `[`6.6.2`](#section-6-6-2)`. Case #2: No Match Found, Pinned Certificate`

`       `[`6.6.3`](#section-6-6-3)`. Case #3: No Match Found, No Pinned Certificate`

`       `[`6.6.4`](#section-6-6-4)`. Fallback`

`   `[`7`](#section-7)`. Security Considerations`

`     `[`7.1`](#section-7-1)`. Pinned Certificates`

`     `[`7.2`](#section-7-2)`. Wildcard Certificates`

`     `[`7.3`](#section-7-3)`. Internationalized Domain Names`

`     `[`7.4`](#section-7-4)`. Multiple Identifiers`
...
<a id="section-1-1"></a> **`1.1. Motivation`**
...
<a id="section-1-3"></a> **`1.3. How to Read This Document`**
...
<a id="section-1-4"></a> **`1.4. Applicability`**
...
<a id="section-1-5"></a> **`1.5. Overview of Recommendations`**
...
<a id="section-1-6"></a> **`1.6. Generalization from Current Technologies`**
...
<a id="section-1-7"></a> **`1.7. Scope`**

```text

```

<a id="section-1-7-1"></a> **`1.7.1. In Scope`**
...
<a id="section-1-7-2"></a> **`1.7.2. Out of Scope`**
...
<a id="section-1-8"></a> **`1.8. Terminology`**
...
<a id="section-2"></a> **`2. Naming of Application Services`**
...
<a id="section-2-1"></a> **`2.1. Naming Application Services`**
...
<a id="section-2-2"></a> **`2.2. DNS Domain Names`**
...
<a id="section-2-3"></a> **`2.3. Subject Naming in PKIX Certificates`**
...
<a id="section-2-3-1"></a> **`2.3.1. Implementation Notes`**
...
<a id="section-3"></a> **`3. Designing Application Protocols`**
...
<a id="section-4"></a> **`4. Representing Server Identity`**
...
<a id="section-4-2"></a> **`4.2. Examples`**
...
<a id="section-5"></a> **`5. Requesting Server Certificates`**
...
<a id="section-6"></a> **`6. Verifying Service Identity`**
...
<a id="section-6-2"></a> **`6.2. Constructing a List of Reference Identifiers`**

```text

```

<a id="section-6-2-1"></a> **`6.2.1. Rules`**
...
<a id="section-6-2-2"></a> **`6.2.2. Examples`**
...
<a id="section-6-3"></a> **`6.3. Preparing to Seek a Match`**
...
<a id="section-6-4"></a> **`6.4. Matching the DNS Domain Name Portion`**
...
<a id="section-6-4-1"></a> **`6.4.1. Checking of Traditional Domain Names`**
...
<a id="section-6-4-2"></a> **`6.4.2. Checking of Internationalized Domain Names`**
...
<a id="section-6-4-3"></a> **`6.4.3. Checking of Wildcard Certificates`**
...
<a id="section-6-4-4"></a> **`6.4.4. Checking of Common Names`**
...
<a id="section-6-5"></a> **`6.5. Matching the Application Service Type Portion`**
...
<a id="section-6-5-1"></a> **`6.5.1. SRV-ID`**
...
<a id="section-6-5-2"></a> **`6.5.2. URI-ID`**
...
<a id="section-6-6"></a> **`6.6. Outcome`**
...
<a id="section-6-6-1"></a> **`6.6.1. Case #1: Match Found`**
...
<a id="section-6-6-2"></a> **`6.6.2. Case #2: No Match Found, Pinned Certificate`**
...
<a id="section-6-6-3"></a> **`6.6.3. Case #3: No Match Found, No Pinned Certificate`**
...
<a id="section-6-6-4"></a> **`6.6.4. Fallback`**
...
<a id="section-7-1"></a> **`7.1. Pinned Certificates`**
...
<a id="section-7-2"></a> **`7.2. Wildcard Certificates`**
...
<a id="section-7-3"></a> **`7.3. Internationalized Domain Names`**
...
<a id="section-7-4"></a> **`7.4. Multiple Identifiers`**
