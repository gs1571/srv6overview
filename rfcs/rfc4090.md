...
`   `[`3`](#section-3)`. Local Repair Techniques`

`       `[`3.1`](#section-3-1)`. One-to-One Backup`

`       `[`3.2`](#section-3-2)`. Facility Backup`

`   `[`4`](#section-4)`. RSVP Extensions`

`       `[`4.1`](#section-4-1)`. FAST_REROUTE Object`

`       `[`4.2`](#section-4-2)`. DETOUR Object`

`             `[`4.2.1`](#section-4-2-1)`. DETOUR Object for IPv4 Address`

`             `[`4.2.2`](#section-4-2-2)`. DETOUR Object for IPv6 Address`

`       `[`4.3`](#section-4-3)`. SESSION_ATTRIBUTE Flags`

`       `[`4.4`](#section-4-4)`. RRO IPv4/IPv6 Sub-object Flags`

`   `[`5`](#section-5)`. Head-End Behavior`

`   `[`6`](#section-6)`. Point of Local Repair (PLR) Behavior`

`       `[`6.1`](#section-6-1)`. Signaling a Backup Path`

`             `[`6.1.1`](#section-6-1-1)`. Backup Path Identification: Sender`

`                    Template-Specific`

`             `[`6.1.2`](#section-6-1-2)`. Backup Path Identification: Path-Specific`

`       `[`6.2`](#section-6-2)`. Procedures for Backup Path Computation`

`       `[`6.3`](#section-6-3)`. Signaling Backups for One-to-One Protection`

`             `[`6.3.1`](#section-6-3-1)`. Make-before-Break with Detour LSPs`

`             `[`6.3.2`](#section-6-3-2)`. Message Handling`

`             `[`6.3.3`](#section-6-3-3)`. Local Reroute of Traffic onto Detour LSP`

`        `[`6.4`](#section-6-4)`. Signaling for Facility Protection`

`             `[`6.4.1`](#section-6-4-1)`. Discovering Downstream Labels`

`             `[`6.4.2`](#section-6-4-2)`. Procedures for the PLR before Local Repair`

`             `[`6.4.3`](#section-6-4-3)`. Procedures for the PLR during Local Repair`

`             `[`6.4.4`](#section-6-4-4)`. Processing Backup Tunnel's ERO`

`        `[`6.5`](#section-6-5)`. PLR Procedures during Local Repair`

`             `[`6.5.1`](#section-6-5-1)`. Notification of Local Repair`

`             `[`6.5.2`](#section-6-5-2)`. Revertive Behavior`

`   `[`7`](#section-7)`. Merge Node Behavior`

`       `[`7.1`](#section-7-1)`. Handling Backup Path Messages before Failure`

`             `[`7.1.1`](#section-7-1-1)`. Merging Backup Paths using the Sender`

`                    Template-Specific Method`

`             `[`7.1.2`](#section-7-1-2)`. Merging Detours using the Path-Specific Method`

`             `[`7.1.3`](#section-7-1-3)`. Message Handling for Merged Detours`

`       `[`7.2`](#section-7-2)`. Handling Failures`

`   `[`8`](#section-8)`. Behavior of All LSRs`

`       `[`8.1`](#section-8-1)`. Merging Detours in the Path-Specific Method`
...
<a id="section-3"></a> **`3. Local Repair Techniques`**
...
<a id="section-3-1"></a> **`3.1. One-to-One Backup`**
...
<a id="section-3-2"></a> **`3.2. Facility Backup`**
...
<a id="section-4"></a> **`4. RSVP Extensions`**
...
<a id="section-4-1"></a> **`4.1. FAST_REROUTE Object`**
...
<a id="section-4-2"></a> **`4.2. DETOUR Object`**
...
<a id="section-4-2-1"></a> **`4.2.1. DETOUR Object for IPv4 Address`**
...
<a id="section-4-2-2"></a> **`4.2.2. DETOUR Object for IPv6 Address`**
...
<a id="section-4-3"></a> **`4.3. SESSION_ATTRIBUTE Flags`**
...
<a id="section-4-4"></a> **`4.4. RRO IPv4/IPv6 Sub-object Flags`**
...
<a id="section-5"></a> **`5. Head-End Behavior`**
...
<a id="section-6"></a> **`6. Point of Local Repair (PLR) Behavior`**
...
<a id="section-6-1"></a> **`6.1. Signaling a Backup Path`**
...
<a id="section-6-1-1"></a> **`6.1.1. Backup Path Identification: Sender Template-Specific`**
...
<a id="section-6-1-2"></a> **`6.1.2. Backup Path Identification: Path-Specific`**
...
<a id="section-6-2"></a> **`6.2. Procedures for Backup Path Computation`**
...
<a id="section-6-3"></a> **`6.3. Signaling Backups for One-to-One Protection`**
...
<a id="section-6-3-1"></a> **`6.3.1. Make-before-Break with Detour LSPs`**
...
<a id="section-6-3-2"></a> **`6.3.2. Message Handling`**
...
<a id="section-6-3-3"></a> **`6.3.3. Local Reroute of Traffic onto Detour LSP`**
...
<a id="section-6-4"></a> **`6.4. Signaling for Facility Protection`**
...
<a id="section-6-4-1"></a> **`6.4.1. Discovering Downstream Labels`**
...
<a id="section-6-4-2"></a> **`6.4.2. Procedures for the PLR before Local Repair`**
...
<a id="section-6-4-3"></a> **`6.4.3. Procedures for the PLR during Local Repair`**
...
<a id="section-6-4-4"></a> **`6.4.4. Processing Backup Tunnel's ERO`**
...
<a id="section-6-5"></a> **`6.5. PLR Procedures during Local Repair`**
...
<a id="section-6-5-1"></a> **`6.5.1. Notification of Local Repair`**
...
<a id="section-6-5-2"></a> **`6.5.2. Revertive Behavior`**
...
<a id="section-7"></a> **`7. Merge Node Behavior`**
...
<a id="section-7-1"></a> **`7.1. Handling Backup Path Messages before Failure`**
...
<a id="section-7-1-1"></a> **`7.1.1. Merging Backup Paths using the Sender Template-Specific Method`**
...
<a id="section-7-1-2"></a> **`7.1.2. Merging Detours using the Path-Specific Method`**
...
<a id="section-7-1-2-1"></a> **`7.1.2.1. An Example of Path Message Merging`**
...
<a id="section-7-1-3"></a> **`7.1.3. Message Handling for Merged Detours`**
...
<a id="section-7-2"></a> **`7.2. Handling Failures`**
...
<a id="section-8"></a> **`8. Behavior of All LSRs`**
...
<a id="section-8-1"></a> **`8.1. Merging Detours in the Path-Specific Method`**
...
<a id="section-10-1"></a> **`10.1. DETOUR Object`**
...
<a id="section-10-2"></a> **`10.2. FAST_REROUTE Object`**
