...
`   `[`6`](#section-6)`. Packet Expansion`

`   `[`7`](#section-7)`. IKE Conventions`

`      `[`7.1`](#section-7-1)`. Keying Material and Salt Values`

`      `[`7.2`](#section-7-2)`. Phase 1 Identifier`

`      `[`7.3`](#section-7-3)`. Phase 2 Identifier`

`      `[`7.4`](#section-7-4)`. Key Length Attribute`

`   `[`8`](#section-8)`. Test Vectors`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Design Rationale`
...
<a id="section-2"></a> **`2. AES CCM Mode`**
...
<a id="section-6"></a> **`6. Packet Expansion`**
...
<a id="section-7"></a> **`7. IKE Conventions`**
...
<a id="section-7-1"></a> **`7.1. Keying Material and Salt Values`**
...
<a id="section-7-2"></a> **`7.2. Phase 1 Identifier`**
...
<a id="section-7-3"></a> **`7.3. Phase 2 Identifier`**
...
<a id="section-7-4"></a> **`7.4. Key Length Attribute`**
...
<a id="section-8"></a> **`8. Test Vectors`**
...
<a id="section-10"></a> **`10. Design Rationale`**
