...
`   `[`2`](#section-2)`. Prefix-to-AS Mapping Database`

`     `[`2.1`](#section-2-1)`. Pseudo-Code`

`   `[`3`](#section-3)`. Policy Control`

`   `[`4`](#section-4)`. Interaction with Local Cache`
...
`     `[`8.2`](#section-8-2)`. Informational References`
...
<a id="section-2"></a> **`2. Prefix-to-AS Mapping Database`**
...
<a id="section-2-1"></a> **`2.1. Pseudo-Code`**
...
<a id="section-3"></a> **`3. Policy Control`**
...
<a id="section-4"></a> **`4. Interaction with Local Cache`**
...
<a id="section-8-2"></a> **`8.2. Informational References`**
