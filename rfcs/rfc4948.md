...
`   `[`2`](#section-2)`. The Root of All Evils: An Underground Economy`

`     `[`2.1`](#section-2-1)`. The Underground Economy`

`     `[`2.2`](#section-2-2)`. Our Enemy Using Our Networks, Our Tools`

`     `[`2.3`](#section-2-3)`. Compromised Systems Being a Major Source of Problems`

`     `[`2.4`](#section-2-4)`. Lack of Meaningful Deterrence`

`     `[`2.5`](#section-2-5)`. Consequences`

`   `[`3`](#section-3)`. How Bad Is The Problem?`

`     `[`3.1`](#section-3-1)`. Backbone Providers`

`       `[`3.1.1`](#section-3-1-1)`. DDoS Traffic`

`       `[`3.1.2`](#section-3-1-2)`. Problem Mitigation`

`     `[`3.2`](#section-3-2)`. Access Providers`

`     `[`3.3`](#section-3-3)`. Enterprise Networks: Perspective from a Large`

`           Enterprise`

`     `[`3.4`](#section-3-4)`. Domain Name Services`

`   `[`4`](#section-4)`. Current Vulnerabilities and Existing Solutions`

`     `[`4.1`](#section-4-1)`. Internet Vulnerabilities`

`     `[`4.2`](#section-4-2)`. Existing Solutions`

`       `[`4.2.1`](#section-4-2-1)`. Existing Solutions for Backbone Providers`

`       `[`4.2.2`](#section-4-2-2)`. Existing Solutions for Enterprise Networks`

`     `[`4.3`](#section-4-3)`. Shortfalls in the Existing Network Protection`

`       `[`4.3.1`](#section-4-3-1)`. Inadequate Tools`

`       `[`4.3.2`](#section-4-3-2)`. Inadequate Deployments`

`       `[`4.3.3`](#section-4-3-3)`. Inadequate Education`

`       `[`4.3.4`](#section-4-3-4)`. Is Closing Down Open Internet Access Necessary?`

`   `[`5`](#section-5)`. Active and Potential Solutions in the Pipeline`

`     `[`5.1`](#section-5-1)`. Central Policy Repository`

`     `[`5.2`](#section-5-2)`. Flow Based Tools`

`     `[`5.3`](#section-5-3)`. Internet Motion Sensor (IMS)`

`     `[`5.4`](#section-5-4)`. BCP 38`

`     `[`5.5`](#section-5-5)`. Layer 5 to 7 Awareness`

`     `[`5.6`](#section-5-6)`. How To's`

`     `[`5.7`](#section-5-7)`. SHRED`

`   `[`6`](#section-6)`. Research in Progress`

`     `[`6.1`](#section-6-1)`. Ongoing Research`

`       `[`6.1.1`](#section-6-1-1)`. Exploited Hosts`

`       `[`6.1.2`](#section-6-1-2)`. Distributed Denial of Service (DDoS) Attacks`

`       `[`6.1.3`](#section-6-1-3)`. Spyware`

`       `[`6.1.4`](#section-6-1-4)`. Forensic Aids`

`       `[`6.1.5`](#section-6-1-5)`. Measurements`

`       `[`6.1.6`](#section-6-1-6)`. Traffic Analysis`

`       `[`6.1.7`](#section-6-1-7)`. Protocol and Software Security`

`     `[`6.2`](#section-6-2)`. Research on the Internet`

`       `[`6.2.1`](#section-6-2-1)`. Research and Standards`

`       `[`6.2.2`](#section-6-2-2)`. Research and the Bad Guys`

`   `[`7`](#section-7)`. Aladdin's Lamp`

`     `[`7.1`](#section-7-1)`. Security Improvements`

`     `[`7.2`](#section-7-2)`. Unwanted Traffic`

`   `[`8`](#section-8)`. Workshop Summary`

`     `[`8.1`](#section-8-1)`. Hard Questions`

`     `[`8.2`](#section-8-2)`. Medium or Long Term Steps`

`     `[`8.3`](#section-8-3)`. Immediately Actionable Steps`

`   `[`9`](#section-9)`. Terminology`
...
<a id="section-2"></a> **`2. The Root of All Evils: An Underground Economy`**
...
<a id="section-2-1"></a> **`2.1. The Underground Economy`**
...
<a id="section-2-2"></a> **`2.2. Our Enemy Using Our Networks, Our Tools`**
...
<a id="section-2-3"></a> **`2.3. Compromised Systems Being a Major Source of Problems`**
...
<a id="section-2-4"></a> **`2.4. Lack of Meaningful Deterrence`**
...
<a id="section-2-5"></a> **`2.5. Consequences`**
...
<a id="section-3"></a> **`3. How Bad Is The Problem?`**
...
<a id="section-3-1"></a> **`3.1. Backbone Providers`**
...
<a id="section-3-1-1"></a> **`3.1.1. DDoS Traffic`**
...
<a id="section-3-1-2"></a> **`3.1.2. Problem Mitigation`**
...
<a id="section-3-2"></a> **`3.2. Access Providers`**
...
<a id="section-3-3"></a> **`3.3. Enterprise Networks: Perspective from a Large Enterprise`**
...
<a id="section-3-4"></a> **`3.4. Domain Name Services`**
...
<a id="section-4"></a> **`4. Current Vulnerabilities and Existing Solutions`**
...
<a id="section-4-1"></a> **`4.1. Internet Vulnerabilities`**
...
<a id="section-4-2"></a> **`4.2. Existing Solutions`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. Existing Solutions for Backbone Providers`**
...
<a id="section-4-2-2"></a> **`4.2.2. Existing Solutions for Enterprise Networks`**
...
<a id="section-4-3"></a> **`4.3. Shortfalls in the Existing Network Protection`**

```text

```

<a id="section-4-3-1"></a> **`4.3.1. Inadequate Tools`**
...
<a id="section-4-3-2"></a> **`4.3.2. Inadequate Deployments`**
...
<a id="section-4-3-3"></a> **`4.3.3. Inadequate Education`**
...
<a id="section-4-3-4"></a> **`4.3.4. Is Closing Down Open Internet Access Necessary?`**
...
<a id="section-5"></a> **`5. Active and Potential Solutions in the Pipeline`**
...
<a id="section-5-1"></a> **`5.1. Central Policy Repository`**
...
<a id="section-5-2"></a> **`5.2. Flow Based Tools`**
...
<a id="section-5-3"></a> **`5.3. Internet Motion Sensor (IMS)`**
...
<a id="section-5-5"></a> **`5.5. Layer 5 to 7 Awareness`**
...
<a id="section-5-6"></a> **`5.6. How To's`**
...
<a id="section-6"></a> **`6. Research in Progress`**
...
<a id="section-6-1"></a> **`6.1. Ongoing Research`**
...
<a id="section-6-1-1"></a> **`6.1.1. Exploited Hosts`**
...
<a id="section-6-1-1-1"></a> **`6.1.1.1. Prevention`**
...
<a id="section-6-1-1-2"></a> **`6.1.1.2. Detection`**
...
<a id="section-6-1-1-3"></a> **`6.1.1.3. Defense`**
...
<a id="section-6-1-2"></a> **`6.1.2. Distributed Denial of Service (DDoS) Attacks`**
...
<a id="section-6-1-2-1"></a> **`6.1.2.1. Application Oriented DDoS Research`**
...
<a id="section-6-1-2-2"></a> **`6.1.2.2. Network Oriented DDoS Research`**
...
<a id="section-6-1-3"></a> **`6.1.3. Spyware`**
...
<a id="section-6-1-4"></a> **`6.1.4. Forensic Aids`**
...
<a id="section-6-1-5"></a> **`6.1.5. Measurements`**
...
<a id="section-6-1-6"></a> **`6.1.6. Traffic Analysis`**
...
<a id="section-6-1-7"></a> **`6.1.7. Protocol and Software Security`**
...
<a id="section-6-2"></a> **`6.2. Research on the Internet`**
...
<a id="section-6-2-1"></a> **`6.2.1. Research and Standards`**
...
<a id="section-6-2-2"></a> **`6.2.2. Research and the Bad Guys`**
...
<a id="section-7"></a> **`7. Aladdin's Lamp`**
...
<a id="section-7-1"></a> **`7.1. Security Improvements`**
...
<a id="section-7-2"></a> **`7.2. Unwanted Traffic`**
...
<a id="section-8"></a> **`8. Workshop Summary`**
...
<a id="section-8-1"></a> **`8.1. Hard Questions`**
...
<a id="section-8-2"></a> **`8.2. Medium or Long Term Steps`**
...
<a id="section-8-3"></a> **`8.3. Immediately Actionable Steps`**
...
<a id="section-9"></a> **`9. Terminology`**
