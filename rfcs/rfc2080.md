...
`   `[`1.1`](#section-1-1)`. Theoretical Underpinnings`

`   `[`1.2`](#section-1-2)`. Limitations of the Protocol`

`   `[`2`](#section-2)`. Protocol Specification`

`   `[`2.1`](#section-2-1)`. Message Format`

`   `[`2.1.1`](#section-2-1-1)`. Next Hop`

`   `[`2.2`](#section-2-2)`. Addressing Considerations`

`   `[`2.3`](#section-2-3)`. Timers`

`   `[`2.4`](#section-2-4)`. Input Processing`

`   `[`2.4.1`](#section-2-4-1)`. Request Messages`

`   `[`2.4.2`](#section-2-4-2)`. Response Messages`

`   `[`2.5`](#section-2-5)`. Output Processing`

`   `[`2.5.1`](#section-2-5-1)`. Triggered Updates`

`   `[`2.5.2`](#section-2-5-2)`. Generating Response Messages`

`   `[`2.6`](#section-2-6)`. Split Horizon`

`   `[`3`](#section-3)`. Control Functions`
...
<a id="section-3"></a> **`3. Control Functions`**
