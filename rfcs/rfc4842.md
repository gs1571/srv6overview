...
`   `[`3`](#section-3)`. Requirements Notation`

`   `[`4`](#section-4)`. Acronyms`

`   `[`5`](#section-5)`. CEP Encapsulation Format`

`     `[`5.1`](#section-5-1)`. SONET/SDH Fragment`

`     `[`5.2`](#section-5-2)`. CEP Header`

`     `[`5.3`](#section-5-3)`. RTP Header`

`     `[`5.4`](#section-5-4)`. PSN Encapsulation`

`   `[`6`](#section-6)`. CEP Operation`

`     `[`6.1`](#section-6-1)`. CEP Packetizer and De-Packetizer`

`     `[`6.2`](#section-6-2)`. Packet Synchronization`

`       `[`6.2.1`](#section-6-2-1)`. Acquisition of Packet Synchronization`

`       `[`6.2.2`](#section-6-2-2)`. Loss of Packet Synchronization`

`   `[`7`](#section-7)`. SONET/SDH Maintenance Signals`

`     `[`7.1`](#section-7-1)`. SONET/SDH to PSN`

`       `[`7.1.1`](#section-7-1-1)`. CEP-AIS: AIS-P/V Indication`

`       `[`7.1.2`](#section-7-1-2)`. Unequipped Indication`

`       `[`7.1.3`](#section-7-1-3)`. CEP-RDI: Remote Defect Indication`

`     `[`7.2`](#section-7-2)`. PSN to SONET/SDH`

`       `[`7.2.1`](#section-7-2-1)`. CEP-AIS: AIS-P/V Indication`

`       `[`7.2.2`](#section-7-2-2)`. Unequipped Indication`

`   `[`8`](#section-8)`. SONET/SDH Transport Timing`

`   `[`9`](#section-9)`. SONET/SDH Pointer Management`

`     `[`9.1`](#section-9-1)`. Explicit Pointer Adjustment Relay (EPAR)`

`     `[`9.2`](#section-9-2)`. Adaptive Pointer Management (APM)`

`   `[`10`](#section-10)`. CEP Performance Monitors`

`     `[`10.1`](#section-10-1)`. Near-End Performance Monitors`

`     `[`10.2`](#section-10-2)`. Far-End Performance Monitors`

`   `[`11`](#section-11)`. Payload Compression Options`

`     `[`11.1`](#section-11-1)`. Dynamic Bandwidth Allocation`

`     `[`11.2`](#section-11-2)`. Service-Specific Payload Formats`

`       `[`11.2.1`](#section-11-2-1)`. Fractional STS-1 (VC-3) Encapsulation`

`         `[`11.2.1.1`](#section-11-2-1-1)`. Fractional STS-1 CEP Header`

`         `[`11.2.1.2`](#section-11-2-1-2)`. B3 Compensation`

`         `[`11.2.1.3`](#section-11-2-1-3)`. Actual Payload Size`

`       `[`11.2.2`](#section-11-2-2)`. Asynchronous T3/E3 STS-1 (VC-3) Encapsulation`

`         `[`11.2.2.1`](#section-11-2-2-1)`. T3 Payload Compression`

`         `[`11.2.2.2`](#section-11-2-2-2)`. E3 Payload Compression`

`       `[`11.2.3`](#section-11-2-3)`. Fractional VC-4 Encapsulation`

`         `[`11.2.3.1`](#section-11-2-3-1)`. Fractional VC-4 Mapping`

`         `[`11.2.3.2`](#section-11-2-3-2)`. Fractional VC-4 CEP Header`

`         `[`11.2.3.3`](#section-11-2-3-3)`. B3 Compensation`

`         `[`11.2.3.4`](#section-11-2-3-4)`. Actual Payload Sizes`

`   `[`12`](#section-12)`. Signaling of CEP Pseudowires`

`     `[`12.1`](#section-12-1)`. CEP/TDM Payload Bytes`

`     `[`12.2`](#section-12-2)`. CEP/TDM Bit Rate`

`     `[`12.3`](#section-12-3)`. CEP Options`

`   `[`13`](#section-13)`. Congestion Control`
...
<a id="section-3"></a> **`3. Requirements Notation`**
...
<a id="section-5"></a> **`5. CEP Encapsulation Format`**
...
<a id="section-5-1"></a> **`5.1. SONET/SDH Fragment`**
...
<a id="section-5-2"></a> **`5.2. CEP Header`**
...
<a id="section-5-3"></a> **`5.3. RTP Header`**
...
<a id="section-5-4"></a> **`5.4. PSN Encapsulation`**
...
<a id="section-6"></a> **`6. CEP Operation`**
...
<a id="section-6-1"></a> **`6.1. CEP Packetizer and De-Packetizer`**
...
<a id="section-6-2"></a> **`6.2. Packet Synchronization`**
...
<a id="section-6-2-1"></a> **`6.2.1. Acquisition of Packet Synchronization`**
...
<a id="section-6-2-2"></a> **`6.2.2. Loss of Packet Synchronization`**
...
<a id="section-7"></a> **`7. SONET/SDH Maintenance Signals`**
...
<a id="section-7-1"></a> **`7.1. SONET/SDH to PSN`**
...
<a id="section-7-1-1"></a> **`7.1.1. CEP-AIS: AIS-P/V Indication`**
...
<a id="section-7-1-2"></a> **`7.1.2. Unequipped Indication`**
...
<a id="section-7-1-3"></a> **`7.1.3. CEP-RDI: Remote Defect Indication`**
...
<a id="section-7-2"></a> **`7.2. PSN to SONET/SDH`**
...
<a id="section-7-2-1"></a> **`7.2.1. CEP-AIS: AIS-P/V Indication`**
...
<a id="section-7-2-2"></a> **`7.2.2. Unequipped Indication`**
...
<a id="section-8"></a> **`8. SONET/SDH Transport Timing`**
...
<a id="section-9"></a> **`9. SONET/SDH Pointer Management`**
...
<a id="section-9-1"></a> **`9.1. Explicit Pointer Adjustment Relay (EPAR)`**
...
<a id="section-9-2"></a> **`9.2. Adaptive Pointer Management (APM)`**
...
<a id="section-10"></a> **`10. CEP Performance Monitors`**
...
<a id="section-10-1"></a> **`10.1. Near-End Performance Monitors`**
...
<a id="section-10-2"></a> **`10.2. Far-End Performance Monitors`**
...
<a id="section-11"></a> **`11. Payload Compression Options`**
...
<a id="section-11-1"></a> **`11.1. Dynamic Bandwidth Allocation`**
...
<a id="section-11-2"></a> **`11.2. Service-Specific Payload Formats`**
...
<a id="section-11-2-1"></a> **`11.2.1. Fractional STS-1 (VC-3) Encapsulation`**
...
<a id="section-11-2-1-1"></a> **`11.2.1.1. Fractional STS-1 CEP Header`**
...
<a id="section-11-2-1-2"></a> **`11.2.1.2. B3 Compensation`**
...
<a id="section-11-2-1-3"></a> **`11.2.1.3. Actual Payload Size`**
...
<a id="section-11-2-2"></a> **`11.2.2. Asynchronous T3/E3 STS-1 (VC-3) Encapsulation`**
...
<a id="section-11-2-2-1"></a> **`11.2.2.1. T3 Payload Compression`**
...
<a id="section-11-2-2-2"></a> **`11.2.2.2. E3 Payload Compression`**
...
<a id="section-11-2-3"></a> **`11.2.3. Fractional VC-4 Encapsulation`**
...
<a id="section-11-2-3-1"></a> **`11.2.3.1. Fractional VC-4 Mapping`**
...
<a id="section-11-2-3-2"></a> **`11.2.3.2. Fractional VC-4 CEP Header`**
...
<a id="section-11-2-3-3"></a> **`11.2.3.3. B3 Compensation`**
...
<a id="section-11-2-3-4"></a> **`11.2.3.4. Actual Payload Sizes`**
...
<a id="section-12"></a> **`12. Signaling of CEP Pseudowires`**
...
<a id="section-12-1"></a> **`12.1. CEP/TDM Payload Bytes`**
...
<a id="section-12-2"></a> **`12.2. CEP/TDM Bit Rate`**
...
<a id="section-12-3"></a> **`12.3. CEP Options`**
...
<a id="section-13"></a> **`13. Congestion Control`**
...
<a id="section-15"></a> **`15. IANA Considerations`**
...
<a id="section-17"></a> **`17. Co-Authors`**
