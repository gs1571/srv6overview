...
`   `[`1.1`](#section-1-1)`. Cross-Realm Operation`

`   `[`1.2`](#section-1-2)`. Environmental assumptions`

`   `[`1.3`](#section-1-3)`. Glossary of terms`

`   `[`2`](#section-2)`. Ticket flag uses and requests`

`   `[`2.1`](#section-2-1)`. Initial and pre-authenticated tickets`
...
`   `[`2.7`](#section-2-7)`. Other KDC options`
...
`   `[`3.3.3.1`](#section-3-3-3-1)`. Encoding the transited field`
...
`   `[`4`](#section-4)`. The Kerberos Database`

`   `[`4.1`](#section-4-1)`. Database contents`

`   `[`4.2`](#section-4-2)`. Additional fields`

`   `[`4.3`](#section-4-3)`. Frequently Changing Fields`

`   `[`4.4`](#section-4-4)`. Site Constants`

`   `[`5`](#section-5)`. Message Specifications`

`   `[`5.1`](#section-5-1)`. ASN.1 Distinguished Encoding Representation`

`   `[`5.2`](#section-5-2)`. ASN.1 Base Definitions`

`   `[`5.3`](#section-5-3)`. Tickets and Authenticators`

`   `[`5.3.1`](#section-5-3-1)`. Tickets`

`   `[`5.3.2`](#section-5-3-2)`. Authenticators`
...
`   `[`6`](#section-6)`. Encryption and Checksum Specifications`

`   `[`6.1`](#section-6-1)`. Encryption Specifications`

`   `[`6.2`](#section-6-2)`. Encryption Keys`

`   `[`6.3`](#section-6-3)`. Encryption Systems`

`   `[`6.3.1`](#section-6-3-1)`. The NULL Encryption System (null)`

`   `[`6.3.2`](#section-6-3-2)`. DES in CBC mode with a CRC-32 checksum (descbc-crc)71`

`   `[`6.3.3`](#section-6-3-3)`. DES in CBC mode with an MD4 checksum (descbc-md4)  72`

`   `[`6.3.4`](#section-6-3-4)`. DES in CBC mode with an MD5 checksum (descbc-md5)  72`

`   `[`6.4`](#section-6-4)`. Checksums`

`   `[`6.4.1`](#section-6-4-1)`. The CRC-32 Checksum (crc32)`

`   `[`6.4.2`](#section-6-4-2)`. The RSA MD4 Checksum (rsa-md4)`

`   `[`6.4.3`](#section-6-4-3)`. RSA MD4 Cryptographic Checksum Using DES`

`   (rsa-md4-des)`

`   `[`6.4.4`](#section-6-4-4)`. The RSA MD5 Checksum (rsa-md5)`

`   `[`6.4.5`](#section-6-4-5)`. RSA MD5 Cryptographic Checksum Using DES`

`   (rsa-md5-des)`

`   `[`6.4.6`](#section-6-4-6)`. DES cipher-block chained checksum (des-mac)`

`   `[`6.4.7`](#section-6-4-7)`. RSA MD4 Cryptographic Checksum Using DES`

`   alternative (rsa-md4-des-k)`

`   `[`6.4.8`](#section-6-4-8)`. DES cipher-block chained checksum alternative`

`   (des-mac-k)`

`   `[`7`](#section-7)`. Naming Constraints`

`   `[`7.1`](#section-7-1)`. Realm Names`

`   `[`7.2`](#section-7-2)`. Principal Names`

`   `[`7.2.1`](#section-7-2-1)`. Name of server principals`

`   `[`8`](#section-8)`. Constants and other defined values`

`   `[`8.1`](#section-8-1)`. Host address types`

`   `[`8.2`](#section-8-2)`. KDC messages`

`   `[`8.2.1`](#section-8-2-1)`. IP transport`

`   `[`8.2.2`](#section-8-2-2)`. OSI transport`

`   `[`8.2.3`](#section-8-2-3)`. Name of the TGS`

`   `[`8.3`](#section-8-3)`. Protocol constants and associated values`

`   `[`9`](#section-9)`. Interoperability requirements`

`   `[`9.1`](#section-9-1)`. Specification 1`

`   `[`9.2`](#section-9-2)`. Recommended KDC values`
...
<a id="section-1-1"></a> **`1.1. Cross-Realm Operation`**
...
<a id="section-1-2"></a> **`1.2. Environmental assumptions`**
...
<a id="section-1-3"></a> **`1.3. Glossary of terms`**
...
<a id="section-2-1"></a> **`2.1. Initial and pre-authenticated tickets`**
...
<a id="section-2-7"></a> **`2.7. Other KDC options`**
...
<a id="section-3-3-3-1"></a> **`3.3.3.1. Encoding the transited field`**
...
<a id="section-4"></a> **`4. The Kerberos Database`**
...
<a id="section-4-1"></a> **`4.1. Database contents`**
...
<a id="section-4-2"></a> **`4.2. Additional fields`**
...
<a id="section-4-3"></a> **`4.3. Frequently Changing Fields`**
...
<a id="section-4-4"></a> **`4.4. Site Constants`**
...
<a id="section-5-1"></a> **`5.1. ASN.1 Distinguished Encoding Representation`**
...
<a id="section-5-2"></a> **`5.2. ASN.1 Base Definitions`**
...
<a id="section-5-3"></a> **`5.3. Tickets and Authenticators`**
...
<a id="section-5-3-1"></a> **`5.3.1. Tickets`**
...
<a id="section-5-3-2"></a> **`5.3.2. Authenticators`**
...
<a id="section-6"></a> **`6. Encryption and Checksum Specifications`**
...
<a id="section-6-1"></a> **`6.1. Encryption Specifications`**
...
<a id="section-6-2"></a> **`6.2. Encryption Keys`**
...
<a id="section-6-3"></a> **`6.3. Encryption Systems`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. The NULL Encryption System (null)`**
...
<a id="section-6-3-2"></a> **`6.3.2. DES in CBC mode with a CRC-32 checksum (des-cbc-crc)`**
...
<a id="section-6-3-3"></a> **`6.3.3. DES in CBC mode with an MD4 checksum (des-cbc-md4)`**
...
<a id="section-6-3-4"></a> **`6.3.4. DES in CBC mode with an MD5 checksum (des-cbc-md5)`**
...
<a id="section-6-4"></a> **`6.4. Checksums`**
...
<a id="section-6-4-1"></a> **`6.4.1. The CRC-32 Checksum (crc32)`**
...
<a id="section-6-4-2"></a> **`6.4.2. The RSA MD4 Checksum (rsa-md4)`**
...
<a id="section-6-4-3"></a> **`6.4.3. RSA MD4 Cryptographic Checksum Using DES (rsa-md4des)`**
...
<a id="section-6-4-4"></a> **`6.4.4. The RSA MD5 Checksum (rsa-md5)`**
...
<a id="section-6-4-5"></a> **`6.4.5. RSA MD5 Cryptographic Checksum Using DES (rsa-md5des)`**
...
<a id="section-6-4-6"></a> **`6.4.6. DES cipher-block chained checksum (des-mac)`**
...
<a id="section-6-4-7"></a> **`6.4.7. RSA MD4 Cryptographic Checksum Using DES alternative`**
...
<a id="section-6-4-8"></a> **`6.4.8. DES cipher-block chained checksum alternative (desmac-k)`**
...
<a id="section-7"></a> **`7. Naming Constraints`**

```text

```

<a id="section-7-1"></a> **`7.1. Realm Names`**
...
<a id="section-7-2"></a> **`7.2. Principal Names`**
...
<a id="section-7-2-1"></a> **`7.2.1. Name of server principals`**
...
<a id="section-8"></a> **`8. Constants and other defined values`**

```text

```

<a id="section-8-1"></a> **`8.1. Host address types`**
...
<a id="section-8-2"></a> **`8.2. KDC messages`**

```text

```

<a id="section-8-2-1"></a> **`8.2.1. IP transport`**
...
<a id="section-8-2-2"></a> **`8.2.2. OSI transport`**
...
<a id="section-8-2-3"></a> **`8.2.3. Name of the TGS`**
...
<a id="section-8-3"></a> **`8.3. Protocol constants and associated values`**
...
<a id="section-9"></a> **`9. Interoperability requirements`**
...
<a id="section-9-1"></a> **`9.1. Specification 1`**
...
<a id="section-9-2"></a> **`9.2. Recommended KDC values`**
...
<a id="section-10"></a> **`10. Acknowledgments`**
