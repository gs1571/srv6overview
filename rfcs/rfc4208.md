...
`      `[`1.1`](#section-1-1)`. GMPLS User-Network Interface (GMPLS UNI)`

`   `[`2`](#section-2)`. Addressing`

`   `[`3`](#section-3)`. ERO Processing`

`      `[`3.1`](#section-3-1)`. Path Message without ERO`

`      `[`3.2`](#section-3-2)`. Path Message with ERO`

`      `[`3.3`](#section-3-3)`. Explicit Label Control`

`   `[`4`](#section-4)`. RRO Processing`

`   `[`5`](#section-5)`. Notification`

`   `[`6`](#section-6)`. Connection Deletion`

`      `[`6.1`](#section-6-1)`. Alarm-Free Connection Deletion`

`      `[`6.2`](#section-6-2)`. Connection Deletion with PathErr`

`   `[`7`](#section-7)`. VPN Connections`
...
`      `[`10.2`](#section-10-2)`. Informational References`
...
<a id="section-1-1"></a> **`1.1. GMPLS User-Network Interface (GMPLS UNI)`**
...
<a id="section-3"></a> **`3. ERO Processing`**
...
<a id="section-3-1"></a> **`3.1. Path Message without ERO`**
...
<a id="section-3-2"></a> **`3.2. Path Message with ERO`**
...
<a id="section-3-3"></a> **`3.3. Explicit Label Control`**
...
<a id="section-4"></a> **`4. RRO Processing`**
...
<a id="section-5"></a> **`5. Notification`**
...
<a id="section-6"></a> **`6. Connection Deletion`**

```text

```

<a id="section-6-1"></a> **`6.1. Alarm-Free Connection Deletion`**
...
<a id="section-6-2"></a> **`6.2. Connection Deletion with PathErr`**
...
<a id="section-7"></a> **`7. VPN Connections`**
...
<a id="section-10-2"></a> **`10.2. Informational References`**
