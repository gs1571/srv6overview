...
`   `[`2`](#section-2)`. Functional Model`

`      `[`2.1`](#section-2-1)`. Terminology`

`      `[`2.2`](#section-2-2)`. Assumptions`

`      `[`2.3`](#section-2-3)`. Interactions`

`   `[`3`](#section-3)`. Control Plane`

`      `[`3.1`](#section-3-1)`. Auto-Discovery`

`           `[`3.1.1`](#section-3-1-1)`. Functions`

`           `[`3.1.2`](#section-3-1-2)`. Protocol Specification`

`      `[`3.2`](#section-3-2)`. Signaling`

`           `[`3.2.1`](#section-3-2-1)`. Label Blocks`

`           `[`3.2.2`](#section-3-2-2)`. VPLS BGP NLRI`

`           `[`3.2.3`](#section-3-2-3)`. PW Setup and Teardown`

`           `[`3.2.4`](#section-3-2-4)`. Signaling PE Capabilities`

`      `[`3.3`](#section-3-3)`. BGP VPLS Operation`

`      `[`3.4`](#section-3-4)`. Multi-AS VPLS`

`           `[`3.4.1`](#section-3-4-1)`. Method (a): VPLS-to-VPLS Connections at the ASBRs`

`           `[`3.4.2`](#section-3-4-2)`. Method (b): EBGP Redistribution of VPLS`

`                  Information between ASBRs`

`           `[`3.4.3`](#section-3-4-3)`. Method (c): Multi-Hop EBGP Redistribution`

`                  of VPLS Information`

`           `[`3.4.4`](#section-3-4-4)`. Allocation of VE IDs across Multiple ASes`

`      `[`3.5`](#section-3-5)`. Multi-homing and Path Selection`

`      `[`3.6`](#section-3-6)`. Hierarchical BGP VPLS`

`   `[`4`](#section-4)`. Data Plane`

`      `[`4.1`](#section-4-1)`. Encapsulation`

`      `[`4.2`](#section-4-2)`. Forwarding`

`           `[`4.2.1`](#section-4-2-1)`. MAC Address Learning`

`           `[`4.2.2`](#section-4-2-2)`. Aging`

`           `[`4.2.3`](#section-4-2-3)`. Flooding`

`           `[`4.2.4`](#section-4-2-4)`. Broadcast and Multicast`

`           `[`4.2.5`](#section-4-2-5)`. "Split Horizon" Forwarding`

`           `[`4.2.6`](#section-4-2-6)`. Qualified and Unqualified Learning`

`           `[`4.2.7`](#section-4-2-7)`. Class of Service`

`   `[`5`](#section-5)`. Deployment Options`
...
<a id="section-2"></a> **`2. Functional Model`**
...
<a id="section-2-2"></a> **`2.2. Assumptions`**
...
<a id="section-2-3"></a> **`2.3. Interactions`**
...
<a id="section-3"></a> **`3. Control Plane`**
...
<a id="section-3-1"></a> **`3.1. Auto-Discovery`**
...
<a id="section-3-1-1"></a> **`3.1.1. Functions`**
...
<a id="section-3-1-2"></a> **`3.1.2. Protocol Specification`**
...
<a id="section-3-2"></a> **`3.2. Signaling`**
...
<a id="section-3-2-1"></a> **`3.2.1. Label Blocks`**
...
<a id="section-3-2-2"></a> **`3.2.2. VPLS BGP NLRI`**
...
<a id="section-3-2-3"></a> **`3.2.3. PW Setup and Teardown`**
...
<a id="section-3-2-4"></a> **`3.2.4. Signaling PE Capabilities`**
...
<a id="section-3-3"></a> **`3.3. BGP VPLS Operation`**
...
<a id="section-3-4"></a> **`3.4. Multi-AS VPLS`**
...
<a id="section-3-4-1"></a> **`3.4.1. Method (a): VPLS-to-VPLS Connections at the ASBRs`**
...
<a id="section-3-4-2"></a> **`3.4.2. Method (b): EBGP Redistribution of VPLS Information between`**
...
<a id="section-3-4-3"></a> **`3.4.3. Method (c): Multi-Hop EBGP Redistribution of VPLS Information`**
...
<a id="section-3-4-4"></a> **`3.4.4. Allocation of VE IDs across Multiple ASes`**
...
<a id="section-3-5"></a> **`3.5. Multi-homing and Path Selection`**
...
<a id="section-3-6"></a> **`3.6. Hierarchical BGP VPLS`**
...
<a id="section-4-1"></a> **`4.1. Encapsulation`**
...
<a id="section-4-2"></a> **`4.2. Forwarding`**
...
<a id="section-4-2-1"></a> **`4.2.1. MAC Address Learning`**
...
<a id="section-4-2-2"></a> **`4.2.2. Aging`**
...
<a id="section-4-2-3"></a> **`4.2.3. Flooding`**
...
<a id="section-4-2-4"></a> **`4.2.4. Broadcast and Multicast`**
...
<a id="section-4-2-5"></a> **`4.2.5. "Split Horizon" Forwarding`**
...
<a id="section-4-2-6"></a> **`4.2.6. Qualified and Unqualified Learning`**
...
<a id="section-4-2-7"></a> **`4.2.7. Class of Service`**
...
<a id="section-5"></a> **`5. Deployment Options`**
