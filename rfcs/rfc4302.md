...
`   `[`2`](#section-2)`. Authentication Header Format`

`      `[`2.1`](#section-2-1)`. Next Header`

`      `[`2.2`](#section-2-2)`. Payload Length`

`      `[`2.3`](#section-2-3)`. Reserved`

`      `[`2.4`](#section-2-4)`. Security Parameters Index (SPI)`

`      `[`2.5`](#section-2-5)`. Sequence Number`

`           `[`2.5.1`](#section-2-5-1)`. Extended (64-bit) Sequence Number`

`      `[`2.6`](#section-2-6)`. Integrity Check Value (ICV)`

`   `[`3`](#section-3)`. Authentication Header Processing`

`      `[`3.1`](#section-3-1)`. Authentication Header Location`

`           `[`3.1.1`](#section-3-1-1)`. Transport Mode`

`           `[`3.1.2`](#section-3-1-2)`. Tunnel Mode`

`      `[`3.2`](#section-3-2)`. Integrity Algorithms`

`      `[`3.3`](#section-3-3)`. Outbound Packet Processing`

`           `[`3.3.1`](#section-3-3-1)`. Security Association Lookup`

`           `[`3.3.2`](#section-3-3-2)`. Sequence Number Generation`

`           `[`3.3.3`](#section-3-3-3)`. Integrity Check Value Calculation`

`                  `[`3.3.3.1`](#section-3-3-3-1)`. Handling Mutable Fields`

`                  `[`3.3.3.2`](#section-3-3-3-2)`. Padding and Extended Sequence Numbers`
...
`   `[`7`](#section-7)`. Differences from RFC 2402`
...
<a id="section-2"></a> **`2. Authentication Header Format`**
...
<a id="section-2-1"></a> **`2.1. Next Header`**
...
<a id="section-2-2"></a> **`2.2. Payload Length`**
...
<a id="section-2-3"></a> **`2.3. Reserved`**
...
<a id="section-2-4"></a> **`2.4. Security Parameters Index (SPI)`**
...
<a id="section-2-5"></a> **`2.5. Sequence Number`**
...
<a id="section-2-5-1"></a> **`2.5.1. Extended (64-bit) Sequence Number`**
...
<a id="section-2-6"></a> **`2.6. Integrity Check Value (ICV)`**
...
<a id="section-3"></a> **`3. Authentication Header Processing`**

```text

```

<a id="section-3-1"></a> **`3.1. Authentication Header Location`**
...
<a id="section-3-1-1"></a> **`3.1.1. Transport Mode`**
...
<a id="section-3-1-2"></a> **`3.1.2. Tunnel Mode`**
...
<a id="section-3-2"></a> **`3.2. Integrity Algorithms`**
...
<a id="section-3-3-2"></a> **`3.3.2. Sequence Number Generation`**
...
<a id="section-3-3-3"></a> **`3.3.3. Integrity Check Value Calculation`**
...
<a id="section-3-3-3-1"></a> **`3.3.3.1. Handling Mutable Fields`**
...
<a id="section-3-3-3-1-1"></a> **`3.3.3.1.1. ICV Computation for IPv4`**

```text

```

<a id="section-3-3-3-1-1-1"></a> **`3.3.3.1.1.1. Base Header Fields`**
...
<a id="section-3-3-3-1-1-2"></a> **`3.3.3.1.1.2. Options`**
...
<a id="section-3-3-3-1-2"></a> **`3.3.3.1.2. ICV Computation for IPv6`**

```text

```

<a id="section-3-3-3-1-2-1"></a> **`3.3.3.1.2.1. Base Header Fields`**
...
<a id="section-3-3-3-1-2-2"></a> **`3.3.3.1.2.2. Extension Headers Containing Options`**
...
<a id="section-3-3-3-1-2-3"></a> **`3.3.3.1.2.3. Extension Headers Not Containing Options`**
...
<a id="section-3-3-3-2"></a> **`3.3.3.2. Padding and Extended Sequence Numbers`**

```text

```

<a id="section-3-3-3-2-1"></a> **`3.3.3.2.1. ICV Padding`**
...
<a id="section-3-3-3-2-2"></a> **`3.3.3.2.2. Implicit Packet Padding and ESN`**
...
<a id="section-7"></a> **`7. Differences from RFC 2402`**
