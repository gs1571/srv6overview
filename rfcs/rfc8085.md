...
`   `[`3`](#section-3)`. UDP Usage Guidelines`

`      `[`3.1`](#section-3-1)`. Congestion Control Guidelines`

`      `[`3.2`](#section-3-2)`. Message Size Guidelines`

`      `[`3.3`](#section-3-3)`. Reliability Guidelines`

`      `[`3.4`](#section-3-4)`. Checksum Guidelines`

`      `[`3.5`](#section-3-5)`. Middlebox Traversal Guidelines`

`      `[`3.6`](#section-3-6)`. Limited Applicability and Controlled Environments`

`   `[`4`](#section-4)`. Multicast UDP Usage Guidelines`

`      `[`4.1`](#section-4-1)`. Multicast Congestion Control Guidelines`

`      `[`4.2`](#section-4-2)`. Message Size Guidelines for Multicast`

`   `[`5`](#section-5)`. Programming Guidelines`

`      `[`5.1`](#section-5-1)`. Using UDP Ports`

`      `[`5.2`](#section-5-2)`. ICMP Guidelines`
...
<a id="section-3"></a> **`3. UDP Usage Guidelines`**
...
<a id="section-3-1"></a> **`3.1. Congestion Control Guidelines`**
...
<a id="section-3-1-1"></a> **`3.1.1. Protocol Timer Guidelines`**
...
<a id="section-3-1-2"></a> **`3.1.2. Bulk-Transfer Applications`**
...
<a id="section-3-1-3"></a> **`3.1.3. Low Data-Volume Applications`**
...
<a id="section-3-1-4"></a> **`3.1.4. Applications Supporting Bidirectional Communications`**
...
<a id="section-3-1-5"></a> **`3.1.5. Implications of RTT and Loss Measurements on Congestion Control`**
...
<a id="section-3-1-6"></a> **`3.1.6. Burst Mitigation and Pacing`**
...
<a id="section-3-1-7"></a> **`3.1.7. Explicit Congestion Notification`**
...
<a id="section-3-1-8"></a> **`3.1.8. Differentiated Services Model`**
...
<a id="section-3-1-9"></a> **`3.1.9. QoS, Pre-Provisioned, or Reserved Capacity`**
...
<a id="section-3-1-10"></a> **`3.1.10. Circuit Breaker Mechanisms`**
...
<a id="section-3-1-11"></a> **`3.1.11. UDP Tunnels`**
...
<a id="section-3-2"></a> **`3.2. Message Size Guidelines`**
...
<a id="section-3-3"></a> **`3.3. Reliability Guidelines`**
...
<a id="section-3-4"></a> **`3.4. Checksum Guidelines`**
...
<a id="section-3-4-1"></a> **`3.4.1. IPv6 Zero UDP Checksum`**
...
<a id="section-3-4-2"></a> **`3.4.2. UDP-Lite`**
...
<a id="section-3-5"></a> **`3.5. Middlebox Traversal Guidelines`**
...
<a id="section-3-6"></a> **`3.6. Limited Applicability and Controlled Environments`**
...
<a id="section-4"></a> **`4. Multicast UDP Usage Guidelines`**
...
<a id="section-4-1"></a> **`4.1. Multicast Congestion Control Guidelines`**
...
<a id="section-4-1-1"></a> **`4.1.1. Bulk-Transfer Multicast Applications`**
...
<a id="section-4-1-2"></a> **`4.1.2. Low Data-Volume Multicast Applications`**
...
<a id="section-4-2"></a> **`4.2. Message Size Guidelines for Multicast`**
...
<a id="section-5"></a> **`5. Programming Guidelines`**
...
<a id="section-5-1"></a> **`5.1. Using UDP Ports`**
...
<a id="section-5-1-1"></a> **`5.1.1. Usage of UDP for Source Port Entropy and the IPv6 Flow Label`**
...
<a id="section-5-1-2"></a> **`5.1.2. Applications Using Multiple UDP Ports`**
...
<a id="section-5-2"></a> **`5.2. ICMP Guidelines`**
