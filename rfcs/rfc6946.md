...
`   `[`3`](#section-3)`. Generation of IPv6 Atomic Fragments`

`   `[`4`](#section-4)`. Updating RFC 2460 and RFC 5722`
...
<a id="section-3"></a> **`3. Generation of IPv6 Atomic Fragments`**
...
<a id="section-4"></a> **`4. Updating RFC 2460 and RFC 5722`**
