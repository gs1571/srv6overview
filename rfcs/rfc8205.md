...
`   `[`2`](#section-2)`. BGPsec Negotiation`

`     `[`2.1`](#section-2-1)`. The BGPsec Capability`

`     `[`2.2`](#section-2-2)`. Negotiating BGPsec Support`

`   `[`3`](#section-3)`. The BGPsec_PATH Attribute`

`     `[`3.1`](#section-3-1)`. Secure_Path`

`     `[`3.2`](#section-3-2)`. Signature_Block`

`   `[`4`](#section-4)`. BGPsec UPDATE Messages`

`     `[`4.1`](#section-4-1)`. General Guidance`

`     `[`4.2`](#section-4-2)`. Constructing the BGPsec_PATH Attribute`

`     `[`4.3`](#section-4-3)`. Processing Instructions for Confederation Members`

`     `[`4.4`](#section-4-4)`. Reconstructing the AS_PATH Attribute`

`   `[`5`](#section-5)`. Processing a Received BGPsec UPDATE Message`

`     `[`5.1`](#section-5-1)`. Overview of BGPsec Validation`

`     `[`5.2`](#section-5-2)`. Validation Algorithm`

`   `[`6`](#section-6)`. Algorithms and Extensibility`

`     `[`6.1`](#section-6-1)`. Algorithm Suite Considerations`

`     `[`6.2`](#section-6-2)`. Considerations for the SKI Size`

`     `[`6.3`](#section-6-3)`. Extensibility Considerations`

`   `[`7`](#section-7)`. Operations and Management Considerations`

`     `[`7.1`](#section-7-1)`. Capability Negotiation Failure`

`     `[`7.2`](#section-7-2)`. Preventing Misuse of pCount=0`

`     `[`7.3`](#section-7-3)`. Early Termination of Signature Verification`

`     `[`7.4`](#section-7-4)`. Non-deterministic Signature Algorithms`

`     `[`7.5`](#section-7-5)`. Private AS Numbers`

`     `[`7.6`](#section-7-6)`. Robustness Considerations for Accessing RPKI Data`

`     `[`7.7`](#section-7-7)`. Graceful Restart`

`     `[`7.8`](#section-7-8)`. Robustness of Secret Random Number in ECDSA`

`     `[`7.9`](#section-7-9)`. Incremental/Partial Deployment Considerations`

`   `[`8`](#section-8)`. Security Considerations`

`     `[`8.1`](#section-8-1)`. Security Guarantees`

`     `[`8.2`](#section-8-2)`. On the Removal of BGPsec Signatures`

`     `[`8.3`](#section-8-3)`. Mitigation of Denial-of-Service Attacks`

`     `[`8.4`](#section-8-4)`. Additional Security Considerations`
...
<a id="section-2"></a> **`2. BGPsec Negotiation`**
...
<a id="section-2-1"></a> **`2.1. The BGPsec Capability`**
...
<a id="section-2-2"></a> **`2.2. Negotiating BGPsec Support`**
...
<a id="section-3"></a> **`3. The BGPsec_PATH Attribute`**
...
<a id="section-3-1"></a> **`3.1. Secure_Path`**
...
<a id="section-3-2"></a> **`3.2. Signature_Block`**
...
<a id="section-4"></a> **`4. BGPsec UPDATE Messages`**
...
<a id="section-4-1"></a> **`4.1. General Guidance`**
...
<a id="section-4-2"></a> **`4.2. Constructing the BGPsec_PATH Attribute`**
...
<a id="section-4-3"></a> **`4.3. Processing Instructions for Confederation Members`**
...
<a id="section-4-4"></a> **`4.4. Reconstructing the AS_PATH Attribute`**
...
<a id="section-5"></a> **`5. Processing a Received BGPsec UPDATE Message`**
...
<a id="section-5-1"></a> **`5.1. Overview of BGPsec Validation`**
...
<a id="section-5-2"></a> **`5.2. Validation Algorithm`**
...
<a id="section-6"></a> **`6. Algorithms and Extensibility`**

```text

```

<a id="section-6-1"></a> **`6.1. Algorithm Suite Considerations`**
...
<a id="section-6-2"></a> **`6.2. Considerations for the SKI Size`**
...
<a id="section-6-3"></a> **`6.3. Extensibility Considerations`**
...
<a id="section-7"></a> **`7. Operations and Management Considerations`**
...
<a id="section-7-1"></a> **`7.1. Capability Negotiation Failure`**
...
<a id="section-7-2"></a> **`7.2. Preventing Misuse of pCount=0`**
...
<a id="section-7-3"></a> **`7.3. Early Termination of Signature Verification`**
...
<a id="section-7-4"></a> **`7.4. Non-deterministic Signature Algorithms`**
...
<a id="section-7-5"></a> **`7.5. Private AS Numbers`**
...
<a id="section-7-6"></a> **`7.6. Robustness Considerations for Accessing RPKI Data`**
...
<a id="section-7-7"></a> **`7.7. Graceful Restart`**
...
<a id="section-7-8"></a> **`7.8. Robustness of Secret Random Number in ECDSA`**
...
<a id="section-7-9"></a> **`7.9. Incremental/Partial Deployment Considerations`**
...
<a id="section-8-1"></a> **`8.1. Security Guarantees`**
...
<a id="section-8-2"></a> **`8.2. On the Removal of BGPsec Signatures`**
...
<a id="section-8-3"></a> **`8.3. Mitigation of Denial-of-Service Attacks`**
...
<a id="section-8-4"></a> **`8.4. Additional Security Considerations`**
