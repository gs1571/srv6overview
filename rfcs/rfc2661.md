...
`   `[`1`](#section-1)`. 1 Specification of Requirements`

`   `[`1`](#section-1)`. 2 Terminology`

`   `[`2`](#section-2)`. 0 Topology`

`   `[`3`](#section-3)`. 0 Protocol Overview`

`   `[`3`](#section-3)`. 1 L2TP Header Format`

`   `[`3`](#section-3)`. 2 Control Message Types`

`   `[`4`](#section-4)`. 0 Control Message Attribute Value Pairs`

`   `[`4`](#section-4)`. 1 AVP Format`

`   `[`4`](#section-4)`. 2 Mandatory AVPs`

`   `[`4`](#section-4)`. 3 Hiding of AVP Attribute Values`

`   `[`4`](#section-4)`. 4 AVP Summary`

`      `[`4.4`](#section-4-4)`. 1 AVPs Applicable To All Control Messages`

`      `[`4.4`](#section-4-4)`. 2 Result and Error Codes`

`      `[`4.4`](#section-4-4)`. 3 Control Connection Management AVPs`

`      `[`4.4`](#section-4-4)`. 4 Call Management AVPs`

`      `[`4.4`](#section-4-4)`. 5 Proxy LCP and Authentication AVPs`

`      `[`4.4`](#section-4-4)`. 6 Call Status AVPs`

`   `[`5`](#section-5)`. 0 Protocol Operation`

`   `[`5`](#section-5)`. 1 Control Connection Establishment`

`      `[`5.1`](#section-5-1)`. 1 Tunnel Authentication`

`   `[`5`](#section-5)`. 2 Session Establishment`

`      `[`5.2`](#section-5-2)`. 1 Incoming Call Establishment`

`      `[`5.2`](#section-5-2)`. 2 Outgoing Call Establishment`

`   `[`5`](#section-5)`. 3 Forwarding PPP Frames`

`   `[`5`](#section-5)`. 4 Using Sequence Numbers on the Data Channel`

`   `[`5`](#section-5)`. 5 Keepalive (Hello)`

`   `[`5`](#section-5)`. 6 Session Teardown`

`   `[`5`](#section-5)`. 7 Control Connection Teardown`

`   `[`5`](#section-5)`. 8 Reliable Delivery of Control Messages`

`   `[`6`](#section-6)`. 0 Control Connection Protocol Specification`

`   `[`6`](#section-6)`. 1 Start-Control-Connection-Request (SCCRQ)`

`   `[`6`](#section-6)`. 2 Start-Control-Connection-Reply (SCCRP)`

`   `[`6`](#section-6)`. 3 Start-Control-Connection-Connected (SCCCN)`

`   `[`6`](#section-6)`. 4 Stop-Control-Connection-Notification (StopCCN)`

`   `[`6`](#section-6)`. 5 Hello (HELLO)`

`   `[`6`](#section-6)`. 6 Incoming-Call-Request (ICRQ)`

`   `[`6`](#section-6)`. 7 Incoming-Call-Reply (ICRP)`

`   `[`6`](#section-6)`. 8 Incoming-Call-Connected (ICCN)`

`   `[`6`](#section-6)`. 9 Outgoing-Call-Request (OCRQ)`

`   `[`6`](#section-6)`. 10 Outgoing-Call-Reply (OCRP)`

`   `[`6`](#section-6)`. 11 Outgoing-Call-Connected (OCCN)`

`   `[`6`](#section-6)`. 12 Call-Disconnect-Notify (CDN)`

`   `[`6`](#section-6)`. 13 WAN-Error-Notify (WEN)`

`   `[`6`](#section-6)`. 14 Set-Link-Info (SLI)`

`   `[`7`](#section-7)`. 0 Control Connection State Machines`

`   `[`7`](#section-7)`. 1 Control Connection Protocol Operation`

`   `[`7`](#section-7)`. 2 Control Connection States`

`      `[`7.2`](#section-7-2)`. 1 Control Connection Establishment`

`   `[`7`](#section-7)`. 3 Timing considerations`

`   `[`7`](#section-7)`. 4 Incoming calls`

`      `[`7.4`](#section-7-4)`. 1 LAC Incoming Call States`

`      `[`7.4`](#section-7-4)`. 2 LNS Incoming Call States`

`   `[`7`](#section-7)`. 5 Outgoing calls`

`      `[`7.5`](#section-7-5)`. 1 LAC Outgoing Call States`

`      `[`7.5`](#section-7-5)`. 2 LNS Outgoing Call States`

`   `[`7`](#section-7)`. 6 Tunnel Disconnection`

`   `[`8`](#section-8)`. 0 L2TP Over Specific Media`

`   `[`8`](#section-8)`. 1 L2TP over UDP/IP`

`   `[`8`](#section-8)`. 2 IP`

`   `[`9`](#section-9)`. 0 Security Considerations`

`   `[`9`](#section-9)`. 1 Tunnel Endpoint Security`

`   `[`9`](#section-9)`. 2 Packet Level Security`

`   `[`9`](#section-9)`. 3 End to End Security`

`   `[`9`](#section-9)`. 4 L2TP and IPsec`

`   `[`9`](#section-9)`. 5 Proxy PPP Authentication`

`   `[`10`](#section-10)`. 0 IANA Considerations`

`   `[`10`](#section-10)`. 1 AVP Attributes`

`   `[`10`](#section-10)`. 2 Message Type AVP Values`

`   `[`10`](#section-10)`. 3 Result Code AVP Values`

`      `[`10.3`](#section-10-3)`. 1 Result Code Field Values`

`      `[`10.3`](#section-10-3)`. 2 Error Code Field Values`

`   `[`10`](#section-10)`. 4 Framing Capabilities & Bearer Capabilities`

`   `[`10`](#section-10)`. 5 Proxy Authen Type AVP Values`

`   `[`10`](#section-10)`. 6 AVP Header Bits`

`   `[`11`](#section-11)`. 0 References`

`   `[`12`](#section-12)`. 0 Acknowledgments`

`   `[`13`](#section-13)`. 0 Authors' Addresses`
