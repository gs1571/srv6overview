...
`   `[`2`](#section-2)`. PPVPN Terminology`

`   `[`3`](#section-3)`. Provider Provisioned Virtual Private Network Services`

`       `[`3.1`](#section-3-1)`. Layer 3 VPN (L3VPN)`

`       `[`3.2`](#section-3-2)`. Layer 2 VPN (L2VPN)`

`       `[`3.3`](#section-3-3)`. Virtual Private LAN Service (VPLS)`

`       `[`3.4`](#section-3-4)`. Virtual Private Wire Service (VPWS)`

`       `[`3.5`](#section-3-5)`. IP-Only LAN-Like Service (IPLS)`

`       `[`3.6`](#section-3-6)`. Pseudo Wire (PW)`

`       `[`3.7`](#section-3-7)`. Transparent LAN Service (TLS)`

`       `[`3.8`](#section-3-8)`. Virtual LAN (VLAN)`

`       `[`3.9`](#section-3-9)`. Virtual Leased Line Service (VLLS)`

`       `[`3.10`](#section-3-10)`. Virtual Private Network (VPN)`

`       `[`3.11`](#section-3-11)`. Virtual Private Switched Network (VPSN)`

`   `[`4`](#section-4)`. Classification of VPNs`

`   `[`5`](#section-5)`. Building Blocks`

`       `[`5.1`](#section-5-1)`. Customer Edge Device (CE)`

`             `[`5.1.1`](#section-5-1-1)`. Device Based CE Naming`

`             `[`5.1.2`](#section-5-1-2)`. Service Based CE Naming`

`       `[`5.2`](#section-5-2)`. Provider Edge (PE)`

`             `[`5.2.1`](#section-5-2-1)`. Device Based PE Naming`

`             `[`5.2.2`](#section-5-2-2)`. Service Based PE Naming`

`             `[`5.2.3`](#section-5-2-3)`. Distribution Based PE Naming`

`       `[`5.3`](#section-5-3)`. Core`

`             `[`5.3.1`](#section-5-3-1)`. Provider Router (P)`

`       `[`5.4`](#section-5-4)`. Naming in Specific Internet Drafts`

`             `[`5.4.1`](#section-5-4-1)`. Layer 2 PE (L2PE)`

`             `[`5.4.2`](#section-5-4-2)`. Logical PE (LPE)`

`             `[`5.4.3`](#section-5-4-3)`. PE-CLE`

`             `[`5.4.4`](#section-5-4-4)`. PE-Core`

`             `[`5.4.5`](#section-5-4-5)`. PE-Edge`

`             `[`5.4.6`](#section-5-4-6)`. PE-POP`

`             `[`5.4.7`](#section-5-4-7)`. VPLS Edge (VE)`

`   `[`6`](#section-6)`. Functions`

`       `[`6.1`](#section-6-1)`. Attachment Circuit (AC)`

`       `[`6.2`](#section-6-2)`. Backdoor Links`

`       `[`6.3`](#section-6-3)`. Endpoint Discovery`

`       `[`6.4`](#section-6-4)`. Flooding`

`       `[`6.5`](#section-6-5)`. MAC Address Learning`

`             `[`6.5.1`](#section-6-5-1)`. Qualified Learning`

`             `[`6.5.2`](#section-6-5-2)`. Unqualified Learning`

`       `[`6.6`](#section-6-6)`. Signalling`

`   `[`7`](#section-7)`. 'Boxes'`

`       `[`7.1`](#section-7-1)`. Aggregation Box`

`       `[`7.2`](#section-7-2)`. Customer Premises Equipment (CPE)`

`       `[`7.3`](#section-7-3)`. Multi-Tenant Unit (MTU)`

`   `[`8`](#section-8)`. Packet Switched Network (PSN)`

`       `[`8.1`](#section-8-1)`. Route Distinguisher (RD)`

`       `[`8.2`](#section-8-2)`. Route Reflector`

`       `[`8.3`](#section-8-3)`. Route Target (RT)`

`       `[`8.4`](#section-8-4)`. Tunnel`

`       `[`8.5`](#section-8-5)`. Tunnel Multiplexor`

`       `[`8.6`](#section-8-6)`. Virtual Channel (VC)`

`       `[`8.7`](#section-8-7)`. VC Label`

`       `[`8.8`](#section-8-8)`. Inner Label`

`       `[`8.9`](#section-8-9)`. VPN Routing and Forwarding (VRF)`

`       `[`8.10`](#section-8-10)`. VPN Forwarding Instance (VFI)`

`       `[`8.11`](#section-8-11)`. Virtual Switch Instance (VSI)`

`       `[`8.12`](#section-8-12)`. Virtual Router (VR)`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Acknowledgements`

`   `[`11`](#section-11)`. Informative References`
...
<a id="section-2"></a> **`2. PPVPN Terminology`**
...
<a id="section-3"></a> **`3. Provider Provisioned Virtual Private Network Services`**
...
<a id="section-3-1"></a> **`3.1. Layer 3 VPN (L3VPN)`**
...
<a id="section-3-2"></a> **`3.2. Layer 2 VPN (L2VPN)`**
...
<a id="section-3-3"></a> **`3.3. Virtual Private LAN Service (VPLS)`**
...
<a id="section-3-4"></a> **`3.4. Virtual Private Wire Service (VPWS)`**
...
<a id="section-3-5"></a> **`3.5. IP-Only LAN-Like Service (IPLS)`**
...
<a id="section-3-6"></a> **`3.6. Pseudo Wire (PW)`**
...
<a id="section-3-7"></a> **`3.7. Transparent LAN Service (TLS)`**
...
<a id="section-3-8"></a> **`3.8. Virtual LAN (VLAN)`**
...
<a id="section-3-9"></a> **`3.9. Virtual Leased Line Service (VLLS)`**
...
<a id="section-3-10"></a> **`3.10. Virtual Private Network (VPN)`**
...
<a id="section-3-11"></a> **`3.11. Virtual Private Switched Network (VPSN)`**
...
<a id="section-4"></a> **`4. Classification of VPNs`**
...
<a id="section-5"></a> **`5. Building Blocks`**
...
<a id="section-5-1"></a> **`5.1. Customer Edge Device (CE)`**
...
<a id="section-5-1-1"></a> **`5.1.1. Device Based CE Naming`**

```text

```

<a id="section-5-1-1-1"></a> **`5.1.1.1. Customer Edge Router (CE-R)`**
...
<a id="section-5-1-1-2"></a> **`5.1.1.2. Customer Edge Switch (CE-S)`**
...
<a id="section-5-1-2"></a> **`5.1.2. Service Based CE Naming`**
...
<a id="section-5-1-2-1"></a> **`5.1.2.1. L3VPN-CE`**
...
<a id="section-5-1-2-2"></a> **`5.1.2.2. VPLS-CE`**
...
<a id="section-5-1-2-3"></a> **`5.1.2.3. VPWS-CE`**
...
<a id="section-5-2"></a> **`5.2. Provider Edge (PE)`**
...
<a id="section-5-2-1"></a> **`5.2.1. Device Based PE Naming`**
...
<a id="section-5-2-1-1"></a> **`5.2.1.1. Provider Edge Router (PE-R)`**
...
<a id="section-5-2-1-2"></a> **`5.2.1.2. Provider Edge Switch (PE-S)`**
...
<a id="section-5-2-2"></a> **`5.2.2. Service Based PE Naming`**

```text

```

<a id="section-5-2-2-1"></a> **`5.2.2.1. L3VPN-PE`**
...
<a id="section-5-2-2-2"></a> **`5.2.2.2. VPWS-PE`**
...
<a id="section-5-2-2-3"></a> **`5.2.2.3. VPLS-PE`**
...
<a id="section-5-2-3"></a> **`5.2.3. Distribution Based PE Naming`**
...
<a id="section-5-2-3-1"></a> **`5.2.3.1. Network Facing PE (N-PE)`**
...
<a id="section-5-2-3-2"></a> **`5.2.3.2. User Facing PE (U-PE)`**
...
<a id="section-5-3"></a> **`5.3. Core`**

```text

```

<a id="section-5-3-1"></a> **`5.3.1. Provider Router (P)`**
...
<a id="section-5-4"></a> **`5.4. Naming in Specific Internet Drafts`**

```text

```

<a id="section-5-4-1"></a> **`5.4.1. Layer 2 PE (L2PE)`**
...
<a id="section-5-4-2"></a> **`5.4.2. Logical PE (LPE)`**
...
<a id="section-5-4-3"></a> **`5.4.3. PE-CLE`**
...
<a id="section-5-4-4"></a> **`5.4.4. PE-Core`**
...
<a id="section-5-4-5"></a> **`5.4.5. PE-Edge`**
...
<a id="section-5-4-6"></a> **`5.4.6. PE-POP`**
...
<a id="section-5-4-7"></a> **`5.4.7. VPLS Edge (VE)`**
...
<a id="section-6-1"></a> **`6.1. Attachment Circuit (AC)`**
...
<a id="section-6-2"></a> **`6.2. Backdoor Links`**
...
<a id="section-6-3"></a> **`6.3. Endpoint Discovery`**
...
<a id="section-6-4"></a> **`6.4. Flooding`**
...
<a id="section-6-5"></a> **`6.5. MAC Address Learning`**
...
<a id="section-6-5-1"></a> **`6.5.1. Qualified Learning`**
...
<a id="section-6-5-2"></a> **`6.5.2. Unqualified Learning`**
...
<a id="section-6-6"></a> **`6.6. Signalling`**
...
<a id="section-7-1"></a> **`7.1. Aggregation Box`**
...
<a id="section-7-2"></a> **`7.2. Customer Premises Equipment (CPE)`**
...
<a id="section-7-3"></a> **`7.3. Multi-Tenant Unit (MTU)`**
...
<a id="section-8"></a> **`8. Packet Switched Network (PSN)`**
...
<a id="section-8-1"></a> **`8.1. Route Distinguisher (RD)`**
...
<a id="section-8-2"></a> **`8.2. Route Reflector`**
...
<a id="section-8-3"></a> **`8.3. Route Target (RT)`**
...
<a id="section-8-5"></a> **`8.5. Tunnel Multiplexor`**
...
<a id="section-8-6"></a> **`8.6. Virtual Channel (VC)`**
...
<a id="section-8-7"></a> **`8.7. VC Label`**
...
<a id="section-8-8"></a> **`8.8. Inner Label`**
...
<a id="section-8-9"></a> **`8.9. VPN Routing and Forwarding (VRF)`**
...
<a id="section-8-10"></a> **`8.10. VPN Forwarding Instance (VFI)`**
...
<a id="section-8-11"></a> **`8.11. Virtual Switch Instance (VSI)`**
...
<a id="section-8-12"></a> **`8.12. Virtual Router (VR)`**
...
<a id="section-11"></a> **`11. Informative References`**
