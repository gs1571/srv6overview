...
`   `[`2`](#section-2)`. Link-Attributes Sub-TLV Format`

`   `[`3`](#section-3)`. Interoperability with Routers Not Supporting This Capability`
...
<a id="section-2"></a> **`2. Link-Attributes Sub-TLV Format`**
...
<a id="section-3"></a> **`3. Interoperability with Routers Not Supporting This Capability`**
