...
`   `[`3`](#section-3)`. Information Loss and Loops`

`   `[`4`](#section-4)`. Using the LSA Options to Prevent Loops`
...
<a id="section-3"></a> **`3. Information Loss and Loops`**
...
<a id="section-4"></a> **`4. Using the LSA Options to Prevent Loops`**
