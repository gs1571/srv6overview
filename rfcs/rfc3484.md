...
`   `[`2`](#section-2)`. Context in Which the Algorithms Operate`

`         `[`2.1`](#section-2-1)`. Policy Table`

`         `[`2.2`](#section-2-2)`. Common Prefix Length`

`   `[`3`](#section-3)`. Address Properties`

`         `[`3.1`](#section-3-1)`. Scope Comparisons`

`         `[`3.2`](#section-3-2)`. IPv4 Addresses and IPv4-Mapped Addresses`

`         `[`3.3`](#section-3-3)`. Other IPv6 Addresses with Embedded IPv4 Addresses`

`         `[`3.4`](#section-3-4)`. IPv6 Loopback Address and Other Format Prefixes`

`         `[`3.5`](#section-3-5)`. Mobility Addresses`

`   `[`4`](#section-4)`. Candidate Source Addresses`

`   `[`5`](#section-5)`. Source Address Selection`

`   `[`6`](#section-6)`. Destination Address Selection`

`   `[`7`](#section-7)`. Interactions with Routing`

`   `[`8`](#section-8)`. Implementation Considerations`

`   `[`9`](#section-9)`. Security Considerations`

`   `[`10`](#section-10)`. Examples`

`         `[`10.1`](#section-10-1)`. Default Source Address Selection`

`         `[`10.2`](#section-10-2)`. Default Destination Address Selection`

`         `[`10.3`](#section-10-3)`. Configuring Preference for IPv6 or IPv4`

`         `[`10.4`](#section-10-4)`. Configuring Preference for Scoped Addresses`

`         `[`10.5`](#section-10-5)`. Configuring a Multi-Homed Site`
...
<a id="section-2"></a> **`2. Context in Which the Algorithms Operate`**
...
<a id="section-2-1"></a> **`2.1. Policy Table`**
...
<a id="section-2-2"></a> **`2.2. Common Prefix Length`**
...
<a id="section-3"></a> **`3. Address Properties`**
...
<a id="section-3-1"></a> **`3.1. Scope Comparisons`**
...
<a id="section-3-2"></a> **`3.2. IPv4 Addresses and IPv4-Mapped Addresses`**
...
<a id="section-3-3"></a> **`3.3. Other IPv6 Addresses with Embedded IPv4 Addresses`**
...
<a id="section-3-4"></a> **`3.4. IPv6 Loopback Address and Other Format Prefixes`**
...
<a id="section-3-5"></a> **`3.5. Mobility Addresses`**
...
<a id="section-4"></a> **`4. Candidate Source Addresses`**
...
<a id="section-5"></a> **`5. Source Address Selection`**
...
<a id="section-6"></a> **`6. Destination Address Selection`**
...
<a id="section-7"></a> **`7. Interactions with Routing`**
...
<a id="section-8"></a> **`8. Implementation Considerations`**
...
<a id="section-10-1"></a> **`10.1. Default Source Address Selection`**
...
<a id="section-10-2"></a> **`10.2. Default Destination Address Selection`**
...
<a id="section-10-3"></a> **`10.3. Configuring Preference for IPv6 or IPv4`**
...
<a id="section-10-4"></a> **`10.4. Configuring Preference for Scoped Addresses`**
...
<a id="section-10-5"></a> **`10.5. Configuring a Multi-Homed Site`**
