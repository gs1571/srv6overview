...
`   `[`3`](#section-3)`. General Recommendations`

`     `[`3.1`](#section-3-1)`. Protocol Versions`

`       `[`3.1.1`](#section-3-1-1)`. SSL/TLS Protocol Versions`

`       `[`3.1.2`](#section-3-1-2)`. DTLS Protocol Versions`

`       `[`3.1.3`](#section-3-1-3)`. Fallback to Lower Versions`

`     `[`3.2`](#section-3-2)`. Strict TLS`

`     `[`3.3`](#section-3-3)`. Compression`

`     `[`3.4`](#section-3-4)`. TLS Session Resumption`

`     `[`3.5`](#section-3-5)`. TLS Renegotiation`

`     `[`3.6`](#section-3-6)`. Server Name Indication`

`   `[`4`](#section-4)`. Recommendations: Cipher Suites`

`     `[`4.1`](#section-4-1)`. General Guidelines`

`     `[`4.2`](#section-4-2)`. Recommended Cipher Suites`

`       `[`4.2.1`](#section-4-2-1)`. Implementation Details`

`     `[`4.3`](#section-4-3)`. Public Key Length`

`     `[`4.4`](#section-4-4)`. Modular Exponential vs. Elliptic Curve DH Cipher Suites`

`     `[`4.5`](#section-4-5)`. Truncated HMAC`

`   `[`5`](#section-5)`. Applicability Statement`

`     `[`5.1`](#section-5-1)`. Security Services`

`     `[`5.2`](#section-5-2)`. Opportunistic Security`

`   `[`6`](#section-6)`. Security Considerations`

`     `[`6.1`](#section-6-1)`. Host Name Validation`

`     `[`6.2`](#section-6-2)`. AES-GCM`

`     `[`6.3`](#section-6-3)`. Forward Secrecy`

`     `[`6.4`](#section-6-4)`. Diffie-Hellman Exponent Reuse`

`     `[`6.5`](#section-6-5)`. Certificate Revocation`
...
<a id="section-3"></a> **`3. General Recommendations`**
...
<a id="section-3-1"></a> **`3.1. Protocol Versions`**

```text

```

<a id="section-3-1-1"></a> **`3.1.1. SSL/TLS Protocol Versions`**
...
<a id="section-3-1-2"></a> **`3.1.2. DTLS Protocol Versions`**
...
<a id="section-3-1-3"></a> **`3.1.3. Fallback to Lower Versions`**
...
<a id="section-3-2"></a> **`3.2. Strict TLS`**
...
<a id="section-3-3"></a> **`3.3. Compression`**
...
<a id="section-3-4"></a> **`3.4. TLS Session Resumption`**
...
<a id="section-3-5"></a> **`3.5. TLS Renegotiation`**
...
<a id="section-3-6"></a> **`3.6. Server Name Indication`**
...
<a id="section-4"></a> **`4. Recommendations: Cipher Suites`**
...
<a id="section-4-1"></a> **`4.1. General Guidelines`**
...
<a id="section-4-2"></a> **`4.2. Recommended Cipher Suites`**
...
<a id="section-4-2-1"></a> **`4.2.1. Implementation Details`**
...
<a id="section-4-3"></a> **`4.3. Public Key Length`**
...
<a id="section-4-4"></a> **`4.4. Modular Exponential vs. Elliptic Curve DH Cipher Suites`**
...
<a id="section-4-5"></a> **`4.5. Truncated HMAC`**
...
<a id="section-5-1"></a> **`5.1. Security Services`**
...
<a id="section-5-2"></a> **`5.2. Opportunistic Security`**
...
<a id="section-6-1"></a> **`6.1. Host Name Validation`**
...
<a id="section-6-2"></a> **`6.2. AES-GCM`**
...
<a id="section-6-3"></a> **`6.3. Forward Secrecy`**
...
<a id="section-6-4"></a> **`6.4. Diffie-Hellman Exponent Reuse`**
...
<a id="section-6-5"></a> **`6.5. Certificate Revocation`**
