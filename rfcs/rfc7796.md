...
`   `[`4`](#section-4)`. PE Model with E-Tree Support`

`     `[`4.1`](#section-4-1)`. Existing PE Models`

`     `[`4.2`](#section-4-2)`. A New PE Model with E-Tree Support`

`   `[`5`](#section-5)`. PW for E-Tree Support`

`     `[`5.1`](#section-5-1)`. PW Encapsulation`

`     `[`5.2`](#section-5-2)`. VLAN Mapping`

`     `[`5.3`](#section-5-3)`. PW Processing`

`       `[`5.3.1`](#section-5-3-1)`. PW Processing in the VLAN Mapping Mode`

`       `[`5.3.2`](#section-5-3-2)`. PW Processing in the Compatible Mode`

`       `[`5.3.3`](#section-5-3-3)`. PW Processing in the Optimized Mode`

`   `[`6`](#section-6)`. Signaling for E-Tree Support`

`     `[`6.1`](#section-6-1)`. LDP Extensions for E-Tree Support`

`     `[`6.2`](#section-6-2)`. BGP Extensions for E-Tree Support`

`   `[`7`](#section-7)`. OAM Considerations`
...
<a id="section-4"></a> **`4. PE Model with E-Tree Support`**
...
<a id="section-4-1"></a> **`4.1. Existing PE Models`**
...
<a id="section-4-2"></a> **`4.2. A New PE Model with E-Tree Support`**
...
<a id="section-5"></a> **`5. PW for E-Tree Support`**

```text

```

<a id="section-5-1"></a> **`5.1. PW Encapsulation`**
...
<a id="section-5-2"></a> **`5.2. VLAN Mapping`**
...
<a id="section-5-3"></a> **`5.3. PW Processing`**

```text

```

<a id="section-5-3-1"></a> **`5.3.1. PW Processing in the VLAN Mapping Mode`**
...
<a id="section-5-3-2"></a> **`5.3.2. PW Processing in the Compatible Mode`**
...
<a id="section-5-3-3"></a> **`5.3.3. PW Processing in the Optimized Mode`**
...
<a id="section-6"></a> **`6. Signaling for E-Tree Support`**

```text

```

<a id="section-6-1"></a> **`6.1. LDP Extensions for E-Tree Support`**
...
<a id="section-6-2"></a> **`6.2. BGP Extensions for E-Tree Support`**
...
<a id="section-7"></a> **`7. OAM Considerations`**
...
<a id="section-8"></a> **`8. Applicability`**
