...
`   `[`2`](#section-2)`. Requirement to Transmit Extension Headers`

`     `[`2.1`](#section-2-1)`. All Extension Headers`

`     `[`2.2`](#section-2-2)`. Hop-by-Hop Options`
...
<a id="section-2"></a> **`2. Requirement to Transmit Extension Headers`**

```text

```

<a id="section-2-1"></a> **`2.1. All Extension Headers`**
...
<a id="section-2-2"></a> **`2.2. Hop-by-Hop Options`**
