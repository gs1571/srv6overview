...
`   `[`2`](#section-2)`. Rule Definition`

`     `[`2.1`](#section-2-1)`. Rule Naming`

`     `[`2.2`](#section-2-2)`. Rule Form`

`     `[`2.3`](#section-2-3)`. Terminal Values`

`     `[`2.4`](#section-2-4)`. External Encodings`

`   `[`3`](#section-3)`. Operators`

`     `[`3.1`](#section-3-1)`. Concatenation:  Rule1 Rule2`

`     `[`3.2`](#section-3-2)`. Alternatives:  Rule1 / Rule2`

`     `[`3.3`](#section-3-3)`. Incremental Alternatives: Rule1 =/ Rule2`

`     `[`3.4`](#section-3-4)`. Value Range Alternatives:  %c##-##`

`     `[`3.5`](#section-3-5)`. Sequence Group:  (Rule1 Rule2)`

`     `[`3.6`](#section-3-6)`. Variable Repetition:  *Rule`

`     `[`3.7`](#section-3-7)`. Specific Repetition:  nRule`

`     `[`3.8`](#section-3-8)`. Optional Sequence:  [RULE]`

`     `[`3.9`](#section-3-9)`. Comment:  ; Comment`

`     `[`3.10`](#section-3-10)`. Operator Precedence`

`   `[`4`](#section-4)`. ABNF Definition of ABNF`
...
<a id="section-2"></a> **`2. Rule Definition`**

```text

```

<a id="section-2-1"></a> **`2.1. Rule Naming`**
...
<a id="section-2-2"></a> **`2.2. Rule Form`**
...
<a id="section-2-3"></a> **`2.3. Terminal Values`**
...
<a id="section-2-4"></a> **`2.4. External Encodings`**
...
<a id="section-3"></a> **`3. Operators`**

```text

```

<a id="section-3-1"></a> **`3.1. Concatenation:  Rule1 Rule2`**
...
<a id="section-3-2"></a> **`3.2. Alternatives:  Rule1 / Rule2`**
...
<a id="section-3-3"></a> **`3.3. Incremental Alternatives: Rule1 =/ Rule2`**
...
<a id="section-3-4"></a> **`3.4. Value Range Alternatives:  %c##-##`**
...
<a id="section-3-5"></a> **`3.5. Sequence Group:  (Rule1 Rule2)`**
...
<a id="section-3-6"></a> **`3.6. Variable Repetition:  *Rule`**
...
```text
   ...
   where  and <b> are optional decimal values, indicating at least
    and at most <b> occurrences of the element.
...
<a id="section-3-7"></a> **`3.7. Specific Repetition:  nRule`**
...
<a id="section-3-8"></a> **`3.8. Optional Sequence:  [RULE]`**
...
<a id="section-3-9"></a> **`3.9. Comment:  ; Comment`**
...
<a id="section-3-10"></a> **`3.10. Operator Precedence`**
...
<a id="section-4"></a> **`4. ABNF Definition of ABNF`**
