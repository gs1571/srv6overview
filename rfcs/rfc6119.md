...
<a id="section-3-1"></a> **`3.1. Identifying IS-IS Links Using IPv6 Addresses`**
...
<a id="section-3-1-1"></a> **`3.1.1. IPv6 Address Types`**
...
<a id="section-3-2"></a> **`3.2. IP Addresses Used in Traffic Engineering TLVs`**
...
<a id="section-3-2-1"></a> **`3.2.1. TE Router ID TLV`**
...
<a id="section-3-2-2"></a> **`3.2.2. IPv4 Interface Address Sub-TLV`**
...
<a id="section-3-2-3"></a> **`3.2.3. IPv4 Neighbor Address Sub-TLV`**
...
<a id="section-3-2-4"></a> **`3.2.4. IPv4 SRLG TLV`**
...
<a id="section-4"></a> **`4. IPv6 TE TLVs`**

```text

```

<a id="section-4-1"></a> **`4.1. IPv6 TE Router ID TLV`**
...
<a id="section-4-2"></a> **`4.2. IPv6 Interface Address Sub-TLV`**
...
<a id="section-4-3"></a> **`4.3. IPv6 Neighbor Address sub-TLV`**
...
<a id="section-4-4"></a> **`4.4. IPv6 SRLG TLV`**
...
<a id="section-4-5"></a> **`4.5. IPv6 Global Interface Address TLV`**
...
<a id="section-6"></a> **`6. IPv4/IPv6 Migration`**
