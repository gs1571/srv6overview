...
`      `[`1.1`](#section-1-1)`. Applicability to Generalized MPLS`

`      `[`1.2`](#section-1-2)`. A Rejected Alternate Solution`

`   `[`2`](#section-2)`. Terminology`

`   `[`3`](#section-3)`. Attributes TLVs`

`      `[`3.1`](#section-3-1)`. Attribute Flags TLV`

`   `[`4`](#section-4)`. LSP_ATTRIBUTES Object`

`      `[`4.1`](#section-4-1)`. Format`

`      `[`4.2`](#section-4-2)`. Generic Processing Rules for Path Messages`

`      `[`4.3`](#section-4-3)`. Generic Processing Rules for Resv Messages`

`   `[`5`](#section-5)`. LSP_REQUIRED_ATTRIBUTES Object`

`      `[`5.1`](#section-5-1)`. Format`

`      `[`5.2`](#section-5-2)`. Generic Processing Rules`

`   `[`6`](#section-6)`. Inheritance Rules`

`   `[`7`](#section-7)`. Recording Attributes Per LSP`

`      `[`7.1`](#section-7-1)`. Requirements`

`      `[`7.2`](#section-7-2)`. RRO Attributes Subobject`

`      `[`7.3`](#section-7-3)`. Procedures`

`           `[`7.3.1`](#section-7-3-1)`. Subobject Presence Rules`

`           `[`7.3.2`](#section-7-3-2)`. Reporting Compliance with LSP Attributes`

`           `[`7.3.3`](#section-7-3-3)`. Reporting Per-Hop Attributes`

`           `[`7.3.4`](#section-7-3-4)`. Default Behavior`

`   `[`8`](#section-8)`. Summary of Attribute Bit Allocation`

`   `[`9`](#section-9)`. Message Formats`

`   `[`10`](#section-10)`. Guidance for Key Application Scenarios`

`      `[`10.1`](#section-10-1)`. Communicating to Egress LSRs`

`      `[`10.2`](#section-10-2)`. Communicating to Key Transit LSRs`

`      `[`10.3`](#section-10-3)`. Communicating to All LSRs`

`   `[`11`](#section-11)`. IANA Considerations`

`      `[`11.1`](#section-11-1)`. New RSVP C-Nums and C-Types`

`      `[`11.2`](#section-11-2)`. New TLV Space`

`      `[`11.3`](#section-11-3)`. Attribute Flags`

`      `[`11.4`](#section-11-4)`. New Error Codes`

`      `[`11.5`](#section-11-5)`. New Record Route Subobject Identifier`

`   `[`12`](#section-12)`. Security Considerations`

`   `[`13`](#section-13)`. Acknowledgements`

`   `[`14`](#section-14)`. Changes from RFC 4420 to RFC 5420`
...
<a id="section-1-1"></a> **`1.1. Applicability to Generalized MPLS`**
...
<a id="section-1-2"></a> **`1.2. A Rejected Alternate Solution`**
...
<a id="section-3"></a> **`3. Attributes TLVs`**
...
<a id="section-3-1"></a> **`3.1. Attribute Flags TLV`**
...
<a id="section-4"></a> **`4. LSP_ATTRIBUTES Object`**
...
<a id="section-4-2"></a> **`4.2. Generic Processing Rules for Path Messages`**
...
<a id="section-4-3"></a> **`4.3. Generic Processing Rules for Resv Messages`**
...
<a id="section-5"></a> **`5. LSP_REQUIRED_ATTRIBUTES Object`**
...
<a id="section-5-2"></a> **`5.2. Generic Processing Rules`**
...
<a id="section-6"></a> **`6. Inheritance Rules`**
...
<a id="section-7"></a> **`7. Recording Attributes Per LSP`**

```text

```

<a id="section-7-1"></a> **`7.1. Requirements`**
...
<a id="section-7-2"></a> **`7.2. RRO Attributes Subobject`**
...
<a id="section-7-3"></a> **`7.3. Procedures`**

```text

```

<a id="section-7-3-1"></a> **`7.3.1. Subobject Presence Rules`**
...
<a id="section-7-3-2"></a> **`7.3.2. Reporting Compliance with LSP Attributes`**
...
<a id="section-7-3-3"></a> **`7.3.3. Reporting Per-Hop Attributes`**
...
<a id="section-7-3-4"></a> **`7.3.4. Default Behavior`**
...
<a id="section-8"></a> **`8. Summary of Attribute Bit Allocation`**
...
<a id="section-9"></a> **`9. Message Formats`**
...
<a id="section-10"></a> **`10. Guidance for Key Application Scenarios`**
...
<a id="section-10-1"></a> **`10.1. Communicating to Egress LSRs`**
...
<a id="section-10-2"></a> **`10.2. Communicating to Key Transit LSRs`**
...
<a id="section-10-3"></a> **`10.3. Communicating to All LSRs`**
...
<a id="section-11-1"></a> **`11.1. New RSVP C-Nums and C-Types`**
...
<a id="section-11-2"></a> **`11.2. New TLV Space`**
...
<a id="section-11-3"></a> **`11.3. Attribute Flags`**
...
<a id="section-11-4"></a> **`11.4. New Error Codes`**
...
<a id="section-11-5"></a> **`11.5. New Record Route Subobject Identifier`**
...
<a id="section-14"></a> **`14. Changes from RFC 4420 to RFC 5420`**
