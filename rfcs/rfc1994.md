...
`     `[`2`](#section-2)`. Challenge-Handshake Authentication Protocol`

`        `[`2.1`](#section-2-1)`. Advantages`

`        `[`2.2`](#section-2-2)`. Disadvantages`

`        `[`2.3`](#section-2-3)`. Design Requirements`

`     `[`3`](#section-3)`. Configuration Option Format`

`     `[`4`](#section-4)`. Packet Format`

`        `[`4.1`](#section-4-1)`. Challenge and Response`
...
<a id="section-2"></a> **`2. Challenge-Handshake Authentication Protocol`**
...
<a id="section-2-1"></a> **`2.1. Advantages`**
...
<a id="section-2-2"></a> **`2.2. Disadvantages`**
...
<a id="section-2-3"></a> **`2.3. Design Requirements`**
...
<a id="section-3"></a> **`3. Configuration Option Format`**
...
<a id="section-4"></a> **`4. Packet Format`**
...
<a id="section-4-1"></a> **`4.1. Challenge and Response`**
