...
<a id="section-3"></a> **`3. IP in IP Encapsulation`**
...
<a id="section-3-1"></a> **`3.1. IP Header Fields and Handling`**
...
<a id="section-3-2"></a> **`3.2. Routing Failures`**
...
<a id="section-4"></a> **`4. ICMP Messages from within the Tunnel`**
...
<a id="section-4-1"></a> **`4.1. Destination Unreachable (Type 3)`**
...
<a id="section-4-2"></a> **`4.2. Source Quench (Type 4)`**
...
<a id="section-4-3"></a> **`4.3. Redirect (Type 5)`**
...
<a id="section-4-4"></a> **`4.4. Time Exceeded (Type 11)`**
...
<a id="section-4-5"></a> **`4.5. Parameter Problem (Type 12)`**
...
<a id="section-4-6"></a> **`4.6. Other ICMP Messages`**
...
<a id="section-5"></a> **`5. Tunnel Management`**
...
<a id="section-5-1"></a> **`5.1. Tunnel MTU Discovery`**
...
<a id="section-5-2"></a> **`5.2. Congestion`**
...
<a id="section-6-1"></a> **`6.1. Router Considerations`**
...
<a id="section-6-2"></a> **`6.2. Host Considerations`**
