...
`   `[`2`](#section-2)`. The Goals of Security`

`      `[`2.1`](#section-2-1)`. Communication Security`

`           `[`2.1.1`](#section-2-1-1)`. Confidentiality`

`           `[`2.1.2`](#section-2-1-2)`. Data Integrity`

`           `[`2.1.3`](#section-2-1-3)`. Peer Entity authentication`

`      `[`2.2`](#section-2-2)`. Non-Repudiation`

`      `[`2.3`](#section-2-3)`. Systems Security`

`           `[`2.3.1`](#section-2-3-1)`. Unauthorized Usage`

`           `[`2.3.2`](#section-2-3-2)`. Inappropriate Usage`

`           `[`2.3.3`](#section-2-3-3)`. Denial of Service`

`   `[`3`](#section-3)`. The Internet Threat Model`

`      `[`3.1`](#section-3-1)`. Limited Threat Models`

`      `[`3.2`](#section-3-2)`. Passive Attacks`

`           `[`3.2.1`](#section-3-2-1)`. Confidentiality Violations`

`           `[`3.2.2`](#section-3-2-2)`. Password Sniffing`

`           `[`3.2.3`](#section-3-2-3)`. Offline Cryptographic Attacks`

`      `[`3.3`](#section-3-3)`. Active Attacks`

`           `[`3.3.1`](#section-3-3-1)`. Replay Attacks`

`           `[`3.3.2`](#section-3-3-2)`. Message Insertion`

`           `[`3.3.3`](#section-3-3-3)`. Message Deletion`

`           `[`3.3.4`](#section-3-3-4)`. Message Modification`

`           `[`3.3.5`](#section-3-3-5)`. Man-In-The-Middle`

`      `[`3.4`](#section-3-4)`. Topological Issues`

`      `[`3.5`](#section-3-5)`. On-path versus off-path`

`      `[`3.6`](#section-3-6)`. Link-local`

`   `[`4`](#section-4)`. Common Issues`

`      `[`4.1`](#section-4-1)`. User Authentication`

`           `[`4.1.1`](#section-4-1-1)`. Username/Password`

`           `[`4.1.2`](#section-4-1-2)`. Challenge Response and One Time Passwords`

`           `[`4.1.3`](#section-4-1-3)`. Shared Keys`

`           `[`4.1.4`](#section-4-1-4)`. Key Distribution Centers`

`           `[`4.1.5`](#section-4-1-5)`. Certificates`

`           `[`4.1.6`](#section-4-1-6)`. Some Uncommon Systems`

`           `[`4.1.7`](#section-4-1-7)`. Host Authentication`

`      `[`4.2`](#section-4-2)`. Generic Security Frameworks`

`      `[`4.3`](#section-4-3)`. Non-repudiation`

`      `[`4.4`](#section-4-4)`. Authorization vs. Authentication`

`           `[`4.4.1`](#section-4-4-1)`. Access Control Lists`

`           `[`4.4.2`](#section-4-4-2)`. Certificate Based Systems`

`      `[`4.5`](#section-4-5)`. Providing Traffic Security`

`           `[`4.5.1`](#section-4-5-1)`. IPsec`

`           `[`4.5.2`](#section-4-5-2)`. SSL/TLS`

`           `[`4.5.3`](#section-4-5-3)`. Remote Login`

`      `[`4.6`](#section-4-6)`. Denial of Service Attacks and Countermeasures`

`           `[`4.6.1`](#section-4-6-1)`. Blind Denial of Service`

`           `[`4.6.2`](#section-4-6-2)`. Distributed Denial of Service`

`           `[`4.6.3`](#section-4-6-3)`. Avoiding Denial of Service`

`           `[`4.6.4`](#section-4-6-4)`. Example: TCP SYN Floods`

`           `[`4.6.5`](#section-4-6-5)`. Example: Photuris`

`      `[`4.7`](#section-4-7)`. Object vs. Channel Security`

`      `[`4.8`](#section-4-8)`. Firewalls and Network Topology`

`   `[`5`](#section-5)`. Writing Security Considerations Sections`

`   `[`6`](#section-6)`. Examples`

`      `[`6.1`](#section-6-1)`. SMTP`

`           `[`6.1.1`](#section-6-1-1)`. Security Considerations`

`           `[`6.1.2`](#section-6-1-2)`. Communications security issues`

`           `[`6.1.3`](#section-6-1-3)`. Denial of Service`

`      `[`6.2`](#section-6-2)`. VRRP`

`           `[`6.2.1`](#section-6-2-1)`. Security Considerations`
...
<a id="section-1-1"></a> **`1.1. Requirements`**
...
<a id="section-2"></a> **`2. The Goals of Security`**
...
<a id="section-2-1"></a> **`2.1. Communication Security`**
...
<a id="section-2-1-1"></a> **`2.1.1. Confidentiality`**
...
<a id="section-2-1-2"></a> **`2.1.2. Data Integrity`**
...
<a id="section-2-1-3"></a> **`2.1.3. Peer Entity authentication`**
...
<a id="section-2-2"></a> **`2.2. Non-Repudiation`**
...
<a id="section-2-3"></a> **`2.3. Systems Security`**
...
<a id="section-2-3-1"></a> **`2.3.1. Unauthorized Usage`**
...
<a id="section-2-3-2"></a> **`2.3.2. Inappropriate Usage`**
...
<a id="section-2-3-3"></a> **`2.3.3. Denial of Service`**
...
<a id="section-3"></a> **`3. The Internet Threat Model`**
...
<a id="section-3-1"></a> **`3.1. Limited Threat Models`**
...
<a id="section-3-2"></a> **`3.2. Passive Attacks`**
...
<a id="section-3-2-1"></a> **`3.2.1. Confidentiality Violations`**
...
<a id="section-3-2-2"></a> **`3.2.2. Password Sniffing`**
...
<a id="section-3-2-3"></a> **`3.2.3. Offline Cryptographic Attacks`**
...
<a id="section-3-3"></a> **`3.3. Active Attacks`**
...
<a id="section-3-3-1"></a> **`3.3.1. Replay Attacks`**
...
<a id="section-3-3-2"></a> **`3.3.2. Message Insertion`**
...
<a id="section-3-3-3"></a> **`3.3.3. Message Deletion`**
...
<a id="section-3-3-4"></a> **`3.3.4. Message Modification`**
...
<a id="section-3-3-5"></a> **`3.3.5. Man-In-The-Middle`**
...
<a id="section-3-4"></a> **`3.4. Topological Issues`**
...
<a id="section-3-5"></a> **`3.5. On-path versus off-path`**
...
<a id="section-3-6"></a> **`3.6. Link-local`**
...
<a id="section-4"></a> **`4. Common Issues`**
...
<a id="section-4-1"></a> **`4.1. User Authentication`**
...
<a id="section-4-1-1"></a> **`4.1.1. Username/Password`**
...
<a id="section-4-1-2"></a> **`4.1.2. Challenge Response and One Time Passwords`**
...
<a id="section-4-1-3"></a> **`4.1.3. Shared Keys`**
...
<a id="section-4-1-4"></a> **`4.1.4. Key Distribution Centers`**
...
<a id="section-4-1-5"></a> **`4.1.5. Certificates`**
...
<a id="section-4-1-6"></a> **`4.1.6. Some Uncommon Systems`**
...
<a id="section-4-1-7"></a> **`4.1.7. Host Authentication`**
...
<a id="section-4-2"></a> **`4.2. Generic Security Frameworks`**
...
<a id="section-4-3"></a> **`4.3. Non-repudiation`**
...
<a id="section-4-4"></a> **`4.4. Authorization vs. Authentication`**
...
<a id="section-4-4-1"></a> **`4.4.1. Access Control Lists`**
...
<a id="section-4-4-2"></a> **`4.4.2. Certificate Based Systems`**
...
<a id="section-4-5"></a> **`4.5. Providing Traffic Security`**
...
<a id="section-4-5-1"></a> **`4.5.1. IPsec`**
...
<a id="section-4-5-2"></a> **`4.5.2. SSL/TLS`**
...
<a id="section-4-5-2-1"></a> **`4.5.2.1. Virtual Hosts`**
...
<a id="section-4-5-2-2"></a> **`4.5.2.2. Remote Authentication and TLS`**
...
<a id="section-4-5-3"></a> **`4.5.3. Remote Login`**
...
<a id="section-4-6"></a> **`4.6. Denial of Service Attacks and Countermeasures`**
...
<a id="section-4-6-1"></a> **`4.6.1. Blind Denial of Service`**
...
<a id="section-4-6-2"></a> **`4.6.2. Distributed Denial of Service`**
...
<a id="section-4-6-3"></a> **`4.6.3. Avoiding Denial of Service`**
...
<a id="section-4-6-3-1"></a> **`4.6.3.1. Make your attacker do more work than you do`**
...
<a id="section-4-6-3-2"></a> **`4.6.3.2. Make your attacker prove they can receive data from you`**
...
<a id="section-4-6-4"></a> **`4.6.4. Example: TCP SYN Floods`**
...
<a id="section-4-6-5"></a> **`4.6.5. Example: Photuris`**
...
<a id="section-4-7"></a> **`4.7. Object vs. Channel Security`**
...
<a id="section-4-8"></a> **`4.8. Firewalls and Network Topology`**
...
<a id="section-5"></a> **`5. Writing Security Considerations Sections`**
...
<a id="section-6-1-1"></a> **`6.1.1. Security Considerations`**

```text

```

<a id="section-6-1-1-1"></a> **`6.1.1.1. Mail Security and Spoofing`**
...
<a id="section-6-1-1-2"></a> **`6.1.1.2. Blind Copies`**
...
<a id="section-6-1-1-3"></a> **`6.1.1.3. VRFY, EXPN, and Security`**
...
<a id="section-6-1-1-4"></a> **`6.1.1.4. Information Disclosure in Announcements`**
...
<a id="section-6-1-1-5"></a> **`6.1.1.5. Information Disclosure in Trace Fields`**
...
<a id="section-6-1-1-6"></a> **`6.1.1.6. Information Disclosure in Message Forwarding`**
...
<a id="section-6-1-1-7"></a> **`6.1.1.7. Scope of Operation of SMTP Servers`**
...
<a id="section-6-1-1-8"></a> **`6.1.1.8. Inappropriate Usage [NEW]`**
...
<a id="section-6-1-1-8-1"></a> **`6.1.1.8.1. Closed Relaying [NEW]`**
...
<a id="section-6-1-1-8-2"></a> **`6.1.1.8.2. Endpoints [NEW]`**
...
<a id="section-6-1-2"></a> **`6.1.2. Communications security issues [NEW]`**
...
<a id="section-6-1-2-1"></a> **`6.1.2.1. SMTP over IPSEC [NEW]`**
...
<a id="section-6-1-2-2"></a> **`6.1.2.2. SMTP/TLS [NEW]`**
...
<a id="section-6-1-2-3"></a> **`6.1.2.3. S/MIME and PGP/MIME [NEW]`**
...
<a id="section-6-1-3"></a> **`6.1.3. Denial of Service [NEW]`**
...
<a id="section-6-2-1"></a> **`6.2.1. Security Considerations`**
...
<a id="section-6-2-1-1"></a> **`6.2.1.1. No Authentication`**
...
<a id="section-6-2-1-2"></a> **`6.2.1.2. Simple Text Password`**
...
<a id="section-6-2-1-3"></a> **`6.2.1.3. IP Authentication Header`**
