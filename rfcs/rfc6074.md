...
`   `[`2`](#section-2)`. Signaling Protocol Framework`

`     `[`2.1`](#section-2-1)`. Endpoint Identification`

`     `[`2.2`](#section-2-2)`. Creating a Single Bidirectional Pseudowire`

`     `[`2.3`](#section-2-3)`. Attachment Identifiers and Forwarders`

`   `[`3`](#section-3)`. Applications`

`     `[`3.1`](#section-3-1)`. Individual Point-to-Point Pseudowires`

`       `[`3.1.1`](#section-3-1-1)`. Provisioning Models`

`         `[`3.1.1.1`](#section-3-1-1-1)`. Double-Sided Provisioning`

`         `[`3.1.1.2`](#section-3-1-1-2)`. Single-Sided Provisioning with Discovery`

`       `[`3.1.2`](#section-3-1-2)`. Signaling`

`     `[`3.2`](#section-3-2)`. Virtual Private LAN Service`

`       `[`3.2.1`](#section-3-2-1)`. Provisioning`

`       `[`3.2.2`](#section-3-2-2)`. Auto-Discovery`

`         `[`3.2.2.1`](#section-3-2-2-1)`. BGP-Based Auto-Discovery`

`       `[`3.2.3`](#section-3-2-3)`. Signaling`

`       `[`3.2.4`](#section-3-2-4)`. Pseudowires as VPLS Attachment Circuits`

`     `[`3.3`](#section-3-3)`. Colored Pools: Full Mesh of Point-to-Point Pseudowires .`

`       `[`3.3.1`](#section-3-3-1)`. Provisioning`

`       `[`3.3.2`](#section-3-3-2)`. Auto-Discovery`

`         `[`3.3.2.1`](#section-3-3-2-1)`. BGP-Based Auto-Discovery`

`       `[`3.3.3`](#section-3-3-3)`. Signaling`

`     `[`3.4`](#section-3-4)`. Colored Pools: Partial Mesh`

`     `[`3.5`](#section-3-5)`. Distributed VPLS`

`       `[`3.5.1`](#section-3-5-1)`. Signaling`

`       `[`3.5.2`](#section-3-5-2)`. Provisioning and Discovery`

`       `[`3.5.3`](#section-3-5-3)`. Non-Distributed VPLS as a Sub-Case`

`       `[`3.5.4`](#section-3-5-4)`. Splicing and the Data Plane`

`   `[`4`](#section-4)`. Inter-AS Operation`

`     `[`4.1`](#section-4-1)`. Multihop EBGP Redistribution of L2VPN NLRIs`

`     `[`4.2`](#section-4-2)`. EBGP Redistribution of L2VPN NLRIs with Multi-Segment`

`           Pseudowires`

`     `[`4.3`](#section-4-3)`. Inter-Provider Application of Distributed VPLS`

`           Signaling`

`     `[`4.4`](#section-4-4)`. RT and RD Assignment Considerations`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. IANA Considerations`

`   `[`7`](#section-7)`. BGP-AD and VPLS-BGP Interoperability`
...
<a id="section-2"></a> **`2. Signaling Protocol Framework`**

```text

```

<a id="section-2-1"></a> **`2.1. Endpoint Identification`**
...
<a id="section-2-2"></a> **`2.2. Creating a Single Bidirectional Pseudowire`**
...
<a id="section-2-3"></a> **`2.3. Attachment Identifiers and Forwarders`**
...
<a id="section-3"></a> **`3. Applications`**
...
<a id="section-3-1"></a> **`3.1. Individual Point-to-Point Pseudowires`**
...
<a id="section-3-1-1"></a> **`3.1.1. Provisioning Models`**

```text

```

<a id="section-3-1-1-1"></a> **`3.1.1.1. Double-Sided Provisioning`**
...
<a id="section-3-1-1-2"></a> **`3.1.1.2. Single-Sided Provisioning with Discovery`**
...
<a id="section-3-1-2"></a> **`3.1.2. Signaling`**
...
<a id="section-3-2"></a> **`3.2. Virtual Private LAN Service`**
...
<a id="section-3-2-1"></a> **`3.2.1. Provisioning`**
...
<a id="section-3-2-2"></a> **`3.2.2. Auto-Discovery`**

```text

```

<a id="section-3-2-2-1"></a> **`3.2.2.1. BGP-Based Auto-Discovery`**
...
<a id="section-3-2-3"></a> **`3.2.3. Signaling`**
...
<a id="section-3-2-4"></a> **`3.2.4. Pseudowires as VPLS Attachment Circuits`**
...
<a id="section-3-3"></a> **`3.3. Colored Pools: Full Mesh of Point-to-Point Pseudowires`**
...
<a id="section-3-3-1"></a> **`3.3.1. Provisioning`**
...
<a id="section-3-3-2"></a> **`3.3.2. Auto-Discovery`**

```text

```

<a id="section-3-3-2-1"></a> **`3.3.2.1. BGP-Based Auto-Discovery`**
...
<a id="section-3-3-3"></a> **`3.3.3. Signaling`**
...
<a id="section-3-4"></a> **`3.4. Colored Pools: Partial Mesh`**
...
<a id="section-3-5"></a> **`3.5. Distributed VPLS`**
...
<a id="section-3-5-1"></a> **`3.5.1. Signaling`**
...
<a id="section-3-5-2"></a> **`3.5.2. Provisioning and Discovery`**
...
<a id="section-3-5-3"></a> **`3.5.3. Non-Distributed VPLS as a Sub-Case`**
...
<a id="section-3-5-4"></a> **`3.5.4. Splicing and the Data Plane`**
...
<a id="section-4"></a> **`4. Inter-AS Operation`**
...
<a id="section-4-1"></a> **`4.1. Multihop EBGP Redistribution of L2VPN NLRIs`**
...
<a id="section-4-2"></a> **`4.2. EBGP Redistribution of L2VPN NLRIs with Multi-Segment Pseudowires`**
...
<a id="section-4-3"></a> **`4.3. Inter-Provider Application of Distributed VPLS Signaling`**
...
<a id="section-4-4"></a> **`4.4. RT and RD Assignment Considerations`**
...
<a id="section-7"></a> **`7. BGP-AD and VPLS-BGP Interoperability`**
