...
`   `[`3`](#section-3)`. Reference Model`

`      `[`3.1`](#section-3-1)`. Scope of Deployment Model`

`   `[`4`](#section-4)`. Detailed PCECP Requirements for Inter-AS G(MPLS) TE Path`

`      Computation`

`      `[`4.1`](#section-4-1)`. PCE Communication Protocol Requirements`

`           `[`4.1.1`](#section-4-1-1)`. Requirements for Path Computation Requests`

`           `[`4.1.2`](#section-4-1-2)`. Requirements for Path Computation Responses`

`      `[`4.2`](#section-4-2)`. Scalability and Performance Considerations`

`      `[`4.3`](#section-4-3)`. Management Considerations`

`      `[`4.4`](#section-4-4)`. Confidentiality`

`      `[`4.5`](#section-4-5)`. Policy Controls Affecting Inter-AS PCECP`

`           `[`4.5.1`](#section-4-5-1)`. Inter-AS PCE Peering Policy Controls`

`           `[`4.5.2`](#section-4-5-2)`. Inter-AS PCE Re-Interpretation Policies`

`   `[`5`](#section-5)`. Security Considerations`

`      `[`5.1`](#section-5-1)`. Use and Distribution of Keys`

`      `[`5.2`](#section-5-2)`. Application of Policy`

`      `[`5.3`](#section-5-3)`. Confidentiality`

`      `[`5.4`](#section-5-4)`. Falsification of Information`
...
<a id="section-3"></a> **`3. Reference Model`**
...
<a id="section-3-1"></a> **`3.1. Scope of Deployment Model`**
...
<a id="section-4"></a> **`4. Detailed PCECP Requirements for Inter-AS G(MPLS) TE Path Computation`**
...
<a id="section-4-1"></a> **`4.1. PCE Communication Protocol Requirements`**
...
<a id="section-4-1-1"></a> **`4.1.1. Requirements for Path Computation Requests`**
...
<a id="section-4-1-2"></a> **`4.1.2. Requirements for Path Computation Responses`**
...
<a id="section-4-2"></a> **`4.2. Scalability and Performance Considerations`**
...
<a id="section-4-3"></a> **`4.3. Management Considerations`**
...
<a id="section-4-4"></a> **`4.4. Confidentiality`**
...
<a id="section-4-5"></a> **`4.5. Policy Controls Affecting Inter-AS PCECP`**
...
<a id="section-4-5-1"></a> **`4.5.1. Inter-AS PCE Peering Policy Controls`**
...
<a id="section-4-5-2"></a> **`4.5.2. Inter-AS PCE Re-Interpretation Policies`**
...
<a id="section-5-1"></a> **`5.1. Use and Distribution of Keys`**
...
<a id="section-5-2"></a> **`5.2. Application of Policy`**
...
<a id="section-5-3"></a> **`5.3. Confidentiality`**
...
<a id="section-5-4"></a> **`5.4. Falsification of Information`**
