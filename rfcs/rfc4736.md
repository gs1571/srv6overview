...
`   `[`3`](#section-3)`. Establishment of a Loosely Routed TE LSP`

`   `[`4`](#section-4)`. Reoptimization of a Loosely Routed TE LSP Path`

`   `[`5`](#section-5)`. Signaling Extensions`

`      `[`5.1`](#section-5-1)`. Path Re-Evaluation Request`

`      `[`5.2`](#section-5-2)`. New Error Value Sub-Codes`

`   `[`6`](#section-6)`. Mode of Operation`

`      `[`6.1`](#section-6-1)`. Head-End Reoptimization Control`

`      `[`6.2`](#section-6-2)`. Reoptimization Triggers`

`      `[`6.3`](#section-6-3)`. Head-End Request versus Mid-Point Explicit`

`           Notification Functions`

`           `[`6.3.1`](#section-6-3-1)`. Head-End Request Function`

`           `[`6.3.2`](#section-6-3-2)`. Mid-Point Explicit Notification`

`           `[`6.3.3`](#section-6-3-3)`. ERO Caching`

`   `[`7`](#section-7)`. Applicability and Interoperability`
...
<a id="section-3"></a> **`3. Establishment of a Loosely Routed TE LSP`**
...
<a id="section-4"></a> **`4. Reoptimization of a Loosely Routed TE LSP Path`**
...
<a id="section-5"></a> **`5. Signaling Extensions`**
...
<a id="section-5-1"></a> **`5.1. Path Re-Evaluation Request`**
...
<a id="section-5-2"></a> **`5.2. New Error Value Sub-Codes`**
...
<a id="section-6"></a> **`6. Mode of Operation`**

```text

```

<a id="section-6-1"></a> **`6.1. Head-End Reoptimization Control`**
...
<a id="section-6-2"></a> **`6.2. Reoptimization Triggers`**
...
<a id="section-6-3"></a> **`6.3. Head-End Request versus Mid-Point Explicit Notification Functions`**
...
<a id="section-6-3-1"></a> **`6.3.1. Head-End Request Function`**
...
<a id="section-6-3-2"></a> **`6.3.2. Mid-Point Explicit Notification`**
...
<a id="section-6-3-3"></a> **`6.3.3. ERO Caching`**
...
<a id="section-7"></a> **`7. Applicability and Interoperability`**
