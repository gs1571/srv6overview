...
`        `[`1.1`](#section-1-1)`. Goal and Scope of the Document`

`   `[`2`](#section-2)`. Brief Description of a Generic ISP Network`

`   `[`3`](#section-3)`. Transition Scenarios`

`        `[`3.1`](#section-3-1)`. Identification of Stages and Scenarios`

`        `[`3.2`](#section-3-2)`. Stages`

`              `[`3.2.1`](#section-3-2-1)`. Stage 1 Scenarios: Launch`

`              `[`3.2.2`](#section-3-2-2)`. Stage 2a Scenarios: Backbone`

`              `[`3.2.3`](#section-3-2-3)`. Stage 2b Scenarios: Customer Connection`

`              `[`3.2.4`](#section-3-2-4)`. Stage 3 Scenarios: Complete`

`              `[`3.2.5`](#section-3-2-5)`. Stages 2a and 3: Combination Scenarios`

`        `[`3.3`](#section-3-3)`. Transition Scenarios`

`        `[`3.4`](#section-3-4)`. Actions Needed When Deploying IPv6 in an ISP's Network`

`   `[`4`](#section-4)`. Backbone Transition Actions`

`        `[`4.1`](#section-4-1)`. Steps in the Transition of Backbone Networks`

`              `[`4.1.1`](#section-4-1-1)`. MPLS Backbone`

`        `[`4.2`](#section-4-2)`. Configuration of Backbone Equipment`

`        `[`4.3`](#section-4-3)`. Routing`

`              `[`4.3.1`](#section-4-3-1)`. IGP`

`              `[`4.3.2`](#section-4-3-2)`. EGP`

`              `[`4.3.3`](#section-4-3-3)`. Transport of Routing Protocols`

`        `[`4.4`](#section-4-4)`. Multicast`

`   `[`5`](#section-5)`. Customer Connection Transition Actions`

`        `[`5.1`](#section-5-1)`. Steps in the Transition of Customer Connection Networks 13`

`              `[`5.1.1`](#section-5-1-1)`. Small End Sites`

`              `[`5.1.2`](#section-5-1-2)`. Large End Sites`

`        `[`5.2`](#section-5-2)`. User Authentication/Access Control Requirements`

`        `[`5.3`](#section-5-3)`. Configuration of Customer Equipment`

`        `[`5.4`](#section-5-4)`. Requirements for Traceability`

`        `[`5.5`](#section-5-5)`. Ingress Filtering in the Customer Connection Network.`

`        `[`5.6`](#section-5-6)`. Multihoming`

`        `[`5.7`](#section-5-7)`. Quality of Service`

`   `[`6`](#section-6)`. Network and Service Operation Actions`

`   `[`7`](#section-7)`. Future Stages`

`   `[`8`](#section-8)`. Requirements for Follow-On Work`

`   `[`9`](#section-9)`. Example Networks`

`        `[`9.1`](#section-9-1)`. Example 1`

`        `[`9.2`](#section-9-2)`. Example 2`

`        `[`9.3`](#section-9-3)`. Example 3`
...
<a id="section-1-1"></a> **`1.1. Goal and Scope of the Document`**
...
<a id="section-2"></a> **`2. Brief Description of a Generic ISP Network`**
...
<a id="section-3"></a> **`3. Transition Scenarios`**

```text

```

<a id="section-3-1"></a> **`3.1. Identification of Stages and Scenarios`**
...
<a id="section-3-2-1"></a> **`3.2.1. Stage 1 Scenarios: Launch`**
...
<a id="section-3-2-2"></a> **`3.2.2. Stage 2a Scenarios: Backbone`**
...
<a id="section-3-2-3"></a> **`3.2.3. Stage 2b Scenarios: Customer Connection`**
...
<a id="section-3-2-4"></a> **`3.2.4. Stage 3 Scenarios: Complete`**
...
<a id="section-3-2-5"></a> **`3.2.5. Stages 2a and 3: Combination Scenarios`**
...
<a id="section-3-3"></a> **`3.3. Transition Scenarios`**
...
<a id="section-3-4"></a> **`3.4. Actions Needed When Deploying IPv6 in an ISP's Network`**
...
<a id="section-4"></a> **`4. Backbone Transition Actions`**

```text

```

<a id="section-4-1"></a> **`4.1. Steps in the Transition of Backbone Networks`**
...
<a id="section-4-1-1"></a> **`4.1.1. MPLS Backbone`**
...
<a id="section-4-2"></a> **`4.2. Configuration of Backbone Equipment`**
...
<a id="section-4-3"></a> **`4.3. Routing`**
...
<a id="section-4-3-1"></a> **`4.3.1. IGP`**
...
<a id="section-4-3-2"></a> **`4.3.2. EGP`**
...
<a id="section-4-3-3"></a> **`4.3.3. Transport of Routing Protocols`**
...
<a id="section-4-4"></a> **`4.4. Multicast`**
...
<a id="section-5"></a> **`5. Customer Connection Transition Actions`**

```text

```

<a id="section-5-1"></a> **`5.1. Steps in the Transition of Customer Connection Networks`**
...
<a id="section-5-1-1"></a> **`5.1.1. Small End Sites`**
...
<a id="section-5-1-2"></a> **`5.1.2. Large End Sites`**
...
<a id="section-5-2"></a> **`5.2. User Authentication/Access Control Requirements`**
...
<a id="section-5-3"></a> **`5.3. Configuration of Customer Equipment`**
...
<a id="section-5-4"></a> **`5.4. Requirements for Traceability`**
...
<a id="section-5-5"></a> **`5.5. Ingress Filtering in the Customer Connection Network`**
...
<a id="section-5-6"></a> **`5.6. Multihoming`**
...
<a id="section-6"></a> **`6. Network and Service Operation Actions`**
...
<a id="section-7"></a> **`7. Future Stages`**
...
<a id="section-8"></a> **`8. Requirements for Follow-On Work`**
...
<a id="section-9"></a> **`9. Example Networks`**
...
<a id="section-9-1"></a> **`9.1. Example 1`**
...
<a id="section-9-2"></a> **`9.2. Example 2`**
...
<a id="section-9-3"></a> **`9.3. Example 3`**
