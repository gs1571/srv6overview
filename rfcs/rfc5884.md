...
`      `[`3.1`](#section-3-1)`. BFD for MPLS LSPs: Motivation`

`      `[`3.2`](#section-3-2)`. Using BFD in Conjunction with LSP Ping`

`   `[`4`](#section-4)`. Theory of Operation`

`   `[`5`](#section-5)`. Initialization and Demultiplexing`

`   `[`6`](#section-6)`. Session Establishment`

`      `[`6.1`](#section-6-1)`. BFD Discriminator TLV in LSP Ping`

`   `[`7`](#section-7)`. Encapsulation`
...
<a id="section-3"></a> **`3. Applicability`**
...
<a id="section-3-1"></a> **`3.1. BFD for MPLS LSPs: Motivation`**
...
<a id="section-3-2"></a> **`3.2. Using BFD in Conjunction with LSP Ping`**
...
<a id="section-5"></a> **`5. Initialization and Demultiplexing`**
...
<a id="section-6"></a> **`6. Session Establishment`**
...
<a id="section-6-1"></a> **`6.1. BFD Discriminator TLV in LSP Ping`**
...
<a id="section-7"></a> **`7. Encapsulation`**
