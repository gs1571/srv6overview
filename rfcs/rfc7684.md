...
`   `[`2`](#section-2)`. OSPFv2 Extended Prefix Opaque LSA`

`      `[`2.1`](#section-2-1)`. OSPFv2 Extended Prefix TLV`

`   `[`3`](#section-3)`. OSPFv2 Extended Link Opaque LSA`

`      `[`3.1`](#section-3-1)`. OSPFv2 Extended Link TLV`

`   `[`4`](#section-4)`. Backward Compatibility`

`   `[`5`](#section-5)`. Security Considerations`

`   `[`6`](#section-6)`. IANA Considerations`

`      `[`6.1`](#section-6-1)`. OSPFv2 Extended Prefix Opaque LSA TLVs Registry`

`      `[`6.2`](#section-6-2)`. OSPFv2 Extended Prefix TLV Sub-TLVs Registry`

`      `[`6.3`](#section-6-3)`. OSPFv2 Extended Prefix TLV Flags Registry`

`      `[`6.4`](#section-6-4)`. OSPFv2 Extended Link Opaque LSA TLVs Registry`

`      `[`6.5`](#section-6-5)`. OSPFv2 Extended Link TLV Sub-TLVs Registry`
...
<a id="section-2"></a> **`2. OSPFv2 Extended Prefix Opaque LSA`**
...
<a id="section-2-1"></a> **`2.1. OSPFv2 Extended Prefix TLV`**
...
<a id="section-3"></a> **`3. OSPFv2 Extended Link Opaque LSA`**
...
<a id="section-3-1"></a> **`3.1. OSPFv2 Extended Link TLV`**
...
<a id="section-4"></a> **`4. Backward Compatibility`**
...
<a id="section-6-1"></a> **`6.1. OSPFv2 Extended Prefix Opaque LSA TLVs Registry`**
...
<a id="section-6-2"></a> **`6.2. OSPFv2 Extended Prefix TLV Sub-TLVs Registry`**
...
<a id="section-6-3"></a> **`6.3. OSPFv2 Extended Prefix TLV Flags Registry`**
...
<a id="section-6-4"></a> **`6.4. OSPFv2 Extended Link Opaque LSA TLVs Registry`**
...
<a id="section-6-5"></a> **`6.5. OSPFv2 Extended Link TLV Sub-TLVs Registry`**
