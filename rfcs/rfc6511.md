...
`   `[`2`](#section-2)`. RSVP-TE Signaling Extensions`

`      `[`2.1`](#section-2-1)`. Signaling Non-PHP Behavior`

`      `[`2.2`](#section-2-2)`. Signaling OOB Mapping Indication`

`      `[`2.3`](#section-2-3)`. Relationship between OOB and Non-PHP Flags`

`      `[`2.4`](#section-2-4)`. Egress Procedure for Label Binding`

`   `[`3`](#section-3)`. Security Considerations`

`   `[`4`](#section-4)`. IANA Considerations`

`      `[`4.1`](#section-4-1)`. Attribute Flags for LSP Attributes Object`

`      `[`4.2`](#section-4-2)`. New RSVP Error Sub-Code`
...
<a id="section-2"></a> **`2. RSVP-TE Signaling Extensions`**
...
<a id="section-2-1"></a> **`2.1. Signaling Non-PHP Behavior`**
...
<a id="section-2-2"></a> **`2.2. Signaling OOB Mapping Indication`**
...
<a id="section-2-3"></a> **`2.3. Relationship between OOB and Non-PHP Flags`**
...
<a id="section-2-4"></a> **`2.4. Egress Procedure for Label Binding`**
...
<a id="section-4-1"></a> **`4.1. Attribute Flags for LSP Attributes Object`**
...
<a id="section-4-2"></a> **`4.2. New RSVP Error Sub-Code`**
