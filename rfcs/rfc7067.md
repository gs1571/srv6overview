...
`   `[`3`](#section-3)`. Impact of Massive Number of End Stations`

`      `[`3.1`](#section-3-1)`. Issues of Flooding-Based Learning in Data Centers`

`      `[`3.2`](#section-3-2)`. Two Examples`

`   `[`4`](#section-4)`. Benefits of Directory-Assisted TRILL Edge`

`   `[`5`](#section-5)`. Generic Operation of Directory Assistance`

`      `[`5.1`](#section-5-1)`. Information in Directory for Edge RBridges`

`      `[`5.2`](#section-5-2)`. Push Model and Requirements`

`      `[`5.3`](#section-5-3)`. Pull Model and Requirements`

`   `[`6`](#section-6)`. Recommendation`
...
<a id="section-3"></a> **`3. Impact of Massive Number of End Stations`**
...
<a id="section-3-1"></a> **`3.1. Issues of Flooding-Based Learning in Data Centers`**
...
<a id="section-3-2"></a> **`3.2. Two Examples`**
...
<a id="section-4"></a> **`4. Benefits of Directory-Assisted TRILL Edge`**
...
<a id="section-5"></a> **`5. Generic Operation of Directory Assistance`**
...
<a id="section-5-1"></a> **`5.1. Information in Directory for Edge RBridges`**
...
<a id="section-5-2"></a> **`5.2. Push Model and Requirements`**
...
<a id="section-5-3"></a> **`5.3. Pull Model and Requirements`**
...
<a id="section-6"></a> **`6. Recommendation`**
