...
`   `[`2`](#section-2)`. Issues Due to IPv6 Protocol`

`     `[`2.1`](#section-2-1)`. IPv6 Protocol-Specific Issues`

`       `[`2.1.1`](#section-2-1-1)`. Routing Headers and Hosts`

`       `[`2.1.2`](#section-2-1-2)`. Routing Headers for Mobile IPv6 and Other Purposes .`

`       `[`2.1.3`](#section-2-1-3)`. Site-Scope Multicast Addresses`

`       `[`2.1.4`](#section-2-1-4)`. ICMPv6 and Multicast`

`       `[`2.1.5`](#section-2-1-5)`. Bogus Errored Packets in ICMPv6 Error Messages`

`       `[`2.1.6`](#section-2-1-6)`. Anycast Traffic Identification and Security`

`       `[`2.1.7`](#section-2-1-7)`. Address Privacy Extensions Interact with DDoS`

`               Defenses`

`       `[`2.1.8`](#section-2-1-8)`. Dynamic DNS: Stateless Address Autoconfiguration,`

`               Privacy Extensions, and SEND`

`       `[`2.1.9`](#section-2-1-9)`. Extension Headers`

`       `[`2.1.10`](#section-2-1-10)`. Fragmentation: Reassembly and Deep Packet`

`               Inspection`

`       `[`2.1.11`](#section-2-1-11)`. Fragmentation Related DoS Attacks`

`       `[`2.1.12`](#section-2-1-12)`. Link-Local Addresses and Securing Neighbor`

`               Discovery`

`       `[`2.1.13`](#section-2-1-13)`. Securing Router Advertisements`

`       `[`2.1.14`](#section-2-1-14)`. Host-to-Router Load Sharing`

`       `[`2.1.15`](#section-2-1-15)`. Mobile IPv6`

`     `[`2.2`](#section-2-2)`. IPv4-Mapped IPv6 Addresses`

`     `[`2.3`](#section-2-3)`. Increased End-to-End Transparency`

`       `[`2.3.1`](#section-2-3-1)`. IPv6 Networks without NATs`

`       `[`2.3.2`](#section-2-3-2)`. Enterprise Network Security Model for IPv6`

`     `[`2.4`](#section-2-4)`. IPv6 in IPv6 Tunnels`

`   `[`3`](#section-3)`. Issues Due to Transition Mechanisms`

`     `[`3.1`](#section-3-1)`. IPv6 Transition/Coexistence Mechanism-Specific Issues  .`

`     `[`3.2`](#section-3-2)`. Automatic Tunneling and Relays`

`     `[`3.3`](#section-3-3)`. Tunneling IPv6 through IPv4 Networks May Break IPv4`

`           Network Security Assumptions`

`   `[`4`](#section-4)`. Issues Due to IPv6 Deployment`

`     `[`4.1`](#section-4-1)`. Avoiding the Trap of Insecure IPv6 Service Piloting`

`     `[`4.2`](#section-4-2)`. DNS Server Problems`

`     `[`4.3`](#section-4-3)`. Addressing Schemes and Securing Routers`

`     `[`4.4`](#section-4-4)`. Consequences of Multiple Addresses in IPv6`

`     `[`4.5`](#section-4-5)`. Deploying ICMPv6`

`       `[`4.5.1`](#section-4-5-1)`. Problems Resulting from ICMPv6 Transparency`

`     `[`4.6`](#section-4-6)`. IPsec Transport Mode`

`     `[`4.7`](#section-4-7)`. Reduced Functionality Devices`

`     `[`4.8`](#section-4-8)`. Operational Factors when Enabling IPv6 in the Network  .`

`     `[`4.9`](#section-4-9)`. Security Issues Due to Neighbor Discovery Proxies`
...
<a id="section-2"></a> **`2. Issues Due to IPv6 Protocol`**
...
<a id="section-2-1"></a> **`2.1. IPv6 Protocol-Specific Issues`**
...
<a id="section-2-1-1"></a> **`2.1.1. Routing Headers and Hosts`**
...
<a id="section-2-1-2"></a> **`2.1.2. Routing Headers for Mobile IPv6 and Other Purposes`**
...
<a id="section-2-1-3"></a> **`2.1.3. Site-Scope Multicast Addresses`**
...
<a id="section-2-1-4"></a> **`2.1.4. ICMPv6 and Multicast`**
...
<a id="section-2-1-5"></a> **`2.1.5. Bogus Errored Packets in ICMPv6 Error Messages`**
...
<a id="section-2-1-6"></a> **`2.1.6. Anycast Traffic Identification and Security`**
...
<a id="section-2-1-7"></a> **`2.1.7. Address Privacy Extensions Interact with DDoS Defenses`**
...
<a id="section-2-1-8"></a> **`2.1.8. Dynamic DNS: Stateless Address Autoconfiguration, Privacy`**
...
<a id="section-2-1-9"></a> **`2.1.9. Extension Headers`**
...
<a id="section-2-1-9-1"></a> **`2.1.9.1. Processing Extension Headers in Middleboxes`**
...
<a id="section-2-1-9-2"></a> **`2.1.9.2. Processing Extension Header Chains`**
...
<a id="section-2-1-9-3"></a> **`2.1.9.3. Unknown Headers/Destination Options and Security Policy`**
...
<a id="section-2-1-9-4"></a> **`2.1.9.4. Excessive Hop-by-Hop Options`**
...
<a id="section-2-1-9-5"></a> **`2.1.9.5. Misuse of Pad1 and PadN Options`**
...
<a id="section-2-1-9-6"></a> **`2.1.9.6. Overuse of Router Alert Option`**
...
<a id="section-2-1-10"></a> **`2.1.10. Fragmentation: Reassembly and Deep Packet Inspection`**
...
<a id="section-2-1-11"></a> **`2.1.11. Fragmentation Related DoS Attacks`**
...
<a id="section-2-1-12"></a> **`2.1.12. Link-Local Addresses and Securing Neighbor Discovery`**
...
<a id="section-2-1-13"></a> **`2.1.13. Securing Router Advertisements`**
...
<a id="section-2-1-14"></a> **`2.1.14. Host-to-Router Load Sharing`**
...
<a id="section-2-1-15"></a> **`2.1.15. Mobile IPv6`**
...
<a id="section-2-1-15-1"></a> **`2.1.15.1. Obsolete Home Address Option in Mobile IPv6`**
...
<a id="section-2-2"></a> **`2.2. IPv4-Mapped IPv6 Addresses`**
...
<a id="section-2-3"></a> **`2.3. Increased End-to-End Transparency`**
...
<a id="section-2-3-1"></a> **`2.3.1. IPv6 Networks without NATs`**
...
<a id="section-2-3-2"></a> **`2.3.2. Enterprise Network Security Model for IPv6`**
...
<a id="section-2-4"></a> **`2.4. IPv6 in IPv6 Tunnels`**
...
<a id="section-3"></a> **`3. Issues Due to Transition Mechanisms`**

```text

```

<a id="section-3-1"></a> **`3.1. IPv6 Transition/Coexistence Mechanism-Specific Issues`**
...
<a id="section-3-2"></a> **`3.2. Automatic Tunneling and Relays`**
...
<a id="section-3-3"></a> **`3.3. Tunneling IPv6 through IPv4 Networks May Break IPv4 Network`**
...
<a id="section-4"></a> **`4. Issues Due to IPv6 Deployment`**

```text

```

<a id="section-4-1"></a> **`4.1. Avoiding the Trap of Insecure IPv6 Service Piloting`**
...
<a id="section-4-2"></a> **`4.2. DNS Server Problems`**
...
<a id="section-4-3"></a> **`4.3. Addressing Schemes and Securing Routers`**
...
<a id="section-4-4"></a> **`4.4. Consequences of Multiple Addresses in IPv6`**
...
<a id="section-4-5"></a> **`4.5. Deploying ICMPv6`**
...
<a id="section-4-5-1"></a> **`4.5.1. Problems Resulting from ICMPv6 Transparency`**
...
<a id="section-4-6"></a> **`4.6. IPsec Transport Mode`**
...
<a id="section-4-7"></a> **`4.7. Reduced Functionality Devices`**
...
<a id="section-4-8"></a> **`4.8. Operational Factors when Enabling IPv6 in the Network`**
...
<a id="section-4-9"></a> **`4.9. Security Issues Due to Neighbor Discovery Proxies`**
