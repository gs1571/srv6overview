...
`   `[`3`](#section-3)`. Motivation and Objectives for Stateful PCE`

`      `[`3.1`](#section-3-1)`. Motivation`

`           `[`3.1.1`](#section-3-1-1)`. Background`

`           `[`3.1.2`](#section-3-1-2)`. Why a Stateful PCE?`

`           `[`3.1.3`](#section-3-1-3)`. Protocol vs. Configuration`

`      `[`3.2`](#section-3-2)`. Objectives`

`   `[`4`](#section-4)`. New Functions to Support Stateful PCEs`

`   `[`5`](#section-5)`. Overview of Protocol Extensions`

`      `[`5.1`](#section-5-1)`. LSP State Ownership`

`      `[`5.2`](#section-5-2)`. New Messages`

`      `[`5.3`](#section-5-3)`. Error Reporting`

`      `[`5.4`](#section-5-4)`. Capability Advertisement`

`      `[`5.5`](#section-5-5)`. IGP Extensions for Stateful PCE Capabilities`

`           Advertisement`

`      `[`5.6`](#section-5-6)`. State Synchronization`

`      `[`5.7`](#section-5-7)`. LSP Delegation`

`           `[`5.7.1`](#section-5-7-1)`. Delegating an LSP`

`           `[`5.7.2`](#section-5-7-2)`. Revoking a Delegation`

`           `[`5.7.3`](#section-5-7-3)`. Returning a Delegation`

`           `[`5.7.4`](#section-5-7-4)`. Redundant Stateful PCEs`

`           `[`5.7.5`](#section-5-7-5)`. Redelegation on PCE Failure`

`      `[`5.8`](#section-5-8)`. LSP Operations`

`           `[`5.8.1`](#section-5-8-1)`. Passive Stateful PCE Path Computation`

`                  Request/Response`

`           `[`5.8.2`](#section-5-8-2)`. Switching from Passive Stateful to Active`

`                  Stateful`

`           `[`5.8.3`](#section-5-8-3)`. Active Stateful PCE LSP Update`

`      `[`5.9`](#section-5-9)`. LSP Protection`

`      `[`5.10`](#section-5-10)`. PCEP Sessions`
...
`      `[`6.3`](#section-6-3)`. The PCErr Message`

`      `[`6.4`](#section-6-4)`. The PCReq Message`

`      `[`6.5`](#section-6-5)`. The PCRep Message`

`   `[`7`](#section-7)`. Object Formats`

`      `[`7.1`](#section-7-1)`. OPEN Object`

`           `[`7.1.1`](#section-7-1-1)`. STATEFUL-PCE-CAPABILITY TLV`

`      `[`7.2`](#section-7-2)`. SRP Object`

`      `[`7.3`](#section-7-3)`. LSP Object`

`           `[`7.3.1`](#section-7-3-1)`. LSP-IDENTIFIERS TLVs`

`           `[`7.3.2`](#section-7-3-2)`. Symbolic Path Name TLV`

`           `[`7.3.3`](#section-7-3-3)`. LSP Error Code TLV`

`           `[`7.3.4`](#section-7-3-4)`. RSVP Error Spec TLV`

`   `[`8`](#section-8)`. IANA Considerations`

`      `[`8.1`](#section-8-1)`. PCE Capabilities in IGP Advertisements`

`      `[`8.2`](#section-8-2)`. PCEP Messages`

`      `[`8.3`](#section-8-3)`. PCEP Objects`

`      `[`8.4`](#section-8-4)`. LSP Object`

`      `[`8.5`](#section-8-5)`. PCEP-Error Object`

`      `[`8.6`](#section-8-6)`. Notification Object`

`      `[`8.7`](#section-8-7)`. PCEP TLV Type Indicators`

`      `[`8.8`](#section-8-8)`. STATEFUL-PCE-CAPABILITY TLV`

`      `[`8.9`](#section-8-9)`. LSP-ERROR-CODE TLV`

`   `[`9`](#section-9)`. Manageability Considerations`

`      `[`9.1`](#section-9-1)`. Control Function and Policy`

`      `[`9.2`](#section-9-2)`. Information and Data Models`

`      `[`9.3`](#section-9-3)`. Liveness Detection and Monitoring`

`      `[`9.4`](#section-9-4)`. Verifying Correct Operation`

`      `[`9.5`](#section-9-5)`. Requirements on Other Protocols and Functional`

`           Components`

`      `[`9.6`](#section-9-6)`. Impact on Network Operation`

`   `[`10`](#section-10)`. Security Considerations`

`      `[`10.1`](#section-10-1)`. Vulnerability`

`      `[`10.2`](#section-10-2)`. LSP State Snooping`

`      `[`10.3`](#section-10-3)`. Malicious PCE`

`      `[`10.4`](#section-10-4)`. Malicious PCC`
...
<a id="section-3"></a> **`3. Motivation and Objectives for Stateful PCE`**
...
<a id="section-3-1-1"></a> **`3.1.1. Background`**
...
<a id="section-3-1-2"></a> **`3.1.2. Why a Stateful PCE?`**
...
<a id="section-3-1-3"></a> **`3.1.3. Protocol vs. Configuration`**
...
<a id="section-4"></a> **`4. New Functions to Support Stateful PCEs`**
...
<a id="section-5"></a> **`5. Overview of Protocol Extensions`**

```text

```

<a id="section-5-1"></a> **`5.1. LSP State Ownership`**
...
<a id="section-5-2"></a> **`5.2. New Messages`**
...
<a id="section-5-3"></a> **`5.3. Error Reporting`**
...
<a id="section-5-4"></a> **`5.4. Capability Advertisement`**
...
<a id="section-5-5"></a> **`5.5. IGP Extensions for Stateful PCE Capabilities Advertisement`**
...
<a id="section-5-6"></a> **`5.6. State Synchronization`**
...
<a id="section-5-7"></a> **`5.7. LSP Delegation`**
...
<a id="section-5-7-1"></a> **`5.7.1. Delegating an LSP`**
...
<a id="section-5-7-2"></a> **`5.7.2. Revoking a Delegation`**

```text

```

<a id="section-5-7-2-1"></a> **`5.7.2.1. Explicit Revocation`**
...
<a id="section-5-7-2-2"></a> **`5.7.2.2. Revocation on Redelegation Timeout`**
...
<a id="section-5-7-3"></a> **`5.7.3. Returning a Delegation`**
...
<a id="section-5-7-4"></a> **`5.7.4. Redundant Stateful PCEs`**
...
<a id="section-5-7-5"></a> **`5.7.5. Redelegation on PCE Failure`**
...
<a id="section-5-8"></a> **`5.8. LSP Operations`**

```text

```

<a id="section-5-8-1"></a> **`5.8.1. Passive Stateful PCE Path Computation Request/Response`**
...
<a id="section-5-8-2"></a> **`5.8.2. Switching from Passive Stateful to Active Stateful`**
...
<a id="section-5-8-3"></a> **`5.8.3. Active Stateful PCE LSP Update`**
...
<a id="section-5-9"></a> **`5.9. LSP Protection`**
...
<a id="section-5-10"></a> **`5.10. PCEP Sessions`**
...
```text
   ...
   Where:
      ...
      Section 7.9 of [RFC5440].
       ...
       consists of the actual computed and
...
<a id="section-6-3"></a> **`6.3. The PCErr Message`**
...
<a id="section-6-4"></a> **`6.4. The PCReq Message`**
...
<a id="section-6-5"></a> **`6.5. The PCRep Message`**
...
<a id="section-7-1"></a> **`7.1. OPEN Object`**
...
<a id="section-7-1-1"></a> **`7.1.1. STATEFUL-PCE-CAPABILITY TLV`**
...
<a id="section-7-2"></a> **`7.2. SRP Object`**
...
<a id="section-7-3"></a> **`7.3. LSP Object`**
...
<a id="section-7-3-1"></a> **`7.3.1. LSP-IDENTIFIERS TLVs`**
...
<a id="section-7-3-2"></a> **`7.3.2. Symbolic Path Name TLV`**
...
<a id="section-7-3-3"></a> **`7.3.3. LSP Error Code TLV`**
...
<a id="section-7-3-4"></a> **`7.3.4. RSVP Error Spec TLV`**
...
<a id="section-8-1"></a> **`8.1. PCE Capabilities in IGP Advertisements`**
...
<a id="section-8-2"></a> **`8.2. PCEP Messages`**
...
<a id="section-8-3"></a> **`8.3. PCEP Objects`**
...
<a id="section-8-4"></a> **`8.4. LSP Object`**
...
<a id="section-8-5"></a> **`8.5. PCEP-Error Object`**
...
<a id="section-8-6"></a> **`8.6. Notification Object`**
...
<a id="section-8-7"></a> **`8.7. PCEP TLV Type Indicators`**
...
<a id="section-8-8"></a> **`8.8. STATEFUL-PCE-CAPABILITY TLV`**
...
<a id="section-8-9"></a> **`8.9. LSP-ERROR-CODE TLV`**
...
<a id="section-9"></a> **`9. Manageability Considerations`**
...
<a id="section-9-1"></a> **`9.1. Control Function and Policy`**
...
<a id="section-9-2"></a> **`9.2. Information and Data Models`**
...
<a id="section-9-3"></a> **`9.3. Liveness Detection and Monitoring`**
...
<a id="section-9-4"></a> **`9.4. Verifying Correct Operation`**
...
<a id="section-9-5"></a> **`9.5. Requirements on Other Protocols and Functional Components`**
...
<a id="section-9-6"></a> **`9.6. Impact on Network Operation`**
...
<a id="section-10-2"></a> **`10.2. LSP State Snooping`**
...
<a id="section-10-3"></a> **`10.3. Malicious PCE`**
...
<a id="section-10-4"></a> **`10.4. Malicious PCC`**
