...
`   `[`2`](#section-2)`. BFD on LAG Member Links`

`     `[`2.1`](#section-2-1)`. Micro-BFD Session Address Family`

`     `[`2.2`](#section-2-2)`. Micro-BFD Session Negotiation`

`     `[`2.3`](#section-2-3)`. Micro-BFD Session Ethernet Details`

`   `[`3`](#section-3)`. Interaction between LAG and BFD`

`   `[`4`](#section-4)`. BFD on LAG Member Links and L3 Applications`

`   `[`5`](#section-5)`. Detecting a Member Link Failure`
...
<a id="section-2"></a> **`2. BFD on LAG Member Links`**
...
<a id="section-2-1"></a> **`2.1. Micro-BFD Session Address Family`**
...
<a id="section-2-2"></a> **`2.2. Micro-BFD Session Negotiation`**
...
<a id="section-2-3"></a> **`2.3. Micro-BFD Session Ethernet Details`**
...
<a id="section-3"></a> **`3. Interaction between LAG and BFD`**
...
<a id="section-4"></a> **`4. BFD on LAG Member Links and L3 Applications`**
...
<a id="section-5"></a> **`5. Detecting a Member Link Failure`**
