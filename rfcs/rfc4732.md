...
`   `[`2`](#section-2)`. An Overview of Denial-of-Service Threats`

`      `[`2.1`](#section-2-1)`. DoS Attacks on End-Systems`

`           `[`2.1.1`](#section-2-1-1)`. Exploiting Poor Software Quality`

`           `[`2.1.2`](#section-2-1-2)`. Application Resource Exhaustion`

`           `[`2.1.3`](#section-2-1-3)`. Operating System Resource Exhaustion`

`           `[`2.1.4`](#section-2-1-4)`. Triggered Lockouts and Quota Exhaustion`

`      `[`2.2`](#section-2-2)`. DoS Attacks on Routers`

`           `[`2.2.1`](#section-2-2-1)`. Attacks on Routers through Routing Protocols`

`           `[`2.2.2`](#section-2-2-2)`. IP Multicast-based DoS Attacks`

`           `[`2.2.3`](#section-2-2-3)`. Attacks on Router Forwarding Engines`

`      `[`2.3`](#section-2-3)`. Attacks on Ongoing Communications`

`      `[`2.4`](#section-2-4)`. Attacks Using the Victim's Own Resources`

`      `[`2.5`](#section-2-5)`. DoS Attacks on Local Hosts or Infrastructure`

`      `[`2.6`](#section-2-6)`. DoS Attacks on Sites through DNS`

`      `[`2.7`](#section-2-7)`. DoS Attacks on Links`

`      `[`2.8`](#section-2-8)`. DoS Attacks on Firewalls`

`      `[`2.9`](#section-2-9)`. DoS Attacks on IDS Systems`

`      `[`2.10`](#section-2-10)`. DoS Attacks on or via NTP`

`      `[`2.11`](#section-2-11)`. Physical DoS`

`      `[`2.12`](#section-2-12)`. Social Engineering DoS`

`      `[`2.13`](#section-2-13)`. Legal DoS`

`      `[`2.14`](#section-2-14)`. Spam and Black-Hole Lists`

`   `[`3`](#section-3)`. Attack Amplifiers`

`      `[`3.1`](#section-3-1)`. Methods of Attack Amplification`

`      `[`3.2`](#section-3-2)`. Strategies to Mitigate Attack Amplification`

`   `[`4`](#section-4)`. DoS Mitigation Strategies`

`      `[`4.1`](#section-4-1)`. Protocol Design`

`           `[`4.1.1`](#section-4-1-1)`. Don't Hold State for Unverified Hosts`

`           `[`4.1.2`](#section-4-1-2)`. Make It Hard to Simulate a Legitimate User`

`           `[`4.1.3`](#section-4-1-3)`. Graceful Routing Degradation`

`           `[`4.1.4`](#section-4-1-4)`. Autoconfiguration and Authentication`

`      `[`4.2`](#section-4-2)`. Network Design and Configuration`

`           `[`4.2.1`](#section-4-2-1)`. Redundancy and Distributed Service`

`           `[`4.2.2`](#section-4-2-2)`. Authenticate Routing Adjacencies`

`           `[`4.2.3`](#section-4-2-3)`. Isolate Router-to-Router Traffic`

`      `[`4.3`](#section-4-3)`. Router Implementation Issues`

`           `[`4.3.1`](#section-4-3-1)`. Checking Protocol Syntax and Semantics`

`           `[`4.3.2`](#section-4-3-2)`. Consistency Checks`

`           `[`4.3.3`](#section-4-3-3)`. Enhance Router Robustness through`

`                  Operational Adjustments`

`           `[`4.3.4`](#section-4-3-4)`. Proper Handling of Router Resource Exhaustion`

`      `[`4.4`](#section-4-4)`. End-System Implementation Issues`

`           `[`4.4.1`](#section-4-4-1)`. State Lookup Complexity`

`           `[`4.4.2`](#section-4-4-2)`. Operational Issues`
...
<a id="section-2"></a> **`2. An Overview of Denial-of-Service Threats`**
...
<a id="section-2-1"></a> **`2.1. DoS Attacks on End-Systems`**
...
<a id="section-2-1-1"></a> **`2.1.1. Exploiting Poor Software Quality`**
...
<a id="section-2-1-2"></a> **`2.1.2. Application Resource Exhaustion`**
...
<a id="section-2-1-3"></a> **`2.1.3. Operating System Resource Exhaustion`**
...
<a id="section-2-1-4"></a> **`2.1.4. Triggered Lockouts and Quota Exhaustion`**
...
<a id="section-2-2"></a> **`2.2. DoS Attacks on Routers`**
...
<a id="section-2-2-1"></a> **`2.2.1. Attacks on Routers through Routing Protocols`**
...
<a id="section-2-2-2"></a> **`2.2.2. IP Multicast-based DoS Attacks`**
...
<a id="section-2-2-3"></a> **`2.2.3. Attacks on Router Forwarding Engines`**
...
<a id="section-2-3"></a> **`2.3. Attacks on Ongoing Communications`**
...
<a id="section-2-4"></a> **`2.4. Attacks Using the Victim's Own Resources`**
...
<a id="section-2-5"></a> **`2.5. DoS Attacks on Local Hosts or Infrastructure`**
...
<a id="section-2-6"></a> **`2.6. DoS Attacks on Sites through DNS`**
...
<a id="section-2-7"></a> **`2.7. DoS Attacks on Links`**
...
<a id="section-2-8"></a> **`2.8. DoS Attacks on Firewalls`**
...
<a id="section-2-9"></a> **`2.9. DoS Attacks on IDS Systems`**
...
<a id="section-2-10"></a> **`2.10. DoS Attacks on or via NTP`**
...
<a id="section-2-11"></a> **`2.11. Physical DoS`**
...
<a id="section-2-12"></a> **`2.12. Social Engineering DoS`**
...
<a id="section-2-13"></a> **`2.13. Legal DoS`**
...
<a id="section-2-14"></a> **`2.14. Spam and Black-Hole Lists`**
...
<a id="section-3"></a> **`3. Attack Amplifiers`**
...
<a id="section-3-1"></a> **`3.1. Methods of Attack Amplification`**
...
<a id="section-3-2"></a> **`3.2. Strategies to Mitigate Attack Amplification`**
...
<a id="section-4"></a> **`4. DoS Mitigation Strategies`**
...
<a id="section-4-1"></a> **`4.1. Protocol Design`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Don't Hold State for Unverified Hosts`**
...
<a id="section-4-1-2"></a> **`4.1.2. Make It Hard to Simulate a Legitimate User`**
...
<a id="section-4-1-3"></a> **`4.1.3. Graceful Routing Degradation`**
...
<a id="section-4-1-4"></a> **`4.1.4. Autoconfiguration and Authentication`**
...
<a id="section-4-2"></a> **`4.2. Network Design and Configuration`**
...
<a id="section-4-2-1"></a> **`4.2.1. Redundancy and Distributed Service`**
...
<a id="section-4-2-2"></a> **`4.2.2. Authenticate Routing Adjacencies`**
...
<a id="section-4-2-3"></a> **`4.2.3. Isolate Router-to-Router Traffic`**
...
<a id="section-4-3"></a> **`4.3. Router Implementation Issues`**
...
<a id="section-4-3-1"></a> **`4.3.1. Checking Protocol Syntax and Semantics`**
...
<a id="section-4-3-2"></a> **`4.3.2. Consistency Checks`**
...
<a id="section-4-3-3"></a> **`4.3.3. Enhance Router Robustness through Operational Adjustments`**
...
<a id="section-4-3-4"></a> **`4.3.4. Proper Handling of Router Resource Exhaustion`**
...
<a id="section-4-4"></a> **`4.4. End-System Implementation Issues`**

```text

```

<a id="section-4-4-1"></a> **`4.4.1. State Lookup Complexity`**
...
<a id="section-4-4-1-1"></a> **`4.4.1.1. Avoid Livelock`**
...
<a id="section-4-4-1-2"></a> **`4.4.1.2. Use Unpredictable Values for Session IDs`**
...
<a id="section-4-4-2"></a> **`4.4.2. Operational Issues`**

```text

```

<a id="section-4-4-2-1"></a> **`4.4.2.1. Eliminate Bad Traffic Early`**
...
<a id="section-4-4-2-2"></a> **`4.4.2.2. Establish a Monitoring Framework`**
...
<a id="section-5"></a> **`5. Conclusions`**
