...
`   `[`2`](#section-2)`. MPLS Encapsulation Using an SFF Label`

`      `[`2.1`](#section-2-1)`. MPLS Label Stack Construction at the Sending Node`

`      `[`2.2`](#section-2-2)`. SFF Label Processing at the Destination Node`

`   `[`3`](#section-3)`. Equal-Cost Multipath (ECMP) Considerations`

`   `[`4`](#section-4)`. Operations, Administration, and Maintenance (OAM)`
...
<a id="section-2"></a> **`2. MPLS Encapsulation Using an SFF Label`**
...
<a id="section-2-1"></a> **`2.1. MPLS Label Stack Construction at the Sending Node`**
...
<a id="section-2-2"></a> **`2.2. SFF Label Processing at the Destination Node`**
...
<a id="section-3"></a> **`3. Equal-Cost Multipath (ECMP) Considerations`**
...
<a id="section-4"></a> **`4. Operations, Administration, and Maintenance (OAM) Considerations`**
