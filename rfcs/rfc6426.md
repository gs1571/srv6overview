...
`     `[`1.2`](#section-1-2)`. On-Demand CV for MPLS-TP LSPs Using IP Encapsulation`

`     `[`1.3`](#section-1-3)`. On-Demand CV for MPLS-TP LSPs Using Non-IP`

`           Encapsulation`

`   `[`2`](#section-2)`. LSP Ping Extensions`

`     `[`2.1`](#section-2-1)`. New Address Type for Downstream Mapping TLV`

`       `[`2.1.1`](#section-2-1-1)`. DSMAP/DDMAP Non-IP Address Information`

`     `[`2.2`](#section-2-2)`. Source/Destination Identifier TLV`

`       `[`2.2.1`](#section-2-2-1)`. Source/Destination Identifier TLV Format`

`       `[`2.2.2`](#section-2-2-2)`. Source Identifier TLV`

`       `[`2.2.3`](#section-2-2-3)`. Destination Identifier TLV`

`     `[`2.3`](#section-2-3)`. Identifying Statically Provisioned LSPs and PWs`

`       `[`2.3.1`](#section-2-3-1)`. Static LSP Sub-TLV`

`       `[`2.3.2`](#section-2-3-2)`. Static Pseudowire Sub-TLV`

`   `[`3`](#section-3)`. Performing On-Demand CV over MPLS-TP LSPs`

`     `[`3.1`](#section-3-1)`. LSP Ping with IP Encapsulation`

`     `[`3.2`](#section-3-2)`. On-Demand CV with IP Encapsulation, over ACH`

`     `[`3.3`](#section-3-3)`. Non-IP-Based On-Demand CV, Using ACH`

`     `[`3.4`](#section-3-4)`. Reverse-Path Connectivity Verification`

`       `[`3.4.1`](#section-3-4-1)`. Requesting Reverse-Path Connectivity Verification  .`

`       `[`3.4.2`](#section-3-4-2)`. Responder Procedures`

`       `[`3.4.3`](#section-3-4-3)`. Requester Procedures`

`     `[`3.5`](#section-3-5)`. P2MP Considerations`

`     `[`3.6`](#section-3-6)`. Management Considerations for Operation with Static`

`           MPLS-TP`

`     `[`3.7`](#section-3-7)`. Generic Associated Channel Label (GAL) Processing`

`   `[`4`](#section-4)`. Performing On-Demand Route Tracing over MPLS-TP LSPs`

`     `[`4.1`](#section-4-1)`. On-Demand LSP Route Tracing with IP Encapsulation`

`     `[`4.2`](#section-4-2)`. Non-IP-Based On-Demand LSP Route Tracing, Using ACH`

`       `[`4.2.1`](#section-4-2-1)`. Requester Procedure for Sending Echo Request`

`               Packets`

`       `[`4.2.2`](#section-4-2-2)`. Requester Procedure for Receiving Echo Response`

`               Packets`

`       `[`4.2.3`](#section-4-2-3)`. Responder Procedure`

`     `[`4.3`](#section-4-3)`. P2MP Considerations`

`     `[`4.4`](#section-4-4)`. ECMP Considerations`
...
`     `[`7.1`](#section-7-1)`. New Source and Destination Identifier TLVs`

`     `[`7.2`](#section-7-2)`. New Target FEC Stack Sub-TLVs`

`     `[`7.3`](#section-7-3)`. New Reverse-Path Target FEC Stack TLV`

`     `[`7.4`](#section-7-4)`. New Pseudowire Associated Channel Type`

`     `[`7.5`](#section-7-5)`. New Downstream Mapping Address Type Registry`

`   `[`8`](#section-8)`. Contributing Authors and Acknowledgements`
...
<a id="section-1-2"></a> **`1.2. On-Demand CV for MPLS-TP LSPs Using IP Encapsulation`**
...
<a id="section-1-3"></a> **`1.3. On-Demand CV for MPLS-TP LSPs Using Non-IP Encapsulation`**
...
<a id="section-2"></a> **`2. LSP Ping Extensions`**

```text

```

<a id="section-2-1"></a> **`2.1. New Address Type for Downstream Mapping TLV`**
...
<a id="section-2-1-1"></a> **`2.1.1. DSMAP/DDMAP Non-IP Address Information`**
...
<a id="section-2-2"></a> **`2.2. Source/Destination Identifier TLV`**

```text

```

<a id="section-2-2-1"></a> **`2.2.1. Source/Destination Identifier TLV Format`**
...
<a id="section-2-2-2"></a> **`2.2.2. Source Identifier TLV`**
...
<a id="section-2-2-3"></a> **`2.2.3. Destination Identifier TLV`**
...
<a id="section-2-3"></a> **`2.3. Identifying Statically Provisioned LSPs and PWs`**
...
<a id="section-2-3-1"></a> **`2.3.1. Static LSP Sub-TLV`**
...
<a id="section-2-3-2"></a> **`2.3.2. Static Pseudowire Sub-TLV`**
...
<a id="section-3"></a> **`3. Performing On-Demand CV over MPLS-TP LSPs`**
...
<a id="section-3-1"></a> **`3.1. LSP Ping with IP Encapsulation`**
...
<a id="section-3-2"></a> **`3.2. On-Demand CV with IP Encapsulation, over ACH`**
...
<a id="section-3-3"></a> **`3.3. Non-IP-Based On-Demand CV, Using ACH`**
...
<a id="section-3-4"></a> **`3.4. Reverse-Path Connectivity Verification`**

```text

```

<a id="section-3-4-1"></a> **`3.4.1. Requesting Reverse-Path Connectivity Verification`**
...
<a id="section-3-4-2"></a> **`3.4.2. Responder Procedures`**
...
<a id="section-3-4-3"></a> **`3.4.3. Requester Procedures`**
...
<a id="section-3-5"></a> **`3.5. P2MP Considerations`**
...
<a id="section-3-6"></a> **`3.6. Management Considerations for Operation with Static MPLS-TP`**
...
<a id="section-3-7"></a> **`3.7. Generic Associated Channel Label (GAL) Processing`**
...
<a id="section-4"></a> **`4. Performing On-Demand Route Tracing over MPLS-TP LSPs`**
...
<a id="section-4-1"></a> **`4.1. On-Demand LSP Route Tracing with IP Encapsulation`**
...
<a id="section-4-2"></a> **`4.2. Non-IP-Based On-Demand LSP Route Tracing, Using ACH`**
...
<a id="section-4-2-1"></a> **`4.2.1. Requester Procedure for Sending Echo Request Packets`**
...
<a id="section-4-2-2"></a> **`4.2.2. Requester Procedure for Receiving Echo Response Packets`**
...
<a id="section-4-2-3"></a> **`4.2.3. Responder Procedure`**
...
<a id="section-4-3"></a> **`4.3. P2MP Considerations`**
...
<a id="section-4-4"></a> **`4.4. ECMP Considerations`**
...
<a id="section-5"></a> **`5. Applicability`**
...
<a id="section-7-1"></a> **`7.1. New Source and Destination Identifier TLVs`**
...
<a id="section-7-2"></a> **`7.2. New Target FEC Stack Sub-TLVs`**
...
<a id="section-7-3"></a> **`7.3. New Reverse-Path Target FEC Stack TLV`**
...
<a id="section-7-4"></a> **`7.4. New Pseudowire Associated Channel Type`**
...
<a id="section-7-5"></a> **`7.5. New Downstream Mapping Address Type Registry`**
...
<a id="section-8"></a> **`8. Contributing Authors and Acknowledgements`**
