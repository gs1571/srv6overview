...
`     `[`1.1`](#section-1-1)`. Context and Background`

`     `[`1.2`](#section-1-2)`. Terminology`

`     `[`1.3`](#section-1-3)`. Discussion List`

`   `[`2`](#section-2)`. Encodings that Represent Unicode Code Points: Code`

`       Position versus UTF-8 or UTF-16 Octets`

`   `[`3`](#section-3)`. Referring to Unicode Characters`

`   `[`4`](#section-4)`. Syntax for Code Point Escapes`

`   `[`5`](#section-5)`. Recommended Presentation Variants for Unicode Code Point`

`       Escapes`

`     `[`5.1`](#section-5-1)`. Backslash-U with Delimiters`

`     `[`5.2`](#section-5-2)`. XML and HTML`

`   `[`6`](#section-6)`. Forms that Are Normally Not Recommended`

`     `[`6.1`](#section-6-1)`. The C Programming Language: Backslash-U`

`     `[`6.2`](#section-6-2)`. Perl: A Hexadecimal String`

`     `[`6.3`](#section-6-3)`. Java: Escaped UTF-16`
...
<a id="section-1-1"></a> **`1.1. Context and Background`**
...
<a id="section-1-3"></a> **`1.3. Discussion List`**
...
<a id="section-2"></a> **`2. Encodings that Represent Unicode Code Points: Code Position versus`**
...
<a id="section-3"></a> **`3. Referring to Unicode Characters`**
...
<a id="section-4"></a> **`4. Syntax for Code Point Escapes`**
...
<a id="section-5"></a> **`5. Recommended Presentation Variants for Unicode Code Point Escapes`**
...
<a id="section-5-1"></a> **`5.1. Backslash-U with Delimiters`**
...
<a id="section-5-2"></a> **`5.2. XML and HTML`**
...
<a id="section-6"></a> **`6. Forms that Are Normally Not Recommended`**

```text

```

<a id="section-6-1"></a> **`6.1. The C Programming Language: Backslash-U`**
...
<a id="section-6-2"></a> **`6.2. Perl: A Hexadecimal String`**
...
<a id="section-6-3"></a> **`6.3. Java: Escaped UTF-16`**
