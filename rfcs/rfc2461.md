...
`      `[`2.1`](#section-2-1)`. General`

`      `[`2.2`](#section-2-2)`. Link Types`

`      `[`2.3`](#section-2-3)`. Addresses`

`      `[`2.4`](#section-2-4)`. Requirements`

`   `[`3`](#section-3)`. PROTOCOL OVERVIEW`

`      `[`3.1`](#section-3-1)`. Comparison with IPv4`

`      `[`3.2`](#section-3-2)`. Supported Link Types`

`   `[`4`](#section-4)`. MESSAGE FORMATS`

`      `[`4.1`](#section-4-1)`. Router Solicitation Message Format`

`      `[`4.2`](#section-4-2)`. Router Advertisement Message Format`

`      `[`4.3`](#section-4-3)`. Neighbor Solicitation Message Format`

`      `[`4.4`](#section-4-4)`. Neighbor Advertisement Message Format`

`      `[`4.5`](#section-4-5)`. Redirect Message Format`

`      `[`4.6`](#section-4-6)`. Option Formats`

`         `[`4.6.1`](#section-4-6-1)`. Source/Target Link-layer Address`

`         `[`4.6.2`](#section-4-6-2)`. Prefix Information`

`         `[`4.6.3`](#section-4-6-3)`. Redirected Header`

`         `[`4.6.4`](#section-4-6-4)`. MTU`

`   `[`5`](#section-5)`. CONCEPTUAL MODEL OF A HOST`

`      `[`5.1`](#section-5-1)`. Conceptual Data Structures`

`      `[`5.2`](#section-5-2)`. Conceptual Sending Algorithm`

`      `[`5.3`](#section-5-3)`. Garbage Collection and Timeout Requirements`

`   `[`6`](#section-6)`. ROUTER AND PREFIX DISCOVERY`

`      `[`6.1`](#section-6-1)`. Message Validation`

`         `[`6.1.1`](#section-6-1-1)`. Validation of Router Solicitation Messages`

`         `[`6.1.2`](#section-6-1-2)`. Validation of Router Advertisement Messages`

`      `[`6.2`](#section-6-2)`. Router Specification`

`         `[`6.2.1`](#section-6-2-1)`. Router Configuration Variables`

`         `[`6.2.2`](#section-6-2-2)`. Becoming An Advertising Interface`

`         `[`6.2.3`](#section-6-2-3)`. Router Advertisement Message Content`

`         `[`6.2.4`](#section-6-2-4)`. Sending Unsolicited Router Advertisements`

`         `[`6.2.5`](#section-6-2-5)`. Ceasing To Be An Advertising Interface`

`         `[`6.2.6`](#section-6-2-6)`. Processing Router Solicitations`

`         `[`6.2.7`](#section-6-2-7)`. Router Advertisement Consistency`

`         `[`6.2.8`](#section-6-2-8)`. Link-local Address Change`

`      `[`6.3`](#section-6-3)`. Host Specification`

`         `[`6.3.1`](#section-6-3-1)`. Host Configuration Variables`

`         `[`6.3.2`](#section-6-3-2)`. Host Variables`

`         `[`6.3.3`](#section-6-3-3)`. Interface Initialization`

`         `[`6.3.4`](#section-6-3-4)`. Processing Received Router Advertisements`

`         `[`6.3.5`](#section-6-3-5)`. Timing out Prefixes and Default Routers`

`         `[`6.3.6`](#section-6-3-6)`. Default Router Selection`

`         `[`6.3.7`](#section-6-3-7)`. Sending Router Solicitations`

`   `[`7`](#section-7)`. ADDRESS RESOLUTION AND NEIGHBOR UNREACHABILITY DETECTION`

`      `[`7.1`](#section-7-1)`. Message Validation`

`         `[`7.1.1`](#section-7-1-1)`. Validation of Neighbor Solicitations`

`         `[`7.1.2`](#section-7-1-2)`. Validation of Neighbor Advertisements`

`      `[`7.2`](#section-7-2)`. Address Resolution`

`         `[`7.2.1`](#section-7-2-1)`. Interface Initialization`

`         `[`7.2.2`](#section-7-2-2)`. Sending Neighbor Solicitations`

`         `[`7.2.3`](#section-7-2-3)`. Receipt of Neighbor Solicitations`

`         `[`7.2.4`](#section-7-2-4)`. Sending Solicited Neighbor Advertisements`

`         `[`7.2.5`](#section-7-2-5)`. Receipt of Neighbor Advertisements`

`         `[`7.2.6`](#section-7-2-6)`. Sending Unsolicited Neighbor Advertisements`

`         `[`7.2.7`](#section-7-2-7)`. Anycast Neighbor Advertisements`

`         `[`7.2.8`](#section-7-2-8)`. Proxy Neighbor Advertisements`

`      `[`7.3`](#section-7-3)`. Neighbor Unreachability Detection`

`         `[`7.3.1`](#section-7-3-1)`. Reachability Confirmation`

`         `[`7.3.2`](#section-7-3-2)`. Neighbor Cache Entry States`

`         `[`7.3.3`](#section-7-3-3)`. Node Behavior`

`   `[`8`](#section-8)`. REDIRECT FUNCTION`

`      `[`8.1`](#section-8-1)`. Validation of Redirect Messages`

`      `[`8.2`](#section-8-2)`. Router Specification`

`      `[`8.3`](#section-8-3)`. Host Specification`

`   `[`9`](#section-9)`. EXTENSIBILITY - OPTION PROCESSING`

`   `[`10`](#section-10)`. PROTOCOL CONSTANTS`

`   `[`11`](#section-11)`. SECURITY CONSIDERATIONS`

`   `[`12`](#section-12)`. RENUMBERING CONSIDERATIONS`
...
<a id="section-2-1"></a> **`2.1. General`**
...
<a id="section-2-2"></a> **`2.2. Link Types`**
...
<a id="section-2-3"></a> **`2.3. Addresses`**
...
<a id="section-2-4"></a> **`2.4. Requirements`**
...
<a id="section-3-1"></a> **`3.1. Comparison with IPv4`**
...
<a id="section-3-2"></a> **`3.2. Supported Link Types`**
...
<a id="section-4"></a> **`4. MESSAGE FORMATS`**

```text

```

<a id="section-4-1"></a> **`4.1. Router Solicitation Message Format`**
...
<a id="section-4-2"></a> **`4.2. Router Advertisement Message Format`**
...
<a id="section-4-3"></a> **`4.3. Neighbor Solicitation Message Format`**
...
<a id="section-4-4"></a> **`4.4. Neighbor Advertisement Message Format`**
...
<a id="section-4-5"></a> **`4.5. Redirect Message Format`**
...
<a id="section-4-6"></a> **`4.6. Option Formats`**
...
<a id="section-4-6-1"></a> **`4.6.1. Source/Target Link-layer Address`**
...
<a id="section-4-6-2"></a> **`4.6.2. Prefix Information`**
...
<a id="section-4-6-3"></a> **`4.6.3. Redirected Header`**
...
<a id="section-4-6-4"></a> **`4.6.4. MTU`**
...
<a id="section-5"></a> **`5. CONCEPTUAL MODEL OF A HOST`**
...
<a id="section-5-1"></a> **`5.1. Conceptual Data Structures`**
...
<a id="section-5-2"></a> **`5.2. Conceptual Sending Algorithm`**
...
<a id="section-5-3"></a> **`5.3. Garbage Collection and Timeout Requirements`**
...
<a id="section-6"></a> **`6. ROUTER AND PREFIX DISCOVERY`**
...
<a id="section-6-1"></a> **`6.1. Message Validation`**

```text

```

<a id="section-6-1-1"></a> **`6.1.1. Validation of Router Solicitation Messages`**
...
<a id="section-6-1-2"></a> **`6.1.2. Validation of Router Advertisement Messages`**
...
<a id="section-6-2"></a> **`6.2. Router Specification`**

```text

```

<a id="section-6-2-1"></a> **`6.2.1. Router Configuration Variables`**
...
<a id="section-6-2-2"></a> **`6.2.2. Becoming An Advertising Interface`**
...
<a id="section-6-2-3"></a> **`6.2.3. Router Advertisement Message Content`**
...
<a id="section-6-2-4"></a> **`6.2.4. Sending Unsolicited Router Advertisements`**
...
<a id="section-6-2-5"></a> **`6.2.5. Ceasing To Be An Advertising Interface`**
...
<a id="section-6-2-6"></a> **`6.2.6. Processing Router Solicitations`**
...
<a id="section-6-2-7"></a> **`6.2.7. Router Advertisement Consistency`**
...
<a id="section-6-2-8"></a> **`6.2.8. Link-local Address Change`**
...
<a id="section-6-3"></a> **`6.3. Host Specification`**

```text

```

<a id="section-6-3-1"></a> **`6.3.1. Host Configuration Variables`**
...
<a id="section-6-3-2"></a> **`6.3.2. Host Variables`**
...
<a id="section-6-3-3"></a> **`6.3.3. Interface Initialization`**
...
<a id="section-6-3-4"></a> **`6.3.4. Processing Received Router Advertisements`**
...
<a id="section-6-3-5"></a> **`6.3.5. Timing out Prefixes and Default Routers`**
...
<a id="section-6-3-6"></a> **`6.3.6. Default Router Selection`**
...
<a id="section-6-3-7"></a> **`6.3.7. Sending Router Solicitations`**
...
<a id="section-7"></a> **`7. ADDRESS RESOLUTION AND NEIGHBOR UNREACHABILITY DETECTION`**
...
<a id="section-7-1"></a> **`7.1. Message Validation`**

```text

```

<a id="section-7-1-1"></a> **`7.1.1. Validation of Neighbor Solicitations`**
...
<a id="section-7-1-2"></a> **`7.1.2. Validation of Neighbor Advertisements`**
...
<a id="section-7-2"></a> **`7.2. Address Resolution`**
...
<a id="section-7-2-1"></a> **`7.2.1. Interface Initialization`**
...
<a id="section-7-2-2"></a> **`7.2.2. Sending Neighbor Solicitations`**
...
<a id="section-7-2-3"></a> **`7.2.3. Receipt of Neighbor Solicitations`**
...
<a id="section-7-2-4"></a> **`7.2.4. Sending Solicited Neighbor Advertisements`**
...
<a id="section-7-2-5"></a> **`7.2.5. Receipt of Neighbor Advertisements`**
...
<a id="section-7-2-6"></a> **`7.2.6. Sending Unsolicited Neighbor Advertisements`**
...
<a id="section-7-2-7"></a> **`7.2.7. Anycast Neighbor Advertisements`**
...
<a id="section-7-2-8"></a> **`7.2.8. Proxy Neighbor Advertisements`**
...
<a id="section-7-3"></a> **`7.3. Neighbor Unreachability Detection`**
...
<a id="section-7-3-1"></a> **`7.3.1. Reachability Confirmation`**
...
<a id="section-7-3-2"></a> **`7.3.2. Neighbor Cache Entry States`**
...
<a id="section-7-3-3"></a> **`7.3.3. Node Behavior`**
...
<a id="section-8"></a> **`8. REDIRECT FUNCTION`**
...
<a id="section-8-1"></a> **`8.1. Validation of Redirect Messages`**
...
<a id="section-8-2"></a> **`8.2. Router Specification`**
...
<a id="section-8-3"></a> **`8.3. Host Specification`**
...
<a id="section-9"></a> **`9. EXTENSIBILITY - OPTION PROCESSING`**
...
<a id="section-10"></a> **`10. PROTOCOL CONSTANTS`**
...
<a id="section-12"></a> **`12. RENUMBERING CONSIDERATIONS`**
