...
`   `[`1`](#section-1)`. Problem, Goal, and Motivation`

`   `[`2`](#section-2)`. CIDR address allocation`

`   `[`2.1`](#section-2-1)`. Aggregation and its limitations`

`   `[`2.2`](#section-2-2)`. Distributed network number allocation`

`   `[`3`](#section-3)`. Cost-benefit analysis`

`   `[`3.1`](#section-3-1)`. Present allocation figures`

`   `[`3.2`](#section-3-2)`. Historic growth rates`

`   `[`3.3`](#section-3-3)`. Detailed analysis`

`   `[`3.3.1`](#section-3-3-1)`. Benefits of new addressing plan`

`   `[`3.3.2`](#section-3-3-2)`. Growth rate projections`

`   `[`4`](#section-4)`. Changes to inter-domain routing protocols and practices`

`   `[`4.1`](#section-4-1)`. Protocol-independent semantic changes`

`   `[`4.2`](#section-4-2)`. Rules for route advertisement`

`   `[`4.3`](#section-4-3)`. How the rules work`

`   `[`4.4`](#section-4-4)`. Responsibility for and configuration of aggregation`

`   `[`4.5`](#section-4-5)`. Intra-domain protocol considerations`

`   `[`5`](#section-5)`. Example of new allocation and routing`

`   `[`5.1`](#section-5-1)`. Address allocation`

`   `[`5.2`](#section-5-2)`. Routing advertisements`

`   `[`6`](#section-6)`. Extending CIDR to class A addresses`

`   `[`7`](#section-7)`. Domain Naming Service considerations`

`   `[`7`](#section-7)`. 1 Procedural changes for class-C "supernets"`

`   `[`7`](#section-7)`. 2 Procedural changes for class-A subnetting`

`   `[`8`](#section-8)`. Transitioning to a long term solution`
...
<a id="section-1"></a> **`1. Problem, Goal, and Motivation`**
...
<a id="section-2"></a> **`2. CIDR address allocation`**
...
<a id="section-3"></a> **`3. Cost-benefit analysis`**
...
<a id="section-4"></a> **`4. Changes to inter-domain routing protocols and practices`**
...
<a id="section-5"></a> **`5. Example of new allocation and routing`**
...
<a id="section-6"></a> **`6. Extending CIDR to class A addresses`**
...
<a id="section-7"></a> **`7. Domain Service considerations`**
...
<a id="section-8"></a> **`8. Transitioning to a long term solution`**
...
<a id="section-10"></a> **`10. Recommendations`**
