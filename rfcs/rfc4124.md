...
`   `[`4`](#section-4)`. Configurable Parameters`

`      `[`4.1`](#section-4-1)`. Link Parameters`

`           `[`4.1.1`](#section-4-1-1)`. Bandwidth Constraints (BCs)`

`           `[`4.1.2`](#section-4-1-2)`. Overbooking`

`      `[`4.2`](#section-4-2)`. LSR Parameters`

`           `[`4.2.1`](#section-4-2-1)`. TE-Class Mapping`

`      `[`4.3`](#section-4-3)`. LSP Parameters`

`           `[`4.3.1`](#section-4-3-1)`. Class-Type`

`           `[`4.3.2`](#section-4-3-2)`. Setup and Holding Preemption Priorities`

`           `[`4.3.3`](#section-4-3-3)`. Class-Type/Preemption Relationship`

`      `[`4.4`](#section-4-4)`. Examples of Parameters Configuration`

`           `[`4.4.1`](#section-4-4-1)`. Example 1`

`           `[`4.4.2`](#section-4-4-2)`. Example 2`

`           `[`4.4.3`](#section-4-4-3)`. Example 3`

`           `[`4.4.4`](#section-4-4-4)`. Example 4`

`           `[`4.4.5`](#section-4-4-5)`. Example 5`

`   `[`5`](#section-5)`. IGP Extensions for DS-TE`

`      `[`5.1`](#section-5-1)`. Bandwidth Constraints`

`      `[`5.2`](#section-5-2)`. Unreserved Bandwidth`

`   `[`6`](#section-6)`. RSVP-TE Extensions for DS-TE`

`      `[`6.1`](#section-6-1)`. DS-TE-Related RSVP Messages Format`

`           `[`6.1.1`](#section-6-1-1)`. Path Message Format`

`      `[`6.2`](#section-6-2)`. CLASSTYPE Object`

`           `[`6.2.1`](#section-6-2-1)`. CLASSTYPE object`

`      `[`6.3`](#section-6-3)`. Handling CLASSTYPE Object`

`      `[`6.4`](#section-6-4)`. Non-support of the CLASSTYPE Object`

`      `[`6.5`](#section-6-5)`. Error Codes for Diffserv-aware TE`

`   `[`7`](#section-7)`. DS-TE Support with MPLS Extensions`

`      `[`7.1`](#section-7-1)`. DS-TE Support and References to Preemption Priority`

`      `[`7.2`](#section-7-2)`. DS-TE Support and References to Maximum Reservable`

`           Bandwidth`

`   `[`8`](#section-8)`. Constraint-Based Routing`

`   `[`9`](#section-9)`. Diffserv Scheduling`

`   `[`10`](#section-10)`. Existing TE as a Particular Case of DS-TE`

`   `[`11`](#section-11)`. Computing "Unreserved TE-Class [i]" and Admission`

`       Control Rules`

`       `[`11.1`](#section-11-1)`. Computing "Unreserved TE-Class [i]"`

`       `[`11.2`](#section-11-2)`. Admission Control Rules`

`   `[`12`](#section-12)`. Security Considerations`

`   `[`13`](#section-13)`. IANA Considerations`

`       `[`13.1`](#section-13-1)`. A New Name Space for Bandwidth Constraints Model`

`             Identifiers`

`       `[`13.2`](#section-13-2)`. A New Name Space for Error Values under the`

`             "Diffserv-aware TE`

`       `[`13.3`](#section-13-3)`. Assignments Made in This Document`

`             `[`13.3.1`](#section-13-3-1)`. Bandwidth Constraints sub-TLV for`

`                     OSPF Version 2`

`             `[`13.3.2`](#section-13-3-2)`. Bandwidth Constraints sub-TLV for ISIS`

`             `[`13.3.3`](#section-13-3-3)`. CLASSTYPE Object for RSVP`

`             `[`13.3.4`](#section-13-3-4)`. "Diffserv-aware TE Error" Error Code`

`             `[`13.3.5`](#section-13-3-5)`. Error Values for "Diffserv-aware TE Error"`
...
<a id="section-1-1"></a> **`1.1. Specification of Requirements`**
...
<a id="section-4"></a> **`4. Configurable Parameters`**
...
<a id="section-4-1"></a> **`4.1. Link Parameters`**

```text

```

<a id="section-4-1-1"></a> **`4.1.1. Bandwidth Constraints (BCs)`**
...
<a id="section-4-1-2"></a> **`4.1.2. Overbooking`**
...
<a id="section-4-2"></a> **`4.2. LSR Parameters`**

```text

```

<a id="section-4-2-1"></a> **`4.2.1. TE-Class Mapping`**
...
<a id="section-4-3"></a> **`4.3. LSP Parameters`**

```text

```

<a id="section-4-3-1"></a> **`4.3.1. Class-Type`**
...
<a id="section-4-3-2"></a> **`4.3.2. Setup and Holding Preemption Priorities`**
...
<a id="section-4-3-3"></a> **`4.3.3. Class-Type/Preemption Relationship`**
...
<a id="section-4-4"></a> **`4.4. Examples of Parameters Configuration`**
...
<a id="section-4-4-1"></a> **`4.4.1. Example 1`**
...
<a id="section-4-4-2"></a> **`4.4.2. Example 2`**
...
<a id="section-4-4-3"></a> **`4.4.3. Example 3`**
...
<a id="section-4-4-4"></a> **`4.4.4. Example 4`**
...
<a id="section-4-4-5"></a> **`4.4.5. Example 5`**
...
<a id="section-5"></a> **`5. IGP Extensions for DS-TE`**
...
<a id="section-5-1"></a> **`5.1. Bandwidth Constraints`**
...
<a id="section-5-2"></a> **`5.2. Unreserved Bandwidth`**
...
<a id="section-6"></a> **`6. RSVP-TE Extensions for DS-TE`**
...
<a id="section-6-1"></a> **`6.1. DS-TE-Related RSVP Messages Format`**
...
<a id="section-6-1-1"></a> **`6.1.1. Path Message Format`**
...
<a id="section-6-2"></a> **`6.2. CLASSTYPE Object`**
...
<a id="section-6-2-1"></a> **`6.2.1. CLASSTYPE object`**
...
<a id="section-6-3"></a> **`6.3. Handling CLASSTYPE Object`**
...
<a id="section-6-4"></a> **`6.4. Non-support of the CLASSTYPE Object`**
...
<a id="section-6-5"></a> **`6.5. Error Codes for Diffserv-aware TE`**
...
<a id="section-7"></a> **`7. DS-TE Support with MPLS Extensions`**
...
<a id="section-7-1"></a> **`7.1. DS-TE Support and References to Preemption Priority`**
...
<a id="section-7-2"></a> **`7.2. DS-TE Support and References to Maximum Reservable Bandwidth`**
...
<a id="section-8"></a> **`8. Constraint-Based Routing`**
...
<a id="section-9"></a> **`9. Diffserv Scheduling`**
...
<a id="section-10"></a> **`10. Existing TE as a Particular Case of DS-TE`**
...
<a id="section-11"></a> **`11. Computing "Unreserved TE-Class [i]" and Admission Control Rules`**

```text

```

<a id="section-11-1"></a> **`11.1. Computing "Unreserved TE-Class [i]"`**
...
<a id="section-11-2"></a> **`11.2. Admission Control Rules`**
...
<a id="section-13-1"></a> **`13.1. A New Name Space for Bandwidth Constraints Model Identifiers`**
...
<a id="section-13-2"></a> **`13.2. A New Name Space for Error Values under the "Diffserv-aware TE`**
...
<a id="section-13-3"></a> **`13.3. Assignments Made in This Document`**

```text

```

<a id="section-13-3-1"></a> **`13.3.1. Bandwidth Constraints sub-TLV for OSPF Version 2`**
...
<a id="section-13-3-2"></a> **`13.3.2. Bandwidth Constraints sub-TLV for ISIS`**
...
<a id="section-13-3-3"></a> **`13.3.3. CLASSTYPE Object for RSVP`**
...
<a id="section-13-3-4"></a> **`13.3.4. "Diffserv-aware TE Error" Error Code`**
...
<a id="section-13-3-5"></a> **`13.3.5. Error Values for "Diffserv-aware TE Error"`**
