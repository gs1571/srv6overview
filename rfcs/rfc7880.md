...
`   `[`3`](#section-3)`. Seamless BFD Overview`

`   `[`4`](#section-4)`. S-BFD Discriminators`

`      `[`4.1`](#section-4-1)`. S-BFD Discriminator Uniqueness`

`      `[`4.2`](#section-4-2)`. Discriminator Pools`

`   `[`5`](#section-5)`. Reflector BFD Session`

`   `[`6`](#section-6)`. State Variables`

`      `[`6.1`](#section-6-1)`. New State Variables`

`      `[`6.2`](#section-6-2)`. State Variable Initialization and Maintenance`

`   `[`7`](#section-7)`. S-BFD Procedures`

`      `[`7.1`](#section-7-1)`. Demultiplexing of S-BFD Control Packet`

`      `[`7.2`](#section-7-2)`. Responder Procedures`

`           `[`7.2.1`](#section-7-2-1)`. Responder Demultiplexing`

`           `[`7.2.2`](#section-7-2-2)`. Transmission of S-BFD Control Packet by`

`                  SBFDReflector`

`           `[`7.2.3`](#section-7-2-3)`. Additional SBFDReflector Behaviors`

`      `[`7.3`](#section-7-3)`. Initiator Procedures`

`           `[`7.3.1`](#section-7-3-1)`. SBFDInitiator State Machine`

`           `[`7.3.2`](#section-7-3-2)`. Transmission of S-BFD Control Packet by`

`                  SBFDInitiator`

`           `[`7.3.3`](#section-7-3-3)`. Additional SBFDInitiator Behaviors`

`      `[`7.4`](#section-7-4)`. Diagnostic Values`

`      `[`7.5`](#section-7-5)`. The Poll Sequence`

`   `[`8`](#section-8)`. Operational Considerations`

`      `[`8.1`](#section-8-1)`. Scaling Aspect`

`      `[`8.2`](#section-8-2)`. Congestion Considerations`

`   `[`9`](#section-9)`. Co-existence with Classical BFD Sessions`

`   `[`10`](#section-10)`. S-BFD Echo Function`
...
<a id="section-3"></a> **`3. Seamless BFD Overview`**
...
<a id="section-4"></a> **`4. S-BFD Discriminators`**

```text

```

<a id="section-4-1"></a> **`4.1. S-BFD Discriminator Uniqueness`**
...
<a id="section-4-2"></a> **`4.2. Discriminator Pools`**
...
<a id="section-5"></a> **`5. Reflector BFD Session`**
...
<a id="section-6"></a> **`6. State Variables`**
...
<a id="section-6-1"></a> **`6.1. New State Variables`**
...
<a id="section-6-2"></a> **`6.2. State Variable Initialization and Maintenance`**
...
<a id="section-7"></a> **`7. S-BFD Procedures`**

```text

```

<a id="section-7-1"></a> **`7.1. Demultiplexing of S-BFD Control Packet`**
...
<a id="section-7-2"></a> **`7.2. Responder Procedures`**
...
<a id="section-7-2-1"></a> **`7.2.1. Responder Demultiplexing`**
...
<a id="section-7-2-2"></a> **`7.2.2. Transmission of S-BFD Control Packet by SBFDReflector`**
...
<a id="section-7-2-3"></a> **`7.2.3. Additional SBFDReflector Behaviors`**
...
<a id="section-7-3"></a> **`7.3. Initiator Procedures`**
...
<a id="section-7-3-1"></a> **`7.3.1. SBFDInitiator State Machine`**
...
<a id="section-7-3-2"></a> **`7.3.2. Transmission of S-BFD Control Packet by SBFDInitiator`**
...
<a id="section-7-3-3"></a> **`7.3.3. Additional SBFDInitiator Behaviors`**
...
<a id="section-7-4"></a> **`7.4. Diagnostic Values`**
...
<a id="section-7-5"></a> **`7.5. The Poll Sequence`**
...
<a id="section-8-1"></a> **`8.1. Scaling Aspect`**
...
<a id="section-8-2"></a> **`8.2. Congestion Considerations`**
...
<a id="section-9"></a> **`9. Co-existence with Classical BFD Sessions`**
...
<a id="section-10"></a> **`10. S-BFD Echo Function`**
