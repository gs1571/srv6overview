...
`   `[`2`](#section-2)`. The VPN-IPv6 Address Family`

`   `[`3`](#section-3)`. VPN-IPv6 Route Distribution`

`      `[`3.1`](#section-3-1)`. Route Distribution Among PEs by BGP`

`      `[`3.2`](#section-3-2)`. VPN IPv6 NLRI Encoding`

`           `[`3.2.1`](#section-3-2-1)`. BGP Next Hop encoding`

`                  `[`3.2.1.1`](#section-3-2-1-1)`. BGP Speaker Requesting IPv6 Transport`

`                  `[`3.2.1.2`](#section-3-2-1-2)`. BGP Speaker Requesting IPv4 Transport`

`      `[`3.3`](#section-3-3)`. Route Target`

`      `[`3.4`](#section-3-4)`. BGP Capability Negotiation`

`   `[`4`](#section-4)`. Encapsulation`

`   `[`5`](#section-5)`. Address Types`

`   `[`6`](#section-6)`. Multicast`

`   `[`7`](#section-7)`. Carriers' Carriers`

`   `[`8`](#section-8)`. Multi-AS Backbones`

`   `[`9`](#section-9)`. Accessing the Internet from a VPN`

`   `[`10`](#section-10)`. Management VPN`

`   `[`11`](#section-11)`. Security Considerations`

`   `[`12`](#section-12)`. Quality of Service`
...
<a id="section-2"></a> **`2. The VPN-IPv6 Address Family`**
...
<a id="section-3"></a> **`3. VPN-IPv6 Route Distribution`**

```text

```

<a id="section-3-1"></a> **`3.1. Route Distribution Among PEs by BGP`**
...
<a id="section-3-2"></a> **`3.2. VPN IPv6 NLRI Encoding`**
...
<a id="section-3-2-1"></a> **`3.2.1. BGP Next Hop encoding`**
...
<a id="section-3-2-1-1"></a> **`3.2.1.1. BGP Speaker Requesting IPv6 Transport`**
...
<a id="section-3-2-1-2"></a> **`3.2.1.2. BGP Speaker Requesting IPv4 Transport`**
...
<a id="section-3-3"></a> **`3.3. Route Target`**
...
<a id="section-3-4"></a> **`3.4. BGP Capability Negotiation`**
...
<a id="section-4"></a> **`4. Encapsulation`**
...
<a id="section-5"></a> **`5. Address Types`**
...
<a id="section-7"></a> **`7. Carriers' Carriers`**
...
<a id="section-8"></a> **`8. Multi-AS Backbones`**
...
<a id="section-9"></a> **`9. Accessing the Internet from a VPN`**
...
<a id="section-10"></a> **`10. Management VPN`**
...
<a id="section-12"></a> **`12. Quality of Service`**
