...
`      `[`2.1`](#section-2-1)`. List of Acronyms`

`   `[`3`](#section-3)`. Positioning`

`      `[`3.1`](#section-3-1)`. Data Plane Layers and Control Plane Regions`

`      `[`3.2`](#section-3-2)`. Service Layer Networks`

`      `[`3.3`](#section-3-3)`. Vertical and Horizontal Interaction and Integration`

`      `[`3.4`](#section-3-4)`. Motivation`

`   `[`4`](#section-4)`. Key Concepts of GMPLS-Based MLNs and MRNs`

`      `[`4.1`](#section-4-1)`. Interface Switching Capability`

`      `[`4.2`](#section-4-2)`. Multiple Interface Switching Capabilities`

`           `[`4.2.1`](#section-4-2-1)`. Networks with Multi-Switching-Type-Capable`

`                  Hybrid Nodes`

`      `[`4.3`](#section-4-3)`. Integrated Traffic Engineering (TE) and Resource Control`

`           `[`4.3.1`](#section-4-3-1)`. Triggered Signaling`

`           `[`4.3.2`](#section-4-3-2)`. FA-LSPs`

`           `[`4.3.3`](#section-4-3-3)`. Virtual Network Topology (VNT)`

`   `[`5`](#section-5)`. Requirements`

`      `[`5.1`](#section-5-1)`. Handling Single-Switching and`

`           Multi-Switching-Type-Capable Nodes`

`      `[`5.2`](#section-5-2)`. Advertisement of the Available Adjustment Resources`

`      `[`5.3`](#section-5-3)`. Scalability`

`      `[`5.4`](#section-5-4)`. Stability`

`      `[`5.5`](#section-5-5)`. Disruption Minimization`

`      `[`5.6`](#section-5-6)`. LSP Attribute Inheritance`

`      `[`5.7`](#section-5-7)`. Computing Paths with and without Nested Signaling`

`      `[`5.8`](#section-5-8)`. LSP Resource Utilization`

`           `[`5.8.1`](#section-5-8-1)`. FA-LSP Release and Setup`

`           `[`5.8.2`](#section-5-8-2)`. Virtual TE Links`

`      `[`5.9`](#section-5-9)`. Verification of the LSPs`

`      `[`5.10`](#section-5-10)`. Management`
...
`   `[`9`](#section-9)`. Contributors' Addresses`
...
<a id="section-2-1"></a> **`2.1. List of Acronyms`**
...
<a id="section-3"></a> **`3. Positioning`**
...
<a id="section-3-1"></a> **`3.1. Data Plane Layers and Control Plane Regions`**
...
<a id="section-3-2"></a> **`3.2. Service Layer Networks`**
...
<a id="section-3-3"></a> **`3.3. Vertical and Horizontal Interaction and Integration`**
...
<a id="section-3-4"></a> **`3.4. Motivation`**
...
<a id="section-4"></a> **`4. Key Concepts of GMPLS-Based MLNs and MRNs`**
...
<a id="section-4-1"></a> **`4.1. Interface Switching Capability`**
...
<a id="section-4-2"></a> **`4.2. Multiple Interface Switching Capabilities`**
...
<a id="section-4-2-1"></a> **`4.2.1. Networks with Multi-Switching-Type-Capable Hybrid Nodes`**
...
<a id="section-4-3"></a> **`4.3. Integrated Traffic Engineering (TE) and Resource Control`**
...
<a id="section-4-3-1"></a> **`4.3.1. Triggered Signaling`**
...
<a id="section-4-3-2"></a> **`4.3.2. FA-LSPs`**
...
<a id="section-4-3-3"></a> **`4.3.3. Virtual Network Topology (VNT)`**
...
<a id="section-5"></a> **`5. Requirements`**

```text

```

<a id="section-5-1"></a> **`5.1. Handling Single-Switching and Multi-Switching-Type-Capable Nodes`**
...
<a id="section-5-2"></a> **`5.2. Advertisement of the Available Adjustment Resources`**
...
<a id="section-5-3"></a> **`5.3. Scalability`**
...
<a id="section-5-4"></a> **`5.4. Stability`**
...
<a id="section-5-5"></a> **`5.5. Disruption Minimization`**
...
<a id="section-5-6"></a> **`5.6. LSP Attribute Inheritance`**
...
<a id="section-5-7"></a> **`5.7. Computing Paths with and without Nested Signaling`**
...
<a id="section-5-8"></a> **`5.8. LSP Resource Utilization`**
...
<a id="section-5-8-1"></a> **`5.8.1. FA-LSP Release and Setup`**
...
<a id="section-5-8-2"></a> **`5.8.2. Virtual TE Links`**
...
<a id="section-5-9"></a> **`5.9. Verification of the LSPs`**
...
<a id="section-5-10"></a> **`5.10. Management`**
...
<a id="section-9"></a> **`9. Contributors' Addresses`**
