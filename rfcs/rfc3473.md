...
`   `[`2`](#section-2)`. Label Related Formats`

`    `[`2.1`](#section-2-1)`. Generalized Label Request Object`

`    `[`2.2`](#section-2-2)`. Bandwidth Encoding`

`    `[`2.3`](#section-2-3)`. Generalized Label Object`

`    `[`2.4`](#section-2-4)`. Waveband Switching`

`    `[`2.5`](#section-2-5)`. Suggested Label`

`    `[`2.6`](#section-2-6)`. Label Set`

`   `[`3`](#section-3)`. Bidirectional LSPs`

`    `[`3.1`](#section-3-1)`. Procedures`

`    `[`3.2`](#section-3-2)`. Contention Resolution`

`   `[`4`](#section-4)`. Notification`

`    `[`4.1`](#section-4-1)`. Acceptable Label Set Object`

`    `[`4.2`](#section-4-2)`. Notify Request Objects`

`    `[`4.3`](#section-4-3)`. Notify Message`

`    `[`4.4`](#section-4-4)`. Removing State with a PathErr message`

`   `[`5`](#section-5)`. Explicit Label Control`

`    `[`5.1`](#section-5-1)`. Label ERO subobject`

`    `[`5.2`](#section-5-2)`. Label RRO subobject`

`   `[`6`](#section-6)`. Protection Object`

`    `[`6.1`](#section-6-1)`. Procedures`

`   `[`7`](#section-7)`. Administrative Status Information`

`    `[`7.1`](#section-7-1)`. Admin Status Object`

`    `[`7.2`](#section-7-2)`. Path and Resv Message Procedures`

`    `[`7.3`](#section-7-3)`. Notify Message Procedures`

`   `[`8`](#section-8)`. Control Channel Separation`

`    `[`8.1`](#section-8-1)`. Interface Identification`

`    `[`8.2`](#section-8-2)`. Errored Interface Identification`

`   `[`9`](#section-9)`. Fault Handling`

`    `[`9.1`](#section-9-1)`. Restart_Cap Object`

`    `[`9.2`](#section-9-2)`. Processing of Restart_Cap Object`

`    `[`9.3`](#section-9-3)`. Modification to Hello Processing to Support`

`         State Recovery`

`    `[`9.4`](#section-9-4)`. Control Channel Faults`

`    `[`9.5`](#section-9-5)`. Nodal Faults`

`   `[`10`](#section-10)`. RSVP Message Formats and Handling`

`    `[`10.1`](#section-10-1)`. RSVP Message Formats`

`    `[`10.2`](#section-10-2)`. Addressing Path and PathTear Messages`
...
`    `[`13.1`](#section-13-1)`. IANA Assignments`

`   `[`14`](#section-14)`. Intellectual Property Considerations`
...
`   `[`17`](#section-17)`. Editor's Address`

`   `[`18`](#section-18)`. Full Copyright Statement`
...
<a id="section-2"></a> **`2. Label Related Formats`**
...
<a id="section-2-1"></a> **`2.1. Generalized Label Request Object`**
...
<a id="section-2-1-1"></a> **`2.1.1. Procedures`**
...
<a id="section-2-2"></a> **`2.2. Bandwidth Encoding`**
...
<a id="section-2-3"></a> **`2.3. Generalized Label Object`**
...
<a id="section-2-3-1"></a> **`2.3.1. Procedures`**
...
<a id="section-2-4"></a> **`2.4. Waveband Switching Object`**
...
<a id="section-2-4-1"></a> **`2.4.1. Procedures`**
...
<a id="section-2-5"></a> **`2.5. Suggested Label Object`**
...
<a id="section-2-6"></a> **`2.6. Label Set Object`**
...
<a id="section-2-6-1"></a> **`2.6.1. Procedures`**
...
<a id="section-3"></a> **`3. Bidirectional LSPs`**
...
<a id="section-3-1"></a> **`3.1. Procedures`**
...
<a id="section-3-2"></a> **`3.2. Contention Resolution`**
...
<a id="section-4"></a> **`4. Notification`**
...
<a id="section-4-1"></a> **`4.1. Acceptable Label Set Object`**
...
<a id="section-4-2"></a> **`4.2. Notify Request Objects`**
...
<a id="section-4-2-1"></a> **`4.2.1. Required Information`**
...
<a id="section-4-2-2"></a> **`4.2.2. Procedures`**
...
<a id="section-4-3"></a> **`4.3. Notify Message`**
...
<a id="section-4-3-1"></a> **`4.3.1. Required Information`**
...
<a id="section-4-3-2"></a> **`4.3.2. Procedures`**
...
<a id="section-4-4"></a> **`4.4. Removing State with a PathErr message`**
...
<a id="section-5"></a> **`5. Explicit Label Control`**
...
<a id="section-5-1"></a> **`5.1. Label ERO subobject`**
...
<a id="section-5-1-1"></a> **`5.1.1. Procedures`**
...
<a id="section-5-2"></a> **`5.2. Label RRO subobject`**
...
<a id="section-5-2-1"></a> **`5.2.1. Procedures`**
...
<a id="section-6"></a> **`6. Protection Object`**
...
<a id="section-6-1"></a> **`6.1. Procedures`**
...
<a id="section-7"></a> **`7. Administrative Status Information`**
...
<a id="section-7-1"></a> **`7.1. Admin Status Object`**
...
<a id="section-7-2"></a> **`7.2. Path and Resv Message Procedures`**
...
<a id="section-7-2-1"></a> **`7.2.1. Deletion procedure`**
...
<a id="section-7-2-2"></a> **`7.2.2. Compatibility and Error Procedures`**
...
<a id="section-7-3"></a> **`7.3. Notify Message Procedures`**
...
<a id="section-7-3-1"></a> **`7.3.1. Compatibility and Error Procedures`**
...
<a id="section-8"></a> **`8. Control Channel Separation`**
...
<a id="section-8-1"></a> **`8.1. Interface Identification`**
...
<a id="section-8-1-1"></a> **`8.1.1. IF_ID RSVP_HOP Objects`**
...
<a id="section-8-1-2"></a> **`8.1.2. Procedures`**
...
<a id="section-8-2"></a> **`8.2. Errored Interface Identification`**
...
<a id="section-8-2-1"></a> **`8.2.1. IF_ID ERROR_SPEC Objects`**
...
<a id="section-8-2-2"></a> **`8.2.2. Procedures`**
...
<a id="section-9"></a> **`9. Fault Handling`**
...
<a id="section-9-1"></a> **`9.1. Restart_Cap Object`**
...
<a id="section-9-2"></a> **`9.2. Processing of Restart_Cap Object`**
...
<a id="section-9-3"></a> **`9.3. Modification to Hello Processing to Support State Recovery`**
...
<a id="section-9-4"></a> **`9.4. Control Channel Faults`**
...
<a id="section-9-5"></a> **`9.5. Nodal Faults`**
...
<a id="section-9-5-1"></a> **`9.5.1. Recovery Label`**
...
<a id="section-9-5-2"></a> **`9.5.2. Procedures for the Restarting node`**
...
<a id="section-9-5-3"></a> **`9.5.3. Procedures for the Neighbor of a Restarting node`**
...
<a id="section-10"></a> **`10. RSVP Message Formats and Handling`**
...
<a id="section-10-1"></a> **`10.1. RSVP Message Formats`**
...
<a id="section-10-2"></a> **`10.2. Addressing Path, PathTear and ResvConf Messages`**
...
<a id="section-13-1"></a> **`13.1. IANA Assignments`**
...
<a id="section-14"></a> **`14. Intellectual Property Considerations`**
...
<a id="section-17"></a> **`17. Editor's Address`**
...
<a id="section-18"></a> **`18. Full Copyright Statement`**
