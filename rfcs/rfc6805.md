...
`      `[`1.2`](#section-1-2)`. Definition of a Domain`

`      `[`1.3`](#section-1-3)`. Assumptions and Requirements`

`           `[`1.3.1`](#section-1-3-1)`. Metric Objectives`

`           `[`1.3.2`](#section-1-3-2)`. Diversity`

`                  `[`1.3.2.1`](#section-1-3-2-1)`. Physical Diversity`

`                  `[`1.3.2.2`](#section-1-3-2-2)`. Domain Diversity`

`           `[`1.3.3`](#section-1-3-3)`. Existing Traffic Engineering Constraints`

`           `[`1.3.4`](#section-1-3-4)`. Commercial Constraints`

`           `[`1.3.5`](#section-1-3-5)`. Domain Confidentiality`

`           `[`1.3.6`](#section-1-3-6)`. Limiting Information Aggregation`

`           `[`1.3.7`](#section-1-3-7)`. Domain Interconnection Discovery`

`      `[`1.4`](#section-1-4)`. Terminology`

`   `[`2`](#section-2)`. Examination of Existing PCE Mechanisms`

`      `[`2.1`](#section-2-1)`. Per-Domain Path Computation`

`      `[`2.2`](#section-2-2)`. Backward-Recursive PCE-Based Computation`

`           `[`2.2.1`](#section-2-2-1)`. Applicability of BRPC When the Domain Path`

`                  is Not Known`

`   `[`3`](#section-3)`. Hierarchical PCE`

`   `[`4`](#section-4)`. Hierarchical PCE Procedures`

`      `[`4.1`](#section-4-1)`. Objective Functions and Policy`

`      `[`4.2`](#section-4-2)`. Maintaining Domain Confidentiality`

`      `[`4.3`](#section-4-3)`. PCE Discovery`

`      `[`4.4`](#section-4-4)`. Traffic Engineering Database for the Parent Domain`

`      `[`4.5`](#section-4-5)`. Determination of Destination Domain`

`      `[`4.6`](#section-4-6)`. Hierarchical PCE Examples`

`           `[`4.6.1`](#section-4-6-1)`. Hierarchical PCE Initial Information Exchange`

`           `[`4.6.2`](#section-4-6-2)`. Hierarchical PCE End-to-End Path`

`                  Computation Procedure`

`      `[`4.7`](#section-4-7)`. Hierarchical PCE Error Handling`

`      `[`4.8`](#section-4-8)`. Requirements for Hierarchical PCEP Protocol Extensions`

`           `[`4.8.1`](#section-4-8-1)`. PCEP Request Qualifiers`

`           `[`4.8.2`](#section-4-8-2)`. Indication of Hierarchical PCE Capability`

`           `[`4.8.3`](#section-4-8-3)`. Intention to Utilize Parent PCE Capabilities`

`           `[`4.8.4`](#section-4-8-4)`. Communication of Domain Connectivity Information`

`           `[`4.8.5`](#section-4-8-5)`. Domain Identifiers`

`   `[`5`](#section-5)`. Hierarchical PCE Applicability`

`      `[`5.1`](#section-5-1)`. Autonomous Systems and Areas`

`      `[`5.2`](#section-5-2)`. ASON Architecture`

`           `[`5.2.1`](#section-5-2-1)`. Implicit Consistency between Hierarchical`

`                  PCE and G.7715.2`

`           `[`5.2.2`](#section-5-2-2)`. Benefits of Hierarchical PCEs in ASON`

`   `[`6`](#section-6)`. A Note on BGP-TE`

`      `[`6.1`](#section-6-1)`. Use of BGP for TED Synchronization`

`   `[`7`](#section-7)`. Management Considerations`

`      `[`7.1`](#section-7-1)`. Control of Function and Policy`

`           `[`7.1.1`](#section-7-1-1)`. Child PCE`

`           `[`7.1.2`](#section-7-1-2)`. Parent PCE`

`           `[`7.1.3`](#section-7-1-3)`. Policy Control`

`      `[`7.2`](#section-7-2)`. Information and Data Models`

`      `[`7.3`](#section-7-3)`. Liveness Detection and Monitoring`

`      `[`7.4`](#section-7-4)`. Verifying Correct Operation`

`      `[`7.5`](#section-7-5)`. Impact on Network Operation`
...
<a id="section-1-2"></a> **`1.2. Definition of a Domain`**
...
<a id="section-1-3"></a> **`1.3. Assumptions and Requirements`**
...
<a id="section-1-3-1"></a> **`1.3.1. Metric Objectives`**
...
<a id="section-1-3-2"></a> **`1.3.2. Diversity`**

```text

```

<a id="section-1-3-2-1"></a> **`1.3.2.1. Physical Diversity`**
...
<a id="section-1-3-2-2"></a> **`1.3.2.2. Domain Diversity`**
...
<a id="section-1-3-3"></a> **`1.3.3. Existing Traffic Engineering Constraints`**
...
<a id="section-1-3-4"></a> **`1.3.4. Commercial Constraints`**
...
<a id="section-1-3-5"></a> **`1.3.5. Domain Confidentiality`**
...
<a id="section-1-3-6"></a> **`1.3.6. Limiting Information Aggregation`**
...
<a id="section-1-3-7"></a> **`1.3.7. Domain Interconnection Discovery`**
...
<a id="section-1-4"></a> **`1.4. Terminology`**
...
<a id="section-2"></a> **`2. Examination of Existing PCE Mechanisms`**
...
<a id="section-2-1"></a> **`2.1. Per-Domain Path Computation`**
...
<a id="section-2-2"></a> **`2.2. Backward-Recursive PCE-Based Computation`**
...
<a id="section-2-2-1"></a> **`2.2.1. Applicability of BRPC When the Domain Path is Not Known`**
...
<a id="section-3"></a> **`3. Hierarchical PCE`**
...
<a id="section-4"></a> **`4. Hierarchical PCE Procedures`**

```text

```

<a id="section-4-1"></a> **`4.1. Objective Functions and Policy`**
...
<a id="section-4-2"></a> **`4.2. Maintaining Domain Confidentiality`**
...
<a id="section-4-3"></a> **`4.3. PCE Discovery`**
...
<a id="section-4-4"></a> **`4.4. Traffic Engineering Database for the Parent Domain`**
...
<a id="section-4-5"></a> **`4.5. Determination of Destination Domain`**
...
<a id="section-4-6"></a> **`4.6. Hierarchical PCE Examples`**
...
<a id="section-4-6-1"></a> **`4.6.1. Hierarchical PCE Initial Information Exchange`**
...
<a id="section-4-6-2"></a> **`4.6.2. Hierarchical PCE End-to-End Path Computation Procedure`**
...
<a id="section-4-7"></a> **`4.7. Hierarchical PCE Error Handling`**
...
<a id="section-4-8"></a> **`4.8. Requirements for Hierarchical PCEP Protocol Extensions`**
...
<a id="section-4-8-1"></a> **`4.8.1. PCEP Request Qualifiers`**
...
<a id="section-4-8-2"></a> **`4.8.2. Indication of Hierarchical PCE Capability`**
...
<a id="section-4-8-3"></a> **`4.8.3. Intention to Utilize Parent PCE Capabilities`**
...
<a id="section-4-8-4"></a> **`4.8.4. Communication of Domain Connectivity Information`**
...
<a id="section-4-8-5"></a> **`4.8.5. Domain Identifiers`**
...
<a id="section-5"></a> **`5. Hierarchical PCE Applicability`**
...
<a id="section-5-1"></a> **`5.1. Autonomous Systems and Areas`**
...
<a id="section-5-2"></a> **`5.2. ASON Architecture`**
...
<a id="section-5-2-1"></a> **`5.2.1. Implicit Consistency between Hierarchical PCE and G.7715.2`**
...
<a id="section-5-2-2"></a> **`5.2.2. Benefits of Hierarchical PCEs in ASON`**
...
<a id="section-6"></a> **`6. A Note on BGP-TE`**
...
<a id="section-6-1"></a> **`6.1. Use of BGP for TED Synchronization`**
...
<a id="section-7"></a> **`7. Management Considerations`**
...
<a id="section-7-1"></a> **`7.1. Control of Function and Policy`**

```text

```

<a id="section-7-1-1"></a> **`7.1.1. Child PCE`**
...
<a id="section-7-1-2"></a> **`7.1.2. Parent PCE`**
...
<a id="section-7-1-3"></a> **`7.1.3. Policy Control`**
...
<a id="section-7-2"></a> **`7.2. Information and Data Models`**
...
<a id="section-7-3"></a> **`7.3. Liveness Detection and Monitoring`**
...
<a id="section-7-4"></a> **`7.4. Verifying Correct Operation`**
...
<a id="section-7-5"></a> **`7.5. Impact on Network Operation`**
