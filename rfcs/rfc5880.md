...
`      `[`3.1`](#section-3-1)`. Addressing and Session Establishment`

`      `[`3.2`](#section-3-2)`. Operating Modes`

`   `[`4`](#section-4)`. BFD Control Packet Format`

`      `[`4.1`](#section-4-1)`. Generic BFD Control Packet Format`

`      `[`4.2`](#section-4-2)`. Simple Password Authentication Section Format`

`      `[`4.3`](#section-4-3)`. Keyed MD5 and Meticulous Keyed MD5 Authentication`

`           Section Format`

`      `[`4.4`](#section-4-4)`. Keyed SHA1 and Meticulous Keyed SHA1`

`           Authentication Section Format`

`   `[`5`](#section-5)`. BFD Echo Packet Format`

`   `[`6`](#section-6)`. Elements of Procedure`

`      `[`6.1`](#section-6-1)`. Overview`

`      `[`6.2`](#section-6-2)`. BFD State Machine`

`      `[`6.3`](#section-6-3)`. Demultiplexing and the Discriminator Fields`

`      `[`6.4`](#section-6-4)`. The Echo Function and Asymmetry`

`      `[`6.5`](#section-6-5)`. The Poll Sequence`

`      `[`6.6`](#section-6-6)`. Demand Mode`

`      `[`6.7`](#section-6-7)`. Authentication`

`           `[`6.7.1`](#section-6-7-1)`. Enabling and Disabling Authentication`

`           `[`6.7.2`](#section-6-7-2)`. Simple Password Authentication`

`           `[`6.7.3`](#section-6-7-3)`. Keyed MD5 and Meticulous Keyed MD5 Authentication`

`           `[`6.7.4`](#section-6-7-4)`. Keyed SHA1 and Meticulous Keyed SHA1`

`                  Authentication`

`      `[`6.8`](#section-6-8)`. Functional Specifics`

`           `[`6.8.1`](#section-6-8-1)`. State Variables`

`           `[`6.8.2`](#section-6-8-2)`. Timer Negotiation`

`           `[`6.8.3`](#section-6-8-3)`. Timer Manipulation`

`           `[`6.8.4`](#section-6-8-4)`. Calculating the Detection Time`

`           `[`6.8.5`](#section-6-8-5)`. Detecting Failures with the Echo Function`

`           `[`6.8.6`](#section-6-8-6)`. Reception of BFD Control Packets`

`           `[`6.8.7`](#section-6-8-7)`. Transmitting BFD Control Packets`

`           `[`6.8.8`](#section-6-8-8)`. Reception of BFD Echo Packets`

`           `[`6.8.9`](#section-6-8-9)`. Transmission of BFD Echo Packets`

`           `[`6.8.10`](#section-6-8-10)`. Min Rx Interval Change`

`           `[`6.8.11`](#section-6-8-11)`. Min Tx Interval Change`

`           `[`6.8.12`](#section-6-8-12)`. Detect Multiplier Change`

`           `[`6.8.13`](#section-6-8-13)`. Enabling or Disabling The Echo Function`

`           `[`6.8.14`](#section-6-8-14)`. Enabling or Disabling Demand Mode`

`           `[`6.8.15`](#section-6-8-15)`. Forwarding Plane Reset`

`           `[`6.8.16`](#section-6-8-16)`. Administrative Control`

`           `[`6.8.17`](#section-6-8-17)`. Concatenated Paths`

`           `[`6.8.18`](#section-6-8-18)`. Holding Down Sessions`

`   `[`7`](#section-7)`. Operational Considerations`
...
<a id="section-3-1"></a> **`3.1. Addressing and Session Establishment`**
...
<a id="section-3-2"></a> **`3.2. Operating Modes`**
...
<a id="section-4"></a> **`4. BFD Control Packet Format`**

```text

```

<a id="section-4-1"></a> **`4.1. Generic BFD Control Packet Format`**
...
<a id="section-4-2"></a> **`4.2. Simple Password Authentication Section Format`**
...
<a id="section-4-3"></a> **`4.3. Keyed MD5 and Meticulous Keyed MD5 Authentication Section Format`**
...
<a id="section-4-4"></a> **`4.4. Keyed SHA1 and Meticulous Keyed SHA1 Authentication Section Format`**
...
<a id="section-5"></a> **`5. BFD Echo Packet Format`**
...
<a id="section-6"></a> **`6. Elements of Procedure`**
...
<a id="section-6-2"></a> **`6.2. BFD State Machine`**
...
<a id="section-6-3"></a> **`6.3. Demultiplexing and the Discriminator Fields`**
...
<a id="section-6-4"></a> **`6.4. The Echo Function and Asymmetry`**
...
<a id="section-6-5"></a> **`6.5. The Poll Sequence`**
...
<a id="section-6-6"></a> **`6.6. Demand Mode`**
...
<a id="section-6-7"></a> **`6.7. Authentication`**
...
<a id="section-6-7-1"></a> **`6.7.1. Enabling and Disabling Authentication`**
...
<a id="section-6-7-2"></a> **`6.7.2. Simple Password Authentication`**
...
<a id="section-6-7-3"></a> **`6.7.3. Keyed MD5 and Meticulous Keyed MD5 Authentication`**
...
<a id="section-6-7-4"></a> **`6.7.4. Keyed SHA1 and Meticulous Keyed SHA1 Authentication`**
...
<a id="section-6-8"></a> **`6.8. Functional Specifics`**
...
<a id="section-6-8-1"></a> **`6.8.1. State Variables`**
...
<a id="section-6-8-2"></a> **`6.8.2. Timer Negotiation`**
...
<a id="section-6-8-3"></a> **`6.8.3. Timer Manipulation`**
...
<a id="section-6-8-4"></a> **`6.8.4. Calculating the Detection Time`**
...
<a id="section-6-8-5"></a> **`6.8.5. Detecting Failures with the Echo Function`**
...
<a id="section-6-8-6"></a> **`6.8.6. Reception of BFD Control Packets`**
...
<a id="section-6-8-7"></a> **`6.8.7. Transmitting BFD Control Packets`**
...
<a id="section-6-8-8"></a> **`6.8.8. Reception of BFD Echo Packets`**
...
<a id="section-6-8-9"></a> **`6.8.9. Transmission of BFD Echo Packets`**
...
<a id="section-6-8-10"></a> **`6.8.10. Min Rx Interval Change`**
...
<a id="section-6-8-11"></a> **`6.8.11. Min Tx Interval Change`**
...
<a id="section-6-8-12"></a> **`6.8.12. Detect Multiplier Change`**
...
<a id="section-6-8-13"></a> **`6.8.13. Enabling or Disabling The Echo Function`**
...
<a id="section-6-8-14"></a> **`6.8.14. Enabling or Disabling Demand Mode`**
...
<a id="section-6-8-15"></a> **`6.8.15. Forwarding Plane Reset`**
...
<a id="section-6-8-16"></a> **`6.8.16. Administrative Control`**
...
<a id="section-6-8-17"></a> **`6.8.17. Concatenated Paths`**
...
<a id="section-6-8-18"></a> **`6.8.18. Holding Down Sessions`**
...
<a id="section-7"></a> **`7. Operational Considerations`**
