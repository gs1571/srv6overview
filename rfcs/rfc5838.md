...
`     `[`1.2`](#section-1-2)`. Requirements Notation`

`   `[`2`](#section-2)`. Protocol Details`

`     `[`2.1`](#section-2-1)`. Instance ID Values for New AFs`

`     `[`2.2`](#section-2-2)`. OSPFv3 Options Changes`

`     `[`2.3`](#section-2-3)`. Advertising Prefixes in AFs Other Than IPv6`

`     `[`2.4`](#section-2-4)`. Changes to the Hello Packet Processing`

`     `[`2.5`](#section-2-5)`. Next-Hop Calculation for IPv4 Unicast and Multicast AFs`

`     `[`2.6`](#section-2-6)`. AS-External-LSA and NSSA-LSA Forwarding Address for`

`           IPv4 Unicast and IPv4 Multicast AFs`

`     `[`2.7`](#section-2-7)`. Database Description Maximum Transmission Unit (MTU)`

`           Specification for Non-IPv6 AFs`

`     `[`2.8`](#section-2-8)`. Operation over Virtual Links`

`   `[`3`](#section-3)`. Backward Compatibility`
...
<a id="section-1-2"></a> **`1.2. Requirements Notation`**
...
<a id="section-2"></a> **`2. Protocol Details`**
...
<a id="section-2-1"></a> **`2.1. Instance ID Values for New AFs`**
...
<a id="section-2-2"></a> **`2.2. OSPFv3 Options Changes`**
...
<a id="section-2-3"></a> **`2.3. Advertising Prefixes in AFs Other Than IPv6`**
...
<a id="section-2-4"></a> **`2.4. Changes to the Hello Packet Processing`**
...
<a id="section-2-5"></a> **`2.5. Next-Hop Calculation for IPv4 Unicast and Multicast AFs`**
...
<a id="section-2-6"></a> **`2.6. AS-External-LSA and NSSA-LSA Forwarding Address for IPv4 Unicast`**
...
<a id="section-2-7"></a> **`2.7. Database Description Maximum Transmission Unit (MTU) Specification`**
...
<a id="section-2-8"></a> **`2.8. Operation over Virtual Links`**
...
<a id="section-3"></a> **`3. Backward Compatibility`**
