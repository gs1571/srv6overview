...
`   `[`5`](#section-5)`. Layering`

`     `[`5.1`](#section-5-1)`. Accounting for Header Sizes`

`     `[`5.2`](#section-5-2)`. Storing PMTU Information`

`     `[`5.3`](#section-5-3)`. Accounting for IPsec`

`     `[`5.4`](#section-5-4)`. Multicast`

`   `[`6`](#section-6)`. Common Packetization Properties`

`     `[`6.1`](#section-6-1)`. Mechanism to Detect Loss`

`     `[`6.2`](#section-6-2)`. Generating Probes`

`   `[`7`](#section-7)`. The Probing Method`

`     `[`7.1`](#section-7-1)`. Packet Size Ranges`

`     `[`7.2`](#section-7-2)`. Selecting Initial Values`

`     `[`7.3`](#section-7-3)`. Selecting Probe Size`

`     `[`7.4`](#section-7-4)`. Probing Preconditions`

`     `[`7.5`](#section-7-5)`. Conducting a Probe`

`     `[`7.6`](#section-7-6)`. Response to Probe Results`

`       `[`7.6.1`](#section-7-6-1)`. Probe Success`

`       `[`7.6.2`](#section-7-6-2)`. Probe Failure`

`       `[`7.6.3`](#section-7-6-3)`. Probe Timeout Failure`

`       `[`7.6.4`](#section-7-6-4)`. Probe Inconclusive`

`     `[`7.7`](#section-7-7)`. Full-Stop Timeout`

`     `[`7.8`](#section-7-8)`. MTU Verification`

`   `[`8`](#section-8)`. Host Fragmentation`

`   `[`9`](#section-9)`. Application Probing`

`   `[`10`](#section-10)`. Specific Packetization Layers`

`     `[`10.1`](#section-10-1)`. Probing Method Using TCP`

`     `[`10.2`](#section-10-2)`. Probing Method Using SCTP`

`     `[`10.3`](#section-10-3)`. Probing Method for IP Fragmentation`

`     `[`10.4`](#section-10-4)`. Probing Method Using Applications`
...
<a id="section-4"></a> **`4. Requirements`**
...
<a id="section-5-1"></a> **`5.1. Accounting for Header Sizes`**
...
<a id="section-5-2"></a> **`5.2. Storing PMTU Information`**
...
<a id="section-5-3"></a> **`5.3. Accounting for IPsec`**
...
<a id="section-5-4"></a> **`5.4. Multicast`**
...
<a id="section-6"></a> **`6. Common Packetization Properties`**
...
<a id="section-6-1"></a> **`6.1. Mechanism to Detect Loss`**
...
<a id="section-6-2"></a> **`6.2. Generating Probes`**
...
<a id="section-7"></a> **`7. The Probing Method`**
...
<a id="section-7-1"></a> **`7.1. Packet Size Ranges`**
...
<a id="section-7-2"></a> **`7.2. Selecting Initial Values`**
...
<a id="section-7-3"></a> **`7.3. Selecting Probe Size`**
...
<a id="section-7-4"></a> **`7.4. Probing Preconditions`**
...
<a id="section-7-5"></a> **`7.5. Conducting a Probe`**
...
<a id="section-7-6"></a> **`7.6. Response to Probe Results`**
...
<a id="section-7-6-1"></a> **`7.6.1. Probe Success`**
...
<a id="section-7-6-2"></a> **`7.6.2. Probe Failure`**
...
<a id="section-7-6-3"></a> **`7.6.3. Probe Timeout Failure`**
...
<a id="section-7-6-4"></a> **`7.6.4. Probe Inconclusive`**
...
<a id="section-7-7"></a> **`7.7. Full-Stop Timeout`**
...
<a id="section-7-8"></a> **`7.8. MTU Verification`**
...
<a id="section-8"></a> **`8. Host Fragmentation`**
...
<a id="section-9"></a> **`9. Application Probing`**
...
<a id="section-10"></a> **`10. Specific Packetization Layers`**
...
<a id="section-10-1"></a> **`10.1. Probing Method Using TCP`**
...
<a id="section-10-2"></a> **`10.2. Probing Method Using SCTP`**
...
<a id="section-10-3"></a> **`10.3. Probing Method for IP Fragmentation`**
...
<a id="section-10-4"></a> **`10.4. Probing Method Using Applications`**
