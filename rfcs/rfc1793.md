...
`    `[`1`](#section-1)`. Model for demand circuits`

`    `[`2`](#section-2)`. Modifications to all OSPF routers`

`    `[`2.1`](#section-2-1)`. The OSPF Options field`

`    `[`2.2`](#section-2-2)`. The LS age field`

`    `[`2.3`](#section-2-3)`. Removing stale DoNotAge LSAs`

`    `[`2.4`](#section-2-4)`. A change to the flooding algorithm`

`    `[`2.5`](#section-2-5)`. Interoperability with unmodified OSPF routers`

`    `[`2.5.1`](#section-2-5-1)`. Indicating across area boundaries`

`    `[`2.5.1`](#section-2-5-1)`. 1 Limiting indication-LSA origination`

`    `[`3`](#section-3)`. Modifications to demand circuit endpoints`

`    `[`3.1`](#section-3-1)`. Interface State machine modifications`

`    `[`3.2`](#section-3-2)`. Sending and Receiving OSPF Hellos`

`    `[`3.2.1`](#section-3-2-1)`. Negotiating Hello suppression`

`    `[`3.2.2`](#section-3-2-2)`. Neighbor state machine modifications`

`    `[`3.3`](#section-3-3)`. Flooding over demand circuits`

`    `[`3.4`](#section-3-4)`. Virtual link support`

`    `[`3.5`](#section-3-5)`. Point-to-MultiPoint Interface support`

`    `[`4`](#section-4)`. Examples`

`    `[`4.1`](#section-4-1)`. Example 1: Sole connectivity through demand circuits`

`    `[`4.2`](#section-4-2)`. Example 2: Demand and non-demand circuits in parallel`

`    `[`4.3`](#section-4-3)`. Example 3: Operation when oversubscribed`

`    `[`5`](#section-5)`. Topology recommendations`

`    `[`6`](#section-6)`. Lost functionality`

`    `[`7`](#section-7)`. Future work: Oversubscription`

`    `[`8`](#section-8)`. Unsupported capabilities`
...
<a id="section-1"></a> **`1. Model for demand circuits`**
...
<a id="section-2"></a> **`2. Modifications to all OSPF routers`**
...
<a id="section-2-4"></a> **`2.4. A change to the flooding algorithm`**
...
<a id="section-3"></a> **`3. Modifications to demand circuit endpoints`**
...
<a id="section-5"></a> **`5. Topology recommendations`**
...
<a id="section-6"></a> **`6. Lost functionality`**
...
<a id="section-7"></a> **`7. Future work: Oversubscription`**
...
<a id="section-8"></a> **`8. Unsupported capabilities`**
