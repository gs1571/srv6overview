...
`   `[`1`](#section-1)`. Overview of Contents`

`   `[`2`](#section-2)`. Definitions of Bit Strings and Integers`

`   `[`3`](#section-3)`. Operations on Words`

`   `[`4`](#section-4)`. Message Padding`

`   `[`5`](#section-5)`. Functions and Constants Used`

`   `[`6`](#section-6)`. Computing the Message Digest`

`   `[`6`](#section-6)`. 1 Method 1`

`   `[`6`](#section-6)`. 2 Method 2`

`   `[`7`](#section-7)`. C Code`

`   `[`7`](#section-7)`. 1 .h file`

`   `[`7`](#section-7)`. 2 .c file`

`   `[`7`](#section-7)`. 3 Test Driver`
...
<a id="section-1"></a> **`1. Overview of Contents`**
...
<a id="section-2"></a> **`2. Definitions of Bit Strings and Integers`**
...
<a id="section-3"></a> **`3. Operations on Words`**
...
<a id="section-4"></a> **`4. Message Padding`**
...
<a id="section-5"></a> **`5. Functions and Constants Used`**
...
<a id="section-6"></a> **`6. Computing the Message Digest`**
