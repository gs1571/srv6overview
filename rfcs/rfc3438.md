...
`     `[`2`](#section-2)`. 1 Control Message AVPs`

`     `[`2`](#section-2)`. 2 Message Type AVP Values`

`     `[`2`](#section-2)`. 3 Result Code AVP Values`

`     `[`2`](#section-2)`. 4 Remaining Values`

`   `[`3`](#section-3)`. Normative References`
...
<a id="section-3"></a> **`3. Normative References`**
