...
`   `[`3`](#section-3)`. Applicability Statement`

`   `[`4`](#section-4)`. Terminology`

`   `[`5`](#section-5)`. General Encapsulation Method`

`      `[`5.1`](#section-5-1)`. The Control Word`

`           `[`5.1.1`](#section-5-1-1)`. The Generic Control Word`

`           `[`5.1.2`](#section-5-1-2)`. The Preferred Control Word`

`           `[`5.1.3`](#section-5-1-3)`. Setting the Sequence Number Field in the`

`                  Control Word`

`      `[`5.2`](#section-5-2)`. MTU Requirements`

`      `[`5.3`](#section-5-3)`. MPLS Shim S Bit Value`

`      `[`5.4`](#section-5-4)`. MPLS Shim TTL Values`

`   `[`6`](#section-6)`. Encapsulation Mode Applicability`

`      `[`6.1`](#section-6-1)`. ATM N-to-One Cell Mode`

`      `[`6.2`](#section-6-2)`. ATM One-to-One Cell Encapsulation`

`      `[`6.3`](#section-6-3)`. AAL5 SDU Frame Encapsulation`

`      `[`6.4`](#section-6-4)`. AAL5 PDU Frame Encapsulation`

`   `[`7`](#section-7)`. ATM OAM Cell Support`

`      `[`7.1`](#section-7-1)`. VCC Case`

`      `[`7.2`](#section-7-2)`. VPC Case`

`      `[`7.3`](#section-7-3)`. SDU/PDU OAM Cell Emulation Mode`

`      `[`7.4`](#section-7-4)`. Defect Handling`

`   `[`8`](#section-8)`. ATM N-to-One Cell Mode`

`      `[`8.1`](#section-8-1)`. ATM N-to-One Service Encapsulation`

`   `[`9`](#section-9)`. ATM One-to-One Cell Mode`

`      `[`9.1`](#section-9-1)`. ATM One-to-One Service Encapsulation`

`      `[`9.2`](#section-9-2)`. Sequence Number`

`      `[`9.3`](#section-9-3)`. ATM VCC Cell Transport Service`

`      `[`9.4`](#section-9-4)`. ATM VPC Services`

`           `[`9.4.1`](#section-9-4-1)`. ATM VPC Cell Transport Services`

`   `[`10`](#section-10)`. ATM AAL5 CPCS-SDU Mode`

`      `[`10.1`](#section-10-1)`. Transparent AAL5 SDU Frame Encapsulation`

`   `[`11`](#section-11)`. AAL5 PDU Frame Mode`

`      `[`11.1`](#section-11-1)`. Transparent AAL5 PDU Frame Encapsulation`

`      `[`11.2`](#section-11-2)`. Fragmentation`

`           `[`11.2.1`](#section-11-2-1)`. Procedures in the ATM-to-PSN Direction`

`           `[`11.2.2`](#section-11-2-2)`. Procedures in the PSN-to-ATM Direction`

`   `[`12`](#section-12)`. Mapping of ATM and PSN Classes of Service`

`   `[`13`](#section-13)`. ILMI Support`

`   `[`14`](#section-14)`. ATM-Specific Interface Parameter Sub-TLVs`

`   `[`15`](#section-15)`. Congestion Control`

`   `[`16`](#section-16)`. Security Considerations`

`   `[`17`](#section-17)`. Normative References`

`   `[`18`](#section-18)`. Informative References`

`   `[`19`](#section-19)`. Significant Contributors`
...
<a id="section-3"></a> **`3. Applicability Statement`**
...
<a id="section-5"></a> **`5. General Encapsulation Method`**
...
<a id="section-5-1"></a> **`5.1. The Control Word`**
...
<a id="section-5-1-1"></a> **`5.1.1. The Generic Control Word`**
...
<a id="section-5-1-2"></a> **`5.1.2. The Preferred Control Word`**
...
<a id="section-5-1-3"></a> **`5.1.3. Setting the Sequence Number Field in the Control Word`**
...
<a id="section-5-2"></a> **`5.2. MTU Requirements`**
...
<a id="section-5-3"></a> **`5.3. MPLS Shim S Bit Value`**
...
<a id="section-5-4"></a> **`5.4. MPLS Shim TTL Values`**
...
<a id="section-6"></a> **`6. Encapsulation Mode Applicability`**
...
<a id="section-6-1"></a> **`6.1. ATM N-to-One Cell Mode`**
...
<a id="section-6-2"></a> **`6.2. ATM One-to-One Cell Encapsulation`**
...
<a id="section-6-3"></a> **`6.3. AAL5 SDU Frame Encapsulation`**
...
<a id="section-6-4"></a> **`6.4. AAL5 PDU Frame Encapsulation`**
...
<a id="section-7"></a> **`7. ATM OAM Cell Support`**

```text

```

<a id="section-7-1"></a> **`7.1. VCC Case`**
...
<a id="section-7-2"></a> **`7.2. VPC Case`**
...
<a id="section-7-3"></a> **`7.3. SDU/PDU OAM Cell Emulation Mode`**
...
<a id="section-7-4"></a> **`7.4. Defect Handling`**
...
<a id="section-8"></a> **`8. ATM N-to-One Cell Mode`**
...
<a id="section-8-1"></a> **`8.1. ATM N-to-One Service Encapsulation`**
...
<a id="section-9"></a> **`9. ATM One-to-One Cell Mode`**
...
<a id="section-9-1"></a> **`9.1. ATM One-to-One Service Encapsulation`**
...
<a id="section-9-2"></a> **`9.2. Sequence Number`**
...
<a id="section-9-3"></a> **`9.3. ATM VCC Cell Transport Service`**
...
<a id="section-9-4"></a> **`9.4. ATM VPC Services`**
...
<a id="section-9-4-1"></a> **`9.4.1. ATM VPC Cell Transport Services`**
...
<a id="section-10"></a> **`10. ATM AAL5 CPCS-SDU Mode`**
...
<a id="section-10-1"></a> **`10.1. Transparent AAL5 SDU Frame Encapsulation`**
...
<a id="section-11"></a> **`11. AAL5 PDU Frame Mode`**
...
<a id="section-11-1"></a> **`11.1. Transparent AAL5 PDU Frame Encapsulation`**
...
<a id="section-11-2"></a> **`11.2. Fragmentation`**
...
<a id="section-11-2-1"></a> **`11.2.1. Procedures in the ATM-to-PSN Direction`**
...
<a id="section-11-2-2"></a> **`11.2.2. Procedures in the PSN-to-ATM Direction`**
...
<a id="section-12"></a> **`12. Mapping of ATM and PSN Classes of Service`**
...
<a id="section-13"></a> **`13. ILMI Support`**
...
<a id="section-14"></a> **`14. ATM-Specific Interface Parameter Sub-TLVs`**
...
<a id="section-15"></a> **`15. Congestion Control`**
...
<a id="section-17"></a> **`17. Normative References`**
...
<a id="section-18"></a> **`18. Informative References`**
...
<a id="section-19"></a> **`19. Significant Contributors`**
