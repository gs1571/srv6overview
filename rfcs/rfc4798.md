...
`   `[`3`](#section-3)`. Transport over IPv4-signaled LSPs and IPv6 Label Binding`

`   `[`4`](#section-4)`. Crossing Multiple IPv4 Autonomous Systems`
...
<a id="section-3"></a> **`3. Transport over IPv4-signaled LSPs and IPv6 Label Binding`**
...
<a id="section-4"></a> **`4. Crossing Multiple IPv4 Autonomous Systems`**
