...
`   `[`2`](#section-2)`. IS Neighbor Sub-TLV Registry`

`   `[`3`](#section-3)`. Prefix Reachability Sub-TLV Registry`

`   `[`4`](#section-4)`. Guidance for Designated Experts`
...
<a id="section-2"></a> **`2. IS Neighbor Sub-TLV Registry`**
...
<a id="section-3"></a> **`3. Prefix Reachability Sub-TLV Registry`**
...
<a id="section-4"></a> **`4. Guidance for Designated Experts`**
