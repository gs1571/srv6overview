...
- [2. Motivation and Applicability](#section-2)
  - [2.1. MPLS-TE with PCE](#section-2.1)
  - [2.2. ALTO Server Network API](#section-2.2)
- [3. BGP Speaker Roles for BGP-LS](#section-3)
- [4. Advertising IGP Information into BGP-LS](#section-4)
- [5. Carrying Link-State Information in BGP](#section-5)
  - [5.1. TLV Format](#section-5.1)
  - [5.2. The Link-State NLRI](#section-5.2)
    - [5.2.1. Node Descriptors](#section-5.2.1)
    - [5.2.2. Link Descriptors](#section-5.2.2)
    - [5.2.3. Prefix Descriptors](#section-5.2.3)
  - [5.3. The BGP-LS Attribute](#section-5.3)
    - [5.3.1. Node Attribute TLVs](#section-5.3.1)
    - [5.3.2. Link Attribute TLVs](#section-5.3.2)
    - [5.3.3. Prefix Attribute TLVs](#section-5.3.3)
  - [5.4. Private Use](#section-5.4)
  - [5.5. BGP Next-Hop Information](#section-5.5)
  - [5.6. Inter-AS Links](#section-5.6)
  - [5.7. OSPF Virtual Links and Sham Links](#section-5.7)
  - [5.8. OSPFv2 Type 4 Summary-LSA & OSPFv3 Inter-Area-Router-LSA](#section-5.8)
  - [5.9. Handling of Unreachable IGP Nodes](#section-5.9)
  - [5.10. Router-ID Anchoring Example: ISO Pseudonode](#section-5.10)
  - [5.11. Router-ID Anchoring Example: OSPF Pseudonode](#section-5.11)
  - [5.12. Router-ID Anchoring Example: OSPFv2 to IS-IS Migration](#section-5.12)
- [6. Link to Path Aggregation](#section-6)
...
- [7. IANA Considerations](#section-7)
  - [7.1. BGP-LS Registries](#section-7.1)
    - [7.1.1. BGP-LS NLRI Types Registry](#section-7.1.1)
    - [7.1.2. BGP-LS Protocol-IDs Registry](#section-7.1.2)
    - [7.1.3. BGP-LS Well-Known Instance-IDs Registry](#section-7.1.3)
    - [7.1.4. BGP-LS Node Flags Registry](#section-7.1.4)
    - [7.1.5. BGP-LS MPLS Protocol Mask Registry](#section-7.1.5)
    - [7.1.6. BGP-LS IGP Prefix Flags Registry](#section-7.1.6)
    - [7.1.7. BGP-LS TLVs Registry](#section-7.1.7)
  - [7.2. Guidance for Designated Experts](#section-7.2)
- [8. Manageability Considerations](#section-8)
  - [8.1. Operational Considerations](#section-8.1)
    - [8.1.1. Operations](#section-8.1.1)
    - [8.1.2. Installation and Initial Setup](#section-8.1.2)
    - [8.1.3. Migration Path](#section-8.1.3)
    - [8.1.4. Requirements for Other Protocols and Functional Components](#section-8.1.4)
    - [8.1.5. Impact on Network Operation](#section-8.1.5)
    - [8.1.6. Verifying Correct Operation](#section-8.1.6)
  - [8.2. Management Considerations](#section-8.2)
    - [8.2.1. Management Information](#section-8.2.1)
    - [8.2.2. Fault Management](#section-8.2.2)
    - [8.2.3. Configuration Management](#section-8.2.3)
    - [8.2.4. Accounting Management](#section-8.2.4)
    - [8.2.5. Performance Management](#section-8.2.5)
    - [8.2.6. Security Management](#section-8.2.6)
- [9. TLV/Sub-TLV Code Points Summary](#section-9)
...
- [Appendix A. Changes from RFC 7752](#section-appendix.a)
- [Acknowledgements](#section-appendix.b)
- [Contributors](#section-appendix.c)
- [Author's Address](#section-appendix.d)
...
<a name="RFC2545"></a> **[RFC2545]** P. Marques, F. Dupont, "Use of BGP-4 Multiprotocol Extensions for IPv6 Inter-Domain Routing", RFC 2545, DOI 10.17487/RFC2545, March 1999. <https://www.rfc-editor.org/info/rfc2545>
...
<a name="RFC4203"></a> **[RFC4203]** K. Kompella, Y. Rekhter, "OSPF Extensions in Support of Generalized Multi-Protocol Label Switching (GMPLS)", RFC 4203, DOI 10.17487/RFC4203, October 2005. <https://www.rfc-editor.org/info/rfc4203>
...
<a name="RFC4577"></a> **[RFC4577]** E. Rosen, P. Psenak, P. Pillay-Esnault, "OSPF as the Provider/Customer Edge Protocol for BGP/MPLS IP Virtual Private Networks (VPNs)", RFC 4577, DOI 10.17487/RFC4577, June 2006. <https://www.rfc-editor.org/info/rfc4577>

<a name="RFC4760"></a> **[RFC4760]** T. Bates, R. Chandra, D. Katz, Y. Rekhter, "Multiprotocol Extensions for BGP-4", RFC 4760, DOI 10.17487/RFC4760, January 2007. <https://www.rfc-editor.org/info/rfc4760>

<a name="RFC4915"></a> **[RFC4915]** P. Psenak, S. Mirtorabi, A. Roy, L. Nguyen, P. Pillay-Esnault, "Multi-Topology (MT) Routing in OSPF", RFC 4915, DOI 10.17487/RFC4915, June 2007. <https://www.rfc-editor.org/info/rfc4915>
...
<a name="RFC5130"></a> **[RFC5130]** S. Previdi, M. Shand, C. Martin, "A Policy Control Mechanism in IS-IS Using Administrative Tags", RFC 5130, DOI 10.17487/RFC5130, February 2008. <https://www.rfc-editor.org/info/rfc5130>

<a name="RFC5301"></a> **[RFC5301]** D. McPherson, N. Shen, "Dynamic Hostname Exchange Mechanism for IS-IS", RFC 5301, DOI 10.17487/RFC5301, October 2008. <https://www.rfc-editor.org/info/rfc5301>
...
<a name="RFC5642"></a> **[RFC5642]** S. Venkata, S. Harwani, C. Pignataro, D. McPherson, "Dynamic Hostname Exchange Mechanism for OSPF", RFC 5642, DOI 10.17487/RFC5642, August 2009. <https://www.rfc-editor.org/info/rfc5642>

<a name="RFC5890"></a> **[RFC5890]** J. Klensin, "Internationalized Domain Names for Applications (IDNA): Definitions and Document Framework", RFC 5890, DOI 10.17487/RFC5890, August 2010. <https://www.rfc-editor.org/info/rfc5890>
...
<a name="RFC6565"></a> **[RFC6565]** P. Pillay-Esnault, P. Moyer, J. Doyle, E. Ertekin, M. Lundberg, "OSPFv3 as a Provider Edge to Customer Edge (PE-CE) Routing Protocol", RFC 6565, DOI 10.17487/RFC6565, June 2012. <https://www.rfc-editor.org/info/rfc6565>
...
<a name="RFC8654"></a> **[RFC8654]** R. Bush, K. Patel, D. Ward, "Extended Message Support for BGP", RFC 8654, DOI 10.17487/RFC8654, October 2019. <https://www.rfc-editor.org/info/rfc8654>

## Informative References

<a name="RFC1918"></a> **[RFC1918]** Y. Rekhter, B. Moskowitz, D. Karrenberg, G. J. de Groot, E. Lear, "Address Allocation for Private Internets", BCP 5, RFC 1918, DOI 10.17487/RFC1918, February 1996. <https://www.rfc-editor.org/info/rfc1918>
...
<a name="RFC4364"></a> **[RFC4364]** E. Rosen, Y. Rekhter, "BGP/MPLS IP Virtual Private Networks (VPNs)", RFC 4364, DOI 10.17487/RFC4364, February 2006. <https://www.rfc-editor.org/info/rfc4364>
...
<a name="RFC5392"></a> **[RFC5392]** M. Chen, R. Zhang, X. Duan, "OSPF Extensions in Support of Inter-Autonomous System (AS) MPLS and GMPLS Traffic Engineering", RFC 5392, DOI 10.17487/RFC5392, January 2009. <https://www.rfc-editor.org/info/rfc5392>

<a name="RFC5693"></a> **[RFC5693]** J. Seedorf, E. Burger, "Application-Layer Traffic Optimization (ALTO) Problem Statement", RFC 5693, DOI 10.17487/RFC5693, October 2009. <https://www.rfc-editor.org/info/rfc5693>
...
<a name="RFC6549"></a> **[RFC6549]** A. Lindem, A. Roy, S. Mirtorabi, "OSPFv2 Multi-Instance Extensions", RFC 6549, DOI 10.17487/RFC6549, March 2012. <https://www.rfc-editor.org/info/rfc6549>
...
<a name="RFC7285"></a> **[RFC7285]** R. Alimi, R. Penno, Y. Yang, S. Kiesel, S. Previdi, W. Roome, S. Shalunov, R. Woundy, "Application-Layer Traffic Optimization (ALTO) Protocol", RFC 7285, DOI 10.17487/RFC7285, September 2014. <https://www.rfc-editor.org/info/rfc7285>
...
<a name="RFC7911"></a> **[RFC7911]** D. Walton, A. Retana, E. Chen, J. Scudder, "Advertisement of Multiple Paths in BGP", RFC 7911, DOI 10.17487/RFC7911, July 2016. <https://www.rfc-editor.org/info/rfc7911>

<a name="RFC8202"></a> **[RFC8202]** L. Ginsberg, S. Previdi, W. Henderickx, "IS-IS Multi-Instance", RFC 8202, DOI 10.17487/RFC8202, June 2017. <https://www.rfc-editor.org/info/rfc8202>

<a name="RFC9029"></a> **[RFC9029]** A. Farrel, "Updates to the Allocation Policy for the Border Gateway Protocol - Link State (BGP-LS) Parameters Registries", RFC 9029, DOI 10.17487/RFC9029, June 2021. <https://www.rfc-editor.org/info/rfc9029>

<a name="RFC9346"></a> **[RFC9346]** M. Chen, L. Ginsberg, S. Previdi, D. Xiaodong, "IS-IS Extensions in Support of Inter-Autonomous System (AS) MPLS and GMPLS Traffic Engineering", RFC 9346, DOI 10.17487/RFC9346, February 2023. <https://www.rfc-editor.org/info/rfc9346>
