...
`      `[`1.2`](#section-1-2)`. The IEEE Registration Authority`

`           `[`1.2.1`](#section-1-2-1)`. The IANA OUI`

`      `[`1.3`](#section-1-3)`. Acknowledgements`

`   `[`2`](#section-2)`. Ethernet Identifier Parameters`

`      `[`2.1`](#section-2-1)`. 48-Bit MAC Identifiers and OUIs`

`           `[`2.1.1`](#section-2-1-1)`. EUI-48 Allocations under the IANA OUI`

`           `[`2.1.2`](#section-2-1-2)`. EUI-48 IANA Allocation Considerations`

`      `[`2.2`](#section-2-2)`. 64-Bit MAC Identifiers`

`           `[`2.2.1`](#section-2-2-1)`. IPv6 Use of Modified EUI-64 Identifiers`

`           `[`2.2.2`](#section-2-2-2)`. EUI-64 IANA Allocation Considerations`

`      `[`2.3`](#section-2-3)`. Other MAC-48 Identifiers Used by IETF`
...
`      `[`3.1`](#section-3-1)`. Ethernet Protocol Allocation under the IANA OUI`
...
`      `[`5.2`](#section-5-2)`. Informational IANA Web Page Material`

`      `[`5.3`](#section-5-3)`. OUI Exhaustion`
...
<a id="section-1-2"></a> **`1.2. The IEEE Registration Authority`**
...
<a id="section-1-2-1"></a> **`1.2.1. The IANA OUI`**
...
<a id="section-1-3"></a> **`1.3. Acknowledgements`**
...
<a id="section-2-1"></a> **`2.1. 48-Bit MAC Identifiers and OUIs`**
...
<a id="section-2-1-1"></a> **`2.1.1. EUI-48 Allocations under the IANA OUI`**
...
<a id="section-2-1-2"></a> **`2.1.2. EUI-48 IANA Allocation Considerations`**
...
<a id="section-2-2-2"></a> **`2.2.2. EUI-64 IANA Allocation Considerations`**
...
<a id="section-2-3"></a> **`2.3. Other MAC-48 Identifiers Used by IETF`**
...
<a id="section-3-1"></a> **`3.1. Ethernet Protocol Allocation under the IANA OUI`**
...
<a id="section-5-2"></a> **`5.2. Informational IANA Web Page Material`**
...
<a id="section-5-3"></a> **`5.3. OUI Exhaustion`**
