...
`   `[`2`](#section-2)`. Conditions for Early Allocation`

`   `[`3`](#section-3)`. Process for Early Allocation`

`     `[`3.1`](#section-3-1)`. Request`

`     `[`3.2`](#section-3-2)`. Follow-Up`

`     `[`3.3`](#section-3-3)`. Expiry`
...
<a id="section-2"></a> **`2. Conditions for Early Allocation`**
...
<a id="section-3"></a> **`3. Process for Early Allocation`**
...
<a id="section-3-1"></a> **`3.1. Request`**
...
<a id="section-3-2"></a> **`3.2. Follow-Up`**
