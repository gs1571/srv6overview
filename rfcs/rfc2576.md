...
<a id="section-1-4"></a> **`1.4. SNMPv1 and SNMPv2 Access to MIB Data`**
...
<a id="section-2"></a> **`2. SMI and Management Information Mappings`**
...
<a id="section-2-1"></a> **`2.1. MIB Modules`**
...
<a id="section-2-1-1"></a> **`2.1.1. Object Definitions`**
...
<a id="section-2-1-2"></a> **`2.1.2. Trap and Notification Definitions`**
...
<a id="section-2-2"></a> **`2.2. Compliance Statements`**
...
<a id="section-2-3"></a> **`2.3. Capabilities Statements`**
...
<a id="section-3"></a> **`3. Translating Notifications Parameters`**
...
<a id="section-3-1"></a> **`3.1. Translating SNMPv1 Notification Parameters to SNMPv2 Notification`**
...
<a id="section-3-2"></a> **`3.2. Translating SNMPv2 Notification Parameters to SNMPv1 Notification`**
...
<a id="section-4"></a> **`4. Approaches to Coexistence in a Multi-lingual Network`**
...
<a id="section-4-1"></a> **`4.1. Multi-lingual implementations`**
...
<a id="section-4-1-1"></a> **`4.1.1. Command Generator`**
...
<a id="section-4-1-2"></a> **`4.1.2. Command Responder`**
...
<a id="section-4-1-2-1"></a> **`4.1.2.1. Handling Counter64`**
...
<a id="section-4-1-2-2"></a> **`4.1.2.2. Mapping SNMPv2 Exceptions`**
...
<a id="section-4-1-2-2-1"></a> **`4.1.2.2.1. Mapping noSuchObject and noSuchInstance`**
...
<a id="section-4-1-2-2-2"></a> **`4.1.2.2.2. Mapping endOfMibView`**
...
<a id="section-4-1-2-3"></a> **`4.1.2.3. Processing An SNMPv1 GetRequest`**
...
<a id="section-4-1-2-4"></a> **`4.1.2.4. Processing An SNMPv1 GetNextRequest`**
...
<a id="section-4-1-2-5"></a> **`4.1.2.5. Processing An SNMPv1 SetRequest`**
...
<a id="section-4-1-3"></a> **`4.1.3. Notification Originator`**
...
<a id="section-4-1-4"></a> **`4.1.4. Notification Receiver`**
...
<a id="section-4-2"></a> **`4.2. Proxy Implementations`**
...
<a id="section-4-2-1"></a> **`4.2.1. Upstream Version Greater Than Downstream Version`**
...
<a id="section-4-2-2"></a> **`4.2.2. Upstream Version Less Than Downstream Version`**
...
<a id="section-4-3"></a> **`4.3. Error Status Mappings`**
...
<a id="section-5"></a> **`5. Message Processing Models and Security Models`**
...
<a id="section-5-1"></a> **`5.1. Mappings`**
...
<a id="section-5-2"></a> **`5.2. The SNMPv1 MP Model and SNMPv1 Community-based Security Model`**
...
<a id="section-5-2-1"></a> **`5.2.1. Processing An Incoming Request`**
...
<a id="section-5-2-2"></a> **`5.2.2. Generating An Outgoing Response`**
...
<a id="section-5-2-3"></a> **`5.2.3. Generating An Outgoing Notification`**
...
<a id="section-5-3"></a> **`5.3. The SNMP Community MIB Module`**
...
<a id="section-6"></a> **`6. Intellectual Property`**
...
<a id="section-10"></a> **`10. Editor's Addresses`**
