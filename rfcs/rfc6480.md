...
`   `[`2`](#section-2)`. Public Key Infrastructure for Internet Number Resources`

`      `[`2.1`](#section-2-1)`. Role in the Overall Architecture`

`      `[`2.2`](#section-2-2)`. CA Certificates`

`      `[`2.3`](#section-2-3)`. End-Entity (EE) Certificates`

`      `[`2.4`](#section-2-4)`. Trust Anchors`

`   `[`3`](#section-3)`. Route Origination Authorizations`

`      `[`3.1`](#section-3-1)`. Role in the Overall Architecture`

`      `[`3.2`](#section-3-2)`. Syntax and Semantics`

`   `[`4`](#section-4)`. Repositories`

`      `[`4.1`](#section-4-1)`. Role in the Overall Architecture`

`      `[`4.2`](#section-4-2)`. Contents and Structure`

`      `[`4.3`](#section-4-3)`. Access Protocols`

`      `[`4.4`](#section-4-4)`. Access Control`

`   `[`5`](#section-5)`. Manifests`

`      `[`5.1`](#section-5-1)`. Syntax and Semantics`

`   `[`6`](#section-6)`. Local Cache Maintenance`

`   `[`7`](#section-7)`. Common Operations`

`      `[`7.1`](#section-7-1)`. Certificate Issuance`

`      `[`7.2`](#section-7-2)`. CA Key Rollover`

`      `[`7.3`](#section-7-3)`. ROA Management`

`           `[`7.3.1`](#section-7-3-1)`. Single-Homed Subscribers`

`           `[`7.3.2`](#section-7-3-2)`. Multi-Homed Subscribers`

`           `[`7.3.3`](#section-7-3-3)`. Provider-Independent Address Space`
...
<a id="section-2"></a> **`2. Public Key Infrastructure for Internet Number Resources`**
...
<a id="section-2-1"></a> **`2.1. Role in the Overall Architecture`**
...
<a id="section-2-2"></a> **`2.2. CA Certificates`**
...
<a id="section-2-3"></a> **`2.3. End-Entity (EE) Certificates`**
...
<a id="section-2-4"></a> **`2.4. Trust Anchors`**
...
<a id="section-3"></a> **`3. Route Origination Authorizations`**
...
<a id="section-3-1"></a> **`3.1. Role in the Overall Architecture`**
...
<a id="section-3-2"></a> **`3.2. Syntax and Semantics`**
...
<a id="section-4"></a> **`4. Repositories`**
...
<a id="section-4-1"></a> **`4.1. Role in the Overall Architecture`**
...
<a id="section-4-2"></a> **`4.2. Contents and Structure`**
...
<a id="section-4-3"></a> **`4.3. Access Protocols`**
...
<a id="section-4-4"></a> **`4.4. Access Control`**
...
<a id="section-5-1"></a> **`5.1. Syntax and Semantics`**
...
<a id="section-6"></a> **`6. Local Cache Maintenance`**
...
<a id="section-7"></a> **`7. Common Operations`**
...
<a id="section-7-1"></a> **`7.1. Certificate Issuance`**
...
<a id="section-7-2"></a> **`7.2. CA Key Rollover`**
...
<a id="section-7-3"></a> **`7.3. ROA Management`**
...
<a id="section-7-3-1"></a> **`7.3.1. Single-Homed Subscribers`**
...
<a id="section-7-3-2"></a> **`7.3.2. Multi-Homed Subscribers`**
...
<a id="section-7-3-3"></a> **`7.3.3. Provider-Independent Address Space`**
