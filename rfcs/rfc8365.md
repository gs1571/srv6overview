...
`   `[`2`](#section-2)`. Requirements Notation and Conventions`

`   `[`3`](#section-3)`. Terminology`

`   `[`4`](#section-4)`. EVPN Features`

`   `[`5`](#section-5)`. Encapsulation Options for EVPN Overlays`

`      `[`5.1`](#section-5-1)`. VXLAN/NVGRE Encapsulation`

`           `[`5.1.1`](#section-5-1-1)`. Virtual Identifiers Scope`

`           `[`5.1.2`](#section-5-1-2)`. Virtual Identifiers to EVI Mapping`

`           `[`5.1.3`](#section-5-1-3)`. Constructing EVPN BGP Routes`

`      `[`5.2`](#section-5-2)`. MPLS over GRE`

`   `[`6`](#section-6)`. EVPN with Multiple Data-Plane Encapsulations`

`   `[`7`](#section-7)`. Single-Homing NVEs - NVE Residing in Hypervisor`

`      `[`7.1`](#section-7-1)`. Impact on EVPN BGP Routes & Attributes for VXLAN/NVGRE`

`      `[`7.2`](#section-7-2)`. Impact on EVPN Procedures for VXLAN/NVGRE Encapsulations`

`   `[`8`](#section-8)`. Multihoming NVEs - NVE Residing in ToR Switch`

`      `[`8.1`](#section-8-1)`. EVPN Multihoming Features`

`           `[`8.1.1`](#section-8-1-1)`. Multihomed ES Auto-Discovery`

`           `[`8.1.2`](#section-8-1-2)`. Fast Convergence and Mass Withdrawal`

`           `[`8.1.3`](#section-8-1-3)`. Split-Horizon`

`           `[`8.1.4`](#section-8-1-4)`. Aliasing and Backup Path`

`           `[`8.1.5`](#section-8-1-5)`. DF Election`

`      `[`8.2`](#section-8-2)`. Impact on EVPN BGP Routes and Attributes`

`      `[`8.3`](#section-8-3)`. Impact on EVPN Procedures`

`           `[`8.3.1`](#section-8-3-1)`. Split Horizon`

`           `[`8.3.2`](#section-8-3-2)`. Aliasing and Backup Path`

`           `[`8.3.3`](#section-8-3-3)`. Unknown Unicast Traffic Designation`

`   `[`9`](#section-9)`. Support for Multicast`

`   `[`10`](#section-10)`. Data-Center Interconnections (DCIs)`

`      `[`10.1`](#section-10-1)`. DCI Using GWs`

`      `[`10.2`](#section-10-2)`. DCI Using ASBRs`

`           `[`10.2.1`](#section-10-2-1)`. ASBR Functionality with Single-Homing NVEs`

`           `[`10.2.2`](#section-10-2-2)`. ASBR Functionality with Multihoming NVEs`
...
<a id="section-2"></a> **`2. Requirements Notation and Conventions`**
...
<a id="section-4"></a> **`4. EVPN Features`**
...
<a id="section-5"></a> **`5. Encapsulation Options for EVPN Overlays`**

```text

```

<a id="section-5-1"></a> **`5.1. VXLAN/NVGRE Encapsulation`**
...
<a id="section-5-1-1"></a> **`5.1.1. Virtual Identifiers Scope`**
...
<a id="section-5-1-1-1"></a> **`5.1.1.1. Data-Center Interconnect with Gateway`**
...
<a id="section-5-1-1-2"></a> **`5.1.1.2. Data-Center Interconnect without Gateway`**
...
<a id="section-5-1-2"></a> **`5.1.2. Virtual Identifiers to EVI Mapping`**
...
<a id="section-5-1-2-1"></a> **`5.1.2.1. Auto-Derivation of RT`**
...
<a id="section-5-1-3"></a> **`5.1.3. Constructing EVPN BGP Routes`**
...
<a id="section-5-2"></a> **`5.2. MPLS over GRE`**
...
<a id="section-6"></a> **`6. EVPN with Multiple Data-Plane Encapsulations`**
...
<a id="section-7"></a> **`7. Single-Homing NVEs - NVE Residing in Hypervisor`**
...
<a id="section-7-1"></a> **`7.1. Impact on EVPN BGP Routes & Attributes for VXLAN/NVGRE`**
...
<a id="section-7-2"></a> **`7.2. Impact on EVPN Procedures for VXLAN/NVGRE Encapsulations`**
...
<a id="section-8"></a> **`8. Multihoming NVEs - NVE Residing in ToR Switch`**
...
<a id="section-8-1"></a> **`8.1. EVPN Multihoming Features`**
...
<a id="section-8-1-1"></a> **`8.1.1. Multihomed ES Auto-Discovery`**
...
<a id="section-8-1-2"></a> **`8.1.2. Fast Convergence and Mass Withdrawal`**
...
<a id="section-8-1-3"></a> **`8.1.3. Split-Horizon`**
...
<a id="section-8-1-4"></a> **`8.1.4. Aliasing and Backup Path`**
...
<a id="section-8-1-5"></a> **`8.1.5. DF Election`**
...
<a id="section-8-2"></a> **`8.2. Impact on EVPN BGP Routes and Attributes`**
...
<a id="section-8-3"></a> **`8.3. Impact on EVPN Procedures`**
...
<a id="section-8-3-1"></a> **`8.3.1. Split Horizon`**
...
<a id="section-8-3-2"></a> **`8.3.2. Aliasing and Backup Path`**
...
<a id="section-8-3-3"></a> **`8.3.3. Unknown Unicast Traffic Designation`**
...
<a id="section-9"></a> **`9. Support for Multicast`**
...
<a id="section-10"></a> **`10. Data-Center Interconnections (DCIs)`**
...
<a id="section-10-1"></a> **`10.1. DCI Using GWs`**
...
<a id="section-10-2"></a> **`10.2. DCI Using ASBRs`**
...
<a id="section-10-2-1"></a> **`10.2.1. ASBR Functionality with Single-Homing NVEs`**
...
<a id="section-10-2-2"></a> **`10.2.2. ASBR Functionality with Multihoming NVEs`**
