...
`   `[`1`](#section-1)`. Introduction and Problem Statement`

`      `[`1.1`](#section-1-1)`. Background`

`           `[`1.1.1`](#section-1-1-1)`. Hierarchical LSPs`

`           `[`1.1.2`](#section-1-1-2)`. LSP Stitching Segments`

`           `[`1.1.3`](#section-1-1-3)`. Private Links`

`           `[`1.1.4`](#section-1-1-4)`. Routing Adjacencies`

`           `[`1.1.5`](#section-1-1-5)`. Forwarding Adjacencies`

`           `[`1.1.6`](#section-1-1-6)`. Client/Server Networks`

`           `[`1.1.7`](#section-1-1-7)`. Link Bundles`

`      `[`1.2`](#section-1-2)`. Desired Function`

`      `[`1.3`](#section-1-3)`. Existing Mechanisms`

`           `[`1.3.1`](#section-1-3-1)`. LSP Setup`

`           `[`1.3.2`](#section-1-3-2)`. Routing Adjacency Establishment and Link`

`                  State Advertisement`

`           `[`1.3.3`](#section-1-3-3)`. TE Link Advertisement`

`           `[`1.3.4`](#section-1-3-4)`. Configuration and Management Techniques`

`           `[`1.3.5`](#section-1-3-5)`. Signaled Unnumbered FAs`

`           `[`1.3.6`](#section-1-3-6)`. Establishing Numbered FAs through Signaling`

`                  and Routing`

`      `[`1.4`](#section-1-4)`. Overview of Required Extensions`

`           `[`1.4.1`](#section-1-4-1)`. Efficient Signaling of Numbered FAs`

`           `[`1.4.2`](#section-1-4-2)`. LSPs for Use as Private Links`

`           `[`1.4.3`](#section-1-4-3)`. Signaling an LSP for Use in Another Network`

`           `[`1.4.4`](#section-1-4-4)`. Signaling an LSP for Use in a Link Bundle`

`           `[`1.4.5`](#section-1-4-5)`. Support for IPv4 and IPv6`

`           `[`1.4.6`](#section-1-4-6)`. Backward Compatibility`

`   `[`2`](#section-2)`. Overview of Solution`

`      `[`2.1`](#section-2-1)`. Common Approach for Numbered and Unnumbered Links`

`      `[`2.2`](#section-2-2)`. LSP Usage Indication`

`      `[`2.3`](#section-2-3)`. IGP Instance Identification`

`      `[`2.4`](#section-2-4)`. Link Bundle Identification`

`      `[`2.5`](#section-2-5)`. Backward Compatibility`

`   `[`3`](#section-3)`. Mechanisms and Protocol Extensions`

`      `[`3.1`](#section-3-1)`. LSP_TUNNEL_INTERFACE_ID Object`

`           `[`3.1.1`](#section-3-1-1)`. Existing Definition and Usage`

`           `[`3.1.2`](#section-3-1-2)`. Unnumbered Links with Action Identification`

`           `[`3.1.3`](#section-3-1-3)`. IPv4 Numbered Links with Action Identification`

`           `[`3.1.4`](#section-3-1-4)`. IPv6 Numbered Links with Action Identification`

`      `[`3.2`](#section-3-2)`. Target IGP Identification TLV`

`      `[`3.3`](#section-3-3)`. Component Link Identification TLV`

`           `[`3.3.1`](#section-3-3-1)`. Unnumbered Component Link Identification`

`           `[`3.3.2`](#section-3-3-2)`. IPv4 Numbered Component Link Identification`

`           `[`3.3.3`](#section-3-3-3)`. IPv6 Numbered Component Link Identification`

`      `[`3.4`](#section-3-4)`. Link State Advertisement`

`      `[`3.5`](#section-3-5)`. Message Formats`

`      `[`3.6`](#section-3-6)`. Error Cases and Non-Acceptance`

`      `[`3.7`](#section-3-7)`. Backward Compatibility`

`   `[`4`](#section-4)`. Security Considerations`

`   `[`5`](#section-5)`. IANA Considerations`

`      `[`5.1`](#section-5-1)`. New Class Types`

`      `[`5.2`](#section-5-2)`. Hierarchy Actions`

`      `[`5.3`](#section-5-3)`. New Error Codes and Error Values`
...
<a id="section-1"></a> **`1. Introduction and Problem Statement`**
...
<a id="section-1-1-1"></a> **`1.1.1. Hierarchical LSPs`**
...
<a id="section-1-1-2"></a> **`1.1.2. LSP Stitching Segments`**
...
<a id="section-1-1-3"></a> **`1.1.3. Private Links`**
...
<a id="section-1-1-4"></a> **`1.1.4. Routing Adjacencies`**
...
<a id="section-1-1-5"></a> **`1.1.5. Forwarding Adjacencies`**
...
<a id="section-1-1-6"></a> **`1.1.6. Client/Server Networks`**
...
<a id="section-1-1-7"></a> **`1.1.7. Link Bundles`**
...
<a id="section-1-2"></a> **`1.2. Desired Function`**
...
<a id="section-1-3"></a> **`1.3. Existing Mechanisms`**
...
<a id="section-1-3-1"></a> **`1.3.1. LSP Setup`**
...
<a id="section-1-3-2"></a> **`1.3.2. Routing Adjacency Establishment and Link State Advertisement`**
...
<a id="section-1-3-3"></a> **`1.3.3. TE Link Advertisement`**
...
<a id="section-1-3-4"></a> **`1.3.4. Configuration and Management Techniques`**
...
<a id="section-1-3-5"></a> **`1.3.5. Signaled Unnumbered FAs`**
...
<a id="section-1-3-6"></a> **`1.3.6. Establishing Numbered FAs through Signaling and Routing`**
...
<a id="section-1-4"></a> **`1.4. Overview of Required Extensions`**
...
<a id="section-1-4-1"></a> **`1.4.1. Efficient Signaling of Numbered FAs`**
...
<a id="section-1-4-2"></a> **`1.4.2. LSPs for Use as Private Links`**
...
<a id="section-1-4-3"></a> **`1.4.3. Signaling an LSP for Use in Another Network`**
...
<a id="section-1-4-4"></a> **`1.4.4. Signaling an LSP for Use in a Link Bundle`**
...
<a id="section-1-4-5"></a> **`1.4.5. Support for IPv4 and IPv6`**
...
<a id="section-1-4-6"></a> **`1.4.6. Backward Compatibility`**
...
<a id="section-2"></a> **`2. Overview of Solution`**
...
<a id="section-2-1"></a> **`2.1. Common Approach for Numbered and Unnumbered Links`**
...
<a id="section-2-2"></a> **`2.2. LSP Usage Indication`**
...
<a id="section-2-3"></a> **`2.3. IGP Instance Identification`**
...
<a id="section-2-4"></a> **`2.4. Link Bundle Identification`**
...
<a id="section-2-5"></a> **`2.5. Backward Compatibility`**
...
<a id="section-3"></a> **`3. Mechanisms and Protocol Extensions`**
...
<a id="section-3-1"></a> **`3.1. LSP_TUNNEL_INTERFACE_ID Object`**
...
<a id="section-3-1-1"></a> **`3.1.1. Existing Definition and Usage`**
...
<a id="section-3-1-2"></a> **`3.1.2. Unnumbered Links with Action Identification`**
...
<a id="section-3-1-3"></a> **`3.1.3. IPv4 Numbered Links with Action Identification`**
...
<a id="section-3-1-4"></a> **`3.1.4. IPv6 Numbered Links with Action Identification`**
...
<a id="section-3-2"></a> **`3.2. Target IGP Identification TLV`**
...
<a id="section-3-3"></a> **`3.3. Component Link Identification TLV`**
...
<a id="section-3-3-1"></a> **`3.3.1. Unnumbered Component Link Identification`**
...
<a id="section-3-3-2"></a> **`3.3.2. IPv4 Numbered Component Link Identification`**
...
<a id="section-3-3-3"></a> **`3.3.3. IPv6 Numbered Component Link Identification`**
...
<a id="section-3-4"></a> **`3.4. Link State Advertisement`**
...
<a id="section-3-5"></a> **`3.5. Message Formats`**
...
<a id="section-3-6"></a> **`3.6. Error Cases and Non-Acceptance`**
...
<a id="section-3-7"></a> **`3.7. Backward Compatibility`**
...
<a id="section-5-1"></a> **`5.1. New Class Types`**
...
<a id="section-5-2"></a> **`5.2. Hierarchy Actions`**
...
<a id="section-5-3"></a> **`5.3. New Error Codes and Error Values`**
