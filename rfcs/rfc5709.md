...
<a id="section-3"></a> **`3. Cryptographic Authentication with NIST SHS in HMAC Mode`**
...
<a id="section-3-1"></a> **`3.1. Generating Cryptographic Authentication`**
...
<a id="section-3-2"></a> **`3.2. OSPFv2 Security Association`**
...
<a id="section-3-4"></a> **`3.4. Message Verification`**
...
<a id="section-3-5"></a> **`3.5. Changing OSPFv2 Security Associations`**
