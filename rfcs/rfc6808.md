...
`   `[`2`](#section-2)`. A Definition-Centric Metric Advancement Process`

`   `[`3`](#section-3)`. Test Configuration`

`   `[`4`](#section-4)`. Error Calibration, RFC 2679`

`      `[`4.1`](#section-4-1)`. NetProbe Error and Type-P`

`      `[`4.2`](#section-4-2)`. Perfas+ Error and Type-P`

`   `[`5`](#section-5)`. Predetermined Limits on Equivalence`

`   `[`6`](#section-6)`. Tests to Evaluate RFC 2679 Specifications`

`      `[`6.1`](#section-6-1)`. One-Way Delay, ADK Sample Comparison: Same- and Cross-`

`           Implementation`

`           `[`6.1.1`](#section-6-1-1)`. NetProbe Same-Implementation Results`

`           `[`6.1.2`](#section-6-1-2)`. Perfas+ Same-Implementation Results`

`           `[`6.1.3`](#section-6-1-3)`. One-Way Delay, Cross-Implementation ADK`

`                  Comparison`

`           `[`6.1.4`](#section-6-1-4)`. Conclusions on the ADK Results for One-Way Delay`

`           `[`6.1.5`](#section-6-1-5)`. Additional Investigations`

`      `[`6.2`](#section-6-2)`. One-Way Delay, Loss Threshold, RFC 2679`

`           `[`6.2.1`](#section-6-2-1)`. NetProbe Results for Loss Threshold`

`           `[`6.2.2`](#section-6-2-2)`. Perfas+ Results for Loss Threshold`

`           `[`6.2.3`](#section-6-2-3)`. Conclusions for Loss Threshold`

`      `[`6.3`](#section-6-3)`. One-Way Delay, First Bit to Last Bit, RFC 2679`

`           `[`6.3.1`](#section-6-3-1)`. NetProbe and Perfas+ Results for Serialization`

`           `[`6.3.2`](#section-6-3-2)`. Conclusions for Serialization`

`      `[`6.4`](#section-6-4)`. One-Way Delay, Difference Sample Metric`

`           `[`6.4.1`](#section-6-4-1)`. NetProbe Results for Differential Delay`

`           `[`6.4.2`](#section-6-4-2)`. Perfas+ Results for Differential Delay`

`           `[`6.4.3`](#section-6-4-3)`. Conclusions for Differential Delay`

`      `[`6.5`](#section-6-5)`. Implementation of Statistics for One-Way Delay`

`   `[`7`](#section-7)`. Conclusions and RFC 2679 Errata`
...
<a id="section-2"></a> **`2. A Definition-Centric Metric Advancement Process`**
...
<a id="section-3"></a> **`3. Test Configuration`**
...
<a id="section-4"></a> **`4. Error Calibration, RFC 2679`**
...
<a id="section-4-1"></a> **`4.1. NetProbe Error and Type-P`**
...
<a id="section-4-2"></a> **`4.2. Perfas+ Error and Type-P`**
...
<a id="section-5"></a> **`5. Predetermined Limits on Equivalence`**
...
<a id="section-6"></a> **`6. Tests to Evaluate RFC 2679 Specifications`**
...
<a id="section-6-1"></a> **`6.1. One-Way Delay, ADK Sample Comparison: Same- and Cross-`**
...
<a id="section-6-1-1"></a> **`6.1.1. NetProbe Same-Implementation Results`**
...
<a id="section-6-1-2"></a> **`6.1.2. Perfas+ Same-Implementation Results`**
...
<a id="section-6-1-3"></a> **`6.1.3. One-Way Delay, Cross-Implementation ADK Comparison`**
...
<a id="section-6-1-4"></a> **`6.1.4. Conclusions on the ADK Results for One-Way Delay`**
...
<a id="section-6-1-5"></a> **`6.1.5. Additional Investigations`**
...
<a id="section-6-2"></a> **`6.2. One-Way Delay, Loss Threshold, RFC 2679`**
...
<a id="section-6-2-1"></a> **`6.2.1. NetProbe Results for Loss Threshold`**
...
<a id="section-6-2-2"></a> **`6.2.2. Perfas+ Results for Loss Threshold`**
...
<a id="section-6-2-3"></a> **`6.2.3. Conclusions for Loss Threshold`**
...
<a id="section-6-3"></a> **`6.3. One-Way Delay, First Bit to Last Bit, RFC 2679`**
...
<a id="section-6-3-1"></a> **`6.3.1. NetProbe and Perfas+ Results for Serialization`**
...
<a id="section-6-3-2"></a> **`6.3.2. Conclusions for Serialization`**
...
<a id="section-6-4"></a> **`6.4. One-Way Delay, Difference Sample Metric`**
...
<a id="section-6-4-1"></a> **`6.4.1. NetProbe Results for Differential Delay`**
...
<a id="section-6-4-2"></a> **`6.4.2. Perfas+ Results for Differential Delay`**
...
<a id="section-6-4-3"></a> **`6.4.3. Conclusions for Differential Delay`**
...
<a id="section-6-5"></a> **`6.5. Implementation of Statistics for One-Way Delay`**
...
<a id="section-7"></a> **`7. Conclusions and RFC 2679 Errata`**
