...
<a id="section-2"></a> **`2. Global and Other Specialized Address Blocks`**
...
<a id="section-3"></a> **`3. Summary Table`**
...
<a id="section-4"></a> **`4. Assignments of IPv4 Blocks for New Specialized Uses`**
