...
`     `[`1.1`](#section-1-1)`. Applicability Scope`

`     `[`1.2`](#section-1-2)`. Conventions`

`     `[`1.3`](#section-1-3)`. Terminology`

`   `[`2`](#section-2)`. IPv4-Embedded IPv6 Address Prefix and Format`

`     `[`2.1`](#section-2-1)`. Well-Known Prefix`

`     `[`2.2`](#section-2-2)`. IPv4-Embedded IPv6 Address Format`

`     `[`2.3`](#section-2-3)`. Address Translation Algorithms`

`     `[`2.4`](#section-2-4)`. Text Representation`

`   `[`3`](#section-3)`. Deployment Guidelines`

`     `[`3.1`](#section-3-1)`. Restrictions on the Use of the Well-Known Prefix`

`     `[`3.2`](#section-3-2)`. Impact on Inter-Domain Routing`

`     `[`3.3`](#section-3-3)`. Choice of Prefix for Stateless Translation Deployments .`

`     `[`3.4`](#section-3-4)`. Choice of Prefix for Stateful Translation Deployments  .`

`   `[`4`](#section-4)`. Design Choices`

`     `[`4.1`](#section-4-1)`. Choice of Suffix`

`     `[`4.2`](#section-4-2)`. Choice of the Well-Known Prefix`

`   `[`5`](#section-5)`. Security Considerations`

`     `[`5.1`](#section-5-1)`. Protection against Spoofing`

`     `[`5.2`](#section-5-2)`. Secure Configuration`

`     `[`5.3`](#section-5-3)`. Firewall Configuration`
...
<a id="section-1-1"></a> **`1.1. Applicability Scope`**
...
<a id="section-2"></a> **`2. IPv4-Embedded IPv6 Address Prefix and Format`**

```text

```

<a id="section-2-1"></a> **`2.1. Well-Known Prefix`**
...
<a id="section-2-2"></a> **`2.2. IPv4-Embedded IPv6 Address Format`**
...
<a id="section-2-3"></a> **`2.3. Address Translation Algorithms`**
...
<a id="section-2-4"></a> **`2.4. Text Representation`**
...
<a id="section-3"></a> **`3. Deployment Guidelines`**

```text

```

<a id="section-3-1"></a> **`3.1. Restrictions on the Use of the Well-Known Prefix`**
...
<a id="section-3-2"></a> **`3.2. Impact on Inter-Domain Routing`**
...
<a id="section-3-3"></a> **`3.3. Choice of Prefix for Stateless Translation Deployments`**
...
<a id="section-3-4"></a> **`3.4. Choice of Prefix for Stateful Translation Deployments`**
...
<a id="section-4"></a> **`4. Design Choices`**
...
<a id="section-4-1"></a> **`4.1. Choice of Suffix`**
...
<a id="section-4-2"></a> **`4.2. Choice of the Well-Known Prefix`**
...
<a id="section-5-1"></a> **`5.1. Protection against Spoofing`**
...
<a id="section-5-2"></a> **`5.2. Secure Configuration`**
...
<a id="section-5-3"></a> **`5.3. Firewall Configuration`**
