...
`   `[`1.2`](#section-1-2)`. Edge Devices`

`   `[`1.3`](#section-1-3)`. VPNs with Overlapping Address Spaces`

`   `[`1.4`](#section-1-4)`. VPNs with Different Routes to the Same System`

`   `[`1.5`](#section-1-5)`. Multiple Forwarding Tables in PEs`

`   `[`1.6`](#section-1-6)`. SP Backbone Routers`

`   `[`1.7`](#section-1-7)`. Security`

`   `[`2`](#section-2)`. Sites and CEs`

`   `[`3`](#section-3)`. Per-Site Forwarding Tables in the PEs`

`   `[`3.1`](#section-3-1)`. Virtual Sites`

`   `[`4`](#section-4)`. VPN Route Distribution via BGP`

`   `[`4.1`](#section-4-1)`. The VPN-IPv4 Address Family`

`   `[`4.2`](#section-4-2)`. Controlling Route Distribution`

`   `[`4.2.1`](#section-4-2-1)`. The Target VPN Attribute`

`   `[`4.2.2`](#section-4-2-2)`. Route Distribution Among PEs by BGP`

`   `[`4.2.3`](#section-4-2-3)`. The VPN of Origin Attribute`

`   `[`4.2.4`](#section-4-2-4)`. Building VPNs using Target and Origin Attributes`

`   `[`5`](#section-5)`. Forwarding Across the Backbone`

`   `[`6`](#section-6)`. How PEs Learn Routes from CEs`

`   `[`7`](#section-7)`. How CEs learn Routes from PEs`

`   `[`8`](#section-8)`. What if the CE Supports MPLS?`

`   `[`8.1`](#section-8-1)`. Virtual Sites`

`   `[`8.2`](#section-8-2)`. Representing an ISP VPN as a Stub VPN`

`   `[`9`](#section-9)`. Security`

`   `[`9.1`](#section-9-1)`. Point-to-Point Security Tunnels between CE Routers`

`   `[`9.2`](#section-9-2)`. Multi-Party Security Associations`

`   `[`10`](#section-10)`. Quality of Service`

`   `[`11`](#section-11)`. Scalability`

`   `[`12`](#section-12)`. Intellectual Property Considerations`
...
`   `[`17`](#section-17)`. Full Copyright Statement`
...
<a id="section-1-2"></a> **`1.2. Edge Devices`**
...
<a id="section-1-5"></a> **`1.5. Multiple Forwarding Tables in PEs`**
...
<a id="section-1-6"></a> **`1.6. SP Backbone Routers`**
...
<a id="section-1-7"></a> **`1.7. Security`**
...
<a id="section-3"></a> **`3. Per-Site Forwarding Tables in the PEs`**
...
<a id="section-3-1"></a> **`3.1. Virtual Sites`**
...
<a id="section-4-2"></a> **`4.2. Controlling Route Distribution`**
...
<a id="section-4-2-1"></a> **`4.2.1. The Target VPN Attribute`**
...
<a id="section-4-2-2"></a> **`4.2.2. Route Distribution Among PEs by BGP`**
...
<a id="section-4-2-3"></a> **`4.2.3. The VPN of Origin Attribute`**
...
<a id="section-4-2-4"></a> **`4.2.4. Building VPNs using Target and Origin Attributes`**
...
<a id="section-5"></a> **`5. Forwarding Across the Backbone`**
...
<a id="section-6"></a> **`6. How PEs Learn Routes from CEs`**
...
<a id="section-7"></a> **`7. How CEs learn Routes from PEs`**
...
<a id="section-8"></a> **`8. What if the CE Supports MPLS?`**
...
<a id="section-8-1"></a> **`8.1. Virtual Sites`**
...
<a id="section-8-2"></a> **`8.2. Representing an ISP VPN as a Stub VPN`**
...
<a id="section-9-1"></a> **`9.1. Point-to-Point Security Tunnels between CE Routers`**
...
<a id="section-9-2"></a> **`9.2. Multi-Party Security Associations`**
...
<a id="section-10"></a> **`10. Quality of Service`**
...
<a id="section-11"></a> **`11. Scalability`**
...
<a id="section-12"></a> **`12. Intellectual Property Considerations`**
...
<a id="section-17"></a> **`17. Full Copyright Statement`**
