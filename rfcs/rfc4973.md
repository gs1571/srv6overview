...
`   `[`2`](#section-2)`. Principles of Traffic Engineering`

`   `[`3`](#section-3)`. Terminology`

`      `[`3.1`](#section-3-1)`. Native OSPF Terms`

`      `[`3.2`](#section-3-2)`. OSPF-xTE Terms`

`   `[`4`](#section-4)`. Motivations behind the Design of OSPF-xTE`

`      `[`4.1`](#section-4-1)`. Scalable Design`

`      `[`4.2`](#section-4-2)`. Operable in Mixed and Peer Networks`

`      `[`4.3`](#section-4-3)`. Efficient in Flooding Reach`

`      `[`4.4`](#section-4-4)`. Ability to Reserve TE-Exclusive Links`

`      `[`4.5`](#section-4-5)`. Extensible Design`

`      `[`4.6`](#section-4-6)`. Unified for Packet and Non-Packet Networks`

`      `[`4.7`](#section-4-7)`. Networks Benefiting from the OSPF-xTE Design`

`   `[`5`](#section-5)`. OSPF-xTE Solution Overview`

`      `[`5.1`](#section-5-1)`. OSPF-xTE Solution`

`      `[`5.2`](#section-5-2)`. Assumptions`

`   `[`6`](#section-6)`. Strategy for Transition of Opaque LSAs to OSPF-xTE`

`   `[`7`](#section-7)`. OSPF-xTE Router Adjacency -- TE Topology Discovery`

`      `[`7.1`](#section-7-1)`. The OSPF-xTE Router Adjacency`

`      `[`7.2`](#section-7-2)`. The Hello Protocol`

`      `[`7.3`](#section-7-3)`. The Designated Router`

`      `[`7.4`](#section-7-4)`. The Backup Designated Router`

`      `[`7.5`](#section-7-5)`. Flooding and the Synchronization of Databases`

`      `[`7.6`](#section-7-6)`. The Graph of Adjacencies`

`   `[`8`](#section-8)`. TE LSAs for Packet Network`

`      `[`8.1`](#section-8-1)`. TE-Router LSA (0x81)`

`           `[`8.1.1`](#section-8-1-1)`. Router-TE Flags: TE Capabilities of the Router`

`           `[`8.1.2`](#section-8-1-2)`. Router-TE TLVs`

`           `[`8.1.3`](#section-8-1-3)`. Link-TE Flags: TE Capabilities of a Link`

`           `[`8.1.4`](#section-8-1-4)`. Link-TE TLVs`

`      `[`8.2`](#section-8-2)`. TE-Incremental-Link-Update LSA (0x8d)`

`      `[`8.3`](#section-8-3)`. TE-Circuit-Path LSA (0x8C)`

`      `[`8.4`](#section-8-4)`. TE-Summary LSAs`

`           `[`8.4.1`](#section-8-4-1)`. TE-Summary Network LSA (0x83)`

`           `[`8.4.2`](#section-8-4-2)`. TE-Summary Router LSA (0x84)`

`      `[`8.5`](#section-8-5)`. TE-AS-external LSAs (0x85)`

`   `[`9`](#section-9)`. TE LSAs for Non-Packet Network`

`      `[`9.1`](#section-9-1)`. TE-Router LSA (0x81)`

`           `[`9.1.1`](#section-9-1-1)`. Router-TE flags - TE Capabilities of a Router`

`           `[`9.1.2`](#section-9-1-2)`. Link-TE Options: TE Capabilities of a TE Link`

`      `[`9.2`](#section-9-2)`. TE-positional-ring-network LSA (0x82)`

`      `[`9.3`](#section-9-3)`. TE-Router-Proxy LSA (0x8e)`

`   `[`10`](#section-10)`. Abstract Topology Representation with TE Support`

`   `[`11`](#section-11)`. Changes to Data Structures in OSPF-xTE Nodes`

`      `[`11.1`](#section-11-1)`. Changes to Router Data Structure`

`      `[`11.2`](#section-11-2)`. Two Sets of Neighbors`

`      `[`11.3`](#section-11-3)`. Changes to Interface Data Structure`

`   `[`12`](#section-12)`. IANA Considerations`

`      `[`12.1`](#section-12-1)`. TE LSA Type Values`

`      `[`12.2`](#section-12-2)`. TE TLV Tag Values`

`   `[`13`](#section-13)`. Acknowledgements`
...
<a id="section-2"></a> **`2. Principles of Traffic Engineering`**
...
<a id="section-3-1"></a> **`3.1. Native OSPF Terms`**
...
<a id="section-3-2"></a> **`3.2. OSPF-xTE Terms`**
...
<a id="section-4"></a> **`4. Motivations behind the Design of OSPF-xTE`**
...
<a id="section-4-1"></a> **`4.1. Scalable Design`**
...
<a id="section-4-2"></a> **`4.2. Operable in Mixed and Peer Networks`**
...
<a id="section-4-3"></a> **`4.3. Efficient in Flooding Reach`**
...
<a id="section-4-4"></a> **`4.4. Ability to Reserve TE-Exclusive Links`**
...
<a id="section-4-5"></a> **`4.5. Extensible Design`**
...
<a id="section-4-6"></a> **`4.6. Unified for Packet and Non-Packet Networks`**
...
<a id="section-4-7"></a> **`4.7. Networks Benefiting from the OSPF-xTE Design`**
...
<a id="section-5"></a> **`5. OSPF-xTE Solution Overview`**

```text

```

<a id="section-5-1"></a> **`5.1. OSPF-xTE Solution`**
...
<a id="section-5-2"></a> **`5.2. Assumptions`**
...
<a id="section-6"></a> **`6. Strategy for Transition of Opaque LSAs to OSPF-xTE`**
...
<a id="section-7"></a> **`7. OSPF-xTE Router Adjacency -- TE Topology Discovery`**
...
<a id="section-7-1"></a> **`7.1. The OSPF-xTE Router Adjacency`**
...
<a id="section-7-2"></a> **`7.2. The Hello Protocol`**
...
<a id="section-7-3"></a> **`7.3. The Designated Router`**
...
<a id="section-7-4"></a> **`7.4. The Backup Designated Router`**
...
<a id="section-7-5"></a> **`7.5. Flooding and the Synchronization of Databases`**
...
<a id="section-7-6"></a> **`7.6. The Graph of Adjacencies`**
...
<a id="section-8"></a> **`8. TE LSAs for Packet Network`**
...
<a id="section-8-1"></a> **`8.1. TE-Router LSA (0x81)`**
...
<a id="section-8-1-1"></a> **`8.1.1. Router-TE Flags: TE Capabilities of the Router`**
...
<a id="section-8-1-2"></a> **`8.1.2. Router-TE TLVs`**
...
<a id="section-8-1-2-1"></a> **`8.1.2.1. TE-NODE-TLV-MPLS-SWITCHING`**
...
<a id="section-8-1-2-2"></a> **`8.1.2.2. TE-NODE-TLV-MPLS-SIG-PROTOCOLS`**
...
<a id="section-8-1-2-3"></a> **`8.1.2.3. TE-NODE-TLV-CSPF-ALGORITHMS`**
...
<a id="section-8-1-2-4"></a> **`8.1.2.4. TE-NODE-TLV-NULL`**
...
<a id="section-8-1-3"></a> **`8.1.3. Link-TE Flags: TE Capabilities of a Link`**
...
<a id="section-8-1-4"></a> **`8.1.4. Link-TE TLVs`**

```text

```

<a id="section-8-1-4-1"></a> **`8.1.4.1. TE-LINK-TLV-SRLG`**
...
<a id="section-8-1-4-3"></a> **`8.1.4.3. TE-LINK-TLV-BANDWIDTH-MAX-FOR-TE`**
...
<a id="section-8-1-4-4"></a> **`8.1.4.4. TE-LINK-TLV-BANDWIDTH-TE`**
...
<a id="section-8-1-4-5"></a> **`8.1.4.5. TE-LINK-TLV-LUG`**
...
<a id="section-8-1-4-6"></a> **`8.1.4.6. TE-LINK-TLV-COLOR`**
...
<a id="section-8-1-4-7"></a> **`8.1.4.7. TE-LINK-TLV-NULL`**
...
<a id="section-8-2"></a> **`8.2. TE-Incremental-Link-Update LSA (0x8d)`**
...
<a id="section-8-3"></a> **`8.3. TE-Circuit-Path LSA (0x8C)`**
...
<a id="section-8-4"></a> **`8.4. TE-Summary LSAs`**
...
<a id="section-8-4-1"></a> **`8.4.1. TE-Summary Network LSA (0x83)`**
...
<a id="section-8-4-2"></a> **`8.4.2. TE-Summary Router LSA (0x84)`**
...
<a id="section-8-5"></a> **`8.5. TE-AS-external LSAs (0x85)`**
...
<a id="section-9"></a> **`9. TE LSAs for Non-Packet Network`**
...
<a id="section-9-1"></a> **`9.1. TE-Router LSA (0x81)`**
...
<a id="section-9-2"></a> **`9.2. TE-positional-ring-network LSA (0x82)`**
...
<a id="section-9-3"></a> **`9.3. TE-Router-Proxy LSA (0x8e)`**
...
<a id="section-10"></a> **`10. Abstract Topology Representation with TE Support`**
...
<a id="section-11"></a> **`11. Changes to Data Structures in OSPF-xTE Nodes`**

```text

```

<a id="section-11-1"></a> **`11.1. Changes to Router Data Structure`**
...
<a id="section-11-2"></a> **`11.2. Two Sets of Neighbors`**
...
<a id="section-11-3"></a> **`11.3. Changes to Interface Data Structure`**
...
<a id="section-12-1"></a> **`12.1. TE LSA Type Values`**
...
<a id="section-12-2"></a> **`12.2. TE TLV Tag Values`**
...
<a id="section-13"></a> **`13. Acknowledgements`**
...
<a id="section-14"></a> **`14. Security Considerations`**
